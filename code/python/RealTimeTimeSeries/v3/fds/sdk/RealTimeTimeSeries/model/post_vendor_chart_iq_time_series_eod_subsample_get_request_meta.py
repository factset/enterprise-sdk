...
class PostVendorChartIQTimeSeriesEodSubsampleGetRequestMeta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesEodSubsampleGetRequestMeta - a model defined in OpenAPI
