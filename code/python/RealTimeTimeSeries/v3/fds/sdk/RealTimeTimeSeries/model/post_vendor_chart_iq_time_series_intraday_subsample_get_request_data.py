...
class PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData(ModelNormal):
    ...
    def _from_openapi_data(cls, identifier, _from, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData - a model defined in OpenAPI
