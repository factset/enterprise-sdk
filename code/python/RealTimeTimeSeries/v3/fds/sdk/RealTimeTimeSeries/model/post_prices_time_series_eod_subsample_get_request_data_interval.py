...
class PostPricesTimeSeriesEodSubsampleGetRequestDataInterval(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostPricesTimeSeriesEodSubsampleGetRequestDataInterval - a model defined in OpenAPI
