...
class PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, end, number, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            granularity (str): Subsample granularities suitable for end-of-day data.. [optional] if omitted the server will use the default value of "1w"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, end, number, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples - a model defined in OpenAPI
