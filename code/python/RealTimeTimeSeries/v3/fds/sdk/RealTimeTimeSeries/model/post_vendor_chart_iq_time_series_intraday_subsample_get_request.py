...
def lazy_import():
    ...
    globals()['PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData'] = PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData


class PostVendorChartIQTimeSeriesIntradaySubsampleGetRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesIntradaySubsampleGetRequest - a model defined in OpenAPI
