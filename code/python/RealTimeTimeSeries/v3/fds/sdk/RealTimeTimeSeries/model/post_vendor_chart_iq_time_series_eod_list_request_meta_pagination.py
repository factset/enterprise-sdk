...
class PostVendorChartIQTimeSeriesEodListRequestMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesEodListRequestMetaPagination - a model defined in OpenAPI
