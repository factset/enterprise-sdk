...
from fds.sdk.RealTimeTimeSeries import rest
from fds.sdk.RealTimeTimeSeries.configuration import Configuration
from fds.sdk.RealTimeTimeSeries.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.RealTimeTimeSeries.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/RealTimeTimeSeries/0.11.6 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PricesApi()
        api_instance.post_prices_time_series_eod_list  # this is an instance of the class Endpoint
        api_instance.post_prices_time_series_eod_list()  # this invokes api_instance.post_prices_time_series_eod_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.post_prices_time_series_eod_list.callable or self.callable in this class
