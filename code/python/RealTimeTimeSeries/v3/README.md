...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.RealTimeTimeSeries/0.12.0)](https://pypi.org/project/fds.sdk.RealTimeTimeSeries/v/0.12.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.RealTimeTimeSeries==0.12.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.RealTimeTimeSeries==0.12.0
```
