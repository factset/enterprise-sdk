...
class PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval - a model defined in OpenAPI
