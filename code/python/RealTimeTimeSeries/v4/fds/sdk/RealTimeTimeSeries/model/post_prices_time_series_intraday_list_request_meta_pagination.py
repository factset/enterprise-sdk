...
class PostPricesTimeSeriesIntradayListRequestMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostPricesTimeSeriesIntradayListRequestMetaPagination - a model defined in OpenAPI
