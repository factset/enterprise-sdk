...
class PostPricesTimeSeriesIntradaySubsampleListRequestDataRange(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostPricesTimeSeriesIntradaySubsampleListRequestDataRange - a model defined in OpenAPI
