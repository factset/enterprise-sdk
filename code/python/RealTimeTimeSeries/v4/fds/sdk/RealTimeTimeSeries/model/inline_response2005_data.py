...
def lazy_import():
    ...
    globals()['InlineResponse2005DataRange'] = InlineResponse2005DataRange
    globals()['PostPricesTimeSeriesEodListDataPricesItems'] = PostPricesTimeSeriesEodListDataPricesItems
...
class InlineResponse2005Data(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'range': (InlineResponse2005DataRange,),  # noqa: E501
            'quality': (str, none_type,),  # noqa: E501
            'prices': ([PostPricesTimeSeriesEodListDataPricesItems],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            range (InlineResponse2005DataRange): [optional]  # noqa: E501
            ...
            prices ([PostPricesTimeSeriesEodListDataPricesItems]): Time series of prices. For the attributes first, last, low, high, see attribute `valueUnit` in endpoint `/prices/get` for their unit, except for price type yield, where the `valueUnit` is always `percent` (id=258).. [optional]  # noqa: E501
        """
