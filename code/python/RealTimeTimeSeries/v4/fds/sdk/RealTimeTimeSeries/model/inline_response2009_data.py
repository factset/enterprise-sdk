...
def lazy_import():
    ...
    globals()['InlineResponse2009DataSubsample'] = InlineResponse2009DataSubsample
...
class InlineResponse2009Data(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'subsample': (InlineResponse2009DataSubsample,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            quality (str, none_type): Quality of the price. | Value | Description | | --- | --- | | RLT | Real-time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. |  . [optional]  # noqa: E501
            subsample (InlineResponse2009DataSubsample): [optional]  # noqa: E501
        """
