...
class PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples(ModelNormal):
    ...
    def _from_openapi_data(cls, end, number, *args, **kwargs):  # noqa: E501
        """PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples - a model defined in OpenAPI
