...
def lazy_import():
    ...
    globals()['PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems'] = PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems
...
class InlineResponse2007Data(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'subsamples': ([PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            subsamples ([PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems]): List of summary records. For the attributes first, last, low, high, see attribute `valueUnit` in endpoint `/prices/get` for their unit, except for price type yield, where the `valueUnit` is always `percent` (id=258).. [optional]  # noqa: E501
        """
