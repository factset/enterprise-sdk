...
class PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange - a model defined in OpenAPI
