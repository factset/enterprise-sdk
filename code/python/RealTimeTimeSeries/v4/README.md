...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.RealTimeTimeSeries/0.20.1)](https://pypi.org/project/fds.sdk.RealTimeTimeSeries/v/0.20.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.RealTimeTimeSeries==0.20.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.RealTimeTimeSeries==0.20.1
```
