...
**align_range** | **bool** | If set to &#x60;true&#x60;, the start and end of the range are truncated so that they are aligned to the selected &#x60;granularity&#x60;. | [optional]  if omitted the server will use the default value of False
