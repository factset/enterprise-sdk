# fds.sdk.FactSetQuantFactorLibrary.FactorsApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_factors**](FactorsApi.md#get_factors) | **GET** /factset-quant-factor-library/v1/factors | Retrieves Quant Factors for a small list of ids.
...
with fds.sdk.FactSetQuantFactorLibrary.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves Quant Factors for a small list of ids.
        api_response = api_instance.get_factors(ids, factors, start_date, end_date)
        pprint(api_response)
...
# **get_factors_for_list**
> FactorsResponse get_factors_for_list(factors_request)
...
with fds.sdk.FactSetQuantFactorLibrary.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = factors_api.FactorsApi(api_client)
    factors_request = FactorsRequest(
        ids=Ids(["FDS-US"]),
    ...
    ) # FactorsRequest | Request Body for requesting a list or group of Factors and ids.
    ...
    try:
        ...
        print("Exception when calling FactorsApi->get_factors_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **factors_request** | [**FactorsRequest**](FactorsRequest.md)| Request Body for requesting a list or group of Factors and ids. |
