...
from fds.sdk.FactSetQuantFactorLibrary import rest
from fds.sdk.FactSetQuantFactorLibrary.configuration import Configuration
from fds.sdk.FactSetQuantFactorLibrary.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetQuantFactorLibrary.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetQuantFactorLibrary/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FactorsApi()
        api_instance.get_factors  # this is an instance of the class Endpoint
        api_instance.get_factors()  # this invokes api_instance.get_factors.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_factors.callable or self.callable in this class
