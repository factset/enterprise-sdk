...
class FactorGroupsParam(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FactorGroupsParam - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): List of Factor Groupings to return all factors within the group. .  # noqa: E501

        Keyword Args:
            value ([str]): List of Factor Groupings to return all factors within the group. .  # noqa: E501
