...
class Factors(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_id, fsym_id, date, *args, **kwargs):  # noqa: E501
        """Factors - a model defined in OpenAPI
        ...
        Args:
            ...
            date (date): The as of date of the factors in YYYY-MM-DD format.
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, fsym_id, date, *args, **kwargs):  # noqa: E501
        """Factors - a model defined in OpenAPI
