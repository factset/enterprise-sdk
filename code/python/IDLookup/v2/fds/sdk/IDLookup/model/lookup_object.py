...
class LookupObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, search_text, datasets, *args, **kwargs):  # noqa: E501
        """LookupObject - a model defined in OpenAPI

        Args:
            search_text (str): The string or keyword being searched on.
            datasets (Datasets):
    ...
    @convert_js_args_to_python_args
    def __init__(self, search_text, datasets, *args, **kwargs):  # noqa: E501
        """LookupObject - a model defined in OpenAPI
