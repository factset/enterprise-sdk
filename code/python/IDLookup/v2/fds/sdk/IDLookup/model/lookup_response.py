...
def lazy_import():
    ...
    globals()['LookupResponseMeta'] = LookupResponseMeta
...
class LookupResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ResponseDetails],),  # noqa: E501
            'meta': (LookupResponseMeta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        ...
        Args:
            data ([ResponseDetails]): Array of Lookup details for the query
        ...
        Keyword Args:
            ...
            meta (LookupResponseMeta): [optional]  # noqa: E501
        """
