...
class LookupRequestMeta(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'limit_per_dataset': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        'limit_per_dataset': 'limitPerDataset',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LookupRequestMeta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            limit_per_dataset (int): Number of results to be returned by the search. The API returns only 5 results per dataset if the user specifies `limitPerDataset=5`.. [optional] if omitted the server will use the default value of 10  # noqa: E501
        """
