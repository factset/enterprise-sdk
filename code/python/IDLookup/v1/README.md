...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.IDLookup/0.23.0)](https://pypi.org/project/fds.sdk.IDLookup/v/0.23.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.IDLookup==0.23.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.IDLookup==0.23.0
```
