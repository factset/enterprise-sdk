...
from fds.sdk.IDLookup import rest
from fds.sdk.IDLookup.configuration import Configuration
from fds.sdk.IDLookup.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.IDLookup.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IDLookup/0.22.5 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FactSetIDLookupApi()
        api_instance.search_companyname  # this is an instance of the class Endpoint
        api_instance.search_companyname()  # this invokes api_instance.search_companyname.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.search_companyname.callable or self.callable in this class
