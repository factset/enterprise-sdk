...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.EventCalendar/0.20.12)](https://pypi.org/project/fds.sdk.EventCalendar/v/0.20.12)
...
```shell
poetry add fds.sdk.utils fds.sdk.EventCalendar==0.20.12
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.EventCalendar==0.20.12
```
