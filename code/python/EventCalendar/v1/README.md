...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.EventCalendar/0.21.1)](https://pypi.org/project/fds.sdk.EventCalendar/v/0.21.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.EventCalendar==0.21.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.EventCalendar==0.21.1
```
