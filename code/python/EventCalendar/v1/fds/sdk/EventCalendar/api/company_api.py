...
from fds.sdk.EventCalendar.api_client import ApiClient, Endpoint as _Endpoint
...
class CompanyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_company_event_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (CompanyEventResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 404: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
