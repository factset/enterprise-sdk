...
from fds.sdk.EventCalendar import rest
from fds.sdk.EventCalendar.configuration import Configuration
from fds.sdk.EventCalendar.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.EventCalendar.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/EventCalendar/0.20.12 ({platform.system()}, Python {platform.python_version()})'
