...
def lazy_import():
    ...
    globals()['ForwardPeriod'] = ForwardPeriod
    globals()['Frequency'] = Frequency
    globals()['Ids'] = Ids


class ForwardsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """ForwardsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            forward_period (ForwardPeriod): [optional]  # noqa: E501
            start_date (str): The start date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to latest available. . [optional]  # noqa: E501
            end_date (str): The end date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to latest available. . [optional]  # noqa: E501
