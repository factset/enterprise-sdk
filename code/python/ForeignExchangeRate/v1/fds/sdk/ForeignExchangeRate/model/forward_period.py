...
class ForwardPeriod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ForwardPeriod - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Bid, offer, and mid rates are available for the following 11 time periods.  * ON - Overnight  * TN - Tomorrow Next  * SW - One Week (Spot Week)  * 1M - One Month  * 2M - Two Months  * 3M - Three Months  * 6M - Six Months  * 9M - Nine Months  * 1Y - One Year  * 2Y - Two Years  * 5Y - Five Years . if omitted defaults to "1M", must be one of ["ON", "TN", "SW", "1M", "2M", "3M", "6M", "9M", "1Y", "2Y", "5Y", ]  # noqa: E501
