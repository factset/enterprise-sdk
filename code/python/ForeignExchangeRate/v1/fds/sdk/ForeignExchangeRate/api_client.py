...
from fds.sdk.ForeignExchangeRate import rest
from fds.sdk.ForeignExchangeRate.configuration import Configuration
from fds.sdk.ForeignExchangeRate.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ForeignExchangeRate.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ForeignExchangeRate/1.0.12 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ForwardsApi()
        api_instance.get_fx_forwards  # this is an instance of the class Endpoint
        api_instance.get_fx_forwards()  # this invokes api_instance.get_fx_forwards.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_fx_forwards.callable or self.callable in this class
