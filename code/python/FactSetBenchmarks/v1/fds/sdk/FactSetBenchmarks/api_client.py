...
from fds.sdk.FactSetBenchmarks import rest
from fds.sdk.FactSetBenchmarks.configuration import Configuration
from fds.sdk.FactSetBenchmarks.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetBenchmarks.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetBenchmarks/1.4.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BenchmarkConstituentsApi()
        api_instance.get_benchmark_constituents  # this is an instance of the class Endpoint
        api_instance.get_benchmark_constituents()  # this invokes api_instance.get_benchmark_constituents.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_benchmark_constituents.callable or self.callable in this class
