...
class HelperApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_benchmark_ids_endpoint = _Endpoint(
            settings={
                'response_type': (BenchmarkIdListResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def get_benchmark_ids(
        ...
        **kwargs
        ...
        >>> thread = api.get_benchmark_ids(async_req=True)
        >>> result = thread.get()
    ...
    def get_benchmark_ids_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_benchmark_ids_for_list(benchmark_id_list_request, async_req=True)
        >>> result = thread.get()
