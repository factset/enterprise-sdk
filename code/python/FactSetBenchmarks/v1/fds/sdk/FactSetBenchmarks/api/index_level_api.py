...
class IndexLevelApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_benchmark_ratios_endpoint = _Endpoint(
            settings={
                'response_type': (BenchmarkRatiosResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
        ...
        self.get_index_history_endpoint = _Endpoint(
            settings={
                'response_type': (IndexHistoryResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
        ...
        self.get_index_snapshot_endpoint = _Endpoint(
            settings={
                'response_type': (IndexSnapshotResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def get_benchmark_ratios(
        ...
        **kwargs
        ...
        >>> thread = api.get_benchmark_ratios(ids, metrics, async_req=True)
        >>> result = thread.get()
    ...
    def get_benchmark_ratios_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_benchmark_ratios_for_list(benchmark_ratios_request, async_req=True)
        >>> result = thread.get()
    ...
    def get_index_history(
        ...
        **kwargs
        ...
        >>> thread = api.get_index_history(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_index_history_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_index_history_for_list(index_history_request, async_req=True)
        >>> result = thread.get()
    ...
    def get_index_snapshot(
        ...
        **kwargs
        ...
        >>> thread = api.get_index_snapshot(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_index_snapshot_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_index_snapshot_for_list(index_snapshot_request, async_req=True)
        >>> result = thread.get()
