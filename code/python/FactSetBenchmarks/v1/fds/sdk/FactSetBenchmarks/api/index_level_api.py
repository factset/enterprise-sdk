...
class IndexLevelApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_index_returns_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (IndexReturnsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/factset-benchmarks/v1/index-returns',
                'operation_id': 'get_index_returns',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_index_returns_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (IndexReturnsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/factset-benchmarks/v1/index-returns',
                'operation_id': 'get_index_returns_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'index_returns_request',
                ],
                'required': [
                    'index_returns_request',
                ],
    ...
    def get_index_returns(
        ...
        **kwargs
        ...
        kwargs['end_date'] = \
            end_date
        return self.get_index_returns_endpoint.call_with_http_info(**kwargs)

    def get_index_returns_with_http_info(
        self,
        ids,
        start_date,
        end_date,
        **kwargs
    ) -> typing.Tuple[IndexReturnsResponse, int, typing.MutableMapping]:
        """Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters  # noqa: E501
    ...
    def get_index_returns_async(
        self,
        ids,
        start_date,
        end_date,
        **kwargs
    ) -> "ApplyResult[IndexReturnsResponse]":
        """Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters  # noqa: E501
    ...
    def get_index_returns_with_http_info_async(
        self,
        ids,
        start_date,
        end_date,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[IndexReturnsResponse, int, typing.MutableMapping]]":
        """Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(IndexReturnsResponse, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['ids'] = \
            ids
    ...
    def get_index_returns_for_list(
        self,
        index_returns_request,
        **kwargs
    ) -> IndexReturnsResponse:
        """Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via JSON Request body  # noqa: E501

        Returns aggregated (cumulative) index returns for each requested benchmark across the specified date range. Unlike `/index-history`, which provides full time-series data (prices, levels, constituents, and frequency-based observations), this endpoint is returns-focused and does not return a time series or support frequency parameters. Each benchmark produces a single cumulative return value for the entire date window, rather than a series of observations. The data is aligned with FactSet Benchmark Data Feed. Submit benchmark identifiers and a date range to retrieve cumulative return metrics for the period.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            index_returns_request (IndexReturnsRequest): Requests Index Returns for a list of identifiers and specified date range.
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['index_returns_request'] = \
            index_returns_request
        return self.get_index_returns_for_list_endpoint.call_with_http_info(**kwargs)

    def get_index_returns_for_list_with_http_info(
        self,
        index_returns_request,
        **kwargs
    ) -> typing.Tuple[IndexReturnsResponse, int, typing.MutableMapping]:
    ...
    def get_index_returns_for_list_async(
        self,
        index_returns_request,
        **kwargs
    ) -> "ApplyResult[IndexReturnsResponse]":
    ...
    def get_index_returns_for_list_with_http_info_async(
        self,
        index_returns_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[IndexReturnsResponse, int, typing.MutableMapping]]":
