...
def lazy_import():
    ...
    globals()['ConstituentIds'] = ConstituentIds


class BenchmarkConstituentsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """BenchmarkConstituentsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            date (str): Date of holding expressed in YYYY-MM-DD format.. [optional]  # noqa: E501
