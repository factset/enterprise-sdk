...
def lazy_import():
    ...
    globals()['HedgeType'] = HedgeType
    globals()['ImpliedDate'] = ImpliedDate
    globals()['IndexIds'] = IndexIds
    globals()['ReturnType'] = ReturnType


class IndexHistoryRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """IndexHistoryRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_date (str): Requested start date expressed in YYYY-MM-DD format.. [optional]  # noqa: E501
            end_date (str): Requested end date for Range expressed in YYYY-MM-DD format.. [optional]  # noqa: E501
            frequency (Frequency): [optional]  # noqa: E501
            return_type (ReturnType): [optional]  # noqa: E501
            hedge_type (HedgeType): [optional]  # noqa: E501
            currency (str): Currency for response. Currency code (ISO 4217). For a list of currency codes, see [OA Page 1470](https://my.apps.factset.com/oa/pages/1470).. [optional]  # noqa: E501
            ...
            implied_date (ImpliedDate): [optional]  # noqa: E501
        """
