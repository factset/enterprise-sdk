...
def lazy_import():
    ...
    globals()['FIConstituentIds'] = FIConstituentIds


class FixedIncomeBenchmarkConstituentsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ids': (FIConstituentIds,),  # noqa: E501
            'date': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """FixedIncomeBenchmarkConstituentsRequest - a model defined in OpenAPI

        Args:
            ids (FIConstituentIds):
