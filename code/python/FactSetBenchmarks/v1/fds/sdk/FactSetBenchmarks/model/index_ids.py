...
class IndexIds(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IndexIds - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Benchmark Identifiers. Reference the helper endpoint **/id-list** to get a sample list of  valid identifiers..  # noqa: E501

        Keyword Args:
            value ([str]): Benchmark Identifiers. Reference the helper endpoint **/id-list** to get a sample list of  valid identifiers..  # noqa: E501
