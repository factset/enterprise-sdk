...
class Calendar(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Calendar of data returned. SEVENDAY includes weekends.. if omitted defaults to "FIVEDAY", must be one of ["FIVEDAY", "SEVENDAY", ]  # noqa: E501

        Keyword Args:
            value (str): Calendar of data returned. SEVENDAY includes weekends.. if omitted defaults to "FIVEDAY", must be one of ["FIVEDAY", "SEVENDAY", ]  # noqa: E501
