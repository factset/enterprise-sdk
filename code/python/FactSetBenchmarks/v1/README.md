...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetBenchmarks/1.6.0)](https://pypi.org/project/fds.sdk.FactSetBenchmarks/v/1.6.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetBenchmarks==1.6.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetBenchmarks==1.6.0
```
...
*IndexLevelApi* | [**get_index_returns**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetBenchmarks/v1/docs/IndexLevelApi.md#get_index_returns) | **GET** /factset-benchmarks/v1/index-returns | Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters
*IndexLevelApi* | [**get_index_returns_for_list**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetBenchmarks/v1/docs/IndexLevelApi.md#get_index_returns_for_list) | **POST** /factset-benchmarks/v1/index-returns | Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via JSON Request body
...
## Documentation For Models
 ...
 - [IndexReturns](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetBenchmarks/v1/docs/IndexReturns.md)
 - [IndexReturnsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetBenchmarks/v1/docs/IndexReturnsRequest.md)
 - [IndexReturnsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetBenchmarks/v1/docs/IndexReturnsResponse.md)
