...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetBenchmarks/1.5.0)](https://pypi.org/project/fds.sdk.FactSetBenchmarks/v/1.5.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetBenchmarks==1.5.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetBenchmarks==1.5.0
```
