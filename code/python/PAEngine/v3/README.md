...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.PAEngine/3.0.0)](https://pypi.org/project/fds.sdk.PAEngine/v/3.0.0)
...
```shell
poetry add fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==3.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==3.0.0
```
