...
```shell
poetry add fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==0.21.11
```

### pip

```shell
pip install fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==0.21.11
```
