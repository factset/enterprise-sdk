...
```shell
poetry add fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==1.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==1.0.1
```
