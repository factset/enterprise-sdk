...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.PAEngine/2.2.1)](https://pypi.org/project/fds.sdk.PAEngine/v/2.2.1)
...
```shell
poetry add fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==2.2.1
```

### pip

```shell
pip install fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==2.2.1
```
