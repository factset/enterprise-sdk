...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.PAEngine/4.0.0)](https://pypi.org/project/fds.sdk.PAEngine/v/4.0.0)
...
```shell
poetry add fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==4.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.PAEngine==4.0.0
```
...
*CalendarApi* | [**get_pa_calendars**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/CalendarApi.md#get_pa_calendars) | **GET** /analytics/engines/pa/v3/calendars | Get PA calendars
...
*ConfigurationsApi* | [**get_pa_commentary_configurations**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/ConfigurationsApi.md#get_pa_commentary_configurations) | **GET** /analytics/engines/pa/v3/commentary/configurations | Get PA commentary configurations in a directory
...
## Documentation For Models
 ...
 - [PACalendar](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACalendar.md)
 - [PACalendarRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACalendarRoot.md)
 - [PACommentary](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACommentary.md)
 - [PACommentaryConfigurationSummary](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACommentaryConfigurationSummary.md)
 - [PACommentaryConfigurationSummaryRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACommentaryConfigurationSummaryRoot.md)
 ...
 - [PACommentaryParameters](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACommentaryParameters.md)
 - [PACommentaryParametersRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PAEngine/v3/docs/PACommentaryParametersRoot.md)
