...
[**generate_pa_portfolio_commentary**](PACalculationsApi.md#generate_pa_portfolio_commentary) | **POST** /analytics/engines/pa/v3/calculations/{id}/units/{unitId}/commentary | Generate PA portfolio commentary by calculation and unit id.
...
[**get_pa_portfolio_commentary_result_by_id**](PACalculationsApi.md#get_pa_portfolio_commentary_result_by_id) | **GET** /analytics/engines/pa/v3/calculations/{id}/units/{unitId}/commentary/result | Get PA Portfolio commentary result by calculation and unit id.
[**get_pa_portfolio_commentary_status_by_id**](PACalculationsApi.md#get_pa_portfolio_commentary_status_by_id) | **GET** /analytics/engines/pa/v3/calculations/{id}/units/{unitId}/commentary/status | Get PA portfolio commentary status by calculation and unit id.
...
> PACommentaryRoot generate_pa_portfolio_commentary(id, unit_id)
...
with fds.sdk.PAEngine.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PACalculationsApi->generate_pa_portfolio_commentary: %s\n" % e)
```
...
- **201**: [**PACommentaryRoot**](PACommentaryRoot.md)
- **202**: [**PACommentaryGetStatusRoot**](PACommentaryGetStatusRoot.md)
...
# **get_pa_portfolio_commentary_result_by_id**
> PACommentaryRoot get_pa_portfolio_commentary_result_by_id(id, unit_id)
...
with fds.sdk.PAEngine.ApiClient(configuration) as api_client:
    ...
    try:
        # Get PA Portfolio commentary result by calculation and unit id.
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_pa_portfolio_commentary_result_by_id(id, unit_id)

        pprint(api_response)

    except fds.sdk.PAEngine.ApiException as e:
        print("Exception when calling PACalculationsApi->get_pa_portfolio_commentary_result_by_id: %s\n" % e)
```
...
# **get_pa_portfolio_commentary_status_by_id**
> PACommentaryStatusRoot get_pa_portfolio_commentary_status_by_id(id, unit_id)
...
with fds.sdk.PAEngine.ApiClient(configuration) as api_client:
    ...
    try:
        # Get PA portfolio commentary status by calculation and unit id.
        # example passing only required values which don't have defaults set
        api_response_wrapper = api_instance.get_pa_portfolio_commentary_status_by_id(id, unit_id)
        ...
        print("Exception when calling PACalculationsApi->get_pa_portfolio_commentary_status_by_id: %s\n" % e)
```
...
The endpoint generates varying objects correlating with the successful status code, encapsulated within a response wrapper housing the appropriate object. The response wrapper includes the subsequent response types:
- **200**: [**PACommentaryStatusRoot**](PACommentaryStatusRoot.md)
- **202**: [**PACommentaryGetStatusRoot**](PACommentaryGetStatusRoot.md)
