# fds.sdk.PAEngine.GroupsApi

All URIs are relative to *https://api.factset.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_pa_grouping_frequencies**](GroupsApi.md#get_pa_grouping_frequencies) | **GET** /analytics/engines/pa/v3/grouping-frequencies | Get PA grouping frequencies
...
with fds.sdk.PAEngine.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GroupsApi->get_pa_grouping_frequencies: %s\n" % e)
```
