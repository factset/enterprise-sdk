...
from fds.sdk.PAEngine import rest
from fds.sdk.PAEngine.configuration import Configuration
from fds.sdk.PAEngine.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.PAEngine.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/PAEngine/2.2.1 ({platform.system()}, Python {platform.python_version()})'
