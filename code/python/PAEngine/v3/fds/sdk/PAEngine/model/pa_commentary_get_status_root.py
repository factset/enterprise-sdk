...
def lazy_import():
    ...
    globals()['PACommentaryGetStatus'] = PACommentaryGetStatus


class PACommentaryGetStatusRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PACommentaryGetStatus,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PACommentaryGetStatusRoot - a model defined in OpenAPI

        Args:
            data (PACommentaryGetStatus):
