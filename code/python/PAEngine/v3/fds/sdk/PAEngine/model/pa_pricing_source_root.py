...
def lazy_import():
    ...
    globals()['PAPricingSource'] = PAPricingSource


class PAPricingSourceRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ({str: (PAPricingSource,)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PAPricingSourceRoot - a model defined in OpenAPI

        Args:
            data ({str: (PAPricingSource,)}):
