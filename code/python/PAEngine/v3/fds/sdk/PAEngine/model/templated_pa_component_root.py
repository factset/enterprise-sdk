...
def lazy_import():
    ...
    globals()['TemplatedPAComponent'] = TemplatedPAComponent


class TemplatedPAComponentRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TemplatedPAComponent,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TemplatedPAComponentRoot - a model defined in OpenAPI

        Args:
            data (TemplatedPAComponent):
