...
def lazy_import():
    ...
    globals()['UnlinkedPATemplatePostSummary'] = UnlinkedPATemplatePostSummary


class UnlinkedPATemplatePostSummaryRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (UnlinkedPATemplatePostSummary,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """UnlinkedPATemplatePostSummaryRoot - a model defined in OpenAPI

        Args:
            data (UnlinkedPATemplatePostSummary):
