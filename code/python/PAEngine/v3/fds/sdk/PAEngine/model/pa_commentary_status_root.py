...
def lazy_import():
    ...
    globals()['PACommentaryStatus'] = PACommentaryStatus


class PACommentaryStatusRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PACommentaryStatus,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PACommentaryStatusRoot - a model defined in OpenAPI

        Args:
            data (PACommentaryStatus):
