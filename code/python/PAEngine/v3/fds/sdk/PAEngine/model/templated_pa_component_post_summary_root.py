...
def lazy_import():
    ...
    globals()['TemplatedPAComponentPostSummary'] = TemplatedPAComponentPostSummary


class TemplatedPAComponentPostSummaryRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TemplatedPAComponentPostSummary,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TemplatedPAComponentPostSummaryRoot - a model defined in OpenAPI

        Args:
            data (TemplatedPAComponentPostSummary):
