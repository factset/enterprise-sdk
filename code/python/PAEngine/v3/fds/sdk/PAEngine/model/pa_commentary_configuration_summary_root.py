...
def lazy_import():
    ...
    globals()['PACommentaryConfigurationSummary'] = PACommentaryConfigurationSummary


class PACommentaryConfigurationSummaryRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ({str: (PACommentaryConfigurationSummary,)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PACommentaryConfigurationSummaryRoot - a model defined in OpenAPI

        Args:
            data ({str: (PACommentaryConfigurationSummary,)}):
