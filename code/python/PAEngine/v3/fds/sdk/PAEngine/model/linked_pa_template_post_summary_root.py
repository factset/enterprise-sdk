...
def lazy_import():
    ...
    globals()['LinkedPATemplatePostSummary'] = LinkedPATemplatePostSummary
...
class LinkedPATemplatePostSummaryRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (LinkedPATemplatePostSummary,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """LinkedPATemplatePostSummaryRoot - a model defined in OpenAPI

        Args:
            data (LinkedPATemplatePostSummary):
