...
class ComponentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_pa_component_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (PAComponentRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_pa_component_by_id_with_http_info(
        ...
        id="782DA0A0C9CCCA9F80C2F3622FC1373AED30E1B7C1CF58F4677FE8C4C4901A53",
        **kwargs
    ) -> typing.Tuple[PAComponentRoot, int, typing.MutableMapping]:
        """Get PA component by id  # noqa: E501
    ...
    def get_pa_component_by_id_with_http_info_async(
        ...
        id="782DA0A0C9CCCA9F80C2F3622FC1373AED30E1B7C1CF58F4677FE8C4C4901A53",
        **kwargs
    ) -> "ApplyResult[typing.Tuple[PAComponentRoot, int, typing.MutableMapping]]":
        """Get PA component by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(PAComponentRoot, int, typing.Dict)]
        """
