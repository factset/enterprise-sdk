...
class GroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_pa_groups_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/lookups/v2/engines/pa/groups',
    ...
    def get_pa_groups_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[{str: (Group,)}, int, typing.MutableMapping]:
        """Get PA groups  # noqa: E501
    ...
    def get_pa_groups_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[{str: (Group,)}, int, typing.MutableMapping]]":
        """Get PA groups  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[({str: (Group,)}, int, typing.Dict)]
        """
