...
class ColumnsApi(object):
    ...
    def get_pa_column_by_id_with_http_info(
        ...
        id="2B729FA4EQAEA58B330055A5D064FC4FA32491DAF9D169C3DAD9793880F5",
        **kwargs
    ) -> typing.Tuple[Column, int, typing.MutableMapping]:
        """Get PA column settings  # noqa: E501
    ...
    def get_pa_column_by_id_with_http_info_async(
        ...
        id="2B729FA4EQAEA58B330055A5D064FC4FA32491DAF9D169C3DAD9793880F5",
        **kwargs
    ) -> "ApplyResult[typing.Tuple[Column, int, typing.MutableMapping]]":
        """Get PA column settings  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(Column, int, typing.Dict)]
        """
    ...
    def get_pa_columns_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[{str: (ColumnSummary,)}, int, typing.MutableMapping]:
        """Get PA columns  # noqa: E501
    ...
    def get_pa_columns_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[{str: (ColumnSummary,)}, int, typing.MutableMapping]]":
        """Get PA columns  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[({str: (ColumnSummary,)}, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_pa_columns_endpoint.call_with_http_info(**kwargs)
