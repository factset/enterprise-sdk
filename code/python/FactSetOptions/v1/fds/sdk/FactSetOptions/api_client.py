...
from fds.sdk.FactSetOptions import rest
from fds.sdk.FactSetOptions.configuration import Configuration
from fds.sdk.FactSetOptions.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetOptions.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetOptions/1.0.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = OptionChainsScreeningApi()
        api_instance.get_options_chains_for_list  # this is an instance of the class Endpoint
        api_instance.get_options_chains_for_list()  # this invokes api_instance.get_options_chains_for_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_options_chains_for_list.callable or self.callable in this class
