...
class ExchangeScreeningId(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ExchangeScreeningId - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Controls the Option Universe Screen By Exchange. Screening across all Exchanges is not currently supported. |Exchange ISO|Exchange Name|Option Types Covered|Price Type Used in Greeks| |---|---|---|---| |ALLUSA_OPTS|U.S. Exchange (Composite) - All Historical Options|Equity, Index|Mid Bid/Ask| |USA_OPTS|U.S. Exchange (Composite) - Latest 1 Year|Equity, Index|Mid Bid/Ask| . if omitted defaults to "USA_OPTS", must be one of ["ALLUSA_OPTS", "USA_OPTS", ]  # noqa: E501
