...
**open_interest** | **float** | The total number of options and/or futures contracts that are not closed or delivered on a particular day. | [optional] 
**volume** | **float** | Volume of the option | [optional] 
