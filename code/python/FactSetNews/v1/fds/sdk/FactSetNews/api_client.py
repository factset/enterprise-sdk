...
from fds.sdk.FactSetNews import rest
from fds.sdk.FactSetNews.configuration import Configuration
from fds.sdk.FactSetNews.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetNews.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetNews/1.0.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FiltersApi()
        api_instance.get_filters  # this is an instance of the class Endpoint
        api_instance.get_filters()  # this invokes api_instance.get_filters.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_filters.callable or self.callable in this class
