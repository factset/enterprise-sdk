...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetNews/1.0.1)](https://pypi.org/project/fds.sdk.FactSetNews/v/1.0.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetNews==1.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetNews==1.0.1
```
