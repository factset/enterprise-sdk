...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetNews/0.1.2)](https://pypi.org/project/fds.sdk.FactSetNews/v/0.1.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetNews==0.1.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetNews==0.1.2
```
