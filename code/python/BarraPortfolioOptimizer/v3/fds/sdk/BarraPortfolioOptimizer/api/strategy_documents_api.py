...
class StrategyDocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_barra_strategy_documents_endpoint = _Endpoint(
            settings={
                'response_type': (
    ...
    def get_barra_strategy_documents(
        self,
        ...
        **kwargs
        ...
        kwargs['path'] = \
            path
        return self.get_barra_strategy_documents_endpoint.call_with_http_info(**kwargs)

    def get_barra_strategy_documents_with_http_info(
        self,
        path="Client:folder1/folder2",
        **kwargs
    ...
    def get_barra_strategy_documents_async(
        self,
        path="Client:folder1/folder2",
        **kwargs
    ...
    def get_barra_strategy_documents_with_http_info_async(
        self,
        path="Client:folder1/folder2",
        **kwargs
