...
from fds.sdk.FactSetPrivateEquityandVentureCapital import rest
from fds.sdk.FactSetPrivateEquityandVentureCapital.configuration import Configuration
from fds.sdk.FactSetPrivateEquityandVentureCapital.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPrivateEquityandVentureCapital.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetPrivateEquityandVentureCapital/1.0.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FundsApi()
        api_instance.get_fund  # this is an instance of the class Endpoint
        api_instance.get_fund()  # this invokes api_instance.get_fund.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_fund.callable or self.callable in this class
