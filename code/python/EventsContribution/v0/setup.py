...
NAME = "fds.sdk.EventsContribution"
VERSION = "0.20.3"
...
setup(
    name=NAME,
    version=VERSION,
    description="Events Contribution client library for Python",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/main/code/python/EventsContribution/v0",
