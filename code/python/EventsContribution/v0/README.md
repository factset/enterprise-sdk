...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.EventsContribution/0.21.0)](https://pypi.org/project/fds.sdk.EventsContribution/v/0.21.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.EventsContribution==0.21.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.EventsContribution==0.21.0
```
