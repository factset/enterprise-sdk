...
from fds.sdk.EventsContribution import rest
from fds.sdk.EventsContribution.configuration import Configuration
from fds.sdk.EventsContribution.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.EventsContribution.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/EventsContribution/0.20.5 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EventsContributionApi()
        api_instance.delete_event  # this is an instance of the class Endpoint
        api_instance.delete_event()  # this invokes api_instance.delete_event.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_event.callable or self.callable in this class
