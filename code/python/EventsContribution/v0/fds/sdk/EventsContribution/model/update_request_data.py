...
def lazy_import():
    ...
    globals()['EventUpdateData'] = EventUpdateData


class UpdateRequestData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'event_data': (EventUpdateData,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_data, *args, **kwargs):  # noqa: E501
        """UpdateRequestData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_data, *args, **kwargs):  # noqa: E501
        """UpdateRequestData - a model defined in OpenAPI
