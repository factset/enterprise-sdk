...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ProcuretoPayAPISCIM/0.23.1)](https://pypi.org/project/fds.sdk.ProcuretoPayAPISCIM/v/0.23.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.ProcuretoPayAPISCIM==0.23.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ProcuretoPayAPISCIM==0.23.1
```
