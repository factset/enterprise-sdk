...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ProcuretoPayAPISCIM/0.25.0)](https://pypi.org/project/fds.sdk.ProcuretoPayAPISCIM/v/0.25.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.ProcuretoPayAPISCIM==0.25.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ProcuretoPayAPISCIM==0.25.0
```
...
## Documentation For Models
 ...
 - [ErrorUrnScimSchemasExtensionFactSetCore10Error](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/ProcuretoPayAPISCIM/v2/docs/ErrorUrnScimSchemasExtensionFactSetCore10Error.md)
 ...
 - [GroupResourceUrnScimSchemasExtensionFactSetCore10Group](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/ProcuretoPayAPISCIM/v2/docs/GroupResourceUrnScimSchemasExtensionFactSetCore10Group.md)
