...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/ProcuretoPayAPISCIM/0.22.10'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FileManagerAuditApi()
        api_instance.file_manager_audit_get  # this is an instance of the class Endpoint
        api_instance.file_manager_audit_get()  # this invokes api_instance.file_manager_audit_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.file_manager_audit_get.callable or self.callable in this class
