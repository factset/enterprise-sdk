...
from fds.sdk.ProcuretoPayAPISCIM import rest
from fds.sdk.ProcuretoPayAPISCIM.configuration import Configuration
from fds.sdk.ProcuretoPayAPISCIM.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ProcuretoPayAPISCIM.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ProcuretoPayAPISCIM/0.23.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FederationsApi()
        api_instance.get_federation  # this is an instance of the class Endpoint
        api_instance.get_federation()  # this invokes api_instance.get_federation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_federation.callable or self.callable in this class
