...
class SchemasApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_schema_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (Schema,), 401: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_schemas_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SchemaList,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_schema(
        ...
        **kwargs
        ...
        Get a specific schema. See RFC 7643 section 7.  # noqa: E501
    ...
    def get_schema_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def get_schemas(
        ...
        **kwargs
        ...
        Get a list of supported resource schemas. See RFC 7644 section 4.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_schemas_with_http_info_async(
        self,
        **kwargs
