...
class ServiceProviderConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_service_provider_config_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ServiceProviderConfig,), 401: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_service_provider_config(
        ...
        **kwargs
        ...
        Get service provider configuration, which describes the SCIM specification features available. See RFC 7644 section 4.  # noqa: E501
    ...
    def get_service_provider_config_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[ServiceProviderConfig, int, typing.MutableMapping]:
        """Get service provider configuration.  # noqa: E501
    ...
    def get_service_provider_config_async(
        self,
        **kwargs
    ) -> "ApplyResult[ServiceProviderConfig]":
        """Get service provider configuration.  # noqa: E501
    ...
    def get_service_provider_config_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[ServiceProviderConfig, int, typing.MutableMapping]]":
        """Get service provider configuration.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(ServiceProviderConfig, int, typing.Dict)]
        """
