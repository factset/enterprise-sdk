...
class UserPositionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_user_position_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UserPositionResource,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/UserPositions/{id}',
                'operation_id': 'get_user_position',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_user_positions_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UserPositionResourceList,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/UserPositions',
                'operation_id': 'get_user_positions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_user_position(
        ...
        **kwargs
        ...
        """Get a user position.  # noqa: E501

        Get a specific user position resource.  # noqa: E501
        ...
        kwargs['id'] = \
            id
        return self.get_user_position_endpoint.call_with_http_info(**kwargs)

    def get_user_position_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[UserPositionResource, int, typing.MutableMapping]:
        """Get a user position.  # noqa: E501
    ...
    def get_user_position_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[UserPositionResource]":
        """Get a user position.  # noqa: E501
    ...
    def get_user_position_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UserPositionResource, int, typing.MutableMapping]]":
        """Get a user position.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(UserPositionResource, int, typing.Dict)]
        """
    ...
    def get_user_positions(
        ...
        **kwargs
        ...
        """Get a list of user positions.  # noqa: E501

        Get a list of user position resources.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        return self.get_user_positions_endpoint.call_with_http_info(**kwargs)

    def get_user_positions_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[UserPositionResourceList, int, typing.MutableMapping]:
        """Get a list of user positions.  # noqa: E501
    ...
    def get_user_positions_async(
        self,
        **kwargs
    ) -> "ApplyResult[UserPositionResourceList]":
        """Get a list of user positions.  # noqa: E501
    ...
    def get_user_positions_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UserPositionResourceList, int, typing.MutableMapping]]":
        """Get a list of user positions.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(UserPositionResourceList, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_user_positions_endpoint.call_with_http_info(**kwargs)
