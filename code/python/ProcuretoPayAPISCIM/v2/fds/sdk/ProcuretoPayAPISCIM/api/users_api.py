...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_user_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 201: (UserResource,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_user_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UserResource,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_users_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UserResourceList,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.modify_user_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UserResource,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,), 501: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.replace_user_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UserResource,), 400: (Error,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def create_user(
        ...
        **kwargs
        ...
        Create a user resource.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            user_resource (UserResource): User resource.
    ...
    def create_user_with_http_info(
        ...
        user_resource,
        **kwargs
    ) -> typing.Tuple[UserResource, int, typing.MutableMapping]:
        """Create a user.  # noqa: E501
    ...
    def create_user_with_http_info_async(
        ...
        user_resource,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UserResource, int, typing.MutableMapping]]":
        """Create a user.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(UserResource, int, typing.Dict)]
        """
    ...
    def delete_user(
        ...
        **kwargs
        ...
        Delete a specific user resource.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_user(
        ...
        **kwargs
        ...
        Get a specific user resource.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_user_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UserResource, int, typing.MutableMapping]]":
    ...
    def get_users(
        ...
        **kwargs
        ...
        Get a list of user resources.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_users_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[UserResourceList, int, typing.MutableMapping]:
        """Get a list of users.  # noqa: E501
    ...
    def get_users_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UserResourceList, int, typing.MutableMapping]]":
        """Get a list of users.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(UserResourceList, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_users_endpoint.call_with_http_info(**kwargs)
    ...
    def modify_user(
        ...
        **kwargs
        ...
        Modify a specific user resource (i.e. add, replace, or remove attributes of a user resource.)  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        kwargs['id'] = \
            id
        return self.modify_user_endpoint.call_with_http_info(**kwargs)
    ...
    def modify_user_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UserResource, int, typing.MutableMapping]]":
    ...
    def replace_user(
        ...
        **kwargs
        ...
        Replace a specific user resource with another provided user resource.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def replace_user_with_http_info_async(
        self,
        id,
        user_resource,
        **kwargs
