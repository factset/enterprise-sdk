...
class ProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_product_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ProductResource,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_products_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ProductResourceList,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_product(
        ...
        **kwargs
        ...
        Get a specific product resource.  # noqa: E501
    ...
    def get_product_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def get_products(
        ...
        **kwargs
        ...
        Get a list of product resources.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
