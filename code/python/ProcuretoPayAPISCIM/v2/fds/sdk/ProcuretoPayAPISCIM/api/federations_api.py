...
class FederationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_federation_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FederationResource,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/Federations/{id}',
                'operation_id': 'get_federation',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_federations_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FederationResourceList,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/Federations',
                'operation_id': 'get_federations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.modify_federation_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FederationResource,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/Federations/{id}',
                'operation_id': 'modify_federation',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.replace_federation_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FederationResource,), 400: (Error,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/Federations/{id}',
                'operation_id': 'replace_federation',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def get_federation(
        ...
        **kwargs
        ...
        """Get a federation.  # noqa: E501

        Get a specific federation resource.  # noqa: E501
        ...
        kwargs['id'] = \
            id
        return self.get_federation_endpoint.call_with_http_info(**kwargs)

    def get_federation_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[FederationResource, int, typing.MutableMapping]:
        """Get a federation.  # noqa: E501
    ...
    def get_federation_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[FederationResource]":
        """Get a federation.  # noqa: E501
    ...
    def get_federation_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FederationResource, int, typing.MutableMapping]]":
        """Get a federation.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(FederationResource, int, typing.Dict)]
        """
    ...
    def get_federations(
        ...
        **kwargs
        ...
        """Get a list of federations.  # noqa: E501

        Get a list of federation resources.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        return self.get_federations_endpoint.call_with_http_info(**kwargs)

    def get_federations_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[FederationResourceList, int, typing.MutableMapping]:
        """Get a list of federations.  # noqa: E501
    ...
    def get_federations_async(
        self,
        **kwargs
    ) -> "ApplyResult[FederationResourceList]":
        """Get a list of federations.  # noqa: E501
    ...
    def get_federations_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FederationResourceList, int, typing.MutableMapping]]":
        """Get a list of federations.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(FederationResourceList, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_federations_endpoint.call_with_http_info(**kwargs)


    def modify_federation(
        self,
        id,
        **kwargs
    ) -> FederationResource:
        """Patch a federation.  # noqa: E501

        Modify a specific federation resource (i.e. add, replace, or remove attributes of a federation resource.)  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        kwargs['id'] = \
            id
        return self.modify_federation_endpoint.call_with_http_info(**kwargs)

    def modify_federation_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[FederationResource, int, typing.MutableMapping]:
    ...
    def modify_federation_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FederationResource, int, typing.MutableMapping]]":
    ...
    def replace_federation(
        self,
        id,
        federation_resource,
        **kwargs
    ) -> FederationResource:
        """Replace a federation.  # noqa: E501

        Replace a specific federation resource with another provided federation resource.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            id (str): ID of resource.
            federation_resource (FederationResource): Federation resource.
        ...
        kwargs['id'] = \
            id
        kwargs['federation_resource'] = \
            federation_resource
        return self.replace_federation_endpoint.call_with_http_info(**kwargs)

    def replace_federation_with_http_info(
        self,
        id,
        federation_resource,
        **kwargs
    ...
    def replace_federation_with_http_info_async(
        self,
        id,
        federation_resource,
        **kwargs
