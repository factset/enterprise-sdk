...
class FirmDescriptionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.firm_descriptions_get_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FirmDescriptionResourceList,), 400: (Error,), 401: (Error,), 403: (Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'operation_id': 'firm_descriptions_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.firm_descriptions_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FirmDescriptionResource,), 401: (Error,), 403: (Error,), 404: (Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'operation_id': 'firm_descriptions_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def firm_descriptions_get(
        ...
        **kwargs
        ...
        return self.firm_descriptions_get_endpoint.call_with_http_info(**kwargs)

    def firm_descriptions_get_with_http_info(
        self,
        **kwargs
    ...
    def firm_descriptions_get_async(
        self,
        **kwargs
    ...
    def firm_descriptions_get_with_http_info_async(
        self,
        **kwargs
    ...
    def firm_descriptions_id_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.firm_descriptions_id_get_endpoint.call_with_http_info(**kwargs)

    def firm_descriptions_id_get_with_http_info(
        self,
        id,
        **kwargs
    ...
    def firm_descriptions_id_get_async(
        self,
        id,
        **kwargs
    ...
    def firm_descriptions_id_get_with_http_info_async(
        self,
        id,
        **kwargs
