...
class FirmDescriptionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_firm_description_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FirmDescriptionResource,), 401: (Error,), 403: (Error,), 404: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/FirmDescriptions/{id}',
                'operation_id': 'get_firm_description',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_firm_descriptions_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FirmDescriptionResourceList,), 400: (Error,), 401: (Error,), 403: (Error,), 429: (InlineResponse429,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/FirmDescriptions',
                'operation_id': 'get_firm_descriptions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_firm_description(
        self,
        id,
        **kwargs
    ) -> FirmDescriptionResource:
        """Get a firm description.  # noqa: E501

        Get a specific firm description resource.  # noqa: E501
        ...
        kwargs['id'] = \
            id
        return self.get_firm_description_endpoint.call_with_http_info(**kwargs)

    def get_firm_description_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[FirmDescriptionResource, int, typing.MutableMapping]:
        """Get a firm description.  # noqa: E501
    ...
    def get_firm_description_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[FirmDescriptionResource]":
        """Get a firm description.  # noqa: E501
    ...
    def get_firm_description_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FirmDescriptionResource, int, typing.MutableMapping]]":
        """Get a firm description.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(FirmDescriptionResource, int, typing.Dict)]
        """
    ...
    def get_firm_descriptions(
        self,
        **kwargs
    ) -> FirmDescriptionResourceList:
        """Get a list of firm descriptions.  # noqa: E501

        Get a list of firm description resources.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        return self.get_firm_descriptions_endpoint.call_with_http_info(**kwargs)

    def get_firm_descriptions_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[FirmDescriptionResourceList, int, typing.MutableMapping]:
        """Get a list of firm descriptions.  # noqa: E501
    ...
    def get_firm_descriptions_async(
        self,
        **kwargs
    ) -> "ApplyResult[FirmDescriptionResourceList]":
        """Get a list of firm descriptions.  # noqa: E501
    ...
    def get_firm_descriptions_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FirmDescriptionResourceList, int, typing.MutableMapping]]":
        """Get a list of firm descriptions.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(FirmDescriptionResourceList, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_firm_descriptions_endpoint.call_with_http_info(**kwargs)
