...
class UserResourceUrnScimSchemasExtensionFactSetVRS10UserTenancies(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """UserResourceUrnScimSchemasExtensionFactSetVRS10UserTenancies - a model defined in OpenAPI

        Args:
            value (str): Name of a tenant.
