...
------------- | ------------- | -------------
[**user_positions_get**](UserPositionsApi.md#user_positions_get) | **GET** /UserPositions | Get a list of user positions.
[**user_positions_id_get**](UserPositionsApi.md#user_positions_id_get) | **GET** /UserPositions/{id} | Get a user position.



# **user_positions_get**
> UserPositionResourceList user_positions_get()
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.user_positions_get(filter=filter, start_index=start_index, count=count, attributes=attributes, excluded_attributes=excluded_attributes)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling UserPositionsApi->user_positions_get: %s\n" % e)
```
...
# **user_positions_id_get**
> UserPositionResource user_positions_id_get(id)
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a user position.
        # example passing only required values which don't have defaults set
        api_response = api_instance.user_positions_id_get(id)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling UserPositionsApi->user_positions_id_get: %s\n" % e)
```
