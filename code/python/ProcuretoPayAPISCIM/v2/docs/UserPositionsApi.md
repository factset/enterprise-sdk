# fds.sdk.ProcuretoPayAPISCIM.UserPositionsApi

All URIs are relative to *https://api.factset.com/scim/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_user_position**](UserPositionsApi.md#get_user_position) | **GET** /UserPositions/{id} | Get a user position.
[**get_user_positions**](UserPositionsApi.md#get_user_positions) | **GET** /UserPositions | Get a list of user positions.



# **get_user_position**
> UserPositionResource get_user_position(id)
...
from fds.sdk.ProcuretoPayAPISCIM.api import user_positions_api
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    api_instance = user_positions_api.UserPositionsApi(api_client)
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_user_position(id, attributes=attributes, excluded_attributes=excluded_attributes, additional_attributes=additional_attributes)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling UserPositionsApi->get_user_position: %s\n" % e)
```
...
# **get_user_positions**
> UserPositionResourceList get_user_positions()
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_user_positions(filter=filter, sort_by=sort_by, sort_order=sort_order, start_index=start_index, count=count, attributes=attributes, excluded_attributes=excluded_attributes, additional_attributes=additional_attributes)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling UserPositionsApi->get_user_positions: %s\n" % e)
```
