...
------------- | ------------- | -------------
[**get_schema**](SchemasApi.md#get_schema) | **GET** /Schemas/{id} | Get a schema.
[**get_schemas**](SchemasApi.md#get_schemas) | **GET** /Schemas | Get a list of schemas.
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_schemas(start_index=start_index, count=count)
