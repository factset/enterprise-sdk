...
------------- | ------------- | -------------
[**firm_descriptions_get**](FirmDescriptionsApi.md#firm_descriptions_get) | **GET** /FirmDescriptions | Get a list of firm descriptions.
[**firm_descriptions_id_get**](FirmDescriptionsApi.md#firm_descriptions_id_get) | **GET** /FirmDescriptions/{id} | Get a firm description.



# **firm_descriptions_get**
> FirmDescriptionResourceList firm_descriptions_get()
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.firm_descriptions_get(filter=filter, start_index=start_index, count=count, attributes=attributes, excluded_attributes=excluded_attributes)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling FirmDescriptionsApi->firm_descriptions_get: %s\n" % e)
```
...
# **firm_descriptions_id_get**
> FirmDescriptionResource firm_descriptions_id_get(id)
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a firm description.
        # example passing only required values which don't have defaults set
        api_response = api_instance.firm_descriptions_id_get(id)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling FirmDescriptionsApi->firm_descriptions_id_get: %s\n" % e)
```
