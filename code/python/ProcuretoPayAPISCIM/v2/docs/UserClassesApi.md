...
------------- | ------------- | -------------
[**get_user_class**](UserClassesApi.md#get_user_class) | **GET** /UserClasses/{id} | Get a user class.
[**get_user_classes**](UserClassesApi.md#get_user_classes) | **GET** /UserClasses | Get a list of user classes.



# **get_user_class**
> UserClassResource get_user_class(id)
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_user_class(id, attributes=attributes, excluded_attributes=excluded_attributes, additional_attributes=additional_attributes)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling UserClassesApi->get_user_class: %s\n" % e)
```
...
# **get_user_classes**
> UserClassResourceList get_user_classes()
...
with fds.sdk.ProcuretoPayAPISCIM.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_user_classes(filter=filter, sort_by=sort_by, sort_order=sort_order, start_index=start_index, count=count, attributes=attributes, excluded_attributes=excluded_attributes, additional_attributes=additional_attributes)

        pprint(api_response)

    except fds.sdk.ProcuretoPayAPISCIM.ApiException as e:
        print("Exception when calling UserClassesApi->get_user_classes: %s\n" % e)
```
