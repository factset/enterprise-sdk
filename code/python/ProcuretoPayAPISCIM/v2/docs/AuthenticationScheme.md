...
------------ | ------------- | ------------- | -------------
**type** | **str** | The authentication scheme. | [readonly] 
**name** | **str** | The common authentication scheme name, e.g., HTTP Basic. | [readonly] 
**description** | **str** | A description of the authentication scheme. | [readonly] 
