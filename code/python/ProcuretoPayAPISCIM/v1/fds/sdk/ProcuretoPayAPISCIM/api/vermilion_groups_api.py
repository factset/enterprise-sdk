...
class VermilionGroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.vermilion_groups_get_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (VermilionGroupResource,), 400: (Error,), 401: (Error,), 403: (Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/VermilionGroups',
                'operation_id': 'vermilion_groups_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.vermilion_groups_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (VermilionGroupResource,), 401: (Error,), 403: (Error,), 404: (Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/VermilionGroups/{id}',
                'operation_id': 'vermilion_groups_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.vermilion_groups_id_patch_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/VermilionGroups/{id}',
                'operation_id': 'vermilion_groups_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.vermilion_groups_id_put_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (VermilionGroupResource,), 400: (Error,), 401: (Error,), 403: (Error,), 404: (Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/VermilionGroups/{id}',
                'operation_id': 'vermilion_groups_id_put',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def vermilion_groups_get(
        ...
        **kwargs
        ...
        """Get a list of Vermilion groups.  # noqa: E501
    ...
    def vermilion_groups_get_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[VermilionGroupResource, int, typing.MutableMapping]:
        """Get a list of Vermilion groups.  # noqa: E501
    ...
    def vermilion_groups_get_async(
        self,
        **kwargs
    ) -> "ApplyResult[VermilionGroupResource]":
        """Get a list of Vermilion groups.  # noqa: E501
    ...
    def vermilion_groups_get_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[VermilionGroupResource, int, typing.MutableMapping]]":
        """Get a list of Vermilion groups.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(VermilionGroupResource, int, typing.Dict)]
        """
    ...
    def vermilion_groups_id_get(
        ...
        **kwargs
        ...
        """Get a Vermilion group.  # noqa: E501
    ...
    def vermilion_groups_id_get_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[VermilionGroupResource, int, typing.MutableMapping]:
    ...
    def vermilion_groups_id_get_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[VermilionGroupResource]":
    ...
    def vermilion_groups_id_get_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[VermilionGroupResource, int, typing.MutableMapping]]":
    ...
    def vermilion_groups_id_patch(
        ...
        **kwargs
        ...
        """Patch a Vermilion group (add, replace, or remove attributes of a Vermilion group.)  # noqa: E501
    ...
    def vermilion_groups_id_patch_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[VermilionGroupResource, int, typing.MutableMapping]:
    ...
    def vermilion_groups_id_patch_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[VermilionGroupResource]":
    ...
    def vermilion_groups_id_patch_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[VermilionGroupResource, int, typing.MutableMapping]]":
    ...
    def vermilion_groups_id_put(
        ...
        **kwargs
        ...
        """Replace a Vermilion group.  # noqa: E501

        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            id (str): ID of resource.
            vermilion_group_resource (VermilionGroupResource): Vermilion group resource.
    ...
    def vermilion_groups_id_put_with_http_info(
        self,
        id,
        vermilion_group_resource,
        **kwargs
    ...
    def vermilion_groups_id_put_async(
        self,
        id,
        vermilion_group_resource,
        **kwargs
    ...
    def vermilion_groups_id_put_with_http_info_async(
        self,
        id,
        vermilion_group_resource,
        **kwargs
