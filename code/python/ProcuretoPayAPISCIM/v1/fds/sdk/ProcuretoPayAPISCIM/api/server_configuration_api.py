...
class ServerConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.service_provider_config_get_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ServiceProviderConfig,), 401: (Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'operation_id': 'service_provider_config_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def service_provider_config_get_with_http_info(
        self,
        **kwargs
    ...
    def service_provider_config_get_async(
        self,
        **kwargs
    ...
    def service_provider_config_get_with_http_info_async(
        self,
        **kwargs
