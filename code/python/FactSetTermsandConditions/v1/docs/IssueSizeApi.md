# fds.sdk.FactSetTermsandConditions.IssueSizeApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_issue_size**](IssueSizeApi.md#get_issue_size) | **GET** /factset-terms-and-conditions/v1/issue-size | Return Issue Size data for a list of Fixed Income securities.
...
with fds.sdk.FactSetTermsandConditions.ApiClient(configuration) as api_client:
    ...
    api_instance = issue_size_api.IssueSizeApi(api_client)
    ...
    try:
        ...
        print("Exception when calling IssueSizeApi->get_issue_size: %s\n" % e)
```
...
# **get_issue_size_for_list**
> IssueSizeResponse get_issue_size_for_list(terms_and_conditions_scalar_request)
...
with fds.sdk.FactSetTermsandConditions.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling IssueSizeApi->get_issue_size_for_list: %s\n" % e)
```
