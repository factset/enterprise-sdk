...
class CouponsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_coupon_history_endpoint = _Endpoint(
            settings={
                'response_type': (CouponHistoryResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
        ...
        self.get_coupon_schedules_endpoint = _Endpoint(
            settings={
                'response_type': (CouponSchedulesResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def get_coupon_history(
        ...
        **kwargs
        ...
        >>> thread = api.get_coupon_history(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_coupon_history_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_coupon_history_for_list(terms_and_conditions_scalar_request, async_req=True)
        >>> result = thread.get()
    ...
    def get_coupon_schedules(
        ...
        **kwargs
        ...
        >>> thread = api.get_coupon_schedules(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_coupon_schedules_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_coupon_schedules_for_list(terms_and_conditions_scalar_request, async_req=True)
        >>> result = thread.get()
