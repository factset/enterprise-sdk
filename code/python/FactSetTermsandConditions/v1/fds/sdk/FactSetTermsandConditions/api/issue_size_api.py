...
class IssueSizeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_issue_size_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (IssueSizeResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_issue_size_with_http_info(
        self,
        ids,
        **kwargs
    ) -> typing.Tuple[IssueSizeResponse, int, typing.MutableMapping]:
        """Return Issue Size data for a list of Fixed Income securities.  # noqa: E501
    ...
    def get_issue_size_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[IssueSizeResponse]":
        """Return Issue Size data for a list of Fixed Income securities.  # noqa: E501
    ...
    def get_issue_size_with_http_info_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[IssueSizeResponse, int, typing.MutableMapping]]":
        """Return Issue Size data for a list of Fixed Income securities.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(IssueSizeResponse, int, typing.Dict)]
        """
    ...
    def get_issue_size_for_list_with_http_info(
        self,
        terms_and_conditions_scalar_request,
        **kwargs
    ) -> typing.Tuple[IssueSizeResponse, int, typing.MutableMapping]:
    ...
    def get_issue_size_for_list_async(
        self,
        terms_and_conditions_scalar_request,
        **kwargs
    ) -> "ApplyResult[IssueSizeResponse]":
    ...
    def get_issue_size_for_list_with_http_info_async(
        self,
        terms_and_conditions_scalar_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[IssueSizeResponse, int, typing.MutableMapping]]":
