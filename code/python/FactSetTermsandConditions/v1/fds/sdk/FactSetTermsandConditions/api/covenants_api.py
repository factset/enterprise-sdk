...
class CovenantsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_covenant_details_endpoint = _Endpoint(
            settings={
                'response_type': (CovenantDetailsResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def get_covenant_details(
        ...
        **kwargs
        ...
        >>> thread = api.get_covenant_details(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_covenant_details_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_covenant_details_for_list(terms_and_conditions_scalar_request, async_req=True)
        >>> result = thread.get()
