...
from fds.sdk.FactSetTermsandConditions import rest
from fds.sdk.FactSetTermsandConditions.configuration import Configuration
from fds.sdk.FactSetTermsandConditions.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetTermsandConditions.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetTermsandConditions/1.0.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_agents  # this is an instance of the class Endpoint
        api_instance.get_agents()  # this invokes api_instance.get_agents.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_agents.callable or self.callable in this class
