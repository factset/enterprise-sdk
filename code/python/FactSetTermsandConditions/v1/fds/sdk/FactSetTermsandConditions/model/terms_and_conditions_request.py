...
class TermsAndConditionsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """TermsAndConditionsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fields ([str]): List of Terms and Conditions data items.. [optional]  # noqa: E501
            categories ([str]): Selects the Fixed Income metrics by major category - * **SECURITY_DETAILS** = Detailed information about the security. * **COUPON_DETAILS** = Coupon details. * **CONVERTIBLE_FEATURES** = Features of convertible instruments. * **REDEMPTION_OPTIONS** = Redemption options. . [optional]  # noqa: E501
        """
