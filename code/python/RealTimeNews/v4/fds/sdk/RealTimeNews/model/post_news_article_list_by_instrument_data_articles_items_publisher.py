...
class PostNewsArticleListByInstrumentDataArticlesItemsPublisher(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentDataArticlesItemsPublisher - a model defined in OpenAPI
