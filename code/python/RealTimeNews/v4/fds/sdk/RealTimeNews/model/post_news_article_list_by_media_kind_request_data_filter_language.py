...
class PostNewsArticleListByMediaKindRequestDataFilterLanguage(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByMediaKindRequestDataFilterLanguage - a model defined in OpenAPI
