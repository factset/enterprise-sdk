...
class PostNewsArticleListByMediaKindRequestDataFilterPublisher(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByMediaKindRequestDataFilterPublisher - a model defined in OpenAPI
