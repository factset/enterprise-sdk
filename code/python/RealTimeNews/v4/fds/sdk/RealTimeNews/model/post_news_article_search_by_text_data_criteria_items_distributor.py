...
class PostNewsArticleSearchByTextDataCriteriaItemsDistributor(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleSearchByTextDataCriteriaItemsDistributor - a model defined in OpenAPI
