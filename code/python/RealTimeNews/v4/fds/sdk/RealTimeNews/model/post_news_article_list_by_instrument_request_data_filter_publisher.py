...
class PostNewsArticleListByInstrumentRequestDataFilterPublisher(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentRequestDataFilterPublisher - a model defined in OpenAPI
