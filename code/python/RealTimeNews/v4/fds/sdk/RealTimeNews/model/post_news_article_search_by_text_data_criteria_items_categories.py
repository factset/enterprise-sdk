...
class PostNewsArticleSearchByTextDataCriteriaItemsCategories(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleSearchByTextDataCriteriaItemsCategories - a model defined in OpenAPI
