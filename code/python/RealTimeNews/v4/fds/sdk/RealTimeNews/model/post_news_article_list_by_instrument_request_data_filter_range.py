...
class PostNewsArticleListByInstrumentRequestDataFilterRange(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentRequestDataFilterRange - a model defined in OpenAPI
