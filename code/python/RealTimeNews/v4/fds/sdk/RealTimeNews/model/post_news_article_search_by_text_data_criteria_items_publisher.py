...
class PostNewsArticleSearchByTextDataCriteriaItemsPublisher(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleSearchByTextDataCriteriaItemsPublisher - a model defined in OpenAPI
