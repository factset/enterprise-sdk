...
class PostNewsArticleListByMediaKindRequestDataFilterDistributor(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByMediaKindRequestDataFilterDistributor - a model defined in OpenAPI
