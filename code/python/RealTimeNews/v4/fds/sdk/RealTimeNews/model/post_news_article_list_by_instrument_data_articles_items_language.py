...
class PostNewsArticleListByInstrumentDataArticlesItemsLanguage(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentDataArticlesItemsLanguage - a model defined in OpenAPI
