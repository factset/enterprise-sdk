...
class PostNewsArticleListByInstrumentDataArticlesCategoriesItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentDataArticlesCategoriesItems - a model defined in OpenAPI
