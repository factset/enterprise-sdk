...
class PostNewsArticleListByInstrumentRequestDataFilterCategories(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentRequestDataFilterCategories - a model defined in OpenAPI
