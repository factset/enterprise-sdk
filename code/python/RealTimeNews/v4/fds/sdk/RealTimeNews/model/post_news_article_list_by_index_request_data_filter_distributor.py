...
class PostNewsArticleListByIndexRequestDataFilterDistributor(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByIndexRequestDataFilterDistributor - a model defined in OpenAPI
