...
class PostNewsArticleListByChainDataArticlesCategoriesItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByChainDataArticlesCategoriesItems - a model defined in OpenAPI
