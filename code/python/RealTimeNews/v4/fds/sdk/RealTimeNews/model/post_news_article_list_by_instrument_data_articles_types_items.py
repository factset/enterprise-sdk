...
class PostNewsArticleListByInstrumentDataArticlesTypesItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostNewsArticleListByInstrumentDataArticlesTypesItems - a model defined in OpenAPI
