...
from fds.sdk.RealTimeNews import rest
from fds.sdk.RealTimeNews.configuration import Configuration
from fds.sdk.RealTimeNews.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.RealTimeNews.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/RealTimeNews/0.20.0 ({platform.system()}, Python {platform.python_version()})'
