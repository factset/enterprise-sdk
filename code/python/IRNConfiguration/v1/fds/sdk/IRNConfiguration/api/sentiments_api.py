...
class SentimentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_sentiments_get_endpoint = _Endpoint(
            settings={
                'response_type': ([SentimentConfigDto],),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
                'endpoint_path': '/v1/sentiments',
                'operation_id': 'v1_sentiments_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_sentiments_get(
        ...
        **kwargs
        ...
        >>> thread = api.v1_sentiments_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.v1_sentiments_get_endpoint.call_with_http_info(**kwargs)
