...
class RecommendationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_recommendations_get_endpoint = _Endpoint(
            settings={
                'response_type': ([RecommendationConfigDto],),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
                'endpoint_path': '/v1/recommendations',
                'operation_id': 'v1_recommendations_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_recommendations_get(
        ...
        **kwargs
        ...
        >>> thread = api.v1_recommendations_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.v1_recommendations_get_endpoint.call_with_http_info(**kwargs)
