...
class SubjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_subjects_get_endpoint = _Endpoint(
            settings={
                'response_type': ([SubjectSummaryDto],),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
                'endpoint_path': '/v1/subjects',
                'operation_id': 'v1_subjects_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.v1_subjects_subject_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (SubjectConfigDto,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
                'endpoint_path': '/v1/subjects/{subjectId}',
                'operation_id': 'v1_subjects_subject_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_subjects_get(
        ...
        **kwargs
        ...
        >>> thread = api.v1_subjects_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.v1_subjects_get_endpoint.call_with_http_info(**kwargs)

    def v1_subjects_subject_id_get(
        self,
        subject_id,
        **kwargs
    ):
        ...
        >>> thread = api.v1_subjects_subject_id_get(subject_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subject_id'] = \
            subject_id
        return self.v1_subjects_subject_id_get_endpoint.call_with_http_info(**kwargs)
