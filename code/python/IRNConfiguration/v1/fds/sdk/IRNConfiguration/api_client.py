...
from fds.sdk.IRNConfiguration import rest
from fds.sdk.IRNConfiguration.configuration import Configuration
from fds.sdk.IRNConfiguration.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.IRNConfiguration.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IRNConfiguration/1.1.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ContactsCustomFieldsApi()
        api_instance.create_contact_custom_field  # this is an instance of the class Endpoint
        api_instance.create_contact_custom_field()  # this invokes api_instance.create_contact_custom_field.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_contact_custom_field.callable or self.callable in this class
