...
from fds.sdk.ExchangeDataFeedSnapshotAPISymbolList import rest
from fds.sdk.ExchangeDataFeedSnapshotAPISymbolList.configuration import Configuration
from fds.sdk.ExchangeDataFeedSnapshotAPISymbolList.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ExchangeDataFeedSnapshotAPISymbolList.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ExchangeDataFeedSnapshotAPISymbolList/0.21.15 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_df_snapshot  # this is an instance of the class Endpoint
        api_instance.get_df_snapshot()  # this invokes api_instance.get_df_snapshot.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_df_snapshot.callable or self.callable in this class
