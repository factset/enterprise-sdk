...
setup(
    name=NAME,
    version=VERSION,
    description="Exchange DataFeed Snapshot API - Symbol List client library for Python",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/main/code/python/ExchangeDataFeedSnapshotAPISymbolList/v1",
