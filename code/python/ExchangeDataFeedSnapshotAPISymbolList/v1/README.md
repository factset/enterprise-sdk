...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ExchangeDataFeedSnapshotAPISymbolList/0.21.15)](https://pypi.org/project/fds.sdk.ExchangeDataFeedSnapshotAPISymbolList/v/0.21.15)
...
```shell
poetry add fds.sdk.utils fds.sdk.ExchangeDataFeedSnapshotAPISymbolList==0.21.15
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ExchangeDataFeedSnapshotAPISymbolList==0.21.15
```
