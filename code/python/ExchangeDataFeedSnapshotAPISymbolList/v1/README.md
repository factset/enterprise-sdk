...
```shell
poetry add fds.sdk.utils fds.sdk.ExchangeDataFeedSnapshotAPISymbolList==0.21.9
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ExchangeDataFeedSnapshotAPISymbolList==0.21.9
```
