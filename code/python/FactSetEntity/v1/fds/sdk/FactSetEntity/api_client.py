...
from fds.sdk.FactSetEntity import rest
from fds.sdk.FactSetEntity.configuration import Configuration
from fds.sdk.FactSetEntity.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetEntity.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetEntity/1.1.10 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntityReferenceApi()
        api_instance.get_entity_references  # this is an instance of the class Endpoint
        api_instance.get_entity_references()  # this invokes api_instance.get_entity_references.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_entity_references.callable or self.callable in this class
