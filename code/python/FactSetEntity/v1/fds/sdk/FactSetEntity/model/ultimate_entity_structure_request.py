...
def lazy_import():
    ...
    globals()['StructureIds'] = StructureIds


class UltimateEntityStructureRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """UltimateEntityStructureRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            level (int): Controls the levels returned in the hierarchy. Use -1 to return all levels, or 1-n for a specific level.. [optional] if omitted the server will use the default value of -1  # noqa: E501
            active (Active): [optional]  # noqa: E501
        """
