...
def lazy_import():
    ...
    globals()['HcpIds'] = HcpIds


class CreditParentRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """CreditParentRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            as_of_date (str): The date requested for credit parent calculation. Represented in **YYYY-MM-DD** format. If left blank or not specified, the full credit parent history will be returned. . [optional]  # noqa: E501
        """
