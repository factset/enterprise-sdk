...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetEntity/1.1.10)](https://pypi.org/project/fds.sdk.FactSetEntity/v/1.1.10)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetEntity==1.1.10
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetEntity==1.1.10
```
