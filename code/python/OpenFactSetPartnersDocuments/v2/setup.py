...
setup(
    name=NAME,
    version=VERSION,
    description="Open:FactSet Partners - Documents client library for Python",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/main/code/python/OpenFactSetPartnersDocuments/v2",
