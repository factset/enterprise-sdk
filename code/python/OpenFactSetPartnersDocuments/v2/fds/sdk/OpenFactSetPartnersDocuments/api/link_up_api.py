...
class LinkUpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_link_up_job_listings_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (LinkUpResponse,), 400: (AuthStatus,), 401: (AuthStatus,), 403: (AuthStatus,), 500: (AuthStatus,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/linkup/job-listings',
                'operation_id': 'get_link_up_job_listings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_link_up_job_listings(
        self,
        **kwargs
    ) -> LinkUpResponse:
        """Returns the  daily files from Open:FactSet Partner - LinkUp. The LinkUp API provides access to job listings dataset that is sourced directly from employer webistes globally delivered daily.  # noqa: E501

        Returns the  daily files from Open:FactSet Partner - LinkUp. The LinkUp API provides access to job listings dataset that is sourced directly from employer webistes globally delivered daily. **This API is no longer being sold for new clients.**  # noqa: E501
        ...
        return self.get_link_up_job_listings_endpoint.call_with_http_info(**kwargs)

    def get_link_up_job_listings_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[LinkUpResponse, int, typing.MutableMapping]:
        """Returns the  daily files from Open:FactSet Partner - LinkUp. The LinkUp API provides access to job listings dataset that is sourced directly from employer webistes globally delivered daily.  # noqa: E501
    ...
    def get_link_up_job_listings_async(
        self,
        **kwargs
    ) -> "ApplyResult[LinkUpResponse]":
        """Returns the  daily files from Open:FactSet Partner - LinkUp. The LinkUp API provides access to job listings dataset that is sourced directly from employer webistes globally delivered daily.  # noqa: E501
    ...
    def get_link_up_job_listings_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[LinkUpResponse, int, typing.MutableMapping]]":
        """Returns the  daily files from Open:FactSet Partner - LinkUp. The LinkUp API provides access to job listings dataset that is sourced directly from employer webistes globally delivered daily.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(LinkUpResponse, int, typing.Dict)]
        """
