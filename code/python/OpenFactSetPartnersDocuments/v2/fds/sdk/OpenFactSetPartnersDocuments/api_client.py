...
from fds.sdk.OpenFactSetPartnersDocuments import rest
from fds.sdk.OpenFactSetPartnersDocuments.configuration import Configuration
from fds.sdk.OpenFactSetPartnersDocuments.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OpenFactSetPartnersDocuments.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OpenFactSetPartnersDocuments/3.0.10 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = LinkUpApi()
        api_instance.get_link_up_job_listings  # this is an instance of the class Endpoint
        api_instance.get_link_up_job_listings()  # this invokes api_instance.get_link_up_job_listings.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_link_up_job_listings.callable or self.callable in this class
