...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetPortfolioOptimizer/0.21.14)](https://pypi.org/project/fds.sdk.FactSetPortfolioOptimizer/v/0.21.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetPortfolioOptimizer==0.21.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetPortfolioOptimizer==0.21.14
```
...
## Documentation For Models
 ...
 - [FPOOptimizationParameters](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetPortfolioOptimizer/v3/docs/FPOOptimizationParameters.md)
