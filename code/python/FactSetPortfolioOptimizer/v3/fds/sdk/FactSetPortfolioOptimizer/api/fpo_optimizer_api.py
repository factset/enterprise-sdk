...
class FPOOptimizerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_optimization_parameters_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FPOOptimizationParametersRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_optimization_parameters_with_http_info(
        ...
        id,
        **kwargs
    ) -> typing.Tuple[FPOOptimizationParametersRoot, int, typing.MutableMapping]:
        """Get FPO optimization parameters by id  # noqa: E501
    ...
    def get_optimization_parameters_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[FPOOptimizationParametersRoot]":
        """Get FPO optimization parameters by id  # noqa: E501
    ...
    def get_optimization_parameters_with_http_info_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FPOOptimizationParametersRoot, int, typing.MutableMapping]]":
        """Get FPO optimization parameters by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(FPOOptimizationParametersRoot, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['id'] = \
            id
