...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetPortfolioOptimizer/0.8.17)](https://pypi.org/project/fds.sdk.FactSetPortfolioOptimizer/v/0.8.17)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetPortfolioOptimizer==0.8.17
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetPortfolioOptimizer==0.8.17
```
