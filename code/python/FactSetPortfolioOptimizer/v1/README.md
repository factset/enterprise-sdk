...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetPortfolioOptimizer/0.9.0)](https://pypi.org/project/fds.sdk.FactSetPortfolioOptimizer/v/0.9.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetPortfolioOptimizer==0.9.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetPortfolioOptimizer==0.9.0
```
