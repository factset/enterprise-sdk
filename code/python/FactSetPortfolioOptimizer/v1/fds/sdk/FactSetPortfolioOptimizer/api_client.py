...
from fds.sdk.FactSetPortfolioOptimizer import rest
from fds.sdk.FactSetPortfolioOptimizer.configuration import Configuration
from fds.sdk.FactSetPortfolioOptimizer.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPortfolioOptimizer.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetPortfolioOptimizer/0.8.16 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancel_fpo_optimization_by_id  # this is an instance of the class Endpoint
        api_instance.cancel_fpo_optimization_by_id()  # this invokes api_instance.cancel_fpo_optimization_by_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_fpo_optimization_by_id.callable or self.callable in this class
