...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetEntityReportBuilder/1.0.13)](https://pypi.org/project/fds.sdk.FactSetEntityReportBuilder/v/1.0.13)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetEntityReportBuilder==1.0.13
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetEntityReportBuilder==1.0.13
```
