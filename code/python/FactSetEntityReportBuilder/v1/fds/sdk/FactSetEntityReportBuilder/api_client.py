...
from fds.sdk.FactSetEntityReportBuilder import rest
from fds.sdk.FactSetEntityReportBuilder.configuration import Configuration
from fds.sdk.FactSetEntityReportBuilder.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetEntityReportBuilder.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetEntityReportBuilder/1.0.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntityStructureApi()
        api_instance.get_entity_structure_structure  # this is an instance of the class Endpoint
        api_instance.get_entity_structure_structure()  # this invokes api_instance.get_entity_structure_structure.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_entity_structure_structure.callable or self.callable in this class
