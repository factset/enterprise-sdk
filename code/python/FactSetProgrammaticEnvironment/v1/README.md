...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetProgrammaticEnvironment/0.22.1)](https://pypi.org/project/fds.sdk.FactSetProgrammaticEnvironment/v/0.22.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetProgrammaticEnvironment==0.22.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetProgrammaticEnvironment==0.22.1
```
