...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetProgrammaticEnvironment/0.23.1)](https://pypi.org/project/fds.sdk.FactSetProgrammaticEnvironment/v/0.23.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetProgrammaticEnvironment==0.23.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetProgrammaticEnvironment==0.23.1
```
...
*CalculationsApi* | [**delete_calculation**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetProgrammaticEnvironment/v1/docs/CalculationsApi.md#delete_calculation) | **DELETE** /calculations/{id} | Kill a running calculation by id
...
*ServersApi* | [**stop_server**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetProgrammaticEnvironment/v1/docs/ServersApi.md#stop_server) | **DELETE** /servers | Stop the caller&#39;s API server
