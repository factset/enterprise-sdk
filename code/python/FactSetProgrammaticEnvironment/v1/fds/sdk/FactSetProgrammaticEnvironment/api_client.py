...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetProgrammaticEnvironment/0.22.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_calculations  # this is an instance of the class Endpoint
        api_instance.create_calculations()  # this invokes api_instance.create_calculations.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_calculations.callable or self.callable in this class
