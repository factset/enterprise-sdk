...
class ServersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.stop_server_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'FactSetApiKey',
    ...
    def stop_server(
        ...
        **kwargs
        ...
        return self.stop_server_endpoint.call_with_http_info(**kwargs)
    ...
    def stop_server_with_http_info_async(
        self,
        **kwargs
