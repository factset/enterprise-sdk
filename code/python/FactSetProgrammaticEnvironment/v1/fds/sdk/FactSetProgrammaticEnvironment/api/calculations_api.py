...
class CalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_calculations_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'operation_id': 'create_calculations',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_calculation_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'FactSetApiKey',
                ...
                'operation_id': 'delete_calculation',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_calculations_endpoint = _Endpoint(
            settings={
                'response_type': (
        ...
        self.get_calculations_log_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (file_type,),  },
                  None
                ...
                'endpoint_path': '/calculations/{id}/log',
                'operation_id': 'get_calculations_log',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_calculations_output_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (file_type,),  },
                  None
                ...
                'endpoint_path': '/calculations/{id}/output',
                'operation_id': 'get_calculations_output',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_calculations(
        ...
        **kwargs
        ...
        return self.create_calculations_endpoint.call_with_http_info(**kwargs)

    def create_calculations_with_http_info(
        self,
        **kwargs
    ...
    def create_calculations_with_http_info_async(
        self,
        **kwargs
    ...
    def delete_calculation(
        ...
        **kwargs
        ...
        """Kill a running calculation by id  # noqa: E501

        Aborts a running calculation. Returns 409 if the calculation is already in a terminal state, 422 if the calculation has not started yet or is not supported.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        kwargs['id'] = \
            id
        return self.delete_calculation_endpoint.call_with_http_info(**kwargs)

    def delete_calculation_with_http_info(
        self,
        id,
        **kwargs
    ...
    def delete_calculation_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def get_calculations(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_calculations_endpoint.call_with_http_info(**kwargs)

    def get_calculations_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[CalculationStatus, int, typing.MutableMapping]:
    ...
    def get_calculations_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[CalculationStatus, int, typing.MutableMapping]]":
    ...
    def get_calculations_log(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_calculations_log_endpoint.call_with_http_info(**kwargs)

    def get_calculations_log_with_http_info(
        self,
        id,
        **kwargs
    ...
    def get_calculations_log_async(
        self,
        id,
        **kwargs
    ...
    def get_calculations_log_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def get_calculations_output(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_calculations_output_endpoint.call_with_http_info(**kwargs)

    def get_calculations_output_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[file_type, int, typing.MutableMapping]:
    ...
    def get_calculations_output_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[file_type]":
    ...
    def get_calculations_output_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[file_type, int, typing.MutableMapping]]":
