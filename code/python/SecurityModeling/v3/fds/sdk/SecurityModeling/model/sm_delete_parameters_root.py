...
def lazy_import():
    ...
    globals()['SMDeleteParameters'] = SMDeleteParameters


class SMDeleteParametersRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([SMDeleteParameters],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SMDeleteParametersRoot - a model defined in OpenAPI

        Args:
            data ([SMDeleteParameters]):
