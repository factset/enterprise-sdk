...
def lazy_import():
    ...
    globals()['SMDeleteResponse'] = SMDeleteResponse


class SMDeleteResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([SMDeleteResponse],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SMDeleteResponseRoot - a model defined in OpenAPI

        Args:
            data ([SMDeleteResponse]):
