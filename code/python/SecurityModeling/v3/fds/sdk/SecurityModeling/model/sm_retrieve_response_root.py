...
def lazy_import():
    ...
    globals()['SMRetrieveResponse'] = SMRetrieveResponse


class SMRetrieveResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([SMRetrieveResponse],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SMRetrieveResponseRoot - a model defined in OpenAPI

        Args:
            data ([SMRetrieveResponse]):
