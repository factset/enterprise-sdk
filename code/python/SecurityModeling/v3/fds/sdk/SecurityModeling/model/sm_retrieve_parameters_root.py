...
def lazy_import():
    ...
    globals()['SMRetrieveParameters'] = SMRetrieveParameters


class SMRetrieveParametersRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([SMRetrieveParameters],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SMRetrieveParametersRoot - a model defined in OpenAPI

        Args:
            data ([SMRetrieveParameters]):
