...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.SecurityModeling/0.21.0)](https://pypi.org/project/fds.sdk.SecurityModeling/v/0.21.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.SecurityModeling==0.21.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.SecurityModeling==0.21.0
```
