...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.SecurityModeling/0.20.17)](https://pypi.org/project/fds.sdk.SecurityModeling/v/0.20.17)
...
```shell
poetry add fds.sdk.utils fds.sdk.SecurityModeling==0.20.17
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.SecurityModeling==0.20.17
```
...
------------ | ------------- | ------------- | -------------
*SecurityModelingApi* | [**delete_securities**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/SecurityModeling/v3/docs/SecurityModelingApi.md#delete_securities) | **POST** /delete | Delete existing securities
*SecurityModelingApi* | [**get_securities**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/SecurityModeling/v3/docs/SecurityModelingApi.md#get_securities) | **POST** /retrieve | Get existing securities
*SecurityModelingApi* | [**upsert_securities**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/SecurityModeling/v3/docs/SecurityModelingApi.md#upsert_securities) | **POST** /upsert | Create or update securities
