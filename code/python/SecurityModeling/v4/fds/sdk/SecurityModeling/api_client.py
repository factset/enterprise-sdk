...
from fds.sdk.SecurityModeling import rest
from fds.sdk.SecurityModeling.configuration import Configuration
from fds.sdk.SecurityModeling.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.SecurityModeling.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/SecurityModeling/1.0.0 ({platform.system()}, Python {platform.python_version()})'
