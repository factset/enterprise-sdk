...
setup(
    name=NAME,
    version=VERSION,
    description="FactSet People client library for Python",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetPeople/v1",
