...
from fds.sdk.FactSetPeople import rest
from fds.sdk.FactSetPeople.configuration import Configuration
from fds.sdk.FactSetPeople.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPeople.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetPeople/1.0.15 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_company_compensation  # this is an instance of the class Endpoint
        api_instance.get_company_compensation()  # this invokes api_instance.get_company_compensation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_company_compensation.callable or self.callable in this class
