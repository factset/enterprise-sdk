...
class Status(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Select only Jobs with a certain status primary, active, or inactive.. if omitted defaults to "ALL", must be one of ["ALL", "PRIMARY", "ACTIVE", "INACTIVE", ]  # noqa: E501

        Keyword Args:
            value (str): Select only Jobs with a certain status primary, active, or inactive.. if omitted defaults to "ALL", must be one of ["ALL", "PRIMARY", "ACTIVE", "INACTIVE", ]  # noqa: E501
