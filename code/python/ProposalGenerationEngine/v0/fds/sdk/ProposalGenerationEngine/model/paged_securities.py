...
def lazy_import():
    ...
    globals()['PagedSecuritiesMeta'] = PagedSecuritiesMeta


class PagedSecurities(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([Investment],),  # noqa: E501
            'meta': (PagedSecuritiesMeta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """PagedSecurities - a model defined in OpenAPI

        Args:
            data ([Investment]):
            meta (PagedSecuritiesMeta):
