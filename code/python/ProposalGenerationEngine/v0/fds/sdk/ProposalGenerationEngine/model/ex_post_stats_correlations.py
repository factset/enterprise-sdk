...
def lazy_import():
    ...
    globals()['ExPostStatsCorrelationsData'] = ExPostStatsCorrelationsData


class ExPostStatsCorrelations(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ExPostStatsCorrelationsData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ExPostStatsCorrelations - a model defined in OpenAPI
