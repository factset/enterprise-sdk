...
**display_format** | **int** | 1 - absolute (portfolio relative); 2 - scaled (portfolio relative); 3 - absolute (benchmark relative) | [optional] 
**risk_tree_level** | **int** |  | [optional]  if omitted the server will use the default value of 3
