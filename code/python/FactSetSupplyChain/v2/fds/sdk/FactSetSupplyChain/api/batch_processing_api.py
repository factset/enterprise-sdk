...
class GetBatchDataResponseWrapper:
    ...
    def get_response_200(self) -> BatchResultResponse:
        """
        Raises: ApiException: Invalid response getter called.

        Returns: The long-running request has been completed and the result is created. The response structure will be based on the endpoint that initiated the batch request.
        """
    ...
    def get_response_202(self) -> BatchStatusResponse:
        ...
        Returns: The batch Request has not finished and the result has NOT been created.
        """
...
class BatchProcessingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_batch_data_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BatchResultResponse,), 202: (BatchStatusResponse,), 404: (ErrorResponse,), 422: (ErrorResponse,), 500: (ErrorResponse,),  },
        ...
        self.get_batch_status_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 201: (BatchStatusResponse,), 202: (BatchStatusResponse,), 404: (ErrorResponse,), 422: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_batch_data(
        ...
        **kwargs
        ...
        Returns the response data for the underlying batch request that is specified by the ID. The response structure will be based on the endpoint that initiated the batch request.   # noqa: E501
