...
from fds.sdk.FactSetSupplyChain import rest
from fds.sdk.FactSetSupplyChain.configuration import Configuration
from fds.sdk.FactSetSupplyChain.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetSupplyChain.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetSupplyChain/2.0.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = RelationshipsApi()
        api_instance.get_relationships  # this is an instance of the class Endpoint
        api_instance.get_relationships()  # this invokes api_instance.get_relationships.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_relationships.callable or self.callable in this class
