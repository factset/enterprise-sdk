...
class RelationshipType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The relationship between requested identifier and partner. ., must be one of ["COMPETITORS", "CUSTOMERS", "SUPPLIERS", "PARTNERS", ]  # noqa: E501

        Keyword Args:
            value (str): The relationship between requested identifier and partner. ., must be one of ["COMPETITORS", "CUSTOMERS", "SUPPLIERS", "PARTNERS", ]  # noqa: E501
