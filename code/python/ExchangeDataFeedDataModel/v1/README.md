...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ExchangeDataFeedDataModel/0.20.13)](https://pypi.org/project/fds.sdk.ExchangeDataFeedDataModel/v/0.20.13)
...
```shell
poetry add fds.sdk.utils fds.sdk.ExchangeDataFeedDataModel==0.20.13
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ExchangeDataFeedDataModel==0.20.13
```
