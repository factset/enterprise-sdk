...
class ErrorResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): Unique identifier for the error. [optional]  # noqa: E501
            status (int): HTTP status code representing the outcome of the HTTP request.. [optional]  # noqa: E501
            error (str): The plain text error message. [optional]  # noqa: E501
            errors ([ErrorDetail]): List of detailed error messages. [optional]  # noqa: E501
        """
