...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ExchangeDataFeedDataModel/0.20.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FactSetProductCodesApi()
        api_instance.get_products  # this is an instance of the class Endpoint
        api_instance.get_products()  # this invokes api_instance.get_products.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_products.callable or self.callable in this class
