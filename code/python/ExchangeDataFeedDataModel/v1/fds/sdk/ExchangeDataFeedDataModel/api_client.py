...
from fds.sdk.ExchangeDataFeedDataModel import rest
from fds.sdk.ExchangeDataFeedDataModel.configuration import Configuration
from fds.sdk.ExchangeDataFeedDataModel.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ExchangeDataFeedDataModel.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ExchangeDataFeedDataModel/0.21.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ExchangeInformationApi()
        api_instance.get_exchanges  # this is an instance of the class Endpoint
        api_instance.get_exchanges()  # this invokes api_instance.get_exchanges.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_exchanges.callable or self.callable in this class
