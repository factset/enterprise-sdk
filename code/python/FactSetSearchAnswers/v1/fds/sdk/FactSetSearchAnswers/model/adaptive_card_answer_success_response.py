...
def lazy_import():
    ...
    globals()['AdaptiveCardDataItem'] = AdaptiveCardDataItem


class AdaptiveCardAnswerSuccessResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([AdaptiveCardDataItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """AdaptiveCardAnswerSuccessResponse - a model defined in OpenAPI

        Args:
            data ([AdaptiveCardDataItem]):
