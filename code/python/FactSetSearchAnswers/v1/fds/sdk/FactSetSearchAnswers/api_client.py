...
from fds.sdk.FactSetSearchAnswers import rest
from fds.sdk.FactSetSearchAnswers.configuration import Configuration
from fds.sdk.FactSetSearchAnswers.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetSearchAnswers.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetSearchAnswers/1.1.7 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.search_for_adaptive_card_answer  # this is an instance of the class Endpoint
        api_instance.search_for_adaptive_card_answer()  # this invokes api_instance.search_for_adaptive_card_answer.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.search_for_adaptive_card_answer.callable or self.callable in this class
