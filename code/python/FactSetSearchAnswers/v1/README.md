...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetSearchAnswers/1.1.6)](https://pypi.org/project/fds.sdk.FactSetSearchAnswers/v/1.1.6)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetSearchAnswers==1.1.6
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetSearchAnswers==1.1.6
```
