...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/CompanyLogo/0.40.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CompanyLogosApi()
        api_instance.post_company_logo  # this is an instance of the class Endpoint
        api_instance.post_company_logo()  # this invokes api_instance.post_company_logo.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.post_company_logo.callable or self.callable in this class
