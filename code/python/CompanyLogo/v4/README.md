...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.CompanyLogo/0.21.0)](https://pypi.org/project/fds.sdk.CompanyLogo/v/0.21.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.CompanyLogo==0.21.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.CompanyLogo==0.21.0
```
