...
from fds.sdk.CompanyLogo import rest
from fds.sdk.CompanyLogo.configuration import Configuration
from fds.sdk.CompanyLogo.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.CompanyLogo.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/CompanyLogo/0.20.0 ({platform.system()}, Python {platform.python_version()})'
