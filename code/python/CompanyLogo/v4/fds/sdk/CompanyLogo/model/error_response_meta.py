...
def lazy_import():
    ...
    globals()['ErrorResponseMetaStatus'] = ErrorResponseMetaStatus


class ErrorResponseMeta(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'status': (ErrorResponseMetaStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        """ErrorResponseMeta - a model defined in OpenAPI

        Args:
            status (ErrorResponseMetaStatus):
