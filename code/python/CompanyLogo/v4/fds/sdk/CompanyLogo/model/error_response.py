...
def lazy_import():
    ...
    globals()['ErrorResponseMeta'] = ErrorResponseMeta
...
class ErrorResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'meta': (ErrorResponseMeta,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, meta, errors, *args, **kwargs):  # noqa: E501
        """ErrorResponse - a model defined in OpenAPI

        Args:
            meta (ErrorResponseMeta):
            errors ([ErrorDetail]): Array of error objects
    ...
    @convert_js_args_to_python_args
    def __init__(self, meta, errors, *args, **kwargs):  # noqa: E501
        """ErrorResponse - a model defined in OpenAPI
