...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.CompanyLogo/0.11.4)](https://pypi.org/project/fds.sdk.CompanyLogo/v/0.11.4)
...
```shell
poetry add fds.sdk.utils fds.sdk.CompanyLogo==0.11.4
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.CompanyLogo==0.11.4
```
...
## Documentation For Models
 ...
 - [InlineResponse200DataSmall](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/CompanyLogo/v3/docs/InlineResponse200DataSmall.md)
