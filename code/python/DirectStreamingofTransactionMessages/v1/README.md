...
```shell
poetry add fds.sdk.utils fds.sdk.DirectStreamingofTransactionMessages==0.23.5
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.DirectStreamingofTransactionMessages==0.23.5
```
