...
with fds.sdk.DirectStreamingofTransactionMessages.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_instance.send_transactions(transactions=transactions)    except fds.sdk.DirectStreamingofTransactionMessages.ApiException as e:
        print("Exception when calling DSOTMApi->send_transactions: %s\n" % e)

    # Get response, http status code and response headers
    # try:
    #     # Push transactions data into FactSet's systems.
    #     api_response, http_status_code, response_headers = api_instance.send_transactions_with_http_info(transactions=transactions)    # except fds.sdk.DirectStreamingofTransactionMessages.ApiException as e:
    #     print("Exception when calling DSOTMApi->send_transactions: %s\n" % e)

    # Get response asynchronous
    # try:
    #     # Push transactions data into FactSet's systems.
    #     async_result = api_instance.send_transactions_async(transactions=transactions)    # except fds.sdk.DirectStreamingofTransactionMessages.ApiException as e:
    #     print("Exception when calling DSOTMApi->send_transactions: %s\n" % e)

    # Get response, http status code and response headers asynchronous
    # try:
    #     # Push transactions data into FactSet's systems.
    #     async_result = api_instance.send_transactions_with_http_info_async(transactions=transactions)    # except fds.sdk.DirectStreamingofTransactionMessages.ApiException as e:
    #     print("Exception when calling DSOTMApi->send_transactions: %s\n" % e)
