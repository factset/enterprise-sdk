...
```shell
poetry add fds.sdk.utils fds.sdk.DirectStreamingofTransactionMessages==0.22.7
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.DirectStreamingofTransactionMessages==0.22.7
```
