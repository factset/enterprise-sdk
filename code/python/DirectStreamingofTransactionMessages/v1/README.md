...
```shell
poetry add fds.sdk.utils fds.sdk.DirectStreamingofTransactionMessages==0.24.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.DirectStreamingofTransactionMessages==0.24.1
```
