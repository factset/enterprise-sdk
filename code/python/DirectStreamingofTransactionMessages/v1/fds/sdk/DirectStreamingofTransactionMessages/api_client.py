...
from fds.sdk.DirectStreamingofTransactionMessages import rest
from fds.sdk.DirectStreamingofTransactionMessages.configuration import Configuration
from fds.sdk.DirectStreamingofTransactionMessages.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.DirectStreamingofTransactionMessages.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/DirectStreamingofTransactionMessages/0.24.3 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DSOTMApi()
        api_instance.send_transactions  # this is an instance of the class Endpoint
        api_instance.send_transactions()  # this invokes api_instance.send_transactions.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.send_transactions.callable or self.callable in this class
