...
class PlacementParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            parentid (str, none_type): Unique ID of the order which spawned this placement. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso, *args, **kwargs):  # noqa: E501
        """PlacementParameters - a model defined in OpenAPI
