...
def lazy_import():
    ...
    globals()['DsotmParameters'] = DsotmParameters


class DsotmParametersRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (DsotmParameters,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """DsotmParametersRoot - a model defined in OpenAPI
