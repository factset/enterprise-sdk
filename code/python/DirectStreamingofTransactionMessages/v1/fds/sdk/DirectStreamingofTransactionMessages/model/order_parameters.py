...
class OrderParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso, *args, **kwargs):  # noqa: E501
        """OrderParameters - a model defined in OpenAPI
