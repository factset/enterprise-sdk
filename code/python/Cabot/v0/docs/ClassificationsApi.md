# fds.sdk.Cabot.ClassificationsApi

All URIs are relative to *https://api.factset.com/analytics/cabot/v0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_portfolio_classifications**](ClassificationsApi.md#get_portfolio_classifications) | **GET** /classifications | Cabot main path for Classifications API



# **get_portfolio_classifications**
> ClassificationsResponseRoot get_portfolio_classifications(account_path, benchmark_path)
...
from fds.sdk.Cabot.api import classifications_api
...
with fds.sdk.Cabot.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.get_portfolio_classifications(account_path, benchmark_path)

        pprint(api_response)

    except fds.sdk.Cabot.ApiException as e:
        print("Exception when calling ClassificationsApi->get_portfolio_classifications: %s\n" % e)
```
