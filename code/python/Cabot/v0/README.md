...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Cabot/0.11.3)](https://pypi.org/project/fds.sdk.Cabot/v/0.11.3)
...
```shell
poetry add fds.sdk.utils fds.sdk.Cabot==0.11.3
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Cabot==0.11.3
```
