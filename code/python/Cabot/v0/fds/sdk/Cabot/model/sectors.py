...
class Sectors(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Sectors - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): All currently available sectors.., must be one of ["energy", "materials", "industrials", "consumerDiscretionary", "consumerStaples", "healthCare", "financials", "informationTechnology", "communicationServices", "utilities", "realEstate", "equityDiversified", "equityHealthCare", "equitySelfStorage", "equityIndustrial", "equityOffice", "equityResidential", "equityRetail", "equityLodgingAndResorts", "equitySpecialty", "equityTimberReits", "equityInfrastructureReits", "equityDataCenters", "mortageHomeFinancing", "mortageCommercialFinancing", ]  # noqa: E501
