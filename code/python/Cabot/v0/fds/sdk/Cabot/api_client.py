...
from fds.sdk.Cabot import rest
from fds.sdk.Cabot.configuration import Configuration
from fds.sdk.Cabot.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Cabot.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Cabot/0.12.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BuyingModelsApi()
        api_instance.get_buy_context_model_analytic  # this is an instance of the class Endpoint
        api_instance.get_buy_context_model_analytic()  # this invokes api_instance.get_buy_context_model_analytic.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_buy_context_model_analytic.callable or self.callable in this class
