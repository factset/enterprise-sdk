...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/Cabot/0.10.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CabotModelsAPIApi()
        api_instance.get_sell_timing_model_analytic  # this is an instance of the class Endpoint
        api_instance.get_sell_timing_model_analytic()  # this invokes api_instance.get_sell_timing_model_analytic.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_sell_timing_model_analytic.callable or self.callable in this class
