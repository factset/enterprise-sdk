...
from fds.sdk.IRNMeetings import rest
from fds.sdk.IRNMeetings.configuration import Configuration
from fds.sdk.IRNMeetings.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.IRNMeetings.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IRNMeetings/2.0.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_attachment  # this is an instance of the class Endpoint
        api_instance.create_attachment()  # this invokes api_instance.create_attachment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_attachment.callable or self.callable in this class
