...
class UpdateMeetingDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, identifier, start, end, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, identifier, start, end, *args, **kwargs):  # noqa: E501
        """UpdateMeetingDto - a model defined in OpenAPI
