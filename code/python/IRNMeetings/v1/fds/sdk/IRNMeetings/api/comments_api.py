...
class CommentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_comment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/meetings/{meetingId}/comments',
        ...
        self.create_comment_attachment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/meetings/{meetingId}/comments/{commentId}/attachments',
        ...
        self.delete_comment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/meetings/{meetingId}/comments/{commentId}',
        ...
        self.download_comment_attachment_for_comment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/meetings/{meetingId}/comments/{commentId}/attachments/{attachmentId}/download',
    ...
    def create_comment(
        ...
        **kwargs
        ...
        Create a comment to a Meeting by providing the meeting id and comment details.  # noqa: E501
    ...
    def create_comment_attachment(
        ...
        **kwargs
        ...
        Create a attachment on a comment of a Meeting by providing the meeting id and comment id and attachment details.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def delete_comment(
        ...
        **kwargs
        ...
        Delete a Comment from a Meeting by providing the meeting id and comment id.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def download_comment_attachment_for_comment(
        ...
        **kwargs
        ...
        Download single attachment detail of a comment belonging to a meeting by providing the meeting id, comment id and attachment id.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_comment(
        ...
        **kwargs
        ...
        Get details of a comment belonging to a meeting by providing the meeting id and comment id.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_comment_attachments(
        ...
        **kwargs
        ...
        Get attachments summary of a comment belonging to a meeting by providing the meeting id and comment id.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_comments(
        ...
        **kwargs
        ...
        Get all comments for a meeting by providing the meeting id.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def patch_comment(
        ...
        **kwargs
        ...
        Edit a comment for a meeting by providing the meeting id and comment id.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
