...
class Metrics(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): Requested List of Financial Statement Items or Ratios. Use /metrics endpoint for a complete list of available FF_* metric items. .  # noqa: E501

        Keyword Args:
            value ([str]): Requested List of Financial Statement Items or Ratios. Use /metrics endpoint for a complete list of available FF_* metric items. .  # noqa: E501
