            ...
            root_map={
                ...
                'allowed_values': {
                    ...
                    ('subcategory',): {
                        ...
                        "NON-RECURRING_ITEMS": "NON-RECURRING_ITEMS",
                ...
                'attribute_map': {
                    ...
                    'pit_data_items': 'pitDataItems',
                },
                'location_map': {
                    'category': 'query',
                    'subcategory': 'query',
                    'metric_data_type': 'query',
                    'pit_data_items': 'query',
                },
    ...
    def get_fds_fundamentals_metrics(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            metric_data_type (str): Returns general data type of the metrics like integer, float or strings. When left blank, metrics with all data types would be returned.. [optional] if omitted the server will use the default value of ""
            pit_data_items (bool): Filters the list of metrics based on whether they are available for Point-in-Time (PIT) historical data. * `true` - Returns metrics that are available in PIT datasets. These metrics can be used in the `/point-in-time` endpoint. * `false` (default) - Returns metrics that are available in non-PIT datasets.. [optional] if omitted the server will use the default value of False
