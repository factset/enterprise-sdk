...
class Fundamental(ModelNormal):
    ...
    def _from_openapi_data(cls, fiscal_period, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metric (str, none_type): The requested `metric` input, representing the Fundamentals Data Item. For a definition of the item please use the `/fundamentals/v2/metrics` endpoint.. [optional]  # noqa: E501
