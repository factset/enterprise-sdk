...
class IdentifierList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): Array of identifiers supported in async requests to `/point-in-time` and `/periods` endpoints.  Accepted types: Tickers, SEDOLs, ISINs, CUSIPs, FactSet Permanent Security, Regional, and Entity Identifiers..  # noqa: E501

        Keyword Args:
            value ([str]): Array of identifiers supported in async requests to `/point-in-time` and `/periods` endpoints.  Accepted types: Tickers, SEDOLs, ISINs, CUSIPs, FactSet Permanent Security, Regional, and Entity Identifiers..  # noqa: E501
