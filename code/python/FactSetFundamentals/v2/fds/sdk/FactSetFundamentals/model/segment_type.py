...
class SegmentType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Segment type for the metrics, where   * **BUS**  = Business,   * **GEO** = Geographic . if omitted defaults to "BUS", must be one of ["BUS", "GEO", ]  # noqa: E501

        Keyword Args:
            value (str): Segment type for the metrics, where   * **BUS**  = Business,   * **GEO** = Geographic . if omitted defaults to "BUS", must be one of ["BUS", "GEO", ]  # noqa: E501
