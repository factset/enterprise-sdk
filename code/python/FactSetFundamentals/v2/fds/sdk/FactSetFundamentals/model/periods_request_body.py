...
def lazy_import():
    ...
    globals()['IdentifierList'] = IdentifierList
    globals()['PeriodicityEnum'] = PeriodicityEnum


class PeriodsRequestBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ids, fiscal_period_start, *args, **kwargs):  # noqa: E501
        """PeriodsRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fiscal_period_end (date): Filters for fiscal periods ending on or before this date (YYYY-MM-DD). Used with `fiscalPeriodStart` for a range, or alone for the latest period.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, ids, fiscal_period_start, *args, **kwargs):  # noqa: E501
        """PeriodsRequestBody - a model defined in OpenAPI
