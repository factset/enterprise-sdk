...
class Metric(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_pit': (bool,),  # noqa: E501
            'is_non_pit': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'is_pit': 'isPIT',  # noqa: E501
        'is_non_pit': 'isNonPIT',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metric (str, none_type): Metric identifier to be used as `metrics` input in `/fundamentals/v2/fundamentals` endpoint.. [optional]  # noqa: E501
            ...
            is_pit (bool): Flag indicating if the metric is available in Point-in-Time (PIT) datasets, and can be used with the `/point-in-time` endpoint.. [optional]  # noqa: E501
            is_non_pit (bool): Flag indicating if the metric is available in non-Point-in-Time (non-PIT) datasets, and can be used with the `/fundamentals` endpoint. A metric can be available in both PIT and non-PIT datasets.. [optional]  # noqa: E501
