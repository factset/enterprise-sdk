...
class MetricList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): An array of fundamentals metric identifiers. Use the `/metrics` endpoint for a complete list of available metric identifiers..  # noqa: E501

        Keyword Args:
            value ([str]): An array of fundamentals metric identifiers. Use the `/metrics` endpoint for a complete list of available metric identifiers..  # noqa: E501
