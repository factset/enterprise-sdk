...
class FundamentalsPITData(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundamentalsPITData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_id (str): The identifier provided in the input request that corresponds to this data point.. [optional]  # noqa: E501
            ...
            periodicity (str, none_type): Periodicity of this data point (e.g., `QTR`, `ANN`).. [optional]  # noqa: E501
            ...
            pit_start (datetime, none_type): Start of Point-in-Time (inclusive, in UTC) during which this value was current. Format: ISO 8601 `YYYY-MM-DDTHH:MM:SSZ`. If frequency is weekly (w) or monthly (m), this will be null. . [optional]  # noqa: E501
            pit_end (datetime, none_type): End of Point-in-Time (inclusive, in UTC). Format: ISO 8601 `YYYY-MM-DDTHH:MM:SSZ`. If value is `null` -> this value is current (latest active snapshot). If frequency is weekly or monthly, and this is an end-of-week or end-of-month snapshot -> `pitStart` will be null. . [optional]  # noqa: E501
        """
