...
class FiscalPeriod(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FiscalPeriod - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start (str): The fiscal period start expressed as YYYY-MM-DD.  Calendar date that will fall back to the most recently completed period during resolution. . [optional]  # noqa: E501
            end (str): The fiscal period end expressed YYYY-MM-DD.  Calendar date that will fall back to the most recent completed period during resolution. . [optional]  # noqa: E501
        """
