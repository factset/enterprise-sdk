...
def lazy_import():
    ...
    globals()['Batch'] = Batch
    globals()['FiscalPeriod'] = FiscalPeriod
    globals()['IdsBatchMax30000'] = IdsBatchMax30000
    globals()['Metrics'] = Metrics
    globals()['Periodicity'] = Periodicity
    globals()['UpdateType'] = UpdateType


class FundamentalRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ids': (IdsBatchMax30000,),  # noqa: E501
    ...
    def _from_openapi_data(cls, ids, metrics, *args, **kwargs):  # noqa: E501
        """FundamentalRequestBody - a model defined in OpenAPI

        Args:
            ids (IdsBatchMax30000):
            metrics (Metrics):
        ...
        Keyword Args:
            ...
            fiscal_period (FiscalPeriod): [optional]  # noqa: E501
