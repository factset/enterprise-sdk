...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetFundamentals/3.1.0)](https://pypi.org/project/fds.sdk.FactSetFundamentals/v/3.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetFundamentals==3.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetFundamentals==3.1.0
```
...
*FactSetFundamentalsApi* | [**get_fds_fundamentals_for_list**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FactSetFundamentalsApi.md#get_fds_fundamentals_for_list) | **POST** /fundamentals | Returns Company Fundamentals Data.
*FundamentalsPointInTimeApi* | [**post_fundamentals_fiscal_periods**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FundamentalsPointInTimeApi.md#post_fundamentals_fiscal_periods) | **POST** /periods | Fiscal Periods: Retrieve fiscal period details for multiple securities using POST.
*FundamentalsPointInTimeApi* | [**post_fundamentals_pit_data**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FundamentalsPointInTimeApi.md#post_fundamentals_pit_data) | **POST** /point-in-time | Retrieve Point-in-Time data for multiple securities.
...
## Documentation For Models
 ...
 - [FrequencyEnum](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FrequencyEnum.md)
 ...
 - [FundamentalsPITData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FundamentalsPITData.md)
 - [FundamentalsPITRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FundamentalsPITRequest.md)
 - [FundamentalsPITRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FundamentalsPITRequestBody.md)
 - [FundamentalsPITResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/FundamentalsPITResponse.md)
 ...
 - [IdentifierList](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/IdentifierList.md)
 ...
 - [MetricList](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/MetricList.md)
 ...
 - [PeriodInfo](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/PeriodInfo.md)
 - [Periodicity](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/Periodicity.md)
 - [PeriodicityEnum](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/PeriodicityEnum.md)
 - [PeriodsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/PeriodsRequest.md)
 - [PeriodsRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/PeriodsRequestBody.md)
 - [PeriodsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFundamentals/v2/docs/PeriodsResponse.md)
