...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetFundamentals/2.4.0)](https://pypi.org/project/fds.sdk.FactSetFundamentals/v/2.4.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetFundamentals==2.4.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetFundamentals==2.4.0
```
