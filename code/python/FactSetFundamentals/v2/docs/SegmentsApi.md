# fds.sdk.FactSetFundamentals.SegmentsApi

All URIs are relative to *https://api.factset.com/content/factset-fundamentals/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_fds_segments_for_list**](SegmentsApi.md#get_fds_segments_for_list) | **POST** /segments | Returns Company Segment Data.



# **get_fds_segments_for_list**
> SegmentsResponse get_fds_segments_for_list(segments_request)
...
with fds.sdk.FactSetFundamentals.ApiClient(configuration) as api_client:
    ...
    ) # SegmentsRequest | Request object for requesting segments data

    try:
        # Returns Company Segment Data.
        # example passing only required values which don't have defaults set
        api_response_wrapper = api_instance.get_fds_segments_for_list(segments_request)
        ...
        print("Exception when calling SegmentsApi->get_fds_segments_for_list: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **segments_request** | [**SegmentsRequest**](SegmentsRequest.md)| Request object for requesting segments data |
...
- **200**: [**SegmentsResponse**](SegmentsResponse.md)
