...
from fds.sdk.ProcuretoPayInvoiceandBilling import rest
from fds.sdk.ProcuretoPayInvoiceandBilling.configuration import Configuration
from fds.sdk.ProcuretoPayInvoiceandBilling.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ProcuretoPayInvoiceandBilling.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ProcuretoPayInvoiceandBilling/0.2.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = InvoiceAndBillingApi()
        api_instance.download_invoice  # this is an instance of the class Endpoint
        api_instance.download_invoice()  # this invokes api_instance.download_invoice.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.download_invoice.callable or self.callable in this class
