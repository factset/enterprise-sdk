...
class NewsArticleListMetaSubscription(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'minimum_interval': (float,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewsArticleListMetaSubscription - a model defined in OpenAPI

        Args:

        Keyword Args:
            minimum_interval (float): Non-negative number of milliseconds to throttle the update rate from 0ms to 5000ms. Set to 0 for sending updates immediately.. defaults to 0  # noqa: E501
        ...
        minimum_interval = kwargs.get('minimum_interval', 0)
