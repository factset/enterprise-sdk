...
from fds.sdk.NewsAPIforDigitalPortals import rest
from fds.sdk.NewsAPIforDigitalPortals.configuration import Configuration
from fds.sdk.NewsAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.NewsAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/NewsAPIforDigitalPortals/0.10.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = NewsApi()
        api_instance.get_news_article_get  # this is an instance of the class Endpoint
        api_instance.get_news_article_get()  # this invokes api_instance.get_news_article_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_news_article_get.callable or self.callable in this class
