...
def lazy_import():
    ...
    globals()['TranscriptsResult'] = TranscriptsResult
...
class TranscriptsResponseData(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'TranscriptsResult': TranscriptsResult,
            'documentResult': TranscriptsResult,
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            time_zone (str): Time Zone for story dates/times (POSIX format from IANA timeZone registry). Note: The timeZone will be included in the response only for TranscriptsByTimesRequest.. [optional] if omitted the server will use the default value of "America/New_York"  # noqa: E501
