...
class TranscriptsRequestData(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            end_date (date): End Date (YYYY-MM-DD). . [optional]  # noqa: E501
            start_date_relative (int): Start date relative to today (0=today, -1=yesterday). *Either `startDate` or `startDateRelative` should be used.* . [optional]  # noqa: E501
            ...
            start_date_time (datetime): The date from which data is required . [optional]  # noqa: E501
            end_date_time (datetime): The date to which data is required . [optional]  # noqa: E501
