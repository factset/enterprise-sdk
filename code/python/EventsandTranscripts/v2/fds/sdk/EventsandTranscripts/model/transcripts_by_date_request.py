...
class TranscriptsByDateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start_date (date): Start Date (YYYY-MM-DD). Data available from April 21st, 1999 onwards. *Either `startDate` or `startDateRelative` should be used.* . [optional]  # noqa: E501
            end_date (date): End Date (YYYY-MM-DD). *Either `endDate` or `endDateRelative` should be used.* . [optional]  # noqa: E501
