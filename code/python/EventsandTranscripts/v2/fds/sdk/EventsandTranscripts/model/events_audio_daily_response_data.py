...
class EventsAudioDailyResponseData(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EventsAudioDailyResponseData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            trimmed (bool): The trimmed attribute indicates whether the audio is a trimmed version.   - If **true**, the audio has been trimmed.   - If **false**, the full-length version is used.   Note: If `audioSource` is set to `vendor`, this attribute will always be true. . [optional]  # noqa: E501
            ...
            start_time (datetime, none_type): The official timestamp when FactSet begins the recording.. [optional]  # noqa: E501
            end_time (datetime, none_type): The official timestamp when FactSet ends the recording.. [optional]  # noqa: E501
            upload_time (datetime, none_type): The official timestamp when FactSet publishes the audio file externally.. [optional]  # noqa: E501
