...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.EventsandTranscripts/2.1.3)](https://pypi.org/project/fds.sdk.EventsandTranscripts/v/2.1.3)
...
```shell
poetry add fds.sdk.utils fds.sdk.EventsandTranscripts==2.1.3
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.EventsandTranscripts==2.1.3
```
