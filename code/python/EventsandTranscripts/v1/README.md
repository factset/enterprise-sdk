...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.EventsandTranscripts/0.21.9)](https://pypi.org/project/fds.sdk.EventsandTranscripts/v/0.21.9)
...
```shell
poetry add fds.sdk.utils fds.sdk.EventsandTranscripts==0.21.9
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.EventsandTranscripts==0.21.9
```
