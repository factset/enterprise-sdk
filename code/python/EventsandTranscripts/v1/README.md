...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.EventsandTranscripts/0.21.8)](https://pypi.org/project/fds.sdk.EventsandTranscripts/v/0.21.8)
...
```shell
poetry add fds.sdk.utils fds.sdk.EventsandTranscripts==0.21.8
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.EventsandTranscripts==0.21.8
```
