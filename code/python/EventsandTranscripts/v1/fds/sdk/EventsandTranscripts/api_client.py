...
from fds.sdk.EventsandTranscripts import rest
from fds.sdk.EventsandTranscripts.configuration import Configuration
from fds.sdk.EventsandTranscripts.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.EventsandTranscripts.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/EventsandTranscripts/0.21.9 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CalendarEventsApi()
        api_instance.get_company_event  # this is an instance of the class Endpoint
        api_instance.get_company_event()  # this invokes api_instance.get_company_event.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_company_event.callable or self.callable in this class
