...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetPrices/3.0.1)](https://pypi.org/project/fds.sdk.FactSetPrices/v/3.0.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetPrices==3.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetPrices==3.0.1
```
