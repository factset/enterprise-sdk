...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetPrices/1.1.14)](https://pypi.org/project/fds.sdk.FactSetPrices/v/1.1.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetPrices==1.1.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetPrices==1.1.14
```
