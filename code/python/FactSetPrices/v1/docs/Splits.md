...
**split_factor** | **float** | Split adjustment factor for n splits ago. A 2-for-1 split returns .50, the number you would multiply the stock price by to adjust for the split. | [optional] 
**split_comment** | **str** | Description for the type of split or spin off. | [optional] 
