...
**date** | **date, none_type** | Ex-Date of the split expressed in YYYY-MM-DD format. | [optional] 
**split_factor** | **float, none_type** | Split adjustment factor for n splits ago. A 2-for-1 split returns .50, the number you would multiply the stock price by to adjust for the split. | [optional] 
**split_comment** | **str, none_type** | Description for the type of split or spin off. | [optional] 
