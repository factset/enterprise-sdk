...
class DividendsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_security_dividends_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (DividendsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_security_dividends_async(
        self,
        ids,
        **kwargs
    ...
    def get_security_dividends_with_http_info_async(
        self,
        ids,
        **kwargs
    ...
    def get_security_dividends_for_list_with_http_info(
        self,
        dividends_request,
        **kwargs
    ) -> typing.Tuple[DividendsResponse, int, typing.MutableMapping]:
    ...
    def get_security_dividends_for_list_async(
        self,
        dividends_request,
        **kwargs
    ) -> "ApplyResult[DividendsResponse]":
    ...
    def get_security_dividends_for_list_with_http_info_async(
        self,
        dividends_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[DividendsResponse, int, typing.MutableMapping]]":
