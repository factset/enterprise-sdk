...
class PricesApi(object):
    ...
    def get_security_prices(
        ...
        **kwargs
        ...
        Gets security prices, Open, High, Low, Close, Volume, and currency for a specified date range and frequency. Prices are updated and at different times across the different regions around the globe. The Prices API automatically defaults relative price dates to the local region which is determined by the local region of the requested security id. To learn more about relative dates please visit [OA Page 4627](https://my.apps.factset.com/oa/pages/4627)   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_security_prices_for_list(
        ...
        **kwargs
        ...
        """Requests end-of-day Open, High, Low, Close for a large list of securities.  # noqa: E501
         ...
         Gets security prices, Open, High, Low, Close, Volume, and currency for a specified date range and frequency.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
