...
class GetMarketValueResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetMarketValueResponseWrapper
    ...
    def get_response_200(self) -> MarketValueResponse:
        ...
        Returns: Array of company market capitalization values.
        """
...
class GetMarketValueForListResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetMarketValueForListResponseWrapper
        to status_code, response
...
class MarketValueApi(object):
    ...
    def get_market_value_with_http_info(
        ...
        ids,
        **kwargs
    ) -> typing.Tuple[GetMarketValueResponseWrapper, int, typing.MutableMapping]:
        """Gets the security level and company level market values for a list of `ids` as of given date range and frequency.  # noqa: E501
    ...
    def get_market_value_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[GetMarketValueResponseWrapper]":
        """Gets the security level and company level market values for a list of `ids` as of given date range and frequency.  # noqa: E501
    ...
    def get_market_value_with_http_info_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetMarketValueResponseWrapper, int, typing.MutableMapping]]":
        """Gets the security level and company level market values for a list of `ids` as of given date range and frequency.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetMarketValueResponseWrapper, int, typing.Dict)]
        """
    ...
    def get_market_value_for_list_with_http_info(
        ...
        market_value_request,
        **kwargs
    ) -> typing.Tuple[GetMarketValueForListResponseWrapper, int, typing.MutableMapping]:
        """Requests the market value for a list of `ids` as of given date range.  # noqa: E501
    ...
    def get_market_value_for_list_async(
        ...
        market_value_request,
        **kwargs
    ) -> "ApplyResult[GetMarketValueForListResponseWrapper]":
        """Requests the market value for a list of `ids` as of given date range.  # noqa: E501
    ...
    def get_market_value_for_list_with_http_info_async(
        ...
        market_value_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetMarketValueForListResponseWrapper, int, typing.MutableMapping]]":
        """Requests the market value for a list of `ids` as of given date range.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetMarketValueForListResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['market_value_request'] = \
            market_value_request
