...
from fds.sdk.FactSetPrices import rest
from fds.sdk.FactSetPrices.configuration import Configuration
from fds.sdk.FactSetPrices.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPrices.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetPrices/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DatabaseRolloverApi()
        api_instance.get_database_rollover  # this is an instance of the class Endpoint
        api_instance.get_database_rollover()  # this invokes api_instance.get_database_rollover.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_database_rollover.callable or self.callable in this class
