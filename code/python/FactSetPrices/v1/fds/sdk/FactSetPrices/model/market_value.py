...
class MarketValue(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'entity_market_value': (float, none_type,),  # noqa: E501
            'entity_market_value_ex_non_traded': (float, none_type,),  # noqa: E501
            'security_market_value': (float, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            entity_market_value_ex_non_traded (float, none_type): Aggregate across all share classes and excludes non-traded shares. Values are in base units. For more details visit [Online Assistant Page #16867](https://my.apps.factset.com/oa/pages/16867).. [optional]  # noqa: E501
            security_market_value (float, none_type): Returns the security level market value calculated as the share price multiplied by the number of shares at the security level. **Note:** History is available back to Oct-1999 for North American securities, and 1-Jan-2001 for non-North American securities.. [optional]  # noqa: E501
