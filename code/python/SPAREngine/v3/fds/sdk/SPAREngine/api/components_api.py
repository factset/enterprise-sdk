...
class ComponentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_spar_component_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SPARComponentRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_spar_components_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ComponentSummaryRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_spar_component_by_id(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_spar_component_by_id_endpoint.call_with_http_info(**kwargs)

    def get_spar_component_by_id_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[SPARComponentRoot, int, typing.MutableMapping]:
        """Get SPAR component by id  # noqa: E501
    ...
    def get_spar_component_by_id_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[SPARComponentRoot]":
        """Get SPAR component by id  # noqa: E501
    ...
    def get_spar_component_by_id_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SPARComponentRoot, int, typing.MutableMapping]]":
        """Get SPAR component by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(SPARComponentRoot, int, typing.Dict)]
        """
