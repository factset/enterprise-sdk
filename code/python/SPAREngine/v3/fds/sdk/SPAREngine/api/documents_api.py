...
class DocumentsApi(object):
    ...
    def get_spar3_documents(
        self,
        path="SPAR_DOCUMENTS:Factset Default Document",
        **kwargs
        ...
        Args:
            path (str): The directory to get the documents in. defaults to "SPAR_DOCUMENTS:Factset Default Document", must be one of ["SPAR_DOCUMENTS:Factset Default Document"]
