...
class SPARCalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_calculation_by_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/spar/v3/calculations/{id}',
        ...
        self.get_calculation_parameters_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SPARCalculationParametersRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_calculation_status_by_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/spar/v3/calculations/{id}/status',
        ...
        self.get_calculation_unit_result_by_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/spar/v3/calculations/{id}/units/{unitId}/result',
        ...
        self.post_and_calculate_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/spar/v3/calculations',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'spar_calculation_parameters_root': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_calculation_parameters(
        ...
        **kwargs
        ...
        """Get SPAR calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_with_http_info(
        ...
        id,
        **kwargs
    ) -> typing.Tuple[SPARCalculationParametersRoot, int, typing.MutableMapping]:
        """Get SPAR calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[SPARCalculationParametersRoot]":
        """Get SPAR calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_with_http_info_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SPARCalculationParametersRoot, int, typing.MutableMapping]]":
        """Get SPAR calculation parameters by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(SPARCalculationParametersRoot, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['id'] = \
            id
    ...
    def get_calculation_status_by_id(
        ...
        **kwargs
        ...
        """Get SPAR calculation status by id  # noqa: E501
    ...
    def get_calculation_unit_result_by_id(
        ...
        **kwargs
        ...
        """Get SPAR calculation result by id  # noqa: E501
    ...
    def post_and_calculate(
        ...
        **kwargs
        ...
        """Create and Run SPAR calculation  # noqa: E501

        This endpoint runs the SPAR calculation specified in the POST body parameters.  It can take one or more units as input.    Remarks:    * Any settings in POST body will act as a one-time override over the settings saved in the SPAR template.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def put_and_calculate(
        ...
        **kwargs
        ...
        """Create or Update SPAR calculation and run it.  # noqa: E501

        This endpoint updates and run the SPAR calculation specified in the PUT body parameters. This also allows creating new SPAR calculations with custom ids.  It can take one or more units as input.    Remarks:    * Any settings in PUT body will act as a one-time override over the settings saved in the SPAR template.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
