...
from fds.sdk.SPAREngine import rest
from fds.sdk.SPAREngine.configuration import Configuration
from fds.sdk.SPAREngine.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.SPAREngine.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/SPAREngine/2.0.1 ({platform.system()}, Python {platform.python_version()})'
