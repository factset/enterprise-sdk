...
def lazy_import():
    ...
    globals()['SPARDateParameters'] = SPARDateParameters
    globals()['SPARIdentifier'] = SPARIdentifier


class SPARCalculationParameters(ModelNormal):
    ...
    def _from_openapi_data(cls, componentid, *args, **kwargs):  # noqa: E501
        """SPARCalculationParameters - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            accounts ([SPARIdentifier], none_type): List of accounts for SPAR calculation.. [optional]  # noqa: E501
            ...
            universeid (str, none_type): Universe ID code for calculation. Can be fetched from peer universe endpoint(/analytics/engines/spar/v3/peer-universe). [optional]  # noqa: E501
        """
