...
def lazy_import():
    ...
    globals()['SPARPeerUniverseListResponse'] = SPARPeerUniverseListResponse


class SPARPeerUniverseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (SPARPeerUniverseListResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SPARPeerUniverseRoot - a model defined in OpenAPI

        Args:
            data (SPARPeerUniverseListResponse):
