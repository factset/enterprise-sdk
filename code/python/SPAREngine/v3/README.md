...
```shell
poetry add fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.SPAREngine==2.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.protobuf.stach.extensions fds.sdk.SPAREngine==2.0.1
```
