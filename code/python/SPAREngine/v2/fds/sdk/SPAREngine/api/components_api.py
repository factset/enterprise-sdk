...
class ComponentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_spar_components_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/lookups/v2/engines/spar/components',
    ...
    def get_spar_components_with_http_info(
        self,
        document="Client:Foo",
        **kwargs
    ...
    def get_spar_components_with_http_info_async(
        self,
        document="Client:Foo",
        **kwargs
