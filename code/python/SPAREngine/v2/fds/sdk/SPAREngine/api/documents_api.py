...
class DocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_spar3_documents_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/lookups/v2/engines/spar/documents/{path}',
    ...
    def get_spar3_documents_with_http_info(
        self,
        path="Client:folder1/folder2",
        **kwargs
    ...
    def get_spar3_documents_with_http_info_async(
        self,
        path="Client:folder1/folder2",
        **kwargs
