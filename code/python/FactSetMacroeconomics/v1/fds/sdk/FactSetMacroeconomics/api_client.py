...
from fds.sdk.FactSetMacroeconomics import rest
from fds.sdk.FactSetMacroeconomics.configuration import Configuration
from fds.sdk.FactSetMacroeconomics.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetMacroeconomics.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetMacroeconomics/0.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AsReportedEconomicsApi()
        api_instance.get_as_reported_economics  # this is an instance of the class Endpoint
        api_instance.get_as_reported_economics()  # this invokes api_instance.get_as_reported_economics.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_as_reported_economics.callable or self.callable in this class
