...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetRBICS/1.0.3)](https://pypi.org/project/fds.sdk.FactSetRBICS/v/1.0.3)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetRBICS==1.0.3
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetRBICS==1.0.3
```
