...
with fds.sdk.FactSetRBICS.ApiClient(configuration) as api_client:
    ...
    rbics_ids = ["101010000000","55"] # [str] | RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry.  (optional)
...
------------- | ------------- | ------------- | -------------
 **rbics_ids** | **[str]**| RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry.  | [optional]
