...
class RbicsL6Ids(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RbicsL6Ids - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): RBICS Level 6 Sub-Industry ID Filter. **Note**: Only Level 6 IDs are supported for this endpoint. A complete list of valid Level 6 IDs can be retrieved using the `/structure` endpoints..  # noqa: E501

        Keyword Args:
            value ([str]): RBICS Level 6 Sub-Industry ID Filter. **Note**: Only Level 6 IDs are supported for this endpoint. A complete list of valid Level 6 IDs can be retrieved using the `/structure` endpoints..  # noqa: E501
