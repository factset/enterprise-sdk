...
class Levels(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Levels - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([int]): List of RBICS industry levels to include in the response. **By default if left blank, all levels are returned.** .  # noqa: E501

        Keyword Args:
            value ([int]): List of RBICS industry levels to include in the response. **By default if left blank, all levels are returned.** .  # noqa: E501
