...
class RbicsIds(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RbicsIds - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested. .  # noqa: E501

        Keyword Args:
            value ([str]): RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested. .  # noqa: E501
