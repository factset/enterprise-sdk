...
def lazy_import():
    ...
    globals()['RbicsIndustryIds'] = RbicsIndustryIds


class IndustryRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'rbics_ids': (RbicsIndustryIds,),  # noqa: E501
    ...
    def _from_openapi_data(cls, rbics_ids, *args, **kwargs):  # noqa: E501
        """IndustryRequest - a model defined in OpenAPI

        Args:
            rbics_ids (RbicsIndustryIds):
