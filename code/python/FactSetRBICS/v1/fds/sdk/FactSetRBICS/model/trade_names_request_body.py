...
def lazy_import():
    ...
    globals()['TradeNamesIds'] = TradeNamesIds


class TradeNamesRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """TradeNamesRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            as_of_date (date): Effective date for data expressed in YYYY-MM-DD format. This means the as of date will be in between the start and end date returned. Note that it's possible the end date returned can be null, meaning the tradeName is still active. If no date is requested, the default behavior is to return the latest active data. . [optional]  # noqa: E501
        """
