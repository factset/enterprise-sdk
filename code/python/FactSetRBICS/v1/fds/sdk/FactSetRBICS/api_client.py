...
from fds.sdk.FactSetRBICS import rest
from fds.sdk.FactSetRBICS.configuration import Configuration
from fds.sdk.FactSetRBICS.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetRBICS.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetRBICS/2.0.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntityApi()
        api_instance.get_rbics_entity_focus  # this is an instance of the class Endpoint
        api_instance.get_rbics_entity_focus()  # this invokes api_instance.get_rbics_entity_focus.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_rbics_entity_focus.callable or self.callable in this class
