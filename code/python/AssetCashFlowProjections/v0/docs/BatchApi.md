...
------------- | ------------- | -------------
[**get_batch_job_result**](BatchApi.md#get_batch_job_result) | **GET** /batch/{batchId}/result | Get Batch Job result by ID
[**get_batch_status**](BatchApi.md#get_batch_status) | **GET** /batch/{batchId}/status | Get Batch status by ID
[**post_batch**](BatchApi.md#post_batch) | **POST** /batch | Trigger batch job



# **get_batch_job_result**
> BatchJobResult get_batch_job_result(batch_id)
...
with fds.sdk.AssetCashFlowProjections.ApiClient(configuration) as api_client:
    ...
    batch_id = "batchId_example" # str | Batch Job ID

    try:
        # Get Batch Job result by ID
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_batch_job_result(batch_id)

        pprint(api_response)

    except fds.sdk.AssetCashFlowProjections.ApiException as e:
        print("Exception when calling BatchApi->get_batch_job_result: %s\n" % e)
```
...
# **get_batch_status**
> BatchJobStatus get_batch_status(batch_id)
...
with fds.sdk.AssetCashFlowProjections.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BatchApi->get_batch_status: %s\n" % e)
```
