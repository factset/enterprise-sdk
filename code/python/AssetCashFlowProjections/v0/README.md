...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.AssetCashFlowProjections/0.10.2)](https://pypi.org/project/fds.sdk.AssetCashFlowProjections/v/0.10.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.AssetCashFlowProjections==0.10.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.AssetCashFlowProjections==0.10.2
```
