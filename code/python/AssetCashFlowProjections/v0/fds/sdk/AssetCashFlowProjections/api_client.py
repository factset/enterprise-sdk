...
from fds.sdk.AssetCashFlowProjections import rest
from fds.sdk.AssetCashFlowProjections.configuration import Configuration
from fds.sdk.AssetCashFlowProjections.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.AssetCashFlowProjections.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/AssetCashFlowProjections/0.12.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BatchApi()
        api_instance.get_batch_job_result  # this is an instance of the class Endpoint
        api_instance.get_batch_job_result()  # this invokes api_instance.get_batch_job_result.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_batch_job_result.callable or self.callable in this class
