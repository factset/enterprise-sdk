...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/AssetCashFlowProjections/0.10.3 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.post_batch  # this is an instance of the class Endpoint
        api_instance.post_batch()  # this invokes api_instance.post_batch.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.post_batch.callable or self.callable in this class
