...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/AssetCashFlowProjections/0.10.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ScenariosApi()
        api_instance.get_upload_status  # this is an instance of the class Endpoint
        api_instance.get_upload_status()  # this invokes api_instance.get_upload_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_upload_status.callable or self.callable in this class
