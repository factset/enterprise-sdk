...
class DocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_document_details_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UpdateDocument,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_documents_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (DocumentResponse,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_document_details_with_http_info(
        ...
        document_path,
        **kwargs
    ) -> typing.Tuple[UpdateDocument, int, typing.MutableMapping]:
        """Retrieve a document  # noqa: E501
    ...
    def get_document_details_with_http_info_async(
        ...
        document_path,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UpdateDocument, int, typing.MutableMapping]]":
        """Retrieve a document  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(UpdateDocument, int, typing.Dict)]
        """
    ...
    def get_documents(
        ...
        **kwargs
        ...
        """Gives all the ACFP documents in the given directory.  # noqa: E501

        Provides the list of all documents in a specified directory  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_documents_with_http_info(
        ...
        directory_path,
        **kwargs
    ) -> typing.Tuple[DocumentResponse, int, typing.MutableMapping]:
        """Gives all the ACFP documents in the given directory.  # noqa: E501
    ...
    def get_documents_with_http_info_async(
        self,
        directory_path,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[DocumentResponse, int, typing.MutableMapping]]":
        """Gives all the ACFP documents in the given directory.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(DocumentResponse, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['directory_path'] = \
            directory_path
    ...
    def put_document(
        ...
        **kwargs
        ...
        Keyword Args:
            update_document (UpdateDocument): [optional]
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
                Default is True. NOTE: if this API returns a file, it is the responsibility
                of the caller to close the file stream.
