...
class ClientScenariosUploadParameters(ModelNormal):
    ...
    validations = {
        ('file_name',): {
            'max_length': 41,
            'regex': {
                'pattern': r'^.*\.(csv|scn|fac|rts|CSV|SCN|FAC|RTS)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'replace_special_characters': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'replace_special_characters': 'replaceSpecialCharacters',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, as_of_date, file_name, *args, **kwargs):  # noqa: E501
        """ClientScenariosUploadParameters - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            overwrite (bool): Flag to indicate if existing file needs to be overwritten. Please expect a 409 if the file already exists and the overwrite is not set to true.. [optional] if omitted the server will use the default value of False  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, as_of_date, file_name, *args, **kwargs):  # noqa: E501
        """ClientScenariosUploadParameters - a model defined in OpenAPI
