...
from fds.sdk.StandardDatafeed import rest
from fds.sdk.StandardDatafeed.configuration import Configuration
from fds.sdk.StandardDatafeed.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.StandardDatafeed.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/StandardDatafeed/0.21.15 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SDFAndQFLContentLibraryApi()
