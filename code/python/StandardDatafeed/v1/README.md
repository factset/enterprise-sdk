...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.StandardDatafeed/0.21.16)](https://pypi.org/project/fds.sdk.StandardDatafeed/v/0.21.16)
...
```shell
poetry add fds.sdk.utils fds.sdk.StandardDatafeed==0.21.16
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.StandardDatafeed==0.21.16
```
