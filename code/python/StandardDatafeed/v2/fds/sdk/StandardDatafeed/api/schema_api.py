...
class SchemaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_list_schemaswithoutwithoout_required_parameters_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ListSchema,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'operation_id': 'get_list_schemaswithoutwithoout_required_parameters',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_schema_details_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SchemaDetail,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_list_schemaswithoutwithoout_required_parameters(
        self,
        **kwargs
    ) -> ListSchema:
        """List of Standard DataFeed (SDF) schemas.  # noqa: E501

        This helper endpoint provides the list of schemas subscribed by the client and their corresponding versions.   # noqa: E501
        ...
        return self.get_list_schemaswithoutwithoout_required_parameters_endpoint.call_with_http_info(**kwargs)

    def get_list_schemaswithoutwithoout_required_parameters_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[ListSchema, int, typing.MutableMapping]:
        """List of Standard DataFeed (SDF) schemas.  # noqa: E501
    ...
    def get_list_schemaswithoutwithoout_required_parameters_async(
        self,
        **kwargs
    ) -> "ApplyResult[ListSchema]":
        """List of Standard DataFeed (SDF) schemas.  # noqa: E501
    ...
    def get_list_schemaswithoutwithoout_required_parameters_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[ListSchema, int, typing.MutableMapping]]":
        """List of Standard DataFeed (SDF) schemas.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(ListSchema, int, typing.Dict)]
        """
    ...
    def get_schema_details(
        ...
        **kwargs
        ...
        If the schema and version number are passed in the request, this endpoint provides a pre-signed URL pointing to the location from where the schema details can be downloaded.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        kwargs['version'] = \
            version
        return self.get_schema_details_endpoint.call_with_http_info(**kwargs)

    def get_schema_details_with_http_info(
        self,
        schema,
        version,
        **kwargs
    ) -> typing.Tuple[SchemaDetail, int, typing.MutableMapping]:
        """Schema Details.  # noqa: E501
    ...
    def get_schema_details_async(
        self,
        schema,
        version,
        **kwargs
    ) -> "ApplyResult[SchemaDetail]":
        """Schema Details.  # noqa: E501
    ...
    def get_schema_details_with_http_info_async(
        self,
        schema,
        version,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SchemaDetail, int, typing.MutableMapping]]":
        """Schema Details.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(SchemaDetail, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['schema'] = \
            schema
