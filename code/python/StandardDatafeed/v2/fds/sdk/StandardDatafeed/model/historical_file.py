...
def lazy_import():
    ...
    globals()['HistoricalFileObject'] = HistoricalFileObject
    globals()['Meta'] = Meta


class HistoricalFile(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([HistoricalFileObject],),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """HistoricalFile - a model defined in OpenAPI

        Args:
            data ([HistoricalFileObject]): Historical Files Data Array.
