...
def lazy_import():
    ...
    globals()['ListSchemaObject'] = ListSchemaObject


class ListSchema(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ListSchemaObject],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListSchema - a model defined in OpenAPI

        Args:
            data ([ListSchemaObject]): Schema List Data Array.
