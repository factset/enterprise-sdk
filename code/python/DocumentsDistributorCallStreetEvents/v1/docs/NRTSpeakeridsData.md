...
**cosine_score** | **float, none_type** | The cosine similarity score (Confidence score)  for a particular speaker.  A score &gt;&#x3D; 0.49 while a speaker is speaking can be considered as a high confidence in the predicted speaker.  Only the SpeakerIDs with the highest cosineScore are rendered in the result set. | [optional] 
**affiliation_id** | **str, none_type** | Affiliation ID denotes the company a speaker is associated with. | [optional] 
