...
setup(
    name=NAME,
    version=VERSION,
    description="FactSet SDK - Documents Distributor - CallStreet Events",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/master/code/python/DocumentsDistributorCallStreetEvents",
