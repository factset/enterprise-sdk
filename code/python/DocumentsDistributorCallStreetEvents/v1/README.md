...
```shell
poetry add fds.sdk.utils fds.sdk.DocumentsDistributorCallStreetEvents==0.21.17
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.DocumentsDistributorCallStreetEvents==0.21.17
```
