...
from fds.sdk.DocumentsDistributorCallStreetEvents import rest
from fds.sdk.DocumentsDistributorCallStreetEvents.configuration import Configuration
from fds.sdk.DocumentsDistributorCallStreetEvents.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.DocumentsDistributorCallStreetEvents.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/DocumentsDistributorCallStreetEvents/0.21.20 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EventsAudioApi()
        api_instance.get_docs_distributor_audio_v1_history_files  # this is an instance of the class Endpoint
        api_instance.get_docs_distributor_audio_v1_history_files()  # this invokes api_instance.get_docs_distributor_audio_v1_history_files.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_docs_distributor_audio_v1_history_files.callable or self.callable in this class
