...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/DocumentsDistributorCallStreetEvents/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_docs_distributor_audio_v1_list_files  # this is an instance of the class Endpoint
        api_instance.get_docs_distributor_audio_v1_list_files()  # this invokes api_instance.get_docs_distributor_audio_v1_list_files.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_docs_distributor_audio_v1_list_files.callable or self.callable in this class
