...
class NearRealTimeTranscriptsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_bulk_documents_nrt_v1_calls_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (NRTCalls,), 400: (NRTCalls400Response,), 401: (Error,), 403: (NRT403Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_bulk_documents_nrt_v1_indexed_nrt_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (IndexedNRT,), 400: (NRTSnippets400Response,), 401: (Error,), 403: (NRT403Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_bulk_documents_nrt_v1_list_snippets_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (NRTSnippets,), 400: (NRTSnippets400Response,), 401: (Error,), 403: (NRT403Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_bulk_documents_nrt_v1_speakerids_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (NRTSpeakerids,), 400: (NRTSpeakerids400Response,), 401: (Error,), 403: (NRT403Error,), 500: (Error,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
