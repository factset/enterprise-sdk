...
class EventsAudioApi(object):
    ...
    def get_docs_distributor_audio_v1_history_files(
        ...
        **kwargs
        ...
        Returns the historical audio recordings and related metadata dating back from May 10, 2011 to Sep 30, 2022.  Query parameters can be used to filter and narrow down the results.  # noqa: E501
