...
class EventsAudioData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'duration_secs': (float,),  # noqa: E501
            'end_offset_seconds': (float,),  # noqa: E501
            'start_offset_seconds': (float,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EventsAudioData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            url (str): Download link for the audio file. [optional]  # noqa: E501
            file_name (str): The filename of the audio file. [optional]  # noqa: E501
            duration_secs (float): Total duration of the recording in seconds based on startOffsetSeconds to endOffsetSeconds. [optional]  # noqa: E501
            end_offset_seconds (float): The delta in seconds between startTime to when FactSet marks the end of the call. [optional]  # noqa: E501
            start_offset_seconds (float): The delta in seconds between start of audio file to when FactSet marks the beginning of the call. [optional]  # noqa: E501
            source_code (str): Identifies the method of how the event is recorded Below are the descriptions for each Source Code - * P = Phone * W = Webcast * V = Vendor * I = Webcast Replay * F = Flash - identical to webcast; can merge with \"W\" in the future * R = Replay (Phone Replay). [optional]  # noqa: E501
            start_time (str): The official timestamp when FactSet begins the recording. [optional]  # noqa: E501
            end_time (str): The official timestamp when FactSet ends the recording. [optional]  # noqa: E501
            upload_time (str): The official timestamp when FactSet publishes the audio file externally. [optional]  # noqa: E501
            file_size (float): Size of the Audio file, in bytes. [optional]  # noqa: E501
            report_id (int): The unique ID of the audio file for an event. The same ID is used for the transcript of the same event. [optional]  # noqa: E501
            ...
            trimmed (bool): The trimmed attribute helps identify if the audio is the trimmed version. [optional]  # noqa: E501
            sample_rate (float): The number of samples of audio carried per second in Kbps. [optional]  # noqa: E501
            bitrate (float): The total number of bits of information stored per second of sound in Kbps. [optional]  # noqa: E501
            audio_source_id (int): Unique ID for an Internal recording specific to reportID. For example, ReportID X would have multiple recordings from different source (Phone or Webcast or Vendor or Replay). One ReportID can have multiple AudioSource ids.. [optional]  # noqa: E501
        """
