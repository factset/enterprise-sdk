...
class NRTSpeakeridsMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NRTSpeakeridsMetaPagination - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total (int): Total number of results the API returns for a particular query. [optional]  # noqa: E501
            is_estimated_total (bool): Boolean value that represents whether the total count of results returned is exact or an estimate. This is defaulted to False as the API should always return the exact count. [optional]  # noqa: E501
            limit (int): Number of results returned per page. [optional]  # noqa: E501
            offset (int): The flag indicating the position in the results array if additional results are available beyond the default value or the value in paginationLimit parameter (if used). This value is passed in the _paginationOffset parameter to retrieve subsequent results. [optional]  # noqa: E501
        """
