...
class NRTCallsData(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NRTCallsData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            source_code (str): Identifier for the source of how the event is recorded. P:- Phone Replay W:- Webcast. [optional]  # noqa: E501
            audio_source_id (int): Unique ID for an Internal recording specific to reportID. For example, ReportID X would have multiple recordings from different source (dial-in - P or webcast - W). One reportId can have multiple audiosource ids.. [optional]  # noqa: E501
            recording_start_time (str): The official UTC timestamp when FactSet starts the recording. [optional]  # noqa: E501
            ...
            event_type (str): Refers to the various event types covered by FactSet CallStreet - * Analyst, Investor & Shareholder Meeting => AS * Earnings Call => E * Earnings Release => ER * Guidance => G * Sales & Revenue Call => SA * Sales & Revenue Release => SR * Special & M&A (Special Situation) => SS. [optional]  # noqa: E501
            event_title (str): Title of the Event. [optional]  # noqa: E501
            event_datetime_utc (str): The official UTC timestamp of the start of the event. [optional]  # noqa: E501
        """
