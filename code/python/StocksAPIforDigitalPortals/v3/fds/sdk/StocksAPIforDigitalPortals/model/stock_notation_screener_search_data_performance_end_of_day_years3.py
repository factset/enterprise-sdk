...
class StockNotationScreenerSearchDataPerformanceEndOfDayYears3(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataPerformanceEndOfDayYears3 - a model defined in OpenAPI
