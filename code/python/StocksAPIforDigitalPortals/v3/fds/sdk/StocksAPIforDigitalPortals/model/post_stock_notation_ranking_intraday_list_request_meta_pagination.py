...
class PostStockNotationRankingIntradayListRequestMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationRankingIntradayListRequestMetaPagination - a model defined in OpenAPI
