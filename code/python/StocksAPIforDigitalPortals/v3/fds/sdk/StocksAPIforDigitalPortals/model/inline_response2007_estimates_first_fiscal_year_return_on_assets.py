...
class InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets - a model defined in OpenAPI
