...
class StockNotationScreenerSearchDataRatiosEnterpriseValueEbit(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataRatiosEnterpriseValueEbit - a model defined in OpenAPI
