...
class StockNotationScreenerSearchDataCurrencyDependentKeyFiguresPerShareDividends(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataCurrencyDependentKeyFiguresPerShareDividends - a model defined in OpenAPI
