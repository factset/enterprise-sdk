...
class InlineResponse2007EstimatesFirstFiscalYearRatiosPriceSales(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2007EstimatesFirstFiscalYearRatiosPriceSales - a model defined in OpenAPI
