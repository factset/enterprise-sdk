...
class PostStockNotationScreenerSearchRequestDataIndexMembership(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationScreenerSearchRequestDataIndexMembership - a model defined in OpenAPI
