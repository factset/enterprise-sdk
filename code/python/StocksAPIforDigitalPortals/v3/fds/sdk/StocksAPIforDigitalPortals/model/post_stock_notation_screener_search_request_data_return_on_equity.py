...
class PostStockNotationScreenerSearchRequestDataReturnOnEquity(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationScreenerSearchRequestDataReturnOnEquity - a model defined in OpenAPI
