...
class PostStockNotationScreenerSearchRequestDataReturnOnAssets(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationScreenerSearchRequestDataReturnOnAssets - a model defined in OpenAPI
