...
class PostStockNotationScreenerSearchRequestDataNetIncomeMargin(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationScreenerSearchRequestDataNetIncomeMargin - a model defined in OpenAPI
