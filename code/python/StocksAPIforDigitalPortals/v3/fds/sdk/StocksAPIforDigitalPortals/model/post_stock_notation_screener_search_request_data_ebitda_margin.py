...
class PostStockNotationScreenerSearchRequestDataEbitdaMargin(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationScreenerSearchRequestDataEbitdaMargin - a model defined in OpenAPI
