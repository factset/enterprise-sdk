...
class InlineResponse2008DataEstimatesFirstFiscalYearFiscalYear(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2008DataEstimatesFirstFiscalYearFiscalYear - a model defined in OpenAPI
