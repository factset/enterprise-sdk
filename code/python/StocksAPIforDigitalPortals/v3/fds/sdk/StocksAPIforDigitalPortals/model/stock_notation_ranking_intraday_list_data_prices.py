...
class StockNotationRankingIntradayListDataPrices(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationRankingIntradayListDataPrices - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            quality (str): Quality of the trade-related attributes, see attributes `trade` and `accumulated` in the response.. [optional] if omitted the server will use the default value of "DLY"  # noqa: E501
        """
