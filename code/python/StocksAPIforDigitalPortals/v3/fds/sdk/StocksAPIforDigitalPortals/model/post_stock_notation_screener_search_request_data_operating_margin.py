...
class PostStockNotationScreenerSearchRequestDataOperatingMargin(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockNotationScreenerSearchRequestDataOperatingMargin - a model defined in OpenAPI
