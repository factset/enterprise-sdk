...
class PostStockDividendListRequestMeta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostStockDividendListRequestMeta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sort ([str]): Sortable attributes. The sort order is ascending unless it is prefixed with a minus sign, in which case it is descending. A list of at most 4 (possibly prefixed) attribute name(s) is allowed.. [optional] if omitted the server will use the default value of ["dividends.dates.payment"]  # noqa: E501
        """
