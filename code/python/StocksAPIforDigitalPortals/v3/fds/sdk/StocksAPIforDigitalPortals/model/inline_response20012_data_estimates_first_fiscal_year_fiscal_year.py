...
class InlineResponse20012DataEstimatesFirstFiscalYearFiscalYear(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse20012DataEstimatesFirstFiscalYearFiscalYear - a model defined in OpenAPI
