...
class StockNotationScreenerSearchDataPerformanceEndOfDayYear1(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataPerformanceEndOfDayYear1 - a model defined in OpenAPI
