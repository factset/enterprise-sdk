...
class StockNotationScreenerSearchDataCurrencyDependentKeyFiguresPerShareBookValue(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataCurrencyDependentKeyFiguresPerShareBookValue - a model defined in OpenAPI
