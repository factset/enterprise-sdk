...
from fds.sdk.StocksAPIforDigitalPortals import rest
from fds.sdk.StocksAPIforDigitalPortals.configuration import Configuration
from fds.sdk.StocksAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/StocksAPIforDigitalPortals/0.10.21 ({platform.system()}, Python {platform.python_version()})'
