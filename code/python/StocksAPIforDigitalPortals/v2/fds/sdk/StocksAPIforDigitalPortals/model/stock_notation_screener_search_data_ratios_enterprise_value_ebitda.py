...
class StockNotationScreenerSearchDataRatiosEnterpriseValueEbitda(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataRatiosEnterpriseValueEbitda - a model defined in OpenAPI
