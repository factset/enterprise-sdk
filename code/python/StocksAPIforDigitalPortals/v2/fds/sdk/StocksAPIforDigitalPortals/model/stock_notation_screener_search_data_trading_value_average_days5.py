...
class StockNotationScreenerSearchDataTradingValueAverageDays5(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataTradingValueAverageDays5 - a model defined in OpenAPI
