...
class StockNotationScreenerSearchDataPerformanceEndOfDayMonths6(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataPerformanceEndOfDayMonths6 - a model defined in OpenAPI
