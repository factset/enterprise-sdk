...
class StockNotationScreenerSearchDataPerformanceEndOfDayMonths3(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataPerformanceEndOfDayMonths3 - a model defined in OpenAPI
