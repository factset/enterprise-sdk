...
class StockNotationScreenerSearchDataRecommendationConsensus(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataRecommendationConsensus - a model defined in OpenAPI
