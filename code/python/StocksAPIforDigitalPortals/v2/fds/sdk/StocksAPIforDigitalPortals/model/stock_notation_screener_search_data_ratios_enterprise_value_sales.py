...
class StockNotationScreenerSearchDataRatiosEnterpriseValueSales(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StockNotationScreenerSearchDataRatiosEnterpriseValueSales - a model defined in OpenAPI
