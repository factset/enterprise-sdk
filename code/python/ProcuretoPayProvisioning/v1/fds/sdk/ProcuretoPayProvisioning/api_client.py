...
from fds.sdk.ProcuretoPayProvisioning import rest
from fds.sdk.ProcuretoPayProvisioning.configuration import Configuration
from fds.sdk.ProcuretoPayProvisioning.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ProcuretoPayProvisioning.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/ProcuretoPayProvisioning/0.9.1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntitlementManagementApi()
        api_instance.add_products_post  # this is an instance of the class Endpoint
        api_instance.add_products_post()  # this invokes api_instance.add_products_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_products_post.callable or self.callable in this class
