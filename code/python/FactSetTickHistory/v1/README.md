...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetTickHistory/0.22.14)](https://pypi.org/project/fds.sdk.FactSetTickHistory/v/0.22.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetTickHistory==0.22.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetTickHistory==0.22.14
```
