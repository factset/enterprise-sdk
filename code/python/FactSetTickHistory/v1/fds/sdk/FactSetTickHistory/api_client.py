...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetTickHistory/0.22.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GetFilesApi()
        api_instance.v1_get_files_get  # this is an instance of the class Endpoint
        api_instance.v1_get_files_get()  # this invokes api_instance.v1_get_files_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_get_files_get.callable or self.callable in this class
