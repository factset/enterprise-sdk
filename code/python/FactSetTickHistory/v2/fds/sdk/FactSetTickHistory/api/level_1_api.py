...
class GetStatusLevel1ResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetStatusLevel1ResponseWrapper
...
class GetTickHistoryFilesResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetTickHistoryFilesResponseWrapper
        to status_code, response
...
class Level1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_id_endpoint = _Endpoint(
            settings={
                'response_type': (
        ...
        self.get_status_level1_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'operation_id': 'get_status_level1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_tick_history_coverage_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'operation_id': 'get_tick_history_coverage',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_tick_history_files_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'operation_id': 'get_tick_history_files',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_id(
        ...
        **kwargs
        ...
        Data available from 20120101 to current date.  # noqa: E501
        ...
        kwargs['levelone_request'] = \
            levelone_request
        return self.get_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_id_with_http_info_async(
        self,
        levelone_request,
        **kwargs
    ...
    def get_status_level1(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_status_level1_endpoint.call_with_http_info(**kwargs)

    def get_status_level1_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[GetStatusLevel1ResponseWrapper, int, typing.MutableMapping]:
        """Returns the status of the ID  # noqa: E501
    ...
    def get_status_level1_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[GetStatusLevel1ResponseWrapper]":
        """Returns the status of the ID  # noqa: E501
    ...
    def get_status_level1_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetStatusLevel1ResponseWrapper, int, typing.MutableMapping]]":
        """Returns the status of the ID  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetStatusLevel1ResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['id'] = \
            id
    ...
    def get_tick_history_coverage(
        ...
        **kwargs
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        return self.get_tick_history_coverage_endpoint.call_with_http_info(**kwargs)

    def get_tick_history_coverage_with_http_info(
        self,
        **kwargs
    ...
    def get_tick_history_coverage_async(
        self,
        **kwargs
    ...
    def get_tick_history_coverage_with_http_info_async(
        self,
        **kwargs
    ...
    def get_tick_history_files(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_tick_history_files_endpoint.call_with_http_info(**kwargs)

    def get_tick_history_files_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[GetTickHistoryFilesResponseWrapper, int, typing.MutableMapping]:
        """Returns the tick history files requested in the /create endpoint  # noqa: E501
    ...
    def get_tick_history_files_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[GetTickHistoryFilesResponseWrapper]":
        """Returns the tick history files requested in the /create endpoint  # noqa: E501
    ...
    def get_tick_history_files_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetTickHistoryFilesResponseWrapper, int, typing.MutableMapping]]":
        """Returns the tick history files requested in the /create endpoint  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetTickHistoryFilesResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['id'] = \
            id
