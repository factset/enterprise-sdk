...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetTickHistory/1.0.1)](https://pypi.org/project/fds.sdk.FactSetTickHistory/v/1.0.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetTickHistory==1.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetTickHistory==1.0.1
```
