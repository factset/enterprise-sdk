...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetTickHistory/1.3.0)](https://pypi.org/project/fds.sdk.FactSetTickHistory/v/1.3.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetTickHistory==1.3.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetTickHistory==1.3.0
```
