...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetTickHistory==0.30.3
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetTickHistory==0.30.3
```
...
with fds.sdk.FactSetTickHistory.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # Returns the ID for the requested data.
    #     api_response, http_status_code, response_headers = api_instance.get_id_with_http_info(levelone_request)
    ...
    # try:
    #     # Returns the ID for the requested data.
    #     async_result = api_instance.get_id_async(levelone_request)
    ...
    # try:
    #     # Returns the ID for the requested data.
    #     async_result = api_instance.get_id_with_http_info_async(levelone_request)
...
------------ | ------------- | ------------- | -------------
*Level1Api* | [**get_id**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level1Api.md#get_id) | **POST** /level1/files/create | Returns the ID for the requested data.
*Level1Api* | [**get_status_level1**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level1Api.md#get_status_level1) | **GET** /level1/files/status | Returns the status of the ID
*Level1Api* | [**get_tick_history_coverage**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level1Api.md#get_tick_history_coverage) | **GET** /level1/coverage | Returns the coverage for the requested ticker/isin along with other response fields for Level1 data.
*Level1Api* | [**get_tick_history_files**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level1Api.md#get_tick_history_files) | **GET** /level1/files/get | Returns the tick history files requested in the /create endpoint
*Level2Api* | [**get_status_level2**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level2Api.md#get_status_level2) | **GET** /level2/files/status | Returns the status of the ID
*Level2Api* | [**get_tick_history_files_level2**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level2Api.md#get_tick_history_files_level2) | **GET** /level2/files/get | Returns the tick history files requested in the /create endpoint
*Level2Api* | [**getlevel2id**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level2Api.md#getlevel2id) | **POST** /level2/files/create | Returns the ID for the requested data.
...
## Documentation For Models
 ...
 - [DateRange](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/DateRange.md)
 - [DateRangeOne](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/DateRangeOne.md)
 ...
 - [Level2RequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Level2RequestBody.md)
 - [LevelTwoRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/LevelTwoRequest.md)
 ...
 - [LeveltwoGetFilesResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/LeveltwoGetFilesResponse.md)
 - [Meta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Meta.md)
 - [Mic](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Mic.md)
 - [Pagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/Pagination.md)
 - [ResponseFileType](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/ResponseFileType.md)
 ...
 - [TickDataLevel2](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetTickHistory/v2/docs/TickDataLevel2.md)
