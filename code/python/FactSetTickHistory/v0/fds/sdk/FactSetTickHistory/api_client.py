...
from fds.sdk.FactSetTickHistory import rest
from fds.sdk.FactSetTickHistory.configuration import Configuration
from fds.sdk.FactSetTickHistory.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetTickHistory.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetTickHistory/0.0.1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GetFilesLevel2BETAApi()
        api_instance.get_tick_history_files_level2  # this is an instance of the class Endpoint
        api_instance.get_tick_history_files_level2()  # this invokes api_instance.get_tick_history_files_level2.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_tick_history_files_level2.callable or self.callable in this class
