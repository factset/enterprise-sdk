...
from fds.sdk.PortfolioReportingBatcher import rest
from fds.sdk.PortfolioReportingBatcher.configuration import Configuration
from fds.sdk.PortfolioReportingBatcher.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.PortfolioReportingBatcher.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/PortfolioReportingBatcher/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = RunsApi()
        api_instance.check_run_status  # this is an instance of the class Endpoint
        api_instance.check_run_status()  # this invokes api_instance.check_run_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.check_run_status.callable or self.callable in this class
