...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.PortfolioReportingBatcher/2.0.0)](https://pypi.org/project/fds.sdk.PortfolioReportingBatcher/v/2.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.PortfolioReportingBatcher==2.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.PortfolioReportingBatcher==2.0.0
```
