...
[![API Version](https://img.shields.io/badge/api-v1.1.0-blue)](https://developer.factset.com/api-catalog/portfolio-reporting-batcher-api)
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.PortfolioReportingBatcher/1.1.0)](https://pypi.org/project/fds.sdk.PortfolioReportingBatcher/v/1.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.PortfolioReportingBatcher==1.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.PortfolioReportingBatcher==1.1.0
```
