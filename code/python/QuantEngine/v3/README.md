...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.QuantEngine/1.1.0)](https://pypi.org/project/fds.sdk.QuantEngine/v/1.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.QuantEngine==1.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.QuantEngine==1.1.0
```
