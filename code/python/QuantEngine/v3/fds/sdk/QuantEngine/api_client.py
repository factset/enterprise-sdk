...
from fds.sdk.QuantEngine import rest
from fds.sdk.QuantEngine.configuration import Configuration
from fds.sdk.QuantEngine.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.QuantEngine.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/QuantEngine/1.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = QuantCalculationsApi()
