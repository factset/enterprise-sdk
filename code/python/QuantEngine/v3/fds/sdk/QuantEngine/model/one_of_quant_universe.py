...
class OneOfQuantUniverse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'IdentifierUniverse': QuantIdentifierUniverse,
            'QuantIdentifierUniverse': QuantIdentifierUniverse,
            'QuantScreeningExpressionUniverse': QuantScreeningExpressionUniverse,
            'QuantUniversalScreenUniverse': QuantUniversalScreenUniverse,
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OneOfQuantUniverse - a model defined in OpenAPI
