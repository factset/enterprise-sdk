...
def lazy_import():
    ...
    globals()['QuantAllUniversalScreenParameters'] = QuantAllUniversalScreenParameters
...
class OneOfQuantFormulas(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AllUniversalScreenParameters': QuantAllUniversalScreenParameters,
            'FqlExpression': QuantFqlExpression,
            'QuantAllUniversalScreenParameters': QuantAllUniversalScreenParameters,
            'QuantFqlExpression': QuantFqlExpression,
            'QuantScreeningExpression': QuantScreeningExpression,
            'QuantUniversalScreenParameter': QuantUniversalScreenParameter,
            'ScreeningExpression': QuantScreeningExpression,
            'UniversalScreenParameter': QuantUniversalScreenParameter,
        }
        if not val:
            return None
        return {'source': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OneOfQuantFormulas - a model defined in OpenAPI
