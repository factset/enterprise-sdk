...
class OneOfQuantDates(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'DateList': QuantDateList,
            'FdsDate': QuantFdsDate,
            'QuantDateList': QuantDateList,
            'QuantFdsDate': QuantFdsDate,
        }
        if not val:
            return None
        return {'source': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OneOfQuantDates - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            calendar (str): [optional]  # noqa: E501
        """
