...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetFundamentalsReportBuilder/1.0.13)](https://pypi.org/project/fds.sdk.FactSetFundamentalsReportBuilder/v/1.0.13)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetFundamentalsReportBuilder==1.0.13
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetFundamentalsReportBuilder==1.0.13
```
