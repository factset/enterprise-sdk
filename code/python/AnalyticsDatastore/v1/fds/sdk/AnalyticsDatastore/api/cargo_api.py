...
class CargoApi(object):
    ...
    def get_cargo_endpoint(
        ...
        **kwargs
        ...
        Args:
            group_id (str): The ID of the group. defaults to "a4186c50f8e74f979d271dd22298c901", must be one of ["a4186c50f8e74f979d271dd22298c901"]
            object_id (str): The ID of the object. defaults to "fe875bc4150542dea6bc237663a01a0d", must be one of ["fe875bc4150542dea6bc237663a01a0d"]
