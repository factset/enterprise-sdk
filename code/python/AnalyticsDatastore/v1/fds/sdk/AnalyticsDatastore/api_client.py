...
from fds.sdk.AnalyticsDatastore import rest
from fds.sdk.AnalyticsDatastore.configuration import Configuration
from fds.sdk.AnalyticsDatastore.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.AnalyticsDatastore.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/AnalyticsDatastore/0.22.6 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_documents_end_point  # this is an instance of the class Endpoint
        api_instance.get_documents_end_point()  # this invokes api_instance.get_documents_end_point.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_documents_end_point.callable or self.callable in this class
