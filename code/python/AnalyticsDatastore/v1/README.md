...
with fds.sdk.AnalyticsDatastore.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # Get Cargo endpoint, gets an object given an ID. In this case ID retrieved from Swivel Location header, results in json response body of the report.
    #     api_response, http_status_code, response_headers = api_instance.get_cargo_endpoint_with_http_info(group_id, object_id)
    #     pprint(api_response)
    ...
    # try:
    #     # Get Cargo endpoint, gets an object given an ID. In this case ID retrieved from Swivel Location header, results in json response body of the report.
    #     async_result = api_instance.get_cargo_endpoint_async(group_id, object_id)
    ...
    # try:
    #     # Get Cargo endpoint, gets an object given an ID. In this case ID retrieved from Swivel Location header, results in json response body of the report.
    #     async_result = api_instance.get_cargo_endpoint_with_http_info_async(group_id, object_id)
