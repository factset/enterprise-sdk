...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.AnalyticsDatastore/0.22.7)](https://pypi.org/project/fds.sdk.AnalyticsDatastore/v/0.22.7)
...
```shell
poetry add fds.sdk.utils fds.sdk.AnalyticsDatastore==0.22.7
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.AnalyticsDatastore==0.22.7
```
