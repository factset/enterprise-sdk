...
class Metrics(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): List of data items for Exchange Traded Funds. To fetch a list of all available data items, use the **/metrics** endpoint. .  # noqa: E501

        Keyword Args:
            value ([str]): List of data items for Exchange Traded Funds. To fetch a list of all available data items, use the **/metrics** endpoint. .  # noqa: E501
