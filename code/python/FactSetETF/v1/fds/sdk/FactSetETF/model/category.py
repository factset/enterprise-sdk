...
class Category(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Filters the list of ETF metrics by major category - |---|---| |category|description| |BENCHMARK_DETAILS|description| ., must be one of ["BENCHMARK_DETAILS", "CLASSIFICATION", "COSTS_FEES", "COUNTERPARTY", "CREATE_REDEEM", "DESCRIPTIVE", "DISTRIBUTIONS", "DOCUMENTATION", "GEARING", "HEDGE", "RISK", "SERVICE_PROVIDERS", "STATUS", "STRATEGY", "STRUCTURE", "TAX", ]  # noqa: E501

        Keyword Args:
            value (str): Filters the list of ETF metrics by major category - |---|---| |category|description| |BENCHMARK_DETAILS|description| ., must be one of ["BENCHMARK_DETAILS", "CLASSIFICATION", "COSTS_FEES", "COUNTERPARTY", "CREATE_REDEEM", "DESCRIPTIVE", "DISTRIBUTIONS", "DOCUMENTATION", "GEARING", "HEDGE", "RISK", "SERVICE_PROVIDERS", "STATUS", "STRATEGY", "STRUCTURE", "TAX", ]  # noqa: E501
