...
from fds.sdk.WatchlistAPIforDigitalPortals import rest
from fds.sdk.WatchlistAPIforDigitalPortals.configuration import Configuration
from fds.sdk.WatchlistAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.WatchlistAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/WatchlistAPIforDigitalPortals/0.9.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = WatchlistApi()
        api_instance.watchlist_create_post  # this is an instance of the class Endpoint
        api_instance.watchlist_create_post()  # this invokes api_instance.watchlist_create_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.watchlist_create_post.callable or self.callable in this class
