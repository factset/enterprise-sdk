...
from fds.sdk.InvestmentResearch import rest
from fds.sdk.InvestmentResearch.configuration import Configuration
from fds.sdk.InvestmentResearch.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.InvestmentResearch.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/InvestmentResearch/3.0.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_asset_types  # this is an instance of the class Endpoint
        api_instance.get_asset_types()  # this invokes api_instance.get_asset_types.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_asset_types.callable or self.callable in this class
