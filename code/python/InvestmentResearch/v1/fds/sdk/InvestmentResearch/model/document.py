...
class Document(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            link (str): The link to download the document.  **Note:** For documents with `source: AMR` (Aftermarket Research), this is a preview link only. To access the full document, call the `/purchase-amr` endpoint with the `documentId` to retrieve the `purchaseLink`.. [optional]  # noqa: E501
