...
class Sources(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): Code for document source to include. Available values:    * **FRC**: FactSet Research Connect   * **AMR**: Aftermarket Research.  # noqa: E501

        Keyword Args:
            value ([str]): Code for document source to include. Available values:    * **FRC**: FactSet Research Connect   * **AMR**: Aftermarket Research.  # noqa: E501
