...
class ResearchApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_purchase_links_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (PurchaseResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/purchase-amr',
                'operation_id': 'get_purchase_links',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_count(
        ...
        **kwargs
        ...
        Returns the available count of documents (up to 10000) based on search criteria. This endpoint accepts up to 10 IDs per request.  # noqa: E501
    ...
    def get_purchase_links(
        ...
        **kwargs
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['purchase_request'] = \
            purchase_request
        return self.get_purchase_links_endpoint.call_with_http_info(**kwargs)

    def get_purchase_links_with_http_info(
        self,
        purchase_request,
        **kwargs
    ) -> typing.Tuple[PurchaseResponse, int, typing.MutableMapping]:
        """Retrieve purchase links and metadata for specified research documents.  # noqa: E501
    ...
    def get_purchase_links_async(
        self,
        purchase_request,
        **kwargs
    ) -> "ApplyResult[PurchaseResponse]":
        """Retrieve purchase links and metadata for specified research documents.  # noqa: E501
    ...
    def get_purchase_links_with_http_info_async(
        self,
        purchase_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[PurchaseResponse, int, typing.MutableMapping]]":
        """Retrieve purchase links and metadata for specified research documents.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(PurchaseResponse, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['purchase_request'] = \
            purchase_request
