...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.InvestmentResearch/0.2.0)](https://pypi.org/project/fds.sdk.InvestmentResearch/v/0.2.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.InvestmentResearch==0.2.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.InvestmentResearch==0.2.0
```
