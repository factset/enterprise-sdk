...
def lazy_import():
    ...
    globals()['EMSCreateChildOrdersResponse'] = EMSCreateChildOrdersResponse


class EMSCreateChildOrdersResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (EMSCreateChildOrdersResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """EMSCreateChildOrdersResponseRoot - a model defined in OpenAPI

        Args:
            data (EMSCreateChildOrdersResponse):
