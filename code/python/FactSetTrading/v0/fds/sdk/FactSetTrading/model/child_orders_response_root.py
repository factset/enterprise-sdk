...
def lazy_import():
    ...
    globals()['ChildOrdersResponse'] = ChildOrdersResponse


class ChildOrdersResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ChildOrdersResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ChildOrdersResponseRoot - a model defined in OpenAPI

        Args:
            data (ChildOrdersResponse):
