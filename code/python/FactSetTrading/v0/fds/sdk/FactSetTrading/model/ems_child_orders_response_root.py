...
def lazy_import():
    ...
    globals()['EMSChildOrdersResponse'] = EMSChildOrdersResponse


class EMSChildOrdersResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (EMSChildOrdersResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """EMSChildOrdersResponseRoot - a model defined in OpenAPI

        Args:
            data (EMSChildOrdersResponse):
