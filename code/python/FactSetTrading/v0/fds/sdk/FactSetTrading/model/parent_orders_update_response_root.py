...
def lazy_import():
    ...
    globals()['ParentOrdersUpdateResponse'] = ParentOrdersUpdateResponse


class ParentOrdersUpdateResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ParentOrdersUpdateResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ParentOrdersUpdateResponseRoot - a model defined in OpenAPI

        Args:
            data ([ParentOrdersUpdateResponse]):
