...
def lazy_import():
    ...
    globals()['InboundOrdersResponse'] = InboundOrdersResponse


class InboundOrdersResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (InboundOrdersResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """InboundOrdersResponseRoot - a model defined in OpenAPI

        Args:
            data (InboundOrdersResponse):
