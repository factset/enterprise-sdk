...
class ParentId(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, symbol, basket_id, *args, **kwargs):  # noqa: E501
        """ParentId - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, symbol, basket_id, *args, **kwargs):  # noqa: E501
        """ParentId - a model defined in OpenAPI
