...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetTrading/0.22.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancel  # this is an instance of the class Endpoint
        api_instance.cancel()  # this invokes api_instance.cancel.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel.callable or self.callable in this class
