...
from fds.sdk.FactSetTrading import rest
from fds.sdk.FactSetTrading.configuration import Configuration
from fds.sdk.FactSetTrading.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetTrading.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetTrading/1.0.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ChildOrdersApi()
        api_instance.cancel_child_order  # this is an instance of the class Endpoint
        api_instance.cancel_child_order()  # this invokes api_instance.cancel_child_order.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_child_order.callable or self.callable in this class
