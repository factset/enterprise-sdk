...
def lazy_import():
    ...
    globals()['EMSOrdersCreateResponse'] = EMSOrdersCreateResponse


class EMSOrdersCreateResponseEmsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (EMSOrdersCreateResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """EMSOrdersCreateResponseEmsResponse - a model defined in OpenAPI

        Args:
            data (EMSOrdersCreateResponse):
