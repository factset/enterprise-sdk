...
def lazy_import():
    ...
    globals()['CreateChildOrdersResponse'] = CreateChildOrdersResponse


class CreateChildOrdersResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (CreateChildOrdersResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CreateChildOrdersResponseRoot - a model defined in OpenAPI

        Args:
            data (CreateChildOrdersResponse):
