...
with fds.sdk.FactSetTrading.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # Cancel the orders on EMS system.
    #     api_response, http_status_code, response_headers = api_instance.cancel_with_http_info(ems_cancel_orders_data_meta_model=ems_cancel_orders_data_meta_model)
    #     pprint(api_response)
    ...
    # try:
    #     # Cancel the orders on EMS system.
    #     async_result = api_instance.cancel_async(ems_cancel_orders_data_meta_model=ems_cancel_orders_data_meta_model)
    ...
    # try:
    #     # Cancel the orders on EMS system.
    #     async_result = api_instance.cancel_with_http_info_async(ems_cancel_orders_data_meta_model=ems_cancel_orders_data_meta_model)
