...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ConversationalAPIPoweredbyFactSetMercury/1.1.1)](https://pypi.org/project/fds.sdk.ConversationalAPIPoweredbyFactSetMercury/v/1.1.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.ConversationalAPIPoweredbyFactSetMercury==1.1.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ConversationalAPIPoweredbyFactSetMercury==1.1.1
```
