...
class PromptParameter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, place_holder, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            selection_type (str): Selection type, currently only support single selection. defaults to "single", must be one of ["single", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, place_holder, value, *args, **kwargs):  # noqa: E501
        """PromptParameter - a model defined in OpenAPI
