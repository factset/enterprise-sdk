...
def lazy_import():
    ...
    globals()['BadFeedbackRequestErrorObject'] = BadFeedbackRequestErrorObject


class BadFeedbackRequestError(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'errors': ([BadFeedbackRequestErrorObject],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, errors, *args, **kwargs):  # noqa: E501
        """BadFeedbackRequestError - a model defined in OpenAPI

        Args:
            errors ([BadFeedbackRequestErrorObject]): Array of BadFeedbackRequestErrorObject
