...
class InternalServerErrorObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, detail, *args, **kwargs):  # noqa: E501
        """InternalServerErrorObject - a model defined in OpenAPI
        ...
        Keyword Args:
            title (str): Title of error. defaults to "Unknown Error", must be one of ["Unknown Error", ]  # noqa: E501
            code (str): Code of error. defaults to "genericServerError", must be one of ["genericServerError", ]  # noqa: E501
        ...
        title = kwargs.get('title', "Unknown Error")
        code = kwargs.get('code', "genericServerError")
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, detail, *args, **kwargs):  # noqa: E501
        """InternalServerErrorObject - a model defined in OpenAPI
