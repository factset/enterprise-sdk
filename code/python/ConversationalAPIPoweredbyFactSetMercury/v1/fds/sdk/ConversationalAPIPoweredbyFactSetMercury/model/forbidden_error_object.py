...
class ForbiddenErrorObject(ModelNormal):
    ...
    def _from_openapi_data(cls, id, detail, *args, **kwargs):  # noqa: E501
        """ForbiddenErrorObject - a model defined in OpenAPI
        ...
        Keyword Args:
            title (str): Title of error. defaults to "Not Authorized", must be one of ["Not Authorized", ]  # noqa: E501
            code (str): Code of error. defaults to "forbidden", must be one of ["forbidden", ]  # noqa: E501
        ...
        title = kwargs.get('title', "Not Authorized")
