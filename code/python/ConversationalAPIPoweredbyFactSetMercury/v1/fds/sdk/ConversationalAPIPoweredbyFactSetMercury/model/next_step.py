...
class NextStep(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        ...
        Args:
            value ([NextStepItem]): List of NextStep action items

        Keyword Args:
            type (str): Datatype contained in this data object. defaults to "NextStep", must be one of ["NextStep", ]  # noqa: E501
