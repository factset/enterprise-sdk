...
class BadRequestErrorWithInvalidDataSchemaObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, title, code, detail, *args, **kwargs):  # noqa: E501
        """BadRequestErrorWithInvalidDataSchemaObject - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, title, code, detail, *args, **kwargs):  # noqa: E501
        """BadRequestErrorWithInvalidDataSchemaObject - a model defined in OpenAPI
