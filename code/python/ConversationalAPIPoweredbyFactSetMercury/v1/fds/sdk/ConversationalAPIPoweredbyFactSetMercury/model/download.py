...
class Download(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, label, error, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            error (FileGenerationErrorObject):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, error, *args, **kwargs):  # noqa: E501
        """Download - a model defined in OpenAPI
