...
class OpenUrl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, label, url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            action (str): Type of action. defaults to "OpenUrl", must be one of ["OpenUrl", ]  # noqa: E501
            ...
            category (str, none_type): Category of associated url. [optional]  # noqa: E501
        """

        action = kwargs.get('action', "OpenUrl")
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, url, *args, **kwargs):  # noqa: E501
        """OpenUrl - a model defined in OpenAPI
