...
class FileGenerationErrorObject(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FileGenerationErrorObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            title (str): Title of error. [optional] if omitted the server will use the default value of "File Generation Error"  # noqa: E501
            code (str): Code of error. [optional] if omitted the server will use the default value of "conversational_api_fileGenerationError"  # noqa: E501
