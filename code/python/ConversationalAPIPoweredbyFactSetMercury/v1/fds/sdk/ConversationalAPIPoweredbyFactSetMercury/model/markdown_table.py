...
class MarkdownTable(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """MarkdownTable - a model defined in OpenAPI

        Args:
            value (str): Markdown formatted table data

        Keyword Args:
            type (str): Datatype contained in this data object. defaults to "MarkdownTable", must be one of ["MarkdownTable", ]  # noqa: E501
        ...
        type = kwargs.get('type', "MarkdownTable")
