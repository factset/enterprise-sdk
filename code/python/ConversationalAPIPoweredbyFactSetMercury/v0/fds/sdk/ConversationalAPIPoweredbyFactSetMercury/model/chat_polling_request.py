...
def lazy_import():
    ...
    globals()['ChatPollingRequestData'] = ChatPollingRequestData


class ChatPollingRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ChatPollingRequestData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ChatPollingRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data (ChatPollingRequestData): [optional]  # noqa: E501
        """
