...
class PromptParameter(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PromptParameter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            selection_type (str): Selection type, currently only support single selection. [optional] if omitted the server will use the default value of "single"  # noqa: E501
            place_holder (str): PlaceHolder value used in the prompt template. [optional]  # noqa: E501
            value ([str]): Selection option values can be used to replace the placeHolder in the prompt template. [optional]  # noqa: E501
        """
