...
def lazy_import():
    ...
    globals()['FileDownloadRequestData'] = FileDownloadRequestData


class FileDownloadRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (FileDownloadRequestData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """FileDownloadRequest - a model defined in OpenAPI
