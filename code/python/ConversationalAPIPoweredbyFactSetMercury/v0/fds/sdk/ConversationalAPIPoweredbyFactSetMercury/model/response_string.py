...
class ResponseString(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """ResponseString - a model defined in OpenAPI

        Args:
            value (str): String containing chat response to the query

        Keyword Args:
            type (str): Datatype contained in this data object. defaults to "string", must be one of ["string", ]  # noqa: E501
