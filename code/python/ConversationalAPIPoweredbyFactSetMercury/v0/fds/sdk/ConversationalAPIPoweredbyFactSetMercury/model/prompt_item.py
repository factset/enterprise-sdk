...
def lazy_import():
    ...
    globals()['PromptParameters'] = PromptParameters


class PromptItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'prompt_parameters': (PromptParameters,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, prompt, *args, **kwargs):  # noqa: E501
        """PromptItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            prompt_parameters (PromptParameters): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, prompt, *args, **kwargs):  # noqa: E501
        """PromptItem - a model defined in OpenAPI
