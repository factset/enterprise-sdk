...
def lazy_import():
    ...
    globals()['AdaptiveCardBodyElements'] = AdaptiveCardBodyElements


class AdaptiveCardData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'body': (AdaptiveCardBodyElements,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, type, version, *args, **kwargs):  # noqa: E501
        """AdaptiveCardData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            body (AdaptiveCardBodyElements): [optional]  # noqa: E501
        """
