...
def lazy_import():
    ...
    globals()['QueryChatRequestData'] = QueryChatRequestData


class QueryChatRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (QueryChatRequestData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """QueryChatRequest - a model defined in OpenAPI
