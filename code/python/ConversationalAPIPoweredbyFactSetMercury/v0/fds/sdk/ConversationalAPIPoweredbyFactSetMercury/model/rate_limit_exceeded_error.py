...
class RateLimitExceededError(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'errors': ([ErrorObject], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RateLimitExceededError - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            message (str): Message of error response. [optional] if omitted the server will use the default value of "API rate limit exceeded"  # noqa: E501
            errors ([ErrorObject], none_type): Array of ErrorObject. [optional]  # noqa: E501
        """
