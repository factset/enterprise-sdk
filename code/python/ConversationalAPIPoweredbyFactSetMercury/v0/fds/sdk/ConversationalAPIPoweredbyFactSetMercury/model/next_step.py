...
def lazy_import():
    ...
    globals()['NextStepItem'] = NextStepItem


class NextStep(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NextStep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Datatype contained in this data object. [optional] if omitted the server will use the default value of "NextStep"  # noqa: E501
            value ([NextStepItem]): List of NextStep items. [optional]  # noqa: E501
        """
