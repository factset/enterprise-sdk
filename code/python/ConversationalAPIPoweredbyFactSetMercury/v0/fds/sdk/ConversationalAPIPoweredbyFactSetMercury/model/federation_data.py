...
def lazy_import():
    ...
    globals()['AdaptiveCard'] = AdaptiveCard
    globals()['Citations'] = Citations
    globals()['NextStep'] = NextStep
    globals()['PromptItem'] = PromptItem
    globals()['ResponseString'] = ResponseString
    globals()['SuggestedPrompts'] = SuggestedPrompts
    globals()['Table'] = Table


class FederationData(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FederationData - a model defined in OpenAPI

        Keyword Args:
            type (str): Datatype contained in this data object. defaults to "SuggestedPrompts", must be one of ["SuggestedPrompts", ]  # noqa: E501
            ...
            citations (Citations): [optional]  # noqa: E501
            value ([PromptItem]): List of suggested prompts. [optional]  # noqa: E501
        """

        type = kwargs.get('type', "SuggestedPrompts")
