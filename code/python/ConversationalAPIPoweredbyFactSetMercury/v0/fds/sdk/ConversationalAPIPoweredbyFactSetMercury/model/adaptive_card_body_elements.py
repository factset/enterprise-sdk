...
def lazy_import():
    ...
    globals()['AdaptiveCardBodyElement'] = AdaptiveCardBodyElement


class AdaptiveCardBodyElements(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AdaptiveCardBodyElements - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AdaptiveCardBodyElement]): Array of Adaptive Card body elements.  # noqa: E501

        Keyword Args:
            value ([AdaptiveCardBodyElement]): Array of Adaptive Card body elements.  # noqa: E501
