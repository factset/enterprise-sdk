...
from fds.sdk.ConversationalAPIPoweredbyFactSetMercury import rest
from fds.sdk.ConversationalAPIPoweredbyFactSetMercury.configuration import Configuration
from fds.sdk.ConversationalAPIPoweredbyFactSetMercury.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ConversationalAPIPoweredbyFactSetMercury.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ConversationalAPIPoweredbyFactSetMercury/0.1.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DownloadApi()
        api_instance.download_file  # this is an instance of the class Endpoint
        api_instance.download_file()  # this invokes api_instance.download_file.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.download_file.callable or self.callable in this class
