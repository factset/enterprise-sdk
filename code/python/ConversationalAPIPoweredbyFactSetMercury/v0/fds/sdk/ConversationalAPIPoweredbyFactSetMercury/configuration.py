...
conf = fds.sdk.ConversationalAPIPoweredbyFactSetMercury.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.factset.com/conversational/v0" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("fds.sdk.ConversationalAPIPoweredbyFactSetMercury")
