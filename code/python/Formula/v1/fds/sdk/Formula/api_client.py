...
from fds.sdk.Formula import rest
from fds.sdk.Formula.configuration import Configuration
from fds.sdk.Formula.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Formula.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Formula/4.0.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancel_batch_job  # this is an instance of the class Endpoint
        api_instance.cancel_batch_job()  # this invokes api_instance.cancel_batch_job.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_batch_job.callable or self.callable in this class
