...
def lazy_import():
    ...
    globals()['TimeSeriesRequestData'] = TimeSeriesRequestData


class TimeSeriesRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TimeSeriesRequestData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TimeSeriesRequest - a model defined in OpenAPI
