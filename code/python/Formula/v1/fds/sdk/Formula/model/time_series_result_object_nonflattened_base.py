...
class TimeSeriesResultObjectNonflattenedBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, error, formula, request_id, data_type, object_type, *args, **kwargs):  # noqa: E501
        """TimeSeriesResultObjectNonflattenedBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, error, formula, request_id, data_type, object_type, *args, **kwargs):  # noqa: E501
        """TimeSeriesResultObjectNonflattenedBase - a model defined in OpenAPI
