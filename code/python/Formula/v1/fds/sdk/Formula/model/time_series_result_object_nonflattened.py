...
def lazy_import():
    ...
    globals()['TimeSeriesResultObjectNonflattenedArray'] = TimeSeriesResultObjectNonflattenedArray
    globals()['TimeSeriesResultObjectNonflattenedMatrix'] = TimeSeriesResultObjectNonflattenedMatrix
    globals()['TimeSeriesResultObjectNonflattenedScalar'] = TimeSeriesResultObjectNonflattenedScalar
    globals()['TimeSeriesResultObjectNonflattenedTimeseriesObject'] = TimeSeriesResultObjectNonflattenedTimeseriesObject


class TimeSeriesResultObjectNonflattened(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'ARRAY': TimeSeriesResultObjectNonflattenedArray,
            'MATRIX': TimeSeriesResultObjectNonflattenedMatrix,
            'SCALAR': TimeSeriesResultObjectNonflattenedScalar,
            'TIMESERIES': TimeSeriesResultObjectNonflattenedTimeseriesObject,
            'time_series_result_object_nonflattened_array': TimeSeriesResultObjectNonflattenedArray,
            'time_series_result_object_nonflattened_matrix': TimeSeriesResultObjectNonflattenedMatrix,
            'time_series_result_object_nonflattened_scalar': TimeSeriesResultObjectNonflattenedScalar,
            'time_series_result_object_nonflattened_timeseries_object': TimeSeriesResultObjectNonflattenedTimeseriesObject,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TimeSeriesResultObjectNonflattened - a model defined in OpenAPI
