...
------------- | ------------- | -------------
[**get_time_series_data**](TimeSeriesApi.md#get_time_series_data) | **GET** /time-series | Retrieve data items (FQL formulas) for a list of identifiers or defined universe.
