...
**any string name** | [**CrossSectionalResultObjectFlattenedAddl**](CrossSectionalResultObjectFlattenedAddl.md) | any string name can be used but the value must be the correct type | [optional]
