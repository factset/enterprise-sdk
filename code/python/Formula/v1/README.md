...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Formula/3.0.2)](https://pypi.org/project/fds.sdk.Formula/v/3.0.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.Formula==3.0.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Formula==3.0.2
```
