...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Formula/5.0.0)](https://pypi.org/project/fds.sdk.Formula/v/5.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.Formula==5.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Formula==5.0.0
```
...
## Documentation For Models
 ...
 - [UnifiedResultObjectFlattenedAddl](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Formula/v1/docs/UnifiedResultObjectFlattenedAddl.md)
