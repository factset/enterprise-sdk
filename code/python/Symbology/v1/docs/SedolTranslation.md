...
**sedol_effective_start_date** | **str** | The effective start date in which the CUSIP was valid for the security. | [optional] 
**sedol_effective_end_date** | **str** | The effective end date in which the Sedol was valid. If null, the Sedol is still active for the security and date requested. | [optional] 
**as_of_date** | **date** | The reqeuested date for the symbol. | [optional] 
