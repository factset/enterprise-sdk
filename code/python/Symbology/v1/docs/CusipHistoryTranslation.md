...
**cusip_effective_start_date** | **date** | CUSIP effective start date in YYYY-MM-DD format. | [optional] 
**cusip_effective_end_date** | **date** | CUSIP effective end date in YYYY-MM-DD format. Null if still active. | [optional] 
