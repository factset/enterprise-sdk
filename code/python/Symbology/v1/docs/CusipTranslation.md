...
**cusip** | **str** | CUSIP with Check Digit | [optional] 
**cusip_effective_start_date** | **str** | The effective start date in which the CUSIP was valid for the security. | [optional] 
**cusip_effective_end_date** | **str** | The effective end date in which the CUSIP was valid. If null, the CUSIP is still active for the security and date requested. | [optional] 
**as_of_date** | **date** | The effective end date in which the CUSIP was valid. If null, the CUSIP is still active for the security and date requested. | [optional] 
