...
class FactsetTranslation(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            security_type (str): Returns security types for equities. For definitions of Security Types, visit [Online Assistant Page #15776](https://oa.apps.factset.com/pages/15776). [optional]  # noqa: E501
