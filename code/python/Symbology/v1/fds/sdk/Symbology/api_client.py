...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/Symbology/0.8.10'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BloombergFIGIApi()
        api_instance.batch_translate_bloomberg  # this is an instance of the class Endpoint
        api_instance.batch_translate_bloomberg()  # this invokes api_instance.batch_translate_bloomberg.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batch_translate_bloomberg.callable or self.callable in this class
