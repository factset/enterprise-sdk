...
class FactSetApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.batch_translate_factset_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/symbology/v1/factset',
                'operation_id': 'batch_translate_factset',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def batch_translate_factset_with_http_info(
        self,
        factset_translation_request,
        **kwargs
    ...
    def batch_translate_factset_async(
        self,
        factset_translation_request,
        **kwargs
    ...
    def batch_translate_factset_with_http_info_async(
        self,
        factset_translation_request,
        **kwargs
    ...
    def translate_factset(
        ...
        **kwargs
        ...
        Translate market security symbols into FactSet Permanent Security Identifiers. The permanent identifier provides a unique record key and a convenient way to link across content sets. Additionally, if your firm does not have licenses for the symbol systems (e.g., CUSIP, SEDOL, ISIN), the permanent identifier provides a way to deliver security and listing-level data. <p>*GET Method is limited by URL Length of 2,048 characters. If a large universe of symbols is requested, it's advised to use POST method to retrieve the same response model.*</P><p>**This endpoint is included with all other Content API packages.**</p>  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
