...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Symbology/3.1.1)](https://pypi.org/project/fds.sdk.Symbology/v/3.1.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.Symbology==3.1.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Symbology==3.1.1
```
