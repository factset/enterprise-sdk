...
from fds.sdk.Symbology import rest
from fds.sdk.Symbology.configuration import Configuration
from fds.sdk.Symbology.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Symbology.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Symbology/3.1.2 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = HistoricalIdentifierResolutionApi()
        api_instance.batch_historical_identifier_resolution  # this is an instance of the class Endpoint
        api_instance.batch_historical_identifier_resolution()  # this invokes api_instance.batch_historical_identifier_resolution.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batch_historical_identifier_resolution.callable or self.callable in this class
