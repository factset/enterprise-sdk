...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/Symbology/2.3.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IdentifierResolutionApi()
        api_instance.batch_identifier_resolution  # this is an instance of the class Endpoint
        api_instance.batch_identifier_resolution()  # this invokes api_instance.batch_identifier_resolution.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batch_identifier_resolution.callable or self.callable in this class
