...
class GetHistoricalOutputSymbolTypes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GetHistoricalOutputSymbolTypes - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Requested identifiers to be returned. Multiple identifier types can be requested with each request..  # noqa: E501

        Keyword Args:
            value ([str]): Requested identifiers to be returned. Multiple identifier types can be requested with each request..  # noqa: E501
