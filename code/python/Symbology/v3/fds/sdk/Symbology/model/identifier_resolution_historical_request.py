...
def lazy_import():
    ...
    globals()['IdentifierResolutionHistoricalRequestBody'] = IdentifierResolutionHistoricalRequestBody


class IdentifierResolutionHistoricalRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (IdentifierResolutionHistoricalRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """IdentifierResolutionHistoricalRequest - a model defined in OpenAPI
