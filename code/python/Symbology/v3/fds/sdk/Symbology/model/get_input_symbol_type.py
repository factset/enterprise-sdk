...
class GetInputSymbolType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The type of symbol submitted for resolution to other identifiers. Only one type of symbol is accepted with each request.. if omitted defaults to "tickerRegion", must be one of ["BIC", "CIK", "CRD", "DUNS", "EIN", "FITCH", "LEI", "MD", "SPR", "VALOREN", "WKN", "UKCH", "RSSD", "SEDOL", "CUSIP", "fsymEntityId", "fsymSecurityId", "fsymRegionalId", "fsymListingId", "ISIN", "tickerExchange", "tickerRegion", "bloombergFigi", "bloombergTicker", "GVKEY", "GVKEY & IID", "JCN", "LoanX", "MarkitRed", ]  # noqa: E501
