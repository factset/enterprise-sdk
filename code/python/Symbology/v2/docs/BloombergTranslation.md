...
**bbg_security_id** | **str** | Bloomberg Security Identifier. | [optional] 
**bbg_composite_id** | **str** | Bloomberg Security Identifier. | [optional] 
**bbg_listing_id** | **str** | Bloomberg Security Identifier. | [optional] 
**bbg_ticker_listing** | **str** | Bloomberg Security Identifier. | [optional] 
**bbg_ticker_composite** | **str** | Bloomberg Security Identifier. | [optional] 
