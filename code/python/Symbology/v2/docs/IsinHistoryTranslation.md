...
**isin_effective_start_date** | **date** | ISIN effective start date in YYYY-MM-DD format. | [optional] 
**isin_effective_end_date** | **date** | ISIN effective end date in YYYY-MM-DD format. Null if still active. | [optional] 
