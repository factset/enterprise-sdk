...
class SedolTranslation(ModelNormal):
    ...
    attribute_map = {
        ...
        'sedol_primary': 'sedolPrimary',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            sedol_primary (str): The SEDOL for the Primary Listing of the requested security. If you request a specific exchange (e.g. -MEX), the SEDOL will translate for that listing, while the SEDOL Primary will always resolve back to the primary region (e.g. -US).. [optional]  # noqa: E501
