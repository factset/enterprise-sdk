...
class TickerHistoryTranslationRequest(ModelNormal):
    ...
    attribute_map = {
        'ids': 'ids',  # noqa: E501
        'ticker_type': 'tickerType',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ids, ticker_type, *args, **kwargs):  # noqa: E501
        """TickerHistoryTranslationRequest - a model defined in OpenAPI

        Args:
            ids (GetIds):
            ticker_type (str): Controls the Ticker Type returned.   * **REGION** = Ticker-Regional   * **EXCHANGE** = Ticker-Exchange 
        ...
        Keyword Args:
            ...
            as_of_date (str): As-Of date for historical symbol request in YYYY-MM-DD format.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, ids, ticker_type, *args, **kwargs):  # noqa: E501
        """TickerHistoryTranslationRequest - a model defined in OpenAPI
