...
from fds.sdk.VirtualPortfolioAPIforDigitalPortals import rest
from fds.sdk.VirtualPortfolioAPIforDigitalPortals.configuration import Configuration
from fds.sdk.VirtualPortfolioAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.VirtualPortfolioAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/VirtualPortfolioAPIforDigitalPortals/0.9.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PortfolioApi()
        api_instance.portfolio_create_post  # this is an instance of the class Endpoint
        api_instance.portfolio_create_post()  # this invokes api_instance.portfolio_create_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.portfolio_create_post.callable or self.callable in this class
