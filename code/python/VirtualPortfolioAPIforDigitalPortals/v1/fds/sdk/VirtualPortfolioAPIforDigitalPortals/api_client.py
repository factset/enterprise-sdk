...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/VirtualPortfolioAPIforDigitalPortals/0.9.5'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_portfolio_get  # this is an instance of the class Endpoint
        api_instance.get_portfolio_get()  # this invokes api_instance.get_portfolio_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_portfolio_get.callable or self.callable in this class
