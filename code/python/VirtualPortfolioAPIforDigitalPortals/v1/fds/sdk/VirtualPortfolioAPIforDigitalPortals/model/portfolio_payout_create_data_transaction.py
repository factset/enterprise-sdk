...
class PortfolioPayoutCreateDataTransaction(ModelNormal):
    ...
    def _from_openapi_data(cls, id, *args, **kwargs):  # noqa: E501
        """PortfolioPayoutCreateDataTransaction - a model defined in OpenAPI

        Args:
            id (str): Identifier of the buy transaction.
