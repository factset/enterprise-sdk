...
from fds.sdk.OptimizationEngineAPIMultiperiod import rest
from fds.sdk.OptimizationEngineAPIMultiperiod.configuration import Configuration
from fds.sdk.OptimizationEngineAPIMultiperiod.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OptimizationEngineAPIMultiperiod.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OptimizationEngineAPIMultiperiod/0.21.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.mpo_v1_optimize_fpo_post  # this is an instance of the class Endpoint
        api_instance.mpo_v1_optimize_fpo_post()  # this invokes api_instance.mpo_v1_optimize_fpo_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.mpo_v1_optimize_fpo_post.callable or self.callable in this class
