...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/CompanyLogoAPIforDigitalPortals/0.9.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_company_logo_get_by_instrument  # this is an instance of the class Endpoint
        api_instance.get_company_logo_get_by_instrument()  # this invokes api_instance.get_company_logo_get_by_instrument.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_company_logo_get_by_instrument.callable or self.callable in this class
