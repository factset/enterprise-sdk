...
class ErrorObject(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): The errors member contains additional information about a failed request..  # noqa: E501

        Keyword Args:
            value ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): The errors member contains additional information about a failed request..  # noqa: E501
