...
from fds.sdk.CompanyLogoAPIforDigitalPortals import rest
from fds.sdk.CompanyLogoAPIforDigitalPortals.configuration import Configuration
from fds.sdk.CompanyLogoAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.CompanyLogoAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/CompanyLogoAPIforDigitalPortals/0.10.11'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_company_logo_get  # this is an instance of the class Endpoint
        api_instance.get_company_logo_get()  # this invokes api_instance.get_company_logo_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_company_logo_get.callable or self.callable in this class
