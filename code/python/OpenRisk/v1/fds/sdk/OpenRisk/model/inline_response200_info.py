...
class InlineResponse200Info(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, description, version, contact, *args, **kwargs):  # noqa: E501
        """InlineResponse200Info - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, description, version, contact, *args, **kwargs):  # noqa: E501
        """InlineResponse200Info - a model defined in OpenAPI
