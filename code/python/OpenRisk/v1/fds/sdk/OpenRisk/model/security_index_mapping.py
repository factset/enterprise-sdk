...
class SecurityIndexMapping(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SecurityIndexMapping - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Indicates security lot index mappings per input Holding should be provided in the response, and in which direction those indices should map. Security Labels will contain either 'indicesInputToResult' or 'indicesResultToInput' for the respective selection.., must be one of ["InputToResult", "ResultToInput", ]  # noqa: E501
