...
class HoldingAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'grouping': (SecurityGroup,),  # noqa: E501
            'uncovered_assets': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'uncovered_assets': 'uncoveredAssets',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            grouping (SecurityGroup): [optional]  # noqa: E501
            uncovered_assets (str): Uncovered asset weight handling. Default values: 'portfolio' -> ExcludeToGlobalCash, 'benchmark' -> Normalize, 'market' -> Normalize. See also [OA:21737](https://my.apps.factset.com/oa/pages/21737#group_normal_mix). [optional]  # noqa: E501
        """
