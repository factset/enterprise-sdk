...
class StatResultValueVector(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """StatResultValueVector - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([float, none_type]): Array of floating point values.  # noqa: E501

        Keyword Args:
            value ([float, none_type]): Array of floating point values.  # noqa: E501
