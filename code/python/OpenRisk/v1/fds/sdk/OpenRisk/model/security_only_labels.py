...
def lazy_import():
    ...
    globals()['SecurityOnlyLabelsSecurity'] = SecurityOnlyLabelsSecurity


class SecurityOnlyLabels(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'security': (SecurityOnlyLabelsSecurity,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, security, *args, **kwargs):  # noqa: E501
        """SecurityOnlyLabels - a model defined in OpenAPI

        Args:
            security (SecurityOnlyLabelsSecurity):
    ...
    @convert_js_args_to_python_args
    def __init__(self, security, *args, **kwargs):  # noqa: E501
        """SecurityOnlyLabels - a model defined in OpenAPI
