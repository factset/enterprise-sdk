...
def lazy_import():
    ...
    globals()['CalculateFromHoldingsRequestData'] = CalculateFromHoldingsRequestData


class CalculateFromHoldingsRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (CalculateFromHoldingsRequestData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CalculateFromHoldingsRequestBody - a model defined in OpenAPI
