...
from fds.sdk.OpenRisk import rest
from fds.sdk.OpenRisk.configuration import Configuration
from fds.sdk.OpenRisk.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OpenRisk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OpenRisk/4.0.3 ({platform.system()}, Python {platform.python_version()})'
