...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.OpenRisk/4.0.3)](https://pypi.org/project/fds.sdk.OpenRisk/v/4.0.3)
...
```shell
poetry add fds.sdk.utils fds.sdk.OpenRisk==4.0.3
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.OpenRisk==4.0.3
```
