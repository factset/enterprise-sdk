...
------------ | ------------- | ------------- | -------------
**covered** | **bool** | Coverage flag. The value will be false to indicate the security is excluded. | [optional]  if omitted the server will use the default value of False
