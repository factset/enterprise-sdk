...
class PostAndCalculateResponseWrapper:
    ...
    def get_response_201(self) -> file_type:
        """
        Raises: ApiException: Invalid response getter called.
...
class PubCalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_calculation_parameters_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (PubCalculationParametersRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.post_and_calculate_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (CalculationStatusRoot,), 201: (file_type,), 202: (CalculationStatusRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
        ...
        self.put_and_calculate_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (CalculationStatusRoot,), 201: (file_type,), 202: (CalculationStatusRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,), 409: (ClientErrorResponse,),  },
    ...
    def get_calculation_parameters_with_http_info(
        ...
        id,
        **kwargs
    ) -> typing.Tuple[PubCalculationParametersRoot, int, typing.MutableMapping]:
        """Get Pub calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[PubCalculationParametersRoot]":
        """Get Pub calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_with_http_info_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[PubCalculationParametersRoot, int, typing.MutableMapping]]":
        """Get Pub calculation parameters by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(PubCalculationParametersRoot, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['id'] = \
            id
