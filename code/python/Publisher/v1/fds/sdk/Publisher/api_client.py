...
from fds.sdk.Publisher import rest
from fds.sdk.Publisher.configuration import Configuration
from fds.sdk.Publisher.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Publisher.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Publisher/0.8.16 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_accounts  # this is an instance of the class Endpoint
        api_instance.get_accounts()  # this invokes api_instance.get_accounts.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_accounts.callable or self.callable in this class
