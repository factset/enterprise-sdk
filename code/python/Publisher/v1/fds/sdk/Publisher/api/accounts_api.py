...
from fds.sdk.Publisher.api_client import ApiClient, Endpoint as _Endpoint
...
class AccountsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_accounts_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/lookups/v2/accounts/{path}',
    ...
    def get_accounts_with_http_info(
        ...
        path="Client:Foo/Bar",
        **kwargs
    ) -> typing.Tuple[AccountDirectories, int, typing.MutableMapping]:
        """Get accounts and sub-directories in a directory  # noqa: E501
    ...
    def get_accounts_async(
        ...
        path="Client:Foo/Bar",
        **kwargs
    ) -> "ApplyResult[AccountDirectories]":
        """Get accounts and sub-directories in a directory  # noqa: E501
    ...
    def get_accounts_with_http_info_async(
        ...
        path="Client:Foo/Bar",
        **kwargs
    ) -> "ApplyResult[typing.Tuple[AccountDirectories, int, typing.MutableMapping]]":
        """Get accounts and sub-directories in a directory  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(AccountDirectories, int, typing.Dict)]
        """
