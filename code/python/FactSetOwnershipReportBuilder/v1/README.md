...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetOwnershipReportBuilder/1.1.6)](https://pypi.org/project/fds.sdk.FactSetOwnershipReportBuilder/v/1.1.6)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetOwnershipReportBuilder==1.1.6
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetOwnershipReportBuilder==1.1.6
```
...
## Documentation For Models
 ...
 - [ResponseUltimateParent](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnershipReportBuilder/v1/docs/ResponseUltimateParent.md)
