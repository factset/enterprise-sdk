...
from fds.sdk.FactSetOwnershipReportBuilder import rest
from fds.sdk.FactSetOwnershipReportBuilder.configuration import Configuration
from fds.sdk.FactSetOwnershipReportBuilder.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetOwnershipReportBuilder.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetOwnershipReportBuilder/1.1.5 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = OwnershipApi()
        api_instance.get_ownership_holders  # this is an instance of the class Endpoint
        api_instance.get_ownership_holders()  # this invokes api_instance.get_ownership_holders.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_ownership_holders.callable or self.callable in this class
