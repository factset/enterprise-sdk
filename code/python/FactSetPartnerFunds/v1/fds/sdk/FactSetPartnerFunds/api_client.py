...
from fds.sdk.FactSetPartnerFunds import rest
from fds.sdk.FactSetPartnerFunds.configuration import Configuration
from fds.sdk.FactSetPartnerFunds.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPartnerFunds.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetPartnerFunds/0.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CanadianMutualFundDataFromFundataApi()
        api_instance.get_asset_allocations  # this is an instance of the class Endpoint
        api_instance.get_asset_allocations()  # this invokes api_instance.get_asset_allocations.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_asset_allocations.callable or self.callable in this class
