...
from fds.sdk.RecommendationListAPIforDigitalPortals import rest
from fds.sdk.RecommendationListAPIforDigitalPortals.configuration import Configuration
from fds.sdk.RecommendationListAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.RecommendationListAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/RecommendationListAPIforDigitalPortals/0.10.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = RecommendationListApi()
        api_instance.get_recommendation_list_get  # this is an instance of the class Endpoint
        api_instance.get_recommendation_list_get()  # this invokes api_instance.get_recommendation_list_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_recommendation_list_get.callable or self.callable in this class
