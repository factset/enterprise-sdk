...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetEstimatesReportBuilder/1.0.14)](https://pypi.org/project/fds.sdk.FactSetEstimatesReportBuilder/v/1.0.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetEstimatesReportBuilder==1.0.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetEstimatesReportBuilder==1.0.14
```
