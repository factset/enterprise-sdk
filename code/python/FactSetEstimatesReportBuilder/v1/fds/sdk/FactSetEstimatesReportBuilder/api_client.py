...
from fds.sdk.FactSetEstimatesReportBuilder import rest
from fds.sdk.FactSetEstimatesReportBuilder.configuration import Configuration
from fds.sdk.FactSetEstimatesReportBuilder.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetEstimatesReportBuilder.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetEstimatesReportBuilder/1.0.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AllEstimatesApi()
        api_instance.get_estimates_balance_sheet  # this is an instance of the class Endpoint
        api_instance.get_estimates_balance_sheet()  # this invokes api_instance.get_estimates_balance_sheet.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_estimates_balance_sheet.callable or self.callable in this class
