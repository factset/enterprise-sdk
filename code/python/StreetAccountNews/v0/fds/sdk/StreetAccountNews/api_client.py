...
from fds.sdk.StreetAccountNews import rest
from fds.sdk.StreetAccountNews.configuration import Configuration
from fds.sdk.StreetAccountNews.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.StreetAccountNews.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/StreetAccountNews/0.20.3'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_street_account_filters  # this is an instance of the class Endpoint
        api_instance.get_street_account_filters()  # this invokes api_instance.get_street_account_filters.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_street_account_filters.callable or self.callable in this class
