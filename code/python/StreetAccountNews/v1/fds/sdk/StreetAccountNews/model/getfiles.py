...
class Getfiles(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start_date (datetime): The startDate from which the data is required in YYYY-MM-DDTHH:MM:SSZ format. [optional]  # noqa: E501
            end_date (datetime): The endDate until which the data is fetched in YYYY-MM-DDTHH:MM:SSZ format. [optional]  # noqa: E501
            id (str): Unique id to get the xml files for the requested date. [optional]  # noqa: E501
