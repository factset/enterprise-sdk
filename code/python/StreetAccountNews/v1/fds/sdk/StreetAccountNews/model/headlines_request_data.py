...
class HeadlinesRequestData(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            tickers ([HeadlinesRequestTickersObject]): List of tickers to filter the headlines. Each ticker is an object.. [optional]  # noqa: E501
            ...
            categories ([str]): A list of categories used to filter the headlines. Categories are define the nature or topic of the headlines, such as \"Earnings\". Use the `/filters/categories` endpoint to get the list of available categories.. [optional]  # noqa: E501
            topics ([str]): A list of topics used to filter the headlines. Topics represent specific subjects or themes associated with the headlines, such as \"Market Summaries\". Use the `/filters/topics` endpoint to get the list of available topics.. [optional]  # noqa: E501
            regions ([str]): A list of regions used to filter the headlines. Regions specify the geographical location or market to which the headlines are relevant, for example, \"North America\". Use the `/filters/regions` endpoint to get the list of available regions.. [optional]  # noqa: E501
            sectors ([str]): A list of sectors used to filter the headlines. Sectors are segments or divisions of the economy or market provided by StreetAccount, such as \"Financial\". Use the `/filters/sectors`endpoint to get the list of available sectors.. [optional]  # noqa: E501
