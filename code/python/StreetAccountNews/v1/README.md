...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.StreetAccountNews/1.2.0)](https://pypi.org/project/fds.sdk.StreetAccountNews/v/1.2.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.StreetAccountNews==1.2.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.StreetAccountNews==1.2.0
```
