...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.StreetAccountNews/1.2.1)](https://pypi.org/project/fds.sdk.StreetAccountNews/v/1.2.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.StreetAccountNews==1.2.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.StreetAccountNews==1.2.1
```
