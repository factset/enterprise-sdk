...
[![API Version](https://img.shields.io/badge/api-v1.2.1-blue)](https://developer.factset.com/api-catalog/streetaccount-news-api)
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.StreetAccountNews/2.1.0)](https://pypi.org/project/fds.sdk.StreetAccountNews/v/2.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.StreetAccountNews==2.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.StreetAccountNews==2.1.0
```
...
*SABurstsApi* | [**get_latest_burst_file**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/StreetAccountNews/v1/docs/SABurstsApi.md#get_latest_burst_file) | **GET** /sa-bursts/latest-file | Retrieve the latest burst file metadata and download URL
...
## Documentation For Models
 ...
 - [BurstFileResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/StreetAccountNews/v1/docs/BurstFileResponse.md)
 - [BurstFileResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/StreetAccountNews/v1/docs/BurstFileResponseData.md)
