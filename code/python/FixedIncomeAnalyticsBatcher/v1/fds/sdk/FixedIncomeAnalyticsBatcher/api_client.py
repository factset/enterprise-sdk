...
from fds.sdk.FixedIncomeAnalyticsBatcher import rest
from fds.sdk.FixedIncomeAnalyticsBatcher.configuration import Configuration
from fds.sdk.FixedIncomeAnalyticsBatcher.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FixedIncomeAnalyticsBatcher.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FixedIncomeAnalyticsBatcher/0.21.15 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FIABCalculationsApi()
        api_instance.get_fiab_calculation_by_id  # this is an instance of the class Endpoint
        api_instance.get_fiab_calculation_by_id()  # this invokes api_instance.get_fiab_calculation_by_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_fiab_calculation_by_id.callable or self.callable in this class
