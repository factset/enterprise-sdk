...
class ModelAccountSchemaRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ModelAccountAdditionalField],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ModelAccountSchemaRoot - a model defined in OpenAPI

        Args:
            data ([ModelAccountAdditionalField]):
