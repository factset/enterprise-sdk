...
------------- | ------------- | -------------
[**create_entity_task**](EntityMatchBulkApi.md#create_entity_task) | **POST** /factset-concordance/v1/entity-task | Input a file with names and attributes, creating a taskId.
[**get_entity_decisions**](EntityMatchBulkApi.md#get_entity_decisions) | **GET** /factset-concordance/v1/entity-decisions | Get the decisions of matches for the requested taskId.
[**get_entity_task_status**](EntityMatchBulkApi.md#get_entity_task_status) | **GET** /factset-concordance/v1/entity-task-status | Gets the status of the requested taskId or all tasks for a User


# **create_entity_task**
> EntityTaskResponse create_entity_task(task_name, input_file, client_id_column, name_column)
...
with fds.sdk.FactSetConcordance.ApiClient(configuration) as api_client:
    ...
    try:
        # Input a file with names and attributes, creating a taskId.
        api_response = api_instance.create_entity_task(task_name, input_file, client_id_column, name_column)
        pprint(api_response)
    except fds.sdk.FactSetConcordance.ApiException as e:
        print("Exception when calling EntityMatchBulkApi->create_entity_task: %s\n" % e)
