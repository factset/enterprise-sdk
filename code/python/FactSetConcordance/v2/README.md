...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetConcordance/1.0.2)](https://pypi.org/project/fds.sdk.FactSetConcordance/v/1.0.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetConcordance==1.0.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetConcordance==1.0.2
```
