...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetConcordance/2.0.1)](https://pypi.org/project/fds.sdk.FactSetConcordance/v/2.0.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetConcordance==2.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetConcordance==2.0.1
```
