 ...
 **country** | **str**| ISO2 country code corresponding to the entity name that is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754#country). | [optional]
    ...
    entity_match_request = EntityMatchRequest(
        input=[
            EntityMatchRequestInput(
                ...
                spr="562703",
                ticker="PriceTicker",
                ticker_exchange="TSLA-NAS",
                ticker_region="TSLA-US",
                ukch="CE012494",
                valoren="",
                wkn="A1CX3T",
                additional_context={
