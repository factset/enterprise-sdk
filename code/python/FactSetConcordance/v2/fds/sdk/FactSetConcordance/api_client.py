...
from fds.sdk.FactSetConcordance import rest
from fds.sdk.FactSetConcordance.configuration import Configuration
from fds.sdk.FactSetConcordance.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetConcordance.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetConcordance/0.23.1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntityMappingsApi()
        api_instance.get_entity_mapping_delete_for_list  # this is an instance of the class Endpoint
        api_instance.get_entity_mapping_delete_for_list()  # this invokes api_instance.get_entity_mapping_delete_for_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_entity_mapping_delete_for_list.callable or self.callable in this class
