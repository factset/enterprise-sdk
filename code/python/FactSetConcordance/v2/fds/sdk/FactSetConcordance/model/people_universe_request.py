...
class PeopleUniverseRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, universe_id, *args, **kwargs):  # noqa: E501
        """PeopleUniverseRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            offset (int): starting row of the universe. [optional]  # noqa: E501
            limit (int): Limits the number of records in the response.. [optional]  # noqa: E501
            map_status ([str]): Filter by the People Decisions that have the specified mapStatus, where -       * MAPPED - The requested Entity Name is successfully mapped to a FactSet Entity Id (-E)       * UNMAPPED - The requested Entity Name is unmapped by FactSet.       * INDETERMINATE - The requested Entity Name was unable to make a mapping. . [optional]  # noqa: E501
            client_id ([str]): fetch only the mappings that has client id included in the specified list.. [optional]  # noqa: E501
            sort ([str]): fetch according to sort orders. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, universe_id, *args, **kwargs):  # noqa: E501
        """PeopleUniverseRequest - a model defined in OpenAPI
