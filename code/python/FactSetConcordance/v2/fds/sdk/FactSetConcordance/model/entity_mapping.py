...
class EntityMapping(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'client_creditsafe': (str, none_type,),  # noqa: E501
            'client_crunchbase': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            client_creditsafe (str, none_type): Creditsafe Identifier. [optional]  # noqa: E501
            client_crunchbase (str, none_type): Crunchbase Identifier. [optional]  # noqa: E501
            ...
            client_exclude_entity_type ([str]): Entity types excluded by the user. If provided, entities with the specified entity types will not be considered. . [optional]  # noqa: E501
            client_exclude_entity_sub_type ([str]): Entity sub-types excluded by the user. If provided, entities with the specified entity sub-types will not be considered. . [optional]  # noqa: E501
            client_include_entity_type ([str]): Entity types included by the user. If provided, only entities with the specified entity types will be considered. . [optional]  # noqa: E501
            client_include_entity_sub_type ([str]): Entity sub-types included by the user. If provided, only entities with the specified entity sub-types will be considered. . [optional]  # noqa: E501
        """
