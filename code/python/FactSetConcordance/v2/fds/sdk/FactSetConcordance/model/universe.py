...
class Universe(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Universe - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            universe_type (str, none_type): The user specified universe entity.. [optional]  # noqa: E501
            ...
            auto_remap (bool): When `true`, allows automatic re-evaluation and overwriting of existing mappings in the universe when new metadata is submitted.. [optional]  # noqa: E501
        """
