...
class EntityMatchRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'candidates_count': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'candidates_count': 'candidatesCount',  # noqa: E501
    ...
    def _from_openapi_data(cls, input, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            candidates_count (int): Maximum number of candidates to be returned. Parent entities, when includeParent is true, are not included in this count. . [optional] if omitted the server will use the default value of 20  # noqa: E501
