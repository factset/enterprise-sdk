...
class SnowflakeEntityMappingRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SnowflakeEntityMappingRequest - a model defined in OpenAPI

        Args:
            data ([[{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]]): Array of input rows
