        ...
        self.get_entity_task_for_list_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'creditsafe_column': 'creditsafeColumn',
                    'crunchbase_column': 'crunchbaseColumn',
                    'cusip_column': 'cusipColumn',
                    'ein_column': 'einColumn',
                    'factset_id_column': 'factsetIdColumn',
                    'fitch_column': 'fitchColumn',
                    'gvkey_column': 'gvkeyColumn',
                    'gvkey_iid_column': 'gvkeyIidColumn',
                    'isin_column': 'isinColumn',
                    'jcn_column': 'jcnColumn',
                    'lei_column': 'leiColumn',
                    'lxid_column': 'lxidColumn',
                    'md_column': 'mdColumn',
                    'red_code_column': 'redCodeColumn',
                ...
                'location_map': {
                    ...
                    'cik_column': 'form',
                    'crd_column': 'form',
                    'creditsafe_column': 'form',
                    'crunchbase_column': 'form',
                    'cusip_column': 'form',
                    'ein_column': 'form',
                    'factset_id_column': 'form',
                    'fitch_column': 'form',
                    'gvkey_column': 'form',
                    'gvkey_iid_column': 'form',
                    'isin_column': 'form',
                    'jcn_column': 'form',
                    'lei_column': 'form',
                    'lxid_column': 'form',
                    'md_column': 'form',
                    'red_code_column': 'form',
                    'rssd_column': 'form',
                    'sedol_column': 'form',
                    'spr_column': 'form',
                    'ticker_column': 'form',
