...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetGlobalPrices/2.5.1)](https://pypi.org/project/fds.sdk.FactSetGlobalPrices/v/2.5.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetGlobalPrices==2.5.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetGlobalPrices==2.5.1
```
