...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetGlobalPrices/2.8.0)](https://pypi.org/project/fds.sdk.FactSetGlobalPrices/v/2.8.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetGlobalPrices==2.8.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetGlobalPrices==2.8.0
```
...
*ReturnsApi* | [**get_range**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetGlobalPrices/v1/docs/ReturnsApi.md#get_range) | **GET** /factset-global-prices/v1/returns-range | Retrieves returns for specified IDs and currency within a required custom date range.
...
*ReturnsApi* | [**get_returns_range_for_list**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetGlobalPrices/v1/docs/ReturnsApi.md#get_returns_range_for_list) | **POST** /factset-global-prices/v1/returns-range | Retrieves returns for specified IDs and currency within a required custom date range.
...
## Documentation For Models
 ...
 - [RangeRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetGlobalPrices/v1/docs/RangeRequest.md)
 - [RangeResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetGlobalPrices/v1/docs/RangeResponse.md)
 - [Returns](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetGlobalPrices/v1/docs/Returns.md)
 - [ReturnsRange](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetGlobalPrices/v1/docs/ReturnsRange.md)
