...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetGlobalPrices/2.2.4)](https://pypi.org/project/fds.sdk.FactSetGlobalPrices/v/2.2.4)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetGlobalPrices==2.2.4
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetGlobalPrices==2.2.4
```
