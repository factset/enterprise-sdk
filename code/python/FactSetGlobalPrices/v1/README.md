...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetGlobalPrices/3.1.0)](https://pypi.org/project/fds.sdk.FactSetGlobalPrices/v/3.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetGlobalPrices==3.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetGlobalPrices==3.1.0
```
