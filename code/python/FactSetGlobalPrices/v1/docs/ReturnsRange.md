...
------------ | ------------- | ------------- | -------------
**fsym_id** | **str, none_type** | FactSet Permanent Identifier. Six alpha-numeric characters, excluding vowels, with an -R suffix (XXXXXX-R) or a -L Suffix (XXXXXX-L). | [optional] 
