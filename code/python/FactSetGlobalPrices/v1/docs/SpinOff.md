...
**company_name** | **str, none_type** | Name of the company/security that declared the spin-off. | [optional] 
...
**price_adj_factor** | **float, none_type** | The price adjustment factor associated with the rights, spin-off, split, bonus or stock dividend event. | [optional] 
