...
------------- | ------------- | -------------
[**get_range**](ReturnsApi.md#get_range) | **GET** /factset-global-prices/v1/returns-range | Retrieves returns for specified IDs and currency within a required custom date range.
...
[**get_returns_range_for_list**](ReturnsApi.md#get_returns_range_for_list) | **POST** /factset-global-prices/v1/returns-range | Retrieves returns for specified IDs and currency within a required custom date range.



# **get_range**
> RangeResponse get_range(ids, start_date, end_date)
...
with fds.sdk.FactSetGlobalPrices.ApiClient(configuration) as api_client:
    ...
    end_date = "2021-08-27" # str | The end date requested for a given date range in **YYYY-MM-DD** format. The input end date is required and must come after the input start date. Future dates (T+1) are not accepted in this endpoint. 
    ...
    try:
        ...
        # and optional values
        api_response_wrapper = api_instance.get_range(ids, start_date, end_date, currency=currency, dividend_adjust=dividend_adjust, batch=batch)
        ...
        print("Exception when calling ReturnsApi->get_range: %s\n" % e)
```
 ...
 **end_date** | **str**| The end date requested for a given date range in **YYYY-MM-DD** format. The input end date is required and must come after the input start date. Future dates (T+1) are not accepted in this endpoint.  |
...
- **200**: [**RangeResponse**](RangeResponse.md)
...
# **get_returns_range_for_list**
> RangeResponse get_returns_range_for_list(range_request)
...
with fds.sdk.FactSetGlobalPrices.ApiClient(configuration) as api_client:
    ...
    range_request = RangeRequest(
        ...
        dividend_adjust=DividendAdjust("EXDATE_C"),
        batch=Batch("N"),
    ) # RangeRequest | Request object for `ReturnsRange`.

    try:
        # Retrieves returns for specified IDs and currency within a required custom date range.
        # example passing only required values which don't have defaults set
        api_response_wrapper = api_instance.get_returns_range_for_list(range_request)
        ...
        print("Exception when calling ReturnsApi->get_returns_range_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **range_request** | [**RangeRequest**](RangeRequest.md)| Request object for &#x60;ReturnsRange&#x60;. |
