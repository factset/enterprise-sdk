...
**company_name** | **str, none_type** | Name of the company/security that declared the dividend. | [optional] 
...
**dividend_type** | **str, none_type** | Dividend Type Description. For available values, visit [Online Assistant Page #8764](https://oa.apps.factset.com/pages/8764). | [optional] 
**dividend_status** | **str, none_type** | Identifies the dividend status( Active, Cancelled, Postponed, Partial Information). | [optional] 
**dividend_per_share** | **float, none_type** | The amount to be paid as per the dividend event in the declared currency. | [optional] 
**declared_currency** | **str, none_type** | Currency ISO code in which the distribution amount is declared. | [optional] 
**event_description** | **str, none_type** | Textual description identifying the event. Example- Split (Mandatory): 3 for 1. | [optional] 
