...
**company_name** | **str, none_type** | Name of the company/security that declared the rights issue. | [optional] 
...
**rights_issue_price** | **float, none_type** | Price at which the rights are issued. | [optional] 
**rights_issue_currency** | **str, none_type** | Currency ISO code in which the rights are issued. | [optional] 
**price_adj_factor** | **float, none_type** | The price adjustment factor associated with the rights issue. | [optional] 
