...
def lazy_import():
    ...
    globals()['SharesOutstandingRequestBody'] = SharesOutstandingRequestBody


class SharesOutstandingRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (SharesOutstandingRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SharesOutstandingRequest - a model defined in OpenAPI
