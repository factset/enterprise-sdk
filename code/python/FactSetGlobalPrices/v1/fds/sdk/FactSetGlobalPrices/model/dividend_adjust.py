...
class DividendAdjust(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Controls the dividend reinvestment for the returns calculation.   * **PRICE** = Price Change - Dividends Excluded.   * **EXDATE** = Simple Return - Dividends Received on exdate but not reinvested.   * **EXDATE_C** = Compound Return - Dividends reinvested on exdate. . if omitted defaults to "EXDATE_C", must be one of ["PRICE", "EXDATE", "EXDATE_C", ]  # noqa: E501
