...
class EventCategory(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Selects the Event Category to include in the response.   * **CASH_DIVS** = Cash Dividends   * **STOCK_DIST** = Stock Distributions   * **SPINOFFS** = Spin Offs   * **RIGHTS** = Rights Issue   * **SPLITS** = Splits   * **ALL** = Returns all Event Types. If left blank the service will default to ALL. . if omitted defaults to "ALL", must be one of ["CASH_DIVS", "STOCK_DIST", "RIGHTS", "SPINOFFS", "SPLITS", "ALL", ]  # noqa: E501
