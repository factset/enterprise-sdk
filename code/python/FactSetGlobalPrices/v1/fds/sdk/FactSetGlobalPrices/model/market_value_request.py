...
def lazy_import():
    ...
    globals()['MarketValueRequestBody'] = MarketValueRequestBody


class MarketValueRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (MarketValueRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """MarketValueRequest - a model defined in OpenAPI

        Args:
            data (MarketValueRequestBody):
