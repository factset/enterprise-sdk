...
class GlobalPricesRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ids, start_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            fields (PricesFields): [optional]  # noqa: E501
            ...
            currency (str): Currency code for adjusting prices. Default is Local. For a list of currency ISO codes, visit [Online Assistant Page 1470](https://oa.apps.factset.com/pages/1470).. [optional] if omitted the server will use the default value of "LOCAL"  # noqa: E501
            calendar (Calendar): [optional]  # noqa: E501
            adjust (Adjust): [optional]  # noqa: E501
            precision (Precision): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, ids, start_date, *args, **kwargs):  # noqa: E501
        """GlobalPricesRequest - a model defined in OpenAPI
