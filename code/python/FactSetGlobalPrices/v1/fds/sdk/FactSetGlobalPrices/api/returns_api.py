...
class GetRangeResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetRangeResponseWrapper
    ...
    def get_response_200(self) -> RangeResponse:
        """
...
class GetReturnsRangeForListResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetReturnsRangeForListResponseWrapper
        to status_code, response
...
class ReturnsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_range_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (RangeResponse,), 202: (BatchStatusResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                ...
                'endpoint_path': '/factset-global-prices/v1/returns-range',
        ...
        self.get_returns_range_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (RangeResponse,), 202: (BatchStatusResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                ...
                'endpoint_path': '/factset-global-prices/v1/returns-range',
                'operation_id': 'get_returns_range_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_range(
        ...
        **kwargs
        ...
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501

        Returns the total calculated returns for the specified IDs and currency over a required date range, defined by the mandatory parameters `startDate` and `endDate`.     # noqa: E501
    ...
    def get_range_with_http_info(
        ...
        end_date,
        **kwargs
    ) -> typing.Tuple[GetRangeResponseWrapper, int, typing.MutableMapping]:
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501
    ...
    def get_range_async(
        ...
        end_date,
        **kwargs
    ) -> "ApplyResult[GetRangeResponseWrapper]":
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501
    ...
    def get_range_with_http_info_async(
        self,
        ids,
        start_date,
        end_date,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetRangeResponseWrapper, int, typing.MutableMapping]]":
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetRangeResponseWrapper, int, typing.Dict)]
        """
    ...
    def get_returns_range_for_list(
        self,
        range_request,
        **kwargs
    ) -> GetReturnsRangeForListResponseWrapper:
        ...
        Args:
            range_request (RangeRequest): Request object for `ReturnsRange`.
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['range_request'] = \
            range_request
        return self.get_returns_range_for_list_endpoint.call_with_http_info(**kwargs)

    def get_returns_range_for_list_with_http_info(
        self,
        range_request,
        **kwargs
    ) -> typing.Tuple[GetReturnsRangeForListResponseWrapper, int, typing.MutableMapping]:
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501
    ...
    def get_returns_range_for_list_async(
        self,
        range_request,
        **kwargs
    ) -> "ApplyResult[GetReturnsRangeForListResponseWrapper]":
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501
    ...
    def get_returns_range_for_list_with_http_info_async(
        self,
        range_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetReturnsRangeForListResponseWrapper, int, typing.MutableMapping]]":
        """Retrieves returns for specified IDs and currency within a required custom date range.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetReturnsRangeForListResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['range_request'] = \
            range_request
