...
class PricesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_gpd_prices_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (GlobalPricesResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_gpd_prices_with_http_info(
        ...
        end_date,
        **kwargs
    ) -> typing.Tuple[GlobalPricesResponse, int, typing.MutableMapping]:
        """Gets end-of-day Open, High, Low, Close for a list of securities.  # noqa: E501
    ...
    def get_gpd_prices_async(
        ...
        end_date,
        **kwargs
    ) -> "ApplyResult[GlobalPricesResponse]":
        """Gets end-of-day Open, High, Low, Close for a list of securities.  # noqa: E501
    ...
    def get_gpd_prices_with_http_info_async(
        ...
        end_date,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GlobalPricesResponse, int, typing.MutableMapping]]":
        """Gets end-of-day Open, High, Low, Close for a list of securities.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GlobalPricesResponse, int, typing.Dict)]
        """
