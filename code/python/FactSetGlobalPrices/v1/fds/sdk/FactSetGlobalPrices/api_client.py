...
from fds.sdk.FactSetGlobalPrices import rest
from fds.sdk.FactSetGlobalPrices.configuration import Configuration
from fds.sdk.FactSetGlobalPrices.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetGlobalPrices.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetGlobalPrices/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CorporateActionsApi()
        api_instance.get_gpd_corporate_actions  # this is an instance of the class Endpoint
        api_instance.get_gpd_corporate_actions()  # this invokes api_instance.get_gpd_corporate_actions.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_gpd_corporate_actions.callable or self.callable in this class
