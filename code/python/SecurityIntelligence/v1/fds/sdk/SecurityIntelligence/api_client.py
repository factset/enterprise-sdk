...
from fds.sdk.SecurityIntelligence import rest
from fds.sdk.SecurityIntelligence.configuration import Configuration
from fds.sdk.SecurityIntelligence.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.SecurityIntelligence.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/SecurityIntelligence/0.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CompanySummaryApi()
        api_instance.get_company_debt_summary  # this is an instance of the class Endpoint
        api_instance.get_company_debt_summary()  # this invokes api_instance.get_company_debt_summary.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_company_debt_summary.callable or self.callable in this class
