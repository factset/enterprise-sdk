...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.SecurityIntelligence/0.2.0)](https://pypi.org/project/fds.sdk.SecurityIntelligence/v/0.2.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.SecurityIntelligence==0.2.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.SecurityIntelligence==0.2.0
```
