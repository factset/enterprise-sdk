...
from fds.sdk.CapitalStructureReportBuilder import rest
from fds.sdk.CapitalStructureReportBuilder.configuration import Configuration
from fds.sdk.CapitalStructureReportBuilder.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.CapitalStructureReportBuilder.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/CapitalStructureReportBuilder/1.0.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CapitalStructureApi()
        api_instance.get_dcs_detail  # this is an instance of the class Endpoint
        api_instance.get_dcs_detail()  # this invokes api_instance.get_dcs_detail.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_dcs_detail.callable or self.callable in this class
