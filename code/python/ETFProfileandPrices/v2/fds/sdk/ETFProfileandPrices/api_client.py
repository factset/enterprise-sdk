...
from fds.sdk.ETFProfileandPrices import rest
from fds.sdk.ETFProfileandPrices.configuration import Configuration
from fds.sdk.ETFProfileandPrices.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ETFProfileandPrices.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ETFProfileandPrices/0.10.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FactsetApi()
        api_instance.get_factset_etf_allocation_asset_list_by_symbol  # this is an instance of the class Endpoint
        api_instance.get_factset_etf_allocation_asset_list_by_symbol()  # this invokes api_instance.get_factset_etf_allocation_asset_list_by_symbol.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_factset_etf_allocation_asset_list_by_symbol.callable or self.callable in this class
