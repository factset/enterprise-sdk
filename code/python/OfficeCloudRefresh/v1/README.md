...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.OfficeCloudRefresh/0.1.1)](https://pypi.org/project/fds.sdk.OfficeCloudRefresh/v/0.1.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.OfficeCloudRefresh==0.1.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.OfficeCloudRefresh==0.1.1
```
