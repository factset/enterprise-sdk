...
from fds.sdk.OfficeCloudRefresh import rest
from fds.sdk.OfficeCloudRefresh.configuration import Configuration
from fds.sdk.OfficeCloudRefresh.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OfficeCloudRefresh.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OfficeCloudRefresh/0.2.1 ({platform.system()}, Python {platform.python_version()})'
