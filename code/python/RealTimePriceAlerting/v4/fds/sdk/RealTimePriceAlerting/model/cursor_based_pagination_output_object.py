...
class CursorBasedPaginationOutputObject(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_estimated_total': (bool, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            total (int, none_type): Total number of entries in the result set.. [optional]  # noqa: E501
            is_estimated_total (bool, none_type): Flag indicating that the value of `total` is estimated.. [optional]  # noqa: E501
            next (str, none_type): The next cursor position to use in the parameter `pagination.cursor` for an endpoint that supports cursor-based pagination, otherwise `null`.. [optional]  # noqa: E501
            previous (str, none_type): The previous cursor position to use in the parameter `pagination.cursor` for an endpoint that supports cursor-based pagination. If a previous cursor position is not supported or available, `previous` is `null`.. [optional]  # noqa: E501
        """
