...
class GetAlertingPricesBasicAlertListDataItemsTriggerPrice(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetAlertingPricesBasicAlertListDataItemsTriggerPrice - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str, none_type): Type of the price as configured for the customer. | Value | Description | | --- | --- | | trade | Trade price (ordinary, auction, pre or post-trading). | | bid | Bid price. | | ask | Ask price. |  . [optional]  # noqa: E501
            quality (str, none_type): Quality of the price. | Value | Description | | --- | --- | | RLT | Real-time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours or days. |  . [optional]  # noqa: E501
        """
