...
class PostAlertingPricesBasicTriggerListRequestDataFilterStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostAlertingPricesBasicTriggerListRequestDataFilterStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (str): Code of the status. | Value | Description | | --- | --- | | active | The trigger is active and trigger conditions are evaluated. | | inactive | The trigger is inactive and conditions do not generate alerts. | | error | The trigger is in an error state, error details are noted in `details` |  . [optional]  # noqa: E501
        """
