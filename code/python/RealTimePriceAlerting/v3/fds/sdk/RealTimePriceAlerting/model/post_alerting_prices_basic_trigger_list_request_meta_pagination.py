...
class PostAlertingPricesBasicTriggerListRequestMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostAlertingPricesBasicTriggerListRequestMetaPagination - a model defined in OpenAPI
