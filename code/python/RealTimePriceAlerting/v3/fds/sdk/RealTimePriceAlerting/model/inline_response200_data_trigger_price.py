...
class InlineResponse200DataTriggerPrice(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse200DataTriggerPrice - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            quality (str, none_type): Price quality of the trigger. | Value | Description | | --- | --- | | RLT | Real-Time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours. |  . [optional]  # noqa: E501
        """
