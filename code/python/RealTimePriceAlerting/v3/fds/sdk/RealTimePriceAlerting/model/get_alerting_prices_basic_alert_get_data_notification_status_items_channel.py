...
class GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel - a model defined in OpenAPI
