...
from fds.sdk.RealTimePriceAlerting import rest
from fds.sdk.RealTimePriceAlerting.configuration import Configuration
from fds.sdk.RealTimePriceAlerting.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.RealTimePriceAlerting.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/RealTimePriceAlerting/0.12.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AlertingApi()
        api_instance.get_alerting_prices_basic_alert_get  # this is an instance of the class Endpoint
        api_instance.get_alerting_prices_basic_alert_get()  # this invokes api_instance.get_alerting_prices_basic_alert_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_alerting_prices_basic_alert_get.callable or self.callable in this class
