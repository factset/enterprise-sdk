...
**trading_volume** | **float, none_type** | Number of units (e.g. shares) solicited. | [optional] 
**trading_value** | **float, none_type** | Monetary equivalent (cash value) of the offer. See attribute &#x60;currency&#x60; for its unit. | [optional] 
