...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve FactSet identifiers for a given notation.
        api_response = api_instance.get_notation_cross_reference_fact_set_identifier_get(id)
        pprint(api_response)
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Translate a FactSet market symbol to a notation.
        api_response = api_instance.get_notation_cross_reference_get_by_fact_set_market_symbol(fact_set_market_symbol)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Basic data for a notation.
        api_response = api_instance.get_notation_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of one month.
        api_response = api_instance.get_notation_key_figures_month_1_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of one month, for a list of notations.
        api_response = api_instance.get_notation_key_figures_month_1_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of three months.
        api_response = api_instance.get_notation_key_figures_month_3_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of three months, for a list of notations.
        api_response = api_instance.get_notation_key_figures_month_3_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of six months.
        api_response = api_instance.get_notation_key_figures_month_6_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of six months, for a list of notations.
        api_response = api_instance.get_notation_key_figures_month_6_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of one week.
        api_response = api_instance.get_notation_key_figures_week_1_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of one week, for a list of notations.
        api_response = api_instance.get_notation_key_figures_week_1_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of one year.
        api_response = api_instance.get_notation_key_figures_year_1_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of one year, for a list of notations.
        api_response = api_instance.get_notation_key_figures_year_1_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of three years.
        api_response = api_instance.get_notation_key_figures_year_3_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of three years, for a list of notations.
        api_response = api_instance.get_notation_key_figures_year_3_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of five years.
        api_response = api_instance.get_notation_key_figures_year_5_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range of five years, for a list of notations.
        api_response = api_instance.get_notation_key_figures_year_5_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range year-to-date (YTD)..
        api_response = api_instance.get_notation_key_figures_year_to_date_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # End-of-day (EOD) key figures for the time range year-to-date (YTD), for a list of notations..
        api_response = api_instance.get_notation_key_figures_year_to_date_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Basic data for a list of notations.
        api_response = api_instance.get_notation_list(ids)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Basic search for notations.
        api_response = api_instance.get_notation_search_basic(search_value)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Basic search for notations.
        api_response = api_instance.get_notation_search_by_text_ranked_by_volume(search_value)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
        print("Exception when calling NotationApi->get_notation_search_by_text_ranked_by_volume: %s\n" % e)
...
with fds.sdk.QuotesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    try:
        # Intraday trading status of a notation.
        api_response = api_instance.get_notation_status_get(id)
        pprint(api_response)
    except fds.sdk.QuotesAPIforDigitalPortals.ApiException as e:
