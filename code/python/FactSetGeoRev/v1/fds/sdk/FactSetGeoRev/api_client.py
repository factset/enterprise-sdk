...
from fds.sdk.FactSetGeoRev import rest
from fds.sdk.FactSetGeoRev.configuration import Configuration
from fds.sdk.FactSetGeoRev.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetGeoRev.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetGeoRev/1.0.14 ({platform.system()}, Python {platform.python_version()})'
