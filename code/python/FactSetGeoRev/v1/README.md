...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetGeoRev/1.0.14)](https://pypi.org/project/fds.sdk.FactSetGeoRev/v/1.0.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetGeoRev==1.0.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetGeoRev==1.0.14
```
