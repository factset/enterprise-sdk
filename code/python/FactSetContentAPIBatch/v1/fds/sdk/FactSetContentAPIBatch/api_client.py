...
from fds.sdk.FactSetContentAPIBatch import rest
from fds.sdk.FactSetContentAPIBatch.configuration import Configuration
from fds.sdk.FactSetContentAPIBatch.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetContentAPIBatch.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetContentAPIBatch/0.21.13 ({platform.system()}, Python {platform.python_version()})'
