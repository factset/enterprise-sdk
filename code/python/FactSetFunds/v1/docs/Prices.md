...
**price** | **float** | The NAV for the requested share class. NOTE - FactSet Mutual Funds does not use seven-day yields to price money market funds. | [optional] 
**date** | **str** | The date of the NAV in YYYY-MM-DD format. | [optional] 
