# fds.sdk.FactSetFunds.BatchProcessingApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_batch_data**](BatchProcessingApi.md#get_batch_data) | **GET** /factset-funds/v1/batch-result | Returns the response for a Batch Request
[**get_batch_status**](BatchProcessingApi.md#get_batch_status) | **GET** /factset-funds/v1/batch-status | Returns the status for a Batch Request
...
from fds.sdk.FactSetFunds.api import batch_processing_api
