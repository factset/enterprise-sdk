...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetFunds/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FundFlowsAUMApi()
        api_instance.get_funds_aum  # this is an instance of the class Endpoint
        api_instance.get_funds_aum()  # this invokes api_instance.get_funds_aum.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_funds_aum.callable or self.callable in this class
