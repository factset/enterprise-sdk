...
from fds.sdk.FactSetFunds import rest
from fds.sdk.FactSetFunds.configuration import Configuration
from fds.sdk.FactSetFunds.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetFunds.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetFunds/2.2.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DistributionsApi()
        api_instance.get_funds_dist_current  # this is an instance of the class Endpoint
        api_instance.get_funds_dist_current()  # this invokes api_instance.get_funds_dist_current.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_funds_dist_current.callable or self.callable in this class
