...
class GetMarketAggregatesResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetMarketAggregatesResponseWrapper
    ...
    def get_response_200(self) -> MarketAggregatesResponse:
        """
        Raises: ApiException: Invalid response getter called.

        Returns: The Market Aggregates response object.
        """
...
class GetMarketAggregatesForListResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetMarketAggregatesForListResponseWrapper
        to status_code, response
...
class MarketAggregatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_market_aggregates_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (MarketAggregatesResponse,), 202: (BatchStatusResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
    ...
    def get_market_aggregates_with_http_info(
        ...
        ids,
        **kwargs
    ) -> typing.Tuple[GetMarketAggregatesResponseWrapper, int, typing.MutableMapping]:
        """Get market aggregates for a requested time series.  # noqa: E501
    ...
    def get_market_aggregates_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[GetMarketAggregatesResponseWrapper]":
        """Get market aggregates for a requested time series.  # noqa: E501
    ...
    def get_market_aggregates_with_http_info_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetMarketAggregatesResponseWrapper, int, typing.MutableMapping]]":
        """Get market aggregates for a requested time series.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetMarketAggregatesResponseWrapper, int, typing.Dict)]
        """
    ...
    def get_market_aggregates_for_list_with_http_info(
        ...
        market_aggregates_request,
        **kwargs
    ) -> typing.Tuple[GetMarketAggregatesForListResponseWrapper, int, typing.MutableMapping]:
        """Get market aggregates for a requested time series.  # noqa: E501
    ...
    def get_market_aggregates_for_list_async(
        ...
        market_aggregates_request,
        **kwargs
    ) -> "ApplyResult[GetMarketAggregatesForListResponseWrapper]":
        """Get market aggregates for a requested time series.  # noqa: E501
    ...
    def get_market_aggregates_for_list_with_http_info_async(
        ...
        market_aggregates_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetMarketAggregatesForListResponseWrapper, int, typing.MutableMapping]]":
        """Get market aggregates for a requested time series.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetMarketAggregatesForListResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['market_aggregates_request'] = \
            market_aggregates_request
