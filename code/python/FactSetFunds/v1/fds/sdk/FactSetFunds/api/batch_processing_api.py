...
class GetBatchDataResponseWrapper:
    ...
    def get_response_200(self) -> BatchResultResponse:
        ...
        Returns: Request Response Object when the batch request has been completed and the response is created
        """
...
class BatchProcessingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_batch_data_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BatchResultResponse,), 202: (BatchStatusResponse,), 400: (BatchErrorResponse,), 401: (BatchErrorResponse,), 403: (BatchErrorResponse,), 404: (BatchErrorResponse,), 500: (BatchErrorResponse,),  },
                ...
                'endpoint_path': '/factset-funds/v1/batch-result',
        ...
        self.get_batch_status_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 201: (BatchStatusResponse,), 202: (BatchStatusResponse,), 400: (BatchErrorResponse,), 401: (BatchErrorResponse,), 403: (BatchErrorResponse,), 404: (BatchErrorResponse,), 500: (BatchErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/factset-funds/v1/batch-status',
