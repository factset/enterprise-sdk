...
class ReturnsRangeRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """ReturnsRangeRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_date (str): The start date requested for a given date range in YYYY-MM-DD format. If left blank, the API will default to the day prior to today's previous close. The startDate cannot be equal to the endDate as no return can be computed. Additionally, the startDate MUST be equal to or greater than the `priceFirstDate` found within the /summary endpoint. . [optional]  # noqa: E501
