...
def lazy_import():
    ...
    globals()['IdsBatchPostMarket'] = IdsBatchPostMarket


class MarketAggregatesRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ids': (IdsBatchPostMarket,),  # noqa: E501
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """MarketAggregatesRequest - a model defined in OpenAPI

        Args:
            ids (IdsBatchPostMarket):
