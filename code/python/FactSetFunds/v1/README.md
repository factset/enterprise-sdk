...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetFunds/3.0.0)](https://pypi.org/project/fds.sdk.FactSetFunds/v/3.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetFunds==3.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetFunds==3.0.0
```
