...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetFunds/1.3.0)](https://pypi.org/project/fds.sdk.FactSetFunds/v/1.3.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetFunds==1.3.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetFunds==1.3.0
```
