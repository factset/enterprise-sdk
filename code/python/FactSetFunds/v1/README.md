...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetFunds/4.0.0)](https://pypi.org/project/fds.sdk.FactSetFunds/v/4.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetFunds==4.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetFunds==4.0.0
```
...
------------ | ------------- | ------------- | -------------
*BatchProcessingApi* | [**get_batch_data**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchProcessingApi.md#get_batch_data) | **GET** /factset-funds/v1/batch-result | Returns the response for a Batch Request
*BatchProcessingApi* | [**get_batch_status**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchProcessingApi.md#get_batch_status) | **GET** /factset-funds/v1/batch-status | Returns the status for a Batch Request
...
*ScreeningOperationsApi* | [**create_content_set**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#create_content_set) | **POST** /factset-funds/v1/screener/content-sets/create | Create a new custom content set with required fields from the default content sets.
*ScreeningOperationsApi* | [**delete_content_set**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#delete_content_set) | **DELETE** /factset-funds/v1/screener/content-sets/{name} | Delete a custom content set.
*ScreeningOperationsApi* | [**get_content_sets**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#get_content_sets) | **GET** /factset-funds/v1/screener/content-sets | Get the content sets that are permissioned for the user.
*ScreeningOperationsApi* | [**get_distinct_count**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#get_distinct_count) | **POST** /factset-funds/v1/screener/distinct-count | Returns the number of records for a given field spread across all possible values.
*ScreeningOperationsApi* | [**get_fields**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#get_fields) | **GET** /factset-funds/v1/screener/fields | Get the list of fields available for given content set.
*ScreeningOperationsApi* | [**get_screener_data**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#get_screener_data) | **POST** /factset-funds/v1/screener/search | Returns all the records that match the given criteria.
*ScreeningOperationsApi* | [**get_statistics**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ScreeningOperationsApi.md#get_statistics) | **POST** /factset-funds/v1/screener/statistics | Returns the statistics and histogram data for a given field within the specified content sets.
...
## Documentation For Models
 ...
 - [Batch](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Batch.md)
 - [BatchErrorObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchErrorObject.md)
 - [BatchErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchErrorResponse.md)
 - [BatchResult](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchResult.md)
 - [BatchResultResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchResultResponse.md)
 - [BatchStatus](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchStatus.md)
 - [BatchStatusResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/BatchStatusResponse.md)
 ...
 - [ContentSet](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ContentSet.md)
 - [ContentSetItem](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ContentSetItem.md)
 - [ContentSetsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ContentSetsResponse.md)
 ...
 - [CreateContentSetRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CreateContentSetRequest.md)
 - [CreateContentSetRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CreateContentSetRequestBody.md)
 - [CreateContentSetResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CreateContentSetResponse.md)
 - [CreateContentSetResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CreateContentSetResponseData.md)
 - [CreateRequestFieldObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CreateRequestFieldObject.md)
 - [Criterion](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Criterion.md)
 - [CustomContentSetItem](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CustomContentSetItem.md)
 - [CustomContentSets](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/CustomContentSets.md)
 ...
 - [DistinctCountData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/DistinctCountData.md)
 - [DistinctCountMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/DistinctCountMeta.md)
 - [DistinctCountRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/DistinctCountRequest.md)
 - [DistinctCountRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/DistinctCountRequestBody.md)
 - [DistinctCountResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/DistinctCountResponse.md)
 ...
 - [ErrorObjectScreener](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ErrorObjectScreener.md)
 - [ErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ErrorResponse.md)
 - [ErrorResponseScreener](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/ErrorResponseScreener.md)
 ...
 - [Field](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Field.md)
 - [FieldResponseObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/FieldResponseObject.md)
 - [FieldValues](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/FieldValues.md)
 - [FieldsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/FieldsResponse.md)
 - [Filter](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Filter.md)
 ...
 - [HistogramData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/HistogramData.md)
 - [Ids](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Ids.md)
 - [IdsBatchPost](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/IdsBatchPost.md)
 - [IdsBatchPostMarket](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/IdsBatchPostMarket.md)
 - [JoinType](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/JoinType.md)
 ...
 - [Meta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Meta.md)
 - [MetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/MetaPagination.md)
 - [NestedFieldValueObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/NestedFieldValueObject.md)
 - [NestedFieldValues](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/NestedFieldValues.md)
 - [Operator](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Operator.md)
 - [Pagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/Pagination.md)
 ...
 - [SearchContentSets](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchContentSets.md)
 - [SearchCriterion](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchCriterion.md)
 - [SearchData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchData.md)
 - [SearchFilter](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchFilter.md)
 - [SearchMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchMeta.md)
 - [SearchRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchRequest.md)
 - [SearchRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchRequestBody.md)
 - [SearchResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SearchResponse.md)
 - [SplitAdjust](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/SplitAdjust.md)
 - [StatisticsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/StatisticsRequest.md)
 - [StatisticsRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/StatisticsRequestBody.md)
 - [StatisticsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/StatisticsResponse.md)
 - [StatisticsResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetFunds/v1/docs/StatisticsResponseData.md)
