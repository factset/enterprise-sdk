# fds.sdk.FactSetFunds.ScreenerOperationsApi

All URIs are relative to *https://api.factset.com/content/factset-funds/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_content_set**](ScreenerOperationsApi.md#create_content_set) | **POST** /screener/content-sets/create | Create a new custom content set with required fields from the default content sets.
[**delete_content_set**](ScreenerOperationsApi.md#delete_content_set) | **DELETE** /screener/content-sets/{name} | Delete a custom content set.
[**get_content_sets**](ScreenerOperationsApi.md#get_content_sets) | **GET** /screener/content-sets | Get the content sets that are permissioned for the user.
[**get_distinct_count**](ScreenerOperationsApi.md#get_distinct_count) | **POST** /screener/distinct-count | Returns the number of records for a given field spread across all possible values.
[**get_fields**](ScreenerOperationsApi.md#get_fields) | **GET** /screener/fields | Get the list of fields available for given content set.
[**get_screener_data**](ScreenerOperationsApi.md#get_screener_data) | **POST** /screener/search | Returns all the records that match the given criteria.
[**get_statistics**](ScreenerOperationsApi.md#get_statistics) | **POST** /screener/statistics | Returns the statistics and histogram data for a given field within the specified content sets.
...
from fds.sdk.FactSetFunds.api import screener_operations_api
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    api_instance = screener_operations_api.ScreenerOperationsApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->create_content_set: %s\n" % e)
```
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->delete_content_set: %s\n" % e)
```
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->get_content_sets: %s\n" % e)
```
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->get_distinct_count: %s\n" % e)
```
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    content_sets = [
        "contentSets_example",
    ] # [str] | The content sets from which the fields are requested.
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->get_fields: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **content_sets** | **[str]**| The content sets from which the fields are requested. |
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->get_screener_data: %s\n" % e)
```
...
with fds.sdk.FactSetFunds.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ScreenerOperationsApi->get_statistics: %s\n" % e)
```
