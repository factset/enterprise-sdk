...
**since_inception_annualized** | **float, none_type** | The average annual rate of return since the fund&#39;s inception date, calculated using compounding. This is always a total return (dividends are included) and is not affected by the &#x60;dividendAdjust&#x60; parameter. | [optional] 
