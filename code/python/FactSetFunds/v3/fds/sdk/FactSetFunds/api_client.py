...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetFunds/0.40.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PortfolioExposureAndAnalysisApi()
        api_instance.get_financial_key_items  # this is an instance of the class Endpoint
        api_instance.get_financial_key_items()  # this invokes api_instance.get_financial_key_items.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_financial_key_items.callable or self.callable in this class
