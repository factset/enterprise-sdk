...
class LastTradeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.tick_history_lasttrade_get_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'endpoint_path': '/TickHistory/lasttrade',
                'operation_id': 'tick_history_lasttrade_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def tick_history_lasttrade_get(
        self,
        id,
        **kwargs
    ) -> TickhistoryResponse:
        """Request returns data for the last trade and associated quotes before the specified time  # noqa: E501
        ...
        kwargs['id'] = \
            id
        return self.tick_history_lasttrade_get_endpoint.call_with_http_info(**kwargs)

    def tick_history_lasttrade_get_with_http_info(
        self,
        id,
        **kwargs
    ...
    def tick_history_lasttrade_get_async(
        self,
        id,
        **kwargs
    ...
    def tick_history_lasttrade_get_with_http_info_async(
        self,
        id,
        **kwargs
