...
class FirstTradeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.tick_history_firsttrade_get_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/TickHistory/firsttrade',
                'operation_id': 'tick_history_firsttrade_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def tick_history_firsttrade_get(
        ...
        **kwargs
        ...
        """Request returns data for the first trade (official and unofficial) after the specified time  # noqa: E501
    ...
    def tick_history_firsttrade_get_with_http_info(
        self,
        id,
        **kwargs
    ...
    def tick_history_firsttrade_get_async(
        self,
        id,
        **kwargs
    ...
    def tick_history_firsttrade_get_with_http_info_async(
        self,
        id,
        **kwargs
