...
class Specialfield(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'nf': (str,),  # noqa: E501
            'na': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            na ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): **#NA#** - Not Applicable. The requested field could not be found for the requested symbol. This usually means that the field is not applicable for this type of record.. [optional]  # noqa: E501
        """
