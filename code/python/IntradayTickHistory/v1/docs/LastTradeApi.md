# fds.sdk.IntradayTickHistory.LastTradeApi
...
from fds.sdk.IntradayTickHistory.api import last_trade_api
...
with fds.sdk.IntradayTickHistory.ApiClient(configuration) as api_client:
    ...
    try:
        # Request returns data for the last trade and associated quotes before the specified time
        api_response = api_instance.tick_history_lasttrade_get(id)
        pprint(api_response)
