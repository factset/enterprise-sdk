...
from fds.sdk.FactSetDebtCapitalStructure import rest
from fds.sdk.FactSetDebtCapitalStructure.configuration import Configuration
from fds.sdk.FactSetDebtCapitalStructure.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetDebtCapitalStructure.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetDebtCapitalStructure/0.1.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ReferenceApi()
        api_instance.get_details_list  # this is an instance of the class Endpoint
        api_instance.get_details_list()  # this invokes api_instance.get_details_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_details_list.callable or self.callable in this class
