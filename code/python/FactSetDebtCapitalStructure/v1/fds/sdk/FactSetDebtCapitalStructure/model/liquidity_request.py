...
def lazy_import():
    ...
    globals()['LiquidityRequestBody'] = LiquidityRequestBody


class LiquidityRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (LiquidityRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """LiquidityRequest - a model defined in OpenAPI
