...
class DCSRequestBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ids, start_date, metrics, *args, **kwargs):  # noqa: E501
        """DCSRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            end_date (date): The date of the period requested in **YYYY-MM-DD** format. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, ids, start_date, metrics, *args, **kwargs):  # noqa: E501
        """DCSRequestBody - a model defined in OpenAPI
