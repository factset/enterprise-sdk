...
def lazy_import():
    ...
    globals()['InterimDetailsRequestBody'] = InterimDetailsRequestBody


class InterimDetailsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (InterimDetailsRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """InterimDetailsRequest - a model defined in OpenAPI
