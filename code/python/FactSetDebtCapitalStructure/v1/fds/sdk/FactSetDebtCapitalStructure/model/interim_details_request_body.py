...
class InterimDetailsRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """InterimDetailsRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            currency (str): Currency code for currency values. For a list of currency ISO codes, visit Online Assistant Page [OA1470](https://my.apps.factset.com/oa/pages/1470). . [optional] if omitted the server will use the default value of "LOCAL"  # noqa: E501
        """
