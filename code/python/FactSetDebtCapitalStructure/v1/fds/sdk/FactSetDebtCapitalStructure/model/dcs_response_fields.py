...
def lazy_import():
    ...
    globals()['DCSValue'] = DCSValue


class DcsResponseFields(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DcsResponseFields - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fysm_id (str): Identifier that was used for the request.. [optional]  # noqa: E501
            metric (str, none_type): The requested `metric` input, representing the Liquidity data item. For a definition of the item please use the `/metrics` endpoint.. [optional]  # noqa: E501
            fiscal_year (int, none_type): Fiscal year of the reported period in YYYY format.. [optional]  # noqa: E501
            report_date (date, none_type): Reporting date for the debt instrument.. [optional]  # noqa: E501
            ...
            value (DCSValue): [optional]  # noqa: E501
        """
