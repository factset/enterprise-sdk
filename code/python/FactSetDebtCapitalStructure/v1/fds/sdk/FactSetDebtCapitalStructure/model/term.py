...
class Term(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Specifies whether to select short-term or long-term liquidity options.   * **SHORT_TERM** = Short Term.   * **LONG_TERM** = Long Term. . if omitted defaults to "SHORT_TERM", must be one of ["SHORT_TERM", "LONG_TERM", ]  # noqa: E501

        Keyword Args:
            value (str): Specifies whether to select short-term or long-term liquidity options.   * **SHORT_TERM** = Short Term.   * **LONG_TERM** = Long Term. . if omitted defaults to "SHORT_TERM", must be one of ["SHORT_TERM", "LONG_TERM", ]  # noqa: E501
