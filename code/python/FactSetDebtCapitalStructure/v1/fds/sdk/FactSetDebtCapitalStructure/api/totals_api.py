...
class TotalsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_dcs_totals_post_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (DcsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 404: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/dcs-totals',
                'operation_id': 'get_dcs_totals_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_dcs_totals_post(
        self,
        dcs_request,
        **kwargs
    ) -> DcsResponse:
        """Retrieves debt instrument totals for specified metrics and date ranges.  # noqa: E501

        Returns debt instruments totals.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            dcs_request (DCSRequest): Request object for `DCS Totals`.
        ...
        kwargs['dcs_request'] = \
            dcs_request
        return self.get_dcs_totals_post_endpoint.call_with_http_info(**kwargs)

    def get_dcs_totals_post_with_http_info(
        self,
        dcs_request,
        **kwargs
    ) -> typing.Tuple[DcsResponse, int, typing.MutableMapping]:
        """Retrieves debt instrument totals for specified metrics and date ranges.  # noqa: E501
    ...
    def get_dcs_totals_post_async(
        self,
        dcs_request,
        **kwargs
    ) -> "ApplyResult[DcsResponse]":
        """Retrieves debt instrument totals for specified metrics and date ranges.  # noqa: E501
    ...
    def get_dcs_totals_post_with_http_info_async(
        self,
        dcs_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[DcsResponse, int, typing.MutableMapping]]":
        """Retrieves debt instrument totals for specified metrics and date ranges.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(DcsResponse, int, typing.Dict)]
        """
