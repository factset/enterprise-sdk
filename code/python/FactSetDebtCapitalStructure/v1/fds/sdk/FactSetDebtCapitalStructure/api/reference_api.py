...
from fds.sdk.FactSetDebtCapitalStructure.api_client import ApiClient, Endpoint as _Endpoint
...
class ReferenceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_details_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'endpoint_path': '/details',
                'operation_id': 'get_details_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_interim_details_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (DetailsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 404: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/details-interim',
                'operation_id': 'get_interim_details_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'interim_details_request',
                ],
                'required': [
                    'interim_details_request',
                ],
    ...
    def get_details_list(
        ...
        **kwargs
        ...
        """Returns debt instruments for a list of companies.  # noqa: E501

        Gets instruments of varying types such as Revolving Credit, Term Loans, ST Debt Total, Notes/Bonds, and Other.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            details_request (DetailsRequest): Request object for `Details`.
        ...
        kwargs['details_request'] = \
            details_request
        return self.get_details_list_endpoint.call_with_http_info(**kwargs)

    def get_details_list_with_http_info(
        self,
        details_request,
        **kwargs
    ...
    def get_details_list_with_http_info_async(
        self,
        details_request,
        **kwargs
    ...
    def get_interim_details_list(
        self,
        interim_details_request,
        **kwargs
    ) -> DetailsResponse:
        """Returns most recently available debt instrument data for a list of companies.  # noqa: E501

        Gets instruments of varying types such as Revolving Credit, Term Loans, ST Debt Total, Notes/Bonds, and Other. The data returned by this endpoint is for the interim period and only returns the most recently available value.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            interim_details_request (InterimDetailsRequest): Request object for `Details`.
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['interim_details_request'] = \
            interim_details_request
        return self.get_interim_details_list_endpoint.call_with_http_info(**kwargs)

    def get_interim_details_list_with_http_info(
        self,
        interim_details_request,
        **kwargs
    ) -> typing.Tuple[DetailsResponse, int, typing.MutableMapping]:
    ...
    def get_interim_details_list_async(
        self,
        interim_details_request,
        **kwargs
    ) -> "ApplyResult[DetailsResponse]":
    ...
    def get_interim_details_list_with_http_info_async(
        self,
        interim_details_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[DetailsResponse, int, typing.MutableMapping]]":
