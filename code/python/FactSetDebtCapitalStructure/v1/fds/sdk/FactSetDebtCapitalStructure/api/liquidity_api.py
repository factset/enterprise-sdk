...
class LiquidityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_liquidity_post_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (LiquidityResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 404: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/liquidity',
                'operation_id': 'get_liquidity_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_liquidity_post(
        self,
        liquidity_request,
        **kwargs
    ) -> LiquidityResponse:
        """Returns liquidity information for specified metrics and date ranges.  # noqa: E501

        Gets liquidity detail and summary information (includes all instrument details).   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            liquidity_request (LiquidityRequest): Request object for `Liquidity`.
        ...
        kwargs['liquidity_request'] = \
            liquidity_request
        return self.get_liquidity_post_endpoint.call_with_http_info(**kwargs)

    def get_liquidity_post_with_http_info(
        self,
        liquidity_request,
        **kwargs
    ) -> typing.Tuple[LiquidityResponse, int, typing.MutableMapping]:
        """Returns liquidity information for specified metrics and date ranges.  # noqa: E501
    ...
    def get_liquidity_post_async(
        self,
        liquidity_request,
        **kwargs
    ) -> "ApplyResult[LiquidityResponse]":
        """Returns liquidity information for specified metrics and date ranges.  # noqa: E501
    ...
    def get_liquidity_post_with_http_info_async(
        self,
        liquidity_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[LiquidityResponse, int, typing.MutableMapping]]":
        """Returns liquidity information for specified metrics and date ranges.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(LiquidityResponse, int, typing.Dict)]
        """
