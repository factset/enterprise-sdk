# fds.sdk.FactSetDebtCapitalStructure.MetricsApi

All URIs are relative to *https://api.factset.com/content/factset-dcs/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_metrics**](MetricsApi.md#get_metrics) | **GET** /metrics | Returns available DCS metrics to use in other endpoints.
...
from fds.sdk.FactSetDebtCapitalStructure.api import metrics_api
...
with fds.sdk.FactSetDebtCapitalStructure.ApiClient(configuration) as api_client:
    ...
    category = "DCS_Totals" # str | Filters the list of available DCS metrics by endpoint.  -   * **DCS Totals** = DCS Totals   * **Liquidity** = Liquidity  (optional)
...
------------- | ------------- | ------------- | -------------
 **category** | **str**| Filters the list of available DCS metrics by endpoint.  -   * **DCS Totals** &#x3D; DCS Totals   * **Liquidity** &#x3D; Liquidity  | [optional]
