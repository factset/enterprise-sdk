# fds.sdk.FactSetDebtCapitalStructure.DetailsApi

All URIs are relative to *https://api.factset.com/content/factset-dcs/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_details_list**](DetailsApi.md#get_details_list) | **POST** /details | Returns debt instruments for a list of companies.
[**get_details_summary**](DetailsApi.md#get_details_summary) | **GET** /details-summary | Returns debt instrument totals details for specified list of companies.
[**get_interim_details_list**](DetailsApi.md#get_interim_details_list) | **POST** /details-interim | Returns most recently available debt instrument data for a list of companies.
...
# **get_details_summary**
> DetailsSummaryResponse get_details_summary(ids, periodicity, start_date)
...
with fds.sdk.FactSetDebtCapitalStructure.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    ids = ["IBM-US"] # [str] | The requested list of security identifiers. Accepted ID types include Market Tickers,  SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.  
    periodicity = "ANN" # str | Periodicity or frequency of the fiscal periods, where   * **ANN**  = Annual Original,   * **QTR**  = Quarterly 
    start_date = dateutil_parser('2024-01-01').date() # date | The date of the period requested in YYYY-MM-DD format.  Future dates (T+1) are not accepted in this endpoint. 
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_details_summary(ids, periodicity, start_date, currency=currency)

        pprint(api_response)

    except fds.sdk.FactSetDebtCapitalStructure.ApiException as e:
        print("Exception when calling DetailsApi->get_details_summary: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ids** | **[str]**| The requested list of security identifiers. Accepted ID types include Market Tickers,  SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.   |
 **periodicity** | **str**| Periodicity or frequency of the fiscal periods, where   * **ANN**  &#x3D; Annual Original,   * **QTR**  &#x3D; Quarterly  |
...
with fds.sdk.FactSetDebtCapitalStructure.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DetailsApi->get_interim_details_list: %s\n" % e)
```
