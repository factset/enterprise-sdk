...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IssueTracker/0.5.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_file_attachment  # this is an instance of the class Endpoint
        api_instance.get_file_attachment()  # this invokes api_instance.get_file_attachment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_file_attachment.callable or self.callable in this class
