...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.IssueTracker/0.6.0)](https://pypi.org/project/fds.sdk.IssueTracker/v/0.6.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.IssueTracker==0.6.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.IssueTracker==0.6.0
```
