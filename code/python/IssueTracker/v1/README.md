...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.IssueTracker/0.4.1)](https://pypi.org/project/fds.sdk.IssueTracker/v/0.4.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.IssueTracker==0.4.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.IssueTracker==0.4.1
```
