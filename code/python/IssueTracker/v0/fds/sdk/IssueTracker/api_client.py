...
from fds.sdk.IssueTracker import rest
from fds.sdk.IssueTracker.configuration import Configuration
from fds.sdk.IssueTracker.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.IssueTracker.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/IssueTracker/0.1.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IssueApi()
        api_instance.get_issue  # this is an instance of the class Endpoint
        api_instance.get_issue()  # this invokes api_instance.get_issue.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_issue.callable or self.callable in this class
