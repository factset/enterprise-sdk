...
class IdsABS(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdsABS - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Security or Entity identifiers. FactSet Identifiers, tickers, CUSIP, ISIN and SEDOL are accepted input. .  # noqa: E501

        Keyword Args:
            value ([str]): Security or Entity identifiers. FactSet Identifiers, tickers, CUSIP, ISIN and SEDOL are accepted input. .  # noqa: E501
