...
class BondCoupon(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'coupon_frequency': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'coupon_frequency': 'couponFrequency',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BondCoupon - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            accrued_interest (float, none_type): The interest that is owed, but not yet paid, added to the price of the bond. Available only for `corporate and municipal bonds`.. [optional]  # noqa: E501
            coupon (float, none_type): The current coupon rate of the instrument. Available only for `corporate and municipal bonds`.. [optional]  # noqa: E501
            coupon_type (str, none_type): The coupon type of the instrument. Available only for `corporate and municipal bonds`.. [optional]  # noqa: E501
            coupon_frequency (str, none_type): The coupon frequency of the bond. Available only for `corporate bonds`. . [optional]  # noqa: E501
        """
