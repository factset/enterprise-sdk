...
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics import rest
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.configuration import Configuration
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/SPGlobalFixedIncomeEvaluatedPricesandAnalytics/0.1.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ABSDetailsApi()
        api_instance.get_abs_details  # this is an instance of the class Endpoint
        api_instance.get_abs_details()  # this invokes api_instance.get_abs_details.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_abs_details.callable or self.callable in this class
