...
class YieldApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_bond_yield_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondYieldResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/yield',
                'operation_id': 'get_bond_yield',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_bond_yield_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondYieldResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/yield',
                'operation_id': 'get_bond_yield_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_bond_yield(
        ...
        **kwargs
        ...
        """Get yield information for given date range and list of securities  # noqa: E501

        Get the yield information like yield to maturity, yield to worst, benchmark yield to maturity and yield to call provided by Markit for a specified date range and frequency.    # noqa: E501
        ...
        kwargs['ids'] = \
            ids
        return self.get_bond_yield_endpoint.call_with_http_info(**kwargs)

    def get_bond_yield_with_http_info(
        self,
        ids,
        **kwargs
    ) -> typing.Tuple[BondYieldResponse, int, typing.MutableMapping]:
        """Get yield information for given date range and list of securities  # noqa: E501
    ...
    def get_bond_yield_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[BondYieldResponse]":
        """Get yield information for given date range and list of securities  # noqa: E501
    ...
    def get_bond_yield_with_http_info_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondYieldResponse, int, typing.MutableMapping]]":
        """Get yield information for given date range and list of securities  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(BondYieldResponse, int, typing.Dict)]
        """
    ...
    def get_bond_yield_for_list(
        self,
        bond_yield_request,
        **kwargs
    ) -> BondYieldResponse:
        """Request yield information for given date range and list of securities  # noqa: E501

        Get the yield information like yield to maturity, yield to worst, benchmark yield to maturity and yield to call provided by Markit for a specified date range and frequency.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            bond_yield_request (BondYieldRequest): Request object for requesting yield data
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['bond_yield_request'] = \
            bond_yield_request
        return self.get_bond_yield_for_list_endpoint.call_with_http_info(**kwargs)

    def get_bond_yield_for_list_with_http_info(
        self,
        bond_yield_request,
        **kwargs
    ) -> typing.Tuple[BondYieldResponse, int, typing.MutableMapping]:
    ...
    def get_bond_yield_for_list_async(
        self,
        bond_yield_request,
        **kwargs
    ) -> "ApplyResult[BondYieldResponse]":
    ...
    def get_bond_yield_for_list_with_http_info_async(
        self,
        bond_yield_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondYieldResponse, int, typing.MutableMapping]]":
