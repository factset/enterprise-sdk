...
class IssuerYieldCurveApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_bond_issuer_yield_curve_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondIssuerYieldCurveResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/issuer-yield-curve',
                'operation_id': 'get_bond_issuer_yield_curve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_bond_issuer_yield_curve_for_list_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/issuer-yield-curve',
                'operation_id': 'get_bond_issuer_yield_curve_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'bond_issuer_yield_curve_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_bond_issuer_yield_curve(
        ...
        **kwargs
        ...
        """Get yield curve data for given date range and list of securities  # noqa: E501

        Get yield curve data points and dates for 3M, 6M, 1Y, 2Y, 3Y, 4Y, 5Y, 6Y, 7Y, 8Y, 9Y, 10Y, 15Y, 20Y, 25Y, 30Y and 40Y provided by Markit for the specified date range and frequency.   # noqa: E501
    ...
    def get_bond_issuer_yield_curve_with_http_info(
        self,
        ids,
        **kwargs
    ) -> typing.Tuple[BondIssuerYieldCurveResponse, int, typing.MutableMapping]:
        """Get yield curve data for given date range and list of securities  # noqa: E501
    ...
    def get_bond_issuer_yield_curve_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[BondIssuerYieldCurveResponse]":
        """Get yield curve data for given date range and list of securities  # noqa: E501
    ...
    def get_bond_issuer_yield_curve_with_http_info_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondIssuerYieldCurveResponse, int, typing.MutableMapping]]":
        """Get yield curve data for given date range and list of securities  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(BondIssuerYieldCurveResponse, int, typing.Dict)]
        """
    ...
    def get_bond_issuer_yield_curve_for_list(
        ...
        **kwargs
        ...
        """Request yield curve data for given date range and list of securities  # noqa: E501

        Get yield curve data points and dates for 3M, 6M, 1Y, 2Y, 3Y, 4Y, 5Y, 6Y, 7Y, 8Y, 9Y, 10Y, 15Y, 20Y, 25Y, 30Y and 40Y provided by Markit for the specified date range and frequency.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            bond_issuer_yield_curve_request (BondIssuerYieldCurveRequest): Request object for requesting issuer yield curve data.
    ...
    def get_bond_issuer_yield_curve_for_list_with_http_info(
        self,
        bond_issuer_yield_curve_request,
        **kwargs
    ) -> typing.Tuple[BondIssuerYieldCurveResponse, int, typing.MutableMapping]:
    ...
    def get_bond_issuer_yield_curve_for_list_async(
        self,
        bond_issuer_yield_curve_request,
        **kwargs
    ) -> "ApplyResult[BondIssuerYieldCurveResponse]":
    ...
    def get_bond_issuer_yield_curve_for_list_with_http_info_async(
        self,
        bond_issuer_yield_curve_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondIssuerYieldCurveResponse, int, typing.MutableMapping]]":
