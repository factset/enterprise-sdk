...
class SpreadApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_bond_spread_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondSpreadResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/spread',
                'operation_id': 'get_bond_spread',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_bond_spread_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondSpreadResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/spread',
                'operation_id': 'get_bond_spread_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_bond_spread(
        ...
        **kwargs
        ...
        """Get the Spread and OAS data for a list of securities  # noqa: E501

        Get spread details like discount margin, OAS, Asset Swap Spread, Z Spread, spread benchmark provided by Markit for a specified date range and frequency.   # noqa: E501
        ...
        kwargs['ids'] = \
            ids
        return self.get_bond_spread_endpoint.call_with_http_info(**kwargs)

    def get_bond_spread_with_http_info(
        self,
        ids,
        **kwargs
    ) -> typing.Tuple[BondSpreadResponse, int, typing.MutableMapping]:
        """Get the Spread and OAS data for a list of securities  # noqa: E501
    ...
    def get_bond_spread_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[BondSpreadResponse]":
        """Get the Spread and OAS data for a list of securities  # noqa: E501
    ...
    def get_bond_spread_with_http_info_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondSpreadResponse, int, typing.MutableMapping]]":
        """Get the Spread and OAS data for a list of securities  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(BondSpreadResponse, int, typing.Dict)]
        """
    ...
    def get_bond_spread_for_list(
        self,
        bond_spread_request,
        **kwargs
    ) -> BondSpreadResponse:
        """Request the Spread and OAS data for a list of securities  # noqa: E501

        Get spread details like discount margin, OAS, Asset Swap Spread, Z Spread, spread benchmark provided by Markit for a specified date range and frequency.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            bond_spread_request (BondSpreadRequest): Request object for requesting pricing data
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['bond_spread_request'] = \
            bond_spread_request
        return self.get_bond_spread_for_list_endpoint.call_with_http_info(**kwargs)

    def get_bond_spread_for_list_with_http_info(
        self,
        bond_spread_request,
        **kwargs
    ) -> typing.Tuple[BondSpreadResponse, int, typing.MutableMapping]:
    ...
    def get_bond_spread_for_list_async(
        self,
        bond_spread_request,
        **kwargs
    ) -> "ApplyResult[BondSpreadResponse]":
    ...
    def get_bond_spread_for_list_with_http_info_async(
        self,
        bond_spread_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondSpreadResponse, int, typing.MutableMapping]]":
