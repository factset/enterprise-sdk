...
class ABSDetailsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_abs_details_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (AbsDetailsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/abs-details',
                'operation_id': 'get_abs_details',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_abs_details_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (AbsDetailsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/abs-details',
                'operation_id': 'get_abs_details_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_abs_details(
        ...
        **kwargs
        ...
        """Get Asset Backed Security Details for a list of securities  # noqa: E501

        Get details for Asset Backed Securities like factors, pay up, wal, cdr, cpr and prepay details provided by Markit for the specified date range and frequency.   # noqa: E501
        ...
        kwargs['ids'] = \
            ids
        return self.get_abs_details_endpoint.call_with_http_info(**kwargs)

    def get_abs_details_with_http_info(
        self,
        ids,
        **kwargs
    ) -> typing.Tuple[AbsDetailsResponse, int, typing.MutableMapping]:
        """Get Asset Backed Security Details for a list of securities  # noqa: E501
    ...
    def get_abs_details_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[AbsDetailsResponse]":
        """Get Asset Backed Security Details for a list of securities  # noqa: E501
    ...
    def get_abs_details_with_http_info_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[AbsDetailsResponse, int, typing.MutableMapping]]":
        """Get Asset Backed Security Details for a list of securities  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(AbsDetailsResponse, int, typing.Dict)]
        """
    ...
    def get_abs_details_for_list(
        self,
        abs_details_request,
        **kwargs
    ) -> AbsDetailsResponse:
        """Request Asset Backed Security Details for a list of securities  # noqa: E501

        Get details for Asset Backed Securities like factors, pay up, wal, cdr, cpr and prepay details provided by Markit for the specified date range and frequency.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            abs_details_request (AbsDetailsRequest): Request object for requesting ABS details
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['abs_details_request'] = \
            abs_details_request
        return self.get_abs_details_for_list_endpoint.call_with_http_info(**kwargs)

    def get_abs_details_for_list_with_http_info(
        self,
        abs_details_request,
        **kwargs
    ) -> typing.Tuple[AbsDetailsResponse, int, typing.MutableMapping]:
    ...
    def get_abs_details_for_list_async(
        self,
        abs_details_request,
        **kwargs
    ) -> "ApplyResult[AbsDetailsResponse]":
    ...
    def get_abs_details_for_list_with_http_info_async(
        self,
        abs_details_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[AbsDetailsResponse, int, typing.MutableMapping]]":
