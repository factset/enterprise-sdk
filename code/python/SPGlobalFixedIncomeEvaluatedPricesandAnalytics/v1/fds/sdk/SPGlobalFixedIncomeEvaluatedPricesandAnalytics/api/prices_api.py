...
class PricesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_bond_prices_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondPricesResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/prices',
                'operation_id': 'get_bond_prices',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_bond_prices_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BondPricesResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/markit-bond-prices-and-analytics/v1/prices',
                'operation_id': 'get_bond_prices_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_bond_prices(
        ...
        **kwargs
        ...
        """Get Bid, Mid and Ask prices for a list of securities  # noqa: E501

        Get bond clean and dirty bid, mid and ask pricing data provided by Markit for a specified date range and frequency.   # noqa: E501
        ...
        kwargs['ids'] = \
            ids
        return self.get_bond_prices_endpoint.call_with_http_info(**kwargs)

    def get_bond_prices_with_http_info(
        self,
        ids,
        **kwargs
    ) -> typing.Tuple[BondPricesResponse, int, typing.MutableMapping]:
        """Get Bid, Mid and Ask prices for a list of securities  # noqa: E501
    ...
    def get_bond_prices_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[BondPricesResponse]":
        """Get Bid, Mid and Ask prices for a list of securities  # noqa: E501
    ...
    def get_bond_prices_with_http_info_async(
        self,
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondPricesResponse, int, typing.MutableMapping]]":
        """Get Bid, Mid and Ask prices for a list of securities  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(BondPricesResponse, int, typing.Dict)]
        """
    ...
    def get_bond_prices_for_list(
        self,
        bond_prices_request,
        **kwargs
    ) -> BondPricesResponse:
        """Request Bid, Mid and Ask prices for a list of securities  # noqa: E501

        Get bond clean and dirty bid, mid and ask pricing data provided by Markit for a specified date range and frequency.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            bond_prices_request (BondPricesRequest): Request object for requesting pricing data
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['bond_prices_request'] = \
            bond_prices_request
        return self.get_bond_prices_for_list_endpoint.call_with_http_info(**kwargs)

    def get_bond_prices_for_list_with_http_info(
        self,
        bond_prices_request,
        **kwargs
    ) -> typing.Tuple[BondPricesResponse, int, typing.MutableMapping]:
    ...
    def get_bond_prices_for_list_async(
        self,
        bond_prices_request,
        **kwargs
    ) -> "ApplyResult[BondPricesResponse]":
    ...
    def get_bond_prices_for_list_with_http_info_async(
        self,
        bond_prices_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[BondPricesResponse, int, typing.MutableMapping]]":
