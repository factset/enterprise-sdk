# fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.CouponApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_bond_coupon**](CouponApi.md#get_bond_coupon) | **GET** /markit-bond-prices-and-analytics/v1/coupon | Get coupon data for given date range and list of securities
...
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api import coupon_api
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_bond_coupon(ids, start_date=start_date, end_date=end_date, frequency=frequency, calendar=calendar)
        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling CouponApi->get_bond_coupon: %s\n" % e)
```
...
# **get_bond_coupon_for_list**
> BondCouponResponse get_bond_coupon_for_list(bond_coupon_request)
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    bond_coupon_request = BondCouponRequest(
        ids=Ids(["US45905URL07"]),
        start_date="2021-01-01",
        end_date="2021-12-31",
        frequency=Frequency("D"),
        calendar=Calendar("FIVEDAY"),
    ) # BondCouponRequest | Request object for requesting Coupon data

    try:
        # Request coupon data for given date range and list of securities
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_bond_coupon_for_list(bond_coupon_request)
        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling CouponApi->get_bond_coupon_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bond_coupon_request** | [**BondCouponRequest**](BondCouponRequest.md)| Request object for requesting Coupon data |
