# fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.PricesApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_bond_prices**](PricesApi.md#get_bond_prices) | **GET** /markit-bond-prices-and-analytics/v1/prices | Get Bid, Mid and Ask prices for a list of securities
...
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api import prices_api
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_bond_prices(ids, start_date=start_date, end_date=end_date, frequency=frequency, calendar=calendar)

        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling PricesApi->get_bond_prices: %s\n" % e)
```
...
# **get_bond_prices_for_list**
> BondPricesResponse get_bond_prices_for_list(bond_prices_request)
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    # NOTE: The parameter variable defined below is just an example and may potentially contain non valid values. So please replace this with valid values.
    bond_prices_request = BondPricesRequest(
        ids=Ids(["US45905URL07"]),
        start_date="2021-01-01",
        end_date="2021-12-31",
        frequency=Frequency("D"),
        calendar=Calendar("FIVEDAY"),
    ) # BondPricesRequest | Request object for requesting pricing data

    try:
        # Request Bid, Mid and Ask prices for a list of securities
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_bond_prices_for_list(bond_prices_request)

        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling PricesApi->get_bond_prices_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bond_prices_request** | [**BondPricesRequest**](BondPricesRequest.md)| Request object for requesting pricing data |
