# fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ABSDetailsApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_abs_details**](ABSDetailsApi.md#get_abs_details) | **GET** /markit-bond-prices-and-analytics/v1/abs-details | Get Asset Backed Security Details for a list of securities
...
# **get_abs_details_for_list**
> AbsDetailsResponse get_abs_details_for_list(abs_details_request)
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    # NOTE: The parameter variable defined below is just an example and may potentially contain non valid values. So please replace this with valid values.
    abs_details_request = AbsDetailsRequest(
        ids=IdsABS(["US05522RDC97"]),
        start_date="2021-01-01",
        end_date="2021-12-31",
        frequency=Frequency("D"),
        calendar=Calendar("FIVEDAY"),
    ) # AbsDetailsRequest | Request object for requesting ABS details

    try:
        # Request Asset Backed Security Details for a list of securities
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_abs_details_for_list(abs_details_request)

        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling ABSDetailsApi->get_abs_details_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **abs_details_request** | [**AbsDetailsRequest**](AbsDetailsRequest.md)| Request object for requesting ABS details |
