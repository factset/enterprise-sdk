# fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.IssuerYieldCurveApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_bond_issuer_yield_curve**](IssuerYieldCurveApi.md#get_bond_issuer_yield_curve) | **GET** /markit-bond-prices-and-analytics/v1/issuer-yield-curve | Get yield curve data for given date range and list of securities
...
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api import issuer_yield_curve_api
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    api_instance = issuer_yield_curve_api.IssuerYieldCurveApi(api_client)
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_bond_issuer_yield_curve(ids, start_date=start_date, end_date=end_date, frequency=frequency, calendar=calendar)
        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling IssuerYieldCurveApi->get_bond_issuer_yield_curve: %s\n" % e)
```
...
> BondIssuerYieldCurveResponse get_bond_issuer_yield_curve_for_list(bond_issuer_yield_curve_request)
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    bond_issuer_yield_curve_request = BondIssuerYieldCurveRequest(
        ids=Ids(["US45905URL07"]),
        start_date="2021-01-01",
        end_date="2021-12-31",
        frequency=Frequency("D"),
        calendar=Calendar("FIVEDAY"),
    ) # BondIssuerYieldCurveRequest | Request object for requesting issuer yield curve data.

    try:
        # Request yield curve data for given date range and list of securities
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_bond_issuer_yield_curve_for_list(bond_issuer_yield_curve_request)
        pprint(api_response)

    except fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiException as e:
        print("Exception when calling IssuerYieldCurveApi->get_bond_issuer_yield_curve_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bond_issuer_yield_curve_request** | [**BondIssuerYieldCurveRequest**](BondIssuerYieldCurveRequest.md)| Request object for requesting issuer yield curve data. |
