# fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.YieldApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_bond_yield**](YieldApi.md#get_bond_yield) | **GET** /markit-bond-prices-and-analytics/v1/yield | Get yield information for given date range and list of securities
...
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api import yield_api
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    api_instance = yield_api.YieldApi(api_client)
    ...
    try:
        ...
        print("Exception when calling YieldApi->get_bond_yield: %s\n" % e)
```
...
# **get_bond_yield_for_list**
> BondYieldResponse get_bond_yield_for_list(bond_yield_request)
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    bond_yield_request = BondYieldRequest(
        ids=Ids(["US45905URL07"]),
        start_date="2021-01-01",
        end_date="2021-12-31",
        frequency=Frequency("D"),
        calendar=Calendar("FIVEDAY"),
    ) # BondYieldRequest | Request object for requesting yield data
    ...
    try:
        ...
        print("Exception when calling YieldApi->get_bond_yield_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bond_yield_request** | [**BondYieldRequest**](BondYieldRequest.md)| Request object for requesting yield data |
