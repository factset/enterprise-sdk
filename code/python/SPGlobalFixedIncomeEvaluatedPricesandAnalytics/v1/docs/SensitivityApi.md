# fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.SensitivityApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_bond_sensitivity**](SensitivityApi.md#get_bond_sensitivity) | **GET** /markit-bond-prices-and-analytics/v1/sensitivity | Get the bond sensitivity data for a list of securities
...
from fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api import sensitivity_api
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    api_instance = sensitivity_api.SensitivityApi(api_client)
    ...
    try:
        ...
        print("Exception when calling SensitivityApi->get_bond_sensitivity: %s\n" % e)
```
...
# **get_bond_sensitivity_for_list**
> BondSensitivityResponse get_bond_sensitivity_for_list(bond_sensitivity_request)
...
with fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.ApiClient(configuration) as api_client:
    ...
    bond_sensitivity_request = BondSensitivityRequest(
        ids=Ids(["US45905URL07"]),
        start_date="2021-01-01",
        end_date="2021-12-31",
        frequency=Frequency("D"),
        calendar=Calendar("FIVEDAY"),
    ) # BondSensitivityRequest | Request object for requesting sensitivity data
    ...
    try:
        ...
        print("Exception when calling SensitivityApi->get_bond_sensitivity_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bond_sensitivity_request** | [**BondSensitivityRequest**](BondSensitivityRequest.md)| Request object for requesting sensitivity data |
