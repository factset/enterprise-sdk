...
```shell
poetry add fds.sdk.utils fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics==0.1.9
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics==0.1.9
```
