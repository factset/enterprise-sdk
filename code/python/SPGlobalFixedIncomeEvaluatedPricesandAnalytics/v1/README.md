...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics/0.1.14)](https://pypi.org/project/fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics/v/0.1.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics==0.1.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics==0.1.14
```
