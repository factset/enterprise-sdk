...
class CustomDocumentsFetchApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_custom_upload_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (UploadedDocumentsList,), 401: (str,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/custom-upload-list',
                'operation_id': 'get_custom_upload_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_custom_upload_list(
        self,
        **kwargs
    ) -> UploadedDocumentsList:
        """Check out the documents uploaded before to use them in creating books  # noqa: E501

        Retrieves the list of documents uploaded before using the endpoint \"/upload-custom-document\". The documents uploaded are available for 30 days from the date of uploading.  # noqa: E501
        ...
        return self.get_custom_upload_list_endpoint.call_with_http_info(**kwargs)

    def get_custom_upload_list_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[UploadedDocumentsList, int, typing.MutableMapping]:
        """Check out the documents uploaded before to use them in creating books  # noqa: E501
    ...
    def get_custom_upload_list_async(
        self,
        **kwargs
    ) -> "ApplyResult[UploadedDocumentsList]":
        """Check out the documents uploaded before to use them in creating books  # noqa: E501
    ...
    def get_custom_upload_list_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[UploadedDocumentsList, int, typing.MutableMapping]]":
        """Check out the documents uploaded before to use them in creating books  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(UploadedDocumentsList, int, typing.Dict)]
        """
