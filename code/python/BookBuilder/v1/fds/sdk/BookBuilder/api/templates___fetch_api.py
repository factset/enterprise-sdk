...
class TemplatesFetchApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_template_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (EnableTemplateInfo,), 401: (str,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'operation_id': 'get_template_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_template_list(
        ...
        **kwargs
        ...
        """Retrieves the list of templates that are available  # noqa: E501

        A template is a predefined list of content to be compiled in a PDF. This end point works without any parameters and retrieves the list of templates available for the user. Templates need to defined/created in FactSet workstation.  # noqa: E501
        ...
        return self.get_template_list_endpoint.call_with_http_info(**kwargs)

    def get_template_list_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[EnableTemplateInfo, int, typing.MutableMapping]:
        """Retrieves the list of templates that are available  # noqa: E501
    ...
    def get_template_list_async(
        self,
        **kwargs
    ) -> "ApplyResult[EnableTemplateInfo]":
        """Retrieves the list of templates that are available  # noqa: E501
    ...
    def get_template_list_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[EnableTemplateInfo, int, typing.MutableMapping]]":
        """Retrieves the list of templates that are available  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(EnableTemplateInfo, int, typing.Dict)]
        """
