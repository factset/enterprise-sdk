...
from fds.sdk.BookBuilder import rest
from fds.sdk.BookBuilder.configuration import Configuration
from fds.sdk.BookBuilder.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.BookBuilder.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/BookBuilder/0.1.2 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BooksCreationApi()
        api_instance.create_book  # this is an instance of the class Endpoint
        api_instance.create_book()  # this invokes api_instance.create_book.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_book.callable or self.callable in this class
