...
class UploadedDocumentsList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UploadedDocumentsList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([bool, date, datetime, dict, float, int, list, str, none_type]): Request to enable template list information for the client..  # noqa: E501

        Keyword Args:
            value ([bool, date, datetime, dict, float, int, list, str, none_type]): Request to enable template list information for the client..  # noqa: E501
