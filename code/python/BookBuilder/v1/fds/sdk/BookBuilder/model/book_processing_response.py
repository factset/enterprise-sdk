...
def lazy_import():
    ...
    globals()['BookProcessingResponseItem'] = BookProcessingResponseItem


class BookProcessingResponse(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([BookProcessingResponseItem],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """BookProcessingResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([BookProcessingResponseItem]): Response indicating that the book is currently processing..  # noqa: E501

        Keyword Args:
            value ([BookProcessingResponseItem]): Response indicating that the book is currently processing..  # noqa: E501
