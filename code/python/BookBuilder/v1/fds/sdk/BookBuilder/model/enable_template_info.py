...
def lazy_import():
    ...
    globals()['TemplateInfo'] = TemplateInfo


class EnableTemplateInfo(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """EnableTemplateInfo - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TemplateInfo]): Request to enable template list information for the client..  # noqa: E501

        Keyword Args:
            value ([TemplateInfo]): Request to enable template list information for the client..  # noqa: E501
