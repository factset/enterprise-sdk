...
def lazy_import():
    ...
    globals()['BookInfo'] = BookInfo


class EnableBookListInfo(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """EnableBookListInfo - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([BookInfo]): Request to enable Book list information for the client..  # noqa: E501

        Keyword Args:
            value ([BookInfo]): Request to enable Book list information for the client..  # noqa: E501
