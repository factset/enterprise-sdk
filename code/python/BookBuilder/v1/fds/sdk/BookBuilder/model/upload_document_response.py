...
class UploadDocumentResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UploadDocumentResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([bool, date, datetime, dict, float, int, list, str, none_type]): Response to Upload Document..  # noqa: E501

        Keyword Args:
            value ([bool, date, datetime, dict, float, int, list, str, none_type]): Response to Upload Document..  # noqa: E501
