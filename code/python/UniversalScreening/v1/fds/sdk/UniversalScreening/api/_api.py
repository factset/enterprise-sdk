...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_active_job_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/calculations/{id}',
        ...
        self.get_all_active_jobs_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (InlineResponse200,), 401: (ErrorArray,), 404: (ErrorArray,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.poll_archive_ofdb_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'endpoint_path': '/v1/archive/{id}/status',
                'operation_id': 'poll_archive_ofdb',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.poll_calculate_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/calculations/{id}/status',
    ...
    def poll_archive_ofdb(
        self,
        id,
        **kwargs
    ) -> ResourceStatusResponse:
        """poll_archive_ofdb  # noqa: E501

        Polls the archive OFDB job with a given archive job ID and returns job status  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
        ...
        kwargs['id'] = \
            id
        return self.poll_archive_ofdb_endpoint.call_with_http_info(**kwargs)

    def poll_archive_ofdb_with_http_info(
        self,
        id,
        **kwargs
    ...
    def poll_archive_ofdb_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def poll_calculate(
        ...
        **kwargs
        ...
        Polls the calculation job with a given screen calculation ID and returns job status  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def submit_archive_ofdb(
        ...
        **kwargs
        ...
        Begins archive of screen to OFDB  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def submit_calculate(
        ...
        **kwargs
        ...
        Begins calculation of screen  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
