...
from fds.sdk.UniversalScreening import rest
from fds.sdk.UniversalScreening.configuration import Configuration
from fds.sdk.UniversalScreening.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.UniversalScreening.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/UniversalScreening/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_active_job  # this is an instance of the class Endpoint
        api_instance.delete_active_job()  # this invokes api_instance.delete_active_job.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_active_job.callable or self.callable in this class
