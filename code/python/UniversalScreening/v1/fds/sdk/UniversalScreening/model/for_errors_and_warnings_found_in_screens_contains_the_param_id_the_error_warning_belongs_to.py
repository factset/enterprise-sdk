...
class ForErrorsAndWarningsFoundInScreensContainsTheParamIDTheErrorWarningBelongsTo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ForErrorsAndWarningsFoundInScreensContainsTheParamIDTheErrorWarningBelongsTo - a model defined in OpenAPI
