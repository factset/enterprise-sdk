...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.UniversalScreening/1.3.0)](https://pypi.org/project/fds.sdk.UniversalScreening/v/1.3.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.UniversalScreening==1.3.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.UniversalScreening==1.3.0
```
...
*ScreeningOperationsApi* | [**get_export_results**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/ScreeningOperationsApi.md#get_export_results) | **GET** /job/{id}/export | 
...
*ScreeningOperationsApi* | [**submit_export**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/ScreeningOperationsApi.md#submit_export) | **POST** /job/export | 
...
## Documentation For Models
 ...
 - [CalculateMetadata](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/CalculateMetadata.md)
 - [DelimitedOptions](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/DelimitedOptions.md)
 ...
 - [ExcelOptions](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/ExcelOptions.md)
 - [GroupingInfo](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/GroupingInfo.md)
 ...
 - [PdfOptions](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/PdfOptions.md)
 ...
 - [ScreenExportParameters](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/ScreenExportParameters.md)
 - [ScreenExportParametersData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/ScreenExportParametersData.md)
 - [SubmitExportResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/SubmitExportResponse.md)
 - [SubmitExportResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/UniversalScreening/v2/docs/SubmitExportResponseData.md)
