...
class CalculateMetadata(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CalculateMetadata - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sort ([str]): An array of parameter references to sort by to override the sort set in the screen document. Format is \"#P.<parameter_name>\" for ascending sort, \"-#P.<parameter_name>\" for descending. Will sort by references in order of appearance in the provided list, i.e. will sort first by the 0th reference, then the 1st reference and so on. Limit of 7 references.. [optional]  # noqa: E501
        """
