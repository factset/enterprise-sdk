...
class JobManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_active_job_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'delete_active_job',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.delete_all_active_jobs_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'delete_all_active_jobs',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_all_active_jobs_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ActiveJobsData,), 401: (ErrorArray,), 404: (ErrorArray,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/v2/jobs',
                'operation_id': 'get_all_active_jobs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def delete_active_job(
        ...
        **kwargs
        ...
        """delete_active_job  # noqa: E501

        Delete a specified job started by the requester's username-serial  # noqa: E501
    ...
    def delete_active_job_with_http_info(
        self,
        id,
        **kwargs
    ...
    def delete_active_job_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def delete_all_active_jobs(
        ...
        **kwargs
        ...
        """delete_all_active_jobs  # noqa: E501

        Delete all active jobs started by the requester's username-serial  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def delete_all_active_jobs_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[None, int, typing.MutableMapping]:
        """delete_all_active_jobs  # noqa: E501
    ...
    def delete_all_active_jobs_async(
        self,
        **kwargs
    ) -> "ApplyResult[None]":
        """delete_all_active_jobs  # noqa: E501
    ...
    def delete_all_active_jobs_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[None, int, typing.MutableMapping]]":
        """delete_all_active_jobs  # noqa: E501
    ...
    def get_all_active_jobs(
        ...
        **kwargs
        ...
        """get_all_active_jobs  # noqa: E501

        Retrieve list of all active job ids started by requester's username-serial  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_all_active_jobs_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[ActiveJobsData, int, typing.MutableMapping]:
        """get_all_active_jobs  # noqa: E501
    ...
    def get_all_active_jobs_async(
        self,
        **kwargs
    ) -> "ApplyResult[ActiveJobsData]":
        """get_all_active_jobs  # noqa: E501
    ...
    def get_all_active_jobs_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[ActiveJobsData, int, typing.MutableMapping]]":
        """get_all_active_jobs  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(ActiveJobsData, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_all_active_jobs_endpoint.call_with_http_info(**kwargs)
