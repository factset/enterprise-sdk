...
from fds.sdk.FactSetMergersandAcquisitions import rest
from fds.sdk.FactSetMergersandAcquisitions.configuration import Configuration
from fds.sdk.FactSetMergersandAcquisitions.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetMergersandAcquisitions.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetMergersandAcquisitions/1.1.2 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DealsApi()
        api_instance.get_deals_by_company_list  # this is an instance of the class Endpoint
        api_instance.get_deals_by_company_list()  # this invokes api_instance.get_deals_by_company_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_deals_by_company_list.callable or self.callable in this class
