...
class DealIds(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DealIds - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): The requested list of deal identifiers. Maximum of 100 IDs are supported. .  # noqa: E501

        Keyword Args:
            value ([str]): The requested list of deal identifiers. Maximum of 100 IDs are supported. .  # noqa: E501
