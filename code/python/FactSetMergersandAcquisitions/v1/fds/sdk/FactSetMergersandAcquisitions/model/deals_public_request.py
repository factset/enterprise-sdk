...
def lazy_import():
    ...
    globals()['DealsPublicRequestBody'] = DealsPublicRequestBody


class DealsPublicRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (DealsPublicRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """DealsPublicRequest - a model defined in OpenAPI
