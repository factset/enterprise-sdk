...
class AdvisorParticipant(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdvisorParticipant - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fsym_id (str, none_type): FactSet Permanent Identifier of the participant. Six alpha-numeric characters, excluding vowels, with an -E suffix (XXXXXX-E). Null values indicate that no data is available.. [optional]  # noqa: E501
            name (str, none_type): Entity name of the advisor. Null values indicate that no data is available.. [optional]  # noqa: E501
            fees (float, none_type): Fees of the advisor. All values in millions of USD. Null values indicate that no data is available.. [optional]  # noqa: E501
        """
