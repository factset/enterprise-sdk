...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetMergersandAcquisitions/1.1.1)](https://pypi.org/project/fds.sdk.FactSetMergersandAcquisitions/v/1.1.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetMergersandAcquisitions==1.1.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetMergersandAcquisitions==1.1.1
```
