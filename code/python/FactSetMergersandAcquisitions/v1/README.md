...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetMergersandAcquisitions/1.1.0)](https://pypi.org/project/fds.sdk.FactSetMergersandAcquisitions/v/1.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetMergersandAcquisitions==1.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetMergersandAcquisitions==1.1.0
```
