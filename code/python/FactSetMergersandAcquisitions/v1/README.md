...
[![API Version](https://img.shields.io/badge/api-v1.2.0-blue)](https://developer.factset.com/api-catalog/factset-mergers-acquisitions-api)
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetMergersandAcquisitions/2.1.0)](https://pypi.org/project/fds.sdk.FactSetMergersandAcquisitions/v/2.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetMergersandAcquisitions==2.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetMergersandAcquisitions==2.1.0
```
