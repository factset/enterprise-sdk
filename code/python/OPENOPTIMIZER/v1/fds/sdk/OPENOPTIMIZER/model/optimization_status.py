...
def lazy_import():
    ...
    globals()['OptimizationStatusData'] = OptimizationStatusData


class OptimizationStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (OptimizationStatusData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """OptimizationStatus - a model defined in OpenAPI

        Args:
            data (OptimizationStatusData):
