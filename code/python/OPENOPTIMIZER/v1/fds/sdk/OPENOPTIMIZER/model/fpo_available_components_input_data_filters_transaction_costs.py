...
class FPOAvailableComponentsInputDataFiltersTransactionCosts(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FPOAvailableComponentsInputDataFiltersTransactionCosts - a model defined in OpenAPI
