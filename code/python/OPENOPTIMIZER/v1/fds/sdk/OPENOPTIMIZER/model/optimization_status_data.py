...
class OptimizationStatusData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'detailed_status': (str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'detailed_status': 'detailedStatus',  # noqa: E501
    ...
    def _from_openapi_data(cls, id, status, *args, **kwargs):  # noqa: E501
        """OptimizationStatusData - a model defined in OpenAPI

        Args:
            id (str): Unique identifier for the optimization
            status (str): Current status of the optimization
        ...
        Keyword Args:
            ...
            detailed_status (str, none_type): Detailed status message of the optimization. [optional]  # noqa: E501
