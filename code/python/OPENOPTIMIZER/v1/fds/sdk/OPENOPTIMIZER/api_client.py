...
from fds.sdk.OPENOPTIMIZER import rest
from fds.sdk.OPENOPTIMIZER.configuration import Configuration
from fds.sdk.OPENOPTIMIZER.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OPENOPTIMIZER.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OPENOPTIMIZER/0.0.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AxiomaEquityPortfolioOptimizerApi()
        api_instance.get_global_variables_axp  # this is an instance of the class Endpoint
        api_instance.get_global_variables_axp()  # this invokes api_instance.get_global_variables_axp.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_global_variables_axp.callable or self.callable in this class
