# fds.sdk.OPENOPTIMIZER.NorthfieldPortfolioOptimizerApi

All URIs are relative to *https://api.factset.com/open-optimizer/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_global_variables_npo**](NorthfieldPortfolioOptimizerApi.md#get_global_variables_npo) | **GET** /npo/settings/global-variables | Returns a dictionary with the name-value pairs for all global variables.
[**get_optimization_result_by_id_npo**](NorthfieldPortfolioOptimizerApi.md#get_optimization_result_by_id_npo) | **GET** /npo/{id} | Get NPO optimization result by id
[**get_optimization_status_by_id_npo**](NorthfieldPortfolioOptimizerApi.md#get_optimization_status_by_id_npo) | **GET** /npo/{id}/status | Get NPO optimization status by id
[**post_and_optimize_npo**](NorthfieldPortfolioOptimizerApi.md#post_and_optimize_npo) | **POST** /npo/optimize | Create and Run NPO optimization
[**post_components_npo**](NorthfieldPortfolioOptimizerApi.md#post_components_npo) | **POST** /npo/settings/components | Returns a dictionary with individually-filtered metadata for each component type.
[**post_strategies_npo**](NorthfieldPortfolioOptimizerApi.md#post_strategies_npo) | **POST** /npo/settings/strategies | Returns a dictionary containing all strategies stored in a specified directory. Returns all strategies if no directory is given.



# **get_global_variables_npo**
> SettingsGlobalVarsResponse get_global_variables_npo()
...
from fds.sdk.OPENOPTIMIZER.api import northfield_portfolio_optimizer_api
...
with fds.sdk.OPENOPTIMIZER.ApiClient(configuration) as api_client:
    ...
    api_instance = northfield_portfolio_optimizer_api.NorthfieldPortfolioOptimizerApi(api_client)
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_global_variables_npo(cache_control=cache_control)

        pprint(api_response)

    except fds.sdk.OPENOPTIMIZER.ApiException as e:
        print("Exception when calling NorthfieldPortfolioOptimizerApi->get_global_variables_npo: %s\n" % e)
```
...
# **get_optimization_result_by_id_npo**
> ResultResponse get_optimization_result_by_id_npo(id)
...
with fds.sdk.OPENOPTIMIZER.ApiClient(configuration) as api_client:
    ...
    try:
        # Get NPO optimization result by id
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_optimization_result_by_id_npo(id)

        pprint(api_response)

    except fds.sdk.OPENOPTIMIZER.ApiException as e:
        print("Exception when calling NorthfieldPortfolioOptimizerApi->get_optimization_result_by_id_npo: %s\n" % e)
```
...
# **get_optimization_status_by_id_npo**
> OptimizationStatus get_optimization_status_by_id_npo(id)
...
with fds.sdk.OPENOPTIMIZER.ApiClient(configuration) as api_client:
    ...
    try:
        # Get NPO optimization status by id
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_optimization_status_by_id_npo(id)

        pprint(api_response)

    except fds.sdk.OPENOPTIMIZER.ApiException as e:
        print("Exception when calling NorthfieldPortfolioOptimizerApi->get_optimization_status_by_id_npo: %s\n" % e)
```
...
# **post_and_optimize_npo**
> OptimizationStatus post_and_optimize_npo()
...
with fds.sdk.OPENOPTIMIZER.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    cache_control = "Cache-Control_example" # str | Standard HTTP header.  Accepts max-stale. (optional)
    npo_optimization_parameters_request = NPOOptimizationParametersRequest(
        data=NPOOptimizationParameters(
            account=NPOAccountInput(
            ...
            strategy=NPOOptimizerStrategyInput(
                overrides=NPOOptimizerStrategyOverridesInput(
                    objective="NPO_OBJECTIVE_FUNCTION_KEY_20120101_",
                    tax="NPO_TAX_KEY_20120101_",
                    constraints={},
                    alpha="P(0)/100",
                    transaction_cost="NPO_TRANS_COST_MODEL_KEY_20130612_",
                ),
                id="Client:/folder1/NPO_Model",
            ),
    ...
    ) # NPOOptimizationParametersRequest | Optimization Parameters (optional)

    try:
        # Create and Run NPO optimization
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.post_and_optimize_npo(cache_control=cache_control, npo_optimization_parameters_request=npo_optimization_parameters_request)

        pprint(api_response)

    except fds.sdk.OPENOPTIMIZER.ApiException as e:
        print("Exception when calling NorthfieldPortfolioOptimizerApi->post_and_optimize_npo: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **cache_control** | **str**| Standard HTTP header.  Accepts max-stale. | [optional]
 **npo_optimization_parameters_request** | [**NPOOptimizationParametersRequest**](NPOOptimizationParametersRequest.md)| Optimization Parameters | [optional]
...
# **post_components_npo**
> AvailableComponentsResponse post_components_npo()
...
with fds.sdk.OPENOPTIMIZER.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.post_components_npo(bpmnpo_available_components_input=bpmnpo_available_components_input)

        pprint(api_response)

    except fds.sdk.OPENOPTIMIZER.ApiException as e:
        print("Exception when calling NorthfieldPortfolioOptimizerApi->post_components_npo: %s\n" % e)
```
...
# **post_strategies_npo**
> AvailableStrategiesResponse post_strategies_npo()
...
with fds.sdk.OPENOPTIMIZER.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.post_strategies_npo(cache_control=cache_control, available_strategies_input=available_strategies_input)

        pprint(api_response)

    except fds.sdk.OPENOPTIMIZER.ApiException as e:
        print("Exception when calling NorthfieldPortfolioOptimizerApi->post_strategies_npo: %s\n" % e)
```
