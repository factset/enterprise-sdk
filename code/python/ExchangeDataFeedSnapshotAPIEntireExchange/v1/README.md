...
```shell
poetry add fds.sdk.utils fds.sdk.ExchangeDataFeedSnapshotAPIEntireExchange==0.21.12
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ExchangeDataFeedSnapshotAPIEntireExchange==0.21.12
```
