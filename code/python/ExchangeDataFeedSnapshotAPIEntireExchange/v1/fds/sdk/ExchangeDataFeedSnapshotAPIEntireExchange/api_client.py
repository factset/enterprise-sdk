...
from fds.sdk.ExchangeDataFeedSnapshotAPIEntireExchange import rest
from fds.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.configuration import Configuration
from fds.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ExchangeDataFeedSnapshotAPIEntireExchange/0.21.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SnapshotApi()
        api_instance.get_v1_list_files  # this is an instance of the class Endpoint
        api_instance.get_v1_list_files()  # this invokes api_instance.get_v1_list_files.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_v1_list_files.callable or self.callable in this class
