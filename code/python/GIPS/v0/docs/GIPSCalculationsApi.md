# fds.sdk.GIPS.GIPSCalculationsApi

All URIs are relative to *https://api.factset.com/analytics/engines/gips/v0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancel_calculation_by_id**](GIPSCalculationsApi.md#cancel_calculation_by_id) | **DELETE** /calculations/{id} | Cancel GIPS calculation by id
[**gips_get_all_calculations**](GIPSCalculationsApi.md#gips_get_all_calculations) | **GET** /calculations | Get all calculations
[**gips_get_calculation_status_by_id**](GIPSCalculationsApi.md#gips_get_calculation_status_by_id) | **GET** /calculations/{id}/status | Get GIPS calculation status by id
[**gips_get_calculation_unit_result_by_id**](GIPSCalculationsApi.md#gips_get_calculation_unit_result_by_id) | **GET** /calculations/{id}/units/{unitId}/result | Get GIPS calculation result by id
[**gips_post_and_calculate**](GIPSCalculationsApi.md#gips_post_and_calculate) | **POST** /calculations | Create and Run GIPS calculation
...
# **gips_get_all_calculations**
> CalculationsSummaryRoot gips_get_all_calculations()
...
with fds.sdk.GIPS.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    page_number = 1 # int | Page number to be viewed (optional) if omitted the server will use the default value of 1

    try:
        # Get all calculations
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.gips_get_all_calculations(page_number=page_number)

        pprint(api_response)

    except fds.sdk.GIPS.ApiException as e:
        print("Exception when calling GIPSCalculationsApi->gips_get_all_calculations: %s\n" % e)
```
...
# **gips_get_calculation_status_by_id**
> CalculationStatusRoot gips_get_calculation_status_by_id(id)
...
with fds.sdk.GIPS.ApiClient(configuration) as api_client:
    ...
    try:
        # Get GIPS calculation status by id
        # example passing only required values which don't have defaults set
        api_response = api_instance.gips_get_calculation_status_by_id(id)

        pprint(api_response)

    except fds.sdk.GIPS.ApiException as e:
        print("Exception when calling GIPSCalculationsApi->gips_get_calculation_status_by_id: %s\n" % e)
```
...
# **gips_get_calculation_unit_result_by_id**
> FactSetProtobufStachV3StachV3Table gips_get_calculation_unit_result_by_id(id, unit_id)
...
with fds.sdk.GIPS.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    id = "id_example" # str | from url, provided from the location header in the Get GIPS calculation status by id endpoint
    unit_id = "unitId_example" # str | from url, provided from the location header in the Get GIPS calculation status by id endpoint

    try:
        # Get GIPS calculation result by id
        # example passing only required values which don't have defaults set
        api_response = api_instance.gips_get_calculation_unit_result_by_id(id, unit_id)

        pprint(api_response)

    except fds.sdk.GIPS.ApiException as e:
        print("Exception when calling GIPSCalculationsApi->gips_get_calculation_unit_result_by_id: %s\n" % e)
```
...
# **gips_post_and_calculate**
> CalculationStatusRoot gips_post_and_calculate()
...
with fds.sdk.GIPS.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    x_fact_set_api_long_running_deadline = 20 # int | The number of seconds the request will wait before sending back the response. If not provided, 20 will be used as default. (optional)
    cache_control = "max-stale=0" # str | Standard HTTP header.  Accepts max-stale. (optional)
    gips_calculation_parameters_root = GIPSCalculationParametersRoot(
        data={
            "key": GIPSCalculationParameters(
                account="jUR,rZ#UM/?R,Fp^l6$ARj.acTm",
    ...
    ) # GIPSCalculationParametersRoot | The request body contains the information needed to run a calculation, e.g. the GIPS composite. See the schema for more details. (optional)

    try:
        # Create and Run GIPS calculation
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.gips_post_and_calculate(x_fact_set_api_long_running_deadline=x_fact_set_api_long_running_deadline, cache_control=cache_control, gips_calculation_parameters_root=gips_calculation_parameters_root)

        pprint(api_response)

    except fds.sdk.GIPS.ApiException as e:
        print("Exception when calling GIPSCalculationsApi->gips_post_and_calculate: %s\n" % e)
```
 ...
 **gips_calculation_parameters_root** | [**GIPSCalculationParametersRoot**](GIPSCalculationParametersRoot.md)| The request body contains the information needed to run a calculation, e.g. the GIPS composite. See the schema for more details. | [optional]
