...
class FactSetProtobufStachV3TableTypesPaginationTypesCursor(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FactSetProtobufStachV3TableTypesPaginationTypesCursor - a model defined in OpenAPI
