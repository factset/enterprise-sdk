...
def lazy_import():
    ...
    globals()['CalculationsSummary'] = CalculationsSummary
    globals()['PaginationMeta'] = PaginationMeta


class CalculationsSummaryRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        ...
        Args:
            data ({str: (CalculationsSummary,)}): The object that contains the main information requested.
