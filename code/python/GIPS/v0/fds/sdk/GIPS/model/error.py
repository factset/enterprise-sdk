...
class Error(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str, none_type): Identifier for the error (the Chain ID). [optional]  # noqa: E501
            code (str, none_type): The error code. [optional]  # noqa: E501
            title (str, none_type): The title of the error. [optional]  # noqa: E501
