...
from fds.sdk.RealTimeQuotes import rest
from fds.sdk.RealTimeQuotes.configuration import Configuration
from fds.sdk.RealTimeQuotes.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.RealTimeQuotes.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/RealTimeQuotes/0.12.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BasicApi()
        api_instance.get_basic_asset_class_list  # this is an instance of the class Endpoint
        api_instance.get_basic_asset_class_list()  # this invokes api_instance.get_basic_asset_class_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_basic_asset_class_list.callable or self.callable in this class
