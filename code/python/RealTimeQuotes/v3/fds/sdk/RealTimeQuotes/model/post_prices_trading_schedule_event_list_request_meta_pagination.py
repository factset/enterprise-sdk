...
class PostPricesTradingScheduleEventListRequestMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostPricesTradingScheduleEventListRequestMetaPagination - a model defined in OpenAPI
