...
class PostInstrumentNotationListRequestMeta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostInstrumentNotationListRequestMeta - a model defined in OpenAPI
