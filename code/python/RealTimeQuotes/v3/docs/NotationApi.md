# fds.sdk.RealTimeQuotes.NotationApi

All URIs are relative to *https://api.factset.com/wealth/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_notation_cross_reference_fact_set_identifier_get**](NotationApi.md#get_notation_cross_reference_fact_set_identifier_get) | **GET** /notation/crossReference/factSetIdentifier/get | Retrieve FactSet identifiers for a given notation.
[**get_notation_cross_reference_get_by_fact_set_market_symbol**](NotationApi.md#get_notation_cross_reference_get_by_fact_set_market_symbol) | **GET** /notation/crossReference/getByFactSetMarketSymbol | Translate a FactSet market symbol to a notation.
[**get_notation_get**](NotationApi.md#get_notation_get) | **GET** /notation/get | Basic data for a notation.
[**get_notation_key_figures_month_1_get**](NotationApi.md#get_notation_key_figures_month_1_get) | **GET** /notation/keyFigures/month/1/get | End-of-day (EOD) key figures for the time range of one month.
[**get_notation_key_figures_month_1_list**](NotationApi.md#get_notation_key_figures_month_1_list) | **GET** /notation/keyFigures/month/1/list | End-of-day (EOD) key figures for the time range of one month, for a list of notations.
[**get_notation_key_figures_month_3_get**](NotationApi.md#get_notation_key_figures_month_3_get) | **GET** /notation/keyFigures/month/3/get | End-of-day (EOD) key figures for the time range of three months.
...
[**get_notation_selection_list_list**](NotationApi.md#get_notation_selection_list_list) | **GET** /notation/selectionList/list | Set of custom notation-level selection lists.
[**get_notation_selection_list_list_by_notation**](NotationApi.md#get_notation_selection_list_list_by_notation) | **GET** /notation/selectionList/listByNotation | For each given notation, returns the notation-level selection lists of which the notation is a member.
...
[**post_notation_selection_list_members_list**](NotationApi.md#post_notation_selection_list_members_list) | **POST** /notation/selectionList/members/list | List of notations belonging to a notation-level selection list.



# **get_notation_cross_reference_fact_set_identifier_get**
> InlineResponse20075 get_notation_cross_reference_fact_set_identifier_get(identifier, identifier_type)
...
from fds.sdk.RealTimeQuotes.api import notation_api
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_cross_reference_fact_set_identifier_get: %s\n" % e)
```
...
> InlineResponse20071 get_notation_cross_reference_get_by_fact_set_market_symbol(fact_set_market_symbol)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_cross_reference_get_by_fact_set_market_symbol: %s\n" % e)
```
...
# **get_notation_get**
> InlineResponse20068 get_notation_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_get: %s\n" % e)
```
...
> InlineResponse20080 get_notation_key_figures_month_1_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_month_1_get: %s\n" % e)
```
...
> InlineResponse20081 get_notation_key_figures_month_1_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_month_1_list: %s\n" % e)
```
...
> InlineResponse20078 get_notation_key_figures_month_3_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_month_3_get: %s\n" % e)
```
...
> InlineResponse20079 get_notation_key_figures_month_3_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_month_3_list: %s\n" % e)
```
...
> InlineResponse20078 get_notation_key_figures_month_6_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_month_6_get: %s\n" % e)
```
...
> InlineResponse20079 get_notation_key_figures_month_6_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_month_6_list: %s\n" % e)
```
...
> InlineResponse20084 get_notation_key_figures_trading_day_average_get(identifier, identifier_type)
...
> InlineResponse20080 get_notation_key_figures_week_1_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_week_1_get: %s\n" % e)
```
...
> InlineResponse20081 get_notation_key_figures_week_1_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_week_1_list: %s\n" % e)
```
...
> InlineResponse20078 get_notation_key_figures_year_10_get(identifier, identifier_type)
...
> InlineResponse20079 get_notation_key_figures_year_10_list(identifiers, identifier_type)
...
> InlineResponse20080 get_notation_key_figures_year_1_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_1_get: %s\n" % e)
```
...
> InlineResponse20081 get_notation_key_figures_year_1_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_1_list: %s\n" % e)
```
...
> InlineResponse20078 get_notation_key_figures_year_3_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_3_get: %s\n" % e)
```
...
> InlineResponse20079 get_notation_key_figures_year_3_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_3_list: %s\n" % e)
```
...
> InlineResponse20078 get_notation_key_figures_year_5_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_5_get: %s\n" % e)
```
...
> InlineResponse20079 get_notation_key_figures_year_5_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_5_list: %s\n" % e)
```
...
> InlineResponse20078 get_notation_key_figures_year_7_get(identifier, identifier_type)
...
> InlineResponse20079 get_notation_key_figures_year_7_list(identifiers, identifier_type)
...
> InlineResponse20082 get_notation_key_figures_year_to_date_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_to_date_get: %s\n" % e)
```
...
> InlineResponse20083 get_notation_key_figures_year_to_date_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_key_figures_year_to_date_list: %s\n" % e)
```
...
# **get_notation_list**
> InlineResponse20069 get_notation_list(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_list: %s\n" % e)
```
...
> InlineResponse20098 get_notation_search_basic(search_value)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->get_notation_search_basic: %s\n" % e)
```
...
# **get_notation_selection_list_list**
> InlineResponse20065 get_notation_selection_list_list()
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_notation_selection_list_list(attributes=attributes)

        pprint(api_response)

    except fds.sdk.RealTimeQuotes.ApiException as e:
        print("Exception when calling NotationApi->get_notation_selection_list_list: %s\n" % e)
```
...
# **get_notation_selection_list_list_by_notation**
> InlineResponse20086 get_notation_selection_list_list_by_notation(identifiers, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_notation_selection_list_list_by_notation(identifiers, identifier_type, attributes=attributes)

        pprint(api_response)

    except fds.sdk.RealTimeQuotes.ApiException as e:
        print("Exception when calling NotationApi->get_notation_selection_list_list_by_notation: %s\n" % e)
```
...
> InlineResponse20088 get_notation_status_get(identifier, identifier_type)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_notation_status_get(identifier, identifier_type, quality=quality, attributes=attributes, subscription_minimum_interval=subscription_minimum_interval)

        pprint(api_response)

    except fds.sdk.RealTimeQuotes.ApiException as e:
        print("Exception when calling NotationApi->get_notation_status_get: %s\n" % e)
```
...
> InlineResponse20070 post_notation_category_list()
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    post_notation_category_list_request = PostNotationCategoryListRequest(
        ...
        meta=PostNotationCategoryListRequestMeta(
...
# **post_notation_cross_reference_fact_set_identifier_list_by_fact_set_identifier**
> InlineResponse20076 post_notation_cross_reference_fact_set_identifier_list_by_fact_set_identifier(post_notation_cross_reference_fact_set_identifier_list_by_fact_set_identifier_request)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->post_notation_cross_reference_fact_set_identifier_list_by_fact_set_identifier: %s\n" % e)
```
...
> InlineResponse20077 post_notation_cross_reference_fact_set_identifier_list_by_instrument(post_notation_cross_reference_fact_set_identifier_list_by_instrument_request)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->post_notation_cross_reference_fact_set_identifier_list_by_instrument: %s\n" % e)
```
...
> InlineResponse20072 post_notation_cross_reference_list_by_instrument()
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->post_notation_cross_reference_list_by_instrument: %s\n" % e)
```
...
> InlineResponse20073 post_notation_cross_reference_list_by_isin()
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->post_notation_cross_reference_list_by_isin: %s\n" % e)
```
...
> InlineResponse20074 post_notation_cross_reference_list_by_symbol()
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotationApi->post_notation_cross_reference_list_by_symbol: %s\n" % e)
```
...
> InlineResponse20085 post_notation_market_list()
...
> InlineResponse20099 post_notation_search_by_text(post_notation_search_by_text_request)
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    post_notation_search_by_text_request = PostNotationSearchByTextRequest(
        data=PostNotationSearchByTextRequestData(
            ...
            validation=PostNotationSearchByTextRequestDataValidation(
                ...
                value_unit=PostNotationSelectionListMembersListRequestDataFilterValueUnit(
                ...
                instrument_selection_list=PostNotationSearchByTextRequestDataValidationInstrumentSelectionList(
                    restrict=PostNotationSearchByTextRequestDataValidationInstrumentSelectionListRestrict(
                        ids=[
                            3.14,
                        ],
                    ),
                    exclude=PostNotationSearchByTextRequestDataValidationInstrumentSelectionListExclude(
                        ids=[
                            3.14,
                        ],
                    ),
                ),
                notation_selection_list=PostNotationSearchByTextRequestDataValidationNotationSelectionList(
                    restrict=PostNotationSearchByTextRequestDataValidationNotationSelectionListRestrict(
                        ids=[
                            3.14,
                        ],
                    ),
                    exclude=PostNotationSearchByTextRequestDataValidationNotationSelectionListExclude(
                        ids=[
                            3.14,
                        ],
                    ),
            ...
            asset_class=PostNotationSearchByTextRequestDataAssetClass(
                ids=[
                    3.14,
                ],
            ),
            instrument_category=PostNotationSearchByTextRequestDataInstrumentCategory(
                restrict=PostNotationSearchByTextRequestDataInstrumentCategoryRestrict(
                    ids=[
                        3.14,
                    ],
                ),
                exclude=PostNotationSelectionListMembersListRequestDataFilterInstrumentCategoryExclude(
                    ids=[
                        3.14,
                    ],
                ),
    ...
    try:
        ...
        print("Exception when calling NotationApi->post_notation_search_by_text: %s\n" % e)
```
...
# **post_notation_selection_list_members_list**
> InlineResponse20087 post_notation_selection_list_members_list()
...
with fds.sdk.RealTimeQuotes.ApiClient(configuration) as api_client:
    ...
    post_notation_selection_list_members_list_request = PostNotationSelectionListMembersListRequest(
        data=PostNotationSelectionListMembersListRequestData(
            id=3.14,
            filter=PostNotationSelectionListMembersListRequestDataFilter(
                market=PostNotationSelectionListMembersListRequestDataFilterMarket(
                    restrict=PostInstrumentNotationListRequestDataFilterMarketSelectionRestrict(
                        ids=[
                            3.14,
                        ],
                ...
                instrument_category=PostNotationSelectionListMembersListRequestDataFilterInstrumentCategory(
                    restrict=PostNotationSelectionListMembersListRequestDataFilterInstrumentCategoryRestrict(
                        ids=[
                            3.14,
                        ],
                    ),
        ...
        meta=PostNotationSelectionListMembersListRequestMeta(
            attributes=AttributesMember([
                "attributes_example",
            ]),
            language=LanguageMember("language_example"),
    ...
    ) # PostNotationSelectionListMembersListRequest | Request Body (optional)

    try:
        # List of notations belonging to a notation-level selection list.
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.post_notation_selection_list_members_list(post_notation_selection_list_members_list_request=post_notation_selection_list_members_list_request)

        pprint(api_response)

    except fds.sdk.RealTimeQuotes.ApiException as e:
        print("Exception when calling NotationApi->post_notation_selection_list_members_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **post_notation_selection_list_members_list_request** | [**PostNotationSelectionListMembersListRequest**](PostNotationSelectionListMembersListRequest.md)| Request Body | [optional]
