...
**trading_volume** | **float, none_type** | Number of units (e.g. shares) traded. | [optional] 
**trading_value** | **float, none_type** | Monetary equivalent (cash value) of the trades. See attribute &#x60;currency&#x60; for its unit. | [optional] 
**volume_weighted_average_price** | **float, none_type** | The volume-weighted average price (VWAP). See attribute &#x60;valueUnit&#x60; for its unit. | [optional] 
