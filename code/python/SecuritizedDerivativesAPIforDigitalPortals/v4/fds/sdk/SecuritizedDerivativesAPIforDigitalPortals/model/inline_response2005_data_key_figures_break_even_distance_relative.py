...
class InlineResponse2005DataKeyFiguresBreakEvenDistanceRelative(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2005DataKeyFiguresBreakEvenDistanceRelative - a model defined in OpenAPI
