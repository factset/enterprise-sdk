...
def lazy_import():
    from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.model.get_securitized_derivative_key_figures_notation_get_data_underlyings_items import GetSecuritizedDerivativeKeyFiguresNotationGetDataUnderlyingsItems
    ...
    globals()['GetSecuritizedDerivativeKeyFiguresNotationGetDataUnderlyingsItems'] = GetSecuritizedDerivativeKeyFiguresNotationGetDataUnderlyingsItems
...
class InlineResponse2003Data(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'underlyings': ([GetSecuritizedDerivativeKeyFiguresNotationGetDataUnderlyingsItems],),  # noqa: E501
            ...
            'outperformance_point': (float, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            underlyings ([GetSecuritizedDerivativeKeyFiguresNotationGetDataUnderlyingsItems]): Details of the underlyings.. [optional]  # noqa: E501
            ...
            time_value (float, none_type): Ask-based time value. It represents the difference between the ask price of the securitized derivative and its intrinsic value (see attribute `intrinsicValue`). This key figure is calculated for plain vanilla warrants only.. [optional]  # noqa: E501
            outperformance_point (float, none_type): Ask-based outperformance point. It represents the underlying level from which the underlying starts to outperform the securitized derivative, thus the investor would be better off investing directly in the underlying. It is calculated only for securitized derivatives with a limited payout (e.g. capped products). This key figure is not calculated for securitized derivatives with multiple underlyings. For the value unit, see attribute `underlyings.valueUnit`.. [optional]  # noqa: E501
