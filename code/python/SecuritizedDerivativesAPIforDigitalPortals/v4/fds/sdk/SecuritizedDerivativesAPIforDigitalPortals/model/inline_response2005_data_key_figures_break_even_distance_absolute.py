...
class InlineResponse2005DataKeyFiguresBreakEvenDistanceAbsolute(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2005DataKeyFiguresBreakEvenDistanceAbsolute - a model defined in OpenAPI
