...
class PostSecuritizedDerivativeNotationScreenerValueRangesGetRequestDataLifeCycleIssue(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostSecuritizedDerivativeNotationScreenerValueRangesGetRequestDataLifeCycleIssue - a model defined in OpenAPI
