...
class InlineResponse2005DataKeyFiguresThetaOneWeekUnadjusted(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2005DataKeyFiguresThetaOneWeekUnadjusted - a model defined in OpenAPI
