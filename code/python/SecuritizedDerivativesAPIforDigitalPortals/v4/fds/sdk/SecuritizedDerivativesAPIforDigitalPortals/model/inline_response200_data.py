...
def lazy_import():
    from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.model.get_securitized_derivative_get_data_country_security_registration_items import GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems
    from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.model.get_securitized_derivative_get_data_type_items import GetSecuritizedDerivativeGetDataTypeItems
    ...
    globals()['GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems'] = GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems
    globals()['GetSecuritizedDerivativeGetDataTypeItems'] = GetSecuritizedDerivativeGetDataTypeItems
...
class InlineResponse200Data(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_private_placement': (bool, none_type,),  # noqa: E501
            'name': (str, none_type,),  # noqa: E501
            'short_name': (str, none_type,),  # noqa: E501
            'type': ([GetSecuritizedDerivativeGetDataTypeItems],),  # noqa: E501
            'is_incomplete': (bool, none_type,),  # noqa: E501
            'life_cycle': (InlineResponse200DataLifeCycle,),  # noqa: E501
            'country_security_registration': ([GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems],),  # noqa: E501
            'reference_debtor': (InlineResponse200DataReferenceDebtor,),  # noqa: E501
            'is_collateralized': (bool, none_type,),  # noqa: E501
            'is_quanto': (bool, none_type,),  # noqa: E501
            'capital_protection': (float, none_type,),  # noqa: E501
            'has_catch_up': (bool, none_type,),  # noqa: E501
            'has_automatic_exercise': (bool, none_type,),  # noqa: E501
            'order_volume': (InlineResponse200DataOrderVolume,),  # noqa: E501
            'redemption_amount': (float, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_private_placement (bool, none_type): If true, the instrument is part of a private placement and therefore not publicly traded.. [optional]  # noqa: E501
            ...
            is_incomplete (bool, none_type): If true, the data supplier has marked the data for this instrument as incomplete.. [optional]  # noqa: E501
            life_cycle (InlineResponse200DataLifeCycle): [optional]  # noqa: E501
            country_security_registration ([GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems]): List of countries where the instrument is registered. See endpoint `/basic/region/country/list` for possible values.. [optional]  # noqa: E501
            reference_debtor (InlineResponse200DataReferenceDebtor): [optional]  # noqa: E501
            is_collateralized (bool, none_type): If true, this instrument is protected against an issuer default by collateral (e.g. COSI collateralization by SIX Swiss Exchange).. [optional]  # noqa: E501
            is_quanto (bool, none_type): If true, the risk of exchange rate fluctuations between the value unit of the underlying (all of them, in case of multiple underlyings) and the value unit of the redemption is hedged.. [optional]  # noqa: E501
            capital_protection (float, none_type): Proportion of the nominal amount protected against loss, usually 100%.. [optional]  # noqa: E501
            has_catch_up (bool, none_type): If true, the instrument has a so-called \"memory feature\" (also called \"catch up\"). This means that a conditional payment that has not been paid out could be paid on a subsequent payment date if the condition is then satisfied.. [optional]  # noqa: E501
            ...
            management_fee (float, none_type): Management fee paid annually by the investor to the issuer of the securitized derivative instrument.. [optional]  # noqa: E501
