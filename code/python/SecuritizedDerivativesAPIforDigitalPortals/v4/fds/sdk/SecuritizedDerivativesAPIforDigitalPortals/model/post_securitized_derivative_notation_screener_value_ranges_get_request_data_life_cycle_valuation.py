...
class PostSecuritizedDerivativeNotationScreenerValueRangesGetRequestDataLifeCycleValuation(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostSecuritizedDerivativeNotationScreenerValueRangesGetRequestDataLifeCycleValuation - a model defined in OpenAPI
