...
class InlineResponse2005DataKeyFiguresBreakEvenBreakEvenPoint(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2005DataKeyFiguresBreakEvenBreakEvenPoint - a model defined in OpenAPI
