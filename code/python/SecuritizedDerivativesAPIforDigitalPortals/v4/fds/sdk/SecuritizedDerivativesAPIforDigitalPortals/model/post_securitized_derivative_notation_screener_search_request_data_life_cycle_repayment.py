...
class PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycleRepayment(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycleRepayment - a model defined in OpenAPI
