...
class GetSecuritizedDerivativeUnderlyingListDataUnderlyingsItemsNotationFsymRegional(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetSecuritizedDerivativeUnderlyingListDataUnderlyingsItemsNotationFsymRegional - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ticker_region (str, none_type): FactSet regional symbol of the notation, consisting of the ticker and the two-character code of the country or region where the listing is traded (example: DAI-DE).. [optional]  # noqa: E501
            is_primary (bool, none_type): Indicates whether the notation is in the primary region of the security (`true`) or not (`false`).. [optional]  # noqa: E501
        """
