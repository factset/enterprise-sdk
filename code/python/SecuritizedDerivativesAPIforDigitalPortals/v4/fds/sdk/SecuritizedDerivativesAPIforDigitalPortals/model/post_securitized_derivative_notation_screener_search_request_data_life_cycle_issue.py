...
class PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycleIssue(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycleIssue - a model defined in OpenAPI
