...
from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals import rest
from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.configuration import Configuration
from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/SecuritizedDerivativesAPIforDigitalPortals/0.40.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SecuritizedDerivativeApi()
        api_instance.get_securitized_derivative_barrier_type_list  # this is an instance of the class Endpoint
        api_instance.get_securitized_derivative_barrier_type_list()  # this invokes api_instance.get_securitized_derivative_barrier_type_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_securitized_derivative_barrier_type_list.callable or self.callable in this class
