...
------------ | ------------- | ------------- | -------------
**effective** | **float, none_type** | Vega calculated using the actual cover ratio of the securitized derivative. | [optional] 
**unadjusted** | **float, none_type** | Vega calculated using a (hypothetical) cover ratio of 1:1. | [optional] 
