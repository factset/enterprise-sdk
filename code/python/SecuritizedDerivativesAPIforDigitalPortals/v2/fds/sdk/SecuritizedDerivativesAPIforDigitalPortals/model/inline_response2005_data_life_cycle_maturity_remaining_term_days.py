...
class InlineResponse2005DataLifeCycleMaturityRemainingTermDays(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2005DataLifeCycleMaturityRemainingTermDays - a model defined in OpenAPI
