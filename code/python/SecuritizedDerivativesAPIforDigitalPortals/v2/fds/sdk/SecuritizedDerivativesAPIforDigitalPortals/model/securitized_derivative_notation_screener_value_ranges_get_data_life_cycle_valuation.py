...
class SecuritizedDerivativeNotationScreenerValueRangesGetDataLifeCycleValuation(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """SecuritizedDerivativeNotationScreenerValueRangesGetDataLifeCycleValuation - a model defined in OpenAPI
