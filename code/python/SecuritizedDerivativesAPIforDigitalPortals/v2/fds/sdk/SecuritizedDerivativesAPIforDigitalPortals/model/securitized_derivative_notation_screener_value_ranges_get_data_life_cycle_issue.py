...
class SecuritizedDerivativeNotationScreenerValueRangesGetDataLifeCycleIssue(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """SecuritizedDerivativeNotationScreenerValueRangesGetDataLifeCycleIssue - a model defined in OpenAPI
