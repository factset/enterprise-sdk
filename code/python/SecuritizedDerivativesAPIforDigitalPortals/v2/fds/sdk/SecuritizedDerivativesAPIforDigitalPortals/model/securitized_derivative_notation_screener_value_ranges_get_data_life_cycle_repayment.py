...
class SecuritizedDerivativeNotationScreenerValueRangesGetDataLifeCycleRepayment(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """SecuritizedDerivativeNotationScreenerValueRangesGetDataLifeCycleRepayment - a model defined in OpenAPI
