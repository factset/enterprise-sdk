...
class SecuritizedDerivativeNotationScreenerSearchMetaPagination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SecuritizedDerivativeNotationScreenerSearchMetaPagination - a model defined in OpenAPI
