...
class SecuritizedDerivativeNotationScreenerValueRangesGetMeta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SecuritizedDerivativeNotationScreenerValueRangesGetMeta - a model defined in OpenAPI
