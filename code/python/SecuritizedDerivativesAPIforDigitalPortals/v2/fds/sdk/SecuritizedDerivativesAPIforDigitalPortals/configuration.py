...
conf = fds.sdk.SecuritizedDerivativesAPIforDigitalPortals.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("fds.sdk.SecuritizedDerivativesAPIforDigitalPortals")
