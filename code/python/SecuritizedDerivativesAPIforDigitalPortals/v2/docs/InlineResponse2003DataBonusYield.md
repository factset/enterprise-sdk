...
------------ | ------------- | ------------- | -------------
**absolute** | **float** | Bonus yield in absolute terms. | [optional] 
**relative** | **float** | Bonus yield relative to the ask price. | [optional] 
**annualized** | **float** | Annualized bonus yield relative to the ask price. | [optional] 
