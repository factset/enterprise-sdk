...
------------ | ------------- | ------------- | -------------
**absolute** | **float** | Maximum yield in absolute terms. | [optional] 
**relative** | **float** | Maximum yield relative to the ask price. | [optional] 
**annualized** | **float** | Annualized maximum yield relative to the ask price. | [optional] 
