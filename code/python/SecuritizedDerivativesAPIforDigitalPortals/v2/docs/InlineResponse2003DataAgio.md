...
------------ | ------------- | ------------- | -------------
**absolute** | **float** | Agio in absolute terms. | [optional] 
**relative** | **float** | Agio relative to the underlying level. | [optional] 
**annualized** | **float** | Annualized agio relative to the underlying level. | [optional] 
