...
------------ | ------------- | ------------- | -------------
**effective** | **float** | Weekly theta calculated using the actual cover ratio of the securitized derivative. | [optional] 
**unadjusted** | **float** | Weekly theta calculated using a (hypothetical) cover ratio of 1:1. | [optional] 
