...
------------ | ------------- | ------------- | -------------
**effective** | **float** | Delta calculated using the actual cover ration of the securitized derivative. | [optional] 
**unadjusted** | **float** | Delta calculated using a (hypothetical) cover ratio of 1:1. | [optional] 
