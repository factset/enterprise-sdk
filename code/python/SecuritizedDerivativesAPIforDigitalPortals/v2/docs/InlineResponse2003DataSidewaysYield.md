...
------------ | ------------- | ------------- | -------------
**absolute** | **float** | Sideways yield in absolute terms. | [optional] 
**relative** | **float** | Sideways yield relative to the ask price. | [optional] 
**annualized** | **float** | Annualized sideways yield relative to the ask price. | [optional] 
