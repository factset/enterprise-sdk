...
------------ | ------------- | ------------- | -------------
**id** | **float** | Identifier of the reference debtor. | [optional] 
**name** | **str** | Name of the reference debtor. | [optional] 
**lei** | **str** | Legal Entity Identifier of the reference debtor. | [optional] 
