...
from fds.sdk.ContentFeedsDataDictionary import rest
from fds.sdk.ContentFeedsDataDictionary.configuration import Configuration
from fds.sdk.ContentFeedsDataDictionary.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ContentFeedsDataDictionary.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ContentFeedsDataDictionary/0.21.15 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.navigator_basic_search_post  # this is an instance of the class Endpoint
        api_instance.navigator_basic_search_post()  # this invokes api_instance.navigator_basic_search_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.navigator_basic_search_post.callable or self.callable in this class
