...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ContentFeedsDataDictionary/0.22.0)](https://pypi.org/project/fds.sdk.ContentFeedsDataDictionary/v/0.22.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.ContentFeedsDataDictionary==0.22.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ContentFeedsDataDictionary==0.22.0
```
