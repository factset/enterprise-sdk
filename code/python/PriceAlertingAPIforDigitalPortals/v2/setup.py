...
setup(
    name=NAME,
    version=VERSION,
    description="Price Alerting API for Digital Portals client library for Python",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/main/code/python/PriceAlertingAPIforDigitalPortals/v2",
