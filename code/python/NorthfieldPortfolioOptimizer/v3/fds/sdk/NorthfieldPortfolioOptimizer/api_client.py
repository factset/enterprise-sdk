...
from fds.sdk.NorthfieldPortfolioOptimizer import rest
from fds.sdk.NorthfieldPortfolioOptimizer.configuration import Configuration
from fds.sdk.NorthfieldPortfolioOptimizer.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.NorthfieldPortfolioOptimizer.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/NorthfieldPortfolioOptimizer/0.21.13 ({platform.system()}, Python {platform.python_version()})'
