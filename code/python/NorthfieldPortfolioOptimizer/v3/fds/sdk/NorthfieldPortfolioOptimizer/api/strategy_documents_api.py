...
class StrategyDocumentsApi(object):
    ...
    def get_northfield_strategy_documents_with_http_info(
        self,
        path="Client:folder1/folder2",
        **kwargs
    ...
    def get_northfield_strategy_documents_async(
        self,
        path="Client:folder1/folder2",
        **kwargs
    ...
    def get_northfield_strategy_documents_with_http_info_async(
        self,
        path="Client:folder1/folder2",
        **kwargs
