# fds.sdk.NorthfieldPortfolioOptimizer.NPOOptimizerApi
...
from fds.sdk.NorthfieldPortfolioOptimizer.api import npo_optimizer_api
...
with fds.sdk.NorthfieldPortfolioOptimizer.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NPOOptimizerApi->cancel_optimization_by_id: %s\n" % e)
```
...
with fds.sdk.NorthfieldPortfolioOptimizer.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response_wrapper = api_instance.post_and_optimize(x_fact_set_api_long_running_deadline=x_fact_set_api_long_running_deadline, cache_control=cache_control, npo_optimization_parameters_root=npo_optimization_parameters_root)
...
with fds.sdk.NorthfieldPortfolioOptimizer.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response_wrapper = api_instance.put_and_optimize(id, x_fact_set_api_long_running_deadline=x_fact_set_api_long_running_deadline, cache_control=cache_control, npo_optimization_parameters_root=npo_optimization_parameters_root)
