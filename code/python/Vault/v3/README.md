...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Vault/2.0.2)](https://pypi.org/project/fds.sdk.Vault/v/2.0.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.Vault==2.0.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Vault==2.0.2
```
