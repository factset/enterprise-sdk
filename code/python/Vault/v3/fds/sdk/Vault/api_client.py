...
from fds.sdk.Vault import rest
from fds.sdk.Vault.configuration import Configuration
from fds.sdk.Vault.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Vault.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/Vault/0.21.10'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ComponentsApi()
        api_instance.get_vault_component_by_id  # this is an instance of the class Endpoint
        api_instance.get_vault_component_by_id()  # this invokes api_instance.get_vault_component_by_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_vault_component_by_id.callable or self.callable in this class
