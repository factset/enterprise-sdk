...
def lazy_import():
    ...
    globals()['DocumentDirectories'] = DocumentDirectories


class DocumentDirectoriesRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """DocumentDirectoriesRoot - a model defined in OpenAPI

        Args:
            data (DocumentDirectories):
