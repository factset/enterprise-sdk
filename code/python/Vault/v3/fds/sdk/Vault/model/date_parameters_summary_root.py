...
def lazy_import():
    ...
    globals()['DateParametersSummary'] = DateParametersSummary


class DateParametersSummaryRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """DateParametersSummaryRoot - a model defined in OpenAPI

        Args:
            data (DateParametersSummary):
