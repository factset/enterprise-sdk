...
def lazy_import():
    ...
    globals()['VaultConfigurationSummary'] = VaultConfigurationSummary


class VaultConfigurationSummaryRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VaultConfigurationSummaryRoot - a model defined in OpenAPI

        Args:
            data ({str: (VaultConfigurationSummary,)}):
