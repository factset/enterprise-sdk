...
def lazy_import():
    ...
    globals()['ComponentSummary'] = ComponentSummary


class ComponentSummaryRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ComponentSummaryRoot - a model defined in OpenAPI

        Args:
            data ({str: (ComponentSummary,)}):
