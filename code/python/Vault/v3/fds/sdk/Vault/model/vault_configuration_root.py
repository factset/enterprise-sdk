...
def lazy_import():
    ...
    globals()['VaultConfiguration'] = VaultConfiguration


class VaultConfigurationRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VaultConfigurationRoot - a model defined in OpenAPI

        Args:
            data (VaultConfiguration):
