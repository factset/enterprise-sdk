...
class ComponentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_vault_component_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (VaultComponentRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_vault_component_by_id_with_http_info(
        ...
        id,
        **kwargs
    ) -> typing.Tuple[VaultComponentRoot, int, typing.MutableMapping]:
        """Get Vault component by id  # noqa: E501
    ...
    def get_vault_component_by_id_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[VaultComponentRoot]":
        """Get Vault component by id  # noqa: E501
    ...
    def get_vault_component_by_id_with_http_info_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[VaultComponentRoot, int, typing.MutableMapping]]":
        """Get Vault component by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(VaultComponentRoot, int, typing.Dict)]
        """
