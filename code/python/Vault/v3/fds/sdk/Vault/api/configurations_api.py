...
class ConfigurationsApi(object):
    ...
    def get_vault_configuration_by_id(
        ...
        **kwargs
        ...
        This endpoint returns details for a Vault configuration as well as a list of accounts it is used in.    The __lockingDate__ parameter in the response can help in identifying if the vault configuration data is locked or unlocked.  # noqa: E501
