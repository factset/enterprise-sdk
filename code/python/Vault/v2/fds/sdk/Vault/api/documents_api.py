...
class DocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_vault_documents_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'endpoint_path': '/analytics/lookups/v2/engines/vault/documents/{path}',
    ...
    def get_vault_documents(
        ...
        **kwargs
        ...
        kwargs['path'] = \
            path
        return self.get_vault_documents_endpoint.call_with_http_info(**kwargs)

    def get_vault_documents_with_http_info(
        self,
        path="Client:folder1/folder2",
        **kwargs
    ...
    def get_vault_documents_with_http_info_async(
        self,
        path="Client:folder1/folder2",
        **kwargs
