...
class DatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.convert_vault_dates_to_absolute_format_endpoint = _Endpoint(
            settings={
                'response_type': (DateParametersSummary,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def convert_vault_dates_to_absolute_format(
        ...
        **kwargs
        ...
        >>> thread = api.convert_vault_dates_to_absolute_format(enddate="-1AY", componentid="7CF4BCEB46020A5D3C78344108905FF73A4937F5E37CFF6BD97EC29545341935", account="Client:Foo/Bar/myaccount.acct", async_req=True)
        >>> result = thread.get()
