...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MarketImpactApi()
        api_instance.get_cost_impact  # this is an instance of the class Endpoint
        api_instance.get_cost_impact()  # this invokes api_instance.get_cost_impact.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_cost_impact.callable or self.callable in this class
