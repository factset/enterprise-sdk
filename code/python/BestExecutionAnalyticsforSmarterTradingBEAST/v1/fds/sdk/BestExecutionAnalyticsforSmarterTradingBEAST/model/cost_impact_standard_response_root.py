...
def lazy_import():
    ...
    globals()['CostImpactStandard'] = CostImpactStandard


class CostImpactStandardResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (CostImpactStandard,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CostImpactStandardResponseRoot - a model defined in OpenAPI

        Args:
            data (CostImpactStandard):
