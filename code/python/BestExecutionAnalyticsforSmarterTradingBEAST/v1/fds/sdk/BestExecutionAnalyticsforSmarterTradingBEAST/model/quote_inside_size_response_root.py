...
def lazy_import():
    ...
    globals()['QuoteInsideSizeResponse'] = QuoteInsideSizeResponse


class QuoteInsideSizeResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (QuoteInsideSizeResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """QuoteInsideSizeResponseRoot - a model defined in OpenAPI

        Args:
            data (QuoteInsideSizeResponse):
