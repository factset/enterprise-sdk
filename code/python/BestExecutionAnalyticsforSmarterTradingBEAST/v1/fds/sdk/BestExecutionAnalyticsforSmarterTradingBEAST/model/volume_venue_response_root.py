...
def lazy_import():
    ...
    globals()['VolumeVenueResponse'] = VolumeVenueResponse


class VolumeVenueResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (VolumeVenueResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VolumeVenueResponseRoot - a model defined in OpenAPI

        Args:
            data (VolumeVenueResponse):
