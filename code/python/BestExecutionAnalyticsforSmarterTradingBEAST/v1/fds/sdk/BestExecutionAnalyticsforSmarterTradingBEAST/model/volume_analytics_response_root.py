...
def lazy_import():
    ...
    globals()['VolumeAnalyticsResponse'] = VolumeAnalyticsResponse


class VolumeAnalyticsResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (VolumeAnalyticsResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VolumeAnalyticsResponseRoot - a model defined in OpenAPI

        Args:
            data (VolumeAnalyticsResponse):
