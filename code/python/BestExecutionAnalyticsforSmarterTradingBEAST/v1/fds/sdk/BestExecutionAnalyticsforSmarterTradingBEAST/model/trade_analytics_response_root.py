...
def lazy_import():
    ...
    globals()['TradeAnalyticsResponse'] = TradeAnalyticsResponse


class TradeAnalyticsResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TradeAnalyticsResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TradeAnalyticsResponseRoot - a model defined in OpenAPI

        Args:
            data (TradeAnalyticsResponse):
