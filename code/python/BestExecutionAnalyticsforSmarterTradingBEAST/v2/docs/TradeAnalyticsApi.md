# fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.TradeAnalyticsApi

All URIs are relative to *https://api.factset.com/analytics/beast/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_trade_analytics**](TradeAnalyticsApi.md#get_trade_analytics) | **GET** /la/trade/trade-analytics | Get Trade Analytics
[**get_volume_analytics**](TradeAnalyticsApi.md#get_volume_analytics) | **GET** /la/trade/volume-analytics | Get Volume Analytics



# **get_trade_analytics**
> TradeAnalyticsResponseRoot get_trade_analytics(start_date, end_date, security_id, region)
...
from fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.api import trade_analytics_api
...
with fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiClient(configuration) as api_client:
    ...
    api_instance = trade_analytics_api.TradeAnalyticsApi(api_client)
    ...
    try:
        ...
        api_response = api_instance.get_trade_analytics(start_date, end_date, security_id, region)

        pprint(api_response)

    except fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiException as e:
        print("Exception when calling TradeAnalyticsApi->get_trade_analytics: %s\n" % e)
```
...
> VolumeAnalyticsResponseRoot get_volume_analytics(start_date, end_date, security_id, region)
...
with fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Volume Analytics
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_volume_analytics(start_date, end_date, security_id, region)

        pprint(api_response)

    except fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiException as e:
        print("Exception when calling TradeAnalyticsApi->get_volume_analytics: %s\n" % e)
```
