# fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ReportsApi

All URIs are relative to *https://api.factset.com/analytics/beast/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_parent_aggregate_analysis**](ReportsApi.md#get_parent_aggregate_analysis) | **GET** /tca/report/parent-aggregate-analysis | Get Parent Aggregate Analysis



# **get_parent_aggregate_analysis**
> ReportResponseRoot get_parent_aggregate_analysis(start_date, end_date)
...
from fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.api import reports_api
...
with fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.get_parent_aggregate_analysis(start_date, end_date)

        pprint(api_response)

    except fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiException as e:
        print("Exception when calling ReportsApi->get_parent_aggregate_analysis: %s\n" % e)
```
