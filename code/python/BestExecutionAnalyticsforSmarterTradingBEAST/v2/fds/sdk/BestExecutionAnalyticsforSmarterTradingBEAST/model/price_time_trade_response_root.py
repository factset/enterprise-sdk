...
def lazy_import():
    ...
    globals()['PriceTimeTradeResponse'] = PriceTimeTradeResponse


class PriceTimeTradeResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PriceTimeTradeResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PriceTimeTradeResponseRoot - a model defined in OpenAPI

        Args:
            data (PriceTimeTradeResponse):
