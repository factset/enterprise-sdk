...
from fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST import rest
from fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.configuration import Configuration
from fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/BestExecutionAnalyticsforSmarterTradingBEAST/0.0.4 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = LiquidityAnalyticsApi()
        api_instance.get_liquidity_analytics  # this is an instance of the class Endpoint
        api_instance.get_liquidity_analytics()  # this invokes api_instance.get_liquidity_analytics.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_liquidity_analytics.callable or self.callable in this class
