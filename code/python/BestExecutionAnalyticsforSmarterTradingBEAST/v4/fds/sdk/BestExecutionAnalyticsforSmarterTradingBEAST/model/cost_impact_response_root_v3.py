...
def lazy_import():
    ...
    globals()['AggregateMarketImpact'] = AggregateMarketImpact


class CostImpactResponseRootV3(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (AggregateMarketImpact,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CostImpactResponseRootV3 - a model defined in OpenAPI

        Args:
            data (AggregateMarketImpact):
