...
def lazy_import():
    ...
    globals()['QuotesAndTradesAnalyticsResponse'] = QuotesAndTradesAnalyticsResponse


class QuotesAnalyticsResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([QuotesAndTradesAnalyticsResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """QuotesAnalyticsResponseRoot - a model defined in OpenAPI

        Args:
            data ([QuotesAndTradesAnalyticsResponse]): List of QuotesAndTradesAnalyticsResponse
