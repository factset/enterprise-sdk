...
def lazy_import():
    ...
    globals()['InvestmentTimingResponse'] = InvestmentTimingResponse


class InvestmentTimingResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (InvestmentTimingResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """InvestmentTimingResponseRoot - a model defined in OpenAPI

        Args:
            data (InvestmentTimingResponse):
