...
def lazy_import():
    ...
    globals()['OutlierResponse'] = OutlierResponse


class OutlierResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (OutlierResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """OutlierResponseRoot - a model defined in OpenAPI
