...
def lazy_import():
    ...
    globals()['IndexETFResponse'] = IndexETFResponse


class IndexETFResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (IndexETFResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """IndexETFResponseRoot - a model defined in OpenAPI

        Args:
            data (IndexETFResponse):
