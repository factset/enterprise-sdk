...
**risk_aversion** | **float** | RiskAversion | [optional] 
**market_impact_status** | **str** | MarketImpactStatus | [optional] 
...
**confidence_interval_bps** | **float** | Confidence Interval Bps | [optional] 
