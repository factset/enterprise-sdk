...
with fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiClient(configuration) as api_client:
    ...
    metric_type = "firstFillMidPerfBps" # str | The benchmark to measure outlier metrics
    ...
    min_percent = 2.5 # float | The winsorization min percentile values defining orders as outliers (optional) if omitted the server will use the default value of 2.5
    max_percent = 97.5 # float | The winsorization max percentile values defining orders as outliers (optional) if omitted the server will use the default value of 97.5
    bin_scalar = 51 # int | number of bins to distribute the orders (optional) if omitted the server will use the default value of 51

    try:
        # Get Outlier Metrics by percentile
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_outlier_metrics_by_percentile(metric_type, start_date, end_date, country=country, trader=trader, min_percent=min_percent, max_percent=max_percent, bin_scalar=bin_scalar)
...
------------- | ------------- | ------------- | -------------
 **metric_type** | **str**| The benchmark to measure outlier metrics |
 ...
 **min_percent** | **float**| The winsorization min percentile values defining orders as outliers | [optional] if omitted the server will use the default value of 2.5
 **max_percent** | **float**| The winsorization max percentile values defining orders as outliers | [optional] if omitted the server will use the default value of 97.5
 **bin_scalar** | **int**| number of bins to distribute the orders | [optional] if omitted the server will use the default value of 51
...
with fds.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.ApiClient(configuration) as api_client:
    ...
    country = "US" # str | The two character ISO country code of the trading region, like US. EMEA is used for the European trading region (optional)
    trader = "trader_example" # str | Optionally specify a trader to filter by, Example : Ryan (optional)
    deviation = 2 # float | The winsorization deviation - standard deviation to define orders as outlier (optional) if omitted the server will use the default value of 2
    bin_scalar = 51 # int | number of bins to distribute the orders (optional) if omitted the server will use the default value of 51
    ...
    try:
        ...
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_outlier_metrics_standard(metric_type, start_date, end_date, country=country, trader=trader, deviation=deviation, bin_scalar=bin_scalar)
 ...
 **country** | **str**| The two character ISO country code of the trading region, like US. EMEA is used for the European trading region | [optional]
 **trader** | **str**| Optionally specify a trader to filter by, Example : Ryan | [optional]
 **deviation** | **float**| The winsorization deviation - standard deviation to define orders as outlier | [optional] if omitted the server will use the default value of 2
 **bin_scalar** | **int**| number of bins to distribute the orders | [optional] if omitted the server will use the default value of 51
