...
def lazy_import():
    ...
    globals()['OrderFillCountResponse'] = OrderFillCountResponse


class OrderFillCountResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (OrderFillCountResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """OrderFillCountResponseRoot - a model defined in OpenAPI

        Args:
            data (OrderFillCountResponse):
