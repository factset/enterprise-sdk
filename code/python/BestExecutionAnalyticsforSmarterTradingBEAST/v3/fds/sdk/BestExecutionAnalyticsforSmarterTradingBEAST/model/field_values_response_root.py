...
def lazy_import():
    ...
    globals()['FieldValuesResponse'] = FieldValuesResponse


class FieldValuesResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([FieldValuesResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """FieldValuesResponseRoot - a model defined in OpenAPI

        Args:
            data ([FieldValuesResponse]): List of Field Values response objects
