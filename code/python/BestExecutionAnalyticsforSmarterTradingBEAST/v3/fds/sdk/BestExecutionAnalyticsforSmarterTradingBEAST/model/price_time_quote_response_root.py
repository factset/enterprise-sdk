...
def lazy_import():
    ...
    globals()['PriceTimeQuoteResponse'] = PriceTimeQuoteResponse


class PriceTimeQuoteResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PriceTimeQuoteResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PriceTimeQuoteResponseRoot - a model defined in OpenAPI

        Args:
            data (PriceTimeQuoteResponse):
