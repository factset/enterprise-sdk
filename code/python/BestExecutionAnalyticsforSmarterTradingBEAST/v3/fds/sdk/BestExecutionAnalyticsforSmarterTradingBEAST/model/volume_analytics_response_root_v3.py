...
def lazy_import():
    ...
    globals()['VolumeAnalyticsResponseV3'] = VolumeAnalyticsResponseV3


class VolumeAnalyticsResponseRootV3(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([VolumeAnalyticsResponseV3],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VolumeAnalyticsResponseRootV3 - a model defined in OpenAPI

        Args:
            data ([VolumeAnalyticsResponseV3]): List of VolumeAnalyticsResponseV3
