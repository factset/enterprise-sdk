...
def lazy_import():
    ...
    globals()['LiquidityAnalyticsResponse'] = LiquidityAnalyticsResponse


class LiquidityAnalyticsResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([LiquidityAnalyticsResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """LiquidityAnalyticsResponseRoot - a model defined in OpenAPI

        Args:
            data ([LiquidityAnalyticsResponse]): List of LiquidityAnalyticsResponse
