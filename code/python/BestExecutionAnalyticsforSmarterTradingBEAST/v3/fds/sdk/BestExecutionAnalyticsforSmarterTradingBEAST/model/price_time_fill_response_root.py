...
def lazy_import():
    ...
    globals()['PriceTimeFillResponse'] = PriceTimeFillResponse


class PriceTimeFillResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PriceTimeFillResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PriceTimeFillResponseRoot - a model defined in OpenAPI

        Args:
            data (PriceTimeFillResponse):
