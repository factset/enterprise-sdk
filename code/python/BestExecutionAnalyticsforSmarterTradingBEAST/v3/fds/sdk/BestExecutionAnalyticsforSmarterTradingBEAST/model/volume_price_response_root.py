...
def lazy_import():
    ...
    globals()['VolumePriceResponse'] = VolumePriceResponse


class VolumePriceResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (VolumePriceResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VolumePriceResponseRoot - a model defined in OpenAPI

        Args:
            data (VolumePriceResponse):
