...
def lazy_import():
    ...
    globals()['OrderInfoResponse'] = OrderInfoResponse


class OrderInfoResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (OrderInfoResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """OrderInfoResponseRoot - a model defined in OpenAPI
