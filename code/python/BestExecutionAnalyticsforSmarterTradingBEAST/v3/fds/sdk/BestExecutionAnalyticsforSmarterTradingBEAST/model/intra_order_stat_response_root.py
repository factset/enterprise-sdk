...
def lazy_import():
    ...
    globals()['IntraOrderStatResponse'] = IntraOrderStatResponse


class IntraOrderStatResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (IntraOrderStatResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """IntraOrderStatResponseRoot - a model defined in OpenAPI

        Args:
            data (IntraOrderStatResponse):
