...
def lazy_import():
    ...
    globals()['VolumeTimeResponse'] = VolumeTimeResponse


class VolumeTimeResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (VolumeTimeResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VolumeTimeResponseRoot - a model defined in OpenAPI

        Args:
            data (VolumeTimeResponse):
