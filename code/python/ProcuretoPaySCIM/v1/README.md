...
# Procure to Pay SCIM client library for Python

[![PyPi](https://img.shields.io/pypi/v/fds.sdk.ProcuretoPaySCIM)](https://pypi.org/project/fds.sdk.ProcuretoPaySCIM/)
...
```shell
poetry add fds.sdk.utils fds.sdk.ProcuretoPaySCIM
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.ProcuretoPaySCIM
```
...
with fds.sdk.ProcuretoPaySCIM.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # Get a group.
    #     api_response, http_status_code, response_headers = api_instance.group_id_get_with_http_info(id)
    #     pprint(api_response)
    ...
    # try:
    #     # Get a group.
    #     async_result = api_instance.group_id_get_async(id)
    ...
    # try:
    #     # Get a group.
    #     async_result = api_instance.group_id_get_with_http_info_async(id)
...
If the OpenAPI document is large, imports in fds.sdk.ProcuretoPaySCIM.apis and fds.sdk.ProcuretoPaySCIM.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from fds.sdk.ProcuretoPaySCIM.api.default_api import DefaultApi`
- `from fds.sdk.ProcuretoPaySCIM.model.pet import Pet`
...
import fds.sdk.ProcuretoPaySCIM
from fds.sdk.ProcuretoPaySCIM.apis import *
from fds.sdk.ProcuretoPaySCIM.models import *
```
