...
from fds.sdk.ProcuretoPaySCIM import rest
from fds.sdk.ProcuretoPaySCIM.configuration import Configuration
from fds.sdk.ProcuretoPaySCIM.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ProcuretoPaySCIM.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/ProcuretoPaySCIM/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.group_id_get  # this is an instance of the class Endpoint
        api_instance.group_id_get()  # this invokes api_instance.group_id_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.group_id_get.callable or self.callable in this class
