...
class ServiceProviderConfigFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, supported, max_results, *args, **kwargs):  # noqa: E501
        """ServiceProviderConfigFilter - a model defined in OpenAPI
