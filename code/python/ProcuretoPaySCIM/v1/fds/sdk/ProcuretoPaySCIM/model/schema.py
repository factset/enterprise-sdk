...
class Schema(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, attributes, *args, **kwargs):  # noqa: E501
        """Schema - a model defined in OpenAPI

        Args:
            id (str): The unique URI of the schema. When applicable, service providers MUST specify the URI.
            name (str): The schema's human-readable name.  When applicable, service providers MUST specify the name, e.g., 'User'.
            attributes ([SchemaAttributes]): A complex attribute that includes the attributes of a schema.
