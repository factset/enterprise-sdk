...
class ServiceProviderConfigChangePassword(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, supported, *args, **kwargs):  # noqa: E501
        """ServiceProviderConfigChangePassword - a model defined in OpenAPI
