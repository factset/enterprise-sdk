...
from fds.sdk.VectorData import rest
from fds.sdk.VectorData.configuration import Configuration
from fds.sdk.VectorData.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.VectorData.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/VectorData/0.20.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_document_types  # this is an instance of the class Endpoint
        api_instance.get_document_types()  # this invokes api_instance.get_document_types.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_document_types.callable or self.callable in this class
