...
def lazy_import():
    ...
    globals()['Meta'] = Meta
    globals()['VectorDataRequestData'] = VectorDataRequestData


class VectorDataRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (VectorDataRequestData,),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """VectorDataRequest - a model defined in OpenAPI
