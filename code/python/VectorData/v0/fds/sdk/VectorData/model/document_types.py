...
class DocumentTypes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, document_type, description, *args, **kwargs):  # noqa: E501
        """DocumentTypes - a model defined in OpenAPI

        Args:
            document_type (str): type of the document
            description (str): document type description
    ...
    @convert_js_args_to_python_args
    def __init__(self, document_type, description, *args, **kwargs):  # noqa: E501
        """DocumentTypes - a model defined in OpenAPI
