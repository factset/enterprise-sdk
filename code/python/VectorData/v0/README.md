...
[![API Version](https://img.shields.io/badge/api-v0.3.0-blue)](https://developer.factset.com/api-catalog/vector-data-api)
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.VectorData/0.0.4)](https://pypi.org/project/fds.sdk.VectorData/v/0.0.4)
...
```shell
poetry add fds.sdk.utils fds.sdk.VectorData==0.0.4
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.VectorData==0.0.4
```
