...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.VectorData/0.20.0)](https://pypi.org/project/fds.sdk.VectorData/v/0.20.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.VectorData==0.20.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.VectorData==0.20.0
```
