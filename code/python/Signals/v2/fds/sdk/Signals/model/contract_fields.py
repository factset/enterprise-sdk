...
class ContractFields(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, summary, event_date, *args, **kwargs):  # noqa: E501
        """ContractFields - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            additional_properties (ContractProperty): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, summary, event_date, *args, **kwargs):  # noqa: E501
        """ContractFields - a model defined in OpenAPI
