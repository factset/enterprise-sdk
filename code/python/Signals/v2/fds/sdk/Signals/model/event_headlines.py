...
def lazy_import():
    ...
    globals()['EventsMeta'] = EventsMeta


class EventHeadlines(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([EventHeadlineDataItem],),  # noqa: E501
            'meta': (EventsMeta,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """EventHeadlines - a model defined in OpenAPI

        Args:
            data ([EventHeadlineDataItem]):
            meta (EventsMeta):
