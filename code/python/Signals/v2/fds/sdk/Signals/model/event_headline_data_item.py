...
class EventHeadlineDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_id, signal_id, signal_name, theme, source, event_id, event_date, summary, user_relevance_score, *args, **kwargs):  # noqa: E501
        """EventHeadlineDataItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            company_name (str): Name of the company reported in signal. Omitted if null.. [optional]  # noqa: E501
            created (datetime): Date/Time in UTC the event was first recorded in our data store.. [optional]  # noqa: E501
        """
        ...
        self.user_relevance_score = user_relevance_score
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, signal_id, signal_name, theme, source, event_id, event_date, summary, user_relevance_score, *args, **kwargs):  # noqa: E501
        """EventHeadlineDataItem - a model defined in OpenAPI
