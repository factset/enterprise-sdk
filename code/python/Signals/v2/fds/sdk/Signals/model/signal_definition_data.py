...
class SignalDefinitionData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, signal_id, theme, categories, contract, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, signal_id, theme, categories, contract, *args, **kwargs):  # noqa: E501
        """SignalDefinitionData - a model defined in OpenAPI
