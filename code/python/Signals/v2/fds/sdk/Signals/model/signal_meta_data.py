...
def lazy_import():
    ...
    globals()['SignalMetaDataData'] = SignalMetaDataData


class SignalMetaData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([SignalMetaDataData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SignalMetaData - a model defined in OpenAPI

        Args:
            data ([SignalMetaDataData]):
