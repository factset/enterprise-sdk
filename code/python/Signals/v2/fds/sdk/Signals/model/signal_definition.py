...
def lazy_import():
    ...
    globals()['SignalDefinitionData'] = SignalDefinitionData


class SignalDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (SignalDefinitionData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SignalDefinition - a model defined in OpenAPI

        Args:
            data (SignalDefinitionData):
