...
def lazy_import():
    ...
    globals()['EventDetailDataItem'] = EventDetailDataItem
    globals()['EventMeta'] = EventMeta


class EventDetail(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (EventDetailDataItem,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """EventDetail - a model defined in OpenAPI

        Args:
            data (EventDetailDataItem):
            meta (EventMeta):
