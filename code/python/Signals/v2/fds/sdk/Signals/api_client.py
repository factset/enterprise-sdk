...
from fds.sdk.Signals import rest
from fds.sdk.Signals.configuration import Configuration
from fds.sdk.Signals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Signals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Signals/1.0.2 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_event_adaptive_card_by_id  # this is an instance of the class Endpoint
        api_instance.get_event_adaptive_card_by_id()  # this invokes api_instance.get_event_adaptive_card_by_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_event_adaptive_card_by_id.callable or self.callable in this class
