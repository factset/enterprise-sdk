...
class MetadataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_categories_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SignalMetaData,), 429: (RateLimitResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_data_dictionary_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SignalDefinition,), 404: (ErrorResponse,), 429: (RateLimitResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/data-dictionary/{signalId}',
                'operation_id': 'get_data_dictionary_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_categories(
        ...
        **kwargs
        ...
        Fetch a list of available signal categories  # noqa: E501
    ...
    def get_categories_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[SignalMetaData, int, typing.MutableMapping]:
        """get_categories  # noqa: E501
    ...
    def get_categories_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SignalMetaData, int, typing.MutableMapping]]":
        """get_categories  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(SignalMetaData, int, typing.Dict)]
        """
    ...
    def get_data_dictionary(
        ...
        **kwargs
        ...
        """get_data_dictionary  # noqa: E501

        Fetch a list of all active signals  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_data_dictionary_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[SignalMetaData, int, typing.MutableMapping]:
        """get_data_dictionary  # noqa: E501
    ...
    def get_data_dictionary_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SignalMetaData, int, typing.MutableMapping]]":
        """get_data_dictionary  # noqa: E501
    ...
    def get_data_dictionary_by_id(
        ...
        **kwargs
        ...
        """get_data_dictionary_by_id  # noqa: E501

        Fetch the metadata and contract for the requested signal  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_data_dictionary_by_id_with_http_info(
        self,
        signal_id,
        **kwargs
    ) -> typing.Tuple[SignalDefinition, int, typing.MutableMapping]:
        """get_data_dictionary_by_id  # noqa: E501
    ...
    def get_data_dictionary_by_id_async(
        self,
        signal_id,
        **kwargs
    ) -> "ApplyResult[SignalDefinition]":
        """get_data_dictionary_by_id  # noqa: E501
    ...
    def get_data_dictionary_by_id_with_http_info_async(
        self,
        signal_id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SignalDefinition, int, typing.MutableMapping]]":
        """get_data_dictionary_by_id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(SignalDefinition, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['signal_id'] = \
            signal_id
    ...
    def get_themes(
        ...
        **kwargs
        ...
        Fetch a list of available signal themes  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
