...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Signals/1.0.2)](https://pypi.org/project/fds.sdk.Signals/v/1.0.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.Signals==1.0.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Signals==1.0.2
```
...
## Documentation For Models
 ...
 - [ContractFieldsEventDate](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Signals/v2/docs/ContractFieldsEventDate.md)
