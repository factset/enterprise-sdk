...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Signals/1.0.1)](https://pypi.org/project/fds.sdk.Signals/v/1.0.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.Signals==1.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Signals==1.0.1
```
