...
from fds.sdk.IRNCustomSymbols import rest
from fds.sdk.IRNCustomSymbols.configuration import Configuration
from fds.sdk.IRNCustomSymbols.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.IRNCustomSymbols.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IRNCustomSymbols/1.0.12 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CustomSymbolsApi()
        api_instance.create_custom_symbol  # this is an instance of the class Endpoint
        api_instance.create_custom_symbol()  # this invokes api_instance.create_custom_symbol.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_custom_symbol.callable or self.callable in this class
