...
from fds.sdk.Classifications import rest
from fds.sdk.Classifications.configuration import Configuration
from fds.sdk.Classifications.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Classifications.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Classifications/1.0.12 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GICSApi()
        api_instance.get_gics  # this is an instance of the class Endpoint
        api_instance.get_gics()  # this invokes api_instance.get_gics.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_gics.callable or self.callable in this class
