...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Classifications/1.0.13)](https://pypi.org/project/fds.sdk.Classifications/v/1.0.13)
...
```shell
poetry add fds.sdk.utils fds.sdk.Classifications==1.0.13
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Classifications==1.0.13
```
