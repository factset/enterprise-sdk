...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Classifications/1.0.14)](https://pypi.org/project/fds.sdk.Classifications/v/1.0.14)
...
```shell
poetry add fds.sdk.utils fds.sdk.Classifications==1.0.14
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Classifications==1.0.14
```
