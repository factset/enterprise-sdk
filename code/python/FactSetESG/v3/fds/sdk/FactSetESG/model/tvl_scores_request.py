...
def lazy_import():
    ...
    globals()['TvlScoresRequestBody'] = TvlScoresRequestBody


class TvlScoresRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TvlScoresRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TvlScoresRequest - a model defined in OpenAPI

        Args:
            data (TvlScoresRequestBody):
