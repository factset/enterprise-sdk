...
def lazy_import():
    ...
    globals()['FieldsTvlSpotlights'] = FieldsTvlSpotlights
    globals()['PaiIds'] = PaiIds
    globals()['TvlSpotlightsCategories'] = TvlSpotlightsCategories


class TvlSpotlightsRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ids': (PaiIds,),  # noqa: E501
            'categories': (TvlSpotlightsCategories,),  # noqa: E501
            'fields': (FieldsTvlSpotlights,),  # noqa: E501
            'start_date': (date,),  # noqa: E501
            'end_date': (date,),  # noqa: E501
            'primary_only': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'primary_only': 'primaryOnly',  # noqa: E501
        'is_removed': 'isRemoved',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """TvlSpotlightsRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            categories (TvlSpotlightsCategories): [optional]  # noqa: E501
            fields (FieldsTvlSpotlights): [optional]  # noqa: E501
            start_date (date): The start date requested for a given date range in YYYY-MM-DD format. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            end_date (date): The end date requested for a given date range in YYYY-MM-DD format. The input end date must be after the input start date. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            primary_only (bool): Return only primary Spotlights when set to true . [optional] if omitted the server will use the default value of True  # noqa: E501
