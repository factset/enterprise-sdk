...
def lazy_import():
    ...
    globals()['TvlArticlesRequestBody'] = TvlArticlesRequestBody


class TvlArticlesRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TvlArticlesRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TvlArticlesRequest - a model defined in OpenAPI

        Args:
            data (TvlArticlesRequestBody):
