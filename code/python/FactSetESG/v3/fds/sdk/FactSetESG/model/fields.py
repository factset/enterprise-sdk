...
class Fields(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'value' in kwargs:
            ...
            value = ["TOPLEVEL","PILLARS","DIMENSIONS","SASBCATEGORIES"]
