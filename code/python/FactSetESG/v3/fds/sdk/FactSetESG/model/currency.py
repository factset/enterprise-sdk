...
class Currency(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Currency code for currency values. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470). . if omitted defaults to "LOCAL"  # noqa: E501

        Keyword Args:
            value (str): Currency code for currency values. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470). . if omitted defaults to "LOCAL"  # noqa: E501
