...
def lazy_import():
    ...
    globals()['TvlSpotlightsRequestBody'] = TvlSpotlightsRequestBody


class TvlSpotlightsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TvlSpotlightsRequestBody,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TvlSpotlightsRequest - a model defined in OpenAPI

        Args:
            data (TvlSpotlightsRequestBody):
