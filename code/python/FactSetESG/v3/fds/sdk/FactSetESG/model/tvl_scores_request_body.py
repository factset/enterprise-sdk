...
def lazy_import():
    ...
    globals()['Ids'] = Ids
    globals()['TvlScoreType'] = TvlScoreType


class TvlScoresRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'ids': (Ids,),  # noqa: E501
            'score_type': (TvlScoreType,),  # noqa: E501
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """TvlScoresRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            score_type (TvlScoreType): [optional]  # noqa: E501
            fields (Fields): [optional]  # noqa: E501
            start_date (date): The start date requested for a given date range in **YYYY-MM-DD** format. Data is available on a Fiscal Annual periodicity, but updated Daily. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            end_date (date): The end date requested for a given date range in **YYYY-MM-DD** format. Data is available on a Fiscal Annual periodicity, but updated Daily. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
