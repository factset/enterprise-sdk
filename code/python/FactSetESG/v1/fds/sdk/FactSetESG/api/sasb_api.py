...
class SASBApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_sasb_ranks_endpoint = _Endpoint(
            settings={
                'response_type': (SasbRanksResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
        ...
        self.get_sasb_scores_endpoint = _Endpoint(
            settings={
                'response_type': (SasbScoresResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
        ...
        self.get_sasb_scores_all_endpoint = _Endpoint(
            settings={
                'response_type': (SasbScoresAllResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def get_sasb_ranks(
        ...
        **kwargs
        ...
        >>> thread = api.get_sasb_ranks(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_sasb_ranks_post(
        ...
        **kwargs
        ...
        >>> thread = api.get_sasb_ranks_post(sasb_ranks_request, async_req=True)
        >>> result = thread.get()
    ...
    def get_sasb_scores(
        ...
        **kwargs
        ...
        >>> thread = api.get_sasb_scores(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_sasb_scores_all(
        ...
        **Retrieves a flat array of all categories for the requested scoreType and ids. Unlike the /sasb-scores endpoint the format of the response returns category names as part of the key value.**<p> Gets values for all categories for the selected score type(s) for the requested identifier(s). FactSet Truvalue Labs SASB Scores provides short-term, long-term, and momentum scores that are generated for 26 ESG categories defined by the Sustainability Accounting Standards Board. ESG Ranks are not supported in this Endpoint.   # noqa: E501
        ...
        >>> thread = api.get_sasb_scores_all(ids, async_req=True)
        >>> result = thread.get()
    ...
    def get_sasb_scores_all_post(
        ...
        **Retrieves a flat array of all categories for the requested scoreType and ids. Unlike the /sasb-scores endpoint the format of the response returns category names as part of the key value.**<p> Gets values for all categories for the selected score type(s) for the requested identifier(s). FactSet Truvalue Labs SASB Scores provides short-term, long-term, and momentum scores that are generated for 26 ESG categories defined by the Sustainability Accounting Standards Board. ESG Ranks are not supported in this Endpoint.   # noqa: E501
        ...
        >>> thread = api.get_sasb_scores_all_post(sasb_scores_all_request, async_req=True)
        >>> result = thread.get()
    ...
    def get_sasb_scores_post(
        ...
        **kwargs
        ...
        >>> thread = api.get_sasb_scores_post(sasb_scores_request, async_req=True)
        >>> result = thread.get()
