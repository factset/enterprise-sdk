...
class SfdrPaiRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """SfdrPaiRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            feelback (bool): This parameter would return the latest PAI data based on the indicators or subtopics requested. The parameter should not be used in conjuction `fiscalPeriodStart` and `fiscalPeriodEnd` . [optional] if omitted the server will use the default value of False  # noqa: E501
            fiscal_period_start (str): Fiscal period start is expressed in YYYY formats. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            fiscal_period_end (str): Fiscal period end is expressed in YYYY formats. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            indicators (Indicators): [optional]  # noqa: E501
