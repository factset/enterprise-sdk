...
class SdgScores(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, fsym_id, request_id, score_type, *args, **kwargs):  # noqa: E501
        """SdgScores - a model defined in OpenAPI

        Args:
            date (date, none_type): Ending date for the period requested expressed in YYYY-MM-DD format.
            fsym_id (str, none_type): FactSet Entity Identifier. Six alpha-numeric characters, excluding vowels, with a -E suffix (XXXXXX-E).
            request_id (str): Identifier that was used for the request.
            score_type (str, none_type): The name of the specific SDG Score type being shown in the response. This will be represented by the scoreTypes input: PULSE, INSIGHT, MOMENTUM, ART_VOL_TTM, CAT_VOL_TTM, or DYNAMIC_MAT.
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, fsym_id, request_id, score_type, *args, **kwargs):  # noqa: E501
        """SdgScores - a model defined in OpenAPI
