...
class SasbRanks(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sasb_rank': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'sasb_category': 'sasbCategory',  # noqa: E501
        'sasb_rank': 'sasbRank',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SasbRanks - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sasb_category (str, none_type): The specific SASB 'category' the Rank is referring to.. [optional]  # noqa: E501
            sasb_rank (str, none_type): The SASB Rank for the given category in Proper format.   |Rank|Industry Percentile Range (%)|   |---|---|   |Leader|90 - 100|   |Above Average|70 - 89.9|   |Average|30 - 69.9|   |Below Average|10 - 29.9|   |Laggard|0 - 9.9| . [optional]  # noqa: E501
        """
