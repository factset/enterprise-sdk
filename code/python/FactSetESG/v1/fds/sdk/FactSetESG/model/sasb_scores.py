...
class SasbScores(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sasb_score': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    attribute_map = {
        ...
        'sasb_score': 'sasbScore',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SasbScores - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sasb_category (str): The specific SASB 'category' the score is referring to.. [optional]  # noqa: E501
            sasb_score ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The SASB Score value for the given 'scoreType' and 'category'. When scoreType = ESG_RANK, the data type will be string, otherwise data type will be a number with double format.. [optional]  # noqa: E501
