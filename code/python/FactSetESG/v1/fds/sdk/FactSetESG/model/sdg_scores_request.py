...
def lazy_import():
    ...
    globals()['SdgCategories'] = SdgCategories
    globals()['SdgFrequency'] = SdgFrequency
    globals()['SdgScoreTypes'] = SdgScoreTypes
    globals()['TvlIds'] = TvlIds


class SdgScoresRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ids': (TvlIds,),  # noqa: E501
            'score_types': (SdgScoreTypes,),  # noqa: E501
            'categories': (SdgCategories,),  # noqa: E501
            'start_date': (str,),  # noqa: E501
            'end_date': (str,),  # noqa: E501
            'frequency': (SdgFrequency,),  # noqa: E501
        }
    ...
    attribute_map = {
        'ids': 'ids',  # noqa: E501
        'score_types': 'scoreTypes',  # noqa: E501
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """SdgScoresRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            score_types (SdgScoreTypes): [optional]  # noqa: E501
            categories (SdgCategories): [optional]  # noqa: E501
            start_date (str): The start date requested for a given date range in YYYY-MM-DD format. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            end_date (str): The end date requested for a given date range in YYYY-MM-DD format. The input end date must be after the input start date. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
            frequency (SdgFrequency): [optional]  # noqa: E501
        """
