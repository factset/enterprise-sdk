...
def lazy_import():
    ...
    globals()['Ids'] = Ids
    globals()['RankCategories'] = RankCategories


class SasbRanksRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'ids': (Ids,),  # noqa: E501
            'categories': (RankCategories,),  # noqa: E501
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """SasbRanksRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            categories (RankCategories): [optional]  # noqa: E501
            ...
            end_date (str): The end date requested for a given date range in **YYYY-MM-DD** format. Data is available on a Fiscal Annual periodicity, but updated Daily. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint. . [optional]  # noqa: E501
