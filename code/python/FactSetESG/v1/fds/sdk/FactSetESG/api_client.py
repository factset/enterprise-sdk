...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FactSetESG/0.20.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SASBApi()
        api_instance.get_sasb_ranks  # this is an instance of the class Endpoint
        api_instance.get_sasb_ranks()  # this invokes api_instance.get_sasb_ranks.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_sasb_ranks.callable or self.callable in this class
