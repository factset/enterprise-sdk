...
from fds.sdk.FactSetESG import rest
from fds.sdk.FactSetESG.configuration import Configuration
from fds.sdk.FactSetESG.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetESG.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetESG/1.3.5 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ArticlesApi()
        api_instance.get_sasb_articles  # this is an instance of the class Endpoint
        api_instance.get_sasb_articles()  # this invokes api_instance.get_sasb_articles.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_sasb_articles.callable or self.callable in this class
