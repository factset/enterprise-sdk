...
with fds.sdk.FactSetESG.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets ESG Rankings for a requested list of ids and dates.
        api_response = api_instance.get_sasb_ranks(ids)
        pprint(api_response)
...
with fds.sdk.FactSetESG.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets short-term, long-term, and momentum scores based on the 26 ESG categories defined by the Sustainability Accounting Standards Board (SASB).
        api_response = api_instance.get_sasb_scores(ids)
        pprint(api_response)
    except fds.sdk.FactSetESG.ApiException as e:
    ...
    try:
        # Gets short-term, long-term, and momentum scores based on the 26 ESG categories defined by the Sustainability Accounting Standards Board (SASB).
        api_response = api_instance.get_sasb_scores(ids, score_types=score_types, categories=categories, start_date=start_date, end_date=end_date, frequency=frequency)
        pprint(api_response)
    except fds.sdk.FactSetESG.ApiException as e:
        print("Exception when calling SASBApi->get_sasb_scores: %s\n" % e)
```
...
with fds.sdk.FactSetESG.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets a flat key value array of scores for named categories of the input scoreType(s).
        api_response = api_instance.get_sasb_scores_all(ids)
        pprint(api_response)
    except fds.sdk.FactSetESG.ApiException as e:
    ...
    try:
        # Gets a flat key value array of scores for named categories of the input scoreType(s).
        api_response = api_instance.get_sasb_scores_all(ids, score_types=score_types, start_date=start_date, end_date=end_date, frequency=frequency)
        pprint(api_response)
    except fds.sdk.FactSetESG.ApiException as e:
        print("Exception when calling SASBApi->get_sasb_scores_all: %s\n" % e)
```
