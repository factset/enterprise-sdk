...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetESG/1.3.6)](https://pypi.org/project/fds.sdk.FactSetESG/v/1.3.6)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetESG==1.3.6
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetESG==1.3.6
```
