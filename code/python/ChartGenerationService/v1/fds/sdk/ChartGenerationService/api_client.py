...
from fds.sdk.ChartGenerationService import rest
from fds.sdk.ChartGenerationService.configuration import Configuration
from fds.sdk.ChartGenerationService.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ChartGenerationService.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/ChartGenerationService/0.21.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ChartTemplatesApi()
        api_instance.get_category_list  # this is an instance of the class Endpoint
        api_instance.get_category_list()  # this invokes api_instance.get_category_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_category_list.callable or self.callable in this class
