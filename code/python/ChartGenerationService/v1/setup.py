...
setup(
    name=NAME,
    version=VERSION,
    description="Chart Generation Service client library for Python",
    author="FactSet Research Systems",
    url="https://github.com/FactSet/enterprise-sdk/tree/main/code/python/ChartGenerationService/v1",
