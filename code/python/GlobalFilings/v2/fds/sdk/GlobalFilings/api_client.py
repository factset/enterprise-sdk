...
from fds.sdk.GlobalFilings import rest
from fds.sdk.GlobalFilings.configuration import Configuration
from fds.sdk.GlobalFilings.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.GlobalFilings.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/GlobalFilings/2.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FilingsAPIApi()
        api_instance.get_count  # this is an instance of the class Endpoint
        api_instance.get_count()  # this invokes api_instance.get_count.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_count.callable or self.callable in this class
