...
class FilingsAPIApi(object):
    ...
    def get_filings(
        ...
        **kwargs
        ...
        Returns the filings documents within FactSet coverage along with other response fields. Upon request, this endpoint can fetch up to 10,000 documents.   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
