...
[![API Version](https://img.shields.io/badge/api-v2.2.2-blue)](https://developer.factset.com/api-catalog/global-filings-api)
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.GlobalFilings/3.1.0)](https://pypi.org/project/fds.sdk.GlobalFilings/v/3.1.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.GlobalFilings==3.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.GlobalFilings==3.1.0
```
