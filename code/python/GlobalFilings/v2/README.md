...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.GlobalFilings/2.0.0)](https://pypi.org/project/fds.sdk.GlobalFilings/v/2.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.GlobalFilings==2.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.GlobalFilings==2.0.0
```
...
with fds.sdk.GlobalFilings.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # Returns the count of filings for specified source.
    #     api_response, http_status_code, response_headers = api_instance.get_count_with_http_info(ids, sources, start_date=start_date, end_date=end_date)
    ...
    # try:
    #     # Returns the count of filings for specified source.
    #     async_result = api_instance.get_count_async(ids, sources, start_date=start_date, end_date=end_date)
    ...
    # try:
    #     # Returns the count of filings for specified source.
    #     async_result = api_instance.get_count_with_http_info_async(ids, sources, start_date=start_date, end_date=end_date)
