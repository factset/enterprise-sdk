...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.GlobalFilings/0.1.6)](https://pypi.org/project/fds.sdk.GlobalFilings/v/0.1.6)
...
```shell
poetry add fds.sdk.utils fds.sdk.GlobalFilings==0.1.6
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.GlobalFilings==0.1.6
```
...
## Documentation For Models
 ...
 - [ErrorExample](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/GlobalFilings/v0/docs/ErrorExample.md)
