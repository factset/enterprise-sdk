...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.GlobalFilings/1.0.5)](https://pypi.org/project/fds.sdk.GlobalFilings/v/1.0.5)
...
```shell
poetry add fds.sdk.utils fds.sdk.GlobalFilings==1.0.5
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.GlobalFilings==1.0.5
```
