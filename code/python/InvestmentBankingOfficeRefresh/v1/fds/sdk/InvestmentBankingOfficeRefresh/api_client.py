...
from fds.sdk.InvestmentBankingOfficeRefresh import rest
from fds.sdk.InvestmentBankingOfficeRefresh.configuration import Configuration
from fds.sdk.InvestmentBankingOfficeRefresh.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.InvestmentBankingOfficeRefresh.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/InvestmentBankingOfficeRefresh/1.1.2 ({platform.system()}, Python {platform.python_version()})'
