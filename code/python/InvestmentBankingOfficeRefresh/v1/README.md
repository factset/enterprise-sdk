...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.InvestmentBankingOfficeRefresh/1.1.2)](https://pypi.org/project/fds.sdk.InvestmentBankingOfficeRefresh/v/1.1.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.InvestmentBankingOfficeRefresh==1.1.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.InvestmentBankingOfficeRefresh==1.1.2
```
