...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.InvestmentBankingOfficeRefresh/2.0.0)](https://pypi.org/project/fds.sdk.InvestmentBankingOfficeRefresh/v/2.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.InvestmentBankingOfficeRefresh==2.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.InvestmentBankingOfficeRefresh==2.0.0
```
