...
```shell
poetry add fds.sdk.utils fds.sdk.InvestmentBankingOfficeRefresh==0.20.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.InvestmentBankingOfficeRefresh==0.20.0
```
...
with fds.sdk.InvestmentBankingOfficeRefresh.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # Retrieve a calculated file by resource ID.
    #     api_response_wrapper, http_status_code, response_headers = api_instance.get_file_by_id_with_http_info(id, output_file_name=output_file_name)
    ...
    # try:
    #     # Retrieve a calculated file by resource ID.
    #     async_result = api_instance.get_file_by_id_async(id, output_file_name=output_file_name)
    ...
    # try:
    #     # Retrieve a calculated file by resource ID.
    #     async_result = api_instance.get_file_by_id_with_http_info_async(id, output_file_name=output_file_name)
