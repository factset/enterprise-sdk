...
from fds.sdk.IRNNotes import rest
from fds.sdk.IRNNotes.configuration import Configuration
from fds.sdk.IRNNotes.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.IRNNotes.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IRNNotes/4.0.2 ({platform.system()}, Python {platform.python_version()})'
