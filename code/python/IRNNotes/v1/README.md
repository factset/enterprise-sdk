...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.IRNNotes/5.0.0)](https://pypi.org/project/fds.sdk.IRNNotes/v/5.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.IRNNotes==5.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.IRNNotes==5.0.0
```
