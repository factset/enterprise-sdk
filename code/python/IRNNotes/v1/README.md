...
```shell
poetry add fds.sdk.utils fds.sdk.IRNNotes==1.2.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.IRNNotes==1.2.0
```
...
## Documentation For Models
 ...
 - [AttachmentStatus](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/IRNNotes/v1/docs/AttachmentStatus.md)
