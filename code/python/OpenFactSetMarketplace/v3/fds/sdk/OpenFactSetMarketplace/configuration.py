...
conf = fds.sdk.OpenFactSetMarketplace.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.factset.com/ofs/v3" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("fds.sdk.OpenFactSetMarketplace")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.factset.com/ofs/v3",
