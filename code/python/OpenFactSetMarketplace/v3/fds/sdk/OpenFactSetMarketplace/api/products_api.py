...
class ProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_product_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ProductSuccessResponse,), 401: (str,), 403: (str,), 404: (ErrorResponse,), 429: (str,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_products_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (ProductsSuccessResponse,), 401: (str,), 403: (str,), 429: (str,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_product_by_id(
        ...
        **kwargs
        ...
        Get a single Open:FactSet Marketplace Catalog product by ID.  # noqa: E501
    ...
    def get_product_by_id_with_http_info(
        ...
        id,
        **kwargs
    ) -> typing.Tuple[ProductSuccessResponse, int, typing.MutableMapping]:
        """get_product_by_id  # noqa: E501
    ...
    def get_product_by_id_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[ProductSuccessResponse]":
        """get_product_by_id  # noqa: E501
    ...
    def get_product_by_id_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[ProductSuccessResponse, int, typing.MutableMapping]]":
        """get_product_by_id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(ProductSuccessResponse, int, typing.Dict)]
        """
    ...
    def get_products(
        ...
        **kwargs
        ...
        Get all products published on the Open:FactSet Marketplace Catalog.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
    ...
    def get_products_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[ProductsSuccessResponse, int, typing.MutableMapping]:
        """get_products  # noqa: E501
    ...
    def get_products_async(
        self,
        **kwargs
    ) -> "ApplyResult[ProductsSuccessResponse]":
        """get_products  # noqa: E501
    ...
    def get_products_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[ProductsSuccessResponse, int, typing.MutableMapping]]":
        """get_products  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(ProductsSuccessResponse, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.get_products_endpoint.call_with_http_info(**kwargs)
