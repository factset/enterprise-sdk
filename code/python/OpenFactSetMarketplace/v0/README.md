...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.OpenFactSetMarketplace/0.0.1)](https://pypi.org/project/fds.sdk.OpenFactSetMarketplace/v/0.0.1)
...
```shell
poetry add fds.sdk.utils fds.sdk.OpenFactSetMarketplace==0.0.1
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.OpenFactSetMarketplace==0.0.1
```
