...
class RelatedProducts(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, product_page_url, title, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, product_page_url, title, *args, **kwargs):  # noqa: E501
        """RelatedProducts - a model defined in OpenAPI
