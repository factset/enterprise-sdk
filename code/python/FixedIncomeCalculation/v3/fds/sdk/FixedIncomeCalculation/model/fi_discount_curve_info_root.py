...
def lazy_import():
    ...
    globals()['FIDiscountCurveInfo'] = FIDiscountCurveInfo


class FIDiscountCurveInfoRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ({str: (FIDiscountCurveInfo,)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """FIDiscountCurveInfoRoot - a model defined in OpenAPI

        Args:
            data ({str: (FIDiscountCurveInfo,)}):
