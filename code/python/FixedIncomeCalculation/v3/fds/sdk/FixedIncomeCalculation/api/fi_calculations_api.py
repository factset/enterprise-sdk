...
class PostAndCalculateResponseWrapper:
    ...
    def get_response_201(self) -> ObjectRoot:
        ...
        Returns: Expected response if calculation is completed in a short span, returns JSON in the format specified in the Calculation parameters.
        """
...
class FICalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_calculation_parameters_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FICalculationParametersRoot,), 400: (ClientErrorResponse,), 404: (ClientErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_calculation_result_endpoint = _Endpoint(
            settings={
                'response_type': (
                ...
                'endpoint_path': '/calculations/{id}/result',
    ...
    def get_calculation_parameters_with_http_info(
        ...
        id,
        **kwargs
    ) -> typing.Tuple[FICalculationParametersRoot, int, typing.MutableMapping]:
        """Get FI calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[FICalculationParametersRoot]":
        """Get FI calculation parameters by id  # noqa: E501
    ...
    def get_calculation_parameters_with_http_info_async(
        ...
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[FICalculationParametersRoot, int, typing.MutableMapping]]":
        """Get FI calculation parameters by id  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(FICalculationParametersRoot, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['id'] = \
            id
    ...
    def get_calculation_result(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_calculation_result_endpoint.call_with_http_info(**kwargs)

    def get_calculation_result_with_http_info(
        self,
        id,
        **kwargs
    ...
    def get_calculation_result_async(
        self,
        id,
        **kwargs
    ...
    def get_calculation_result_with_http_info_async(
        self,
        id,
        **kwargs
