...
from fds.sdk.FixedIncomeCalculation import rest
from fds.sdk.FixedIncomeCalculation.configuration import Configuration
from fds.sdk.FixedIncomeCalculation.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FixedIncomeCalculation.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FixedIncomeCalculation/0.8.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FICalculationsApi()
        api_instance.cancel_fi_calculation_by_id  # this is an instance of the class Endpoint
        api_instance.cancel_fi_calculation_by_id()  # this invokes api_instance.cancel_fi_calculation_by_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_fi_calculation_by_id.callable or self.callable in this class
