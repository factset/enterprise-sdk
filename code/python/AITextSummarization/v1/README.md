...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**get_result_v1_result_result_id**](docs/DefaultApi.md#get_result_v1_result_result_id) | **GET** /v1/result/{result_id} | GET request that returns the full headline and summary results from the initial POST requests
*DefaultApi* | [**post_headline_and_summary_v1_headline_and_summary**](docs/DefaultApi.md#post_headline_and_summary_v1_headline_and_summary) | **POST** /v1/headline-and-summary | POST request to create a 2-3 sentence summary from input text
*DefaultApi* | [**post_headline_v1_headline**](docs/DefaultApi.md#post_headline_v1_headline) | **POST** /v1/headline | POST request to create a headline from input text
*DefaultApi* | [**post_summary_v1_summary**](docs/DefaultApi.md#post_summary_v1_summary) | **POST** /v1/summary | POST request to create a headline and summary from input text
