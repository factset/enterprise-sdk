...
from fds.sdk.AITextSummarization import rest
from fds.sdk.AITextSummarization.configuration import Configuration
from fds.sdk.AITextSummarization.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.AITextSummarization.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/AITextSummarization/0.21.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_result_v1_result_result_id  # this is an instance of the class Endpoint
        api_instance.get_result_v1_result_result_id()  # this invokes api_instance.get_result_v1_result_result_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_result_v1_result_result_id.callable or self.callable in this class
