...
from fds.sdk.OffPlatformIntegrations import rest
from fds.sdk.OffPlatformIntegrations.configuration import Configuration
from fds.sdk.OffPlatformIntegrations.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OffPlatformIntegrations.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OffPlatformIntegrations/0.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CheckCACCESSApi()
        api_instance.check_caccess  # this is an instance of the class Endpoint
        api_instance.check_caccess()  # this invokes api_instance.check_caccess.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.check_caccess.callable or self.callable in this class
