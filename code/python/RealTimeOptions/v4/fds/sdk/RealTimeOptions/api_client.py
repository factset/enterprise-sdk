...
from fds.sdk.RealTimeOptions import rest
from fds.sdk.RealTimeOptions.configuration import Configuration
from fds.sdk.RealTimeOptions.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.RealTimeOptions.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/RealTimeOptions/0.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = OptionApi()
        api_instance.get_option_get  # this is an instance of the class Endpoint
        api_instance.get_option_get()  # this invokes api_instance.get_option_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_option_get.callable or self.callable in this class
