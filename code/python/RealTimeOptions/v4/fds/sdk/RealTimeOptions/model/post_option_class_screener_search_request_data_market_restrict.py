...
class PostOptionClassScreenerSearchRequestDataMarketRestrict(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionClassScreenerSearchRequestDataMarketRestrict - a model defined in OpenAPI
