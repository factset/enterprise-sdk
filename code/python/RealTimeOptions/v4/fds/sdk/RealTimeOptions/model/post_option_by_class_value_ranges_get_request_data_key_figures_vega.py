...
class PostOptionByClassValueRangesGetRequestDataKeyFiguresVega(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetRequestDataKeyFiguresVega - a model defined in OpenAPI
