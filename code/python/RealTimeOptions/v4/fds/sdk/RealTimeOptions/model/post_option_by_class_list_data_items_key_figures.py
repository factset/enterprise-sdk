...
class PostOptionByClassListDataItemsKeyFigures(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListDataItemsKeyFigures - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            omega (float, none_type): Ask-based omega. It represents delta (see attribute delta) multiplied with the leverage (see attribute `leverage`), both calculated based on the ask price of the option. Omega indicates the elasticity of the option's price regarding the underlying level.. [optional]  # noqa: E501
