...
class PostOptionByClassListRequestDataKeyFiguresOmegaMinimum(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListRequestDataKeyFiguresOmegaMinimum - a model defined in OpenAPI
