...
class PostOptionClassScreenerSearchRequestDataUnderlyingNotation(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionClassScreenerSearchRequestDataUnderlyingNotation - a model defined in OpenAPI
