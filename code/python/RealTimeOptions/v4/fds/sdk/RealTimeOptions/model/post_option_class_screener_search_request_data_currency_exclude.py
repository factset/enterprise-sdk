...
class PostOptionClassScreenerSearchRequestDataCurrencyExclude(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionClassScreenerSearchRequestDataCurrencyExclude - a model defined in OpenAPI
