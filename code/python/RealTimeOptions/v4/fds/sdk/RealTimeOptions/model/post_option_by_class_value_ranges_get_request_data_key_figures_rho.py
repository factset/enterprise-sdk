...
class PostOptionByClassValueRangesGetRequestDataKeyFiguresRho(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetRequestDataKeyFiguresRho - a model defined in OpenAPI
