...
class PostOptionClassScreenerSearchRequestDataCategoryRestrict(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionClassScreenerSearchRequestDataCategoryRestrict - a model defined in OpenAPI
