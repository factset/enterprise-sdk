...
class PostOptionByClassListRequestDataKeyFiguresGammaMinimum(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListRequestDataKeyFiguresGammaMinimum - a model defined in OpenAPI
