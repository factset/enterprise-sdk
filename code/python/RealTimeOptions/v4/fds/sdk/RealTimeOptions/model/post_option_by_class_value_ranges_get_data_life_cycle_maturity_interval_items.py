...
class PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (str, none_type): Attribute value. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  . [optional]  # noqa: E501
