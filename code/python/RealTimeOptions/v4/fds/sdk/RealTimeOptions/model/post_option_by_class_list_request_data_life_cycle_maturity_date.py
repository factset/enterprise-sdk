...
class PostOptionByClassListRequestDataLifeCycleMaturityDate(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListRequestDataLifeCycleMaturityDate - a model defined in OpenAPI
