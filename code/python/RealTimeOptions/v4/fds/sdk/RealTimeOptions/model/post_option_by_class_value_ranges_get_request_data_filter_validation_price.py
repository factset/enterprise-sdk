...
def lazy_import():
    ...
    globals()['PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest'] = PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest
    globals()['PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious'] = PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious


class PostOptionByClassValueRangesGetRequestDataFilterValidationPrice(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'latest': (PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest,),  # noqa: E501
            'previous': (PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetRequestDataFilterValidationPrice - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            quality (str): Quality of the price. | Value | Description | | --- | --- | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours or days. |  . [optional]  # noqa: E501
            latest (PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest): [optional]  # noqa: E501
            previous (PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious): [optional]  # noqa: E501
        """
