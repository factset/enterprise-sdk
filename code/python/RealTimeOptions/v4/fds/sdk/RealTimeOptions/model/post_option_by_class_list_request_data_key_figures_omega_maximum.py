...
class PostOptionByClassListRequestDataKeyFiguresOmegaMaximum(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListRequestDataKeyFiguresOmegaMaximum - a model defined in OpenAPI
