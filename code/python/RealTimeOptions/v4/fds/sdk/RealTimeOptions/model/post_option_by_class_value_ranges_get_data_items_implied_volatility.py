...
class PostOptionByClassValueRangesGetDataItemsImpliedVolatility(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetDataItemsImpliedVolatility - a model defined in OpenAPI
