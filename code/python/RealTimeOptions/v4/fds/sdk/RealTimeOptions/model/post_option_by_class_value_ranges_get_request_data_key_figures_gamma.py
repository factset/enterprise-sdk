...
class PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma - a model defined in OpenAPI
