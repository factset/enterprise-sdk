...
class PostOptionByClassListDataItemsInstrumentExercise(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListDataItemsInstrumentExercise - a model defined in OpenAPI
