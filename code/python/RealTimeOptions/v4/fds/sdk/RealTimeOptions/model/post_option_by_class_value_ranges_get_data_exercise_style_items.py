...
class PostOptionByClassValueRangesGetDataExerciseStyleItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetDataExerciseStyleItems - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (str, none_type): undefined | Value | Description | | --- | --- | | american | An American-style option can be exercised anytime during its life. | | european | A European-style option can be exercised at the end of its life. |  . [optional]  # noqa: E501
