...
class PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega - a model defined in OpenAPI
