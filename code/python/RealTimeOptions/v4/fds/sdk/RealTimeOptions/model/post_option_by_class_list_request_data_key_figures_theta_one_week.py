...
class PostOptionByClassListRequestDataKeyFiguresThetaOneWeek(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListRequestDataKeyFiguresThetaOneWeek - a model defined in OpenAPI
