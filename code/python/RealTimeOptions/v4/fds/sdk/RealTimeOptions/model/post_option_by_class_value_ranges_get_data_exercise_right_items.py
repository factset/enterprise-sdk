...
class PostOptionByClassValueRangesGetDataExerciseRightItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetDataExerciseRightItems - a model defined in OpenAPI
