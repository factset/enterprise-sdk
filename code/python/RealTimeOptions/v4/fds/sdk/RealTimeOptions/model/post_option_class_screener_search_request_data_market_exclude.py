...
class PostOptionClassScreenerSearchRequestDataMarketExclude(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionClassScreenerSearchRequestDataMarketExclude - a model defined in OpenAPI
