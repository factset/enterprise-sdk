...
class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate - a model defined in OpenAPI
