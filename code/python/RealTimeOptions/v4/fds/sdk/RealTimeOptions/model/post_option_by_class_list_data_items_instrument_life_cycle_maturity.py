...
class PostOptionByClassListDataItemsInstrumentLifeCycleMaturity(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostOptionByClassListDataItemsInstrumentLifeCycleMaturity - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            date (date, none_type): Date of the option's maturity.. [optional]  # noqa: E501
            interval (str, none_type): Maturity interval of the option. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  . [optional]  # noqa: E501
        """
