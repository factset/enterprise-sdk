...
class OptimizationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_axioma_optimization_by_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/axp/v1/optimizations/{id}',
                'operation_id': 'cancel_axioma_optimization_by_id',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_axioma_optimization_by_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/axp/v1/optimizations/{id}',
                'operation_id': 'get_axioma_optimization_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.run_axioma_optimization_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/axp/v1/optimizations',
                'operation_id': 'run_axioma_optimization',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'axioma_equity_optimization_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def cancel_axioma_optimization_by_id_with_http_info(
        self,
        id,
        **kwargs
    ...
    def cancel_axioma_optimization_by_id_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[None]":
    ...
    def cancel_axioma_optimization_by_id_with_http_info_async(
        self,
        id,
        **kwargs
    ...
    def get_axioma_optimization_by_id_with_http_info(
        self,
        id,
        **kwargs
    ) -> typing.Tuple[None, int, typing.MutableMapping]:
    ...
    def get_axioma_optimization_by_id_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[None]":
    ...
    def get_axioma_optimization_by_id_with_http_info_async(
        self,
        id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[None, int, typing.MutableMapping]]":
    ...
    def run_axioma_optimization(
        ...
        **kwargs
        ...
        Keyword Args:
            axioma_equity_optimization_parameters (AxiomaEquityOptimizationParameters): [optional]
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
                Default is True.
            _request_timeout (int/float/tuple): timeout setting for this request. If
    ...
    def run_axioma_optimization_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[None, int, typing.MutableMapping]:
        """Run Axioma optimization  # noqa: E501
    ...
    def run_axioma_optimization_async(
        self,
        **kwargs
    ) -> "ApplyResult[None]":
        """Run Axioma optimization  # noqa: E501
    ...
    def run_axioma_optimization_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[None, int, typing.MutableMapping]]":
        """Run Axioma optimization  # noqa: E501
