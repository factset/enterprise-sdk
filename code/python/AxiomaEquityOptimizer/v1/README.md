...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.AxiomaEquityOptimizer/0.9.0)](https://pypi.org/project/fds.sdk.AxiomaEquityOptimizer/v/0.9.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.AxiomaEquityOptimizer==0.9.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.AxiomaEquityOptimizer==0.9.0
```
