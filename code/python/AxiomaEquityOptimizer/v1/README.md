...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.AxiomaEquityOptimizer/0.8.16)](https://pypi.org/project/fds.sdk.AxiomaEquityOptimizer/v/0.8.16)
...
```shell
poetry add fds.sdk.utils fds.sdk.AxiomaEquityOptimizer==0.8.16
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.AxiomaEquityOptimizer==0.8.16
```
