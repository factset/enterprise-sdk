# fds.sdk.AxiomaEquityOptimizer.AXPOptimizerApi

All URIs are relative to *https://api.factset.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancel_optimization_by_id**](AXPOptimizerApi.md#cancel_optimization_by_id) | **DELETE** /analytics/engines/axp/v3/optimizations/{id} | Cancel Axioma optimization by id
[**get_optimization_parameters**](AXPOptimizerApi.md#get_optimization_parameters) | **GET** /analytics/engines/axp/v3/optimizations/{id} | Get Axioma optimization parameters by id
[**get_optimization_result**](AXPOptimizerApi.md#get_optimization_result) | **GET** /analytics/engines/axp/v3/optimizations/{id}/result | Get Axioma optimization result by id
[**get_optimization_status_by_id**](AXPOptimizerApi.md#get_optimization_status_by_id) | **GET** /analytics/engines/axp/v3/optimizations/{id}/status | Get Axioma optimization status by id
[**post_and_optimize**](AXPOptimizerApi.md#post_and_optimize) | **POST** /analytics/engines/axp/v3/optimizations | Create and Run Axioma optimization
[**put_and_optimize**](AXPOptimizerApi.md#put_and_optimize) | **PUT** /analytics/engines/axp/v3/optimizations/{id} | Create or Update Axioma optimization and run it.
 ...
 **axioma_equity_optimization_parameters_root** | [**AxiomaEquityOptimizationParametersRoot**](AxiomaEquityOptimizationParametersRoot.md)| Calculation Parameters | [optional]
