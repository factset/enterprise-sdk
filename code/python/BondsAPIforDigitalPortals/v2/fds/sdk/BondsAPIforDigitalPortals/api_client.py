...
from fds.sdk.BondsAPIforDigitalPortals import rest
from fds.sdk.BondsAPIforDigitalPortals.configuration import Configuration
from fds.sdk.BondsAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.BondsAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/BondsAPIforDigitalPortals/0.10.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DebtInstrumentApi()
        api_instance.get_debt_instrument_get  # this is an instance of the class Endpoint
        api_instance.get_debt_instrument_get()  # this invokes api_instance.get_debt_instrument_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_debt_instrument_get.callable or self.callable in this class
