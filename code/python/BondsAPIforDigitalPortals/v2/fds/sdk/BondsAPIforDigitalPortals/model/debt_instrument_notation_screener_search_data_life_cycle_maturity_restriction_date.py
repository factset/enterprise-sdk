...
class DebtInstrumentNotationScreenerSearchDataLifeCycleMaturityRestrictionDate(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """DebtInstrumentNotationScreenerSearchDataLifeCycleMaturityRestrictionDate - a model defined in OpenAPI
