...
class DebtInstrumentNotationScreenerSearchDataRatingGradeMinimum(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DebtInstrumentNotationScreenerSearchDataRatingGradeMinimum - a model defined in OpenAPI
