...
class DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum - a model defined in OpenAPI
