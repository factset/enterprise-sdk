...
class DebtInstrumentNotationScreenerSearchDataLifeCycleIssue(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """DebtInstrumentNotationScreenerSearchDataLifeCycleIssue - a model defined in OpenAPI
