...
class InlineResponse2004DataLifeCycleMaturityRemainingTermYears(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2004DataLifeCycleMaturityRemainingTermYears - a model defined in OpenAPI
