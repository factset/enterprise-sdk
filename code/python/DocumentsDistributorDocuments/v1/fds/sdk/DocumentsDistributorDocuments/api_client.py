...
from fds.sdk.DocumentsDistributorDocuments import rest
from fds.sdk.DocumentsDistributorDocuments.configuration import Configuration
from fds.sdk.DocumentsDistributorDocuments.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.DocumentsDistributorDocuments.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/DocumentsDistributorDocuments/0.21.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GlobalFilingsAPIApi()
        api_instance.global_filings_v1_list_files_get  # this is an instance of the class Endpoint
        api_instance.global_filings_v1_list_files_get()  # this invokes api_instance.global_filings_v1_list_files_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.global_filings_v1_list_files_get.callable or self.callable in this class
