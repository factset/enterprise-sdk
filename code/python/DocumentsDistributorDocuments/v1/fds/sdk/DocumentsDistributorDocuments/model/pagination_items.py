...
class PaginationItems(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PaginationItems - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            offset (int): The flag indicating the position in the results array if additional results are available beyond the default value or the value in paginationLimit parameter (if used). Thiis value is passed in the _paginationOffset parameter to retreieve subsequent results. [optional]  # noqa: E501
        """
