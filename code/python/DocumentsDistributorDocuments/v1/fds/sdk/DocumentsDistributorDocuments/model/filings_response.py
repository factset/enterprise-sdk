...
def lazy_import():
    ...
    globals()['FilingsFiles'] = FilingsFiles


class FilingsResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FilingsResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([FilingsFiles]):  # noqa: E501

        Keyword Args:
            value ([FilingsFiles]):  # noqa: E501
