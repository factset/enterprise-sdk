...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.DocumentsDistributorDocuments/0.22.0)](https://pypi.org/project/fds.sdk.DocumentsDistributorDocuments/v/0.22.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.DocumentsDistributorDocuments==0.22.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.DocumentsDistributorDocuments==0.22.0
```
...
*StreetAccountXMLAPIApi* | [**asynch_streetaccount_v1_request_files_get**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/DocumentsDistributorDocuments/v1/docs/StreetAccountXMLAPIApi.md#asynch_streetaccount_v1_request_files_get) | **GET** /asynch/streetaccount/v1/request-files | Returns the jobID
