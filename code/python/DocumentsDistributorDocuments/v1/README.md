...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.DocumentsDistributorDocuments/0.23.0)](https://pypi.org/project/fds.sdk.DocumentsDistributorDocuments/v/0.23.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.DocumentsDistributorDocuments==0.23.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.DocumentsDistributorDocuments==0.23.0
```
