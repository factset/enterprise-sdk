...
from fds.sdk.ModelPortfolio import rest
from fds.sdk.ModelPortfolio.configuration import Configuration
from fds.sdk.ModelPortfolio.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.ModelPortfolio.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/ModelPortfolio/0.20.0'
