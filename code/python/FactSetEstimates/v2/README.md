...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetEstimates/3.3.0)](https://pypi.org/project/fds.sdk.FactSetEstimates/v/3.3.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetEstimates==3.3.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetEstimates==3.3.0
```
