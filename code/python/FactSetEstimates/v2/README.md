...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetEstimates/2.2.0)](https://pypi.org/project/fds.sdk.FactSetEstimates/v/2.2.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetEstimates==2.2.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetEstimates==2.2.0
```
