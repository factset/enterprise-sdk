...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetEstimates/4.1.0)](https://pypi.org/project/fds.sdk.FactSetEstimates/v/4.1.0)
...
All endpoints, except /company-reports/* and /metrics are limited to a quota of 4 million datapoints per minute. Requests exceeding this limit (greater than 4 million datapoints per minute) will receive a 429 response.    
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetEstimates==4.1.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetEstimates==4.1.0
```
...
*DataItemsApi* | [**get_estimate_segment_detail_metrics**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/DataItemsApi.md#get_estimate_segment_detail_metrics) | **GET** /factset-estimates/v2/segments-metrics | Available Estimate Segment Detail metrics
...
*SegmentsApi* | [**get_segments_details_for_list**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/SegmentsApi.md#get_segments_details_for_list) | **POST** /factset-estimates/v2/segments-detail | Retrieves product segment detail estimates for a requested list of ids and fiscal periods
...
## Documentation For Models
 ...
 - [MetricSegmentDetail](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/MetricSegmentDetail.md)
 ...
 - [MetricsSegmentDetailResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/MetricsSegmentDetailResponse.md)
 ...
 - [SegmentId](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/SegmentId.md)
 ...
 - [SegmentsDetailsEstimate](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/SegmentsDetailsEstimate.md)
 - [SegmentsDetailsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/SegmentsDetailsRequest.md)
 - [SegmentsDetailsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/SegmentsDetailsResponse.md)
 ...
 - [SegmentsMetrics](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetEstimates/v2/docs/SegmentsMetrics.md)
