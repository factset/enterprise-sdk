...
**change_type** | **str, none_type** | Indicates whether the rating has increased, decreased, or remained unchanged compared to the previous rating.   * **increase** &#x3D; Rating improved   * **decrease** &#x3D; Rating worsened   * **unchanged** &#x3D; Rating remained the same  | [optional] 
