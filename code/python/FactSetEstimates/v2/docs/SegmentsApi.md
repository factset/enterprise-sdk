...
[**get_segments_details_for_list**](SegmentsApi.md#get_segments_details_for_list) | **POST** /factset-estimates/v2/segments-detail | Retrieves product segment detail estimates for a requested list of ids and fiscal periods
...
# **get_segments_details_for_list**
> SegmentsDetailsResponse get_segments_details_for_list(segments_details_request)
...
with fds.sdk.FactSetEstimates.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    segments_details_request = SegmentsDetailsRequest(
        ids=[
            "ids_example",
        ],
        ...
        metrics=SegmentsMetrics(["SALES"]),
        segment_type=SegmentType("BUS"),
        segment_ids=SegmentId(["PRODLINE_SALES_1"]),
        currency="USD",
    ...
    try:
        # Retrieves product segment detail estimates for a requested list of ids and fiscal periods
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_segments_details_for_list(segments_details_request)

        pprint(api_response)

    except fds.sdk.FactSetEstimates.ApiException as e:
        print("Exception when calling SegmentsApi->get_segments_details_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **segments_details_request** | [**SegmentsDetailsRequest**](SegmentsDetailsRequest.md)| Request object for Product Segments estimates. |
