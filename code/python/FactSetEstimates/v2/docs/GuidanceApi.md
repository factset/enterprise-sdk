# fds.sdk.FactSetEstimates.GuidanceApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_guidance**](GuidanceApi.md#get_guidance) | **GET** /factset-estimates/v2/guidance | Retrieves guidance for a requested list of ids and dates.
[**get_guidance_for_list**](GuidanceApi.md#get_guidance_for_list) | **POST** /factset-estimates/v2/guidance | Retrieves guidance for a requested list of ids and dates.



# **get_guidance**
> GuidanceResponse get_guidance(ids, metrics)
...
from fds.sdk.FactSetEstimates.api import guidance_api
...
with fds.sdk.FactSetEstimates.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_guidance(ids, metrics, start_date=start_date, end_date=end_date, relative_fiscal_start=relative_fiscal_start, relative_fiscal_end=relative_fiscal_end, periodicity=periodicity, frequency=frequency, currency=currency)

        pprint(api_response)

    except fds.sdk.FactSetEstimates.ApiException as e:
        print("Exception when calling GuidanceApi->get_guidance: %s\n" % e)
```
...
# **get_guidance_for_list**
> GuidanceResponse get_guidance_for_list(guidance_request)
...
with fds.sdk.FactSetEstimates.ApiClient(configuration) as api_client:
    ...
    ) # GuidanceRequest | Request object for Estimate Data Items.

    try:
        # Retrieves guidance for a requested list of ids and dates.
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_guidance_for_list(guidance_request)

        pprint(api_response)

    except fds.sdk.FactSetEstimates.ApiException as e:
        print("Exception when calling GuidanceApi->get_guidance_for_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **guidance_request** | [**GuidanceRequest**](GuidanceRequest.md)| Request object for Estimate Data Items. |
