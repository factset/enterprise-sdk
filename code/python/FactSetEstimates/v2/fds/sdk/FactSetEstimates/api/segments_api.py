...
class SegmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_segments_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SegmentsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_segments_details_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SegmentsDetailsResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/factset-estimates/v2/segments-detail',
                'operation_id': 'get_segments_details_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_segments_details_for_list(
        self,
        segments_details_request,
        **kwargs
    ) -> SegmentsDetailsResponse:
        """Retrieves product segment detail estimates for a requested list of ids and fiscal periods  # noqa: E501

        Returns FactSet Estimates Details Data for the segments gathered from the Business, Geographical, or Actual Reconciliation (ADJUSTMENT) classifications by using fiscal periods with a reporting frequency.    # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only

        Args:
            segments_details_request (SegmentsDetailsRequest): Request object for Product Segments estimates.
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['segments_details_request'] = \
            segments_details_request
        return self.get_segments_details_for_list_endpoint.call_with_http_info(**kwargs)

    def get_segments_details_for_list_with_http_info(
        self,
        segments_details_request,
        **kwargs
    ) -> typing.Tuple[SegmentsDetailsResponse, int, typing.MutableMapping]:
        """Retrieves product segment detail estimates for a requested list of ids and fiscal periods  # noqa: E501
    ...
    def get_segments_details_for_list_async(
        self,
        segments_details_request,
        **kwargs
    ) -> "ApplyResult[SegmentsDetailsResponse]":
        """Retrieves product segment detail estimates for a requested list of ids and fiscal periods  # noqa: E501
    ...
    def get_segments_details_for_list_with_http_info_async(
        self,
        segments_details_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[SegmentsDetailsResponse, int, typing.MutableMapping]]":
        """Retrieves product segment detail estimates for a requested list of ids and fiscal periods  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(SegmentsDetailsResponse, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['segments_details_request'] = \
            segments_details_request
