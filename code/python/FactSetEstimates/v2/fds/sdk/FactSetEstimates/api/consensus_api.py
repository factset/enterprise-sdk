...
class ConsensusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_fixed_consensus_endpoint = _Endpoint(
            settings={
                'response_type': (ConsensusResponse,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
    ...
    def get_fixed_consensus(
        ...
        **kwargs
        ...
        >>> thread = api.get_fixed_consensus(ids, metrics, async_req=True)
        >>> result = thread.get()
    ...
    def get_fixed_consensus_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_fixed_consensus_for_list(fixed_consensus_request, async_req=True)
        >>> result = thread.get()
    ...
    def get_rolling_consensus(
        ...
        **kwargs
        ...
        >>> thread = api.get_rolling_consensus(ids, metrics, async_req=True)
        >>> result = thread.get()
    ...
    def get_rolling_consensus_for_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_rolling_consensus_for_list(rolling_consensus_request, async_req=True)
        >>> result = thread.get()
