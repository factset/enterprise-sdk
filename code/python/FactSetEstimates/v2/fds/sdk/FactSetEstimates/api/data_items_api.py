...
class DataItemsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_estimate_segment_detail_metrics_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (MetricsSegmentDetailResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/factset-estimates/v2/segments-metrics',
                'operation_id': 'get_estimate_segment_detail_metrics',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_estimate_segment_detail_metrics(
        self,
        ids,
        metrics,
        **kwargs
    ) -> MetricsSegmentDetailResponse:
        """Available Estimate Segment Detail metrics  # noqa: E501
        ...
        kwargs['metrics'] = \
            metrics
        return self.get_estimate_segment_detail_metrics_endpoint.call_with_http_info(**kwargs)

    def get_estimate_segment_detail_metrics_with_http_info(
        self,
        ids,
        metrics,
        **kwargs
    ) -> typing.Tuple[MetricsSegmentDetailResponse, int, typing.MutableMapping]:
        """Available Estimate Segment Detail metrics  # noqa: E501
    ...
    def get_estimate_segment_detail_metrics_async(
        self,
        ids,
        metrics,
        **kwargs
    ) -> "ApplyResult[MetricsSegmentDetailResponse]":
        """Available Estimate Segment Detail metrics  # noqa: E501
    ...
    def get_estimate_segment_detail_metrics_with_http_info_async(
        self,
        ids,
        metrics,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[MetricsSegmentDetailResponse, int, typing.MutableMapping]]":
        """Available Estimate Segment Detail metrics  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(MetricsSegmentDetailResponse, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['ids'] = \
            ids
