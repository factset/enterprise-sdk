...
class GuidanceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_guidance_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (GuidanceResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/factset-estimates/v2/guidance',
                'operation_id': 'get_guidance',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_guidance_for_list_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (GuidanceResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ...
                'endpoint_path': '/factset-estimates/v2/guidance',
                'operation_id': 'get_guidance_for_list',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_guidance(
        ...
        **kwargs
        ...
        """Retrieves guidance for a requested list of ids and dates.  # noqa: E501

        Returns FactSet Estimates guidance data for the current unreported period as of the requested dates. </p>   # noqa: E501
        ...
        kwargs['metrics'] = \
            metrics
        return self.get_guidance_endpoint.call_with_http_info(**kwargs)

    def get_guidance_with_http_info(
        self,
        ids,
        metrics,
        **kwargs
    ) -> typing.Tuple[GuidanceResponse, int, typing.MutableMapping]:
        """Retrieves guidance for a requested list of ids and dates.  # noqa: E501
    ...
    def get_guidance_async(
        self,
        ids,
        metrics,
        **kwargs
    ) -> "ApplyResult[GuidanceResponse]":
        """Retrieves guidance for a requested list of ids and dates.  # noqa: E501
    ...
    def get_guidance_with_http_info_async(
        self,
        ids,
        metrics,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GuidanceResponse, int, typing.MutableMapping]]":
        """Retrieves guidance for a requested list of ids and dates.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GuidanceResponse, int, typing.Dict)]
        """
    ...
    def get_guidance_for_list(
        ...
        **kwargs
        ...
        Args:
            guidance_request (GuidanceRequest): Request object for Estimate Data Items.
        ...
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=True, async_req=False)
        kwargs['guidance_request'] = \
            guidance_request
        return self.get_guidance_for_list_endpoint.call_with_http_info(**kwargs)

    def get_guidance_for_list_with_http_info(
        self,
        guidance_request,
        **kwargs
    ) -> typing.Tuple[GuidanceResponse, int, typing.MutableMapping]:
    ...
    def get_guidance_for_list_async(
        self,
        guidance_request,
        **kwargs
    ) -> "ApplyResult[GuidanceResponse]":
    ...
    def get_guidance_for_list_with_http_info_async(
        self,
        guidance_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GuidanceResponse, int, typing.MutableMapping]]":
