...
from fds.sdk.FactSetEstimates import rest
from fds.sdk.FactSetEstimates.configuration import Configuration
from fds.sdk.FactSetEstimates.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetEstimates.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetEstimates/1.2.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BrokerDetailApi()
        api_instance.get_fixed_detail  # this is an instance of the class Endpoint
        api_instance.get_fixed_detail()  # this invokes api_instance.get_fixed_detail.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_fixed_detail.callable or self.callable in this class
