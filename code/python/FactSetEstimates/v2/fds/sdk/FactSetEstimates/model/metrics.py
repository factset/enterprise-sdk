...
class Metrics(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): Requested metrics. Use the `/metrics` endpoint for a list of estimate items.For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034)..  # noqa: E501

        Keyword Args:
            value ([str]): Requested metrics. Use the `/metrics` endpoint for a list of estimate items.For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034)..  # noqa: E501
