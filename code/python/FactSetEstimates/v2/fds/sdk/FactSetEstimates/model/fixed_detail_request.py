...
class FixedDetailRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'include_doc_id': 'includeDocId',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, ids, metrics, *args, **kwargs):  # noqa: E501
        """FixedDetailRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_date (date): The start date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this #endpoint. To determine the earliest available historical data, refer to the History section in the Online Assistant: <a href=\"https://my.apps.factset.com/oa/pages/20121\" target=\"_blank\"> Online Assistant – History Section</a>. . [optional]  # noqa: E501
