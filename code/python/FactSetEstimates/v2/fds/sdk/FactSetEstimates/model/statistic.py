...
class Statistic(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Statistic for consensus calculation.. if omitted defaults to "MEAN", must be one of ["MEAN", "MEDIAN", "HIGH", "LOW", "COUNT", "STDDEV", ]  # noqa: E501

        Keyword Args:
            value (str): Statistic for consensus calculation.. if omitted defaults to "MEAN", must be one of ["MEAN", "MEDIAN", "HIGH", "LOW", "COUNT", "STDDEV", ]  # noqa: E501
