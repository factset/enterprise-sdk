...
class SegmentsEstimate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SegmentsEstimate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            segment_type (str, none_type): Segment selected. [optional]  # noqa: E501
            ...
            estimate_date (date, none_type): The date the estimates are as of in YYYY-MM-DD format.. [optional]  # noqa: E501
            currency (str, none_type): Currency used estimates in consensus calculations. Use 'ESTIMATE' as input for values in Estimate Currency. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470).. [optional]  # noqa: E501
