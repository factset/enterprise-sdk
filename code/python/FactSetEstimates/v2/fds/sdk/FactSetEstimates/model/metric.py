...
class Metric(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metric (str): Metric identifier to be used as `metrics` input in the FactSet Estimate endpoints.. [optional]  # noqa: E501
            name (str): Plain text name of the metric.. [optional]  # noqa: E501
            category (str): Primary Category of metric item, such as, FINANCIAL_STATEMENT or INDUSTRY_METRIC. [optional]  # noqa: E501
            subcategory (str): Sub-category of metric items, such as the INCOME_STATEMENT or AIRLINES.. [optional]  # noqa: E501
            o_aurl (str): The Online Assistant Page URL, used to lookup the definition and methodology of the requested item.. [optional]  # noqa: E501
        """
