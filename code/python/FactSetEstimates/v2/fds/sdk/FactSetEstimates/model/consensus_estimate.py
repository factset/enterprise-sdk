...
class ConsensusEstimate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            estimate_count (int, none_type): Count or NEST of estimates in consensus calculation. Will be `null` when `periodicity` is `LTMA` or `NTMA`. For more details, visit [Online Assistant Page #16598](https://oa.apps.factset.com/pages/16114). [optional]  # noqa: E501
