...
class SegmentsDetailsEstimate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SegmentsDetailsEstimate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            segment_id (str, none_type): Use the /segments-metrics endpoint for a complete list.. [optional]  # noqa: E501
            segment_type (str): Controls the type of segment selected.   * **BUS** = Business   * **GEO** = Geographic . [optional] if omitted the server will use the default value of "BUS"  # noqa: E501
            ...
            currency (str, none_type): Currency used estimates in consensus calculations. Use `ESTIMATE` as input for values in Estimate Currency. For a list of currency ISO codes, visit <a href=\"https://oa.apps.factset.com/pages/1470\" target=\"_blank\">Online Assistant Page #1470</a>.. [optional]  # noqa: E501
            estimate_currency (str, none_type): Estimate currency of the requested Security. [optional]  # noqa: E501
            estimate_date (date, none_type): Date of estimate expressed in YYYY-MM-DD format. For more details, visit <a href=\"https://oa.apps.factset.com/pages/16598\" target=\"_blank\">Online Assistant Page. [optional]  # noqa: E501
