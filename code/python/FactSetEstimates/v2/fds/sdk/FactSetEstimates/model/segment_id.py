...
class SegmentId(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SegmentId - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Requested segmentId. Use the `/segments-metrics` endpoint for a list of segment_ids..  # noqa: E501

        Keyword Args:
            value ([str]): Requested segmentId. Use the `/segments-metrics` endpoint for a list of segment_ids..  # noqa: E501
