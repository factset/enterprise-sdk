...
class SegmentType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Controls the type of segment selected.   * **BUS** = Business   * **GEO** = Geographic . if omitted defaults to "BUS", must be one of ["BUS", "GEO", ]  # noqa: E501

        Keyword Args:
            value (str): Controls the type of segment selected.   * **BUS** = Business   * **GEO** = Geographic . if omitted defaults to "BUS", must be one of ["BUS", "GEO", ]  # noqa: E501
