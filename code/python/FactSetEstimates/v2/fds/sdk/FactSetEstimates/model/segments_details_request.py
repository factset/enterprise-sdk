...
def lazy_import():
    ...
    globals()['SegmentsMetrics'] = SegmentsMetrics


class SegmentsDetailsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'ids': ([str],),  # noqa: E501
            'metrics': (SegmentsMetrics,),  # noqa: E501
            'segment_ids': (SegmentId,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ids, metrics, segment_ids, *args, **kwargs):  # noqa: E501
        """SegmentsDetailsRequest - a model defined in OpenAPI

        Args:
            ids ([str]):
            metrics (SegmentsMetrics):
    ...
    @convert_js_args_to_python_args
    def __init__(self, ids, metrics, segment_ids, *args, **kwargs):  # noqa: E501
        """SegmentsDetailsRequest - a model defined in OpenAPI
