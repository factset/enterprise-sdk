...
class FundIssuerSearchDataShareClassRegistrationCountryExclude(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundIssuerSearchDataShareClassRegistrationCountryExclude - a model defined in OpenAPI
