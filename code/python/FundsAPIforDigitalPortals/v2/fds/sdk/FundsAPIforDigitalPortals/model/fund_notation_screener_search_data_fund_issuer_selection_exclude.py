...
class FundNotationScreenerSearchDataFundIssuerSelectionExclude(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundNotationScreenerSearchDataFundIssuerSelectionExclude - a model defined in OpenAPI
