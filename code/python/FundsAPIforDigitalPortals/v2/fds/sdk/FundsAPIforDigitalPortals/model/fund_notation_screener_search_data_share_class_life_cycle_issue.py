...
class FundNotationScreenerSearchDataShareClassLifeCycleIssue(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """FundNotationScreenerSearchDataShareClassLifeCycleIssue - a model defined in OpenAPI
