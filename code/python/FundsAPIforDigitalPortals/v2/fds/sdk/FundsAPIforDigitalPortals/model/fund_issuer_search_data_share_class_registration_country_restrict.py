...
class FundIssuerSearchDataShareClassRegistrationCountryRestrict(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundIssuerSearchDataShareClassRegistrationCountryRestrict - a model defined in OpenAPI
