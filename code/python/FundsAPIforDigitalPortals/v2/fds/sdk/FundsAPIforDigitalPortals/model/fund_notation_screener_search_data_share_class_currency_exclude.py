...
class FundNotationScreenerSearchDataShareClassCurrencyExclude(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundNotationScreenerSearchDataShareClassCurrencyExclude - a model defined in OpenAPI
