...
class InlineResponse2005DataShareClassFeeCustodianBankCurrent(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InlineResponse2005DataShareClassFeeCustodianBankCurrent - a model defined in OpenAPI
