...
class FundNotationScreenerSearchDataValidationCurrencyRestrict(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundNotationScreenerSearchDataValidationCurrencyRestrict - a model defined in OpenAPI
