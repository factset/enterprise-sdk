...
class FundNotationScreenerSearchDataFundHoldingTypeRestrict(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FundNotationScreenerSearchDataFundHoldingTypeRestrict - a model defined in OpenAPI
