...
from fds.sdk.FundsAPIforDigitalPortals import rest
from fds.sdk.FundsAPIforDigitalPortals.configuration import Configuration
from fds.sdk.FundsAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FundsAPIforDigitalPortals.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/FundsAPIforDigitalPortals/0.10.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FundApi()
        api_instance.get_fund_holding_list_by_instrument  # this is an instance of the class Endpoint
        api_instance.get_fund_holding_list_by_instrument()  # this invokes api_instance.get_fund_holding_list_by_instrument.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_fund_holding_list_by_instrument.callable or self.callable in this class
