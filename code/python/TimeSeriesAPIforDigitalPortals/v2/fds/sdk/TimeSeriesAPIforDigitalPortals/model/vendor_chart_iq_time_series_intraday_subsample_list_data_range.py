...
class VendorChartIQTimeSeriesIntradaySubsampleListDataRange(ModelNormal):
    ...
    def _from_openapi_data(cls, start, end, *args, **kwargs):  # noqa: E501
        """VendorChartIQTimeSeriesIntradaySubsampleListDataRange - a model defined in OpenAPI
