...
from fds.sdk.TimeSeriesAPIforDigitalPortals import rest
from fds.sdk.TimeSeriesAPIforDigitalPortals.configuration import Configuration
from fds.sdk.TimeSeriesAPIforDigitalPortals.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/TimeSeriesAPIforDigitalPortals/0.9.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_prices_time_series_intraday_subsample_get  # this is an instance of the class Endpoint
        api_instance.get_prices_time_series_intraday_subsample_get()  # this invokes api_instance.get_prices_time_series_intraday_subsample_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_prices_time_series_intraday_subsample_get.callable or self.callable in this class
