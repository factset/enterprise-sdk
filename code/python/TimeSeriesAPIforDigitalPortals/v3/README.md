...
with fds.sdk.TimeSeriesAPIforDigitalPortals.ApiClient(configuration) as api_client:
    ...
    # try:
    #     # End-of-day time series data for a notation.
    #     api_response, http_status_code, response_headers = api_instance.post_prices_time_series_eod_list_with_http_info(body)
    #     pprint(api_response)
    ...
    # try:
    #     # End-of-day time series data for a notation.
    #     async_result = api_instance.post_prices_time_series_eod_list_async(body)
    ...
    # try:
    #     # End-of-day time series data for a notation.
    #     async_result = api_instance.post_prices_time_series_eod_list_with_http_info_async(body)
