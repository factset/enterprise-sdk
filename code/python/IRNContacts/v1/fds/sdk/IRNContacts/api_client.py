...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/IRNContacts/1.1.2 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_contact  # this is an instance of the class Endpoint
        api_instance.create_contact()  # this invokes api_instance.create_contact.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_contact.callable or self.callable in this class
