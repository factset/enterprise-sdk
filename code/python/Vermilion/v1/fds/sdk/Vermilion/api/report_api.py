...
class ReportApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_tenant_reports_get_endpoint = _Endpoint(
            settings={
                'response_type': ([ReportDefinitionList],),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
                'endpoint_path': '/v1/{tenant}/reports',
                'operation_id': 'v1_tenant_reports_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.v1_tenant_reports_report_definition_code_get_endpoint = _Endpoint(
            settings={
                'response_type': (ReportDefinitionData,),
                'auth': [
                    'FactSetApiKey',
                    'FactSetOAuth2'
                ],
                'endpoint_path': '/v1/{tenant}/reports/{reportDefinitionCode}',
                'operation_id': 'v1_tenant_reports_report_definition_code_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_tenant_reports_get(
        ...
        **kwargs
        ...
        >>> thread = api.v1_tenant_reports_get(tenant, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['tenant'] = \
            tenant
        return self.v1_tenant_reports_get_endpoint.call_with_http_info(**kwargs)

    def v1_tenant_reports_report_definition_code_get(
        self,
        tenant,
        report_definition_code,
        **kwargs
        ...
        >>> thread = api.v1_tenant_reports_report_definition_code_get(tenant, report_definition_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['report_definition_code'] = \
            report_definition_code
        return self.v1_tenant_reports_report_definition_code_get_endpoint.call_with_http_info(**kwargs)
