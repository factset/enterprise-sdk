...
from fds.sdk.Vermilion import rest
from fds.sdk.Vermilion.configuration import Configuration
from fds.sdk.Vermilion.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.Vermilion.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/Vermilion/0.9.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DatasourceApi()
        api_instance.v1_tenant_data_sources_data_source_code_data_get  # this is an instance of the class Endpoint
        api_instance.v1_tenant_data_sources_data_source_code_data_get()  # this invokes api_instance.v1_tenant_data_sources_data_source_code_data_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_tenant_data_sources_data_source_code_data_get.callable or self.callable in this class
