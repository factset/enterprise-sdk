...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/Vermilion/1.3.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_all_data_sources  # this is an instance of the class Endpoint
        api_instance.get_all_data_sources()  # this invokes api_instance.get_all_data_sources.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_all_data_sources.callable or self.callable in this class
