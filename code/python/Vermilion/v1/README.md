...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.Vermilion/1.3.0)](https://pypi.org/project/fds.sdk.Vermilion/v/1.3.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.Vermilion==1.3.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.Vermilion==1.3.0
```
...
*WorkflowApi* | [**generate_schedule_tasks**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/WorkflowApi.md#generate_schedule_tasks) | **POST** /v1/{tenant}/schedules/{scheduleId}/generate-tasks | Generates the tasks for the initialised schedule
*WorkflowApi* | [**get_schedule_by_id**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/WorkflowApi.md#get_schedule_by_id) | **GET** /v1/{tenant}/schedules/{scheduleId} | Gets a schedule based on the schedule ID
...
*WorkflowApi* | [**get_task**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/WorkflowApi.md#get_task) | **GET** /v1/{tenant}/tasks/{taskId} | Gets a task based on the task ID
*WorkflowApi* | [**get_task_history**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/WorkflowApi.md#get_task_history) | **GET** /v1/{tenant}/tasks/{taskId}/history | Gets the task history for a specific task
*WorkflowApi* | [**get_tasks**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/WorkflowApi.md#get_tasks) | **GET** /v1/{tenant}/tasks | Retrieves a list of all tasks
...
*WorkflowApi* | [**update_task_details**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/WorkflowApi.md#update_task_details) | **PATCH** /v1/{tenant}/tasks/{taskId} | Updates the task details for the specified task.
...
## Documentation For Models
 ...
 - [CreateScimUserJSONRequestName](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/CreateScimUserJSONRequestName.md)
 ...
 - [EntityFieldValueDTOMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/EntityFieldValueDTOMeta.md)
 - [EntityFieldValueDTOMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/EntityFieldValueDTOMetaPagination.md)
 ...
 - [ReportDefinitionListMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ReportDefinitionListMeta.md)
 - [ReportDefinitionListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ReportDefinitionListMetaPagination.md)
 ...
 - [ReportInstanceListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ReportInstanceListMetaPagination.md)
 ...
 - [ScheduleAPIDTO](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleAPIDTO.md)
 - [ScheduleAPIDTOAllOf](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleAPIDTOAllOf.md)
 ...
 - [ScheduleDefinitionsListMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleDefinitionsListMeta.md)
 - [ScheduleDefinitionsListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleDefinitionsListMetaPagination.md)
 ...
 - [ScheduleGenerationLogListMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleGenerationLogListMeta.md)
 - [ScheduleGenerationLogListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleGenerationLogListMetaPagination.md)
 ...
 - [ScheduleResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/ScheduleResponseData.md)
 ...
 - [SchedulesListMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/SchedulesListMeta.md)
 - [SchedulesListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/SchedulesListMetaPagination.md)
 ...
 - [TaskDetails](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskDetails.md)
 - [TaskDetailsObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskDetailsObject.md)
 - [TaskHistoryList](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskHistoryList.md)
 - [TaskHistoryListMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskHistoryListMeta.md)
 - [TaskHistoryListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskHistoryListMetaPagination.md)
 - [TaskHistoryObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskHistoryObject.md)
 - [TaskList](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskList.md)
 - [TaskListItemDetails](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskListItemDetails.md)
 - [TaskListItemDetailsAllOf](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskListItemDetailsAllOf.md)
 - [TaskListMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskListMeta.md)
 - [TaskListMetaPagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskListMetaPagination.md)
 - [TaskPatchRequestBody](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskPatchRequestBody.md)
 - [TaskPatchRequestBodyData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskPatchRequestBodyData.md)
 - [TaskPatchResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskPatchResponse.md)
 - [TaskPatchResponseObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/Vermilion/v1/docs/TaskPatchResponseObject.md)
