...
from fds.sdk.FactSetIntradayTickHistory import rest
from fds.sdk.FactSetIntradayTickHistory.configuration import Configuration
from fds.sdk.FactSetIntradayTickHistory.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetIntradayTickHistory.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetIntradayTickHistory/0.21.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FirstTradeApi()
        api_instance.tick_history_firsttrade_get  # this is an instance of the class Endpoint
        api_instance.tick_history_firsttrade_get()  # this invokes api_instance.tick_history_firsttrade_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.tick_history_firsttrade_get.callable or self.callable in this class
