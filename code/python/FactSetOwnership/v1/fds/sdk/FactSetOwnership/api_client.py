...
from fds.sdk.FactSetOwnership import rest
from fds.sdk.FactSetOwnership.configuration import Configuration
from fds.sdk.FactSetOwnership.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetOwnership.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetOwnership/1.0.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FundHoldingsApi()
        api_instance.get_ownership_holdings  # this is an instance of the class Endpoint
        api_instance.get_ownership_holdings()  # this invokes api_instance.get_ownership_holdings.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_ownership_holdings.callable or self.callable in this class
