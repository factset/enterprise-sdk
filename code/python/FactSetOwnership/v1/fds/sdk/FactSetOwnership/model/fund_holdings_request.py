...
def lazy_import():
    ...
    globals()['Batch'] = Batch
    globals()['IdFundHoldings'] = IdFundHoldings


class FundHoldingsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """FundHoldingsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            date (str): Date of holdings expressed in YYYY-MM-DD format.. [optional]  # noqa: E501
            topn (str): Limits number of holdings or holders displayed by the top *n* securities. Default is ALL, or use integer to limit number.. [optional] if omitted the server will use the default value of "ALL"  # noqa: E501
            asset_type (AssetType): [optional]  # noqa: E501
            currency (str): Currency code for adjusting prices. Default is Local. For a list of currency ISO codes, visit [Online Assistant Page 1470](https://oa.apps.factset.com/pages/1470).. [optional]  # noqa: E501
