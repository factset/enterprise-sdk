...
class PeriodOfMeasure(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PeriodOfMeasure - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Determines the range over which the code calculates change for Percent Ownership and Position Change.   * **1M** = 1 Month (last 30 days)   * **3M** = 3 Months (last 90 days)   * **6M** =  6 Months (last 180 days)   * **12M** = 12 Months (last 365 days) . if omitted defaults to "6M", must be one of ["1M", "3M", "6M", "12M", ]  # noqa: E501

        Keyword Args:
            value (str): Determines the range over which the code calculates change for Percent Ownership and Position Change.   * **1M** = 1 Month (last 30 days)   * **3M** = 3 Months (last 90 days)   * **6M** =  6 Months (last 180 days)   * **12M** = 12 Months (last 365 days) . if omitted defaults to "6M", must be one of ["1M", "3M", "6M", "12M", ]  # noqa: E501
