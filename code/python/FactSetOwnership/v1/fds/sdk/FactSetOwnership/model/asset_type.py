...
class AssetType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Select type of assets returned, whereby EQ = Equity, FI = Fixed Income, and ALL = all asset types.. if omitted defaults to "EQ", must be one of ["ALL", "EQ", "FI", ]  # noqa: E501

        Keyword Args:
            value (str): Select type of assets returned, whereby EQ = Equity, FI = Fixed Income, and ALL = all asset types.. if omitted defaults to "EQ", must be one of ["ALL", "EQ", "FI", ]  # noqa: E501
