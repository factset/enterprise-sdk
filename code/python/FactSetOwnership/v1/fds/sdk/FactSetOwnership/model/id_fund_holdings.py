...
class IdFundHoldings(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdFundHoldings - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): List of Fund identifiers..  # noqa: E501

        Keyword Args:
            value ([str]): List of Fund identifiers..  # noqa: E501
