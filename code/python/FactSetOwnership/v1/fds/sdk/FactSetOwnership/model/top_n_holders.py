...
class TopNHolders(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TopNHolders - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Specifies the number of top holders whose data is returned.   * **ALL** = All holders   * **5** = Top 5 Institutional Holders   * **10** = Top 10 Institutional Holders   * **25** = Top 25 Institutional Holders   * **50** = Top 50 Institutional Holders   * **100** = Top 100 Institutional Holders . if omitted defaults to "25", must be one of ["ALL", "5", "10", "25", "50", "100", ]  # noqa: E501

        Keyword Args:
            value (str): Specifies the number of top holders whose data is returned.   * **ALL** = All holders   * **5** = Top 5 Institutional Holders   * **10** = Top 10 Institutional Holders   * **25** = Top 25 Institutional Holders   * **50** = Top 50 Institutional Holders   * **100** = Top 100 Institutional Holders . if omitted defaults to "25", must be one of ["ALL", "5", "10", "25", "50", "100", ]  # noqa: E501
