...
class IdHolders(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdHolders - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Security Requested for Holders information..  # noqa: E501

        Keyword Args:
            value ([str]): Security Requested for Holders information..  # noqa: E501
