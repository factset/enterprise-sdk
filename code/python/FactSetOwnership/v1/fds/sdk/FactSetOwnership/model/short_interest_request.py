...
def lazy_import():
    ...
    globals()['ShortInterestRequestData'] = ShortInterestRequestData


class ShortInterestRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ShortInterestRequestData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ShortInterestRequest - a model defined in OpenAPI
