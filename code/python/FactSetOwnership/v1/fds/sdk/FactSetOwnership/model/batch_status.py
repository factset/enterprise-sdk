...
def lazy_import():
    ...
    globals()['BatchErrorObject'] = BatchErrorObject


class BatchStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'error': (BatchErrorObject,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start_time (datetime): The time when the batch request was initiated. This is in Eastern Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SSS], following ISO 8601.. [optional]  # noqa: E501
            end_time (datetime, none_type): The time when the batch request was completed. This is in Eastern Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SSS], following ISO 8601.. [optional]  # noqa: E501
            status (str): The status signifies the current state of the batch request that can be 'queued', 'executing', 'created', or 'failed'.. [optional]  # noqa: E501
            error (BatchErrorObject): [optional]  # noqa: E501
        """
