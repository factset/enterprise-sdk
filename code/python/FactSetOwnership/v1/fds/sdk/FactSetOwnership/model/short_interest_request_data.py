...
class ShortInterestRequestData(ModelNormal):
    ...
    def _from_openapi_data(cls, ids, *args, **kwargs):  # noqa: E501
        """ShortInterestRequestData - a model defined in OpenAPI

        Args:
            ids ([str]): List of requested short interest identifiers. ***ids limit = 1 per request***
        ...
        Keyword Args:
            ...
            years (int):  The number of years of historical short interest data to include (integer value from 1 to 10).. [optional]  # noqa: E501
        """
