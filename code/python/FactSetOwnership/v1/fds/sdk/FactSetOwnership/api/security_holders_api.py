...
class GetSecurityHoldersResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetSecurityHoldersResponseWrapper
    ...
    def get_response_200(self) -> SecurityHoldersResponse:
        """
        Raises: ApiException: Invalid response getter called.

        Returns: Security Holders Response.
        """
...
class PostSecurityHoldersResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new PostSecurityHoldersResponseWrapper
        to status_code, response
...
class SecurityHoldersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_security_holders_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (SecurityHoldersResponse,), 202: (BatchStatusResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
                ...
                'endpoint_path': '/security-holders',
    ...
    def get_security_holders_with_http_info(
        ...
        ids,
        **kwargs
    ) -> typing.Tuple[GetSecurityHoldersResponseWrapper, int, typing.MutableMapping]:
        """Get security ownership data for requested security identifers.  # noqa: E501
    ...
    def get_security_holders_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[GetSecurityHoldersResponseWrapper]":
        """Get security ownership data for requested security identifers.  # noqa: E501
    ...
    def get_security_holders_with_http_info_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetSecurityHoldersResponseWrapper, int, typing.MutableMapping]]":
        """Get security ownership data for requested security identifers.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetSecurityHoldersResponseWrapper, int, typing.Dict)]
        """
    ...
    def post_security_holders_with_http_info(
        ...
        security_holders_request,
        **kwargs
    ) -> typing.Tuple[PostSecurityHoldersResponseWrapper, int, typing.MutableMapping]:
        """Get security ownership data for a list of requested securities.  # noqa: E501
    ...
    def post_security_holders_async(
        ...
        security_holders_request,
        **kwargs
    ) -> "ApplyResult[PostSecurityHoldersResponseWrapper]":
        """Get security ownership data for a list of requested securities.  # noqa: E501
    ...
    def post_security_holders_with_http_info_async(
        ...
        security_holders_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[PostSecurityHoldersResponseWrapper, int, typing.MutableMapping]]":
        """Get security ownership data for a list of requested securities.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(PostSecurityHoldersResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['security_holders_request'] = \
            security_holders_request
