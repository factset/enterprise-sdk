...
class GetBatchDataResponseWrapper:
    ...
    def get_response_200(self) -> BatchResultResponse:
        ...
        Returns: Returns the request&#39;s response object after the batch request has finished processing and the response is created
        """
...
class BatchProcessingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_batch_data_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (BatchResultResponse,), 202: (BatchStatusResponse,), 401: (ErrorResponse,), 404: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
        ...
        self.get_batch_status_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 201: (BatchStatusResponse,), 202: (BatchStatusResponse,), 401: (ErrorResponse,), 404: (ErrorResponse,), 429: (ErrorResponse,), 500: (ErrorResponse,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def get_batch_data(
        ...
        **kwargs
        ...
        """Returns the response for the Batch Request  # noqa: E501

        Returns the response data for the specified batch id upon successful completion.  # noqa: E501
    ...
    def get_batch_status(
        ...
        **kwargs
        ...
        """Returns the latest status and metadata for the Batch Request.  # noqa: E501

        Returns the current processing status of the batch request identified by the specified batch Id. Use this endpoint to monitor and track the progress or completion of long-running batch operations.  # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
