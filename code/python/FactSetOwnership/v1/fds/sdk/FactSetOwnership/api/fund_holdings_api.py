...
class GetOwnershipHoldingsResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new GetOwnershipHoldingsResponseWrapper
    ...
    def get_response_200(self) -> FundHoldingsResponse:
        """
        Raises: ApiException: Invalid response getter called.

        Returns: Fund Holdings Response.
        """
...
class PostOwnershipHoldingsResponseWrapper:
    def __init__(self, status_code: int, response: object):
        """
        This constructor initializes the new PostOwnershipHoldingsResponseWrapper
        to status_code, response
...
class FundHoldingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_ownership_holdings_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (FundHoldingsResponse,), 202: (BatchStatusResponse,), 400: (ErrorResponse,), 401: (ErrorResponse,), 403: (ErrorResponse,), 415: (ErrorResponse,), 500: (ErrorResponse,),  },
    ...
    def get_ownership_holdings_with_http_info(
        ...
        ids,
        **kwargs
    ) -> typing.Tuple[GetOwnershipHoldingsResponseWrapper, int, typing.MutableMapping]:
        """Get underlying holdings information for a requested fund identifer.  # noqa: E501
    ...
    def get_ownership_holdings_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[GetOwnershipHoldingsResponseWrapper]":
        """Get underlying holdings information for a requested fund identifer.  # noqa: E501
    ...
    def get_ownership_holdings_with_http_info_async(
        ...
        ids,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[GetOwnershipHoldingsResponseWrapper, int, typing.MutableMapping]]":
        """Get underlying holdings information for a requested fund identifer.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(GetOwnershipHoldingsResponseWrapper, int, typing.Dict)]
        """
    ...
    def post_ownership_holdings_with_http_info(
        ...
        fund_holdings_request,
        **kwargs
    ) -> typing.Tuple[PostOwnershipHoldingsResponseWrapper, int, typing.MutableMapping]:
        """Get holdings for a list of funds.  # noqa: E501
    ...
    def post_ownership_holdings_async(
        ...
        fund_holdings_request,
        **kwargs
    ) -> "ApplyResult[PostOwnershipHoldingsResponseWrapper]":
        """Get holdings for a list of funds.  # noqa: E501
    ...
    def post_ownership_holdings_with_http_info_async(
        ...
        fund_holdings_request,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[PostOwnershipHoldingsResponseWrapper, int, typing.MutableMapping]]":
        """Get holdings for a list of funds.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(PostOwnershipHoldingsResponseWrapper, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        kwargs['fund_holdings_request'] = \
            fund_holdings_request
