...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetOwnership/1.4.0)](https://pypi.org/project/fds.sdk.FactSetOwnership/v/1.4.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetOwnership==1.4.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetOwnership==1.4.0
```
