...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.FactSetOwnership/3.0.0)](https://pypi.org/project/fds.sdk.FactSetOwnership/v/3.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.FactSetOwnership==3.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.FactSetOwnership==3.0.0
```
...
*CompanyReportsApi* | [**get_ownership_company_reports_summary**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/CompanyReportsApi.md#get_ownership_company_reports_summary) | **GET** /company-reports/summary | Get current only ownership summary data for a list of requested identifiers.
*CompanyReportsApi* | [**post_ownership_company_reports_summary**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/CompanyReportsApi.md#post_ownership_company_reports_summary) | **POST** /company-reports/summary | Get current only ownership summary data for a list of requested identifiers.
...
*ShortInterestApi* | [**get_short_interest**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/ShortInterestApi.md#get_short_interest) | **GET** /short-interest | Gets short interest data for a requested identifier.
*ShortInterestApi* | [**post_short_interest**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/ShortInterestApi.md#post_short_interest) | **POST** /short-interest | Gets short interest data for a requested identifier.
...
## Documentation For Models
 ...
 - [IdCompanyReports](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/IdCompanyReports.md)
 ...
 - [Meta](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/Meta.md)
 - [MetaRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/MetaRequest.md)
 - [OwnershipSummary](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/OwnershipSummary.md)
 - [OwnershipSummaryRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/OwnershipSummaryRequest.md)
 - [OwnershipSummaryRequestData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/OwnershipSummaryRequestData.md)
 - [OwnershipSummaryResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/OwnershipSummaryResponse.md)
 - [Pagination](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/Pagination.md)
 - [PaginationRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/PaginationRequest.md)
 ...
 - [ShortInterest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/ShortInterest.md)
 - [ShortInterestRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/ShortInterestRequest.md)
 - [ShortInterestRequestData](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/ShortInterestRequestData.md)
 - [ShortInterestResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/FactSetOwnership/v1/docs/ShortInterestResponse.md)
