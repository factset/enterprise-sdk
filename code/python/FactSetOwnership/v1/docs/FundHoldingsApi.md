...
with fds.sdk.FactSetOwnership.ApiClient(configuration) as api_client:
    ...
    asset_type = AssetType("EQ") # AssetType | Filter holdings by the following major asset classes -   * **EQ**  = Equity   * **FI** = Fixed Income   * **ALL** = ALL  (optional)
 ...
 **asset_type** | **AssetType**| Filter holdings by the following major asset classes -   * **EQ**  &#x3D; Equity   * **FI** &#x3D; Fixed Income   * **ALL** &#x3D; ALL  | [optional]
