...
class NonPeriodicFields(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NonPeriodicFields - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Private Markets Non-Periodic Fields. .  # noqa: E501

        Keyword Args:
            value ([str]): Private Markets Non-Periodic Fields. .  # noqa: E501
