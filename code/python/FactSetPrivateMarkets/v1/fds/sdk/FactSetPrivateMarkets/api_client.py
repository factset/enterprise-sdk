...
from fds.sdk.FactSetPrivateMarkets import rest
from fds.sdk.FactSetPrivateMarkets.configuration import Configuration
from fds.sdk.FactSetPrivateMarkets.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPrivateMarkets.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetPrivateMarkets/1.0.13 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_fields  # this is an instance of the class Endpoint
        api_instance.get_fields()  # this invokes api_instance.get_fields.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_fields.callable or self.callable in this class
