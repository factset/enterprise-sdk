...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.AxiomaFixedIncomeOptimizer/0.21.13)](https://pypi.org/project/fds.sdk.AxiomaFixedIncomeOptimizer/v/0.21.13)
...
```shell
poetry add fds.sdk.utils fds.sdk.AxiomaFixedIncomeOptimizer==0.21.13
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.AxiomaFixedIncomeOptimizer==0.21.13
```
