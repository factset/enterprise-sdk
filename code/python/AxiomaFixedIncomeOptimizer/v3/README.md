...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.AxiomaFixedIncomeOptimizer/0.21.15)](https://pypi.org/project/fds.sdk.AxiomaFixedIncomeOptimizer/v/0.21.15)
...
```shell
poetry add fds.sdk.utils fds.sdk.AxiomaFixedIncomeOptimizer==0.21.15
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.AxiomaFixedIncomeOptimizer==0.21.15
```
...
## Documentation For Models
 ...
 - [OptimizerOptimalHoldings](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/AxiomaFixedIncomeOptimizer/v3/docs/OptimizerOptimalHoldings.md)
