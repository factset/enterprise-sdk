...
from fds.sdk.FactSetBanks import rest
from fds.sdk.FactSetBanks.configuration import Configuration
from fds.sdk.FactSetBanks.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetBanks.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetBanks/0.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BranchesApi()
        api_instance.get_branches  # this is an instance of the class Endpoint
        api_instance.get_branches()  # this invokes api_instance.get_branches.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_branches.callable or self.callable in this class
