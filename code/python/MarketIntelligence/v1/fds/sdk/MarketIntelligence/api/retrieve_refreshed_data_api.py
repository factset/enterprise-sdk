...
class RetrieveRefreshedDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_data_poll_id_result_get_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/get-data/{poll_id}/result',
                'operation_id': 'get_data_poll_id_result_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_data_poll_id_result_get(
        ...
        **kwargs
        ...
        Endpoint to retrieve raw data in JSON format for a particular Market Intelligence report.  # noqa: E501
    ...
    def get_data_poll_id_result_get_with_http_info(
        self,
        poll_id,
        **kwargs
    ) -> typing.Tuple[ReportDataHeader, int, typing.MutableMapping]:
        """Retrieve data for desired report.  # noqa: E501
    ...
    def get_data_poll_id_result_get_async(
        self,
        poll_id,
        **kwargs
    ) -> "ApplyResult[ReportDataHeader]":
        """Retrieve data for desired report.  # noqa: E501
    ...
    def get_data_poll_id_result_get_with_http_info_async(
        self,
        poll_id,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[ReportDataHeader, int, typing.MutableMapping]]":
        """Retrieve data for desired report.  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(ReportDataHeader, int, typing.Dict)]
        """
