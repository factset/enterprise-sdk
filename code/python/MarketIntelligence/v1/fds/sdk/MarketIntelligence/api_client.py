...
from fds.sdk.MarketIntelligence import rest
from fds.sdk.MarketIntelligence.configuration import Configuration
from fds.sdk.MarketIntelligence.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.MarketIntelligence.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/MarketIntelligence/0.21.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CreateReportApi()
        api_instance.create_post  # this is an instance of the class Endpoint
        api_instance.create_post()  # this invokes api_instance.create_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_post.callable or self.callable in this class
