...
from fds.sdk.FactSetNER import rest
from fds.sdk.FactSetNER.configuration import Configuration
from fds.sdk.FactSetNER.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetNER.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetNER/0.21.14 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntitiesApi()
        api_instance.post_entities_entities  # this is an instance of the class Endpoint
        api_instance.post_entities_entities()  # this invokes api_instance.post_entities_entities.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.post_entities_entities.callable or self.callable in this class
