...
with fds.sdk.FactSetNER.ApiClient(configuration) as api_client:
    ...
    # try:
    #     api_response, http_status_code, response_headers = api_instance.post_entities_entities_with_http_info(payload=payload)
    #     pprint(api_response)
    ...
    # try:
    #     async_result = api_instance.post_entities_entities_async(payload=payload)
    ...
    # try:
    #     async_result = api_instance.post_entities_entities_with_http_info_async(payload=payload)
