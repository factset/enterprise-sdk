...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.NaturalLanguageProcessing/0.23.7)](https://pypi.org/project/fds.sdk.NaturalLanguageProcessing/v/0.23.7)
...
```shell
poetry add fds.sdk.utils fds.sdk.NaturalLanguageProcessing==0.23.7
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.NaturalLanguageProcessing==0.23.7
```
