...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.NaturalLanguageProcessing/0.23.8)](https://pypi.org/project/fds.sdk.NaturalLanguageProcessing/v/0.23.8)
...
```shell
poetry add fds.sdk.utils fds.sdk.NaturalLanguageProcessing==0.23.8
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.NaturalLanguageProcessing==0.23.8
```
