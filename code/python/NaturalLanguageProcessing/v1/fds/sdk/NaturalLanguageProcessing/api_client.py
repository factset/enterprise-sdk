...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/NaturalLanguageProcessing/0.21.1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ThemesApi()
        api_instance.cognitive_nlp_v1_themes_post  # this is an instance of the class Endpoint
        api_instance.cognitive_nlp_v1_themes_post()  # this invokes api_instance.cognitive_nlp_v1_themes_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cognitive_nlp_v1_themes_post.callable or self.callable in this class
