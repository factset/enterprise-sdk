...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/NaturalLanguageProcessing/0.23.6 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.summarization_headline  # this is an instance of the class Endpoint
        api_instance.summarization_headline()  # this invokes api_instance.summarization_headline.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.summarization_headline.callable or self.callable in this class
