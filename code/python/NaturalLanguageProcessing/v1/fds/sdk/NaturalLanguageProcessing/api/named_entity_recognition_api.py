...
class NamedEntityRecognitionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ner_entities_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/ner/entities',
                'operation_id': 'ner_entities',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def ner_entities(
        ...
        **kwargs
        ...
        Detect entities (People, Places, Organizations, etc.) in plain text  # noqa: E501
    ...
    def ner_entities_with_http_info(
        self,
        **kwargs
    ...
    def ner_entities_with_http_info_async(
        self,
        **kwargs
