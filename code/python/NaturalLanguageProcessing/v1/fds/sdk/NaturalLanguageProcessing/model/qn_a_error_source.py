...
class QnAErrorSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, parameter, pointer, *args, **kwargs):  # noqa: E501
        """QnAErrorSource - a model defined in OpenAPI

        Args:
            parameter (str): A string indicating which path or URI query parameter caused the error.
            pointer (str): More details pointing to the error.
    ...
    @convert_js_args_to_python_args
    def __init__(self, parameter, pointer, *args, **kwargs):  # noqa: E501
        """QnAErrorSource - a model defined in OpenAPI
