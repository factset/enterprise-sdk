...
def lazy_import():
    ...
    globals()['QnAHTTPError'] = QnAHTTPError


class QnAHTTPErrorRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, errors, *args, **kwargs):  # noqa: E501
        """QnAHTTPErrorRoot - a model defined in OpenAPI

        Args:
            errors ([QnAHTTPError]): List of errors
