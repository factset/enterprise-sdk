...
def lazy_import():
    ...
    globals()['ThemeSentiment'] = ThemeSentiment


class ThemeSentimentsRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ThemeSentimentsRoot - a model defined in OpenAPI

        Args:
            data ([ThemeSentiment]): List of themes and their respective sentiments
