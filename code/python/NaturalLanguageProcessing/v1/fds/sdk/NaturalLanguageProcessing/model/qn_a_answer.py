...
class QnAAnswer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, answer, score, *args, **kwargs):  # noqa: E501
        """QnAAnswer - a model defined in OpenAPI

        Args:
            answer (str): The machine-generated answer to the question
            score (float): The confidence score associated to the answer
    ...
    @convert_js_args_to_python_args
    def __init__(self, answer, score, *args, **kwargs):  # noqa: E501
        """QnAAnswer - a model defined in OpenAPI
