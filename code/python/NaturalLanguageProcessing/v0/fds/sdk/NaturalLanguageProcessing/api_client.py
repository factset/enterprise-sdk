...
from fds.sdk.NaturalLanguageProcessing import rest
from fds.sdk.NaturalLanguageProcessing.configuration import Configuration
from fds.sdk.NaturalLanguageProcessing.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.NaturalLanguageProcessing.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/NaturalLanguageProcessing/0.40.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.post_advanced_ner_extraction  # this is an instance of the class Endpoint
        api_instance.post_advanced_ner_extraction()  # this invokes api_instance.post_advanced_ner_extraction.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.post_advanced_ner_extraction.callable or self.callable in this class
