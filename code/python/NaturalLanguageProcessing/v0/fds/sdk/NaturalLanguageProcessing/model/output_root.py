...
def lazy_import():
    ...
    globals()['OutputItem'] = OutputItem


class OutputRoot(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """OutputRoot - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            meta ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Includes `model`, `modelDuration`, and `taskDuration`.. [optional]  # noqa: E501
        """
