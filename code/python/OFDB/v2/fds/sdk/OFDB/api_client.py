...
from fds.sdk.OFDB import rest
from fds.sdk.OFDB.configuration import Configuration
from fds.sdk.OFDB.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.OFDB.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OFDB/0.32.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AddApi()
        api_instance.add_dates  # this is an instance of the class Endpoint
        api_instance.add_dates()  # this invokes api_instance.add_dates.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_dates.callable or self.callable in this class
