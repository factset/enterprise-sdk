...
------------- | ------------- | -------------
[**get_resource_audit**](LongRunningApi.md#get_resource_audit) | **GET** /database/{path}/audit/{id} | 
[**get_resource_bulk_delete**](LongRunningApi.md#get_resource_bulk_delete) | **GET** /database/{path}/delete/{id} | 
[**get_resource_data**](LongRunningApi.md#get_resource_data) | **GET** /database/{path}/{id} | 
[**get_resource_database**](LongRunningApi.md#get_resource_database) | **GET** /database/{id} | 
[**get_resource_date**](LongRunningApi.md#get_resource_date) | **GET** /database/{path}/dates/{date}/{id} | 
[**get_resource_dates**](LongRunningApi.md#get_resource_dates) | **GET** /database/{path}/dates/{id} | 
[**get_resource_fields**](LongRunningApi.md#get_resource_fields) | **GET** /database/{path}/fields/{id} | 
[**get_resource_stats**](LongRunningApi.md#get_resource_stats) | **GET** /database/{path}/stats/{id} | 
[**get_resource_symbol**](LongRunningApi.md#get_resource_symbol) | **GET** /database/{path}/symbols/{symbol}/{id} | 
[**get_resource_symbols**](LongRunningApi.md#get_resource_symbols) | **GET** /database/{path}/symbols/{id} | 
...
> CreateDatabase get_resource_database(path, id)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_resource_database(path, id)
