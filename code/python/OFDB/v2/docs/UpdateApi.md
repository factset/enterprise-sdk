...
# **update_dates**
> SuccessPostResponse update_dates(path, update_dates)
...
# **update_symbol**
> SuccessPostResponse update_symbol(path, symbol, update_symbol)
...
# **update_symbols**
> SuccessPostResponse update_symbols(path, update_symbols)
