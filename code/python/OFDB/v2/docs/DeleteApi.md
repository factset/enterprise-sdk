# fds.sdk.OFDB.DeleteApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_bulk_items**](DeleteApi.md#delete_bulk_items) | **POST** /database/{path}/delete | 
[**delete_date**](DeleteApi.md#delete_date) | **DELETE** /database/{path}/dates/{date} | 
[**delete_date_from_symbol**](DeleteApi.md#delete_date_from_symbol) | **DELETE** /database/{path}/dates/{date}/symbols/{symbol} | 
[**delete_symbol**](DeleteApi.md#delete_symbol) | **DELETE** /database/{path}/symbols/{symbol} | 
[**get_resource_date_from_symbol**](DeleteApi.md#get_resource_date_from_symbol) | **DELETE** /database/{path}/dates/{date}/symbols/{symbol}/jobs/{id} | 



# **delete_bulk_items**
> InlineResponse202 delete_bulk_items(path)
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import delete_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DeleteApi->delete_bulk_items: %s\n" % e)
```
 ...
 **bulk_delete** | [**BulkDelete**](BulkDelete.md)|  | [optional]
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DeleteApi->delete_date: %s\n" % e)
```
...
# **delete_date_from_symbol**
> InlineResponse202 delete_date_from_symbol(path, date, symbol)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DeleteApi->delete_date_from_symbol: %s\n" % e)
```
...
# **delete_symbol**
> InlineResponse202 delete_symbol(path, symbol)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DeleteApi->delete_symbol: %s\n" % e)
```
...
# **get_resource_date_from_symbol**
> InlineResponse202 get_resource_date_from_symbol(path, date, symbol, id)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_resource_date_from_symbol(path, date, symbol, id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling DeleteApi->get_resource_date_from_symbol: %s\n" % e)
```
