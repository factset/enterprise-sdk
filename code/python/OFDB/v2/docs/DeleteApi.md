...
[**get_resource_date_from_symbol**](DeleteApi.md#get_resource_date_from_symbol) | **DELETE** /database/{path}/dates/{date}/symbols/{symbol}/{id} | 



# **delete_bulk_items**
> InlineResponse2003 delete_bulk_items(path)
