...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.OFDB/0.33.0)](https://pypi.org/project/fds.sdk.OFDB/v/0.33.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.OFDB==0.33.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.OFDB==0.33.0
```
