...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.OFDB/0.32.2)](https://pypi.org/project/fds.sdk.OFDB/v/0.32.2)
...
```shell
poetry add fds.sdk.utils fds.sdk.OFDB==0.32.2
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.OFDB==0.32.2
```
...
*LongRunningApi* | [**get_resource_date**](https://github.com/FactSet/enterprise-sdk/tree/main/code/python/OFDB/v2/docs/LongRunningApi.md#get_resource_date) | **GET** /database/{path}/dates/{date}/{id} | 
