...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/OFDB/0.21.4'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_symbol_date  # this is an instance of the class Endpoint
        api_instance.add_symbol_date()  # this invokes api_instance.add_symbol_date.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_symbol_date.callable or self.callable in this class
