...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fds-sdk/python/OFDB/0.21.1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_database  # this is an instance of the class Endpoint
        api_instance.create_database()  # this invokes api_instance.create_database.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_database.callable or self.callable in this class
