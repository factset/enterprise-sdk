...
class ViewApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_dates_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (Dates,), 202: (InlineResponse202,), 400: (InlineResponse400,), 403: (InlineResponse403,), 404: (InlineResponse404,), 429: (InlineResponse429,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_fields_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (Fields,), 202: (InlineResponse202,), 400: (InlineResponse400,), 403: (InlineResponse403,), 404: (InlineResponse404,), 429: (InlineResponse429,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
        ...
        self.get_symbols_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 200: (Symbols,), 202: (InlineResponse202,), 400: (InlineResponse400,), 403: (InlineResponse403,), 404: (InlineResponse404,), 429: (InlineResponse429,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
