...
class CreateApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_symbol_date3_d_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'add_symbol_date3_d',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.create_database_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 201: (AddDatabase,), 202: (InlineResponse202,), 400: (InlineResponse400,), 403: (InlineResponse403,), 404: (InlineResponse404,), 429: (InlineResponse429,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
    ...
    def add_symbol_date(
        ...
        **kwargs
        ...
        Args:
            ...
            add_symbol_date (AddSymbolDate): Required data for creating date in the database. At least one iterative field is required otherwise it will throw 400.
    ...
    def add_symbol_date_with_http_info(
        self,
        path,
        add_symbol_date,
        **kwargs
    ...
    def add_symbol_date_with_http_info_async(
        self,
        path,
        add_symbol_date,
        **kwargs
    ...
    def add_symbol_date3_d(
        ...
        **kwargs
        ...
        Args:
            ...
            add_symbol_date3_d (AddSymbolDate3D): Data for creating symbol specific to a date in the database. At least one 3d field is required along with symbol.
    ...
    def add_symbol_date3_d_with_http_info_async(
        self,
        path,
        date,
        add_symbol_date3_d,
    ...
    def create_database_with_http_info(
        self,
        **kwargs
    ) -> typing.Tuple[AddDatabase, int, typing.MutableMapping]:
        """create_database  # noqa: E501
    ...
    def create_database_with_http_info_async(
        self,
        **kwargs
    ) -> "ApplyResult[typing.Tuple[AddDatabase, int, typing.MutableMapping]]":
        """create_database  # noqa: E501
        ...
        Keyword Args:
            ...
            _host_index (int/None): specifies the index of the server
                ...
                Default is read from the configuration.
        Returns:
            ApplyResult[(AddDatabase, int, typing.Dict)]
        """
        self.apply_kwargs_defaults(kwargs=kwargs, return_http_data_only=False, async_req=True)
        return self.create_database_endpoint.call_with_http_info(**kwargs)
