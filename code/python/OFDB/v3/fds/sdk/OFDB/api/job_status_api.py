...
class JobStatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_database_status_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (
                  { 201: (InlineResponse201,), 202: (InlineResponse201,), 400: (InlineResponse400,), 403: (InlineResponse403,), 404: (InlineResponse403,), 406: (InlineResponse403,), 429: (InlineResponse403,),  },
                  None
                ),
                'auth': [
                    'FactSetApiKey',
                ...
                'endpoint_path': '/database/job/status/get',
                'operation_id': 'get_database_status_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_database_status_by_id(
        self,
        job_id,
        **kwargs
    ) -> InlineResponse201:
        """get_database_status_by_id  # noqa: E501
        ...
        kwargs['job_id'] = \
            job_id
        return self.get_database_status_by_id_endpoint.call_with_http_info(**kwargs)

    def get_database_status_by_id_with_http_info(
        self,
        job_id,
        **kwargs
    ...
    def get_database_status_by_id_async(
        self,
        job_id,
        **kwargs
    ...
    def get_database_status_by_id_with_http_info_async(
        self,
        job_id,
        **kwargs
