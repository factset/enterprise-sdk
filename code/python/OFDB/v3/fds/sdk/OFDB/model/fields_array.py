...
def lazy_import():
    ...
    globals()['FieldObject'] = FieldObject


class FieldsArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FieldsArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([FieldObject]):  # noqa: E501

        Keyword Args:
            value ([FieldObject]):  # noqa: E501
