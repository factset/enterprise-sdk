# fds.sdk.OFDB.JobStatusApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_database_status_by_id**](JobStatusApi.md#get_database_status_by_id) | **GET** /database/job/status/get | 



# **get_database_status_by_id**
> InlineResponse201 get_database_status_by_id(job_id)
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import job_status_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    api_instance = job_status_api.JobStatusApi(api_client)

    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    job_id = "jobId_example" # str | jobId generated from the database endpoints.

    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_database_status_by_id(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling JobStatusApi->get_database_status_by_id: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **job_id** | **str**| jobId generated from the database endpoints. |
