# fds.sdk.OFDB.BulkDeleteApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_bulk_items**](BulkDeleteApi.md#delete_bulk_items) | **POST** /database/bulk-delete | 
[**get_resource_delete_bulk_items**](BulkDeleteApi.md#get_resource_delete_bulk_items) | **GET** /database/job/result/bulk-delete/get | 



# **delete_bulk_items**
> InlineResponse201 delete_bulk_items()
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import bulk_delete_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    api_instance = bulk_delete_api.BulkDeleteApi(api_client)

    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    bulk_delete_root = BulkDeleteRoot(
        data=BulkDeleteRootData(
            database_path="Client:/Folder1/Database.OFDB",
            content=BulkDeleteItemArray([
    ...
    ) # BulkDeleteRoot |  (optional)

    try:
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.delete_bulk_items(bulk_delete_root=bulk_delete_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling BulkDeleteApi->delete_bulk_items: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **bulk_delete_root** | [**BulkDeleteRoot**](BulkDeleteRoot.md)|  | [optional]
...
> InlineResponse2003 get_resource_delete_bulk_items(job_id)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_resource_delete_bulk_items(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling BulkDeleteApi->get_resource_delete_bulk_items: %s\n" % e)
```
