# fds.sdk.OFDB.SchemaApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_fields**](SchemaApi.md#add_fields) | **POST** /database/schema/add | 
[**create_database**](SchemaApi.md#create_database) | **POST** /database/schema/create | 
[**get_fields**](SchemaApi.md#get_fields) | **POST** /database/schema/get | 
[**get_resource_get_fields**](SchemaApi.md#get_resource_get_fields) | **GET** /database/job/result/schema/get | 



# **add_fields**
> InlineResponse201 add_fields(add_fields_root)
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import schema_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    add_fields_root = AddFieldsRoot(
        data=AddFieldsRootData(
    ...
    ) # AddFieldsRoot | Data for creating fields in the database.

    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.add_fields(add_fields_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SchemaApi->add_fields: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **add_fields_root** | [**AddFieldsRoot**](AddFieldsRoot.md)| Data for creating fields in the database. |
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    create_database_root = CreateDatabaseRoot(
        data=CreateDatabaseRootData(
            database_path="Client:/Folder1/Database.OFDB",
    ...
    ) # CreateDatabaseRoot |  (optional)

    try:
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.create_database(create_database_root=create_database_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SchemaApi->create_database: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_database_root** | [**CreateDatabaseRoot**](CreateDatabaseRoot.md)|  | [optional]
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_fields(database_path_root=database_path_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SchemaApi->get_fields: %s\n" % e)
```
...
> InlineResponse2002 get_resource_get_fields(job_id)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_resource_get_fields(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SchemaApi->get_resource_get_fields: %s\n" % e)
```
