# fds.sdk.OFDB.StatsApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_resource_get_stats**](StatsApi.md#get_resource_get_stats) | **GET** /database/job/result/stats/get | 
[**get_stats**](StatsApi.md#get_stats) | **POST** /database/stats/get | 



# **get_resource_get_stats**
> InlineResponse2001 get_resource_get_stats(job_id)
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import stats_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.get_resource_get_stats(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling StatsApi->get_resource_get_stats: %s\n" % e)
```
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_stats(database_path_root=database_path_root)
