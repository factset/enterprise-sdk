# fds.sdk.OFDB.SymbolsApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_resource_get_symbols**](SymbolsApi.md#get_resource_get_symbols) | **GET** /database/job/result/symbols/get | 
[**get_symbols**](SymbolsApi.md#get_symbols) | **POST** /database/symbols/get | 
[**replace_symbols**](SymbolsApi.md#replace_symbols) | **POST** /database/symbols/replace | 
[**update_symbols**](SymbolsApi.md#update_symbols) | **POST** /database/symbols/update | 



# **get_resource_get_symbols**
> InlineResponse2004 get_resource_get_symbols(job_id)
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import symbols_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.get_resource_get_symbols(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SymbolsApi->get_resource_get_symbols: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | Successful symbols array within database |  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  |
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        # and optional values
        api_response = api_instance.get_symbols(database_path_root=database_path_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SymbolsApi->get_symbols: %s\n" % e)
```
...
# **replace_symbols**
> InlineResponse201 replace_symbols(add_symbols_root)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    add_symbols_root = AddSymbolsRoot(
        data=AddSymbolsRootData(
            database_path="Client:/Folder1/Database.OFDB",
            content=SymbolAndContentArray([
    ...
    ) # AddSymbolsRoot | Data for creating symbol in the database

    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.replace_symbols(add_symbols_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SymbolsApi->replace_symbols: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **add_symbols_root** | [**AddSymbolsRoot**](AddSymbolsRoot.md)| Data for creating symbol in the database |
...
# **update_symbols**
> InlineResponse201 update_symbols(update_symbols_root)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    update_symbols_root = UpdateSymbolsRoot(
        data=AddSymbolsRootData(
            database_path="Client:/Folder1/Database.OFDB",
            content=SymbolAndContentArray([
                SymbolAndContentObject(
    ...
    ) # UpdateSymbolsRoot | Data for updating symbol in the database

    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.update_symbols(update_symbols_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling SymbolsApi->update_symbols: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **update_symbols_root** | [**UpdateSymbolsRoot**](UpdateSymbolsRoot.md)| Data for updating symbol in the database |
