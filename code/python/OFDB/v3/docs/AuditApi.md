# fds.sdk.OFDB.AuditApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_audit**](AuditApi.md#get_audit) | **POST** /database/audit/get | 
[**get_resource_get_audit**](AuditApi.md#get_resource_get_audit) | **GET** /database/job/result/audit/get | 



# **get_audit**
> InlineResponse201 get_audit()
...
> InlineResponse200 get_resource_get_audit(job_id)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_resource_get_audit(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling AuditApi->get_resource_get_audit: %s\n" % e)
```
