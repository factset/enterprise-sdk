# fds.sdk.OFDB.DatesApi

All URIs are relative to *https://api.factset.com/analytics/ofdb/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_dates**](DatesApi.md#get_dates) | **POST** /database/dates/get | 
[**get_resource_get_dates**](DatesApi.md#get_resource_get_dates) | **GET** /database/job/result/dates/get | 
[**replace_dates**](DatesApi.md#replace_dates) | **POST** /database/dates/replace | 
[**update_dates**](DatesApi.md#update_dates) | **POST** /database/dates/update | 



# **get_dates**
> InlineResponse201 get_dates()
...
import fds.sdk.OFDB
from fds.sdk.OFDB.api import dates_api
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # and optional values
        api_response = api_instance.get_dates(database_path_root=database_path_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling DatesApi->get_dates: %s\n" % e)
```
...
> InlineResponse2005 get_resource_get_dates(job_id)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.get_resource_get_dates(job_id)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling DatesApi->get_resource_get_dates: %s\n" % e)
```
...
# **replace_dates**
> InlineResponse201 replace_dates(add_dates_root)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    add_dates_root = AddDatesRoot(
        data=AddDatesRootData(
            database_path="Client:/Folder1/Database.OFDB",
            content=DateAndContentArray([
    ...
    ) # AddDatesRoot | Date content is required and must contain symbol and at least one iterative field

    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.replace_dates(add_dates_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling DatesApi->replace_dates: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **add_dates_root** | [**AddDatesRoot**](AddDatesRoot.md)| Date content is required and must contain symbol and at least one iterative field |
...
# **update_dates**
> InlineResponse201 update_dates(update_dates_root)
...
with fds.sdk.OFDB.ApiClient(configuration) as api_client:
    ...
    # NOTE: The following variables are just an example and may contain invalid values. Please, replace these with valid values.
    update_dates_root = UpdateDatesRoot(
        data=AddDatesRootData(
            database_path="Client:/Folder1/Database.OFDB",
            content=DateAndContentArray([
                DateAndContentObject(
    ...
    ) # UpdateDatesRoot | Required data for updating date in the database

    try:
        # example passing only required values which don't have defaults set
        api_response = api_instance.update_dates(update_dates_root)

        pprint(api_response)

    except fds.sdk.OFDB.ApiException as e:
        print("Exception when calling DatesApi->update_dates: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **update_dates_root** | [**UpdateDatesRoot**](UpdateDatesRoot.md)| Required data for updating date in the database |
