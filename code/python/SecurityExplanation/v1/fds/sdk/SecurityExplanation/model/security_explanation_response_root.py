...
def lazy_import():
    ...
    globals()['SecurityExplanationResponse'] = SecurityExplanationResponse


class SecurityExplanationResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (SecurityExplanationResponse,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SecurityExplanationResponseRoot - a model defined in OpenAPI

        Args:
            data (SecurityExplanationResponse):
        ...
        Keyword Args:
            ...
            meta ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Metadata of the response.. [optional]  # noqa: E501
        """
