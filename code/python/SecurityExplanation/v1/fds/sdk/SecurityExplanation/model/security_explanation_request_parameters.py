...
def lazy_import():
    ...
    globals()['BrokerResearchSummary'] = BrokerResearchSummary
...
class SecurityExplanationRequestParameters(ModelNormal):
    ...
    def _from_openapi_data(cls, id, start_date, end_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enable_links (bool): Include or exclude hyperlinks to underlying sources.. [optional] if omitted the server will use the default value of False  # noqa: E501
