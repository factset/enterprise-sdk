...
def lazy_import():
    ...
    globals()['SecurityExplanationRequestParameters'] = SecurityExplanationRequestParameters


class SecurityExplanationParametersRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (SecurityExplanationRequestParameters,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SecurityExplanationParametersRoot - a model defined in OpenAPI
