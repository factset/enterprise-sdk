...
def lazy_import():
    ...
    globals()['ExplanationStatus'] = ExplanationStatus


class ExplanationStatusRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ExplanationStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ExplanationStatusRoot - a model defined in OpenAPI
