...
def lazy_import():
    ...
    globals()['ExplanationCreateResponse'] = ExplanationCreateResponse


class ExplanationCreateResponseRoot(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ExplanationCreateResponse,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ExplanationCreateResponseRoot - a model defined in OpenAPI

        Args:
            data (ExplanationCreateResponse):
