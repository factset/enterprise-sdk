...
from fds.sdk.SecurityExplanation import rest
from fds.sdk.SecurityExplanation.configuration import Configuration
from fds.sdk.SecurityExplanation.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.SecurityExplanation.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/SecurityExplanation/1.1.0 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SecurityExplanationApi()
        api_instance.check_explanation_status  # this is an instance of the class Endpoint
        api_instance.check_explanation_status()  # this invokes api_instance.check_explanation_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.check_explanation_status.callable or self.callable in this class
