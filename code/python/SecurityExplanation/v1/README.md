...
[![PyPi](https://img.shields.io/pypi/v/fds.sdk.SecurityExplanation/1.0.0)](https://pypi.org/project/fds.sdk.SecurityExplanation/v/1.0.0)
...
```shell
poetry add fds.sdk.utils fds.sdk.SecurityExplanation==1.0.0
```

### pip

```shell
pip install fds.sdk.utils fds.sdk.SecurityExplanation==1.0.0
```
