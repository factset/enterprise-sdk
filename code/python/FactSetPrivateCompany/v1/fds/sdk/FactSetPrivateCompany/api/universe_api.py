...
class UniverseApi(object):
    ...
    def get_universe(
        ...
        **kwargs
        ...
        Finds the best candidate entities matching the given entity name. Country code can also be supplied to narrow the search. <p>**Max of 1 Name permitted in a single GET request.** Use the POST method to fetch up to 25 names.</p><p>   # noqa: E501
    ...
    def get_universe_for_list(
        ...
        **kwargs
        ...
        """Returns Entity Candidates and Matches for a requested list of up to 25 names and attributes.  # noqa: E501

        Finds the best candidate entities matching the given entity name. Country code can also be supplied to narrow the search. <p>**Max of 25 Names inputted.**</p><p>   # noqa: E501
        This method makes a synchronous HTTP request. Returns the http data only
