...
class FinancialsMetrics(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FinancialsMetrics - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Private Company Financials Metrics. .  # noqa: E501

        Keyword Args:
            value ([str]): Private Company Financials Metrics. .  # noqa: E501
