...
def lazy_import():
    ...
    globals()['NonPeriodicMetrics'] = NonPeriodicMetrics
    globals()['PrivateMarketIds'] = PrivateMarketIds


class NonPeriodicRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ids': (PrivateMarketIds,),  # noqa: E501
            'metrics': (NonPeriodicMetrics,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, ids, metrics, *args, **kwargs):  # noqa: E501
        """NonPeriodicRequestBody - a model defined in OpenAPI

        Args:
            ids (PrivateMarketIds):
            metrics (NonPeriodicMetrics):
