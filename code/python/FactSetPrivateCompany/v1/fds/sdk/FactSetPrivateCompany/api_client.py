...
from fds.sdk.FactSetPrivateCompany import rest
from fds.sdk.FactSetPrivateCompany.configuration import Configuration
from fds.sdk.FactSetPrivateCompany.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.sdk.FactSetPrivateCompany.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/FactSetPrivateCompany/1.0.1 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CompanyReportsApi()
        api_instance.get_financials_report  # this is an instance of the class Endpoint
        api_instance.get_financials_report()  # this invokes api_instance.get_financials_report.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_financials_report.callable or self.callable in this class
