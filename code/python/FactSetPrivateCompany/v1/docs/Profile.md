...
**total_investors** | **int, none_type** | Total number of investors for the portfolio company. | [optional] 
...
**vcpe_amount_raised_local_currency** | **float, none_type** | Current estimated total of venture capital and private equity raised in all rounds of the portfolio company. This item applies to venture capital and private equity raised rounds.    | [optional] 
