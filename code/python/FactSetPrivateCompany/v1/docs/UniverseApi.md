# fds.sdk.FactSetPrivateCompany.UniverseApi
...
[**get_universe_for_list**](UniverseApi.md#get_universe_for_list) | **POST** /universe | Returns Entity Candidates and Matches for a requested list of up to 25 names and attributes.
...
from fds.sdk.FactSetPrivateCompany.api import universe_api
...
with fds.sdk.FactSetPrivateCompany.ApiClient(configuration) as api_client:
    ...
    name = "Alto Pharmacy" # str | Name of Entity to match.<br/>  <p>***max length** =  200 per request*</p> 
    country = "US" # str | ISO2 country code corresponding to the entity name is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754). (optional)
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Name of Entity to match.&lt;br/&gt;  &lt;p&gt;***max length** &#x3D;  200 per request*&lt;/p&gt;  |
 **country** | **str**| ISO2 country code corresponding to the entity name is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754). | [optional]
