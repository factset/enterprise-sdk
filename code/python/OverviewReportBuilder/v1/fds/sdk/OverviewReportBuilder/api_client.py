...
from fds.sdk.OverviewReportBuilder import rest
from fds.sdk.OverviewReportBuilder.configuration import Configuration
from fds.sdk.OverviewReportBuilder.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = f'fds-sdk/python/OverviewReportBuilder/1.1.11 ({platform.system()}, Python {platform.python_version()})'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.current_cap_get  # this is an instance of the class Endpoint
        api_instance.current_cap_get()  # this invokes api_instance.current_cap_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.current_cap_get.callable or self.callable in this class
