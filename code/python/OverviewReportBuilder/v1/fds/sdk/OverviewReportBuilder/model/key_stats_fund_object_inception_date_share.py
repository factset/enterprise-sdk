...
def lazy_import():
    ...
    globals()['KeyStatsEntityObjectFirstDateValue'] = KeyStatsEntityObjectFirstDateValue
    globals()['KeyStatsEntityObjectRange52WeekValue'] = KeyStatsEntityObjectRange52WeekValue


class KeyStatsFundObjectInceptionDateShare(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': (KeyStatsEntityObjectFirstDateValue,),  # noqa: E501
    ...
    def _from_openapi_data(cls, value, label, *args, **kwargs):  # noqa: E501
        """KeyStatsFundObjectInceptionDateShare - a model defined in OpenAPI

        Args:
            value (KeyStatsEntityObjectFirstDateValue):
