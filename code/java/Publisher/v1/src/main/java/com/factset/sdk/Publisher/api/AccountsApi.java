...
public class AccountsApi {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Expected response, returns a list of accounts and directories </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public AccountDirectories getAccounts(String path) throws ApiException {
   ...
   * This endpoint looks up all ACCT and ACTM files and sub-directories in a given directory.
   * @param path The directory to get the accounts and sub-directories in (required)
   * @return ApiResponse&lt;AccountDirectories&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<AccountDirectories> getAccountsWithHttpInfo(String path) throws ApiException {
    ...
    String localVarPath = "/analytics/lookups/v2/accounts/{path}"
