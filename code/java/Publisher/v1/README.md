...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/publisher/0.9.4)](https://central.sonatype.com/artifact/com.factset.sdk/publisher/0.9.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:publisher:0.9.4"
  }
```
