...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/publisher/0.9.2)](https://central.sonatype.com/artifact/com.factset.sdk/publisher/0.9.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:publisher:0.9.2"
  }
```
