package com.factset.sdk.Publisher;
...
import com.factset.sdk.Publisher.auth.Authentication;
import com.factset.sdk.Publisher.auth.HttpBasicAuth;
import com.factset.sdk.Publisher.auth.HttpBearerAuth;
import com.factset.sdk.Publisher.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.Publisher.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/Publisher/0.40.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.Publisher.ApiClient} object.
   */
