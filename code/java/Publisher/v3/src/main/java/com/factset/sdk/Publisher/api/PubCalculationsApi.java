...
import com.factset.sdk.Publisher.models.CalculationStatusRoot;
import com.factset.sdk.Publisher.models.ClientErrorResponse;
import com.factset.sdk.Publisher.models.ObjectRoot;
import com.factset.sdk.Publisher.models.PubCalculationParametersRoot;
...
public class PubCalculationsApi {
 ...
 /**
  ...
  public ApiResponse<Void> cancelCalculationByIdWithHttpInfo(String id) throws ApiException {
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("PubCalculationsApi.cancelCalculationById", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<PubCalculationParametersRoot> getCalculationParametersWithHttpInfo(String id) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("PubCalculationsApi.getCalculationParameters", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<CalculationStatusRoot> getCalculationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("PubCalculationsApi.getCalculationStatusById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public ObjectRoot getCalculationUnitResultById(String id, String unitId, String accept) throws ApiException {
   ...
   */
  public ApiResponse<ObjectRoot> getCalculationUnitResultByIdWithHttpInfo(String id, String unitId, String accept) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("PubCalculationsApi.getCalculationUnitResultById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public PostAndCalculateResponseWrapper postAndCalculate(Integer xFactSetApiLongRunningDeadline, String cacheControl, PubCalculationParametersRoot pubCalculationParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<PostAndCalculateResponseWrapper> postAndCalculateWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, PubCalculationParametersRoot pubCalculationParametersRoot) throws ApiException {
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("PubCalculationsApi.postAndCalculate", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public PutAndCalculateResponseWrapper putAndCalculate(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, PubCalculationParametersRoot pubCalculationParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<PutAndCalculateResponseWrapper> putAndCalculateWithHttpInfo(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, PubCalculationParametersRoot pubCalculationParametersRoot) throws ApiException {
    Object localVarPostBody = pubCalculationParametersRoot;
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("PubCalculationsApi.putAndCalculate", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
