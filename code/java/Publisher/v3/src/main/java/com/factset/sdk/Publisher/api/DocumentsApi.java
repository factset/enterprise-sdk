...
public class DocumentsApi {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Expected response, returns a list of Publisher documents and directories </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
  ...
  public ApiResponse<DocumentDirectoriesRoot> getPubDocumentsWithHttpInfo(String path) throws ApiException {
    ...
    if (path == null) {
      throw new ApiException(400, "Missing the required parameter 'path' when calling getPubDocuments");
    }
    
    // create path and map variables
    String localVarPath = "/analytics/engines/pub/v3/documents/{path}"
