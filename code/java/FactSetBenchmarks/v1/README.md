...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetbenchmarks/3.4.1)](https://central.sonatype.com/artifact/com.factset.sdk/factsetbenchmarks/3.4.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetbenchmarks:3.4.1"
  }
```
