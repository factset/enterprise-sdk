...
public class IndexHistory implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fsymId, date, name, constituentNumber, currency, marketValue, price, priceReturnPercent, totalReturnLevel, totalReturnPercent, returnType, requestId);
  }
