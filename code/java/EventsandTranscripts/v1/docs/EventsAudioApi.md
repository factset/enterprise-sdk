...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        EventsAudioApi apiInstance = new EventsAudioApi(defaultClient);
        LocalDate startDate = LocalDate.parse("2020-10-01T00:00:00.000Z"); // LocalDate | The earliest date of the audio file the API should fetch for.  - Format: Should be absolute (YYYY-MM-DD). 
        LocalDate endDate = LocalDate.parse("2020-12-26T00:00:00.000Z"); // LocalDate | The latest date of the audio file the API should fetch for. - Format: Should be absolute (YYYY-MM-DD). 
