...
import com.factset.sdk.EventsandTranscripts.models.TranscriptObject;
...
@JsonPropertyOrder({
  Transcripts.JSON_PROPERTY_DATA,
  Transcripts.JSON_PROPERTY_META
})
...
public class Transcripts implements Serializable {
  ...
  private java.util.List<TranscriptObject> data = null;
  ...
  public Transcripts data(java.util.List<TranscriptObject> data) {
    this.data = data;
    return this;
  }

  public Transcripts addDataItem(TranscriptObject dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<TranscriptObject> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<TranscriptObject> data) {
    this.data = data;
  }


  public Transcripts meta(TranscriptsMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, transcripts.data) &&
        Objects.equals(this.meta, transcripts.meta);
  }
