...
import com.factset.sdk.EventsandTranscripts.models.ErrorExample;
...
public class Error implements Serializable {
  ...
  public Error errors(java.util.List<ErrorExample> errors) {
    this.errors = errors;
    return this;
  }

  public Error addErrorsItem(ErrorExample errorsItem) {
    if (this.errors == null) {
