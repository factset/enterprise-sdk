...
import com.factset.sdk.EventsandTranscripts.auth.Authentication;
import com.factset.sdk.EventsandTranscripts.auth.HttpBasicAuth;
import com.factset.sdk.EventsandTranscripts.auth.HttpBearerAuth;
import com.factset.sdk.EventsandTranscripts.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.EventsandTranscripts.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/EventsandTranscripts/0.21.5 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.EventsandTranscripts.ApiClient} object.
   */
