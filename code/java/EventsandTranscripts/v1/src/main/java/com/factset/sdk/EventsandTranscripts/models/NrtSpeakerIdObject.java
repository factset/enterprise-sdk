...
public class NrtSpeakerIdObject implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "The  Confidence score similarity for a particular speaker.  A score >= 0.49 while a speaker is speaking can be considered as a high confidence in the predicted speaker.  Only the speakerIDs with confidenceScore >= 0.49 are rendered in the result set.")
  @JsonIgnore
