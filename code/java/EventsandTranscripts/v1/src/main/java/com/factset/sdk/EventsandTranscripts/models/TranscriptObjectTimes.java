 ...
 */
@JsonPropertyOrder({
  TranscriptObjectTimes.JSON_PROPERTY_VERSION_ID,
  TranscriptObjectTimes.JSON_PROPERTY_PRIMARY_IDS,
  TranscriptObjectTimes.JSON_PROPERTY_ALL_IDS,
  TranscriptObjectTimes.JSON_PROPERTY_REPORT_ID,
  TranscriptObjectTimes.JSON_PROPERTY_EVENT_ID,
  TranscriptObjectTimes.JSON_PROPERTY_EVENT_DATE,
  TranscriptObjectTimes.JSON_PROPERTY_TRANSCRIPT_TYPE,
  TranscriptObjectTimes.JSON_PROPERTY_HEADLINE,
  TranscriptObjectTimes.JSON_PROPERTY_STORY_DATE_TIME,
  TranscriptObjectTimes.JSON_PROPERTY_UPLOAD_DATE_TIME,
  TranscriptObjectTimes.JSON_PROPERTY_EVENT_TYPE,
  TranscriptObjectTimes.JSON_PROPERTY_CATEGORIES,
  TranscriptObjectTimes.JSON_PROPERTY_TRANSCRIPTS_LINK
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class TranscriptObjectTimes implements Serializable {
  ...
  public TranscriptObjectTimes() { 
  }

  public TranscriptObjectTimes versionId(String versionId) {
  ...
  **/
  ...
  public TranscriptObjectTimes primaryIds(java.util.List<String> primaryIds) {
    this.primaryIds = primaryIds;
    return this;
  }

  public TranscriptObjectTimes addPrimaryIdsItem(String primaryIdsItem) {
  ...
  **/
  ...
  public TranscriptObjectTimes allIds(java.util.List<String> allIds) {
    this.allIds = allIds;
    return this;
  }

  public TranscriptObjectTimes addAllIdsItem(String allIdsItem) {
    if (this.allIds == null) {
  ...
  **/
  ...
  public TranscriptObjectTimes reportId(String reportId) {
  ...
  **/
  ...
  public TranscriptObjectTimes eventId(String eventId) {
  ...
  **/
  ...
  public TranscriptObjectTimes eventDate(LocalDate eventDate) {
  ...
  **/
  ...
  public TranscriptObjectTimes transcriptType(TranscriptTypeEnum transcriptType) {
  ...
  **/
  ...
  public TranscriptObjectTimes headline(String headline) {
  ...
  **/
  ...
  public TranscriptObjectTimes storyDateTime(OffsetDateTime storyDateTime) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Refers to either the date and time of the story, which is in UTC")
  ...
  public TranscriptObjectTimes uploadDateTime(OffsetDateTime uploadDateTime) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "It is the time when transcript is created, which is in UTC.")
  ...
  public TranscriptObjectTimes eventType(EventTypeEnum eventType) {
  ...
  **/
  ...
  public TranscriptObjectTimes categories(java.util.List<String> categories) {
    this.categories = categories;
    return this;
  }

  public TranscriptObjectTimes addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public TranscriptObjectTimes transcriptsLink(String transcriptsLink) {
  ...
  **/
  ...
  /**
   * Return true if this TranscriptObjectTimes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TranscriptObjectTimes transcriptObjectTimes = (TranscriptObjectTimes) o;
    return Objects.equals(this.versionId, transcriptObjectTimes.versionId) &&
        Objects.equals(this.primaryIds, transcriptObjectTimes.primaryIds) &&
        Objects.equals(this.allIds, transcriptObjectTimes.allIds) &&
        Objects.equals(this.reportId, transcriptObjectTimes.reportId) &&
        Objects.equals(this.eventId, transcriptObjectTimes.eventId) &&
        Objects.equals(this.eventDate, transcriptObjectTimes.eventDate) &&
        Objects.equals(this.transcriptType, transcriptObjectTimes.transcriptType) &&
        Objects.equals(this.headline, transcriptObjectTimes.headline) &&
        Objects.equals(this.storyDateTime, transcriptObjectTimes.storyDateTime) &&
        Objects.equals(this.uploadDateTime, transcriptObjectTimes.uploadDateTime) &&
        Objects.equals(this.eventType, transcriptObjectTimes.eventType) &&
        Objects.equals(this.categories, transcriptObjectTimes.categories) &&
        Objects.equals(this.transcriptsLink, transcriptObjectTimes.transcriptsLink);
  }

  @Override
  public int hashCode() {
    return Objects.hash(versionId, primaryIds, allIds, reportId, eventId, eventDate, transcriptType, headline, storyDateTime, uploadDateTime, eventType, categories, transcriptsLink);
  }
