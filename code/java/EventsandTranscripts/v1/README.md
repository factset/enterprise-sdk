...
[![API Version](https://img.shields.io/badge/api-v1.0.0-blue)](https://developer.factset.com/api-catalog/documents-distributor-callstreet-events)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:eventsandtranscripts:0.20.0"
  }
```
...
## Documentation for Models
 ...
 - [EventsAudioDailyFileNameData](docs/EventsAudioDailyFileNameData.md)
