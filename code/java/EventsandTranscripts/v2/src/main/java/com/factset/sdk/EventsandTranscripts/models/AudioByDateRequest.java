...
public class AudioByDateRequest implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "Sat Jan 01 00:00:00 UTC 2022", value = "The earliest date of the audio file the API should fetch for. - Format: Should be absolute (YYYY-MM-DD). - *Either `startDate` or `startDateRelative` should be used, but not both.* - Data available from 10th May 2011 onwards. - If dates are not provided, default will return all files. ")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Wed Jun 01 00:00:00 UTC 2022", value = "The latest date of the audio file the API should fetch for. - Format: Should be absolute (YYYY-MM-DD). - *Either `endDate` or `endDateRelative` should be used, but not both.* - If dates are not provided, default will return all files. ")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "-1", value = "The latest date of the feed file the API should fetch based on the file timestamp, relative to today. - Format: Integer ('0' for today, '-1' for yesterday, etc.). - *Either `endDate` or `endDateRelative` should be used, but not both.* - If dates are not provided, default will return all files. ")
