...
public class CompanyEventRequestDataUniverse implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"AAPL-US\",\"MSFT-US\",\"FDS-US\"]", required = true, value = "Companies to return in the response")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Tickers", required = true, value = "* Tickers: Represents individual stock symbols, unique identifiers for company shares.  * Index: Refers to market indices, tracking stock group performance as benchmarks.  * Etf: Stands for Exchange Traded Funds, traded like stocks, tracking indices or sectors.  * AllCompanies: Encompasses all publicly traded companies available for investment or analysis.")
