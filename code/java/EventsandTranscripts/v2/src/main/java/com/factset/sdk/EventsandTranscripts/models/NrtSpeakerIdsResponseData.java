 ...
 */
@JsonPropertyOrder({
  NrtSpeakerIdsResponseData.JSON_PROPERTY_AUDIO_SOURCE_ID,
  NrtSpeakerIdsResponseData.JSON_PROPERTY_SPEAKER_START_OFFSET,
  NrtSpeakerIdsResponseData.JSON_PROPERTY_SPEAKER_ID,
  NrtSpeakerIdsResponseData.JSON_PROPERTY_CONFIDENCE_SCORE,
  NrtSpeakerIdsResponseData.JSON_PROPERTY_AFFILIATION_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class NrtSpeakerIdsResponseData implements Serializable {
  ...
  public NrtSpeakerIdsResponseData() { 
  }

  public NrtSpeakerIdsResponseData audioSourceId(Integer audioSourceId) {
  ...
  **/
  ...
  public NrtSpeakerIdsResponseData speakerStartOffset(BigDecimal speakerStartOffset) {
  ...
  **/
  ...
  public NrtSpeakerIdsResponseData speakerId(String speakerId) {
  ...
  **/
  ...
  public NrtSpeakerIdsResponseData confidenceScore(BigDecimal confidenceScore) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "The confidence score indicates the similarity for a particular speaker.  A score ≥ 0.49 while a speaker is speaking is considered high confidence in the predicted speaker.  Only speaker IDs with a confidence score ≥ 0.49 are included in the result set.")
  @JsonIgnore
  ...
  public NrtSpeakerIdsResponseData affiliationId(String affiliationId) {
  ...
  **/
  ...
  /**
   * Return true if this NrtSpeakerIdsResponseData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NrtSpeakerIdsResponseData nrtSpeakerIdsResponseData = (NrtSpeakerIdsResponseData) o;
    return equalsNullable(this.audioSourceId, nrtSpeakerIdsResponseData.audioSourceId) &&
        equalsNullable(this.speakerStartOffset, nrtSpeakerIdsResponseData.speakerStartOffset) &&
        equalsNullable(this.speakerId, nrtSpeakerIdsResponseData.speakerId) &&
        equalsNullable(this.confidenceScore, nrtSpeakerIdsResponseData.confidenceScore) &&
        equalsNullable(this.affiliationId, nrtSpeakerIdsResponseData.affiliationId);
  }
