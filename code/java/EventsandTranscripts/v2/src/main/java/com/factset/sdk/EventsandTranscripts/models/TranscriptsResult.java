...
@JsonPropertyOrder({
  TranscriptsResult.JSON_PROPERTY_TRANSCRIPT_RESPONSE_TYPE,
  TranscriptsResult.JSON_PROPERTY_VERSION_ID,
  TranscriptsResult.JSON_PROPERTY_PRIMARY_IDS,
  TranscriptsResult.JSON_PROPERTY_ALL_IDS,
  TranscriptsResult.JSON_PROPERTY_REPORT_ID,
  TranscriptsResult.JSON_PROPERTY_EVENT_ID,
  TranscriptsResult.JSON_PROPERTY_EVENT_DATE,
  TranscriptsResult.JSON_PROPERTY_TRANSCRIPT_TYPE,
  TranscriptsResult.JSON_PROPERTY_HEADLINE,
  TranscriptsResult.JSON_PROPERTY_STORY_DATE_TIME,
  TranscriptsResult.JSON_PROPERTY_TIME_ZONE,
  TranscriptsResult.JSON_PROPERTY_UPLOAD_DATE_TIME,
  TranscriptsResult.JSON_PROPERTY_EVENT_TYPE,
  TranscriptsResult.JSON_PROPERTY_CATEGORIES,
  TranscriptsResult.JSON_PROPERTY_TRANSCRIPTS_URL
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class TranscriptsResult implements Serializable {
  ...
  public TranscriptsResult transcriptResponseType(TranscriptResponseTypeEnum transcriptResponseType) {
  ...
  **/
  ...
  public TranscriptsResult versionId(String versionId) {
  ...
  **/
  ...
  public TranscriptsResult primaryIds(java.util.List<String> primaryIds) {
    this.primaryIds = primaryIds;
    return this;
  }

  public TranscriptsResult addPrimaryIdsItem(String primaryIdsItem) {
  ...
  **/
  ...
  public TranscriptsResult allIds(java.util.List<String> allIds) {
    this.allIds = allIds;
    return this;
  }

  public TranscriptsResult addAllIdsItem(String allIdsItem) {
    if (this.allIds == null) {
  ...
  **/
  ...
  public TranscriptsResult reportId(String reportId) {
  ...
  **/
  ...
  public TranscriptsResult eventId(String eventId) {
  ...
  **/
  ...
  public TranscriptsResult eventDate(LocalDate eventDate) {
  ...
  **/
  ...
  public TranscriptsResult transcriptType(TranscriptTypeEnum transcriptType) {
  ...
  **/
  ...
  public TranscriptsResult headline(String headline) {
  ...
  **/
  ...
  public TranscriptsResult storyDateTime(OffsetDateTime storyDateTime) {
    this.storyDateTime = storyDateTime;
    return this;
  }
  ...
  **/
  ...
  public TranscriptsResult timeZone(String timeZone) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "America/New_York", value = "Time Zone for story dates/times (POSIX format from IANA timeZone registry). Note: The timeZone will be included in the response only for TranscriptsByTimesRequest.")
  ...
  public TranscriptsResult uploadDateTime(OffsetDateTime uploadDateTime) {
  ...
  **/
  ...
  public TranscriptsResult eventType(EventTypeEnum eventType) {
  ...
  **/
  ...
  public TranscriptsResult categories(java.util.List<String> categories) {
    this.categories = categories;
    return this;
  }

  public TranscriptsResult addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public TranscriptsResult transcriptsUrl(String transcriptsUrl) {
  ...
  **/
  ...
  /**
   * Return true if this TranscriptsResult object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TranscriptsResult transcriptsResult = (TranscriptsResult) o;
    return Objects.equals(this.transcriptResponseType, transcriptsResult.transcriptResponseType) &&
        Objects.equals(this.versionId, transcriptsResult.versionId) &&
        Objects.equals(this.primaryIds, transcriptsResult.primaryIds) &&
        Objects.equals(this.allIds, transcriptsResult.allIds) &&
        Objects.equals(this.reportId, transcriptsResult.reportId) &&
        Objects.equals(this.eventId, transcriptsResult.eventId) &&
        Objects.equals(this.eventDate, transcriptsResult.eventDate) &&
        Objects.equals(this.transcriptType, transcriptsResult.transcriptType) &&
        Objects.equals(this.headline, transcriptsResult.headline) &&
        Objects.equals(this.storyDateTime, transcriptsResult.storyDateTime) &&
        Objects.equals(this.timeZone, transcriptsResult.timeZone) &&
        Objects.equals(this.uploadDateTime, transcriptsResult.uploadDateTime) &&
        Objects.equals(this.eventType, transcriptsResult.eventType) &&
        Objects.equals(this.categories, transcriptsResult.categories) &&
        Objects.equals(this.transcriptsUrl, transcriptsResult.transcriptsUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transcriptResponseType, versionId, primaryIds, allIds, reportId, eventId, eventDate, transcriptType, headline, storyDateTime, timeZone, uploadDateTime, eventType, categories, transcriptsUrl);
  }
