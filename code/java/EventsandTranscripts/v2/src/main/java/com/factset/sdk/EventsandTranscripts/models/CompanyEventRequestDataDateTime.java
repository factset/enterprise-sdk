 ...
 */
@ApiModel(description = "Data is available from 2002.  If users provide future dates in requests, the API returns data between the specified start and end dates, subject to the maximum allowed date range.  Date range limits by universe type: - Tickers, Index, and Etf: Maximum of 365 days between start and end. - AllCompanies: Maximum of 90 days between start and end. ")
@JsonPropertyOrder({
...
public class CompanyEventRequestDataDateTime implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-12-01T00:00Z", required = true, value = "Start time of the event in ISO 8601 format.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "2022-12-31T22:59:02Z", required = true, value = "End time of the event in ISO 8601 format.")
