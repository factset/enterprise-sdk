 ...
 */
@ApiModel(description = "- Data is available from 2002. - If users provide future dates in requests, the API will return data between `start` and `end` up to 90 days. ")
@JsonPropertyOrder({
