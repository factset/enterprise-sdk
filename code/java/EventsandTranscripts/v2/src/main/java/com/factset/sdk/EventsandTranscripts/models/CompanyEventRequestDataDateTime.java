 ...
 */
@ApiModel(description = "- Data is available from November 1st, 2022. - If users provide future dates in requests, the API will return data between `start` and `end` up to 90 days. ")
@JsonPropertyOrder({
...
public class CompanyEventRequestDataDateTime implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-12-01T00:00Z", required = true, value = "Start time of the event in ISO 8601 format. The maximum `dateTime` limit between start and end is up to 90 days.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "2022-12-31T22:59:02Z", required = true, value = "End time of the event in ISO 8601 format. The maximum `dateTime` limit between start and end is up to 90 days.")
