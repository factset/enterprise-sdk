...
@JsonPropertyOrder({
  DocumentOne.JSON_PROPERTY_PRIMARY_IDS,
  DocumentOne.JSON_PROPERTY_ALL_IDS,
  DocumentOne.JSON_PROPERTY_HEADLINE,
  DocumentOne.JSON_PROPERTY_STORY_DATE_TIME,
  DocumentOne.JSON_PROPERTY_CATEGORIES,
  DocumentOne.JSON_PROPERTY_SLIDES_URL,
  DocumentOne.JSON_PROPERTY_EVENT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class DocumentOne implements Serializable {
  ...
  public static final String JSON_PROPERTY_SLIDES_URL = "slidesUrl";
  ...
  public DocumentOne primaryIds(java.util.List<String> primaryIds) {
    this.primaryIds = primaryIds;
    return this;
  }

  public DocumentOne addPrimaryIdsItem(String primaryIdsItem) {
  ...
  **/
  ...
  public DocumentOne allIds(java.util.List<String> allIds) {
    this.allIds = allIds;
    return this;
  }

  public DocumentOne addAllIdsItem(String allIdsItem) {
    if (this.allIds == null) {
  ...
  **/
  ...
  public DocumentOne headline(String headline) {
  ...
  **/
  ...
  public DocumentOne storyDateTime(OffsetDateTime storyDateTime) {
  ...
  **/
  ...
  public DocumentOne categories(java.util.List<String> categories) {
    this.categories = categories;
    return this;
  }

  public DocumentOne addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public DocumentOne slidesUrl(String slidesUrl) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "This is a URL for downloading the document with an expiration duration of 24 hours.")
  @JsonProperty(JSON_PROPERTY_SLIDES_URL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public DocumentOne eventId(String eventId) {
  ...
  **/
  ...
  /**
   * Return true if this DocumentOne object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DocumentOne documentOne = (DocumentOne) o;
    return Objects.equals(this.primaryIds, documentOne.primaryIds) &&
        Objects.equals(this.allIds, documentOne.allIds) &&
        Objects.equals(this.headline, documentOne.headline) &&
        Objects.equals(this.storyDateTime, documentOne.storyDateTime) &&
        Objects.equals(this.categories, documentOne.categories) &&
        Objects.equals(this.slidesUrl, documentOne.slidesUrl) &&
        Objects.equals(this.eventId, documentOne.eventId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryIds, allIds, headline, storyDateTime, categories, slidesUrl, eventId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentOne {\n");
    ...
    sb.append("    slidesUrl: ").append(toIndentedString(slidesUrl)).append("\n");
