...
@JsonPropertyOrder({
  ...
  TranscriptsByIdsRequest.JSON_PROPERTY_DATE_TYPE,
...
public class TranscriptsByIdsRequest implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Fri Dec 22 00:00:00 UTC 2023", value = "Start Date (YYYY-MM-DD). If dates are not provided, default will return all files. ")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Sat Dec 23 00:00:00 UTC 2023", value = "End Date (YYYY-MM-DD). If dates are not provided, default will return all files. ")
  ...
  public TranscriptsByIdsRequest dateType(DateTypeEnum dateType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.primaryId, transcriptsByIdsRequest.primaryId) &&
        ...
        Objects.equals(this.dateType, transcriptsByIdsRequest.dateType) &&
        Objects.equals(this.searchText, transcriptsByIdsRequest.searchText);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryId, ids, reportIds, categories, startDate, endDate, dateType, searchText);
  }
