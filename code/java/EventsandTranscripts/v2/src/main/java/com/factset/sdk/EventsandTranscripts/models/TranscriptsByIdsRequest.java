...
public class TranscriptsByIdsRequest implements Serializable {
  ...
  **/
  ...
  public TranscriptsByIdsRequest dateType(String dateType) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "upload", value = "Enables filtering of transcripts based on their uploadDateTime. ")
