...
public class DatesApi {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 404 </td><td> vault Document or account not found. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public DateParametersSummary convertVaultDatesToAbsoluteFormat(String enddate, String componentid, String account, String startdate) throws ApiException {
   ...
   */
  public ApiResponse<DateParametersSummary> convertVaultDatesToAbsoluteFormatWithHttpInfo(String enddate, String componentid, String account, String startdate) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'enddate' is set
    if (enddate == null) {
      throw new ApiException(400, "Missing the required parameter 'enddate' when calling convertVaultDatesToAbsoluteFormat");
    }
    
    // verify the required parameter 'componentid' is set
    if (componentid == null) {
      throw new ApiException(400, "Missing the required parameter 'componentid' when calling convertVaultDatesToAbsoluteFormat");
    }
    
    // verify the required parameter 'account' is set
    if (account == null) {
      throw new ApiException(400, "Missing the required parameter 'account' when calling convertVaultDatesToAbsoluteFormat");
    }
    
    // create path and map variables
    String localVarPath = "/analytics/lookups/v2/engines/vault/dates";
