...
public class FrequenciesApi {
  ...
  public FrequenciesApi(ApiClient apiClient) {
    ...
    private static final Map<Integer, GenericType> getVaultFrequenciesResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getVaultFrequenciesResponseTypeMap.put(200, new GenericType<java.util.Map<String, Frequency>>(){});
  }
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Expected response, returns a list of Vault frequencies. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public java.util.Map<String, Frequency> getVaultFrequencies() throws ApiException {
   ...
   */
  public ApiResponse<java.util.Map<String, Frequency>> getVaultFrequenciesWithHttpInfo() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/analytics/lookups/v2/engines/vault/frequencies";
    ...
    > apiResponse = apiClient.invokeAPI("FrequenciesApi.getVaultFrequencies", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getVaultFrequenciesResponseTypeMap, false);
