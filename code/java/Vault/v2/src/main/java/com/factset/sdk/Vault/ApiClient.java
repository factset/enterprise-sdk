...
import com.factset.sdk.Vault.auth.Authentication;
import com.factset.sdk.Vault.auth.HttpBasicAuth;
import com.factset.sdk.Vault.auth.HttpBearerAuth;
import com.factset.sdk.Vault.auth.FactSetOAuth2ClientAuth;
import com.factset.sdk.Vault.auth.ApiKeyAuth;
import com.factset.sdk.Vault.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap, OAuth2Client oauth2Client) {
    ...
    setUserAgent("fds-sdk/java/Vault/0.8.1");
   ...
   * @return this instance of {@link com.factset.sdk.Vault.ApiClient} object.
   */
