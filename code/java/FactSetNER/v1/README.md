...
```groovy
  ...
  dependencies {
     implementation "com.factset.sdk:factsetner:0.8.0"
  }
```
...
------------ | ------------- | ------------- | -------------
*EntitiesApi* | [**postEntitiesEntities**](docs/EntitiesApi.md#postEntitiesEntities) | **POST** /cognitive/ner/v1/entities | 
