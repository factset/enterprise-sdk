...
public class EntitiesApi {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 401 </td><td> Error: Unauthorized </td><td>  -  </td></tr>
       <tr><td> 500 </td><td> Server-side Error </td><td>  -  </td></tr>
     </table>
   */
  public Response postEntitiesEntities(Input payload) throws ApiException {
   ...
   */
  public ApiResponse<Response> postEntitiesEntitiesWithHttpInfo(Input payload) throws ApiException {
    Object localVarPostBody = payload;
    
    // verify the required parameter 'payload' is set
    if (payload == null) {
      throw new ApiException(400, "Missing the required parameter 'payload' when calling postEntitiesEntities");
    }
    
    // create path and map variables
    String localVarPath = "/cognitive/ner/v2/entities";
