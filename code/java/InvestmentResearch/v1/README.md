...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/investmentresearch/2.0.0)](https://central.sonatype.com/artifact/com.factset.sdk/investmentresearch/2.0.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:investmentresearch:2.0.0"
  }
```
...
*ResearchApi* | [**getPurchaseLinks**](docs/ResearchApi.md#getPurchaseLinks) | **POST** /purchase-amr | Retrieve purchase links and metadata for specified research documents.
...
## Documentation for Models
 ...
 - [CountSource](docs/CountSource.md)
 ...
 - [PurchaseDocument](docs/PurchaseDocument.md)
 ...
 - [PurchaseResponseItems](docs/PurchaseResponseItems.md)
