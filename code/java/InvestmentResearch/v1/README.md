...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/investmentresearch/1.0.0)](https://central.sonatype.com/artifact/com.factset.sdk/investmentresearch/1.0.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:investmentresearch:1.0.0"
  }
```
