...
------------ | ------------- | ------------- | -------------
**ids** | **java.util.List&lt;String&gt;** | Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol, CUSIP, ISIN, Entity ID and SEDOL. &gt; **Note:** If this parameter is not provided, response should not include the requestId field. |  [optional]
...
**sources** | [**java.util.List&lt;SourcesEnum&gt;**](#java.util.List&lt;SourcesEnum&gt;) | Code for document source to include. Available values:    * **FRC**: FactSet Research Connect   * **AMR**: Aftermarket Research |  [optional]
...
## Enum: java.util.List&lt;SourcesEnum&gt;
