...
public class SearchRequestBody implements Serializable {
  ...
  private java.util.List<SourcesEnum> sources = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"MODN-US\"]", value = "Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol, CUSIP, ISIN, Entity ID and SEDOL. > **Note:** If this parameter is not provided, response should not include the requestId field.")
  ...
  **/
  ...
  public SearchRequestBody sources(java.util.List<SourcesEnum> sources) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Code for document source to include. Available values:    * **FRC**: FactSet Research Connect   * **AMR**: Aftermarket Research")
  @JsonProperty(JSON_PROPERTY_SOURCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<SourcesEnum> getSources() {
    return sources;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SOURCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSources(java.util.List<SourcesEnum> sources) {
    this.sources = sources;
  }
