...
import com.factset.sdk.InvestmentResearch.models.CountSource;
 ...
 */
@ApiModel(description = "Count request body elements")
@JsonPropertyOrder({
  CountRequestBody.JSON_PROPERTY_IDS,
  CountRequestBody.JSON_PROPERTY_START_DATE,
  CountRequestBody.JSON_PROPERTY_END_DATE,
  CountRequestBody.JSON_PROPERTY_START_DATE_RELATIVE,
  CountRequestBody.JSON_PROPERTY_END_DATE_RELATIVE,
  CountRequestBody.JSON_PROPERTY_SOURCE,
  CountRequestBody.JSON_PROPERTY_TIMEZONE,
  CountRequestBody.JSON_PROPERTY_CATEGORIES,
  CountRequestBody.JSON_PROPERTY_PRIMARY_ID,
  CountRequestBody.JSON_PROPERTY_SEARCH_TEXT,
  CountRequestBody.JSON_PROPERTY_CONTRIBUTOR_ID,
  CountRequestBody.JSON_PROPERTY_ANALYST_ID,
  CountRequestBody.JSON_PROPERTY_REPORT_FOCI,
  CountRequestBody.JSON_PROPERTY_SECURITY_TYPES,
  CountRequestBody.JSON_PROPERTY_ASSET_TYPES,
  CountRequestBody.JSON_PROPERTY_ASSET_CLASSES,
  CountRequestBody.JSON_PROPERTY_COVERAGE_ACTIONS,
  CountRequestBody.JSON_PROPERTY_COMPILATION_INDICATORS,
  CountRequestBody.JSON_PROPERTY_DISCIPLINES,
  CountRequestBody.JSON_PROPERTY_ISSUER_TYPES,
  CountRequestBody.JSON_PROPERTY_PERIODICITIES,
  CountRequestBody.JSON_PROPERTY_PURPOSES,
  CountRequestBody.JSON_PROPERTY_RATING_ACTIONS,
  CountRequestBody.JSON_PROPERTY_RESEARCH_APPROACHES,
  CountRequestBody.JSON_PROPERTY_TARGET_ACTIONS,
  CountRequestBody.JSON_PROPERTY_WEIGHTING_ACTIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class CountRequestBody implements Serializable {
  ...
  public CountRequestBody ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public CountRequestBody addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"MODN-US\"]", value = "Requested symbols or securities.  This is a comma-separated list with a maximum limit of 10.  Each symbol can be a FactSet exchange symbol, CUSIP, ISIN, Entity ID and SEDOL. > **Note:** If this parameter is not provided, response should not include the requestId field.")
  ...
  public CountRequestBody startDate(LocalDate startDate) {
  ...
  **/
  ...
  public CountRequestBody endDate(LocalDate endDate) {
  ...
  **/
  ...
  public CountRequestBody startDateRelative(Integer startDateRelative) {
  ...
  **/
  ...
  public CountRequestBody endDateRelative(Integer endDateRelative) {
  ...
  **/
  ...
  public CountRequestBody source(CountSource source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSource(CountSource source) {
    this.source = source;
  }


  public CountRequestBody timezone(String timezone) {
  ...
  **/
  ...
  public CountRequestBody categories(java.util.List<String> categories) {
    this.categories = categories;
    return this;
  }

  public CountRequestBody addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public CountRequestBody primaryId(Boolean primaryId) {
  ...
  **/
  ...
  public CountRequestBody searchText(String searchText) {
  ...
  **/
  ...
  public CountRequestBody contributorId(java.util.List<Integer> contributorId) {
    this.contributorId = contributorId;
    return this;
  }

  public CountRequestBody addContributorIdItem(Integer contributorIdItem) {
  ...
  **/
  ...
  public CountRequestBody analystId(java.util.List<Integer> analystId) {
    this.analystId = analystId;
    return this;
  }

  public CountRequestBody addAnalystIdItem(Integer analystIdItem) {
  ...
  **/
  ...
  public CountRequestBody reportFoci(java.util.Set<ReportFociEnum> reportFoci) {
    this.reportFoci = reportFoci;
    return this;
  }

  public CountRequestBody addReportFociItem(ReportFociEnum reportFociItem) {
  ...
  **/
  ...
  public CountRequestBody securityTypes(java.util.List<String> securityTypes) {
    this.securityTypes = securityTypes;
    return this;
  }

  public CountRequestBody addSecurityTypesItem(String securityTypesItem) {
  ...
  **/
  ...
  public CountRequestBody assetTypes(java.util.List<String> assetTypes) {
    this.assetTypes = assetTypes;
    return this;
  }

  public CountRequestBody addAssetTypesItem(String assetTypesItem) {
  ...
  **/
  ...
  public CountRequestBody assetClasses(java.util.Set<AssetClassesEnum> assetClasses) {
    this.assetClasses = assetClasses;
    return this;
  }

  public CountRequestBody addAssetClassesItem(AssetClassesEnum assetClassesItem) {
  ...
  **/
  ...
  public CountRequestBody coverageActions(java.util.Set<CoverageActionsEnum> coverageActions) {
    this.coverageActions = coverageActions;
    return this;
  }

  public CountRequestBody addCoverageActionsItem(CoverageActionsEnum coverageActionsItem) {
  ...
  **/
  ...
  public CountRequestBody compilationIndicators(Boolean compilationIndicators) {
  ...
  **/
  ...
  public CountRequestBody disciplines(java.util.Set<DisciplinesEnum> disciplines) {
    this.disciplines = disciplines;
    return this;
  }

  public CountRequestBody addDisciplinesItem(DisciplinesEnum disciplinesItem) {
  ...
  **/
  ...
  public CountRequestBody issuerTypes(java.util.Set<IssuerTypesEnum> issuerTypes) {
    this.issuerTypes = issuerTypes;
    return this;
  }

  public CountRequestBody addIssuerTypesItem(IssuerTypesEnum issuerTypesItem) {
  ...
  **/
  ...
  public CountRequestBody periodicities(java.util.Set<PeriodicitiesEnum> periodicities) {
    this.periodicities = periodicities;
    return this;
  }

  public CountRequestBody addPeriodicitiesItem(PeriodicitiesEnum periodicitiesItem) {
  ...
  **/
  ...
  public CountRequestBody purposes(java.util.Set<PurposesEnum> purposes) {
    this.purposes = purposes;
    return this;
  }

  public CountRequestBody addPurposesItem(PurposesEnum purposesItem) {
  ...
  **/
  ...
  public CountRequestBody ratingActions(java.util.Set<RatingActionsEnum> ratingActions) {
    this.ratingActions = ratingActions;
    return this;
  }

  public CountRequestBody addRatingActionsItem(RatingActionsEnum ratingActionsItem) {
  ...
  **/
  ...
  public CountRequestBody researchApproaches(java.util.Set<ResearchApproachesEnum> researchApproaches) {
    this.researchApproaches = researchApproaches;
    return this;
  }

  public CountRequestBody addResearchApproachesItem(ResearchApproachesEnum researchApproachesItem) {
  ...
  **/
  ...
  public CountRequestBody targetActions(java.util.Set<TargetActionsEnum> targetActions) {
    this.targetActions = targetActions;
    return this;
  }

  public CountRequestBody addTargetActionsItem(TargetActionsEnum targetActionsItem) {
  ...
  **/
  ...
  public CountRequestBody weightingActions(java.util.Set<WeightingActionsEnum> weightingActions) {
    this.weightingActions = weightingActions;
    return this;
  }

  public CountRequestBody addWeightingActionsItem(WeightingActionsEnum weightingActionsItem) {
  ...
  **/
  ...
  /**
   * Return true if this CountRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CountRequestBody countRequestBody = (CountRequestBody) o;
    return Objects.equals(this.ids, countRequestBody.ids) &&
        Objects.equals(this.startDate, countRequestBody.startDate) &&
        Objects.equals(this.endDate, countRequestBody.endDate) &&
        Objects.equals(this.startDateRelative, countRequestBody.startDateRelative) &&
        Objects.equals(this.endDateRelative, countRequestBody.endDateRelative) &&
        Objects.equals(this.source, countRequestBody.source) &&
        Objects.equals(this.timezone, countRequestBody.timezone) &&
        Objects.equals(this.categories, countRequestBody.categories) &&
        Objects.equals(this.primaryId, countRequestBody.primaryId) &&
        Objects.equals(this.searchText, countRequestBody.searchText) &&
        Objects.equals(this.contributorId, countRequestBody.contributorId) &&
        Objects.equals(this.analystId, countRequestBody.analystId) &&
        Objects.equals(this.reportFoci, countRequestBody.reportFoci) &&
        Objects.equals(this.securityTypes, countRequestBody.securityTypes) &&
        Objects.equals(this.assetTypes, countRequestBody.assetTypes) &&
        Objects.equals(this.assetClasses, countRequestBody.assetClasses) &&
        Objects.equals(this.coverageActions, countRequestBody.coverageActions) &&
        Objects.equals(this.compilationIndicators, countRequestBody.compilationIndicators) &&
        Objects.equals(this.disciplines, countRequestBody.disciplines) &&
        Objects.equals(this.issuerTypes, countRequestBody.issuerTypes) &&
        Objects.equals(this.periodicities, countRequestBody.periodicities) &&
        Objects.equals(this.purposes, countRequestBody.purposes) &&
        Objects.equals(this.ratingActions, countRequestBody.ratingActions) &&
        Objects.equals(this.researchApproaches, countRequestBody.researchApproaches) &&
        Objects.equals(this.targetActions, countRequestBody.targetActions) &&
        Objects.equals(this.weightingActions, countRequestBody.weightingActions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, startDate, endDate, startDateRelative, endDateRelative, source, timezone, categories, primaryId, searchText, contributorId, analystId, reportFoci, securityTypes, assetTypes, assetClasses, coverageActions, compilationIndicators, disciplines, issuerTypes, periodicities, purposes, ratingActions, researchApproaches, targetActions, weightingActions);
  }
