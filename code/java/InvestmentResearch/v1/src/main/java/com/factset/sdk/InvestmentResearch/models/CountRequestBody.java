...
public class CountRequestBody implements Serializable {
  ...
  **/
  ...
  public CountRequestBody source(String source) {
    this.source = source;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "FRC", value = "Code for document source to include. Available value:-     * FRC - FactSet Research Connect")
