...
import com.factset.sdk.InvestmentResearch.api.ResearchApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ResearchApi apiInstance = new ResearchApi(defaultClient);
        CountRequest countRequest = new CountRequest(); // CountRequest | 
        try {
            CountResponse result = apiInstance.getCount(countRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ResearchApi#getCount");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ResearchApi#getInvestmentResearchData");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
