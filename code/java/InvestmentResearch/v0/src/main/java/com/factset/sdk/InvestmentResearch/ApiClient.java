...
import com.factset.sdk.InvestmentResearch.auth.Authentication;
import com.factset.sdk.InvestmentResearch.auth.HttpBasicAuth;
import com.factset.sdk.InvestmentResearch.auth.HttpBearerAuth;
import com.factset.sdk.InvestmentResearch.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.InvestmentResearch.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/content/investment-research/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/content/investment-research/v0",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/InvestmentResearch/0.1.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.InvestmentResearch.ApiClient} object.
   */
