...
import com.factset.sdk.InvestmentResearch.models.ResearchAnalystResponseObject;
 ...
 */
@ApiModel(description = "List of individual research analysts associated with authored research documents.")
@JsonPropertyOrder({
  ResearchAnalystResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class ResearchAnalystResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<ResearchAnalystResponseObject> data = null;

  public ResearchAnalystResponse() { 
  }

  public ResearchAnalystResponse data(java.util.List<ResearchAnalystResponseObject> data) {
    this.data = data;
    return this;
  }

  public ResearchAnalystResponse addDataItem(ResearchAnalystResponseObject dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of research analyst records.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<ResearchAnalystResponseObject> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<ResearchAnalystResponseObject> data) {
    this.data = data;
  }


  /**
   * Return true if this ResearchAnalystResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResearchAnalystResponse researchAnalystResponse = (ResearchAnalystResponse) o;
    return Objects.equals(this.data, researchAnalystResponse.data);
  }
