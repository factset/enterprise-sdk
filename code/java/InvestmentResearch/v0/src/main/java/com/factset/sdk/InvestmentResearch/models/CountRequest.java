...
import com.factset.sdk.InvestmentResearch.models.CountRequestBody;
...
@JsonPropertyOrder({
  CountRequest.JSON_PROPERTY_DATA
})
...
public class CountRequest implements Serializable {
  ...
  @JsonCreator
  public CountRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) CountRequestBody data
  ) {
    this();
    this.data = data;
  }

  public CountRequest data(CountRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public CountRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(CountRequestBody data) {
    this.data = data;
  }


  /**
   * Return true if this CountRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CountRequest countRequest = (CountRequest) o;
    return Objects.equals(this.data, countRequest.data);
  }
