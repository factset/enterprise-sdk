...
import com.factset.sdk.IDLookup.models.LookupResponseMeta;
...
@JsonPropertyOrder({
  LookupResponse.JSON_PROPERTY_DATA,
  LookupResponse.JSON_PROPERTY_META
})
...
public class LookupResponse implements Serializable {
  ...
  private java.util.List<ResponseDetails> data = new java.util.ArrayList<>();

  public static final String JSON_PROPERTY_META = "meta";
  private LookupResponseMeta meta;
  ...
  @JsonCreator
  public LookupResponse(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.List<ResponseDetails> data
  ) {
    this();
    this.data = data;
  }

  public LookupResponse data(java.util.List<ResponseDetails> data) {
    this.data = data;
    return this;
  }

  public LookupResponse addDataItem(ResponseDetails dataItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Array of Lookup details for the query")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public java.util.List<ResponseDetails> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(java.util.List<ResponseDetails> data) {
    this.data = data;
  }


  public LookupResponse meta(LookupResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public LookupResponseMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(LookupResponseMeta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, lookupResponse.data) &&
        Objects.equals(this.meta, lookupResponse.meta);
  }
