...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/idlookup/1.0.4)](https://central.sonatype.com/artifact/com.factset.sdk/idlookup/1.0.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:idlookup:1.0.4"
  }
```
