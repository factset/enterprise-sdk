...
import com.factset.sdk.GIPS.Configuration;
...
> CalculationsSummaryRoot gipsGetAllCalculations(pageNumber)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        GipsCalculationsApi apiInstance = new GipsCalculationsApi(defaultClient);
        Integer pageNumber = 1; // Integer | Page number to be viewed
        try {
            CalculationsSummaryRoot result = apiInstance.gipsGetAllCalculations(pageNumber);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling GipsCalculationsApi#gipsGetAllCalculations");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pageNumber** | **Integer**| Page number to be viewed | [optional] [default to 1]
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String id = "id_example"; // String | from url, provided from the location header in the Create and Run GIPS calculation endpoint
        try {
            CalculationStatusRoot result = apiInstance.gipsGetCalculationStatusById(id);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling GipsCalculationsApi#gipsGetCalculationStatusById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **201** | Expected response once calculation is completed. |  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  |
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        GipsCalculationsApi apiInstance = new GipsCalculationsApi(defaultClient);
        String id = "id_example"; // String | from url, provided from the location header in the Get GIPS calculation status by id endpoint
        String unitId = "unitId_example"; // String | from url, provided from the location header in the Get GIPS calculation status by id endpoint
        try {
            FactSetProtobufStachV3StachV3Table result = apiInstance.gipsGetCalculationUnitResultById(id, unitId);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling GipsCalculationsApi#gipsGetCalculationUnitResultById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CalculationStatusRoot gipsPostAndCalculate(xFactSetApiLongRunningDeadline, cacheControl, giPSCalculationParametersRoot)

Create and Run GIPS calculation

This endpoint runs the GIPS calculation specified in the POST body parameters.
It can take upto 2 units.

Remarks:

*	Any settings in POST body will act as a one-time override over the settings saved in the GIPS template.
Use this endpoint to trigger calculation requests.
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        GipsCalculationsApi apiInstance = new GipsCalculationsApi(defaultClient);
        Integer xFactSetApiLongRunningDeadline = 20; // Integer | The number of seconds the request will wait before sending back the response. If not provided, 20 will be used as default.
        String cacheControl = "max-stale=0"; // String | Standard HTTP header.  Accepts max-stale.
        GIPSCalculationParametersRoot giPSCalculationParametersRoot = new GIPSCalculationParametersRoot(); // GIPSCalculationParametersRoot | The request body contains the information needed to run a calculation, e.g. the GIPS composite. See the schema for more details.
        try {
            CalculationStatusRoot result = apiInstance.gipsPostAndCalculate(xFactSetApiLongRunningDeadline, cacheControl, giPSCalculationParametersRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling GipsCalculationsApi#gipsPostAndCalculate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **xFactSetApiLongRunningDeadline** | **Integer**| The number of seconds the request will wait before sending back the response. If not provided, 20 will be used as default. | [optional]
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **201** | Expected response if the calculation has one unit and is completed in a short span, or returns cached results returns. |  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  |
