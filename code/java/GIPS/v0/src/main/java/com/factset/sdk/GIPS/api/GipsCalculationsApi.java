...
import com.factset.sdk.GIPS.models.APIClientErrorResponse;
import com.factset.sdk.GIPS.models.CalculationStatusRoot;
import com.factset.sdk.GIPS.models.CalculationsSummaryRoot;
import com.factset.sdk.GIPS.models.FactSetProtobufStachV3StachV3Table;
import com.factset.sdk.GIPS.models.GIPSCalculationParametersRoot;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GipsCalculationsApi {
  private ApiClient apiClient;

  public GipsCalculationsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public GipsCalculationsApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> cancelCalculationByIdResponseTypeMap = new HashMap<Integer, GenericType>();

  private static final Map<Integer, GenericType> gipsGetAllCalculationsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    gipsGetAllCalculationsResponseTypeMap.put(200, new GenericType<CalculationsSummaryRoot>(){});
    gipsGetAllCalculationsResponseTypeMap.put(400, new GenericType<APIClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> gipsGetCalculationStatusByIdResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    gipsGetCalculationStatusByIdResponseTypeMap.put(201, new GenericType<CalculationStatusRoot>(){});
    gipsGetCalculationStatusByIdResponseTypeMap.put(202, new GenericType<CalculationStatusRoot>(){});
    gipsGetCalculationStatusByIdResponseTypeMap.put(404, new GenericType<APIClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> gipsGetCalculationUnitResultByIdResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    gipsGetCalculationUnitResultByIdResponseTypeMap.put(200, new GenericType<FactSetProtobufStachV3StachV3Table>(){});
    gipsGetCalculationUnitResultByIdResponseTypeMap.put(404, new GenericType<APIClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> gipsPostAndCalculateResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    gipsPostAndCalculateResponseTypeMap.put(201, new GenericType<CalculationStatusRoot>(){});
    gipsPostAndCalculateResponseTypeMap.put(202, new GenericType<CalculationStatusRoot>(){});
    gipsPostAndCalculateResponseTypeMap.put(400, new GenericType<APIClientErrorResponse>(){});
    gipsPostAndCalculateResponseTypeMap.put(404, new GenericType<APIClientErrorResponse>(){});
    gipsPostAndCalculateResponseTypeMap.put(429, new GenericType<APIClientErrorResponse>(){});
  }
   ...
   * @param id from url, provided from the location header in the Create and Run GIPS calculation endpoint (required)
  ...
  public ApiResponse<Void> cancelCalculationByIdWithHttpInfo(String id) throws ApiException {
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("GipsCalculationsApi.cancelCalculationById", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
   ...
   * @param pageNumber Page number to be viewed (optional, default to 1)
   ...
   */
  public CalculationsSummaryRoot gipsGetAllCalculations(Integer pageNumber) throws ApiException {
    return gipsGetAllCalculationsWithHttpInfo(pageNumber).getData();
  }
   ...
   */
  public ApiResponse<CalculationsSummaryRoot> gipsGetAllCalculationsWithHttpInfo(Integer pageNumber) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("GipsCalculationsApi.gipsGetAllCalculations", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, gipsGetAllCalculationsResponseTypeMap, false);
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 201 </td><td> Expected response once calculation is completed. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public CalculationStatusRoot gipsGetCalculationStatusById(String id) throws ApiException {
    return gipsGetCalculationStatusByIdWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<CalculationStatusRoot> gipsGetCalculationStatusByIdWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling gipsGetCalculationStatusById");
    }
    ...
    > apiResponse = apiClient.invokeAPI("GipsCalculationsApi.gipsGetCalculationStatusById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, gipsGetCalculationStatusByIdResponseTypeMap, false);
   ...
   * @param id from url, provided from the location header in the Get GIPS calculation status by id endpoint (required)
   * @param unitId from url, provided from the location header in the Get GIPS calculation status by id endpoint (required)
   * @return FactSetProtobufStachV3StachV3Table
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public FactSetProtobufStachV3StachV3Table gipsGetCalculationUnitResultById(String id, String unitId) throws ApiException {
    return gipsGetCalculationUnitResultByIdWithHttpInfo(id, unitId).getData();
  }
   ...
   * @param id from url, provided from the location header in the Get GIPS calculation status by id endpoint (required)
   * @param unitId from url, provided from the location header in the Get GIPS calculation status by id endpoint (required)
   * @return ApiResponse&lt;FactSetProtobufStachV3StachV3Table&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<FactSetProtobufStachV3StachV3Table> gipsGetCalculationUnitResultByIdWithHttpInfo(String id, String unitId) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling gipsGetCalculationUnitResultById");
    }
    
    // verify the required parameter 'unitId' is set
    if (unitId == null) {
      throw new ApiException(400, "Missing the required parameter 'unitId' when calling gipsGetCalculationUnitResultById");
    }
    ...
    final String[] localVarAccepts = {
      "application/stach.v3+json", "application/json"
    };
    final String localVarAccept = apiClient.selectHeaderAccept(localVarAccepts);
    ...
    > apiResponse = apiClient.invokeAPI("GipsCalculationsApi.gipsGetCalculationUnitResultById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, gipsGetCalculationUnitResultByIdResponseTypeMap, false);
   ...
   * @param xFactSetApiLongRunningDeadline The number of seconds the request will wait before sending back the response. If not provided, 20 will be used as default. (optional)
   * @param cacheControl Standard HTTP header.  Accepts max-stale. (optional)
   * @param giPSCalculationParametersRoot The request body contains the information needed to run a calculation, e.g. the GIPS composite. See the schema for more details. (optional)
   * @return CalculationStatusRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 201 </td><td> Expected response if the calculation has one unit and is completed in a short span, or returns cached results returns. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public CalculationStatusRoot gipsPostAndCalculate(Integer xFactSetApiLongRunningDeadline, String cacheControl, GIPSCalculationParametersRoot giPSCalculationParametersRoot) throws ApiException {
    return gipsPostAndCalculateWithHttpInfo(xFactSetApiLongRunningDeadline, cacheControl, giPSCalculationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<CalculationStatusRoot> gipsPostAndCalculateWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, GIPSCalculationParametersRoot giPSCalculationParametersRoot) throws ApiException {
    Object localVarPostBody = giPSCalculationParametersRoot;
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("GipsCalculationsApi.gipsPostAndCalculate", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, gipsPostAndCalculateResponseTypeMap, false);
