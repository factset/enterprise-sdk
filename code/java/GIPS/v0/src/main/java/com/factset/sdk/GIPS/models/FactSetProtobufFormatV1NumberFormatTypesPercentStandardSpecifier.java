 ...
 */
@JsonPropertyOrder({
  FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.JSON_PROPERTY_DECIMAL_DIGITS,
  FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.JSON_PROPERTY_DECIMAL_SEPARATOR,
  FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.JSON_PROPERTY_GROUP_SEPARATOR,
  FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.JSON_PROPERTY_GROUP_SIZES,
  FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.JSON_PROPERTY_NEGATIVE_PATTERN,
  FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.JSON_PROPERTY_POSITIVE_PATTERN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier implements Serializable {
  ...
  public FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier() { 
  }
  ...
  public FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier decimalDigits(Integer decimalDigits) {
  ...
  **/
  ...
  public FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier decimalSeparator(String decimalSeparator) {
  ...
  **/
  ...
  public FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier groupSeparator(String groupSeparator) {
  ...
  **/
  ...
  public FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier negativePattern(String negativePattern) {
  ...
  **/
  ...
  public FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier positivePattern(String positivePattern) {
  ...
  **/
  ...
  /**
   * Return true if this FactSet.Protobuf.Format.V1.NumberFormat.Types.PercentStandardSpecifier object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier = (FactSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier) o;
    return Objects.equals(this.decimalDigits, factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.decimalDigits) &&
        equalsNullable(this.decimalSeparator, factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.decimalSeparator) &&
        equalsNullable(this.groupSeparator, factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.groupSeparator) &&
        equalsNullable(this.groupSizes, factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.groupSizes) &&
        equalsNullable(this.negativePattern, factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.negativePattern) &&
        equalsNullable(this.positivePattern, factSetProtobufFormatV1NumberFormatTypesPercentStandardSpecifier.positivePattern);
  }
