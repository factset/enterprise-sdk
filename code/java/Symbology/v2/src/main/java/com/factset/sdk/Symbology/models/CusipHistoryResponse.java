...
import com.factset.sdk.Symbology.models.CusipHistoryTranslation;
...
@JsonPropertyOrder({
  CusipHistoryResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CusipHistoryResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<CusipHistoryTranslation> data = null;

  public CusipHistoryResponse() { 
  }

  public CusipHistoryResponse data(java.util.List<CusipHistoryTranslation> data) {
    this.data = data;
    return this;
  }

  public CusipHistoryResponse addDataItem(CusipHistoryTranslation dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<CusipHistoryTranslation> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<CusipHistoryTranslation> data) {
    this.data = data;
  }


  /**
   * Return true if this cusipHistoryResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CusipHistoryResponse cusipHistoryResponse = (CusipHistoryResponse) o;
    return Objects.equals(this.data, cusipHistoryResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CusipHistoryResponse {\n");
