...
import com.factset.sdk.Symbology.models.IsinTranslation;
...
@JsonPropertyOrder({
  IsinTranslationResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class IsinTranslationResponse implements Serializable {
  ...
  public IsinTranslationResponse addDataItem(IsinTranslation dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<IsinTranslation> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<IsinTranslation> data) {
    this.data = data;
  }


  /**
   * Return true if this isinTranslationResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IsinTranslationResponse isinTranslationResponse = (IsinTranslationResponse) o;
    return Objects.equals(this.data, isinTranslationResponse.data);
  }
