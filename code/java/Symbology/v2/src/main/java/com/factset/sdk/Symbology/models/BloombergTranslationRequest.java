 ...
 */
@ApiModel(description = "Request object for Bloomberg Translation endpoint.")
@JsonPropertyOrder({
  BloombergTranslationRequest.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class BloombergTranslationRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<String> ids = new java.util.ArrayList<>();

  public BloombergTranslationRequest() { 
  }
  ...
  public BloombergTranslationRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public BloombergTranslationRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  /**
   * Return true if this bloombergTranslationRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BloombergTranslationRequest bloombergTranslationRequest = (BloombergTranslationRequest) o;
    return Objects.equals(this.ids, bloombergTranslationRequest.ids);
  }
