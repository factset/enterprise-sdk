...
@JsonPropertyOrder({
  FactsetTranslationRequest.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class FactsetTranslationRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<String> ids = new java.util.ArrayList<>();

  public FactsetTranslationRequest() { 
  }
  ...
  public FactsetTranslationRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public FactsetTranslationRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  /**
   * Return true if this factsetTranslationRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FactsetTranslationRequest factsetTranslationRequest = (FactsetTranslationRequest) o;
    return Objects.equals(this.ids, factsetTranslationRequest.ids);
  }
