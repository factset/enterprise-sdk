...
import com.factset.sdk.Symbology.models.SedolTranslation;
...
@JsonPropertyOrder({
  SedolTranslationResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class SedolTranslationResponse implements Serializable {
  ...
  public SedolTranslationResponse addDataItem(SedolTranslation dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<SedolTranslation> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<SedolTranslation> data) {
    this.data = data;
  }


  /**
   * Return true if this sedolTranslationResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SedolTranslationResponse sedolTranslationResponse = (SedolTranslationResponse) o;
    return Objects.equals(this.data, sedolTranslationResponse.data);
  }
