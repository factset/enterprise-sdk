...
import com.factset.sdk.Symbology.models.BloombergTranslation;
 ...
 */
@ApiModel(description = "Response object for Symbol Translation endpoint.")
@JsonPropertyOrder({
  BloombergTranslationResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class BloombergTranslationResponse implements Serializable {
  ...
  public BloombergTranslationResponse addDataItem(BloombergTranslation dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<BloombergTranslation> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<BloombergTranslation> data) {
    this.data = data;
  }


  /**
   * Return true if this bloombergTranslationResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BloombergTranslationResponse bloombergTranslationResponse = (BloombergTranslationResponse) o;
    return Objects.equals(this.data, bloombergTranslationResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class BloombergTranslationResponse {\n");
