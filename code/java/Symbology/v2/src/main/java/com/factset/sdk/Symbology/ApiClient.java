...
import com.factset.sdk.Symbology.auth.Authentication;
import com.factset.sdk.Symbology.auth.HttpBasicAuth;
import com.factset.sdk.Symbology.auth.HttpBearerAuth;
import com.factset.sdk.Symbology.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.Symbology.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/Symbology/2.0.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.Symbology.ApiClient} object.
   */
