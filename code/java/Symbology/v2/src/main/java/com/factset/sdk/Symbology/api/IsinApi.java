...
public class IsinApi {
   ...
   * @param isinHistoryTranslationRequest Response Body for ISIN History (required)
  ...
  public ApiResponse<IsinHistoryTranslationResponse> batchIsinHistoryWithHttpInfo(IsinHistoryTranslationRequest isinHistoryTranslationRequest) throws ApiException {
    ...
    String localVarPath = "/symbology/v2/isin-history";
  ...
  public ApiResponse<IsinTranslationResponse> batchTranslateIsinWithHttpInfo(IsinTranslationRequest isinTranslationRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/symbology/v2/isin";
   ...
   */
  public IsinHistoryTranslationResponse isinHistory(java.util.List<String> ids, String asOfDate) throws ApiException {
    return isinHistoryWithHttpInfo(ids, asOfDate).getData();
  }
   ...
   */
  public ApiResponse<IsinHistoryTranslationResponse> isinHistoryWithHttpInfo(java.util.List<String> ids, String asOfDate) throws ApiException {
   ...
   */
  public IsinTranslationResponse translateIsin(java.util.List<String> ids) throws ApiException {
    return translateIsinWithHttpInfo(ids).getData();
  }
   ...
   */
  public ApiResponse<IsinTranslationResponse> translateIsinWithHttpInfo(java.util.List<String> ids) throws ApiException {
    Object localVarPostBody = null;
