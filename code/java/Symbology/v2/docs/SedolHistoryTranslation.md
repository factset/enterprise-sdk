...
**sedolEffectiveStartDate** | **LocalDate** | SEDOL effective start date in YYYY-MM-DD format. |  [optional]
**sedolEffectiveEndDate** | **LocalDate** | SEDOL effective end date in YYYY-MM-DD format. Null if still active. |  [optional]
