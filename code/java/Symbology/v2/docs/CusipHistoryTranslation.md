...
**cusipEffectiveStartDate** | **LocalDate** | CUSIP effective start date in YYYY-MM-DD format. |  [optional]
**cusipEffectiveEndDate** | **LocalDate** | CUSIP effective end date in YYYY-MM-DD format. Null if still active. |  [optional]
**asOfDate** | **LocalDate** | As of Date in YYYY-MM-DD format. |  [optional]
