...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/symbology/4.1.3)](https://central.sonatype.com/artifact/com.factset.sdk/symbology/4.1.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:symbology:4.1.3"
  }
```
