...
**isinEffectiveStartDate** | **LocalDate** | ISIN effective start date in YYYY-MM-DD format. |  [optional]
**isinEffectiveEndDate** | **LocalDate** | ISIN effective end date in YYYY-MM-DD format. Null if still active. |  [optional]
