...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CusipHistoryTranslationResponse result = apiInstance.batchCusipHistory(cusipHistoryTranslationRequest);
...
public class Example {
    public static void main(String[] args) {
        ...
        CusipApi apiInstance = new CusipApi(defaultClient);
        CusipTranslationRequest cusipTranslationRequest = new CusipTranslationRequest(); // CusipTranslationRequest | Request Body for CUSIP Symbology Translation
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CusipHistoryTranslationResponse result = apiInstance.cusipHistory(ids);
            System.out.println(result);
        } catch (ApiException e) {
...
> CusipTranslationResponse translateCusip(ids, asOfDate)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CusipTranslationResponse result = apiInstance.translateCusip(ids, asOfDate);
            System.out.println(result);
        } catch (ApiException e) {
