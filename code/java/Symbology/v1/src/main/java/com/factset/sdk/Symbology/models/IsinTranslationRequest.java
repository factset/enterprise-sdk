 ...
 */
@ApiModel(description = "Request object for ISIN Translation endpoint.")
@JsonPropertyOrder({
  IsinTranslationRequest.JSON_PROPERTY_IDS,
  IsinTranslationRequest.JSON_PROPERTY_AS_OF_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class IsinTranslationRequest implements Serializable {
  ...
  public IsinTranslationRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public IsinTranslationRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public IsinTranslationRequest asOfDate(String asOfDate) {
  ...
  **/
  ...
  /**
   * Return true if this isinTranslationRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IsinTranslationRequest isinTranslationRequest = (IsinTranslationRequest) o;
    return Objects.equals(this.ids, isinTranslationRequest.ids) &&
        Objects.equals(this.asOfDate, isinTranslationRequest.asOfDate);
  }
