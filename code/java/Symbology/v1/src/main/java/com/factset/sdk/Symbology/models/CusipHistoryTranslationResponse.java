...
@JsonPropertyOrder({
  CusipHistoryTranslationResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CusipHistoryTranslationResponse implements Serializable {
  ...
  public CusipHistoryTranslationResponse addDataItem(CusipHistoryTranslation dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this cusipHistoryTranslationResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CusipHistoryTranslationResponse cusipHistoryTranslationResponse = (CusipHistoryTranslationResponse) o;
    return Objects.equals(this.data, cusipHistoryTranslationResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CusipHistoryTranslationResponse {\n");
