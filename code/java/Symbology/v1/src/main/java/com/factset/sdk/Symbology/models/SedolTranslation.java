...
@JsonPropertyOrder({
  ...
  SedolTranslation.JSON_PROPERTY_SEDOL_EFFECTIVE_START_DATE,
  SedolTranslation.JSON_PROPERTY_SEDOL_EFFECTIVE_END_DATE,
  SedolTranslation.JSON_PROPERTY_AS_OF_DATE,
...
public class SedolTranslation implements Serializable {
  ...
  **/
  ...
  public SedolTranslation sedolEffectiveStartDate(String sedolEffectiveStartDate) {
  ...
  **/
  ...
  public String getSedolEffectiveStartDate() {
    return sedolEffectiveStartDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SEDOL_EFFECTIVE_START_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSedolEffectiveStartDate(String sedolEffectiveStartDate) {
    this.sedolEffectiveStartDate = sedolEffectiveStartDate;
  }


  public SedolTranslation sedolEffectiveEndDate(String sedolEffectiveEndDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2015-10-05", value = "The effective end date in which the Sedol was valid. If null, the Sedol is still active for the security and date requested.")
  @JsonProperty(JSON_PROPERTY_SEDOL_EFFECTIVE_END_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getSedolEffectiveEndDate() {
    return sedolEffectiveEndDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SEDOL_EFFECTIVE_END_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSedolEffectiveEndDate(String sedolEffectiveEndDate) {
    this.sedolEffectiveEndDate = sedolEffectiveEndDate;
  }


  public SedolTranslation asOfDate(LocalDate asOfDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Fri Jan 01 00:00:00 UTC 2010", value = "The reqeuested date for the symbol.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GOOGL-US", value = "Identifier specified in the request")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fsymId, sedolTranslation.fsymId) &&
        ...
        Objects.equals(this.sedolEffectiveStartDate, sedolTranslation.sedolEffectiveStartDate) &&
        Objects.equals(this.sedolEffectiveEndDate, sedolTranslation.sedolEffectiveEndDate) &&
        Objects.equals(this.asOfDate, sedolTranslation.asOfDate) &&
