...
public class TickerApi {
   ...
   * Returns the full history of Ticker-Exchange or Ticker-Region changes for a requested security. 
   * @param tickerHistoryTranslationRequest Request Body for Ticker History (required)
  ...
  public ApiResponse<TickerHistoryTranslationResponse> batchTickerHistoryWithHttpInfo(TickerHistoryTranslationRequest tickerHistoryTranslationRequest) throws ApiException {
    ...
    String localVarPath = "/symbology/v1/ticker-history";
  ...
  public ApiResponse<TickerTranslationResponse> batchTranslateTickerWithHttpInfo(TickerTranslationRequest tickerTranslationRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/symbology/v1/ticker";
   ...
   */
  public TickerHistoryTranslationResponse tickerHistory(java.util.List<String> ids, String tickerType) throws ApiException {
    return tickerHistoryWithHttpInfo(ids, tickerType).getData();
  }
   ...
   */
  public ApiResponse<TickerHistoryTranslationResponse> tickerHistoryWithHttpInfo(java.util.List<String> ids, String tickerType) throws ApiException {
   ...
   */
  public TickerTranslationResponse translateTicker(java.util.List<String> ids, String tickerType, String asOfDate) throws ApiException {
    return translateTickerWithHttpInfo(ids, tickerType, asOfDate).getData();
  }
   ...
   */
  public ApiResponse<TickerTranslationResponse> translateTickerWithHttpInfo(java.util.List<String> ids, String tickerType, String asOfDate) throws ApiException {
    Object localVarPostBody = null;
