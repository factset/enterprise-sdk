...
public class SedolApi {
   ...
   * @param sedolHistoryTranslationRequest Request Body for SEDOL History (required)
  ...
  public ApiResponse<SedolHistoryTranslationResponse> batchSedolHistoryWithHttpInfo(SedolHistoryTranslationRequest sedolHistoryTranslationRequest) throws ApiException {
    ...
    String localVarPath = "/symbology/v1/sedol-history";
  ...
  public ApiResponse<SedolTranslationResponse> batchTranslateSedolWithHttpInfo(SedolTranslationRequest sedolTranslationRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/symbology/v1/sedol";
   ...
   */
  public SedolHistoryTranslationResponse sedolHistory(java.util.List<String> ids) throws ApiException {
    return sedolHistoryWithHttpInfo(ids).getData();
  }
   ...
   */
  public ApiResponse<SedolHistoryTranslationResponse> sedolHistoryWithHttpInfo(java.util.List<String> ids) throws ApiException {
   ...
   */
  public SedolTranslationResponse translateSedol(java.util.List<String> ids, String asOfDate) throws ApiException {
    return translateSedolWithHttpInfo(ids, asOfDate).getData();
  }
   ...
   */
  public ApiResponse<SedolTranslationResponse> translateSedolWithHttpInfo(java.util.List<String> ids, String asOfDate) throws ApiException {
    Object localVarPostBody = null;
