...
import com.factset.sdk.FactSetContentAPIBatch.auth.Authentication;
import com.factset.sdk.FactSetContentAPIBatch.auth.HttpBasicAuth;
import com.factset.sdk.FactSetContentAPIBatch.auth.HttpBearerAuth;
import com.factset.sdk.FactSetContentAPIBatch.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetContentAPIBatch.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    ...
    new ServerConfiguration(
      "http://cts-content-proxy-ts-poc.factset.io",
      "Test Server",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetContentAPIBatch/0.22.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetContentAPIBatch.ApiClient} object.
   */
