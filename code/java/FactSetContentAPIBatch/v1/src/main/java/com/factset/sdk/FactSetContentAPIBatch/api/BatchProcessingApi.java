...
import com.factset.sdk.FactSetContentAPIBatch.models.BatchDataRequest;
import com.factset.sdk.FactSetContentAPIBatch.models.BatchDataResponse;
import com.factset.sdk.FactSetContentAPIBatch.models.BatchStatusRequest;
...
public class BatchProcessingApi {
  ...
  static {
    ...
    getBatchDataWithPostResponseTypeMap.put(404, new GenericType<ErrorResponse>(){});
  }
  ...
  static {
    ...
    getBatchStatusWithPostResponseTypeMap.put(404, new GenericType<ErrorResponse>(){});
  }
 ...
 /**
  ...
  public ApiResponse<GetBatchDataResponseWrapper> getBatchDataWithHttpInfo(java.util.UUID id) throws ApiException {
    ...
    String localVarPath = "/batch/v1/result";
   ...
   * @param batchDataRequest Batch Data Request Post Body (required)
  ...
  public ApiResponse<BatchStatusResponse> getBatchStatusWithHttpInfo(java.util.UUID id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/batch/v1/status";
   ...
   * Returns the status for a Batch Request
   * Return the status for the underlying batch request that is specified by the id. 
   * @param batchStatusRequest Batch Status Request Post Body (required)
   * @return BatchStatusResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public BatchStatusResponse getBatchStatusWithPost(BatchStatusRequest batchStatusRequest) throws ApiException {
    return getBatchStatusWithPostWithHttpInfo(batchStatusRequest).getData();
  }
   ...
   */
  public ApiResponse<BatchStatusResponse> getBatchStatusWithPostWithHttpInfo(BatchStatusRequest batchStatusRequest) throws ApiException {
    Object localVarPostBody = batchStatusRequest;
    
    // verify the required parameter 'batchStatusRequest' is set
    if (batchStatusRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'batchStatusRequest' when calling getBatchStatusWithPost");
    }
