...
# Procure to Pay SCIM client library for Java

[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/procuretopayscim)](https://search.maven.org/artifact/com.factset.sdk/procuretopayscim)
...
<dependency>
  <groupId>com.factset.sdk</groupId>
  <artifactId>procuretopayscim</artifactId>
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:procuretopayscim:0.20.0"
  }
```
...
import com.factset.sdk.ProcuretoPaySCIM.*;
