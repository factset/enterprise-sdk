...
import com.factset.sdk.ProcuretoPaySCIM.auth.Authentication;
import com.factset.sdk.ProcuretoPaySCIM.auth.HttpBasicAuth;
import com.factset.sdk.ProcuretoPaySCIM.auth.HttpBearerAuth;
import com.factset.sdk.ProcuretoPaySCIM.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ProcuretoPaySCIM.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ProcuretoPaySCIM/0.20.0");
   ...
   * @return this instance of {@link com.factset.sdk.ProcuretoPaySCIM.ApiClient} object.
   */
