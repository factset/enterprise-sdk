...
@JsonPropertyOrder({
  ...
  DealValue.JSON_PROPERTY_COMPLETION_TRANSACTION_VALUE,
  DealValue.JSON_PROPERTY_COMPLETION_ENTERPRISE_VALUE,
...
public class DealValue implements Serializable {
  ...
  public static final String JSON_PROPERTY_COMPLETION_TRANSACTION_VALUE = "completionTransactionValue";
  private JsonNullable<BigDecimal> completionTransactionValue = JsonNullable.<BigDecimal>undefined();

  public static final String JSON_PROPERTY_COMPLETION_ENTERPRISE_VALUE = "completionEnterpriseValue";
  private JsonNullable<BigDecimal> completionEnterpriseValue = JsonNullable.<BigDecimal>undefined();
  ...
  **/
  ...
  public DealValue completionTransactionValue(BigDecimal completionTransactionValue) {
    this.completionTransactionValue = JsonNullable.<BigDecimal>of(completionTransactionValue);
    return this;
  }

   /**
   * Returns the transaction value (in USD Millions) at completion for the specified deal identifier. Transaction Value, but calculated instead using the terms of the transaction at completion (vs. announcement).
   * @return completionTransactionValue
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "4251.21114", value = "Returns the transaction value (in USD Millions) at completion for the specified deal identifier. Transaction Value, but calculated instead using the terms of the transaction at completion (vs. announcement).")
  @JsonIgnore

  public BigDecimal getCompletionTransactionValue() {
        return completionTransactionValue.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_COMPLETION_TRANSACTION_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<BigDecimal> getCompletionTransactionValue_JsonNullable() {
    return completionTransactionValue;
  }
  
  @JsonProperty(JSON_PROPERTY_COMPLETION_TRANSACTION_VALUE)
  public void setCompletionTransactionValue_JsonNullable(JsonNullable<BigDecimal> completionTransactionValue) {
    this.completionTransactionValue = completionTransactionValue;
  }

  public void setCompletionTransactionValue(BigDecimal completionTransactionValue) {
    this.completionTransactionValue = JsonNullable.<BigDecimal>of(completionTransactionValue);
  }


  public DealValue completionEnterpriseValue(BigDecimal completionEnterpriseValue) {
    this.completionEnterpriseValue = JsonNullable.<BigDecimal>of(completionEnterpriseValue);
    return this;
  }

   /**
   * Returns the enterprise value (in USD Millions) of the transaction at completion, for the specified deal identifier. This is calculated as the total value of the transaction at completion (base equity price at completion), including interest-bearing debt and preferred stock minus cash from the balance sheet.
   * @return completionEnterpriseValue
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "4276.711124", value = "Returns the enterprise value (in USD Millions) of the transaction at completion, for the specified deal identifier. This is calculated as the total value of the transaction at completion (base equity price at completion), including interest-bearing debt and preferred stock minus cash from the balance sheet.")
  @JsonIgnore

  public BigDecimal getCompletionEnterpriseValue() {
        return completionEnterpriseValue.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_COMPLETION_ENTERPRISE_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<BigDecimal> getCompletionEnterpriseValue_JsonNullable() {
    return completionEnterpriseValue;
  }
  
  @JsonProperty(JSON_PROPERTY_COMPLETION_ENTERPRISE_VALUE)
  public void setCompletionEnterpriseValue_JsonNullable(JsonNullable<BigDecimal> completionEnterpriseValue) {
    this.completionEnterpriseValue = completionEnterpriseValue;
  }

  public void setCompletionEnterpriseValue(BigDecimal completionEnterpriseValue) {
    this.completionEnterpriseValue = JsonNullable.<BigDecimal>of(completionEnterpriseValue);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.baseEquity, dealValue.baseEquity) &&
        ...
        equalsNullable(this.completionTransactionValue, dealValue.completionTransactionValue) &&
        equalsNullable(this.completionEnterpriseValue, dealValue.completionEnterpriseValue) &&
  ...
  public String toString() {
    ...
    sb.append("    completionTransactionValue: ").append(toIndentedString(completionTransactionValue)).append("\n");
    sb.append("    completionEnterpriseValue: ").append(toIndentedString(completionEnterpriseValue)).append("\n");
