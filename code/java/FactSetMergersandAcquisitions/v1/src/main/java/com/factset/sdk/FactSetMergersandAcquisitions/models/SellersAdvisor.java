 ...
 */
@ApiModel(description = "Sellers Advisor Object")
@JsonPropertyOrder({
  SellersAdvisor.JSON_PROPERTY_FINANCIAL,
  SellersAdvisor.JSON_PROPERTY_LEGAL
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SellersAdvisor implements Serializable {
  ...
  public SellersAdvisor() { 
  }

  public SellersAdvisor financial(java.util.List<AdvisorParticipant> financial) {
    this.financial = financial;
    return this;
  }

  public SellersAdvisor addFinancialItem(AdvisorParticipant financialItem) {
  ...
  **/
  ...
  public SellersAdvisor legal(java.util.List<AdvisorParticipant> legal) {
    this.legal = legal;
    return this;
  }

  public SellersAdvisor addLegalItem(AdvisorParticipant legalItem) {
    if (this.legal == null) {
  ...
  **/
  ...
  /**
   * Return true if this SellersAdvisor object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SellersAdvisor sellersAdvisor = (SellersAdvisor) o;
    return Objects.equals(this.financial, sellersAdvisor.financial) &&
        Objects.equals(this.legal, sellersAdvisor.legal);
  }
