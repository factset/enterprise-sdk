...
import com.factset.sdk.FactSetMergersandAcquisitions.auth.Authentication;
import com.factset.sdk.FactSetMergersandAcquisitions.auth.HttpBasicAuth;
import com.factset.sdk.FactSetMergersandAcquisitions.auth.HttpBearerAuth;
import com.factset.sdk.FactSetMergersandAcquisitions.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetMergersandAcquisitions.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/content/factset-mergers-acquisitions/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/content/factset-mergers-acquisitions/v1",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetMergersandAcquisitions/1.0.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetMergersandAcquisitions.ApiClient} object.
   */
