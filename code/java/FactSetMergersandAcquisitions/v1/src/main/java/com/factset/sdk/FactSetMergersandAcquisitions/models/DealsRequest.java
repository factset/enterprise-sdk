...
import com.factset.sdk.FactSetMergersandAcquisitions.models.DealsRequestBody;
...
@JsonPropertyOrder({
  DealsRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class DealsRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private DealsRequestBody data;
  ...
  @JsonCreator
  public DealsRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) DealsRequestBody data
  ) {
    this();
    this.data = data;
  }

  public DealsRequest data(DealsRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public DealsRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(DealsRequestBody data) {
    this.data = data;
  }


  /**
   * Return true if this DealsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DealsRequest dealsRequest = (DealsRequest) o;
    return Objects.equals(this.data, dealsRequest.data);
  }
