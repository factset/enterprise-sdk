...
public class InlineResponse200DataTriggerStatus implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "error", value = "Code of the status. | Value | Description | | --- | --- | | active | The trigger is active and trigger conditions are evaluated. | | inactive | The trigger is inactive and conditions do not generate alerts | | error | The trigger is in an error state, error details are noted in \"details\" |  ")
  @JsonIgnore
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.code, inlineResponse200DataTriggerStatus.code) &&
        equalsNullable(this.details, inlineResponse200DataTriggerStatus.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse200DataTriggerStatus.encryptedDetails);
  }
