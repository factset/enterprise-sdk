...
@JsonPropertyOrder({
  PostAlertingPricesBasicTriggerListDataItemsStatus.JSON_PROPERTY_CODE,
  PostAlertingPricesBasicTriggerListDataItemsStatus.JSON_PROPERTY_DETAILS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostAlertingPricesBasicTriggerListDataItemsStatus implements Serializable {
  ...
  public PostAlertingPricesBasicTriggerListDataItemsStatus() { 
  }

  public PostAlertingPricesBasicTriggerListDataItemsStatus code(CodeEnum code) {
  ...
  **/
  ...
  @ApiModelProperty(example = "inactive", value = "Code of the status. | Value | Description | | --- | --- | | active | The trigger is active and trigger conditions are evaluated. | | inactive | The trigger is inactive and conditions do not generate alerts | | error | The trigger is in an error state, error details are noted in \"details\" |  ")
  @JsonIgnore
  ...
  public PostAlertingPricesBasicTriggerListDataItemsStatus details(String details) {
  ...
  **/
  ...
  /**
   * Return true if this PostAlertingPricesBasicTriggerListDataItems_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostAlertingPricesBasicTriggerListDataItemsStatus postAlertingPricesBasicTriggerListDataItemsStatus = (PostAlertingPricesBasicTriggerListDataItemsStatus) o;
    return equalsNullable(this.code, postAlertingPricesBasicTriggerListDataItemsStatus.code) &&
        equalsNullable(this.details, postAlertingPricesBasicTriggerListDataItemsStatus.details);
  }
