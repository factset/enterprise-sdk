...
import com.factset.sdk.RealTimePriceAlerting.models.GetAlertingPricesBasicAlertGetDataNotificationStatusItems;
...
@JsonPropertyOrder({
  InlineResponse200DataNotification.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse200DataNotification implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_STATUS = "status";
  private java.util.List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems> status = null;

  public InlineResponse200DataNotification() { 
  }

  public InlineResponse200DataNotification status(java.util.List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems> status) {
    this.status = status;
    return this;
  }

  public InlineResponse200DataNotification addStatusItem(GetAlertingPricesBasicAlertGetDataNotificationStatusItems statusItem) {
    if (this.status == null) {
  ...
  **/
  ...
  public java.util.List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems> getStatus() {
    return status;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(java.util.List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems> status) {
    this.status = status;
  }


  /**
   * Return true if this inline_response_200_data_notification object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataNotification inlineResponse200DataNotification = (InlineResponse200DataNotification) o;
    return Objects.equals(this.status, inlineResponse200DataNotification.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse200DataNotification {\n");
