...
import com.factset.sdk.RealTimePriceAlerting.models.InlineResponse200DataNotificationStatus;
...
public class InlineResponse200DataNotification implements Serializable {
  ...
  private java.util.List<InlineResponse200DataNotificationStatus> status = null;

  public InlineResponse200DataNotification() { 
  }

  public InlineResponse200DataNotification status(java.util.List<InlineResponse200DataNotificationStatus> status) {
    this.status = status;
    return this;
  }

  public InlineResponse200DataNotification addStatusItem(InlineResponse200DataNotificationStatus statusItem) {
    if (this.status == null) {
  ...
  **/
  ...
  public java.util.List<InlineResponse200DataNotificationStatus> getStatus() {
    return status;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(java.util.List<InlineResponse200DataNotificationStatus> status) {
    this.status = status;
  }
