...
import com.factset.sdk.RealTimePriceAlerting.models.GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel;
...
@JsonPropertyOrder({
  GetAlertingPricesBasicAlertListDataNotificationStatusItems.JSON_PROPERTY_CHANNEL,
  GetAlertingPricesBasicAlertListDataNotificationStatusItems.JSON_PROPERTY_TIME,
  GetAlertingPricesBasicAlertListDataNotificationStatusItems.JSON_PROPERTY_CODE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicAlertListDataNotificationStatusItems implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_CHANNEL = "channel";
  private GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel channel;
  ...
  public GetAlertingPricesBasicAlertListDataNotificationStatusItems() { 
  }

  public GetAlertingPricesBasicAlertListDataNotificationStatusItems channel(GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel channel) {
  ...
  **/
  ...
  public GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel getChannel() {
    return channel;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHANNEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChannel(GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel channel) {
    this.channel = channel;
  }


  public GetAlertingPricesBasicAlertListDataNotificationStatusItems time(OffsetDateTime time) {
  ...
  **/
  ...
  public GetAlertingPricesBasicAlertListDataNotificationStatusItems code(CodeEnum code) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "rejected", value = "Code of the status. | Value | Description | | --- | --- | | pending | Notification has not been processed. | | sent | Notification has been sent but delivery status is unknown. | | delivered | Notification has been delivered. | | error | Notification has not been delivered due to an error. | | rejected | Notification delivery has been rejected (possibly due to return mails being received for delivery address). |  ")
  @JsonIgnore
  ...
  /**
   * Return true if this GetAlertingPricesBasicAlertListDataNotificationStatusItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicAlertListDataNotificationStatusItems getAlertingPricesBasicAlertListDataNotificationStatusItems = (GetAlertingPricesBasicAlertListDataNotificationStatusItems) o;
    return Objects.equals(this.channel, getAlertingPricesBasicAlertListDataNotificationStatusItems.channel) &&
        equalsNullable(this.time, getAlertingPricesBasicAlertListDataNotificationStatusItems.time) &&
        equalsNullable(this.code, getAlertingPricesBasicAlertListDataNotificationStatusItems.code);
  }
