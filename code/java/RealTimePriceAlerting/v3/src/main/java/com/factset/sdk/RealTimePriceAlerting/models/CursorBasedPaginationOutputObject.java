...
public class CursorBasedPaginationOutputObject implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "5", required = true, value = "Total number of entries in the result set.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Lorem ipsum", required = true, value = "The next cursor position to use in the parameter `pagination.cursor` for an endpoint that supports cursor-based pagination, otherwise `null`.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Lorem ipsum", required = true, value = "The previous cursor position to use in the parameter `pagination.cursor` for an endpoint that supports cursor-based pagination. If a previous cursor position is not supported or available, `previous` is `null`.")
