 ...
 */
@JsonPropertyOrder({
  InlineResponse2002DataNotificationChannel.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2002DataNotificationChannel implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private JsonNullable<BigDecimal> id = JsonNullable.<BigDecimal>undefined();

  public InlineResponse2002DataNotificationChannel() { 
  }

  public InlineResponse2002DataNotificationChannel id(BigDecimal id) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_2_data_notification_channel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2002DataNotificationChannel inlineResponse2002DataNotificationChannel = (InlineResponse2002DataNotificationChannel) o;
    return equalsNullable(this.id, inlineResponse2002DataNotificationChannel.id);
  }
