...
@JsonPropertyOrder({
  PostAlertingPricesBasicTriggerListDataNotificationChannelItems.JSON_PROPERTY_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostAlertingPricesBasicTriggerListDataNotificationChannelItems implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private JsonNullable<BigDecimal> id = JsonNullable.<BigDecimal>undefined();

  public PostAlertingPricesBasicTriggerListDataNotificationChannelItems() { 
  }

  public PostAlertingPricesBasicTriggerListDataNotificationChannelItems id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "5", value = "Identifier of the notification channel.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostAlertingPricesBasicTriggerListDataNotificationChannelItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostAlertingPricesBasicTriggerListDataNotificationChannelItems postAlertingPricesBasicTriggerListDataNotificationChannelItems = (PostAlertingPricesBasicTriggerListDataNotificationChannelItems) o;
    return equalsNullable(this.id, postAlertingPricesBasicTriggerListDataNotificationChannelItems.id);
  }
