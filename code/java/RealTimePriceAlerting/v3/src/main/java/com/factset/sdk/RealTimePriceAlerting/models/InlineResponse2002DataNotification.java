...
import com.factset.sdk.RealTimePriceAlerting.models.GetAlertingPricesBasicTriggerGetDataNotificationChannelItems;
...
public class InlineResponse2002DataNotification implements Serializable {
  ...
  private java.util.List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems> channel = null;

  public InlineResponse2002DataNotification() { 
  }

  public InlineResponse2002DataNotification channel(java.util.List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems> channel) {
    this.channel = channel;
    return this;
  }

  public InlineResponse2002DataNotification addChannelItem(GetAlertingPricesBasicTriggerGetDataNotificationChannelItems channelItem) {
  ...
  **/
  ...
  public java.util.List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems> getChannel() {
    return channel;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHANNEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChannel(java.util.List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems> channel) {
    this.channel = channel;
  }
