...
@JsonPropertyOrder({
  GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel.JSON_PROPERTY_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private JsonNullable<BigDecimal> id = JsonNullable.<BigDecimal>undefined();

  public GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel() { 
  }

  public GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Identifier of the notification channel.")
  @JsonIgnore
  ...
  /**
   * Return true if this GetAlertingPricesBasicAlertListDataNotificationStatusItems_channel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel getAlertingPricesBasicAlertListDataNotificationStatusItemsChannel = (GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel) o;
    return equalsNullable(this.id, getAlertingPricesBasicAlertListDataNotificationStatusItemsChannel.id);
  }
