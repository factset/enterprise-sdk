...
import com.factset.sdk.RealTimePriceAlerting.models.GetAlertingPricesBasicAlertListDataNotificationStatusItems;
 ...
 */
@ApiModel(description = "Notification information of the alert.")
@JsonPropertyOrder({
  GetAlertingPricesBasicAlertListDataItemsNotification.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicAlertListDataItemsNotification implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_STATUS = "status";
  private java.util.List<GetAlertingPricesBasicAlertListDataNotificationStatusItems> status = null;

  public GetAlertingPricesBasicAlertListDataItemsNotification() { 
  }

  public GetAlertingPricesBasicAlertListDataItemsNotification status(java.util.List<GetAlertingPricesBasicAlertListDataNotificationStatusItems> status) {
    this.status = status;
    return this;
  }

  public GetAlertingPricesBasicAlertListDataItemsNotification addStatusItem(GetAlertingPricesBasicAlertListDataNotificationStatusItems statusItem) {
    if (this.status == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Status of a notification per channel.")
  @JsonProperty(JSON_PROPERTY_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<GetAlertingPricesBasicAlertListDataNotificationStatusItems> getStatus() {
    return status;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(java.util.List<GetAlertingPricesBasicAlertListDataNotificationStatusItems> status) {
    this.status = status;
  }


  /**
   * Return true if this GetAlertingPricesBasicAlertListDataItems_notification object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicAlertListDataItemsNotification getAlertingPricesBasicAlertListDataItemsNotification = (GetAlertingPricesBasicAlertListDataItemsNotification) o;
    return Objects.equals(this.status, getAlertingPricesBasicAlertListDataItemsNotification.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAlertingPricesBasicAlertListDataItemsNotification {\n");
