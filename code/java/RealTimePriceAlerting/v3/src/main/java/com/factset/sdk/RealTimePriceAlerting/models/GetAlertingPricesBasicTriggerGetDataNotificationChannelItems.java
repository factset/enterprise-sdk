...
@JsonPropertyOrder({
  GetAlertingPricesBasicTriggerGetDataNotificationChannelItems.JSON_PROPERTY_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicTriggerGetDataNotificationChannelItems implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private JsonNullable<BigDecimal> id = JsonNullable.<BigDecimal>undefined();

  public GetAlertingPricesBasicTriggerGetDataNotificationChannelItems() { 
  }

  public GetAlertingPricesBasicTriggerGetDataNotificationChannelItems id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", value = "Identifier of the notification channel.")
  @JsonIgnore
  ...
  /**
   * Return true if this GetAlertingPricesBasicTriggerGetDataNotificationChannelItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicTriggerGetDataNotificationChannelItems getAlertingPricesBasicTriggerGetDataNotificationChannelItems = (GetAlertingPricesBasicTriggerGetDataNotificationChannelItems) o;
    return equalsNullable(this.id, getAlertingPricesBasicTriggerGetDataNotificationChannelItems.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAlertingPricesBasicTriggerGetDataNotificationChannelItems {\n");
