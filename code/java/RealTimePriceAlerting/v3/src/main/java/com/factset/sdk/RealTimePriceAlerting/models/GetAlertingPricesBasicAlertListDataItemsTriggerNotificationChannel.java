...
@JsonPropertyOrder({
  GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel.JSON_PROPERTY_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private java.util.List<BigDecimal> id = null;

  public GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel() { 
  }

  public GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel id(java.util.List<BigDecimal> id) {
    this.id = id;
    return this;
  }

  public GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel addIdItem(BigDecimal idItem) {
    if (this.id == null) {
  ...
  **/
  ...
  /**
   * Return true if this GetAlertingPricesBasicAlertListDataItems_trigger_notification_channel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel getAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel = (GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel) o;
    return Objects.equals(this.id, getAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel.id);
  }
