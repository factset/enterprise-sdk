...
import com.factset.sdk.RealTimePriceAlerting.models.PostAlertingPricesBasicTriggerListRequestDataFilterStatus;
 ...
 */
@ApiModel(description = "Criteria that filter the items in the response list.")
@JsonPropertyOrder({
  PostAlertingPricesBasicTriggerListRequestDataFilter.JSON_PROPERTY_STATUS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostAlertingPricesBasicTriggerListRequestDataFilter implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_STATUS = "status";
  private PostAlertingPricesBasicTriggerListRequestDataFilterStatus status;

  public PostAlertingPricesBasicTriggerListRequestDataFilter() { 
  }

  public PostAlertingPricesBasicTriggerListRequestDataFilter status(PostAlertingPricesBasicTriggerListRequestDataFilterStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public PostAlertingPricesBasicTriggerListRequestDataFilterStatus getStatus() {
    return status;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(PostAlertingPricesBasicTriggerListRequestDataFilterStatus status) {
    this.status = status;
  }


  /**
   * Return true if this PostAlertingPricesBasicTriggerListRequest_data_filter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostAlertingPricesBasicTriggerListRequestDataFilter postAlertingPricesBasicTriggerListRequestDataFilter = (PostAlertingPricesBasicTriggerListRequestDataFilter) o;
    return Objects.equals(this.status, postAlertingPricesBasicTriggerListRequestDataFilter.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostAlertingPricesBasicTriggerListRequestDataFilter {\n");
