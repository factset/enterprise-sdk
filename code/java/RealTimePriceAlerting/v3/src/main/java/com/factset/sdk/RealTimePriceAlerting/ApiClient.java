...
import com.factset.sdk.RealTimePriceAlerting.auth.Authentication;
import com.factset.sdk.RealTimePriceAlerting.auth.HttpBasicAuth;
import com.factset.sdk.RealTimePriceAlerting.auth.HttpBearerAuth;
import com.factset.sdk.RealTimePriceAlerting.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.RealTimePriceAlerting.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/wealth/v3";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/wealth/v3",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/RealTimePriceAlerting/0.13.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.RealTimePriceAlerting.ApiClient} object.
   */
