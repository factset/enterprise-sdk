...
@JsonPropertyOrder({
  GetAlertingPricesBasicAlertListDataItemsTriggerRange.JSON_PROPERTY_UPPER_LIMIT,
  GetAlertingPricesBasicAlertListDataItemsTriggerRange.JSON_PROPERTY_LOWER_LIMIT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicAlertListDataItemsTriggerRange implements Serializable {
  ...
  public GetAlertingPricesBasicAlertListDataItemsTriggerRange() { 
  }

  public GetAlertingPricesBasicAlertListDataItemsTriggerRange upperLimit(BigDecimal upperLimit) {
  ...
  **/
  ...
  public GetAlertingPricesBasicAlertListDataItemsTriggerRange lowerLimit(BigDecimal lowerLimit) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "5.05", value = "Lower limit.")
  @JsonIgnore
  ...
  /**
   * Return true if this GetAlertingPricesBasicAlertListDataItems_trigger_range object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicAlertListDataItemsTriggerRange getAlertingPricesBasicAlertListDataItemsTriggerRange = (GetAlertingPricesBasicAlertListDataItemsTriggerRange) o;
    return equalsNullable(this.upperLimit, getAlertingPricesBasicAlertListDataItemsTriggerRange.upperLimit) &&
        equalsNullable(this.lowerLimit, getAlertingPricesBasicAlertListDataItemsTriggerRange.lowerLimit);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAlertingPricesBasicAlertListDataItemsTriggerRange {\n");
