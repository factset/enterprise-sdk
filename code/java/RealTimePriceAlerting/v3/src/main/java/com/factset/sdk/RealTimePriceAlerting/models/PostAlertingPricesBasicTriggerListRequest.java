...
import com.factset.sdk.RealTimePriceAlerting.models.PostAlertingPricesBasicTriggerListRequestData;
import com.factset.sdk.RealTimePriceAlerting.models.PostAlertingPricesBasicTriggerListRequestMeta;
...
@JsonPropertyOrder({
  PostAlertingPricesBasicTriggerListRequest.JSON_PROPERTY_DATA,
  PostAlertingPricesBasicTriggerListRequest.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostAlertingPricesBasicTriggerListRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private PostAlertingPricesBasicTriggerListRequestData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PostAlertingPricesBasicTriggerListRequestMeta meta;

  public PostAlertingPricesBasicTriggerListRequest() { 
  }

  @JsonCreator
  public PostAlertingPricesBasicTriggerListRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) PostAlertingPricesBasicTriggerListRequestData data
  ) {
    this();
    this.data = data;
  }

  public PostAlertingPricesBasicTriggerListRequest data(PostAlertingPricesBasicTriggerListRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PostAlertingPricesBasicTriggerListRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(PostAlertingPricesBasicTriggerListRequestData data) {
    this.data = data;
  }


  public PostAlertingPricesBasicTriggerListRequest meta(PostAlertingPricesBasicTriggerListRequestMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public PostAlertingPricesBasicTriggerListRequestMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(PostAlertingPricesBasicTriggerListRequestMeta meta) {
    this.meta = meta;
  }


  /**
   * Return true if this PostAlertingPricesBasicTriggerListRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostAlertingPricesBasicTriggerListRequest postAlertingPricesBasicTriggerListRequest = (PostAlertingPricesBasicTriggerListRequest) o;
    return Objects.equals(this.data, postAlertingPricesBasicTriggerListRequest.data) &&
        Objects.equals(this.meta, postAlertingPricesBasicTriggerListRequest.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostAlertingPricesBasicTriggerListRequest {\n");
