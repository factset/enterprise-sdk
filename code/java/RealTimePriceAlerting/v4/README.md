...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/realtimepricealerting/0.14.1)](https://central.sonatype.com/artifact/com.factset.sdk/realtimepricealerting/0.14.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:realtimepricealerting:0.14.1"
  }
```
