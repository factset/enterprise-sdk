...
@JsonPropertyOrder({
  InlineResponse2002DataPrice.JSON_PROPERTY_TYPE,
  InlineResponse2002DataPrice.JSON_PROPERTY_QUALITY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse2002DataPrice implements Serializable {
  ...
  public InlineResponse2002DataPrice() { 
  }

  public InlineResponse2002DataPrice type(TypeEnum type) {
  ...
  **/
  ...
  public InlineResponse2002DataPrice quality(QualityEnum quality) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "DLY", value = "Quality of the price. | Value | Description | | --- | --- | | RLT | Real-time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours or days. |  ")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_2_data_price object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2002DataPrice inlineResponse2002DataPrice = (InlineResponse2002DataPrice) o;
    return equalsNullable(this.type, inlineResponse2002DataPrice.type) &&
        equalsNullable(this.quality, inlineResponse2002DataPrice.quality);
  }
