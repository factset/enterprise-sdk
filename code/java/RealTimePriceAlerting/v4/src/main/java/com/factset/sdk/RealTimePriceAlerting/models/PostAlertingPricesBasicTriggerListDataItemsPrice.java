...
@JsonPropertyOrder({
  PostAlertingPricesBasicTriggerListDataItemsPrice.JSON_PROPERTY_TYPE,
  PostAlertingPricesBasicTriggerListDataItemsPrice.JSON_PROPERTY_QUALITY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostAlertingPricesBasicTriggerListDataItemsPrice implements Serializable {
  ...
  public PostAlertingPricesBasicTriggerListDataItemsPrice() { 
  }

  public PostAlertingPricesBasicTriggerListDataItemsPrice type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "ask", value = "Type of the price as configured for the customer. | Value | Description | | --- | --- | | trade | Trade price (ordinary, auction, pre or post-trading). | | bid | Bid price. | | ask | Ask price. |  ")
  @JsonIgnore
  ...
  public PostAlertingPricesBasicTriggerListDataItemsPrice quality(QualityEnum quality) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "EOD", value = "Quality of the price. | Value | Description | | --- | --- | | RLT | Real-time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours or days. |  ")
  @JsonIgnore
  ...
  /**
   * Return true if this PostAlertingPricesBasicTriggerListDataItems_price object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostAlertingPricesBasicTriggerListDataItemsPrice postAlertingPricesBasicTriggerListDataItemsPrice = (PostAlertingPricesBasicTriggerListDataItemsPrice) o;
    return equalsNullable(this.type, postAlertingPricesBasicTriggerListDataItemsPrice.type) &&
        equalsNullable(this.quality, postAlertingPricesBasicTriggerListDataItemsPrice.quality);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostAlertingPricesBasicTriggerListDataItemsPrice {\n");
