...
import com.factset.sdk.RealTimePriceAlerting.models.PostAlertingPricesBasicTriggerListRequestMetaPagination;
...
@JsonPropertyOrder({
  PostAlertingPricesBasicTriggerListRequestMeta.JSON_PROPERTY_ATTRIBUTES,
  PostAlertingPricesBasicTriggerListRequestMeta.JSON_PROPERTY_PAGINATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostAlertingPricesBasicTriggerListRequestMeta implements Serializable {
  ...
  private PostAlertingPricesBasicTriggerListRequestMetaPagination pagination;

  public PostAlertingPricesBasicTriggerListRequestMeta() { 
  }

  public PostAlertingPricesBasicTriggerListRequestMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostAlertingPricesBasicTriggerListRequestMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public PostAlertingPricesBasicTriggerListRequestMeta pagination(PostAlertingPricesBasicTriggerListRequestMetaPagination pagination) {
  ...
  **/
  ...
  public PostAlertingPricesBasicTriggerListRequestMetaPagination getPagination() {
    return pagination;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAGINATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPagination(PostAlertingPricesBasicTriggerListRequestMetaPagination pagination) {
    this.pagination = pagination;
  }


  /**
   * Return true if this PostAlertingPricesBasicTriggerListRequest_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostAlertingPricesBasicTriggerListRequestMeta postAlertingPricesBasicTriggerListRequestMeta = (PostAlertingPricesBasicTriggerListRequestMeta) o;
    return Objects.equals(this.attributes, postAlertingPricesBasicTriggerListRequestMeta.attributes) &&
        Objects.equals(this.pagination, postAlertingPricesBasicTriggerListRequestMeta.pagination);
  }
