...
import com.factset.sdk.RealTimePriceAlerting.models.GetAlertingPricesBasicAlertListDataItems;
...
public class InlineResponse2001 implements Serializable {
  ...
  private java.util.List<GetAlertingPricesBasicAlertListDataItems> data = null;
  ...
  public InlineResponse2001 data(java.util.List<GetAlertingPricesBasicAlertListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2001 addDataItem(GetAlertingPricesBasicAlertListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<GetAlertingPricesBasicAlertListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<GetAlertingPricesBasicAlertListDataItems> data) {
    this.data = data;
  }
