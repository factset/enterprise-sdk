...
import com.factset.sdk.RealTimePriceAlerting.models.GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel;
 ...
 */
@ApiModel(description = "Notification specific configuration.")
@JsonPropertyOrder({
  GetAlertingPricesBasicAlertListDataItemsTriggerNotification.JSON_PROPERTY_CHANNEL
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetAlertingPricesBasicAlertListDataItemsTriggerNotification implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_CHANNEL = "channel";
  private GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel channel;

  public GetAlertingPricesBasicAlertListDataItemsTriggerNotification() { 
  }

  public GetAlertingPricesBasicAlertListDataItemsTriggerNotification channel(GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel channel) {
  ...
  **/
  ...
  public GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel getChannel() {
    return channel;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHANNEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChannel(GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel channel) {
    this.channel = channel;
  }


  /**
   * Return true if this GetAlertingPricesBasicAlertListDataItems_trigger_notification object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAlertingPricesBasicAlertListDataItemsTriggerNotification getAlertingPricesBasicAlertListDataItemsTriggerNotification = (GetAlertingPricesBasicAlertListDataItemsTriggerNotification) o;
    return Objects.equals(this.channel, getAlertingPricesBasicAlertListDataItemsTriggerNotification.channel);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAlertingPricesBasicAlertListDataItemsTriggerNotification {\n");
