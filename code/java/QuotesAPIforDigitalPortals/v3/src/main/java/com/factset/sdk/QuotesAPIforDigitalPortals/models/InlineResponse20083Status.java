...
@JsonPropertyOrder({
  InlineResponse20083Status.JSON_PROPERTY_CODE,
  InlineResponse20083Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20083Status.JSON_PROPERTY_DETAILS,
  InlineResponse20083Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20083Status implements Serializable {
  ...
  public InlineResponse20083Status() { 
  }

  public InlineResponse20083Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20083Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20083Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20083Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_83_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20083Status inlineResponse20083Status = (InlineResponse20083Status) o;
    return equalsNullable(this.code, inlineResponse20083Status.code) &&
        equalsNullable(this.identifier, inlineResponse20083Status.identifier) &&
        equalsNullable(this.details, inlineResponse20083Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20083Status.encryptedDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20083Status {\n");
