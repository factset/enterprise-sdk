...
@JsonPropertyOrder({
  InlineResponse20066Status.JSON_PROPERTY_CODE,
  InlineResponse20066Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20066Status.JSON_PROPERTY_DETAILS,
  InlineResponse20066Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20066Status implements Serializable {
  ...
  public InlineResponse20066Status() { 
  }

  public InlineResponse20066Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20066Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20066Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20066Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_66_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20066Status inlineResponse20066Status = (InlineResponse20066Status) o;
    return equalsNullable(this.code, inlineResponse20066Status.code) &&
        equalsNullable(this.identifier, inlineResponse20066Status.identifier) &&
        equalsNullable(this.details, inlineResponse20066Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20066Status.encryptedDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20066Status {\n");
