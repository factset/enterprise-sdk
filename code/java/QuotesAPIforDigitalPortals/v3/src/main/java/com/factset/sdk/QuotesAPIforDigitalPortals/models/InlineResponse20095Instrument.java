...
@JsonPropertyOrder({
  InlineResponse20095Instrument.JSON_PROPERTY_ID,
  InlineResponse20095Instrument.JSON_PROPERTY_NAME,
  InlineResponse20095Instrument.JSON_PROPERTY_ISIN,
  InlineResponse20095Instrument.JSON_PROPERTY_NSIN,
  InlineResponse20095Instrument.JSON_PROPERTY_ASSET_CLASS,
  InlineResponse20095Instrument.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20095Instrument implements Serializable {
  ...
  public InlineResponse20095Instrument() { 
  }

  public InlineResponse20095Instrument id(String id) {
  ...
  **/
  ...
  public InlineResponse20095Instrument name(String name) {
  ...
  **/
  ...
  public InlineResponse20095Instrument isin(String isin) {
  ...
  **/
  ...
  public InlineResponse20095Instrument nsin(InlineResponse20093InstrumentNsin nsin) {
    this.nsin = nsin;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20095Instrument assetClass(String assetClass) {
  ...
  **/
  ...
  public InlineResponse20095Instrument type(java.util.List<InlineResponse20038DataCategories> type) {
    this.type = type;
    return this;
  }

  public InlineResponse20095Instrument addTypeItem(InlineResponse20038DataCategories typeItem) {
    if (this.type == null) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_95_instrument object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20095Instrument inlineResponse20095Instrument = (InlineResponse20095Instrument) o;
    return equalsNullable(this.id, inlineResponse20095Instrument.id) &&
        equalsNullable(this.name, inlineResponse20095Instrument.name) &&
        equalsNullable(this.isin, inlineResponse20095Instrument.isin) &&
        Objects.equals(this.nsin, inlineResponse20095Instrument.nsin) &&
        equalsNullable(this.assetClass, inlineResponse20095Instrument.assetClass) &&
        Objects.equals(this.type, inlineResponse20095Instrument.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20095Instrument {\n");
