 ...
 */
@JsonPropertyOrder({
  InlineResponse20089DataAsks.JSON_PROPERTY_ID,
  InlineResponse20089DataAsks.JSON_PROPERTY_TIME,
  InlineResponse20089DataAsks.JSON_PROPERTY_TYPE,
  InlineResponse20089DataAsks.JSON_PROPERTY_PRICE,
  InlineResponse20089DataAsks.JSON_PROPERTY_QUOTE_CONDITION,
  InlineResponse20089DataAsks.JSON_PROPERTY_VOLUME,
  InlineResponse20089DataAsks.JSON_PROPERTY_MARKET_MAKER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20089DataAsks implements Serializable {
  ...
  public InlineResponse20089DataAsks() { 
  }

  public InlineResponse20089DataAsks id(String id) {
  ...
  **/
  ...
  public InlineResponse20089DataAsks time(String time) {
  ...
  **/
  ...
  public InlineResponse20089DataAsks type(TypeEnum type) {
  ...
  **/
  ...
  public InlineResponse20089DataAsks price(BigDecimal price) {
  ...
  **/
  ...
  public InlineResponse20089DataAsks quoteCondition(String quoteCondition) {
  ...
  **/
  ...
  public InlineResponse20089DataAsks volume(BigDecimal volume) {
  ...
  **/
  ...
  public InlineResponse20089DataAsks marketMaker(String marketMaker) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_89_data_asks object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20089DataAsks inlineResponse20089DataAsks = (InlineResponse20089DataAsks) o;
    return equalsNullable(this.id, inlineResponse20089DataAsks.id) &&
        equalsNullable(this.time, inlineResponse20089DataAsks.time) &&
        equalsNullable(this.type, inlineResponse20089DataAsks.type) &&
        equalsNullable(this.price, inlineResponse20089DataAsks.price) &&
        equalsNullable(this.quoteCondition, inlineResponse20089DataAsks.quoteCondition) &&
        equalsNullable(this.volume, inlineResponse20089DataAsks.volume) &&
        equalsNullable(this.marketMaker, inlineResponse20089DataAsks.marketMaker);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20089DataAsks {\n");
