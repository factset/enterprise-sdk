...
@JsonPropertyOrder({
  InlineResponse20076Status.JSON_PROPERTY_CODE,
  InlineResponse20076Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20076Status.JSON_PROPERTY_DETAILS,
  InlineResponse20076Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20076Status implements Serializable {
  ...
  public InlineResponse20076Status() { 
  }

  public InlineResponse20076Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20076Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20076Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20076Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_76_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20076Status inlineResponse20076Status = (InlineResponse20076Status) o;
    return equalsNullable(this.code, inlineResponse20076Status.code) &&
        equalsNullable(this.identifier, inlineResponse20076Status.identifier) &&
        equalsNullable(this.details, inlineResponse20076Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20076Status.encryptedDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20076Status {\n");
