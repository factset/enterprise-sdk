 ...
 */
@JsonPropertyOrder({
  InlineResponse20087DataAsks.JSON_PROPERTY_ID,
  InlineResponse20087DataAsks.JSON_PROPERTY_TIME,
  InlineResponse20087DataAsks.JSON_PROPERTY_TYPE,
  InlineResponse20087DataAsks.JSON_PROPERTY_PRICE,
  InlineResponse20087DataAsks.JSON_PROPERTY_QUOTE_CONDITION,
  InlineResponse20087DataAsks.JSON_PROPERTY_VOLUME,
  InlineResponse20087DataAsks.JSON_PROPERTY_MARKET_MAKER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20087DataAsks implements Serializable {
  ...
  public InlineResponse20087DataAsks() { 
  }

  public InlineResponse20087DataAsks id(String id) {
  ...
  **/
  ...
  public InlineResponse20087DataAsks time(String time) {
  ...
  **/
  ...
  public InlineResponse20087DataAsks type(TypeEnum type) {
  ...
  **/
  ...
  public InlineResponse20087DataAsks price(BigDecimal price) {
  ...
  **/
  ...
  public InlineResponse20087DataAsks quoteCondition(String quoteCondition) {
  ...
  **/
  ...
  public InlineResponse20087DataAsks volume(BigDecimal volume) {
  ...
  **/
  ...
  public InlineResponse20087DataAsks marketMaker(String marketMaker) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_87_data_asks object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20087DataAsks inlineResponse20087DataAsks = (InlineResponse20087DataAsks) o;
    return equalsNullable(this.id, inlineResponse20087DataAsks.id) &&
        equalsNullable(this.time, inlineResponse20087DataAsks.time) &&
        equalsNullable(this.type, inlineResponse20087DataAsks.type) &&
        equalsNullable(this.price, inlineResponse20087DataAsks.price) &&
        equalsNullable(this.quoteCondition, inlineResponse20087DataAsks.quoteCondition) &&
        equalsNullable(this.volume, inlineResponse20087DataAsks.volume) &&
        equalsNullable(this.marketMaker, inlineResponse20087DataAsks.marketMaker);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20087DataAsks {\n");
