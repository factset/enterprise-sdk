...
@JsonPropertyOrder({
  InlineResponse20065DataValueUnit.JSON_PROPERTY_ID,
  InlineResponse20065DataValueUnit.JSON_PROPERTY_CODE,
  InlineResponse20065DataValueUnit.JSON_PROPERTY_ISO_CODE,
  InlineResponse20065DataValueUnit.JSON_PROPERTY_NAME
})
...
public class InlineResponse20065DataValueUnit implements Serializable {
  ...
  public InlineResponse20065DataValueUnit() { 
  }

  public InlineResponse20065DataValueUnit id(BigDecimal id) {
  ...
  **/
  ...
  public InlineResponse20065DataValueUnit code(String code) {
  ...
  **/
  ...
  public InlineResponse20065DataValueUnit isoCode(String isoCode) {
  ...
  **/
  ...
  public InlineResponse20065DataValueUnit name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_65_data_valueUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20065DataValueUnit inlineResponse20065DataValueUnit = (InlineResponse20065DataValueUnit) o;
    return equalsNullable(this.id, inlineResponse20065DataValueUnit.id) &&
        equalsNullable(this.code, inlineResponse20065DataValueUnit.code) &&
        equalsNullable(this.isoCode, inlineResponse20065DataValueUnit.isoCode) &&
        equalsNullable(this.name, inlineResponse20065DataValueUnit.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20065DataValueUnit {\n");
