...
public class InlineResponse20051DataCurrency implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.id, inlineResponse20051DataCurrency.id) &&
        equalsNullable(this.code, inlineResponse20051DataCurrency.code) &&
        equalsNullable(this.isoCode, inlineResponse20051DataCurrency.isoCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(id), hashCodeNullable(code), hashCodeNullable(isoCode));
  }
