...
@JsonPropertyOrder({
  InlineResponse20093Instrument.JSON_PROPERTY_ID,
  InlineResponse20093Instrument.JSON_PROPERTY_NAME,
  InlineResponse20093Instrument.JSON_PROPERTY_ISIN,
  InlineResponse20093Instrument.JSON_PROPERTY_NSIN,
  InlineResponse20093Instrument.JSON_PROPERTY_ASSET_CLASS,
  InlineResponse20093Instrument.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20093Instrument implements Serializable {
  ...
  public InlineResponse20093Instrument() { 
  }

  public InlineResponse20093Instrument id(String id) {
  ...
  **/
  ...
  public InlineResponse20093Instrument name(String name) {
  ...
  **/
  ...
  public InlineResponse20093Instrument isin(String isin) {
  ...
  **/
  ...
  public InlineResponse20093Instrument assetClass(String assetClass) {
  ...
  **/
  ...
  public InlineResponse20093Instrument type(java.util.List<InlineResponse20038DataCategories> type) {
    this.type = type;
    return this;
  }

  public InlineResponse20093Instrument addTypeItem(InlineResponse20038DataCategories typeItem) {
    if (this.type == null) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_93_instrument object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20093Instrument inlineResponse20093Instrument = (InlineResponse20093Instrument) o;
    return equalsNullable(this.id, inlineResponse20093Instrument.id) &&
        equalsNullable(this.name, inlineResponse20093Instrument.name) &&
        equalsNullable(this.isin, inlineResponse20093Instrument.isin) &&
        Objects.equals(this.nsin, inlineResponse20093Instrument.nsin) &&
        equalsNullable(this.assetClass, inlineResponse20093Instrument.assetClass) &&
        Objects.equals(this.type, inlineResponse20093Instrument.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20093Instrument {\n");
