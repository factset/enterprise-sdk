...
import com.factset.sdk.QuotesAPIforDigitalPortals.models.BasicMicOperatingListData;
import com.factset.sdk.QuotesAPIforDigitalPortals.models.BasicMicOperatingListMeta;
...
public class InlineObject4 implements Serializable {
  ...
  private BasicMicOperatingListData data;
  ...
  **/
  ...
  public BasicMicOperatingListData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(BasicMicOperatingListData data) {
    this.data = data;
  }


  public InlineObject4 meta(BasicMicOperatingListMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public BasicMicOperatingListMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(BasicMicOperatingListMeta meta) {
    this.meta = meta;
  }
