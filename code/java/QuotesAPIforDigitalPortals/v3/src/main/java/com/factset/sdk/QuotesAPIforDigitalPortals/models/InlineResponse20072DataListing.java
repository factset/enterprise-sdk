...
import com.factset.sdk.QuotesAPIforDigitalPortals.models.InlineResponse20072DataNotation;
 ...
 */
@JsonPropertyOrder({
  InlineResponse20072DataListing.JSON_PROPERTY_NOTATION,
  InlineResponse20072DataListing.JSON_PROPERTY_IS_PRIMARY,
  InlineResponse20072DataListing.JSON_PROPERTY_PERMANENT_IDENTIFIER,
  InlineResponse20072DataListing.JSON_PROPERTY_TICKER_EXCHANGE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20072DataListing implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_NOTATION = "notation";
  private InlineResponse20072DataNotation notation;
  ...
  public InlineResponse20072DataListing() { 
  }

  public InlineResponse20072DataListing notation(InlineResponse20072DataNotation notation) {
  ...
  **/
  ...
  public InlineResponse20072DataNotation getNotation() {
    return notation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NOTATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNotation(InlineResponse20072DataNotation notation) {
    this.notation = notation;
  }


  public InlineResponse20072DataListing isPrimary(Boolean isPrimary) {
  ...
  **/
  ...
  public InlineResponse20072DataListing permanentIdentifier(String permanentIdentifier) {
  ...
  **/
  ...
  public InlineResponse20072DataListing tickerExchange(String tickerExchange) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_72_data_listing object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20072DataListing inlineResponse20072DataListing = (InlineResponse20072DataListing) o;
    return Objects.equals(this.notation, inlineResponse20072DataListing.notation) &&
        equalsNullable(this.isPrimary, inlineResponse20072DataListing.isPrimary) &&
        equalsNullable(this.permanentIdentifier, inlineResponse20072DataListing.permanentIdentifier) &&
        equalsNullable(this.tickerExchange, inlineResponse20072DataListing.tickerExchange);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(notation, hashCodeNullable(isPrimary), hashCodeNullable(permanentIdentifier), hashCodeNullable(tickerExchange));
  }
