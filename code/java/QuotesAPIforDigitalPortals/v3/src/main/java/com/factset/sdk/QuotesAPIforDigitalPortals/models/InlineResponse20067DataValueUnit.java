...
@JsonPropertyOrder({
  InlineResponse20067DataValueUnit.JSON_PROPERTY_ID,
  InlineResponse20067DataValueUnit.JSON_PROPERTY_CODE,
  InlineResponse20067DataValueUnit.JSON_PROPERTY_ISO_CODE,
  InlineResponse20067DataValueUnit.JSON_PROPERTY_NAME
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20067DataValueUnit implements Serializable {
  ...
  public InlineResponse20067DataValueUnit() { 
  }

  public InlineResponse20067DataValueUnit id(BigDecimal id) {
  ...
  **/
  ...
  public InlineResponse20067DataValueUnit code(String code) {
  ...
  **/
  ...
  public InlineResponse20067DataValueUnit isoCode(String isoCode) {
  ...
  **/
  ...
  public InlineResponse20067DataValueUnit name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_67_data_valueUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20067DataValueUnit inlineResponse20067DataValueUnit = (InlineResponse20067DataValueUnit) o;
    return equalsNullable(this.id, inlineResponse20067DataValueUnit.id) &&
        equalsNullable(this.code, inlineResponse20067DataValueUnit.code) &&
        equalsNullable(this.isoCode, inlineResponse20067DataValueUnit.isoCode) &&
        equalsNullable(this.name, inlineResponse20067DataValueUnit.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20067DataValueUnit {\n");
