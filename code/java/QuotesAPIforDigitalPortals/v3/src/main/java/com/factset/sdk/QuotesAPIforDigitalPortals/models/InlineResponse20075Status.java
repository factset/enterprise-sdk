...
@JsonPropertyOrder({
  InlineResponse20075Status.JSON_PROPERTY_CODE,
  InlineResponse20075Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20075Status.JSON_PROPERTY_DETAILS,
  InlineResponse20075Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20075Status implements Serializable {
  ...
  public InlineResponse20075Status() { 
  }

  public InlineResponse20075Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20075Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20075Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20075Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_75_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20075Status inlineResponse20075Status = (InlineResponse20075Status) o;
    return equalsNullable(this.code, inlineResponse20075Status.code) &&
        equalsNullable(this.identifier, inlineResponse20075Status.identifier) &&
        equalsNullable(this.details, inlineResponse20075Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20075Status.encryptedDetails);
  }
