...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'quotesapifordigitalportals' jar has been published to maven central.
    mavenLocal()       // Needed if the 'quotesapifordigitalportals' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:quotesapifordigitalportals:0.9.0"
  }
```
...
- `target/quotesapifordigitalportals-0.9.0.jar`
- `target/lib/*.jar`
