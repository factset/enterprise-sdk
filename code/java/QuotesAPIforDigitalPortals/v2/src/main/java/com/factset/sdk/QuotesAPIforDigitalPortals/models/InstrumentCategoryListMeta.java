...
@JsonPropertyOrder({
  InstrumentCategoryListMeta.JSON_PROPERTY_ATTRIBUTES,
  InstrumentCategoryListMeta.JSON_PROPERTY_LANGUAGE,
  InstrumentCategoryListMeta.JSON_PROPERTY_SORT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InstrumentCategoryListMeta implements Serializable {
  ...
  public InstrumentCategoryListMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public InstrumentCategoryListMeta language(String language) {
  ...
  **/
  ...
  public InstrumentCategoryListMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public InstrumentCategoryListMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  /**
   * Return true if this _instrument_category_list_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InstrumentCategoryListMeta instrumentCategoryListMeta = (InstrumentCategoryListMeta) o;
    return Objects.equals(this.attributes, instrumentCategoryListMeta.attributes) &&
        Objects.equals(this.language, instrumentCategoryListMeta.language) &&
        Objects.equals(this.sort, instrumentCategoryListMeta.sort);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstrumentCategoryListMeta {\n");
