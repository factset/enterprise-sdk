...
@JsonPropertyOrder({
  BasicMediaTypeListMeta.JSON_PROPERTY_ATTRIBUTES,
  BasicMediaTypeListMeta.JSON_PROPERTY_SORT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class BasicMediaTypeListMeta implements Serializable {
  ...
  public BasicMediaTypeListMeta() { 
  }

  public BasicMediaTypeListMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public BasicMediaTypeListMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public BasicMediaTypeListMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public BasicMediaTypeListMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  /**
   * Return true if this _basic_media_type_list_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BasicMediaTypeListMeta basicMediaTypeListMeta = (BasicMediaTypeListMeta) o;
    return Objects.equals(this.attributes, basicMediaTypeListMeta.attributes) &&
        Objects.equals(this.sort, basicMediaTypeListMeta.sort);
  }
