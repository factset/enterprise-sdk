...
import com.factset.sdk.FactSetOwnershipReportBuilder.models.CategoryCategory;
...
import com.factset.sdk.FactSetOwnershipReportBuilder.models.CurrencySymbolCurrencySymbol;
import com.factset.sdk.FactSetOwnershipReportBuilder.models.Description;
import com.factset.sdk.FactSetOwnershipReportBuilder.models.DescriptionDescription;
import com.factset.sdk.FactSetOwnershipReportBuilder.models.Frequency;
import com.factset.sdk.FactSetOwnershipReportBuilder.models.FrequencyFrequency;
...
import com.factset.sdk.FactSetOwnershipReportBuilder.models.ScaleScale;
import com.factset.sdk.FactSetOwnershipReportBuilder.models.ValueType;
import com.factset.sdk.FactSetOwnershipReportBuilder.models.ValueTypeValueType;
...
public class MetadataEntry extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class MetadataEntryDeserializer extends StdDeserializer<MetadataEntry> {
        ...
        public MetadataEntry deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (FsymId.class.equals(Integer.class) || FsymId.class.equals(Long.class) || FsymId.class.equals(Float.class) || FsymId.class.equals(Double.class) || FsymId.class.equals(Boolean.class) || FsymId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FsymId.class.equals(Integer.class) || FsymId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FsymId.class.equals(Float.class) || FsymId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (FsymId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FsymId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<FsymId>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'FsymId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FsymId'", e);
            }
    ...
    static {
        ...
        schemas.put("FsymId", new GenericType<FsymId>() {
        });
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, FsymId, Scale, ValueType
     *
    ...
    public void setActualInstance(Object instance) {
        // FsymId
        if (JSON.isInstanceOf(FsymId.class, instance, new HashSet<Class<?>>())) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Category, CurrencyCode, CurrencySymbol, Description, Frequency, FsymId, Scale, ValueType");
    }
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, FsymId, Scale, ValueType
     *
     * @return The actual instance (Category, CurrencyCode, CurrencySymbol, Description, Frequency, FsymId, Scale, ValueType)
     */
    @Override
    ...
    /**
     * Get the actual instance of `FsymId`. If the actual instance is not `FsymId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FsymId`
     * @throws ClassCastException if the instance is not `FsymId`
     */
    public FsymId getFsymId() throws ClassCastException {
        return (FsymId)super.getActualInstance();
    }
