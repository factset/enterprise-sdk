...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetpeople)](https://search.maven.org/artifact/com.factset.sdk/factsetpeople)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetpeople:1.0.11"
  }
```
