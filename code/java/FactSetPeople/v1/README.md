...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'factsetpeople' jar has been published to maven central.
    mavenLocal()       // Needed if the 'factsetpeople' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:factsetpeople:0.9.0"
  }
```
...
- `target/factsetpeople-0.9.0.jar`
- `target/lib/*.jar`
