...
import com.factset.sdk.TimeSeriesAPIforDigitalPortals.models.VendorChartIQTimeSeriesEodSubsampleListData;
...
public class InlineObject2 implements Serializable {
  ...
  private VendorChartIQTimeSeriesEodSubsampleListData data;
  ...
  @JsonCreator
  public InlineObject2(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) VendorChartIQTimeSeriesEodSubsampleListData data
  ) {
    this();
    this.data = data;
  }

  public InlineObject2 data(VendorChartIQTimeSeriesEodSubsampleListData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public VendorChartIQTimeSeriesEodSubsampleListData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(VendorChartIQTimeSeriesEodSubsampleListData data) {
    this.data = data;
  }


  public InlineObject2 meta(VendorChartIQTimeSeriesEodListMeta meta) {
    this.meta = meta;
    return this;
  }
