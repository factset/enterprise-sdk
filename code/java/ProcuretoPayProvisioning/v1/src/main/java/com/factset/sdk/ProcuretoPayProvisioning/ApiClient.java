...
import com.factset.sdk.ProcuretoPayProvisioning.auth.Authentication;
import com.factset.sdk.ProcuretoPayProvisioning.auth.HttpBasicAuth;
import com.factset.sdk.ProcuretoPayProvisioning.auth.HttpBearerAuth;
import com.factset.sdk.ProcuretoPayProvisioning.auth.FactSetOAuth2ClientAuth;
import com.factset.sdk.ProcuretoPayProvisioning.auth.ApiKeyAuth;
import com.factset.sdk.ProcuretoPayProvisioning.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/procuretopay/provisioning";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/procuretopay/provisioning",
  ...
  protected Map<String, List<ServerConfiguration>> operationServers = new HashMap<String, List<ServerConfiguration>>() {{
    put("EntitlementManagementApi.addProductsPost", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("EntitlementManagementApi.removeProductsPost", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("OrderStatusApi.transactionStatusGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("UserManagementApi.cancelIndividualPost", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("UserManagementApi.createIndividualPost", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("UserManagementApi.getIndividualGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("UserManagementApi.listIndividualsGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("UserManagementApi.modifyIndividualPost", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api.factset.com/procuretopay/provisioning/",
        "No description provided",
        new HashMap<String, ServerVariable>()
  ...
  public ApiClient(Map<String, Authentication> authMap, OAuth2Client oauth2Client) {
    ...
    setUserAgent("fds-sdk/java/ProcuretoPayProvisioning/0.9.1");
   ...
   * @return this instance of {@link com.factset.sdk.ProcuretoPayProvisioning.ApiClient} object.
   */
