...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/procure-to-pay/invoice-and-billing/v2";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/procure-to-pay/invoice-and-billing/v2",
      "Production Environment",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.uat.factset.com/procure-to-pay/invoice-and-billing/v2",
      "UAT environment",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ProcuretoPayInvoiceandBilling/0.2.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
