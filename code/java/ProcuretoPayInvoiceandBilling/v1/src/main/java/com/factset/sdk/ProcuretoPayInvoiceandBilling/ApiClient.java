...
import com.factset.sdk.ProcuretoPayInvoiceandBilling.auth.Authentication;
import com.factset.sdk.ProcuretoPayInvoiceandBilling.auth.HttpBasicAuth;
import com.factset.sdk.ProcuretoPayInvoiceandBilling.auth.HttpBearerAuth;
import com.factset.sdk.ProcuretoPayInvoiceandBilling.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ProcuretoPayInvoiceandBilling.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api-sandbox.factset.com/procuretopay/invoice-and-billing";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api-sandbox.factset.com/procuretopay/invoice-and-billing",
  ...
  protected Map<String, List<ServerConfiguration>> operationServers = new HashMap<String, List<ServerConfiguration>>() {{
    put("InvoiceAndBillingApi.getFitsReportGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api-sandbox.factset.com/procuretopay/invoice-and-billing/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("InvoiceAndBillingApi.getInvoiceGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api-sandbox.factset.com/procuretopay/invoice-and-billing/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("InvoiceAndBillingApi.invoiceDetailsGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api-sandbox.factset.com/procuretopay/invoice-and-billing/",
        "No description provided",
        new HashMap<String, ServerVariable>()
    ...
    put("InvoiceAndBillingApi.listInvoicesGet", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://api-sandbox.factset.com/procuretopay/invoice-and-billing/",
        "No description provided",
        new HashMap<String, ServerVariable>()
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ProcuretoPayInvoiceandBilling/0.1.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ProcuretoPayInvoiceandBilling.ApiClient} object.
   */
