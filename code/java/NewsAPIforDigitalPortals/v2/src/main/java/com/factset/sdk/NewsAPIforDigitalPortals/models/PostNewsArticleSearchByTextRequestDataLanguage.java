 ...
 */
@ApiModel(description = "Languages of the news article. A news article is found if one of the specified languages matches. See endpoint `/basic/language/list` for valid values.")
@JsonPropertyOrder({
  PostNewsArticleSearchByTextRequestDataLanguage.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostNewsArticleSearchByTextRequestDataLanguage implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public PostNewsArticleSearchByTextRequestDataLanguage() { 
  }

  public PostNewsArticleSearchByTextRequestDataLanguage ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostNewsArticleSearchByTextRequestDataLanguage addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostNewsArticleSearchByTextRequest_data_language object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNewsArticleSearchByTextRequestDataLanguage postNewsArticleSearchByTextRequestDataLanguage = (PostNewsArticleSearchByTextRequestDataLanguage) o;
    return Objects.equals(this.ids, postNewsArticleSearchByTextRequestDataLanguage.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostNewsArticleSearchByTextRequestDataLanguage {\n");
