...
@JsonPropertyOrder({
  NewsPublisherSearchByNameDataFilterDelivery.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class NewsPublisherSearchByNameDataFilterDelivery implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private BigDecimal id;

  public NewsPublisherSearchByNameDataFilterDelivery() { 
  }

  public NewsPublisherSearchByNameDataFilterDelivery id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Identifier of delivery.")
  ...
  /**
   * Return true if this _news_publisher_searchByName_data_filter_delivery object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewsPublisherSearchByNameDataFilterDelivery newsPublisherSearchByNameDataFilterDelivery = (NewsPublisherSearchByNameDataFilterDelivery) o;
    return Objects.equals(this.id, newsPublisherSearchByNameDataFilterDelivery.id);
  }
