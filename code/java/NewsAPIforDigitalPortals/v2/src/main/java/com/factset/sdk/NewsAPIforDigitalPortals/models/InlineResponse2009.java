...
import com.factset.sdk.NewsAPIforDigitalPortals.models.InlineResponse2009Data;
...
public class InlineResponse2009 implements Serializable {
  ...
  private java.util.List<InlineResponse2009Data> data = null;
  ...
  public InlineResponse2009 data(java.util.List<InlineResponse2009Data> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public java.util.List<InlineResponse2009Data> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<InlineResponse2009Data> data) {
    this.data = data;
  }


  public InlineResponse2009 meta(InlineResponse200Meta meta) {
    this.meta = meta;
    return this;
  }
