...
@JsonPropertyOrder({
  PostNewsArticleListRequestDataFilterLanguage.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostNewsArticleListRequestDataFilterLanguage implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public PostNewsArticleListRequestDataFilterLanguage() { 
  }

  public PostNewsArticleListRequestDataFilterLanguage ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostNewsArticleListRequestDataFilterLanguage addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostNewsArticleListRequest_data_filter_language object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNewsArticleListRequestDataFilterLanguage postNewsArticleListRequestDataFilterLanguage = (PostNewsArticleListRequestDataFilterLanguage) o;
    return Objects.equals(this.ids, postNewsArticleListRequestDataFilterLanguage.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostNewsArticleListRequestDataFilterLanguage {\n");
