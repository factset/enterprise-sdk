 ...
 */
@ApiModel(description = "Filter for specific distributors of the news article. See endpoint `/news/distributor/list` for valid values.")
@JsonPropertyOrder({
...
public class PostNewsArticleListRequestDataFilterDistributor implements Serializable {
  ...
  public PostNewsArticleListRequestDataFilterDistributor() { 
  }

  public PostNewsArticleListRequestDataFilterDistributor ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostNewsArticleListRequestDataFilterDistributor addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostNewsArticleListRequest_data_filter_distributor object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNewsArticleListRequestDataFilterDistributor postNewsArticleListRequestDataFilterDistributor = (PostNewsArticleListRequestDataFilterDistributor) o;
    return Objects.equals(this.ids, postNewsArticleListRequestDataFilterDistributor.ids);
  }
