...
@JsonPropertyOrder({
  PostNewsArticleSearchByTextRequestDataCategories.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostNewsArticleSearchByTextRequestDataCategories implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public PostNewsArticleSearchByTextRequestDataCategories() { 
  }

  public PostNewsArticleSearchByTextRequestDataCategories ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostNewsArticleSearchByTextRequestDataCategories addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostNewsArticleSearchByTextRequest_data_categories object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNewsArticleSearchByTextRequestDataCategories postNewsArticleSearchByTextRequestDataCategories = (PostNewsArticleSearchByTextRequestDataCategories) o;
    return Objects.equals(this.ids, postNewsArticleSearchByTextRequestDataCategories.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostNewsArticleSearchByTextRequestDataCategories {\n");
