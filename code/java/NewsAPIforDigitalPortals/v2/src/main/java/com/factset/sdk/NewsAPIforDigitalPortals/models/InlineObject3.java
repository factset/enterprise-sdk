...
import com.factset.sdk.NewsAPIforDigitalPortals.models.NewsArticleListByInstrumentData;
...
public class InlineObject3 implements Serializable {
  ...
  private NewsArticleListByInstrumentData data;
  ...
  **/
  ...
  public NewsArticleListByInstrumentData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(NewsArticleListByInstrumentData data) {
    this.data = data;
  }


  public InlineObject3 meta(NewsArticleListMeta meta) {
    this.meta = meta;
    return this;
  }
