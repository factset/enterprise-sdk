...
@JsonPropertyOrder({
  NewsArticleListDataFilterPublisher.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class NewsArticleListDataFilterPublisher implements Serializable {
  ...
  public NewsArticleListDataFilterPublisher addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _news_article_list_data_filter_publisher object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewsArticleListDataFilterPublisher newsArticleListDataFilterPublisher = (NewsArticleListDataFilterPublisher) o;
    return Objects.equals(this.ids, newsArticleListDataFilterPublisher.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewsArticleListDataFilterPublisher {\n");
