...
@JsonPropertyOrder({
  NewsPublisherSearchByNameMeta.JSON_PROPERTY_ATTRIBUTES,
  NewsPublisherSearchByNameMeta.JSON_PROPERTY_SORT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class NewsPublisherSearchByNameMeta implements Serializable {
  ...
  public NewsPublisherSearchByNameMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public NewsPublisherSearchByNameMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public NewsPublisherSearchByNameMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  /**
   * Return true if this _news_publisher_searchByName_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewsPublisherSearchByNameMeta newsPublisherSearchByNameMeta = (NewsPublisherSearchByNameMeta) o;
    return Objects.equals(this.attributes, newsPublisherSearchByNameMeta.attributes) &&
        Objects.equals(this.sort, newsPublisherSearchByNameMeta.sort);
  }
