...
@JsonPropertyOrder({
  InlineResponse2003DataStatus.JSON_PROPERTY_CODE,
  InlineResponse2003DataStatus.JSON_PROPERTY_IDENTIFIER,
  InlineResponse2003DataStatus.JSON_PROPERTY_DETAILS,
  InlineResponse2003DataStatus.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2003DataStatus implements Serializable {
  ...
  public InlineResponse2003DataStatus() { 
  }

  public InlineResponse2003DataStatus code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse2003DataStatus identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse2003DataStatus details(String details) {
  ...
  **/
  ...
  public InlineResponse2003DataStatus encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_3_data_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2003DataStatus inlineResponse2003DataStatus = (InlineResponse2003DataStatus) o;
    return equalsNullable(this.code, inlineResponse2003DataStatus.code) &&
        equalsNullable(this.identifier, inlineResponse2003DataStatus.identifier) &&
        equalsNullable(this.details, inlineResponse2003DataStatus.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse2003DataStatus.encryptedDetails);
  }
