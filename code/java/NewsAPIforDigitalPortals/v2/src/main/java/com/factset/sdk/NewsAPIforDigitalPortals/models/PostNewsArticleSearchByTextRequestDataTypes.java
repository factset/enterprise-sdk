...
@JsonPropertyOrder({
  PostNewsArticleSearchByTextRequestDataTypes.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostNewsArticleSearchByTextRequestDataTypes implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public PostNewsArticleSearchByTextRequestDataTypes() { 
  }

  public PostNewsArticleSearchByTextRequestDataTypes ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostNewsArticleSearchByTextRequestDataTypes addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostNewsArticleSearchByTextRequest_data_types object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNewsArticleSearchByTextRequestDataTypes postNewsArticleSearchByTextRequestDataTypes = (PostNewsArticleSearchByTextRequestDataTypes) o;
    return Objects.equals(this.ids, postNewsArticleSearchByTextRequestDataTypes.ids);
  }
