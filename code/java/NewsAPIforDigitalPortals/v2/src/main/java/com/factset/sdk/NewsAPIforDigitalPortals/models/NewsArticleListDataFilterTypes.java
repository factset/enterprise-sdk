...
@JsonPropertyOrder({
  NewsArticleListDataFilterTypes.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class NewsArticleListDataFilterTypes implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public NewsArticleListDataFilterTypes() { 
  }

  public NewsArticleListDataFilterTypes ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public NewsArticleListDataFilterTypes addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _news_article_list_data_filter_types object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewsArticleListDataFilterTypes newsArticleListDataFilterTypes = (NewsArticleListDataFilterTypes) o;
    return Objects.equals(this.ids, newsArticleListDataFilterTypes.ids);
  }
