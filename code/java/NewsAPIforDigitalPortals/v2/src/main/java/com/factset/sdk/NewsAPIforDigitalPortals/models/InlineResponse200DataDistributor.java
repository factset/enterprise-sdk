...
@JsonPropertyOrder({
  InlineResponse200DataDistributor.JSON_PROPERTY_ID,
  InlineResponse200DataDistributor.JSON_PROPERTY_NAME
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse200DataDistributor implements Serializable {
  ...
  public InlineResponse200DataDistributor() { 
  }

  public InlineResponse200DataDistributor id(BigDecimal id) {
  ...
  **/
  ...
  public InlineResponse200DataDistributor name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_data_distributor object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataDistributor inlineResponse200DataDistributor = (InlineResponse200DataDistributor) o;
    return equalsNullable(this.id, inlineResponse200DataDistributor.id) &&
        equalsNullable(this.name, inlineResponse200DataDistributor.name);
  }
