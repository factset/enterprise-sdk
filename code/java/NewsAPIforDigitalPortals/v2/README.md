...
# News API for Digital Portals client library for Java

[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/newsapifordigitalportals)](https://search.maven.org/artifact/com.factset.sdk/newsapifordigitalportals)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:newsapifordigitalportals:0.10.10"
  }
```
