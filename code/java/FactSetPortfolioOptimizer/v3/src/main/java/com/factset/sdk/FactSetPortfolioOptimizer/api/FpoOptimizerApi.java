...
import com.factset.sdk.FactSetPortfolioOptimizer.models.FPOOptimizationParametersRoot;
import com.factset.sdk.FactSetPortfolioOptimizer.models.ObjectRoot;
...
public class FpoOptimizerApi {
 ...
 /**
  ...
  public ApiResponse<Void> cancelOptimizationByIdWithHttpInfo(String id) throws ApiException {
    ...
    String localVarPath = "/analytics/engines/fpo/v3/optimizations/{id}"
  ...
  public ApiResponse<ObjectRoot> getOptimizationResultWithHttpInfo(String id, String accept) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/fpo/v3/optimizations/{id}/result"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
  ...
  public ApiResponse<ObjectRoot> getOptimizationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/fpo/v3/optimizations/{id}/status"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
