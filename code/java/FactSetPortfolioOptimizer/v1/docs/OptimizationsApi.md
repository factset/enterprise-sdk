...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling OptimizationsApi#getFPOOptimizationById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> runFPOOptimization(fpOOptimizationParameters)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        OptimizationsApi apiInstance = new OptimizationsApi(defaultClient);
        FPOOptimizationParameters fpOOptimizationParameters = new FPOOptimizationParameters(); // FPOOptimizationParameters | 
        try {
            apiInstance.runFPOOptimization(fpOOptimizationParameters);

        } catch (ApiException e) {
            System.err.println("Exception when calling OptimizationsApi#runFPOOptimization");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
