...
public class OptimizationsApi {
   ...
   */
  public void cancelFPOOptimizationById(String id) throws ApiException {
   ...
   */
  public ApiResponse<Void> cancelFPOOptimizationByIdWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling cancelFPOOptimizationById");
    }
    
    // create path and map variables
    String localVarPath = "/analytics/engines/fpo/v1/optimizations/{id}"
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Expected response once optimization is completed, returns JSON in the format specified in the Run Optimization endpoint. </td><td>  * Content-Encoding - Standard HTTP header. Header value based on Accept-Encoding Request header. <br>  * Content-Type - Standard HTTP header. <br>  * Transfer-Encoding - Standard HTTP header. Header value will be set to Chunked if Accept-Encoding header is specified. <br>  * X-DataDirect-Request-Key - FactSet’s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public void getFPOOptimizationById(String id) throws ApiException {
   ...
   */
  public ApiResponse<Void> getFPOOptimizationByIdWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getFPOOptimizationById");
    }
   ...
   * @param fpOOptimizationParameters  (optional)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 201 </td><td> Expected response if optimization is completed within 30 seconds, returns JSON in the format specified in the Run optimization endpoint. </td><td>  * X-DataDirect-Request-Key - FactSet’s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public void runFPOOptimization(FPOOptimizationParameters fpOOptimizationParameters) throws ApiException {
   ...
   */
  public ApiResponse<Void> runFPOOptimizationWithHttpInfo(FPOOptimizationParameters fpOOptimizationParameters) throws ApiException {
    Object localVarPostBody = fpOOptimizationParameters;
    
    // create path and map variables
    String localVarPath = "/analytics/engines/fpo/v1/optimizations";
