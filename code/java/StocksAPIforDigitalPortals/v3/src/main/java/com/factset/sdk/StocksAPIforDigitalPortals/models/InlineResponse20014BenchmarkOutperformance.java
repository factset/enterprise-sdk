...
@JsonPropertyOrder({
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_WEEK1,
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_MONTH1,
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_MONTHS3,
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_MONTHS6,
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_YEAR1,
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_YEARS3,
  InlineResponse20014BenchmarkOutperformance.JSON_PROPERTY_YEARS5
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse20014BenchmarkOutperformance implements Serializable {
  ...
  public InlineResponse20014BenchmarkOutperformance() { 
  }

  public InlineResponse20014BenchmarkOutperformance week1(BigDecimal week1) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Outperformance for the time range one week.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkOutperformance month1(BigDecimal month1) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Outperformance for the time range one month.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkOutperformance months3(BigDecimal months3) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Outperformance for the time range three months.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkOutperformance months6(BigDecimal months6) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Outperformance for the time range six months.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkOutperformance year1(BigDecimal year1) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Outperformance for the time range one year.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkOutperformance years3(BigDecimal years3) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Outperformance for the time range three years.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkOutperformance years5(BigDecimal years5) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Outperformance for the time range five years.")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_14_benchmark_outperformance object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20014BenchmarkOutperformance inlineResponse20014BenchmarkOutperformance = (InlineResponse20014BenchmarkOutperformance) o;
    return equalsNullable(this.week1, inlineResponse20014BenchmarkOutperformance.week1) &&
        equalsNullable(this.month1, inlineResponse20014BenchmarkOutperformance.month1) &&
        equalsNullable(this.months3, inlineResponse20014BenchmarkOutperformance.months3) &&
        equalsNullable(this.months6, inlineResponse20014BenchmarkOutperformance.months6) &&
        equalsNullable(this.year1, inlineResponse20014BenchmarkOutperformance.year1) &&
        equalsNullable(this.years3, inlineResponse20014BenchmarkOutperformance.years3) &&
        equalsNullable(this.years5, inlineResponse20014BenchmarkOutperformance.years5);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(week1), hashCodeNullable(month1), hashCodeNullable(months3), hashCodeNullable(months6), hashCodeNullable(year1), hashCodeNullable(years3), hashCodeNullable(years5));
  }
