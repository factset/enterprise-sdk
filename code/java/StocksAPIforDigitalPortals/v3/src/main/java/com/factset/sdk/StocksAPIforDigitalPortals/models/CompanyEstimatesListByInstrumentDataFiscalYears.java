 ...
 */
@ApiModel(description = "The response includes data items from the fiscal year specified as start (inclusive) up to the fiscal year specified as end (inclusive). The attribute `start` must be less than or equal to the attribute `end`.")
@JsonPropertyOrder({
  CompanyEstimatesListByInstrumentDataFiscalYears.JSON_PROPERTY_START,
  CompanyEstimatesListByInstrumentDataFiscalYears.JSON_PROPERTY_END
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CompanyEstimatesListByInstrumentDataFiscalYears implements Serializable {
  ...
  public CompanyEstimatesListByInstrumentDataFiscalYears() { 
  }

  public CompanyEstimatesListByInstrumentDataFiscalYears start(BigDecimal start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public CompanyEstimatesListByInstrumentDataFiscalYears end(BigDecimal end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this _company_estimates_listByInstrument_data_fiscalYears object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CompanyEstimatesListByInstrumentDataFiscalYears companyEstimatesListByInstrumentDataFiscalYears = (CompanyEstimatesListByInstrumentDataFiscalYears) o;
    return Objects.equals(this.start, companyEstimatesListByInstrumentDataFiscalYears.start) &&
        Objects.equals(this.end, companyEstimatesListByInstrumentDataFiscalYears.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyEstimatesListByInstrumentDataFiscalYears {\n");
