 ...
 */
@ApiModel(description = "Net income, which is the profit before extraordinary items and preferred and common dividends, but after operating and non-operating income and expenses, reserves, income taxes, minority interest and equity in earnings.")
@JsonPropertyOrder({
  InlineResponse2001DataIncomeStatementNetIncome.JSON_PROPERTY_VALUE,
...
public class InlineResponse2001DataIncomeStatementNetIncome implements Serializable {
  ...
  private JsonNullable<BigDecimal> margin = JsonNullable.<BigDecimal>undefined();

  public InlineResponse2001DataIncomeStatementNetIncome() { 
  }

  public InlineResponse2001DataIncomeStatementNetIncome value(BigDecimal value) {
  ...
  **/
  ...
  public InlineResponse2001DataIncomeStatementNetIncome growth(BigDecimal growth) {
  ...
  **/
  ...
  public InlineResponse2001DataIncomeStatementNetIncome margin(BigDecimal margin) {
    this.margin = JsonNullable.<BigDecimal>of(margin);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<BigDecimal> getMargin_JsonNullable() {
    return margin;
  }
  
  @JsonProperty(JSON_PROPERTY_MARGIN)
  public void setMargin_JsonNullable(JsonNullable<BigDecimal> margin) {
    this.margin = margin;
  }
  ...
  /**
   * Return true if this inline_response_200_1_data_incomeStatement_netIncome object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataIncomeStatementNetIncome inlineResponse2001DataIncomeStatementNetIncome = (InlineResponse2001DataIncomeStatementNetIncome) o;
    return equalsNullable(this.value, inlineResponse2001DataIncomeStatementNetIncome.value) &&
        equalsNullable(this.growth, inlineResponse2001DataIncomeStatementNetIncome.growth) &&
        equalsNullable(this.margin, inlineResponse2001DataIncomeStatementNetIncome.margin);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(value), hashCodeNullable(growth), hashCodeNullable(margin));
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse2001DataIncomeStatementNetIncome {\n");
