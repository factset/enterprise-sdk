...
@JsonPropertyOrder({
  InlineResponse2005Type.JSON_PROPERTY_ID,
  InlineResponse2005Type.JSON_PROPERTY_NAME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse2005Type implements Serializable {
  ...
  public InlineResponse2005Type() { 
  }

  public InlineResponse2005Type id(BigDecimal id) {
  ...
  **/
  ...
  public InlineResponse2005Type name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_5_type object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2005Type inlineResponse2005Type = (InlineResponse2005Type) o;
    return equalsNullable(this.id, inlineResponse2005Type.id) &&
        equalsNullable(this.name, inlineResponse2005Type.name);
  }
