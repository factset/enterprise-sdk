 ...
 */
@ApiModel(description = "Total value of the shareholders' equity.")
@JsonPropertyOrder({
  InlineResponse2001DataBalanceSheetTotalShareholdersEquity.JSON_PROPERTY_VALUE,
  InlineResponse2001DataBalanceSheetTotalShareholdersEquity.JSON_PROPERTY_GROWTH,
...
public class InlineResponse2001DataBalanceSheetTotalShareholdersEquity implements Serializable {
  ...
  public InlineResponse2001DataBalanceSheetTotalShareholdersEquity() { 
  }

  public InlineResponse2001DataBalanceSheetTotalShareholdersEquity value(BigDecimal value) {
  ...
  **/
  ...
  public InlineResponse2001DataBalanceSheetTotalShareholdersEquity growth(BigDecimal growth) {
  ...
  **/
  ...
  public InlineResponse2001DataBalanceSheetTotalShareholdersEquity ratioToTotalAssets(BigDecimal ratioToTotalAssets) {
  ...
  **/
  ...
  public InlineResponse2001DataBalanceSheetTotalShareholdersEquity returnOnEquity(BigDecimal returnOnEquity) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_1_data_balanceSheet_totalShareholdersEquity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataBalanceSheetTotalShareholdersEquity inlineResponse2001DataBalanceSheetTotalShareholdersEquity = (InlineResponse2001DataBalanceSheetTotalShareholdersEquity) o;
    return equalsNullable(this.value, inlineResponse2001DataBalanceSheetTotalShareholdersEquity.value) &&
        equalsNullable(this.growth, inlineResponse2001DataBalanceSheetTotalShareholdersEquity.growth) &&
        equalsNullable(this.ratioToTotalAssets, inlineResponse2001DataBalanceSheetTotalShareholdersEquity.ratioToTotalAssets) &&
        equalsNullable(this.returnOnEquity, inlineResponse2001DataBalanceSheetTotalShareholdersEquity.returnOnEquity);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(value), hashCodeNullable(growth), hashCodeNullable(ratioToTotalAssets), hashCodeNullable(returnOnEquity));
  }
