 ...
 */
@ApiModel(description = "Total claim and loss expenses, which is all expenses related to the payment of policy benefits, including adjusters' fees, investigating expenses and other costs associated with settling claims. Relevant for insurance companies.")
@JsonPropertyOrder({
  InlineResponse2001DataIncomeStatementClaimLossExpense.JSON_PROPERTY_VALUE,
...
public class InlineResponse2001DataIncomeStatementClaimLossExpense implements Serializable {
  ...
  public static final String JSON_PROPERTY_LOSS_RATIO = "lossRatio";
  private JsonNullable<BigDecimal> lossRatio = JsonNullable.<BigDecimal>undefined();

  public InlineResponse2001DataIncomeStatementClaimLossExpense() { 
  }

  public InlineResponse2001DataIncomeStatementClaimLossExpense value(BigDecimal value) {
  ...
  **/
  ...
  public InlineResponse2001DataIncomeStatementClaimLossExpense growth(BigDecimal growth) {
  ...
  **/
  ...
  public InlineResponse2001DataIncomeStatementClaimLossExpense lossRatio(BigDecimal lossRatio) {
    this.lossRatio = JsonNullable.<BigDecimal>of(lossRatio);
    return this;
  }
  ...
  **/
  ...
  public BigDecimal getLossRatio() {
        return lossRatio.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_LOSS_RATIO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<BigDecimal> getLossRatio_JsonNullable() {
    return lossRatio;
  }
  
  @JsonProperty(JSON_PROPERTY_LOSS_RATIO)
  public void setLossRatio_JsonNullable(JsonNullable<BigDecimal> lossRatio) {
  ...
  /**
   * Return true if this inline_response_200_1_data_incomeStatement_claimLossExpense object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataIncomeStatementClaimLossExpense inlineResponse2001DataIncomeStatementClaimLossExpense = (InlineResponse2001DataIncomeStatementClaimLossExpense) o;
    return equalsNullable(this.value, inlineResponse2001DataIncomeStatementClaimLossExpense.value) &&
        equalsNullable(this.growth, inlineResponse2001DataIncomeStatementClaimLossExpense.growth) &&
        equalsNullable(this.lossRatio, inlineResponse2001DataIncomeStatementClaimLossExpense.lossRatio);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(value), hashCodeNullable(growth), hashCodeNullable(lossRatio));
  }
