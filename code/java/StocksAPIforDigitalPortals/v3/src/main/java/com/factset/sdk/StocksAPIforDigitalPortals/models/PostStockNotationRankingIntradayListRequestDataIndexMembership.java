...
@JsonPropertyOrder({
  PostStockNotationRankingIntradayListRequestDataIndexMembership.JSON_PROPERTY_IDS,
  PostStockNotationRankingIntradayListRequestDataIndexMembership.JSON_PROPERTY_USE_ALTERNATIVE_NOTATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostStockNotationRankingIntradayListRequestDataIndexMembership implements Serializable {
  ...
  public PostStockNotationRankingIntradayListRequestDataIndexMembership() { 
  }

  public PostStockNotationRankingIntradayListRequestDataIndexMembership ids(java.util.Set<String> ids) {
    this.ids = ids;
    return this;
  }

  public PostStockNotationRankingIntradayListRequestDataIndexMembership addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public PostStockNotationRankingIntradayListRequestDataIndexMembership useAlternativeNotation(Boolean useAlternativeNotation) {
  ...
  **/
  ...
  /**
   * Return true if this PostStockNotationRankingIntradayListRequest_data_indexMembership object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostStockNotationRankingIntradayListRequestDataIndexMembership postStockNotationRankingIntradayListRequestDataIndexMembership = (PostStockNotationRankingIntradayListRequestDataIndexMembership) o;
    return Objects.equals(this.ids, postStockNotationRankingIntradayListRequestDataIndexMembership.ids) &&
        Objects.equals(this.useAlternativeNotation, postStockNotationRankingIntradayListRequestDataIndexMembership.useAlternativeNotation);
  }
