...
@JsonPropertyOrder({
  StockNotationScreenerSearchDataValidationMarketPriority.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class StockNotationScreenerSearchDataValidationMarketPriority implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public StockNotationScreenerSearchDataValidationMarketPriority() { 
  }

  public StockNotationScreenerSearchDataValidationMarketPriority ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public StockNotationScreenerSearchDataValidationMarketPriority addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _stock_notation_screener_search_data_validation_market_priority object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StockNotationScreenerSearchDataValidationMarketPriority stockNotationScreenerSearchDataValidationMarketPriority = (StockNotationScreenerSearchDataValidationMarketPriority) o;
    return Objects.equals(this.ids, stockNotationScreenerSearchDataValidationMarketPriority.ids);
  }
