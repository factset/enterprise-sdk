 ...
 */
@ApiModel(description = "Gross income, which is the profit before extraordinary items and preferred and common dividends, but after operating and non-operating income and expenses, reserves, income taxes, minority interest and equity in earnings. Discontinued operations are included only if they result from a purely operating gain or loss on the discontinued business segment.")
@JsonPropertyOrder({
  InlineResponse2001DataIncomeStatementGrossIncome.JSON_PROPERTY_VALUE,
...
public class InlineResponse2001DataIncomeStatementGrossIncome implements Serializable {
  ...
  public InlineResponse2001DataIncomeStatementGrossIncome() { 
  }

  public InlineResponse2001DataIncomeStatementGrossIncome value(BigDecimal value) {
  ...
  **/
  ...
  public InlineResponse2001DataIncomeStatementGrossIncome growth(BigDecimal growth) {
  ...
  **/
  ...
  public InlineResponse2001DataIncomeStatementGrossIncome margin(BigDecimal margin) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_1_data_incomeStatement_grossIncome object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataIncomeStatementGrossIncome inlineResponse2001DataIncomeStatementGrossIncome = (InlineResponse2001DataIncomeStatementGrossIncome) o;
    return equalsNullable(this.value, inlineResponse2001DataIncomeStatementGrossIncome.value) &&
        equalsNullable(this.growth, inlineResponse2001DataIncomeStatementGrossIncome.growth) &&
        equalsNullable(this.margin, inlineResponse2001DataIncomeStatementGrossIncome.margin);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse2001DataIncomeStatementGrossIncome {\n");
