...
@JsonPropertyOrder({
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_WEEK1,
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_MONTH1,
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_MONTHS3,
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_MONTHS6,
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_YEAR1,
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_YEARS3,
  InlineResponse20014BenchmarkCorrelation.JSON_PROPERTY_YEARS5
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20014BenchmarkCorrelation implements Serializable {
  ...
  public InlineResponse20014BenchmarkCorrelation() { 
  }

  public InlineResponse20014BenchmarkCorrelation week1(BigDecimal week1) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Correlation for the time range one week.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkCorrelation month1(BigDecimal month1) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Correlation for the time range one month.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkCorrelation months3(BigDecimal months3) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Correlation for the time range three months.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkCorrelation months6(BigDecimal months6) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Correlation for the time range six months.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkCorrelation year1(BigDecimal year1) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Correlation for the time range one year.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkCorrelation years3(BigDecimal years3) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Correlation for the time range three years.")
  @JsonIgnore
  ...
  public InlineResponse20014BenchmarkCorrelation years5(BigDecimal years5) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Correlation for the time range five years.")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_14_benchmark_correlation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20014BenchmarkCorrelation inlineResponse20014BenchmarkCorrelation = (InlineResponse20014BenchmarkCorrelation) o;
    return equalsNullable(this.week1, inlineResponse20014BenchmarkCorrelation.week1) &&
        equalsNullable(this.month1, inlineResponse20014BenchmarkCorrelation.month1) &&
        equalsNullable(this.months3, inlineResponse20014BenchmarkCorrelation.months3) &&
        equalsNullable(this.months6, inlineResponse20014BenchmarkCorrelation.months6) &&
        equalsNullable(this.year1, inlineResponse20014BenchmarkCorrelation.year1) &&
        equalsNullable(this.years3, inlineResponse20014BenchmarkCorrelation.years3) &&
        equalsNullable(this.years5, inlineResponse20014BenchmarkCorrelation.years5);
  }
