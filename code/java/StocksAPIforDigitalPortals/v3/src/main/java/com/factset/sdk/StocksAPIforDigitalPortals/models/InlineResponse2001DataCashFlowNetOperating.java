 ...
 */
@ApiModel(description = "Net operating cash flow.")
@JsonPropertyOrder({
  InlineResponse2001DataCashFlowNetOperating.JSON_PROPERTY_VALUE,
...
public class InlineResponse2001DataCashFlowNetOperating implements Serializable {
  ...
  private JsonNullable<BigDecimal> returnOnInvestedCapital = JsonNullable.<BigDecimal>undefined();

  public InlineResponse2001DataCashFlowNetOperating() { 
  }

  public InlineResponse2001DataCashFlowNetOperating value(BigDecimal value) {
  ...
  **/
  ...
  public InlineResponse2001DataCashFlowNetOperating growth(BigDecimal growth) {
  ...
  **/
  ...
  public InlineResponse2001DataCashFlowNetOperating returnOnInvestedCapital(BigDecimal returnOnInvestedCapital) {
    this.returnOnInvestedCapital = JsonNullable.<BigDecimal>of(returnOnInvestedCapital);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<BigDecimal> getReturnOnInvestedCapital_JsonNullable() {
    return returnOnInvestedCapital;
  }
  
  @JsonProperty(JSON_PROPERTY_RETURN_ON_INVESTED_CAPITAL)
  public void setReturnOnInvestedCapital_JsonNullable(JsonNullable<BigDecimal> returnOnInvestedCapital) {
  ...
  /**
   * Return true if this inline_response_200_1_data_cashFlow_netOperating object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataCashFlowNetOperating inlineResponse2001DataCashFlowNetOperating = (InlineResponse2001DataCashFlowNetOperating) o;
    return equalsNullable(this.value, inlineResponse2001DataCashFlowNetOperating.value) &&
        equalsNullable(this.growth, inlineResponse2001DataCashFlowNetOperating.growth) &&
        equalsNullable(this.returnOnInvestedCapital, inlineResponse2001DataCashFlowNetOperating.returnOnInvestedCapital);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(value), hashCodeNullable(growth), hashCodeNullable(returnOnInvestedCapital));
  }
