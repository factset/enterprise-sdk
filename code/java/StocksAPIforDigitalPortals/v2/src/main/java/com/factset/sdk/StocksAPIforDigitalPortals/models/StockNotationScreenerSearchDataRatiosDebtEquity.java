 ...
 */
@ApiModel(description = "Value range for the ratio of the total debt, divided by the total shareholder's equity.")
@JsonPropertyOrder({
  StockNotationScreenerSearchDataRatiosDebtEquity.JSON_PROPERTY_MINIMUM,
  StockNotationScreenerSearchDataRatiosDebtEquity.JSON_PROPERTY_MAXIMUM
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class StockNotationScreenerSearchDataRatiosDebtEquity implements Serializable {
  ...
  **/
  ...
  public StockNotationScreenerSearchDataRatiosDebtEquity maximum(StockNotationScreenerSearchDataCurrencyDependentKeyFiguresMarketCapitalizationMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this _stock_notation_screener_search_data_ratios_debtEquity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StockNotationScreenerSearchDataRatiosDebtEquity stockNotationScreenerSearchDataRatiosDebtEquity = (StockNotationScreenerSearchDataRatiosDebtEquity) o;
    return Objects.equals(this.minimum, stockNotationScreenerSearchDataRatiosDebtEquity.minimum) &&
        Objects.equals(this.maximum, stockNotationScreenerSearchDataRatiosDebtEquity.maximum);
  }
