...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/securitymodeling/0.21.5)](https://central.sonatype.com/artifact/com.factset.sdk/securitymodeling/0.21.5)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:securitymodeling:0.21.5"
  }
```
...
------------ | ------------- | ------------- | -------------
*SecurityModelingApi* | [**deleteSecurities**](docs/SecurityModelingApi.md#deleteSecurities) | **POST** /delete | Delete existing securities
*SecurityModelingApi* | [**getSecurities**](docs/SecurityModelingApi.md#getSecurities) | **POST** /retrieve | Get existing securities
*SecurityModelingApi* | [**upsertSecurities**](docs/SecurityModelingApi.md#upsertSecurities) | **POST** /upsert | Create or update securities
