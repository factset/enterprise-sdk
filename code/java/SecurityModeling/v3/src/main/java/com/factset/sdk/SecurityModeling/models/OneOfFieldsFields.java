...
public class OneOfFieldsFields extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class OneOfFieldsFieldsSerializer extends StdSerializer<OneOfFieldsFields> {
        public OneOfFieldsFieldsSerializer(Class<OneOfFieldsFields> t) {
            super(t);
        }
    ...
    public static class OneOfFieldsFieldsDeserializer extends StdDeserializer<OneOfFieldsFields> {
