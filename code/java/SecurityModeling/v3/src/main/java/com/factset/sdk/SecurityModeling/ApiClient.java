...
import com.factset.sdk.SecurityModeling.auth.Authentication;
import com.factset.sdk.SecurityModeling.auth.HttpBasicAuth;
import com.factset.sdk.SecurityModeling.auth.HttpBearerAuth;
import com.factset.sdk.SecurityModeling.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.SecurityModeling.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/security-modeling/v3/securities";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/analytics/security-modeling/v3/securities",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/SecurityModeling/0.21.5 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.SecurityModeling.ApiClient} object.
   */
