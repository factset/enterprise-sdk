...
import com.factset.sdk.SecurityModeling.models.SMDeleteParameters;
...
public class SMDeleteParametersRoot implements Serializable {
  ...
  private java.util.List<SMDeleteParameters> data = new java.util.ArrayList<>();

  public static final String JSON_PROPERTY_META = "meta";
  private JsonNullable<Object> meta = JsonNullable.<Object>undefined();

  public SMDeleteParametersRoot() { 
  }

  @JsonCreator
  public SMDeleteParametersRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.List<SMDeleteParameters> data
  ) {
    this();
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, smDeleteParametersRoot.data) &&
        equalsNullable(this.meta, smDeleteParametersRoot.meta);
  }
