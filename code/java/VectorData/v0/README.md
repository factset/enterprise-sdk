...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/vectordata/0.0.6)](https://central.sonatype.com/artifact/com.factset.sdk/vectordata/0.0.6)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:vectordata:0.0.6"
  }
```
