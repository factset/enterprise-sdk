...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/vectordata/0.20.0)](https://central.sonatype.com/artifact/com.factset.sdk/vectordata/0.20.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:vectordata:0.20.0"
  }
```
