...
public class VectorDataRequestData implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "[\"10-K\",\"10-Q\",\"8-K\",\"News\",\"Transcripts\"]", value = "The search to include any of the document type.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(query, startDate, endDate, esgTheme, searchConcept, sentiment, documentTypes, sources);
  }
