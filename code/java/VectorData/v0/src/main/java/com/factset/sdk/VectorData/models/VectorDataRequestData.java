...
public class VectorDataRequestData implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "[\"Neutral\",\"Negative\"]", value = "It is the measure of expressed attitude or opinion of the document, such as \"Negative\" or \"Very Positive\". Use the `/meta/themes` endpoint to get a list of all available sentiment values.")
