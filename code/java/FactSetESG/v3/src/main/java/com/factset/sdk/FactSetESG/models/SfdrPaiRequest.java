...
import com.factset.sdk.FactSetESG.models.SfdrPaiRequestBody;
...
@JsonPropertyOrder({
  SfdrPaiRequest.JSON_PROPERTY_DATA
})
...
public class SfdrPaiRequest implements Serializable {
  ...
  private SfdrPaiRequestBody data;
  ...
  @JsonCreator
  public SfdrPaiRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) SfdrPaiRequestBody data
  ) {
    this();
    this.data = data;
  }

  public SfdrPaiRequest data(SfdrPaiRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public SfdrPaiRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(SfdrPaiRequestBody data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, sfdrPaiRequest.data);
  }
