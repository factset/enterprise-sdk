...
@JsonPropertyOrder({
  TvlArticlesRequestBody.JSON_PROPERTY_IDS,
  TvlArticlesRequestBody.JSON_PROPERTY_CATEGORIES,
  TvlArticlesRequestBody.JSON_PROPERTY_FIELDS,
  TvlArticlesRequestBody.JSON_PROPERTY_START_DATE,
  TvlArticlesRequestBody.JSON_PROPERTY_END_DATE,
  TvlArticlesRequestBody.JSON_PROPERTY_DATE_OF
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class TvlArticlesRequestBody implements Serializable {
  ...
  public TvlArticlesRequestBody ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public TvlArticlesRequestBody addIdsItem(String idsItem) {
  ...
  **/
  ...
  public TvlArticlesRequestBody categories(java.util.List<String> categories) {
    this.categories = categories;
    return this;
  }

  public TvlArticlesRequestBody addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public TvlArticlesRequestBody fields(java.util.List<String> fields) {
    this.fields = fields;
    return this;
  }

  public TvlArticlesRequestBody addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "[\"datePublication\"]", value = "Request available Articles data fields to be included in the response.  Default is all fields. `factsetEntityId` and `articleId` are always included.    <h3>Common Fields</h3>    |field|description|   |---|---|   |factsetEntityId|Factset Regional Security Identifier|   |articleId|Unique ID of the article assigned by Truvalue|               <h3>Articles Fields</h3>     |field|description|   |---|---|   |datePublication|Publication date of the article in YYYY-MM-DD format|   |dateIngestion|Date of the TVL article ingestion and processing|   |headlineEn|Title of the article|   |sourceName|Source of the article|   |articleCategory|Categories assigned by Truvalue|   |bulletsEn|AI-generated bullet point summary for each article. Note, including bullets increases response size drastically|   |author|Author of the article|   |url|URL of the article|   |sourceLang|Language code of the article|   |orgName|Organization name assigned by Truvalue|   |pillarsDimensions|Categorizes and tags the articles under 3-Pillars and 5-Dimensions|    ")
  ...
  public TvlArticlesRequestBody startDate(LocalDate startDate) {
    this.startDate = startDate;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Fri Jan 01 00:00:00 UTC 2021", required = true, value = "The start date requested for a given date range in YYYY-MM-DD format. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. ")
  ...
  public TvlArticlesRequestBody endDate(LocalDate endDate) {
    this.endDate = endDate;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Sat Oct 30 00:00:00 UTC 2021", required = true, value = "The end date requested for a given date range in YYYY-MM-DD format. The input end date must be after the input start date. Future dates (T+1) are not accepted in this endpoint. ")
  ...
  public TvlArticlesRequestBody dateOf(DateOf dateOf) {
    this.dateOf = dateOf;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this TvlArticlesRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TvlArticlesRequestBody tvlArticlesRequestBody = (TvlArticlesRequestBody) o;
    return Objects.equals(this.ids, tvlArticlesRequestBody.ids) &&
        Objects.equals(this.categories, tvlArticlesRequestBody.categories) &&
        Objects.equals(this.fields, tvlArticlesRequestBody.fields) &&
        Objects.equals(this.startDate, tvlArticlesRequestBody.startDate) &&
        Objects.equals(this.endDate, tvlArticlesRequestBody.endDate) &&
        Objects.equals(this.dateOf, tvlArticlesRequestBody.dateOf);
  }
  ...
  public String toString() {
    ...
    sb.append("class TvlArticlesRequestBody {\n");
