...
@JsonPropertyOrder({
  SfdrPaiRequestBody.JSON_PROPERTY_IDS,
  SfdrPaiRequestBody.JSON_PROPERTY_FEELBACK,
  SfdrPaiRequestBody.JSON_PROPERTY_FISCAL_PERIOD_START,
  SfdrPaiRequestBody.JSON_PROPERTY_FISCAL_PERIOD_END,
  SfdrPaiRequestBody.JSON_PROPERTY_INDICATORS,
  SfdrPaiRequestBody.JSON_PROPERTY_CURRENCY,
  SfdrPaiRequestBody.JSON_PROPERTY_CALCULATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SfdrPaiRequestBody implements Serializable {
  ...
  public SfdrPaiRequestBody(
    ...
    @JsonProperty(value=JSON_PROPERTY_FISCAL_PERIOD_END, required=true) LocalDate fiscalPeriodEnd
  ) {
    this();
    this.ids = ids;
  ...
  public SfdrPaiRequestBody ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public SfdrPaiRequestBody addIdsItem(String idsItem) {
  ...
  **/
  ...
  public SfdrPaiRequestBody feelback(Boolean feelback) {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", value = "This parameter would return the latest PAI data/s based on the indicators, date range and/or subtopics requested. ")
  ...
  public SfdrPaiRequestBody fiscalPeriodStart(LocalDate fiscalPeriodStart) {
    this.fiscalPeriodStart = fiscalPeriodStart;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Wed Jan 01 00:00:00 UTC 2020", required = true, value = "Fiscal period start is expressed in YYYY-MM-DD formats. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. ")
  ...
  public SfdrPaiRequestBody fiscalPeriodEnd(LocalDate fiscalPeriodEnd) {
    this.fiscalPeriodEnd = fiscalPeriodEnd;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "Sun Feb 20 00:00:00 UTC 2022", required = true, value = "Fiscal period end is expressed in YYYY-MM-DD formats. The input start date must be before the input end date. Future dates (T+1) are not accepted in this endpoint. ")
  ...
  public SfdrPaiRequestBody indicators(java.util.List<String> indicators) {
    this.indicators = indicators;
    return this;
  }

  public SfdrPaiRequestBody addIndicatorsItem(String indicatorsItem) {
  ...
  **/
  ...
  public SfdrPaiRequestBody currency(String currency) {
  ...
  **/
  ...
  public SfdrPaiRequestBody calculation(Boolean calculation) {
  ...
  **/
  ...
  /**
   * Return true if this SfdrPaiRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SfdrPaiRequestBody sfdrPaiRequestBody = (SfdrPaiRequestBody) o;
    return Objects.equals(this.ids, sfdrPaiRequestBody.ids) &&
        Objects.equals(this.feelback, sfdrPaiRequestBody.feelback) &&
        Objects.equals(this.fiscalPeriodStart, sfdrPaiRequestBody.fiscalPeriodStart) &&
        Objects.equals(this.fiscalPeriodEnd, sfdrPaiRequestBody.fiscalPeriodEnd) &&
        Objects.equals(this.indicators, sfdrPaiRequestBody.indicators) &&
        Objects.equals(this.currency, sfdrPaiRequestBody.currency) &&
        Objects.equals(this.calculation, sfdrPaiRequestBody.calculation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, feelback, fiscalPeriodStart, fiscalPeriodEnd, indicators, currency, calculation);
  }
