 ...
 */
@JsonPropertyOrder({
  SdgScores.JSON_PROPERTY_DATE,
  SdgScores.JSON_PROPERTY_FSYM_ID,
...
public class SdgScores implements Serializable {
  ...
  public SdgScores(
    ...
    @JsonProperty(value=JSON_PROPERTY_SCORE_TYPE, required=true) String scoreType
  ) {
    this();
    this.date = date;
    this.fsymId = fsymId;
  ...
  public SdgScores date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public SdgScores fsymId(String fsymId) {
    this.fsymId = fsymId;
    return this;
  }
  ...
  **/
  ...
  public SdgScores requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  **/
  ...
  public SdgScores scoreType(String scoreType) {
    this.scoreType = scoreType;
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SdgScores putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this sdgScores object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SdgScores sdgScores = (SdgScores) o;
    return Objects.equals(this.date, sdgScores.date) &&
        Objects.equals(this.fsymId, sdgScores.fsymId) &&
        Objects.equals(this.requestId, sdgScores.requestId) &&
        Objects.equals(this.scoreType, sdgScores.scoreType)&&
        Objects.equals(this.additionalProperties, sdgScores.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, fsymId, requestId, scoreType, additionalProperties);
  }
