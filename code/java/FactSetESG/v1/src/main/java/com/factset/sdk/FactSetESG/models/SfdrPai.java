...
public class SfdrPai implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(fsymId), requestId, hashCodeNullable(subTopicCode), hashCodeNullable(subTopicName), hashCodeNullable(indicatorType), hashCodeNullable(periodEndDate), hashCodeNullable(reportingPeriod), hashCodeNullable(standardizedUnit), hashCodeNullable(standardizedValue));
  }
