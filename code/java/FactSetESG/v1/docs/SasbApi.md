...
> SasbRanksResponse getSasbRanks(ids, categories, startDate, endDate, frequency)
...
> SasbScoresResponse getSasbScores(ids, scoreTypes, categories, startDate, endDate, frequency)
...
> SasbScoresAllResponse getSasbScoresAll(ids, scoreTypes, startDate, endDate, frequency)
