...
> CheckExplanationStatusResponseWrapper checkExplanationStatus(id)
...
import com.factset.sdk.SecurityExplanation.api.SecurityExplanationApi.CheckExplanationStatusResponseWrapper;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            CheckExplanationStatusResponseWrapper result = apiInstance.checkExplanationStatus(id);
            switch(result.getStatusCode()) {
            
                case 201:
                    System.out.println(result.getResponse201()); // ExplanationStatusRoot
            
                case 202:
                    System.out.println(result.getResponse202()); // ExplanationCreateResponseRoot
...
> ExplanationCreateResponseRoot createExplanation(securityExplanationParametersRoot)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SecurityExplanationApi apiInstance = new SecurityExplanationApi(defaultClient);
        SecurityExplanationParametersRoot securityExplanationParametersRoot = new SecurityExplanationParametersRoot(); // SecurityExplanationParametersRoot | 
        try {
            ExplanationCreateResponseRoot result = apiInstance.createExplanation(securityExplanationParametersRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SecurityExplanationApi#createExplanation");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
