package com.factset.sdk.SecurityExplanation;
...
import com.factset.sdk.SecurityExplanation.auth.Authentication;
import com.factset.sdk.SecurityExplanation.auth.HttpBasicAuth;
import com.factset.sdk.SecurityExplanation.auth.HttpBearerAuth;
import com.factset.sdk.SecurityExplanation.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.SecurityExplanation.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/security-explanation/v1";
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/SecurityExplanation/1.0.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.SecurityExplanation.ApiClient} object.
   */
