 ...
 */
@ApiModel(description = "The pointer and parameter of the error")
@JsonPropertyOrder({
...
public class ErrorSource implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.parameter, errorSource.parameter) &&
        equalsNullable(this.pointer, errorSource.pointer);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(parameter), hashCodeNullable(pointer));
  }
