 ...
 */
@ApiModel(description = "Holding asset type classification represented by categories from the category system \"Asset class classification system for mutual funds, defined by FactSet Research Systems Inc.\". See endpoint `/category/listBySystem` with `id=288` for valid values.")
@JsonPropertyOrder({
  FundNotationScreenerSearchDataFundHoldingType.JSON_PROPERTY_RESTRICT,
  FundNotationScreenerSearchDataFundHoldingType.JSON_PROPERTY_EXCLUDE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class FundNotationScreenerSearchDataFundHoldingType implements Serializable {
  ...
  public FundNotationScreenerSearchDataFundHoldingType() { 
  }

  public FundNotationScreenerSearchDataFundHoldingType restrict(FundNotationScreenerSearchDataFundHoldingTypeRestrict restrict) {
  ...
  **/
  ...
  public FundNotationScreenerSearchDataFundHoldingType exclude(FundNotationScreenerSearchDataFundHoldingTypeExclude exclude) {
  ...
  **/
  ...
  /**
   * Return true if this _fund_notation_screener_search_data_fund_holdingType object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FundNotationScreenerSearchDataFundHoldingType fundNotationScreenerSearchDataFundHoldingType = (FundNotationScreenerSearchDataFundHoldingType) o;
    return Objects.equals(this.restrict, fundNotationScreenerSearchDataFundHoldingType.restrict) &&
        Objects.equals(this.exclude, fundNotationScreenerSearchDataFundHoldingType.exclude);
  }
  ...
  public String toString() {
    ...
    sb.append("class FundNotationScreenerSearchDataFundHoldingType {\n");
