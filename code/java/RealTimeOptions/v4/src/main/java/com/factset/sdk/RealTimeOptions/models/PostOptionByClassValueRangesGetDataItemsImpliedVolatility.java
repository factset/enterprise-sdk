 ...
 */
@ApiModel(description = "Value range of the implied volatility.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetDataItemsImpliedVolatility.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetDataItemsImpliedVolatility.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetDataItemsImpliedVolatility implements Serializable {
  ...
  public PostOptionByClassValueRangesGetDataItemsImpliedVolatility() { 
  }

  public PostOptionByClassValueRangesGetDataItemsImpliedVolatility minimum(BigDecimal minimum) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0.5", value = "Minimum value.")
  @JsonIgnore
  ...
  public PostOptionByClassValueRangesGetDataItemsImpliedVolatility maximum(BigDecimal maximum) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "0.4", value = "Maximum value.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetDataItems_impliedVolatility object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetDataItemsImpliedVolatility postOptionByClassValueRangesGetDataItemsImpliedVolatility = (PostOptionByClassValueRangesGetDataItemsImpliedVolatility) o;
    return equalsNullable(this.minimum, postOptionByClassValueRangesGetDataItemsImpliedVolatility.minimum) &&
        equalsNullable(this.maximum, postOptionByClassValueRangesGetDataItemsImpliedVolatility.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetDataItemsImpliedVolatility {\n");
