 ...
 */
@ApiModel(description = "Notation of the underlying.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataUnderlyingNotation.JSON_PROPERTY_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataUnderlyingNotation implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public PostOptionClassScreenerSearchRequestDataUnderlyingNotation() { 
  }

  public PostOptionClassScreenerSearchRequestDataUnderlyingNotation id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_underlying_notation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataUnderlyingNotation postOptionClassScreenerSearchRequestDataUnderlyingNotation = (PostOptionClassScreenerSearchRequestDataUnderlyingNotation) o;
    return Objects.equals(this.id, postOptionClassScreenerSearchRequestDataUnderlyingNotation.id);
  }
