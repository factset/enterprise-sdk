...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataFilterValidation;
...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataFilter.JSON_PROPERTY_VALIDATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataFilter implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_VALIDATION = "validation";
  private PostOptionByClassValueRangesGetRequestDataFilterValidation validation;

  public PostOptionByClassValueRangesGetRequestDataFilter() { 
  }

  public PostOptionByClassValueRangesGetRequestDataFilter validation(PostOptionByClassValueRangesGetRequestDataFilterValidation validation) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataFilterValidation getValidation() {
    return validation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALIDATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValidation(PostOptionByClassValueRangesGetRequestDataFilterValidation validation) {
    this.validation = validation;
  }


  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_filter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataFilter postOptionByClassValueRangesGetRequestDataFilter = (PostOptionByClassValueRangesGetRequestDataFilter) o;
    return Objects.equals(this.validation, postOptionByClassValueRangesGetRequestDataFilter.validation);
  }
