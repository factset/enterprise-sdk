 ...
 */
@ApiModel(description = "Specifies the contract sizes an option may have.")
@JsonPropertyOrder({
  PostOptionByClassListRequestDataContractSizeRestrict.JSON_PROPERTY_VALUES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataContractSizeRestrict implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_VALUES = "values";
  private java.util.Set<BigDecimal> values = null;

  public PostOptionByClassListRequestDataContractSizeRestrict() { 
  }

  public PostOptionByClassListRequestDataContractSizeRestrict values(java.util.Set<BigDecimal> values) {
    this.values = values;
    return this;
  }

  public PostOptionByClassListRequestDataContractSizeRestrict addValuesItem(BigDecimal valuesItem) {
    if (this.values == null) {
      this.values = new java.util.LinkedHashSet<>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "Set of contract sizes.")
  @JsonProperty(JSON_PROPERTY_VALUES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.Set<BigDecimal> getValues() {
    return values;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(java.util.Set<BigDecimal> values) {
    this.values = values;
  }


  /**
   * Return true if this PostOptionByClassListRequest_data_contractSize_restrict object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataContractSizeRestrict postOptionByClassListRequestDataContractSizeRestrict = (PostOptionByClassListRequestDataContractSizeRestrict) o;
    return Objects.equals(this.values, postOptionByClassListRequestDataContractSizeRestrict.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassListRequestDataContractSizeRestrict {\n");
