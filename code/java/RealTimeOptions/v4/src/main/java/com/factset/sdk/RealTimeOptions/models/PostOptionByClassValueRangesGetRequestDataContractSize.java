...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataContractSizeExclude;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataContractSizeRestrict;
...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataContractSize.JSON_PROPERTY_RESTRICT,
  PostOptionByClassValueRangesGetRequestDataContractSize.JSON_PROPERTY_EXCLUDE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataContractSize implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_RESTRICT = "restrict";
  private PostOptionByClassValueRangesGetRequestDataContractSizeRestrict restrict;

  public static final String JSON_PROPERTY_EXCLUDE = "exclude";
  private PostOptionByClassValueRangesGetRequestDataContractSizeExclude exclude;

  public PostOptionByClassValueRangesGetRequestDataContractSize() { 
  }

  public PostOptionByClassValueRangesGetRequestDataContractSize restrict(PostOptionByClassValueRangesGetRequestDataContractSizeRestrict restrict) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataContractSizeRestrict getRestrict() {
    return restrict;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESTRICT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRestrict(PostOptionByClassValueRangesGetRequestDataContractSizeRestrict restrict) {
    this.restrict = restrict;
  }


  public PostOptionByClassValueRangesGetRequestDataContractSize exclude(PostOptionByClassValueRangesGetRequestDataContractSizeExclude exclude) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataContractSizeExclude getExclude() {
    return exclude;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXCLUDE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExclude(PostOptionByClassValueRangesGetRequestDataContractSizeExclude exclude) {
    this.exclude = exclude;
  }


  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_contractSize object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataContractSize postOptionByClassValueRangesGetRequestDataContractSize = (PostOptionByClassValueRangesGetRequestDataContractSize) o;
    return Objects.equals(this.restrict, postOptionByClassValueRangesGetRequestDataContractSize.restrict) &&
        Objects.equals(this.exclude, postOptionByClassValueRangesGetRequestDataContractSize.exclude);
  }
