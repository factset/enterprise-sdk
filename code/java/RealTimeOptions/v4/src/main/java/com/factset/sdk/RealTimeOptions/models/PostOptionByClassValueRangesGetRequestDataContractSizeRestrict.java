...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataContractSizeRestrict.JSON_PROPERTY_VALUES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataContractSizeRestrict implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_VALUES = "values";
  private java.util.Set<BigDecimal> values = null;

  public PostOptionByClassValueRangesGetRequestDataContractSizeRestrict() { 
  }

  public PostOptionByClassValueRangesGetRequestDataContractSizeRestrict values(java.util.Set<BigDecimal> values) {
    this.values = values;
    return this;
  }

  public PostOptionByClassValueRangesGetRequestDataContractSizeRestrict addValuesItem(BigDecimal valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_contractSize_restrict object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataContractSizeRestrict postOptionByClassValueRangesGetRequestDataContractSizeRestrict = (PostOptionByClassValueRangesGetRequestDataContractSizeRestrict) o;
    return Objects.equals(this.values, postOptionByClassValueRangesGetRequestDataContractSizeRestrict.values);
  }
