 ...
 */
@ApiModel(description = "Specifies the categories an option class may not have.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataCategoryExclude.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataCategoryExclude implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<BigDecimal> ids = null;

  public PostOptionClassScreenerSearchRequestDataCategoryExclude() { 
  }

  public PostOptionClassScreenerSearchRequestDataCategoryExclude ids(java.util.List<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostOptionClassScreenerSearchRequestDataCategoryExclude addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_category_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataCategoryExclude postOptionClassScreenerSearchRequestDataCategoryExclude = (PostOptionClassScreenerSearchRequestDataCategoryExclude) o;
    return Objects.equals(this.ids, postOptionClassScreenerSearchRequestDataCategoryExclude.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequestDataCategoryExclude {\n");
