 ...
 */
@ApiModel(description = "Value range of the rho. It represents the first partial derivative of the function determining the option's theoretical price with respect to the risk-free interest rate, evaluated at the current risk-free interest rate. Rho indicates the ratio of the absolute change of the price of an option for an absolute change of the risk-free interest rate, thus it represents the price sensitivity of the option relative to changes in the risk-free interest rate. The key figure is shown in one basis point change.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataKeyFiguresRho.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataKeyFiguresRho.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataKeyFiguresRho implements Serializable {
  ...
  public PostOptionByClassValueRangesGetRequestDataKeyFiguresRho() { 
  }

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresRho minimum(PostOptionByClassListRequestDataOpenInterestMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataKeyFiguresRho maximum(PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_keyFigures_rho object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataKeyFiguresRho postOptionByClassValueRangesGetRequestDataKeyFiguresRho = (PostOptionByClassValueRangesGetRequestDataKeyFiguresRho) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataKeyFiguresRho.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataKeyFiguresRho.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataKeyFiguresRho {\n");
