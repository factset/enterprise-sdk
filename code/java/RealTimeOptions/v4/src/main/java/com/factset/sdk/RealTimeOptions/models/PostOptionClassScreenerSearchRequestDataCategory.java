...
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestDataCategoryExclude;
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestDataCategoryRestrict;
 ...
 */
@ApiModel(description = "Category-related class selection as defined by FactSet (see MDG category system 18).")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataCategory.JSON_PROPERTY_RESTRICT,
  PostOptionClassScreenerSearchRequestDataCategory.JSON_PROPERTY_EXCLUDE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataCategory implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_RESTRICT = "restrict";
  private PostOptionClassScreenerSearchRequestDataCategoryRestrict restrict;

  public static final String JSON_PROPERTY_EXCLUDE = "exclude";
  private PostOptionClassScreenerSearchRequestDataCategoryExclude exclude;

  public PostOptionClassScreenerSearchRequestDataCategory() { 
  }

  public PostOptionClassScreenerSearchRequestDataCategory restrict(PostOptionClassScreenerSearchRequestDataCategoryRestrict restrict) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestDataCategoryRestrict getRestrict() {
    return restrict;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESTRICT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRestrict(PostOptionClassScreenerSearchRequestDataCategoryRestrict restrict) {
    this.restrict = restrict;
  }


  public PostOptionClassScreenerSearchRequestDataCategory exclude(PostOptionClassScreenerSearchRequestDataCategoryExclude exclude) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestDataCategoryExclude getExclude() {
    return exclude;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXCLUDE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExclude(PostOptionClassScreenerSearchRequestDataCategoryExclude exclude) {
    this.exclude = exclude;
  }


  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_category object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataCategory postOptionClassScreenerSearchRequestDataCategory = (PostOptionClassScreenerSearchRequestDataCategory) o;
    return Objects.equals(this.restrict, postOptionClassScreenerSearchRequestDataCategory.restrict) &&
        Objects.equals(this.exclude, postOptionClassScreenerSearchRequestDataCategory.exclude);
  }
