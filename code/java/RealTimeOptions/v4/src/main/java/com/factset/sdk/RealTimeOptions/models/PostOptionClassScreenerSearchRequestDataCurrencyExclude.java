 ...
 */
@ApiModel(description = "Specifies the currencies an option class may not have.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataCurrencyExclude.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataCurrencyExclude implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<BigDecimal> ids = null;

  public PostOptionClassScreenerSearchRequestDataCurrencyExclude() { 
  }

  public PostOptionClassScreenerSearchRequestDataCurrencyExclude ids(java.util.List<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostOptionClassScreenerSearchRequestDataCurrencyExclude addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_currency_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataCurrencyExclude postOptionClassScreenerSearchRequestDataCurrencyExclude = (PostOptionClassScreenerSearchRequestDataCurrencyExclude) o;
    return Objects.equals(this.ids, postOptionClassScreenerSearchRequestDataCurrencyExclude.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequestDataCurrencyExclude {\n");
