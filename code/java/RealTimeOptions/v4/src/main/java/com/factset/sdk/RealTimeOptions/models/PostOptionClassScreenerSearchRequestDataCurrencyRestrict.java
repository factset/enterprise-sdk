 ...
 */
@ApiModel(description = "Specifies the currencies an option class may have.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataCurrencyRestrict.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataCurrencyRestrict implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<BigDecimal> ids = null;

  public PostOptionClassScreenerSearchRequestDataCurrencyRestrict() { 
  }

  public PostOptionClassScreenerSearchRequestDataCurrencyRestrict ids(java.util.List<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostOptionClassScreenerSearchRequestDataCurrencyRestrict addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_currency_restrict object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataCurrencyRestrict postOptionClassScreenerSearchRequestDataCurrencyRestrict = (PostOptionClassScreenerSearchRequestDataCurrencyRestrict) o;
    return Objects.equals(this.ids, postOptionClassScreenerSearchRequestDataCurrencyRestrict.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequestDataCurrencyRestrict {\n");
