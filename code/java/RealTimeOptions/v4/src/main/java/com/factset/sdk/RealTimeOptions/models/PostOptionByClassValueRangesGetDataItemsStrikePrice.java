 ...
 */
@ApiModel(description = "Value range of the strike price.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetDataItemsStrikePrice.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetDataItemsStrikePrice.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetDataItemsStrikePrice implements Serializable {
  ...
  public PostOptionByClassValueRangesGetDataItemsStrikePrice() { 
  }

  public PostOptionByClassValueRangesGetDataItemsStrikePrice minimum(BigDecimal minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetDataItemsStrikePrice maximum(BigDecimal maximum) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "5.05", value = "Maximum value.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetDataItems_strikePrice object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetDataItemsStrikePrice postOptionByClassValueRangesGetDataItemsStrikePrice = (PostOptionByClassValueRangesGetDataItemsStrikePrice) o;
    return equalsNullable(this.minimum, postOptionByClassValueRangesGetDataItemsStrikePrice.minimum) &&
        equalsNullable(this.maximum, postOptionByClassValueRangesGetDataItemsStrikePrice.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetDataItemsStrikePrice {\n");
