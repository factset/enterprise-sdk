...
@JsonPropertyOrder({
  InlineResponse200DataStrikePriceValueUnit.JSON_PROPERTY_ID,
  InlineResponse200DataStrikePriceValueUnit.JSON_PROPERTY_CODE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse200DataStrikePriceValueUnit implements Serializable {
  ...
  public InlineResponse200DataStrikePriceValueUnit() { 
  }

  public InlineResponse200DataStrikePriceValueUnit id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Idenitifier of the value unit.")
  @JsonIgnore
  ...
  public InlineResponse200DataStrikePriceValueUnit code(String code) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_data_strikePrice_valueUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataStrikePriceValueUnit inlineResponse200DataStrikePriceValueUnit = (InlineResponse200DataStrikePriceValueUnit) o;
    return equalsNullable(this.id, inlineResponse200DataStrikePriceValueUnit.id) &&
        equalsNullable(this.code, inlineResponse200DataStrikePriceValueUnit.code);
  }
