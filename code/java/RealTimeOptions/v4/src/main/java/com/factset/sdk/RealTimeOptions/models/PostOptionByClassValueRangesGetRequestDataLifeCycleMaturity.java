...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate;
...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.JSON_PROPERTY_DATE,
  PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.JSON_PROPERTY_INTERVAL
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATE = "date";
  private PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate date;
  ...
  public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity() { 
  }

  public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity date(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate getDate() {
    return date;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDate(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate date) {
    this.date = date;
  }


  public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity interval(java.util.Set<IntervalEnum> interval) {
    this.interval = interval;
    return this;
  }

  public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity addIntervalItem(IntervalEnum intervalItem) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_lifeCycle_maturity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity postOptionByClassValueRangesGetRequestDataLifeCycleMaturity = (PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity) o;
    return Objects.equals(this.date, postOptionByClassValueRangesGetRequestDataLifeCycleMaturity.date) &&
        Objects.equals(this.interval, postOptionByClassValueRangesGetRequestDataLifeCycleMaturity.interval);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity {\n");
