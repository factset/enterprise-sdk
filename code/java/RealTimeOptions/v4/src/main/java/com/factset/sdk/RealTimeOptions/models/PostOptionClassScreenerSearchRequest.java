...
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestData;
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestMeta;
...
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequest.JSON_PROPERTY_DATA,
  PostOptionClassScreenerSearchRequest.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private PostOptionClassScreenerSearchRequestData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PostOptionClassScreenerSearchRequestMeta meta;

  public PostOptionClassScreenerSearchRequest() { 
  }

  @JsonCreator
  public PostOptionClassScreenerSearchRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) PostOptionClassScreenerSearchRequestData data
  ) {
    this();
    this.data = data;
  }

  public PostOptionClassScreenerSearchRequest data(PostOptionClassScreenerSearchRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(PostOptionClassScreenerSearchRequestData data) {
    this.data = data;
  }


  public PostOptionClassScreenerSearchRequest meta(PostOptionClassScreenerSearchRequestMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(PostOptionClassScreenerSearchRequestMeta meta) {
    this.meta = meta;
  }


  /**
   * Return true if this PostOptionClassScreenerSearchRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequest postOptionClassScreenerSearchRequest = (PostOptionClassScreenerSearchRequest) o;
    return Objects.equals(this.data, postOptionClassScreenerSearchRequest.data) &&
        Objects.equals(this.meta, postOptionClassScreenerSearchRequest.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequest {\n");
