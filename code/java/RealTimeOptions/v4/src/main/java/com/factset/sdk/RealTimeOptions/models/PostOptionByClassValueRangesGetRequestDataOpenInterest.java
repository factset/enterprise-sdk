...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum;
 ...
 */
@ApiModel(description = "Value range of the open positions.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataOpenInterest.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataOpenInterest.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataOpenInterest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MINIMUM = "minimum";
  private PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum minimum;

  public static final String JSON_PROPERTY_MAXIMUM = "maximum";
  private PostOptionByClassListRequestDataOpenInterestMaximum maximum;

  public PostOptionByClassValueRangesGetRequestDataOpenInterest() { 
  }

  public PostOptionByClassValueRangesGetRequestDataOpenInterest minimum(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum getMinimum() {
    return minimum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MINIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinimum(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum minimum) {
    this.minimum = minimum;
  }


  public PostOptionByClassValueRangesGetRequestDataOpenInterest maximum(PostOptionByClassListRequestDataOpenInterestMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_openInterest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataOpenInterest postOptionByClassValueRangesGetRequestDataOpenInterest = (PostOptionByClassValueRangesGetRequestDataOpenInterest) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataOpenInterest.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataOpenInterest.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataOpenInterest {\n");
