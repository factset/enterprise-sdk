...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataFilterValidationPriceLatest;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataFilterValidationPricePrevious;
...
@JsonPropertyOrder({
  PostOptionByClassListRequestDataFilterValidationPrice.JSON_PROPERTY_QUALITY,
  PostOptionByClassListRequestDataFilterValidationPrice.JSON_PROPERTY_LATEST,
  PostOptionByClassListRequestDataFilterValidationPrice.JSON_PROPERTY_PREVIOUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataFilterValidationPrice implements Serializable {
  ...
  private PostOptionByClassListRequestDataFilterValidationPriceLatest latest;

  public static final String JSON_PROPERTY_PREVIOUS = "previous";
  private PostOptionByClassListRequestDataFilterValidationPricePrevious previous;

  public PostOptionByClassListRequestDataFilterValidationPrice() { 
  }

  public PostOptionByClassListRequestDataFilterValidationPrice quality(QualityEnum quality) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataFilterValidationPrice latest(PostOptionByClassListRequestDataFilterValidationPriceLatest latest) {
    this.latest = latest;
    return this;
  }
  ...
  **/
  ...
  public PostOptionByClassListRequestDataFilterValidationPriceLatest getLatest() {
    return latest;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LATEST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLatest(PostOptionByClassListRequestDataFilterValidationPriceLatest latest) {
    this.latest = latest;
  }


  public PostOptionByClassListRequestDataFilterValidationPrice previous(PostOptionByClassListRequestDataFilterValidationPricePrevious previous) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataFilterValidationPricePrevious getPrevious() {
    return previous;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PREVIOUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrevious(PostOptionByClassListRequestDataFilterValidationPricePrevious previous) {
    this.previous = previous;
  }


  /**
   * Return true if this PostOptionByClassListRequest_data_filter_validation_price object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataFilterValidationPrice postOptionByClassListRequestDataFilterValidationPrice = (PostOptionByClassListRequestDataFilterValidationPrice) o;
    return Objects.equals(this.quality, postOptionByClassListRequestDataFilterValidationPrice.quality) &&
        Objects.equals(this.latest, postOptionByClassListRequestDataFilterValidationPrice.latest) &&
        Objects.equals(this.previous, postOptionByClassListRequestDataFilterValidationPrice.previous);
  }
