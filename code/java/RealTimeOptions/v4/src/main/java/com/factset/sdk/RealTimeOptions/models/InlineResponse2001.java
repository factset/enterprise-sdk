...
import com.factset.sdk.RealTimeOptions.models.InlineResponse2001Meta;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListDataItems;
...
public class InlineResponse2001 implements Serializable {
  ...
  private java.util.List<PostOptionByClassListDataItems> data = null;
  ...
  public InlineResponse2001 data(java.util.List<PostOptionByClassListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2001 addDataItem(PostOptionByClassListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<PostOptionByClassListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostOptionByClassListDataItems> data) {
    this.data = data;
  }
