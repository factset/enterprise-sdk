 ...
 */
@ApiModel(description = "Value range of the vega. It represents the first partial derivative of the function determining the option's theoretical price with respect to the implied volatility, evaluated at the current implied volatility. Vega indicates the ratio of the absolute change of the price of an option for an absolute change of the implied volatility, thus it represents the price sensitivity of the option relative to changes in the implied volatility.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataKeyFiguresVega.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataKeyFiguresVega.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataKeyFiguresVega implements Serializable {
  ...
  public PostOptionByClassValueRangesGetRequestDataKeyFiguresVega() { 
  }

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresVega minimum(PostOptionByClassListRequestDataContractStrikePriceMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataKeyFiguresVega maximum(PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_keyFigures_vega object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataKeyFiguresVega postOptionByClassValueRangesGetRequestDataKeyFiguresVega = (PostOptionByClassValueRangesGetRequestDataKeyFiguresVega) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataKeyFiguresVega.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataKeyFiguresVega.maximum);
  }
