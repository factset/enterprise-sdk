...
import com.factset.sdk.RealTimeOptions.auth.Authentication;
import com.factset.sdk.RealTimeOptions.auth.HttpBasicAuth;
import com.factset.sdk.RealTimeOptions.auth.HttpBearerAuth;
import com.factset.sdk.RealTimeOptions.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.RealTimeOptions.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/RealTimeOptions/0.1.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.RealTimeOptions.ApiClient} object.
   */
