 ...
 */
@ApiModel(description = "Value range of the weekly theta. It represents the first partial derivative of the function determining the option's theoretical price with respect to the residual term, evaluated at the current residual term and multiplied by 7/365. Weekly theta indicates the absolute change (decrease) of the price of an option for a reduction of the residual term by one week (seven calendar days), thus it represents the price sensitivity of the option relative to changes in the residual term.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek implements Serializable {
  ...
  public PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek() { 
  }

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek minimum(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek maximum(PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_keyFigures_thetaOneWeek object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek postOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek = (PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek {\n");
