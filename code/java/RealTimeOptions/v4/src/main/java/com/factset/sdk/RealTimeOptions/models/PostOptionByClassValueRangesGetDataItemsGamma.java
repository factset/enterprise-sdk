 ...
 */
@ApiModel(description = "Value range of the gamma.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetDataItemsGamma.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetDataItemsGamma.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetDataItemsGamma implements Serializable {
  ...
  public PostOptionByClassValueRangesGetDataItemsGamma() { 
  }

  public PostOptionByClassValueRangesGetDataItemsGamma minimum(BigDecimal minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetDataItemsGamma maximum(BigDecimal maximum) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "4.04", value = "Maximum value.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetDataItems_gamma object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetDataItemsGamma postOptionByClassValueRangesGetDataItemsGamma = (PostOptionByClassValueRangesGetDataItemsGamma) o;
    return equalsNullable(this.minimum, postOptionByClassValueRangesGetDataItemsGamma.minimum) &&
        equalsNullable(this.maximum, postOptionByClassValueRangesGetDataItemsGamma.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetDataItemsGamma {\n");
