 ...
 */
@ApiModel(description = "Specifies the markets from which an option class may originate.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataMarketRestrict.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataMarketRestrict implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<BigDecimal> ids = null;

  public PostOptionClassScreenerSearchRequestDataMarketRestrict() { 
  }

  public PostOptionClassScreenerSearchRequestDataMarketRestrict ids(java.util.List<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostOptionClassScreenerSearchRequestDataMarketRestrict addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_market_restrict object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataMarketRestrict postOptionClassScreenerSearchRequestDataMarketRestrict = (PostOptionClassScreenerSearchRequestDataMarketRestrict) o;
    return Objects.equals(this.ids, postOptionClassScreenerSearchRequestDataMarketRestrict.ids);
  }
