...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataKeyFiguresRhoMinimum;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum;
 ...
 */
@ApiModel(description = "Value range of the strike price of the option.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataContractStrikePrice.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataContractStrikePrice.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataContractStrikePrice implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MINIMUM = "minimum";
  private PostOptionByClassListRequestDataKeyFiguresRhoMinimum minimum;

  public static final String JSON_PROPERTY_MAXIMUM = "maximum";
  private PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum maximum;

  public PostOptionByClassValueRangesGetRequestDataContractStrikePrice() { 
  }

  public PostOptionByClassValueRangesGetRequestDataContractStrikePrice minimum(PostOptionByClassListRequestDataKeyFiguresRhoMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresRhoMinimum getMinimum() {
    return minimum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MINIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinimum(PostOptionByClassListRequestDataKeyFiguresRhoMinimum minimum) {
    this.minimum = minimum;
  }


  public PostOptionByClassValueRangesGetRequestDataContractStrikePrice maximum(PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum maximum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum getMaximum() {
    return maximum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAXIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaximum(PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum maximum) {
    this.maximum = maximum;
  }


  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_contract_strikePrice object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataContractStrikePrice postOptionByClassValueRangesGetRequestDataContractStrikePrice = (PostOptionByClassValueRangesGetRequestDataContractStrikePrice) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataContractStrikePrice.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataContractStrikePrice.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataContractStrikePrice {\n");
