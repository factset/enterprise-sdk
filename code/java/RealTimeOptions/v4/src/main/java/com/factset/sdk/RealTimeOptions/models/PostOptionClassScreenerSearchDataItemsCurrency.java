 ...
 */
@ApiModel(description = "Main or fractional currency of the option class. See endpoint `/basic/value-unit/currency/list` for possible values.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchDataItemsCurrency.JSON_PROPERTY_ID,
  PostOptionClassScreenerSearchDataItemsCurrency.JSON_PROPERTY_CODE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchDataItemsCurrency implements Serializable {
  ...
  public PostOptionClassScreenerSearchDataItemsCurrency() { 
  }

  public PostOptionClassScreenerSearchDataItemsCurrency id(BigDecimal id) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchDataItemsCurrency code(String code) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchDataItems_currency object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchDataItemsCurrency postOptionClassScreenerSearchDataItemsCurrency = (PostOptionClassScreenerSearchDataItemsCurrency) o;
    return equalsNullable(this.id, postOptionClassScreenerSearchDataItemsCurrency.id) &&
        equalsNullable(this.code, postOptionClassScreenerSearchDataItemsCurrency.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchDataItemsCurrency {\n");
