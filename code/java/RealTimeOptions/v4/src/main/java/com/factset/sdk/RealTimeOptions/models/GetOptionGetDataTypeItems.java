...
@JsonPropertyOrder({
  GetOptionGetDataTypeItems.JSON_PROPERTY_ID,
  GetOptionGetDataTypeItems.JSON_PROPERTY_NAME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetOptionGetDataTypeItems implements Serializable {
  ...
  public GetOptionGetDataTypeItems() { 
  }

  public GetOptionGetDataTypeItems id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Identifier of the instrument type.")
  @JsonIgnore
  ...
  public GetOptionGetDataTypeItems name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this GetOptionGetDataTypeItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetOptionGetDataTypeItems getOptionGetDataTypeItems = (GetOptionGetDataTypeItems) o;
    return equalsNullable(this.id, getOptionGetDataTypeItems.id) &&
        equalsNullable(this.name, getOptionGetDataTypeItems.name);
  }
