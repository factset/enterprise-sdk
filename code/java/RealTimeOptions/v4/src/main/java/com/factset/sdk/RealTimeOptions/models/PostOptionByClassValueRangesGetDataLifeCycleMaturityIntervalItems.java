...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.JSON_PROPERTY_VALUE,
  PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.JSON_PROPERTY_COUNT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems implements Serializable {
  ...
  public PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems() { 
  }

  public PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems value(ValueEnum value) {
  ...
  **/
  ...
  @ApiModelProperty(example = "daily", value = "Attribute value. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  ")
  @JsonIgnore
  ...
  public PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems count(BigDecimal count) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems postOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems = (PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems) o;
    return equalsNullable(this.value, postOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.value) &&
        equalsNullable(this.count, postOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.count);
  }
