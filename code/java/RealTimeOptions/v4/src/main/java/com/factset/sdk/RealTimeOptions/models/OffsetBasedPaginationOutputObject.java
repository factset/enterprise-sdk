...
public class OffsetBasedPaginationOutputObject implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "3", value = "Total number of entries in the result set.")
  @JsonIgnore
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.total, offsetBasedPaginationOutputObject.total) &&
        equalsNullable(this.isEstimatedTotal, offsetBasedPaginationOutputObject.isEstimatedTotal);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(total), hashCodeNullable(isEstimatedTotal));
  }
