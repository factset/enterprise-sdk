...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit;
 ...
 */
@ApiModel(description = "Price at which the holder of an option can buy (in the case of a call option) or sell (in the case of a put option) the underlying asset when the option is exercised. It is also known as the exercise price.")
@JsonPropertyOrder({
  PostOptionByClassListDataItemsInstrumentStrikePrice.JSON_PROPERTY_LEVEL,
  PostOptionByClassListDataItemsInstrumentStrikePrice.JSON_PROPERTY_VALUE_UNIT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListDataItemsInstrumentStrikePrice implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_LEVEL = "level";
  private JsonNullable<BigDecimal> level = JsonNullable.<BigDecimal>undefined();

  public static final String JSON_PROPERTY_VALUE_UNIT = "valueUnit";
  private PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit valueUnit;

  public PostOptionByClassListDataItemsInstrumentStrikePrice() { 
  }

  public PostOptionByClassListDataItemsInstrumentStrikePrice level(BigDecimal level) {
    this.level = JsonNullable.<BigDecimal>of(level);
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "5.05", value = "Level of the strike price.")
  @JsonIgnore
  ...
  public JsonNullable<BigDecimal> getLevel_JsonNullable() {
    return level;
  }
  
  @JsonProperty(JSON_PROPERTY_LEVEL)
  public void setLevel_JsonNullable(JsonNullable<BigDecimal> level) {
    this.level = level;
  }
  ...
  public PostOptionByClassListDataItemsInstrumentStrikePrice valueUnit(PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit valueUnit) {
  ...
  **/
  ...
  public PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit getValueUnit() {
    return valueUnit;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE_UNIT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValueUnit(PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit valueUnit) {
    this.valueUnit = valueUnit;
  }


  /**
   * Return true if this PostOptionByClassListDataItems_instrument_strikePrice object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListDataItemsInstrumentStrikePrice postOptionByClassListDataItemsInstrumentStrikePrice = (PostOptionByClassListDataItemsInstrumentStrikePrice) o;
    return equalsNullable(this.level, postOptionByClassListDataItemsInstrumentStrikePrice.level) &&
        Objects.equals(this.valueUnit, postOptionByClassListDataItemsInstrumentStrikePrice.valueUnit);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(level), valueUnit);
  }
