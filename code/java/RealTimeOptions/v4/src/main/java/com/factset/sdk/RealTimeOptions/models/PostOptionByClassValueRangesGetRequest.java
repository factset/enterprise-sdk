...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestData;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestMeta;
...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequest.JSON_PROPERTY_DATA,
  PostOptionByClassValueRangesGetRequest.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private PostOptionByClassValueRangesGetRequestData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PostOptionByClassValueRangesGetRequestMeta meta;

  public PostOptionByClassValueRangesGetRequest() { 
  }

  @JsonCreator
  public PostOptionByClassValueRangesGetRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) PostOptionByClassValueRangesGetRequestData data
  ) {
    this();
    this.data = data;
  }

  public PostOptionByClassValueRangesGetRequest data(PostOptionByClassValueRangesGetRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(PostOptionByClassValueRangesGetRequestData data) {
    this.data = data;
  }


  public PostOptionByClassValueRangesGetRequest meta(PostOptionByClassValueRangesGetRequestMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(PostOptionByClassValueRangesGetRequestMeta meta) {
    this.meta = meta;
  }


  /**
   * Return true if this PostOptionByClassValueRangesGetRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequest postOptionByClassValueRangesGetRequest = (PostOptionByClassValueRangesGetRequest) o;
    return Objects.equals(this.data, postOptionByClassValueRangesGetRequest.data) &&
        Objects.equals(this.meta, postOptionByClassValueRangesGetRequest.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequest {\n");
