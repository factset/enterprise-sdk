...
@JsonPropertyOrder({
  PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.JSON_PROPERTY_PERMANENT_IDENTIFIER,
  PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.JSON_PROPERTY_TICKER_EXCHANGE,
  PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.JSON_PROPERTY_IS_PRIMARY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing implements Serializable {
  ...
  public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing() { 
  }

  public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing permanentIdentifier(String permanentIdentifier) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing tickerExchange(String tickerExchange) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing isPrimary(Boolean isPrimary) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Indicates whether the notation is the primary notation among all notations within the same region (`true`) or not (`false`).")
  @JsonIgnore
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchDataItems_underlying_notation_fsym_listing object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing postOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing = (PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing) o;
    return equalsNullable(this.permanentIdentifier, postOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.permanentIdentifier) &&
        equalsNullable(this.tickerExchange, postOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.tickerExchange) &&
        equalsNullable(this.isPrimary, postOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.isPrimary);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing {\n");
