...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetDataItems;
...
public class InlineResponse2002 implements Serializable {
  ...
  private java.util.List<PostOptionByClassValueRangesGetDataItems> data = null;
  ...
  public InlineResponse2002 data(java.util.List<PostOptionByClassValueRangesGetDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(PostOptionByClassValueRangesGetDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Possible values and value ranges of the parameters.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<PostOptionByClassValueRangesGetDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostOptionByClassValueRangesGetDataItems> data) {
    this.data = data;
  }
