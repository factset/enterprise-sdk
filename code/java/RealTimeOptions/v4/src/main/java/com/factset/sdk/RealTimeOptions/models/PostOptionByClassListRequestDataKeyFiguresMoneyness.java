 ...
 */
@ApiModel(description = "Value range of the ratio of the current underlying level to the strike of an option. For calls, it is current underlying level divided by the strike. For puts, it is strike divided by the current underlying level. It measures the degree to which an option is in-the-money (moneyness > 1) or out-of-the-money (moneyness < 1). If moneyness = 1, the option is at-the-money.")
@JsonPropertyOrder({
  PostOptionByClassListRequestDataKeyFiguresMoneyness.JSON_PROPERTY_MINIMUM,
  PostOptionByClassListRequestDataKeyFiguresMoneyness.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataKeyFiguresMoneyness implements Serializable {
  ...
  public PostOptionByClassListRequestDataKeyFiguresMoneyness() { 
  }

  public PostOptionByClassListRequestDataKeyFiguresMoneyness minimum(PostOptionByClassListRequestDataOpenInterestMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresMoneyness maximum(PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassListRequest_data_keyFigures_moneyness object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataKeyFiguresMoneyness postOptionByClassListRequestDataKeyFiguresMoneyness = (PostOptionByClassListRequestDataKeyFiguresMoneyness) o;
    return Objects.equals(this.minimum, postOptionByClassListRequestDataKeyFiguresMoneyness.minimum) &&
        Objects.equals(this.maximum, postOptionByClassListRequestDataKeyFiguresMoneyness.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassListRequestDataKeyFiguresMoneyness {\n");
