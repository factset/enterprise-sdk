...
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestDataUnderlyingInstrument;
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestDataUnderlyingNotation;
 ...
 */
@ApiModel(description = "Underlying selection.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataUnderlying.JSON_PROPERTY_INSTRUMENT,
  PostOptionClassScreenerSearchRequestDataUnderlying.JSON_PROPERTY_NOTATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataUnderlying implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_INSTRUMENT = "instrument";
  private PostOptionClassScreenerSearchRequestDataUnderlyingInstrument instrument;

  public static final String JSON_PROPERTY_NOTATION = "notation";
  private PostOptionClassScreenerSearchRequestDataUnderlyingNotation notation;

  public PostOptionClassScreenerSearchRequestDataUnderlying() { 
  }

  public PostOptionClassScreenerSearchRequestDataUnderlying instrument(PostOptionClassScreenerSearchRequestDataUnderlyingInstrument instrument) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestDataUnderlyingInstrument getInstrument() {
    return instrument;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INSTRUMENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInstrument(PostOptionClassScreenerSearchRequestDataUnderlyingInstrument instrument) {
    this.instrument = instrument;
  }


  public PostOptionClassScreenerSearchRequestDataUnderlying notation(PostOptionClassScreenerSearchRequestDataUnderlyingNotation notation) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestDataUnderlyingNotation getNotation() {
    return notation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NOTATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNotation(PostOptionClassScreenerSearchRequestDataUnderlyingNotation notation) {
    this.notation = notation;
  }


  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_underlying object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataUnderlying postOptionClassScreenerSearchRequestDataUnderlying = (PostOptionClassScreenerSearchRequestDataUnderlying) o;
    return Objects.equals(this.instrument, postOptionClassScreenerSearchRequestDataUnderlying.instrument) &&
        Objects.equals(this.notation, postOptionClassScreenerSearchRequestDataUnderlying.notation);
  }
