 ...
 */
@ApiModel(description = "Value range of the weekly theta.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetDataItemsThetaOneWeek.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetDataItemsThetaOneWeek.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetDataItemsThetaOneWeek implements Serializable {
  ...
  public PostOptionByClassValueRangesGetDataItemsThetaOneWeek() { 
  }

  public PostOptionByClassValueRangesGetDataItemsThetaOneWeek minimum(BigDecimal minimum) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetDataItemsThetaOneWeek maximum(BigDecimal maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetDataItems_thetaOneWeek object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetDataItemsThetaOneWeek postOptionByClassValueRangesGetDataItemsThetaOneWeek = (PostOptionByClassValueRangesGetDataItemsThetaOneWeek) o;
    return equalsNullable(this.minimum, postOptionByClassValueRangesGetDataItemsThetaOneWeek.minimum) &&
        equalsNullable(this.maximum, postOptionByClassValueRangesGetDataItemsThetaOneWeek.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetDataItemsThetaOneWeek {\n");
