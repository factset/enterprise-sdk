...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataKeyFiguresGammaMinimum;
 ...
 */
@ApiModel(description = "Value range of the delta. It represents the first partial derivative of the function determining the option's theoretical price with respect to the underlying level, evaluated at the underlying level. Delta indicates the ratio of the absolute change of the price of an option for an indefinitely small absolute change in the underlying level, thus it represents the price sensitivity of the option relative to changes in the underlying level.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MINIMUM = "minimum";
  private PostOptionByClassListRequestDataKeyFiguresGammaMinimum minimum;

  public static final String JSON_PROPERTY_MAXIMUM = "maximum";
  private PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum;

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta() { 
  }

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta minimum(PostOptionByClassListRequestDataKeyFiguresGammaMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresGammaMinimum getMinimum() {
    return minimum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MINIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinimum(PostOptionByClassListRequestDataKeyFiguresGammaMinimum minimum) {
    this.minimum = minimum;
  }


  public PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta maximum(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_keyFigures_delta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta postOptionByClassValueRangesGetRequestDataKeyFiguresDelta = (PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataKeyFiguresDelta.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataKeyFiguresDelta.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta {\n");
