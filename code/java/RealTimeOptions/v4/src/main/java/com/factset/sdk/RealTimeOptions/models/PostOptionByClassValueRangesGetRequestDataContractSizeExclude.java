...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataContractSizeExclude.JSON_PROPERTY_VALUES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataContractSizeExclude implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_VALUES = "values";
  private java.util.Set<BigDecimal> values = null;

  public PostOptionByClassValueRangesGetRequestDataContractSizeExclude() { 
  }

  public PostOptionByClassValueRangesGetRequestDataContractSizeExclude values(java.util.Set<BigDecimal> values) {
    this.values = values;
    return this;
  }

  public PostOptionByClassValueRangesGetRequestDataContractSizeExclude addValuesItem(BigDecimal valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_contractSize_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataContractSizeExclude postOptionByClassValueRangesGetRequestDataContractSizeExclude = (PostOptionByClassValueRangesGetRequestDataContractSizeExclude) o;
    return Objects.equals(this.values, postOptionByClassValueRangesGetRequestDataContractSizeExclude.values);
  }
