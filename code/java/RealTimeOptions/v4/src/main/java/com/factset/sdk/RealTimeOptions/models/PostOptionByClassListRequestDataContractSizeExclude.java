 ...
 */
@ApiModel(description = "Specifies the contract sizes an option may not have.")
@JsonPropertyOrder({
  PostOptionByClassListRequestDataContractSizeExclude.JSON_PROPERTY_VALUES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataContractSizeExclude implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_VALUES = "values";
  private java.util.Set<BigDecimal> values = null;

  public PostOptionByClassListRequestDataContractSizeExclude() { 
  }

  public PostOptionByClassListRequestDataContractSizeExclude values(java.util.Set<BigDecimal> values) {
    this.values = values;
    return this;
  }

  public PostOptionByClassListRequestDataContractSizeExclude addValuesItem(BigDecimal valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionByClassListRequest_data_contractSize_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataContractSizeExclude postOptionByClassListRequestDataContractSizeExclude = (PostOptionByClassListRequestDataContractSizeExclude) o;
    return Objects.equals(this.values, postOptionByClassListRequestDataContractSizeExclude.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassListRequestDataContractSizeExclude {\n");
