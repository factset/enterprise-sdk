...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListDataItemsInstrumentLifeCycleExpiration;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListDataItemsInstrumentLifeCycleMaturity;
...
@JsonPropertyOrder({
  PostOptionByClassListDataItemsInstrumentLifeCycle.JSON_PROPERTY_MATURITY,
  PostOptionByClassListDataItemsInstrumentLifeCycle.JSON_PROPERTY_EXPIRATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListDataItemsInstrumentLifeCycle implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MATURITY = "maturity";
  private PostOptionByClassListDataItemsInstrumentLifeCycleMaturity maturity;

  public static final String JSON_PROPERTY_EXPIRATION = "expiration";
  private PostOptionByClassListDataItemsInstrumentLifeCycleExpiration expiration;

  public PostOptionByClassListDataItemsInstrumentLifeCycle() { 
  }

  public PostOptionByClassListDataItemsInstrumentLifeCycle maturity(PostOptionByClassListDataItemsInstrumentLifeCycleMaturity maturity) {
  ...
  **/
  ...
  public PostOptionByClassListDataItemsInstrumentLifeCycleMaturity getMaturity() {
    return maturity;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MATURITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaturity(PostOptionByClassListDataItemsInstrumentLifeCycleMaturity maturity) {
    this.maturity = maturity;
  }


  public PostOptionByClassListDataItemsInstrumentLifeCycle expiration(PostOptionByClassListDataItemsInstrumentLifeCycleExpiration expiration) {
  ...
  **/
  ...
  public PostOptionByClassListDataItemsInstrumentLifeCycleExpiration getExpiration() {
    return expiration;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPIRATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExpiration(PostOptionByClassListDataItemsInstrumentLifeCycleExpiration expiration) {
    this.expiration = expiration;
  }


  /**
   * Return true if this PostOptionByClassListDataItems_instrument_lifeCycle object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListDataItemsInstrumentLifeCycle postOptionByClassListDataItemsInstrumentLifeCycle = (PostOptionByClassListDataItemsInstrumentLifeCycle) o;
    return Objects.equals(this.maturity, postOptionByClassListDataItemsInstrumentLifeCycle.maturity) &&
        Objects.equals(this.expiration, postOptionByClassListDataItemsInstrumentLifeCycle.expiration);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassListDataItemsInstrumentLifeCycle {\n");
