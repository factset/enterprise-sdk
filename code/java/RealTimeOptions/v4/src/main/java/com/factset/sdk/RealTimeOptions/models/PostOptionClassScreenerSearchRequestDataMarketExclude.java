 ...
 */
@ApiModel(description = "Specifies the markets from which an option class may not originate.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataMarketExclude.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataMarketExclude implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<BigDecimal> ids = null;

  public PostOptionClassScreenerSearchRequestDataMarketExclude() { 
  }

  public PostOptionClassScreenerSearchRequestDataMarketExclude ids(java.util.List<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostOptionClassScreenerSearchRequestDataMarketExclude addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_market_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataMarketExclude postOptionClassScreenerSearchRequestDataMarketExclude = (PostOptionClassScreenerSearchRequestDataMarketExclude) o;
    return Objects.equals(this.ids, postOptionClassScreenerSearchRequestDataMarketExclude.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequestDataMarketExclude {\n");
