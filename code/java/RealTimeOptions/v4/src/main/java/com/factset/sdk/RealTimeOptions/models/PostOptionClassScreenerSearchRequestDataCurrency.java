...
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestDataCurrencyExclude;
import com.factset.sdk.RealTimeOptions.models.PostOptionClassScreenerSearchRequestDataCurrencyRestrict;
 ...
 */
@ApiModel(description = "Currency-related class selection. See endpoint `/basic/value-unit/currency/list` for possible values.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataCurrency.JSON_PROPERTY_RESTRICT,
  PostOptionClassScreenerSearchRequestDataCurrency.JSON_PROPERTY_EXCLUDE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataCurrency implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_RESTRICT = "restrict";
  private PostOptionClassScreenerSearchRequestDataCurrencyRestrict restrict;

  public static final String JSON_PROPERTY_EXCLUDE = "exclude";
  private PostOptionClassScreenerSearchRequestDataCurrencyExclude exclude;

  public PostOptionClassScreenerSearchRequestDataCurrency() { 
  }

  public PostOptionClassScreenerSearchRequestDataCurrency restrict(PostOptionClassScreenerSearchRequestDataCurrencyRestrict restrict) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestDataCurrencyRestrict getRestrict() {
    return restrict;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESTRICT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRestrict(PostOptionClassScreenerSearchRequestDataCurrencyRestrict restrict) {
    this.restrict = restrict;
  }


  public PostOptionClassScreenerSearchRequestDataCurrency exclude(PostOptionClassScreenerSearchRequestDataCurrencyExclude exclude) {
  ...
  **/
  ...
  public PostOptionClassScreenerSearchRequestDataCurrencyExclude getExclude() {
    return exclude;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXCLUDE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExclude(PostOptionClassScreenerSearchRequestDataCurrencyExclude exclude) {
    this.exclude = exclude;
  }


  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_currency object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataCurrency postOptionClassScreenerSearchRequestDataCurrency = (PostOptionClassScreenerSearchRequestDataCurrency) o;
    return Objects.equals(this.restrict, postOptionClassScreenerSearchRequestDataCurrency.restrict) &&
        Objects.equals(this.exclude, postOptionClassScreenerSearchRequestDataCurrency.exclude);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequestDataCurrency {\n");
