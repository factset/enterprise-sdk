...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity;
...
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataLifeCycle.JSON_PROPERTY_MATURITY,
  PostOptionByClassValueRangesGetRequestDataLifeCycle.JSON_PROPERTY_EXPIRATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataLifeCycle implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MATURITY = "maturity";
  private PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity maturity;

  public static final String JSON_PROPERTY_EXPIRATION = "expiration";
  private PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration expiration;

  public PostOptionByClassValueRangesGetRequestDataLifeCycle() { 
  }

  public PostOptionByClassValueRangesGetRequestDataLifeCycle maturity(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity maturity) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity getMaturity() {
    return maturity;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MATURITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaturity(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity maturity) {
    this.maturity = maturity;
  }


  public PostOptionByClassValueRangesGetRequestDataLifeCycle expiration(PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration expiration) {
  ...
  **/
  ...
  public PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration getExpiration() {
    return expiration;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPIRATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExpiration(PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration expiration) {
    this.expiration = expiration;
  }


  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_lifeCycle object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataLifeCycle postOptionByClassValueRangesGetRequestDataLifeCycle = (PostOptionByClassValueRangesGetRequestDataLifeCycle) o;
    return Objects.equals(this.maturity, postOptionByClassValueRangesGetRequestDataLifeCycle.maturity) &&
        Objects.equals(this.expiration, postOptionByClassValueRangesGetRequestDataLifeCycle.expiration);
  }
