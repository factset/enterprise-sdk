...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum;
 ...
 */
@ApiModel(description = "Value range of the implied volatility. It represents the volatility of the underlying that justifies the ask price of the option, when used as a parameter in the option's pricing model (such as Black-Scholes). Its value is a result of the pricing process, thus it represents the annual volatility of the underlying expected by the market participants until maturity of the option.")
@JsonPropertyOrder({
  PostOptionByClassListRequestDataKeyFiguresImpliedVolatility.JSON_PROPERTY_MINIMUM,
  PostOptionByClassListRequestDataKeyFiguresImpliedVolatility.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataKeyFiguresImpliedVolatility implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MINIMUM = "minimum";
  private PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum minimum;

  public static final String JSON_PROPERTY_MAXIMUM = "maximum";
  private PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum maximum;

  public PostOptionByClassListRequestDataKeyFiguresImpliedVolatility() { 
  }

  public PostOptionByClassListRequestDataKeyFiguresImpliedVolatility minimum(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum getMinimum() {
    return minimum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MINIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinimum(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum minimum) {
    this.minimum = minimum;
  }


  public PostOptionByClassListRequestDataKeyFiguresImpliedVolatility maximum(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum maximum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum getMaximum() {
    return maximum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAXIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaximum(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum maximum) {
    this.maximum = maximum;
  }


  /**
   * Return true if this PostOptionByClassListRequest_data_keyFigures_impliedVolatility object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataKeyFiguresImpliedVolatility postOptionByClassListRequestDataKeyFiguresImpliedVolatility = (PostOptionByClassListRequestDataKeyFiguresImpliedVolatility) o;
    return Objects.equals(this.minimum, postOptionByClassListRequestDataKeyFiguresImpliedVolatility.minimum) &&
        Objects.equals(this.maximum, postOptionByClassListRequestDataKeyFiguresImpliedVolatility.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassListRequestDataKeyFiguresImpliedVolatility {\n");
