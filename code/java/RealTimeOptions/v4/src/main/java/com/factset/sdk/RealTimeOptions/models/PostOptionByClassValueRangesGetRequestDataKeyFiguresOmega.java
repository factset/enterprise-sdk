...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataOpenInterestMaximum;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataOpenInterestMinimum;
 ...
 */
@ApiModel(description = "Value range of the omega. It represents delta (see attribute delta) multiplied with the leverage (see attribute `leverage`), both calculated based on the ask price of the option. Omega indicates the elasticity of the option's price regarding the underlying level.")
@JsonPropertyOrder({
  PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega.JSON_PROPERTY_MINIMUM,
  PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MINIMUM = "minimum";
  private PostOptionByClassListRequestDataOpenInterestMinimum minimum;

  public static final String JSON_PROPERTY_MAXIMUM = "maximum";
  private PostOptionByClassListRequestDataOpenInterestMaximum maximum;

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega() { 
  }

  public PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega minimum(PostOptionByClassListRequestDataOpenInterestMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataOpenInterestMinimum getMinimum() {
    return minimum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MINIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinimum(PostOptionByClassListRequestDataOpenInterestMinimum minimum) {
    this.minimum = minimum;
  }


  public PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega maximum(PostOptionByClassListRequestDataOpenInterestMaximum maximum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataOpenInterestMaximum getMaximum() {
    return maximum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAXIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaximum(PostOptionByClassListRequestDataOpenInterestMaximum maximum) {
    this.maximum = maximum;
  }


  /**
   * Return true if this PostOptionByClassValueRangesGetRequest_data_keyFigures_omega object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega postOptionByClassValueRangesGetRequestDataKeyFiguresOmega = (PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega) o;
    return Objects.equals(this.minimum, postOptionByClassValueRangesGetRequestDataKeyFiguresOmega.minimum) &&
        Objects.equals(this.maximum, postOptionByClassValueRangesGetRequestDataKeyFiguresOmega.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega {\n");
