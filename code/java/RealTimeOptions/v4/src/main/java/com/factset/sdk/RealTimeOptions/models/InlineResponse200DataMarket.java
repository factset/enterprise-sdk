 ...
 */
@ApiModel(description = "Market of the option.")
@JsonPropertyOrder({
  InlineResponse200DataMarket.JSON_PROPERTY_ID,
  InlineResponse200DataMarket.JSON_PROPERTY_NAME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse200DataMarket implements Serializable {
  ...
  public InlineResponse200DataMarket() { 
  }

  public InlineResponse200DataMarket id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "3", value = "Identifier of the market.")
  @JsonIgnore
  ...
  public InlineResponse200DataMarket name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_data_market object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataMarket inlineResponse200DataMarket = (InlineResponse200DataMarket) o;
    return equalsNullable(this.id, inlineResponse200DataMarket.id) &&
        equalsNullable(this.name, inlineResponse200DataMarket.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse200DataMarket {\n");
