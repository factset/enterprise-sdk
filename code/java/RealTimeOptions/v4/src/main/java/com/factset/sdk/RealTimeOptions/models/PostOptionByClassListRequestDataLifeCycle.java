...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataLifeCycleExpiration;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataLifeCycleMaturity;
...
@JsonPropertyOrder({
  PostOptionByClassListRequestDataLifeCycle.JSON_PROPERTY_MATURITY,
  PostOptionByClassListRequestDataLifeCycle.JSON_PROPERTY_EXPIRATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataLifeCycle implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MATURITY = "maturity";
  private PostOptionByClassListRequestDataLifeCycleMaturity maturity;

  public static final String JSON_PROPERTY_EXPIRATION = "expiration";
  private PostOptionByClassListRequestDataLifeCycleExpiration expiration;

  public PostOptionByClassListRequestDataLifeCycle() { 
  }

  public PostOptionByClassListRequestDataLifeCycle maturity(PostOptionByClassListRequestDataLifeCycleMaturity maturity) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataLifeCycleMaturity getMaturity() {
    return maturity;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MATURITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaturity(PostOptionByClassListRequestDataLifeCycleMaturity maturity) {
    this.maturity = maturity;
  }


  public PostOptionByClassListRequestDataLifeCycle expiration(PostOptionByClassListRequestDataLifeCycleExpiration expiration) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataLifeCycleExpiration getExpiration() {
    return expiration;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPIRATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExpiration(PostOptionByClassListRequestDataLifeCycleExpiration expiration) {
    this.expiration = expiration;
  }


  /**
   * Return true if this PostOptionByClassListRequest_data_lifeCycle object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataLifeCycle postOptionByClassListRequestDataLifeCycle = (PostOptionByClassListRequestDataLifeCycle) o;
    return Objects.equals(this.maturity, postOptionByClassListRequestDataLifeCycle.maturity) &&
        Objects.equals(this.expiration, postOptionByClassListRequestDataLifeCycle.expiration);
  }
