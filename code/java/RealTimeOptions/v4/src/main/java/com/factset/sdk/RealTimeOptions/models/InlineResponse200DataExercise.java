...
@JsonPropertyOrder({
  InlineResponse200DataExercise.JSON_PROPERTY_RIGHT,
  InlineResponse200DataExercise.JSON_PROPERTY_STYLE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse200DataExercise implements Serializable {
  ...
  **/
  ...
  public InlineResponse200DataExercise style(StyleEnum style) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "european", value = "Exercise style of the option. | Value | Description | | --- | --- | | american | An American-style option can be exercised anytime during its life. | | european | A European-style option can be exercised at the end of its life. |  ")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_data_exercise object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataExercise inlineResponse200DataExercise = (InlineResponse200DataExercise) o;
    return equalsNullable(this.right, inlineResponse200DataExercise.right) &&
        equalsNullable(this.style, inlineResponse200DataExercise.style);
  }
