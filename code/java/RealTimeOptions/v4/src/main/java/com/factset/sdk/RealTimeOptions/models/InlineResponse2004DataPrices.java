...
import com.factset.sdk.RealTimeOptions.models.InlineResponse2004DataPricesAsk;
 ...
 */
@ApiModel(description = "Prices of the option as used for the calculation.")
@JsonPropertyOrder({
  InlineResponse2004DataPrices.JSON_PROPERTY_ASK
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse2004DataPrices implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ASK = "ask";
  private InlineResponse2004DataPricesAsk ask;

  public InlineResponse2004DataPrices() { 
  }

  public InlineResponse2004DataPrices ask(InlineResponse2004DataPricesAsk ask) {
    this.ask = ask;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2004DataPricesAsk getAsk() {
    return ask;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ASK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAsk(InlineResponse2004DataPricesAsk ask) {
    this.ask = ask;
  }


  /**
   * Return true if this inline_response_200_4_data_prices object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2004DataPrices inlineResponse2004DataPrices = (InlineResponse2004DataPrices) o;
    return Objects.equals(this.ask, inlineResponse2004DataPrices.ask);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ask);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineResponse2004DataPrices {\n");
