 ...
 */
@ApiModel(description = "Main or fractional currency of the settlement price. See endpoint `/basic/value-unit/currency/list` for possible values.")
@JsonPropertyOrder({
  InlineResponse200DataSettlementCurrency.JSON_PROPERTY_ID,
  InlineResponse200DataSettlementCurrency.JSON_PROPERTY_CODE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse200DataSettlementCurrency implements Serializable {
  ...
  public InlineResponse200DataSettlementCurrency() { 
  }

  public InlineResponse200DataSettlementCurrency id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Identifier of the currency.")
  @JsonIgnore
  ...
  public InlineResponse200DataSettlementCurrency code(String code) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_data_settlement_currency object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataSettlementCurrency inlineResponse200DataSettlementCurrency = (InlineResponse200DataSettlementCurrency) o;
    return equalsNullable(this.id, inlineResponse200DataSettlementCurrency.id) &&
        equalsNullable(this.code, inlineResponse200DataSettlementCurrency.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse200DataSettlementCurrency {\n");
