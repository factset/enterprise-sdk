 ...
 */
@ApiModel(description = "Specifies the categories an option class may have.")
@JsonPropertyOrder({
  PostOptionClassScreenerSearchRequestDataCategoryRestrict.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionClassScreenerSearchRequestDataCategoryRestrict implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.List<BigDecimal> ids = null;

  public PostOptionClassScreenerSearchRequestDataCategoryRestrict() { 
  }

  public PostOptionClassScreenerSearchRequestDataCategoryRestrict ids(java.util.List<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostOptionClassScreenerSearchRequestDataCategoryRestrict addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of category identifiers.")
  ...
  /**
   * Return true if this PostOptionClassScreenerSearchRequest_data_category_restrict object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionClassScreenerSearchRequestDataCategoryRestrict postOptionClassScreenerSearchRequestDataCategoryRestrict = (PostOptionClassScreenerSearchRequestDataCategoryRestrict) o;
    return Objects.equals(this.ids, postOptionClassScreenerSearchRequestDataCategoryRestrict.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionClassScreenerSearchRequestDataCategoryRestrict {\n");
