...
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataKeyFiguresOmegaMaximum;
import com.factset.sdk.RealTimeOptions.models.PostOptionByClassListRequestDataKeyFiguresOmegaMinimum;
...
@JsonPropertyOrder({
  PostOptionByClassListRequestDataKeyFiguresOmega.JSON_PROPERTY_MINIMUM,
  PostOptionByClassListRequestDataKeyFiguresOmega.JSON_PROPERTY_MAXIMUM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostOptionByClassListRequestDataKeyFiguresOmega implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MINIMUM = "minimum";
  private PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum;

  public static final String JSON_PROPERTY_MAXIMUM = "maximum";
  private PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum;

  public PostOptionByClassListRequestDataKeyFiguresOmega() { 
  }

  public PostOptionByClassListRequestDataKeyFiguresOmega minimum(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresOmegaMinimum getMinimum() {
    return minimum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MINIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinimum(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum) {
    this.minimum = minimum;
  }


  public PostOptionByClassListRequestDataKeyFiguresOmega maximum(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum) {
  ...
  **/
  ...
  public PostOptionByClassListRequestDataKeyFiguresOmegaMaximum getMaximum() {
    return maximum;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAXIMUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaximum(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum) {
    this.maximum = maximum;
  }


  /**
   * Return true if this PostOptionByClassListRequest_data_keyFigures_omega object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOptionByClassListRequestDataKeyFiguresOmega postOptionByClassListRequestDataKeyFiguresOmega = (PostOptionByClassListRequestDataKeyFiguresOmega) o;
    return Objects.equals(this.minimum, postOptionByClassListRequestDataKeyFiguresOmega.minimum) &&
        Objects.equals(this.maximum, postOptionByClassListRequestDataKeyFiguresOmega.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOptionByClassListRequestDataKeyFiguresOmega {\n");
