package com.factset.sdk.FactSetEntityReportBuilder;
...
import com.factset.sdk.FactSetEntityReportBuilder.auth.Authentication;
import com.factset.sdk.FactSetEntityReportBuilder.auth.HttpBasicAuth;
import com.factset.sdk.FactSetEntityReportBuilder.auth.HttpBearerAuth;
import com.factset.sdk.FactSetEntityReportBuilder.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetEntityReportBuilder.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/report/entity/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/report/entity/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetEntityReportBuilder/2.0.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetEntityReportBuilder.ApiClient} object.
   */
