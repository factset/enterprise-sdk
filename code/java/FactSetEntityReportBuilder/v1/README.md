...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetentityreportbuilder/2.0.3)](https://central.sonatype.com/artifact/com.factset.sdk/factsetentityreportbuilder/2.0.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetentityreportbuilder:2.0.3"
  }
```
