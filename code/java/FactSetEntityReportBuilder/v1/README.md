...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetentityreportbuilder)](https://search.maven.org/artifact/com.factset.sdk/factsetentityreportbuilder)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetentityreportbuilder:2.0.0"
  }
```
