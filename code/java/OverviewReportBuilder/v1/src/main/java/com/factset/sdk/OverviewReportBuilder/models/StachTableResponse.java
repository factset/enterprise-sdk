 ...
 */
@JsonPropertyOrder({
  StachTableResponse.JSON_PROPERTY_DATA,
  StachTableResponse.JSON_PROPERTY_META
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class StachTableResponse implements Serializable {
  ...
  public StachTableResponse() { 
  }

  public StachTableResponse data(Object data) {
  ...
  **/
  ...
  public StachTableResponse meta(java.util.Map<String, String> meta) {
    this.meta = meta;
    return this;
  }

  public StachTableResponse putMetaItem(String key, String metaItem) {
    if (this.meta == null) {
  ...
  **/
  ...
  /**
   * Return true if this StachTableResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StachTableResponse stachTableResponse = (StachTableResponse) o;
    return equalsNullable(this.data, stachTableResponse.data) &&
        Objects.equals(this.meta, stachTableResponse.meta);
  }
