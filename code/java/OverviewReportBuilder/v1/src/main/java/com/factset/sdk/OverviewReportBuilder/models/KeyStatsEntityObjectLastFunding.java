 ...
 */
@ApiModel(description = "The most recent date on which a company raised capital from investors in a funding round.")
@JsonPropertyOrder({
  KeyStatsEntityObjectLastFunding.JSON_PROPERTY_VALUE,
  KeyStatsEntityObjectLastFunding.JSON_PROPERTY_LABEL
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class KeyStatsEntityObjectLastFunding implements Serializable {
  ...
  public KeyStatsEntityObjectLastFunding() { 
  }
  ...
  public KeyStatsEntityObjectLastFunding value(KeyStatsEntityObjectFirstDateValue value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public KeyStatsEntityObjectLastFunding label(KeyStatsEntityObjectRange52WeekValue label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this KeyStatsEntityObject_lastFunding object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    KeyStatsEntityObjectLastFunding keyStatsEntityObjectLastFunding = (KeyStatsEntityObjectLastFunding) o;
    return Objects.equals(this.value, keyStatsEntityObjectLastFunding.value) &&
        Objects.equals(this.label, keyStatsEntityObjectLastFunding.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyStatsEntityObjectLastFunding {\n");
