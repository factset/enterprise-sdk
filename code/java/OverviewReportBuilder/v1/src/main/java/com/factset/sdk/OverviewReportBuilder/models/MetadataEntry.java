...
public class MetadataEntry extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class MetadataEntryDeserializer extends StdDeserializer<MetadataEntry> {
        ...
        public MetadataEntry deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (Sources.class.equals(Integer.class) || Sources.class.equals(Long.class) || Sources.class.equals(Float.class) || Sources.class.equals(Double.class) || Sources.class.equals(Boolean.class) || Sources.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((Sources.class.equals(Integer.class) || Sources.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((Sources.class.equals(Float.class) || Sources.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (Sources.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (Sources.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<Sources>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Sources'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Sources'", e);
            }
    ...
    public MetadataEntry(Sources o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("Sources", new GenericType<Sources>() {
        });
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, Scale, Sources, TransactionId, TransactionType, ValueType
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        // Sources
        if (JSON.isInstanceOf(Sources.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, Scale, Sources, TransactionId, TransactionType, ValueType");
    }
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, Scale, Sources, TransactionId, TransactionType, ValueType
     *
     * @return The actual instance (Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, Scale, Sources, TransactionId, TransactionType, ValueType)
     */
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Sources`
     * @throws ClassCastException if the instance is not `Sources`
     */
