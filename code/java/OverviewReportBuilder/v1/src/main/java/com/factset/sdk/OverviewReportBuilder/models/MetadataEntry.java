...
import com.factset.sdk.OverviewReportBuilder.models.CategoryCategory;
...
import com.factset.sdk.OverviewReportBuilder.models.DescriptionDescription;
...
import com.factset.sdk.OverviewReportBuilder.models.MetricMetric;
import com.factset.sdk.OverviewReportBuilder.models.RelevanceType;
import com.factset.sdk.OverviewReportBuilder.models.RelevanceTypeRelevanceType;
...
import com.factset.sdk.OverviewReportBuilder.models.TransactionIdTransactionId;
...
public class MetadataEntry extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class MetadataEntryDeserializer extends StdDeserializer<MetadataEntry> {
        ...
        public MetadataEntry deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (Metric.class.equals(Integer.class) || Metric.class.equals(Long.class) || Metric.class.equals(Float.class) || Metric.class.equals(Double.class) || Metric.class.equals(Boolean.class) || Metric.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((Metric.class.equals(Integer.class) || Metric.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((Metric.class.equals(Float.class) || Metric.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                ...
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<Metric>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
            ...
            // deserialize RelevanceType
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (RelevanceType.class.equals(Integer.class) || RelevanceType.class.equals(Long.class) || RelevanceType.class.equals(Float.class) || RelevanceType.class.equals(Double.class) || RelevanceType.class.equals(Boolean.class) || RelevanceType.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((RelevanceType.class.equals(Integer.class) || RelevanceType.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((RelevanceType.class.equals(Float.class) || RelevanceType.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (RelevanceType.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (RelevanceType.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<RelevanceType>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'RelevanceType'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'RelevanceType'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (TransactionId.class.equals(Integer.class) || TransactionId.class.equals(Long.class) || TransactionId.class.equals(Float.class) || TransactionId.class.equals(Double.class) || TransactionId.class.equals(Boolean.class) || TransactionId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((TransactionId.class.equals(Integer.class) || TransactionId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((TransactionId.class.equals(Float.class) || TransactionId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (TransactionId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (TransactionId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<TransactionId>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'TransactionId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'TransactionId'", e);
            }

            // deserialize TransactionType
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (TransactionType.class.equals(Integer.class) || TransactionType.class.equals(Long.class) || TransactionType.class.equals(Float.class) || TransactionType.class.equals(Double.class) || TransactionType.class.equals(Boolean.class) || TransactionType.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((TransactionType.class.equals(Integer.class) || TransactionType.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((TransactionType.class.equals(Float.class) || TransactionType.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (TransactionType.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (TransactionType.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<TransactionType>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'TransactionType'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'TransactionType'", e);
            }
    ...
    public MetadataEntry(Metric o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public MetadataEntry(RelevanceType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public MetadataEntry(TransactionId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public MetadataEntry(TransactionType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("RelevanceType", new GenericType<RelevanceType>() {
        });
        schemas.put("Scale", new GenericType<Scale>() {
        });
        schemas.put("TransactionId", new GenericType<TransactionId>() {
        });
        schemas.put("TransactionType", new GenericType<TransactionType>() {
        });
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, RelevanceType, Scale, TransactionId, TransactionType, ValueType
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        // RelevanceType
        if (JSON.isInstanceOf(RelevanceType.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        // TransactionId
        if (JSON.isInstanceOf(TransactionId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        // TransactionType
        if (JSON.isInstanceOf(TransactionType.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, RelevanceType, Scale, TransactionId, TransactionType, ValueType");
    }
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, RelevanceType, Scale, TransactionId, TransactionType, ValueType
     *
     * @return The actual instance (Category, CurrencyCode, CurrencySymbol, Description, Frequency, Metric, RelevanceType, Scale, TransactionId, TransactionType, ValueType)
     */
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `RelevanceType`
     * @throws ClassCastException if the instance is not `RelevanceType`
     */
    public RelevanceType getRelevanceType() throws ClassCastException {
        return (RelevanceType)super.getActualInstance();
    }
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `TransactionId`
     * @throws ClassCastException if the instance is not `TransactionId`
     */
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `TransactionType`
     * @throws ClassCastException if the instance is not `TransactionType`
     */
