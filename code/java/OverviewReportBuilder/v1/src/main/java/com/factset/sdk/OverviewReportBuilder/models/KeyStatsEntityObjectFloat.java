 ...
 */
@ApiModel(description = "The percentage of a company's outstanding shares that are available for trading by the public, excluding shares that are closely held or restricted")
@JsonPropertyOrder({
  KeyStatsEntityObjectFloat.JSON_PROPERTY_VALUE,
  KeyStatsEntityObjectFloat.JSON_PROPERTY_LABEL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class KeyStatsEntityObjectFloat implements Serializable {
  ...
  public KeyStatsEntityObjectFloat() { 
  }
  ...
  public KeyStatsEntityObjectFloat value(KeyStatsEntityObjectAverageDailyVolValue value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public KeyStatsEntityObjectFloat label(KeyStatsEntityObjectRange52WeekValue label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this KeyStatsEntityObject_float object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    KeyStatsEntityObjectFloat keyStatsEntityObjectFloat = (KeyStatsEntityObjectFloat) o;
    return Objects.equals(this.value, keyStatsEntityObjectFloat.value) &&
        Objects.equals(this.label, keyStatsEntityObjectFloat.label);
  }
