package com.factset.sdk.OverviewReportBuilder;
...
import com.factset.sdk.OverviewReportBuilder.auth.Authentication;
import com.factset.sdk.OverviewReportBuilder.auth.HttpBasicAuth;
import com.factset.sdk.OverviewReportBuilder.auth.HttpBearerAuth;
import com.factset.sdk.OverviewReportBuilder.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.OverviewReportBuilder.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/report/overview/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/report/overview/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/OverviewReportBuilder/2.1.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.OverviewReportBuilder.ApiClient} object.
   */
