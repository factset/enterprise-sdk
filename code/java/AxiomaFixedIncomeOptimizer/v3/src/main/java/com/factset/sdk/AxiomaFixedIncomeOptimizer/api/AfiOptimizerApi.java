...
import com.factset.sdk.AxiomaFixedIncomeOptimizer.models.AFIOptimizationParametersRoot;
import com.factset.sdk.AxiomaFixedIncomeOptimizer.models.CalculationInfoRoot;
import com.factset.sdk.AxiomaFixedIncomeOptimizer.models.ClientErrorResponse;
import com.factset.sdk.AxiomaFixedIncomeOptimizer.models.ObjectRoot;
...
public class AfiOptimizerApi {
  ...
  public AfiOptimizerApi(ApiClient apiClient) {
  ...
  static {
    getOptimizationParametersResponseTypeMap.put(200, new GenericType<AFIOptimizationParametersRoot>(){});
 ...
 /**
   ...
   * @param id from url, provided from the location header in the Create and Run AFI optimization endpoint (required)
  ...
  public ApiResponse<Void> cancelOptimizationByIdWithHttpInfo(String id) throws ApiException {
    ...
    String localVarPath = "/analytics/engines/afi/v3/optimizations/{id}"
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("AfiOptimizerApi.cancelOptimizationById", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
   ...
   */
  public AFIOptimizationParametersRoot getOptimizationParameters(String id) throws ApiException {
   ...
   * This is the endpoint that returns the optimization parameters passed for an optimization.
   * @param id from url, provided from the location header in the Create and Run AFI optimization endpoint (required)
   * @return ApiResponse&lt;AFIOptimizationParametersRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<AFIOptimizationParametersRoot> getOptimizationParametersWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("AfiOptimizerApi.getOptimizationParameters", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @param id from url, provided from the location header in the Get AFI optimization status by id endpoint (required)
   * @return ObjectRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public ApiResponse<ObjectRoot> getOptimizationResultWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/afi/v3/optimizations/{id}/result"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    > apiResponse = apiClient.invokeAPI("AfiOptimizerApi.getOptimizationResult", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<ObjectRoot> getOptimizationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/afi/v3/optimizations/{id}/status"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    > apiResponse = apiClient.invokeAPI("AfiOptimizerApi.getOptimizationStatusById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @param afIOptimizationParametersRoot Optimization Parameters (optional)
   ...
   */
  public PostAndOptimizeResponseWrapper postAndOptimize(Integer xFactSetApiLongRunningDeadline, String cacheControl, AFIOptimizationParametersRoot afIOptimizationParametersRoot) throws ApiException {
    return postAndOptimizeWithHttpInfo(xFactSetApiLongRunningDeadline, cacheControl, afIOptimizationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<PostAndOptimizeResponseWrapper> postAndOptimizeWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, AFIOptimizationParametersRoot afIOptimizationParametersRoot) throws ApiException {
    Object localVarPostBody = afIOptimizationParametersRoot;
    
    // create path and map variables
    String localVarPath = "/analytics/engines/afi/v3/optimizations";
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("AfiOptimizerApi.postAndOptimize", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 403 </td><td> User is forbidden with current credentials </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 404 </td><td> One or more optimization settings were unavailable. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 409 </td><td> Duplicate optimization exists with same parameters. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 415 </td><td> Missing/Invalid Content-Type header. Header needs to be set to application/json. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 429 </td><td> Rate limit reached. Cancel older requests using Cancel optimization endpoint or wait for older requests to finish/expire. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  * Retry-After - Time to wait in seconds before making a new request as the rate limit has reached. <br>  </td></tr>
       <tr><td> 500 </td><td> Server error. Log the X-DataDirect-Request-Key header to assist in troubleshooting. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  </td></tr>
       <tr><td> 503 </td><td> Request timed out. Retry the request in sometime. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  </td></tr>
   ...
   */
  public PutAndOptimizeResponseWrapper putAndOptimize(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, AFIOptimizationParametersRoot afIOptimizationParametersRoot) throws ApiException {
    return putAndOptimizeWithHttpInfo(id, xFactSetApiLongRunningDeadline, cacheControl, afIOptimizationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<PutAndOptimizeResponseWrapper> putAndOptimizeWithHttpInfo(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, AFIOptimizationParametersRoot afIOptimizationParametersRoot) throws ApiException {
    Object localVarPostBody = afIOptimizationParametersRoot;
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("AfiOptimizerApi.putAndOptimize", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
