 ...
 */
@ApiModel(description = "Cost and Fees Request Body")
@JsonPropertyOrder({
  CostsFeesRequest.JSON_PROPERTY_IDS,
  CostsFeesRequest.JSON_PROPERTY_DATE,
  CostsFeesRequest.JSON_PROPERTY_CURRENCY
})
...
public class CostsFeesRequest implements Serializable {
  ...
  public CostsFeesRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public CostsFeesRequest date(String date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "2019-12-31", value = "The date requested in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint. ")
  ...
  public CostsFeesRequest currency(String currency) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ids, costsFeesRequest.ids) &&
        Objects.equals(this.date, costsFeesRequest.date) &&
        Objects.equals(this.currency, costsFeesRequest.currency);
  }
