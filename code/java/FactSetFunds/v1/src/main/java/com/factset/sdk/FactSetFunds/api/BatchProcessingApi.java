...
import com.factset.sdk.FactSetFunds.models.BatchErrorResponse;
import com.factset.sdk.FactSetFunds.models.BatchResultResponse;
...
public class BatchProcessingApi {
  ...
  static {
    ...
    getBatchDataResponseTypeMap.put(400, new GenericType<BatchErrorResponse>(){});
    getBatchDataResponseTypeMap.put(401, new GenericType<BatchErrorResponse>(){});
    getBatchDataResponseTypeMap.put(403, new GenericType<BatchErrorResponse>(){});
    getBatchDataResponseTypeMap.put(404, new GenericType<BatchErrorResponse>(){});
    getBatchDataResponseTypeMap.put(500, new GenericType<BatchErrorResponse>(){});
  }
  ...
  static {
    ...
    getBatchStatusResponseTypeMap.put(400, new GenericType<BatchErrorResponse>(){});
    getBatchStatusResponseTypeMap.put(401, new GenericType<BatchErrorResponse>(){});
    getBatchStatusResponseTypeMap.put(403, new GenericType<BatchErrorResponse>(){});
    getBatchStatusResponseTypeMap.put(404, new GenericType<BatchErrorResponse>(){});
    getBatchStatusResponseTypeMap.put(500, new GenericType<BatchErrorResponse>(){});
  }
 ...
 /**
  ...
  public ApiResponse<GetBatchDataResponseWrapper> getBatchDataWithHttpInfo(java.util.UUID id) throws ApiException {
    ...
    String localVarPath = "/factset-funds/v1/batch-result";
  ...
  public ApiResponse<BatchStatusResponse> getBatchStatusWithHttpInfo(java.util.UUID id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/factset-funds/v1/batch-status";
