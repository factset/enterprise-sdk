...
public class ReturnsSnapshot implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(fsymId), hashCodeNullable(oneWeek), hashCodeNullable(oneMonth), hashCodeNullable(threeMonth), hashCodeNullable(yearToDate), hashCodeNullable(oneYear), hashCodeNullable(threeYear), hashCodeNullable(threeYearAnnualized), hashCodeNullable(fiveYear), hashCodeNullable(fiveYearAnnualized), hashCodeNullable(tenYear), hashCodeNullable(tenYearAnnualized), hashCodeNullable(date), requestId);
  }
