...
@JsonPropertyOrder({
  StatusesRequest.JSON_PROPERTY_IDS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class StatusesRequest implements Serializable {
  ...
  public StatusesRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public StatusesRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  /**
   * Return true if this statusesRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StatusesRequest statusesRequest = (StatusesRequest) o;
    return Objects.equals(this.ids, statusesRequest.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusesRequest {\n");
