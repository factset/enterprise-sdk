...
@JsonPropertyOrder({
  ...
  GroupHoldingsRequest.JSON_PROPERTY_BATCH
})
...
public class GroupHoldingsRequest implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"SPAXX\",\"FCNTX\"]", required = true, value = "The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs.  Request Limits:    - ids limit = 1000 per request(Non batch)     - Batch requests:       * Single day: up to 3000 IDs per request       * Multi-day: up to 500 IDs per request        ")
  ...
  **/
  ...
  public GroupHoldingsRequest batch(Batch batch) {
    this.batch = batch;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ids, groupHoldingsRequest.ids) &&
        ...
        Objects.equals(this.batch, groupHoldingsRequest.batch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, asOfDate, group, batch);
  }
