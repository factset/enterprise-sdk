 ...
 */
public enum DistributionOrYieldDist {
  ...
  DistributionOrYieldDist(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DistributionOrYieldDist fromValue(String value) {
    for (DistributionOrYieldDist b : DistributionOrYieldDist.values()) {
