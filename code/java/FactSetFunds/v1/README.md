...
[![API Version](https://img.shields.io/badge/api-v1.2.0-blue)](https://developer.factset.com/api-catalog/factset-funds-api)
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetfunds/2.2.0)](https://central.sonatype.com/artifact/com.factset.sdk/factsetfunds/2.2.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetfunds:2.2.0"
  }
```
