...
[![API Version](https://img.shields.io/badge/api-v1.7.0-blue)](https://developer.factset.com/api-catalog/factset-funds-api)
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetfunds/5.0.0)](https://central.sonatype.com/artifact/com.factset.sdk/factsetfunds/5.0.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetfunds:5.0.0"
  }
```
...
import com.factset.sdk.FactSetFunds.api.BatchProcessingApi;
import com.factset.sdk.FactSetFunds.api.BatchProcessingApi.GetBatchDataResponseWrapper;
...
------------ | ------------- | ------------- | -------------
*BatchProcessingApi* | [**getBatchData**](docs/BatchProcessingApi.md#getBatchData) | **GET** /factset-funds/v1/batch-result | Returns the response for a Batch Request
*BatchProcessingApi* | [**getBatchStatus**](docs/BatchProcessingApi.md#getBatchStatus) | **GET** /factset-funds/v1/batch-status | Returns the status for a Batch Request
