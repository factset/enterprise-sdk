...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetfunds/4.1.0)](https://central.sonatype.com/artifact/com.factset.sdk/factsetfunds/4.1.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetfunds:4.1.0"
  }
```
