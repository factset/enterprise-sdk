...
[![API Version](https://img.shields.io/badge/api-v1.3.0-blue)](https://developer.factset.com/api-catalog/factset-funds-api)
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetfunds/3.0.0)](https://central.sonatype.com/artifact/com.factset.sdk/factsetfunds/3.0.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetfunds:3.0.0"
  }
```
