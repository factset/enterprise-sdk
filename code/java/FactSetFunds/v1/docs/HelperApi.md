...
> StatusesResponse getStatuses(ids)
...
import com.factset.sdk.FactSetFunds.api.HelperApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling HelperApi#getStatuses");
...
> StatusesResponse getStatusesForList(statusesRequest)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        HelperApi apiInstance = new HelperApi(defaultClient);
        StatusesRequest statusesRequest = new StatusesRequest(); // StatusesRequest | The Statuses request body, allowing the user to specify a list of ids.
        try {
            StatusesResponse result = apiInstance.getStatusesForList(statusesRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling HelperApi#getStatusesForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
