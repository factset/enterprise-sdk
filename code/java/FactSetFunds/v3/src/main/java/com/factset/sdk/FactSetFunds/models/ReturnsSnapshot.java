...
import com.factset.sdk.FactSetFunds.models.ReturnsSnapshotAllOf;
 ...
 */
@ApiModel(description = "Snapshot of fund returns across multiple time periods including one week, one month, YTD, and annualized returns")
@JsonPropertyOrder({
  ReturnsSnapshot.JSON_PROPERTY_FSYM_ID,
  ReturnsSnapshot.JSON_PROPERTY_REQUEST_ID,
  ReturnsSnapshot.JSON_PROPERTY_ERROR,
...
public class ReturnsSnapshot implements Serializable {
  ...
  **/
  ...
  public ReturnsSnapshot error(FundsErrorObject error) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.fsymId, returnsSnapshot.fsymId) &&
        ...
        equalsNullable(this.error, returnsSnapshot.error) &&
