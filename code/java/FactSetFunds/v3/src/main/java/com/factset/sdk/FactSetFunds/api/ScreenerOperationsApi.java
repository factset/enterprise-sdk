...
public class ScreenerOperationsApi {
  private ApiClient apiClient;

  public ScreenerOperationsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ScreenerOperationsApi(ApiClient apiClient) {
  ...
  static {
    ...
    getContentSetsResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  ...
  public ApiResponse<CreateContentSetResponse> createContentSetWithHttpInfo(CreateContentSetRequest createContentSetRequest) throws ApiException {
    ...
    String localVarPath = "/screener/content-sets/create";
    ...
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.createContentSet", localVarPath, "POST", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<Void> deleteContentSetWithHttpInfo(String name) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/screener/content-sets/{name}"
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.deleteContentSet", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<ContentSetsResponse> getContentSetsWithHttpInfo() throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/screener/content-sets";
    ...
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.getContentSets", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<DistinctCountResponse> getDistinctCountWithHttpInfo(DistinctCountRequest distinctCountRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/screener/distinct-count";
    ...
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.getDistinctCount", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @param contentSets The content sets from which the fields are requested. (required)
  ...
  public ApiResponse<FieldsResponse> getFieldsWithHttpInfo(java.util.List<String> contentSets) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/screener/fields";
    ...
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.getFields", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<SearchResponse> getScreenerDataWithHttpInfo(SearchRequest searchRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/screener/search";
    ...
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.getScreenerData", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<StatisticsResponse> getStatisticsWithHttpInfo(StatisticsRequest statisticsRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/screener/statistics";
    ...
    > apiResponse = apiClient.invokeAPI("ScreenerOperationsApi.getStatistics", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
