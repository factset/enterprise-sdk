...
> TradingResponse getTrading(ids)
...
import com.factset.sdk.FactSetFunds.api.TradingApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling TradingApi#getTrading");
...
> TradingResponse getTradingForList(tradingRequest)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        TradingApi apiInstance = new TradingApi(defaultClient);
        TradingRequest tradingRequest = new TradingRequest(); // TradingRequest | 
        try {
            TradingResponse result = apiInstance.getTradingForList(tradingRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling TradingApi#getTradingForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
