...
import com.factset.sdk.FactSetFunds.api.ScreenerOperationsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ScreenerOperationsApi apiInstance = new ScreenerOperationsApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling ScreenerOperationsApi#createContentSet");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ScreenerOperationsApi#deleteContentSet");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ScreenerOperationsApi#getContentSets");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ScreenerOperationsApi#getDistinctCount");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ScreenerOperationsApi apiInstance = new ScreenerOperationsApi(defaultClient);
        java.util.List<String> contentSets = Arrays.asList(); // java.util.List<String> | The content sets from which the fields are requested.
        try {
            FieldsResponse result = apiInstance.getFields(contentSets);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ScreenerOperationsApi#getFields");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **contentSets** | **List&lt;String&gt;**| The content sets from which the fields are requested. |
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ScreenerOperationsApi#getScreenerData");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ScreenerOperationsApi#getStatistics");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
