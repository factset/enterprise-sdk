package com.factset.sdk.IRNContacts;
...
import com.factset.sdk.IRNContacts.auth.Authentication;
import com.factset.sdk.IRNContacts.auth.HttpBasicAuth;
import com.factset.sdk.IRNContacts.auth.HttpBearerAuth;
import com.factset.sdk.IRNContacts.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.IRNContacts.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/IRNContacts/2.1.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.IRNContacts.ApiClient} object.
   */
