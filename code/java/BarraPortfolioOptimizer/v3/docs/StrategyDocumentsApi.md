...
import com.factset.sdk.BarraPortfolioOptimizer.model.*;
import com.factset.sdk.BarraPortfolioOptimizer.api.StrategyDocumentsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        String path = "Client:folder1/folder2"; // String | The directory to get the strategy documents and sub-directories in
        try {
