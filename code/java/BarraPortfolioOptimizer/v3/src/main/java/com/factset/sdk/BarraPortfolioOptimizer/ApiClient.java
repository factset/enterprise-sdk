...
import com.factset.sdk.BarraPortfolioOptimizer.auth.Authentication;
import com.factset.sdk.BarraPortfolioOptimizer.auth.HttpBasicAuth;
import com.factset.sdk.BarraPortfolioOptimizer.auth.HttpBearerAuth;
import com.factset.sdk.BarraPortfolioOptimizer.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.BarraPortfolioOptimizer.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/BarraPortfolioOptimizer/0.22.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.BarraPortfolioOptimizer.ApiClient} object.
   */
