package com.factset.sdk.BarraPortfolioOptimizer.api;

import com.factset.sdk.BarraPortfolioOptimizer.ApiException;
import com.factset.sdk.BarraPortfolioOptimizer.ApiClient;
import com.factset.sdk.BarraPortfolioOptimizer.ApiResponse;
...
import com.factset.sdk.BarraPortfolioOptimizer.models.BPMOptimizationParametersRoot;
import com.factset.sdk.BarraPortfolioOptimizer.models.CalculationInfoRoot;
...
public class BpmOptimizerApi {
 ...
 /**
  ...
  public ApiResponse<Void> cancelOptimizationByIdWithHttpInfo(String id) throws ApiException {
    ...
    String localVarPath = "/analytics/engines/bpm/v3/optimizations/{id}"
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("BpmOptimizerApi.cancelOptimizationById", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
   ...
   */
  public BPMOptimizationParametersRoot getOptimizationParameters(String id) throws ApiException {
   ...
   * This is the endpoint that returns the optimization parameters passed for an optimization.
   * @param id from url, provided from the location header in the Create and Run BPM optimization endpoint (required)
   * @return ApiResponse&lt;BPMOptimizationParametersRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<BPMOptimizationParametersRoot> getOptimizationParametersWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("BpmOptimizerApi.getOptimizationParameters", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @param id from url, provided from the location header in the Get BPM optimization status by id endpoint (required)
   * @return ObjectRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
  ...
  public ApiResponse<ObjectRoot> getOptimizationResultWithHttpInfo(String id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/bpm/v3/optimizations/{id}/result"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    > apiResponse = apiClient.invokeAPI("BpmOptimizerApi.getOptimizationResult", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<ObjectRoot> getOptimizationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/bpm/v3/optimizations/{id}/status"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    > apiResponse = apiClient.invokeAPI("BpmOptimizerApi.getOptimizationStatusById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public PostAndOptimizeResponseWrapper postAndOptimize(Integer xFactSetApiLongRunningDeadline, String cacheControl, BPMOptimizationParametersRoot bpMOptimizationParametersRoot) throws ApiException {
    return postAndOptimizeWithHttpInfo(xFactSetApiLongRunningDeadline, cacheControl, bpMOptimizationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<PostAndOptimizeResponseWrapper> postAndOptimizeWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, BPMOptimizationParametersRoot bpMOptimizationParametersRoot) throws ApiException {
    Object localVarPostBody = bpMOptimizationParametersRoot;
    
    // create path and map variables
    String localVarPath = "/analytics/engines/bpm/v3/optimizations";
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("BpmOptimizerApi.postAndOptimize", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public PutAndOptimizeResponseWrapper putAndOptimize(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, BPMOptimizationParametersRoot bpMOptimizationParametersRoot) throws ApiException {
    return putAndOptimizeWithHttpInfo(id, xFactSetApiLongRunningDeadline, cacheControl, bpMOptimizationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<PutAndOptimizeResponseWrapper> putAndOptimizeWithHttpInfo(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, BPMOptimizationParametersRoot bpMOptimizationParametersRoot) throws ApiException {
    Object localVarPostBody = bpMOptimizationParametersRoot;
...
if (cacheControl != null)
    ...
    > apiResponse = apiClient.invokeAPI("BpmOptimizerApi.putAndOptimize", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
