...
import com.factset.sdk.ForeignExchangeRate.models.Forward;
 ...
 */
@JsonPropertyOrder({
  ForwardsResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ForwardsResponse implements Serializable {
  ...
  public ForwardsResponse addDataItem(Forward dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of Forward Objects")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<Forward> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<Forward> data) {
    this.data = data;
  }


  /**
   * Return true if this forwardsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ForwardsResponse forwardsResponse = (ForwardsResponse) o;
    return Objects.equals(this.data, forwardsResponse.data);
  }
