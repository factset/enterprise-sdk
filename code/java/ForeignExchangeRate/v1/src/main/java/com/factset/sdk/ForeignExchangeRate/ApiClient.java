...
import com.factset.sdk.ForeignExchangeRate.auth.Authentication;
import com.factset.sdk.ForeignExchangeRate.auth.HttpBasicAuth;
import com.factset.sdk.ForeignExchangeRate.auth.HttpBearerAuth;
import com.factset.sdk.ForeignExchangeRate.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ForeignExchangeRate.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/content";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/content",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ForeignExchangeRate/2.0.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ForeignExchangeRate.ApiClient} object.
   */
