...
import com.factset.sdk.IRNCustomSymbols.auth.Authentication;
import com.factset.sdk.IRNCustomSymbols.auth.HttpBasicAuth;
import com.factset.sdk.IRNCustomSymbols.auth.HttpBearerAuth;
import com.factset.sdk.IRNCustomSymbols.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.IRNCustomSymbols.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/IRNCustomSymbols/2.1.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.IRNCustomSymbols.ApiClient} object.
   */
