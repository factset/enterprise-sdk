...
public class InlineResponse20010DataSubsamples implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.time, inlineResponse20010DataSubsamples.time) &&
        equalsNullable(this.first, inlineResponse20010DataSubsamples.first) &&
        equalsNullable(this.last, inlineResponse20010DataSubsamples.last) &&
        equalsNullable(this.low, inlineResponse20010DataSubsamples.low) &&
        equalsNullable(this.high, inlineResponse20010DataSubsamples.high) &&
        equalsNullable(this.tradingVolume, inlineResponse20010DataSubsamples.tradingVolume) &&
        equalsNullable(this.tradingValue, inlineResponse20010DataSubsamples.tradingValue);
  }
