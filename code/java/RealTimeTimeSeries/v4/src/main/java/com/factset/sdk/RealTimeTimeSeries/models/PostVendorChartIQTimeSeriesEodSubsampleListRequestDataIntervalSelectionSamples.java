...
public class PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "Mon Jan 01 00:00:00 UTC 2024", required = true, value = "Date of the end point of the subsamples (exclusive). `end` is limited to the day after the current day.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "2999", required = true, value = "Number of subsamples returned. The product of `number` and `granularity` must not extend further into the past than 1900-01-01.")
