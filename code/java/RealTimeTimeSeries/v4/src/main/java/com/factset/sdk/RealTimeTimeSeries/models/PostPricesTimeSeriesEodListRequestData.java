...
import com.factset.sdk.RealTimeTimeSeries.models.PostPricesTimeSeriesEodListRequestDataRange;
...
@JsonPropertyOrder({
  PostPricesTimeSeriesEodListRequestData.JSON_PROPERTY_IDENTIFIER,
  PostPricesTimeSeriesEodListRequestData.JSON_PROPERTY_TYPE,
  PostPricesTimeSeriesEodListRequestData.JSON_PROPERTY_QUALITY,
  PostPricesTimeSeriesEodListRequestData.JSON_PROPERTY_RANGE,
  PostPricesTimeSeriesEodListRequestData.JSON_PROPERTY_NEWEST_FIRST,
  PostPricesTimeSeriesEodListRequestData.JSON_PROPERTY_ADJUSTMENTS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostPricesTimeSeriesEodListRequestData implements Serializable {
  ...
  private PostPricesTimeSeriesEodListRequestDataRange range;
  ...
  public PostPricesTimeSeriesEodListRequestData() { 
  }
  ...
  public PostPricesTimeSeriesEodListRequestData(
    ...
    @JsonProperty(value=JSON_PROPERTY_RANGE, required=true) PostPricesTimeSeriesEodListRequestDataRange range
  ) {
    this();
  ...
  public PostPricesTimeSeriesEodListRequestData identifier(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier) {
    this.identifier = identifier;
    return this;
  }
  ...
  **/
  ...
  public PostPricesTimeSeriesEodListRequestData type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public PostPricesTimeSeriesEodListRequestData quality(QualityEnum quality) {
  ...
  **/
  ...
  public PostPricesTimeSeriesEodListRequestData range(PostPricesTimeSeriesEodListRequestDataRange range) {
    this.range = range;
    return this;
  }
  ...
  **/
  ...
  public PostPricesTimeSeriesEodListRequestDataRange getRange() {
    return range;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RANGE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRange(PostPricesTimeSeriesEodListRequestDataRange range) {
    this.range = range;
  }


  public PostPricesTimeSeriesEodListRequestData newestFirst(Boolean newestFirst) {
  ...
  **/
  ...
  public PostPricesTimeSeriesEodListRequestData adjustments(PostVendorChartIQTimeSeriesEodListRequestDataAdjustments adjustments) {
  ...
  **/
  ...
  /**
   * Return true if this PostPricesTimeSeriesEodListRequest_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostPricesTimeSeriesEodListRequestData postPricesTimeSeriesEodListRequestData = (PostPricesTimeSeriesEodListRequestData) o;
    return Objects.equals(this.identifier, postPricesTimeSeriesEodListRequestData.identifier) &&
        Objects.equals(this.type, postPricesTimeSeriesEodListRequestData.type) &&
        Objects.equals(this.quality, postPricesTimeSeriesEodListRequestData.quality) &&
        Objects.equals(this.range, postPricesTimeSeriesEodListRequestData.range) &&
        Objects.equals(this.newestFirst, postPricesTimeSeriesEodListRequestData.newestFirst) &&
        Objects.equals(this.adjustments, postPricesTimeSeriesEodListRequestData.adjustments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, type, quality, range, newestFirst, adjustments);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostPricesTimeSeriesEodListRequestData {\n");
