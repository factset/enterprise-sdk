...
import com.factset.sdk.RealTimeTimeSeries.models.PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval;
...
@JsonPropertyOrder({
  PostVendorChartIQTimeSeriesEodSubsampleGetRequestData.JSON_PROPERTY_IDENTIFIER,
  PostVendorChartIQTimeSeriesEodSubsampleGetRequestData.JSON_PROPERTY_TYPE,
  PostVendorChartIQTimeSeriesEodSubsampleGetRequestData.JSON_PROPERTY_QUALITY,
...
public class PostVendorChartIQTimeSeriesEodSubsampleGetRequestData implements Serializable {
  ...
  private PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval interval;
  ...
  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestData(
    ...
    @JsonProperty(value=JSON_PROPERTY_INTERVAL, required=true) PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval interval
  ) {
    this();
  ...
  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestData identifier(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier) {
    this.identifier = identifier;
    return this;
  }
  ...
  **/
  ...
  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestData type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestData quality(QualityEnum quality) {
  ...
  **/
  ...
  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestData interval(PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval interval) {
    this.interval = interval;
    return this;
  }
  ...
  **/
  ...
  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval getInterval() {
    return interval;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INTERVAL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInterval(PostVendorChartIQTimeSeriesEodSubsampleGetRequestDataInterval interval) {
    this.interval = interval;
  }


  public PostVendorChartIQTimeSeriesEodSubsampleGetRequestData adjustments(PostVendorChartIQTimeSeriesEodListRequestDataAdjustments adjustments) {
  ...
  **/
  ...
  /**
   * Return true if this PostVendorChartIQTimeSeriesEodSubsampleGetRequest_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostVendorChartIQTimeSeriesEodSubsampleGetRequestData postVendorChartIQTimeSeriesEodSubsampleGetRequestData = (PostVendorChartIQTimeSeriesEodSubsampleGetRequestData) o;
    return Objects.equals(this.identifier, postVendorChartIQTimeSeriesEodSubsampleGetRequestData.identifier) &&
        Objects.equals(this.type, postVendorChartIQTimeSeriesEodSubsampleGetRequestData.type) &&
        Objects.equals(this.quality, postVendorChartIQTimeSeriesEodSubsampleGetRequestData.quality) &&
        Objects.equals(this.interval, postVendorChartIQTimeSeriesEodSubsampleGetRequestData.interval) &&
        Objects.equals(this.adjustments, postVendorChartIQTimeSeriesEodSubsampleGetRequestData.adjustments);
  }
