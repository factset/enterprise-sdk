...
@JsonPropertyOrder({
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_TIME,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_FIRST,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_LAST,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_LOW,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_HIGH,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_TRADING_VOLUME,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_TRADING_VALUE,
  PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.JSON_PROPERTY_VOLUME_WEIGHTED_AVERAGE_PRICE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems implements Serializable {
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems() { 
  }

  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems time(OffsetDateTime time) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2024-01-01T00:00Z", value = "Date and time of the start of the subsample.")
  @JsonIgnore
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems first(BigDecimal first) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "3.03", value = "First price of the subsample.")
  @JsonIgnore
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems last(BigDecimal last) {
  ...
  **/
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems low(BigDecimal low) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "5.05", value = "Lowest price of the subsample.")
  @JsonIgnore
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems high(BigDecimal high) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "5.05", value = "Highest price of the subsample.")
  @JsonIgnore
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems tradingVolume(BigDecimal tradingVolume) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "1.01", value = "Accumulated number of units (e.g. shares) traded of the subsample. If the requested type of the price is ask, bid, or yield, the value is empty.")
  @JsonIgnore
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems tradingValue(BigDecimal tradingValue) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "4.04", value = "Accumulated monetary equivalent (cash value) of the subsample. If the requested type of the price is ask, bid, or yield, the value is empty. See attribute `currency` in endpoint `/prices/get` for its unit.")
  @JsonIgnore
  ...
  public PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems volumeWeightedAveragePrice(BigDecimal volumeWeightedAveragePrice) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2.02", value = "The volume-weighted average price (VWAP) of the subsample. See attribute currency in endpoint `/prices/get` for its unit.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems = (PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems) o;
    return equalsNullable(this.time, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.time) &&
        equalsNullable(this.first, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.first) &&
        equalsNullable(this.last, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.last) &&
        equalsNullable(this.low, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.low) &&
        equalsNullable(this.high, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.high) &&
        equalsNullable(this.tradingVolume, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.tradingVolume) &&
        equalsNullable(this.tradingValue, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.tradingValue) &&
        equalsNullable(this.volumeWeightedAveragePrice, postPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems.volumeWeightedAveragePrice);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(time), hashCodeNullable(first), hashCodeNullable(last), hashCodeNullable(low), hashCodeNullable(high), hashCodeNullable(tradingVolume), hashCodeNullable(tradingValue), hashCodeNullable(volumeWeightedAveragePrice));
  }
  ...
  public String toString() {
    ...
    sb.append("class PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems {\n");
