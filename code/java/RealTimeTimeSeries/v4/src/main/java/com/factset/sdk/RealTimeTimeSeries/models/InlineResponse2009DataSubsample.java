...
public class InlineResponse2009DataSubsample implements Serializable {
  ...
  public InlineResponse2009DataSubsample time(OffsetDateTime time) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "4.04", value = "First price of the subsample.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "5.05", value = "Accumulated number of units (e.g. shares) traded of the subsample. If the requested type of the price is ask, bid, or yield, the value is empty.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "3.03", value = "Accumulated monetary equivalent (cash value) of the subsample. If the requested type of the price is ask, bid, or yield, the value is empty. See attribute `currency` in endpoint `/prices/get` for its unit.")
  @JsonIgnore
