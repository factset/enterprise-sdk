...
import com.factset.sdk.RealTimeTimeSeries.models.InlineResponse2005DataRange;
import com.factset.sdk.RealTimeTimeSeries.models.PostPricesTimeSeriesEodListDataPricesItems;
...
public class InlineResponse2005Data implements Serializable {
  ...
  private JsonNullable<InlineResponse2005DataRange> range = JsonNullable.<InlineResponse2005DataRange>undefined();
  ...
  private java.util.List<PostPricesTimeSeriesEodListDataPricesItems> prices = null;
  ...
  **/
  ...
  public InlineResponse2005Data range(InlineResponse2005DataRange range) {
    this.range = JsonNullable.<InlineResponse2005DataRange>of(range);
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2005DataRange getRange() {
  ...
  public JsonNullable<InlineResponse2005DataRange> getRange_JsonNullable() {
    return range;
  }
  
  @JsonProperty(JSON_PROPERTY_RANGE)
  public void setRange_JsonNullable(JsonNullable<InlineResponse2005DataRange> range) {
    this.range = range;
  }

  public void setRange(InlineResponse2005DataRange range) {
    this.range = JsonNullable.<InlineResponse2005DataRange>of(range);
  }
  ...
  **/
  ...
  public InlineResponse2005Data prices(java.util.List<PostPricesTimeSeriesEodListDataPricesItems> prices) {
    this.prices = prices;
    return this;
  }

  public InlineResponse2005Data addPricesItem(PostPricesTimeSeriesEodListDataPricesItems pricesItem) {
    if (this.prices == null) {
  ...
  **/
  ...
  public java.util.List<PostPricesTimeSeriesEodListDataPricesItems> getPrices() {
    return prices;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PRICES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrices(java.util.List<PostPricesTimeSeriesEodListDataPricesItems> prices) {
    this.prices = prices;
  }
