...
import com.factset.sdk.RealTimeTimeSeries.models.PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems;
...
public class InlineResponse2007Data implements Serializable {
  ...
  private java.util.List<PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems> subsamples = null;
  ...
  **/
  ...
  public InlineResponse2007Data subsamples(java.util.List<PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems> subsamples) {
    this.subsamples = subsamples;
    return this;
  }

  public InlineResponse2007Data addSubsamplesItem(PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems subsamplesItem) {
  ...
  **/
  ...
  public java.util.List<PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems> getSubsamples() {
    return subsamples;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBSAMPLES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubsamples(java.util.List<PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems> subsamples) {
    this.subsamples = subsamples;
  }
