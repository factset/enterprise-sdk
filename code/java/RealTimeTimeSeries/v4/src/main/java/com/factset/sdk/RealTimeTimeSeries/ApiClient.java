...
import com.factset.sdk.RealTimeTimeSeries.auth.Authentication;
import com.factset.sdk.RealTimeTimeSeries.auth.HttpBasicAuth;
import com.factset.sdk.RealTimeTimeSeries.auth.HttpBearerAuth;
import com.factset.sdk.RealTimeTimeSeries.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.RealTimeTimeSeries.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/RealTimeTimeSeries/0.20.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.RealTimeTimeSeries.ApiClient} object.
   */
