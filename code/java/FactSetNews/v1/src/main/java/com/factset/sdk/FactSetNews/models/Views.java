...
import com.factset.sdk.FactSetNews.models.ViewsObject;
 ...
 * FactSet News views
 */
@ApiModel(description = "FactSet News views")
@JsonPropertyOrder({
  Views.JSON_PROPERTY_DATA
})
...
public class Views implements Serializable {
  ...
  private java.util.List<ViewsObject> data = null;

  public Views() { 
  }

  public Views data(java.util.List<ViewsObject> data) {
    this.data = data;
    return this;
  }

  public Views addDataItem(ViewsObject dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<ViewsObject> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<ViewsObject> data) {
    this.data = data;
  }


  /**
   * Return true if this Views object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Views views = (Views) o;
    return Objects.equals(this.data, views.data);
  }
