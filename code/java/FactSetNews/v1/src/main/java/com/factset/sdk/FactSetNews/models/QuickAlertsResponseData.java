 ...
 */
@JsonPropertyOrder({
  QuickAlertsResponseData.JSON_PROPERTY_NAME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class QuickAlertsResponseData implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_NAME = "name";
  private String name;

  public QuickAlertsResponseData() { 
  }

  public QuickAlertsResponseData name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "FactSet News", value = "The name of the view associated with quick alerts.")
  ...
  /**
   * Return true if this QuickAlertsResponse_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    QuickAlertsResponseData quickAlertsResponseData = (QuickAlertsResponseData) o;
    return Objects.equals(this.name, quickAlertsResponseData.name);
  }
