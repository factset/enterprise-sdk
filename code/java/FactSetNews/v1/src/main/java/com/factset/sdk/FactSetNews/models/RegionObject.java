 ...
 */
@JsonPropertyOrder({
  RegionObject.JSON_PROPERTY_NAME,
  RegionObject.JSON_PROPERTY_VALUE
})
...
public class RegionObject implements Serializable {
  ...
  public RegionObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "Algeria", value = "The name of the region.")
  ...
  public RegionObject value(java.util.List<String> value) {
    this.value = value;
    return this;
  }

  public RegionObject addValueItem(String valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  /**
   * Return true if this RegionObject object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RegionObject regionObject = (RegionObject) o;
    return Objects.equals(this.name, regionObject.name) &&
        Objects.equals(this.value, regionObject.value);
  }
