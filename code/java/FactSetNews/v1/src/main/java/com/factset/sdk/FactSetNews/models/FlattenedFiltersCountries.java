 ...
 */
@ApiModel(description = "Flattened Filters Countries Object")
@JsonPropertyOrder({
  FlattenedFiltersCountries.JSON_PROPERTY_COUNTRIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class FlattenedFiltersCountries implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_COUNTRIES = "countries";
  private java.util.List<FlattenedFiltersCountriesObject> countries = null;

  public FlattenedFiltersCountries() { 
  }

  public FlattenedFiltersCountries countries(java.util.List<FlattenedFiltersCountriesObject> countries) {
    this.countries = countries;
    return this;
  }

  public FlattenedFiltersCountries addCountriesItem(FlattenedFiltersCountriesObject countriesItem) {
  ...
  **/
  ...
  /**
   * Return true if this FlattenedFiltersCountries object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FlattenedFiltersCountries flattenedFiltersCountries = (FlattenedFiltersCountries) o;
    return Objects.equals(this.countries, flattenedFiltersCountries.countries);
  }
