...
@JsonDeserialize(using = StringOrNumberTagValue.StringOrNumberTagValueDeserializer.class)
@JsonSerialize(using = StringOrNumberTagValue.StringOrNumberTagValueSerializer.class)
public class StringOrNumberTagValue extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(StringOrNumberTagValue.class.getName());

    public static class StringOrNumberTagValueSerializer extends StdSerializer<StringOrNumberTagValue> {
        public StringOrNumberTagValueSerializer(Class<StringOrNumberTagValue> t) {
            super(t);
        }

        public StringOrNumberTagValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(StringOrNumberTagValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class StringOrNumberTagValueDeserializer extends StdDeserializer<StringOrNumberTagValue> {
        public StringOrNumberTagValueDeserializer() {
            this(StringOrNumberTagValue.class);
        }

        public StringOrNumberTagValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public StringOrNumberTagValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                StringOrNumberTagValue ret = new StringOrNumberTagValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for StringOrNumberTagValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public StringOrNumberTagValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "StringOrNumberTagValue cannot be null");
        }
    }
    ...
    public StringOrNumberTagValue() {
        super("oneOf", Boolean.FALSE);
    }

    public StringOrNumberTagValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public StringOrNumberTagValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(StringOrNumberTagValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return StringOrNumberTagValue.schemas;
    }
