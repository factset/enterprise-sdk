 ...
 */
@ApiModel(description = "Response object for a single tag")
@JsonPropertyOrder({
  TagResponse.JSON_PROPERTY_DATA
})
...
public class TagResponse implements Serializable {
  ...
  public TagResponse data(TagModel data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(TagModel data) {
    this.data = data;
  }


  /**
   * Return true if this TagResponse object is equal to o.
   */
  @Override
