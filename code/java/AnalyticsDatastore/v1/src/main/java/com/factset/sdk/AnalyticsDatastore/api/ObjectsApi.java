...
public class ObjectsApi {
   ...
   */
  public void getCargoEndpoint(String groupId, String objectId) throws ApiException {
   ...
   */
  public ApiResponse<Void> getCargoEndpointWithHttpInfo(String groupId, String objectId) throws ApiException {
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("ObjectsApi.getCargoEndpoint", localVarPath, "GET", localVarQueryParams, localVarPostBody,
