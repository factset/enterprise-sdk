...
public class QuantCalculationParametersRoot implements Serializable {
  ...
  private JsonNullable<java.util.Map<String, QuantCalculationParameters>> data = JsonNullable.<java.util.Map<String, QuantCalculationParameters>>undefined();
  ...
  public QuantCalculationParametersRoot data(java.util.Map<String, QuantCalculationParameters> data) {
    this.data = JsonNullable.<java.util.Map<String, QuantCalculationParameters>>of(data);
    return this;
  }
  ...
  public QuantCalculationParametersRoot putDataItem(String key, QuantCalculationParameters dataItem) {
    if (this.data == null || !this.data.isPresent()) {
      this.data = JsonNullable.<java.util.Map<String, QuantCalculationParameters>>of(new java.util.HashMap<>());
    }
    try {
  ...
  **/
  ...
  public JsonNullable<java.util.Map<String, QuantCalculationParameters>> getData_JsonNullable() {
    return data;
  }
  
  @JsonProperty(JSON_PROPERTY_DATA)
  public void setData_JsonNullable(JsonNullable<java.util.Map<String, QuantCalculationParameters>> data) {
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.data, quantCalculationParametersRoot.data) &&
