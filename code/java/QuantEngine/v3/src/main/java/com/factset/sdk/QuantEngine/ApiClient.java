...
import com.factset.sdk.QuantEngine.auth.Authentication;
import com.factset.sdk.QuantEngine.auth.HttpBasicAuth;
import com.factset.sdk.QuantEngine.auth.HttpBearerAuth;
import com.factset.sdk.QuantEngine.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.QuantEngine.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/engines/quant/v3";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/analytics/engines/quant/v3",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/QuantEngine/2.1.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.QuantEngine.ApiClient} object.
   */
