package com.factset.sdk.QuantEngine.api;

import com.factset.sdk.QuantEngine.ApiException;
import com.factset.sdk.QuantEngine.ApiClient;
import com.factset.sdk.QuantEngine.ApiResponse;
...
import com.factset.sdk.QuantEngine.models.CalculationStatusRoot;
import com.factset.sdk.QuantEngine.models.CalculationsSummaryRoot;
import com.factset.sdk.QuantEngine.models.ClientErrorResponse;
import java.io.File;
...
public class QuantCalculationsApi {
 ...
 /**
   ...
   * @param id from url, provided from the location header in the Create and Run Quant calculation endpoint (required)
  ...
  public ApiResponse<Void> cancelCalculationByIdWithHttpInfo(String id) throws ApiException {
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.cancelCalculationById", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<CalculationsSummaryRoot> getAllCalculationsWithHttpInfo(Integer pageNumber) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.getAllCalculations", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Expected response, returns the Quant Engine calculation parameters. </td><td>  * Content-Encoding - Standard HTTP header. Header value based on Accept-Encoding Request header. <br>  * Content-Type - Standard HTTP header. <br>  * Transfer-Encoding - Standard HTTP header. Header value will be set to Chunked if Accept-Encoding header is specified. <br>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 400 </td><td> Invalid identifier provided. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 401 </td><td> Missing or invalid authentication. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  </td></tr>
       <tr><td> 403 </td><td> User is forbidden with current credentials </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
  ...
  public ApiResponse<QuantCalculationParametersRoot> getCalculationParametersWithHttpInfo(String id) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.getCalculationParameters", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<CalculationStatusRoot> getCalculationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.getCalculationStatusById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<File> getCalculationUnitInfoByIdWithHttpInfo(String id, String unitId) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getCalculationUnitInfoById");
    }
    
    // verify the required parameter 'unitId' is set
    if (unitId == null) {
      throw new ApiException(400, "Missing the required parameter 'unitId' when calling getCalculationUnitInfoById");
    }
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.getCalculationUnitInfoById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getCalculationUnitInfoByIdResponseTypeMap, false);
  ...
  public ApiResponse<File> getCalculationUnitResultByIdWithHttpInfo(String id, String unitId) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.getCalculationUnitResultById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public PostAndCalculateResponseWrapper postAndCalculate(String cacheControl, QuantCalculationParametersRoot quantCalculationParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<PostAndCalculateResponseWrapper> postAndCalculateWithHttpInfo(String cacheControl, QuantCalculationParametersRoot quantCalculationParametersRoot) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.postAndCalculate", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public PutAndCalculateResponseWrapper putAndCalculate(String id, String cacheControl, QuantCalculationParametersRoot quantCalculationParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<PutAndCalculateResponseWrapper> putAndCalculateWithHttpInfo(String id, String cacheControl, QuantCalculationParametersRoot quantCalculationParametersRoot) throws ApiException {
    Object localVarPostBody = quantCalculationParametersRoot;
    ...
    > apiResponse = apiClient.invokeAPI("QuantCalculationsApi.putAndCalculate", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
