...
import com.factset.sdk.OffPlatformIntegrations.auth.Authentication;
import com.factset.sdk.OffPlatformIntegrations.auth.HttpBasicAuth;
import com.factset.sdk.OffPlatformIntegrations.auth.HttpBearerAuth;
import com.factset.sdk.OffPlatformIntegrations.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.OffPlatformIntegrations.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/services/off-platform-integrations-api/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/services/off-platform-integrations-api/v1",
      "Production Server",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/OffPlatformIntegrations/0.1.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.OffPlatformIntegrations.ApiClient} object.
   */
