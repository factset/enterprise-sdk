package com.factset.sdk.ContentFeedsDataDictionary;
...
import com.factset.sdk.ContentFeedsDataDictionary.auth.Authentication;
import com.factset.sdk.ContentFeedsDataDictionary.auth.HttpBasicAuth;
import com.factset.sdk.ContentFeedsDataDictionary.auth.HttpBearerAuth;
import com.factset.sdk.ContentFeedsDataDictionary.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ContentFeedsDataDictionary.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/data-dictionary";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/data-dictionary",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ContentFeedsDataDictionary/0.22.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ContentFeedsDataDictionary.ApiClient} object.
   */
