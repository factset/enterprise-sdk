...
import com.factset.sdk.CapitalStructureReportBuilder.models.ErrorObject;
 ...
 */
@ApiModel(description = "A response indicating that there were one or more errors with the requests.")
@JsonPropertyOrder({
...
public class ErrorResponse implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "Errors which may have occurred during the request")
