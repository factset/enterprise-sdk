...
import com.factset.sdk.CapitalStructureReportBuilder.models.CategoryCategory;
import com.factset.sdk.CapitalStructureReportBuilder.models.CurrencyCode;
import com.factset.sdk.CapitalStructureReportBuilder.models.CurrencyCodeCurrencyCode;
import com.factset.sdk.CapitalStructureReportBuilder.models.CurrencySymbol;
import com.factset.sdk.CapitalStructureReportBuilder.models.CurrencySymbolCurrencySymbol;
import com.factset.sdk.CapitalStructureReportBuilder.models.Description;
import com.factset.sdk.CapitalStructureReportBuilder.models.DescriptionDescription;
...
import com.factset.sdk.CapitalStructureReportBuilder.models.ScaleScale;
...
public class MetadataEntry extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class MetadataEntryDeserializer extends StdDeserializer<MetadataEntry> {
        ...
        public MetadataEntry deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize InterimStatus
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (InterimStatus.class.equals(Integer.class) || InterimStatus.class.equals(Long.class) || InterimStatus.class.equals(Float.class) || InterimStatus.class.equals(Double.class) || InterimStatus.class.equals(Boolean.class) || InterimStatus.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((InterimStatus.class.equals(Integer.class) || InterimStatus.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((InterimStatus.class.equals(Float.class) || InterimStatus.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (InterimStatus.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (InterimStatus.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<InterimStatus>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'InterimStatus'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'InterimStatus'", e);
            }
    ...
    public MetadataEntry(InterimStatus o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    static {
        ...
        schemas.put("InterimStatus", new GenericType<InterimStatus>() {
        });
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, InterimStatus, Scale, ValueType
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        // InterimStatus
        if (JSON.isInstanceOf(InterimStatus.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Category, CurrencyCode, CurrencySymbol, Description, Frequency, InterimStatus, Scale, ValueType");
    }
     ...
     * Category, CurrencyCode, CurrencySymbol, Description, Frequency, InterimStatus, Scale, ValueType
     *
     * @return The actual instance (Category, CurrencyCode, CurrencySymbol, Description, Frequency, InterimStatus, Scale, ValueType)
     */
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `InterimStatus`
     * @throws ClassCastException if the instance is not `InterimStatus`
     */
    public InterimStatus getInterimStatus() throws ClassCastException {
        return (InterimStatus)super.getActualInstance();
    }
