package com.factset.sdk.CapitalStructureReportBuilder;
...
import com.factset.sdk.CapitalStructureReportBuilder.auth.Authentication;
import com.factset.sdk.CapitalStructureReportBuilder.auth.HttpBasicAuth;
import com.factset.sdk.CapitalStructureReportBuilder.auth.HttpBearerAuth;
import com.factset.sdk.CapitalStructureReportBuilder.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.CapitalStructureReportBuilder.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/report/capital/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/report/capital/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/CapitalStructureReportBuilder/2.0.4 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.CapitalStructureReportBuilder.ApiClient} object.
   */
