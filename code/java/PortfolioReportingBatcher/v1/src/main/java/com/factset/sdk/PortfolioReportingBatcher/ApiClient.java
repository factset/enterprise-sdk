...
import com.factset.sdk.PortfolioReportingBatcher.auth.Authentication;
import com.factset.sdk.PortfolioReportingBatcher.auth.HttpBasicAuth;
import com.factset.sdk.PortfolioReportingBatcher.auth.HttpBearerAuth;
import com.factset.sdk.PortfolioReportingBatcher.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.PortfolioReportingBatcher.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/prb/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/analytics/prb/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/PortfolioReportingBatcher/0.25.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.PortfolioReportingBatcher.ApiClient} object.
   */
