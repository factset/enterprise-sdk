...
public class JobsApi {
  ...
  private static final Map<Integer, GenericType> v1GetDetailsForJobResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    v1GetDetailsForJobResponseTypeMap.put(200, new GenericType<JobDetailsResponse>(){});
    v1GetDetailsForJobResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    v1GetDetailsForJobResponseTypeMap.put(404, new GenericType<ClientErrorResponse>(){});
    v1GetDetailsForJobResponseTypeMap.put(429, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> v1GetPrbJobsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    v1GetPrbJobsResponseTypeMap.put(200, new GenericType<JobListResponse>(){});
    v1GetPrbJobsResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
  }
   ...
   */
  public JobDetailsResponse v1GetDetailsForJob(JobTypes type, String name, java.util.List<String> attribute) throws ApiException {
    return v1GetDetailsForJobWithHttpInfo(type, name, attribute).getData();
  }
   ...
   */
  public ApiResponse<JobDetailsResponse> v1GetDetailsForJobWithHttpInfo(JobTypes type, String name, java.util.List<String> attribute) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(400, "Missing the required parameter 'type' when calling v1GetDetailsForJob");
    }
    
    // verify the required parameter 'name' is set
    if (name == null) {
      throw new ApiException(400, "Missing the required parameter 'name' when calling v1GetDetailsForJob");
    }
    ...
    > apiResponse = apiClient.invokeAPI("JobsApi.v1GetDetailsForJob", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, v1GetDetailsForJobResponseTypeMap, false);
   ...
   */
  public JobListResponse v1GetPrbJobs(JobTypes type, String name, Integer paginationOffset, Integer paginationLimit) throws ApiException {
    return v1GetPrbJobsWithHttpInfo(type, name, paginationOffset, paginationLimit).getData();
  }
   ...
   */
  public ApiResponse<JobListResponse> v1GetPrbJobsWithHttpInfo(JobTypes type, String name, Integer paginationOffset, Integer paginationLimit) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("JobsApi.v1GetPrbJobs", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, v1GetPrbJobsResponseTypeMap, false);
