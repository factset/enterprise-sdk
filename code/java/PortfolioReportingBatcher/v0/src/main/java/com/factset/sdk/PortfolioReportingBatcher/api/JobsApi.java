...
import com.factset.sdk.PortfolioReportingBatcher.models.JobListResponse;
...
public class JobsApi {
  ...
  private static final Map<Integer, GenericType> getPrbJobsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getPrbJobsResponseTypeMap.put(200, new GenericType<JobListResponse>(){});
    getPrbJobsResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
  }
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 400 </td><td> Invalid input parameters. </td><td>  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-FactSet-Api-RateLimit-Limit -  <br>  * X-FactSet-Api-RateLimit-Remaining -  <br>  * X-FactSet-Api-RateLimit-Reset -  <br>  </td></tr>
   ...
   * @param name The job name (optional)
   * @param paginationOffset The number of jobs to skip (please note the jobs are ordered by last modified in descending order, i.e. most recently modified will show on the (optional)
   * @param paginationLimit The number of jobs to bring back (maximum 50) (optional)
   ...
   */
  public JobListResponse getPrbJobs(JobTypes type, String name, Integer paginationOffset, Integer paginationLimit) throws ApiException {
    return getPrbJobsWithHttpInfo(type, name, paginationOffset, paginationLimit).getData();
  }
   ...
   */
  public ApiResponse<JobListResponse> getPrbJobsWithHttpInfo(JobTypes type, String name, Integer paginationOffset, Integer paginationLimit) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("JobsApi.getPrbJobs", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getPrbJobsResponseTypeMap, false);
