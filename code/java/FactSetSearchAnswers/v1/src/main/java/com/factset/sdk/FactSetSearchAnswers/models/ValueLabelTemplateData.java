...
import com.factset.sdk.FactSetSearchAnswers.models.ValueLabelTemplateDataAllOf;
 ...
 */
@JsonPropertyOrder({
  ValueLabelTemplateData.JSON_PROPERTY_HEADLINE,
  ValueLabelTemplateData.JSON_PROPERTY_FOOTER,
  ValueLabelTemplateData.JSON_PROPERTY_FDC3_CONTEXT,
  ValueLabelTemplateData.JSON_PROPERTY_APPLICATION_LINKS,
  ValueLabelTemplateData.JSON_PROPERTY_VALUE,
  ValueLabelTemplateData.JSON_PROPERTY_LABEL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ValueLabelTemplateData implements Serializable {
  ...
  public ValueLabelTemplateData headline(String headline) {
    this.headline = headline;
    return this;
  }
  ...
  **/
  ...
  public ValueLabelTemplateData footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  **/
  ...
  public ValueLabelTemplateData fdc3Context(Fdc3Context fdc3Context) {
  ...
  **/
  ...
  public ValueLabelTemplateData applicationLinks(java.util.List<ApplicationLink> applicationLinks) {
    this.applicationLinks = applicationLinks;
    return this;
  }

  public ValueLabelTemplateData addApplicationLinksItem(ApplicationLink applicationLinksItem) {
  ...
  **/
  ...
  public ValueLabelTemplateData value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public ValueLabelTemplateData label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ValueLabelTemplateData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ValueLabelTemplateData valueLabelTemplateData = (ValueLabelTemplateData) o;
    return Objects.equals(this.headline, valueLabelTemplateData.headline) &&
        Objects.equals(this.footer, valueLabelTemplateData.footer) &&
        Objects.equals(this.fdc3Context, valueLabelTemplateData.fdc3Context) &&
        Objects.equals(this.applicationLinks, valueLabelTemplateData.applicationLinks) &&
        Objects.equals(this.value, valueLabelTemplateData.value) &&
        Objects.equals(this.label, valueLabelTemplateData.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValueLabelTemplateData {\n");
