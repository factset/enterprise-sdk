...
import com.factset.sdk.FactSetSearchAnswers.models.PercentChangeLabelTemplateDataAllOf;
 ...
 */
@JsonPropertyOrder({
  PercentChangeLabelTemplateData.JSON_PROPERTY_HEADLINE,
  PercentChangeLabelTemplateData.JSON_PROPERTY_FOOTER,
  PercentChangeLabelTemplateData.JSON_PROPERTY_FDC3_CONTEXT,
  PercentChangeLabelTemplateData.JSON_PROPERTY_APPLICATION_LINKS,
...
public class PercentChangeLabelTemplateData implements Serializable {
  ...
  public PercentChangeLabelTemplateData() { 
  }
  ...
  public PercentChangeLabelTemplateData headline(String headline) {
    this.headline = headline;
    return this;
  }
  ...
  **/
  ...
  public PercentChangeLabelTemplateData footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  **/
  ...
  public PercentChangeLabelTemplateData fdc3Context(Fdc3Context fdc3Context) {
  ...
  **/
  ...
  public PercentChangeLabelTemplateData applicationLinks(java.util.List<ApplicationLink> applicationLinks) {
    this.applicationLinks = applicationLinks;
    return this;
  }

  public PercentChangeLabelTemplateData addApplicationLinksItem(ApplicationLink applicationLinksItem) {
  ...
  **/
  ...
  public PercentChangeLabelTemplateData percentChange(PercentChange percentChange) {
  ...
  **/
  ...
  public PercentChangeLabelTemplateData label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this PercentChangeLabelTemplateData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PercentChangeLabelTemplateData percentChangeLabelTemplateData = (PercentChangeLabelTemplateData) o;
    return Objects.equals(this.headline, percentChangeLabelTemplateData.headline) &&
        Objects.equals(this.footer, percentChangeLabelTemplateData.footer) &&
        Objects.equals(this.fdc3Context, percentChangeLabelTemplateData.fdc3Context) &&
        Objects.equals(this.applicationLinks, percentChangeLabelTemplateData.applicationLinks) &&
        Objects.equals(this.percentChange, percentChangeLabelTemplateData.percentChange) &&
        Objects.equals(this.label, percentChangeLabelTemplateData.label);
  }

  @Override
  public int hashCode() {
    return Objects.hash(headline, footer, fdc3Context, applicationLinks, percentChange, label);
  }
