...
import com.factset.sdk.FactSetSearchAnswers.models.ValueLabelDateDataPairListTemplateAllOf;
...
@JsonPropertyOrder({
  ...
  ValueLabelDateDataPairListTemplate.JSON_PROPERTY_APPLICATION_LINKS,
  ValueLabelDateDataPairListTemplate.JSON_PROPERTY_VALUE,
  ValueLabelDateDataPairListTemplate.JSON_PROPERTY_LABEL,
  ValueLabelDateDataPairListTemplate.JSON_PROPERTY_DATE,
  ValueLabelDateDataPairListTemplate.JSON_PROPERTY_LIST
})
...
public class ValueLabelDateDataPairListTemplate implements Serializable {
  ...
  **/
  ...
  public ValueLabelDateDataPairListTemplate footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  **/
  ...
  public ValueLabelDateDataPairListTemplate fdc3Context(Fdc3Context fdc3Context) {
  ...
  **/
  ...
  public ValueLabelDateDataPairListTemplate applicationLinks(java.util.List<ApplicationLink> applicationLinks) {
    this.applicationLinks = applicationLinks;
    return this;
  }

  public ValueLabelDateDataPairListTemplate addApplicationLinksItem(ApplicationLink applicationLinksItem) {
  ...
  **/
  ...
  public ValueLabelDateDataPairListTemplate value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public ValueLabelDateDataPairListTemplate label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public ValueLabelDateDataPairListTemplate date(String date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ValueLabelDateDataPairListTemplate object is equal to o.
   */
  @Override
