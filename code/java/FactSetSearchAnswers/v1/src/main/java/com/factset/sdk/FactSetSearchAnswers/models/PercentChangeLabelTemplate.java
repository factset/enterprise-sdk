...
public class PercentChangeLabelTemplate implements Serializable {
  ...
  **/
  ...
  public PercentChangeLabelTemplate footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  **/
  ...
  public PercentChangeLabelTemplate fdc3Context(Fdc3Context fdc3Context) {
  ...
  **/
  ...
  public PercentChangeLabelTemplate label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this PercentChangeLabelTemplate object is equal to o.
   */
  @Override
