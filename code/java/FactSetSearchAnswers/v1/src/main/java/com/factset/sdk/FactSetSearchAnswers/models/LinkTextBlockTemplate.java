...
import com.factset.sdk.FactSetSearchAnswers.models.LinkTextBlockTemplateAllOf;
...
public class LinkTextBlockTemplate implements Serializable {
  ...
  **/
  ...
  public LinkTextBlockTemplate footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  **/
  ...
  public LinkTextBlockTemplate fdc3Context(Fdc3Context fdc3Context) {
  ...
  **/
  ...
  public LinkTextBlockTemplate applicationLinks(java.util.List<ApplicationLink> applicationLinks) {
    this.applicationLinks = applicationLinks;
    return this;
  }

  public LinkTextBlockTemplate addApplicationLinksItem(ApplicationLink applicationLinksItem) {
  ...
  **/
  ...
  public LinkTextBlockTemplate link(String link) {
    this.link = link;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this LinkTextBlockTemplate object is equal to o.
   */
  @Override
