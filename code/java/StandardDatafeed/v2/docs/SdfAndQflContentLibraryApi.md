...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String endDate = "2023-01-28T00:00:00.000Z"; // String | The latest date of the feed file the API should fetch for based on the file timestamp.  - Format: Should be absolute - YYYY-MM-DD. 
