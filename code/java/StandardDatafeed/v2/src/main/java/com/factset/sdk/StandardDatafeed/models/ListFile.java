...
import com.factset.sdk.StandardDatafeed.models.ListFileObject;
 ...
 * List Files Object
 */
@ApiModel(description = "List Files Object")
@JsonPropertyOrder({
  ListFile.JSON_PROPERTY_DATA,
  ListFile.JSON_PROPERTY_META
})
...
public class ListFile implements Serializable {
  ...
  private java.util.List<ListFileObject> data = new java.util.ArrayList<>();
  ...
  @JsonCreator
  public ListFile(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.List<ListFileObject> data
  ) {
    this();
    this.data = data;
  }

  public ListFile data(java.util.List<ListFileObject> data) {
    this.data = data;
    return this;
  }

  public ListFile addDataItem(ListFileObject dataItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "List Files Data Array.")
  ...
  public ListFile meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ListFile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listFile.data) &&
        Objects.equals(this.meta, listFile.meta);
  }
