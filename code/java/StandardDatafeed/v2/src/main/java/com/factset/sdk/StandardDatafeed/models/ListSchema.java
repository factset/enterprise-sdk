...
import com.factset.sdk.StandardDatafeed.models.ListSchemaObject;
 ...
 * Schema List Object.
 */
@ApiModel(description = "Schema List Object.")
@JsonPropertyOrder({
  ListSchema.JSON_PROPERTY_DATA
})
...
public class ListSchema implements Serializable {
  ...
  private java.util.List<ListSchemaObject> data = new java.util.ArrayList<>();
  ...
  @JsonCreator
  public ListSchema(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.List<ListSchemaObject> data
  ) {
    this();
    this.data = data;
  }

  public ListSchema data(java.util.List<ListSchemaObject> data) {
    this.data = data;
    return this;
  }

  public ListSchema addDataItem(ListSchemaObject dataItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Schema List Data Array.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public java.util.List<ListSchemaObject> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(java.util.List<ListSchemaObject> data) {
    this.data = data;
  }


  /**
   * Return true if this ListSchema object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListSchema listSchema = (ListSchema) o;
    return Objects.equals(this.data, listSchema.data);
  }
