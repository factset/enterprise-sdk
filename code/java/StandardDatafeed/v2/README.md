...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/standarddatafeed/1.0.5)](https://central.sonatype.com/artifact/com.factset.sdk/standarddatafeed/1.0.5)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:standarddatafeed:1.0.5"
  }
```
