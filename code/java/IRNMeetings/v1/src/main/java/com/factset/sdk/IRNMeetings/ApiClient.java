...
import com.factset.sdk.IRNMeetings.auth.Authentication;
import com.factset.sdk.IRNMeetings.auth.HttpBasicAuth;
import com.factset.sdk.IRNMeetings.auth.HttpBearerAuth;
import com.factset.sdk.IRNMeetings.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.IRNMeetings.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/IRNMeetings/4.0.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.IRNMeetings.ApiClient} object.
   */
