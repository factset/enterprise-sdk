...
> java.util.Map&lt;String, Frequency&gt; getSPARFrequencies()
...
import com.factset.sdk.SPAREngine.api.FrequenciesApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            java.util.Map<String, Frequency> result = apiInstance.getSPARFrequencies();
...
[**java.util.Map&lt;String, Frequency&gt;**](Frequency.md)
