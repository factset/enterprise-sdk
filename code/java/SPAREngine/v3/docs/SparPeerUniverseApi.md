...
> SPARPeerUniverseRoot getListOfPeerUniverse(category, name, directory)

Get List of Peer Universe

Retrieves peer universe information that can be used when specifying universeId for SPAR calculations. This endpoint returns a list of available universes for different categories.

 Parameters: Category is mandatory.

Usage:
* Category parameter: Fetches all peer universe details available for specified category.
* Use parameters to narrow down your lookup based on peer universe name, category, and/or directory.

Remarks:
* Category Values: Allowed values include category name like 'US Funds', 'Asia Funds', 'Intl Funds','Institutions', 'Hedge Funds', 'Database', 'Domicile', 'Manager', 'Rating', 'OFDBs', 'Screens' etc.
* Access to specific categories may vary depending on your permissions.
* Directory parameter is mandatory when category is 'OFDBs' or 'Screens'. Eg: CLIENT:/FOLDER1.
* Note: Category 'Client funds' is not supported yet.
...
import com.factset.sdk.SPAREngine.api.SparPeerUniverseApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SparPeerUniverseApi apiInstance = new SparPeerUniverseApi(defaultClient);
        String category = "US Funds"; // String | Peer universe category
        String name = "Morningstar US"; // String | Peer universe name
        String directory = "directory_example"; // String | The directory to get the peer universe
        try {
            SPARPeerUniverseRoot result = apiInstance.getListOfPeerUniverse(category, name, directory);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SparPeerUniverseApi#getListOfPeerUniverse");
