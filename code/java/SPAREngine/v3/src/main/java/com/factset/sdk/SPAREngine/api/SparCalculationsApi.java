...
import com.factset.sdk.SPAREngine.models.CalculationsSummaryRoot;
import com.factset.sdk.SPAREngine.models.ClientErrorResponse;
import com.factset.sdk.SPAREngine.models.ObjectRoot;
import com.factset.sdk.SPAREngine.models.SPARCalculationParametersRoot;
...
public class SparCalculationsApi {
 ...
 /**
  ...
  public ApiResponse<Void> cancelCalculationByIdWithHttpInfo(String id) throws ApiException {
    ...
    String localVarPath = "/analytics/engines/spar/v3/calculations/{id}"
  ...
  public ApiResponse<CalculationsSummaryRoot> getAllCalculationsWithHttpInfo(Integer pageNumber) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/spar/v3/calculations";
    ...
    > apiResponse = apiClient.invokeAPI("SparCalculationsApi.getAllCalculations", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<CalculationStatusRoot> getCalculationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/spar/v3/calculations/{id}/status"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
  ...
  public ApiResponse<ObjectRoot> getCalculationUnitResultByIdWithHttpInfo(String id, String unitId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/analytics/engines/spar/v3/calculations/{id}/units/{unitId}/result"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()))
