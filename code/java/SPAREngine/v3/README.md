...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/sparengine/3.0.3)](https://central.sonatype.com/artifact/com.factset.sdk/sparengine/3.0.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:sparengine:3.0.3"
  }
```
