...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/sparengine/3.2.0)](https://central.sonatype.com/artifact/com.factset.sdk/sparengine/3.2.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:sparengine:3.2.0"
  }
```
...
*SparPeerUniverseApi* | [**getListOfPeerUniverse**](docs/SparPeerUniverseApi.md#getListOfPeerUniverse) | **GET** /analytics/engines/spar/v3/peer-universe | Get List of Peer Universe
...
## Documentation for Models
 ...
 - [SPARComponentIdentifier](docs/SPARComponentIdentifier.md)
 ...
 - [SPARPeerUniverseListResponse](docs/SPARPeerUniverseListResponse.md)
 - [SPARPeerUniverseResponseItem](docs/SPARPeerUniverseResponseItem.md)
 - [SPARPeerUniverseRoot](docs/SPARPeerUniverseRoot.md)
