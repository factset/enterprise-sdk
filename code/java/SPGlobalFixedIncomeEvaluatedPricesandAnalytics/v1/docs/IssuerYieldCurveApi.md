...
> BondIssuerYieldCurveResponse getBondIssuerYieldCurve(ids, startDate, endDate, frequency, calendar)
...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api.IssuerYieldCurveApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        IssuerYieldCurveApi apiInstance = new IssuerYieldCurveApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling IssuerYieldCurveApi#getBondIssuerYieldCurve");
...
> BondIssuerYieldCurveResponse getBondIssuerYieldCurveForList(bondIssuerYieldCurveRequest)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        IssuerYieldCurveApi apiInstance = new IssuerYieldCurveApi(defaultClient);
        BondIssuerYieldCurveRequest bondIssuerYieldCurveRequest = new BondIssuerYieldCurveRequest(); // BondIssuerYieldCurveRequest | Request object for requesting issuer yield curve data.
        try {
            BondIssuerYieldCurveResponse result = apiInstance.getBondIssuerYieldCurveForList(bondIssuerYieldCurveRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling IssuerYieldCurveApi#getBondIssuerYieldCurveForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
