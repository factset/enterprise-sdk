...
> AbsDetailsResponse getABSDetails(ids, startDate, endDate, frequency, calendar)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        AbsDetailsApi apiInstance = new AbsDetailsApi(defaultClient);
        AbsDetailsRequest absDetailsRequest = new AbsDetailsRequest(); // AbsDetailsRequest | Request object for requesting ABS details
        try {
            AbsDetailsResponse result = apiInstance.getABSDetailsForList(absDetailsRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling AbsDetailsApi#getABSDetailsForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
