...
------------- | ------------- | -------------
[**getBondPrices**](PricesApi.md#getBondPrices) | **GET** /markit-bond-prices-and-analytics/v1/prices | Get Bid, Mid and Ask prices for a list of securities
[**getBondPricesForList**](PricesApi.md#getBondPricesForList) | **POST** /markit-bond-prices-and-analytics/v1/prices | Request Bid, Mid and Ask prices for a list of securities



## getBondPrices

> BondPricesResponse getBondPrices(ids, startDate, endDate, frequency, calendar)
...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api.PricesApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            BondPricesResponse result = apiInstance.getBondPrices(ids, startDate, endDate, frequency, calendar);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling PricesApi#getBondPrices");
...
[**BondPricesResponse**](BondPricesResponse.md)
...
## getBondPricesForList

> BondPricesResponse getBondPricesForList(bondPricesRequest)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        PricesApi apiInstance = new PricesApi(defaultClient);
        BondPricesRequest bondPricesRequest = new BondPricesRequest(); // BondPricesRequest | Request object for requesting pricing data
        try {
            BondPricesResponse result = apiInstance.getBondPricesForList(bondPricesRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling PricesApi#getBondPricesForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bondPricesRequest** | [**BondPricesRequest**](BondPricesRequest.md)| Request object for requesting pricing data |
