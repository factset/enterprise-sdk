...
> BondSensitivityResponse getBondSensitivity(ids, startDate, endDate, frequency, calendar)
...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api.SensitivityApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SensitivityApi apiInstance = new SensitivityApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling SensitivityApi#getBondSensitivity");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SensitivityApi apiInstance = new SensitivityApi(defaultClient);
        BondSensitivityRequest bondSensitivityRequest = new BondSensitivityRequest(); // BondSensitivityRequest | Request object for requesting sensitivity data
        try {
            BondSensitivityResponse result = apiInstance.getBondSensitivityForList(bondSensitivityRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SensitivityApi#getBondSensitivityForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
