...
> BondYieldResponse getBondYield(ids, startDate, endDate, frequency, calendar)
...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.api.YieldApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        YieldApi apiInstance = new YieldApi(defaultClient);
        ...
        try {
            BondYieldResponse result = apiInstance.getBondYield(ids, startDate, endDate, frequency, calendar);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling YieldApi#getBondYield");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        YieldApi apiInstance = new YieldApi(defaultClient);
        BondYieldRequest bondYieldRequest = new BondYieldRequest(); // BondYieldRequest | Request object for requesting yield data
        try {
            BondYieldResponse result = apiInstance.getBondYieldForList(bondYieldRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling YieldApi#getBondYieldForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
