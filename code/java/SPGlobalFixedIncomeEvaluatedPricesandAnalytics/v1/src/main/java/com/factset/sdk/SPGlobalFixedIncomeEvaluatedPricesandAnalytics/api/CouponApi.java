...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.models.BondCouponRequest;
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.models.BondCouponResponse;
...
public class CouponApi {
  ...
  static {
    ...
    getBondCouponResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getBondCouponResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
  ...
  static {
    ...
    getBondCouponForListResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
    getBondCouponForListResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getBondCouponForListResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
    getBondCouponForListResponseTypeMap.put(415, new GenericType<ErrorResponse>(){});
  ...
  /**
   * Get coupon data for given date range and list of securities
   ...
   * @return BondCouponResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Bond Coupon items </td><td>  -  </td></tr>
   ...
   */
  public BondCouponResponse getBondCoupon(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar) throws ApiException {
    return getBondCouponWithHttpInfo(ids, startDate, endDate, frequency, calendar).getData();
  }
   ...
   * @param frequency Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** &#x3D; Fiscal Quarter of the company.   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.   * **FY** &#x3D; Fiscal Annual, based on the last trading day of the company&#39;s fiscal year.  (optional, default to D)
   * @param calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)
   * @return ApiResponse&lt;BondCouponResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<BondCouponResponse> getBondCouponWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getBondCoupon");
    }
    
    // create path and map variables
    String localVarPath = "/markit-bond-prices-and-analytics/v1/coupon";
    ...
    > apiResponse = apiClient.invokeAPI("CouponApi.getBondCoupon", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getBondCouponResponseTypeMap, false);

    return apiResponse;

  }
  /**
   * Request coupon data for given date range and list of securities
   * Get coupon information like accrued interest, coupon, coupon type and coupon frequency provided by Markit for specified date range and frequency. 
   * @param bondCouponRequest Request object for requesting Coupon data (required)
   * @return BondCouponResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Bond Coupon data items </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public BondCouponResponse getBondCouponForList(BondCouponRequest bondCouponRequest) throws ApiException {
    return getBondCouponForListWithHttpInfo(bondCouponRequest).getData();
  }
   ...
   */
  public ApiResponse<BondCouponResponse> getBondCouponForListWithHttpInfo(BondCouponRequest bondCouponRequest) throws ApiException {
    Object localVarPostBody = bondCouponRequest;
    
    // verify the required parameter 'bondCouponRequest' is set
    if (bondCouponRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'bondCouponRequest' when calling getBondCouponForList");
    }
    ...
    > apiResponse = apiClient.invokeAPI("CouponApi.getBondCouponForList", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getBondCouponForListResponseTypeMap, false);
