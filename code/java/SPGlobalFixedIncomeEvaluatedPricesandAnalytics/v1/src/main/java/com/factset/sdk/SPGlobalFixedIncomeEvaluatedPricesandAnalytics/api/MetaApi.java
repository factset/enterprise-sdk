...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.models.BondMetaRequest;
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.models.BondMetaResponse;
...
public class MetaApi {
  ...
  static {
    ...
    getBondMetaResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getBondMetaResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
  ...
  static {
    ...
    getBondMetaForListResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
    getBondMetaForListResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getBondMetaForListResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
    getBondMetaForListResponseTypeMap.put(415, new GenericType<ErrorResponse>(){});
   ...
   * @return BondMetaResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Bond Meta items </td><td>  -  </td></tr>
   ...
   */
  public BondMetaResponse getBondMeta(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar) throws ApiException {
    return getBondMetaWithHttpInfo(ids, startDate, endDate, frequency, calendar).getData();
  }
   ...
   * @param frequency Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** &#x3D; Fiscal Quarter of the company.   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.   * **FY** &#x3D; Fiscal Annual, based on the last trading day of the company&#39;s fiscal year.  (optional, default to D)
   * @param calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)
   * @return ApiResponse&lt;BondMetaResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<BondMetaResponse> getBondMetaWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getBondMeta");
    }
    
    // create path and map variables
    String localVarPath = "/markit-bond-prices-and-analytics/v1/meta";
    ...
    > apiResponse = apiClient.invokeAPI("MetaApi.getBondMeta", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getBondMetaResponseTypeMap, false);
   ...
   * Get bond meta data for a list of securities.
   * Get bond metadata like classification, maturity date, symbology information like isin, cusip, vendorid, ticker, issue and issuer name provided by Markit for a list of securities. 
   * @param bondMetaRequest Request object for requesting meta data (required)
   * @return BondMetaResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Bond Meta data items </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public BondMetaResponse getBondMetaForList(BondMetaRequest bondMetaRequest) throws ApiException {
    return getBondMetaForListWithHttpInfo(bondMetaRequest).getData();
  }
   ...
   */
  public ApiResponse<BondMetaResponse> getBondMetaForListWithHttpInfo(BondMetaRequest bondMetaRequest) throws ApiException {
    Object localVarPostBody = bondMetaRequest;
    
    // verify the required parameter 'bondMetaRequest' is set
    if (bondMetaRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'bondMetaRequest' when calling getBondMetaForList");
    }
    ...
    > apiResponse = apiClient.invokeAPI("MetaApi.getBondMetaForList", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getBondMetaForListResponseTypeMap, false);
