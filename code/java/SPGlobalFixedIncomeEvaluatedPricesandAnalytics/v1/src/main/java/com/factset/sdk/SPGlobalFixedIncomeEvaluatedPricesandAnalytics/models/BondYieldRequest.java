 ...
 */
@ApiModel(description = "Bond Yield request body elements")
@JsonPropertyOrder({
  BondYieldRequest.JSON_PROPERTY_IDS,
  BondYieldRequest.JSON_PROPERTY_START_DATE,
  BondYieldRequest.JSON_PROPERTY_END_DATE,
  BondYieldRequest.JSON_PROPERTY_FREQUENCY,
  BondYieldRequest.JSON_PROPERTY_CALENDAR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class BondYieldRequest implements Serializable {
  ...
  public BondYieldRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public BondYieldRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public BondYieldRequest startDate(String startDate) {
  ...
  **/
  ...
  public BondYieldRequest endDate(String endDate) {
  ...
  **/
  ...
  public BondYieldRequest frequency(Frequency frequency) {
  ...
  **/
  ...
  public BondYieldRequest calendar(Calendar calendar) {
  ...
  **/
  ...
  /**
   * Return true if this bondYieldRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BondYieldRequest bondYieldRequest = (BondYieldRequest) o;
    return Objects.equals(this.ids, bondYieldRequest.ids) &&
        Objects.equals(this.startDate, bondYieldRequest.startDate) &&
        Objects.equals(this.endDate, bondYieldRequest.endDate) &&
        Objects.equals(this.frequency, bondYieldRequest.frequency) &&
        Objects.equals(this.calendar, bondYieldRequest.calendar);
  }
  ...
  public String toString() {
    ...
    sb.append("class BondYieldRequest {\n");
