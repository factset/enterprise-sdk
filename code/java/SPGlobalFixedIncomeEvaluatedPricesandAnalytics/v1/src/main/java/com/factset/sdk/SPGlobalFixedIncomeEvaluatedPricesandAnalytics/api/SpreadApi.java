...
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.models.BondSpreadRequest;
import com.factset.sdk.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.models.BondSpreadResponse;
...
public class SpreadApi {
  ...
  static {
    ...
    getBondSpreadResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getBondSpreadResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
  ...
  static {
    ...
    getBondSpreadForListResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
    getBondSpreadForListResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getBondSpreadForListResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
    getBondSpreadForListResponseTypeMap.put(415, new GenericType<ErrorResponse>(){});
   ...
   * @return BondSpreadResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Bond Spread items </td><td>  -  </td></tr>
   ...
   */
  public BondSpreadResponse getBondSpread(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar) throws ApiException {
    return getBondSpreadWithHttpInfo(ids, startDate, endDate, frequency, calendar).getData();
  }
   ...
   * @param frequency Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** &#x3D; Fiscal Quarter of the company.   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.   * **FY** &#x3D; Fiscal Annual, based on the last trading day of the company&#39;s fiscal year.  (optional, default to D)
   * @param calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)
   * @return ApiResponse&lt;BondSpreadResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<BondSpreadResponse> getBondSpreadWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getBondSpread");
    }
    
    // create path and map variables
    String localVarPath = "/markit-bond-prices-and-analytics/v1/spread";
    ...
    > apiResponse = apiClient.invokeAPI("SpreadApi.getBondSpread", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getBondSpreadResponseTypeMap, false);
   ...
   * Get spread details like discount margin, OAS, Asset Swap Spread, Z Spread, spread benchmark provided by Markit for a specified date range and frequency. 
   * @param bondSpreadRequest Request object for requesting pricing data (required)
   * @return BondSpreadResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public BondSpreadResponse getBondSpreadForList(BondSpreadRequest bondSpreadRequest) throws ApiException {
    return getBondSpreadForListWithHttpInfo(bondSpreadRequest).getData();
  }
   ...
   */
  public ApiResponse<BondSpreadResponse> getBondSpreadForListWithHttpInfo(BondSpreadRequest bondSpreadRequest) throws ApiException {
    Object localVarPostBody = bondSpreadRequest;
    
    // verify the required parameter 'bondSpreadRequest' is set
    if (bondSpreadRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'bondSpreadRequest' when calling getBondSpreadForList");
    }
    ...
    > apiResponse = apiClient.invokeAPI("SpreadApi.getBondSpreadForList", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getBondSpreadForListResponseTypeMap, false);
