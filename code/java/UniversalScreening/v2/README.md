...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/universalscreening/2.3.0)](https://central.sonatype.com/artifact/com.factset.sdk/universalscreening/2.3.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:universalscreening:2.3.0"
  }
```
...
*ScreeningOperationsApi* | [**getExportResults**](docs/ScreeningOperationsApi.md#getExportResults) | **GET** /job/{id}/export | 
...
*ScreeningOperationsApi* | [**submitExport**](docs/ScreeningOperationsApi.md#submitExport) | **POST** /job/export | 
...
## Documentation for Models
 ...
 - [CalculateMetadata](docs/CalculateMetadata.md)
 - [DelimitedOptions](docs/DelimitedOptions.md)
 - [ErrorArray](docs/ErrorArray.md)
 - [ErrorCode](docs/ErrorCode.md)
 - [ErrorObject](docs/ErrorObject.md)
 - [ErrorObjectSource](docs/ErrorObjectSource.md)
 - [ExcelOptions](docs/ExcelOptions.md)
 ...
 - [ScreenExportParameters](docs/ScreenExportParameters.md)
 - [ScreenExportParametersData](docs/ScreenExportParametersData.md)
 - [SubmitExportResponse](docs/SubmitExportResponse.md)
 - [SubmitExportResponseData](docs/SubmitExportResponseData.md)
