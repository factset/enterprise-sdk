...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/universalscreening/2.3.1)](https://central.sonatype.com/artifact/com.factset.sdk/universalscreening/2.3.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:universalscreening:2.3.1"
  }
```
