...
import com.factset.sdk.UniversalScreening.auth.Authentication;
import com.factset.sdk.UniversalScreening.auth.HttpBasicAuth;
import com.factset.sdk.UniversalScreening.auth.HttpBearerAuth;
import com.factset.sdk.UniversalScreening.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.UniversalScreening.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/universal-screening/v2";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/universal-screening/v2",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/UniversalScreening/2.2.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.UniversalScreening.ApiClient} object.
   */
