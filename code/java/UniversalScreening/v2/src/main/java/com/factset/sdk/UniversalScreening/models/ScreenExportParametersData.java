 ...
 */
@ApiModel(description = "Object containing screen and export data")
@JsonPropertyOrder({
  ScreenExportParametersData.JSON_PROPERTY_SCREEN_NAME,
...
public class ScreenExportParametersData implements Serializable {
  ...
  public ScreenExportParametersData(
    ...
    @JsonProperty(value=JSON_PROPERTY_FILE, required=true) Object _file
  ) {
    this();
  ...
  public ScreenExportParametersData screenName(String screenName) {
    this.screenName = screenName;
    return this;
  }
  ...
  **/
  ...
  public ScreenExportParametersData _file(Object _file) {
    this._file = _file;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Data required for file export.")
  ...
  public ScreenExportParametersData backtestDate(String backtestDate) {
  ...
  **/
  ...
  public ScreenExportParametersData globalVariablesMap(java.util.Map<String, String> globalVariablesMap) {
    this.globalVariablesMap = globalVariablesMap;
    return this;
  }

  public ScreenExportParametersData putGlobalVariablesMapItem(String key, String globalVariablesMapItem) {
  ...
  **/
  ...
  public ScreenExportParametersData legacyUniverseType(LegacyUniverseTypeEnum legacyUniverseType) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "equity", value = "Universe type to open a Screen 1.0 document (.usscreen) with\\ `equity`: Uses the equity universe from the Screen 1.0 document.\\ `debt`: Uses the debt universe from the Screen 1.0 document.\\ `fund`: Uses the fund universe from the Screen 1.0 document.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    ScreenExportParametersData screenExportParametersData = (ScreenExportParametersData) o;
    return Objects.equals(this.screenName, screenExportParametersData.screenName) &&
