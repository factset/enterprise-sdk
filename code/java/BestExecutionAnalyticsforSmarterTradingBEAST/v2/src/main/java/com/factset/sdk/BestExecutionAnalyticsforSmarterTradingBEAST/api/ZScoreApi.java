...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.models.ZScoreResponseRoot;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class ZScoreApi {
  ...
  public ZScoreApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> getZScoreQuotesResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getZScoreQuotesResponseTypeMap.put(200, new GenericType<ZScoreResponseRoot>(){});
    getZScoreQuotesResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getZScoreTradesResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getZScoreTradesResponseTypeMap.put(200, new GenericType<ZScoreResponseRoot>(){});
    getZScoreTradesResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  }
   ...
   */
  public ZScoreResponseRoot getZScoreQuotes(String startDate, String endDate, String securityId, String region) throws ApiException {
    return getZScoreQuotesWithHttpInfo(startDate, endDate, securityId, region).getData();
  }
   ...
   * @param securityId ISIN for European securities, otherwise TICKER (required)
   * @param region The two character ISO country code of the trading region. EMEA is used for the European trading region (required)
   * @return ApiResponse&lt;ZScoreResponseRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<ZScoreResponseRoot> getZScoreQuotesWithHttpInfo(String startDate, String endDate, String securityId, String region) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
      throw new ApiException(400, "Missing the required parameter 'startDate' when calling getZScoreQuotes");
    }
    
    // verify the required parameter 'endDate' is set
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getZScoreQuotes");
    }
    
    // verify the required parameter 'securityId' is set
    if (securityId == null) {
      throw new ApiException(400, "Missing the required parameter 'securityId' when calling getZScoreQuotes");
    }
    
    // verify the required parameter 'region' is set
    if (region == null) {
      throw new ApiException(400, "Missing the required parameter 'region' when calling getZScoreQuotes");
    }
    
    // create path and map variables
    String localVarPath = "/la/zscore/quotes";
    ...
    > apiResponse = apiClient.invokeAPI("ZScoreApi.getZScoreQuotes", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getZScoreQuotesResponseTypeMap, false);
   ...
   */
  public ZScoreResponseRoot getZScoreTrades(String startDate, String endDate, String securityId, String region) throws ApiException {
    return getZScoreTradesWithHttpInfo(startDate, endDate, securityId, region).getData();
  }
   ...
   */
  public ApiResponse<ZScoreResponseRoot> getZScoreTradesWithHttpInfo(String startDate, String endDate, String securityId, String region) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
      throw new ApiException(400, "Missing the required parameter 'startDate' when calling getZScoreTrades");
    }
    
    // verify the required parameter 'endDate' is set
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getZScoreTrades");
    }
    
    // verify the required parameter 'securityId' is set
    if (securityId == null) {
      throw new ApiException(400, "Missing the required parameter 'securityId' when calling getZScoreTrades");
    }
    
    // verify the required parameter 'region' is set
    if (region == null) {
      throw new ApiException(400, "Missing the required parameter 'region' when calling getZScoreTrades");
    }
    
    // create path and map variables
    String localVarPath = "/la/zscore/trades";
    ...
    > apiResponse = apiClient.invokeAPI("ZScoreApi.getZScoreTrades", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getZScoreTradesResponseTypeMap, false);
