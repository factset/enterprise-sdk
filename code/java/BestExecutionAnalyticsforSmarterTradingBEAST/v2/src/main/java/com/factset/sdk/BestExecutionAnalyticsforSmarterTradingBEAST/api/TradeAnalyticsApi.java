...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.models.TradeAnalyticsResponseRoot;
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.models.VolumeAnalyticsResponseRoot;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class TradeAnalyticsApi {
  private ApiClient apiClient;

  public TradeAnalyticsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public TradeAnalyticsApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> getTradeAnalyticsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getTradeAnalyticsResponseTypeMap.put(200, new GenericType<TradeAnalyticsResponseRoot>(){});
    getTradeAnalyticsResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getVolumeAnalyticsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getVolumeAnalyticsResponseTypeMap.put(200, new GenericType<VolumeAnalyticsResponseRoot>(){});
    getVolumeAnalyticsResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  }
   ...
   * @return TradeAnalyticsResponseRoot
   ...
   */
  public TradeAnalyticsResponseRoot getTradeAnalytics(String startDate, String endDate, String securityId, String region) throws ApiException {
    return getTradeAnalyticsWithHttpInfo(startDate, endDate, securityId, region).getData();
  }
   ...
   * @param securityId ISIN for European securities, otherwise TICKER (required)
   * @param region The two character ISO country code of the trading region. EMEA is used for the European trading region (required)
   * @return ApiResponse&lt;TradeAnalyticsResponseRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<TradeAnalyticsResponseRoot> getTradeAnalyticsWithHttpInfo(String startDate, String endDate, String securityId, String region) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
      throw new ApiException(400, "Missing the required parameter 'startDate' when calling getTradeAnalytics");
    }
    
    // verify the required parameter 'endDate' is set
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getTradeAnalytics");
    }
    
    // verify the required parameter 'securityId' is set
    if (securityId == null) {
      throw new ApiException(400, "Missing the required parameter 'securityId' when calling getTradeAnalytics");
    }
    
    // verify the required parameter 'region' is set
    if (region == null) {
      throw new ApiException(400, "Missing the required parameter 'region' when calling getTradeAnalytics");
    }
    
    // create path and map variables
    String localVarPath = "/la/trade/trade-analytics";
    ...
    > apiResponse = apiClient.invokeAPI("TradeAnalyticsApi.getTradeAnalytics", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getTradeAnalyticsResponseTypeMap, false);
   ...
   * @param securityId ISIN for European securities, otherwise TICKER (required)
   * @param region The two character ISO country code of the trading region. EMEA is used for the European trading region (required)
   * @return VolumeAnalyticsResponseRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public VolumeAnalyticsResponseRoot getVolumeAnalytics(String startDate, String endDate, String securityId, String region) throws ApiException {
    return getVolumeAnalyticsWithHttpInfo(startDate, endDate, securityId, region).getData();
  }
   ...
   * @param securityId ISIN for European securities, otherwise TICKER (required)
   * @param region The two character ISO country code of the trading region. EMEA is used for the European trading region (required)
   * @return ApiResponse&lt;VolumeAnalyticsResponseRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<VolumeAnalyticsResponseRoot> getVolumeAnalyticsWithHttpInfo(String startDate, String endDate, String securityId, String region) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
      throw new ApiException(400, "Missing the required parameter 'startDate' when calling getVolumeAnalytics");
    }
    
    // verify the required parameter 'endDate' is set
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getVolumeAnalytics");
    }
    
    // verify the required parameter 'securityId' is set
    if (securityId == null) {
      throw new ApiException(400, "Missing the required parameter 'securityId' when calling getVolumeAnalytics");
    }
    
    // verify the required parameter 'region' is set
    if (region == null) {
      throw new ApiException(400, "Missing the required parameter 'region' when calling getVolumeAnalytics");
    }
    
    // create path and map variables
    String localVarPath = "/la/trade/volume-analytics";
    ...
    > apiResponse = apiClient.invokeAPI("TradeAnalyticsApi.getVolumeAnalytics", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getVolumeAnalyticsResponseTypeMap, false);
