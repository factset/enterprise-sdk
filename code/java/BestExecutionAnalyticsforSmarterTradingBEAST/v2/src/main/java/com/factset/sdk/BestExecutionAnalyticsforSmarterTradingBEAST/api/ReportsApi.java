...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.models.ReportResponseRoot;
...
public class ReportsApi {
  ...
  private static final Map<Integer, GenericType> getParentAggregateAnalysisResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getParentAggregateAnalysisResponseTypeMap.put(200, new GenericType<ReportResponseRoot>(){});
    getParentAggregateAnalysisResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  }
   ...
   */
  public ReportResponseRoot getParentAggregateAnalysis(String startDate, String endDate) throws ApiException {
    return getParentAggregateAnalysisWithHttpInfo(startDate, endDate).getData();
  }
   ...
   * @param startDate Search start date in the format YYYY-MM-DD (required)
   * @param endDate Search end date in the format YYYY-MM-DD (required)
   * @return ApiResponse&lt;ReportResponseRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<ReportResponseRoot> getParentAggregateAnalysisWithHttpInfo(String startDate, String endDate) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
      throw new ApiException(400, "Missing the required parameter 'startDate' when calling getParentAggregateAnalysis");
    }
    
    // verify the required parameter 'endDate' is set
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getParentAggregateAnalysis");
    }
    
    // create path and map variables
    String localVarPath = "/tca/report/parent-aggregate-analysis";
    ...
    > apiResponse = apiClient.invokeAPI("ReportsApi.getParentAggregateAnalysis", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getParentAggregateAnalysisResponseTypeMap, false);
