...
> OrdersResponseRoot getOrders(startDate, endDate, securityId, trader, region, strategy, broker, searchText, hierarchical)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String trader = "trader_example"; // String | Order Trader
        ...
        String strategy = "strategy_example"; // String | Order Strategy
        String broker = "broker_example"; // String | Order Broker
        String searchText = "searchText_example"; // String | Free text field for searching all fields
