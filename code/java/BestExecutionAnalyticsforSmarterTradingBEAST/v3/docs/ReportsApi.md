...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.api.ReportsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ReportsApi#getParentAggregateAnalysis");
