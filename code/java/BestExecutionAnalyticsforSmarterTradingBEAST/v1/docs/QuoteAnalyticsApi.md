...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.api.QuoteAnalyticsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        QuoteAnalyticsApi apiInstance = new QuoteAnalyticsApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling QuoteAnalyticsApi#getQuoteInsideSize");
