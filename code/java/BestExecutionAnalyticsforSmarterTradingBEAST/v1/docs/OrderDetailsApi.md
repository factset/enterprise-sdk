...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.api.OrderDetailsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        OrderDetailsApi apiInstance = new OrderDetailsApi(defaultClient);
        String orderId = "orderId_example"; // String | The Order Id
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            OrderFillCountResponseRoot result = apiInstance.getOrderFillCount(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderFillCount");
 ...
 **date** | **String**| The Order Date in the format YYYY-MM-DD |
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            IndexETFResponseRoot result = apiInstance.getOrderIndexETF(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderIndexETF");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            OrderInfoResponseRoot result = apiInstance.getOrderInfo(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderInfo");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            IntraOrderStatResponseRoot result = apiInstance.getOrderIntraStats(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderIntraStats");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            InvestmentTimingResponseRoot result = apiInstance.getOrderInvestmentTiming(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderInvestmentTiming");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            PriceTimeFillResponseRoot result = apiInstance.getOrderPriceTimeFills(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderPriceTimeFills");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            PriceTimeQuoteResponseRoot result = apiInstance.getOrderPriceTimeQuotes(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderPriceTimeQuotes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            PriceTimeTradeResponseRoot result = apiInstance.getOrderPriceTimeTrades(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderPriceTimeTrades");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            VolumePriceResponseRoot result = apiInstance.getOrderVolumePrice(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderVolumePrice");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            VolumeTimeResponseRoot result = apiInstance.getOrderVolumeTime(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderVolumeTime");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String date = "2024-08-29"; // String | The Order Date in the format YYYY-MM-DD
        try {
            VolumeVenueResponseRoot result = apiInstance.getOrderVolumeVenue(orderId, date);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OrderDetailsApi#getOrderVolumeVenue");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
