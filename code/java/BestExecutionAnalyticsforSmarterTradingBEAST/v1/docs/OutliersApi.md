...
> OutlierResponseRoot getOutlierMetrics(metricType, startDate, endDate, deviation, binScalar)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String startDate = "2024-08-20"; // String | Start date in the format YYYY-MM-DD
        ...
        try {
            OutlierResponseRoot result = apiInstance.getOutlierMetrics(metricType, startDate, endDate, deviation, binScalar);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OutliersApi#getOutlierMetrics");
...
------------- | ------------- | ------------- | -------------
 **metricType** | **String**| Metric type | [enum: firstFillMidPerfBps, lastFillMidPerfBps, openPerfBps, closePerfBps]
...
> OutlierResponseRoot getOutlierMetricsByPercent(metricType, startDate, endDate, minPercent, maxPercent, binScalar)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String startDate = "2024-08-20"; // String | Start date in the format YYYY-MM-DD
        String endDate = "2024-08-29"; // String | End date in the format YYYY-MM-DD
        Float minPercent = 25F; // Float | Min Percentage
        Float maxPercent = 75F; // Float | Max Percentage
        Integer binScalar = 51; // Integer | Bin Scalar
        try {
            OutlierResponseRoot result = apiInstance.getOutlierMetricsByPercent(metricType, startDate, endDate, minPercent, maxPercent, binScalar);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling OutliersApi#getOutlierMetricsByPercent");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
 ...
 **startDate** | **String**| Start date in the format YYYY-MM-DD |
 **endDate** | **String**| End date in the format YYYY-MM-DD |
 **minPercent** | **Float**| Min Percentage | [optional] [default to 25]
 **maxPercent** | **Float**| Max Percentage | [optional] [default to 75]
 **binScalar** | **Integer**| Bin Scalar | [optional] [default to 51]
