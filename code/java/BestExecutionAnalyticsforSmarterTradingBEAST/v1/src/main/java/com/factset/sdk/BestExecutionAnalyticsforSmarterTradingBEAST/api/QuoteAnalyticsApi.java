...
import com.factset.sdk.BestExecutionAnalyticsforSmarterTradingBEAST.models.QuoteInsideSizeResponseRoot;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class QuoteAnalyticsApi {
  private ApiClient apiClient;

  public QuoteAnalyticsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public QuoteAnalyticsApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> getQuoteInsideSizeResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getQuoteInsideSizeResponseTypeMap.put(200, new GenericType<QuoteInsideSizeResponseRoot>(){});
    getQuoteInsideSizeResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
  }
   ...
   * @return QuoteInsideSizeResponseRoot
   ...
   */
  public QuoteInsideSizeResponseRoot getQuoteInsideSize(String startDate, String endDate, String securityId, String region) throws ApiException {
    return getQuoteInsideSizeWithHttpInfo(startDate, endDate, securityId, region).getData();
  }
   ...
   * @param securityId ISIN for European securities, otherwise TICKER (required)
   * @param region The two character ISO country code of the trading region. EMEA is used for the European trading region (required)
   * @return ApiResponse&lt;QuoteInsideSizeResponseRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<QuoteInsideSizeResponseRoot> getQuoteInsideSizeWithHttpInfo(String startDate, String endDate, String securityId, String region) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
      throw new ApiException(400, "Missing the required parameter 'startDate' when calling getQuoteInsideSize");
    }
    
    // verify the required parameter 'endDate' is set
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getQuoteInsideSize");
    }
    
    // verify the required parameter 'securityId' is set
    if (securityId == null) {
      throw new ApiException(400, "Missing the required parameter 'securityId' when calling getQuoteInsideSize");
    }
    
    // verify the required parameter 'region' is set
    if (region == null) {
      throw new ApiException(400, "Missing the required parameter 'region' when calling getQuoteInsideSize");
    }
    
    // create path and map variables
    String localVarPath = "/la/quote/inside-size";
    ...
    > apiResponse = apiClient.invokeAPI("QuoteAnalyticsApi.getQuoteInsideSize", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getQuoteInsideSizeResponseTypeMap, false);
