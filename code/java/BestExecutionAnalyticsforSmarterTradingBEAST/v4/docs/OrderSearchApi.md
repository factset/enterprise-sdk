 ...
 **orderFields** | **List&lt;String&gt;**| Specify order fields to select. The OrderId, Country, MasterOrderId, MessageType and ParentId fields are default fields and must be included if none are specified. | [optional] [enum: All, Default, Algo, AlgoWheel, BasketId, BbgTicker, Broker, ClientId, ClosePrice, ClosePerfBps, CompanyName, CostEstimates, Country, CountryAlias, Currency, DateId, Destination, Destinationtype, Direction, ErrorCodes, FillTimeUtc, FirstFillMid, FirstFillMidPerfBps, FirstFillPreAsk, FirstFillPreBid, FirstFillPrice, FirstFillPricePerfBps, FirstFillTime, FirstFillTimeStatus, FxRate, GrandParentId, Id, IntraOrderVolatility, IntraOrderVolatilityBps, Isin, LastFillMid, LastFillMidPerfBps, LastFillPreAsk, LastFillPreBid, LastFillPrice, LastFillTime, LimitParticipationRatePct, LimitPrice, LimitPwp01PerfBps, LimitPwp01Price, LimitPwp01Volume, LimitPwp02PerfBps, LimitPwp02Price, LimitPwp02Volume, LimitPwp03PerfBps, LimitPwp03Price, LimitPwp03Volume, LimitPwp05PerfBps, LimitPwp05Price, LimitPwp05Volume, LimitPwp10PerfBps, LimitPwp10Price, LimitPwp10Volume, LimitPwp20PerfBps, LimitPwp20Price, LimitPwp20Volume, LimitPwp50PerfBps, LimitPwp50Price, LimitPwp50Volume, LimitPwp100PerfBps, LimitPwp100Price, LimitPwp100Volume, LimitVwapFfClose, LimitVwapFfClosePerfBps, LimitVwapFfCloseVolume, LimitVwapFfLf, LimitVwapFfLfPerfBps, LimitVwapFfLfVolume, LimitVwapHighAvgPrice, LimitVwapHighAvgPricePerfBps, LimitVwapHighAvgPriceVolume, LimitVwapLowAvgPrice, LimitVwapLowAvgPricePerfBps, LimitVwapLowAvgPriceVolume, LimitVwapOpenClose, LimitVwapOpenClosePerfBps, LimitVwapOpenCloseVolume, LimitVwapOrderEntryClose, LimitVwapOrderEntryClosePerfBps, LimitVwapOrderEntryCloseVolume, MarketAdjustment, MarketCap, MarketSpreadCross, MasterOrderId, MessageType, MultidayBenchmarks, Note, OpenPerfBps, OpenPrice, OrderId, OrderEntryFillMid, OrderEntryFillMidPerfBps, OrderEntryPreAsk, OrderEntryPreBid, OrderEntryTimeUtc, OrderType, OrderVolume, ParentCreationTimeUtc, ParentId, ParticipationRatePct, Price, ProcessedTime, Pwp01PerfBps, Pwp01Price, Pwp01Volume, Pwp02PerfBps, Pwp02Price, Pwp02Volume, Pwp03PerfBps, Pwp03Price, Pwp03Volume, Pwp05PerfBps, Pwp05Price, Pwp05Volume, Pwp10PerfBps, Pwp10Price, Pwp10Volume, Pwp20PerfBps, Pwp20Price, Pwp20Volume, Pwp50PerfBps, Pwp50Price, Pwp50Volume, Pwp100PerfBps, Pwp100Price, Pwp100Volume, RefCurrency, RefValue, Region, Reversion5MinMidBps, Reversion5MinMidPrice, Reversion10MinMidBps, Reversion10MinMidPrice, Reversion15MinMidBps, Reversion15MinMidPrice, Reversion60MinMidBps, Reversion60MinMidPrice, Sector, SecurityId, Side, SpreadCross, Status, Strategy, Symbol, Synthetic, Trader, Twas, TwasAskSize, TwasBidSize, Udfmap, Value, Venue, Volume, VwapFfClose, VwapFfClosePerfBps, VwapFfCloseVolume, VwapFfLf, VwapFfLfPerfBps, VwapFfLfVolume, VwapHighAvgPrice, VwapHighAvgPricePerfBps, VwapHighAvgPriceVolume, VwapLowAvgPrice, VwapLowAvgPricePerfBps, VwapLowAvgPriceVolume, VwapOpenClose, VwapOpenClosePerfBps, VwapOpenCloseVolume, VwapOrderEntryClose, VwapOrderEntryClosePerfBps, VwapOrderEntryCloseVolume]
 **hierarchical** | **Boolean**| Return order records in hierarchical format or as flat records | [optional] [default to true]
 **messageType** | **String**| Return parent or child order records by messageType. Only apply when hierarchical is false | [optional] [default to Undefined] [enum: Undefined, Parent, Child, Allocation]
