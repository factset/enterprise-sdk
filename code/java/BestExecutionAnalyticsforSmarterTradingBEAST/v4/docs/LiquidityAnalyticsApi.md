...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        java.util.List<String> securityIds = Arrays.asList(); // java.util.List<String> | ISIN for European or India securities, otherwise TICKER. Either FDS-US-USD or FDS-US works.
...
------------- | ------------- | ------------- | -------------
 **securityIds** | **List&lt;String&gt;**| ISIN for European or India securities, otherwise TICKER. Either FDS-US-USD or FDS-US works. |
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling LiquidityAnalyticsApi#getLiquidityQuotes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling LiquidityAnalyticsApi#getLiquidityTrades");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling LiquidityAnalyticsApi#getLiquidityVolumeAnalytics");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
