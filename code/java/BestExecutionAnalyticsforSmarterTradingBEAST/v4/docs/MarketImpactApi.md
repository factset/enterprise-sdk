...
> CostImpactResponseRootV3 getCostImpactV3(securityId, orderVolume, country, currency, strategy, riskAversion, date, startTime, endTime, isMomentum, side, peer, frontLoadHalfLife, rearLoadHalfLife, rearRatio, binsData)
