...
public class OutliersApi {
   ...
   * @param metricType The benchmark to measure outlier metrics (required)
   * @param startDate Date in the format YYYY-MM-DD (required)
   * @param endDate Date in the format YYYY-MM-DD (required)
   * @param country The two character ISO country code of the trading region, like US. EMEA is used for the European trading region (optional)
   * @param trader Optionally specify a trader to filter by, Example : Ryan (optional)
   * @param minPercent The winsorization min percentile values defining orders as outliers (optional, default to 2.5)
   * @param maxPercent The winsorization max percentile values defining orders as outliers (optional, default to 97.5)
   * @param binScalar number of bins to distribute the orders (optional, default to 51)
   ...
   */
  public OutlierResponseRoot getOutlierMetricsByPercentile(String metricType, LocalDate startDate, LocalDate endDate, String country, String trader, Float minPercent, Float maxPercent, Integer binScalar) throws ApiException {
    return getOutlierMetricsByPercentileWithHttpInfo(metricType, startDate, endDate, country, trader, minPercent, maxPercent, binScalar).getData();
  }
   ...
   */
  public ApiResponse<OutlierResponseRoot> getOutlierMetricsByPercentileWithHttpInfo(String metricType, LocalDate startDate, LocalDate endDate, String country, String trader, Float minPercent, Float maxPercent, Integer binScalar) throws ApiException {
   ...
   * @param country The two character ISO country code of the trading region, like US. EMEA is used for the European trading region (optional)
   * @param trader Optionally specify a trader to filter by, Example : Ryan (optional)
   * @param deviation The winsorization deviation - standard deviation to define orders as outlier (optional, default to 2)
   * @param binScalar number of bins to distribute the orders (optional, default to 51)
   * @return OutlierResponseRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
   ...
   */
  public OutlierResponseRoot getOutlierMetricsStandard(String metricType, LocalDate startDate, LocalDate endDate, String country, String trader, Float deviation, Integer binScalar) throws ApiException {
    return getOutlierMetricsStandardWithHttpInfo(metricType, startDate, endDate, country, trader, deviation, binScalar).getData();
  }
   ...
   */
  public ApiResponse<OutlierResponseRoot> getOutlierMetricsStandardWithHttpInfo(String metricType, LocalDate startDate, LocalDate endDate, String country, String trader, Float deviation, Integer binScalar) throws ApiException {
    Object localVarPostBody = null;
