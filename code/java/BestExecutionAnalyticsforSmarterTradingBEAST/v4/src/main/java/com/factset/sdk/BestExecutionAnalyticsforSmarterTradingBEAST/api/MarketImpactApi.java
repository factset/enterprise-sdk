...
public class MarketImpactApi {
   ...
   * Get Cost Impact
   * Get Cost Impact
   * @param securityId ISIN for European or India securities, otherwise TICKER. Works together with country and currency parameters. (required)
   ...
   */
  public CostImpactResponseRootV3 getCostImpactV3(String securityId, String orderVolume, String country, String currency, String strategy, java.util.List<String> riskAversion, LocalDate date, String startTime, String endTime, Boolean isMomentum, String side, Boolean peer, Float frontLoadHalfLife, Float rearLoadHalfLife, Float rearRatio, Boolean binsData) throws ApiException {
    return getCostImpactV3WithHttpInfo(securityId, orderVolume, country, currency, strategy, riskAversion, date, startTime, endTime, isMomentum, side, peer, frontLoadHalfLife, rearLoadHalfLife, rearRatio, binsData).getData();
  }
   ...
   */
  public ApiResponse<CostImpactResponseRootV3> getCostImpactV3WithHttpInfo(String securityId, String orderVolume, String country, String currency, String strategy, java.util.List<String> riskAversion, LocalDate date, String startTime, String endTime, Boolean isMomentum, String side, Boolean peer, Float frontLoadHalfLife, Float rearLoadHalfLife, Float rearRatio, Boolean binsData) throws ApiException {
