...
public class FinancialsRequest implements Serializable {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2019-12-31", required = true, value = "The end date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint. ")
