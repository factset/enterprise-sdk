...
import com.factset.sdk.FactSetPrivateMarkets.models.ErrorResponseSubErrors;
...
public class ErrorResponse implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "/factset-private-markets/v1/{end-point}", value = "The Endpoint path {package}/version/{endpoint}")
