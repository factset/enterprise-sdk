...
public class EventsAudioData implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, fileName, durationSecs, endOffsetSeconds, startOffsetSeconds, sourceCode, startTime, endTime, uploadTime, fileSize, reportId, ticker, entityId, trimmed, sampleRate, bitrate);
  }
