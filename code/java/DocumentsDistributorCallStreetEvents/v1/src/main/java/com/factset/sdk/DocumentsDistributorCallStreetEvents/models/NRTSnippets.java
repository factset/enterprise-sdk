...
import com.factset.sdk.DocumentsDistributorCallStreetEvents.models.NRTSnippetsData;
...
public class NRTSnippets implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<NRTSnippetsData> data = null;
  ...
  public NRTSnippets addDataItem(NRTSnippetsData dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<NRTSnippetsData> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<NRTSnippetsData> data) {
    this.data = data;
  }


  public NRTSnippets meta(NRTSnippetsMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this NRT-Snippets object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NRTSnippets nrTSnippets = (NRTSnippets) o;
    return Objects.equals(this.data, nrTSnippets.data) &&
        Objects.equals(this.meta, nrTSnippets.meta);
  }
