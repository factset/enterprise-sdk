...
import com.factset.sdk.DocumentsDistributorCallStreetEvents.models.IndexedNRTMeta;
...
public class IndexedNRT implements Serializable {
  ...
  **/
  ...
  public IndexedNRT meta(IndexedNRTMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(IndexedNRTMeta meta) {
    this.meta = meta;
  }


  /**
   * Return true if this Indexed-NRT object is equal to o.
   */
  @Override
