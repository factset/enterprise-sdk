...
import com.factset.sdk.DocumentsDistributorCallStreetEvents.models.NRTSnippetsMeta;
...
public class IndexedNRT implements Serializable {
  ...
  **/
  ...
  public IndexedNRT meta(NRTSnippetsMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public NRTSnippetsMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(NRTSnippetsMeta meta) {
    this.meta = meta;
  }
