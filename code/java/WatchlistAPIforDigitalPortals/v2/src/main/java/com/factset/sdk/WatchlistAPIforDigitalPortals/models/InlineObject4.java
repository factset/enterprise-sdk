...
import com.factset.sdk.WatchlistAPIforDigitalPortals.models.WatchlistPositionDeleteData;
...
public class InlineObject4 implements Serializable {
  ...
  public InlineObject4 data(WatchlistPositionDeleteData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public InlineObject4 meta(WatchlistCreateMeta meta) {
    this.meta = meta;
    return this;
  }
