...
import com.factset.sdk.WatchlistAPIforDigitalPortals.models.WatchlistDeleteData;
...
public class InlineObject1 implements Serializable {
  ...
  private WatchlistDeleteData data;
  ...
  public InlineObject1 data(WatchlistDeleteData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public WatchlistDeleteData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(WatchlistDeleteData data) {
    this.data = data;
  }
