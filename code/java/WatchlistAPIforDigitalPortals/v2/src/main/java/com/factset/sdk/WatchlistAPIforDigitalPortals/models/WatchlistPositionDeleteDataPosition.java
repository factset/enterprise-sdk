...
@JsonPropertyOrder({
  WatchlistPositionDeleteDataPosition.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class WatchlistPositionDeleteDataPosition implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private BigDecimal id;

  public WatchlistPositionDeleteDataPosition() { 
  }
  ...
  public WatchlistPositionDeleteDataPosition id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Identifier of a position.")
  ...
  /**
   * Return true if this _watchlist_position_delete_data_position object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WatchlistPositionDeleteDataPosition watchlistPositionDeleteDataPosition = (WatchlistPositionDeleteDataPosition) o;
    return Objects.equals(this.id, watchlistPositionDeleteDataPosition.id);
  }
