...
import com.factset.sdk.WatchlistAPIforDigitalPortals.models.WatchlistPositionGetData;
...
public class InlineObject5 implements Serializable {
  ...
  private WatchlistPositionGetData data;
  ...
  public InlineObject5 data(WatchlistPositionGetData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public WatchlistPositionGetData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(WatchlistPositionGetData data) {
    this.data = data;
  }
