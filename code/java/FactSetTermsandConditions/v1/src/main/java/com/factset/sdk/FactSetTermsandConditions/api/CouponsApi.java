...
public class CouponsApi {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Coupon History Response </td><td>  -  </td></tr>
   ...
   */
  public CouponHistoryResponse getCouponHistory(java.util.List<String> ids) throws ApiException {
    return getCouponHistoryWithHttpInfo(ids).getData();
  }
   ...
   * Returns historical Coupon information for the Fixed Income security. 
   * @param ids List of Fixed Income Security identifiers. Supported symbol types include CUSIP, SEDOL, ISIN, and FactSet Security Permanent Identifier (-S).  **ID LIMIT &#x3D; 250** *per request*.  (required)
   * @return ApiResponse&lt;CouponHistoryResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<CouponHistoryResponse> getCouponHistoryWithHttpInfo(java.util.List<String> ids) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getCouponHistory");
    }
    
    // create path and map variables
    String localVarPath = "/factset-terms-and-conditions/v1/coupon-history";
   ...
   * @param termsAndConditionsScalarRequest Request object for Fixed Income Coupon History. (required)
   * @return CouponHistoryResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public CouponHistoryResponse getCouponHistoryForList(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest) throws ApiException {
    return getCouponHistoryForListWithHttpInfo(termsAndConditionsScalarRequest).getData();
  }
   ...
   */
  public ApiResponse<CouponHistoryResponse> getCouponHistoryForListWithHttpInfo(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest) throws ApiException {
    ...
    if (termsAndConditionsScalarRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'termsAndConditionsScalarRequest' when calling getCouponHistoryForList");
    }
   ...
   * @param ids List of Fixed Income Security identifiers. Supported symbol types include CUSIP, SEDOL, ISIN, and FactSet Security Permanent Identifier (-S).  **ID LIMIT &#x3D; 250** *per request*.  (required)
   * @return CouponSchedulesResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Coupon Schedules Response </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public CouponSchedulesResponse getCouponSchedules(java.util.List<String> ids) throws ApiException {
    return getCouponSchedulesWithHttpInfo(ids).getData();
  }
   ...
   * Returns Coupon Schedules information for the Fixed Income security. 
   * @param ids List of Fixed Income Security identifiers. Supported symbol types include CUSIP, SEDOL, ISIN, and FactSet Security Permanent Identifier (-S).  **ID LIMIT &#x3D; 250** *per request*.  (required)
   * @return ApiResponse&lt;CouponSchedulesResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<CouponSchedulesResponse> getCouponSchedulesWithHttpInfo(java.util.List<String> ids) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getCouponSchedules");
    }
    
    // create path and map variables
    String localVarPath = "/factset-terms-and-conditions/v1/coupon-schedules";
   ...
   * @param termsAndConditionsScalarRequest Request object for Fixed Income Coupon Schedules. (required)
   * @return CouponSchedulesResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public CouponSchedulesResponse getCouponSchedulesForList(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest) throws ApiException {
    return getCouponSchedulesForListWithHttpInfo(termsAndConditionsScalarRequest).getData();
  }
   ...
   */
  public ApiResponse<CouponSchedulesResponse> getCouponSchedulesForListWithHttpInfo(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest) throws ApiException {
    Object localVarPostBody = termsAndConditionsScalarRequest;
    
    // verify the required parameter 'termsAndConditionsScalarRequest' is set
    if (termsAndConditionsScalarRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'termsAndConditionsScalarRequest' when calling getCouponSchedulesForList");
    }
