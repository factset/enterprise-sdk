...
import com.factset.sdk.FactSetTermsandConditions.models.UseOfProceedsResponse;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class UseOfProceedsApi {
  private ApiClient apiClient;

  public UseOfProceedsApi() {
   ...
   * @return UseOfProceedsResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Fixed Income Use of Proceeds Response </td><td>  -  </td></tr>
   ...
   */
  public UseOfProceedsResponse getFixedIncomeUseOfProceeds(java.util.List<String> ids) throws ApiException {
    return getFixedIncomeUseOfProceedsWithHttpInfo(ids).getData();
  }
   ...
   * Returns Use of Proceeds for the Fixed Income security. 
   * @param ids List of Fixed Income Security identifiers. Supported symbol types include CUSIP, SEDOL, ISIN, and FactSet Security Permanent Identifier (-S).  **ID LIMIT &#x3D; 250** *per request*.  (required)
   * @return ApiResponse&lt;UseOfProceedsResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<UseOfProceedsResponse> getFixedIncomeUseOfProceedsWithHttpInfo(java.util.List<String> ids) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getFixedIncomeUseOfProceeds");
    }
    
    // create path and map variables
    String localVarPath = "/factset-terms-and-conditions/v1/use-of-proceeds";
   ...
   * @param termsAndConditionsScalarRequest Request object for Fixed Income Use of Proceeds. (required)
   * @return UseOfProceedsResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public UseOfProceedsResponse getFixedIncomeUseOfProceedsForList(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest) throws ApiException {
    return getFixedIncomeUseOfProceedsForListWithHttpInfo(termsAndConditionsScalarRequest).getData();
  }
   ...
   */
  public ApiResponse<UseOfProceedsResponse> getFixedIncomeUseOfProceedsForListWithHttpInfo(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest) throws ApiException {
    ...
    if (termsAndConditionsScalarRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'termsAndConditionsScalarRequest' when calling getFixedIncomeUseOfProceedsForList");
    }
