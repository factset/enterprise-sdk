...
import com.factset.sdk.FactSetTermsandConditions.api.UnderwritersApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        UnderwritersApi apiInstance = new UnderwritersApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling UnderwritersApi#getLeadUnderwriters");
...
public class Example {
    public static void main(String[] args) {
        ...
        UnderwritersApi apiInstance = new UnderwritersApi(defaultClient);
        TermsAndConditionsScalarRequest termsAndConditionsScalarRequest = new TermsAndConditionsScalarRequest(); // TermsAndConditionsScalarRequest | Request object for Fixed Income Lead Underwriters.
        try {
            LeadUnderwritersResponse result = apiInstance.getLeadUnderwritersForList(termsAndConditionsScalarRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling UnderwritersApi#getLeadUnderwritersForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
