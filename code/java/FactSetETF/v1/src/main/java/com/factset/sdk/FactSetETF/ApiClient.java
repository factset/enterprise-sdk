...
import com.factset.sdk.FactSetETF.auth.Authentication;
import com.factset.sdk.FactSetETF.auth.HttpBasicAuth;
import com.factset.sdk.FactSetETF.auth.HttpBearerAuth;
import com.factset.sdk.FactSetETF.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetETF.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetETF/2.0.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetETF.ApiClient} object.
   */
