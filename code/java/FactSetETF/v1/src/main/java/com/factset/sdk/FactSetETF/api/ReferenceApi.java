...
import com.factset.sdk.FactSetETF.models.EtfReferenceDataRequest;
import com.factset.sdk.FactSetETF.models.EtfReferenceDataResponse;
...
public class ReferenceApi {
   ...
   */
  public EtfReferenceDataResponse getEtfReferenceData(java.util.List<String> ids, java.util.List<String> metrics, java.util.List<Category> categories) throws ApiException {
    return getEtfReferenceDataWithHttpInfo(ids, metrics, categories).getData();
  }
   ...
   * @param metrics List of individdual data items for Exchange Traded Funds. By default only the fsymId and requestId are returned. To fetch a list of all available data items, use the **_/metrics** endpoint.  (optional)
   * @param categories Groupings of &#x60;metrics&#x60; data items. Supply a list of categories below to return collections of data items in response. |category|description| |---|---| |BENCHMARK_DETAILS|Details surrounding the underlying Benchmark Id and Segment Banchmark| |CLASSIFICATION|FactSet Fund Classification Codes and Names, across Asset Class, Broad  Geography, Fund Categories, Focus, Niche, and more.| |COSTS_FEES|Expenses and Fees such as capital gains, expense ratio, management fees, and more.| |COUNTERPARTY|Credit and Swap Counterparty details| |CREATE_REDEEM|Creation and Redemption Sizes| |DESCRIPTIVE|General Descriptive information such as name, objectives, issuer details, launch dates, website, and more.| |DISTRIBUTIONS|Dividend Dates, Dividend Treatmetns, Min/Max Cap Gains| |DOCUMENTATION|Details surrounding reporting information.| |GEARING|Leverage factors, inverse flags, and more.| |HEDGE|Hedging Information| |RISK|CIFSC Risk Ratings| |SERVICE_PROVIDERS|Distributors, issuers, and Advisor details| |STATUS|Actively Managed Flags| |STRATEGY|Segment Codes, selection criteria, strategy codes, weighting schemes, and lending details.| |STRUCTURE|ETF Type, backing codes, synthetic types, ucits compliance, legal structures, and more.| |TAX|Tax Types, distribution takes, K1 Flags, and more.|  (optional)
   * @return ApiResponse&lt;EtfReferenceDataResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<EtfReferenceDataResponse> getEtfReferenceDataWithHttpInfo(java.util.List<String> ids, java.util.List<String> metrics, java.util.List<Category> categories) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getEtfReferenceData");
    }
    
    // create path and map variables
    String localVarPath = "/factset-etf/v1/reference";
   ...
   * @param etfReferenceDataRequest Request object for Exchange Traded Funds (required)
   * @return EtfReferenceDataResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public EtfReferenceDataResponse getEtfReferenceDataForList(EtfReferenceDataRequest etfReferenceDataRequest) throws ApiException {
    return getEtfReferenceDataForListWithHttpInfo(etfReferenceDataRequest).getData();
  }
   ...
   */
  public ApiResponse<EtfReferenceDataResponse> getEtfReferenceDataForListWithHttpInfo(EtfReferenceDataRequest etfReferenceDataRequest) throws ApiException {
    Object localVarPostBody = etfReferenceDataRequest;
    
    // verify the required parameter 'etfReferenceDataRequest' is set
    if (etfReferenceDataRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'etfReferenceDataRequest' when calling getEtfReferenceDataForList");
    }
