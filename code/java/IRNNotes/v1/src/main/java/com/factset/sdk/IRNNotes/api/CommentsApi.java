...
public class CommentsApi {
   ...
   */
  public NewItemDto createCommentAttachment(java.util.UUID noteId, java.util.UUID commentId, File file) throws ApiException {
    return createCommentAttachmentWithHttpInfo(noteId, commentId, file).getData();
  }
   ...
   */
  public ApiResponse<NewItemDto> createCommentAttachmentWithHttpInfo(java.util.UUID noteId, java.util.UUID commentId, File file) throws ApiException {
