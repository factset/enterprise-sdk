package com.factset.sdk.FactSetTrading;
...
import com.factset.sdk.FactSetTrading.auth.Authentication;
import com.factset.sdk.FactSetTrading.auth.HttpBasicAuth;
import com.factset.sdk.FactSetTrading.auth.HttpBearerAuth;
import com.factset.sdk.FactSetTrading.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetTrading.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/trading/ems/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/trading/ems/v0",
      "Production",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.uat.factset.com/trading/ems/v0",
      "UAT",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetTrading/0.26.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetTrading.ApiClient} object.
   */
