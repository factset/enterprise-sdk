...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsettrading:0.21.2"
  }
```
...
## Documentation for Models
 ...
 - [EMSCancelOrdersDataMetaModel](docs/EMSCancelOrdersDataMetaModel.md)
 ...
 - [EMSOrdersCreateResponseEmsResponse](docs/EMSOrdersCreateResponseEmsResponse.md)
 - [EMSOrdersDataMetaModel](docs/EMSOrdersDataMetaModel.md)
 - [EMSReplaceOrder](docs/EMSReplaceOrder.md)
 - [EMSReplaceOrders](docs/EMSReplaceOrders.md)
 - [EMSReplaceOrdersDataMetaModel](docs/EMSReplaceOrdersDataMetaModel.md)
 - [Error](docs/Error.md)
