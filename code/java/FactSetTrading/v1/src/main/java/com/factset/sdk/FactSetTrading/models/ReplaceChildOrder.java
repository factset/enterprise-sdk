 ...
 * Replace Child Order
 */
@ApiModel(description = "Replace Child Order")
@JsonPropertyOrder({
...
public class ReplaceChildOrder implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "100.01", value = "Number of shares/Quantity to be routed. Must be less than or equal to the orderQuantity of the parent order.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "120.01", value = "Stop-loss price to buy/sell stock at market.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "200.01", value = "Maximum number of shares within an order to be shown on the exchange floor at any given time.")
  @JsonIgnore
