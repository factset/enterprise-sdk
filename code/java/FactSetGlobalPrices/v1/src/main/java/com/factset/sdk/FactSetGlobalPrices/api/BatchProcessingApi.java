...
import com.factset.sdk.FactSetGlobalPrices.models.BatchErrorResponse;
...
public class BatchProcessingApi {
  ...
  static {
    ...
    getBatchDataResponseTypeMap.put(404, new GenericType<BatchErrorResponse>(){});
  }
  ...
  static {
    ...
    getBatchStatusResponseTypeMap.put(404, new GenericType<BatchErrorResponse>(){});
  }

  
 /**
   * Wrapper to support GET /factset-global-prices/v1/batch-result returning different types
   * per status code.
   *
   * <p>
   * Responses:
