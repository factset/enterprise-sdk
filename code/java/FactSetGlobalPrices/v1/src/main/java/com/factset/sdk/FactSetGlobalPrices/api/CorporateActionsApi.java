...
public class CorporateActionsApi {
   ...
   */
  public CorporateActionsResponse getGPDCorporateActions(java.util.List<String> ids, String eventCategory, java.util.List<String> fields, String startDate, String endDate, String currency) throws ApiException {
    return getGPDCorporateActionsWithHttpInfo(ids, eventCategory, fields, startDate, endDate, currency).getData();
  }
   ...
   */
  public ApiResponse<CorporateActionsResponse> getGPDCorporateActionsWithHttpInfo(java.util.List<String> ids, String eventCategory, java.util.List<String> fields, String startDate, String endDate, String currency) throws ApiException {
    ...
    GenericType<CorporateActionsResponse> localVarReturnType = new GenericType<CorporateActionsResponse>() {};

    return apiClient.invokeAPI("CorporateActionsApi.getGPDCorporateActions", localVarPath, "GET", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<CorporateActionsResponse> postCorporateActionsWithHttpInfo(CorporateActionsRequest corporateActionsRequest) throws ApiException {
    ...
    return apiClient.invokeAPI("CorporateActionsApi.postCorporateActions", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
