...
@JsonPropertyOrder({
  ...
  GlobalPricesRequest.JSON_PROPERTY_PRECISION,
...
public class GlobalPricesRequest implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"FDS-US\"]", required = true, value = "The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent IDs.  <p>IDs limit =  500 per non-batch request / 2000 per batch request for a single day and 50 per multi-day request for both batch and non-batch. </p> ")
  ...
  **/
  ...
  public GlobalPricesRequest precision(Integer precision) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Specifies the number of decimal places for price fields in the response.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ids, globalPricesRequest.ids) &&
        ...
        Objects.equals(this.precision, globalPricesRequest.precision) &&
        Objects.equals(this.batch, globalPricesRequest.batch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, fields, startDate, endDate, frequency, currency, calendar, adjust, precision, batch);
  }
