...
public class ReturnsRequest implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"TSLA-US\"]", required = true, value = "The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids. Requests are limited to 50 IDs. ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ids, startDate, endDate, currency, frequency, dividendAdjust);
  }
