...
public class BatchResult extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class BatchResultDeserializer extends StdDeserializer<BatchResult> {
        ...
        public BatchResult deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize MarketValueResponseObject
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<MarketValueResponseObject>(){});
                BatchResult ret = new BatchResult();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
    ...
    public BatchResult(MarketValueResponseObject o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("MarketValueResponseObject", new GenericType<MarketValueResponseObject>() {
        });
     ...
     * AnnualizedDividendsObject, CorporateAction, MarketValueResponseObject, Price, Returns, SharesOutstandingResponseObject
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(MarketValueResponseObject.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be AnnualizedDividendsObject, CorporateAction, MarketValueResponseObject, Price, Returns, SharesOutstandingResponseObject");
    }
     ...
     * AnnualizedDividendsObject, CorporateAction, MarketValueResponseObject, Price, Returns, SharesOutstandingResponseObject
     *
     * @return The actual instance (AnnualizedDividendsObject, CorporateAction, MarketValueResponseObject, Price, Returns, SharesOutstandingResponseObject)
     */
    @Override
    ...
    /**
     * Get the actual instance of `MarketValueResponseObject`.
     * If the actual instance is not `MarketValueResponseObject`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `MarketValueResponseObject`
     * @throws ClassCastException if the instance is not `MarketValueResponseObject`
     */
    public MarketValueResponseObject getMarketValueResponseObject() throws ClassCastException {
        return (MarketValueResponseObject)super.getActualInstance();
    }
