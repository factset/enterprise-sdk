 ...
 * Range Request Body
 */
@ApiModel(description = "Range Request Body")
@JsonPropertyOrder({
  RangeRequest.JSON_PROPERTY_IDS,
  RangeRequest.JSON_PROPERTY_START_DATE,
  RangeRequest.JSON_PROPERTY_END_DATE,
  RangeRequest.JSON_PROPERTY_CURRENCY,
  RangeRequest.JSON_PROPERTY_DIVIDEND_ADJUST,
  RangeRequest.JSON_PROPERTY_BATCH
})
...
public class RangeRequest implements Serializable {
  ...
  public RangeRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public RangeRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public RangeRequest startDate(String startDate) {
    this.startDate = startDate;
    return this;
  }
  ...
  **/
  ...
  public RangeRequest endDate(String endDate) {
    this.endDate = endDate;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "2021-08-27", required = true, value = "The end date requested for a given date range in **YYYY-MM-DD** format. The input end date is required and must come after the input start date. Future dates (T+1) are not accepted in this endpoint. ")
  ...
  public RangeRequest currency(String currency) {
  ...
  **/
  ...
  public RangeRequest dividendAdjust(DividendAdjust dividendAdjust) {
  ...
  **/
  ...
  public RangeRequest batch(Batch batch) {
    this.batch = batch;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this RangeRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RangeRequest rangeRequest = (RangeRequest) o;
    return Objects.equals(this.ids, rangeRequest.ids) &&
        Objects.equals(this.startDate, rangeRequest.startDate) &&
        Objects.equals(this.endDate, rangeRequest.endDate) &&
        Objects.equals(this.currency, rangeRequest.currency) &&
        Objects.equals(this.dividendAdjust, rangeRequest.dividendAdjust) &&
        Objects.equals(this.batch, rangeRequest.batch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, startDate, endDate, currency, dividendAdjust, batch);
  }
