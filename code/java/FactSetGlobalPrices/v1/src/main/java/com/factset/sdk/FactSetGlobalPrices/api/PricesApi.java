...
public class PricesApi {
   ...
   */
  public GlobalPricesResponse getGPDPrices(java.util.List<String> ids, String startDate, String endDate, java.util.List<String> fields, String frequency, String calendar, String currency, String adjust) throws ApiException {
    return getGPDPricesWithHttpInfo(ids, startDate, endDate, fields, frequency, calendar, currency, adjust).getData();
  }
   ...
   */
  public ApiResponse<GlobalPricesResponse> getGPDPricesWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, java.util.List<String> fields, String frequency, String calendar, String currency, String adjust) throws ApiException {
    ...
    if (endDate == null) {
      throw new ApiException(400, "Missing the required parameter 'endDate' when calling getGPDPrices");
    }
