...
public class BatchErrorResponse implements Serializable {
  ...
  private JsonNullable<java.util.List<BatchErrorObject>> errors = JsonNullable.<java.util.List<BatchErrorObject>>undefined();

  public BatchErrorResponse() { 
  }

  public BatchErrorResponse errors(java.util.List<BatchErrorObject> errors) {
    this.errors = JsonNullable.<java.util.List<BatchErrorObject>>of(errors);
    return this;
  }

  public BatchErrorResponse addErrorsItem(BatchErrorObject errorsItem) {
    if (this.errors == null || !this.errors.isPresent()) {
      this.errors = JsonNullable.<java.util.List<BatchErrorObject>>of(new java.util.ArrayList<>());
    }
    try {
  ...
  **/
  ...
  public java.util.List<BatchErrorObject> getErrors() {
  ...
  public JsonNullable<java.util.List<BatchErrorObject>> getErrors_JsonNullable() {
    return errors;
  }
  
  @JsonProperty(JSON_PROPERTY_ERRORS)
  public void setErrors_JsonNullable(JsonNullable<java.util.List<BatchErrorObject>> errors) {
    this.errors = errors;
  }

  public void setErrors(java.util.List<BatchErrorObject> errors) {
    this.errors = JsonNullable.<java.util.List<BatchErrorObject>>of(errors);
  }
