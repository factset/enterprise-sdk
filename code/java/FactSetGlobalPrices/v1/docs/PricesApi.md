...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        Integer precision = 2; // Integer | Specifies the number of decimal places for price fields in the response. 
 ...
 **precision** | **Integer**| Specifies the number of decimal places for price fields in the response.  | [optional] [default to 2]
