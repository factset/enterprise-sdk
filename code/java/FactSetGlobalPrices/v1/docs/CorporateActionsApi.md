...
> CorporateActionsResponse getGPDCorporateActions(ids, eventCategory, fields, startDate, endDate, currency, cancelledDividend)
...
> AnnualizedDividendResponse getannualizedDividends(ids, currency)

Gets Indicated Annualized Dividend information.

Gets the Annualized dividend or the latest reported dividend.
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String currency = "USD"; // String | Currency code for adjusting prices. Default is Local. For a list of currency ISO codes, visit [Online Assistant Page 1470](https://oa.apps.factset.com/pages/1470).
        try {
            AnnualizedDividendResponse result = apiInstance.getannualizedDividends(ids, currency);
            System.out.println(result);
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            AnnualizedDividendResponse result = apiInstance.getannualizedDividendsForList(annualizedDividendsRequest);
            System.out.println(result);
