...
> GetRangeResponseWrapper getRange(ids, startDate, endDate, currency, dividendAdjust, batch)
...
import com.factset.sdk.FactSetGlobalPrices.api.ReturnsApi.GetRangeResponseWrapper;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String endDate = "2021-08-27"; // String | The end date requested for a given date range in **YYYY-MM-DD** format. The input end date is required and must come after the input start date. Future dates (T+1) are not accepted in this endpoint. 
        ...
        try {
            GetRangeResponseWrapper result = apiInstance.getRange(ids, startDate, endDate, currency, dividendAdjust, batch);
            switch(result.getStatusCode()) {
            
                case 200:
                    System.out.println(result.getResponse200()); // RangeResponse
            ...
            System.err.println("Exception when calling ReturnsApi#getRange");
...
> GetReturnsRangeForListResponseWrapper getReturnsRangeForList(rangeRequest)
...
import com.factset.sdk.FactSetGlobalPrices.models.*;
import com.factset.sdk.FactSetGlobalPrices.api.ReturnsApi;
import com.factset.sdk.FactSetGlobalPrices.api.ReturnsApi.GetReturnsRangeForListResponseWrapper;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ReturnsApi apiInstance = new ReturnsApi(defaultClient);
        RangeRequest rangeRequest = new RangeRequest(); // RangeRequest | Request object for `ReturnsRange`.
        try {
            GetReturnsRangeForListResponseWrapper result = apiInstance.getReturnsRangeForList(rangeRequest);
            switch(result.getStatusCode()) {
            ...
            System.err.println("Exception when calling ReturnsApi#getReturnsRangeForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
