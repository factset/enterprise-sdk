package com.factset.sdk.SecurityIntelligence;
...
import com.factset.sdk.SecurityIntelligence.auth.Authentication;
import com.factset.sdk.SecurityIntelligence.auth.HttpBasicAuth;
import com.factset.sdk.SecurityIntelligence.auth.HttpBearerAuth;
import com.factset.sdk.SecurityIntelligence.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.SecurityIntelligence.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/security-intelligence/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/security-intelligence/v1",
      "Production Server",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/SecurityIntelligence/0.1.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.SecurityIntelligence.ApiClient} object.
   */
