...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/securityintelligence/0.1.2)](https://central.sonatype.com/artifact/com.factset.sdk/securityintelligence/0.1.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:securityintelligence:0.1.2"
  }
```
