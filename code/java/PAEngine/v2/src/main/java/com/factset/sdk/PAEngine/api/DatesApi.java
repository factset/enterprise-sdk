...
import com.factset.sdk.PAEngine.models.DateParametersSummary;
...
public class DatesApi {
  ...
  static {
    convertPADatesToAbsoluteFormatResponseTypeMap.put(200, new GenericType<DateParametersSummary>(){});
  }
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Expected response, returns the converted dates in yyyymmdd format. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 400 </td><td> Invalid query parameter or value is provided. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       ...
       <tr><td> 404 </td><td> Document or account not found. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public DateParametersSummary convertPADatesToAbsoluteFormat(String enddate, String componentid, String account, String startdate) throws ApiException {
   ...
   * @param account Account (required)
   * @param startdate Start Date (optional, default to -3AY)
   * @return ApiResponse&lt;DateParametersSummary&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<DateParametersSummary> convertPADatesToAbsoluteFormatWithHttpInfo(String enddate, String componentid, String account, String startdate) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'enddate' is set
    if (enddate == null) {
      throw new ApiException(400, "Missing the required parameter 'enddate' when calling convertPADatesToAbsoluteFormat");
    }
    
    // verify the required parameter 'componentid' is set
    if (componentid == null) {
      throw new ApiException(400, "Missing the required parameter 'componentid' when calling convertPADatesToAbsoluteFormat");
    }
    
    // verify the required parameter 'account' is set
    if (account == null) {
      throw new ApiException(400, "Missing the required parameter 'account' when calling convertPADatesToAbsoluteFormat");
    }
    
    // create path and map variables
    String localVarPath = "/analytics/lookups/v2/engines/pa/dates";
