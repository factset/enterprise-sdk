...
import com.factset.sdk.PAEngine.models.DocumentDirectories;
...
public class DocumentsApi {
  ...
  public DocumentsApi(ApiClient apiClient) {
    ...
    private static final Map<Integer, GenericType> getPA3DocumentsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getPA3DocumentsResponseTypeMap.put(200, new GenericType<DocumentDirectories>(){});
  }
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Expected response, returns a list of PA3 documents and directories </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
  ...
  public ApiResponse<DocumentDirectories> getPA3DocumentsWithHttpInfo(String path) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("DocumentsApi.getPA3Documents", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getPA3DocumentsResponseTypeMap, false);
