...
> java.util.Map&lt;String, ColumnStatistic&gt; getPAColumnStatistics()
...
import com.factset.sdk.PAEngine.api.ColumnStatisticsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            java.util.Map<String, ColumnStatistic> result = apiInstance.getPAColumnStatistics();
...
[**java.util.Map&lt;String, ColumnStatistic&gt;**](ColumnStatistic.md)
