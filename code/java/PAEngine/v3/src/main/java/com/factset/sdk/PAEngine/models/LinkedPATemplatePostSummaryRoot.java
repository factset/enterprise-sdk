...
import com.factset.sdk.PAEngine.models.LinkedPATemplatePostSummary;
...
public class LinkedPATemplatePostSummaryRoot implements Serializable {
  ...
  @JsonCreator
  public LinkedPATemplatePostSummaryRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) LinkedPATemplatePostSummary data
  ) {
    this();
    this.data = data;
  }
