...
import com.factset.sdk.PAEngine.auth.Authentication;
import com.factset.sdk.PAEngine.auth.HttpBasicAuth;
import com.factset.sdk.PAEngine.auth.HttpBearerAuth;
import com.factset.sdk.PAEngine.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.PAEngine.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/PAEngine/3.2.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.PAEngine.ApiClient} object.
   */
