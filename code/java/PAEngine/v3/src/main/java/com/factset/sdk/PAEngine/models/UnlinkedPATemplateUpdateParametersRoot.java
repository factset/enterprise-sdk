...
import com.factset.sdk.PAEngine.models.UnlinkedPATemplateUpdateParameters;
...
public class UnlinkedPATemplateUpdateParametersRoot implements Serializable {
  ...
  @JsonCreator
  public UnlinkedPATemplateUpdateParametersRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) UnlinkedPATemplateUpdateParameters data
  ) {
    this();
    this.data = data;
  }
