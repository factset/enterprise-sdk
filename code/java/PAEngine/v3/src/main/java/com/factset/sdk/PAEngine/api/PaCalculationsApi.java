...
import com.factset.sdk.PAEngine.models.PACommentaryGetStatusRoot;
import com.factset.sdk.PAEngine.models.PACommentaryParametersRoot;
import com.factset.sdk.PAEngine.models.PACommentaryRoot;
import com.factset.sdk.PAEngine.models.PACommentaryStatusRoot;
...
public class PaCalculationsApi {
  ...
  private static final Map<Integer, GenericType> generatePAPortfolioCommentaryResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    generatePAPortfolioCommentaryResponseTypeMap.put(201, new GenericType<PACommentaryRoot>(){});
    generatePAPortfolioCommentaryResponseTypeMap.put(202, new GenericType<PACommentaryGetStatusRoot>(){});
    generatePAPortfolioCommentaryResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
  }
  ...
  static {
    getCalculationParametersResponseTypeMap.put(200, new GenericType<PACalculationParametersRoot>(){});
  ...
  private static final Map<Integer, GenericType> getPAPortfolioCommentaryResultByIdResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getPAPortfolioCommentaryResultByIdResponseTypeMap.put(200, new GenericType<PACommentaryRoot>(){});
    getPAPortfolioCommentaryResultByIdResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getPAPortfolioCommentaryStatusByIdResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getPAPortfolioCommentaryStatusByIdResponseTypeMap.put(200, new GenericType<PACommentaryStatusRoot>(){});
    getPAPortfolioCommentaryStatusByIdResponseTypeMap.put(202, new GenericType<PACommentaryGetStatusRoot>(){});
    getPAPortfolioCommentaryStatusByIdResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
  }
 ...
 /**
   ...
   */
  public GeneratePAPortfolioCommentaryResponseWrapper generatePAPortfolioCommentary(String id, String unitId, PACommentaryParametersRoot paCommentaryParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<GeneratePAPortfolioCommentaryResponseWrapper> generatePAPortfolioCommentaryWithHttpInfo(String id, String unitId, PACommentaryParametersRoot paCommentaryParametersRoot) throws ApiException {
    ...
    return new ApiResponse<GeneratePAPortfolioCommentaryResponseWrapper>(statusCode, apiResponse.getHeaders(), responseWrapper);
   ...
   */
  public ApiResponse<GetPAPortfolioCommentaryStatusByIdResponseWrapper> getPAPortfolioCommentaryStatusByIdWithHttpInfo(String id, String unitId) throws ApiException {
    Object localVarPostBody = null;
    ...
    return new ApiResponse<GetPAPortfolioCommentaryStatusByIdResponseWrapper>(statusCode, apiResponse.getHeaders(), responseWrapper);
   ...
   */
  public ApiResponse<PostAndCalculateResponseWrapper> postAndCalculateWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, PACalculationParametersRoot paCalculationParametersRoot) throws ApiException {
...
if (cacheControl != null)
   ...
   */
  public ApiResponse<PutAndCalculateResponseWrapper> putAndCalculateWithHttpInfo(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, PACalculationParametersRoot paCalculationParametersRoot) throws ApiException {
    Object localVarPostBody = paCalculationParametersRoot;
