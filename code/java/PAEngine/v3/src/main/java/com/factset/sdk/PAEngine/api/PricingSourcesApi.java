...
import com.factset.sdk.PAEngine.models.PAPricingSourceRoot;
...
public class PricingSourcesApi {
   ...
   * @param name PA pricing sources name (optional, default to )
   * @param category PA pricing sources category (optional, default to )
   * @param directory The directory to get the PA pricing sources in (optional, default to )
   * @return PAPricingSourceRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Expected response, returns a list of PA pricing sources </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * Age - Standard HTTP header. Header will specify the age of pricing sources list cached response. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       ...
       <tr><td> 404 </td><td> Pricing sources not found. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public PAPricingSourceRoot getPAPricingSources(String name, String category, String directory) throws ApiException {
    return getPAPricingSourcesWithHttpInfo(name, category, directory).getData();
  }
   ...
   * @param category PA pricing sources category (optional, default to )
   * @param directory The directory to get the PA pricing sources in (optional, default to )
   * @return ApiResponse&lt;PAPricingSourceRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<PAPricingSourceRoot> getPAPricingSourcesWithHttpInfo(String name, String category, String directory) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/analytics/engines/pa/v3/pricing-sources";
    ...
    > apiResponse = apiClient.invokeAPI("PricingSourcesApi.getPAPricingSources", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getPAPricingSourcesResponseTypeMap, false);
