...
import com.factset.sdk.PAEngine.models.TemplatedPAComponentPostSummary;
...
public class TemplatedPAComponentPostSummaryRoot implements Serializable {
  ...
  @JsonCreator
  public TemplatedPAComponentPostSummaryRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) TemplatedPAComponentPostSummary data
  ) {
    this();
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, templatedPAComponentPostSummaryRoot.data) &&
        equalsNullable(this.meta, templatedPAComponentPostSummaryRoot.meta);
  }
