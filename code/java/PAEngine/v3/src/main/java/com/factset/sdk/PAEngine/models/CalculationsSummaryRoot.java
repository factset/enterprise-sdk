...
public class CalculationsSummaryRoot implements Serializable {
  ...
  private java.util.Map<String, CalculationsSummary> data = new java.util.HashMap<>();
  ...
  @JsonCreator
  public CalculationsSummaryRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.Map<String, CalculationsSummary> data
  ) {
    this();
    this.data = data;
  }
