...
import com.factset.sdk.PAEngine.models.LinkedPATemplateUpdateParameters;
...
public class LinkedPATemplateUpdateParametersRoot implements Serializable {
  ...
  @JsonCreator
  public LinkedPATemplateUpdateParametersRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) LinkedPATemplateUpdateParameters data
  ) {
    this();
    this.data = data;
  }
