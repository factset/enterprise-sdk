...
public class ColumnStatisticRoot implements Serializable {
  ...
  private java.util.Map<String, ColumnStatistic> data = new java.util.HashMap<>();
  ...
  @JsonCreator
  public ColumnStatisticRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.Map<String, ColumnStatistic> data
  ) {
    this();
    this.data = data;
  }
