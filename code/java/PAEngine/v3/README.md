...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/paengine/4.0.0)](https://central.sonatype.com/artifact/com.factset.sdk/paengine/4.0.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:paengine:4.0.0"
  }
```
...
*CalendarApi* | [**getPACalendars**](docs/CalendarApi.md#getPACalendars) | **GET** /analytics/engines/pa/v3/calendars | Get PA calendars
...
## Documentation for Models
 ...
 - [PACalendar](docs/PACalendar.md)
 - [PACalendarRoot](docs/PACalendarRoot.md)
