...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/paengine/3.2.3)](https://central.sonatype.com/artifact/com.factset.sdk/paengine/3.2.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:paengine:3.2.3"
  }
```
