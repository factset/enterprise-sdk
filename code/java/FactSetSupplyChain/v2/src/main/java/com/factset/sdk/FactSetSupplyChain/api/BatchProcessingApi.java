...
import com.factset.sdk.FactSetSupplyChain.models.BatchResultResponse;
import com.factset.sdk.FactSetSupplyChain.models.BatchStatusResponse;
...
public class BatchProcessingApi {
  ...
  static {
    ...
    getBatchDataResponseTypeMap.put(422, new GenericType<ErrorResponse>(){});
  ...
  static {
    ...
    getBatchStatusResponseTypeMap.put(422, new GenericType<ErrorResponse>(){});
