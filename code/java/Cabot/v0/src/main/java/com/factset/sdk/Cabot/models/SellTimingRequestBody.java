 ...
 */
@JsonPropertyOrder({
  SellTimingRequestBody.JSON_PROPERTY_ACCOUNT_PATH,
  SellTimingRequestBody.JSON_PROPERTY_BENCHMARK_PATH,
  SellTimingRequestBody.JSON_PROPERTY_PERIOD,
  SellTimingRequestBody.JSON_PROPERTY_ATTRIBUTE,
  SellTimingRequestBody.JSON_PROPERTY_SECTOR,
  SellTimingRequestBody.JSON_PROPERTY_REGION,
  SellTimingRequestBody.JSON_PROPERTY_HOLDINGS,
  SellTimingRequestBody.JSON_PROPERTY_CUSTOM_CLASSIFICATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SellTimingRequestBody implements Serializable {
  ...
  private SellTimingHoldings holdings;
  ...
  public SellTimingRequestBody accountPath(String accountPath) {
    this.accountPath = accountPath;
    return this;
  }
  ...
  **/
  ...
  public SellTimingRequestBody benchmarkPath(String benchmarkPath) {
    this.benchmarkPath = benchmarkPath;
    return this;
  }
  ...
  **/
  ...
  public SellTimingRequestBody period(String period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public SellTimingRequestBody attribute(Attributes attribute) {
  ...
  **/
  ...
  public SellTimingRequestBody sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public SellTimingRequestBody region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public SellTimingRequestBody holdings(SellTimingHoldings holdings) {
  ...
  **/
  ...
  public SellTimingHoldings getHoldings() {
    return holdings;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HOLDINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHoldings(SellTimingHoldings holdings) {
    this.holdings = holdings;
  }


  public SellTimingRequestBody customClassifications(java.util.Map<String, String> customClassifications) {
    this.customClassifications = customClassifications;
    return this;
  }

  public SellTimingRequestBody putCustomClassificationsItem(String key, String customClassificationsItem) {
  ...
  **/
  ...
  /**
   * Return true if this SellTimingRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SellTimingRequestBody sellTimingRequestBody = (SellTimingRequestBody) o;
    return Objects.equals(this.accountPath, sellTimingRequestBody.accountPath) &&
        Objects.equals(this.benchmarkPath, sellTimingRequestBody.benchmarkPath) &&
        Objects.equals(this.period, sellTimingRequestBody.period) &&
        Objects.equals(this.attribute, sellTimingRequestBody.attribute) &&
        Objects.equals(this.sector, sellTimingRequestBody.sector) &&
        Objects.equals(this.region, sellTimingRequestBody.region) &&
        Objects.equals(this.holdings, sellTimingRequestBody.holdings) &&
        Objects.equals(this.customClassifications, sellTimingRequestBody.customClassifications);
  }
  ...
  public String toString() {
    ...
    sb.append("class SellTimingRequestBody {\n");
