 ...
 */
@JsonPropertyOrder({
  BuyContextRequestBody.JSON_PROPERTY_ACCOUNT_PATH,
  BuyContextRequestBody.JSON_PROPERTY_BENCHMARK_PATH,
  BuyContextRequestBody.JSON_PROPERTY_PERIOD,
  BuyContextRequestBody.JSON_PROPERTY_ATTRIBUTE,
  BuyContextRequestBody.JSON_PROPERTY_SECTOR,
  BuyContextRequestBody.JSON_PROPERTY_REGION,
  BuyContextRequestBody.JSON_PROPERTY_CUSTOM_CLASSIFICATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class BuyContextRequestBody implements Serializable {
  ...
  public BuyContextRequestBody(
    ...
    @JsonProperty(value=JSON_PROPERTY_ATTRIBUTE, required=true) Attributes attribute
  ) {
    this();
  ...
  public BuyContextRequestBody accountPath(String accountPath) {
    this.accountPath = accountPath;
    return this;
  }
  ...
  **/
  ...
  public BuyContextRequestBody benchmarkPath(String benchmarkPath) {
    this.benchmarkPath = benchmarkPath;
    return this;
  }
  ...
  **/
  ...
  public BuyContextRequestBody period(String period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public BuyContextRequestBody attribute(Attributes attribute) {
    this.attribute = attribute;
    return this;
  }
  ...
  **/
  ...
  public BuyContextRequestBody sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public BuyContextRequestBody region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public BuyContextRequestBody customClassifications(java.util.Map<String, String> customClassifications) {
    this.customClassifications = customClassifications;
    return this;
  }

  public BuyContextRequestBody putCustomClassificationsItem(String key, String customClassificationsItem) {
  ...
  **/
  ...
  /**
   * Return true if this BuyContextRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BuyContextRequestBody buyContextRequestBody = (BuyContextRequestBody) o;
    return Objects.equals(this.accountPath, buyContextRequestBody.accountPath) &&
        Objects.equals(this.benchmarkPath, buyContextRequestBody.benchmarkPath) &&
        Objects.equals(this.period, buyContextRequestBody.period) &&
        Objects.equals(this.attribute, buyContextRequestBody.attribute) &&
        Objects.equals(this.sector, buyContextRequestBody.sector) &&
        Objects.equals(this.region, buyContextRequestBody.region) &&
        Objects.equals(this.customClassifications, buyContextRequestBody.customClassifications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountPath, benchmarkPath, period, attribute, sector, region, customClassifications);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BuyContextRequestBody {\n");
