 ...
 */
@JsonPropertyOrder({
  BuyTimingRequestBody.JSON_PROPERTY_ACCOUNT_PATH,
  BuyTimingRequestBody.JSON_PROPERTY_BENCHMARK_PATH,
  BuyTimingRequestBody.JSON_PROPERTY_PERIOD,
  BuyTimingRequestBody.JSON_PROPERTY_ATTRIBUTE,
  BuyTimingRequestBody.JSON_PROPERTY_SECTOR,
  BuyTimingRequestBody.JSON_PROPERTY_REGION,
  BuyTimingRequestBody.JSON_PROPERTY_HOLDINGS,
  BuyTimingRequestBody.JSON_PROPERTY_CUSTOM_CLASSIFICATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class BuyTimingRequestBody implements Serializable {
  ...
  private BuyTimingHoldings holdings;
  ...
  public BuyTimingRequestBody accountPath(String accountPath) {
    this.accountPath = accountPath;
    return this;
  }
  ...
  **/
  ...
  public BuyTimingRequestBody benchmarkPath(String benchmarkPath) {
    this.benchmarkPath = benchmarkPath;
    return this;
  }
  ...
  **/
  ...
  public BuyTimingRequestBody period(String period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public BuyTimingRequestBody attribute(Attributes attribute) {
  ...
  **/
  ...
  public BuyTimingRequestBody sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public BuyTimingRequestBody region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public BuyTimingRequestBody holdings(BuyTimingHoldings holdings) {
  ...
  **/
  ...
  public BuyTimingHoldings getHoldings() {
    return holdings;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HOLDINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHoldings(BuyTimingHoldings holdings) {
    this.holdings = holdings;
  }


  public BuyTimingRequestBody customClassifications(java.util.Map<String, String> customClassifications) {
    this.customClassifications = customClassifications;
    return this;
  }

  public BuyTimingRequestBody putCustomClassificationsItem(String key, String customClassificationsItem) {
  ...
  **/
  ...
  /**
   * Return true if this BuyTimingRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BuyTimingRequestBody buyTimingRequestBody = (BuyTimingRequestBody) o;
    return Objects.equals(this.accountPath, buyTimingRequestBody.accountPath) &&
        Objects.equals(this.benchmarkPath, buyTimingRequestBody.benchmarkPath) &&
        Objects.equals(this.period, buyTimingRequestBody.period) &&
        Objects.equals(this.attribute, buyTimingRequestBody.attribute) &&
        Objects.equals(this.sector, buyTimingRequestBody.sector) &&
        Objects.equals(this.region, buyTimingRequestBody.region) &&
        Objects.equals(this.holdings, buyTimingRequestBody.holdings) &&
        Objects.equals(this.customClassifications, buyTimingRequestBody.customClassifications);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuyTimingRequestBody {\n");
