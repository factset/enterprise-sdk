 ...
 */
@JsonPropertyOrder({
  RampDownRequestBody.JSON_PROPERTY_ACCOUNT_PATH,
  RampDownRequestBody.JSON_PROPERTY_BENCHMARK_PATH,
  RampDownRequestBody.JSON_PROPERTY_PERIOD,
  RampDownRequestBody.JSON_PROPERTY_ATTRIBUTE,
  RampDownRequestBody.JSON_PROPERTY_SECTOR,
  RampDownRequestBody.JSON_PROPERTY_REGION,
  RampDownRequestBody.JSON_PROPERTY_HOLDINGS,
  RampDownRequestBody.JSON_PROPERTY_CUSTOM_CLASSIFICATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class RampDownRequestBody implements Serializable {
  ...
  private RampDownHoldings holdings;
  ...
  public RampDownRequestBody accountPath(String accountPath) {
    this.accountPath = accountPath;
    return this;
  }
  ...
  **/
  ...
  public RampDownRequestBody benchmarkPath(String benchmarkPath) {
    this.benchmarkPath = benchmarkPath;
    return this;
  }
  ...
  **/
  ...
  public RampDownRequestBody period(String period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public RampDownRequestBody attribute(Attributes attribute) {
  ...
  **/
  ...
  public RampDownRequestBody sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public RampDownRequestBody region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public RampDownRequestBody holdings(RampDownHoldings holdings) {
  ...
  **/
  ...
  public RampDownHoldings getHoldings() {
    return holdings;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HOLDINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHoldings(RampDownHoldings holdings) {
    this.holdings = holdings;
  }


  public RampDownRequestBody customClassifications(java.util.Map<String, String> customClassifications) {
    this.customClassifications = customClassifications;
    return this;
  }

  public RampDownRequestBody putCustomClassificationsItem(String key, String customClassificationsItem) {
  ...
  **/
  ...
  /**
   * Return true if this RampDownRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RampDownRequestBody rampDownRequestBody = (RampDownRequestBody) o;
    return Objects.equals(this.accountPath, rampDownRequestBody.accountPath) &&
        Objects.equals(this.benchmarkPath, rampDownRequestBody.benchmarkPath) &&
        Objects.equals(this.period, rampDownRequestBody.period) &&
        Objects.equals(this.attribute, rampDownRequestBody.attribute) &&
        Objects.equals(this.sector, rampDownRequestBody.sector) &&
        Objects.equals(this.region, rampDownRequestBody.region) &&
        Objects.equals(this.holdings, rampDownRequestBody.holdings) &&
        Objects.equals(this.customClassifications, rampDownRequestBody.customClassifications);
  }
  ...
  public String toString() {
    ...
    sb.append("class RampDownRequestBody {\n");
