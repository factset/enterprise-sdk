 ...
 */
@JsonPropertyOrder({
  SkillsRequestBody.JSON_PROPERTY_ACCOUNT_PATH,
  SkillsRequestBody.JSON_PROPERTY_BENCHMARK_PATH,
  SkillsRequestBody.JSON_PROPERTY_PERIOD,
  SkillsRequestBody.JSON_PROPERTY_ATTRIBUTE,
  SkillsRequestBody.JSON_PROPERTY_SECTOR,
  SkillsRequestBody.JSON_PROPERTY_REGION,
  SkillsRequestBody.JSON_PROPERTY_HOLDINGS,
  SkillsRequestBody.JSON_PROPERTY_CUSTOM_CLASSIFICATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SkillsRequestBody implements Serializable {
  ...
  private SkillsHoldings holdings;
  ...
  public SkillsRequestBody accountPath(String accountPath) {
    this.accountPath = accountPath;
    return this;
  }
  ...
  **/
  ...
  public SkillsRequestBody benchmarkPath(String benchmarkPath) {
    this.benchmarkPath = benchmarkPath;
    return this;
  }
  ...
  **/
  ...
  public SkillsRequestBody period(String period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public SkillsRequestBody attribute(Attributes attribute) {
  ...
  **/
  ...
  public SkillsRequestBody sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public SkillsRequestBody region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public SkillsRequestBody holdings(SkillsHoldings holdings) {
  ...
  **/
  ...
  public SkillsHoldings getHoldings() {
    return holdings;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HOLDINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHoldings(SkillsHoldings holdings) {
    this.holdings = holdings;
  }


  public SkillsRequestBody customClassifications(java.util.Map<String, String> customClassifications) {
    this.customClassifications = customClassifications;
    return this;
  }

  public SkillsRequestBody putCustomClassificationsItem(String key, String customClassificationsItem) {
  ...
  **/
  ...
  /**
   * Return true if this SkillsRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SkillsRequestBody skillsRequestBody = (SkillsRequestBody) o;
    return Objects.equals(this.accountPath, skillsRequestBody.accountPath) &&
        Objects.equals(this.benchmarkPath, skillsRequestBody.benchmarkPath) &&
        Objects.equals(this.period, skillsRequestBody.period) &&
        Objects.equals(this.attribute, skillsRequestBody.attribute) &&
        Objects.equals(this.sector, skillsRequestBody.sector) &&
        Objects.equals(this.region, skillsRequestBody.region) &&
        Objects.equals(this.holdings, skillsRequestBody.holdings) &&
        Objects.equals(this.customClassifications, skillsRequestBody.customClassifications);
  }
