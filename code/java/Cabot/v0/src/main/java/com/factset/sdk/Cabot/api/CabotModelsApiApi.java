...
public class CabotModelsApiApi {
  private ApiClient apiClient;

  public CabotModelsApiApi() {
    this(Configuration.getDefaultApiClient());
  }

  public CabotModelsApiApi(ApiClient apiClient) {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Successful response. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 400 </td><td> Bad request, invalid query parameters. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       ...
       <tr><td> 500 </td><td> Server error. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  </td></tr>
  ...
  public ApiResponse<SellTimingResponseRoot> getSellTimingModelAnalyticWithHttpInfo(String accountPath, String benchmarkPath, String period, Attributes attribute, Sectors sector, Regions region) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("CabotModelsApiApi.getSellTimingModelAnalytic", localVarPath, "GET", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<SkillsResponseRoot> getSkillsModelAnalyticWithHttpInfo(String accountPath, String benchmarkPath, String period, Attributes attribute, Sectors sector, Regions region) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("CabotModelsApiApi.getSkillsModelAnalytic", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
