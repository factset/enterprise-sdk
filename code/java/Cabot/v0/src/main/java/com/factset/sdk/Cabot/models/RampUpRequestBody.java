 ...
 */
@JsonPropertyOrder({
  RampUpRequestBody.JSON_PROPERTY_ACCOUNT_PATH,
  RampUpRequestBody.JSON_PROPERTY_BENCHMARK_PATH,
  RampUpRequestBody.JSON_PROPERTY_PERIOD,
  RampUpRequestBody.JSON_PROPERTY_ATTRIBUTE,
  RampUpRequestBody.JSON_PROPERTY_SECTOR,
  RampUpRequestBody.JSON_PROPERTY_REGION,
  RampUpRequestBody.JSON_PROPERTY_HOLDINGS,
  RampUpRequestBody.JSON_PROPERTY_CUSTOM_CLASSIFICATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class RampUpRequestBody implements Serializable {
  ...
  private RampUpHoldings holdings;
  ...
  public RampUpRequestBody accountPath(String accountPath) {
    this.accountPath = accountPath;
    return this;
  }
  ...
  **/
  ...
  public RampUpRequestBody benchmarkPath(String benchmarkPath) {
    this.benchmarkPath = benchmarkPath;
    return this;
  }
  ...
  **/
  ...
  public RampUpRequestBody period(String period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public RampUpRequestBody attribute(Attributes attribute) {
  ...
  **/
  ...
  public RampUpRequestBody sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public RampUpRequestBody region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public RampUpRequestBody holdings(RampUpHoldings holdings) {
  ...
  **/
  ...
  public RampUpHoldings getHoldings() {
    return holdings;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HOLDINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHoldings(RampUpHoldings holdings) {
    this.holdings = holdings;
  }


  public RampUpRequestBody customClassifications(java.util.Map<String, String> customClassifications) {
    this.customClassifications = customClassifications;
    return this;
  }

  public RampUpRequestBody putCustomClassificationsItem(String key, String customClassificationsItem) {
  ...
  **/
  ...
  /**
   * Return true if this RampUpRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RampUpRequestBody rampUpRequestBody = (RampUpRequestBody) o;
    return Objects.equals(this.accountPath, rampUpRequestBody.accountPath) &&
        Objects.equals(this.benchmarkPath, rampUpRequestBody.benchmarkPath) &&
        Objects.equals(this.period, rampUpRequestBody.period) &&
        Objects.equals(this.attribute, rampUpRequestBody.attribute) &&
        Objects.equals(this.sector, rampUpRequestBody.sector) &&
        Objects.equals(this.region, rampUpRequestBody.region) &&
        Objects.equals(this.holdings, rampUpRequestBody.holdings) &&
        Objects.equals(this.customClassifications, rampUpRequestBody.customClassifications);
  }
  ...
  public String toString() {
    ...
    sb.append("class RampUpRequestBody {\n");
