...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/cabot/0.12.2)](https://central.sonatype.com/artifact/com.factset.sdk/cabot/0.12.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:cabot:0.12.2"
  }
```
