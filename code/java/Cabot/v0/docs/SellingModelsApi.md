...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SellTimingRequestBodyRoot sellTimingRequestBodyRoot = new SellTimingRequestBodyRoot(); // SellTimingRequestBodyRoot | 
        try {
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SellingModelsApi apiInstance = new SellingModelsApi(defaultClient);
        StopLossRequestBodyRoot stopLossRequestBodyRoot = new StopLossRequestBodyRoot(); // StopLossRequestBodyRoot | 
        try {
