...
> AddTrimResponseRoot getAddTrimModelAnalytic(accountPath, benchmarkPath, period, attribute, sector, region)
...
> RampDownResponseRoot getRampDownModelAnalytic(accountPath, benchmarkPath, period, attribute, sector, region)
...
> RampUpResponseRoot getRampUpModelAnalytic(accountPath, benchmarkPath, period, attribute, sector, region)
