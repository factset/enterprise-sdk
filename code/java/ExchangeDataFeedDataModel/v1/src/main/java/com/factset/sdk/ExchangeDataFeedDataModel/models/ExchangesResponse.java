...
import com.factset.sdk.ExchangeDataFeedDataModel.models.ExchangesResponseData;
...
public class ExchangesResponse implements Serializable {
  ...
  private ExchangesResponseData data;
  ...
  @JsonCreator
  public ExchangesResponse(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) ExchangesResponseData data
  ) {
    this();
    this.data = data;
  }

  public ExchangesResponse data(ExchangesResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ExchangesResponseData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(ExchangesResponseData data) {
    this.data = data;
  }
