...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/exchangedatafeeddatamodel)](https://search.maven.org/artifact/com.factset.sdk/exchangedatafeeddatamodel)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:exchangedatafeeddatamodel:0.20.9"
  }
```
