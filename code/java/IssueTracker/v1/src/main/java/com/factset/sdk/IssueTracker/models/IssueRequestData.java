...
@JsonPropertyOrder({
  ...
  IssueRequestData.JSON_PROPERTY_CONNECTOR_ID,
  IssueRequestData.JSON_PROPERTY_CONNECTOR_DISPLAY_ID
})
...
public class IssueRequestData implements Serializable {
  ...
  public static final String JSON_PROPERTY_CONNECTOR_DISPLAY_ID = "connectorDisplayId";
  private String connectorDisplayId;
  ...
  **/
  ...
  public IssueRequestData connectorId(String connectorId) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Id / GUID of the external system where Factset needs to sync back the data. Product should have the settings configured- Please reach out to factset product support team.")
  ...
  public IssueRequestData connectorDisplayId(String connectorDisplayId) {
   ...
   * @return connectorDisplayId
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "User friendly Display ID of the external System")
  @JsonProperty(JSON_PROPERTY_CONNECTOR_DISPLAY_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getConnectorDisplayId() {
    return connectorDisplayId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONNECTOR_DISPLAY_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnectorDisplayId(String connectorDisplayId) {
    this.connectorDisplayId = connectorDisplayId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.subject, issueRequestData.subject) &&
        ...
        Objects.equals(this.connectorId, issueRequestData.connectorId) &&
        Objects.equals(this.connectorDisplayId, issueRequestData.connectorDisplayId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, description, productId, categoryId, severity, attachments, connectorId, connectorDisplayId);
  }
  ...
  public String toString() {
    ...
    sb.append("    connectorDisplayId: ").append(toIndentedString(connectorDisplayId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
