package com.factset.sdk.IssueTracker;
...
import com.factset.sdk.IssueTracker.auth.Authentication;
import com.factset.sdk.IssueTracker.auth.HttpBasicAuth;
import com.factset.sdk.IssueTracker.auth.HttpBearerAuth;
import com.factset.sdk.IssueTracker.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.IssueTracker.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/issue-tracker/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/issue-tracker/v0",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/IssueTracker/0.1.0");
   ...
   * @return this instance of {@link com.factset.sdk.IssueTracker.ApiClient} object.
   */
