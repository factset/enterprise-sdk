...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/axiomaequityoptimizer)](https://search.maven.org/artifact/com.factset.sdk/axiomaequityoptimizer)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:axiomaequityoptimizer:0.8.14"
  }
```
