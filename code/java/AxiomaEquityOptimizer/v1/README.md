...
<dependency>
  ...
  <artifactId>axiomaequityoptimizer</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'axiomaequityoptimizer' jar has been published to maven central.
    mavenLocal()       // Needed if the 'axiomaequityoptimizer' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:axiomaequityoptimizer:0.8.0"
  }
```
...
- `target/axiomaequityoptimizer-0.8.0.jar`
- `target/lib/*.jar`
...
import com.factset.sdk.AxiomaEquityOptimizer.*;
