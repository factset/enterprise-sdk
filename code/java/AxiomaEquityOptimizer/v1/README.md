...
# Axioma Equity Optimizer client library for Java

[![API Version](https://img.shields.io/badge/api-v1-blue)]()
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/axiomaequityoptimizer/0.9.3)](https://central.sonatype.com/artifact/com.factset.sdk/axiomaequityoptimizer/0.9.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:axiomaequityoptimizer:0.9.3"
  }
```
