...
import com.factset.sdk.AxiomaEquityOptimizer.models.DocumentDirectoriesRoot;
...
public class StrategyDocumentsApi {
  ...
  static {
    getAxiomaEquityStrategyDocumentsResponseTypeMap.put(200, new GenericType<DocumentDirectoriesRoot>(){});
  }
  ...
  public ApiResponse<DocumentDirectoriesRoot> getAxiomaEquityStrategyDocumentsWithHttpInfo(String path) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("StrategyDocumentsApi.getAxiomaEquityStrategyDocuments", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getAxiomaEquityStrategyDocumentsResponseTypeMap, false);
