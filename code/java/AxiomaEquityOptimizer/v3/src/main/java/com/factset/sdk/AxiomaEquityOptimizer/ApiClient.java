...
import com.factset.sdk.AxiomaEquityOptimizer.auth.Authentication;
import com.factset.sdk.AxiomaEquityOptimizer.auth.HttpBasicAuth;
import com.factset.sdk.AxiomaEquityOptimizer.auth.HttpBearerAuth;
import com.factset.sdk.AxiomaEquityOptimizer.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.AxiomaEquityOptimizer.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/AxiomaEquityOptimizer/0.22.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.AxiomaEquityOptimizer.ApiClient} object.
   */
