...
import com.factset.sdk.EventsContribution.auth.Authentication;
import com.factset.sdk.EventsContribution.auth.HttpBasicAuth;
import com.factset.sdk.EventsContribution.auth.HttpBearerAuth;
import com.factset.sdk.EventsContribution.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.EventsContribution.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/events-contribution/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/events-contribution/v0",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/EventsContribution/0.20.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.EventsContribution.ApiClient} object.
   */
