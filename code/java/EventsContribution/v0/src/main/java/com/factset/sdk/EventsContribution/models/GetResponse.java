...
import com.factset.sdk.EventsContribution.models.GetResponseData;
 ...
 * Get Event Response
 */
@ApiModel(description = "Get Event Response")
@JsonPropertyOrder({
...
public class GetResponse implements Serializable {
  ...
  public GetResponse data(GetResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(GetResponseData data) {
    this.data = data;
  }
