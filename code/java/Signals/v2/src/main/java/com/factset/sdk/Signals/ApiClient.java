package com.factset.sdk.Signals;
...
import com.factset.sdk.Signals.auth.Authentication;
import com.factset.sdk.Signals.auth.HttpBasicAuth;
import com.factset.sdk.Signals.auth.HttpBearerAuth;
import com.factset.sdk.Signals.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.Signals.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/signals/v2";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/signals/v2",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/Signals/1.0.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
