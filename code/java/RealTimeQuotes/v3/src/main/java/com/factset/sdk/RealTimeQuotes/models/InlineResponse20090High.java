 ...
 */
@ApiModel(description = "Trade with the highest price of the trading day.")
@JsonPropertyOrder({
  InlineResponse20090High.JSON_PROPERTY_TIME,
  InlineResponse20090High.JSON_PROPERTY_PRICE,
  InlineResponse20090High.JSON_PROPERTY_TRADING_VOLUME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse20090High implements Serializable {
  ...
  public InlineResponse20090High() { 
  }

  public InlineResponse20090High time(String time) {
  ...
  **/
  ...
  public InlineResponse20090High price(BigDecimal price) {
  ...
  **/
  ...
  public InlineResponse20090High tradingVolume(BigDecimal tradingVolume) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_90_high object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20090High inlineResponse20090High = (InlineResponse20090High) o;
    return equalsNullable(this.time, inlineResponse20090High.time) &&
        equalsNullable(this.price, inlineResponse20090High.price) &&
        equalsNullable(this.tradingVolume, inlineResponse20090High.tradingVolume);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20090High {\n");
