...
@JsonPropertyOrder({
  PostBasicValueUnitListRequestMeta.JSON_PROPERTY_ATTRIBUTES,
  PostBasicValueUnitListRequestMeta.JSON_PROPERTY_LANGUAGE,
  PostBasicValueUnitListRequestMeta.JSON_PROPERTY_SORT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostBasicValueUnitListRequestMeta implements Serializable {
  ...
  public PostBasicValueUnitListRequestMeta() { 
  }

  public PostBasicValueUnitListRequestMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostBasicValueUnitListRequestMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public PostBasicValueUnitListRequestMeta language(String language) {
  ...
  **/
  ...
  public PostBasicValueUnitListRequestMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public PostBasicValueUnitListRequestMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostBasicValueUnitListRequest_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostBasicValueUnitListRequestMeta postBasicValueUnitListRequestMeta = (PostBasicValueUnitListRequestMeta) o;
    return Objects.equals(this.attributes, postBasicValueUnitListRequestMeta.attributes) &&
        Objects.equals(this.language, postBasicValueUnitListRequestMeta.language) &&
        Objects.equals(this.sort, postBasicValueUnitListRequestMeta.sort);
  }
