...
public class PostBasicMediaTypeListRequestMeta implements Serializable {
  ...
  public PostBasicMediaTypeListRequestMeta() { 
  }

  public PostBasicMediaTypeListRequestMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostBasicMediaTypeListRequestMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public PostBasicMediaTypeListRequestMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public PostBasicMediaTypeListRequestMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostBasicMediaTypeListRequest_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostBasicMediaTypeListRequestMeta postBasicMediaTypeListRequestMeta = (PostBasicMediaTypeListRequestMeta) o;
    return Objects.equals(this.attributes, postBasicMediaTypeListRequestMeta.attributes) &&
        Objects.equals(this.sort, postBasicMediaTypeListRequestMeta.sort);
  }
