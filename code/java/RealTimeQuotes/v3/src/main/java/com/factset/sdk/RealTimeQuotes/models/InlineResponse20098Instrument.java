...
@JsonPropertyOrder({
  InlineResponse20098Instrument.JSON_PROPERTY_ID,
  InlineResponse20098Instrument.JSON_PROPERTY_NAME,
  InlineResponse20098Instrument.JSON_PROPERTY_ISIN,
  InlineResponse20098Instrument.JSON_PROPERTY_NSIN,
  InlineResponse20098Instrument.JSON_PROPERTY_ASSET_CLASS,
  InlineResponse20098Instrument.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20098Instrument implements Serializable {
  ...
  public InlineResponse20098Instrument() { 
  }

  public InlineResponse20098Instrument id(String id) {
  ...
  **/
  ...
  public InlineResponse20098Instrument name(String name) {
  ...
  **/
  ...
  public InlineResponse20098Instrument isin(String isin) {
  ...
  **/
  ...
  public InlineResponse20098Instrument nsin(InlineResponse20067Nsin nsin) {
    this.nsin = nsin;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20098Instrument assetClass(String assetClass) {
  ...
  **/
  ...
  public InlineResponse20098Instrument type(java.util.List<InlineResponse20038DataCategories> type) {
    this.type = type;
    return this;
  }

  public InlineResponse20098Instrument addTypeItem(InlineResponse20038DataCategories typeItem) {
    if (this.type == null) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_98_instrument object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20098Instrument inlineResponse20098Instrument = (InlineResponse20098Instrument) o;
    return equalsNullable(this.id, inlineResponse20098Instrument.id) &&
        equalsNullable(this.name, inlineResponse20098Instrument.name) &&
        equalsNullable(this.isin, inlineResponse20098Instrument.isin) &&
        Objects.equals(this.nsin, inlineResponse20098Instrument.nsin) &&
        equalsNullable(this.assetClass, inlineResponse20098Instrument.assetClass) &&
        Objects.equals(this.type, inlineResponse20098Instrument.type);
  }
