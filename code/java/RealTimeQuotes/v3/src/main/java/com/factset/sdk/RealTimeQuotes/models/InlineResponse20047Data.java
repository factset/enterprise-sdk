...
import com.factset.sdk.RealTimeQuotes.models.InlineResponse20047DataDatasets;
 ...
 */
@ApiModel(description = "List of categories assigned to a specific instrument.")
@JsonPropertyOrder({
  InlineResponse20047Data.JSON_PROPERTY_ID_INSTRUMENT,
  InlineResponse20047Data.JSON_PROPERTY_SOURCE_IDENTIFIER,
  InlineResponse20047Data.JSON_PROPERTY_DATASETS
})
...
public class InlineResponse20047Data implements Serializable {
  ...
  private java.util.List<InlineResponse20047DataDatasets> datasets = null;

  public InlineResponse20047Data() { 
  }

  public InlineResponse20047Data idInstrument(String idInstrument) {
  ...
  **/
  ...
  public InlineResponse20047Data sourceIdentifier(String sourceIdentifier) {
  ...
  **/
  ...
  public InlineResponse20047Data datasets(java.util.List<InlineResponse20047DataDatasets> datasets) {
    this.datasets = datasets;
    return this;
  }

  public InlineResponse20047Data addDatasetsItem(InlineResponse20047DataDatasets datasetsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of datasets with assigned categories.")
  @JsonProperty(JSON_PROPERTY_DATASETS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<InlineResponse20047DataDatasets> getDatasets() {
    return datasets;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATASETS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDatasets(java.util.List<InlineResponse20047DataDatasets> datasets) {
    this.datasets = datasets;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.idInstrument, inlineResponse20047Data.idInstrument) &&
        equalsNullable(this.sourceIdentifier, inlineResponse20047Data.sourceIdentifier) &&
        Objects.equals(this.datasets, inlineResponse20047Data.datasets);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(idInstrument), hashCodeNullable(sourceIdentifier), datasets);
  }
