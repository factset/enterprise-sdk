...
import com.factset.sdk.RealTimeQuotes.models.InlineResponse20093DataAsks;
...
@JsonPropertyOrder({
  InlineResponse20093Data.JSON_PROPERTY_ID_NOTATION,
  InlineResponse20093Data.JSON_PROPERTY_SOURCE_IDENTIFIER,
  InlineResponse20093Data.JSON_PROPERTY_QUALITY,
...
public class InlineResponse20093Data implements Serializable {
  ...
  private java.util.List<InlineResponse20093DataAsks> asks = null;

  public static final String JSON_PROPERTY_BIDS = "bids";
  private java.util.List<InlineResponse20093DataAsks> bids = null;

  public InlineResponse20093Data() { 
  }

  public InlineResponse20093Data idNotation(String idNotation) {
  ...
  **/
  ...
  public InlineResponse20093Data sourceIdentifier(String sourceIdentifier) {
  ...
  **/
  ...
  public InlineResponse20093Data quality(QualityEnum quality) {
  ...
  **/
  ...
  public InlineResponse20093Data asks(java.util.List<InlineResponse20093DataAsks> asks) {
    this.asks = asks;
    return this;
  }

  public InlineResponse20093Data addAsksItem(InlineResponse20093DataAsks asksItem) {
    if (this.asks == null) {
  ...
  **/
  ...
  public java.util.List<InlineResponse20093DataAsks> getAsks() {
    return asks;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ASKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAsks(java.util.List<InlineResponse20093DataAsks> asks) {
    this.asks = asks;
  }


  public InlineResponse20093Data bids(java.util.List<InlineResponse20093DataAsks> bids) {
    this.bids = bids;
    return this;
  }

  public InlineResponse20093Data addBidsItem(InlineResponse20093DataAsks bidsItem) {
    if (this.bids == null) {
  ...
  **/
  ...
  public java.util.List<InlineResponse20093DataAsks> getBids() {
    return bids;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BIDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBids(java.util.List<InlineResponse20093DataAsks> bids) {
    this.bids = bids;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.idNotation, inlineResponse20093Data.idNotation) &&
        equalsNullable(this.sourceIdentifier, inlineResponse20093Data.sourceIdentifier) &&
        equalsNullable(this.quality, inlineResponse20093Data.quality) &&
        Objects.equals(this.asks, inlineResponse20093Data.asks) &&
        Objects.equals(this.bids, inlineResponse20093Data.bids);
  }
