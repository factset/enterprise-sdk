...
import com.factset.sdk.RealTimeQuotes.models.InlineResponse20076DataListing;
 ...
 */
@JsonPropertyOrder({
  InlineResponse20076DataRegional.JSON_PROPERTY_IS_PRIMARY,
  InlineResponse20076DataRegional.JSON_PROPERTY_PERMANENT_IDENTIFIER,
  InlineResponse20076DataRegional.JSON_PROPERTY_TICKER_REGION,
  InlineResponse20076DataRegional.JSON_PROPERTY_LISTING
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20076DataRegional implements Serializable {
  ...
  private java.util.List<InlineResponse20076DataListing> listing = null;

  public InlineResponse20076DataRegional() { 
  }

  public InlineResponse20076DataRegional isPrimary(Boolean isPrimary) {
  ...
  **/
  ...
  public InlineResponse20076DataRegional permanentIdentifier(String permanentIdentifier) {
  ...
  **/
  ...
  public InlineResponse20076DataRegional tickerRegion(String tickerRegion) {
  ...
  **/
  ...
  public InlineResponse20076DataRegional listing(java.util.List<InlineResponse20076DataListing> listing) {
    this.listing = listing;
    return this;
  }

  public InlineResponse20076DataRegional addListingItem(InlineResponse20076DataListing listingItem) {
  ...
  **/
  ...
  public java.util.List<InlineResponse20076DataListing> getListing() {
    return listing;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LISTING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setListing(java.util.List<InlineResponse20076DataListing> listing) {
    this.listing = listing;
  }


  /**
   * Return true if this inline_response_200_76_data_regional object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20076DataRegional inlineResponse20076DataRegional = (InlineResponse20076DataRegional) o;
    return equalsNullable(this.isPrimary, inlineResponse20076DataRegional.isPrimary) &&
        equalsNullable(this.permanentIdentifier, inlineResponse20076DataRegional.permanentIdentifier) &&
        equalsNullable(this.tickerRegion, inlineResponse20076DataRegional.tickerRegion) &&
        Objects.equals(this.listing, inlineResponse20076DataRegional.listing);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20076DataRegional {\n");
