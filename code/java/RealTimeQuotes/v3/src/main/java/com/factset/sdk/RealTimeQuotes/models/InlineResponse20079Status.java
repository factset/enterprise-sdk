...
@JsonPropertyOrder({
  InlineResponse20079Status.JSON_PROPERTY_CODE,
  InlineResponse20079Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20079Status.JSON_PROPERTY_DETAILS,
  InlineResponse20079Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20079Status implements Serializable {
  ...
  public InlineResponse20079Status() { 
  }

  public InlineResponse20079Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20079Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20079Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20079Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_79_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20079Status inlineResponse20079Status = (InlineResponse20079Status) o;
    return equalsNullable(this.code, inlineResponse20079Status.code) &&
        equalsNullable(this.identifier, inlineResponse20079Status.identifier) &&
        equalsNullable(this.details, inlineResponse20079Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20079Status.encryptedDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20079Status {\n");
