...
public class InlineResponse20039DataLevels implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.id, inlineResponse20039DataLevels.id) &&
        equalsNullable(this.name, inlineResponse20039DataLevels.name) &&
        equalsNullable(this.number, inlineResponse20039DataLevels.number) &&
        equalsNullable(this.hasLeafCategories, inlineResponse20039DataLevels.hasLeafCategories);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(id), hashCodeNullable(name), hashCodeNullable(number), hashCodeNullable(hasLeafCategories));
  }
