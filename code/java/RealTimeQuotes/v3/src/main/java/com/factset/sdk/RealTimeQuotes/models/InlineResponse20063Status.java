...
@JsonPropertyOrder({
  InlineResponse20063Status.JSON_PROPERTY_CODE,
  InlineResponse20063Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20063Status.JSON_PROPERTY_DETAILS,
  InlineResponse20063Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20063Status implements Serializable {
  ...
  public InlineResponse20063Status() { 
  }

  public InlineResponse20063Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20063Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20063Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20063Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_63_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20063Status inlineResponse20063Status = (InlineResponse20063Status) o;
    return equalsNullable(this.code, inlineResponse20063Status.code) &&
        equalsNullable(this.identifier, inlineResponse20063Status.identifier) &&
        equalsNullable(this.details, inlineResponse20063Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20063Status.encryptedDetails);
  }
