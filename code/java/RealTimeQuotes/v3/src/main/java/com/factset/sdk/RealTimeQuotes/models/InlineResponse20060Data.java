...
import com.factset.sdk.RealTimeQuotes.models.InlineResponse20060DataRoles;
 ...
 */
@ApiModel(description = "Role-specific background texts of legal entities related to an instrument.")
@JsonPropertyOrder({
  InlineResponse20060Data.JSON_PROPERTY_ID_INSTRUMENT,
  InlineResponse20060Data.JSON_PROPERTY_SOURCE_IDENTIFIER,
  InlineResponse20060Data.JSON_PROPERTY_ROLES
})
...
public class InlineResponse20060Data implements Serializable {
  ...
  private java.util.List<InlineResponse20060DataRoles> roles = null;

  public InlineResponse20060Data() { 
  }

  public InlineResponse20060Data idInstrument(String idInstrument) {
  ...
  **/
  ...
  public InlineResponse20060Data sourceIdentifier(String sourceIdentifier) {
  ...
  **/
  ...
  public InlineResponse20060Data roles(java.util.List<InlineResponse20060DataRoles> roles) {
    this.roles = roles;
    return this;
  }

  public InlineResponse20060Data addRolesItem(InlineResponse20060DataRoles rolesItem) {
    if (this.roles == null) {
   ...
   /**
   * Role-specific background texts.
   * @return roles
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Role-specific background texts.")
  @JsonProperty(JSON_PROPERTY_ROLES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<InlineResponse20060DataRoles> getRoles() {
    return roles;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROLES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoles(java.util.List<InlineResponse20060DataRoles> roles) {
    this.roles = roles;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.idInstrument, inlineResponse20060Data.idInstrument) &&
        equalsNullable(this.sourceIdentifier, inlineResponse20060Data.sourceIdentifier) &&
        Objects.equals(this.roles, inlineResponse20060Data.roles);
  }
