 ...
 */
@JsonPropertyOrder({
  InlineResponse20061DataLegalEntities.JSON_PROPERTY_ID,
...
public class InlineResponse20061DataLegalEntities implements Serializable {
  ...
  public InlineResponse20061DataLegalEntities() { 
  }

  public InlineResponse20061DataLegalEntities id(BigDecimal id) {
  ...
  **/
  ...
  public InlineResponse20061DataLegalEntities name(String name) {
  ...
  **/
  ...
  public InlineResponse20061DataLegalEntities complianceProperties(java.util.List<InlineResponse20048Data> complianceProperties) {
    this.complianceProperties = complianceProperties;
    return this;
  }

  public InlineResponse20061DataLegalEntities addCompliancePropertiesItem(InlineResponse20048Data compliancePropertiesItem) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_61_data_legalEntities object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20061DataLegalEntities inlineResponse20061DataLegalEntities = (InlineResponse20061DataLegalEntities) o;
    return equalsNullable(this.id, inlineResponse20061DataLegalEntities.id) &&
        equalsNullable(this.name, inlineResponse20061DataLegalEntities.name) &&
        Objects.equals(this.complianceProperties, inlineResponse20061DataLegalEntities.complianceProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20061DataLegalEntities {\n");
