...
@JsonPropertyOrder({
  InlineResponse20069Status.JSON_PROPERTY_CODE,
  InlineResponse20069Status.JSON_PROPERTY_IDENTIFIER,
  InlineResponse20069Status.JSON_PROPERTY_DETAILS,
  InlineResponse20069Status.JSON_PROPERTY_ENCRYPTED_DETAILS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse20069Status implements Serializable {
  ...
  public InlineResponse20069Status() { 
  }

  public InlineResponse20069Status code(CodeEnum code) {
  ...
  **/
  ...
  public InlineResponse20069Status identifier(String identifier) {
  ...
  **/
  ...
  public InlineResponse20069Status details(String details) {
  ...
  **/
  ...
  public InlineResponse20069Status encryptedDetails(String encryptedDetails) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_69_status object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20069Status inlineResponse20069Status = (InlineResponse20069Status) o;
    return equalsNullable(this.code, inlineResponse20069Status.code) &&
        equalsNullable(this.identifier, inlineResponse20069Status.identifier) &&
        equalsNullable(this.details, inlineResponse20069Status.details) &&
        equalsNullable(this.encryptedDetails, inlineResponse20069Status.encryptedDetails);
  }
