...
@JsonPropertyOrder({
  InlineResponse20071DataValueUnit.JSON_PROPERTY_ID,
  InlineResponse20071DataValueUnit.JSON_PROPERTY_CODE,
...
public class InlineResponse20071DataValueUnit implements Serializable {
  ...
  public InlineResponse20071DataValueUnit() { 
  }

  public InlineResponse20071DataValueUnit id(BigDecimal id) {
  ...
  **/
  ...
  public InlineResponse20071DataValueUnit code(String code) {
  ...
  **/
  ...
  public InlineResponse20071DataValueUnit isoCode(String isoCode) {
  ...
  **/
  ...
  public InlineResponse20071DataValueUnit name(String name) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_71_data_valueUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20071DataValueUnit inlineResponse20071DataValueUnit = (InlineResponse20071DataValueUnit) o;
    return equalsNullable(this.id, inlineResponse20071DataValueUnit.id) &&
        equalsNullable(this.code, inlineResponse20071DataValueUnit.code) &&
        equalsNullable(this.isoCode, inlineResponse20071DataValueUnit.isoCode) &&
        equalsNullable(this.name, inlineResponse20071DataValueUnit.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20071DataValueUnit {\n");
