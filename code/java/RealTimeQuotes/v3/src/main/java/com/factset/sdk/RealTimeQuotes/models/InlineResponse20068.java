...
import com.factset.sdk.RealTimeQuotes.models.InlineResponse20068Data;
...
public class InlineResponse20068 implements Serializable {
  ...
  private InlineResponse20068Data data;
  ...
  public InlineResponse20068 data(InlineResponse20068Data data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20068Data getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(InlineResponse20068Data data) {
    this.data = data;
  }
