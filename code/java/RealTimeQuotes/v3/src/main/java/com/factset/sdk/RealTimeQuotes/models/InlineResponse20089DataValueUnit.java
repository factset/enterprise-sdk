...
@JsonPropertyOrder({
  InlineResponse20089DataValueUnit.JSON_PROPERTY_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse20089DataValueUnit implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private JsonNullable<BigDecimal> id = JsonNullable.<BigDecimal>undefined();

  public InlineResponse20089DataValueUnit() { 
  }

  public InlineResponse20089DataValueUnit id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Identifier of the valueUnit.")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_89_data_valueUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20089DataValueUnit inlineResponse20089DataValueUnit = (InlineResponse20089DataValueUnit) o;
    return equalsNullable(this.id, inlineResponse20089DataValueUnit.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20089DataValueUnit {\n");
