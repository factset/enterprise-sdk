...
@JsonPropertyOrder({
  PostNotationSearchByTextRequestMeta.JSON_PROPERTY_ATTRIBUTES,
  PostNotationSearchByTextRequestMeta.JSON_PROPERTY_LANGUAGE,
...
public class PostNotationSearchByTextRequestMeta implements Serializable {
  ...
  public PostNotationSearchByTextRequestMeta() { 
  }

  public PostNotationSearchByTextRequestMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostNotationSearchByTextRequestMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public PostNotationSearchByTextRequestMeta language(String language) {
  ...
  **/
  ...
  public PostNotationSearchByTextRequestMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public PostNotationSearchByTextRequestMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public PostNotationSearchByTextRequestMeta pagination(PostBasicMarketListRequestMetaPagination pagination) {
  ...
  **/
  ...
  /**
   * Return true if this PostNotationSearchByTextRequest_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNotationSearchByTextRequestMeta postNotationSearchByTextRequestMeta = (PostNotationSearchByTextRequestMeta) o;
    return Objects.equals(this.attributes, postNotationSearchByTextRequestMeta.attributes) &&
        Objects.equals(this.language, postNotationSearchByTextRequestMeta.language) &&
        Objects.equals(this.sort, postNotationSearchByTextRequestMeta.sort) &&
        Objects.equals(this.pagination, postNotationSearchByTextRequestMeta.pagination);
  }
