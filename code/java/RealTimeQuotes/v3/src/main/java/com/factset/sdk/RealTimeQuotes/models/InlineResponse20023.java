...
import com.factset.sdk.RealTimeQuotes.models.InlineResponse20023Data;
...
public class InlineResponse20023 implements Serializable {
  ...
  private java.util.List<InlineResponse20023Data> data = null;
  ...
  public InlineResponse20023 data(java.util.List<InlineResponse20023Data> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public java.util.List<InlineResponse20023Data> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<InlineResponse20023Data> data) {
    this.data = data;
  }


  public InlineResponse20023 meta(InlineResponse200Meta meta) {
    this.meta = meta;
    return this;
  }
