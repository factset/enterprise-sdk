...
@JsonPropertyOrder({
  PostNotationSelectionListMembersListRequestMeta.JSON_PROPERTY_ATTRIBUTES,
  PostNotationSelectionListMembersListRequestMeta.JSON_PROPERTY_LANGUAGE,
  PostNotationSelectionListMembersListRequestMeta.JSON_PROPERTY_SORT,
  PostNotationSelectionListMembersListRequestMeta.JSON_PROPERTY_PAGINATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostNotationSelectionListMembersListRequestMeta implements Serializable {
  ...
  public PostNotationSelectionListMembersListRequestMeta() { 
  }

  public PostNotationSelectionListMembersListRequestMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostNotationSelectionListMembersListRequestMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public PostNotationSelectionListMembersListRequestMeta language(String language) {
  ...
  **/
  ...
  public PostNotationSelectionListMembersListRequestMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public PostNotationSelectionListMembersListRequestMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public PostNotationSelectionListMembersListRequestMeta pagination(PostBasicMarketListRequestMetaPagination pagination) {
  ...
  **/
  ...
  /**
   * Return true if this PostNotationSelectionListMembersListRequest_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNotationSelectionListMembersListRequestMeta postNotationSelectionListMembersListRequestMeta = (PostNotationSelectionListMembersListRequestMeta) o;
    return Objects.equals(this.attributes, postNotationSelectionListMembersListRequestMeta.attributes) &&
        Objects.equals(this.language, postNotationSelectionListMembersListRequestMeta.language) &&
        Objects.equals(this.sort, postNotationSelectionListMembersListRequestMeta.sort) &&
        Objects.equals(this.pagination, postNotationSelectionListMembersListRequestMeta.pagination);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostNotationSelectionListMembersListRequestMeta {\n");
