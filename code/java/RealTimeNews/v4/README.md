...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/realtimenews/0.20.1)](https://central.sonatype.com/artifact/com.factset.sdk/realtimenews/0.20.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:realtimenews:0.20.1"
  }
```
