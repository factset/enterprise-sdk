...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/realtimenews/0.20.2)](https://central.sonatype.com/artifact/com.factset.sdk/realtimenews/0.20.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:realtimenews:0.20.2"
  }
```
