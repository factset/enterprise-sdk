...
import com.factset.sdk.RealTimeNews.models.GetBasicMarketGroupListDataItems;
...
public class InlineResponse20010 implements Serializable {
  ...
  private java.util.List<GetBasicMarketGroupListDataItems> data = null;
  ...
  public InlineResponse20010 data(java.util.List<GetBasicMarketGroupListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20010 addDataItem(GetBasicMarketGroupListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<GetBasicMarketGroupListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<GetBasicMarketGroupListDataItems> data) {
    this.data = data;
  }
