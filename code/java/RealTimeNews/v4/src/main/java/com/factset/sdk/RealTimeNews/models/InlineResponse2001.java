...
import com.factset.sdk.RealTimeNews.models.PostBasicBackgroundTextTypeListDataItems;
...
public class InlineResponse2001 implements Serializable {
  ...
  private java.util.List<PostBasicBackgroundTextTypeListDataItems> data = null;
  ...
  public InlineResponse2001 data(java.util.List<PostBasicBackgroundTextTypeListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2001 addDataItem(PostBasicBackgroundTextTypeListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of background text types.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<PostBasicBackgroundTextTypeListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostBasicBackgroundTextTypeListDataItems> data) {
    this.data = data;
  }
