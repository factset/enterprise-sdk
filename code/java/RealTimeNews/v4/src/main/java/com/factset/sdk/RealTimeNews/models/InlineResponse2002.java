...
import com.factset.sdk.RealTimeNews.models.GetBasicBenchmarkTypeListDataItems;
...
public class InlineResponse2002 implements Serializable {
  ...
  private java.util.List<GetBasicBenchmarkTypeListDataItems> data = null;
  ...
  public InlineResponse2002 data(java.util.List<GetBasicBenchmarkTypeListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(GetBasicBenchmarkTypeListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of benchmark types.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<GetBasicBenchmarkTypeListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<GetBasicBenchmarkTypeListDataItems> data) {
    this.data = data;
  }
