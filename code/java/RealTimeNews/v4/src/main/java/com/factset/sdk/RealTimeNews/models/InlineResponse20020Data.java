...
import com.factset.sdk.RealTimeNews.models.GetBasicRegionCountryGetByCodeDataSubdivisionsItems;
...
public class InlineResponse20020Data implements Serializable {
  ...
  private java.util.List<GetBasicRegionCountryGetByCodeDataSubdivisionsItems> subdivisions = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Identifier of a country.")
  @JsonIgnore
  ...
  **/
  ...
  public InlineResponse20020Data subdivisions(java.util.List<GetBasicRegionCountryGetByCodeDataSubdivisionsItems> subdivisions) {
    this.subdivisions = subdivisions;
    return this;
  }

  public InlineResponse20020Data addSubdivisionsItem(GetBasicRegionCountryGetByCodeDataSubdivisionsItems subdivisionsItem) {
  ...
  **/
  ...
  public java.util.List<GetBasicRegionCountryGetByCodeDataSubdivisionsItems> getSubdivisions() {
    return subdivisions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBDIVISIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubdivisions(java.util.List<GetBasicRegionCountryGetByCodeDataSubdivisionsItems> subdivisions) {
    this.subdivisions = subdivisions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.id, inlineResponse20020Data.id) &&
        equalsNullable(this.name, inlineResponse20020Data.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(id), hashCodeNullable(name), subdivisions);
  }
