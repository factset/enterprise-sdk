...
import com.factset.sdk.RealTimeNews.models.PostBasicMarketListDataItems;
...
public class InlineResponse2009 implements Serializable {
  ...
  private java.util.List<PostBasicMarketListDataItems> data = null;
  ...
  public InlineResponse2009 data(java.util.List<PostBasicMarketListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2009 addDataItem(PostBasicMarketListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of markets.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<PostBasicMarketListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostBasicMarketListDataItems> data) {
    this.data = data;
  }
