...
public class InlineResponse20025Data implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "USD", value = "ISO 4217 code of the value unit. Empty if the ISO 4217 standard does not define a code for the currency.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "main", value = "Type of the value unit. | Value | Description | | --- | --- | | main | Main currency. | | fractional | Fractional currency. | | alternative | Alternative value unit. |  ")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates whether the value unit is active.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.code, inlineResponse20025Data.code) &&
