...
import com.factset.sdk.RealTimeNews.models.PostBasicDeliveryListDataItems;
...
public class InlineResponse2003 implements Serializable {
  ...
  private java.util.List<PostBasicDeliveryListDataItems> data = null;
  ...
  public InlineResponse2003 data(java.util.List<PostBasicDeliveryListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2003 addDataItem(PostBasicDeliveryListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of deliveries.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<PostBasicDeliveryListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostBasicDeliveryListDataItems> data) {
    this.data = data;
  }
