...
@JsonPropertyOrder({
  GetBasicRegionGetDataNestedRegionsItems.JSON_PROPERTY_ID,
  GetBasicRegionGetDataNestedRegionsItems.JSON_PROPERTY_CODE,
  GetBasicRegionGetDataNestedRegionsItems.JSON_PROPERTY_NAME,
  GetBasicRegionGetDataNestedRegionsItems.JSON_PROPERTY_TYPE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GetBasicRegionGetDataNestedRegionsItems implements Serializable {
  ...
  public GetBasicRegionGetDataNestedRegionsItems() { 
  }

  public GetBasicRegionGetDataNestedRegionsItems id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4", value = "Identifier of a region.")
  @JsonIgnore
  ...
  public GetBasicRegionGetDataNestedRegionsItems code(String code) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "DE", value = "ISO 3166-1 alpha-2 code of the country. This attribute is set for each country, may be set for miscellaneous regions and is empty for regions of other types.")
  @JsonIgnore
  ...
  public GetBasicRegionGetDataNestedRegionsItems name(String name) {
  ...
  **/
  ...
  public GetBasicRegionGetDataNestedRegionsItems type(TypeEnum type) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "subdivision", value = "Type of the region. | Value | Description | | --- | --- | | continent | Regions that are considered to be a continent in the context of the Market Data Gateway. | | country | A region that represents a country that has been assigned an official ISO 3166-1 code. | | subdivision | A region that represents a subdivision of a country that has been assigned an official ISO 3166-2 code. | | misc | A miscellaneous region represents a region that is neither a continent, nor a country, nor a subdivision of a country. | | compound | A compound miscellaneous region consists of member regions which are uniquely and undoubtedly defined. |  ")
  @JsonIgnore
  ...
  /**
   * Return true if this GetBasicRegionGetDataNestedRegionsItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetBasicRegionGetDataNestedRegionsItems getBasicRegionGetDataNestedRegionsItems = (GetBasicRegionGetDataNestedRegionsItems) o;
    return equalsNullable(this.id, getBasicRegionGetDataNestedRegionsItems.id) &&
        equalsNullable(this.code, getBasicRegionGetDataNestedRegionsItems.code) &&
        equalsNullable(this.name, getBasicRegionGetDataNestedRegionsItems.name) &&
        equalsNullable(this.type, getBasicRegionGetDataNestedRegionsItems.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBasicRegionGetDataNestedRegionsItems {\n");
