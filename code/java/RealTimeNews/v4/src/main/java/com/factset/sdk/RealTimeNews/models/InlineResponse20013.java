...
import com.factset.sdk.RealTimeNews.models.PostBasicMediaTypeListDataItems;
...
public class InlineResponse20013 implements Serializable {
  ...
  private java.util.List<PostBasicMediaTypeListDataItems> data = null;
  ...
  public InlineResponse20013 data(java.util.List<PostBasicMediaTypeListDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20013 addDataItem(PostBasicMediaTypeListDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<PostBasicMediaTypeListDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostBasicMediaTypeListDataItems> data) {
    this.data = data;
  }
