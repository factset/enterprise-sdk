...
@JsonPropertyOrder({
  InlineResponse20043DataLanguage.JSON_PROPERTY_ID,
  InlineResponse20043DataLanguage.JSON_PROPERTY_CODE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse20043DataLanguage implements Serializable {
  ...
  public InlineResponse20043DataLanguage() { 
  }

  public InlineResponse20043DataLanguage id(BigDecimal id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Identifier of the language.")
  @JsonIgnore
  ...
  public InlineResponse20043DataLanguage code(String code) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_43_data_language object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20043DataLanguage inlineResponse20043DataLanguage = (InlineResponse20043DataLanguage) o;
    return equalsNullable(this.id, inlineResponse20043DataLanguage.id) &&
        equalsNullable(this.code, inlineResponse20043DataLanguage.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20043DataLanguage {\n");
