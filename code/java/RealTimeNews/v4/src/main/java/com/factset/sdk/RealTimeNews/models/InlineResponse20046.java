...
import com.factset.sdk.RealTimeNews.models.InlineResponse20046Data;
...
public class InlineResponse20046 implements Serializable {
  ...
  private InlineResponse20046Data data;
  ...
  public InlineResponse20046 data(InlineResponse20046Data data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20046Data getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(InlineResponse20046Data data) {
    this.data = data;
  }


  public InlineResponse20046 meta(InlineResponse20044Meta meta) {
    this.meta = meta;
    return this;
  }
