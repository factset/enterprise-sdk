...
public class OffsetBasedPaginationOutputObjectWithoutTotal implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", required = true, value = "Flag indicating that a subsequent request with the same parameters, except that the parameter `pagination.offset` is incremented by `pagination.limit`, would yield additional results.")
