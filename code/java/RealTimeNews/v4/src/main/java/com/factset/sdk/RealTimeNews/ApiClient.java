...
import com.factset.sdk.RealTimeNews.auth.Authentication;
import com.factset.sdk.RealTimeNews.auth.HttpBasicAuth;
import com.factset.sdk.RealTimeNews.auth.HttpBearerAuth;
import com.factset.sdk.RealTimeNews.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.RealTimeNews.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/RealTimeNews/0.20.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.RealTimeNews.ApiClient} object.
   */
