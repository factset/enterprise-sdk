...
@JsonPropertyOrder({
  PostNewsArticleSearchByTextRequestDataPublisher.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PostNewsArticleSearchByTextRequestDataPublisher implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public PostNewsArticleSearchByTextRequestDataPublisher() { 
  }

  public PostNewsArticleSearchByTextRequestDataPublisher ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public PostNewsArticleSearchByTextRequestDataPublisher addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this PostNewsArticleSearchByTextRequest_data_publisher object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostNewsArticleSearchByTextRequestDataPublisher postNewsArticleSearchByTextRequestDataPublisher = (PostNewsArticleSearchByTextRequestDataPublisher) o;
    return Objects.equals(this.ids, postNewsArticleSearchByTextRequestDataPublisher.ids);
  }
