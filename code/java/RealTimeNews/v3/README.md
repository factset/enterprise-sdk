...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/realtimenews/0.12.1)](https://central.sonatype.com/artifact/com.factset.sdk/realtimenews/0.12.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:realtimenews:0.12.1"
  }
```
