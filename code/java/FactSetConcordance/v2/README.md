...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetconcordance/1.0.2)](https://central.sonatype.com/artifact/com.factset.sdk/factsetconcordance/1.0.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetconcordance:1.0.2"
  }
```
