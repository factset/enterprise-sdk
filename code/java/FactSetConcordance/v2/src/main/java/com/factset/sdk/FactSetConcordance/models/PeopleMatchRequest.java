...
@JsonPropertyOrder({
  ...
  PeopleMatchRequest.JSON_PROPERTY_CANDIDATES_COUNT,
...
public class PeopleMatchRequest implements Serializable {
  ...
  public static final String JSON_PROPERTY_CANDIDATES_COUNT = "candidatesCount";
  ...
  **/
  ...
  public PeopleMatchRequest candidatesCount(Integer candidatesCount) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "40", value = "Maximum number of candidates to be returned. Parent entities, when includeParent is true, are not included in this count. ")
  @JsonProperty(JSON_PROPERTY_CANDIDATES_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.input, peopleMatchRequest.input) &&
        Objects.equals(this.candidatesCount, peopleMatchRequest.candidatesCount) &&
        Objects.equals(this.universeId, peopleMatchRequest.universeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(input, candidatesCount, universeId);
  }
