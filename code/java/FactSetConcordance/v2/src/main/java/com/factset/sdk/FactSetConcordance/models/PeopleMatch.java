...
public class PeopleMatch implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.activeRole, peopleMatch.activeRole) &&
        ...
        equalsNullable(this.taskId, peopleMatch.taskId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(activeRole), hashCodeNullable(clientEntity), hashCodeNullable(clientFirstName), hashCodeNullable(clientLastName), hashCodeNullable(clientMiddleName), hashCodeNullable(clientSalutation), hashCodeNullable(clientSuffix), hashCodeNullable(clientPriority), hashCodeNullable(clientPersonName), hashCodeNullable(firstName), hashCodeNullable(personId), hashCodeNullable(lastName), hashCodeNullable(middleName), hashCodeNullable(entity), hashCodeNullable(mapStatus), hashCodeNullable(matchFlag), hashCodeNullable(nameMatchSource), hashCodeNullable(nameMatchString), hashCodeNullable(rowIndex), hashCodeNullable(similarityScore), hashCodeNullable(title), hashCodeNullable(universeId), hashCodeNullable(taskId), hashCodeNullable(suffix), hashCodeNullable(salutation), hashCodeNullable(personName), hashCodeNullable(email), hashCodeNullable(clientId));
  }
