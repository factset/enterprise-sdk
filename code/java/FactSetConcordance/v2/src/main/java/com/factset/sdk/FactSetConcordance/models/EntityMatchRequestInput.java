...
public class EntityMatchRequestInput implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, clientId, country, state, url, priority, bbgFigi, bbgTicker, bic, cik, crd, cusip, duns, ein, factsetId, fitch, gvkey, gvkeyIid, isin, jcn, lei, lxid, md, redCode, rssd, sedol, spr, ticker, tickerExchange, tickerRegion, ukch, valoren, wkn);
  }
