...
public class EntityMatchRequestInput implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "621513451", value = "Name for the type DUNS, Dun&Bradstreet.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, clientId, country, state, url, priority, bic, bbgTicker, cik, crd, cusip, duns, ein, rssd, fitch, isin, lei, bbgFigi, md, ticker, spr, sedol, tickerExchange, tickerRegion, ukch, valoren, wkn);
  }
