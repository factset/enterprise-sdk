 ...
 */
@JsonPropertyOrder({
  PeopleMappingResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PeopleMappingResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private PeopleMapping data;

  public PeopleMappingResponse() { 
  }

  public PeopleMappingResponse data(PeopleMapping data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PeopleMapping data) {
    this.data = data;
  }


  /**
   * Return true if this PeopleMappingResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PeopleMappingResponse peopleMappingResponse = (PeopleMappingResponse) o;
    return Objects.equals(this.data, peopleMappingResponse.data);
  }
