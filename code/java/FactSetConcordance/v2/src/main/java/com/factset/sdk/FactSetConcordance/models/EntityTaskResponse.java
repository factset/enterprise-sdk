 ...
 */
@JsonPropertyOrder({
  EntityTaskResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class EntityTaskResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private EntityTaskStatus data;

  public EntityTaskResponse() { 
  }

  public EntityTaskResponse data(EntityTaskStatus data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public EntityTaskStatus getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(EntityTaskStatus data) {
    this.data = data;
  }


  /**
   * Return true if this EntityTaskResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityTaskResponse entityTaskResponse = (EntityTaskResponse) o;
    return Objects.equals(this.data, entityTaskResponse.data);
  }
