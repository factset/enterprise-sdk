 ...
 */
@JsonPropertyOrder({
  SnowflakeEntityMatchResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SnowflakeEntityMatchResponse implements Serializable {
  ...
  public SnowflakeEntityMatchResponse addDataItem(java.util.List<Object> dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "JSON body to be parsed by snowflake")
  ...
  /**
   * Return true if this SnowflakeEntityMatchResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SnowflakeEntityMatchResponse snowflakeEntityMatchResponse = (SnowflakeEntityMatchResponse) o;
    return Objects.equals(this.data, snowflakeEntityMatchResponse.data);
  }
