 ...
 */
@JsonPropertyOrder({
  EntityUniverseResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class EntityUniverseResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<EntityMapping> data = null;

  public EntityUniverseResponse() { 
  }

  public EntityUniverseResponse data(java.util.List<EntityMapping> data) {
    this.data = data;
    return this;
  }

  public EntityUniverseResponse addDataItem(EntityMapping dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this EntityUniverseResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityUniverseResponse entityUniverseResponse = (EntityUniverseResponse) o;
    return Objects.equals(this.data, entityUniverseResponse.data);
  }
