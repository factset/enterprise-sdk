...
import com.factset.sdk.FactSetConcordance.models.PeopleTask;
 ...
 */
@JsonPropertyOrder({
  PeopleTaskResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PeopleTaskResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private PeopleTask data;

  public PeopleTaskResponse() { 
  }

  public PeopleTaskResponse data(PeopleTask data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PeopleTask data) {
    this.data = data;
  }


  /**
   * Return true if this PeopleTaskResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PeopleTaskResponse peopleTaskResponse = (PeopleTaskResponse) o;
    return Objects.equals(this.data, peopleTaskResponse.data);
  }
