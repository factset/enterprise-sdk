...
@JsonPropertyOrder({
  ...
  EntityTaskStatus.JSON_PROPERTY_CREDITSAFE_COLUMN,
  EntityTaskStatus.JSON_PROPERTY_CRUNCHBASE_COLUMN,
...
public class EntityTaskStatus implements Serializable {
  ...
  public static final String JSON_PROPERTY_CREDITSAFE_COLUMN = "creditsafeColumn";
  private JsonNullable<String> creditsafeColumn = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_CRUNCHBASE_COLUMN = "crunchbaseColumn";
  private JsonNullable<String> crunchbaseColumn = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public EntityTaskStatus creditsafeColumn(String creditsafeColumn) {
    this.creditsafeColumn = JsonNullable.<String>of(creditsafeColumn);
    return this;
  }

   /**
   * the column name for type Creditsafe Identifier
   * @return creditsafeColumn
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "CreditsafeId", value = "the column name for type Creditsafe Identifier")
  @JsonIgnore

  public String getCreditsafeColumn() {
        return creditsafeColumn.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CREDITSAFE_COLUMN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getCreditsafeColumn_JsonNullable() {
    return creditsafeColumn;
  }
  
  @JsonProperty(JSON_PROPERTY_CREDITSAFE_COLUMN)
  public void setCreditsafeColumn_JsonNullable(JsonNullable<String> creditsafeColumn) {
    this.creditsafeColumn = creditsafeColumn;
  }

  public void setCreditsafeColumn(String creditsafeColumn) {
    this.creditsafeColumn = JsonNullable.<String>of(creditsafeColumn);
  }


  public EntityTaskStatus crunchbaseColumn(String crunchbaseColumn) {
    this.crunchbaseColumn = JsonNullable.<String>of(crunchbaseColumn);
    return this;
  }

   /**
   * the column name for type Crunchbase Identifier
   * @return crunchbaseColumn
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "CrunchbaseId", value = "the column name for type Crunchbase Identifier")
  @JsonIgnore

  public String getCrunchbaseColumn() {
        return crunchbaseColumn.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CRUNCHBASE_COLUMN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getCrunchbaseColumn_JsonNullable() {
    return crunchbaseColumn;
  }
  
  @JsonProperty(JSON_PROPERTY_CRUNCHBASE_COLUMN)
  public void setCrunchbaseColumn_JsonNullable(JsonNullable<String> crunchbaseColumn) {
    this.crunchbaseColumn = crunchbaseColumn;
  }

  public void setCrunchbaseColumn(String crunchbaseColumn) {
    this.crunchbaseColumn = JsonNullable.<String>of(crunchbaseColumn);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.taskId, entityTaskStatus.taskId) &&
        ...
        equalsNullable(this.creditsafeColumn, entityTaskStatus.creditsafeColumn) &&
        equalsNullable(this.crunchbaseColumn, entityTaskStatus.crunchbaseColumn) &&
  ...
  public String toString() {
    ...
    sb.append("    creditsafeColumn: ").append(toIndentedString(creditsafeColumn)).append("\n");
    sb.append("    crunchbaseColumn: ").append(toIndentedString(crunchbaseColumn)).append("\n");
