...
public class ManageMappingsApi {
  private ApiClient apiClient;

  public ManageMappingsApi() {
   ...
   */
  public EntityUniverseResponse getEntityUniverse(java.util.List<String> clientId, java.util.List<String> mapStatus, Integer offset, Integer limit) throws ApiException {
    return getEntityUniverseWithHttpInfo(clientId, mapStatus, offset, limit).getData();
  }
   ...
   */
  public ApiResponse<EntityUniverseResponse> getEntityUniverseWithHttpInfo(java.util.List<String> clientId, java.util.List<String> mapStatus, Integer offset, Integer limit) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/factset-concordance/v1/entity-universe";
   ...
   */
  public EntityResponse saveEntityMapping(EntityMappingRequest entityMappingRequest) throws ApiException {
    return saveEntityMappingWithHttpInfo(entityMappingRequest).getData();
  }
   ...
   */
  public ApiResponse<EntityResponse> saveEntityMappingWithHttpInfo(EntityMappingRequest entityMappingRequest) throws ApiException {
    ...
    if (entityMappingRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'entityMappingRequest' when calling saveEntityMapping");
    }
    
    // create path and map variables
    String localVarPath = "/factset-concordance/v1/entity-mapping";
