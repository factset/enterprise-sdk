 ...
 */
@JsonPropertyOrder({
  OptimizerInputsMPSensitivityConstraint.JSON_PROPERTY_CONSTRAINT,
  OptimizerInputsMPSensitivityConstraint.JSON_PROPERTY_ON_PERIODS,
  OptimizerInputsMPSensitivityConstraint.JSON_PROPERTY_ACROSS_PERIODS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class OptimizerInputsMPSensitivityConstraint implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_CONSTRAINT = "constraint";
  private OptimizerInputsSensitivityConstraint constraint;
  ...
  public OptimizerInputsMPSensitivityConstraint() { 
  }

  public OptimizerInputsMPSensitivityConstraint constraint(OptimizerInputsSensitivityConstraint constraint) {
  ...
  **/
  ...
  public OptimizerInputsSensitivityConstraint getConstraint() {
    return constraint;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONSTRAINT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConstraint(OptimizerInputsSensitivityConstraint constraint) {
    this.constraint = constraint;
  }


  public OptimizerInputsMPSensitivityConstraint onPeriods(OptimizerInputsOnPeriods onPeriods) {
  ...
  **/
  ...
  public OptimizerInputsMPSensitivityConstraint acrossPeriods(OptimizerInputsAcrossPeriods acrossPeriods) {
  ...
  **/
  ...
  /**
   * Return true if this optimizer.inputs.MPSensitivityConstraint object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OptimizerInputsMPSensitivityConstraint optimizerInputsMPSensitivityConstraint = (OptimizerInputsMPSensitivityConstraint) o;
    return Objects.equals(this.constraint, optimizerInputsMPSensitivityConstraint.constraint) &&
        Objects.equals(this.onPeriods, optimizerInputsMPSensitivityConstraint.onPeriods) &&
        Objects.equals(this.acrossPeriods, optimizerInputsMPSensitivityConstraint.acrossPeriods);
  }
  ...
  public String toString() {
    ...
    sb.append("class OptimizerInputsMPSensitivityConstraint {\n");
