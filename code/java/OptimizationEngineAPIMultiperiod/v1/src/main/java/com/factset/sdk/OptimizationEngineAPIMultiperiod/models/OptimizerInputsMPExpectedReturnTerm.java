 ...
 */
@JsonPropertyOrder({
  OptimizerInputsMPExpectedReturnTerm.JSON_PROPERTY_TERM,
  OptimizerInputsMPExpectedReturnTerm.JSON_PROPERTY_TERM_ON,
  OptimizerInputsMPExpectedReturnTerm.JSON_PROPERTY_ANNUALIZATION_FACTOR,
  OptimizerInputsMPExpectedReturnTerm.JSON_PROPERTY_ON_PERIODS,
  OptimizerInputsMPExpectedReturnTerm.JSON_PROPERTY_ACROSS_PERIODS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class OptimizerInputsMPExpectedReturnTerm implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_TERM = "term";
  private OptimizerInputsExpectedReturnTerm term;
  ...
  public OptimizerInputsMPExpectedReturnTerm term(OptimizerInputsExpectedReturnTerm term) {
    this.term = term;
    return this;
  }
  ...
  **/
  ...
  public OptimizerInputsExpectedReturnTerm getTerm() {
    return term;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TERM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTerm(OptimizerInputsExpectedReturnTerm term) {
    this.term = term;
  }


  public OptimizerInputsMPExpectedReturnTerm termOn(OptimizerInputsBoundSourceEnum termOn) {
    this.termOn = termOn;
    return this;
  }
  ...
  **/
  ...
  public OptimizerInputsMPExpectedReturnTerm annualizationFactor(Double annualizationFactor) {
  ...
  **/
  ...
  public OptimizerInputsMPExpectedReturnTerm onPeriods(OptimizerInputsOnPeriods onPeriods) {
  ...
  **/
  ...
  public OptimizerInputsMPExpectedReturnTerm acrossPeriods(OptimizerInputsAcrossPeriods acrossPeriods) {
  ...
  **/
  ...
  /**
   * Return true if this optimizer.inputs.MPExpectedReturnTerm object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OptimizerInputsMPExpectedReturnTerm optimizerInputsMPExpectedReturnTerm = (OptimizerInputsMPExpectedReturnTerm) o;
    return Objects.equals(this.term, optimizerInputsMPExpectedReturnTerm.term) &&
        Objects.equals(this.termOn, optimizerInputsMPExpectedReturnTerm.termOn) &&
        Objects.equals(this.annualizationFactor, optimizerInputsMPExpectedReturnTerm.annualizationFactor) &&
        Objects.equals(this.onPeriods, optimizerInputsMPExpectedReturnTerm.onPeriods) &&
        Objects.equals(this.acrossPeriods, optimizerInputsMPExpectedReturnTerm.acrossPeriods);
  }

  @Override
  public int hashCode() {
    return Objects.hash(term, termOn, annualizationFactor, onPeriods, acrossPeriods);
  }
