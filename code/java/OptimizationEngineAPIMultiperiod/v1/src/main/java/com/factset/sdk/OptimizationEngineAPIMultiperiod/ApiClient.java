...
import com.factset.sdk.OptimizationEngineAPIMultiperiod.auth.Authentication;
import com.factset.sdk.OptimizationEngineAPIMultiperiod.auth.HttpBasicAuth;
import com.factset.sdk.OptimizationEngineAPIMultiperiod.auth.HttpBearerAuth;
import com.factset.sdk.OptimizationEngineAPIMultiperiod.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.OptimizationEngineAPIMultiperiod.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/OptimizationEngineAPIMultiperiod/0.22.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.OptimizationEngineAPIMultiperiod.ApiClient} object.
   */
