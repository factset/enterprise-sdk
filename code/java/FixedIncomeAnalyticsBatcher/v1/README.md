...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/fixedincomeanalyticsbatcher)](https://search.maven.org/artifact/com.factset.sdk/fixedincomeanalyticsbatcher)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:fixedincomeanalyticsbatcher:0.21.10"
  }
```
