...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/naturallanguageprocessing/0.24.5)](https://central.sonatype.com/artifact/com.factset.sdk/naturallanguageprocessing/0.24.5)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:naturallanguageprocessing:0.24.5"
  }
```
