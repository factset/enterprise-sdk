...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/naturallanguageprocessing/0.24.4)](https://central.sonatype.com/artifact/com.factset.sdk/naturallanguageprocessing/0.24.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:naturallanguageprocessing:0.24.4"
  }
```
...
public class AiThemesApiExample {
