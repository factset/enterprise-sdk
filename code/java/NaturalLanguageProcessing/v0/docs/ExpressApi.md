...
import com.factset.sdk.NaturalLanguageProcessing.api.ExpressApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ExpressRequestRoot expressRequestRoot = new ExpressRequestRoot(); // ExpressRequestRoot | 
        try {
            OutputRoot result = apiInstance.postExpressNerExtraction(expressRequestRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ExpressApi#postExpressNerExtraction");
