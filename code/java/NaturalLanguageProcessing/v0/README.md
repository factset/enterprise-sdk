...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/naturallanguageprocessing/0.40.0)](https://central.sonatype.com/artifact/com.factset.sdk/naturallanguageprocessing/0.40.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:naturallanguageprocessing:0.40.0"
  }
```
...
public class AdvancedApiExample {
...
------------ | ------------- | ------------- | -------------
*AdvancedApi* | [**postAdvancedNerExtraction**](docs/AdvancedApi.md#postAdvancedNerExtraction) | **POST** /advanced | Advanced Processing
*ExpressApi* | [**postExpressNerExtraction**](docs/ExpressApi.md#postExpressNerExtraction) | **POST** /express | Express Processing


## Documentation for Models

 - [AdvancedEntityType](docs/AdvancedEntityType.md)
 - [AdvancedInput](docs/AdvancedInput.md)
 - [AdvancedRequestRoot](docs/AdvancedRequestRoot.md)
 - [ErrorResponse](docs/ErrorResponse.md)
 - [ErrorSource](docs/ErrorSource.md)
 - [ExpressInput](docs/ExpressInput.md)
 - [ExpressRequestRoot](docs/ExpressRequestRoot.md)
 - [HTTPError](docs/HTTPError.md)
 - [LookupStatus](docs/LookupStatus.md)
 - [OutputItem](docs/OutputItem.md)
 - [OutputRoot](docs/OutputRoot.md)
 - [StandardEntityType](docs/StandardEntityType.md)
