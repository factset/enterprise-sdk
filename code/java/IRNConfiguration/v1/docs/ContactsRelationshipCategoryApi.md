...
import com.factset.sdk.IRNConfiguration.api.ContactsRelationshipCategoryApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ContactsRelationshipCategoryApi apiInstance = new ContactsRelationshipCategoryApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRelationshipCategoryApi#createRelationshipCategory");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRelationshipCategoryApi#deleteRelationshipCategory");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRelationshipCategoryApi#editRelationshipCategory");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> java.util.List<RelationshipCategoryDto> getRelationshipCategories()
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ContactsRelationshipCategoryApi apiInstance = new ContactsRelationshipCategoryApi(defaultClient);
        try {
            java.util.List<RelationshipCategoryDto> result = apiInstance.getRelationshipCategories();
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ContactsRelationshipCategoryApi#getRelationshipCategories");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRelationshipCategoryApi#updateRelationshipCategoryOrder");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
