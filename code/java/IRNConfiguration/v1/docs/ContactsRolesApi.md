...
import com.factset.sdk.IRNConfiguration.api.ContactsRolesApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ContactsRolesApi apiInstance = new ContactsRolesApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRolesApi#createContactRole");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRolesApi#deleteContactRole");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> java.util.List<ContactRoleDto> getContactRoles()
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ContactsRolesApi apiInstance = new ContactsRolesApi(defaultClient);
        try {
            java.util.List<ContactRoleDto> result = apiInstance.getContactRoles();
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ContactsRolesApi#getContactRoles");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsRolesApi#updateContactRole");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
