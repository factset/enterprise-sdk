...
import com.factset.sdk.IRNConfiguration.api.ContactsTypesApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ContactsTypesApi apiInstance = new ContactsTypesApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsTypesApi#createContactType");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsTypesApi#deleteContactType");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> java.util.List<ContactTypeDto> getContactTypes()
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ContactsTypesApi apiInstance = new ContactsTypesApi(defaultClient);
        try {
            java.util.List<ContactTypeDto> result = apiInstance.getContactTypes();
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ContactsTypesApi#getContactTypes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ContactsTypesApi#updateContactType");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
