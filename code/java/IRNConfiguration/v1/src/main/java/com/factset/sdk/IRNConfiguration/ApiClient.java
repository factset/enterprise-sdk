package com.factset.sdk.IRNConfiguration;
...
import com.factset.sdk.IRNConfiguration.auth.Authentication;
import com.factset.sdk.IRNConfiguration.auth.HttpBasicAuth;
import com.factset.sdk.IRNConfiguration.auth.HttpBearerAuth;
import com.factset.sdk.IRNConfiguration.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.IRNConfiguration.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/research/irn/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/research/irn/v1",
      "Production Server",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api-sandbox.factset.com/research/irn/v1",
      "Sandbox Server",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/IRNConfiguration/2.1.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.IRNConfiguration.ApiClient} object.
   */
