  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customSymbolCustomFieldConfigDto.id) &&
        ...
        equalsNullable(this.formulaConfig, customSymbolCustomFieldConfigDto.formulaConfig) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(code), hashCodeNullable(name), hashCodeNullable(type), isHidden, isMandatory, isShownInInfobox, hashCodeNullable(formulaConfig), hashCodeNullable(optionsConfig), hashCodeNullable(customSymbolTypes));
  }
