...
public class UsersApi {
   ...
   */
  public java.util.List<UserConfigDto> v1UsersGet() throws ApiException {
    return v1UsersGetWithHttpInfo().getData();
  }
   ...
   */
  public ApiResponse<java.util.List<UserConfigDto>> v1UsersGetWithHttpInfo() throws ApiException {
    ...
    return apiClient.invokeAPI("UsersApi.v1UsersGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
