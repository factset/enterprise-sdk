 ...
 */
@JsonPropertyOrder({
  ContactTypeDto.JSON_PROPERTY_ID,
  ContactTypeDto.JSON_PROPERTY_NAME
})
...
public class ContactTypeDto implements Serializable {
  ...
  public ContactTypeDto id(java.util.UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ContactTypeDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ContactTypeDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contactTypeDto.id) &&
        Objects.equals(this.name, contactTypeDto.name);
  }
