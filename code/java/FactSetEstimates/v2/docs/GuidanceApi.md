...
> GuidanceResponse getGuidance(ids, metrics, startDate, endDate, relativeFiscalStart, relativeFiscalEnd, periodicity, frequency, currency)
...
import com.factset.sdk.FactSetEstimates.api.GuidanceApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling GuidanceApi#getGuidance");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        GuidanceApi apiInstance = new GuidanceApi(defaultClient);
        GuidanceRequest guidanceRequest = new GuidanceRequest(); // GuidanceRequest | Request object for Estimate Data Items.
        try {
            GuidanceResponse result = apiInstance.getGuidanceForList(guidanceRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling GuidanceApi#getGuidanceForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
