...
> SegmentsDetailsResponse getSegmentsDetailsForList(segmentsDetailsRequest)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SegmentsApi apiInstance = new SegmentsApi(defaultClient);
        SegmentsDetailsRequest segmentsDetailsRequest = new SegmentsDetailsRequest(); // SegmentsDetailsRequest | Request object for Product Segments estimates.
        try {
            SegmentsDetailsResponse result = apiInstance.getSegmentsDetailsForList(segmentsDetailsRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SegmentsApi#getSegmentsDetailsForList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
