...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetestimates/6.0.2)](https://central.sonatype.com/artifact/com.factset.sdk/factsetestimates/6.0.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetestimates:6.0.2"
  }
```
...
*DataItemsApi* | [**getEstimateSegmentDetailMetrics**](docs/DataItemsApi.md#getEstimateSegmentDetailMetrics) | **GET** /factset-estimates/v2/segments-metrics | Available Estimate Segment Detail metrics
...
*SegmentsApi* | [**getSegmentsDetailsForList**](docs/SegmentsApi.md#getSegmentsDetailsForList) | **POST** /factset-estimates/v2/segments-detail | Retrieves product segment detail estimates for a requested list of ids and fiscal periods
...
## Documentation for Models
 ...
 - [MetricSegmentDetail](docs/MetricSegmentDetail.md)
 - [MetricsRequest](docs/MetricsRequest.md)
 - [MetricsResponse](docs/MetricsResponse.md)
 - [MetricsSegmentDetailResponse](docs/MetricsSegmentDetailResponse.md)
 ...
 - [SegmentsDetailsEstimate](docs/SegmentsDetailsEstimate.md)
 - [SegmentsDetailsRequest](docs/SegmentsDetailsRequest.md)
 - [SegmentsDetailsResponse](docs/SegmentsDetailsResponse.md)
