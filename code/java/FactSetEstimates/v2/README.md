...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'factsetestimates' jar has been published to maven central.
    mavenLocal()       // Needed if the 'factsetestimates' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:factsetestimates:0.9.0"
  }
```
...
- `target/factsetestimates-0.9.0.jar`
- `target/lib/*.jar`
