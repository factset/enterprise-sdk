...
import com.factset.sdk.FactSetEstimates.models.Guidance;
 ...
 */
@JsonPropertyOrder({
  GuidanceResponse.JSON_PROPERTY_DATA
})
...
public class GuidanceResponse implements Serializable {
  ...
  private java.util.List<Guidance> data = null;

  public GuidanceResponse() { 
  }

  public GuidanceResponse data(java.util.List<Guidance> data) {
    this.data = data;
    return this;
  }

  public GuidanceResponse addDataItem(Guidance dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<Guidance> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<Guidance> data) {
    this.data = data;
  }


  /**
   * Return true if this guidanceResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GuidanceResponse guidanceResponse = (GuidanceResponse) o;
    return Objects.equals(this.data, guidanceResponse.data);
  }
