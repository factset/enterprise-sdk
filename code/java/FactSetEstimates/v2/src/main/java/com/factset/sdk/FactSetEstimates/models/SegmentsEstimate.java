...
public class SegmentsEstimate implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "USD", value = "Currency used estimates in consensus calculations. Use 'ESTIMATE' as input for values in Estimate Currency. For a list of currency ISO codes, visit [Online Assistant Page $0#1470](https://oa.apps.factset.com/pages/1470).")
  @JsonIgnore
