...
@JsonPropertyOrder({
  ...
  DetailRatings.JSON_PROPERTY_CHANGE_TYPE,
...
public class DetailRatings implements Serializable {
  ...
  **/
  ...
  public DetailRatings changeType(ChangeTypeEnum changeType) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "increase", value = "Indicates whether the rating has increased, decreased, or remained unchanged compared to the previous rating.   * **increase** = Rating improved   * **decrease** = Rating worsened   * **unchanged** = Rating remained the same ")
  @JsonIgnore
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.fsymId, detailRatings.fsymId) &&
        ...
        equalsNullable(this.changeType, detailRatings.changeType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(fsymId), hashCodeNullable(estimateDate), hashCodeNullable(analystId), hashCodeNullable(analystName), hashCodeNullable(brokerId), hashCodeNullable(brokerName), hashCodeNullable(ratingsNoteText), hashCodeNullable(changeType), requestId, hashCodeNullable(inputDateTime), hashCodeNullable(lastModifiedDate));
  }
