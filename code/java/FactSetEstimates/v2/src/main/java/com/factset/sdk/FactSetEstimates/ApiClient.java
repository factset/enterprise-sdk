...
import com.factset.sdk.FactSetEstimates.auth.Authentication;
import com.factset.sdk.FactSetEstimates.auth.HttpBasicAuth;
import com.factset.sdk.FactSetEstimates.auth.HttpBearerAuth;
import com.factset.sdk.FactSetEstimates.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetEstimates.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetEstimates/3.1.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
