...
public class ConsensusEstimate implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "20", value = "Count or NEST of estimates in consensus calculation. Will be `null` when `periodicity` is `LTMA` or `NTMA`. For more details, visit [Online Assistant Page #16598](https://oa.apps.factset.com/pages/16114)")
  @JsonIgnore
