...
import com.factset.sdk.FactSetEstimates.models.GuidanceRequest;
import com.factset.sdk.FactSetEstimates.models.GuidanceResponse;
...
public class GuidanceApi {
  ...
  private static final Map<Integer, GenericType> getGuidanceResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getGuidanceResponseTypeMap.put(200, new GenericType<GuidanceResponse>(){});
    getGuidanceResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
    getGuidanceResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getGuidanceResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
    getGuidanceResponseTypeMap.put(415, new GenericType<ErrorResponse>(){});
    getGuidanceResponseTypeMap.put(429, new GenericType<ErrorResponse>(){});
    getGuidanceResponseTypeMap.put(500, new GenericType<ErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getGuidanceForListResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getGuidanceForListResponseTypeMap.put(200, new GenericType<GuidanceResponse>(){});
    getGuidanceForListResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
    getGuidanceForListResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getGuidanceForListResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
    getGuidanceForListResponseTypeMap.put(415, new GenericType<ErrorResponse>(){});
    getGuidanceForListResponseTypeMap.put(429, new GenericType<ErrorResponse>(){});
    getGuidanceForListResponseTypeMap.put(500, new GenericType<ErrorResponse>(){});
  }
   ...
   */
  public GuidanceResponse getGuidance(java.util.List<String> ids, java.util.List<String> metrics, LocalDate startDate, LocalDate endDate, Integer relativeFiscalStart, Integer relativeFiscalEnd, String periodicity, String frequency, String currency) throws ApiException {
    return getGuidanceWithHttpInfo(ids, metrics, startDate, endDate, relativeFiscalStart, relativeFiscalEnd, periodicity, frequency, currency).getData();
  }
   ...
   * @param frequency Controls the frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).         * **AQ** &#x3D; Quarterly, based on the start date.   * **AY** &#x3D; Actual Annual, based on the start date.   (optional, default to D)
   * @param currency Currency code for adjusting the data. Use &#x60;ESTIMATE&#x60; as input value for the values in Estimate Currency. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470). (optional)
   * @return ApiResponse&lt;GuidanceResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<GuidanceResponse> getGuidanceWithHttpInfo(java.util.List<String> ids, java.util.List<String> metrics, LocalDate startDate, LocalDate endDate, Integer relativeFiscalStart, Integer relativeFiscalEnd, String periodicity, String frequency, String currency) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getGuidance");
    }
    
    // verify the required parameter 'metrics' is set
    if (metrics == null) {
      throw new ApiException(400, "Missing the required parameter 'metrics' when calling getGuidance");
    }
    
    // create path and map variables
    String localVarPath = "/factset-estimates/v2/guidance";
    ...
    > apiResponse = apiClient.invokeAPI("GuidanceApi.getGuidance", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getGuidanceResponseTypeMap, false);
   ...
   * Retrieves guidance for a requested list of ids and dates.
   * Returns FactSet Estimates guidance data for the current unreported period as of the requested dates. &lt;p&gt; 
   * @param guidanceRequest Request object for Estimate Data Items. (required)
   * @return GuidanceResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public GuidanceResponse getGuidanceForList(GuidanceRequest guidanceRequest) throws ApiException {
    return getGuidanceForListWithHttpInfo(guidanceRequest).getData();
  }
   ...
   */
  public ApiResponse<GuidanceResponse> getGuidanceForListWithHttpInfo(GuidanceRequest guidanceRequest) throws ApiException {
    Object localVarPostBody = guidanceRequest;
    
    // verify the required parameter 'guidanceRequest' is set
    if (guidanceRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'guidanceRequest' when calling getGuidanceForList");
    }
    ...
    > apiResponse = apiClient.invokeAPI("GuidanceApi.getGuidanceForList", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getGuidanceForListResponseTypeMap, false);
