...
import com.factset.sdk.FactSetEstimates.models.MetricsSegmentDetailResponse;
...
public class DataItemsApi {
  ...
  private static final Map<Integer, GenericType> getEstimateSegmentDetailMetricsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getEstimateSegmentDetailMetricsResponseTypeMap.put(200, new GenericType<MetricsSegmentDetailResponse>(){});
    getEstimateSegmentDetailMetricsResponseTypeMap.put(400, new GenericType<ErrorResponse>(){});
    getEstimateSegmentDetailMetricsResponseTypeMap.put(401, new GenericType<ErrorResponse>(){});
    getEstimateSegmentDetailMetricsResponseTypeMap.put(403, new GenericType<ErrorResponse>(){});
    getEstimateSegmentDetailMetricsResponseTypeMap.put(415, new GenericType<ErrorResponse>(){});
    getEstimateSegmentDetailMetricsResponseTypeMap.put(500, new GenericType<ErrorResponse>(){});
  }
   ...
   * @param ids Security or Entity identifiers. Accepted inputs include FactSet Identifiers, tickers, CUSIP, and SEDOL.  (required)
   * @param metrics Requested metric. Use the &#x60;/metrics&#x60; endpoint to return a list of available estimate items. **Top 10** most used metrics are **EPS, SALES, DPS, EBITDA, EBIT, PRICE_TGT, CFPS, BPS, NET_INC, and ASSETS**. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034).  (required)
   * @param segmentType Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)
   * @return MetricsSegmentDetailResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Estimate segment detail data metric items </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public MetricsSegmentDetailResponse getEstimateSegmentDetailMetrics(java.util.List<String> ids, java.util.List<String> metrics, String segmentType) throws ApiException {
    return getEstimateSegmentDetailMetricsWithHttpInfo(ids, metrics, segmentType).getData();
  }
   ...
   * @param metrics Requested metric. Use the &#x60;/metrics&#x60; endpoint to return a list of available estimate items. **Top 10** most used metrics are **EPS, SALES, DPS, EBITDA, EBIT, PRICE_TGT, CFPS, BPS, NET_INC, and ASSETS**. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034).  (required)
   * @param segmentType Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)
   * @return ApiResponse&lt;MetricsSegmentDetailResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<MetricsSegmentDetailResponse> getEstimateSegmentDetailMetricsWithHttpInfo(java.util.List<String> ids, java.util.List<String> metrics, String segmentType) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getEstimateSegmentDetailMetrics");
    }
    
    // verify the required parameter 'metrics' is set
    if (metrics == null) {
      throw new ApiException(400, "Missing the required parameter 'metrics' when calling getEstimateSegmentDetailMetrics");
    }
    
    // create path and map variables
    String localVarPath = "/factset-estimates/v2/segments-metrics";
    ...
    > apiResponse = apiClient.invokeAPI("DataItemsApi.getEstimateSegmentDetailMetrics", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getEstimateSegmentDetailMetricsResponseTypeMap, false);
