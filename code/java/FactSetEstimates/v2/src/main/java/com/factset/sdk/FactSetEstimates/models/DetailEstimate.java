...
public class DetailEstimate implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fsymId, metric, periodicity, fiscalYear, fiscalPeriod, fiscalEndDate, relativePeriod, currency, estimateDate, estimateValue, analystId, analystName, brokerId, brokerName, prevEstimateDate, prevEstimateValue, section, statusCode, statusText, requestId);
  }
