...
@JsonPropertyOrder({
  ...
  DetailEstimate.JSON_PROPERTY_DOC_ID,
...
public class DetailEstimate implements Serializable {
  ...
  private JsonNullable<String> docId = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public DetailEstimate docId(String docId) {
    this.docId = JsonNullable.<String>of(docId);
    return this;
  }

   /**
   * A unique identifier for the document report associated with a broker’s analyst estimate. Use this docId to retrieve the corresponding investment report through FactSet’s Investment Research API.
   * @return docId
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "52ddb8602911b02fa3b0f471d25fb6f0", value = "A unique identifier for the document report associated with a broker’s analyst estimate. Use this docId to retrieve the corresponding investment report through FactSet’s Investment Research API.")
  @JsonIgnore
  ...
  public JsonNullable<String> getDocId_JsonNullable() {
    return docId;
  }
  
  @JsonProperty(JSON_PROPERTY_DOC_ID)
  public void setDocId_JsonNullable(JsonNullable<String> docId) {
    this.docId = docId;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, detailEstimate.requestId) &&
        equalsNullable(this.fsymId, detailEstimate.fsymId) &&
        ...
        equalsNullable(this.docId, detailEstimate.docId) &&
