...
import com.factset.sdk.FactSetEstimates.models.ConsensusEstimate;
 ...
 */
@JsonPropertyOrder({
  ConsensusResponse.JSON_PROPERTY_DATA
})
...
public class ConsensusResponse implements Serializable {
  ...
  public ConsensusResponse addDataItem(ConsensusEstimate dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<ConsensusEstimate> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<ConsensusEstimate> data) {
    this.data = data;
  }


  /**
   * Return true if this consensusResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ConsensusResponse consensusResponse = (ConsensusResponse) o;
    return Objects.equals(this.data, consensusResponse.data);
  }
