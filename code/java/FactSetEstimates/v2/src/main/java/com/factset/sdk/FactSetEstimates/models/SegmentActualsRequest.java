 ...
 */
@ApiModel(description = "Request object for requesting segment actuals.")
@JsonPropertyOrder({
  SegmentActualsRequest.JSON_PROPERTY_IDS,
  SegmentActualsRequest.JSON_PROPERTY_METRICS,
  SegmentActualsRequest.JSON_PROPERTY_SEGMENT_TYPE,
  SegmentActualsRequest.JSON_PROPERTY_RELATIVE_FISCAL_START,
  SegmentActualsRequest.JSON_PROPERTY_RELATIVE_FISCAL_END,
  SegmentActualsRequest.JSON_PROPERTY_PERIODICITY,
  SegmentActualsRequest.JSON_PROPERTY_CURRENCY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SegmentActualsRequest implements Serializable {
  ...
  private java.util.List<MetricsEnum> metrics = new java.util.ArrayList<>();
  ...
  public SegmentActualsRequest() { 
  }

  @JsonCreator
  public SegmentActualsRequest(
    @JsonProperty(value=JSON_PROPERTY_IDS, required=true) java.util.List<String> ids, 
    @JsonProperty(value=JSON_PROPERTY_METRICS, required=true) java.util.List<MetricsEnum> metrics
  ) {
    this();
    this.ids = ids;
  ...
  public SegmentActualsRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public SegmentActualsRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public SegmentActualsRequest metrics(java.util.List<MetricsEnum> metrics) {
    this.metrics = metrics;
    return this;
  }

  public SegmentActualsRequest addMetricsItem(MetricsEnum metricsItem) {
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "[\"SALES\"]", required = true, value = "Requested metrics for segment actuals. An asterisk denotes metric items included for geographic segments. Note, the number of metrics you   are allowed to supply is limited to 1 for now. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034).  <h3>Financial Metrics</h3> |field|description| |---|---| |ASP|Average Selling Price| |ARR|Annual Recurring Revenue| |CAPEX|Capital Expenditures| |CCUR_GRTH*|Constant Currency Revenue Growth*| |COS*|Cost of Sales*| |CFO_GAAP|Chief Financial Officer (GAAP)| |DELIVERIES_UNITS|Deliveries Units| |EPS|Earnings Per Share| |EBIT*|Earnings Before Interest and Taxes*| |EBIT_REP|Earnings Before Interest and Taxes - Reported| |EBITDA*|Earnings Before Interest, Taxes, Depreciation, and Amortization*| |EBITDA_REP|Earnings Before Interest, Taxes, Depreciation, and Amortization - Reported| |G_A_EXP|General & Admin Expense| |GROSS_INC*|Gross Income*| |GMV*|Gross Merchandise Volume*| |LCUR_GRTH*|Local Currency Revenue Growth*| |NET_ADDS|Net Adds| |NET_INC*|Net Profit*| |NET_SALES*|Net Sales*| |SUBSCRIBERS_NB*|Number of Subscribers*| |ORGANICGROWTH*|Organic Growth*| |PTX_INC|Pre-Tax Income| |RATEBASE*|Ratebase*| |AVGRATEBASE|Avg. Ratebase| |SALES*|Sales*| |SAMESTORESALES|Same Store Sales| |SGA|Selling, General & Administrative Expenses| |S_M_EXP|Selling & Marketing Expenses| |REV_TOT*|Total Revenues*|  <h3>Industry Metrics</h3> |field|description| |---|---| |UNITS|Units| |NEW_ORDERS_VALUE*|Home Builders - New Orders Value*| |BACKLOG_VALUE|Home Builders - Backlog Value| |MCR|Hospitals - Medical Cost Ratio (%)| |CASH_COST|Mining - Cash Cost| |REAL_PRICE|Mining - Real Price| |DAU*|Social Media/Games - Daily Active Users*| |ARPU|Telecoms - Average Revenue Per User (ARPU)| |CONTR_PROF|Telecoms - Contribution Profit| |PAIDNADDS|Telecoms - Paid Net Adds| ")
  @JsonProperty(JSON_PROPERTY_METRICS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public java.util.List<MetricsEnum> getMetrics() {
    return metrics;
  }
  ...
  @JsonProperty(JSON_PROPERTY_METRICS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMetrics(java.util.List<MetricsEnum> metrics) {
    this.metrics = metrics;
  }


  public SegmentActualsRequest segmentType(SegmentType segmentType) {
  ...
  **/
  ...
  public SegmentActualsRequest relativeFiscalStart(Integer relativeFiscalStart) {
  ...
  **/
  ...
  public SegmentActualsRequest relativeFiscalEnd(Integer relativeFiscalEnd) {
  ...
  **/
  ...
  public SegmentActualsRequest periodicity(Periodicity periodicity) {
  ...
  **/
  ...
  public SegmentActualsRequest currency(String currency) {
  ...
  **/
  ...
  /**
   * Return true if this segmentActualsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SegmentActualsRequest segmentActualsRequest = (SegmentActualsRequest) o;
    return Objects.equals(this.ids, segmentActualsRequest.ids) &&
        Objects.equals(this.metrics, segmentActualsRequest.metrics) &&
        Objects.equals(this.segmentType, segmentActualsRequest.segmentType) &&
        Objects.equals(this.relativeFiscalStart, segmentActualsRequest.relativeFiscalStart) &&
        Objects.equals(this.relativeFiscalEnd, segmentActualsRequest.relativeFiscalEnd) &&
        Objects.equals(this.periodicity, segmentActualsRequest.periodicity) &&
        Objects.equals(this.currency, segmentActualsRequest.currency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, metrics, segmentType, relativeFiscalStart, relativeFiscalEnd, periodicity, currency);
  }
