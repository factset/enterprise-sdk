...
@JsonPropertyOrder({
  ...
  FixedDetailRequest.JSON_PROPERTY_SORT_BY_INPUT_DATE_TIME,
  FixedDetailRequest.JSON_PROPERTY_INCLUDE_DOC_ID
})
...
public class FixedDetailRequest implements Serializable {
  ...
  public static final String JSON_PROPERTY_INCLUDE_DOC_ID = "includeDocId";
  private Boolean includeDocId = false;
  ...
  **/
  ...
  public FixedDetailRequest sortByInputDateTime(Boolean sortByInputDateTime) {
  ...
  **/
  ...
  public FixedDetailRequest includeDocId(Boolean includeDocId) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Controls whether the `docId` field is included in the response.   * `TRUE` = Returns the `docId` field, a unique identifier linking the estimate to the corresponding investment report in FactSet's Investment Research API.   * `FALSE` = Omits the `docId` field from the response. (default) ")
  @JsonProperty(JSON_PROPERTY_INCLUDE_DOC_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_INCLUDE_DOC_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncludeDocId(Boolean includeDocId) {
    this.includeDocId = includeDocId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ids, fixedDetailRequest.ids) &&
        ...
        Objects.equals(this.sortByInputDateTime, fixedDetailRequest.sortByInputDateTime) &&
        Objects.equals(this.includeDocId, fixedDetailRequest.includeDocId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, metrics, startDate, endDate, frequency, includeAll, periodicity, fiscalPeriodStart, fiscalPeriodEnd, currency, brokerNames, updatesOnly, sortByInputDateTime, includeDocId);
  }
  ...
  public String toString() {
    ...
    sb.append("    includeDocId: ").append(toIndentedString(includeDocId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
