...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetfundamentals/4.1.1)](https://central.sonatype.com/artifact/com.factset.sdk/factsetfundamentals/4.1.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetfundamentals:4.1.1"
  }
```
...
*FactSetFundamentalsApi* | [**getFdsFundamentalsForList**](docs/FactSetFundamentalsApi.md#getFdsFundamentalsForList) | **POST** /fundamentals | Returns Company Fundamentals Data.
*FundamentalsPointInTimeApi* | [**postFundamentalsFiscalPeriods**](docs/FundamentalsPointInTimeApi.md#postFundamentalsFiscalPeriods) | **POST** /periods | Fiscal Periods: Retrieve fiscal period details for multiple securities using POST.
*FundamentalsPointInTimeApi* | [**postFundamentalsPITData**](docs/FundamentalsPointInTimeApi.md#postFundamentalsPITData) | **POST** /point-in-time | Retrieve Point-in-Time data for multiple securities.
...
## Documentation for Models
 ...
 - [FundamentalsPITData](docs/FundamentalsPITData.md)
 - [FundamentalsPITRequest](docs/FundamentalsPITRequest.md)
 - [FundamentalsPITRequestBody](docs/FundamentalsPITRequestBody.md)
 - [FundamentalsPITResponse](docs/FundamentalsPITResponse.md)
 ...
 - [PeriodsRequest](docs/PeriodsRequest.md)
 - [PeriodsRequestBody](docs/PeriodsRequestBody.md)
 - [PeriodsResponse](docs/PeriodsResponse.md)
