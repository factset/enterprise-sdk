 ...
 */
@ApiModel(description = "Contains the array of fiscal period information matching the request criteria.")
@JsonPropertyOrder({
  PeriodsResponse.JSON_PROPERTY_DATA
})
...
public class PeriodsResponse implements Serializable {
  ...
  private java.util.List<PeriodInfo> data = null;

  public PeriodsResponse() { 
  }

  public PeriodsResponse data(java.util.List<PeriodInfo> data) {
    this.data = data;
    return this;
  }

  public PeriodsResponse addDataItem(PeriodInfo dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of fiscal period detail objects.")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<PeriodInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PeriodInfo> data) {
    this.data = data;
  }


  /**
   * Return true if this PeriodsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PeriodsResponse periodsResponse = (PeriodsResponse) o;
    return Objects.equals(this.data, periodsResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class PeriodsResponse {\n");
