...
@JsonPropertyOrder({
  ...
  Metric.JSON_PROPERTY_IS_P_I_T,
  Metric.JSON_PROPERTY_IS_NON_P_I_T,
...
public class Metric implements Serializable {
  ...
  public static final String JSON_PROPERTY_IS_P_I_T = "isPIT";
  private Boolean isPIT;

  public static final String JSON_PROPERTY_IS_NON_P_I_T = "isNonPIT";
  private Boolean isNonPIT;
  ...
  **/
  ...
  @ApiModelProperty(example = "FF_ASSETS", value = "Metric identifier to be used as `metrics` input in `/fundamentals/v2/fundamentals` endpoint.")
  @JsonIgnore
  ...
  **/
  ...
  public Metric isPIT(Boolean isPIT) {
    this.isPIT = isPIT;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Flag indicating if the metric is available in Point-in-Time (PIT) datasets, and can be used with the `/point-in-time` endpoint.")
  @JsonProperty(JSON_PROPERTY_IS_P_I_T)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public Metric isNonPIT(Boolean isNonPIT) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Flag indicating if the metric is available in non-Point-in-Time (non-PIT) datasets, and can be used with the `/fundamentals` endpoint. A metric can be available in both PIT and non-PIT datasets.")
  @JsonProperty(JSON_PROPERTY_IS_NON_P_I_T)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getIsNonPIT() {
    return isNonPIT;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IS_NON_P_I_T)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsNonPIT(Boolean isNonPIT) {
    this.isNonPIT = isNonPIT;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.metric, metric.metric) &&
        ...
        Objects.equals(this.isPIT, metric.isPIT) &&
        Objects.equals(this.isNonPIT, metric.isNonPIT) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(metric), hashCodeNullable(name), hashCodeNullable(category), hashCodeNullable(subcategory), isPIT, isNonPIT, hashCodeNullable(oaPageId), hashCodeNullable(description), hashCodeNullable(oaUrl), hashCodeNullable(factor), hashCodeNullable(sdfPackage), hashCodeNullable(dataType));
  }
  ...
  public String toString() {
    ...
    sb.append("    isPIT: ").append(toIndentedString(isPIT)).append("\n");
    sb.append("    isNonPIT: ").append(toIndentedString(isNonPIT)).append("\n");
