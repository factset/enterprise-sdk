...
public class Segment implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "SALES", value = "The requested `metric` input, representing the Fundamentals Data Item. For a definition of the item please use the `/fundamentals/v2/metrics` endpoint.")
  @JsonIgnore
