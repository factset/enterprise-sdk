...
public class BatchResult extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class BatchResultDeserializer extends StdDeserializer<BatchResult> {
        ...
        public BatchResult deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize FundamentalsPITData
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FundamentalsPITData.class.equals(Integer.class) || FundamentalsPITData.class.equals(Long.class) || FundamentalsPITData.class.equals(Float.class) || FundamentalsPITData.class.equals(Double.class) || FundamentalsPITData.class.equals(Boolean.class) || FundamentalsPITData.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FundamentalsPITData.class.equals(Integer.class) || FundamentalsPITData.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FundamentalsPITData.class.equals(Float.class) || FundamentalsPITData.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (FundamentalsPITData.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FundamentalsPITData.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<FundamentalsPITData>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'FundamentalsPITData'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FundamentalsPITData'", e);
            }

            // deserialize PeriodInfo
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (PeriodInfo.class.equals(Integer.class) || PeriodInfo.class.equals(Long.class) || PeriodInfo.class.equals(Float.class) || PeriodInfo.class.equals(Double.class) || PeriodInfo.class.equals(Boolean.class) || PeriodInfo.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((PeriodInfo.class.equals(Integer.class) || PeriodInfo.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((PeriodInfo.class.equals(Float.class) || PeriodInfo.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (PeriodInfo.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (PeriodInfo.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<PeriodInfo>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'PeriodInfo'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'PeriodInfo'", e);
            }
    ...
    public BatchResult(FundamentalsPITData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public BatchResult(PeriodInfo o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    static {
        ...
        schemas.put("FundamentalsPITData", new GenericType<FundamentalsPITData>() {
        });
        schemas.put("PeriodInfo", new GenericType<PeriodInfo>() {
        });
     ...
     * Fundamental, FundamentalsPITData, PeriodInfo, Segment
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        // FundamentalsPITData
        if (JSON.isInstanceOf(FundamentalsPITData.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        // PeriodInfo
        if (JSON.isInstanceOf(PeriodInfo.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Fundamental, FundamentalsPITData, PeriodInfo, Segment");
    }
     ...
     * Fundamental, FundamentalsPITData, PeriodInfo, Segment
     *
     * @return The actual instance (Fundamental, FundamentalsPITData, PeriodInfo, Segment)
     */
    @Override
    ...
    /**
     * Get the actual instance of `FundamentalsPITData`. If the actual instance is not `FundamentalsPITData`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FundamentalsPITData`
     * @throws ClassCastException if the instance is not `FundamentalsPITData`
     */
    public FundamentalsPITData getFundamentalsPITData() throws ClassCastException {
        return (FundamentalsPITData)super.getActualInstance();
    }

    /**
     * Get the actual instance of `PeriodInfo`. If the actual instance is not `PeriodInfo`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `PeriodInfo`
     * @throws ClassCastException if the instance is not `PeriodInfo`
     */
    public PeriodInfo getPeriodInfo() throws ClassCastException {
        return (PeriodInfo)super.getActualInstance();
    }
