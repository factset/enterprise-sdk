...
import com.factset.sdk.FactSetFundamentals.models.PeriodsRequestBody;
 ...
 */
@ApiModel(description = "Wrapper object containing the parameters for a POST request to the `/periods` endpoint.")
@JsonPropertyOrder({
  PeriodsRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PeriodsRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private PeriodsRequestBody data;

  public PeriodsRequest() { 
  }

  @JsonCreator
  public PeriodsRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) PeriodsRequestBody data
  ) {
    this();
    this.data = data;
  }

  public PeriodsRequest data(PeriodsRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PeriodsRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(PeriodsRequestBody data) {
    this.data = data;
  }


  /**
   * Return true if this PeriodsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PeriodsRequest periodsRequest = (PeriodsRequest) o;
    return Objects.equals(this.data, periodsRequest.data);
  }
