...
public class Profile implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, error, hashCodeNullable(fsymId), hashCodeNullable(tickerRegion), exchange, hashCodeNullable(name), address, hashCodeNullable(industry), hashCodeNullable(sector), hashCodeNullable(numberOfEmployees), hashCodeNullable(ceo), hashCodeNullable(businessSummary), hashCodeNullable(yearFounded), hashCodeNullable(marketCapitalization), hashCodeNullable(totalMarketCapitalization), hashCodeNullable(sharesOutstanding), hashCodeNullable(peRatio));
  }
