...
@JsonDeserialize(using = FundamentalValue.FundamentalValueDeserializer.class)
@JsonSerialize(using = FundamentalValue.FundamentalValueSerializer.class)
public class FundamentalValue extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(FundamentalValue.class.getName());

    public static class FundamentalValueSerializer extends StdSerializer<FundamentalValue> {
        public FundamentalValueSerializer(Class<FundamentalValue> t) {
            super(t);
        }

        public FundamentalValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(FundamentalValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class FundamentalValueDeserializer extends StdDeserializer<FundamentalValue> {
        public FundamentalValueDeserializer() {
            this(FundamentalValue.class);
        }

        public FundamentalValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public FundamentalValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                FundamentalValue ret = new FundamentalValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for FundamentalValue: %d classes match result, expected 1", match));
        }
    ...
    public FundamentalValue(Double o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(FundamentalValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return FundamentalValue.schemas;
    }
