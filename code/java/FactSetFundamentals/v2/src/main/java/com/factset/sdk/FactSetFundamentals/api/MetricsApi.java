...
public class MetricsApi {
   ...
   * @param metricDataType Returns general data type of the metrics like integer, float or strings. When left blank, metrics with all data types would be returned. (optional, default to )
   * @param pitDataItems Filters the list of metrics based on whether they are available for Point-in-Time (PIT) historical data. * &#x60;true&#x60; - Returns metrics that are available in PIT datasets. These metrics can be used in the &#x60;/point-in-time&#x60; endpoint. * &#x60;false&#x60; (default) - Returns metrics that are available in non-PIT datasets. (optional, default to false)
   * @return MetricsResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Fundamentals data metric items </td><td>  -  </td></tr>
   ...
   */
  public MetricsResponse getFdsFundamentalsMetrics(String category, String subcategory, String metricDataType, Boolean pitDataItems) throws ApiException {
    return getFdsFundamentalsMetricsWithHttpInfo(category, subcategory, metricDataType, pitDataItems).getData();
  }
   ...
   */
  public ApiResponse<MetricsResponse> getFdsFundamentalsMetricsWithHttpInfo(String category, String subcategory, String metricDataType, Boolean pitDataItems) throws ApiException {
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "pitDataItems", pitDataItems));
