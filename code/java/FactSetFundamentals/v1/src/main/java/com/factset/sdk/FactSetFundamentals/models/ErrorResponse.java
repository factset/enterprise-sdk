...
import com.factset.sdk.FactSetFundamentals.models.ErrorResponseSubErrors;
...
public class ErrorResponse implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "/factset-fundamentals/v1/{endpoint}", value = "The Endpoint path {package}/version/{endpoint}")
