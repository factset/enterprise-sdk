...
The `matchFlag` indicates whether the `entityId` is a FactSet match based on the input name and country. When `true`, the FactSet `entityId` was confidently matched to the input name and country. When `false`, the FactSet `entityId` could not be confidently matched to the input name and country.

**Max of 1 Name permitted in a single GET request.** Use the POST method to fetch up to 25 names.
...
import com.factset.sdk.FactSetPrivateCompany.api.UniverseApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String name = "Alto Pharmacy"; // String | Name of Entity to match.<br/>  <p>***max length** =  200 per request*</p> 
        String country = "US"; // String | ISO2 country code corresponding to the entity name is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754).
        try {
