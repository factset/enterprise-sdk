...
import com.factset.sdk.FactSetPrivateCompany.models.FinancialsRequestBody;
 ...
 */
@ApiModel(description = "Entity Reference Request")
@JsonPropertyOrder({
...
public class FinancialsRequest implements Serializable {
  ...
  private FinancialsRequestBody data;
  ...
  @JsonCreator
  public FinancialsRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) FinancialsRequestBody data
  ) {
    this();
    this.data = data;
  }

  public FinancialsRequest data(FinancialsRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public FinancialsRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(FinancialsRequestBody data) {
    this.data = data;
  }
