...
import com.factset.sdk.FactSetPrivateCompany.auth.Authentication;
import com.factset.sdk.FactSetPrivateCompany.auth.HttpBasicAuth;
import com.factset.sdk.FactSetPrivateCompany.auth.HttpBearerAuth;
import com.factset.sdk.FactSetPrivateCompany.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetPrivateCompany.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/content/private-company/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/content/private-company/v1",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetPrivateCompany/1.0.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetPrivateCompany.ApiClient} object.
   */
