...
public class EntityMatch implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "0H3R4Y-E", value = "FactSet Entity Identifier of the entity matched respective to the requested Name submitted. For more detail, visit [FactSet Permanent Security Identifier](https://oa.apps.factset.com/cms/oaAttachment/64c3213a-f415-4c27-a336-92c73a72deed/24881) ")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Alto Pharmacy LLC", value = "Full name corresponding to the matched entity.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "PVT", value = "Code representing the entity type of the matched entity. For more details, view Online Assistant page [OA16823](https://my.apps.factset.com/oa/pages/16823)")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Flag denoting if the row is a match.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(entityId), hashCodeNullable(entityName), hashCodeNullable(countryCode), hashCodeNullable(entityTypeCode), matchFlag);
  }
