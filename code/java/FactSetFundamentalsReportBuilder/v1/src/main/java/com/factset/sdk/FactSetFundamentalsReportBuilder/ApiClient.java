package com.factset.sdk.FactSetFundamentalsReportBuilder;
...
import com.factset.sdk.FactSetFundamentalsReportBuilder.auth.Authentication;
import com.factset.sdk.FactSetFundamentalsReportBuilder.auth.HttpBasicAuth;
import com.factset.sdk.FactSetFundamentalsReportBuilder.auth.HttpBearerAuth;
import com.factset.sdk.FactSetFundamentalsReportBuilder.auth.FactSetOAuth2ClientAuth;
import com.factset.sdk.FactSetFundamentalsReportBuilder.auth.ApiKeyAuth;
import com.factset.sdk.FactSetFundamentalsReportBuilder.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/report/financials/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/report/financials/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap, OAuth2Client oauth2Client) {
    ...
    setUserAgent("fds-sdk/java/FactSetFundamentalsReportBuilder/0.9.1");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetFundamentalsReportBuilder.ApiClient} object.
   */
