...
import com.factset.sdk.FactSetEntity.auth.Authentication;
import com.factset.sdk.FactSetEntity.auth.HttpBasicAuth;
import com.factset.sdk.FactSetEntity.auth.HttpBearerAuth;
import com.factset.sdk.FactSetEntity.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetEntity.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetEntity/2.2.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetEntity.ApiClient} object.
   */
