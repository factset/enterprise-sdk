...
@JsonPropertyOrder({
  ...
  EntityReference.JSON_PROPERTY_COUNTRY_OF_RISK_GEO_REV,
...
public class EntityReference implements Serializable {
  ...
  public static final String JSON_PROPERTY_COUNTRY_OF_RISK_GEO_REV = "countryOfRiskGeoRev";
  private JsonNullable<String> countryOfRiskGeoRev = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public EntityReference countryOfRiskGeoRev(String countryOfRiskGeoRev) {
    this.countryOfRiskGeoRev = JsonNullable.<String>of(countryOfRiskGeoRev);
    return this;
  }

   /**
   * Entity&#39;s Country of Risk based on the Top Geograghic Revenue. 
   * @return countryOfRiskGeoRev
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "US", value = "Entity's Country of Risk based on the Top Geograghic Revenue. ")
  @JsonIgnore

  public String getCountryOfRiskGeoRev() {
        return countryOfRiskGeoRev.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_COUNTRY_OF_RISK_GEO_REV)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getCountryOfRiskGeoRev_JsonNullable() {
    return countryOfRiskGeoRev;
  }
  
  @JsonProperty(JSON_PROPERTY_COUNTRY_OF_RISK_GEO_REV)
  public void setCountryOfRiskGeoRev_JsonNullable(JsonNullable<String> countryOfRiskGeoRev) {
    this.countryOfRiskGeoRev = countryOfRiskGeoRev;
  }

  public void setCountryOfRiskGeoRev(String countryOfRiskGeoRev) {
    this.countryOfRiskGeoRev = JsonNullable.<String>of(countryOfRiskGeoRev);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.fsymId, entityReference.fsymId) &&
        ...
        equalsNullable(this.countryOfRiskGeoRev, entityReference.countryOfRiskGeoRev) &&
  ...
  public String toString() {
    ...
    sb.append("    countryOfRiskGeoRev: ").append(toIndentedString(countryOfRiskGeoRev)).append("\n");
