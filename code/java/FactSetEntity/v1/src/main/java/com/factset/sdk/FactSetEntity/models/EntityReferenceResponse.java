...
import com.factset.sdk.FactSetEntity.models.EntityReference;
 ...
 */
@JsonPropertyOrder({
  EntityReferenceResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class EntityReferenceResponse implements Serializable {
  ...
  public EntityReferenceResponse addDataItem(EntityReference dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<EntityReference> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<EntityReference> data) {
    this.data = data;
  }


  /**
   * Return true if this entityReferenceResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityReferenceResponse entityReferenceResponse = (EntityReferenceResponse) o;
    return Objects.equals(this.data, entityReferenceResponse.data);
  }
