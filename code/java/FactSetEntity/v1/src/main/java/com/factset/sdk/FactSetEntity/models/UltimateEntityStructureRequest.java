 ...
 */
@ApiModel(description = "Ultimate Entity Structure Request Body")
@JsonPropertyOrder({
  UltimateEntityStructureRequest.JSON_PROPERTY_IDS,
  UltimateEntityStructureRequest.JSON_PROPERTY_LEVEL,
  UltimateEntityStructureRequest.JSON_PROPERTY_ACTIVE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class UltimateEntityStructureRequest implements Serializable {
  ...
  public UltimateEntityStructureRequest() { 
  }
  ...
  public UltimateEntityStructureRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public UltimateEntityStructureRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public UltimateEntityStructureRequest level(Integer level) {
    this.level = level;
    return this;
  }
  ...
  **/
  ...
  public UltimateEntityStructureRequest active(Integer active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ultimateEntityStructureRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UltimateEntityStructureRequest ultimateEntityStructureRequest = (UltimateEntityStructureRequest) o;
    return Objects.equals(this.ids, ultimateEntityStructureRequest.ids) &&
        Objects.equals(this.level, ultimateEntityStructureRequest.level) &&
        Objects.equals(this.active, ultimateEntityStructureRequest.active);
  }
