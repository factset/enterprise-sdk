...
> FirmDescriptionResourceList firmDescriptionsGet(filter, startIndex, count, attributes, excludedAttributes)
...
import com.factset.sdk.ProcuretoPayAPISCIM.api.FirmDescriptionsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        FirmDescriptionsApi apiInstance = new FirmDescriptionsApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling FirmDescriptionsApi#firmDescriptionsGet");
...
> FirmDescriptionResource firmDescriptionsIdGet(id)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling FirmDescriptionsApi#firmDescriptionsIdGet");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
