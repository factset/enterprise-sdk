...
> ProductResource getProduct(id, attributes, excludedAttributes, additionalAttributes)
...
> ProductResourceList getProducts(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes, additionalAttributes)
