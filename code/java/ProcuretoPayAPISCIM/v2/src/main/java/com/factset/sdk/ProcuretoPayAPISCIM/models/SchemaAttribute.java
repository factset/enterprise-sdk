...
import com.factset.sdk.ProcuretoPayAPISCIM.models.SchemaSubAttribute;
...
public class SchemaAttribute implements Serializable {
  ...
  private java.util.List<SchemaSubAttribute> subAttributes = null;
  ...
  public SchemaAttribute(
    ...
    @JsonProperty(JSON_PROPERTY_SUB_ATTRIBUTES) java.util.List<SchemaSubAttribute> subAttributes
  ) {
    this();
    this.name = name;
    this.type = type;
  ...
  **/
  ...
  public java.util.List<SchemaSubAttribute> getSubAttributes() {
    return subAttributes;
  }
  ...
  /**
   * Return true if this SchemaAttribute object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, schemaAttribute.name) &&
