...
public class ServiceProviderConfigFilter implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", required = true, value = "A Boolean value specifying whether or not the operation is supported.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "1000", required = true, value = "An integer value specifying the maximum number of resources returned in a response.")
