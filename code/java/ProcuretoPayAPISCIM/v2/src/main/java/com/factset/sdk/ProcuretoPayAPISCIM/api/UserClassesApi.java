...
public class UserClassesApi {
   ...
   */
  public UserClassResource getUserClass(String id, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    return getUserClassWithHttpInfo(id, attributes, excludedAttributes, additionalAttributes).getData();
  }
   ...
   */
  public ApiResponse<UserClassResource> getUserClassWithHttpInfo(String id, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
   ...
   */
  public UserClassResourceList getUserClasses(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    return getUserClassesWithHttpInfo(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes, additionalAttributes).getData();
  }
   ...
   */
  public ApiResponse<UserClassResourceList> getUserClassesWithHttpInfo(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    Object localVarPostBody = null;
