...
import com.factset.sdk.ProcuretoPayAPISCIM.models.ProductResourceList;
...
public class ProductsApi {
  ...
  private static final Map<Integer, GenericType> getProductResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getProductResponseTypeMap.put(200, new GenericType<ProductResource>(){});
    getProductResponseTypeMap.put(401, new GenericType<Error>(){});
    getProductResponseTypeMap.put(403, new GenericType<Error>(){});
    getProductResponseTypeMap.put(404, new GenericType<Error>(){});
    getProductResponseTypeMap.put(429, new GenericType<InlineResponse429>(){});
    getProductResponseTypeMap.put(500, new GenericType<Error>(){});
  }

  private static final Map<Integer, GenericType> getProductsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getProductsResponseTypeMap.put(200, new GenericType<ProductResourceList>(){});
    getProductsResponseTypeMap.put(400, new GenericType<Error>(){});
    getProductsResponseTypeMap.put(401, new GenericType<Error>(){});
    getProductsResponseTypeMap.put(403, new GenericType<Error>(){});
    getProductsResponseTypeMap.put(429, new GenericType<InlineResponse429>(){});
    getProductsResponseTypeMap.put(500, new GenericType<Error>(){});
  }
   ...
   */
  public ProductResource getProduct(String id) throws ApiException {
    return getProductWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<ProductResource> getProductWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getProduct");
    }
    ...
    > apiResponse = apiClient.invokeAPI("ProductsApi.getProduct", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getProductResponseTypeMap, false);
   ...
   */
  public ProductResourceList getProducts(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, String attributes, String excludedAttributes) throws ApiException {
    return getProductsWithHttpInfo(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes).getData();
  }
   ...
   * @param attributes Attribute whitelist filter string. A comma-separated list of resource attribute names to be returned in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *excludedAttributes* parameter. (optional)
   * @param excludedAttributes Attribute blacklist filter string. A comma-separated list of resource attribute names to be excluded in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* parameter. (optional)
   * @return ApiResponse&lt;ProductResourceList&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<ProductResourceList> getProductsWithHttpInfo(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, String attributes, String excludedAttributes) throws ApiException {
    Object localVarPostBody = null;
