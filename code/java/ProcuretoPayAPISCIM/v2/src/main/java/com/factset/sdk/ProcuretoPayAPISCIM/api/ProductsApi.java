...
public class ProductsApi {
  ...
  static {
    ...
    productsGetResponseTypeMap.put(401, new GenericType<Error>(){});
  ...
  static {
    ...
    productsIdGetResponseTypeMap.put(401, new GenericType<Error>(){});
    productsIdGetResponseTypeMap.put(403, new GenericType<Error>(){});
    productsIdGetResponseTypeMap.put(404, new GenericType<Error>(){});
   ...
   */
  public ProductResourceList productsGet(String filter, Integer startIndex, Integer count, String attributes, String excludedAttributes) throws ApiException {
    return productsGetWithHttpInfo(filter, startIndex, count, attributes, excludedAttributes).getData();
  }
   ...
   */
  public ApiResponse<ProductResourceList> productsGetWithHttpInfo(String filter, Integer startIndex, Integer count, String attributes, String excludedAttributes) throws ApiException {
    ...
    > apiResponse = apiClient.invokeAPI("ProductsApi.productsGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, productsGetResponseTypeMap, false);
   ...
   */
  public ProductResource productsIdGet(String id) throws ApiException {
    return productsIdGetWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<ProductResource> productsIdGetWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling productsIdGet");
    }
    ...
    > apiResponse = apiClient.invokeAPI("ProductsApi.productsIdGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, productsIdGetResponseTypeMap, false);
