...
import com.factset.sdk.ProcuretoPayAPISCIM.auth.Authentication;
import com.factset.sdk.ProcuretoPayAPISCIM.auth.HttpBasicAuth;
import com.factset.sdk.ProcuretoPayAPISCIM.auth.HttpBearerAuth;
import com.factset.sdk.ProcuretoPayAPISCIM.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ProcuretoPayAPISCIM.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/scim/v2";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/scim/v2",
      "Production environment",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.uat.factset.com/scim/v2",
      "UAT environment",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ProcuretoPayAPISCIM/0.24.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ProcuretoPayAPISCIM.ApiClient} object.
   */
