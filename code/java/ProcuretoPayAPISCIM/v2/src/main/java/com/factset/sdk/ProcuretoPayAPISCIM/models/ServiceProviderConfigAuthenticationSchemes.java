...
public class ServiceProviderConfigAuthenticationSchemes implements Serializable {
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The common authentication scheme name, e.g., HTTP Basic.")
  ...
  **/
  ...
  @ApiModelProperty(value = "An HTTP-addressable URL pointing to the authentication scheme's specification.")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "An HTTP-addressable URL pointing to the authentication scheme's usage documentation.")
