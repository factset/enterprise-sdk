...
public class UserPositionsApi {
   ...
   */
  public UserPositionResource getUserPosition(String id) throws ApiException {
    return getUserPositionWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<UserPositionResource> getUserPositionWithHttpInfo(String id) throws ApiException {
   ...
   */
  public UserPositionResourceList getUserPositions(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, String attributes, String excludedAttributes) throws ApiException {
    return getUserPositionsWithHttpInfo(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes).getData();
  }
   ...
   */
  public ApiResponse<UserPositionResourceList> getUserPositionsWithHttpInfo(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, String attributes, String excludedAttributes) throws ApiException {
    Object localVarPostBody = null;
