...
public class UserPositionsApi {
  ...
  private static final Map<Integer, GenericType> getUserPositionResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getUserPositionResponseTypeMap.put(200, new GenericType<UserPositionResource>(){});
    getUserPositionResponseTypeMap.put(401, new GenericType<Error>(){});
    getUserPositionResponseTypeMap.put(403, new GenericType<Error>(){});
    getUserPositionResponseTypeMap.put(404, new GenericType<Error>(){});
    getUserPositionResponseTypeMap.put(429, new GenericType<InlineResponse429>(){});
    getUserPositionResponseTypeMap.put(500, new GenericType<Error>(){});
  }

  private static final Map<Integer, GenericType> getUserPositionsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getUserPositionsResponseTypeMap.put(200, new GenericType<UserPositionResourceList>(){});
    getUserPositionsResponseTypeMap.put(400, new GenericType<Error>(){});
    getUserPositionsResponseTypeMap.put(401, new GenericType<Error>(){});
    getUserPositionsResponseTypeMap.put(403, new GenericType<Error>(){});
    getUserPositionsResponseTypeMap.put(429, new GenericType<InlineResponse429>(){});
    getUserPositionsResponseTypeMap.put(500, new GenericType<Error>(){});
  }
   ...
   */
  public UserPositionResource getUserPosition(String id, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    return getUserPositionWithHttpInfo(id, attributes, excludedAttributes, additionalAttributes).getData();
  }
   ...
   */
  public ApiResponse<UserPositionResource> getUserPositionWithHttpInfo(String id, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getUserPosition");
    }
    ...
    > apiResponse = apiClient.invokeAPI("UserPositionsApi.getUserPosition", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getUserPositionResponseTypeMap, false);
   ...
   */
  public UserPositionResourceList getUserPositions(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    return getUserPositionsWithHttpInfo(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes, additionalAttributes).getData();
  }
   ...
   */
  public ApiResponse<UserPositionResourceList> getUserPositionsWithHttpInfo(String filter, String sortBy, String sortOrder, Integer startIndex, Integer count, java.util.List<String> attributes, java.util.List<String> excludedAttributes, java.util.List<String> additionalAttributes) throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("UserPositionsApi.getUserPositions", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getUserPositionsResponseTypeMap, false);
