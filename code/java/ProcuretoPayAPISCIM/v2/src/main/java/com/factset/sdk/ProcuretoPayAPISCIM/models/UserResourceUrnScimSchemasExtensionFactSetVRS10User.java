...
import com.factset.sdk.ProcuretoPayAPISCIM.models.UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData;
...
public class UserResourceUrnScimSchemasExtensionFactSetVRS10User implements Serializable {
  ...
  private java.util.List<UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData> domainData = null;

  public UserResourceUrnScimSchemasExtensionFactSetVRS10User() { 
  }

  public UserResourceUrnScimSchemasExtensionFactSetVRS10User domainData(java.util.List<UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData> domainData) {
    this.domainData = domainData;
    return this;
  }

  public UserResourceUrnScimSchemasExtensionFactSetVRS10User addDomainDataItem(UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData domainDataItem) {
  ...
  **/
  ...
  public java.util.List<UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData> getDomainData() {
    return domainData;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DOMAIN_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDomainData(java.util.List<UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData> domainData) {
    this.domainData = domainData;
  }
