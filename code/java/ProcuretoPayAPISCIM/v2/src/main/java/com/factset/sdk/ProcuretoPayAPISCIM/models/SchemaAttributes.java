...
import com.factset.sdk.ProcuretoPayAPISCIM.models.SchemaSubAttributes;
 ...
 */
@JsonPropertyOrder({
  SchemaAttributes.JSON_PROPERTY_NAME,
  SchemaAttributes.JSON_PROPERTY_TYPE,
  SchemaAttributes.JSON_PROPERTY_MULTI_VALUED,
  SchemaAttributes.JSON_PROPERTY_DESCRIPTION,
  SchemaAttributes.JSON_PROPERTY_REQUIRED,
  SchemaAttributes.JSON_PROPERTY_CANONICAL_VALUES,
  SchemaAttributes.JSON_PROPERTY_CASE_EXACT,
  SchemaAttributes.JSON_PROPERTY_MUTABILITY,
  SchemaAttributes.JSON_PROPERTY_RETURNED,
  SchemaAttributes.JSON_PROPERTY_UNIQUENESS,
  SchemaAttributes.JSON_PROPERTY_REFERENCE_TYPES,
  SchemaAttributes.JSON_PROPERTY_SUB_ATTRIBUTES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class SchemaAttributes implements Serializable {
  ...
  private java.util.List<SchemaSubAttributes> subAttributes = null;
  ...
  public SchemaAttributes(
    ...
    @JsonProperty(JSON_PROPERTY_SUB_ATTRIBUTES) java.util.List<SchemaSubAttributes> subAttributes
  ) {
    this();
    this.name = name;
    this.type = type;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Used to define the sub-attributes of a complex attribute.")
  ...
  /**
   * Return true if this Schema_attributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, schemaAttributes.name) &&
        Objects.equals(this.type, schemaAttributes.type) &&
        Objects.equals(this.multiValued, schemaAttributes.multiValued) &&
        Objects.equals(this.description, schemaAttributes.description) &&
        Objects.equals(this.required, schemaAttributes.required) &&
        Objects.equals(this.canonicalValues, schemaAttributes.canonicalValues) &&
        Objects.equals(this.caseExact, schemaAttributes.caseExact) &&
        Objects.equals(this.mutability, schemaAttributes.mutability) &&
        Objects.equals(this.returned, schemaAttributes.returned) &&
        Objects.equals(this.uniqueness, schemaAttributes.uniqueness) &&
        Objects.equals(this.referenceTypes, schemaAttributes.referenceTypes) &&
        Objects.equals(this.subAttributes, schemaAttributes.subAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, multiValued, description, required, canonicalValues, caseExact, mutability, returned, uniqueness, referenceTypes, subAttributes);
  }
