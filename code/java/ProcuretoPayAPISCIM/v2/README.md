...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/procuretopayapiscim/0.25.1)](https://central.sonatype.com/artifact/com.factset.sdk/procuretopayapiscim/0.25.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:procuretopayapiscim:0.25.1"
  }
```
...
## Documentation for Models
 ...
 - [Error](docs/Error.md)
 - [ErrorUrnScimSchemasExtensionFactSetCore10Error](docs/ErrorUrnScimSchemasExtensionFactSetCore10Error.md)
 ...
 - [GroupResourceUrnScimSchemasExtensionFactSetCore10Group](docs/GroupResourceUrnScimSchemasExtensionFactSetCore10Group.md)
