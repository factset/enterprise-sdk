...
import com.factset.sdk.DocumentsDistributorDocuments.models.Getfilesone;
 ...
 */
@JsonPropertyOrder({
  NewsgetfilesResponse.JSON_PROPERTY_DATA,
  NewsgetfilesResponse.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class NewsgetfilesResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<Getfilesone> data = null;

  public static final String JSON_PROPERTY_META = "meta";
  private MetaOne meta;

  public NewsgetfilesResponse() { 
  }

  public NewsgetfilesResponse data(java.util.List<Getfilesone> data) {
    this.data = data;
    return this;
  }

  public NewsgetfilesResponse addDataItem(Getfilesone dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<Getfilesone> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<Getfilesone> data) {
    this.data = data;
  }


  public NewsgetfilesResponse meta(MetaOne meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this newsgetfilesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewsgetfilesResponse newsgetfilesResponse = (NewsgetfilesResponse) o;
    return Objects.equals(this.data, newsgetfilesResponse.data) &&
        Objects.equals(this.meta, newsgetfilesResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewsgetfilesResponse {\n");
