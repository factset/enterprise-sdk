 ...
 */
@JsonPropertyOrder({
  NewsStatus.JSON_PROPERTY_ID,
  NewsStatus.JSON_PROPERTY_ERROR_MESSAGE
})
...
public class NewsStatus implements Serializable {
  ...
  public NewsStatus id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public NewsStatus errorMessage(String errorMessage) {
  ...
  **/
  ...
  /**
   * Return true if this newsStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewsStatus newsStatus = (NewsStatus) o;
    return Objects.equals(this.id, newsStatus.id) &&
        Objects.equals(this.errorMessage, newsStatus.errorMessage);
  }
