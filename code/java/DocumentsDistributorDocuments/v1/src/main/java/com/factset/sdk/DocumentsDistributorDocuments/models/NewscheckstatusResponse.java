...
import com.factset.sdk.DocumentsDistributorDocuments.models.Checkstatusone;
 ...
 */
@JsonPropertyOrder({
  NewscheckstatusResponse.JSON_PROPERTY_DATA,
  NewscheckstatusResponse.JSON_PROPERTY_META
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class NewscheckstatusResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<Checkstatusone> data = null;

  public static final String JSON_PROPERTY_META = "meta";
  private MetaOne meta;

  public NewscheckstatusResponse() { 
  }

  public NewscheckstatusResponse data(java.util.List<Checkstatusone> data) {
    this.data = data;
    return this;
  }

  public NewscheckstatusResponse addDataItem(Checkstatusone dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<Checkstatusone> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<Checkstatusone> data) {
    this.data = data;
  }


  public NewscheckstatusResponse meta(MetaOne meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this newscheckstatusResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewscheckstatusResponse newscheckstatusResponse = (NewscheckstatusResponse) o;
    return Objects.equals(this.data, newscheckstatusResponse.data) &&
        Objects.equals(this.meta, newscheckstatusResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewscheckstatusResponse {\n");
