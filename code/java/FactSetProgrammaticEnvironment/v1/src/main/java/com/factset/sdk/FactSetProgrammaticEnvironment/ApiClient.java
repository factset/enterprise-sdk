...
import com.factset.sdk.FactSetProgrammaticEnvironment.auth.Authentication;
import com.factset.sdk.FactSetProgrammaticEnvironment.auth.HttpBasicAuth;
import com.factset.sdk.FactSetProgrammaticEnvironment.auth.HttpBearerAuth;
import com.factset.sdk.FactSetProgrammaticEnvironment.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetProgrammaticEnvironment.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/quant/fpe/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/analytics/quant/fpe/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetProgrammaticEnvironment/0.23.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetProgrammaticEnvironment.ApiClient} object.
   */
