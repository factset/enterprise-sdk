...
public class FiCalculationsApi {
   ...
   * @param id from url, provided from the location header in the Run FI Calculation endpoint (required)
   ...
   */
  public void cancelFICalculationById(String id) throws ApiException {
   ...
   */
  public ApiResponse<Void> cancelFICalculationByIdWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling cancelFICalculationById");
    }
    
    // create path and map variables
    String localVarPath = "/analytics/engines/fi/v1/calculations/{id}"
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Expected response once calculation is completed, returns JSON in the format specified in the Run Calculations endpoint. </td><td>  * Content-Encoding - Standard HTTP header. Header value based on Accept-Encoding Request header. <br>  * Content-Type - Standard HTTP header. <br>  * Transfer-Encoding - Standard HTTP header. Header value will be set to Chunked if Accept-Encoding header is specified. <br>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public Object getFICalculationById(String id) throws ApiException {
    return getFICalculationByIdWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<Object> getFICalculationByIdWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getFICalculationById");
    }
   ...
   * @param xFactSetContentOrganization FactSet content organization (optional)
   * @param xFactSetContentType FactSet content type (optional)
   * @param fiCalculationParameters  (optional)
   * @return Object
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 201 </td><td> Expected response if calculation is completed within 30 seconds, returns JSON in the format specified in the Run Calculations endpoint. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-Calculations-Limit - Maximum FI request limit. <br>  * X-FactSet-Api-Calculations-Remaining - Number of FI requests remaining till request limit reached. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       ...
       <tr><td> 400 </td><td> Invalid POST body. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-Calculations-Limit - Maximum FI request limit. <br>  * X-FactSet-Api-Calculations-Remaining - Number of FI requests remaining till request limit reached. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
   ...
   */
  public Object runFICalculation(String xFactSetContentOrganization, String xFactSetContentType, FICalculationParameters fiCalculationParameters) throws ApiException {
    return runFICalculationWithHttpInfo(xFactSetContentOrganization, xFactSetContentType, fiCalculationParameters).getData();
  }
   ...
   */
  public ApiResponse<Object> runFICalculationWithHttpInfo(String xFactSetContentOrganization, String xFactSetContentType, FICalculationParameters fiCalculationParameters) throws ApiException {
    Object localVarPostBody = fiCalculationParameters;
    
    // create path and map variables
    String localVarPath = "/analytics/engines/fi/v1/calculations";
    ...
    if (xFactSetContentOrganization != null)
      localVarHeaderParams.put("X-FactSet-Content-Organization", apiClient.parameterToString(xFactSetContentOrganization));
if (xFactSetContentType != null)
      localVarHeaderParams.put("X-FactSet-Content-Type", apiClient.parameterToString(xFactSetContentType));
