...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/fixedincomecalculation/2.2.3)](https://central.sonatype.com/artifact/com.factset.sdk/fixedincomecalculation/2.2.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:fixedincomecalculation:2.2.3"
  }
```
