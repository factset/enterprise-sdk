...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/fixedincomecalculation/2.2.4)](https://central.sonatype.com/artifact/com.factset.sdk/fixedincomecalculation/2.2.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:fixedincomecalculation:2.2.4"
  }
```
