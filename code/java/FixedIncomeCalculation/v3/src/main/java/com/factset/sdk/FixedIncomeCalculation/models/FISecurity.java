...
public class FISecurity implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(settlement), hashCodeNullable(callMethod), referenceSecurity, bankLoans, municipalBonds, loss, prepay, hashCodeNullable(matrixSpreadAdjustment), hashCodeNullable(matrixMultiplier), structuredProducts, hashCodeNullable(calcFromMethod), calcFromValue, hashCodeNullable(face), hashCodeNullable(faceType), symbol, hashCodeNullable(discountCurve));
  }
