...
import com.factset.sdk.FixedIncomeCalculation.models.FIDiscountCurveInfo;
...
public class FIDiscountCurveInfoRoot implements Serializable {
  ...
  private java.util.Map<String, FIDiscountCurveInfo> data = new java.util.HashMap<>();

  public static final String JSON_PROPERTY_META = "meta";
  private JsonNullable<Object> meta = JsonNullable.<Object>of(null);

  public FIDiscountCurveInfoRoot() { 
  }

  @JsonCreator
  public FIDiscountCurveInfoRoot(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.Map<String, FIDiscountCurveInfo> data
  ) {
    this();
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, fiDiscountCurveInfoRoot.data) &&
        equalsNullable(this.meta, fiDiscountCurveInfoRoot.meta);
  }
