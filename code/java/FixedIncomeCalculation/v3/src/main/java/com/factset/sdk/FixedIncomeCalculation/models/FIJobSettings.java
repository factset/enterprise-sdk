...
public class FIJobSettings implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(asOfDate, hashCodeNullable(partialDurationMonths), hashCodeNullable(callMethod), hashCodeNullable(settlement), hashCodeNullable(calcFromMethod), bankLoans, municipalBonds, marketEnvironment, structuredProducts);
  }
