...
import com.factset.sdk.FactSetDebtCapitalStructure.api.MetricsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String category = "DCS Totals"; // String | Filters the list of available DCS metrics by endpoint.  -   * **DCS Totals** = DCS Totals   * **Liquidity** = Liquidity 
        try {
...
------------- | ------------- | ------------- | -------------
 **category** | **String**| Filters the list of available DCS metrics by endpoint.  -   * **DCS Totals** &#x3D; DCS Totals   * **Liquidity** &#x3D; Liquidity  | [optional] [enum: DCS Totals, Liquidity]
