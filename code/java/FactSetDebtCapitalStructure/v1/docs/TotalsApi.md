...
import com.factset.sdk.FactSetDebtCapitalStructure.api.TotalsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        DCSRequest dcSRequest = new DCSRequest(); // DCSRequest | Request object for `DCS Totals`.
        try {
            DcsResponse result = apiInstance.getDcsTotalsPost(dcSRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling TotalsApi#getDcsTotalsPost");
