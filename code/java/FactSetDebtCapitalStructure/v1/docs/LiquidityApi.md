...
import com.factset.sdk.FactSetDebtCapitalStructure.api.LiquidityApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        LiquidityApi apiInstance = new LiquidityApi(defaultClient);
        LiquidityRequest liquidityRequest = new LiquidityRequest(); // LiquidityRequest | Request object for `Liquidity`.
        try {
            LiquidityResponse result = apiInstance.getLiquidityPost(liquidityRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling LiquidityApi#getLiquidityPost");
