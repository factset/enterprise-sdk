...
import com.factset.sdk.FactSetDebtCapitalStructure.models.DetailsSummary;
 ...
 */
@ApiModel(description = "Details Summary Response")
@JsonPropertyOrder({
  DetailsSummaryResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class DetailsSummaryResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<DetailsSummary> data = null;

  public DetailsSummaryResponse() { 
  }

  public DetailsSummaryResponse data(java.util.List<DetailsSummary> data) {
    this.data = data;
    return this;
  }

  public DetailsSummaryResponse addDataItem(DetailsSummary dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<DetailsSummary> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<DetailsSummary> data) {
    this.data = data;
  }


  /**
   * Return true if this DetailsSummaryResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DetailsSummaryResponse detailsSummaryResponse = (DetailsSummaryResponse) o;
    return Objects.equals(this.data, detailsSummaryResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetailsSummaryResponse {\n");
