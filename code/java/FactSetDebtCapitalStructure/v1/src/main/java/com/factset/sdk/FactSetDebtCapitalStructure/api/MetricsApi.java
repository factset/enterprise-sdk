...
import com.factset.sdk.FactSetDebtCapitalStructure.models.MetricsResponse;
...
public class MetricsApi {
   ...
   * @param category Filters the list of available DCS metrics by endpoint.  -   * **DCS Totals** &#x3D; DCS Totals   * **Liquidity** &#x3D; Liquidity  (optional)
   * @return MetricsResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Metrics object </td><td>  -  </td></tr>
