...
@JsonDeserialize(using = LiquidityValue.LiquidityValueDeserializer.class)
@JsonSerialize(using = LiquidityValue.LiquidityValueSerializer.class)
public class LiquidityValue extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(LiquidityValue.class.getName());

    public static class LiquidityValueSerializer extends StdSerializer<LiquidityValue> {
        public LiquidityValueSerializer(Class<LiquidityValue> t) {
            super(t);
        }

        public LiquidityValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(LiquidityValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class LiquidityValueDeserializer extends StdDeserializer<LiquidityValue> {
        public LiquidityValueDeserializer() {
            this(LiquidityValue.class);
        }

        public LiquidityValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public LiquidityValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                LiquidityValue ret = new LiquidityValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for LiquidityValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public LiquidityValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public LiquidityValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public LiquidityValue(Double o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(LiquidityValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return LiquidityValue.schemas;
    }
