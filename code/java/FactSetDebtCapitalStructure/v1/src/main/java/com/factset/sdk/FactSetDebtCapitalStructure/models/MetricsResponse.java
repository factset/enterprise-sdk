...
import com.factset.sdk.FactSetDebtCapitalStructure.models.Metric;
...
public class MetricsResponse implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of metric objects representing the data items that can be requested from the Debt Capital Structure API. ")
