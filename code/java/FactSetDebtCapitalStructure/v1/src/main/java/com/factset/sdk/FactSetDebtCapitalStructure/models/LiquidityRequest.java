...
import com.factset.sdk.FactSetDebtCapitalStructure.models.LiquidityRequestBody;
 ...
 * Liquidity Request
 */
@ApiModel(description = "Liquidity Request")
@JsonPropertyOrder({
  LiquidityRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class LiquidityRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private LiquidityRequestBody data;
  ...
  @JsonCreator
  public LiquidityRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) LiquidityRequestBody data
  ) {
    this();
    this.data = data;
  }

  public LiquidityRequest data(LiquidityRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public LiquidityRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(LiquidityRequestBody data) {
    this.data = data;
  }


  /**
   * Return true if this LiquidityRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, liquidityRequest.data);
  }
