...
import com.factset.sdk.FactSetDebtCapitalStructure.models.LiquidityResponseFields;
...
@JsonPropertyOrder({
  LiquidityResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class LiquidityResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<LiquidityResponseFields> data = null;

  public LiquidityResponse() { 
  }

  public LiquidityResponse data(java.util.List<LiquidityResponseFields> data) {
    this.data = data;
    return this;
  }

  public LiquidityResponse addDataItem(LiquidityResponseFields dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<LiquidityResponseFields> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<LiquidityResponseFields> data) {
    this.data = data;
  }


  /**
   * Return true if this LiquidityResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, liquidityResponse.data);
  }
