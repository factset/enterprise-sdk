...
@JsonDeserialize(using = DCSValue.DCSValueDeserializer.class)
@JsonSerialize(using = DCSValue.DCSValueSerializer.class)
public class DCSValue extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(DCSValue.class.getName());

    public static class DCSValueSerializer extends StdSerializer<DCSValue> {
        public DCSValueSerializer(Class<DCSValue> t) {
            super(t);
        }

        public DCSValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(DCSValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DCSValueDeserializer extends StdDeserializer<DCSValue> {
        public DCSValueDeserializer() {
            this(DCSValue.class);
        }

        public DCSValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public DCSValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                DCSValue ret = new DCSValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for DCSValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public DCSValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public DCSValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public DCSValue(Double o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(DCSValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return DCSValue.schemas;
    }
