 ...
 * DCS Totals Response
 */
@ApiModel(description = "DCS Totals Response")
@JsonPropertyOrder({
  DCSTotalsResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class DCSTotalsResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<DcsResponseFields> data = null;

  public DCSTotalsResponse() { 
  }

  public DCSTotalsResponse data(java.util.List<DcsResponseFields> data) {
    this.data = data;
    return this;
  }

  public DCSTotalsResponse addDataItem(DcsResponseFields dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this DCSTotalsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DCSTotalsResponse dcSTotalsResponse = (DCSTotalsResponse) o;
    return Objects.equals(this.data, dcSTotalsResponse.data);
  }
