...
import com.factset.sdk.FactSetDebtCapitalStructure.models.DCSRequestBody;
 ...
 * DCS Totals Request
 */
@ApiModel(description = "DCS Totals Request")
@JsonPropertyOrder({
  DCSRequest.JSON_PROPERTY_DATA
})
...
public class DCSRequest implements Serializable {
  ...
  @JsonCreator
  public DCSRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) DCSRequestBody data
  ) {
    this();
    this.data = data;
  }

  public DCSRequest data(DCSRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(DCSRequestBody data) {
    this.data = data;
  }


  /**
   * Return true if this DCSRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DCSRequest dcSRequest = (DCSRequest) o;
    return Objects.equals(this.data, dcSRequest.data);
  }
