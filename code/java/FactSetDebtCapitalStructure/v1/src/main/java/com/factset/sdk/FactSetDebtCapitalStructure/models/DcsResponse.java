...
import com.factset.sdk.FactSetDebtCapitalStructure.models.DcsResponseFields;
...
@JsonPropertyOrder({
  DcsResponse.JSON_PROPERTY_DATA
})
...
public class DcsResponse implements Serializable {
  ...
  private java.util.List<DcsResponseFields> data = null;

  public DcsResponse() { 
  }

  public DcsResponse data(java.util.List<DcsResponseFields> data) {
    this.data = data;
    return this;
  }

  public DcsResponse addDataItem(DcsResponseFields dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<DcsResponseFields> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<DcsResponseFields> data) {
    this.data = data;
  }


  /**
   * Return true if this DcsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DcsResponse dcsResponse = (DcsResponse) o;
    return Objects.equals(this.data, dcsResponse.data);
  }
