...
import com.factset.sdk.FactSetDebtCapitalStructure.models.InterimDetailsRequestBody;
 ...
 */
@ApiModel(description = "Interim Details Request")
@JsonPropertyOrder({
  InterimDetailsRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InterimDetailsRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private InterimDetailsRequestBody data;

  public InterimDetailsRequest() { 
  }

  @JsonCreator
  public InterimDetailsRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) InterimDetailsRequestBody data
  ) {
    this();
    this.data = data;
  }

  public InterimDetailsRequest data(InterimDetailsRequestBody data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public InterimDetailsRequestBody getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(InterimDetailsRequestBody data) {
    this.data = data;
  }


  /**
   * Return true if this InterimDetailsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InterimDetailsRequest interimDetailsRequest = (InterimDetailsRequest) o;
    return Objects.equals(this.data, interimDetailsRequest.data);
  }
