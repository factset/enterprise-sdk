...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetdebtcapitalstructure)](https://search.maven.org/artifact/com.factset.sdk/factsetdebtcapitalstructure)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetdebtcapitalstructure:0.1.2"
  }
```
