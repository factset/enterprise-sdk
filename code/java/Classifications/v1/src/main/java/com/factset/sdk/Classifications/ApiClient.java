...
import com.factset.sdk.Classifications.auth.Authentication;
import com.factset.sdk.Classifications.auth.HttpBasicAuth;
import com.factset.sdk.Classifications.auth.HttpBearerAuth;
import com.factset.sdk.Classifications.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.Classifications.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/Classifications/2.0.4 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.Classifications.ApiClient} object.
   */
