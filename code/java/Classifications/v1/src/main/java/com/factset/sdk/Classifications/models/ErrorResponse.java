...
import com.factset.sdk.Classifications.models.ErrorResponseSubErrors;
...
public class ErrorResponse implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "/classifications/v1/{endpoint}", value = "The Endpoint path {package}/version/{endpoint}")
