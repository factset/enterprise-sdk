...
# Intraday Tick History client library for Java

[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/intradaytickhistory)](https://search.maven.org/artifact/com.factset.sdk/intradaytickhistory)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:intradaytickhistory:0.20.0"
  }
```
