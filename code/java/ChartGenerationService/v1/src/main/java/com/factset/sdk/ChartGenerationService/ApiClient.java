...
import com.factset.sdk.ChartGenerationService.auth.Authentication;
import com.factset.sdk.ChartGenerationService.auth.HttpBasicAuth;
import com.factset.sdk.ChartGenerationService.auth.HttpBearerAuth;
import com.factset.sdk.ChartGenerationService.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ChartGenerationService.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/charting/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/charting/v1",
      "production server (uses live data)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api-sandbox.factset.com/charting/v1",
      "sandbox server (uses dummy data)",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ChartGenerationService/0.22.4 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ChartGenerationService.ApiClient} object.
   */
