...
import com.factset.sdk.ChartGenerationService.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api-sandbox.factset.com/charting";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api-sandbox.factset.com/charting",
      "sandbox server (uses dummy data)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.factset.com/charting",
  ...
  public ApiClient(Map<String, Authentication> authMap, OAuth2Client oauth2Client) {
    ...
    setUserAgent("fds-sdk/java/ChartGenerationService/0.9.0");
