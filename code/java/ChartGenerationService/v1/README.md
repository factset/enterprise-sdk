...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/chartgenerationservice/0.22.3)](https://central.sonatype.com/artifact/com.factset.sdk/chartgenerationservice/0.22.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:chartgenerationservice:0.22.3"
  }
```
