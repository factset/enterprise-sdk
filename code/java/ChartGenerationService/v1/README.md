...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/chartgenerationservice/0.22.4)](https://central.sonatype.com/artifact/com.factset.sdk/chartgenerationservice/0.22.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:chartgenerationservice:0.22.4"
  }
```
...
------------ | ------------- | ------------- | -------------
*ChartTemplatesApi* | [**getCategoryList**](docs/ChartTemplatesApi.md#getCategoryList) | **GET** /catalog/categories | Get a list of chart categories
*ChartTemplatesApi* | [**getChartList**](docs/ChartTemplatesApi.md#getChartList) | **GET** /catalog/charts | Get a list of chart templates that can be used for getting the image from the service.
*ChartTemplatesApi* | [**images**](docs/ChartTemplatesApi.md#images) | **GET** /image | Get chart image back in PNG or JPEG formats
...
## Documentation for Models
 ...
 - [CategoryChartListErrorObject](docs/CategoryChartListErrorObject.md)
 - [CategoryListResponse](docs/CategoryListResponse.md)
 - [ChartErrorResponseObject](docs/ChartErrorResponseObject.md)
