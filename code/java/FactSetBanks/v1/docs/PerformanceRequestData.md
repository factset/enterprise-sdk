...
**periodicity** | [**PeriodicityEnum**](#PeriodicityEnum) | Periodicity of the UBPR fiscal periods, where   * **ANN** &#x3D; Annual   * **QTR** &#x3D; Quarterly  If omitted, defaults to &#x60;ANN&#x60;.  |  [optional]
...
**metrics** | **java.util.List&lt;String&gt;** | Array of UBPR metric codes to retrieve. Examples include financial ratios, performance metrics, and peer group statistics. Use the &#x60;/metrics&#x60; endpoint to retrieve the full list of available metric codes and their definitions.  | 
