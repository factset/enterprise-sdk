...
public class InlineResponse2007DataUnderlyings implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Constant leverage of the underlying for securitized derivatives with constant leverage that do not have a factor index as underlying (i.e. the attribute `typeComposite` of the underlying instrument is not set or is different from factorIndex).")
