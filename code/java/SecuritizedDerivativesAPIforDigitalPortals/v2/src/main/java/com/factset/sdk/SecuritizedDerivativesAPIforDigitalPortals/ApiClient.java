...
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.auth.Authentication;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.auth.HttpBasicAuth;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.auth.HttpBearerAuth;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.auth.FactSetOAuth2ClientAuth;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.auth.ApiKeyAuth;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "http://api.factset.com/wealth/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "//api.factset.com/wealth/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap, OAuth2Client oauth2Client) {
    ...
    setUserAgent("fds-sdk/java/SecuritizedDerivativesAPIforDigitalPortals/0.9.1");
   ...
   * @return this instance of {@link com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.ApiClient} object.
   */
