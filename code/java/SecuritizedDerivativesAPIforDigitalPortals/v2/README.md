...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'securitizedderivativesapifordigitalportals' jar has been published to maven central.
    mavenLocal()       // Needed if the 'securitizedderivativesapifordigitalportals' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:securitizedderivativesapifordigitalportals:0.9.0"
  }
```
...
- `target/securitizedderivativesapifordigitalportals-0.9.0.jar`
- `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [SecuritizedDerivativeNotationScreenerValueRangesGetDataCapitalProtectionMaximum](docs/SecuritizedDerivativeNotationScreenerValueRangesGetDataCapitalProtectionMaximum.md)
 - [SecuritizedDerivativeNotationScreenerValueRangesGetDataCapitalProtectionMinimum](docs/SecuritizedDerivativeNotationScreenerValueRangesGetDataCapitalProtectionMinimum.md)
