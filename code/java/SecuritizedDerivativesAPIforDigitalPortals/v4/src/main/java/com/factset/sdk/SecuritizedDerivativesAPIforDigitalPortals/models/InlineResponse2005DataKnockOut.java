...
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutBreachedItems;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutObservationItems;
...
public class InlineResponse2005DataKnockOut implements Serializable {
  ...
  private java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutObservationItems> observation = null;
  ...
  private java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutBreachedItems> breached = null;

  public InlineResponse2005DataKnockOut() { 
  }

  public InlineResponse2005DataKnockOut observation(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutObservationItems> observation) {
    this.observation = observation;
    return this;
  }

  public InlineResponse2005DataKnockOut addObservationItem(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutObservationItems observationItem) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutObservationItems> getObservation() {
    return observation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBSERVATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setObservation(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutObservationItems> observation) {
    this.observation = observation;
  }
  ...
  **/
  ...
  public InlineResponse2005DataKnockOut breached(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutBreachedItems> breached) {
    this.breached = breached;
    return this;
  }

  public InlineResponse2005DataKnockOut addBreachedItem(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutBreachedItems breachedItem) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutBreachedItems> getBreached() {
    return breached;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BREACHED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBreached(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataKnockOutBreachedItems> breached) {
    this.breached = breached;
  }
