...
public class InlineResponse2003DataMaximumYield implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "2.02", value = "Maximum yield in absolute terms.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Maximum yield relative to the ask price.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "0.5", value = "Annualized maximum yield relative to the ask price.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.absolute, inlineResponse2003DataMaximumYield.absolute) &&
        equalsNullable(this.relative, inlineResponse2003DataMaximumYield.relative) &&
        equalsNullable(this.annualized, inlineResponse2003DataMaximumYield.annualized);
  }
