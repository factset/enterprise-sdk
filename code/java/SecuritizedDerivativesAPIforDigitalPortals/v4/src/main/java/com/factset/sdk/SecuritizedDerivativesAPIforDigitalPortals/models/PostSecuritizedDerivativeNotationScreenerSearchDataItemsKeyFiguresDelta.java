...
@JsonPropertyOrder({
  PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta.JSON_PROPERTY_EFFECTIVE,
  PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta.JSON_PROPERTY_UNADJUSTED
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta implements Serializable {
  ...
  public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta() { 
  }

  public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta effective(BigDecimal effective) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2.02", value = "Delta calculated using the actual cover ration of the securitized derivative.")
  @JsonIgnore
  ...
  public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta unadjusted(BigDecimal unadjusted) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "3.1415", value = "Delta calculated using a (hypothetical) cover ratio of 1:1.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostSecuritizedDerivativeNotationScreenerSearchDataItems_keyFigures_delta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta postSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta = (PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta) o;
    return equalsNullable(this.effective, postSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta.effective) &&
        equalsNullable(this.unadjusted, postSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta.unadjusted);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDelta {\n");
