 ...
 */
@ApiModel(description = "Discount. It represents the difference between the ask price of the securitized derivative and the underlying level, adjusted for the cover ratio and the currency cross rate. This key figure is calculated only for discount certificates. For the value unit, see attribute `instrument.underlying.valueUnit.`")
@JsonPropertyOrder({
  PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount.JSON_PROPERTY_ABSOLUTE,
  PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount.JSON_PROPERTY_RELATIVE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount implements Serializable {
  ...
  public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount() { 
  }

  public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount absolute(BigDecimal absolute) {
  ...
  **/
  ...
  @ApiModelProperty(example = "3.03", value = "Discount in absolute terms.")
  @JsonIgnore
  ...
  public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount relative(BigDecimal relative) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "0.5", value = "Discount relative to the underlying level.")
  @JsonIgnore
  ...
  /**
   * Return true if this PostSecuritizedDerivativeNotationScreenerSearchDataItems_keyFigures_discount object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount postSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount = (PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount) o;
    return equalsNullable(this.absolute, postSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount.absolute) &&
        equalsNullable(this.relative, postSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount.relative);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount {\n");
