...
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutBreachedItems;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutObservationItems;
...
public class InlineResponse2005DataRangeKnockOut implements Serializable {
  ...
  private java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutObservationItems> observation = null;
  ...
  private java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutBreachedItems> breached = null;
  ...
  public InlineResponse2005DataRangeKnockOut observation(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutObservationItems> observation) {
    this.observation = observation;
    return this;
  }

  public InlineResponse2005DataRangeKnockOut addObservationItem(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutObservationItems observationItem) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutObservationItems> getObservation() {
    return observation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBSERVATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setObservation(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutObservationItems> observation) {
    this.observation = observation;
  }
  ...
  **/
  ...
  public InlineResponse2005DataRangeKnockOut breached(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutBreachedItems> breached) {
    this.breached = breached;
    return this;
  }

  public InlineResponse2005DataRangeKnockOut addBreachedItem(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutBreachedItems breachedItem) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutBreachedItems> getBreached() {
    return breached;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BREACHED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBreached(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeKnockOutBreachedItems> breached) {
    this.breached = breached;
  }


  public InlineResponse2005DataRangeKnockOut cashFlow(InlineResponse2005DataKnockInCashFlow cashFlow) {
