 ...
 */
@ApiModel(description = "Legal entity data of the reference debtor that is monitored for credit events. See endpoint `/legal-entity/list` for possible values.")
@JsonPropertyOrder({
...
public class InlineResponse200DataReferenceDebtorLegalEntity implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "5", value = "Identifier of the reference debtor.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Lorem ipsum", value = "Name of the reference debtor.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Lorem ipsum", value = "Legal Entity Identifier of the reference debtor.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.id, inlineResponse200DataReferenceDebtorLegalEntity.id) &&
        equalsNullable(this.name, inlineResponse200DataReferenceDebtorLegalEntity.name) &&
        equalsNullable(this.lei, inlineResponse200DataReferenceDebtorLegalEntity.lei);
  }
