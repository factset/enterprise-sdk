 ...
 */
@ApiModel(description = "Ask-based vega. It represents the first partial derivative of the function determining the derivative notation's theoretical price with respect to the implied volatility, evaluated at the current implied volatility. Vega indicates the ratio of the absolute change of the price of a derivative for an absolute change of the implied volatility, thus it represents the price sensitivity of the derivative relative to changes in the implied volatility. This key figure is calculated for plain vanilla warrants only.")
@JsonPropertyOrder({
  InlineResponse2003DataVega.JSON_PROPERTY_EFFECTIVE,
  InlineResponse2003DataVega.JSON_PROPERTY_UNADJUSTED
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse2003DataVega implements Serializable {
  ...
  public InlineResponse2003DataVega() { 
  }

  public InlineResponse2003DataVega effective(BigDecimal effective) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2.02", value = "Vega calculated using the actual cover ratio of the securitized derivative.")
  @JsonIgnore
  ...
  public InlineResponse2003DataVega unadjusted(BigDecimal unadjusted) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "4.04", value = "Vega calculated using a (hypothetical) cover ratio of 1:1.")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_3_data_vega object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2003DataVega inlineResponse2003DataVega = (InlineResponse2003DataVega) o;
    return equalsNullable(this.effective, inlineResponse2003DataVega.effective) &&
        equalsNullable(this.unadjusted, inlineResponse2003DataVega.unadjusted);
  }
