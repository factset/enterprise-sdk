...
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationDdvItems;
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationEusipaItems;
 ...
 */
@ApiModel(description = "Lists of categories of the securitized derivatives. Starting with the most coarse level (one), for each level of the category system, the list of categories of the securitized derivatives, matching the parameters, is returned. See endpoint `/category/list-by-system` for possible values.")
@JsonPropertyOrder({
...
public class InlineResponse2005DataCategorization implements Serializable {
  ...
  private java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationDdvItems> ddv = null;

  public static final String JSON_PROPERTY_EUSIPA = "eusipa";
  private java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationEusipaItems> eusipa = null;

  public InlineResponse2005DataCategorization() { 
  }

  public InlineResponse2005DataCategorization ddv(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationDdvItems> ddv) {
    this.ddv = ddv;
    return this;
  }

  public InlineResponse2005DataCategorization addDdvItem(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationDdvItems ddvItem) {
    if (this.ddv == null) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationDdvItems> getDdv() {
    return ddv;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DDV)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDdv(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationDdvItems> ddv) {
    this.ddv = ddv;
  }


  public InlineResponse2005DataCategorization eusipa(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationEusipaItems> eusipa) {
    this.eusipa = eusipa;
    return this;
  }

  public InlineResponse2005DataCategorization addEusipaItem(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationEusipaItems eusipaItem) {
    if (this.eusipa == null) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationEusipaItems> getEusipa() {
    return eusipa;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EUSIPA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEusipa(java.util.List<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataCategorizationEusipaItems> eusipa) {
    this.eusipa = eusipa;
  }
