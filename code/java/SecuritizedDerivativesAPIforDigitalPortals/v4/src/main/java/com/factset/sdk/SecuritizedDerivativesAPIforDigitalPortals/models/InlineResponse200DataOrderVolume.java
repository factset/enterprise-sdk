...
public class InlineResponse200DataOrderVolume implements Serializable {
  ...
  private JsonNullable<BigDecimal> increment = JsonNullable.<BigDecimal>undefined();
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Minimum order volume required for placing an order at the trading venue of the notation for the given market phase.")
  @JsonIgnore
  ...
  public InlineResponse200DataOrderVolume increment(BigDecimal increment) {
    this.increment = JsonNullable.<BigDecimal>of(increment);
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "3.03", value = "Increment of the order volume over the minimum (see attribute inimumOrderVolumeSecDer) required for placing an order at the respective trading venue. The order volume over the minimum must be an integral multiple of the increment. The value unit for this attribute is the same as for the attribute tradingVolumeLatestTradePrice.")
  @JsonIgnore

  public BigDecimal getIncrement() {
        return increment.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_INCREMENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<BigDecimal> getIncrement_JsonNullable() {
    return increment;
  }
  
  @JsonProperty(JSON_PROPERTY_INCREMENT)
  public void setIncrement_JsonNullable(JsonNullable<BigDecimal> increment) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.minimum, inlineResponse200DataOrderVolume.minimum) &&
        equalsNullable(this.increment, inlineResponse200DataOrderVolume.increment);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(minimum), hashCodeNullable(increment));
  }
