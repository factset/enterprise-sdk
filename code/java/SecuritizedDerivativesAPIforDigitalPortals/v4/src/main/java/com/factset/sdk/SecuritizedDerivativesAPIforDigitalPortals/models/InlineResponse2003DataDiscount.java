 ...
 */
@ApiModel(description = "Discount based on the ask price. It represents the difference between the ask price of the securitized derivative and the underlying level, adjusted for the cover ratio and the currency cross rate. This key figure is calculated only for discount certificates. This key figure is not calculated for securitized derivatives with multiple underlyings. For the value unit, see attribute `underlyings.valueUnit`.")
@JsonPropertyOrder({
  InlineResponse2003DataDiscount.JSON_PROPERTY_ABSOLUTE,
  InlineResponse2003DataDiscount.JSON_PROPERTY_RELATIVE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InlineResponse2003DataDiscount implements Serializable {
  ...
  **/
  ...
  public InlineResponse2003DataDiscount relative(BigDecimal relative) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "0.4", value = "Discount relative to the underlying level.")
  @JsonIgnore
  ...
  /**
   * Return true if this inline_response_200_3_data_discount object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2003DataDiscount inlineResponse2003DataDiscount = (InlineResponse2003DataDiscount) o;
    return equalsNullable(this.absolute, inlineResponse2003DataDiscount.absolute) &&
        equalsNullable(this.relative, inlineResponse2003DataDiscount.relative);
  }
