...
@JsonPropertyOrder({
  PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing.JSON_PROPERTY_PERMANENT_IDENTIFIER,
  PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing.JSON_PROPERTY_TICKER_EXCHANGE,
  PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing.JSON_PROPERTY_IS_PRIMARY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing implements Serializable {
  ...
  public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing() { 
  }

  public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing permanentIdentifier(String permanentIdentifier) {
  ...
  **/
  ...
  @ApiModelProperty(example = "DJC0PL-S", value = "FactSet Permanent Identifier for a notation. The format is six alpha numeric characters, excluding vowels, with an L suffix (XXXXXX-L).")
  @JsonIgnore
  ...
  public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing tickerExchange(String tickerExchange) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "FDS-USA", value = "FactSet market symbol of the notation, usually consisting of the ticker (e.g. \"DAI\" for Daimler AG) and the three-character code of the exchange on which the listing is traded (example: DAI-ETR).")
  @JsonIgnore
  ...
  public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing isPrimary(Boolean isPrimary) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates whether the notation is the primary notation among all notations within the same region (`true`) or not (`false`).")
  @JsonIgnore
  ...
  /**
   * Return true if this PostSecuritizedDerivativeNotationRankingIntradayListDataItems_fsym_listing object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing postSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing = (PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing) o;
    return equalsNullable(this.permanentIdentifier, postSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing.permanentIdentifier) &&
        equalsNullable(this.tickerExchange, postSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing.tickerExchange) &&
        equalsNullable(this.isPrimary, postSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing.isPrimary);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing {\n");
