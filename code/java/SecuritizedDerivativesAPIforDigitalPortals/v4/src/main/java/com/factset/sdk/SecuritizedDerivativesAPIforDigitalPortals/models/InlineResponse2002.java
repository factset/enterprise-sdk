...
import com.factset.sdk.SecuritizedDerivativesAPIforDigitalPortals.models.PostSecuritizedDerivativeIssuerSearchDataItems;
...
public class InlineResponse2002 implements Serializable {
  ...
  private java.util.List<PostSecuritizedDerivativeIssuerSearchDataItems> data = null;
  ...
  public InlineResponse2002 data(java.util.List<PostSecuritizedDerivativeIssuerSearchDataItems> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(PostSecuritizedDerivativeIssuerSearchDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<PostSecuritizedDerivativeIssuerSearchDataItems> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<PostSecuritizedDerivativeIssuerSearchDataItems> data) {
    this.data = data;
  }
