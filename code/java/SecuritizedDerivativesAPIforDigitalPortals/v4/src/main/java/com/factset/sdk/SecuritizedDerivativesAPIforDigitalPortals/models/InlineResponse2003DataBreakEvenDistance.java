...
public class InlineResponse2003DataBreakEvenDistance implements Serializable {
  ...
  public InlineResponse2003DataBreakEvenDistance() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "3.03", value = "Distance in absolute terms. For the value unit, see attribute `underlyings.valueUnit`.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Distance relative to the underlying level. ")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.absolute, inlineResponse2003DataBreakEvenDistance.absolute) &&
        equalsNullable(this.relative, inlineResponse2003DataBreakEvenDistance.relative);
  }
