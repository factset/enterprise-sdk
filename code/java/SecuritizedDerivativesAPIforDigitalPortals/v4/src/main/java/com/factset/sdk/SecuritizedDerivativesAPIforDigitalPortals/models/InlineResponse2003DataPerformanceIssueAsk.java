...
public class InlineResponse2003DataPerformanceIssueAsk implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "3.1415", value = "Performance in absolute terms.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Performance relative to the issue price.")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Annualized performance relative to the issue price.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.absolute, inlineResponse2003DataPerformanceIssueAsk.absolute) &&
        equalsNullable(this.relative, inlineResponse2003DataPerformanceIssueAsk.relative) &&
        equalsNullable(this.annualized, inlineResponse2003DataPerformanceIssueAsk.annualized);
  }
