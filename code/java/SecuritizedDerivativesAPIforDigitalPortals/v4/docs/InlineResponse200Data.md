...
**type** | [**java.util.List&lt;GetSecuritizedDerivativeGetDataTypeItems&gt;**](GetSecuritizedDerivativeGetDataTypeItems.md) | Instrument type as defined by FactSet Digital Solutions. Instrument types are arranged in a hierarchy, with the first level representing the most coarse granularity and further levels successively refining the granularity (see MDG category system 18). Please refer to endpoint &#x60;/category/get&#x60; for possible values. |  [optional]
...
**countrySecurityRegistration** | [**java.util.List&lt;GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems&gt;**](GetSecuritizedDerivativeGetDataCountrySecurityRegistrationItems.md) | List of countries where the instrument is registered. See endpoint &#x60;/basic/region/country/list&#x60; for possible values. |  [optional]
...
**managementFee** | **BigDecimal** | Management fee paid annually by the investor to the issuer of the securitized derivative instrument. |  [optional]
