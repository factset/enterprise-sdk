...
import com.factset.sdk.FactSetPrices.models.Splits;
...
public class SplitsResponse implements Serializable {
  ...
  public SplitsResponse addDataItem(Splits dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of Splits Objects")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<Splits> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<Splits> data) {
    this.data = data;
  }
