...
import com.factset.sdk.FactSetPrices.models.SharesResponse;
...
public class SharesApi {
   ...
   * @param splitAdjust Code to control split adjustments for shares count. (optional, default to SPLIT)
   * @return SharesResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Array of security shares </td><td>  -  </td></tr>
   ...
   */
  public SharesResponse getSecurityShares(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar, String splitAdjust) throws ApiException {
    return getSecuritySharesWithHttpInfo(ids, startDate, endDate, frequency, calendar, splitAdjust).getData();
  }
   ...
   */
  public ApiResponse<SharesResponse> getSecuritySharesWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, String frequency, String calendar, String splitAdjust) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getSecurityShares");
    }
    
    // create path and map variables
    String localVarPath = "/factset-prices/v1/shares";
   ...
   * Gets security shares for a list of &#39;ids&#39; and given date range. Share values returned include security-level and company-level.
   * @param sharesRequest Request object for &#x60;Security&#x60; shares. (required)
   * @return SharesResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Array of Shares objects </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public SharesResponse getSecuritySharesForList(SharesRequest sharesRequest) throws ApiException {
    return getSecuritySharesForListWithHttpInfo(sharesRequest).getData();
  }
   ...
   */
  public ApiResponse<SharesResponse> getSecuritySharesForListWithHttpInfo(SharesRequest sharesRequest) throws ApiException {
    Object localVarPostBody = sharesRequest;
    
    // verify the required parameter 'sharesRequest' is set
    if (sharesRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'sharesRequest' when calling getSecuritySharesForList");
    }
