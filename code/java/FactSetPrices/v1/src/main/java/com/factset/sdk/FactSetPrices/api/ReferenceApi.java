...
import com.factset.sdk.FactSetPrices.models.ReferencesResponse;
...
public class ReferenceApi {
   ...
   * @param referencesRequest Request object for &#x60;Security&#x60; prices. (required)
   ...
   */
  public ReferencesResponse getSecurityReferenceForList(ReferencesRequest referencesRequest) throws ApiException {
    return getSecurityReferenceForListWithHttpInfo(referencesRequest).getData();
  }
   ...
   */
  public ApiResponse<ReferencesResponse> getSecurityReferenceForListWithHttpInfo(ReferencesRequest referencesRequest) throws ApiException {
    Object localVarPostBody = referencesRequest;
    
    // verify the required parameter 'referencesRequest' is set
    if (referencesRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'referencesRequest' when calling getSecurityReferenceForList");
    }
    
    // create path and map variables
    String localVarPath = "/factset-prices/v1/references";
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Array of security references objects </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public ReferencesResponse getSecurityReferences(java.util.List<String> ids) throws ApiException {
    return getSecurityReferencesWithHttpInfo(ids).getData();
  }
   ...
   */
  public ApiResponse<ReferencesResponse> getSecurityReferencesWithHttpInfo(java.util.List<String> ids) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getSecurityReferences");
    }
