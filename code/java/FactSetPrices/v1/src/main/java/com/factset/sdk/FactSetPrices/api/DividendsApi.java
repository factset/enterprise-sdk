...
public class DividendsApi {
   ...
   */
  public DividendsResponse getSecurityDividends(java.util.List<String> ids, String startDate, String endDate, String currency, String adjust) throws ApiException {
    return getSecurityDividendsWithHttpInfo(ids, startDate, endDate, currency, adjust).getData();
  }
   ...
   */
  public ApiResponse<DividendsResponse> getSecurityDividendsWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, String currency, String adjust) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'ids' is set
    if (ids == null) {
      throw new ApiException(400, "Missing the required parameter 'ids' when calling getSecurityDividends");
    }
    
    // create path and map variables
    String localVarPath = "/factset-prices/v1/dividends";
   ...
   * @param dividendsRequest Request object for &#x60;Security&#x60; dividends. (required)
   * @return DividendsResponse
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> Array of dividend information for a given date range and list of securities </td><td>  -  </td></tr>
       <tr><td> 400 </td><td> Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. </td><td>  -  </td></tr>
       <tr><td> 401 </td><td> Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. </td><td>  -  </td></tr>
       <tr><td> 415 </td><td> Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. </td><td>  -  </td></tr>
   ...
   */
  public DividendsResponse getSecurityDividendsForList(DividendsRequest dividendsRequest) throws ApiException {
    return getSecurityDividendsForListWithHttpInfo(dividendsRequest).getData();
  }
   ...
   */
  public ApiResponse<DividendsResponse> getSecurityDividendsForListWithHttpInfo(DividendsRequest dividendsRequest) throws ApiException {
    Object localVarPostBody = dividendsRequest;
    
    // verify the required parameter 'dividendsRequest' is set
    if (dividendsRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'dividendsRequest' when calling getSecurityDividendsForList");
    }
