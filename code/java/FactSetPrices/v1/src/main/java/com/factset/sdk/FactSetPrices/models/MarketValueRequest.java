...
import com.factset.sdk.FactSetPrices.models.BatchOne;
...
@JsonPropertyOrder({
  ...
  MarketValueRequest.JSON_PROPERTY_BATCH
})
...
public class MarketValueRequest implements Serializable {
  ...
  private BatchOne batch = BatchOne.N;
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"FDS-US\"]", required = true, value = "The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.    - Batch requests:       * Single day: up to 10,000 IDs per request       * Multi-day: up to 5,000 IDs per request ")
  ...
  **/
  ...
  public MarketValueRequest batch(BatchOne batch) {
    this.batch = batch;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BATCH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBatch(BatchOne batch) {
    this.batch = batch;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ids, marketValueRequest.ids) &&
        ...
        Objects.equals(this.batch, marketValueRequest.batch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, startDate, endDate, frequency, currency, calendar, batch);
  }
