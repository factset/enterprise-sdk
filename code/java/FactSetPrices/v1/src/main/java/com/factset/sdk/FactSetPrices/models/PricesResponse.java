 ...
 */
@JsonPropertyOrder({
  PricesResponse.JSON_PROPERTY_DATA
})
...
public class PricesResponse implements Serializable {
  ...
  public PricesResponse data(java.util.List<Price> data) {
    this.data = data;
    return this;
  }

  public PricesResponse addDataItem(Price dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this pricesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, pricesResponse.data);
  }
