...
public class SchedulesList implements Serializable {
  ...
  **/
  ...
  public SchedulesList data(java.util.List<ScheduleData> data) {
    this.data = data;
    return this;
  }

  public SchedulesList addDataItem(ScheduleData dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<ScheduleData> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<ScheduleData> data) {
    this.data = data;
  }


  /**
   * Return true if this SchedulesList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SchedulesList schedulesList = (SchedulesList) o;
    return Objects.equals(this.meta, schedulesList.meta) &&
        Objects.equals(this.data, schedulesList.data);
  }
