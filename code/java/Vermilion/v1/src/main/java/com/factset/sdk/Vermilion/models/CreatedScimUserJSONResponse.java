...
public class CreatedScimUserJSONResponse implements Serializable {
  ...
  public CreatedScimUserJSONResponse id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createdScimUserJSONResponse.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userName, name, userType, preferredLanguage, active, authenticatedUserName, tenant, phoneNumbers, emails, photos, domainCode, isAdministrator, meta);
  }
