...
public class ScheduleDefinitionsList implements Serializable {
  ...
  **/
  ...
  public ScheduleDefinitionsList data(java.util.List<ScheduleDefinition> data) {
    this.data = data;
    return this;
  }

  public ScheduleDefinitionsList addDataItem(ScheduleDefinition dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<ScheduleDefinition> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<ScheduleDefinition> data) {
    this.data = data;
  }


  /**
   * Return true if this ScheduleDefinitionsList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ScheduleDefinitionsList scheduleDefinitionsList = (ScheduleDefinitionsList) o;
    return Objects.equals(this.meta, scheduleDefinitionsList.meta) &&
        Objects.equals(this.data, scheduleDefinitionsList.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleDefinitionsList {\n");
