...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsettickhistory:0.0.1"
  }
```
...
public class GetFilesLevel2BetaApiExample {
...
------------ | ------------- | ------------- | -------------
*GetFilesLevel2BetaApi* | [**getTickHistoryFilesLevel2**](docs/GetFilesLevel2BetaApi.md#getTickHistoryFilesLevel2) | **GET** /level2/get-files | Returns the files for the requested requestId
*RequestFilesLevel2BetaApi* | [**getrequestIdLevel2**](docs/RequestFilesLevel2BetaApi.md#getrequestIdLevel2) | **GET** /level2/request-files | Returns the requestId and status
...
## Documentation for Models
 ...
 - [Files](docs/Files.md)
 - [GetFilesResponseLevel2](docs/GetFilesResponseLevel2.md)
 - [IsPartial](docs/IsPartial.md)
 - [Level2RequestFilesResponse](docs/Level2RequestFilesResponse.md)
 - [Meta](docs/Meta.md)
