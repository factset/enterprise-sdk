...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsettickhistory/0.23.2)](https://central.sonatype.com/artifact/com.factset.sdk/factsettickhistory/0.23.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsettickhistory:0.23.2"
  }
```
