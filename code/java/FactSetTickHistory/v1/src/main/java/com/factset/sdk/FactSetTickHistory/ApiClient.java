...
import com.factset.sdk.FactSetTickHistory.auth.Authentication;
import com.factset.sdk.FactSetTickHistory.auth.HttpBasicAuth;
import com.factset.sdk.FactSetTickHistory.auth.HttpBearerAuth;
import com.factset.sdk.FactSetTickHistory.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetTickHistory.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api-sandbox.factset.com/bulk-documents/tickhistory";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api-sandbox.factset.com/bulk-documents/tickhistory",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetTickHistory/0.23.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetTickHistory.ApiClient} object.
   */
