...
public class Level1RequestBody implements Serializable {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "USA", required = true, value = "FactSet specific regional or composite exchange code. <p> NOTE:Does not support multiple factsetExchangeCodes</p>. ")
