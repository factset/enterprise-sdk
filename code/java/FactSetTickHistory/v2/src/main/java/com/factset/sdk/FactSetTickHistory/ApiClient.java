...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/tick-history/v2";
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetTickHistory/0.33.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
