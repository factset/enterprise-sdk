...
@JsonPropertyOrder({
  ...
  MinutesbarRequestBody.JSON_PROPERTY_SINGLE
})
...
public class MinutesbarRequestBody implements Serializable {
  ...
  **/
  ...
  public MinutesbarRequestBody single(Boolean single) {
    this.single = single;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "<p> Set `true` to have data returned in a single file. If omitted, data will be returned in multiple files.</p> <p> Up to 128 Megabytes can be returned per file. Please reduce the date and time range of this request accordingly.</p> ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tickers, minutesbarRequestBody.tickers) &&
        ...
        Objects.equals(this.single, minutesbarRequestBody.single);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tickers, factsetExchangeCode, dateTimeRange, granularity, type, single);
  }
