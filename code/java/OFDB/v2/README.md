...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/ofdb/0.33.2)](https://central.sonatype.com/artifact/com.factset.sdk/ofdb/0.33.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:ofdb:0.33.2"
  }
```
