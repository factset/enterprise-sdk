...
@JsonSerialize(using = DataValue.DataValueSerializer.class)
public class DataValue extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(DataValue.class.getName());

    public static class DataValueSerializer extends StdSerializer<DataValue> {
        public DataValueSerializer(Class<DataValue> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(DataValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DataValueDeserializer extends StdDeserializer<DataValue> {
        public DataValueDeserializer() {
            this(DataValue.class);
        }

        public DataValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public DataValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for DataValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public DataValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "DataValue cannot be null");
        }
    }
    ...
    public DataValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public DataValue(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public DataValue(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(DataValue.class, Collections.unmodifiableMap(schemas));
    }
