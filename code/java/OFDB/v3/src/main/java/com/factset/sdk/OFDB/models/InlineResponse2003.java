...
public class InlineResponse2003 implements Serializable {
  ...
  private java.util.List<BulkDeleteRespItem> data = null;

  public InlineResponse2003() { 
  }

  public InlineResponse2003 data(java.util.List<BulkDeleteRespItem> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2003 addDataItem(BulkDeleteRespItem dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<BulkDeleteRespItem> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<BulkDeleteRespItem> data) {
    this.data = data;
  }
