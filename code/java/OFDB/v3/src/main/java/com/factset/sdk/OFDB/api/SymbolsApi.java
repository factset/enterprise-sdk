...
import com.factset.sdk.OFDB.models.AddSymbolsRoot;
...
import com.factset.sdk.OFDB.models.UpdateSymbolsRoot;
...
public class SymbolsApi {
  ...
  public SymbolsApi(ApiClient apiClient) {
  ...
  static {
    getSymbolsResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
  ...
  private static final Map<Integer, GenericType> replaceSymbolsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    replaceSymbolsResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
    replaceSymbolsResponseTypeMap.put(400, new GenericType<InlineResponse400>(){});
    replaceSymbolsResponseTypeMap.put(403, new GenericType<InlineResponse403>(){});
    replaceSymbolsResponseTypeMap.put(404, new GenericType<InlineResponse403>(){});
    replaceSymbolsResponseTypeMap.put(406, new GenericType<InlineResponse403>(){});
    replaceSymbolsResponseTypeMap.put(413, new GenericType<InlineResponse403>(){});
    replaceSymbolsResponseTypeMap.put(429, new GenericType<InlineResponse403>(){});
  }

  private static final Map<Integer, GenericType> updateSymbolsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    updateSymbolsResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Successful symbols array within database </td><td>  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  </td></tr>
   ...
   */
  public InlineResponse2004 getResourceGetSymbols(String jobId) throws ApiException {
    return getResourceGetSymbolsWithHttpInfo(jobId).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse2004> getResourceGetSymbolsWithHttpInfo(String jobId) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'jobId' is set
    if (jobId == null) {
      throw new ApiException(400, "Missing the required parameter 'jobId' when calling getResourceGetSymbols");
    }
    
    // create path and map variables
    String localVarPath = "/database/job/result/symbols/get";
    ...
    > apiResponse = apiClient.invokeAPI("SymbolsApi.getResourceGetSymbols", localVarPath, "GET", localVarQueryParams, localVarPostBody,
   ...
   */
  public InlineResponse201 getSymbols(DatabasePathRoot databasePathRoot) throws ApiException {
    return getSymbolsWithHttpInfo(databasePathRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> getSymbolsWithHttpInfo(DatabasePathRoot databasePathRoot) throws ApiException {
    Object localVarPostBody = databasePathRoot;
    
    // create path and map variables
    String localVarPath = "/database/symbols/get";
    ...
    > apiResponse = apiClient.invokeAPI("SymbolsApi.getSymbols", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @param addSymbolsRoot Data for creating symbol in the database (required)
   * @return InlineResponse201
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public InlineResponse201 replaceSymbols(AddSymbolsRoot addSymbolsRoot) throws ApiException {
    return replaceSymbolsWithHttpInfo(addSymbolsRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> replaceSymbolsWithHttpInfo(AddSymbolsRoot addSymbolsRoot) throws ApiException {
    Object localVarPostBody = addSymbolsRoot;
    
    // verify the required parameter 'addSymbolsRoot' is set
    if (addSymbolsRoot == null) {
      throw new ApiException(400, "Missing the required parameter 'addSymbolsRoot' when calling replaceSymbols");
    }
    
    // create path and map variables
    String localVarPath = "/database/symbols/replace";
    ...
    > apiResponse = apiClient.invokeAPI("SymbolsApi.replaceSymbols", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, replaceSymbolsResponseTypeMap, false);
   ...
   * @param updateSymbolsRoot Data for updating symbol in the database (required)
   * @return InlineResponse201
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public InlineResponse201 updateSymbols(UpdateSymbolsRoot updateSymbolsRoot) throws ApiException {
    return updateSymbolsWithHttpInfo(updateSymbolsRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> updateSymbolsWithHttpInfo(UpdateSymbolsRoot updateSymbolsRoot) throws ApiException {
    Object localVarPostBody = updateSymbolsRoot;
    
    // verify the required parameter 'updateSymbolsRoot' is set
    if (updateSymbolsRoot == null) {
      throw new ApiException(400, "Missing the required parameter 'updateSymbolsRoot' when calling updateSymbols");
    }
    
    // create path and map variables
    String localVarPath = "/database/symbols/update";
    ...
    > apiResponse = apiClient.invokeAPI("SymbolsApi.updateSymbols", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
