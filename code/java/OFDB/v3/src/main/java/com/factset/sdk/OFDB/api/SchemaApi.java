...
import com.factset.sdk.OFDB.models.AddFieldsRoot;
import com.factset.sdk.OFDB.models.CreateDatabaseRoot;
...
public class SchemaApi {
  ...
  static {
    addFieldsResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
  ...
  static {
    createDatabaseResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
  ...
  static {
    getFieldsResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
   ...
   * @param addFieldsRoot Data for creating fields in the database. (required)
   ...
   */
  public InlineResponse201 addFields(AddFieldsRoot addFieldsRoot) throws ApiException {
    return addFieldsWithHttpInfo(addFieldsRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> addFieldsWithHttpInfo(AddFieldsRoot addFieldsRoot) throws ApiException {
    Object localVarPostBody = addFieldsRoot;
    
    // verify the required parameter 'addFieldsRoot' is set
    if (addFieldsRoot == null) {
      throw new ApiException(400, "Missing the required parameter 'addFieldsRoot' when calling addFields");
    }
    
    // create path and map variables
    String localVarPath = "/database/schema/add";
    ...
    > apiResponse = apiClient.invokeAPI("SchemaApi.addFields", localVarPath, "POST", localVarQueryParams, localVarPostBody,
   ...
   * @param createDatabaseRoot  (optional)
   * @return InlineResponse201
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public InlineResponse201 createDatabase(CreateDatabaseRoot createDatabaseRoot) throws ApiException {
    return createDatabaseWithHttpInfo(createDatabaseRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> createDatabaseWithHttpInfo(CreateDatabaseRoot createDatabaseRoot) throws ApiException {
    Object localVarPostBody = createDatabaseRoot;
    
    // create path and map variables
    String localVarPath = "/database/schema/create";
    ...
    > apiResponse = apiClient.invokeAPI("SchemaApi.createDatabase", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public InlineResponse201 getFields(DatabasePathRoot databasePathRoot) throws ApiException {
    return getFieldsWithHttpInfo(databasePathRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> getFieldsWithHttpInfo(DatabasePathRoot databasePathRoot) throws ApiException {
    Object localVarPostBody = databasePathRoot;
    
    // create path and map variables
    String localVarPath = "/database/schema/get";
    ...
    > apiResponse = apiClient.invokeAPI("SchemaApi.getFields", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public InlineResponse2002 getResourceGetFields(String jobId) throws ApiException {
    return getResourceGetFieldsWithHttpInfo(jobId).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse2002> getResourceGetFieldsWithHttpInfo(String jobId) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'jobId' is set
    if (jobId == null) {
      throw new ApiException(400, "Missing the required parameter 'jobId' when calling getResourceGetFields");
    }
    
    // create path and map variables
    String localVarPath = "/database/job/result/schema/get";
    ...
    > apiResponse = apiClient.invokeAPI("SchemaApi.getResourceGetFields", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
