...
@JsonDeserialize(using = BulkDeleteRespItemNested.BulkDeleteRespItemNestedDeserializer.class)
@JsonSerialize(using = BulkDeleteRespItemNested.BulkDeleteRespItemNestedSerializer.class)
public class BulkDeleteRespItemNested extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(BulkDeleteRespItemNested.class.getName());

    public static class BulkDeleteRespItemNestedSerializer extends StdSerializer<BulkDeleteRespItemNested> {
        public BulkDeleteRespItemNestedSerializer(Class<BulkDeleteRespItemNested> t) {
            super(t);
        }

        public BulkDeleteRespItemNestedSerializer() {
            this(null);
        }

        @Override
        public void serialize(BulkDeleteRespItemNested value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class BulkDeleteRespItemNestedDeserializer extends StdDeserializer<BulkDeleteRespItemNested> {
        public BulkDeleteRespItemNestedDeserializer() {
            this(BulkDeleteRespItemNested.class);
        }

        public BulkDeleteRespItemNestedDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public BulkDeleteRespItemNested deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                BulkDeleteRespItemNested ret = new BulkDeleteRespItemNested();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for BulkDeleteRespItemNested: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public BulkDeleteRespItemNested getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "BulkDeleteRespItemNested cannot be null");
        }
    }
    ...
    public BulkDeleteRespItemNested() {
    ...
    static {
        ...
        JSON.registerDescendants(BulkDeleteRespItemNested.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return BulkDeleteRespItemNested.schemas;
    }
