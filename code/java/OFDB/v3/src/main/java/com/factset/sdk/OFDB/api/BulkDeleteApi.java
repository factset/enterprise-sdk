...
import com.factset.sdk.OFDB.models.BulkDeleteRoot;
...
public class BulkDeleteApi {
  private ApiClient apiClient;

  public BulkDeleteApi() {
    this(Configuration.getDefaultApiClient());
  }

  public BulkDeleteApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> deleteBulkItemsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    deleteBulkItemsResponseTypeMap.put(202, new GenericType<InlineResponse201>(){});
   ...
   */
  public InlineResponse201 deleteBulkItems(BulkDeleteRoot bulkDeleteRoot) throws ApiException {
    return deleteBulkItemsWithHttpInfo(bulkDeleteRoot).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse201> deleteBulkItemsWithHttpInfo(BulkDeleteRoot bulkDeleteRoot) throws ApiException {
    Object localVarPostBody = bulkDeleteRoot;
    
    // create path and map variables
    String localVarPath = "/database/bulk-delete";
    ...
    > apiResponse = apiClient.invokeAPI("BulkDeleteApi.deleteBulkItems", localVarPath, "POST", localVarQueryParams, localVarPostBody,
   ...
   */
  public InlineResponse2003 getResourceDeleteBulkItems(String jobId) throws ApiException {
    return getResourceDeleteBulkItemsWithHttpInfo(jobId).getData();
  }
   ...
   */
  public ApiResponse<InlineResponse2003> getResourceDeleteBulkItemsWithHttpInfo(String jobId) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'jobId' is set
    if (jobId == null) {
      throw new ApiException(400, "Missing the required parameter 'jobId' when calling getResourceDeleteBulkItems");
    }
    
    // create path and map variables
    String localVarPath = "/database/job/result/bulk-delete/get";
    ...
    > apiResponse = apiClient.invokeAPI("BulkDeleteApi.getResourceDeleteBulkItems", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
