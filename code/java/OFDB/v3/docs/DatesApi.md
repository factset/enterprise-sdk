...
> InlineResponse201 getDates(databasePathRoot)
...
import com.factset.sdk.OFDB.api.DatesApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        DatabasePathRoot databasePathRoot = new DatabasePathRoot(); // DatabasePathRoot | The databasePath to be fetched
        try {
            InlineResponse201 result = apiInstance.getDates(databasePathRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling DatesApi#getDates");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        DatesApi apiInstance = new DatesApi(defaultClient);
        String jobId = "jobId_example"; // String | jobId generated from the audit endpoint.
        try {
            InlineResponse2005 result = apiInstance.getResourceGetDates(jobId);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling DatesApi#getResourceGetDates");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        DatesApi apiInstance = new DatesApi(defaultClient);
        AddDatesRoot addDatesRoot = new AddDatesRoot(); // AddDatesRoot | Date content is required and must contain symbol and at least one iterative field
        try {
            InlineResponse201 result = apiInstance.replaceDates(addDatesRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling DatesApi#replaceDates");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        DatesApi apiInstance = new DatesApi(defaultClient);
        UpdateDatesRoot updateDatesRoot = new UpdateDatesRoot(); // UpdateDatesRoot | Required data for updating date in the database
        try {
            InlineResponse201 result = apiInstance.updateDates(updateDatesRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling DatesApi#updateDates");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
