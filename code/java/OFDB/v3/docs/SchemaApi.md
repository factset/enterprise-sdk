...
import com.factset.sdk.OFDB.api.SchemaApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        AddFieldsRoot addFieldsRoot = new AddFieldsRoot(); // AddFieldsRoot | Data for creating fields in the database.
        try {
            InlineResponse201 result = apiInstance.addFields(addFieldsRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SchemaApi#addFields");
...
> InlineResponse201 createDatabase(createDatabaseRoot)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SchemaApi apiInstance = new SchemaApi(defaultClient);
        CreateDatabaseRoot createDatabaseRoot = new CreateDatabaseRoot(); // CreateDatabaseRoot | 
        try {
            InlineResponse201 result = apiInstance.createDatabase(createDatabaseRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SchemaApi#createDatabase");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> InlineResponse201 getFields(databasePathRoot)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling SchemaApi#getFields");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling SchemaApi#getResourceGetFields");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
