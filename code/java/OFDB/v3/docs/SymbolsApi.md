...
import com.factset.sdk.OFDB.api.SymbolsApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SymbolsApi apiInstance = new SymbolsApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling SymbolsApi#getResourceGetSymbols");
...
> InlineResponse201 getSymbols(databasePathRoot)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling SymbolsApi#getSymbols");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SymbolsApi apiInstance = new SymbolsApi(defaultClient);
        AddSymbolsRoot addSymbolsRoot = new AddSymbolsRoot(); // AddSymbolsRoot | Data for creating symbol in the database
        try {
            InlineResponse201 result = apiInstance.replaceSymbols(addSymbolsRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SymbolsApi#replaceSymbols");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        SymbolsApi apiInstance = new SymbolsApi(defaultClient);
        UpdateSymbolsRoot updateSymbolsRoot = new UpdateSymbolsRoot(); // UpdateSymbolsRoot | Data for updating symbol in the database
        try {
            InlineResponse201 result = apiInstance.updateSymbols(updateSymbolsRoot);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling SymbolsApi#updateSymbols");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
