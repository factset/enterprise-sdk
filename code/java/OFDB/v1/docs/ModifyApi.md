...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ModifyApi#deleteDates");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ModifyApi#deleteSymbolDate3D");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ModifyApi#deleteSymbols");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        String path = "path_example"; // String | Encode database path
        Integer date = 56; // Integer | Date in YYYYMMDD format
        UpdateSymbolDate updateSymbolDate = new UpdateSymbolDate(); // UpdateSymbolDate | Required data for updating date in the database
        try {
            SuccessPostResponse result = apiInstance.updateSymbolDate(path, date, updateSymbolDate);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ModifyApi#updateSymbolDate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        Integer date = 56; // Integer | Date in YYYYMMDD format
        String symbol = "symbol_example"; // String | Symbol with in the ofdb
        UpdateSymbolDate3D updateSymbolDate3D = new UpdateSymbolDate3D(); // UpdateSymbolDate3D | Data for updating symbol in the database
        try {
            SuccessPostResponse result = apiInstance.updateSymbolDate3D(path, date, symbol, updateSymbolDate3D);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ModifyApi#updateSymbolDate3D");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling ModifyApi#updateSymbols");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
