...
@JsonPropertyOrder({
  ModifySymbols.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ModifySymbols implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<Object> data = null;

  public ModifySymbols() { 
  }

  public ModifySymbols data(java.util.List<Object> data) {
    this.data = data;
    return this;
  }

  public ModifySymbols addDataItem(Object dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this modifySymbols object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ModifySymbols modifySymbols = (ModifySymbols) o;
    return Objects.equals(this.data, modifySymbols.data);
  }
