...
@JsonPropertyOrder({
  Modifydatespecific.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class Modifydatespecific implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<Object> data = null;

  public Modifydatespecific() { 
  }

  public Modifydatespecific data(java.util.List<Object> data) {
    this.data = data;
    return this;
  }

  public Modifydatespecific addDataItem(Object dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this modifydatespecific object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Modifydatespecific modifydatespecific = (Modifydatespecific) o;
    return Objects.equals(this.data, modifydatespecific.data);
  }
