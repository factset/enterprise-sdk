...
**l6Id** | **BigDecimal** | Unique identifier for the RBICS Level 6 sector to which the product is assigned |  [optional]
**l6Name** | **String** | The descriptive name for the Level 6 sector classification |  [optional]
**startDate** | **LocalDate** | Date the record was first published |  [optional]
**endDate** | **LocalDate** | Date the record was terminated. The end date may sometimes be null, indicating that the tradeName is currently active. |  [optional]
