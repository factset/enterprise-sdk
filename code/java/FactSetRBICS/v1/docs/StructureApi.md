...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        java.util.List<String> rbicsIds = Arrays.asList(); // java.util.List<String> | RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry. 
...
------------- | ------------- | ------------- | -------------
 **rbicsIds** | **List&lt;String&gt;**| RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry.  | [optional]
