...
public class EntityFocusRequest implements Serializable {
  ...
  private java.util.Set<Integer> levels = null;
  ...
  **/
  ...
  public EntityFocusRequest date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Wed Sep 30 00:00:00 UTC 2020", value = "Effective date for data expressed in YYYY-MM-DD format. If no date is requested, the default behavior is to return the full history for the requested entity. ")
  ...
  public EntityFocusRequest levels(java.util.Set<Integer> levels) {
    this.levels = levels;
    return this;
  }
  ...
  public EntityFocusRequest addLevelsItem(Integer levelsItem) {
    if (this.levels == null) {
      this.levels = new java.util.LinkedHashSet<>();
    }
  ...
  **/
  ...
  public java.util.Set<Integer> getLevels() {
    return levels;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LEVELS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLevels(java.util.Set<Integer> levels) {
    this.levels = levels;
  }
