...
public class EntityFocus implements Serializable {
  ...
  public EntityFocus(
    ...
    @JsonProperty(value=JSON_PROPERTY_FIRST_DATE, required=true) OffsetDateTime firstDate, 
    @JsonProperty(value=JSON_PROPERTY_LAST_DATE, required=true) OffsetDateTime lastDate
  ) {
    this();
  ...
  **/
  ...
  public EntityFocus firstDate(OffsetDateTime firstDate) {
    this.firstDate = firstDate;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2008-08-26T00:00Z", required = true, value = "First date of the classification.")
  ...
  public EntityFocus lastDate(OffsetDateTime lastDate) {
    this.lastDate = lastDate;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2016-09-07T14:00Z", required = true, value = "Date when the classification became no longer valid.")
