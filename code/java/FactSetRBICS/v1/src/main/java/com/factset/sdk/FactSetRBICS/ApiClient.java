...
import com.factset.sdk.FactSetRBICS.auth.Authentication;
import com.factset.sdk.FactSetRBICS.auth.HttpBasicAuth;
import com.factset.sdk.FactSetRBICS.auth.HttpBearerAuth;
import com.factset.sdk.FactSetRBICS.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetRBICS.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetRBICS/1.0.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetRBICS.ApiClient} object.
   */
