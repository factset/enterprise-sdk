...
import com.factset.sdk.FactSetRBICS.models.Entities;
...
public class EntityResponse implements Serializable {
  ...
  private java.util.List<Entities> data = null;

  public EntityResponse() { 
  }

  public EntityResponse data(java.util.List<Entities> data) {
    this.data = data;
    return this;
  }

  public EntityResponse addDataItem(Entities dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of Entity Objects")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<Entities> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<Entities> data) {
    this.data = data;
  }
