...
public class Structure implements Serializable {
  ...
  private JsonNullable<OffsetDateTime> firstDate = JsonNullable.<OffsetDateTime>undefined();

  public static final String JSON_PROPERTY_LAST_DATE = "lastDate";
  private JsonNullable<OffsetDateTime> lastDate = JsonNullable.<OffsetDateTime>undefined();
  ...
  **/
  ...
  public Structure firstDate(OffsetDateTime firstDate) {
    this.firstDate = JsonNullable.<OffsetDateTime>of(firstDate);
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "1945-01-01T00:00Z", value = "First date of the classification.")
  @JsonIgnore
  ...
  public JsonNullable<OffsetDateTime> getFirstDate_JsonNullable() {
    return firstDate;
  }
  
  @JsonProperty(JSON_PROPERTY_FIRST_DATE)
  public void setFirstDate_JsonNullable(JsonNullable<OffsetDateTime> firstDate) {
  ...
  public Structure lastDate(OffsetDateTime lastDate) {
    this.lastDate = JsonNullable.<OffsetDateTime>of(lastDate);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<OffsetDateTime> getLastDate_JsonNullable() {
    return lastDate;
  }
  
  @JsonProperty(JSON_PROPERTY_LAST_DATE)
  public void setLastDate_JsonNullable(JsonNullable<OffsetDateTime> lastDate) {
