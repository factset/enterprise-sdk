...
import com.factset.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.auth.Authentication;
import com.factset.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.auth.HttpBasicAuth;
import com.factset.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.auth.HttpBearerAuth;
import com.factset.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/bulk-documents/exchange-snapshot";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/bulk-documents/exchange-snapshot",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ExchangeDataFeedSnapshotAPIEntireExchange/0.22.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ExchangeDataFeedSnapshotAPIEntireExchange.ApiClient} object.
   */
