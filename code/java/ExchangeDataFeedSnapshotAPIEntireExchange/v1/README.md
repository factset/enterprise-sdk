...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/exchangedatafeedsnapshotapientireexchange/0.22.4)](https://central.sonatype.com/artifact/com.factset.sdk/exchangedatafeedsnapshotapientireexchange/0.22.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:exchangedatafeedsnapshotapientireexchange:0.22.4"
  }
```
