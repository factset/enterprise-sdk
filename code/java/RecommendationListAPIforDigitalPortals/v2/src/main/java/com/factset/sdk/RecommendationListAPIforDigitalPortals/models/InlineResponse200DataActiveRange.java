 ...
 */
@ApiModel(description = "Time range during which the recommendation list is, was, or will be active.")
@JsonPropertyOrder({
  InlineResponse200DataActiveRange.JSON_PROPERTY_START,
  InlineResponse200DataActiveRange.JSON_PROPERTY_END
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse200DataActiveRange implements Serializable {
  ...
  public InlineResponse200DataActiveRange() { 
  }
  ...
  public InlineResponse200DataActiveRange start(String start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse200DataActiveRange end(String end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_data_activeRange object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataActiveRange inlineResponse200DataActiveRange = (InlineResponse200DataActiveRange) o;
    return Objects.equals(this.start, inlineResponse200DataActiveRange.start) &&
        Objects.equals(this.end, inlineResponse200DataActiveRange.end);
  }
