package com.factset.sdk.InvestmentBankingOfficeRefresh;
...
import com.factset.sdk.InvestmentBankingOfficeRefresh.auth.Authentication;
import com.factset.sdk.InvestmentBankingOfficeRefresh.auth.HttpBasicAuth;
import com.factset.sdk.InvestmentBankingOfficeRefresh.auth.HttpBearerAuth;
import com.factset.sdk.InvestmentBankingOfficeRefresh.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.InvestmentBankingOfficeRefresh.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/office-refresh/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/office-refresh/v0",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/InvestmentBankingOfficeRefresh/0.20.1");
   ...
   * @return this instance of {@link com.factset.sdk.InvestmentBankingOfficeRefresh.ApiClient} object.
   */
