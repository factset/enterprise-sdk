...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:investmentbankingofficerefresh:0.21.0"
  }
```
...
public class RefreshOperationsApiExample {
...
*RefreshOperationsApi* | [**postWorkbook**](docs/RefreshOperationsApi.md#postWorkbook) | **POST** /refresh/calculate | Upload a spreadsheet file
