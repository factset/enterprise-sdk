...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'virtualportfolioapifordigitalportals' jar has been published to maven central.
    mavenLocal()       // Needed if the 'virtualportfolioapifordigitalportals' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:virtualportfolioapifordigitalportals:0.9.0"
  }
```
...
- `target/virtualportfolioapifordigitalportals-0.9.0.jar`
- `target/lib/*.jar`
