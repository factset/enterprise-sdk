...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse20010DataTransactionBuy;
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse20010DataTransactionSell;
 ...
 */
@ApiModel(description = "Opening and closing transaction of the closed position.")
@JsonPropertyOrder({
  InlineResponse20010DataTransaction.JSON_PROPERTY_BUY,
  InlineResponse20010DataTransaction.JSON_PROPERTY_SELL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20010DataTransaction implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_BUY = "buy";
  private InlineResponse20010DataTransactionBuy buy;

  public static final String JSON_PROPERTY_SELL = "sell";
  private InlineResponse20010DataTransactionSell sell;

  public InlineResponse20010DataTransaction() { 
  }

  public InlineResponse20010DataTransaction buy(InlineResponse20010DataTransactionBuy buy) {
    this.buy = buy;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20010DataTransactionBuy getBuy() {
    return buy;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BUY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBuy(InlineResponse20010DataTransactionBuy buy) {
    this.buy = buy;
  }


  public InlineResponse20010DataTransaction sell(InlineResponse20010DataTransactionSell sell) {
    this.sell = sell;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20010DataTransactionSell getSell() {
    return sell;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SELL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSell(InlineResponse20010DataTransactionSell sell) {
    this.sell = sell;
  }


  /**
   * Return true if this inline_response_200_10_data_transaction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20010DataTransaction inlineResponse20010DataTransaction = (InlineResponse20010DataTransaction) o;
    return Objects.equals(this.buy, inlineResponse20010DataTransaction.buy) &&
        Objects.equals(this.sell, inlineResponse20010DataTransaction.sell);
  }
