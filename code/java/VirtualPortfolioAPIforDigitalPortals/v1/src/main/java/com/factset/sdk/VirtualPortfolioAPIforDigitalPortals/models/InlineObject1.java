...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioDeleteData;
...
public class InlineObject1 implements Serializable {
  ...
  private PortfolioDeleteData data;
  ...
  public InlineObject1 data(PortfolioDeleteData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioDeleteData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioDeleteData data) {
    this.data = data;
  }


  public InlineObject1 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
