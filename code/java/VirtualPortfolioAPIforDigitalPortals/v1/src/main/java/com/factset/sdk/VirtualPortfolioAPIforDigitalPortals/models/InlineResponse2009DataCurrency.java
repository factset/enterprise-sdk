 ...
 */
@ApiModel(description = "Main currency of the position. See endpoint `/basic/valueUnit/currency/main/list` for possible values.")
@JsonPropertyOrder({
  InlineResponse2009DataCurrency.JSON_PROPERTY_ID,
  InlineResponse2009DataCurrency.JSON_PROPERTY_ISO_CODE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2009DataCurrency implements Serializable {
  ...
  public InlineResponse2009DataCurrency() { 
  }

  public InlineResponse2009DataCurrency id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2009DataCurrency isoCode(String isoCode) {
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_9_data_currency object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2009DataCurrency inlineResponse2009DataCurrency = (InlineResponse2009DataCurrency) o;
    return Objects.equals(this.id, inlineResponse2009DataCurrency.id) &&
        Objects.equals(this.isoCode, inlineResponse2009DataCurrency.isoCode);
  }
