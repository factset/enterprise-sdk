...
public class PortfolioTransactionDeleteData implements Serializable {
  ...
  public PortfolioTransactionDeleteData(
    ...
    @JsonProperty(value=JSON_PROPERTY_NOTATION, required=true) PortfolioPayoutModifyDataPayoutNotation notation
  ) {
    this();
    this.id = id;
  ...
  **/
  ...
  public PortfolioTransactionDeleteData notation(PortfolioPayoutModifyDataPayoutNotation notation) {
    this.notation = notation;
    return this;
  }
