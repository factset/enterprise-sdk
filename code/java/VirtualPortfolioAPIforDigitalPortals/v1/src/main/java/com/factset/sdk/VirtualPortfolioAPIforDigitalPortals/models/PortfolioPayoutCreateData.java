...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutCreateDataTransaction;
...
@JsonPropertyOrder({
  PortfolioPayoutCreateData.JSON_PROPERTY_ID,
  PortfolioPayoutCreateData.JSON_PROPERTY_TYPE,
  PortfolioPayoutCreateData.JSON_PROPERTY_NOTATION,
  PortfolioPayoutCreateData.JSON_PROPERTY_TIME,
  PortfolioPayoutCreateData.JSON_PROPERTY_AMOUNT,
  PortfolioPayoutCreateData.JSON_PROPERTY_TRANSACTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutCreateData implements Serializable {
  ...
  private PortfolioPayoutCreateDataTransaction transaction;

  public PortfolioPayoutCreateData() { 
  }
  ...
  public PortfolioPayoutCreateData id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutCreateData type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Payout type. ")
  ...
  public PortfolioPayoutCreateData notation(PortfolioPayoutCreateDataNotation notation) {
    this.notation = notation;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutCreateData time(String time) {
    this.time = time;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Date and time of the payout.")
  ...
  public PortfolioPayoutCreateData amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Amount of the payout in the portfolio's base currency.")
  ...
  public PortfolioPayoutCreateData transaction(PortfolioPayoutCreateDataTransaction transaction) {
  ...
  **/
  ...
  public PortfolioPayoutCreateDataTransaction getTransaction() {
    return transaction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTransaction(PortfolioPayoutCreateDataTransaction transaction) {
    this.transaction = transaction;
  }


  /**
   * Return true if this _portfolio_payout_create_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutCreateData portfolioPayoutCreateData = (PortfolioPayoutCreateData) o;
    return Objects.equals(this.id, portfolioPayoutCreateData.id) &&
        Objects.equals(this.type, portfolioPayoutCreateData.type) &&
        Objects.equals(this.notation, portfolioPayoutCreateData.notation) &&
        Objects.equals(this.time, portfolioPayoutCreateData.time) &&
        Objects.equals(this.amount, portfolioPayoutCreateData.amount) &&
        Objects.equals(this.transaction, portfolioPayoutCreateData.transaction);
  }
