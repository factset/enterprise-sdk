 ...
 */
@ApiModel(description = "Date and time of the portfolio.")
@JsonPropertyOrder({
  InlineResponse2001DataLifecycleTransaction.JSON_PROPERTY_FIRST,
  InlineResponse2001DataLifecycleTransaction.JSON_PROPERTY_LATEST
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2001DataLifecycleTransaction implements Serializable {
  ...
  public InlineResponse2001DataLifecycleTransaction() { 
  }

  public InlineResponse2001DataLifecycleTransaction first(String first) {
    this.first = first;
    return this;
  }

   /**
   * Date and time of the first transaction.
   * @return first
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time of the first transaction.")
  ...
  public InlineResponse2001DataLifecycleTransaction latest(String latest) {
    this.latest = latest;
    return this;
  }

   /**
   * Date and time of the most recent transaction.
   * @return latest
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time of the most recent transaction.")
  ...
  /**
   * Return true if this inline_response_200_1_data_lifecycle_transaction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataLifecycleTransaction inlineResponse2001DataLifecycleTransaction = (InlineResponse2001DataLifecycleTransaction) o;
    return Objects.equals(this.first, inlineResponse2001DataLifecycleTransaction.first) &&
        Objects.equals(this.latest, inlineResponse2001DataLifecycleTransaction.latest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(first, latest);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineResponse2001DataLifecycleTransaction {\n");
