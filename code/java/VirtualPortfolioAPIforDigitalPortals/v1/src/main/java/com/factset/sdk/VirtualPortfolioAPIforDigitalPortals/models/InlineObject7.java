...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutModifyData;
...
public class InlineObject7 implements Serializable {
  ...
  private PortfolioPayoutModifyData data;
  ...
  public InlineObject7 data(PortfolioPayoutModifyData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutModifyData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioPayoutModifyData data) {
    this.data = data;
  }


  public InlineObject7 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
