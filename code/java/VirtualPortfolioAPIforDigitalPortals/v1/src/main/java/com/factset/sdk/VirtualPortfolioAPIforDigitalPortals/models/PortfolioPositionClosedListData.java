...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPositionClosedListDataRange;
...
@JsonPropertyOrder({
  PortfolioPositionClosedListData.JSON_PROPERTY_ID,
  PortfolioPositionClosedListData.JSON_PROPERTY_RANGE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPositionClosedListData implements Serializable {
  ...
  private PortfolioPositionClosedListDataRange range;

  public PortfolioPositionClosedListData() { 
  }
  ...
  public PortfolioPositionClosedListData id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPositionClosedListData range(PortfolioPositionClosedListDataRange range) {
    this.range = range;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPositionClosedListDataRange getRange() {
    return range;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RANGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRange(PortfolioPositionClosedListDataRange range) {
    this.range = range;
  }


  /**
   * Return true if this _portfolio_position_closed_list_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPositionClosedListData portfolioPositionClosedListData = (PortfolioPositionClosedListData) o;
    return Objects.equals(this.id, portfolioPositionClosedListData.id) &&
        Objects.equals(this.range, portfolioPositionClosedListData.range);
  }
