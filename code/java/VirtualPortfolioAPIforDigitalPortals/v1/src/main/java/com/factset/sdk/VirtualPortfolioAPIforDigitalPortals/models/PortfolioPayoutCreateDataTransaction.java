...
/**
 * Associates the payout with a sub-position opened by a specific buy transaction. If omitted, the payout will be associated with all sub-positions of the notation in the portfolio.
 */
@ApiModel(description = "Associates the payout with a sub-position opened by a specific buy transaction. If omitted, the payout will be associated with all sub-positions of the notation in the portfolio.")
@JsonPropertyOrder({
  PortfolioPayoutCreateDataTransaction.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutCreateDataTransaction implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public PortfolioPayoutCreateDataTransaction() { 
  }
  ...
  public PortfolioPayoutCreateDataTransaction id(String id) {
    this.id = id;
    return this;
  }

   /**
   * Identifier of the buy transaction.
   * @return id
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Identifier of the buy transaction.")
  ...
  /**
   * Return true if this _portfolio_payout_create_data_transaction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutCreateDataTransaction portfolioPayoutCreateDataTransaction = (PortfolioPayoutCreateDataTransaction) o;
    return Objects.equals(this.id, portfolioPayoutCreateDataTransaction.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class PortfolioPayoutCreateDataTransaction {\n");
