...
@JsonPropertyOrder({
  PortfolioPayoutDeleteDataPayout.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutDeleteDataPayout implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public PortfolioPayoutDeleteDataPayout() { 
  }
  ...
  public PortfolioPayoutDeleteDataPayout id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this _portfolio_payout_delete_data_payout object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutDeleteDataPayout portfolioPayoutDeleteDataPayout = (PortfolioPayoutDeleteDataPayout) o;
    return Objects.equals(this.id, portfolioPayoutDeleteDataPayout.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class PortfolioPayoutDeleteDataPayout {\n");
