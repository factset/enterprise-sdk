...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioEvaluationListData;
...
public class InlineObject3 implements Serializable {
  ...
  private PortfolioEvaluationListData data;
  ...
  public InlineObject3 data(PortfolioEvaluationListData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioEvaluationListData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioEvaluationListData data) {
    this.data = data;
  }


  public InlineObject3 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
