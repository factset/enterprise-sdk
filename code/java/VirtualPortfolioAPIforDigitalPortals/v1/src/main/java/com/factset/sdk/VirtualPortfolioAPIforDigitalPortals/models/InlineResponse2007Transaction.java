 ...
 */
@ApiModel(description = "Buy transaction with which the payout is associated; all contained attributes are null if the payout is not associated with any specific buy transaction.")
@JsonPropertyOrder({
  InlineResponse2007Transaction.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2007Transaction implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public InlineResponse2007Transaction() { 
  }

  public InlineResponse2007Transaction id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_7_transaction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2007Transaction inlineResponse2007Transaction = (InlineResponse2007Transaction) o;
    return Objects.equals(this.id, inlineResponse2007Transaction.id);
  }
