 ...
 */
@ApiModel(description = "Notation of the payout.")
@JsonPropertyOrder({
  InlineResponse2007Notation.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2007Notation implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public InlineResponse2007Notation() { 
  }

  public InlineResponse2007Notation id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_7_notation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2007Notation inlineResponse2007Notation = (InlineResponse2007Notation) o;
    return Objects.equals(this.id, inlineResponse2007Notation.id);
  }
