 ...
 */
@ApiModel(description = "Filtering the payouts by instrument.")
@JsonPropertyOrder({
  PortfolioPayoutListDataFilterInstrument.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutListDataFilterInstrument implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public PortfolioPayoutListDataFilterInstrument() { 
  }

  public PortfolioPayoutListDataFilterInstrument id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this _portfolio_payout_list_data_filter_instrument object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutListDataFilterInstrument portfolioPayoutListDataFilterInstrument = (PortfolioPayoutListDataFilterInstrument) o;
    return Objects.equals(this.id, portfolioPayoutListDataFilterInstrument.id);
  }
