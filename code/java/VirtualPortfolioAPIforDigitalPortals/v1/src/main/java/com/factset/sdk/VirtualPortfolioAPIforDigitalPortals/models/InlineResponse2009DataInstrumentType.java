 ...
 */
@JsonPropertyOrder({
  InlineResponse2009DataInstrumentType.JSON_PROPERTY_ID,
  InlineResponse2009DataInstrumentType.JSON_PROPERTY_NAME
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2009DataInstrumentType implements Serializable {
  ...
  public InlineResponse2009DataInstrumentType() { 
  }

  public InlineResponse2009DataInstrumentType id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Identifier of the instrument type.")
  ...
  public InlineResponse2009DataInstrumentType name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the instrument type.")
  ...
  /**
   * Return true if this inline_response_200_9_data_instrument_type object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2009DataInstrumentType inlineResponse2009DataInstrumentType = (InlineResponse2009DataInstrumentType) o;
    return Objects.equals(this.id, inlineResponse2009DataInstrumentType.id) &&
        Objects.equals(this.name, inlineResponse2009DataInstrumentType.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse2009DataInstrumentType {\n");
