...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutDeleteData;
...
public class InlineObject5 implements Serializable {
  ...
  private PortfolioPayoutDeleteData data;
  ...
  public InlineObject5 data(PortfolioPayoutDeleteData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutDeleteData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioPayoutDeleteData data) {
    this.data = data;
  }


  public InlineObject5 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
