...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioTransactionCashDeleteData;
...
public class InlineObject8 implements Serializable {
  ...
  private PortfolioTransactionCashDeleteData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PortfolioCreateMeta meta;


  public InlineObject8 data(PortfolioTransactionCashDeleteData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioTransactionCashDeleteData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioTransactionCashDeleteData data) {
    this.data = data;
  }


  public InlineObject8 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
