...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPositionClosedListData;
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPositionClosedListMeta;
...
public class InlineObject8 implements Serializable {
  ...
  private PortfolioPositionClosedListData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PortfolioPositionClosedListMeta meta;

  public InlineObject8() { 
  }

  public InlineObject8 data(PortfolioPositionClosedListData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPositionClosedListData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioPositionClosedListData data) {
    this.data = data;
  }


  public InlineObject8 meta(PortfolioPositionClosedListMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPositionClosedListMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(PortfolioPositionClosedListMeta meta) {
    this.meta = meta;
  }
