...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse20010DataTransactionBuyCurrency;
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse20010DataTransactionBuyNotation;
 ...
 */
@ApiModel(description = "Opening transaction of the closed position.")
@JsonPropertyOrder({
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_ID,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_TIME,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_NOTATION,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_CURRENCY,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_PRICE,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_CHARGES,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_VALUE,
  InlineResponse20010DataTransactionBuy.JSON_PROPERTY_EXCHANGE_RATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20010DataTransactionBuy implements Serializable {
  ...
  private InlineResponse20010DataTransactionBuyNotation notation;

  public static final String JSON_PROPERTY_CURRENCY = "currency";
  private InlineResponse20010DataTransactionBuyCurrency currency;
  ...
  public InlineResponse20010DataTransactionBuy() { 
  }

  public InlineResponse20010DataTransactionBuy id(String id) {
    this.id = id;
    return this;
  }

   /**
   * Identifier of the opening transaction.
   * @return id
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Identifier of the opening transaction.")
  ...
  public InlineResponse20010DataTransactionBuy time(String time) {
    this.time = time;
    return this;
  }

   /**
   * Date and time of the opening transaction.
   * @return time
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time of the opening transaction.")
  ...
  public InlineResponse20010DataTransactionBuy notation(InlineResponse20010DataTransactionBuyNotation notation) {
  ...
  **/
  ...
  public InlineResponse20010DataTransactionBuyNotation getNotation() {
    return notation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NOTATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNotation(InlineResponse20010DataTransactionBuyNotation notation) {
    this.notation = notation;
  }


  public InlineResponse20010DataTransactionBuy currency(InlineResponse20010DataTransactionBuyCurrency currency) {
  ...
  **/
  ...
  public InlineResponse20010DataTransactionBuyCurrency getCurrency() {
    return currency;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CURRENCY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCurrency(InlineResponse20010DataTransactionBuyCurrency currency) {
    this.currency = currency;
  }


  public InlineResponse20010DataTransactionBuy price(BigDecimal price) {
    this.price = price;
    return this;
  }

   /**
   * Purchase price of the position in the portfolio&#39;s base currency.
   * @return price
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Purchase price of the position in the portfolio's base currency.")
  ...
  public InlineResponse20010DataTransactionBuy charges(BigDecimal charges) {
  ...
  **/
  ...
  public InlineResponse20010DataTransactionBuy value(BigDecimal value) {
    this.value = value;
    return this;
  }

   /**
   * Purchase value of the position in the portfolio&#39;s base currency.
   * @return value
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Purchase value of the position in the portfolio's base currency.")
  ...
  public InlineResponse20010DataTransactionBuy exchangeRate(BigDecimal exchangeRate) {
    this.exchangeRate = exchangeRate;
    return this;
  }

   /**
   * The exchange rate between the notation&#39;s currency and the portfolio currency at the time of the opening trade.
   * @return exchangeRate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The exchange rate between the notation's currency and the portfolio currency at the time of the opening trade.")
  ...
  /**
   * Return true if this inline_response_200_10_data_transaction_buy object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20010DataTransactionBuy inlineResponse20010DataTransactionBuy = (InlineResponse20010DataTransactionBuy) o;
    return Objects.equals(this.id, inlineResponse20010DataTransactionBuy.id) &&
        Objects.equals(this.time, inlineResponse20010DataTransactionBuy.time) &&
        Objects.equals(this.notation, inlineResponse20010DataTransactionBuy.notation) &&
        Objects.equals(this.currency, inlineResponse20010DataTransactionBuy.currency) &&
        Objects.equals(this.price, inlineResponse20010DataTransactionBuy.price) &&
        Objects.equals(this.charges, inlineResponse20010DataTransactionBuy.charges) &&
        Objects.equals(this.value, inlineResponse20010DataTransactionBuy.value) &&
        Objects.equals(this.exchangeRate, inlineResponse20010DataTransactionBuy.exchangeRate);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse20010DataTransactionBuy {\n");
