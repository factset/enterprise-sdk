...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse20015Data;
...
public class InlineResponse20015 implements Serializable {
  ...
  private java.util.List<InlineResponse20015Data> data = null;
  ...
  public InlineResponse20015 data(java.util.List<InlineResponse20015Data> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public java.util.List<InlineResponse20015Data> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<InlineResponse20015Data> data) {
    this.data = data;
  }


  public InlineResponse20015 meta(InlineResponse201Meta meta) {
    this.meta = meta;
    return this;
  }
