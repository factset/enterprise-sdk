...
@JsonPropertyOrder({
  WatchlistModifyData.JSON_PROPERTY_ID,
...
public class WatchlistModifyData implements Serializable {
  ...
  public WatchlistModifyData id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, watchlistModifyData.id) &&
        Objects.equals(this.name, watchlistModifyData.name);
  }
