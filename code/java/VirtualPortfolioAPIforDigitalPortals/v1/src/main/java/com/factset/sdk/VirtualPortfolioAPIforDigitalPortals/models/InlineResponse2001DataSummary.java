...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse2001DataSummaryTransactions;
...
@JsonPropertyOrder({
  InlineResponse2001DataSummary.JSON_PROPERTY_TOTAL_VALUE,
  InlineResponse2001DataSummary.JSON_PROPERTY_MARKET_VALUE,
  InlineResponse2001DataSummary.JSON_PROPERTY_PURCHASE_VALUE,
  InlineResponse2001DataSummary.JSON_PROPERTY_NUMBER_POSITIONS,
  InlineResponse2001DataSummary.JSON_PROPERTY_TRANSACTIONS,
  InlineResponse2001DataSummary.JSON_PROPERTY_CASH
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse2001DataSummary implements Serializable {
  ...
  private InlineResponse2001DataSummaryTransactions transactions;
  ...
  **/
  ...
  public InlineResponse2001DataSummary marketValue(BigDecimal marketValue) {
  ...
  **/
  ...
  public InlineResponse2001DataSummary purchaseValue(BigDecimal purchaseValue) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total purchase value of all securities.")
  ...
  public InlineResponse2001DataSummary numberPositions(BigDecimal numberPositions) {
  ...
  **/
  ...
  public InlineResponse2001DataSummary transactions(InlineResponse2001DataSummaryTransactions transactions) {
  ...
  **/
  ...
  public InlineResponse2001DataSummaryTransactions getTransactions() {
    return transactions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTransactions(InlineResponse2001DataSummaryTransactions transactions) {
    this.transactions = transactions;
  }


  public InlineResponse2001DataSummary cash(InlineResponse2001DataSummaryCash cash) {
    this.cash = cash;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_1_data_summary object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse2001DataSummary inlineResponse2001DataSummary = (InlineResponse2001DataSummary) o;
    return Objects.equals(this.totalValue, inlineResponse2001DataSummary.totalValue) &&
        Objects.equals(this.marketValue, inlineResponse2001DataSummary.marketValue) &&
        Objects.equals(this.purchaseValue, inlineResponse2001DataSummary.purchaseValue) &&
        Objects.equals(this.numberPositions, inlineResponse2001DataSummary.numberPositions) &&
        Objects.equals(this.transactions, inlineResponse2001DataSummary.transactions) &&
        Objects.equals(this.cash, inlineResponse2001DataSummary.cash);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalValue, marketValue, purchaseValue, numberPositions, transactions, cash);
  }
