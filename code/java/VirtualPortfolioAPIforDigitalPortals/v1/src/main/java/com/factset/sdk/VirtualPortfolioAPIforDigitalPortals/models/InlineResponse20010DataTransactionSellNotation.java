 ...
 */
@ApiModel(description = "Notation of the closing transaction.")
@JsonPropertyOrder({
  InlineResponse20010DataTransactionSellNotation.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse20010DataTransactionSellNotation implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public InlineResponse20010DataTransactionSellNotation() { 
  }

  public InlineResponse20010DataTransactionSellNotation id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_10_data_transaction_sell_notation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse20010DataTransactionSellNotation inlineResponse20010DataTransactionSellNotation = (InlineResponse20010DataTransactionSellNotation) o;
    return Objects.equals(this.id, inlineResponse20010DataTransactionSellNotation.id);
  }
