...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.InlineResponse20010DataPositions;
 ...
 */
@ApiModel(description = "List of closed positions.")
@JsonPropertyOrder({
  InlineResponse20010Data.JSON_PROPERTY_POSITIONS
})
...
public class InlineResponse20010Data implements Serializable {
  ...
  private java.util.List<InlineResponse20010DataPositions> positions = null;

  public InlineResponse20010Data() { 
  }

  public InlineResponse20010Data positions(java.util.List<InlineResponse20010DataPositions> positions) {
    this.positions = positions;
    return this;
  }

  public InlineResponse20010Data addPositionsItem(InlineResponse20010DataPositions positionsItem) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Closed positions of the portfolio.")
  @JsonProperty(JSON_PROPERTY_POSITIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<InlineResponse20010DataPositions> getPositions() {
    return positions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_POSITIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPositions(java.util.List<InlineResponse20010DataPositions> positions) {
    this.positions = positions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.positions, inlineResponse20010Data.positions);
  }
