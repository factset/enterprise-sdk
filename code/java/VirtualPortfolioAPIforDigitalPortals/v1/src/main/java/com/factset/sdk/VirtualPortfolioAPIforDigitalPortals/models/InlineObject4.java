...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutCreateData;
...
public class InlineObject4 implements Serializable {
  ...
  private PortfolioPayoutCreateData data;
  ...
  public InlineObject4 data(PortfolioPayoutCreateData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutCreateData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioPayoutCreateData data) {
    this.data = data;
  }
