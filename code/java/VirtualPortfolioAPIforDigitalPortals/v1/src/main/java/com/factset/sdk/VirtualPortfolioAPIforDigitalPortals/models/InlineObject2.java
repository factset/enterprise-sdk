...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioModifyData;
...
public class InlineObject2 implements Serializable {
  ...
  private PortfolioModifyData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PortfolioCreateMeta meta;


  public InlineObject2 data(PortfolioModifyData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioModifyData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioModifyData data) {
    this.data = data;
  }


  public InlineObject2 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
