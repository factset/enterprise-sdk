 ...
 */
@ApiModel(description = "Date range for the closed positions. A valid date range is between 1900-01-01 and the day after the current day. A date before the date of the first transaction is implicitly adjusted to the date of the portfolio's first transaction.")
@JsonPropertyOrder({
  PortfolioPositionClosedListDataRange.JSON_PROPERTY_START,
  PortfolioPositionClosedListDataRange.JSON_PROPERTY_END
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPositionClosedListDataRange implements Serializable {
  ...
  public PortfolioPositionClosedListDataRange() { 
  }
  ...
  public PortfolioPositionClosedListDataRange start(LocalDate start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPositionClosedListDataRange end(LocalDate end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this _portfolio_position_closed_list_data_range object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPositionClosedListDataRange portfolioPositionClosedListDataRange = (PortfolioPositionClosedListDataRange) o;
    return Objects.equals(this.start, portfolioPositionClosedListDataRange.start) &&
        Objects.equals(this.end, portfolioPositionClosedListDataRange.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class PortfolioPositionClosedListDataRange {\n");
