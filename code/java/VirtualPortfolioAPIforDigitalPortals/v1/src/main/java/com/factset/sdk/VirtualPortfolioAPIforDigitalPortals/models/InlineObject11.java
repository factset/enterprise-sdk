...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioTransactionModifyData;
...
public class InlineObject11 implements Serializable {
  ...
  private PortfolioTransactionModifyData data;
  ...
  public InlineObject11 data(PortfolioTransactionModifyData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioTransactionModifyData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioTransactionModifyData data) {
    this.data = data;
  }


  public InlineObject11 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
