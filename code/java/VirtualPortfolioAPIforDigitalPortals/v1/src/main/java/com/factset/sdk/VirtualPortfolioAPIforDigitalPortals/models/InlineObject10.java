...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioTransactionDeleteData;
...
public class InlineObject10 implements Serializable {
  ...
  private PortfolioTransactionDeleteData data;
  ...
  public InlineObject10 data(PortfolioTransactionDeleteData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioTransactionDeleteData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioTransactionDeleteData data) {
    this.data = data;
  }


  public InlineObject10 meta(PortfolioCreateMeta meta) {
    this.meta = meta;
    return this;
  }
