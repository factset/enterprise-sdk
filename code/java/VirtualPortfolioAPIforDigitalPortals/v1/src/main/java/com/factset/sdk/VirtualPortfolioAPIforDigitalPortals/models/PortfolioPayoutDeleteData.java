...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutDeleteDataPayout;
...
@JsonPropertyOrder({
  PortfolioPayoutDeleteData.JSON_PROPERTY_ID,
  PortfolioPayoutDeleteData.JSON_PROPERTY_PAYOUT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutDeleteData implements Serializable {
  ...
  private PortfolioPayoutDeleteDataPayout payout;

  public PortfolioPayoutDeleteData() { 
  }

  @JsonCreator
  public PortfolioPayoutDeleteData(
    @JsonProperty(value=JSON_PROPERTY_ID, required=true) String id, 
    @JsonProperty(value=JSON_PROPERTY_PAYOUT, required=true) PortfolioPayoutDeleteDataPayout payout
  ) {
    this();
    this.id = id;
    this.payout = payout;
  ...
  public PortfolioPayoutDeleteData id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutDeleteData payout(PortfolioPayoutDeleteDataPayout payout) {
    this.payout = payout;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutDeleteDataPayout getPayout() {
    return payout;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYOUT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPayout(PortfolioPayoutDeleteDataPayout payout) {
    this.payout = payout;
  }


  /**
   * Return true if this _portfolio_payout_delete_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutDeleteData portfolioPayoutDeleteData = (PortfolioPayoutDeleteData) o;
    return Objects.equals(this.id, portfolioPayoutDeleteData.id) &&
        Objects.equals(this.payout, portfolioPayoutDeleteData.payout);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, payout);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PortfolioPayoutDeleteData {\n");
