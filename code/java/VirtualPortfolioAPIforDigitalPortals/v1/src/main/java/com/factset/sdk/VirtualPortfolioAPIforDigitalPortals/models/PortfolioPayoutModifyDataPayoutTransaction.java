 ...
 */
@ApiModel(description = "Associates the payout with a sub-position opened by a specific buy transaction and removes the existing association if available.")
@JsonPropertyOrder({
  PortfolioPayoutModifyDataPayoutTransaction.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutModifyDataPayoutTransaction implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ID = "id";
  private String id;

  public PortfolioPayoutModifyDataPayoutTransaction() { 
  }

  public PortfolioPayoutModifyDataPayoutTransaction id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Identifier of the buy transaction.")
  ...
  /**
   * Return true if this _portfolio_payout_modify_data_payout_transaction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutModifyDataPayoutTransaction portfolioPayoutModifyDataPayoutTransaction = (PortfolioPayoutModifyDataPayoutTransaction) o;
    return Objects.equals(this.id, portfolioPayoutModifyDataPayoutTransaction.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class PortfolioPayoutModifyDataPayoutTransaction {\n");
