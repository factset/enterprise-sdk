...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutListMetaPagination;
...
@JsonPropertyOrder({
  PortfolioPayoutListMeta.JSON_PROPERTY_ATTRIBUTES,
  PortfolioPayoutListMeta.JSON_PROPERTY_SORT,
  PortfolioPayoutListMeta.JSON_PROPERTY_PAGINATION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PortfolioPayoutListMeta implements Serializable {
  ...
  private PortfolioPayoutListMetaPagination pagination;

  public PortfolioPayoutListMeta() { 
  }

  public PortfolioPayoutListMeta attributes(java.util.Set<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PortfolioPayoutListMeta addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public PortfolioPayoutListMeta sort(java.util.Set<SortEnum> sort) {
    this.sort = sort;
    return this;
  }

  public PortfolioPayoutListMeta addSortItem(SortEnum sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public PortfolioPayoutListMeta pagination(PortfolioPayoutListMetaPagination pagination) {
  ...
  **/
  ...
  public PortfolioPayoutListMetaPagination getPagination() {
    return pagination;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAGINATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPagination(PortfolioPayoutListMetaPagination pagination) {
    this.pagination = pagination;
  }


  /**
   * Return true if this _portfolio_payout_list_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortfolioPayoutListMeta portfolioPayoutListMeta = (PortfolioPayoutListMeta) o;
    return Objects.equals(this.attributes, portfolioPayoutListMeta.attributes) &&
        Objects.equals(this.sort, portfolioPayoutListMeta.sort) &&
        Objects.equals(this.pagination, portfolioPayoutListMeta.pagination);
  }
