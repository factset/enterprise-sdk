...
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutListData;
import com.factset.sdk.VirtualPortfolioAPIforDigitalPortals.models.PortfolioPayoutListMeta;
...
public class InlineObject6 implements Serializable {
  ...
  private PortfolioPayoutListData data;

  public static final String JSON_PROPERTY_META = "meta";
  private PortfolioPayoutListMeta meta;

  public InlineObject6() { 
  }

  public InlineObject6 data(PortfolioPayoutListData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutListData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PortfolioPayoutListData data) {
    this.data = data;
  }


  public InlineObject6 meta(PortfolioPayoutListMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public PortfolioPayoutListMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(PortfolioPayoutListMeta meta) {
    this.meta = meta;
  }
