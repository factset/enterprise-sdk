package com.factset.sdk.DirectStreamingofTransactionMessages;
...
import com.factset.sdk.DirectStreamingofTransactionMessages.auth.Authentication;
import com.factset.sdk.DirectStreamingofTransactionMessages.auth.HttpBasicAuth;
import com.factset.sdk.DirectStreamingofTransactionMessages.auth.HttpBearerAuth;
import com.factset.sdk.DirectStreamingofTransactionMessages.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.DirectStreamingofTransactionMessages.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/dsotm/v1";
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/DirectStreamingofTransactionMessages/0.25.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.DirectStreamingofTransactionMessages.ApiClient} object.
   */
