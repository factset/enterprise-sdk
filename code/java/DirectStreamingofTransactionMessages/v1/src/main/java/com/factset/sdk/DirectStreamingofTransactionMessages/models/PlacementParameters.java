...
public class PlacementParameters implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, transactionleaves, amount, currencyiso, foreignexchangerate);
  }
