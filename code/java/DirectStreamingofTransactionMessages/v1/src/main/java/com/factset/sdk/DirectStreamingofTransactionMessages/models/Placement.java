  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.placementDate, placement.placementDate) &&
        ...
        equalsNullable(this.limitPrice, placement.limitPrice) &&
        equalsNullable(this.stopPrice, placement.stopPrice) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(placementDate, transactionId, hashCodeNullable(parentId), hashCodeNullable(orderId), transactionStatus, orderType, hashCodeNullable(limitPrice), hashCodeNullable(stopPrice), tif, hashCodeNullable(tifDate), settlementType, hashCodeNullable(settlementDate), account, symbol, instrumentName, side, unitType, hashCodeNullable(transactionLeaves), quantity, gross, hashCodeNullable(price), currency, complianceStatus, hashCodeNullable(addedDateTime), hashCodeNullable(updatedDateTime), hashCodeNullable(additionalFields));
  }
