...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'factsetquantfactorlibrary' jar has been published to maven central.
    mavenLocal()       // Needed if the 'factsetquantfactorlibrary' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:factsetquantfactorlibrary:0.9.0"
  }
```
...
- `target/factsetquantfactorlibrary-0.9.0.jar`
- `target/lib/*.jar`
