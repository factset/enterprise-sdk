...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/factsetquantfactorlibrary/2.0.2)](https://central.sonatype.com/artifact/com.factset.sdk/factsetquantfactorlibrary/2.0.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:factsetquantfactorlibrary:2.0.2"
  }
```
