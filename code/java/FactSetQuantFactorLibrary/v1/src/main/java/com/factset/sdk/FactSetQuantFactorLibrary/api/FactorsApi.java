...
public class FactorsApi {
   ...
   * @param factors Array of individual Factor Items requested. For a list of all available factors and descriptions use the &#x60;/library&#x60; endpoint.***&lt;p&gt;factors limit** &#x3D; 20 individual factors per request*  (optional)
   ...
   */
  public FactorsResponse getFactors(java.util.List<String> ids, String startDate, String endDate, java.util.List<String> factors, java.util.List<String> factorGroups, String frequency) throws ApiException {
    return getFactorsWithHttpInfo(ids, startDate, endDate, factors, factorGroups, frequency).getData();
  }
   ...
   */
  public ApiResponse<FactorsResponse> getFactorsWithHttpInfo(java.util.List<String> ids, String startDate, String endDate, java.util.List<String> factors, java.util.List<String> factorGroups, String frequency) throws ApiException {
