...
@JsonPropertyOrder({
  ...
  InsiderTransactions.JSON_PROPERTY_TRANSACTION_CODE,
  InsiderTransactions.JSON_PROPERTY_TRANSACTION_CODE_DESCRIPTION,
...
public class InsiderTransactions implements Serializable {
  ...
  private JsonNullable<String> transactionCode = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_TRANSACTION_CODE_DESCRIPTION = "transactionCodeDescription";
  private JsonNullable<String> transactionCodeDescription = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public InsiderTransactions transactionCode(String transactionCode) {
    this.transactionCode = JsonNullable.<String>of(transactionCode);
    return this;
  }

   /**
   * Returns the transaction detail code for the transaction.
   * @return transactionCode
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "S", value = "Returns the transaction detail code for the transaction.")
  @JsonIgnore

  public String getTransactionCode() {
        return transactionCode.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TRANSACTION_CODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getTransactionCode_JsonNullable() {
    return transactionCode;
  }
  
  @JsonProperty(JSON_PROPERTY_TRANSACTION_CODE)
  public void setTransactionCode_JsonNullable(JsonNullable<String> transactionCode) {
  ...
  public InsiderTransactions transactionCodeDescription(String transactionCodeDescription) {
    this.transactionCodeDescription = JsonNullable.<String>of(transactionCodeDescription);
    return this;
  }

   /**
   * Returns the description of the transaction detail code for the transaction.
   * @return transactionCodeDescription
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Open market or private sale of non-derivative or derivative security", value = "Returns the description of the transaction detail code for the transaction.")
  @JsonIgnore

  public String getTransactionCodeDescription() {
        return transactionCodeDescription.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TRANSACTION_CODE_DESCRIPTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getTransactionCodeDescription_JsonNullable() {
    return transactionCodeDescription;
  }
  
  @JsonProperty(JSON_PROPERTY_TRANSACTION_CODE_DESCRIPTION)
  public void setTransactionCodeDescription_JsonNullable(JsonNullable<String> transactionCodeDescription) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, insiderTransactions.requestId) &&
        ...
        equalsNullable(this.transactionCode, insiderTransactions.transactionCode) &&
        equalsNullable(this.transactionCodeDescription, insiderTransactions.transactionCodeDescription) &&
