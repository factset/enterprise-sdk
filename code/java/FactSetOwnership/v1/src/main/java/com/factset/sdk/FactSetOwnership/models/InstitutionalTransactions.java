...
@JsonPropertyOrder({
  ...
  InstitutionalTransactions.JSON_PROPERTY_PERIOD_OF_MEASURE,
  InstitutionalTransactions.JSON_PROPERTY_REPORT_DATE,
  InstitutionalTransactions.JSON_PROPERTY_AS_OF_DATE
})
...
public class InstitutionalTransactions implements Serializable {
  ...
  private JsonNullable<String> periodOfMeasure = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public InstitutionalTransactions periodOfMeasure(String periodOfMeasure) {
    this.periodOfMeasure = JsonNullable.<String>of(periodOfMeasure);
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "6M", value = "Returns the range over which the code calculates change for Percent Ownership and Position Change.")
  @JsonIgnore

  public String getPeriodOfMeasure() {
        return periodOfMeasure.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_PERIOD_OF_MEASURE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getPeriodOfMeasure_JsonNullable() {
    return periodOfMeasure;
  }
  
  @JsonProperty(JSON_PROPERTY_PERIOD_OF_MEASURE)
  public void setPeriodOfMeasure_JsonNullable(JsonNullable<String> periodOfMeasure) {
    this.periodOfMeasure = periodOfMeasure;
  }

  public void setPeriodOfMeasure(String periodOfMeasure) {
    this.periodOfMeasure = JsonNullable.<String>of(periodOfMeasure);
  }


  public InstitutionalTransactions reportDate(LocalDate reportDate) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "Fri Nov 15 00:00:00 UTC 2024", value = "Returns the report date for the transactions that occurred between the specified start and end dates.")
  @JsonIgnore
  ...
  public InstitutionalTransactions asOfDate(LocalDate asOfDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, institutionalTransactions.requestId) &&
        ...
        equalsNullable(this.periodOfMeasure, institutionalTransactions.periodOfMeasure) &&
        equalsNullable(this.reportDate, institutionalTransactions.reportDate) &&
        equalsNullable(this.asOfDate, institutionalTransactions.asOfDate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, hashCodeNullable(fsymId), hashCodeNullable(currency), hashCodeNullable(holderName), hashCodeNullable(pctOS), hashCodeNullable(pctChange), hashCodeNullable(posChange), hashCodeNullable(marketVal), hashCodeNullable(periodOfMeasure), hashCodeNullable(reportDate), hashCodeNullable(asOfDate));
  }
