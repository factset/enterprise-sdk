 ...
 */
@ApiModel(description = "fundHolding response")
@JsonPropertyOrder({
  FundHoldingsResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class FundHoldingsResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<FundHolding> data = null;

  public FundHoldingsResponse() { 
  }

  public FundHoldingsResponse data(java.util.List<FundHolding> data) {
    this.data = data;
    return this;
  }

  public FundHoldingsResponse addDataItem(FundHolding dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of Fund holdings")
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<FundHolding> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<FundHolding> data) {
    this.data = data;
  }


  /**
   * Return true if this fundHoldingsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FundHoldingsResponse fundHoldingsResponse = (FundHoldingsResponse) o;
    return Objects.equals(this.data, fundHoldingsResponse.data);
  }
