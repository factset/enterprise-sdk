...
public class FundHolding implements Serializable {
  ...
  **/
  ...
  public FundHolding date(String date) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2018-06-30", value = "Date of the reported holding in YYYY-MM-DD format. For more details, visit [Online Assistant Page #11262](https://oa.apps.factset.com/pages/11262).")
  @JsonIgnore
