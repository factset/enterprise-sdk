...
import com.factset.sdk.FactSetOwnership.auth.Authentication;
import com.factset.sdk.FactSetOwnership.auth.HttpBasicAuth;
import com.factset.sdk.FactSetOwnership.auth.HttpBearerAuth;
import com.factset.sdk.FactSetOwnership.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.FactSetOwnership.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/content/factset-ownership/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/content/factset-ownership/v1",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/FactSetOwnership/2.3.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.FactSetOwnership.ApiClient} object.
   */
