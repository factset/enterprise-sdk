...
import com.factset.sdk.FactSetOwnership.models.ErrorResponseSubErrors;
...
public class ErrorResponse implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2020-06-12T16:08:51.731Z", value = "timestamp in YYYY-MM-DD HH:MM:SS.SSS")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "/factset-ownership/v1/{end-point}", value = "The Endpoint path {package}/version/{endpoint}")
