...
import com.factset.sdk.OpenFactSetMarketplace.auth.Authentication;
import com.factset.sdk.OpenFactSetMarketplace.auth.HttpBasicAuth;
import com.factset.sdk.OpenFactSetMarketplace.auth.HttpBearerAuth;
import com.factset.sdk.OpenFactSetMarketplace.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.OpenFactSetMarketplace.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/ofs/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/ofs/v0",
      "Production server",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/OpenFactSetMarketplace/0.0.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.OpenFactSetMarketplace.ApiClient} object.
   */
