...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/globalfilings/2.3.2)](https://central.sonatype.com/artifact/com.factset.sdk/globalfilings/2.3.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:globalfilings:2.3.2"
  }
```
