...
import com.factset.sdk.GlobalFilings.auth.Authentication;
import com.factset.sdk.GlobalFilings.auth.HttpBasicAuth;
import com.factset.sdk.GlobalFilings.auth.HttpBearerAuth;
import com.factset.sdk.GlobalFilings.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.GlobalFilings.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/content/global-filings/v2";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/content/global-filings/v2",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/GlobalFilings/2.3.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.GlobalFilings.ApiClient} object.
   */
