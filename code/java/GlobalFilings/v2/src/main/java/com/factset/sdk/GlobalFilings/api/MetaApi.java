...
import com.factset.sdk.GlobalFilings.models.CategoryResponse;
import com.factset.sdk.GlobalFilings.models.ErrorResponse;
import com.factset.sdk.GlobalFilings.models.FormTypeResponse;
import com.factset.sdk.GlobalFilings.models.SourceResponse;
import com.factset.sdk.GlobalFilings.models.TimeZoneResponse;
...
public class MetaApi {
  ...
  static {
    getFormtypeResponseTypeMap.put(200, new GenericType<FormTypeResponse>(){});
  ...
  static {
    getTimezoneResponseTypeMap.put(200, new GenericType<TimeZoneResponse>(){});
  ...
  static {
    getcategoriesResponseTypeMap.put(200, new GenericType<CategoryResponse>(){});
   ...
   */
  public FormTypeResponse getFormtype(java.util.List<String> sources) throws ApiException {
    return getFormtypeWithHttpInfo(sources).getData();
  }
   ...
   *  Retrieves and delivers a comprehensive list of all available  &#x60;formTypes&#x60;.
   * @param sources Code for document source to include.  This is a comma-separated list. Use the &#x60;/meta/sources&#x60; endpoint to get the list of available sources. (optional)
   * @return ApiResponse&lt;FormTypeResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<FormTypeResponse> getFormtypeWithHttpInfo(java.util.List<String> sources) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/meta/form-types";
    ...
    > apiResponse = apiClient.invokeAPI("MetaApi.getFormtype", localVarPath, "GET", localVarQueryParams, localVarPostBody,
   ...
   */
  public TimeZoneResponse getTimezone() throws ApiException {
   ...
   */
  public ApiResponse<TimeZoneResponse> getTimezoneWithHttpInfo() throws ApiException {
    Object localVarPostBody = null;
    ...
    > apiResponse = apiClient.invokeAPI("MetaApi.getTimezone", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
