...
public class FilingsApiApi {
   ...
   * @param ids Requested symbols or securities.  This is a comma-separated list with a maximum limit of 10.  Each symbol can be a FactSet exchange symbol, CUSIP, or SEDOL. (required)
   ...
   */
  public CountResponse getCount(java.util.List<String> ids, java.util.List<String> sources, String startDate, String endDate) throws ApiException {
    return getCountWithHttpInfo(ids, sources, startDate, endDate).getData();
  }
   ...
   */
  public ApiResponse<CountResponse> getCountWithHttpInfo(java.util.List<String> ids, java.util.List<String> sources, String startDate, String endDate) throws ApiException {
   ...
   * @param ids Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol, CUSIP, or SEDOL. (required)
  ...
  public ApiResponse<SearchResponse> getFilingsWithHttpInfo(java.util.List<String> ids, java.util.List<String> sources, String startDate, String endDate, Integer paginationLimit, Integer paginationOffset, String timeZone, java.util.List<String> sort, java.util.List<String> categories, Boolean primaryId, String searchText, java.util.List<String> formTypes, String edgarAccession) throws ApiException {
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "sources", sources));
