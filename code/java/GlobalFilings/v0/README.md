...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/globalfilings/0.2.2)](https://central.sonatype.com/artifact/com.factset.sdk/globalfilings/0.2.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:globalfilings:0.2.2"
  }
```
...
*FilingsApiApi* | [**getHelper**](docs/FilingsApiApi.md#getHelper) | **GET** /helper | Returns the static values for various parameters
...
## Documentation for Models
 ...
 - [ResponseHelper](docs/ResponseHelper.md)
 - [ResponseHelperObject](docs/ResponseHelperObject.md)
 - [ResponseHelperObjectCategoriesObject](docs/ResponseHelperObjectCategoriesObject.md)
 - [ResponseHelperObjectFormtypesObject](docs/ResponseHelperObjectFormtypesObject.md)
 - [ResponseHelperObjectSourcesObject](docs/ResponseHelperObjectSourcesObject.md)
 - [ResponseHelperObjectTimeZonesObject](docs/ResponseHelperObjectTimeZonesObject.md)
