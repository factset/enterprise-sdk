...
import com.factset.sdk.GlobalFilings.models.ResponseCountObject;
...
@JsonPropertyOrder({
  ResponseCount.JSON_PROPERTY_DATA
})
...
public class ResponseCount implements Serializable {
  ...
  private java.util.List<ResponseCountObject> data = null;

  public ResponseCount() { 
  }

  public ResponseCount data(java.util.List<ResponseCountObject> data) {
    this.data = data;
    return this;
  }

  public ResponseCount addDataItem(ResponseCountObject dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<ResponseCountObject> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<ResponseCountObject> data) {
    this.data = data;
  }


  /**
   * Return true if this responseCount object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResponseCount responseCount = (ResponseCount) o;
    return Objects.equals(this.data, responseCount.data);
  }
