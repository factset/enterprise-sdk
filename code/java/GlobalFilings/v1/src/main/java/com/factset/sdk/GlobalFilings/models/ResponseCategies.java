...
import com.factset.sdk.GlobalFilings.models.ResponseCategoriesObject;
...
@JsonPropertyOrder({
  ResponseCategies.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class ResponseCategies implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.List<ResponseCategoriesObject> data = null;

  public ResponseCategies() { 
  }

  public ResponseCategies data(java.util.List<ResponseCategoriesObject> data) {
    this.data = data;
    return this;
  }

  public ResponseCategies addDataItem(ResponseCategoriesObject dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this responseCategies object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResponseCategies responseCategies = (ResponseCategies) o;
    return Objects.equals(this.data, responseCategies.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseCategies {\n");
