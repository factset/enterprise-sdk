...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/companylogo/0.41.0)](https://central.sonatype.com/artifact/com.factset.sdk/companylogo/0.41.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:companylogo:0.41.0"
  }
```
...
------------ | ------------- | ------------- | -------------
*CompanyLogosApi* | [**postCompanyLogo**](docs/CompanyLogosApi.md#postCompanyLogo) | **POST** /logo/list | Retrieves logos for one or more publicly traded companies.
