...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/companylogo/0.40.0)](https://central.sonatype.com/artifact/com.factset.sdk/companylogo/0.40.0)
...
<dependency>
  <groupId>com.factset.sdk</groupId>
  <artifactId>companylogo</artifactId>
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:companylogo:0.40.0"
  }
```
...
```java
import com.factset.sdk.CompanyLogo.*;
...
public class CompanyLogosApiExample {
...
------------ | ------------- | ------------- | -------------
*CompanyLogosApi* | [**postCompanyLogo**](docs/CompanyLogosApi.md#postCompanyLogo) | **POST** /company/logo | Retrieves logos for one or more publicly traded companies.


## Documentation for Models

 - [CompanyLogoItemObject](docs/CompanyLogoItemObject.md)
 - [CompanyLogoObject](docs/CompanyLogoObject.md)
 - [ErrorDetail](docs/ErrorDetail.md)
 - [ErrorResponse](docs/ErrorResponse.md)
 - [ErrorResponseMeta](docs/ErrorResponseMeta.md)
 - [ErrorResponseMetaStatus](docs/ErrorResponseMetaStatus.md)
 - [InlineResponse200](docs/InlineResponse200.md)
 - [InlineResponse200Meta](docs/InlineResponse200Meta.md)
 - [PostCompanyLogoRequest](docs/PostCompanyLogoRequest.md)
 - [PostCompanyLogoRequestData](docs/PostCompanyLogoRequestData.md)
 - [PostCompanyLogoRequestDataIdentifier](docs/PostCompanyLogoRequestDataIdentifier.md)
 - [PostCompanyLogoRequestDataSize](docs/PostCompanyLogoRequestDataSize.md)
 - [PostCompanyLogoRequestDataSizeCustom](docs/PostCompanyLogoRequestDataSizeCustom.md)
 - [PostCompanyLogoRequestMeta](docs/PostCompanyLogoRequestMeta.md)
