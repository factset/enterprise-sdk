...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/companylogo/0.20.1)](https://central.sonatype.com/artifact/com.factset.sdk/companylogo/0.20.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:companylogo:0.20.1"
  }
```
