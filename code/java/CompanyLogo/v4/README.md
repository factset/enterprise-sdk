...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/companylogo/0.20.3)](https://central.sonatype.com/artifact/com.factset.sdk/companylogo/0.20.3)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:companylogo:0.20.3"
  }
```
...
------------ | ------------- | ------------- | -------------
*CompanyApi* | [**getCompanyLogoGet**](docs/CompanyApi.md#getCompanyLogoGet) | **GET** /company/logo | List of URLs of company logos.
