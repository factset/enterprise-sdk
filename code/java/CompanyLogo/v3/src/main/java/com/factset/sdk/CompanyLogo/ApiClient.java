...
import com.factset.sdk.CompanyLogo.auth.Authentication;
import com.factset.sdk.CompanyLogo.auth.HttpBasicAuth;
import com.factset.sdk.CompanyLogo.auth.HttpBearerAuth;
import com.factset.sdk.CompanyLogo.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.CompanyLogo.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/CompanyLogo/0.12.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.CompanyLogo.ApiClient} object.
   */
