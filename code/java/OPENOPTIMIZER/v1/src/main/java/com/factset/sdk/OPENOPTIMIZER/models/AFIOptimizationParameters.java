...
import com.factset.sdk.OPENOPTIMIZER.models.AFIAccountInput;
import com.factset.sdk.OPENOPTIMIZER.models.AFIOptimizerStrategyInput;
...
public class AFIOptimizationParameters implements Serializable {
  ...
  private AFIAccountInput account;

  public static final String JSON_PROPERTY_STRATEGY = "strategy";
  private AFIOptimizerStrategyInput strategy;
  ...
  @JsonCreator
  public AFIOptimizationParameters(
    @JsonProperty(value=JSON_PROPERTY_STRATEGY, required=true) AFIOptimizerStrategyInput strategy, 
  ...
  public AFIOptimizationParameters account(AFIAccountInput account) {
  ...
  **/
  ...
  public AFIAccountInput getAccount() {
    return account;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACCOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAccount(AFIAccountInput account) {
    this.account = account;
  }


  public AFIOptimizationParameters strategy(AFIOptimizerStrategyInput strategy) {
    this.strategy = strategy;
    return this;
  }
  ...
  **/
  ...
  public AFIOptimizerStrategyInput getStrategy() {
    return strategy;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STRATEGY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setStrategy(AFIOptimizerStrategyInput strategy) {
    this.strategy = strategy;
  }


  public AFIOptimizationParameters optimization(OptimizationInput optimization) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, afIOptimizationParameters.account) &&
        Objects.equals(this.strategy, afIOptimizationParameters.strategy) &&
