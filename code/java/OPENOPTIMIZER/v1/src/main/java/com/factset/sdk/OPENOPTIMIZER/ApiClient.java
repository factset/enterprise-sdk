...
import com.factset.sdk.OPENOPTIMIZER.auth.Authentication;
import com.factset.sdk.OPENOPTIMIZER.auth.HttpBasicAuth;
import com.factset.sdk.OPENOPTIMIZER.auth.HttpBearerAuth;
import com.factset.sdk.OPENOPTIMIZER.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.OPENOPTIMIZER.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/open-optimizer/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/open-optimizer/v1",
      "Production",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/OPENOPTIMIZER/0.0.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.OPENOPTIMIZER.ApiClient} object.
   */
