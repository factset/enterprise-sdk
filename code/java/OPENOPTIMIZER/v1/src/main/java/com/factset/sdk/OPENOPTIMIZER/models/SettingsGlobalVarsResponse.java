 ...
 */
@JsonPropertyOrder({
  SettingsGlobalVarsResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class SettingsGlobalVarsResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.Map<String, String> data = null;

  public SettingsGlobalVarsResponse() { 
  }

  public SettingsGlobalVarsResponse data(java.util.Map<String, String> data) {
    this.data = data;
    return this;
  }

  public SettingsGlobalVarsResponse putDataItem(String key, String dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(example = "{\"PORTFOLIO\":\"Client:/Folder1/Account1.OFDB\",\"ALPHAX\":\"AVAIL(ML_YTM(#ED),P_PRICE(#ED))\"}", value = "")
  ...
  /**
   * Return true if this SettingsGlobalVarsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SettingsGlobalVarsResponse settingsGlobalVarsResponse = (SettingsGlobalVarsResponse) o;
    return Objects.equals(this.data, settingsGlobalVarsResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsGlobalVarsResponse {\n");
