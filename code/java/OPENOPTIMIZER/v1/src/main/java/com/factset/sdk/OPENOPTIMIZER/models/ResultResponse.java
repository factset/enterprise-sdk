...
import com.factset.sdk.OPENOPTIMIZER.models.ResultResponseData;
 ...
 */
@JsonPropertyOrder({
  ResultResponse.JSON_PROPERTY_DATA
})
...
public class ResultResponse implements Serializable {
  ...
  private ResultResponseData data;
  ...
  @JsonCreator
  public ResultResponse(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) ResultResponseData data
  ) {
    this();
    this.data = data;
  }

  public ResultResponse data(ResultResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(ResultResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this ResultResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, resultResponse.data);
  }
