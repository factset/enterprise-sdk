...
import com.factset.sdk.OPENOPTIMIZER.models.AFIOptimizationParametersRequest;
...
public class AxiomaFixedIncomePortfolioOptimizerApi {
  private ApiClient apiClient;

  public AxiomaFixedIncomePortfolioOptimizerApi() {
    this(Configuration.getDefaultApiClient());
  }

  public AxiomaFixedIncomePortfolioOptimizerApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> getGlobalVariablesAFIResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getGlobalVariablesAFIResponseTypeMap.put(200, new GenericType<SettingsGlobalVarsResponse>(){});
    getGlobalVariablesAFIResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    getGlobalVariablesAFIResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getOptimizationResultByIdAFIResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getOptimizationResultByIdAFIResponseTypeMap.put(200, new GenericType<ResultResponse>(){});
    getOptimizationResultByIdAFIResponseTypeMap.put(202, new GenericType<OptimizationStatus>(){});
    getOptimizationResultByIdAFIResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    getOptimizationResultByIdAFIResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getOptimizationStatusByIdAFIResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getOptimizationStatusByIdAFIResponseTypeMap.put(201, new GenericType<OptimizationStatus>(){});
    getOptimizationStatusByIdAFIResponseTypeMap.put(202, new GenericType<OptimizationStatus>(){});
    getOptimizationStatusByIdAFIResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    getOptimizationStatusByIdAFIResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> postAndOptimizeAFIResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    postAndOptimizeAFIResponseTypeMap.put(202, new GenericType<OptimizationStatus>(){});
    postAndOptimizeAFIResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    postAndOptimizeAFIResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> postComponentsAFIResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    postComponentsAFIResponseTypeMap.put(200, new GenericType<AvailableComponentsResponse>(){});
    postComponentsAFIResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> postStrategiesAFIResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    postStrategiesAFIResponseTypeMap.put(200, new GenericType<AvailableStrategiesResponse>(){});
    postStrategiesAFIResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }
   ...
   */
  public SettingsGlobalVarsResponse getGlobalVariablesAFI(String cacheControl) throws ApiException {
    return getGlobalVariablesAFIWithHttpInfo(cacheControl).getData();
  }
   ...
   */
  public ApiResponse<SettingsGlobalVarsResponse> getGlobalVariablesAFIWithHttpInfo(String cacheControl) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/afi/settings/global-variables";
    ...
    > apiResponse = apiClient.invokeAPI("AxiomaFixedIncomePortfolioOptimizerApi.getGlobalVariablesAFI", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getGlobalVariablesAFIResponseTypeMap, false);
   ...
   */
  public ResultResponse getOptimizationResultByIdAFI(String id) throws ApiException {
    return getOptimizationResultByIdAFIWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<ResultResponse> getOptimizationResultByIdAFIWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getOptimizationResultByIdAFI");
    }
    
    // create path and map variables
    String localVarPath = "/afi/{id}"
    ...
    > apiResponse = apiClient.invokeAPI("AxiomaFixedIncomePortfolioOptimizerApi.getOptimizationResultByIdAFI", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getOptimizationResultByIdAFIResponseTypeMap, false);
   ...
   */
  public OptimizationStatus getOptimizationStatusByIdAFI(String id) throws ApiException {
    return getOptimizationStatusByIdAFIWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<OptimizationStatus> getOptimizationStatusByIdAFIWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getOptimizationStatusByIdAFI");
    }
    
    // create path and map variables
    String localVarPath = "/afi/{id}/status"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    > apiResponse = apiClient.invokeAPI("AxiomaFixedIncomePortfolioOptimizerApi.getOptimizationStatusByIdAFI", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getOptimizationStatusByIdAFIResponseTypeMap, false);
   ...
   * @param cacheControl Standard HTTP header.  Accepts max-stale. (optional)
   * @param afIOptimizationParametersRequest Optimization Parameters (optional)
   * @return OptimizationStatus
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public OptimizationStatus postAndOptimizeAFI(String cacheControl, AFIOptimizationParametersRequest afIOptimizationParametersRequest) throws ApiException {
    return postAndOptimizeAFIWithHttpInfo(cacheControl, afIOptimizationParametersRequest).getData();
  }
   ...
   */
  public ApiResponse<OptimizationStatus> postAndOptimizeAFIWithHttpInfo(String cacheControl, AFIOptimizationParametersRequest afIOptimizationParametersRequest) throws ApiException {
    Object localVarPostBody = afIOptimizationParametersRequest;
    
    // create path and map variables
    String localVarPath = "/afi/optimize";
    ...
    > apiResponse = apiClient.invokeAPI("AxiomaFixedIncomePortfolioOptimizerApi.postAndOptimizeAFI", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, postAndOptimizeAFIResponseTypeMap, false);
   ...
   */
  public AvailableComponentsResponse postComponentsAFI(AXPAvailableComponentsInput axPAvailableComponentsInput) throws ApiException {
    return postComponentsAFIWithHttpInfo(axPAvailableComponentsInput).getData();
  }
   ...
   */
  public ApiResponse<AvailableComponentsResponse> postComponentsAFIWithHttpInfo(AXPAvailableComponentsInput axPAvailableComponentsInput) throws ApiException {
    Object localVarPostBody = axPAvailableComponentsInput;
    
    // create path and map variables
    String localVarPath = "/afi/settings/components";
    ...
    > apiResponse = apiClient.invokeAPI("AxiomaFixedIncomePortfolioOptimizerApi.postComponentsAFI", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, postComponentsAFIResponseTypeMap, false);
   ...
   */
  public AvailableStrategiesResponse postStrategiesAFI(String cacheControl, AvailableStrategiesInput availableStrategiesInput) throws ApiException {
    return postStrategiesAFIWithHttpInfo(cacheControl, availableStrategiesInput).getData();
  }
   ...
   */
  public ApiResponse<AvailableStrategiesResponse> postStrategiesAFIWithHttpInfo(String cacheControl, AvailableStrategiesInput availableStrategiesInput) throws ApiException {
    Object localVarPostBody = availableStrategiesInput;
    
    // create path and map variables
    String localVarPath = "/afi/settings/strategies";
    ...
    > apiResponse = apiClient.invokeAPI("AxiomaFixedIncomePortfolioOptimizerApi.postStrategiesAFI", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, postStrategiesAFIResponseTypeMap, false);
