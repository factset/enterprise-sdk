...
import com.factset.sdk.OPENOPTIMIZER.models.FPOAvailableComponentsInput;
import com.factset.sdk.OPENOPTIMIZER.models.FPOOptimizationParametersRequest;
...
public class FactSetPortfolioOptimizerApi {
  private ApiClient apiClient;

  public FactSetPortfolioOptimizerApi() {
    this(Configuration.getDefaultApiClient());
  }

  public FactSetPortfolioOptimizerApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }
  
  private static final Map<Integer, GenericType> cancelOptimizationByIdFPOResponseTypeMap = new HashMap<Integer, GenericType>();

  private static final Map<Integer, GenericType> getGlobalVariablesFPOResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getGlobalVariablesFPOResponseTypeMap.put(200, new GenericType<SettingsGlobalVarsResponse>(){});
    getGlobalVariablesFPOResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    getGlobalVariablesFPOResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getOptimizationResultByIdFPOResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getOptimizationResultByIdFPOResponseTypeMap.put(200, new GenericType<ResultResponse>(){});
    getOptimizationResultByIdFPOResponseTypeMap.put(202, new GenericType<OptimizationStatus>(){});
    getOptimizationResultByIdFPOResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    getOptimizationResultByIdFPOResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> getOptimizationStatusByIdFPOResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getOptimizationStatusByIdFPOResponseTypeMap.put(201, new GenericType<OptimizationStatus>(){});
    getOptimizationStatusByIdFPOResponseTypeMap.put(202, new GenericType<OptimizationStatus>(){});
    getOptimizationStatusByIdFPOResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    getOptimizationStatusByIdFPOResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> postAndOptimizeResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    postAndOptimizeResponseTypeMap.put(202, new GenericType<OptimizationStatus>(){});
    postAndOptimizeResponseTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
    postAndOptimizeResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> postComponentsFPOResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    postComponentsFPOResponseTypeMap.put(200, new GenericType<AvailableComponentsResponse>(){});
    postComponentsFPOResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }

  private static final Map<Integer, GenericType> postStrategiesFPOResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    postStrategiesFPOResponseTypeMap.put(200, new GenericType<AvailableStrategiesResponse>(){});
    postStrategiesFPOResponseTypeMap.put(417, new GenericType<ClientErrorResponse>(){});
  }
   ...
   * @param id from url, provided from the location header in the Run Optimization endpoint (required)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 204 </td><td> Expected response, optimization was canceled successfully. </td><td>  * X-DataDirect-Request-Key -  <br>  * X-RateLimit-Limit-minute -  <br>  * X-RateLimit-Remaining-minute -  <br>  * X-RateLimit-Limit-second -  <br>  * X-RateLimit-Remaining-second -  <br>  * RateLimit-Limit -  <br>  * RateLimit-Reset -  <br>  </td></tr>
       ...
       <tr><td> 404 </td><td> There was no request for the optimization identifier provided, or the request was already canceled for the provided identifier. </td><td>  * X-DataDirect-Request-Key -  <br>  * X-RateLimit-Limit-minute -  <br>  * X-RateLimit-Remaining-minute -  <br>  * X-RateLimit-Limit-second -  <br>  * X-RateLimit-Remaining-second -  <br>  * RateLimit-Limit -  <br>  * RateLimit-Reset -  <br>  </td></tr>
   ...
   */
  public void cancelOptimizationByIdFPO(String id) throws ApiException {
   ...
   */
  public ApiResponse<Void> cancelOptimizationByIdFPOWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling cancelOptimizationByIdFPO");
    }
    
    // create path and map variables
    String localVarPath = "/fpo/{id}"
    ...
    ApiResponse<
      Void
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.cancelOptimizationByIdFPO", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, cancelOptimizationByIdFPOResponseTypeMap, false);
   ...
   */
  public SettingsGlobalVarsResponse getGlobalVariablesFPO(String cacheControl) throws ApiException {
    return getGlobalVariablesFPOWithHttpInfo(cacheControl).getData();
  }
   ...
   */
  public ApiResponse<SettingsGlobalVarsResponse> getGlobalVariablesFPOWithHttpInfo(String cacheControl) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/fpo/settings/global-variables";
    ...
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.getGlobalVariablesFPO", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getGlobalVariablesFPOResponseTypeMap, false);
   ...
   */
  public ResultResponse getOptimizationResultByIdFPO(String id) throws ApiException {
    return getOptimizationResultByIdFPOWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<ResultResponse> getOptimizationResultByIdFPOWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getOptimizationResultByIdFPO");
    }
    ...
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.getOptimizationResultByIdFPO", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getOptimizationResultByIdFPOResponseTypeMap, false);
   ...
   */
  public OptimizationStatus getOptimizationStatusByIdFPO(String id) throws ApiException {
    return getOptimizationStatusByIdFPOWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<OptimizationStatus> getOptimizationStatusByIdFPOWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getOptimizationStatusByIdFPO");
    }
    
    // create path and map variables
    String localVarPath = "/fpo/{id}/status"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.getOptimizationStatusByIdFPO", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, getOptimizationStatusByIdFPOResponseTypeMap, false);
   ...
   * @param cacheControl Standard HTTP header.  Accepts max-stale. (optional)
   * @param fpOOptimizationParametersRequest Optimization Parameters (optional)
   * @return OptimizationStatus
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   */
  public OptimizationStatus postAndOptimize(String cacheControl, FPOOptimizationParametersRequest fpOOptimizationParametersRequest) throws ApiException {
    return postAndOptimizeWithHttpInfo(cacheControl, fpOOptimizationParametersRequest).getData();
  }
   ...
   */
  public ApiResponse<OptimizationStatus> postAndOptimizeWithHttpInfo(String cacheControl, FPOOptimizationParametersRequest fpOOptimizationParametersRequest) throws ApiException {
    Object localVarPostBody = fpOOptimizationParametersRequest;
    
    // create path and map variables
    String localVarPath = "/fpo/optimize";
    ...
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.postAndOptimize", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   * @param fpOAvailableComponentsInput  (optional)
   ...
   */
  public AvailableComponentsResponse postComponentsFPO(FPOAvailableComponentsInput fpOAvailableComponentsInput) throws ApiException {
    return postComponentsFPOWithHttpInfo(fpOAvailableComponentsInput).getData();
  }
   ...
   */
  public ApiResponse<AvailableComponentsResponse> postComponentsFPOWithHttpInfo(FPOAvailableComponentsInput fpOAvailableComponentsInput) throws ApiException {
    Object localVarPostBody = fpOAvailableComponentsInput;
    
    // create path and map variables
    String localVarPath = "/fpo/settings/components";
    ...
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.postComponentsFPO", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, postComponentsFPOResponseTypeMap, false);
   ...
   */
  public AvailableStrategiesResponse postStrategiesFPO(String cacheControl, AvailableStrategiesInput availableStrategiesInput) throws ApiException {
    return postStrategiesFPOWithHttpInfo(cacheControl, availableStrategiesInput).getData();
  }
   ...
   */
  public ApiResponse<AvailableStrategiesResponse> postStrategiesFPOWithHttpInfo(String cacheControl, AvailableStrategiesInput availableStrategiesInput) throws ApiException {
    Object localVarPostBody = availableStrategiesInput;
    
    // create path and map variables
    String localVarPath = "/fpo/settings/strategies";
    ...
    > apiResponse = apiClient.invokeAPI("FactSetPortfolioOptimizerApi.postStrategiesFPO", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, postStrategiesFPOResponseTypeMap, false);
