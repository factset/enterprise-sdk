 ...
 */
@JsonPropertyOrder({
  AvailableStrategiesResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class AvailableStrategiesResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private java.util.Map<String, java.util.List<String>> data = null;

  public AvailableStrategiesResponse() { 
  }

  public AvailableStrategiesResponse data(java.util.Map<String, java.util.List<String>> data) {
    this.data = data;
    return this;
  }

  public AvailableStrategiesResponse putDataItem(String key, java.util.List<String> dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(example = "{\"Client:/folder1/subfolder1/\":[\"Cash_Flow\",\"Factor_Testing\"],\"Personal:/\":[\"Position_Limit\",\"FNG_Test\"]}", value = "")
  ...
  /**
   * Return true if this AvailableStrategiesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AvailableStrategiesResponse availableStrategiesResponse = (AvailableStrategiesResponse) o;
    return Objects.equals(this.data, availableStrategiesResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailableStrategiesResponse {\n");
