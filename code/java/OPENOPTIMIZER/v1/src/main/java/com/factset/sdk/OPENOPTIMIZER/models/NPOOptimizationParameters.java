...
import com.factset.sdk.OPENOPTIMIZER.models.NPOAccountInput;
import com.factset.sdk.OPENOPTIMIZER.models.NPOOptimizerStrategyInput;
...
public class NPOOptimizationParameters implements Serializable {
  ...
  private NPOAccountInput account;

  public static final String JSON_PROPERTY_STRATEGY = "strategy";
  private NPOOptimizerStrategyInput strategy;
  ...
  @JsonCreator
  public NPOOptimizationParameters(
    @JsonProperty(value=JSON_PROPERTY_STRATEGY, required=true) NPOOptimizerStrategyInput strategy, 
  ...
  public NPOOptimizationParameters account(NPOAccountInput account) {
  ...
  **/
  ...
  public NPOAccountInput getAccount() {
    return account;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACCOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAccount(NPOAccountInput account) {
    this.account = account;
  }


  public NPOOptimizationParameters strategy(NPOOptimizerStrategyInput strategy) {
    this.strategy = strategy;
    return this;
  }
  ...
  **/
  ...
  public NPOOptimizerStrategyInput getStrategy() {
    return strategy;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STRATEGY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setStrategy(NPOOptimizerStrategyInput strategy) {
    this.strategy = strategy;
  }


  public NPOOptimizationParameters optimization(OptimizationInput optimization) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, npOOptimizationParameters.account) &&
        Objects.equals(this.strategy, npOOptimizationParameters.strategy) &&
