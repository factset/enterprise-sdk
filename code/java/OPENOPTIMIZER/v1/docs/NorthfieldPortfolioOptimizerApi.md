...
> SettingsGlobalVarsResponse getGlobalVariablesNPO(cacheControl)
...
import com.factset.sdk.OPENOPTIMIZER.api.NorthfieldPortfolioOptimizerApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        NorthfieldPortfolioOptimizerApi apiInstance = new NorthfieldPortfolioOptimizerApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling NorthfieldPortfolioOptimizerApi#getGlobalVariablesNPO");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling NorthfieldPortfolioOptimizerApi#getOptimizationResultByIdNPO");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
If the optimization has finished computing, a 201 is returned and the result can be fetched using /npo/{id} endpoint. 
Otherwise, the optimization is still running and the body of the response will contain a detailed status in JSON besides its pickup id.
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling NorthfieldPortfolioOptimizerApi#getOptimizationStatusByIdNPO");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> OptimizationStatus postAndOptimizeNPO(cacheControl, npOOptimizationParametersRequest)

Create and Run NPO optimization

This endpoint runs NPO optimization specified in the POST body parameters.
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        NorthfieldPortfolioOptimizerApi apiInstance = new NorthfieldPortfolioOptimizerApi(defaultClient);
        String cacheControl = "cacheControl_example"; // String | Standard HTTP header.  Accepts max-stale.
        NPOOptimizationParametersRequest npOOptimizationParametersRequest = new NPOOptimizationParametersRequest(); // NPOOptimizationParametersRequest | Optimization Parameters
        try {
            OptimizationStatus result = apiInstance.postAndOptimizeNPO(cacheControl, npOOptimizationParametersRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling NorthfieldPortfolioOptimizerApi#postAndOptimizeNPO");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> AvailableComponentsResponse postComponentsNPO(bpMNPOAvailableComponentsInput)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling NorthfieldPortfolioOptimizerApi#postComponentsNPO");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> AvailableStrategiesResponse postStrategiesNPO(cacheControl, availableStrategiesInput)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling NorthfieldPortfolioOptimizerApi#postStrategiesNPO");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
