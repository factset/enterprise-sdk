...
> SettingsGlobalVarsResponse getGlobalVariablesBPM(cacheControl)
...
import com.factset.sdk.OPENOPTIMIZER.api.BarraPortfolioOptimizerApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        BarraPortfolioOptimizerApi apiInstance = new BarraPortfolioOptimizerApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling BarraPortfolioOptimizerApi#getGlobalVariablesBPM");
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling BarraPortfolioOptimizerApi#getOptimizationResultByIdBPM");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
If the optimization has finished computing, a 201 is returned and the result can be fetched using /bpm/{id} endpoint. 
Otherwise, the optimization is still running and the body of the response will contain a detailed status in JSON besides its pickup id.
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling BarraPortfolioOptimizerApi#getOptimizationStatusByIdBPM");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> OptimizationStatus postAndOptimizeBPM(cacheControl, bpMOptimizationParametersRequest)

Create and Run BPM optimization

This endpoint runs BPM optimization specified in the POST body parameters.
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        BarraPortfolioOptimizerApi apiInstance = new BarraPortfolioOptimizerApi(defaultClient);
        String cacheControl = "cacheControl_example"; // String | Standard HTTP header.  Accepts max-stale.
        BPMOptimizationParametersRequest bpMOptimizationParametersRequest = new BPMOptimizationParametersRequest(); // BPMOptimizationParametersRequest | Optimization Parameters
        try {
            OptimizationStatus result = apiInstance.postAndOptimizeBPM(cacheControl, bpMOptimizationParametersRequest);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling BarraPortfolioOptimizerApi#postAndOptimizeBPM");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> AvailableComponentsResponse postComponentsBPM(bpMNPOAvailableComponentsInput)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        BarraPortfolioOptimizerApi apiInstance = new BarraPortfolioOptimizerApi(defaultClient);
        BPMNPOAvailableComponentsInput bpMNPOAvailableComponentsInput = new BPMNPOAvailableComponentsInput(); // BPMNPOAvailableComponentsInput | 
        try {
            AvailableComponentsResponse result = apiInstance.postComponentsBPM(bpMNPOAvailableComponentsInput);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling BarraPortfolioOptimizerApi#postComponentsBPM");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> AvailableStrategiesResponse postStrategiesBPM(cacheControl, availableStrategiesInput)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Exception when calling BarraPortfolioOptimizerApi#postStrategiesBPM");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
