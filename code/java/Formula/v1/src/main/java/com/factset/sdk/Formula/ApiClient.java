...
import com.factset.sdk.Formula.auth.Authentication;
import com.factset.sdk.Formula.auth.HttpBasicAuth;
import com.factset.sdk.Formula.auth.HttpBearerAuth;
import com.factset.sdk.Formula.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.Formula.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/formula-api/v1";
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/Formula/5.0.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.Formula.ApiClient} object.
   */
