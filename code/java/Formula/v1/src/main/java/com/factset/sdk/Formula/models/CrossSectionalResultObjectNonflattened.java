...
public class CrossSectionalResultObjectNonflattened implements Serializable {
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Data item error indicator.  * Zero - success  * Non-zero - failure ")
  ...
  **/
  ...
  /**
   * Return true if this CrossSectionalResultObjectNonflattened object is equal to o.
   */
  @Override
