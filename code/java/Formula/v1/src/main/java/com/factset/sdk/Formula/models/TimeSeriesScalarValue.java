...
public class TimeSeriesScalarValue extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class TimeSeriesScalarValueDeserializer extends StdDeserializer<TimeSeriesScalarValue> {
        ...
        public TimeSeriesScalarValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(LocalDate.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
    ...
    public TimeSeriesScalarValue(LocalDate o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
     ...
     * Double, Integer, LocalDate, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Double, Integer, LocalDate, String");
    }
     ...
     * Double, Integer, LocalDate, String
     *
     * @return The actual instance (Double, Integer, LocalDate, String)
     */
    @Override
