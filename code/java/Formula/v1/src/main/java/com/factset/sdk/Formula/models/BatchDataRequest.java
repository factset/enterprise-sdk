...
import com.factset.sdk.Formula.models.BatchDataRequestData;
 ...
 */
@JsonPropertyOrder({
  BatchDataRequest.JSON_PROPERTY_DATA
})
...
public class BatchDataRequest implements Serializable {
  ...
  private BatchDataRequestData data;
  ...
  @JsonCreator
  public BatchDataRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) BatchDataRequestData data
  ) {
    this();
    this.data = data;
  }

  public BatchDataRequest data(BatchDataRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public BatchDataRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(BatchDataRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, batchDataRequest.data);
  }
