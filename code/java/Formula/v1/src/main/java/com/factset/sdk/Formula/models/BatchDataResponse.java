...
public class BatchDataResponse implements Serializable {
  ...
  private java.util.List<BatchData> data = null;

  public BatchDataResponse() { 
  }

  public BatchDataResponse data(java.util.List<BatchData> data) {
    this.data = data;
    return this;
  }

  public BatchDataResponse addDataItem(BatchData dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public java.util.List<BatchData> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(java.util.List<BatchData> data) {
    this.data = data;
  }
