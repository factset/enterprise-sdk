...
@JsonDeserialize(using = CrossSectionalResultObjectFlattenedAddl.CrossSectionalResultObjectFlattenedAddlDeserializer.class)
@JsonSerialize(using = CrossSectionalResultObjectFlattenedAddl.CrossSectionalResultObjectFlattenedAddlSerializer.class)
public class CrossSectionalResultObjectFlattenedAddl extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(CrossSectionalResultObjectFlattenedAddl.class.getName());

    public static class CrossSectionalResultObjectFlattenedAddlSerializer extends StdSerializer<CrossSectionalResultObjectFlattenedAddl> {
        public CrossSectionalResultObjectFlattenedAddlSerializer(Class<CrossSectionalResultObjectFlattenedAddl> t) {
            super(t);
        }

        public CrossSectionalResultObjectFlattenedAddlSerializer() {
            this(null);
        }

        @Override
        public void serialize(CrossSectionalResultObjectFlattenedAddl value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CrossSectionalResultObjectFlattenedAddlDeserializer extends StdDeserializer<CrossSectionalResultObjectFlattenedAddl> {
        public CrossSectionalResultObjectFlattenedAddlDeserializer() {
            this(CrossSectionalResultObjectFlattenedAddl.class);
        }

        public CrossSectionalResultObjectFlattenedAddlDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CrossSectionalResultObjectFlattenedAddl deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                CrossSectionalResultObjectFlattenedAddl ret = new CrossSectionalResultObjectFlattenedAddl();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for CrossSectionalResultObjectFlattenedAddl: %d classes match result, expected 1", match));
        }
    ...
    public CrossSectionalResultObjectFlattenedAddl(Double o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    public CrossSectionalResultObjectFlattenedAddl(Integer o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(CrossSectionalResultObjectFlattenedAddl.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return CrossSectionalResultObjectFlattenedAddl.schemas;
    }
