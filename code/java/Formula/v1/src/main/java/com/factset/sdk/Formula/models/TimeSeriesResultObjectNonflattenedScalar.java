 ...
 */
@JsonPropertyOrder({
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_RESULT,
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_ERROR,
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_ERROR_MESSAGE,
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_FORMULA,
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_DISPLAY_NAME,
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_REQUEST_ID,
  TimeSeriesResultObjectNonflattenedScalar.JSON_PROPERTY_FSYM_ID,
...
public class TimeSeriesResultObjectNonflattenedScalar implements Serializable {
  ...
  private JsonNullable<TimeSeriesScalarValue> result = JsonNullable.<TimeSeriesScalarValue>undefined();
  ...
  public TimeSeriesResultObjectNonflattenedScalar() { 
  }
  ...
  public TimeSeriesResultObjectNonflattenedScalar result(TimeSeriesScalarValue result) {
    this.result = JsonNullable.<TimeSeriesScalarValue>of(result);
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesScalarValue getResult() {
  ...
  public JsonNullable<TimeSeriesScalarValue> getResult_JsonNullable() {
    return result;
  }
  
  @JsonProperty(JSON_PROPERTY_RESULT)
  public void setResult_JsonNullable(JsonNullable<TimeSeriesScalarValue> result) {
    this.result = result;
  }

  public void setResult(TimeSeriesScalarValue result) {
    this.result = JsonNullable.<TimeSeriesScalarValue>of(result);
  }


  public TimeSeriesResultObjectNonflattenedScalar error(Integer error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar errorMessage(String errorMessage) {
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar formula(String formula) {
    this.formula = formula;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar displayName(String displayName) {
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar fsymId(String fsymId) {
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar dataType(DataTypeEnum dataType) {
    this.dataType = dataType;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedScalar objectType(ObjectTypeEnum objectType) {
    this.objectType = objectType;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this time_series_result_object_nonflattened_scalar object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeSeriesResultObjectNonflattenedScalar timeSeriesResultObjectNonflattenedScalar = (TimeSeriesResultObjectNonflattenedScalar) o;
    return equalsNullable(this.result, timeSeriesResultObjectNonflattenedScalar.result) &&
        Objects.equals(this.error, timeSeriesResultObjectNonflattenedScalar.error) &&
        equalsNullable(this.errorMessage, timeSeriesResultObjectNonflattenedScalar.errorMessage) &&
        Objects.equals(this.formula, timeSeriesResultObjectNonflattenedScalar.formula) &&
        equalsNullable(this.displayName, timeSeriesResultObjectNonflattenedScalar.displayName) &&
        Objects.equals(this.requestId, timeSeriesResultObjectNonflattenedScalar.requestId) &&
        equalsNullable(this.fsymId, timeSeriesResultObjectNonflattenedScalar.fsymId) &&
        Objects.equals(this.dataType, timeSeriesResultObjectNonflattenedScalar.dataType) &&
        Objects.equals(this.objectType, timeSeriesResultObjectNonflattenedScalar.objectType);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(result), error, hashCodeNullable(errorMessage), formula, hashCodeNullable(displayName), requestId, hashCodeNullable(fsymId), dataType, objectType);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeSeriesResultObjectNonflattenedScalar {\n");
