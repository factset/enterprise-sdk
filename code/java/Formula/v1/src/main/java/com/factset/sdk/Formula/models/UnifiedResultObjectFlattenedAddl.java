...
@JsonDeserialize(using = UnifiedResultObjectFlattenedAddl.UnifiedResultObjectFlattenedAddlDeserializer.class)
@JsonSerialize(using = UnifiedResultObjectFlattenedAddl.UnifiedResultObjectFlattenedAddlSerializer.class)
public class UnifiedResultObjectFlattenedAddl extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(UnifiedResultObjectFlattenedAddl.class.getName());

    public static class UnifiedResultObjectFlattenedAddlSerializer extends StdSerializer<UnifiedResultObjectFlattenedAddl> {
        public UnifiedResultObjectFlattenedAddlSerializer(Class<UnifiedResultObjectFlattenedAddl> t) {
            super(t);
        }

        public UnifiedResultObjectFlattenedAddlSerializer() {
            this(null);
        }

        @Override
        public void serialize(UnifiedResultObjectFlattenedAddl value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class UnifiedResultObjectFlattenedAddlDeserializer extends StdDeserializer<UnifiedResultObjectFlattenedAddl> {
        public UnifiedResultObjectFlattenedAddlDeserializer() {
            this(UnifiedResultObjectFlattenedAddl.class);
        }

        public UnifiedResultObjectFlattenedAddlDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public UnifiedResultObjectFlattenedAddl deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                UnifiedResultObjectFlattenedAddl ret = new UnifiedResultObjectFlattenedAddl();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for UnifiedResultObjectFlattenedAddl: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public UnifiedResultObjectFlattenedAddl getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public UnifiedResultObjectFlattenedAddl(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public UnifiedResultObjectFlattenedAddl(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public UnifiedResultObjectFlattenedAddl(Integer o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(UnifiedResultObjectFlattenedAddl.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return UnifiedResultObjectFlattenedAddl.schemas;
    }
