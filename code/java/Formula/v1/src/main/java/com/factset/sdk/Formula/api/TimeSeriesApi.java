...
public class TimeSeriesApi {
  ...
  static {
    ...
    getTimeSeriesDataResponseTypeMap.put(429, new GenericType<Object>(){});
  ...
  static {
    ...
    getTimeSeriesDataForListResponseTypeMap.put(429, new GenericType<Object>(){});
 ...
 /**
   ...
   * @param ids List of entity identifiers.  The &#x60;ids&#x60; and &#x60;universe&#x60; parameters provide two different ways to specify the identifiers for which you want data retrieved. Please enter either the &#x60;ids&#x60; or &#x60;universe&#x60; parameter.  (optional)
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 408 </td><td> Request Timeout. This error may be returned if it takes more than 29 seconds for the request to process or if a batch request takes more than 10 minutes to process. </td><td>  * api-version -  <br>  * api-supported-versions -  <br>  * api-deprecated-versions -  <br>  * chain-id -  <br>  </td></tr>
   ...
   */
  public GetTimeSeriesDataResponseWrapper getTimeSeriesData(java.util.List<String> formulas, java.util.List<String> ids, String universe, String universeType, String calendar, String fsymId, java.util.List<String> displayName, String flatten, String batch) throws ApiException {
    return getTimeSeriesDataWithHttpInfo(formulas, ids, universe, universeType, calendar, fsymId, displayName, flatten, batch).getData();
  }
   ...
   */
  public ApiResponse<GetTimeSeriesDataResponseWrapper> getTimeSeriesDataWithHttpInfo(java.util.List<String> formulas, java.util.List<String> ids, String universe, String universeType, String calendar, String fsymId, java.util.List<String> displayName, String flatten, String batch) throws ApiException {
    ...
    String localVarPath = "/v1/time-series";
