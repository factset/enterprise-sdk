 ...
 */
@ApiModel(description = "The `result` attribute in the Time-Series Non-Flattened Response Object will be an ARRAY.")
@JsonPropertyOrder({
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_RESULT,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_ERROR,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_ERROR_MESSAGE,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_FORMULA,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_DISPLAY_NAME,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_REQUEST_ID,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_FSYM_ID,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_DATA_TYPE,
  TimeSeriesResultObjectNonflattenedArray.JSON_PROPERTY_OBJECT_TYPE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class TimeSeriesResultObjectNonflattenedArray implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_RESULT = "result";
  private java.util.List<TimeSeriesScalarValue> result = null;
  ...
  public TimeSeriesResultObjectNonflattenedArray() { 
  }
  ...
  public TimeSeriesResultObjectNonflattenedArray result(java.util.List<TimeSeriesScalarValue> result) {
    this.result = result;
    return this;
  }

  public TimeSeriesResultObjectNonflattenedArray addResultItem(TimeSeriesScalarValue resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public java.util.List<TimeSeriesScalarValue> getResult() {
    return result;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResult(java.util.List<TimeSeriesScalarValue> result) {
    this.result = result;
  }


  public TimeSeriesResultObjectNonflattenedArray error(Integer error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray errorMessage(String errorMessage) {
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray formula(String formula) {
    this.formula = formula;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray displayName(String displayName) {
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray fsymId(String fsymId) {
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray dataType(DataTypeEnum dataType) {
    this.dataType = dataType;
    return this;
  }
  ...
  **/
  ...
  public TimeSeriesResultObjectNonflattenedArray objectType(ObjectTypeEnum objectType) {
    this.objectType = objectType;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this time_series_result_object_nonflattened_array object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeSeriesResultObjectNonflattenedArray timeSeriesResultObjectNonflattenedArray = (TimeSeriesResultObjectNonflattenedArray) o;
    return Objects.equals(this.result, timeSeriesResultObjectNonflattenedArray.result) &&
        Objects.equals(this.error, timeSeriesResultObjectNonflattenedArray.error) &&
        equalsNullable(this.errorMessage, timeSeriesResultObjectNonflattenedArray.errorMessage) &&
        Objects.equals(this.formula, timeSeriesResultObjectNonflattenedArray.formula) &&
        equalsNullable(this.displayName, timeSeriesResultObjectNonflattenedArray.displayName) &&
        Objects.equals(this.requestId, timeSeriesResultObjectNonflattenedArray.requestId) &&
        equalsNullable(this.fsymId, timeSeriesResultObjectNonflattenedArray.fsymId) &&
        Objects.equals(this.dataType, timeSeriesResultObjectNonflattenedArray.dataType) &&
        Objects.equals(this.objectType, timeSeriesResultObjectNonflattenedArray.objectType);
  }
