 ...
 */
@JsonPropertyOrder({
  BatchList.JSON_PROPERTY_ID,
  BatchList.JSON_PROPERTY_STATUS,
  BatchList.JSON_PROPERTY_ERROR,
  BatchList.JSON_PROPERTY_EXPIRATION
})
...
public class BatchList implements Serializable {
  ...
  public BatchList id(java.util.UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "cdc42135-a9b8-4fd8-9d69-73cea0c23105", value = "the id of batch request.")
  ...
  public BatchList status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "EXECUTING", value = "")
  ...
  public BatchList error(String error) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "The expression entered for the universe parameter is invalid.", value = "Error message.")
  @JsonIgnore
  ...
  public BatchList expiration(OffsetDateTime expiration) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "2024-09-03T09:02:15.529317Z", value = "Time when the batch request will expire, which is 48 hours after the batch is complete. This is in UTC Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SS], following ISO 8601.")
  @JsonIgnore
  ...
  /**
   * Return true if this BatchList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BatchList batchList = (BatchList) o;
    return Objects.equals(this.id, batchList.id) &&
        Objects.equals(this.status, batchList.status) &&
        equalsNullable(this.error, batchList.error) &&
        equalsNullable(this.expiration, batchList.expiration);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, hashCodeNullable(error), hashCodeNullable(expiration));
  }
