...
import com.factset.sdk.Formula.models.CrossSectionalRequestData;
 ...
 */
@ApiModel(description = "`/cross-sectional` Request Body")
@JsonPropertyOrder({
  CrossSectionalRequest.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CrossSectionalRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private CrossSectionalRequestData data;

  public CrossSectionalRequest() { 
  }

  @JsonCreator
  public CrossSectionalRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) CrossSectionalRequestData data
  ) {
    this();
    this.data = data;
  }

  public CrossSectionalRequest data(CrossSectionalRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public CrossSectionalRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(CrossSectionalRequestData data) {
    this.data = data;
  }


  /**
   * Return true if this cross_sectional_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CrossSectionalRequest crossSectionalRequest = (CrossSectionalRequest) o;
    return Objects.equals(this.data, crossSectionalRequest.data);
  }
