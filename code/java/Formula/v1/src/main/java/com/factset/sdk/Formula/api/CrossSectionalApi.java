...
public class CrossSectionalApi {
 ...
 /**
   ...
   */
  public GetCrossSectionalDataResponseWrapper getCrossSectionalData(java.util.List<String> formulas, java.util.List<String> ids, String universe, String universeType, String backTestDate, String calendar, String fsymId, java.util.List<String> displayName, String flatten, String batch) throws ApiException {
    return getCrossSectionalDataWithHttpInfo(formulas, ids, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch).getData();
  }
   ...
   */
  public ApiResponse<GetCrossSectionalDataResponseWrapper> getCrossSectionalDataWithHttpInfo(java.util.List<String> formulas, java.util.List<String> ids, String universe, String universeType, String backTestDate, String calendar, String fsymId, java.util.List<String> displayName, String flatten, String batch) throws ApiException {
