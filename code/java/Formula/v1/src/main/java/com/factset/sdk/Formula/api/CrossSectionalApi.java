...
public class CrossSectionalApi {
  ...
  static {
    ...
    getCrossSectionalDataResponseTypeMap.put(413, new GenericType<ErrorDetail>(){});
    getCrossSectionalDataResponseTypeMap.put(415, new GenericType<ErrorDetail>(){});
    getCrossSectionalDataResponseTypeMap.put(429, new GenericType<ErrorDetail>(){});
 ...
 /**
   * Wrapper to support GET /cross-sectional returning different types
   * per status code.
   *
   * <p>
   * Responses:
 ...
 /**
   ...
   * @param startDate Specify the start date for running the Iterated Cross Sectional Functionality request either in **YYYY-MM-DD**, **YYYYMMDD** or **MM/DD/YYYY** format. User must have access to backtesting functionality. (optional)
   * @param endDate Specify the end date for running the Iterated Cross Sectional Functionality request either in **YYYY-MM-DD**, **YYYYMMDD** or **MM/DD/YYYY** format. User must have access to backtesting functionality. (optional)
   * @param frequency Specify the frequency for running the Iterated Cross Sectional Functionality request. The following frequencies are supported **D**, **W**, **M**, **AM**, **CQ**, **AY**, or **CY**. To learn more about frequency, please visit [Online Assistant Page 1964](https://my.apps.factset.com/oa/pages/1964#frequency). User must have access to backtesting functionality. (optional)
   ...
   */
  public GetCrossSectionalDataResponseWrapper getCrossSectionalData(java.util.List<String> formulas, java.util.List<String> ids, String symbolType, String universe, String universeType, String backTestDate, String calendar, String fsymId, java.util.List<String> displayName, String flatten, String batch, String startDate, String endDate, String frequency) throws ApiException {
    return getCrossSectionalDataWithHttpInfo(formulas, ids, symbolType, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch, startDate, endDate, frequency).getData();
  }
   ...
   */
  public ApiResponse<GetCrossSectionalDataResponseWrapper> getCrossSectionalDataWithHttpInfo(java.util.List<String> formulas, java.util.List<String> ids, String symbolType, String universe, String universeType, String backTestDate, String calendar, String fsymId, java.util.List<String> displayName, String flatten, String batch, String startDate, String endDate, String frequency) throws ApiException {
