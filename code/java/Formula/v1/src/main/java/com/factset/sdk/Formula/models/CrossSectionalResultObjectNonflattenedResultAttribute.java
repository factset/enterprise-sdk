...
@JsonDeserialize(using = CrossSectionalResultObjectNonflattenedResultAttribute.CrossSectionalResultObjectNonflattenedResultAttributeDeserializer.class)
@JsonSerialize(using = CrossSectionalResultObjectNonflattenedResultAttribute.CrossSectionalResultObjectNonflattenedResultAttributeSerializer.class)
public class CrossSectionalResultObjectNonflattenedResultAttribute extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(CrossSectionalResultObjectNonflattenedResultAttribute.class.getName());

    public static class CrossSectionalResultObjectNonflattenedResultAttributeSerializer extends StdSerializer<CrossSectionalResultObjectNonflattenedResultAttribute> {
        public CrossSectionalResultObjectNonflattenedResultAttributeSerializer(Class<CrossSectionalResultObjectNonflattenedResultAttribute> t) {
            super(t);
        }

        public CrossSectionalResultObjectNonflattenedResultAttributeSerializer() {
            this(null);
        }

        @Override
        public void serialize(CrossSectionalResultObjectNonflattenedResultAttribute value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CrossSectionalResultObjectNonflattenedResultAttributeDeserializer extends StdDeserializer<CrossSectionalResultObjectNonflattenedResultAttribute> {
        public CrossSectionalResultObjectNonflattenedResultAttributeDeserializer() {
            this(CrossSectionalResultObjectNonflattenedResultAttribute.class);
        }

        public CrossSectionalResultObjectNonflattenedResultAttributeDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CrossSectionalResultObjectNonflattenedResultAttribute deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                CrossSectionalResultObjectNonflattenedResultAttribute ret = new CrossSectionalResultObjectNonflattenedResultAttribute();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for CrossSectionalResultObjectNonflattenedResultAttribute: %d classes match result, expected 1", match));
        }
    ...
    public CrossSectionalResultObjectNonflattenedResultAttribute(Double o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    public CrossSectionalResultObjectNonflattenedResultAttribute(Integer o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(CrossSectionalResultObjectNonflattenedResultAttribute.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return CrossSectionalResultObjectNonflattenedResultAttribute.schemas;
    }
