...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/formula/6.0.1)](https://central.sonatype.com/artifact/com.factset.sdk/formula/6.0.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:formula:6.0.1"
  }
```
...
------------ | ------------- | ------------- | -------------
*BatchProcessingApi* | [**cancelBatchJob**](docs/BatchProcessingApi.md#cancelBatchJob) | **DELETE** /batch-cancel | Cancels individual ongoing Batch Request
...
*BatchProcessingApi* | [**getBatchDataWithPost**](docs/BatchProcessingApi.md#getBatchDataWithPost) | **POST** /batch-result | Returns the response for a Batch Request
*BatchProcessingApi* | [**getBatchList**](docs/BatchProcessingApi.md#getBatchList) | **GET** /batch-list | Returns a list of all available Batch Requests submitted by a user
...
## Documentation for Models
 ...
 - [BatchListResponse](docs/BatchListResponse.md)
 - [BatchListResponseMeta](docs/BatchListResponseMeta.md)
 ...
 - [UnifiedResultObjectFlattened](docs/UnifiedResultObjectFlattened.md)
 - [UnifiedResultObjectFlattenedAddl](docs/UnifiedResultObjectFlattenedAddl.md)
