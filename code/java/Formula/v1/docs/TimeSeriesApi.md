...
> GetTimeSeriesDataResponseWrapper getTimeSeriesData(formulas, ids, universe, universeType, calendar, fsymId, displayName, flatten, batch)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        try {
            GetTimeSeriesDataResponseWrapper result = apiInstance.getTimeSeriesData(formulas, ids, universe, universeType, calendar, fsymId, displayName, flatten, batch);
