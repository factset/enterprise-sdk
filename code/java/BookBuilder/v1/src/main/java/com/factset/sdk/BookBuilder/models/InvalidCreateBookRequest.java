 ...
 */
@ApiModel(description = "Invalid ticker/section_id/report_id")
@JsonPropertyOrder({
  InvalidCreateBookRequest.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InvalidCreateBookRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MESSAGE = "message";
  private String message;

  public InvalidCreateBookRequest() { 
  }

  public InvalidCreateBookRequest message(String message) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Please input a valid ticker for Public Company/Private Company/Private Equity/Fixed Income/MutualFund/ETF/Holder to build Book.", value = "Invalid Request Message")
  ...
  /**
   * Return true if this Invalid_Create_Book_Request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidCreateBookRequest invalidCreateBookRequest = (InvalidCreateBookRequest) o;
    return Objects.equals(this.message, invalidCreateBookRequest.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidCreateBookRequest {\n");
