 ...
 */
@JsonPropertyOrder({
  TemplateContentSection.JSON_PROPERTY_SECTION_ID,
  TemplateContentSection.JSON_PROPERTY_REPORTS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class TemplateContentSection implements Serializable {
  ...
  public TemplateContentSection() { 
  }

  public TemplateContentSection sectionId(SectionIdEnum sectionId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "COMPANY_OVERVIEW", value = "The identifier for the section, like COMPANY_OVERVIEW.")
  ...
  public TemplateContentSection reports(java.util.List<ReportsEnum> reports) {
    this.reports = reports;
    return this;
  }

  public TemplateContentSection addReportsItem(ReportsEnum reportsItem) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "A list of reports to be included in the section.")
  ...
  /**
   * Return true if this TemplateContentSection object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateContentSection templateContentSection = (TemplateContentSection) o;
    return Objects.equals(this.sectionId, templateContentSection.sectionId) &&
        Objects.equals(this.reports, templateContentSection.reports);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateContentSection {\n");
