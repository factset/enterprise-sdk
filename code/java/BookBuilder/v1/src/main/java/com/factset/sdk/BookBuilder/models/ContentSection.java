 ...
 */
@JsonPropertyOrder({
  ContentSection.JSON_PROPERTY_SECTION_ID,
  ContentSection.JSON_PROPERTY_REPORTS
})
...
public class ContentSection implements Serializable {
  ...
  public ContentSection sectionId(SectionIdEnum sectionId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "COMPANY_OVERVIEW", value = "Section ID within the book.")
  ...
  public ContentSection reports(java.util.List<ReportsEnum> reports) {
    this.reports = reports;
    return this;
  }

  public ContentSection addReportsItem(ReportsEnum reportsItem) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Identifiers for reports within the section.")
  ...
  /**
   * Return true if this ContentSection object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sectionId, contentSection.sectionId) &&
        Objects.equals(this.reports, contentSection.reports);
  }
