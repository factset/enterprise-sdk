 ...
 */
@ApiModel(description = "Invalid template type/section_id/report_id")
@JsonPropertyOrder({
  InvalidTemplateRequest.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class InvalidTemplateRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_MESSAGE = "message";
  private String message;

  public InvalidTemplateRequest() { 
  }

  public InvalidTemplateRequest message(String message) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Template name already exists. Please select a different name.", value = "Invalid request message")
  ...
  /**
   * Return true if this Invalid_Template_Request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidTemplateRequest invalidTemplateRequest = (InvalidTemplateRequest) o;
    return Objects.equals(this.message, invalidTemplateRequest.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidTemplateRequest {\n");
