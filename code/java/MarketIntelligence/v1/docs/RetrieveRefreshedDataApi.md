...
import com.factset.sdk.MarketIntelligence.api.RetrieveRefreshedDataApi;
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        RetrieveRefreshedDataApi apiInstance = new RetrieveRefreshedDataApi(defaultClient);
        String pollId = "pollId_example"; // String | example: 65ba6dd63fb366464646426d0b
        try {
            ReportDataHeader result = apiInstance.getDataPollIdResultGet(pollId);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling RetrieveRefreshedDataApi#getDataPollIdResultGet");
