...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/aitextsummarization/0.22.1)](https://central.sonatype.com/artifact/com.factset.sdk/aitextsummarization/0.22.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:aitextsummarization:0.22.1"
  }
```
