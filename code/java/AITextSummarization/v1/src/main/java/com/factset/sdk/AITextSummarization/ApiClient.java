package com.factset.sdk.AITextSummarization;
...
import com.factset.sdk.AITextSummarization.auth.Authentication;
import com.factset.sdk.AITextSummarization.auth.HttpBasicAuth;
import com.factset.sdk.AITextSummarization.auth.HttpBearerAuth;
import com.factset.sdk.AITextSummarization.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.AITextSummarization.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "http://api.factset.com/cognitive/summarization/v1";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "//api.factset.com/cognitive/summarization/v1",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/AITextSummarization/0.22.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.AITextSummarization.ApiClient} object.
   */
