package com.factset.sdk.ETFProfileandPrices;
...
import com.factset.sdk.ETFProfileandPrices.auth.Authentication;
import com.factset.sdk.ETFProfileandPrices.auth.HttpBasicAuth;
import com.factset.sdk.ETFProfileandPrices.auth.HttpBearerAuth;
import com.factset.sdk.ETFProfileandPrices.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ETFProfileandPrices.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ETFProfileandPrices/0.11.1 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ETFProfileandPrices.ApiClient} object.
   */
