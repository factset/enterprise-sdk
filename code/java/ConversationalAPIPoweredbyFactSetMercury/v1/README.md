...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/conversationalapipoweredbyfactsetmercury/1.2.1)](https://central.sonatype.com/artifact/com.factset.sdk/conversationalapipoweredbyfactsetmercury/1.2.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:conversationalapipoweredbyfactsetmercury:1.2.1"
  }
```
