...
@JsonPropertyOrder({
  QueryResponseData.JSON_PROPERTY_RESPONSE_ID,
...
public class QueryResponseData implements Serializable {
  ...
  private java.util.List<FederationData> data = new java.util.ArrayList<>();
  ...
  public QueryResponseData(
    ...
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) java.util.List<FederationData> data
  ) {
    this();
  ...
  public QueryResponseData responseId(java.util.UUID responseId) {
    this.responseId = responseId;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "ID of the response generated by FactSet Mercury. **Note:** This ID cannot be used as a chatId or jobId.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Data array")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.responseId, queryResponseData.responseId) &&
