 ...
 */
@ApiModel(description = "Response body from `/query` containing the chat ID, job ID, and status of the FactSet Mercury response generator")
@JsonPropertyOrder({
...
public class QueryChatResponse implements Serializable {
  ...
  @JsonCreator
  public QueryChatResponse(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) QueryChatResponseData data
  ) {
    this();
    this.data = data;
  }
