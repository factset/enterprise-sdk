...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.ResourceNotFoundErrorObject;
 ...
 */
@ApiModel(description = "Wrapper containing metadata and appropriate errors as thrown by the API when the requested resource is not found")
@JsonPropertyOrder({
...
public class ResourceNotFoundError implements Serializable {
  ...
  private java.util.List<ResourceNotFoundErrorObject> errors = new java.util.ArrayList<>();
  ...
  @JsonCreator
  public ResourceNotFoundError(
    @JsonProperty(value=JSON_PROPERTY_ERRORS, required=true) java.util.List<ResourceNotFoundErrorObject> errors
  ) {
    this();
    this.errors = errors;
  }

  public ResourceNotFoundError errors(java.util.List<ResourceNotFoundErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public ResourceNotFoundError addErrorsItem(ResourceNotFoundErrorObject errorsItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Array of ResourceNotFoundErrorObject")
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public java.util.List<ResourceNotFoundErrorObject> getErrors() {
    return errors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setErrors(java.util.List<ResourceNotFoundErrorObject> errors) {
    this.errors = errors;
  }
