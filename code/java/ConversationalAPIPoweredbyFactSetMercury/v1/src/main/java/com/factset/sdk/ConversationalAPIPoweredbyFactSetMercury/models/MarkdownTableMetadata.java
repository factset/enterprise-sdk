 ...
 */
@ApiModel(description = "Metadata for the markdown formatted table")
@JsonPropertyOrder({
  MarkdownTableMetadata.JSON_PROPERTY_DISPLAY_NAME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class MarkdownTableMetadata implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DISPLAY_NAME = "displayName";
  private JsonNullable<String> displayName = JsonNullable.<String>undefined();

  public MarkdownTableMetadata() { 
  }

  public MarkdownTableMetadata displayName(String displayName) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Display name of the markdown formatted table")
  @JsonIgnore
  ...
  /**
   * Return true if this MarkdownTable_metadata object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MarkdownTableMetadata markdownTableMetadata = (MarkdownTableMetadata) o;
    return equalsNullable(this.displayName, markdownTableMetadata.displayName);
  }
