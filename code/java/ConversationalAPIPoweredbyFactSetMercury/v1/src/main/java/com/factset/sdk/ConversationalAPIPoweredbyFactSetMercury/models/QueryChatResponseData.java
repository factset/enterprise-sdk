...
public class QueryChatResponseData implements Serializable {
  ...
  @JsonCreator
  public QueryChatResponseData(
    @JsonProperty(value=JSON_PROPERTY_CHAT_ID, required=true) java.util.UUID chatId, 
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Id of current conversation")
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "status of current query")
