 ...
 */
@ApiModel(description = "A list of follow-up prompts generated by FactSet Mercury that may be relevant to the current user prompt. These prompts can be used to guide the user to ask more specific questions or to provide additional context to the user.  SuggestedPrompts may include a FactSet Mercury generated template and prompt parameters to create a new prompt programmatically.   If a user would like to ask a follow-up question from SuggestedPrompts, send the follow-up prompt to the Conversational API `/query` endpoint with your chat ID and continue the conversation chain. ")
@JsonPropertyOrder({
...
public class SuggestedPrompts implements Serializable {
  ...
  private java.util.List<PromptItem> value = new java.util.ArrayList<>();
  ...
  public SuggestedPrompts(
    ...
    @JsonProperty(value=JSON_PROPERTY_VALUE, required=true) java.util.List<PromptItem> value
  ) {
    this();
    this.type = type;
    this.value = value;
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "List of suggested prompts")
