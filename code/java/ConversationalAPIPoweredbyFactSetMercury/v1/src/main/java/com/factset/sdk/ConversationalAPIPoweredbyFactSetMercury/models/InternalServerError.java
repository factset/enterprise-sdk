...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.InternalServerErrorObject;
 ...
 */
@ApiModel(description = "Wrapper containing metadata and appropriate errors as thrown by the API when an internal server error occurs")
@JsonPropertyOrder({
  InternalServerError.JSON_PROPERTY_ERRORS
})
...
public class InternalServerError implements Serializable {
  ...
  private java.util.List<InternalServerErrorObject> errors = new java.util.ArrayList<>();
  ...
  @JsonCreator
  public InternalServerError(
    @JsonProperty(value=JSON_PROPERTY_ERRORS, required=true) java.util.List<InternalServerErrorObject> errors
  ) {
    this();
    this.errors = errors;
  }

  public InternalServerError errors(java.util.List<InternalServerErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public InternalServerError addErrorsItem(InternalServerErrorObject errorsItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Array of InternalServerErrorObject")
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public java.util.List<InternalServerErrorObject> getErrors() {
    return errors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setErrors(java.util.List<InternalServerErrorObject> errors) {
    this.errors = errors;
  }
