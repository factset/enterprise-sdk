...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.BadFeedbackRequestErrorObject;
 ...
 */
@ApiModel(description = "Wrapper containing metadata and appropriate errors as thrown by the API for a bad request to /feedback")
@JsonPropertyOrder({
  BadFeedbackRequestError.JSON_PROPERTY_ERRORS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class BadFeedbackRequestError implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ERRORS = "errors";
  private java.util.List<BadFeedbackRequestErrorObject> errors = new java.util.ArrayList<>();

  public BadFeedbackRequestError() { 
  }

  @JsonCreator
  public BadFeedbackRequestError(
    @JsonProperty(value=JSON_PROPERTY_ERRORS, required=true) java.util.List<BadFeedbackRequestErrorObject> errors
  ) {
    this();
    this.errors = errors;
  }

  public BadFeedbackRequestError errors(java.util.List<BadFeedbackRequestErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public BadFeedbackRequestError addErrorsItem(BadFeedbackRequestErrorObject errorsItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Array of BadFeedbackRequestErrorObject")
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public java.util.List<BadFeedbackRequestErrorObject> getErrors() {
    return errors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setErrors(java.util.List<BadFeedbackRequestErrorObject> errors) {
    this.errors = errors;
  }


  /**
   * Return true if this BadFeedbackRequestError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BadFeedbackRequestError badFeedbackRequestError = (BadFeedbackRequestError) o;
    return Objects.equals(this.errors, badFeedbackRequestError.errors);
  }
