...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.AdaptiveCardData;
...
public class AdaptiveCard implements Serializable {
  ...
  private AdaptiveCardData value;
  ...
  **/
  ...
  public AdaptiveCard value(AdaptiveCardData value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public AdaptiveCardData getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(AdaptiveCardData value) {
    this.value = value;
  }
