...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.FeedbackRequestData;
 ...
 */
@ApiModel(description = "Request body containing feedback for the received response ")
@JsonPropertyOrder({
  FeedbackRequest.JSON_PROPERTY_DATA
})
...
public class FeedbackRequest implements Serializable {
  ...
  private FeedbackRequestData data;

  public FeedbackRequest() { 
  }

  public FeedbackRequest data(FeedbackRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public FeedbackRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(FeedbackRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, feedbackRequest.data);
  }
