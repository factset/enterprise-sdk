...
@JsonPropertyOrder({
  QueryChatResponseData.JSON_PROPERTY_CHAT_ID,
  QueryChatResponseData.JSON_PROPERTY_JOB_ID,
  QueryChatResponseData.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class QueryChatResponseData implements Serializable {
  ...
  public QueryChatResponseData() { 
  }

  public QueryChatResponseData chatId(java.util.UUID chatId) {
    this.chatId = chatId;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Id of current conversation")
  ...
  public QueryChatResponseData jobId(java.util.UUID jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  **/
  ...
  public QueryChatResponseData status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "status of current query")
  ...
  /**
   * Return true if this QueryChatResponse_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    QueryChatResponseData queryChatResponseData = (QueryChatResponseData) o;
    return Objects.equals(this.chatId, queryChatResponseData.chatId) &&
        Objects.equals(this.jobId, queryChatResponseData.jobId) &&
        Objects.equals(this.status, queryChatResponseData.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chatId, jobId, status);
  }
