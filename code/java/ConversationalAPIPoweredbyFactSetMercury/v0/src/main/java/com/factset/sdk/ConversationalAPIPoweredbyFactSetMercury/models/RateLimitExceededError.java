...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.ErrorObject;
 ...
 */
@ApiModel(description = "Error response when rate limit has been exceeded.")
@JsonPropertyOrder({
  RateLimitExceededError.JSON_PROPERTY_MESSAGE,
  RateLimitExceededError.JSON_PROPERTY_ERRORS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class RateLimitExceededError implements Serializable {
  private static final long serialVersionUID = 1L;

  /**
   * Message of error response
   */
  ...
  private JsonNullable<java.util.List<ErrorObject>> errors = JsonNullable.<java.util.List<ErrorObject>>undefined();

  public RateLimitExceededError() { 
  }

  public RateLimitExceededError message(MessageEnum message) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Message of error response")
  ...
  public RateLimitExceededError errors(java.util.List<ErrorObject> errors) {
    this.errors = JsonNullable.<java.util.List<ErrorObject>>of(errors);
    return this;
  }

  public RateLimitExceededError addErrorsItem(ErrorObject errorsItem) {
    if (this.errors == null || !this.errors.isPresent()) {
      this.errors = JsonNullable.<java.util.List<ErrorObject>>of(new java.util.ArrayList<>());
    }
    try {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Array of ErrorObject")
  @JsonIgnore
  ...
  public JsonNullable<java.util.List<ErrorObject>> getErrors_JsonNullable() {
    return errors;
  }
  
  @JsonProperty(JSON_PROPERTY_ERRORS)
  public void setErrors_JsonNullable(JsonNullable<java.util.List<ErrorObject>> errors) {
    this.errors = errors;
  }
  ...
  /**
   * Return true if this RateLimitExceededError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RateLimitExceededError rateLimitExceededError = (RateLimitExceededError) o;
    return Objects.equals(this.message, rateLimitExceededError.message) &&
        equalsNullable(this.errors, rateLimitExceededError.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(message, hashCodeNullable(errors));
  }
  ...
  public String toString() {
    ...
    sb.append("class RateLimitExceededError {\n");
