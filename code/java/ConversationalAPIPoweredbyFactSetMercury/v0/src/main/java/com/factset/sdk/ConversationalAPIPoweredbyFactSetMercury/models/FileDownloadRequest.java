...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.FileDownloadRequestData;
 ...
 */
@ApiModel(description = "Request body containing the file ID for download")
@JsonPropertyOrder({
  FileDownloadRequest.JSON_PROPERTY_DATA
})
...
public class FileDownloadRequest implements Serializable {
  ...
  private FileDownloadRequestData data;
  ...
  @JsonCreator
  public FileDownloadRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) FileDownloadRequestData data
  ) {
    this();
    this.data = data;
  }

  public FileDownloadRequest data(FileDownloadRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public FileDownloadRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(FileDownloadRequestData data) {
    this.data = data;
  }


  /**
   * Return true if this FileDownloadRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, fileDownloadRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileDownloadRequest {\n");
