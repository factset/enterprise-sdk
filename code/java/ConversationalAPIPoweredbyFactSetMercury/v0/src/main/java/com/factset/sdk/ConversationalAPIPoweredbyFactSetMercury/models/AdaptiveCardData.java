...
import java.util.Map;
import java.util.HashMap;
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.AdaptiveCardBodyElement;
 ...
 */
@ApiModel(description = "Data value for an Adaptive Card")
@JsonPropertyOrder({
  AdaptiveCardData.JSON_PROPERTY_TYPE,
  AdaptiveCardData.JSON_PROPERTY_VERSION,
  AdaptiveCardData.JSON_PROPERTY_BODY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class AdaptiveCardData implements Serializable {
  ...
  private java.util.List<AdaptiveCardBodyElement> body = null;
  ...
  public AdaptiveCardData type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Type of card")
  ...
  public AdaptiveCardData version(String version) {
    this.version = version;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Version of card")
  ...
  public AdaptiveCardData body(java.util.List<AdaptiveCardBodyElement> body) {
    this.body = body;
    return this;
  }

  public AdaptiveCardData addBodyItem(AdaptiveCardBodyElement bodyItem) {
    if (this.body == null) {
      this.body = new java.util.ArrayList<>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of Adaptive Card body elements")
  @JsonProperty(JSON_PROPERTY_BODY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public java.util.List<AdaptiveCardBodyElement> getBody() {
    return body;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BODY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBody(java.util.List<AdaptiveCardBodyElement> body) {
    this.body = body;
  }
   ...
   */
  @JsonAnySetter
  public AdaptiveCardData putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this AdaptiveCardData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AdaptiveCardData adaptiveCardData = (AdaptiveCardData) o;
    return Objects.equals(this.type, adaptiveCardData.type) &&
        Objects.equals(this.version, adaptiveCardData.version) &&
        Objects.equals(this.body, adaptiveCardData.body)&&
        Objects.equals(this.additionalProperties, adaptiveCardData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, version, body, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdaptiveCardData {\n");
