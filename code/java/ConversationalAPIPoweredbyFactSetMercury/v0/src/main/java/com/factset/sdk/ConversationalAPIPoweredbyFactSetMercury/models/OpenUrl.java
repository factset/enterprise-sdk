 ...
 */
@ApiModel(description = "Directive to open a FactSet Url. ")
@JsonPropertyOrder({
...
public class OpenUrl implements Serializable {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Name of associated url")
  @JsonIgnore
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Label of associated url")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, openUrl.action) &&
        equalsNullable(this.name, openUrl.name) &&
        Objects.equals(this.label, openUrl.label) &&
        Objects.equals(this.category, openUrl.category) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, hashCodeNullable(name), label, category, url);
  }
