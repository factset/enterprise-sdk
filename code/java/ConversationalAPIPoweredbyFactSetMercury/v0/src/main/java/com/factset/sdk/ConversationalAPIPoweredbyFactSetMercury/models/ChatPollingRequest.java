...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.ChatPollingRequestData;
 ...
 */
@ApiModel(description = "Request body containing the chat job ID")
@JsonPropertyOrder({
  ChatPollingRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class ChatPollingRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private ChatPollingRequestData data;

  public ChatPollingRequest() { 
  }

  public ChatPollingRequest data(ChatPollingRequestData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ChatPollingRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(ChatPollingRequestData data) {
    this.data = data;
  }


  /**
   * Return true if this ChatPollingRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ChatPollingRequest chatPollingRequest = (ChatPollingRequest) o;
    return Objects.equals(this.data, chatPollingRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChatPollingRequest {\n");
