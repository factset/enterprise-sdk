...
@JsonPropertyOrder({
  StatusPollResponseData.JSON_PROPERTY_JOB_ID,
  StatusPollResponseData.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class StatusPollResponseData implements Serializable {
  ...
  public StatusPollResponseData() { 
  }

  public StatusPollResponseData jobId(java.util.UUID jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  **/
  ...
  public StatusPollResponseData status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this StatusPollResponse_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StatusPollResponseData statusPollResponseData = (StatusPollResponseData) o;
    return Objects.equals(this.jobId, statusPollResponseData.jobId) &&
        Objects.equals(this.status, statusPollResponseData.status);
  }
