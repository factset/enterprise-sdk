...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.TableData;
 ...
 */
@ApiModel(description = "FactSet Table data surfaced from FactSet content sets. `Value` property of parent FederationData contains a JSON formatted [FactSet STACH V3 table](https://factset.github.io/stachschema/#/v3/README). Beta feature: Data represented as a STACH table will also be available for download as an Excel file; the `fileId` will be located in the `NextStep` array, as an `Download` action with the name `InteractiveTable`. ")
@JsonPropertyOrder({
...
public class Table implements Serializable {
  ...
  **/
  ...
  public Table value(TableData value) {
    this.value = value;
    return this;
  }
