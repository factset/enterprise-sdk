...
public class PromptParameters implements Serializable {
  ...
  private java.util.List<PromptParameter> params = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "Prompt template used to build a follow up prompt to send to FactSet Mercury")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "List of prompt parameters")
