 ...
 * Available url links
 */
@ApiModel(description = "Available url links")
@JsonPropertyOrder({
  OpenUrlUrl.JSON_PROPERTY_FDSUP,
  OpenUrlUrl.JSON_PROPERTY_HTTP
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class OpenUrlUrl implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_FDSUP = "fdsup";
  private String fdsup;
  ...
  public OpenUrlUrl fdsup(String fdsup) {
    this.fdsup = fdsup;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Fdsup link")
  @JsonProperty(JSON_PROPERTY_FDSUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getFdsup() {
    return fdsup;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FDSUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFdsup(String fdsup) {
    this.fdsup = fdsup;
  }


  public OpenUrlUrl http(String http) {
    this.http = http;
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Http link")
  ...
  /**
   * Return true if this OpenUrl_url object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OpenUrlUrl openUrlUrl = (OpenUrlUrl) o;
    return Objects.equals(this.fdsup, openUrlUrl.fdsup) &&
        Objects.equals(this.http, openUrlUrl.http);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fdsup, http);
  }
  ...
  public String toString() {
    ...
    sb.append("    fdsup: ").append(toIndentedString(fdsup)).append("\n");
