...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.auth.Authentication;
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.auth.HttpBasicAuth;
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.auth.HttpBearerAuth;
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.uat.factset.com/conversational/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.uat.factset.com/conversational/v0",
      "UAT Server",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ConversationalAPIPoweredbyFactSetMercury/0.11.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.ApiClient} object.
   */
