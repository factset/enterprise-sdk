...
public class QueryChatRequestData implements Serializable {
  ...
  private JsonNullable<String> chatId = JsonNullable.<String>undefined();
  ...
  public QueryChatRequestData query(String query) {
   ...
   /**
   * Natural language query for FactSet data
   * @return query
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Natural language query for FactSet data")
  ...
  public QueryChatRequestData chatId(String chatId) {
    this.chatId = JsonNullable.<String>of(chatId);
    return this;
  }

   /**
   * optional ID for the current ongoing conversation
   * @return chatId
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "optional ID for the current ongoing conversation")
  @JsonIgnore
  ...
  public JsonNullable<String> getChatId_JsonNullable() {
    return chatId;
  }
  
  @JsonProperty(JSON_PROPERTY_CHAT_ID)
  public void setChatId_JsonNullable(JsonNullable<String> chatId) {
    this.chatId = chatId;
  }
