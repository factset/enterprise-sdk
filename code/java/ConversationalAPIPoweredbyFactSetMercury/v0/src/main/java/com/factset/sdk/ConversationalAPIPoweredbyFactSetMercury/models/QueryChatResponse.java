...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.QueryChatResponseData;
 ...
 */
@ApiModel(description = "Response from `/query` containing the chat ID, job ID, and executing status")
@JsonPropertyOrder({
  QueryChatResponse.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class QueryChatResponse implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private QueryChatResponseData data;

  public QueryChatResponse() { 
  }

  public QueryChatResponse data(QueryChatResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public QueryChatResponseData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(QueryChatResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this QueryChatResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    QueryChatResponse queryChatResponse = (QueryChatResponse) o;
    return Objects.equals(this.data, queryChatResponse.data);
  }
