 ...
 */
@ApiModel(description = "suggested prompt data object")
@JsonPropertyOrder({
...
public class PromptItem implements Serializable {
  ...
  public PromptItem prompt(String prompt) {
   ...
   /**
   * Prompt to the Conversational API consumer containing a suggested further action
   * @return prompt
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Prompt to the Conversational API consumer containing a suggested further action")
