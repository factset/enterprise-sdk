 ...
 */
@ApiModel(description = "A serialized list of `action` items, which are directives to a front-end application to perform a certain task i.e. open a FactSet application or component, download an Excel file. ")
@JsonPropertyOrder({
...
public class NextStep implements Serializable {
  ...
  private java.util.List<NextStepItem> value = null;
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "List of NextStep items")
