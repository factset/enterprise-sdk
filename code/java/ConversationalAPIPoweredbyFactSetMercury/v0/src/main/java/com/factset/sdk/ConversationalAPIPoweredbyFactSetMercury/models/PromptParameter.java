...
public class PromptParameter implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "Selection type, currently only support single selection")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "PlaceHolder value used in the prompt template")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "Selection option values can be used to replace the placeHolder in the prompt template")
