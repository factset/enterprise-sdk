...
@JsonPropertyOrder({
  FileDownloadRequestData.JSON_PROPERTY_FILE_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class FileDownloadRequestData implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_FILE_ID = "fileId";
  private java.util.UUID fileId;

  public FileDownloadRequestData() { 
  }

  @JsonCreator
  public FileDownloadRequestData(
    @JsonProperty(value=JSON_PROPERTY_FILE_ID, required=true) java.util.UUID fileId
  ) {
    this();
    this.fileId = fileId;
  }

  public FileDownloadRequestData fileId(java.util.UUID fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Id of downloadable file")
  ...
  /**
   * Return true if this FileDownloadRequest_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FileDownloadRequestData fileDownloadRequestData = (FileDownloadRequestData) o;
    return Objects.equals(this.fileId, fileDownloadRequestData.fileId);
  }
