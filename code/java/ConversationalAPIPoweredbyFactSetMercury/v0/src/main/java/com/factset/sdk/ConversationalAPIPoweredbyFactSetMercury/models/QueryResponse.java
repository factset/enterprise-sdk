...
import com.factset.sdk.ConversationalAPIPoweredbyFactSetMercury.models.QueryResponseData;
 ...
 */
@ApiModel(description = "Query response body containing data from FactSet's Mercury LLM and metadata describing the model interaction")
@JsonPropertyOrder({
  QueryResponse.JSON_PROPERTY_DATA
})
...
public class QueryResponse implements Serializable {
  ...
  @JsonCreator
  public QueryResponse(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) QueryResponseData data
  ) {
    this();
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, queryResponse.data);
  }
