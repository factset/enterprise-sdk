...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/conversationalapipoweredbyfactsetmercury/0.11.0)](https://central.sonatype.com/artifact/com.factset.sdk/conversationalapipoweredbyfactsetmercury/0.11.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:conversationalapipoweredbyfactsetmercury:0.11.0"
  }
```
...
------------ | ------------- | ------------- | -------------
*ChatApi* | [**chatCompletion**](docs/ChatApi.md#chatCompletion) | **POST** /chat/completions | Stream a chat completion (OpenAI-compatible)
*ChatApi* | [**listModels**](docs/ChatApi.md#listModels) | **GET** /models | List available models (OpenAI-compatible)
...
## Documentation for Models
 ...
 - [ResponseChoices](docs/ResponseChoices.md)
 - [ResponseChoicesDelta](docs/ResponseChoicesDelta.md)
