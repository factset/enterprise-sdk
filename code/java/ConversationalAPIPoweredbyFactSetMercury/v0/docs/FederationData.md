...
public class Example {
    public static void main(String[] args) {
        ...
        // create a new ResponseString
        ResponseString exampleResponseString = new ResponseString();
        // set FederationData to ResponseString
        exampleFederationData.setActualInstance(exampleResponseString);
        // to get back the ResponseString set earlier
        ResponseString testResponseString = (ResponseString) exampleFederationData.getActualInstance();
