...
public class UploadStatusResponseParameters implements Serializable {
  ...
  private JsonNullable<OffsetDateTime> uploadDateTime = JsonNullable.<OffsetDateTime>undefined();
  ...
  **/
  ...
  public UploadStatusResponseParameters uploadDateTime(OffsetDateTime uploadDateTime) {
    this.uploadDateTime = JsonNullable.<OffsetDateTime>of(uploadDateTime);
    return this;
  }
  ...
  **/
  ...
  public OffsetDateTime getUploadDateTime() {
        return uploadDateTime.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_UPLOAD_DATE_TIME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getUploadDateTime_JsonNullable() {
    return uploadDateTime;
  }
  
  @JsonProperty(JSON_PROPERTY_UPLOAD_DATE_TIME)
  public void setUploadDateTime_JsonNullable(JsonNullable<OffsetDateTime> uploadDateTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acfpStatus, uploadStatusResponseParameters.acfpStatus) &&
        ...
        equalsNullable(this.uploadDateTime, uploadStatusResponseParameters.uploadDateTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acfpStatus, asOfDate, fileName, numberOfScenarios, status, type, hashCodeNullable(uploadDateTime), uploadId);
  }
