package com.factset.sdk.AssetCashFlowProjections;
...
import com.factset.sdk.AssetCashFlowProjections.auth.Authentication;
import com.factset.sdk.AssetCashFlowProjections.auth.HttpBasicAuth;
import com.factset.sdk.AssetCashFlowProjections.auth.HttpBearerAuth;
import com.factset.sdk.AssetCashFlowProjections.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.AssetCashFlowProjections.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/asset-cash-flow-projections/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/analytics/asset-cash-flow-projections/v0",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/AssetCashFlowProjections/0.10.4 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.AssetCashFlowProjections.ApiClient} object.
   */
