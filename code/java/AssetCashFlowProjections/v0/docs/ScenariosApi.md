...
> ClientUploadResponse uploadScenarios(clientScenariosUpload)
...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        ScenariosApi apiInstance = new ScenariosApi(defaultClient);
        ClientScenariosUpload clientScenariosUpload = new ClientScenariosUpload(); // ClientScenariosUpload | Request body
        try {
            ClientUploadResponse result = apiInstance.uploadScenarios(clientScenariosUpload);
            System.out.println(result);

        } catch (ApiException e) {
            System.err.println("Exception when calling ScenariosApi#uploadScenarios");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
