...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/openrisk/5.0.4)](https://central.sonatype.com/artifact/com.factset.sdk/openrisk/5.0.4)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:openrisk:5.0.4"
  }
```
