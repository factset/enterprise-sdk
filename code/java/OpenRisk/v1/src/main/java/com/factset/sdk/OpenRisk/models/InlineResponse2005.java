...
public class InlineResponse2005 implements Serializable {
  ...
  public InlineResponse2005 meta(SecurityOnlySuccessResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2005 data(java.util.List<RiskMappingEntry> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2005 addDataItem(RiskMappingEntry dataItem) {
