...
public class RemoveCurrencyRisk extends AbstractOpenApiSchema implements Serializable {
    ...
    public static class RemoveCurrencyRiskSerializer extends StdSerializer<RemoveCurrencyRisk> {
        public RemoveCurrencyRiskSerializer(Class<RemoveCurrencyRisk> t) {
            super(t);
        }
    ...
    public static class RemoveCurrencyRiskDeserializer extends StdDeserializer<RemoveCurrencyRisk> {
        ...
        public RemoveCurrencyRisk deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize java.util.Map<String, Boolean>
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                ...
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<java.util.Map<String, Boolean>>() { });
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
    ...
    static {
        ...
        schemas.put("java.util.Map<String, Boolean>", new GenericType<java.util.Map<String, Boolean>>() {
        });
     ...
     * Boolean, java.util.Map<String, Boolean>
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Boolean, java.util.Map<String, Boolean>");
    }
     ...
     * Boolean, java.util.Map<String, Boolean>
     *
     * @return The actual instance (Boolean, java.util.Map<String, Boolean>)
     */
    @Override
    ...
    /**
     * Get the actual instance of `java.util.Map<String, Boolean>`. If the actual instance is not `java.util.Map<String, Boolean>`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `java.util.Map<String, Boolean>`
     * @throws ClassCastException if the instance is not `java.util.Map<String, Boolean>`
     */
    public java.util.Map<String, Boolean> getOneOf1() throws ClassCastException {
        return (java.util.Map<String, Boolean>)super.getActualInstance();
    }
