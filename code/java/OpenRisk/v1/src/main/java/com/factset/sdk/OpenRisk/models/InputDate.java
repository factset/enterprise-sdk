...
@JsonDeserialize(using = InputDate.InputDateDeserializer.class)
@JsonSerialize(using = InputDate.InputDateSerializer.class)
public class InputDate extends AbstractOpenApiSchema implements Serializable {
    private static final Logger log = Logger.getLogger(InputDate.class.getName());

    public static class InputDateSerializer extends StdSerializer<InputDate> {
        public InputDateSerializer(Class<InputDate> t) {
            super(t);
        }

        public InputDateSerializer() {
            this(null);
        }

        @Override
        public void serialize(InputDate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class InputDateDeserializer extends StdDeserializer<InputDate> {
        public InputDateDeserializer() {
            this(InputDate.class);
        }

        public InputDateDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public InputDate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                InputDate ret = new InputDate();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for InputDate: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public InputDate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "InputDate cannot be null");
        }
    }
    ...
    public InputDate(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public InputDate(LocalDate o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    static {
        ...
        JSON.registerDescendants(InputDate.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return InputDate.schemas;
    }
