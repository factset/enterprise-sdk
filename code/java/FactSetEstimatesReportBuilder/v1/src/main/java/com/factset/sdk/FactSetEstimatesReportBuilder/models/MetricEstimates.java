 ...
 */
@JsonPropertyOrder({
  MetricEstimates.JSON_PROPERTY_METRIC_ESTIMATES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class MetricEstimates implements Serializable {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_METRIC_ESTIMATES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public MetricEstimatesMetricEstimates getMetricEstimates() {
    return metricEstimates;
  }
  ...
  @JsonProperty(JSON_PROPERTY_METRIC_ESTIMATES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetricEstimates(MetricEstimatesMetricEstimates metricEstimates) {
    this.metricEstimates = metricEstimates;
  }


  /**
   * Return true if this metricEstimates object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MetricEstimates metricEstimates = (MetricEstimates) o;
    return Objects.equals(this.metricEstimates, metricEstimates.metricEstimates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metricEstimates);
  }
  ...
  public String toString() {
    ...
    sb.append("    metricEstimates: ").append(toIndentedString(metricEstimates)).append("\n");
    sb.append("}");
    return sb.toString();
  }
