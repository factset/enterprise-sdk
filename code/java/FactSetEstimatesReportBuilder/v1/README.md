...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'factsetestimatesreportbuilder' jar has been published to maven central.
    mavenLocal()       // Needed if the 'factsetestimatesreportbuilder' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:factsetestimatesreportbuilder:0.9.0"
  }
```
...
- `target/factsetestimatesreportbuilder-0.9.0.jar`
- `target/lib/*.jar`
