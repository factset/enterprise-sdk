...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'bondsapifordigitalportals' jar has been published to maven central.
    mavenLocal()       // Needed if the 'bondsapifordigitalportals' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:bondsapifordigitalportals:0.9.0"
  }
```
...
- `target/bondsapifordigitalportals-0.9.0.jar`
- `target/lib/*.jar`
