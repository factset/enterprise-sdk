...
@JsonPropertyOrder({
  DebtInstrumentNotationScreenerSearchDataValidationMarketPriority.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DebtInstrumentNotationScreenerSearchDataValidationMarketPriority implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public DebtInstrumentNotationScreenerSearchDataValidationMarketPriority() { 
  }

  public DebtInstrumentNotationScreenerSearchDataValidationMarketPriority ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public DebtInstrumentNotationScreenerSearchDataValidationMarketPriority addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _debtInstrument_notation_screener_search_data_validation_market_priority object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DebtInstrumentNotationScreenerSearchDataValidationMarketPriority debtInstrumentNotationScreenerSearchDataValidationMarketPriority = (DebtInstrumentNotationScreenerSearchDataValidationMarketPriority) o;
    return Objects.equals(this.ids, debtInstrumentNotationScreenerSearchDataValidationMarketPriority.ids);
  }
