 ...
 */
@ApiModel(description = "Value range for the base point value, which is the change of the debt instrument's price for a one base point change (nominally, not relatively) of the prevailing market interest rate. One base point is equivalent to 0.01 percent (1/100 of a percent). The unit of the base point value is the value unit of the notation, thus the parameter `validation.valueUnit.restrict.ids` must be set to exactly one value unit in order to use the parameter.")
@JsonPropertyOrder({
  DebtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue.JSON_PROPERTY_MINIMUM,
  DebtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue.JSON_PROPERTY_MAXIMUM
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DebtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue implements Serializable {
  ...
  **/
  ...
  public DebtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue maximum(DebtInstrumentNotationScreenerSearchDataLifeCycleMaturityRestrictionRemainingTermYearsMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this _debtInstrument_notation_screener_search_data_sensitivities_basePointValue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DebtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue debtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue = (DebtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue) o;
    return Objects.equals(this.minimum, debtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue.minimum) &&
        Objects.equals(this.maximum, debtInstrumentNotationScreenerSearchDataSensitivitiesBasePointValue.maximum);
  }
