 ...
 */
@ApiModel(description = "Ranking data of the debt instrument. It indicates how payments related to the debt instrument are ranked  compared to payments on the issuer's other obligations.")
@JsonPropertyOrder({
  InlineResponse200DataDebtRanking.JSON_PROPERTY_ID,
  InlineResponse200DataDebtRanking.JSON_PROPERTY_NAME
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse200DataDebtRanking implements Serializable {
  ...
  public InlineResponse200DataDebtRanking() { 
  }

  public InlineResponse200DataDebtRanking id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Identifier of the debt ranking.")
  ...
  public InlineResponse200DataDebtRanking name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the debt ranking.")
  ...
  /**
   * Return true if this inline_response_200_data_debtRanking object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataDebtRanking inlineResponse200DataDebtRanking = (InlineResponse200DataDebtRanking) o;
    return Objects.equals(this.id, inlineResponse200DataDebtRanking.id) &&
        Objects.equals(this.name, inlineResponse200DataDebtRanking.name);
  }
