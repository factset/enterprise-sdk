...
@JsonPropertyOrder({
  DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_IDS = "ids";
  private java.util.Set<BigDecimal> ids = null;

  public DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude() { 
  }

  public DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude ids(java.util.Set<BigDecimal> ids) {
    this.ids = ids;
    return this;
  }

  public DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _debtInstrument_notation_screener_search_data_validation_market_selection_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude debtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude = (DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude) o;
    return Objects.equals(this.ids, debtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude {\n");
