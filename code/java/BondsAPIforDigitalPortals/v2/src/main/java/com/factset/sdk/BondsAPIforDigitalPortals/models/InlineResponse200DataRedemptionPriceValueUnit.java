 ...
 */
@ApiModel(description = "Value unit of the redemption price such as percentages for a debt instrument quoted in percent, or a main or a fractional currency for a per-unit-quoted debt instrument (rarely). See endpoint `/basic/valueUnit/list` for possible values.")
@JsonPropertyOrder({
  InlineResponse200DataRedemptionPriceValueUnit.JSON_PROPERTY_ID,
  InlineResponse200DataRedemptionPriceValueUnit.JSON_PROPERTY_CODE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InlineResponse200DataRedemptionPriceValueUnit implements Serializable {
  ...
  **/
  ...
  public InlineResponse200DataRedemptionPriceValueUnit code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this inline_response_200_data_redemption_price_valueUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineResponse200DataRedemptionPriceValueUnit inlineResponse200DataRedemptionPriceValueUnit = (InlineResponse200DataRedemptionPriceValueUnit) o;
    return Objects.equals(this.id, inlineResponse200DataRedemptionPriceValueUnit.id) &&
        Objects.equals(this.code, inlineResponse200DataRedemptionPriceValueUnit.code);
  }
