 ...
 */
@ApiModel(description = "Value range for the yield elasticity, which is the ratio of the percentage change of the debt instrument's price for a one percent change (relatively, not nominally) of the prevailing market interest rate.")
@JsonPropertyOrder({
  DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity.JSON_PROPERTY_MINIMUM,
  DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity.JSON_PROPERTY_MAXIMUM
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity implements Serializable {
  ...
  public DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity() { 
  }

  public DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity minimum(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum minimum) {
  ...
  **/
  ...
  public DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity maximum(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum maximum) {
  ...
  **/
  ...
  /**
   * Return true if this _debtInstrument_notation_screener_search_data_sensitivities_elasticity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity debtInstrumentNotationScreenerSearchDataSensitivitiesElasticity = (DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity) o;
    return Objects.equals(this.minimum, debtInstrumentNotationScreenerSearchDataSensitivitiesElasticity.minimum) &&
        Objects.equals(this.maximum, debtInstrumentNotationScreenerSearchDataSensitivitiesElasticity.maximum);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity {\n");
