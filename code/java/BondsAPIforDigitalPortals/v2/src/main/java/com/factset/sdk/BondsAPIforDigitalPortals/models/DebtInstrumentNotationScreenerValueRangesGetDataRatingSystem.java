 ...
 */
@ApiModel(description = "Rating system. The parameter allows to specify the rating system (up to two) from which the available ratings of the restricted set of debt instruments are retrieved without limiting the debt instrument selection to only debt instruments with a rating in that rating system.")
@JsonPropertyOrder({
  DebtInstrumentNotationScreenerValueRangesGetDataRatingSystem.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DebtInstrumentNotationScreenerValueRangesGetDataRatingSystem implements Serializable {
  ...
  public DebtInstrumentNotationScreenerValueRangesGetDataRatingSystem addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _debtInstrument_notation_screener_valueRanges_get_data_rating_system object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DebtInstrumentNotationScreenerValueRangesGetDataRatingSystem debtInstrumentNotationScreenerValueRangesGetDataRatingSystem = (DebtInstrumentNotationScreenerValueRangesGetDataRatingSystem) o;
    return Objects.equals(this.ids, debtInstrumentNotationScreenerValueRangesGetDataRatingSystem.ids);
  }
