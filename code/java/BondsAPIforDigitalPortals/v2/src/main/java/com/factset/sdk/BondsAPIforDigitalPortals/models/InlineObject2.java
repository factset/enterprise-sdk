...
import com.factset.sdk.BondsAPIforDigitalPortals.models.DebtInstrumentNotationScreenerValueRangesGetData;
import com.factset.sdk.BondsAPIforDigitalPortals.models.DebtInstrumentNotationScreenerValueRangesGetMeta;
...
public class InlineObject2 implements Serializable {
  ...
  private DebtInstrumentNotationScreenerValueRangesGetData data;

  public static final String JSON_PROPERTY_META = "meta";
  private DebtInstrumentNotationScreenerValueRangesGetMeta meta;

  public InlineObject2() { 
  }

  public InlineObject2 data(DebtInstrumentNotationScreenerValueRangesGetData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public DebtInstrumentNotationScreenerValueRangesGetData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(DebtInstrumentNotationScreenerValueRangesGetData data) {
    this.data = data;
  }


  public InlineObject2 meta(DebtInstrumentNotationScreenerValueRangesGetMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public DebtInstrumentNotationScreenerValueRangesGetMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(DebtInstrumentNotationScreenerValueRangesGetMeta meta) {
    this.meta = meta;
  }
