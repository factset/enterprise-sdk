 ...
 */
@ApiModel(description = "Exclusion lists. If present, the result does not contain notations belonging to debt instruments that are a member of any of the provided lists.")
@JsonPropertyOrder({
  DebtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude.JSON_PROPERTY_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DebtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude implements Serializable {
  ...
  public DebtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude addIdsItem(BigDecimal idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  /**
   * Return true if this _debtInstrument_notation_screener_search_data_validation_instrumentSelectionList_exclude object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DebtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude debtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude = (DebtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude) o;
    return Objects.equals(this.ids, debtInstrumentNotationScreenerSearchDataValidationInstrumentSelectionListExclude.ids);
  }
