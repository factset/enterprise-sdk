...
import com.factset.sdk.BondsAPIforDigitalPortals.models.DebtInstrumentIssuerSearchData;
import com.factset.sdk.BondsAPIforDigitalPortals.models.DebtInstrumentIssuerSearchMeta;
...
public class InlineObject implements Serializable {
  ...
  private DebtInstrumentIssuerSearchData data;

  public static final String JSON_PROPERTY_META = "meta";
  private DebtInstrumentIssuerSearchMeta meta;

  public InlineObject() { 
  }

  public InlineObject data(DebtInstrumentIssuerSearchData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public DebtInstrumentIssuerSearchData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(DebtInstrumentIssuerSearchData data) {
    this.data = data;
  }


  public InlineObject meta(DebtInstrumentIssuerSearchMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public DebtInstrumentIssuerSearchMeta getMeta() {
    return meta;
  }
  ...
  @JsonProperty(JSON_PROPERTY_META)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMeta(DebtInstrumentIssuerSearchMeta meta) {
    this.meta = meta;
  }
