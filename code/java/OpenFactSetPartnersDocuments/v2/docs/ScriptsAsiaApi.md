...
- type=delta Will get the latest 7 days files. Will run every two hours.
- type=full Will get complete history except the latest 7 days. Will run weekly once on Friday.
