...
> LinkUpResponse getLinkUpJobListings(sort, paginationLimit, paginationOffset, startDate, endDate, type)
 ...
 **startDate** | **LocalDate**| The earliest date of the LinkUp file the API should fetching for based on fileTimestamp. | [optional]
 **endDate** | **LocalDate**| The latest date of the LinkUp file the API should fetching for based on fileTimestamp. | [optional]
 **type** | **String**| Used to provide the full job descriptions when value \&quot;full\&quot; is used for this parameter. | [optional] [default to delta] [enum: full, delta]
