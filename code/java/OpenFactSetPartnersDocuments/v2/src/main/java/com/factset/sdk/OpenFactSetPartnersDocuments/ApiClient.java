...
import com.factset.sdk.OpenFactSetPartnersDocuments.auth.Authentication;
import com.factset.sdk.OpenFactSetPartnersDocuments.auth.HttpBasicAuth;
import com.factset.sdk.OpenFactSetPartnersDocuments.auth.HttpBearerAuth;
import com.factset.sdk.OpenFactSetPartnersDocuments.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.OpenFactSetPartnersDocuments.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/bulk-documents/ofm/v2";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/bulk-documents/ofm/v2",
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/OpenFactSetPartnersDocuments/4.0.2 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.OpenFactSetPartnersDocuments.ApiClient} object.
   */
