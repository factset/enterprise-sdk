...
public class LinkUpApi {
  ...
  private static final Map<Integer, GenericType> getLinkUpJobListingsResponseTypeMap = new HashMap<Integer, GenericType>();
  static {
    getLinkUpJobListingsResponseTypeMap.put(200, new GenericType<LinkUpResponse>(){});
    getLinkUpJobListingsResponseTypeMap.put(400, new GenericType<AuthStatus>(){});
    getLinkUpJobListingsResponseTypeMap.put(401, new GenericType<AuthStatus>(){});
    getLinkUpJobListingsResponseTypeMap.put(403, new GenericType<AuthStatus>(){});
    getLinkUpJobListingsResponseTypeMap.put(500, new GenericType<AuthStatus>(){});
  }
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> Download link &amp; metadata for LinkUp data. </td><td>  -  </td></tr>
   ...
   */
  public ApiResponse<LinkUpResponse> getLinkUpJobListingsWithHttpInfo(String sort, Integer paginationLimit, Integer paginationOffset, LocalDate startDate, LocalDate endDate, String type) throws ApiException {
