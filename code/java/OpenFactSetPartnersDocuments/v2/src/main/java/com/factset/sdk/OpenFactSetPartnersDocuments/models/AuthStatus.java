...
import com.factset.sdk.OpenFactSetPartnersDocuments.models.ErrorExample;
...
@JsonPropertyOrder({
  AuthStatus.JSON_PROPERTY_ERRORS
})
...
public class AuthStatus implements Serializable {
  ...
  public AuthStatus errors(java.util.List<ErrorExample> errors) {
    this.errors = errors;
    return this;
  }

  public AuthStatus addErrorsItem(ErrorExample errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  /**
   * Return true if this AuthStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, authStatus.errors);
  }
