...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'northfieldportfoliooptimizer' jar has been published to maven central.
    mavenLocal()       // Needed if the 'northfieldportfoliooptimizer' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.factset.sdk:northfieldportfoliooptimizer:0.9.0"
  }
```
...
- `target/northfieldportfoliooptimizer-0.9.0.jar`
- `target/lib/*.jar`
