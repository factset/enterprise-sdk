package com.factset.sdk.NorthfieldPortfolioOptimizer;
...
import com.factset.sdk.NorthfieldPortfolioOptimizer.auth.Authentication;
import com.factset.sdk.NorthfieldPortfolioOptimizer.auth.HttpBasicAuth;
import com.factset.sdk.NorthfieldPortfolioOptimizer.auth.HttpBearerAuth;
import com.factset.sdk.NorthfieldPortfolioOptimizer.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.NorthfieldPortfolioOptimizer.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/NorthfieldPortfolioOptimizer/0.22.3 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.NorthfieldPortfolioOptimizer.ApiClient} object.
   */
