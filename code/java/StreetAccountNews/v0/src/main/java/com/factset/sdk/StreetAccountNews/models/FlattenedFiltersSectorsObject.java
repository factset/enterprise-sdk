 ...
 */
@JsonPropertyOrder({
  FlattenedFiltersSectorsObject.JSON_PROPERTY_NAME,
  FlattenedFiltersSectorsObject.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class FlattenedFiltersSectorsObject implements Serializable {
  ...
  public FlattenedFiltersSectorsObject() { 
  }

  public FlattenedFiltersSectorsObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public FlattenedFiltersSectorsObject value(java.util.List<BigDecimal> value) {
    this.value = value;
    return this;
  }

  public FlattenedFiltersSectorsObject addValueItem(BigDecimal valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  /**
   * Return true if this flattenedFiltersSectorsObject object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FlattenedFiltersSectorsObject flattenedFiltersSectorsObject = (FlattenedFiltersSectorsObject) o;
    return Objects.equals(this.name, flattenedFiltersSectorsObject.name) &&
        Objects.equals(this.value, flattenedFiltersSectorsObject.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlattenedFiltersSectorsObject {\n");
