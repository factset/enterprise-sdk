...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/streetaccountnews/1.5.0)](https://central.sonatype.com/artifact/com.factset.sdk/streetaccountnews/1.5.0)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:streetaccountnews:1.5.0"
  }
```
...
*SaBurstsApi* | [**getLatestBurstFile**](docs/SaBurstsApi.md#getLatestBurstFile) | **GET** /sa-bursts/latest-file | Retrieve the latest burst file metadata and download URL
...
## Documentation for Models
 ...
 - [BurstFileResponse](docs/BurstFileResponse.md)
 - [BurstFileResponseData](docs/BurstFileResponseData.md)
