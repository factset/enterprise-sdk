...
public class FlattenedFiltersRegionsObject implements Serializable {
  ...
  **/
  ...
  public FlattenedFiltersRegionsObject value(java.util.List<String> value) {
    this.value = value;
    return this;
  }

  public FlattenedFiltersRegionsObject addValueItem(String valueItem) {
    if (this.value == null) {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "An array containing a single numeric value associated with the region.")
