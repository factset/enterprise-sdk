...
import com.factset.sdk.StreetAccountNews.models.CreateFilesRequestObject;
...
@JsonPropertyOrder({
  CreateFilesRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class CreateFilesRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private CreateFilesRequestObject data;
  ...
  @JsonCreator
  public CreateFilesRequest(
    @JsonProperty(value=JSON_PROPERTY_DATA, required=true) CreateFilesRequestObject data
  ) {
    this();
    this.data = data;
  }

  public CreateFilesRequest data(CreateFilesRequestObject data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public CreateFilesRequestObject getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(CreateFilesRequestObject data) {
    this.data = data;
  }


  /**
   * Return true if this createFilesRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateFilesRequest createFilesRequest = (CreateFilesRequest) o;
    return Objects.equals(this.data, createFilesRequest.data);
  }
