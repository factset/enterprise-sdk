...
public class StructuredFiltersChildrenObjectCategories implements Serializable {
  ...
  public StructuredFiltersChildrenObjectCategories() { 
  }

  public StructuredFiltersChildrenObjectCategories name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public StructuredFiltersChildrenObjectCategories value(java.util.List<String> value) {
    this.value = value;
    return this;
  }

  public StructuredFiltersChildrenObjectCategories addValueItem(String valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  /**
   * Return true if this StructuredFiltersChildrenObjectCategories object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StructuredFiltersChildrenObjectCategories structuredFiltersChildrenObjectCategories = (StructuredFiltersChildrenObjectCategories) o;
    return Objects.equals(this.name, structuredFiltersChildrenObjectCategories.name) &&
        Objects.equals(this.value, structuredFiltersChildrenObjectCategories.value);
  }
