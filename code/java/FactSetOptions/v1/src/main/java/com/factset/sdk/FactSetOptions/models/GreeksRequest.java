 ...
 */
@ApiModel(description = "Options greeks request")
@JsonPropertyOrder({
  GreeksRequest.JSON_PROPERTY_IDS,
  GreeksRequest.JSON_PROPERTY_START_DATE,
  GreeksRequest.JSON_PROPERTY_END_DATE,
  GreeksRequest.JSON_PROPERTY_FREQUENCY,
  GreeksRequest.JSON_PROPERTY_PRICE_TYPE,
  GreeksRequest.JSON_PROPERTY_CALENDAR
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")

public class GreeksRequest implements Serializable {
  ...
  public GreeksRequest ids(java.util.List<String> ids) {
    this.ids = ids;
    return this;
  }

  public GreeksRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public GreeksRequest startDate(String startDate) {
  ...
  **/
  ...
  public GreeksRequest endDate(String endDate) {
  ...
  **/
  ...
  public GreeksRequest frequency(Frequency frequency) {
  ...
  **/
  ...
  public GreeksRequest priceType(PriceType priceType) {
  ...
  **/
  ...
  public GreeksRequest calendar(Calendar calendar) {
  ...
  **/
  ...
  /**
   * Return true if this greeksRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GreeksRequest greeksRequest = (GreeksRequest) o;
    return Objects.equals(this.ids, greeksRequest.ids) &&
        Objects.equals(this.startDate, greeksRequest.startDate) &&
        Objects.equals(this.endDate, greeksRequest.endDate) &&
        Objects.equals(this.frequency, greeksRequest.frequency) &&
        Objects.equals(this.priceType, greeksRequest.priceType) &&
        Objects.equals(this.calendar, greeksRequest.calendar);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, startDate, endDate, frequency, priceType, calendar);
  }
