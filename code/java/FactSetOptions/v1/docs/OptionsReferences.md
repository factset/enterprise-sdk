...
**callPutFlag** | **Integer** | Returns a 0 if the option is a call, returns a 1 if the option is a put. |  [optional]
**callPutPairSymbol** | **String** | Returns the corresponding put symbol given a call symbol; and vice-versa. |  [optional]
**contractSize** | **Integer** | The Option Contract Size |  [optional]
...
**lepoFlag** | **Integer** | Indicates whether or not a given options contract is a Low Exercise Price Option \&quot;LEPO\&quot; (0/1). This is unique to European Options (e.g. ASX exchange). |  [optional]
