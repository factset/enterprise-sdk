...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/eventcalendar/0.22.2)](https://central.sonatype.com/artifact/com.factset.sdk/eventcalendar/0.22.2)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:eventcalendar:0.22.2"
  }
```
