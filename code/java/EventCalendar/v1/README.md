...
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/eventcalendar)](https://search.maven.org/artifact/com.factset.sdk/eventcalendar)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:eventcalendar:0.20.8"
  }
```
