...
# Event Calendar client library for Java

[![API Version](https://img.shields.io/badge/api-v1.0.0-blue)](https://developer.factset.com/api-catalog/)
[![Maven Central](https://img.shields.io/maven-central/v/com.factset.sdk/eventcalendar/0.22.1)](https://central.sonatype.com/artifact/com.factset.sdk/eventcalendar/0.22.1)
...
```groovy
  ...
  dependencies {
    ...
    implementation "com.factset.sdk:eventcalendar:0.22.1"
  }
```
...
```java
import com.factset.sdk.EventCalendar.*;
...
------------ | ------------- | ------------- | -------------
*CompanyApi* | [**getCompanyEvent**](docs/CompanyApi.md#getCompanyEvent) | **POST** /calendar/events | Retrieve Company Event data
