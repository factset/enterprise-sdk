...
public class CompanyApi {
   ...
   * @param identifier Identifier that resolves to a company.  (required)
   * @param identifierType The type of the identifier. (required)
   * @param format Format of the logos. (optional, default to rectangular)
