...
import com.factset.sdk.ProposalGenerationEngine.auth.Authentication;
import com.factset.sdk.ProposalGenerationEngine.auth.HttpBasicAuth;
import com.factset.sdk.ProposalGenerationEngine.auth.HttpBearerAuth;
import com.factset.sdk.ProposalGenerationEngine.auth.ApiKeyAuth;
import com.factset.sdk.utils.authentication.OAuth2Client;
import com.factset.sdk.ProposalGenerationEngine.auth.FactSetOAuth2ClientAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://api.factset.com/analytics/engines/proposal-generation/v0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.factset.com/analytics/engines/proposal-generation/v0",
      "Production",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.uat.factset.com/analytics/engines/proposal-generation/v0",
      "Staging",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("fds-sdk/java/ProposalGenerationEngine/0.1.0 (" + System.getProperty("os.name") + "; Java " + System.getProperty("java.version") + ")");
   ...
   * @return this instance of {@link com.factset.sdk.ProposalGenerationEngine.ApiClient} object.
   */
