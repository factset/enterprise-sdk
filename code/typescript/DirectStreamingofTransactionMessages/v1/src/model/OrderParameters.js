...
class OrderParameters {
     ...
     */
    constructor(portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso) { 
        
        OrderParameters.initialize(this, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso);
    }
     ...
     */
    static initialize(obj, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso) { 
