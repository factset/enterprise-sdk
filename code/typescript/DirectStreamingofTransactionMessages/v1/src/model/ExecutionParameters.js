...
class ExecutionParameters {
     ...
     */
    constructor(net, gross, settlementvalue, settlementdate, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso) { 
        
        ExecutionParameters.initialize(this, net, gross, settlementvalue, settlementdate, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso);
    }
     ...
     */
    static initialize(obj, net, gross, settlementvalue, settlementdate, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso) { 
        obj['net'] = net;
        obj['gross'] = gross;
