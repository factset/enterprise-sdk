...
class PlacementParameters {
     ...
     */
    constructor(settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso) { 
        
        PlacementParameters.initialize(this, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso);
    }
     ...
     */
    static initialize(obj, settlementcurrencyiso, portfolio, transactionid, symbol, description, tradetype, status, tradedate, amount, currencyiso) { 
