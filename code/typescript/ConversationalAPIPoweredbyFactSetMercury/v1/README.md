...
[![npm](https://img.shields.io/badge/npm-v1.0.4-orange)](https://www.npmjs.com/package/@factset/sdk-conversationalapipoweredbyfactsetmercury/v/1.0.4)
...
```shell
npm install @factset/sdk-utils @factset/sdk-conversationalapipoweredbyfactsetmercury@1.0.4
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-conversationalapipoweredbyfactsetmercury@1.0.4
```
