...
import ForbiddenErrorObject from './ForbiddenErrorObject';
...
class ForbiddenError {
     ...
     * @param errors {Array.<module:model/ForbiddenErrorObject>} Array of ForbiddenErrorObject
     */
    constructor(errors) { 
        
        ForbiddenError.initialize(this, errors);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [ForbiddenErrorObject]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/ForbiddenErrorObject>} errors
 */
ForbiddenError.prototype['errors'] = undefined;
