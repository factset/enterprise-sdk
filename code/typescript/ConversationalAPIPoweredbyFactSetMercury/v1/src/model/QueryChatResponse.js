...
import QueryChatResponseData from './QueryChatResponseData';

/**
 * The QueryChatResponse model module.
 * @module model/QueryChatResponse
 */
class QueryChatResponse {
    /**
     * Constructs a new <code>QueryChatResponse</code>.
     * Response body from &#x60;/query&#x60; containing the chat ID, job ID, and status of the FactSet Mercury response generator
     * @alias module:model/QueryChatResponse
     * @param data {module:model/QueryChatResponseData} 
     */
    constructor(data) { 
        
        QueryChatResponse.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>QueryChatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QueryChatResponse} obj Optional instance to populate.
     * @return {module:model/QueryChatResponse} The populated <code>QueryChatResponse</code> instance.
     */
...
/**
 * @member {module:model/QueryChatResponseData} data
 */
QueryChatResponse.prototype['data'] = undefined;
...
export default QueryChatResponse;
