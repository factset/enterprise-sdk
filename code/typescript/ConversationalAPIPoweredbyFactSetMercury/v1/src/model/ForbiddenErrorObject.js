...
/**
 * The ForbiddenErrorObject model module.
 * @module model/ForbiddenErrorObject
 */
class ForbiddenErrorObject {
    /**
     * Constructs a new <code>ForbiddenErrorObject</code>.
     * Single error object returned in response to a user without entitlements to a specific resource
     * @alias module:model/ForbiddenErrorObject
     * @param id {String} Id of error
     * @param title {module:model/ForbiddenErrorObject.TitleEnum} Title of error
     * @param code {module:model/ForbiddenErrorObject.CodeEnum} Code of error
     * @param detail {String} Details of error
     */
    constructor(id, title, code, detail) { 
        
        ForbiddenErrorObject.initialize(this, id, title, code, detail);
    }
    ...
    /**
     * Constructs a <code>ForbiddenErrorObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForbiddenErrorObject} obj Optional instance to populate.
     * @return {module:model/ForbiddenErrorObject} The populated <code>ForbiddenErrorObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForbiddenErrorObject();
 ...
 * @member {String} id
 */
ForbiddenErrorObject.prototype['id'] = undefined;

/**
 * Title of error
 * @member {module:model/ForbiddenErrorObject.TitleEnum} title
 */
ForbiddenErrorObject.prototype['title'] = undefined;

/**
 * Code of error
 * @member {module:model/ForbiddenErrorObject.CodeEnum} code
 */
ForbiddenErrorObject.prototype['code'] = undefined;

/**
 * Details of error
 * @member {String} detail
 */
ForbiddenErrorObject.prototype['detail'] = undefined;
 ...
 * @readonly
 */
ForbiddenErrorObject['TitleEnum'] = {
...
export default ForbiddenErrorObject;
