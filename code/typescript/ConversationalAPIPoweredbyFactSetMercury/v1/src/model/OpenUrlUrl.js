...
/**
 * The OpenUrlUrl model module.
 * @module model/OpenUrlUrl
 */
class OpenUrlUrl {
    /**
     * Constructs a new <code>OpenUrlUrl</code>.
     * Available url links
     * @alias module:model/OpenUrlUrl
     */
    constructor() { 
        
        OpenUrlUrl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenUrlUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenUrlUrl} obj Optional instance to populate.
     * @return {module:model/OpenUrlUrl} The populated <code>OpenUrlUrl</code> instance.
     */
 ...
 * @member {String} fdsup
 */
OpenUrlUrl.prototype['fdsup'] = undefined;

/**
 * Http link
 * @member {String} http
 */
OpenUrlUrl.prototype['http'] = undefined;
