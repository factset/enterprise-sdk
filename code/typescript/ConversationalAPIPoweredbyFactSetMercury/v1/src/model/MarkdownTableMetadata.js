...
/**
 * The MarkdownTableMetadata model module.
 * @module model/MarkdownTableMetadata
 */
class MarkdownTableMetadata {
    /**
     * Constructs a new <code>MarkdownTableMetadata</code>.
     * Metadata for the markdown formatted table
     * @alias module:model/MarkdownTableMetadata
     */
    constructor() { 
        
        MarkdownTableMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MarkdownTableMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarkdownTableMetadata} obj Optional instance to populate.
     * @return {module:model/MarkdownTableMetadata} The populated <code>MarkdownTableMetadata</code> instance.
     */
 ...
 */
MarkdownTableMetadata.prototype['displayName'] = undefined;
...
export default MarkdownTableMetadata;
