...
class PromptParameters {
     ...
     * @param template {String} Prompt template used to build a follow up prompt to send to FactSet Mercury
     * @param params {Array.<module:model/PromptParameter>} List of prompt parameters
     */
    constructor(template, params) { 
        
        PromptParameters.initialize(this, template, params);
    }
     ...
     */
    static initialize(obj, template, params) { 
