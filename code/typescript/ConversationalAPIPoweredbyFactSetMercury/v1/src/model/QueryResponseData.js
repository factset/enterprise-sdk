...
/**
 * The QueryResponseData model module.
 * @module model/QueryResponseData
 */
class QueryResponseData {
    /**
     * Constructs a new <code>QueryResponseData</code>.
     * Data object
     * @alias module:model/QueryResponseData
     * @param responseId {String} ID of the response generated by FactSet Mercury. **Note:** This ID cannot be used as a chatId or jobId.
     * @param data {Array.<module:model/FederationData>} Data array
     */
    constructor(responseId, data) { 
        
        QueryResponseData.initialize(this, responseId, data);
    }
     ...
     */
    static initialize(obj, responseId, data) { 
        obj['responseId'] = responseId;
        obj['data'] = data;
    }

    /**
     * Constructs a <code>QueryResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QueryResponseData} obj Optional instance to populate.
     * @return {module:model/QueryResponseData} The populated <code>QueryResponseData</code> instance.
     */
...
/**
 * ID of the response generated by FactSet Mercury. **Note:** This ID cannot be used as a chatId or jobId.
 * @member {String} responseId
 */
QueryResponseData.prototype['responseId'] = undefined;

/**
 * Data array
 * @member {Array.<module:model/FederationData>} data
 */
QueryResponseData.prototype['data'] = undefined;
...
export default QueryResponseData;
