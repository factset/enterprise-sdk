...
/**
 * The BadFeedbackRequestErrorObject model module.
 * @module model/BadFeedbackRequestErrorObject
 */
class BadFeedbackRequestErrorObject {
    /**
     * Constructs a new <code>BadFeedbackRequestErrorObject</code>.
     * Represents a single error from a bad query request, with error name and identifiers
     * @alias module:model/BadFeedbackRequestErrorObject
     * @param id {String} Id of error
     * @param title {module:model/BadFeedbackRequestErrorObject.TitleEnum} Title of error
     * @param code {module:model/BadFeedbackRequestErrorObject.CodeEnum} Code of error
     * @param detail {String} Details of error
     */
    constructor(id, title, code, detail) { 
        
        BadFeedbackRequestErrorObject.initialize(this, id, title, code, detail);
    }
    ...
    /**
     * Constructs a <code>BadFeedbackRequestErrorObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BadFeedbackRequestErrorObject} obj Optional instance to populate.
     * @return {module:model/BadFeedbackRequestErrorObject} The populated <code>BadFeedbackRequestErrorObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BadFeedbackRequestErrorObject();
 ...
 * @member {String} id
 */
BadFeedbackRequestErrorObject.prototype['id'] = undefined;

/**
 * Title of error
 * @member {module:model/BadFeedbackRequestErrorObject.TitleEnum} title
 */
BadFeedbackRequestErrorObject.prototype['title'] = undefined;

/**
 * Code of error
 * @member {module:model/BadFeedbackRequestErrorObject.CodeEnum} code
 */
BadFeedbackRequestErrorObject.prototype['code'] = undefined;

/**
 * Details of error
 * @member {String} detail
 */
BadFeedbackRequestErrorObject.prototype['detail'] = undefined;
 ...
 * @readonly
 */
BadFeedbackRequestErrorObject['TitleEnum'] = {
    ...
    /**
     * value: "Invalid Response ID"
     * @const
     */
    "Invalid Response ID": "Invalid Response ID"
};
 ...
 * @readonly
 */
BadFeedbackRequestErrorObject['CodeEnum'] = {
    ...
    /**
     * value: "conversational_api_invalidResponseId"
     * @const
     */
...
export default BadFeedbackRequestErrorObject;
