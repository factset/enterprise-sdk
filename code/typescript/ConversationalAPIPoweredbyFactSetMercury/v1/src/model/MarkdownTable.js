...
/**
 * The MarkdownTable model module.
 * @module model/MarkdownTable
 */
class MarkdownTable {
    /**
     * Constructs a new <code>MarkdownTable</code>.
     ...
     * @alias module:model/MarkdownTable
     * @param type {module:model/MarkdownTable.TypeEnum} Datatype contained in this data object
     * @param value {String} Markdown formatted table data
     */
    constructor(type, value) { 
        
        MarkdownTable.initialize(this, type, value);
    }
    ...
    /**
     * Constructs a <code>MarkdownTable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarkdownTable} obj Optional instance to populate.
     * @return {module:model/MarkdownTable} The populated <code>MarkdownTable</code> instance.
     */
