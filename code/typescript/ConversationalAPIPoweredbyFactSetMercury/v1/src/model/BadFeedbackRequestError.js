...
import BadFeedbackRequestErrorObject from './BadFeedbackRequestErrorObject';

/**
 * The BadFeedbackRequestError model module.
 * @module model/BadFeedbackRequestError
 */
class BadFeedbackRequestError {
    /**
     * Constructs a new <code>BadFeedbackRequestError</code>.
     * Wrapper containing metadata and appropriate errors as thrown by the API for a bad request to /feedback
     * @alias module:model/BadFeedbackRequestError
     * @param errors {Array.<module:model/BadFeedbackRequestErrorObject>} Array of BadFeedbackRequestErrorObject
     */
    constructor(errors) { 
        
        BadFeedbackRequestError.initialize(this, errors);
    }
    ...
    /**
     * Constructs a <code>BadFeedbackRequestError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BadFeedbackRequestError} obj Optional instance to populate.
     * @return {module:model/BadFeedbackRequestError} The populated <code>BadFeedbackRequestError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BadFeedbackRequestError();

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [BadFeedbackRequestErrorObject]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/BadFeedbackRequestErrorObject>} errors
 */
BadFeedbackRequestError.prototype['errors'] = undefined;
...
export default BadFeedbackRequestError;
