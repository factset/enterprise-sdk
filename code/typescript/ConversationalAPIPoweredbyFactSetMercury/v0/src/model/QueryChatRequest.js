...
import QueryChatRequestData from './QueryChatRequestData';

/**
 * The QueryChatRequest model module.
 * @module model/QueryChatRequest
 */
class QueryChatRequest {
    /**
     * Constructs a new <code>QueryChatRequest</code>.
     * Request body containing the query to be sent to the LLM
     * @alias module:model/QueryChatRequest
     * @param data {module:model/QueryChatRequestData} 
     */
    constructor(data) { 
        
        QueryChatRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>QueryChatRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QueryChatRequest} obj Optional instance to populate.
     * @return {module:model/QueryChatRequest} The populated <code>QueryChatRequest</code> instance.
     */
...
/**
 * @member {module:model/QueryChatRequestData} data
 */
QueryChatRequest.prototype['data'] = undefined;
...
export default QueryChatRequest;
