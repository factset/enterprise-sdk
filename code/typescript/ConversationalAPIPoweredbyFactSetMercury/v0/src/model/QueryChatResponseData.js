...
/**
 * The QueryChatResponseData model module.
 * @module model/QueryChatResponseData
 */
class QueryChatResponseData {
    /**
     * Constructs a new <code>QueryChatResponseData</code>.
     * Data object
     * @alias module:model/QueryChatResponseData
     */
    constructor() { 
        
        QueryChatResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QueryChatResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QueryChatResponseData} obj Optional instance to populate.
     * @return {module:model/QueryChatResponseData} The populated <code>QueryChatResponseData</code> instance.
     */
 ...
 */
QueryChatResponseData.prototype['chatId'] = undefined;

/**
 * Id of current query
 * @member {String} jobId
 */
QueryChatResponseData.prototype['jobId'] = undefined;

/**
 * status of current query
 * @member {module:model/QueryChatResponseData.StatusEnum} status
 */
QueryChatResponseData.prototype['status'] = undefined;
 ...
 * @readonly
 */
QueryChatResponseData['StatusEnum'] = {
...
export default QueryChatResponseData;
