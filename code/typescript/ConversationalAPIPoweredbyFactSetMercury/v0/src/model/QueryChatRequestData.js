...
/**
 * The QueryChatRequestData model module.
 * @module model/QueryChatRequestData
 */
class QueryChatRequestData {
    /**
     * Constructs a new <code>QueryChatRequestData</code>.
     * Data object
     * @alias module:model/QueryChatRequestData
     * @param query {String} Natural language query for FactSet data
     */
    constructor(query) { 
        
        QueryChatRequestData.initialize(this, query);
    }
    ...
    /**
     * Constructs a <code>QueryChatRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QueryChatRequestData} obj Optional instance to populate.
     * @return {module:model/QueryChatRequestData} The populated <code>QueryChatRequestData</code> instance.
     */
 ...
 * @member {String} query
 */
QueryChatRequestData.prototype['query'] = undefined;

/**
 * optional ID for the current ongoing conversation
 * @member {String} chatId
 */
QueryChatRequestData.prototype['chatId'] = undefined;
...
export default QueryChatRequestData;
