...
import AdaptiveCardData from './AdaptiveCardData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = AdaptiveCardData.constructFromObject(data['value']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/AdaptiveCardData} value
 */
