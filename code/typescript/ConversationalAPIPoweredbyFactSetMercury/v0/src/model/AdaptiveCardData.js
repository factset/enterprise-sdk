...
import AdaptiveCardBodyElement from './AdaptiveCardBodyElement';

/**
 * The AdaptiveCardData model module.
 * @module model/AdaptiveCardData
 */
class AdaptiveCardData {
    /**
     * Constructs a new <code>AdaptiveCardData</code>.
     * Data value for an Adaptive Card
     * @alias module:model/AdaptiveCardData
     * @extends Object
     * @param type {String} Type of card
     * @param version {String} Version of card
     */
    constructor(type, version) { 
        
        AdaptiveCardData.initialize(this, type, version);
    }
     ...
     */
    static initialize(obj, type, version) { 
        obj['type'] = type;
        obj['version'] = version;
    }

    /**
     * Constructs a <code>AdaptiveCardData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdaptiveCardData} obj Optional instance to populate.
     * @return {module:model/AdaptiveCardData} The populated <code>AdaptiveCardData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdaptiveCardData();
            ...
            if (data.hasOwnProperty('body')) {
                obj['body'] = ApiClient.convertToType(data['body'], [AdaptiveCardBodyElement]);
            }
        }
        return obj;
    }
 ...
 * @member {String} type
 */
AdaptiveCardData.prototype['type'] = undefined;

/**
 * Version of card
 * @member {String} version
 */
AdaptiveCardData.prototype['version'] = undefined;

/**
 * Array of Adaptive Card body elements
 * @member {Array.<module:model/AdaptiveCardBodyElement>} body
 */
AdaptiveCardData.prototype['body'] = undefined;
...
export default AdaptiveCardData;
