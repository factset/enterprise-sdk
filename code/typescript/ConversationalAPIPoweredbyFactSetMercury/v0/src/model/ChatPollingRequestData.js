...
/**
 * The ChatPollingRequestData model module.
 * @module model/ChatPollingRequestData
 */
class ChatPollingRequestData {
    /**
     * Constructs a new <code>ChatPollingRequestData</code>.
     * Data object
     * @alias module:model/ChatPollingRequestData
     */
    constructor() { 
        
        ChatPollingRequestData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChatPollingRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChatPollingRequestData} obj Optional instance to populate.
     * @return {module:model/ChatPollingRequestData} The populated <code>ChatPollingRequestData</code> instance.
     */
 ...
 * @member {String} jobId
 */
ChatPollingRequestData.prototype['jobId'] = undefined;
...
export default ChatPollingRequestData;
