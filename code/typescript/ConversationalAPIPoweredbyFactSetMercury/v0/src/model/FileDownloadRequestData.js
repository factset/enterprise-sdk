...
/**
 * The FileDownloadRequestData model module.
 * @module model/FileDownloadRequestData
 */
class FileDownloadRequestData {
    /**
     * Constructs a new <code>FileDownloadRequestData</code>.
     * Data object
     * @alias module:model/FileDownloadRequestData
     * @param fileId {String} Id of downloadable file
     */
    constructor(fileId) { 
        
        FileDownloadRequestData.initialize(this, fileId);
    }
    ...
    /**
     * Constructs a <code>FileDownloadRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileDownloadRequestData} obj Optional instance to populate.
     * @return {module:model/FileDownloadRequestData} The populated <code>FileDownloadRequestData</code> instance.
     */
 ...
 */
FileDownloadRequestData.prototype['fileId'] = undefined;
...
export default FileDownloadRequestData;
