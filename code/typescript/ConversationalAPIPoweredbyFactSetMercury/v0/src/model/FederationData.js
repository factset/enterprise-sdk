...
class FederationData {
     ...
     * @implements module:model/ResponseString
    ...
    constructor(type, value) { 
        ResponseString.initialize(this, type, value);AdaptiveCard.initialize(this);Table.initialize(this);NextStep.initialize(this);SuggestedPrompts.initialize(this);
    ...
    static constructFromObject(data, obj) {
        switch (data['type']) {
            ...
            case 'string':
              return ResponseString.constructFromObject(data, obj);
        }
        return obj;
    }
...
// Implement ResponseString interface:
/**
 * Datatype contained in this data object
