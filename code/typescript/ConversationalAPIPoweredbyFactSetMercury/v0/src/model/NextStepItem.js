...
class NextStepItem {
     ...
     * @param error {Boolean} Boolean representing if there was an error generating the downloadable file
     */
    constructor(error) { 
        OpenUrl.initialize(this);Download.initialize(this, error);
        NextStepItem.initialize(this, error);
    }
 ...
 */
NextStepItem.prototype['errorMessage'] = undefined;
 ...
 * @member {String} errorMessage
 */
Download.prototype['errorMessage'] = undefined;
