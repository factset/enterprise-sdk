...
import ChatPollingRequestData from './ChatPollingRequestData';

/**
 * The ChatPollingRequest model module.
 * @module model/ChatPollingRequest
 */
class ChatPollingRequest {
    /**
     * Constructs a new <code>ChatPollingRequest</code>.
     * Request body containing the chat job ID
     * @alias module:model/ChatPollingRequest
     */
    constructor() { 
        
        ChatPollingRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChatPollingRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChatPollingRequest} obj Optional instance to populate.
     * @return {module:model/ChatPollingRequest} The populated <code>ChatPollingRequest</code> instance.
     */
...
/**
 * @member {module:model/ChatPollingRequestData} data
 */
ChatPollingRequest.prototype['data'] = undefined;
...
export default ChatPollingRequest;
