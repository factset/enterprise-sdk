...
/**
 * The StatusPollResponseData model module.
 * @module model/StatusPollResponseData
 */
class StatusPollResponseData {
    /**
     * Constructs a new <code>StatusPollResponseData</code>.
     * Data object
     * @alias module:model/StatusPollResponseData
     */
    constructor() { 
        
        StatusPollResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatusPollResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusPollResponseData} obj Optional instance to populate.
     * @return {module:model/StatusPollResponseData} The populated <code>StatusPollResponseData</code> instance.
     */
 ...
 * @member {String} jobId
 */
StatusPollResponseData.prototype['jobId'] = undefined;

/**
 * Status of current query
 * @member {module:model/StatusPollResponseData.StatusEnum} status
 */
StatusPollResponseData.prototype['status'] = undefined;
 ...
 * @readonly
 */
StatusPollResponseData['StatusEnum'] = {
...
export default StatusPollResponseData;
