...
/**
 * The ResponseString model module.
 * @module model/ResponseString
 */
class ResponseString {
    /**
     * Constructs a new <code>ResponseString</code>.
     ...
     * @alias module:model/ResponseString
     * @param type {module:model/ResponseString.TypeEnum} Datatype contained in this data object
     * @param value {String} String containing chat response to the query
     */
    constructor(type, value) { 
        
        ResponseString.initialize(this, type, value);
    }
    ...
    /**
     * Constructs a <code>ResponseString</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseString} obj Optional instance to populate.
     * @return {module:model/ResponseString} The populated <code>ResponseString</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseString();
 ...
 * @member {module:model/ResponseString.TypeEnum} type
 */
ResponseString.prototype['type'] = undefined;

/**
 * String containing chat response to the query
 * @member {String} value
 */
ResponseString.prototype['value'] = undefined;
 ...
 */
ResponseString.prototype['citations'] = undefined;
