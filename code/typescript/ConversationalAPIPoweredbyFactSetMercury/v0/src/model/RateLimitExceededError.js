...
/**
 * The RateLimitExceededError model module.
 * @module model/RateLimitExceededError
 */
class RateLimitExceededError {
    /**
     * Constructs a new <code>RateLimitExceededError</code>.
     * Error response when rate limit has been exceeded.
     * @alias module:model/RateLimitExceededError
     */
    constructor() { 
        
        RateLimitExceededError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RateLimitExceededError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RateLimitExceededError} obj Optional instance to populate.
     * @return {module:model/RateLimitExceededError} The populated <code>RateLimitExceededError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RateLimitExceededError();
 ...
 * @member {module:model/RateLimitExceededError.MessageEnum} message
 */
RateLimitExceededError.prototype['message'] = undefined;

/**
 * Array of ErrorObject
 * @member {Array.<module:model/ErrorObject>} errors
 */
RateLimitExceededError.prototype['errors'] = undefined;
 ...
 * @readonly
 */
RateLimitExceededError['MessageEnum'] = {
