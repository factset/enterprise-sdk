...
/**
 * The AdaptiveCardBodyElement model module.
 * @module model/AdaptiveCardBodyElement
 */
class AdaptiveCardBodyElement {
    /**
     * Constructs a new <code>AdaptiveCardBodyElement</code>.
     * Individual Adaptive Card body element
     * @alias module:model/AdaptiveCardBodyElement
     * @extends Object
     * @param type {String} Type of element
     */
    constructor(type) { 
        
        AdaptiveCardBodyElement.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>AdaptiveCardBodyElement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdaptiveCardBodyElement} obj Optional instance to populate.
     * @return {module:model/AdaptiveCardBodyElement} The populated <code>AdaptiveCardBodyElement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdaptiveCardBodyElement();
 ...
 * @member {String} type
 */
AdaptiveCardBodyElement.prototype['type'] = undefined;
...
export default AdaptiveCardBodyElement;
