...
import FileDownloadRequestData from './FileDownloadRequestData';

/**
 * The FileDownloadRequest model module.
 * @module model/FileDownloadRequest
 */
class FileDownloadRequest {
    /**
     * Constructs a new <code>FileDownloadRequest</code>.
     * Request body containing the file ID for download
     * @alias module:model/FileDownloadRequest
     * @param data {module:model/FileDownloadRequestData} 
     */
    constructor(data) { 
        
        FileDownloadRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>FileDownloadRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileDownloadRequest} obj Optional instance to populate.
     * @return {module:model/FileDownloadRequest} The populated <code>FileDownloadRequest</code> instance.
     */
...
/**
 * @member {module:model/FileDownloadRequestData} data
 */
FileDownloadRequest.prototype['data'] = undefined;
...
export default FileDownloadRequest;
