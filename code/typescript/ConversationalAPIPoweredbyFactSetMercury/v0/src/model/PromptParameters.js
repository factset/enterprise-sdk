...
/**
 * The PromptParameters model module.
 * @module model/PromptParameters
 */
class PromptParameters {
    /**
     * Constructs a new <code>PromptParameters</code>.
     * Object containing prompt parameters
     * @alias module:model/PromptParameters
     */
    constructor() { 
        
        PromptParameters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromptParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromptParameters} obj Optional instance to populate.
     * @return {module:model/PromptParameters} The populated <code>PromptParameters</code> instance.
     */
 ...
 */
PromptParameters.prototype['template'] = undefined;

/**
 * List of prompt parameters
 * @member {Array.<module:model/PromptParameter>} params
 */
PromptParameters.prototype['params'] = undefined;
