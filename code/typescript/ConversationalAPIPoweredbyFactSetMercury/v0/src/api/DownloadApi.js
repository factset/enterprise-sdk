...
export default class DownloadApi {
    ...
    */
     ...
     * @param {module:model/FileDownloadRequest} fileDownloadRequest ID refers to the file ID in the NextStep action returned from the `/result` endpoint
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link File} and HTTP response
     */
    downloadFileWithHttpInfo(fileDownloadRequest) {
      let postBody = fileDownloadRequest;
      // verify the required parameter 'fileDownloadRequest' is set
      if (fileDownloadRequest === undefined || fileDownloadRequest === null) {
        throw new Error("Missing the required parameter 'fileDownloadRequest' when calling downloadFile");
      }
      ...
      let accepts = ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/json', 'text/plain'];
    ...
    downloadFile(fileDownloadRequest) {
      return this.downloadFileWithHttpInfo(fileDownloadRequest)
