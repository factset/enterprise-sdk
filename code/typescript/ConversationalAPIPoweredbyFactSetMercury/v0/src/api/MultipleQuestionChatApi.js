...
/**
* MultipleQuestionChat service.
* @module api/MultipleQuestionChatApi
*/
export default class MultipleQuestionChatApi {

    /**
    * Constructs a new MultipleQuestionChatApi. 
    * @alias module:api/MultipleQuestionChatApi
    * @class
    ...
    */
     ...
     * @param {module:model/ChatPollingRequest} chatPollingRequest ID representing the chat process for your query
     ...
     * @param {module:model/QueryChatRequest} queryChatRequest Natural language query for FactSet data
     ...
     */
    queryChatWithHttpInfo(queryChatRequest) {
      ...
      if (queryChatRequest === undefined || queryChatRequest === null) {
        throw new Error("Missing the required parameter 'queryChatRequest' when calling queryChat");
      }
     ...
     */
    queryChat(queryChatRequest) {
      return this.queryChatWithHttpInfo(queryChatRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
