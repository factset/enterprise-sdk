...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.uat.factset.com/conversational/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.uat.factset.com/conversational/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ConversationalAPIPoweredbyFactSetMercury/0.11.0 (${process.platform}; node ${process.version})`
        };
