...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/engines/fiab/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/engines/fiab/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FixedIncomeAnalyticsBatcher/0.22.2 (${process.platform}; node ${process.version})`
        };
