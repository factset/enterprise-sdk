...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api-sandbox.factset.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api-sandbox.factset.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FixedIncomeAnalyticsBatcher/0.22.1 (${process.platform}; node ${process.version})`
        };
