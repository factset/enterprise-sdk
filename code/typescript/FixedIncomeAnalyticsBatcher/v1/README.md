...
[![npm](https://img.shields.io/badge/npm-v0.22.1-orange)](https://www.npmjs.com/package/@factset/sdk-fixedincomeanalyticsbatcher/v/0.22.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-fixedincomeanalyticsbatcher@0.22.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-fixedincomeanalyticsbatcher@0.22.1
```
