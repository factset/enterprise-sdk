...
export default class DetailsApi {
    ...
    */
     ...
     * @param {Array.<String>} ids The requested list of security identifiers. Accepted ID types include Market Tickers,  SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.  
     * @param {module:model/String} periodicity Periodicity or frequency of the fiscal periods, where   * **ANN**  = Annual Original,   * **QTR**  = Quarterly 
     * @param {Date} startDate The date of the period requested in YYYY-MM-DD format.  Future dates (T+1) are not accepted in this endpoint. 
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DetailsSummaryResponse} and HTTP response
     */
    getDetailsSummaryWithHttpInfo(ids, periodicity, startDate, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getDetailsSummary");
      }
      // verify the required parameter 'periodicity' is set
      if (periodicity === undefined || periodicity === null) {
        throw new Error("Missing the required parameter 'periodicity' when calling getDetailsSummary");
      }
      // verify the required parameter 'startDate' is set
      if (startDate === undefined || startDate === null) {
        throw new Error("Missing the required parameter 'startDate' when calling getDetailsSummary");
      }
      ...
      let returnType = DetailsSummaryResponse;
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.currency Currency code for currency values. For a list of currency ISO codes, visit Online Assistant Page [OA1470](https://my.apps.factset.com/oa/pages/1470).  (default to 'LOCAL')
     * @return { Promise.< module:model/DetailsSummaryResponse > } a Promise, with data of type {@link module:model/DetailsSummaryResponse }
     */
    getDetailsSummary(ids, periodicity, startDate, opts) {
      return this.getDetailsSummaryWithHttpInfo(ids, periodicity, startDate, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
