...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/factset-dcs/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/factset-dcs/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetDebtCapitalStructure/1.0.1 (${process.platform}; node ${process.version})`
        };
