...
import LiquidityRequestBody from './LiquidityRequestBody';
...
class LiquidityRequest {
     ...
     * @param data {module:model/LiquidityRequestBody} 
     */
    constructor(data) { 
        
        LiquidityRequest.initialize(this, data);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data') && obj['data'] === undefined) {
                obj['data'] = LiquidityRequestBody.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/LiquidityRequestBody} data
 */
LiquidityRequest.prototype['data'] = undefined;
