...
/**
 * The DetailsSummaryResponse model module.
 * @module model/DetailsSummaryResponse
 */
class DetailsSummaryResponse {
    /**
     * Constructs a new <code>DetailsSummaryResponse</code>.
     * Details Summary Response
     * @alias module:model/DetailsSummaryResponse
     */
    constructor() { 
        
        DetailsSummaryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetailsSummaryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetailsSummaryResponse} obj Optional instance to populate.
     * @return {module:model/DetailsSummaryResponse} The populated <code>DetailsSummaryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetailsSummaryResponse();

            if (data.hasOwnProperty('data') && obj['data'] === undefined) {
                obj['data'] = ApiClient.convertToType(data['data'], [DetailsSummary]);
            }
...
/**
 * @member {Array.<module:model/DetailsSummary>} data
 */
DetailsSummaryResponse.prototype['data'] = undefined;
...
export default DetailsSummaryResponse;
