...
import DcsResponseFields from './DcsResponseFields';

/**
 * The DCSTotalsResponse model module.
 * @module model/DCSTotalsResponse
 */
class DCSTotalsResponse {
    /**
     * Constructs a new <code>DCSTotalsResponse</code>.
     * DCS Totals Response
     * @alias module:model/DCSTotalsResponse
     */
    constructor() { 
        
        DCSTotalsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DCSTotalsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DCSTotalsResponse} obj Optional instance to populate.
     * @return {module:model/DCSTotalsResponse} The populated <code>DCSTotalsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DCSTotalsResponse();

            if (data.hasOwnProperty('data') && obj['data'] === undefined) {
                obj['data'] = ApiClient.convertToType(data['data'], [DcsResponseFields]);
            }
...
/**
 * @member {Array.<module:model/DcsResponseFields>} data
 */
DCSTotalsResponse.prototype['data'] = undefined;
...
export default DCSTotalsResponse;
