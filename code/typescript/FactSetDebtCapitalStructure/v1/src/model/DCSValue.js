...
/**
 * The DCSValue model module.
 * @module model/DCSValue
 */
class DCSValue {
    /**
     * Constructs a new <code>DCSValue</code>.
     * Value of the data metric requested. Depending on the metric, can be either a string or a numeric (double) value. 
     * @alias module:model/DCSValue
     */
    constructor() { 
        
        DCSValue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DCSValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DCSValue} obj Optional instance to populate.
     * @return {module:model/DCSValue} The populated <code>DCSValue</code> instance.
     */
    static constructFromObject(data, obj) {
        // openApiType:number format:double
        if (typeof data === 'number') return data;
        if (typeof data === 'string') return data;
        throw new Error("Failed to construct DCSValue due to oneOf-schemas not matching the data: " + data);
    }
