...
import DCSRequestBody from './DCSRequestBody';

/**
 * The DCSRequest model module.
 * @module model/DCSRequest
 */
class DCSRequest {
    /**
     * Constructs a new <code>DCSRequest</code>.
     * DCS Totals Request
     * @alias module:model/DCSRequest
     * @param data {module:model/DCSRequestBody} 
     */
    constructor(data) { 
        
        DCSRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>DCSRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DCSRequest} obj Optional instance to populate.
     * @return {module:model/DCSRequest} The populated <code>DCSRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DCSRequest();

            if (data.hasOwnProperty('data') && obj['data'] === undefined) {
                obj['data'] = DCSRequestBody.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/DCSRequestBody} data
 */
DCSRequest.prototype['data'] = undefined;
