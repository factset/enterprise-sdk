...
/**
 * The DcsResponse model module.
 * @module model/DcsResponse
 */
class DcsResponse {
    /**
     * Constructs a new <code>DcsResponse</code>.
     * Debt Capital Structure Totals Response
     * @alias module:model/DcsResponse
     */
    constructor() { 
        
        DcsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DcsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DcsResponse} obj Optional instance to populate.
     * @return {module:model/DcsResponse} The populated <code>DcsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DcsResponse();
 ...
 */
DcsResponse.prototype['data'] = undefined;
