...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/open-optimizer/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/open-optimizer/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OPENOPTIMIZER/0.0.1 (${process.platform}; node ${process.version})`
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.factset.com/open-optimizer/v1",
