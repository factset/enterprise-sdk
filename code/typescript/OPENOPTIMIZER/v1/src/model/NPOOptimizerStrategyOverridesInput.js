...
/**
 * The NPOOptimizerStrategyOverridesInput model module.
 * @module model/NPOOptimizerStrategyOverridesInput
 */
class NPOOptimizerStrategyOverridesInput {
    /**
     * Constructs a new <code>NPOOptimizerStrategyOverridesInput</code>.
     * @alias module:model/NPOOptimizerStrategyOverridesInput
     */
    constructor() { 
        
        NPOOptimizerStrategyOverridesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NPOOptimizerStrategyOverridesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NPOOptimizerStrategyOverridesInput} obj Optional instance to populate.
     * @return {module:model/NPOOptimizerStrategyOverridesInput} The populated <code>NPOOptimizerStrategyOverridesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NPOOptimizerStrategyOverridesInput();
 ...
 */
NPOOptimizerStrategyOverridesInput.prototype['objective'] = undefined;

/**
 * @member {String} tax
 */
NPOOptimizerStrategyOverridesInput.prototype['tax'] = undefined;

/**
 * List of constraint type vs constraint id
 * @member {Object} constraints
 */
NPOOptimizerStrategyOverridesInput.prototype['constraints'] = undefined;

/**
 * Alpha
 * @member {String} alpha
 */
NPOOptimizerStrategyOverridesInput.prototype['alpha'] = undefined;

/**
 * Transaction cost
 * @member {String} transactionCost
 */
NPOOptimizerStrategyOverridesInput.prototype['transactionCost'] = undefined;
...
export default NPOOptimizerStrategyOverridesInput;
