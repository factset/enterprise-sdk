...
/**
 * The SettingsGlobalVarsResponse model module.
 * @module model/SettingsGlobalVarsResponse
 */
class SettingsGlobalVarsResponse {
    /**
     * Constructs a new <code>SettingsGlobalVarsResponse</code>.
     * @alias module:model/SettingsGlobalVarsResponse
     */
    constructor() { 
        
        SettingsGlobalVarsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SettingsGlobalVarsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SettingsGlobalVarsResponse} obj Optional instance to populate.
     * @return {module:model/SettingsGlobalVarsResponse} The populated <code>SettingsGlobalVarsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SettingsGlobalVarsResponse();
 ...
 */
SettingsGlobalVarsResponse.prototype['data'] = undefined;
...
export default SettingsGlobalVarsResponse;
