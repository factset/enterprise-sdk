...
/**
 * The NPOAccountInput model module.
 * @module model/NPOAccountInput
 */
class NPOAccountInput {
    /**
     * Constructs a new <code>NPOAccountInput</code>.
     * @alias module:model/NPOAccountInput
     */
    constructor() { 
        
        NPOAccountInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NPOAccountInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NPOAccountInput} obj Optional instance to populate.
     * @return {module:model/NPOAccountInput} The populated <code>NPOAccountInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NPOAccountInput();
 ...
 * @member {String} id
 */
NPOAccountInput.prototype['id'] = undefined;

/**
 * @member {module:model/OptimizerAccountOverridesInput} overrides
 */
NPOAccountInput.prototype['overrides'] = undefined;
...
export default NPOAccountInput;
