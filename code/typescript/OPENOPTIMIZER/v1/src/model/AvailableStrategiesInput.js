...
import AvailableStrategiesInputData from './AvailableStrategiesInputData';

/**
 * The AvailableStrategiesInput model module.
 * @module model/AvailableStrategiesInput
 */
class AvailableStrategiesInput {
    /**
     * Constructs a new <code>AvailableStrategiesInput</code>.
     * @alias module:model/AvailableStrategiesInput
     */
    constructor() { 
        
        AvailableStrategiesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AvailableStrategiesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AvailableStrategiesInput} obj Optional instance to populate.
     * @return {module:model/AvailableStrategiesInput} The populated <code>AvailableStrategiesInput</code> instance.
     */
...
/**
 * @member {module:model/AvailableStrategiesInputData} data
 */
AvailableStrategiesInput.prototype['data'] = undefined;
...
export default AvailableStrategiesInput;
