...
/**
 * The AvailableStrategiesInputData model module.
 * @module model/AvailableStrategiesInputData
 */
class AvailableStrategiesInputData {
    /**
     * Constructs a new <code>AvailableStrategiesInputData</code>.
     * @alias module:model/AvailableStrategiesInputData
     */
    constructor() { 
        
        AvailableStrategiesInputData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AvailableStrategiesInputData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AvailableStrategiesInputData} obj Optional instance to populate.
     * @return {module:model/AvailableStrategiesInputData} The populated <code>AvailableStrategiesInputData</code> instance.
     */
 ...
 * @member {Array.<String>} directory
 */
AvailableStrategiesInputData.prototype['directory'] = undefined;
...
export default AvailableStrategiesInputData;
