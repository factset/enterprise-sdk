...
/**
 * The AFIOptimizationParametersRequest model module.
 * @module model/AFIOptimizationParametersRequest
 */
class AFIOptimizationParametersRequest {
    /**
     * Constructs a new <code>AFIOptimizationParametersRequest</code>.
     * @alias module:model/AFIOptimizationParametersRequest
     */
    constructor() { 
        
        AFIOptimizationParametersRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AFIOptimizationParametersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AFIOptimizationParametersRequest} obj Optional instance to populate.
     * @return {module:model/AFIOptimizationParametersRequest} The populated <code>AFIOptimizationParametersRequest</code> instance.
     */
 ...
 */
AFIOptimizationParametersRequest.prototype['data'] = undefined;
...
export default AFIOptimizationParametersRequest;
