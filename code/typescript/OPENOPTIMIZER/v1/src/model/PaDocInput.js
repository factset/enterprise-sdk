...
/**
 * The PaDocInput model module.
 * @module model/PaDocInput
 */
class PaDocInput {
    /**
     * Constructs a new <code>PaDocInput</code>.
     * @alias module:model/PaDocInput
     * @param id {String} PA document path
     */
    constructor(id) { 
        
        PaDocInput.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PaDocInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaDocInput} obj Optional instance to populate.
     * @return {module:model/PaDocInput} The populated <code>PaDocInput</code> instance.
     */
 ...
 * @member {String} id
 */
PaDocInput.prototype['id'] = undefined;
