...
/**
 * The ReportOutputTypeObject model module.
 * @module model/ReportOutputTypeObject
 */
class ReportOutputTypeObject {
    /**
     * Constructs a new <code>ReportOutputTypeObject</code>.
     * @alias module:model/ReportOutputTypeObject
     * @param identifierType {module:model/ReportOutputTypeObject.IdentifierTypeEnum} Identifier type
     */
    constructor(identifierType) { 
        
        ReportOutputTypeObject.initialize(this, identifierType);
    }
    ...
    /**
     * Constructs a <code>ReportOutputTypeObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportOutputTypeObject} obj Optional instance to populate.
     * @return {module:model/ReportOutputTypeObject} The populated <code>ReportOutputTypeObject</code> instance.
     */
...
/**
 * Identifier type
 * @member {module:model/ReportOutputTypeObject.IdentifierTypeEnum} identifierType
 */
ReportOutputTypeObject.prototype['identifierType'] = undefined;
 ...
 * @readonly
 */
ReportOutputTypeObject['IdentifierTypeEnum'] = {
...
export default ReportOutputTypeObject;
