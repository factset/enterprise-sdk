...
/**
 * The AXPAccountInput model module.
 * @module model/AXPAccountInput
 */
class AXPAccountInput {
    /**
     * Constructs a new <code>AXPAccountInput</code>.
     * @alias module:model/AXPAccountInput
     */
    constructor() { 
        
        AXPAccountInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AXPAccountInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AXPAccountInput} obj Optional instance to populate.
     * @return {module:model/AXPAccountInput} The populated <code>AXPAccountInput</code> instance.
     */
 ...
 * @member {String} id
 */
AXPAccountInput.prototype['id'] = undefined;

/**
 * @member {module:model/OptimizerAccountOverridesInput} overrides
 */
AXPAccountInput.prototype['overrides'] = undefined;
...
export default AXPAccountInput;
