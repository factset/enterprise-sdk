...
/**
 * The BPMOptimizationParametersRequest model module.
 * @module model/BPMOptimizationParametersRequest
 */
class BPMOptimizationParametersRequest {
    /**
     * Constructs a new <code>BPMOptimizationParametersRequest</code>.
     * @alias module:model/BPMOptimizationParametersRequest
     */
    constructor() { 
        
        BPMOptimizationParametersRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BPMOptimizationParametersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BPMOptimizationParametersRequest} obj Optional instance to populate.
     * @return {module:model/BPMOptimizationParametersRequest} The populated <code>BPMOptimizationParametersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BPMOptimizationParametersRequest();
 ...
 */
BPMOptimizationParametersRequest.prototype['data'] = undefined;
...
export default BPMOptimizationParametersRequest;
