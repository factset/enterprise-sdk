...
/**
 * The AFIAccountInput model module.
 * @module model/AFIAccountInput
 */
class AFIAccountInput {
    /**
     * Constructs a new <code>AFIAccountInput</code>.
     * @alias module:model/AFIAccountInput
     */
    constructor() { 
        
        AFIAccountInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AFIAccountInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AFIAccountInput} obj Optional instance to populate.
     * @return {module:model/AFIAccountInput} The populated <code>AFIAccountInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AFIAccountInput();
 ...
 * @member {String} id
 */
AFIAccountInput.prototype['id'] = undefined;

/**
 * @member {module:model/OptimizerAccountOverridesInput} overrides
 */
AFIAccountInput.prototype['overrides'] = undefined;
...
export default AFIAccountInput;
