...
/**
 * The FPOObjectiveInput model module.
 * @module model/FPOObjectiveInput
 */
class FPOObjectiveInput {
    /**
     * Constructs a new <code>FPOObjectiveInput</code>.
     * @alias module:model/FPOObjectiveInput
     */
    constructor() { 
        
        FPOObjectiveInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FPOObjectiveInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FPOObjectiveInput} obj Optional instance to populate.
     * @return {module:model/FPOObjectiveInput} The populated <code>FPOObjectiveInput</code> instance.
     */
 ...
 * @member {String} id
 */
FPOObjectiveInput.prototype['id'] = undefined;

/**
 * @member {Object.<String, module:model/EnabledEnum>} terms
 */
FPOObjectiveInput.prototype['terms'] = undefined;
...
export default FPOObjectiveInput;
