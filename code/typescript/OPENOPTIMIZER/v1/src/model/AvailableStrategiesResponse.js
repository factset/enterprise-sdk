...
/**
 * The AvailableStrategiesResponse model module.
 * @module model/AvailableStrategiesResponse
 */
class AvailableStrategiesResponse {
    /**
     * Constructs a new <code>AvailableStrategiesResponse</code>.
     * @alias module:model/AvailableStrategiesResponse
     */
    constructor() { 
        
        AvailableStrategiesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AvailableStrategiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AvailableStrategiesResponse} obj Optional instance to populate.
     * @return {module:model/AvailableStrategiesResponse} The populated <code>AvailableStrategiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AvailableStrategiesResponse();
 ...
 */
AvailableStrategiesResponse.prototype['data'] = undefined;
...
export default AvailableStrategiesResponse;
