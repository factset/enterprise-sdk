...
/**
 * The ResultResponseDataArchive model module.
 * @module model/ResultResponseDataArchive
 */
class ResultResponseDataArchive {
    /**
     * Constructs a new <code>ResultResponseDataArchive</code>.
     * @alias module:model/ResultResponseDataArchive
     */
    constructor() { 
        
        ResultResponseDataArchive.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResultResponseDataArchive</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResultResponseDataArchive} obj Optional instance to populate.
     * @return {module:model/ResultResponseDataArchive} The populated <code>ResultResponseDataArchive</code> instance.
     */
 ...
 */
ResultResponseDataArchive.prototype['message'] = undefined;

/**
 * Location of the archived optimal account.
 * @member {String} optimalAccount
 */
ResultResponseDataArchive.prototype['optimalAccount'] = undefined;
...
export default ResultResponseDataArchive;
