...
import InlineResponse20094DataAsks from './InlineResponse20094DataAsks';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('asks')) {
                obj['asks'] = ApiClient.convertToType(data['asks'], [InlineResponse20094DataAsks]);
            }
            if (data.hasOwnProperty('bids')) {
                obj['bids'] = ApiClient.convertToType(data['bids'], [InlineResponse20094DataAsks]);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20094Data.prototype['idNotation'] = undefined;

/**
 * Identifier used in the request.
 * @member {String} sourceIdentifier
 */
InlineResponse20094Data.prototype['sourceIdentifier'] = undefined;

/**
 * Quality of the price.
 * @member {module:model/InlineResponse20094Data.QualityEnum} quality
 */
InlineResponse20094Data.prototype['quality'] = undefined;

/**
 * Ask entries of the full orderbook.
 * @member {Array.<module:model/InlineResponse20094DataAsks>} asks
 */
InlineResponse20094Data.prototype['asks'] = undefined;

/**
 * Bid entries of the full orderbook.
 * @member {Array.<module:model/InlineResponse20094DataAsks>} bids
 */
InlineResponse20094Data.prototype['bids'] = undefined;
 ...
 * @readonly
 */
InlineResponse20094Data['QualityEnum'] = {
