...
import PostNotationSearchByTextRequestDataAssetClass from './PostNotationSearchByTextRequestDataAssetClass';
import PostNotationSearchByTextRequestDataInstrumentCategory from './PostNotationSearchByTextRequestDataInstrumentCategory';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('assetClass')) {
                obj['assetClass'] = PostNotationSearchByTextRequestDataAssetClass.constructFromObject(data['assetClass']);
            }
            if (data.hasOwnProperty('instrumentCategory')) {
                obj['instrumentCategory'] = PostNotationSearchByTextRequestDataInstrumentCategory.constructFromObject(data['instrumentCategory']);
            }
...
/**
 * @member {module:model/PostNotationSearchByTextRequestDataAssetClass} assetClass
 */
PostNotationSearchByTextRequestData.prototype['assetClass'] = undefined;

/**
 * @member {module:model/PostNotationSearchByTextRequestDataInstrumentCategory} instrumentCategory
 */
PostNotationSearchByTextRequestData.prototype['instrumentCategory'] = undefined;
