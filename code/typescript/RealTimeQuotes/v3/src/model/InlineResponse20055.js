...
import InlineResponse20055Data from './InlineResponse20055Data';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = InlineResponse20055Data.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/InlineResponse20055Data} data
 */
