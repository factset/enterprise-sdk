...
/**
 * The InlineResponse20067Nsin model module.
 * @module model/InlineResponse20067Nsin
 */
class InlineResponse20067Nsin {
    /**
     * Constructs a new <code>InlineResponse20067Nsin</code>.
     * NSIN data of the instrument.
     * @alias module:model/InlineResponse20067Nsin
     */
    constructor() { 
        
        InlineResponse20067Nsin.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20067Nsin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20067Nsin} obj Optional instance to populate.
     * @return {module:model/InlineResponse20067Nsin} The populated <code>InlineResponse20067Nsin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20067Nsin();
 ...
 * @member {String} wkn
 */
InlineResponse20067Nsin.prototype['wkn'] = undefined;
 ...
 * @member {String} valor
 */
InlineResponse20067Nsin.prototype['valor'] = undefined;
 ...
 * @member {String} cusip
 */
InlineResponse20067Nsin.prototype['cusip'] = undefined;
...
export default InlineResponse20067Nsin;
