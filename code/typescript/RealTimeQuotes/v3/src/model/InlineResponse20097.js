...
import InlineResponse20097Data from './InlineResponse20097Data';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20097Data]);
            }
...
/**
 * List of instruments.
 * @member {Array.<module:model/InlineResponse20097Data>} data
 */
InlineResponse20097.prototype['data'] = undefined;

/**
 * @member {module:model/InlineResponse20036Meta} meta
 */
InlineResponse20097.prototype['meta'] = undefined;
