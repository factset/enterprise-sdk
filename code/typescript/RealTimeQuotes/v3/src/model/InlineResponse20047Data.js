...
import InlineResponse20047DataDatasets from './InlineResponse20047DataDatasets';
...
class InlineResponse20047Data {
     ...
     * List of categories assigned to a specific instrument.
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('datasets')) {
                obj['datasets'] = ApiClient.convertToType(data['datasets'], [InlineResponse20047DataDatasets]);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20047Data.prototype['idInstrument'] = undefined;

/**
 * Identifier used in the request.
 * @member {String} sourceIdentifier
 */
InlineResponse20047Data.prototype['sourceIdentifier'] = undefined;

/**
 * List of datasets with assigned categories.
 * @member {Array.<module:model/InlineResponse20047DataDatasets>} datasets
 */
InlineResponse20047Data.prototype['datasets'] = undefined;
