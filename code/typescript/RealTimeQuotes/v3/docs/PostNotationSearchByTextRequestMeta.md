# realtimequotes.PostNotationSearchByTextRequestMeta
...
* `match.score` (value: `"match.score"`)

* `-match.score` (value: `"-match.score"`)

* `averageIndicativeTradingValue30TD` (value: `"averageIndicativeTradingValue30TD"`)
