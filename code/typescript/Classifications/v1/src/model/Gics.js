...
class Gics {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('gicsSubInudstryNumber')) {
                obj['gicsSubInudstryNumber'] = ApiClient.convertToType(data['gicsSubInudstryNumber'], 'String');
            }
...
/**
 * GICS Industry Number.
 * @member {String} gicsSubInudstryNumber
 */
Gics.prototype['gicsSubInudstryNumber'] = undefined;
