...
[![npm](https://img.shields.io/badge/npm-v0.24.1-orange)](https://www.npmjs.com/package/@factset/sdk-procuretopayapiscim/v/0.24.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-procuretopayapiscim@0.24.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-procuretopayapiscim@0.24.1
```
...
## Documentation for Models
 ...
 - [procuretopayapiscim.ErrorUrnScimSchemasExtensionFactSetCore10Error](docs/ErrorUrnScimSchemasExtensionFactSetCore10Error.md)
 ...
 - [procuretopayapiscim.GroupResourceUrnScimSchemasExtensionFactSetCore10Group](docs/GroupResourceUrnScimSchemasExtensionFactSetCore10Group.md)
