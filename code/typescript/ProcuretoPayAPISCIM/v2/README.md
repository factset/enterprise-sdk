...
[![npm](https://img.shields.io/badge/npm-v0.23.3-orange)](https://www.npmjs.com/package/@factset/sdk-procuretopayapiscim/v/0.23.3)
...
```shell
npm install @factset/sdk-utils @factset/sdk-procuretopayapiscim@0.23.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-procuretopayapiscim@0.23.3
```
