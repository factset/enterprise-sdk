# procuretopayapiscim.ProductsApi
...
> ProductResource getProduct(id, opts)
...
```javascript
const { ApiClient, ProductsApi } = require('@factset/sdk-procuretopayapiscim');
...
// Call api endpoint
apiInstance.getProduct(id, opts).then(
  data => {
...
> ProductResourceList getProducts(opts)
