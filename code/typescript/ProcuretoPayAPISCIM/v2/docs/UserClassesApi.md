...
> UserClassResource getUserClass(id, opts)
...
// Call api endpoint
apiInstance.getUserClass(id, opts).then(
  data => {
...
> UserClassResourceList getUserClasses(opts)
...
// Call api endpoint
apiInstance.getUserClasses(opts).then(
  data => {
