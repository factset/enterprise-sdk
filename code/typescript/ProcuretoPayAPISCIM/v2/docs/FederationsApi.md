...
> FederationResource getFederation(id, opts)
...
> FederationResource replaceFederation(id, federationResource, opts)
...
// Call api endpoint
apiInstance.replaceFederation(id, federationResource, opts).then(
  data => {
