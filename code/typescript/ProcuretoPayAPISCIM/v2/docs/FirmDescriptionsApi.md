# procuretopayapiscim.FirmDescriptionsApi
...
> FirmDescriptionResourceList firmDescriptionsGet(opts)
...
// Call api endpoint
apiInstance.firmDescriptionsGet(opts).then(
  data => {
...
// Call api endpoint
apiInstance.firmDescriptionsIdGet(id).then(
  data => {
