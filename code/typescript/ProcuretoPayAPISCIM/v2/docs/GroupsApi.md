...
> GroupResource getGroup(id, opts)
...
// Call api endpoint
apiInstance.getGroup(id, opts).then(
  data => {
...
> GroupResource replaceGroup(id, groupResource, opts)
...
// Call api endpoint
apiInstance.replaceGroup(id, groupResource, opts).then(
  data => {
