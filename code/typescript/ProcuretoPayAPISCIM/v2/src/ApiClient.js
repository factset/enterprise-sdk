...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/scim/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/scim/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ProcuretoPayAPISCIM/0.23.2 (${process.platform}; node ${process.version})`
        };
