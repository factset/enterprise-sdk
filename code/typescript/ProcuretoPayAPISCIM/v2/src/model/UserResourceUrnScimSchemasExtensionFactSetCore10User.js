...
import ProductResourceReferenceWithRapidActivationInfo from './ProductResourceReferenceWithRapidActivationInfo';
...
class UserResourceUrnScimSchemasExtensionFactSetCore10User {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('department') && obj['department'] === undefined) {
 ...
 */
UserResourceUrnScimSchemasExtensionFactSetCore10User.prototype['department'] = undefined;
 ...
 * @member {Array.<module:model/ProductResourceReferenceWithRapidActivationInfo>} products
 */
