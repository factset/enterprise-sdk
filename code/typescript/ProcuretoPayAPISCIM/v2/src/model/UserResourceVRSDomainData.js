...
class UserResourceVRSDomainData {
     ...
     */
    constructor(domainCode, isAdministrator) { 
        
        UserResourceVRSDomainData.initialize(this, domainCode, isAdministrator);
    }
     ...
     */
    static initialize(obj, domainCode, isAdministrator) { 
