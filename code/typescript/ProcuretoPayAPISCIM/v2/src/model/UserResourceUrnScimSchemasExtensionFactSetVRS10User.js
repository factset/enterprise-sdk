...
import UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData from './UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('domainData')) {
                obj['domainData'] = ApiClient.convertToType(data['domainData'], [UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/UserResourceUrnScimSchemasExtensionFactSetVRS10UserDomainData>} domainData
 */
