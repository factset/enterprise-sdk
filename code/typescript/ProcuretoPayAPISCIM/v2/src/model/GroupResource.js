...
import GroupResourceUrnScimSchemasExtensionFactSetCore10Group from './GroupResourceUrnScimSchemasExtensionFactSetCore10Group';
...
class GroupResource {
     ...
     * @param displayName {String} A human-readable name for the Group.
     */
    constructor(displayName) { 
        
        GroupResource.initialize(this, displayName);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('urn:scim:schemas:extension:FactSet:Core:1.0:Group') && obj['urn:scim:schemas:extension:FactSet:Core:1.0:Group'] === undefined) {
                obj['urn:scim:schemas:extension:FactSet:Core:1.0:Group'] = GroupResourceUrnScimSchemasExtensionFactSetCore10Group.constructFromObject(data['urn:scim:schemas:extension:FactSet:Core:1.0:Group']);
            }
...
/**
 * @member {module:model/GroupResourceUrnScimSchemasExtensionFactSetCore10Group} urn:scim:schemas:extension:FactSet:Core:1.0:Group
 */
GroupResource.prototype['urn:scim:schemas:extension:FactSet:Core:1.0:Group'] = undefined;
