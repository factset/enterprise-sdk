...
import ErrorUrnScimSchemasExtensionFactSetCore10Error from './ErrorUrnScimSchemasExtensionFactSetCore10Error';
...
class Error {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scimType') && obj['scimType'] === undefined) {
            ...
            if (data.hasOwnProperty('urn:scim:schemas:extension:FactSet:Core:1.0:Error') && obj['urn:scim:schemas:extension:FactSet:Core:1.0:Error'] === undefined) {
                obj['urn:scim:schemas:extension:FactSet:Core:1.0:Error'] = ErrorUrnScimSchemasExtensionFactSetCore10Error.constructFromObject(data['urn:scim:schemas:extension:FactSet:Core:1.0:Error']);
            }
...
/**
 * @member {module:model/ErrorUrnScimSchemasExtensionFactSetCore10Error} urn:scim:schemas:extension:FactSet:Core:1.0:Error
 */
Error.prototype['urn:scim:schemas:extension:FactSet:Core:1.0:Error'] = undefined;
