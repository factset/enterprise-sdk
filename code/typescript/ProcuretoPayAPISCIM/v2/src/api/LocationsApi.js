...
export default class LocationsApi {
    ...
    */
     ...
     */
    createLocationWithHttpInfo(locationResource) {
     ...
     */
    createLocation(locationResource) {
      return this.createLocationWithHttpInfo(locationResource)
     ...
     */
    getLocation(id) {
      return this.getLocationWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/LocationResource} and HTTP response
     */
    replaceLocationWithHttpInfo(id, locationResource) {
      let postBody = locationResource;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return { Promise.< module:model/LocationResource > } a Promise, with data of type {@link module:model/LocationResource }
     */
    replaceLocation(id, locationResource) {
      return this.replaceLocationWithHttpInfo(id, locationResource)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
