...
export default class UserPositionsApi {
    ...
    */
     ...
     */
    userPositionsGetWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    userPositionsGet(opts) {
      return this.userPositionsGetWithHttpInfo(opts)
     ...
     */
    userPositionsIdGetWithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling userPositionsIdGet");
      }
     ...
     */
    userPositionsIdGet(id) {
      return this.userPositionsIdGetWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
