...
export default class FederationsApi {
    ...
    */
     ...
     */
    getFederationWithHttpInfo(id, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getFederation(id, opts) {
      return this.getFederationWithHttpInfo(id, opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FederationResource} and HTTP response
     */
    replaceFederationWithHttpInfo(id, federationResource, opts) {
      opts = opts || {};
     ...
     * @return { Promise.< module:model/FederationResource > } a Promise, with data of type {@link module:model/FederationResource }
     */
    replaceFederation(id, federationResource, opts) {
      return this.replaceFederationWithHttpInfo(id, federationResource, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
