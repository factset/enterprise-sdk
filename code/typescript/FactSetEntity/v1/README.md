...
[![npm](https://img.shields.io/npm/v/@factset/sdk-factsetentity)](https://www.npmjs.com/package/@factset/sdk-factsetentity)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetentity@1.1.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetentity@1.1.2
```
