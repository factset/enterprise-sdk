...
**privateEntityFlag** | **Number** | Returns 1 if the entity is a Private Company, otherwise, 0. | [optional] 
**publicEntityFlag** | **Number** | Returns 1 if the entity is a Public Company, otherwise, 0. | [optional] 
...
**incorporationDate** | **Date** | Year the entity was incorporated in YYYY-MM-DD format. | [optional] 
