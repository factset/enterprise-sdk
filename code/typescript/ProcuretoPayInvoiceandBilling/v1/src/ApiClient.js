...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api-sandbox.factset.com/procuretopay/invoice-and-billing') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api-sandbox.factset.com/procuretopay/invoice-and-billing
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ProcuretoPayInvoiceandBilling/0.1.1 (${process.platform}; node ${process.version})`
        };
