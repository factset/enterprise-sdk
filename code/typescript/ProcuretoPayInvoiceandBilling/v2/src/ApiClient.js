...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/procure-to-pay/invoice-and-billing/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/procure-to-pay/invoice-and-billing/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ProcuretoPayInvoiceandBilling/0.2.0 (${process.platform}; node ${process.version})`
        };
