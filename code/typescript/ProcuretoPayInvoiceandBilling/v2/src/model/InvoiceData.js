...
class InvoiceData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('billingAdjustmentsTotal') && obj['billingAdjustmentsTotal'] === undefined) {
            ...
            if (data.hasOwnProperty('billingAddressDetails') && obj['billingAddressDetails'] === undefined) {
