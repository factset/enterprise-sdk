...
import OwnershipSummary from './model/OwnershipSummary';
import OwnershipSummaryRequest from './model/OwnershipSummaryRequest';
import OwnershipSummaryRequestData from './model/OwnershipSummaryRequestData';
...
import ShortInterest from './model/ShortInterest';
import ShortInterestRequest from './model/ShortInterestRequest';
import ShortInterestRequestData from './model/ShortInterestRequestData';
...
import GetOwnershipCompanyReportsSummaryResponseWrapper from './api/CompanyReportsApi';
import PostOwnershipCompanyReportsSummaryResponseWrapper from './api/CompanyReportsApi';
import FundHoldingsApi from './api/FundHoldingsApi';
import GetOwnershipHoldingsResponseWrapper from './api/FundHoldingsApi';
import PostOwnershipHoldingsResponseWrapper from './api/FundHoldingsApi';
import SecurityHoldersApi from './api/SecurityHoldersApi';
import GetSecurityHoldersResponseWrapper from './api/SecurityHoldersApi';
import PostSecurityHoldersResponseWrapper from './api/SecurityHoldersApi';
import ShortInterestApi from './api/ShortInterestApi';
import TransactionsApi from './api/TransactionsApi';
import GetOwnershipInsiderTransactionsResponseWrapper from './api/TransactionsApi';
import GetOwnershipInstitutionalTransactionsResponseWrapper from './api/TransactionsApi';
import PostOwnershipInsiderTransactionsResponseWrapper from './api/TransactionsApi';
import PostOwnershipInstitutionalTransactionsResponseWrapper from './api/TransactionsApi';
...
export {
    ...
    /**
     * The OwnershipSummary model constructor.
     * @property {module:model/OwnershipSummary}
     */
    OwnershipSummary,

    /**
     * The OwnershipSummaryRequest model constructor.
     * @property {module:model/OwnershipSummaryRequest}
     */
    OwnershipSummaryRequest,

    /**
     * The OwnershipSummaryRequestData model constructor.
     * @property {module:model/OwnershipSummaryRequestData}
     */
    OwnershipSummaryRequestData,

    /**
     * The OwnershipSummaryResponse model constructor.
     * @property {module:model/OwnershipSummaryResponse}
     */
    ...
    /**
     * The ShortInterest model constructor.
     * @property {module:model/ShortInterest}
     */
    ShortInterest,

    /**
     * The ShortInterestRequest model constructor.
     * @property {module:model/ShortInterestRequest}
     */
    ShortInterestRequest,

    /**
     * The ShortInterestRequestData model constructor.
     * @property {module:model/ShortInterestRequestData}
     */
    ShortInterestRequestData,

    /**
     * The ShortInterestResponse model constructor.
     * @property {module:model/ShortInterestResponse}
     */
    ...
    */
    ...
    /**
    * The GetOwnershipCompanyReportsSummary response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    GetOwnershipCompanyReportsSummaryResponseWrapper,

    /**
    * The PostOwnershipCompanyReportsSummary response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    ...
    */
    ...
    /**
    * The GetOwnershipHoldings response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    GetOwnershipHoldingsResponseWrapper,

    /**
    * The PostOwnershipHoldings response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    ...
    */
    ...
    /**
    * The GetSecurityHolders response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    GetSecurityHoldersResponseWrapper,

    /**
    * The PostSecurityHolders response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    PostSecurityHoldersResponseWrapper,

    /**
    * The ShortInterestApi service constructor.
    * @property {module:api/ShortInterestApi}
    */
    ShortInterestApi,
    ...
    */
    ...
    /**
    * The GetOwnershipInsiderTransactions response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    GetOwnershipInsiderTransactionsResponseWrapper,

    /**
    * The GetOwnershipInstitutionalTransactions response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    GetOwnershipInstitutionalTransactionsResponseWrapper,

    /**
    * The PostOwnershipInsiderTransactions response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
    PostOwnershipInsiderTransactionsResponseWrapper,

    /**
    * The PostOwnershipInstitutionalTransactions response wrapper.
    * @property {module:GetCalculationStatusByIdResponseWrapper}
    */
