...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/factset-ownership/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/factset-ownership/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetOwnership/2.5.0 (${process.platform}; node ${process.version})`
        };
