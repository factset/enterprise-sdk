...
class BatchResult {
     ...
     * @implements module:model/OwnershipSummary
     */
    constructor() { 
        FundHolding.initialize(this);SecurityHolders.initialize(this);InsiderTransactions.initialize(this);InstitutionalTransactions.initialize(this);OwnershipSummary.initialize(this);
    ...
    static constructFromObject(data, obj) {
        switch (data['type']) {
            ...
            case 'ownershipSummary':
              return OwnershipSummary.constructFromObject(data, obj);
 ...
 */
BatchResult.prototype['percentInstitutionalOutstanding'] = undefined;
 ...
 */
BatchResult.prototype['percentTopTenInstitutional'] = undefined;

/**
 * Position held by insiders as a percentage of total outstanding shares.
 * @member {Number} percentInsiderOutstanding
 */
BatchResult.prototype['percentInsiderOutstanding'] = undefined;
 ...
 * @member {String} transactionCode
 */
InsiderTransactions.prototype['transactionCode'] = undefined;
/**
 * Returns the description of the transaction detail code for the transaction.
 * @member {String} transactionCodeDescription
 */
InsiderTransactions.prototype['transactionCodeDescription'] = undefined;
/**
 * Returns the form types for the transactions that occurred between the specified start and end dates.
 * @member {String} formType
 */
...
// Implement OwnershipSummary interface:
/**
 * Identifier that was used in the request.
 * @member {String} requestId
 */
