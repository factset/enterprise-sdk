...
/**
* Enum class PeriodOfMeasure.
* @enum {}
* @readonly
*/
export default class PeriodOfMeasure {
    ...
    /**
    * Returns a <code>PeriodOfMeasure</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PeriodOfMeasure} The enum <code>PeriodOfMeasure</code> value.
    */
