...
[![npm](https://img.shields.io/badge/npm-v2.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetownership/v/2.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetownership@2.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetownership@2.2.0
```
...
*factsetownership.TransactionsApi* | [**getOwnershipInsiderTransactions**](docs/TransactionsApi.md#getOwnershipInsiderTransactions) | **GET** /factset-ownership/v1/transactions/insider | Get insider transactions details for a list of requested identifiers.
*factsetownership.TransactionsApi* | [**getOwnershipInstitutionalTransactions**](docs/TransactionsApi.md#getOwnershipInstitutionalTransactions) | **GET** /factset-ownership/v1/transactions/institutional | Get institutional transaction details for a list of requested identifiers.
*factsetownership.TransactionsApi* | [**postOwnershipInsiderTransactions**](docs/TransactionsApi.md#postOwnershipInsiderTransactions) | **POST** /factset-ownership/v1/transactions/insider | Get insider transactions details for a list of requested identifiers.
*factsetownership.TransactionsApi* | [**postOwnershipInstituionalTransactions**](docs/TransactionsApi.md#postOwnershipInstituionalTransactions) | **POST** /factset-ownership/v1/transactions/institutional | Gets institutional transaction details for a list of requested identifiers.
