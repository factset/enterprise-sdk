...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/factset-pevc/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/factset-pevc/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetPrivateEquityandVentureCapital/1.0.0 (${process.platform}; node ${process.version})`
        };
