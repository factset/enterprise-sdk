...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/engines/quant/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/engines/quant/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/QuantEngine/2.0.0 (${process.platform}; node ${process.version})`
        };
