# bondsapifordigitalportals.InlineResponse200Data
...
**nominalValue** | **Number** | Nominal value for per-unit quoted debt instruments. Debt instruments quoted in percent do not have a nominal value per se. | [optional] 
