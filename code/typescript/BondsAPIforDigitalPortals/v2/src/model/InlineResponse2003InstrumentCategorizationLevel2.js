...
/**
 * The InlineResponse2003InstrumentCategorizationLevel2 model module.
 * @module model/InlineResponse2003InstrumentCategorizationLevel2
 */
class InlineResponse2003InstrumentCategorizationLevel2 {
    /**
     * Constructs a new <code>InlineResponse2003InstrumentCategorizationLevel2</code>.
     * Second level of categorization.
     * @alias module:model/InlineResponse2003InstrumentCategorizationLevel2
     */
    constructor() { 
        
        InlineResponse2003InstrumentCategorizationLevel2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2003InstrumentCategorizationLevel2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2003InstrumentCategorizationLevel2} obj Optional instance to populate.
     * @return {module:model/InlineResponse2003InstrumentCategorizationLevel2} The populated <code>InlineResponse2003InstrumentCategorizationLevel2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2003InstrumentCategorizationLevel2();
 ...
 * @member {Number} id
 */
InlineResponse2003InstrumentCategorizationLevel2.prototype['id'] = undefined;

/**
 * Name of the category.
 * @member {String} name
 */
InlineResponse2003InstrumentCategorizationLevel2.prototype['name'] = undefined;
...
export default InlineResponse2003InstrumentCategorizationLevel2;
