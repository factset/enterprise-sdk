...
/**
 * The InlineResponse2003InstrumentCategorizationLevel1 model module.
 * @module model/InlineResponse2003InstrumentCategorizationLevel1
 */
class InlineResponse2003InstrumentCategorizationLevel1 {
    /**
     * Constructs a new <code>InlineResponse2003InstrumentCategorizationLevel1</code>.
     * First, most coarse, level of categorization.
     * @alias module:model/InlineResponse2003InstrumentCategorizationLevel1
     */
    constructor() { 
        
        InlineResponse2003InstrumentCategorizationLevel1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2003InstrumentCategorizationLevel1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2003InstrumentCategorizationLevel1} obj Optional instance to populate.
     * @return {module:model/InlineResponse2003InstrumentCategorizationLevel1} The populated <code>InlineResponse2003InstrumentCategorizationLevel1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2003InstrumentCategorizationLevel1();
 ...
 * @member {Number} id
 */
InlineResponse2003InstrumentCategorizationLevel1.prototype['id'] = undefined;

/**
 * Name of the category.
 * @member {String} name
 */
InlineResponse2003InstrumentCategorizationLevel1.prototype['name'] = undefined;
...
export default InlineResponse2003InstrumentCategorizationLevel1;
