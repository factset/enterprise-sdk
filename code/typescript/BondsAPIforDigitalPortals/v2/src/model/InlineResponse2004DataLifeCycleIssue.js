...
/**
 * The InlineResponse2004DataLifeCycleIssue model module.
 * @module model/InlineResponse2004DataLifeCycleIssue
 */
class InlineResponse2004DataLifeCycleIssue {
    /**
     * Constructs a new <code>InlineResponse2004DataLifeCycleIssue</code>.
     * Date range of the issue date.
     * @alias module:model/InlineResponse2004DataLifeCycleIssue
     */
    constructor() { 
        
        InlineResponse2004DataLifeCycleIssue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2004DataLifeCycleIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2004DataLifeCycleIssue} obj Optional instance to populate.
     * @return {module:model/InlineResponse2004DataLifeCycleIssue} The populated <code>InlineResponse2004DataLifeCycleIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2004DataLifeCycleIssue();
 ...
 * @member {Date} minimum
 */
InlineResponse2004DataLifeCycleIssue.prototype['minimum'] = undefined;

/**
 * Maximum date.
 * @member {Date} maximum
 */
InlineResponse2004DataLifeCycleIssue.prototype['maximum'] = undefined;
...
export default InlineResponse2004DataLifeCycleIssue;
