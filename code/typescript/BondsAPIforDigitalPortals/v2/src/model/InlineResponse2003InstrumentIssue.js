...
import InlineResponse2003InstrumentIssueVolume from './InlineResponse2003InstrumentIssueVolume';
...
class InlineResponse2003InstrumentIssue {
    /**
     * Constructs a new <code>InlineResponse2003InstrumentIssue</code>.
     * Issue data of the debt instrument.
     * @alias module:model/InlineResponse2003InstrumentIssue
     */
    constructor() { 
        
        InlineResponse2003InstrumentIssue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2003InstrumentIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2003InstrumentIssue} obj Optional instance to populate.
     * @return {module:model/InlineResponse2003InstrumentIssue} The populated <code>InlineResponse2003InstrumentIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2003InstrumentIssue();

            if (data.hasOwnProperty('volume')) {
                obj['volume'] = InlineResponse2003InstrumentIssueVolume.constructFromObject(data['volume']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2003InstrumentIssueVolume} volume
 */
InlineResponse2003InstrumentIssue.prototype['volume'] = undefined;
...
export default InlineResponse2003InstrumentIssue;
