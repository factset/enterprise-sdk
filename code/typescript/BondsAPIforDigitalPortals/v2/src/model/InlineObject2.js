...
import DebtInstrumentNotationScreenerValueRangesGetData from './DebtInstrumentNotationScreenerValueRangesGetData';
import DebtInstrumentNotationScreenerValueRangesGetMeta from './DebtInstrumentNotationScreenerValueRangesGetMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = DebtInstrumentNotationScreenerValueRangesGetData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = DebtInstrumentNotationScreenerValueRangesGetMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/DebtInstrumentNotationScreenerValueRangesGetData} data
 */
InlineObject2.prototype['data'] = undefined;

/**
 * @member {module:model/DebtInstrumentNotationScreenerValueRangesGetMeta} meta
 */
