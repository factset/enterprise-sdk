...
import DebtInstrumentIssuerSearchData from './DebtInstrumentIssuerSearchData';
import DebtInstrumentIssuerSearchMeta from './DebtInstrumentIssuerSearchMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = DebtInstrumentIssuerSearchData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = DebtInstrumentIssuerSearchMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/DebtInstrumentIssuerSearchData} data
 */
InlineObject.prototype['data'] = undefined;

/**
 * @member {module:model/DebtInstrumentIssuerSearchMeta} meta
 */
