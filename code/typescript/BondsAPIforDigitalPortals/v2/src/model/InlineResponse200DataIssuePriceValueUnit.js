...
class InlineResponse200DataIssuePriceValueUnit {
    /**
     * Constructs a new <code>InlineResponse200DataIssuePriceValueUnit</code>.
     ...
     * @alias module:model/InlineResponse200DataIssuePriceValueUnit
     */
    constructor() { 
        
        InlineResponse200DataIssuePriceValueUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataIssuePriceValueUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataIssuePriceValueUnit} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataIssuePriceValueUnit} The populated <code>InlineResponse200DataIssuePriceValueUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataIssuePriceValueUnit();
 ...
 * @member {Number} id
 */
InlineResponse200DataIssuePriceValueUnit.prototype['id'] = undefined;

/**
 * Code of the value unit.
 * @member {String} code
 */
InlineResponse200DataIssuePriceValueUnit.prototype['code'] = undefined;
...
export default InlineResponse200DataIssuePriceValueUnit;
