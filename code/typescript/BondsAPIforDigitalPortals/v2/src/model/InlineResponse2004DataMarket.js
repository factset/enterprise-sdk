...
/**
 * The InlineResponse2004DataMarket model module.
 * @module model/InlineResponse2004DataMarket
 */
class InlineResponse2004DataMarket {
    /**
     * Constructs a new <code>InlineResponse2004DataMarket</code>.
     * @alias module:model/InlineResponse2004DataMarket
     */
    constructor() { 
        
        InlineResponse2004DataMarket.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2004DataMarket</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2004DataMarket} obj Optional instance to populate.
     * @return {module:model/InlineResponse2004DataMarket} The populated <code>InlineResponse2004DataMarket</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2004DataMarket();
 ...
 * @member {Number} id
 */
InlineResponse2004DataMarket.prototype['id'] = undefined;

/**
 * Name of the market.
 * @member {String} name
 */
InlineResponse2004DataMarket.prototype['name'] = undefined;

/**
 * Number of notations.
 * @member {Number} count
 */
InlineResponse2004DataMarket.prototype['count'] = undefined;
...
export default InlineResponse2004DataMarket;
