...
class Financials {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fpcIndicator') && obj['fpcIndicator'] === undefined) {
                obj['fpcIndicator'] = ApiClient.convertToType(data['fpcIndicator'], 'Number');
            }
 ...
 * @member {Number} fpcIndicator
 */
Financials.prototype['fpcIndicator'] = undefined;
