...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/private-company/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/private-company/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetPrivateCompany/1.0.1 (${process.platform}; node ${process.version})`
        };
