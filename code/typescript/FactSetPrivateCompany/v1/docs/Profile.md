...
**totalInvestors** | **Number** | Total number of investors for the portfolio company. | [optional] 
...
**vcpeAmountRaisedLocalCurrency** | **Number** | Current estimated total of venture capital and private equity raised in all rounds of the portfolio company. This item applies to venture capital and private equity raised rounds.    | [optional] 
