...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api-sandbox.factset.com/bulk-documents/tickhistory') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api-sandbox.factset.com/bulk-documents/tickhistory
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetTickHistory/0.23.0 (${process.platform}; node ${process.version})`
        };
