...
export default class Level1Api {
    ...
    */
     ...
     */
    getIdWithHttpInfo(leveloneRequest) {
      ...
      if (leveloneRequest === undefined || leveloneRequest === null) {
        throw new Error("Missing the required parameter 'leveloneRequest' when calling getId");
      }
     ...
     */
    getId(leveloneRequest) {
      return this.getIdWithHttpInfo(leveloneRequest)
     ...
     */
    getStatusLevel1WithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getStatusLevel1");
      }
      ...
      let returnType = GetStatusLevel1ResponseWrapperTypeMap;
     ...
     * Need to plug-in the id get from /create endpoint into /status endpoint
     * @param {String} id id returned by files create endpoint to poll and collect status of the query
     * @return { Promise.< GetStatusLevel1ResponseWrapper > } a Promise, with data of type {@link GetStatusLevel1ResponseWrapper }
     */
    getStatusLevel1(id) {
      return this.getStatusLevel1WithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    getTickHistoryCoverageWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getTickHistoryCoverage(opts) {
      return this.getTickHistoryCoverageWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    getTickHistoryFilesWithHttpInfo(id, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getTickHistoryFiles");
      }
      ...
      let returnType = GetTickHistoryFilesResponseWrapperTypeMap;
     ...
     * @param {Number} opts.paginationLimit Specifies the maximum number of results to return per response page (default to 20)
     * @param {Number} opts.paginationOffset Specifies the starting point for pagination. This parameter is used to identify the beginning of next set of results (default to 0)
     * @return { Promise.< GetTickHistoryFilesResponseWrapper > } a Promise, with data of type {@link GetTickHistoryFilesResponseWrapper }
     */
    getTickHistoryFiles(id, opts) {
      return this.getTickHistoryFilesWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
...
const GetStatusLevel1ResponseWrapperTypeMap = {
  ...
  _createResponseWrapper(statusCode, response) {
    return new GetStatusLevel1ResponseWrapper(statusCode, response);
  }
};

const GetTickHistoryFilesResponseWrapperTypeMap = {
  ...
  _createResponseWrapper(statusCode, response) {
    return new GetTickHistoryFilesResponseWrapper(statusCode, response);
  }
};
 ...
 * }</pre>
 *
 * @alias module:GetStatusLevel1ResponseWrapper
 * @class
 */
export class GetStatusLevel1ResponseWrapper {
 ...
 * }</pre>
 *
 * @alias module:GetTickHistoryFilesResponseWrapper
 * @class
 */
export class GetTickHistoryFilesResponseWrapper {
