...
[![API Version](https://img.shields.io/badge/api-v2.4.2-blue)](https://developer.factset.com/api-catalog/factset-tick-history-api)
[![npm](https://img.shields.io/badge/npm-v1.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsettickhistory/v/1.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettickhistory@1.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettickhistory@1.2.0
```
