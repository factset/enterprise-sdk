...
[![npm](https://img.shields.io/badge/npm-v1.1.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsettickhistory/v/1.1.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettickhistory@1.1.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettickhistory@1.1.0
```
