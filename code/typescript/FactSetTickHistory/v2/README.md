...
[![API Version](https://img.shields.io/badge/api-v2.2.0-blue)](https://developer.factset.com/api-catalog/factset-tick-history-api)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettickhistory@0.32.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettickhistory@0.32.1
```
