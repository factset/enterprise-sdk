...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettickhistory@0.31.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettickhistory@0.31.0
```
...
*factsettickhistory.Level2Api* | [**getLevel2FileStatus**](docs/Level2Api.md#getLevel2FileStatus) | **GET** /level2/files/status | Returns the status of the ID
*factsettickhistory.Level2Api* | [**getTickHistoryLevel2Files**](docs/Level2Api.md#getTickHistoryLevel2Files) | **GET** /level2/files/get | Returns the tick history files requested in the /create endpoint
*factsettickhistory.Level2Api* | [**requestTickHistoryLeve2Files**](docs/Level2Api.md#requestTickHistoryLeve2Files) | **POST** /level2/files/create | Returns the ID for the requested data.
