...
[![API Version](https://img.shields.io/badge/api-v2.4.1-blue)](https://developer.factset.com/api-catalog/factset-tick-history-api)
[![npm](https://img.shields.io/badge/npm-v1.0.3-orange)](https://www.npmjs.com/package/@factset/sdk-factsettickhistory/v/1.0.3)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettickhistory@1.0.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettickhistory@1.0.3
```
