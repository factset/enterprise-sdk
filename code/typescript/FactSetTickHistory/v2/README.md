...
[![npm](https://img.shields.io/badge/npm-v1.0.1-orange)](https://www.npmjs.com/package/@factset/sdk-factsettickhistory/v/1.0.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettickhistory@1.0.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettickhistory@1.0.1
```
