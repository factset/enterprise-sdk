...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/bulk-documents/tick-history/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/bulk-documents/tick-history/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/FactSetTickHistory/0.0.1'
        };
