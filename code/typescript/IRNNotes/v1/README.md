...
```shell
npm install @factset/sdk-utils @factset/sdk-irnnotes@2.1.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-irnnotes@2.1.0
```
...
## Documentation for Models
 ...
 - [irnnotes.AttachmentStatus](docs/AttachmentStatus.md)
