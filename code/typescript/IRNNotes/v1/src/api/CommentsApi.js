...
export default class CommentsApi {
    ...
    */
    ...
    createCommentAttachmentWithHttpInfo(noteId, commentId, file) {
      ...
      let returnType = NewItemDto;
      return this.apiClient.callApi(
        '/v1/notes/{noteId}/comments/{commentId}/attachments', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteCommentWithHttpInfo(noteId, commentId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v1/notes/{noteId}/comments/{commentId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    downloadCommentAttachmentForCommentWithHttpInfo(noteId, commentId, attachmentId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v1/notes/{noteId}/comments/{commentId}/attachments/{attachmentId}/download', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getCommentWithHttpInfo(noteId, commentId) {
      ...
      return this.apiClient.callApi(
        '/v1/notes/{noteId}/comments/{commentId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getCommentAttachmentsWithHttpInfo(noteId, commentId) {
      ...
      return this.apiClient.callApi(
        '/v1/notes/{noteId}/comments/{commentId}/attachments', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    patchCommentWithHttpInfo(noteId, commentId, opts) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v1/notes/{noteId}/comments/{commentId}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
