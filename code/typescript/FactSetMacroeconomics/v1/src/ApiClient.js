...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/economics/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/economics/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetMacroeconomics/0.1.0 (${process.platform}; node ${process.version})`
        };
