...
import InlineResponse20010DataTransactionBuyCurrency from './InlineResponse20010DataTransactionBuyCurrency';
import InlineResponse20010DataTransactionBuyNotation from './InlineResponse20010DataTransactionBuyNotation';

/**
 * The InlineResponse20010DataTransactionBuy model module.
 * @module model/InlineResponse20010DataTransactionBuy
 */
class InlineResponse20010DataTransactionBuy {
    /**
     * Constructs a new <code>InlineResponse20010DataTransactionBuy</code>.
     * Opening transaction of the closed position.
     * @alias module:model/InlineResponse20010DataTransactionBuy
     */
    constructor() { 
        
        InlineResponse20010DataTransactionBuy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransactionBuy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransactionBuy} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransactionBuy} The populated <code>InlineResponse20010DataTransactionBuy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransactionBuy();
            ...
            if (data.hasOwnProperty('notation')) {
                obj['notation'] = InlineResponse20010DataTransactionBuyNotation.constructFromObject(data['notation']);
            }
            if (data.hasOwnProperty('currency')) {
                obj['currency'] = InlineResponse20010DataTransactionBuyCurrency.constructFromObject(data['currency']);
            }
 ...
 * @member {String} id
 */
InlineResponse20010DataTransactionBuy.prototype['id'] = undefined;

/**
 * Date and time of the opening transaction.
 * @member {String} time
 */
InlineResponse20010DataTransactionBuy.prototype['time'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataTransactionBuyNotation} notation
 */
InlineResponse20010DataTransactionBuy.prototype['notation'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataTransactionBuyCurrency} currency
 */
InlineResponse20010DataTransactionBuy.prototype['currency'] = undefined;

/**
 * Purchase price of the position in the portfolio's base currency.
 * @member {Number} price
 */
InlineResponse20010DataTransactionBuy.prototype['price'] = undefined;

/**
 * Charges accrued in the portfolio's base currency.
 * @member {Number} charges
 */
InlineResponse20010DataTransactionBuy.prototype['charges'] = undefined;

/**
 * Purchase value of the position in the portfolio's base currency.
 * @member {Number} value
 */
InlineResponse20010DataTransactionBuy.prototype['value'] = undefined;
 ...
 */
InlineResponse20010DataTransactionBuy.prototype['exchangeRate'] = undefined;
...
export default InlineResponse20010DataTransactionBuy;
