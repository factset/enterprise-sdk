...
import PortfolioPayoutModifyData from './PortfolioPayoutModifyData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioPayoutModifyData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioPayoutModifyData} data
 */
