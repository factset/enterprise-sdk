...
import InlineResponse20010DataInstrument from './InlineResponse20010DataInstrument';
import InlineResponse20010DataPayout from './InlineResponse20010DataPayout';
import InlineResponse20010DataProfitLoss from './InlineResponse20010DataProfitLoss';
import InlineResponse20010DataTransaction from './InlineResponse20010DataTransaction';

/**
 * The InlineResponse20010DataPositions model module.
 * @module model/InlineResponse20010DataPositions
 */
class InlineResponse20010DataPositions {
    /**
     * Constructs a new <code>InlineResponse20010DataPositions</code>.
     * @alias module:model/InlineResponse20010DataPositions
     */
    constructor() { 
        
        InlineResponse20010DataPositions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataPositions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataPositions} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataPositions} The populated <code>InlineResponse20010DataPositions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataPositions();

            if (data.hasOwnProperty('instrument')) {
                obj['instrument'] = InlineResponse20010DataInstrument.constructFromObject(data['instrument']);
            }
            if (data.hasOwnProperty('transaction')) {
                obj['transaction'] = InlineResponse20010DataTransaction.constructFromObject(data['transaction']);
            }
            if (data.hasOwnProperty('shares')) {
                obj['shares'] = ApiClient.convertToType(data['shares'], 'Number');
            }
            if (data.hasOwnProperty('payout')) {
                obj['payout'] = InlineResponse20010DataPayout.constructFromObject(data['payout']);
            }
            if (data.hasOwnProperty('profitLoss')) {
                obj['profitLoss'] = InlineResponse20010DataProfitLoss.constructFromObject(data['profitLoss']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20010DataInstrument} instrument
 */
InlineResponse20010DataPositions.prototype['instrument'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataTransaction} transaction
 */
InlineResponse20010DataPositions.prototype['transaction'] = undefined;

/**
 * Number of shares in the closed position.
 * @member {Number} shares
 */
InlineResponse20010DataPositions.prototype['shares'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataPayout} payout
 */
InlineResponse20010DataPositions.prototype['payout'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataProfitLoss} profitLoss
 */
InlineResponse20010DataPositions.prototype['profitLoss'] = undefined;
...
export default InlineResponse20010DataPositions;
