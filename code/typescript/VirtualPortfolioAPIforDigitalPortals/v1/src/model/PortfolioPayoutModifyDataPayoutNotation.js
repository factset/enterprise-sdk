...
/**
 * The PortfolioPayoutModifyDataPayoutNotation model module.
 * @module model/PortfolioPayoutModifyDataPayoutNotation
 */
class PortfolioPayoutModifyDataPayoutNotation {
    /**
     * Constructs a new <code>PortfolioPayoutModifyDataPayoutNotation</code>.
     * Notation of the transaction.
     * @alias module:model/PortfolioPayoutModifyDataPayoutNotation
     * @param id {String} Identifier of the notation
     */
    constructor(id) { 
        
        PortfolioPayoutModifyDataPayoutNotation.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutModifyDataPayoutNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutModifyDataPayoutNotation} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutModifyDataPayoutNotation} The populated <code>PortfolioPayoutModifyDataPayoutNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutModifyDataPayoutNotation();
 ...
 * @member {String} id
 */
PortfolioPayoutModifyDataPayoutNotation.prototype['id'] = undefined;
...
export default PortfolioPayoutModifyDataPayoutNotation;
