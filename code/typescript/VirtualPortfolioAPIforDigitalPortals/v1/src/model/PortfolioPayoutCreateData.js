...
import PortfolioPayoutCreateDataTransaction from './PortfolioPayoutCreateDataTransaction';

/**
 * The PortfolioPayoutCreateData model module.
 * @module model/PortfolioPayoutCreateData
 */
class PortfolioPayoutCreateData {
    /**
     * Constructs a new <code>PortfolioPayoutCreateData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PortfolioPayoutCreateData
     * @param id {String} Identifier of the portfolio.
     * @param type {module:model/PortfolioPayoutCreateData.TypeEnum} Payout type. 
     * @param notation {module:model/PortfolioPayoutCreateDataNotation} 
     * @param time {String} Date and time of the payout.
     * @param amount {Number} Amount of the payout in the portfolio's base currency.
     */
    constructor(id, type, notation, time, amount) { 
        
        PortfolioPayoutCreateData.initialize(this, id, type, notation, time, amount);
    }
     ...
     */
    static initialize(obj, id, type, notation, time, amount) { 
        obj['id'] = id;
        obj['type'] = type;
    ...
    /**
     * Constructs a <code>PortfolioPayoutCreateData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutCreateData} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutCreateData} The populated <code>PortfolioPayoutCreateData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutCreateData();
            ...
            if (data.hasOwnProperty('transaction')) {
                obj['transaction'] = PortfolioPayoutCreateDataTransaction.constructFromObject(data['transaction']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
PortfolioPayoutCreateData.prototype['id'] = undefined;

/**
 * Payout type. 
 * @member {module:model/PortfolioPayoutCreateData.TypeEnum} type
 */
PortfolioPayoutCreateData.prototype['type'] = undefined;

/**
 * @member {module:model/PortfolioPayoutCreateDataNotation} notation
 */
PortfolioPayoutCreateData.prototype['notation'] = undefined;

/**
 * Date and time of the payout.
 * @member {String} time
 */
PortfolioPayoutCreateData.prototype['time'] = undefined;

/**
 * Amount of the payout in the portfolio's base currency.
 * @member {Number} amount
 */
PortfolioPayoutCreateData.prototype['amount'] = undefined;

/**
 * @member {module:model/PortfolioPayoutCreateDataTransaction} transaction
 */
PortfolioPayoutCreateData.prototype['transaction'] = undefined;
 ...
 * @readonly
 */
PortfolioPayoutCreateData['TypeEnum'] = {
...
export default PortfolioPayoutCreateData;
