...
import PortfolioEvaluationListData from './PortfolioEvaluationListData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioEvaluationListData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioEvaluationListData} data
 */
