...
import PortfolioPayoutModifyDataPayout from './PortfolioPayoutModifyDataPayout';

/**
 * The PortfolioPayoutModifyData model module.
 * @module model/PortfolioPayoutModifyData
 */
class PortfolioPayoutModifyData {
    /**
     * Constructs a new <code>PortfolioPayoutModifyData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PortfolioPayoutModifyData
     * @param id {String} Identifier of the portfolio.
     */
    constructor(id) { 
        
        PortfolioPayoutModifyData.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutModifyData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutModifyData} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutModifyData} The populated <code>PortfolioPayoutModifyData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutModifyData();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('payout')) {
                obj['payout'] = PortfolioPayoutModifyDataPayout.constructFromObject(data['payout']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
PortfolioPayoutModifyData.prototype['id'] = undefined;

/**
 * @member {module:model/PortfolioPayoutModifyDataPayout} payout
 */
PortfolioPayoutModifyData.prototype['payout'] = undefined;
...
export default PortfolioPayoutModifyData;
