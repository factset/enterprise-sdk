...
/**
 * The PortfolioCreateMeta model module.
 * @module model/PortfolioCreateMeta
 */
class PortfolioCreateMeta {
    /**
     * Constructs a new <code>PortfolioCreateMeta</code>.
     * The meta member contains the meta information of the request.
     * @alias module:model/PortfolioCreateMeta
     */
    constructor() { 
        
        PortfolioCreateMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioCreateMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioCreateMeta} obj Optional instance to populate.
     * @return {module:model/PortfolioCreateMeta} The populated <code>PortfolioCreateMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioCreateMeta();
 ...
 */
PortfolioCreateMeta.prototype['attributes'] = undefined;
...
export default PortfolioCreateMeta;
