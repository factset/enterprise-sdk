...
/**
 * The InlineResponse2007Meta model module.
 * @module model/InlineResponse2007Meta
 */
class InlineResponse2007Meta {
    /**
     * Constructs a new <code>InlineResponse2007Meta</code>.
     * The meta member contains the meta information of the response.
     * @alias module:model/InlineResponse2007Meta
     */
    constructor() { 
        
        InlineResponse2007Meta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007Meta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007Meta} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007Meta} The populated <code>InlineResponse2007Meta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007Meta();
 ...
 */
InlineResponse2007Meta.prototype['status'] = undefined;

/**
 * @member {module:model/OffsetBasedPaginationOutputObject} pagination
 */
InlineResponse2007Meta.prototype['pagination'] = undefined;
...
export default InlineResponse2007Meta;
