...
/**
 * The PortfolioPayoutCreateDataTransaction model module.
 * @module model/PortfolioPayoutCreateDataTransaction
 */
class PortfolioPayoutCreateDataTransaction {
    /**
     * Constructs a new <code>PortfolioPayoutCreateDataTransaction</code>.
     ...
     * @alias module:model/PortfolioPayoutCreateDataTransaction
     * @param id {String} Identifier of the buy transaction.
     */
    constructor(id) { 
        
        PortfolioPayoutCreateDataTransaction.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutCreateDataTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutCreateDataTransaction} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutCreateDataTransaction} The populated <code>PortfolioPayoutCreateDataTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutCreateDataTransaction();
 ...
 * @member {String} id
 */
PortfolioPayoutCreateDataTransaction.prototype['id'] = undefined;
...
export default PortfolioPayoutCreateDataTransaction;
