...
import InlineResponse20015Notation from './InlineResponse20015Notation';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('notation')) {
                obj['notation'] = InlineResponse20015Notation.constructFromObject(data['notation']);
            }
...
/**
 * @member {module:model/InlineResponse20015Notation} notation
 */
InlineResponse20015Data.prototype['notation'] = undefined;

/**
 * Personal note for the watchlist position.
 * @member {String} comment
 */
InlineResponse20015Data.prototype['comment'] = undefined;
