...
import PortfolioPayoutDeleteDataPayout from './PortfolioPayoutDeleteDataPayout';

/**
 * The PortfolioPayoutDeleteData model module.
 * @module model/PortfolioPayoutDeleteData
 */
class PortfolioPayoutDeleteData {
    /**
     * Constructs a new <code>PortfolioPayoutDeleteData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PortfolioPayoutDeleteData
     * @param id {String} Identifier of the portfolio.
     * @param payout {module:model/PortfolioPayoutDeleteDataPayout} 
     */
    constructor(id, payout) { 
        
        PortfolioPayoutDeleteData.initialize(this, id, payout);
    }
     ...
     */
    static initialize(obj, id, payout) { 
        obj['id'] = id;
        obj['payout'] = payout;
    }

    /**
     * Constructs a <code>PortfolioPayoutDeleteData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutDeleteData} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutDeleteData} The populated <code>PortfolioPayoutDeleteData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutDeleteData();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('payout')) {
                obj['payout'] = PortfolioPayoutDeleteDataPayout.constructFromObject(data['payout']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
PortfolioPayoutDeleteData.prototype['id'] = undefined;

/**
 * @member {module:model/PortfolioPayoutDeleteDataPayout} payout
 */
PortfolioPayoutDeleteData.prototype['payout'] = undefined;
...
export default PortfolioPayoutDeleteData;
