...
import InlineResponse2007Meta from './InlineResponse2007Meta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineResponse2007Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2007Meta} meta
 */
