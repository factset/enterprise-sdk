...
import InlineResponse2001DataLifecycle from './InlineResponse2001DataLifecycle';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lifecycle')) {
                obj['lifecycle'] = InlineResponse2001DataLifecycle.constructFromObject(data['lifecycle']);
            }
...
/**
 * @member {module:model/InlineResponse2001DataLifecycle} lifecycle
 */
InlineResponse2001Data.prototype['lifecycle'] = undefined;

/**
 * Date and time of the portfolio valuation.
 * @member {String} asOfDate
 */
InlineResponse2001Data.prototype['asOfDate'] = undefined;
