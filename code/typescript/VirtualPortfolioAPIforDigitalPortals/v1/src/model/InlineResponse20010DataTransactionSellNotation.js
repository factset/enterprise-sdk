...
/**
 * The InlineResponse20010DataTransactionSellNotation model module.
 * @module model/InlineResponse20010DataTransactionSellNotation
 */
class InlineResponse20010DataTransactionSellNotation {
    /**
     * Constructs a new <code>InlineResponse20010DataTransactionSellNotation</code>.
     * Notation of the closing transaction.
     * @alias module:model/InlineResponse20010DataTransactionSellNotation
     */
    constructor() { 
        
        InlineResponse20010DataTransactionSellNotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransactionSellNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransactionSellNotation} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransactionSellNotation} The populated <code>InlineResponse20010DataTransactionSellNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransactionSellNotation();
 ...
 * @member {String} id
 */
InlineResponse20010DataTransactionSellNotation.prototype['id'] = undefined;
...
export default InlineResponse20010DataTransactionSellNotation;
