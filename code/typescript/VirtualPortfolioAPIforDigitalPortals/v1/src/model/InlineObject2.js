...
import PortfolioModifyData from './PortfolioModifyData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioModifyData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioModifyData} data
 */
