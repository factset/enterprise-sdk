...
/**
 * The InlineResponse2009DataNotationPrice model module.
 * @module model/InlineResponse2009DataNotationPrice
 */
class InlineResponse2009DataNotationPrice {
    /**
     * Constructs a new <code>InlineResponse2009DataNotationPrice</code>.
     * Price of the notation.
     * @alias module:model/InlineResponse2009DataNotationPrice
     */
    constructor() { 
        
        InlineResponse2009DataNotationPrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataNotationPrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataNotationPrice} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataNotationPrice} The populated <code>InlineResponse2009DataNotationPrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataNotationPrice();
 ...
 * @member {String} time
 */
InlineResponse2009DataNotationPrice.prototype['time'] = undefined;

/**
 * Trade price.
 * @member {Number} value
 */
InlineResponse2009DataNotationPrice.prototype['value'] = undefined;
...
export default InlineResponse2009DataNotationPrice;
