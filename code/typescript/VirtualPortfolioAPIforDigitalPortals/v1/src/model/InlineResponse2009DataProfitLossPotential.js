...
/**
 * The InlineResponse2009DataProfitLossPotential model module.
 * @module model/InlineResponse2009DataProfitLossPotential
 */
class InlineResponse2009DataProfitLossPotential {
    /**
     * Constructs a new <code>InlineResponse2009DataProfitLossPotential</code>.
     * Summary of potential profit or loss resulting from open positions, i.e. instrument positions that have not been sold.
     * @alias module:model/InlineResponse2009DataProfitLossPotential
     */
    constructor() { 
        
        InlineResponse2009DataProfitLossPotential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataProfitLossPotential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataProfitLossPotential} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataProfitLossPotential} The populated <code>InlineResponse2009DataProfitLossPotential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataProfitLossPotential();
 ...
 */
InlineResponse2009DataProfitLossPotential.prototype['absolute'] = undefined;

/**
 * Relative value of profit or loss.
 * @member {Number} relative
 */
InlineResponse2009DataProfitLossPotential.prototype['relative'] = undefined;
...
export default InlineResponse2009DataProfitLossPotential;
