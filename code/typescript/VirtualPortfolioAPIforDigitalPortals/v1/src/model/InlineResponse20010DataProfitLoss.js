...
/**
 * The InlineResponse20010DataProfitLoss model module.
 * @module model/InlineResponse20010DataProfitLoss
 */
class InlineResponse20010DataProfitLoss {
    /**
     * Constructs a new <code>InlineResponse20010DataProfitLoss</code>.
     ...
     * @alias module:model/InlineResponse20010DataProfitLoss
     */
    constructor() { 
        
        InlineResponse20010DataProfitLoss.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataProfitLoss</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataProfitLoss} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataProfitLoss} The populated <code>InlineResponse20010DataProfitLoss</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataProfitLoss();
 ...
 */
InlineResponse20010DataProfitLoss.prototype['absolute'] = undefined;

/**
 * Relative value of profit or loss.
 * @member {Number} relative
 */
InlineResponse20010DataProfitLoss.prototype['relative'] = undefined;
...
export default InlineResponse20010DataProfitLoss;
