...
import PortfolioPositionClosedListData from './PortfolioPositionClosedListData';
import PortfolioPositionClosedListMeta from './PortfolioPositionClosedListMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioPositionClosedListData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = PortfolioPositionClosedListMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PortfolioPositionClosedListData} data
 */
InlineObject8.prototype['data'] = undefined;

/**
 * @member {module:model/PortfolioPositionClosedListMeta} meta
 */
