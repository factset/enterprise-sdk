...
/**
 * The InlineResponse2009DataCurrency model module.
 * @module model/InlineResponse2009DataCurrency
 */
class InlineResponse2009DataCurrency {
    /**
     * Constructs a new <code>InlineResponse2009DataCurrency</code>.
     * Main currency of the position. See endpoint &#x60;/basic/valueUnit/currency/main/list&#x60; for possible values.
     * @alias module:model/InlineResponse2009DataCurrency
     */
    constructor() { 
        
        InlineResponse2009DataCurrency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataCurrency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataCurrency} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataCurrency} The populated <code>InlineResponse2009DataCurrency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataCurrency();
 ...
 * @member {Number} id
 */
InlineResponse2009DataCurrency.prototype['id'] = undefined;

/**
 * ISO 4217 code of the currency.
 * @member {String} isoCode
 */
InlineResponse2009DataCurrency.prototype['isoCode'] = undefined;
...
export default InlineResponse2009DataCurrency;
