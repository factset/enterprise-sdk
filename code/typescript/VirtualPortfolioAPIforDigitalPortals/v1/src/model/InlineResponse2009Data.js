...
import InlineResponse2009DataPositions from './InlineResponse2009DataPositions';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('positions')) {
                obj['positions'] = ApiClient.convertToType(data['positions'], [InlineResponse2009DataPositions]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/InlineResponse2009DataPositions>} positions
 */
InlineResponse2009Data.prototype['positions'] = undefined;
