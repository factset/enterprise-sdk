...
import PortfolioPayoutListDataFilterInstrument from './PortfolioPayoutListDataFilterInstrument';

/**
 * The PortfolioPayoutListDataFilter model module.
 * @module model/PortfolioPayoutListDataFilter
 */
class PortfolioPayoutListDataFilter {
    /**
     * Constructs a new <code>PortfolioPayoutListDataFilter</code>.
     * Criteria that filter the items in the response list; only items that match all of the criteria are returned.
     * @alias module:model/PortfolioPayoutListDataFilter
     */
    constructor() { 
        
        PortfolioPayoutListDataFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutListDataFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutListDataFilter} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutListDataFilter} The populated <code>PortfolioPayoutListDataFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutListDataFilter();

            if (data.hasOwnProperty('instrument')) {
                obj['instrument'] = PortfolioPayoutListDataFilterInstrument.constructFromObject(data['instrument']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PortfolioPayoutListDataFilterInstrument} instrument
 */
PortfolioPayoutListDataFilter.prototype['instrument'] = undefined;
...
export default PortfolioPayoutListDataFilter;
