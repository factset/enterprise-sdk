...
/**
 * The InlineResponse2009DataProfitLossIntraday model module.
 * @module model/InlineResponse2009DataProfitLossIntraday
 */
class InlineResponse2009DataProfitLossIntraday {
    /**
     * Constructs a new <code>InlineResponse2009DataProfitLossIntraday</code>.
     * Summary of today&#39;s profit or loss, calculated using the most recent price and the last price of the prior trading day.
     * @alias module:model/InlineResponse2009DataProfitLossIntraday
     */
    constructor() { 
        
        InlineResponse2009DataProfitLossIntraday.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataProfitLossIntraday</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataProfitLossIntraday} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataProfitLossIntraday} The populated <code>InlineResponse2009DataProfitLossIntraday</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataProfitLossIntraday();
 ...
 */
InlineResponse2009DataProfitLossIntraday.prototype['absolute'] = undefined;

/**
 * Relative value of profit or loss.
 * @member {Number} relative
 */
InlineResponse2009DataProfitLossIntraday.prototype['relative'] = undefined;
...
export default InlineResponse2009DataProfitLossIntraday;
