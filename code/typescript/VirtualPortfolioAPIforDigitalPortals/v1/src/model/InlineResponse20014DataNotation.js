...
/**
 * The InlineResponse20014DataNotation model module.
 * @module model/InlineResponse20014DataNotation
 */
class InlineResponse20014DataNotation {
    /**
     * Constructs a new <code>InlineResponse20014DataNotation</code>.
     * Notation of the position.
     * @alias module:model/InlineResponse20014DataNotation
     */
    constructor() { 
        
        InlineResponse20014DataNotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20014DataNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20014DataNotation} obj Optional instance to populate.
     * @return {module:model/InlineResponse20014DataNotation} The populated <code>InlineResponse20014DataNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20014DataNotation();
 ...
 * @member {String} id
 */
InlineResponse20014DataNotation.prototype['id'] = undefined;
...
export default InlineResponse20014DataNotation;
