...
import InlineResponse20010DataTransactionSellCurrency from './InlineResponse20010DataTransactionSellCurrency';
import InlineResponse20010DataTransactionSellNotation from './InlineResponse20010DataTransactionSellNotation';

/**
 * The InlineResponse20010DataTransactionSell model module.
 * @module model/InlineResponse20010DataTransactionSell
 */
class InlineResponse20010DataTransactionSell {
    /**
     * Constructs a new <code>InlineResponse20010DataTransactionSell</code>.
     * Closing transaction of the position.
     * @alias module:model/InlineResponse20010DataTransactionSell
     */
    constructor() { 
        
        InlineResponse20010DataTransactionSell.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransactionSell</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransactionSell} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransactionSell} The populated <code>InlineResponse20010DataTransactionSell</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransactionSell();
            ...
            if (data.hasOwnProperty('notation')) {
                obj['notation'] = InlineResponse20010DataTransactionSellNotation.constructFromObject(data['notation']);
            }
            if (data.hasOwnProperty('currency')) {
                obj['currency'] = InlineResponse20010DataTransactionSellCurrency.constructFromObject(data['currency']);
            }
 ...
 * @member {String} id
 */
InlineResponse20010DataTransactionSell.prototype['id'] = undefined;

/**
 * Date and time of the closing transaction.
 * @member {String} time
 */
InlineResponse20010DataTransactionSell.prototype['time'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataTransactionSellNotation} notation
 */
InlineResponse20010DataTransactionSell.prototype['notation'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataTransactionSellCurrency} currency
 */
InlineResponse20010DataTransactionSell.prototype['currency'] = undefined;

/**
 * Selling price of the position in the portfolio's base currency.
 * @member {Number} price
 */
InlineResponse20010DataTransactionSell.prototype['price'] = undefined;

/**
 * Charges accrued in the portfolio's base currency.
 * @member {Number} charges
 */
InlineResponse20010DataTransactionSell.prototype['charges'] = undefined;

/**
 * Sales value of the position in the portfolio's base currency.
 * @member {Number} value
 */
InlineResponse20010DataTransactionSell.prototype['value'] = undefined;
 ...
 */
InlineResponse20010DataTransactionSell.prototype['exchangeRate'] = undefined;
...
export default InlineResponse20010DataTransactionSell;
