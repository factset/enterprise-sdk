...
import PortfolioPayoutListData from './PortfolioPayoutListData';
import PortfolioPayoutListMeta from './PortfolioPayoutListMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioPayoutListData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = PortfolioPayoutListMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PortfolioPayoutListData} data
 */
InlineObject6.prototype['data'] = undefined;

/**
 * @member {module:model/PortfolioPayoutListMeta} meta
 */
