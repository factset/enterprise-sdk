...
import PortfolioTransactionModifyData from './PortfolioTransactionModifyData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioTransactionModifyData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioTransactionModifyData} data
 */
