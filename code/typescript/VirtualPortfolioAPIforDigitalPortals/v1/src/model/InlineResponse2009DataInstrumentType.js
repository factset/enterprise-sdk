...
/**
 * The InlineResponse2009DataInstrumentType model module.
 * @module model/InlineResponse2009DataInstrumentType
 */
class InlineResponse2009DataInstrumentType {
    /**
     * Constructs a new <code>InlineResponse2009DataInstrumentType</code>.
     * @alias module:model/InlineResponse2009DataInstrumentType
     */
    constructor() { 
        
        InlineResponse2009DataInstrumentType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataInstrumentType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataInstrumentType} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataInstrumentType} The populated <code>InlineResponse2009DataInstrumentType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataInstrumentType();
 ...
 * @member {Number} id
 */
InlineResponse2009DataInstrumentType.prototype['id'] = undefined;

/**
 * Name of the instrument type.
 * @member {String} name
 */
InlineResponse2009DataInstrumentType.prototype['name'] = undefined;
...
export default InlineResponse2009DataInstrumentType;
