...
/**
 * The InlineResponse2009DataShares model module.
 * @module model/InlineResponse2009DataShares
 */
class InlineResponse2009DataShares {
    /**
     * Constructs a new <code>InlineResponse2009DataShares</code>.
     * Number of shares in the position.
     * @alias module:model/InlineResponse2009DataShares
     */
    constructor() { 
        
        InlineResponse2009DataShares.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataShares</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataShares} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataShares} The populated <code>InlineResponse2009DataShares</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataShares();
 ...
 */
InlineResponse2009DataShares.prototype['bought'] = undefined;

/**
 * Number of shares sold.
 * @member {Number} sold
 */
InlineResponse2009DataShares.prototype['sold'] = undefined;

/**
 * Open number of shares.
 * @member {Number} open
 */
InlineResponse2009DataShares.prototype['open'] = undefined;
...
export default InlineResponse2009DataShares;
