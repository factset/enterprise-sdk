...
import PortfolioDeleteData from './PortfolioDeleteData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioDeleteData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioDeleteData} data
 */
