...
import InlineResponse2009DataProfitLossIntraday from './InlineResponse2009DataProfitLossIntraday';
import InlineResponse2009DataProfitLossPotential from './InlineResponse2009DataProfitLossPotential';

/**
 * The InlineResponse2009DataProfitLoss model module.
 * @module model/InlineResponse2009DataProfitLoss
 */
class InlineResponse2009DataProfitLoss {
    /**
     * Constructs a new <code>InlineResponse2009DataProfitLoss</code>.
     ...
     * @alias module:model/InlineResponse2009DataProfitLoss
     */
    constructor() { 
        
        InlineResponse2009DataProfitLoss.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataProfitLoss</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataProfitLoss} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataProfitLoss} The populated <code>InlineResponse2009DataProfitLoss</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataProfitLoss();

            if (data.hasOwnProperty('intraday')) {
                obj['intraday'] = InlineResponse2009DataProfitLossIntraday.constructFromObject(data['intraday']);
            }
            if (data.hasOwnProperty('potential')) {
                obj['potential'] = InlineResponse2009DataProfitLossPotential.constructFromObject(data['potential']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2009DataProfitLossIntraday} intraday
 */
InlineResponse2009DataProfitLoss.prototype['intraday'] = undefined;

/**
 * @member {module:model/InlineResponse2009DataProfitLossPotential} potential
 */
InlineResponse2009DataProfitLoss.prototype['potential'] = undefined;
...
export default InlineResponse2009DataProfitLoss;
