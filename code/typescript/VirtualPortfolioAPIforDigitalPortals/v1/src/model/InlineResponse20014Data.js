...
import InlineResponse20014DataNotation from './InlineResponse20014DataNotation';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('notation')) {
                obj['notation'] = InlineResponse20014DataNotation.constructFromObject(data['notation']);
            }
...
/**
 * @member {module:model/InlineResponse20014DataNotation} notation
 */
InlineResponse20014Data.prototype['notation'] = undefined;

/**
 * Personal note for the watchlist position.
 * @member {String} comment
 */
InlineResponse20014Data.prototype['comment'] = undefined;
