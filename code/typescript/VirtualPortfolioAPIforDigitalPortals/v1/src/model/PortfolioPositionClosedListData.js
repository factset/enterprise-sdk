...
import PortfolioPositionClosedListDataRange from './PortfolioPositionClosedListDataRange';

/**
 * The PortfolioPositionClosedListData model module.
 * @module model/PortfolioPositionClosedListData
 */
class PortfolioPositionClosedListData {
    /**
     * Constructs a new <code>PortfolioPositionClosedListData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PortfolioPositionClosedListData
     * @param id {String} Identifier of the portfolio.
     */
    constructor(id) { 
        
        PortfolioPositionClosedListData.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPositionClosedListData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPositionClosedListData} obj Optional instance to populate.
     * @return {module:model/PortfolioPositionClosedListData} The populated <code>PortfolioPositionClosedListData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPositionClosedListData();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('range')) {
                obj['range'] = PortfolioPositionClosedListDataRange.constructFromObject(data['range']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
PortfolioPositionClosedListData.prototype['id'] = undefined;

/**
 * @member {module:model/PortfolioPositionClosedListDataRange} range
 */
PortfolioPositionClosedListData.prototype['range'] = undefined;
...
export default PortfolioPositionClosedListData;
