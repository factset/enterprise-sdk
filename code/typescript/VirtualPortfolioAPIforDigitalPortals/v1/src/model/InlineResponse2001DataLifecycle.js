...
import InlineResponse2001DataLifecycleTransaction from './InlineResponse2001DataLifecycleTransaction';

/**
 * The InlineResponse2001DataLifecycle model module.
 * @module model/InlineResponse2001DataLifecycle
 */
class InlineResponse2001DataLifecycle {
    /**
     * Constructs a new <code>InlineResponse2001DataLifecycle</code>.
     * Events in the lifecycle of a portfolio.
     * @alias module:model/InlineResponse2001DataLifecycle
     */
    constructor() { 
        
        InlineResponse2001DataLifecycle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2001DataLifecycle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2001DataLifecycle} obj Optional instance to populate.
     * @return {module:model/InlineResponse2001DataLifecycle} The populated <code>InlineResponse2001DataLifecycle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2001DataLifecycle();

            if (data.hasOwnProperty('creation')) {
                obj['creation'] = ApiClient.convertToType(data['creation'], 'String');
            }
            if (data.hasOwnProperty('transaction')) {
                obj['transaction'] = InlineResponse2001DataLifecycleTransaction.constructFromObject(data['transaction']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse2001DataLifecycle.prototype['creation'] = undefined;

/**
 * @member {module:model/InlineResponse2001DataLifecycleTransaction} transaction
 */
InlineResponse2001DataLifecycle.prototype['transaction'] = undefined;
...
export default InlineResponse2001DataLifecycle;
