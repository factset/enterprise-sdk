...
import PortfolioTransactionCreateData from './PortfolioTransactionCreateData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioTransactionCreateData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioTransactionCreateData} data
 */
