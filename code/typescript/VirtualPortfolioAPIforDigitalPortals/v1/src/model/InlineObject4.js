...
import PortfolioPayoutCreateData from './PortfolioPayoutCreateData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioPayoutCreateData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioPayoutCreateData} data
 */
