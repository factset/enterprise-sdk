...
/**
 * The InlineResponse2007Transaction model module.
 * @module model/InlineResponse2007Transaction
 */
class InlineResponse2007Transaction {
    /**
     * Constructs a new <code>InlineResponse2007Transaction</code>.
     ...
     * @alias module:model/InlineResponse2007Transaction
     */
    constructor() { 
        
        InlineResponse2007Transaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007Transaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007Transaction} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007Transaction} The populated <code>InlineResponse2007Transaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007Transaction();
 ...
 * @member {String} id
 */
InlineResponse2007Transaction.prototype['id'] = undefined;
...
export default InlineResponse2007Transaction;
