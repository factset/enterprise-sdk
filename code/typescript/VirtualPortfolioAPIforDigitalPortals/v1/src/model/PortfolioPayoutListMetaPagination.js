...
/**
 * The PortfolioPayoutListMetaPagination model module.
 * @module model/PortfolioPayoutListMetaPagination
 */
class PortfolioPayoutListMetaPagination {
    /**
     * Constructs a new <code>PortfolioPayoutListMetaPagination</code>.
     * Pagination attributes for the offset-based pagination strategy.
     * @alias module:model/PortfolioPayoutListMetaPagination
     */
    constructor() { 
        
        PortfolioPayoutListMetaPagination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutListMetaPagination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutListMetaPagination} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutListMetaPagination} The populated <code>PortfolioPayoutListMetaPagination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutListMetaPagination();
 ...
 * @default 0
 */
PortfolioPayoutListMetaPagination.prototype['offset'] = 0;
 ...
 * @default 20
 */
PortfolioPayoutListMetaPagination.prototype['limit'] = 20;
...
export default PortfolioPayoutListMetaPagination;
