...
/**
 * The PortfolioPayoutListDataFilterInstrument model module.
 * @module model/PortfolioPayoutListDataFilterInstrument
 */
class PortfolioPayoutListDataFilterInstrument {
    /**
     * Constructs a new <code>PortfolioPayoutListDataFilterInstrument</code>.
     * Filtering the payouts by instrument.
     * @alias module:model/PortfolioPayoutListDataFilterInstrument
     */
    constructor() { 
        
        PortfolioPayoutListDataFilterInstrument.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutListDataFilterInstrument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutListDataFilterInstrument} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutListDataFilterInstrument} The populated <code>PortfolioPayoutListDataFilterInstrument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutListDataFilterInstrument();
 ...
 * @member {String} id
 */
PortfolioPayoutListDataFilterInstrument.prototype['id'] = undefined;
...
export default PortfolioPayoutListDataFilterInstrument;
