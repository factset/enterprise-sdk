...
/**
 * The InlineResponse20010DataTransactionBuyNotation model module.
 * @module model/InlineResponse20010DataTransactionBuyNotation
 */
class InlineResponse20010DataTransactionBuyNotation {
    /**
     * Constructs a new <code>InlineResponse20010DataTransactionBuyNotation</code>.
     * Notation of the opening transaction.
     * @alias module:model/InlineResponse20010DataTransactionBuyNotation
     */
    constructor() { 
        
        InlineResponse20010DataTransactionBuyNotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransactionBuyNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransactionBuyNotation} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransactionBuyNotation} The populated <code>InlineResponse20010DataTransactionBuyNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransactionBuyNotation();
 ...
 * @member {String} id
 */
InlineResponse20010DataTransactionBuyNotation.prototype['id'] = undefined;
...
export default InlineResponse20010DataTransactionBuyNotation;
