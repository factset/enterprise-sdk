...
/**
 * The PortfolioPayoutDeleteDataPayout model module.
 * @module model/PortfolioPayoutDeleteDataPayout
 */
class PortfolioPayoutDeleteDataPayout {
    /**
     * Constructs a new <code>PortfolioPayoutDeleteDataPayout</code>.
     * Payout of the portfolio.
     * @alias module:model/PortfolioPayoutDeleteDataPayout
     * @param id {String} Identifier of the payout.
     */
    constructor(id) { 
        
        PortfolioPayoutDeleteDataPayout.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutDeleteDataPayout</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutDeleteDataPayout} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutDeleteDataPayout} The populated <code>PortfolioPayoutDeleteDataPayout</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutDeleteDataPayout();
 ...
 * @member {String} id
 */
PortfolioPayoutDeleteDataPayout.prototype['id'] = undefined;
...
export default PortfolioPayoutDeleteDataPayout;
