...
import WatchlistPositionCreateData from './WatchlistPositionCreateData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = WatchlistPositionCreateData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/WatchlistPositionCreateData} data
 */
