...
import InlineResponse20010DataPositions from './InlineResponse20010DataPositions';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('positions')) {
                obj['positions'] = ApiClient.convertToType(data['positions'], [InlineResponse20010DataPositions]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/InlineResponse20010DataPositions>} positions
 */
InlineResponse20010Data.prototype['positions'] = undefined;
