...
import PortfolioCreateData from './PortfolioCreateData';
...
class InlineObject {
     ...
     * @param data {module:model/PortfolioCreateData} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioCreateData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioCreateData} data
 */
