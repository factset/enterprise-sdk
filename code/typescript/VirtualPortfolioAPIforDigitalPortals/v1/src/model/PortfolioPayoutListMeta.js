...
import PortfolioPayoutListMetaPagination from './PortfolioPayoutListMetaPagination';

/**
 * The PortfolioPayoutListMeta model module.
 * @module model/PortfolioPayoutListMeta
 */
class PortfolioPayoutListMeta {
    /**
     * Constructs a new <code>PortfolioPayoutListMeta</code>.
     * The meta member contains the meta information of the request.
     * @alias module:model/PortfolioPayoutListMeta
     */
    constructor() { 
        
        PortfolioPayoutListMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutListMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutListMeta} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutListMeta} The populated <code>PortfolioPayoutListMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutListMeta();
            ...
            if (data.hasOwnProperty('pagination')) {
                obj['pagination'] = PortfolioPayoutListMetaPagination.constructFromObject(data['pagination']);
            }
        }
        return obj;
    }
 ...
 */
PortfolioPayoutListMeta.prototype['attributes'] = undefined;
 ...
 * @member {Array.<module:model/PortfolioPayoutListMeta.SortEnum>} sort
 */
PortfolioPayoutListMeta.prototype['sort'] = undefined;

/**
 * @member {module:model/PortfolioPayoutListMetaPagination} pagination
 */
PortfolioPayoutListMeta.prototype['pagination'] = undefined;
 ...
 * @readonly
 */
PortfolioPayoutListMeta['SortEnum'] = {
...
export default PortfolioPayoutListMeta;
