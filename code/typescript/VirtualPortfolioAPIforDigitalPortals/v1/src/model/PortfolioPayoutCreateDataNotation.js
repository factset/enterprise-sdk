...
/**
 * The PortfolioPayoutCreateDataNotation model module.
 * @module model/PortfolioPayoutCreateDataNotation
 */
class PortfolioPayoutCreateDataNotation {
    /**
     * Constructs a new <code>PortfolioPayoutCreateDataNotation</code>.
     * Notation of the position.
     * @alias module:model/PortfolioPayoutCreateDataNotation
     * @param id {String} Identifier of the notation.
     */
    constructor(id) { 
        
        PortfolioPayoutCreateDataNotation.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutCreateDataNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutCreateDataNotation} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutCreateDataNotation} The populated <code>PortfolioPayoutCreateDataNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutCreateDataNotation();
 ...
 * @member {String} id
 */
PortfolioPayoutCreateDataNotation.prototype['id'] = undefined;
...
export default PortfolioPayoutCreateDataNotation;
