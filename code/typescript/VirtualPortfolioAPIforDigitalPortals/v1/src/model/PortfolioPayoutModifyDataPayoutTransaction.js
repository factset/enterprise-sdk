...
/**
 * The PortfolioPayoutModifyDataPayoutTransaction model module.
 * @module model/PortfolioPayoutModifyDataPayoutTransaction
 */
class PortfolioPayoutModifyDataPayoutTransaction {
    /**
     * Constructs a new <code>PortfolioPayoutModifyDataPayoutTransaction</code>.
     ...
     * @alias module:model/PortfolioPayoutModifyDataPayoutTransaction
     */
    constructor() { 
        
        PortfolioPayoutModifyDataPayoutTransaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutModifyDataPayoutTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutModifyDataPayoutTransaction} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutModifyDataPayoutTransaction} The populated <code>PortfolioPayoutModifyDataPayoutTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutModifyDataPayoutTransaction();
 ...
 * @member {String} id
 */
PortfolioPayoutModifyDataPayoutTransaction.prototype['id'] = undefined;
...
export default PortfolioPayoutModifyDataPayoutTransaction;
