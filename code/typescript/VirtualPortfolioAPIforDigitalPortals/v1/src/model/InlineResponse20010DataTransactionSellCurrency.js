...
/**
 * The InlineResponse20010DataTransactionSellCurrency model module.
 * @module model/InlineResponse20010DataTransactionSellCurrency
 */
class InlineResponse20010DataTransactionSellCurrency {
    /**
     * Constructs a new <code>InlineResponse20010DataTransactionSellCurrency</code>.
     * Currency of the closing transaction. See endpoint &#x60;/basic/valueUnit/currency/main/list&#x60; for possible values.
     * @alias module:model/InlineResponse20010DataTransactionSellCurrency
     */
    constructor() { 
        
        InlineResponse20010DataTransactionSellCurrency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransactionSellCurrency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransactionSellCurrency} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransactionSellCurrency} The populated <code>InlineResponse20010DataTransactionSellCurrency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransactionSellCurrency();
 ...
 * @member {Number} id
 */
InlineResponse20010DataTransactionSellCurrency.prototype['id'] = undefined;

/**
 * ISO 4217 code of the currency.
 * @member {String} isoCode
 */
InlineResponse20010DataTransactionSellCurrency.prototype['isoCode'] = undefined;
...
export default InlineResponse20010DataTransactionSellCurrency;
