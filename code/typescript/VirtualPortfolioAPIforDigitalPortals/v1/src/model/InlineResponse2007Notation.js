...
/**
 * The InlineResponse2007Notation model module.
 * @module model/InlineResponse2007Notation
 */
class InlineResponse2007Notation {
    /**
     * Constructs a new <code>InlineResponse2007Notation</code>.
     * Notation of the payout.
     * @alias module:model/InlineResponse2007Notation
     */
    constructor() { 
        
        InlineResponse2007Notation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007Notation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007Notation} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007Notation} The populated <code>InlineResponse2007Notation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007Notation();
 ...
 * @member {String} id
 */
InlineResponse2007Notation.prototype['id'] = undefined;
...
export default InlineResponse2007Notation;
