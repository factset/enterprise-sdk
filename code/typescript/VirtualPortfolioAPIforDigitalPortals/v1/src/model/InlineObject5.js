...
import PortfolioPayoutDeleteData from './PortfolioPayoutDeleteData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioPayoutDeleteData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioPayoutDeleteData} data
 */
