...
/**
 * The InlineResponse2009DataPurchase model module.
 * @module model/InlineResponse2009DataPurchase
 */
class InlineResponse2009DataPurchase {
    /**
     * Constructs a new <code>InlineResponse2009DataPurchase</code>.
     * Purchase details of the position.
     * @alias module:model/InlineResponse2009DataPurchase
     */
    constructor() { 
        
        InlineResponse2009DataPurchase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataPurchase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataPurchase} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataPurchase} The populated <code>InlineResponse2009DataPurchase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataPurchase();
...
export default InlineResponse2009DataPurchase;
