...
/**
 * The InlineResponse20015Notation model module.
 * @module model/InlineResponse20015Notation
 */
class InlineResponse20015Notation {
    /**
     * Constructs a new <code>InlineResponse20015Notation</code>.
     * Notation of the position.
     * @alias module:model/InlineResponse20015Notation
     */
    constructor() { 
        
        InlineResponse20015Notation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20015Notation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20015Notation} obj Optional instance to populate.
     * @return {module:model/InlineResponse20015Notation} The populated <code>InlineResponse20015Notation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20015Notation();
 ...
 * @member {String} id
 */
InlineResponse20015Notation.prototype['id'] = undefined;
...
export default InlineResponse20015Notation;
