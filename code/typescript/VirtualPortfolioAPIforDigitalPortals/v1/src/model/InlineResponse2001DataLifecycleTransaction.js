...
/**
 * The InlineResponse2001DataLifecycleTransaction model module.
 * @module model/InlineResponse2001DataLifecycleTransaction
 */
class InlineResponse2001DataLifecycleTransaction {
    /**
     * Constructs a new <code>InlineResponse2001DataLifecycleTransaction</code>.
     * Date and time of the portfolio.
     * @alias module:model/InlineResponse2001DataLifecycleTransaction
     */
    constructor() { 
        
        InlineResponse2001DataLifecycleTransaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2001DataLifecycleTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2001DataLifecycleTransaction} obj Optional instance to populate.
     * @return {module:model/InlineResponse2001DataLifecycleTransaction} The populated <code>InlineResponse2001DataLifecycleTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2001DataLifecycleTransaction();
 ...
 * @member {String} first
 */
InlineResponse2001DataLifecycleTransaction.prototype['first'] = undefined;

/**
 * Date and time of the most recent transaction.
 * @member {String} latest
 */
InlineResponse2001DataLifecycleTransaction.prototype['latest'] = undefined;
...
export default InlineResponse2001DataLifecycleTransaction;
