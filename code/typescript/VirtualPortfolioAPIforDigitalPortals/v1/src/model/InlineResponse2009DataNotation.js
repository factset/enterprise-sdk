...
import InlineResponse2009DataNotationPrice from './InlineResponse2009DataNotationPrice';

/**
 * The InlineResponse2009DataNotation model module.
 * @module model/InlineResponse2009DataNotation
 */
class InlineResponse2009DataNotation {
    /**
     * Constructs a new <code>InlineResponse2009DataNotation</code>.
     * Notation of the transaction establishing the position, i.e. its first transaction.
     * @alias module:model/InlineResponse2009DataNotation
     */
    constructor() { 
        
        InlineResponse2009DataNotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2009DataNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2009DataNotation} obj Optional instance to populate.
     * @return {module:model/InlineResponse2009DataNotation} The populated <code>InlineResponse2009DataNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2009DataNotation();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('price')) {
                obj['price'] = InlineResponse2009DataNotationPrice.constructFromObject(data['price']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
InlineResponse2009DataNotation.prototype['id'] = undefined;

/**
 * @member {module:model/InlineResponse2009DataNotationPrice} price
 */
InlineResponse2009DataNotation.prototype['price'] = undefined;
...
export default InlineResponse2009DataNotation;
