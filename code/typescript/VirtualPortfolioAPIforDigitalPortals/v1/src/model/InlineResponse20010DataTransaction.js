...
import InlineResponse20010DataTransactionBuy from './InlineResponse20010DataTransactionBuy';
import InlineResponse20010DataTransactionSell from './InlineResponse20010DataTransactionSell';

/**
 * The InlineResponse20010DataTransaction model module.
 * @module model/InlineResponse20010DataTransaction
 */
class InlineResponse20010DataTransaction {
    /**
     * Constructs a new <code>InlineResponse20010DataTransaction</code>.
     * Opening and closing transaction of the closed position.
     * @alias module:model/InlineResponse20010DataTransaction
     */
    constructor() { 
        
        InlineResponse20010DataTransaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransaction} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransaction} The populated <code>InlineResponse20010DataTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransaction();

            if (data.hasOwnProperty('buy')) {
                obj['buy'] = InlineResponse20010DataTransactionBuy.constructFromObject(data['buy']);
            }
            if (data.hasOwnProperty('sell')) {
                obj['sell'] = InlineResponse20010DataTransactionSell.constructFromObject(data['sell']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20010DataTransactionBuy} buy
 */
InlineResponse20010DataTransaction.prototype['buy'] = undefined;

/**
 * @member {module:model/InlineResponse20010DataTransactionSell} sell
 */
InlineResponse20010DataTransaction.prototype['sell'] = undefined;
...
export default InlineResponse20010DataTransaction;
