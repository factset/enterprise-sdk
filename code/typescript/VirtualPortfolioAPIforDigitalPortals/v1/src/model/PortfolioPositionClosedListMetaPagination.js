...
/**
 * The PortfolioPositionClosedListMetaPagination model module.
 * @module model/PortfolioPositionClosedListMetaPagination
 */
class PortfolioPositionClosedListMetaPagination {
    /**
     * Constructs a new <code>PortfolioPositionClosedListMetaPagination</code>.
     * Pagination attributes for the offset-based pagination strategy.
     * @alias module:model/PortfolioPositionClosedListMetaPagination
     */
    constructor() { 
        
        PortfolioPositionClosedListMetaPagination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortfolioPositionClosedListMetaPagination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPositionClosedListMetaPagination} obj Optional instance to populate.
     * @return {module:model/PortfolioPositionClosedListMetaPagination} The populated <code>PortfolioPositionClosedListMetaPagination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPositionClosedListMetaPagination();
 ...
 * @default 0
 */
PortfolioPositionClosedListMetaPagination.prototype['offset'] = 0;
 ...
 * @default 20
 */
PortfolioPositionClosedListMetaPagination.prototype['limit'] = 20;
...
export default PortfolioPositionClosedListMetaPagination;
