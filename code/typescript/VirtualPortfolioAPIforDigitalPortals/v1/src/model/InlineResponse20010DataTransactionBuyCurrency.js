...
/**
 * The InlineResponse20010DataTransactionBuyCurrency model module.
 * @module model/InlineResponse20010DataTransactionBuyCurrency
 */
class InlineResponse20010DataTransactionBuyCurrency {
    /**
     * Constructs a new <code>InlineResponse20010DataTransactionBuyCurrency</code>.
     * Currency of the opening transaction. See endpoint &#x60;/basic/valueUnit/currency/main/list&#x60; for possible values.
     * @alias module:model/InlineResponse20010DataTransactionBuyCurrency
     */
    constructor() { 
        
        InlineResponse20010DataTransactionBuyCurrency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataTransactionBuyCurrency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataTransactionBuyCurrency} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataTransactionBuyCurrency} The populated <code>InlineResponse20010DataTransactionBuyCurrency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataTransactionBuyCurrency();
 ...
 * @member {Number} id
 */
InlineResponse20010DataTransactionBuyCurrency.prototype['id'] = undefined;

/**
 * ISO 4217 code of the currency.
 * @member {String} isoCode
 */
InlineResponse20010DataTransactionBuyCurrency.prototype['isoCode'] = undefined;
...
export default InlineResponse20010DataTransactionBuyCurrency;
