...
import PortfolioTransactionDeleteData from './PortfolioTransactionDeleteData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PortfolioTransactionDeleteData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PortfolioTransactionDeleteData} data
 */
