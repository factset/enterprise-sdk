...
/**
 * The InlineResponse20010DataPayout model module.
 * @module model/InlineResponse20010DataPayout
 */
class InlineResponse20010DataPayout {
    /**
     * Constructs a new <code>InlineResponse20010DataPayout</code>.
     * Amount of money received from payouts in the portfolio&#39;s base currency.
     * @alias module:model/InlineResponse20010DataPayout
     */
    constructor() { 
        
        InlineResponse20010DataPayout.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20010DataPayout</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20010DataPayout} obj Optional instance to populate.
     * @return {module:model/InlineResponse20010DataPayout} The populated <code>InlineResponse20010DataPayout</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20010DataPayout();
 ...
 */
InlineResponse20010DataPayout.prototype['amount'] = undefined;
...
export default InlineResponse20010DataPayout;
