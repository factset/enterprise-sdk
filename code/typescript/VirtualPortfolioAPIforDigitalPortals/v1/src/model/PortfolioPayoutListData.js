...
import PortfolioPayoutListDataFilter from './PortfolioPayoutListDataFilter';

/**
 * The PortfolioPayoutListData model module.
 * @module model/PortfolioPayoutListData
 */
class PortfolioPayoutListData {
    /**
     * Constructs a new <code>PortfolioPayoutListData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PortfolioPayoutListData
     * @param id {String} Identifier of the portfolio.
     */
    constructor(id) { 
        
        PortfolioPayoutListData.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PortfolioPayoutListData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioPayoutListData} obj Optional instance to populate.
     * @return {module:model/PortfolioPayoutListData} The populated <code>PortfolioPayoutListData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioPayoutListData();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('filter')) {
                obj['filter'] = PortfolioPayoutListDataFilter.constructFromObject(data['filter']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
PortfolioPayoutListData.prototype['id'] = undefined;

/**
 * @member {module:model/PortfolioPayoutListDataFilter} filter
 */
PortfolioPayoutListData.prototype['filter'] = undefined;
...
export default PortfolioPayoutListData;
