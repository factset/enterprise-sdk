...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/trading/ems/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/trading/ems/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetTrading/1.0.0 (${process.platform}; node ${process.version})`
        };
    ...
    */
    hostSettings() {
        return [
            ...
            {
              'url': "https://api.uat.factset.com/trading/ems/v1",
              'description': "UAT",
            }
      ];
    }
