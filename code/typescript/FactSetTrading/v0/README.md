...
[![npm](https://img.shields.io/badge/npm-v0.26.1-orange)](https://www.npmjs.com/package/@factset/sdk-factsettrading/v/0.26.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsettrading@0.26.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsettrading@0.26.1
```
