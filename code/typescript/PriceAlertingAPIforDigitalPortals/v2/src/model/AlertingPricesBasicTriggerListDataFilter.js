...
import AlertingPricesBasicTriggerListDataFilterStatus from './AlertingPricesBasicTriggerListDataFilterStatus';
...
class AlertingPricesBasicTriggerListDataFilter {
    /**
     * Constructs a new <code>AlertingPricesBasicTriggerListDataFilter</code>.
     * Criteria that filter the items in the response list.
     * @alias module:model/AlertingPricesBasicTriggerListDataFilter
     */
    constructor() { 
        
        AlertingPricesBasicTriggerListDataFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AlertingPricesBasicTriggerListDataFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlertingPricesBasicTriggerListDataFilter} obj Optional instance to populate.
     * @return {module:model/AlertingPricesBasicTriggerListDataFilter} The populated <code>AlertingPricesBasicTriggerListDataFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlertingPricesBasicTriggerListDataFilter();

            if (data.hasOwnProperty('status')) {
                obj['status'] = AlertingPricesBasicTriggerListDataFilterStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/AlertingPricesBasicTriggerListDataFilterStatus} status
 */
AlertingPricesBasicTriggerListDataFilter.prototype['status'] = undefined;
...
export default AlertingPricesBasicTriggerListDataFilter;
