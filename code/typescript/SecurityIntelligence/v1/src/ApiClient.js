...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/security-intelligence/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/security-intelligence/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/SecurityIntelligence/0.1.0 (${process.platform}; node ${process.version})`
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.factset.com/security-intelligence/v1",
