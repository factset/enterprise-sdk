...
[![npm](https://img.shields.io/badge/npm-v0.1.1-orange)](https://www.npmjs.com/package/@factset/sdk-securityintelligence/v/0.1.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-securityintelligence@0.1.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-securityintelligence@0.1.1
```
