...
**metrics** | **[String]** | Array of FOCUS metric codes to retrieve.  - Income Statement: FSF_FR_COMMISS_FEE_INC, FSF_FR_COMMISS_FEE_EXP, FSF_FR_COMMISS_FEE_EXP_OTH - Balance Sheet: Various asset and liability metrics - Net Capital: FSF_FR_NET_CAP, FSF_FR_FM_NET_CAP_REQ, FSF_FR_FM_NET_CAP_REQ_ALT  Omit to retrieve all available metrics. Use the &#x60;/metrics&#x60; endpoint to retrieve the full list of available metric codes and their definitions.  | 
