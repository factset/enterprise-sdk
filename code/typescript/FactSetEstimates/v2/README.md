...
[![API Version](https://img.shields.io/badge/api-v2.9.0-blue)]()
[![npm](https://img.shields.io/badge/npm-v4.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetestimates/v/4.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetestimates@4.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetestimates@4.2.0
```
