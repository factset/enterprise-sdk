...
[![API Version](https://img.shields.io/badge/api-v2.9.1-blue)]()
[![npm](https://img.shields.io/badge/npm-v4.3.1-orange)](https://www.npmjs.com/package/@factset/sdk-factsetestimates/v/4.3.1)
...
All endpoints, except /company-reports/_* and /metrics are limited to a quota of 4 million datapoints per minute. Requests exceeding this limit (greater than 4 million datapoints per minute) will receive a 429 response.    
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetestimates@4.3.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetestimates@4.3.1
```
...
*factsetestimates.DataItemsApi* | [**getEstimateSegmentDetailMetrics**](docs/DataItemsApi.md#getEstimateSegmentDetailMetrics) | **GET** /factset-estimates/v2/segments-metrics | Available Estimate Segment Detail metrics
...
*factsetestimates.GuidanceApi* | [**getGuidance**](docs/GuidanceApi.md#getGuidance) | **GET** /factset-estimates/v2/guidance | Retrieves guidance for a requested list of ids and dates.
*factsetestimates.GuidanceApi* | [**getGuidanceForList**](docs/GuidanceApi.md#getGuidanceForList) | **POST** /factset-estimates/v2/guidance | Retrieves guidance for a requested list of ids and dates.
...
*factsetestimates.SegmentsApi* | [**getSegmentsDetailsForList**](docs/SegmentsApi.md#getSegmentsDetailsForList) | **POST** /factset-estimates/v2/segments-detail | Retrieves product segment detail estimates for a requested list of ids and fiscal periods
...
## Documentation for Models
 ...
 - [factsetestimates.Guidance](docs/Guidance.md)
 - [factsetestimates.GuidanceRequest](docs/GuidanceRequest.md)
 - [factsetestimates.GuidanceRequestBody](docs/GuidanceRequestBody.md)
 - [factsetestimates.GuidanceResponse](docs/GuidanceResponse.md)
 - [factsetestimates.Meta](docs/Meta.md)
 - [factsetestimates.Metric](docs/Metric.md)
 - [factsetestimates.MetricSegmentDetail](docs/MetricSegmentDetail.md)
 - [factsetestimates.MetricsRequest](docs/MetricsRequest.md)
 - [factsetestimates.MetricsResponse](docs/MetricsResponse.md)
 - [factsetestimates.MetricsSegmentDetailResponse](docs/MetricsSegmentDetailResponse.md)
 ...
 - [factsetestimates.SegmentsDetailsEstimate](docs/SegmentsDetailsEstimate.md)
 - [factsetestimates.SegmentsDetailsRequest](docs/SegmentsDetailsRequest.md)
 - [factsetestimates.SegmentsDetailsResponse](docs/SegmentsDetailsResponse.md)
