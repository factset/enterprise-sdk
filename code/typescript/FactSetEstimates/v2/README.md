...
[![API Version](https://img.shields.io/badge/api-v2.6.2-blue)]()
[![npm](https://img.shields.io/badge/npm-v2.2.4-orange)](https://www.npmjs.com/package/@factset/sdk-factsetestimates/v/2.2.4)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetestimates@2.2.4
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetestimates@2.2.4
```
