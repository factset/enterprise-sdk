...
class FixedDetailRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('includeDocId') && obj['includeDocId'] === undefined) {
                obj['includeDocId'] = ApiClient.convertToType(data['includeDocId'], 'Boolean');
            }
 ...
 * @member {Boolean} includeDocId
 * @default false
 */
FixedDetailRequest.prototype['includeDocId'] = false;
