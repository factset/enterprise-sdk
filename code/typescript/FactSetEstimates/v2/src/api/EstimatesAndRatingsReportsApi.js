...
export default class EstimatesAndRatingsReportsApi {
    ...
    */
     ...
     * @param {String} id The requested security identifier. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent IDs. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AnalystRatingResponse} and HTTP response
     */
    getAnalystRatingsWithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAnalystRatings");
      }
      ...
      let returnType = AnalystRatingResponse;

      return this.apiClient.callApi(
        '/factset-estimates/v2/company-reports/analyst-ratings', 'GET',
     ...
     * Returns historical monthly view of analyst ratings for given identifier upto a period of 12 months. 
     * @param {String} id The requested security identifier. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent IDs. 
     * @return { Promise.< module:model/AnalystRatingResponse > } a Promise, with data of type {@link module:model/AnalystRatingResponse }
     */
    getAnalystRatings(id) {
      return this.getAnalystRatingsWithHttpInfo(id)
