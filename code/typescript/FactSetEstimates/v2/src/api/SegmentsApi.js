...
import SegmentsDetailsRequest from '../model/SegmentsDetailsRequest';
import SegmentsDetailsResponse from '../model/SegmentsDetailsResponse';
...
export default class SegmentsApi {
    ...
    */
     ...
     * @param {Date} opts.startDate Start of the perspective date range for estimates, expressed in YYYY-MM-DD format. If left blank, the API defaults to the start of the latest company reporting period. Future dates (T+1) are not accepted.
     * @param {Date} opts.endDate End of the perspective date range for estimates, expressed in YYYY-MM-DD format. If left blank, the API defaults to the end of the latest company reporting period. Future dates (T+1) are not accepted.
     ...
     * @param {module:model/SegmentsDetailsRequest} segmentsDetailsRequest Request object for Product Segments estimates.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/SegmentsDetailsResponse} and HTTP response
     */
    getSegmentsDetailsForListWithHttpInfo(segmentsDetailsRequest) {
      let postBody = segmentsDetailsRequest;
      // verify the required parameter 'segmentsDetailsRequest' is set
      if (segmentsDetailsRequest === undefined || segmentsDetailsRequest === null) {
        throw new Error("Missing the required parameter 'segmentsDetailsRequest' when calling getSegmentsDetailsForList");
      }
      ...
      let returnType = SegmentsDetailsResponse;

      return this.apiClient.callApi(
        '/factset-estimates/v2/segments-detail', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Returns FactSet Estimates Details Data for the segments gathered from the Business, Geographical, or Actual Reconciliation (ADJUSTMENT) classifications by using fiscal periods with a reporting frequency.  
     * @param {module:model/SegmentsDetailsRequest} segmentsDetailsRequest Request object for Product Segments estimates.
     * @return { Promise.< module:model/SegmentsDetailsResponse > } a Promise, with data of type {@link module:model/SegmentsDetailsResponse }
     */
    getSegmentsDetailsForList(segmentsDetailsRequest) {
      return this.getSegmentsDetailsForListWithHttpInfo(segmentsDetailsRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
