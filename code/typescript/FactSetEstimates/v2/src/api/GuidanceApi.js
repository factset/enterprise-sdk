...
export default class GuidanceApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GuidanceResponse} and HTTP response
     */
    getGuidanceWithHttpInfo(ids, metrics, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getGuidance");
      }
      // verify the required parameter 'metrics' is set
      if (metrics === undefined || metrics === null) {
        throw new Error("Missing the required parameter 'metrics' when calling getGuidance");
      }
      ...
      let returnType = GuidanceResponse;

      return this.apiClient.callApi(
        '/factset-estimates/v2/guidance', 'GET',
     ...
     * @param {module:model/String} opts.frequency Controls the frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **AM** = Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).         * **AQ** = Quarterly, based on the start date.   * **AY** = Actual Annual, based on the start date.   (default to 'AM')
     * @param {String} opts.currency Currency code for adjusting the data. Use `ESTIMATE` as input value for the values in Estimate Currency. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470).
     * @return { Promise.< module:model/GuidanceResponse > } a Promise, with data of type {@link module:model/GuidanceResponse }
     */
    getGuidance(ids, metrics, opts) {
      return this.getGuidanceWithHttpInfo(ids, metrics, opts)
     ...
     * Retrieves guidance for a requested list of ids and dates.
     * Returns FactSet Estimates guidance data for the current unreported period as of the requested dates. <p> 
     * @param {module:model/GuidanceRequest} guidanceRequest Request object for Estimate Data Items.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GuidanceResponse} and HTTP response
     */
    getGuidanceForListWithHttpInfo(guidanceRequest) {
      let postBody = guidanceRequest;
      // verify the required parameter 'guidanceRequest' is set
      if (guidanceRequest === undefined || guidanceRequest === null) {
        throw new Error("Missing the required parameter 'guidanceRequest' when calling getGuidanceForList");
      }
      ...
      return this.apiClient.callApi(
        '/factset-estimates/v2/guidance', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/GuidanceResponse > } a Promise, with data of type {@link module:model/GuidanceResponse }
     */
    getGuidanceForList(guidanceRequest) {
      return this.getGuidanceForListWithHttpInfo(guidanceRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
