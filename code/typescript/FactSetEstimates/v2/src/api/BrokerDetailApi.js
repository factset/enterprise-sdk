...
export default class BrokerDetailApi {
    ...
    */
     ...
     * @param {Boolean} opts.includeDocId Controls whether the `docId` field is included in the response.   * **TRUE** = Returns the `docId` field, a unique identifier linking the estimate to the corresponding investment report in FactSet's Investment Research API.   * **FALSE** = Omits the `docId` field from the response. (default)  (default to false)
    ...
    getFixedDetailWithHttpInfo(ids, metrics, opts) {
      ...
      let queryParams = {
        ...
        'includeDocId': opts['includeDocId']
      };
      let headerParams = {
      };
      let formParams = {
