...
import MetricsSegmentDetailResponse from '../model/MetricsSegmentDetailResponse';
...
export default class DataItemsApi {
    ...
    */
     ...
     * @param {Array.<String>} ids Security or Entity identifiers. Accepted inputs include FactSet Identifiers, tickers, CUSIP, and SEDOL. 
     * @param {Array.<String>} metrics Requested metric. Use the `/metrics` endpoint to return a list of available estimate items. **Top 10** most used metrics are **EPS, SALES, DPS, EBITDA, EBIT, PRICE_TGT, CFPS, BPS, NET_INC, and ASSETS**. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034). 
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.segmentType Controls the type of segment selected.   * **BUS** = Business / Product Segment   * **GEO** = Geographic Segment   * **ALL** = Both Business and Geographic Segments  (default to 'BUS')
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MetricsSegmentDetailResponse} and HTTP response
     */
    getEstimateSegmentDetailMetricsWithHttpInfo(ids, metrics, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getEstimateSegmentDetailMetrics");
      }
      // verify the required parameter 'metrics' is set
      if (metrics === undefined || metrics === null) {
        throw new Error("Missing the required parameter 'metrics' when calling getEstimateSegmentDetailMetrics");
      }
      ...
      let returnType = MetricsSegmentDetailResponse;

      return this.apiClient.callApi(
        '/factset-estimates/v2/segments-metrics', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.segmentType Controls the type of segment selected.   * **BUS** = Business / Product Segment   * **GEO** = Geographic Segment   * **ALL** = Both Business and Geographic Segments  (default to 'BUS')
     * @return { Promise.< module:model/MetricsSegmentDetailResponse > } a Promise, with data of type {@link module:model/MetricsSegmentDetailResponse }
     */
    getEstimateSegmentDetailMetrics(ids, metrics, opts) {
      return this.getEstimateSegmentDetailMetricsWithHttpInfo(ids, metrics, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
