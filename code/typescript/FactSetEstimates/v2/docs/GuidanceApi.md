...
> GuidanceResponse getGuidance(ids, metrics, opts)
...
```javascript
const { ApiClient, GuidanceApi } = require('@factset/sdk-factsetestimates');
...
const apiInstance = new GuidanceApi();
...
// Call api endpoint
apiInstance.getGuidance(ids, metrics, opts).then(
  data => {
...
> GuidanceResponse getGuidanceForList(guidanceRequest)
...
const apiInstance = new GuidanceApi();
const guidanceRequest = new factsetestimates.GuidanceRequest(); // GuidanceRequest | Request object for Estimate Data Items.

// Call api endpoint
apiInstance.getGuidanceForList(guidanceRequest).then(
  data => {
