...
const apiInstance = new SegmentsApi();
const segmentsDetailsRequest = new factsetestimates.SegmentsDetailsRequest(); // SegmentsDetailsRequest | Request object for Product Segments estimates.

// Call api endpoint
apiInstance.getSegmentsDetailsForList(segmentsDetailsRequest).then(
  data => {
