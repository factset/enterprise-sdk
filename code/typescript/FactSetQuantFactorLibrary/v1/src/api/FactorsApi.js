...
export default class FactorsApi {
    ...
    */
     ...
     * @param {Array.<String>} opts.factors Array of individual Factor Items requested. For a list of all available factors and descriptions use the `/library` endpoint.***<p>factors limit** = 20 individual factors per request* 
     ...
     */
    getFactorsWithHttpInfo(ids, startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getFactors(ids, startDate, endDate, opts) {
      return this.getFactorsWithHttpInfo(ids, startDate, endDate, opts)
