...
[![npm](https://img.shields.io/badge/npm-v2.1.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetquantfactorlibrary/v/2.1.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetquantfactorlibrary@2.1.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetquantfactorlibrary@2.1.0
```
...
```javascript
const { ApiClient } = require('@factset/sdk-factsetquantfactorlibrary');
