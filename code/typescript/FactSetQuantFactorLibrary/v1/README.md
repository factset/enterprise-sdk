# @factset/sdk-factsetquantfactorlibrary

factsetquantfactorlibrary - JavaScript client for @factset/sdk-factsetquantfactorlibrary
...
```shell
npm install @factset/sdk-factsetquantfactorlibrary --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your @factset/sdk-factsetquantfactorlibrary from, and run:
