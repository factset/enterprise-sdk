# factsetquantfactorlibrary.HelperApi
...
> LibraryResponse getFactorLibrary(opts)
...
const opts = {
  'factors': ["rsi21D","ulcer252D","turbulence21D"], // [String] | Array of individual Factor Items requested for the library endpoint. Use the factorGroups parameter to pull for a full list of factors based off the input group.  
...
------------- | ------------- | ------------- | -------------
 **factors** | [**[String]**](String.md)| Array of individual Factor Items requested for the library endpoint. Use the factorGroups parameter to pull for a full list of factors based off the input group.   | [optional] 
...
const apiInstance = new HelperApi();
const libraryRequest = new factsetquantfactorlibrary.LibraryRequest(); // LibraryRequest | Available Factors and Related Meta Data.
