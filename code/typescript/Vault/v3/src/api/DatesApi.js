...
export default class DatesApi {
    ...
    */
     ...
     * @param {String} componentid Vault Component Id. This is a sample example for illustration purposes only. Client should use a valid Component Id to get a successful response.
     * @param {String} account Account. This is a sample example for illustration purposes only. Client should use a valid Component Id to get a successful response.
