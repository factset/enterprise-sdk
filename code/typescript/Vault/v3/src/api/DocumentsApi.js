...
export default class DocumentsApi {
    ...
    */
     ...
     * @param {String} path The directory to get the documents in. This is a sample example for illustration purposes only. Client should use a valid Directory/Sub-Directory to get a successful response.
