...
export default class TranscriptsApi {
    ...
    */
     ...
     * @param {Array.<String>} opts.ids Requested symbols or securities. This is a list with a maximum limit of 1000. Each symbol can be a FactSet exchange symbol, CUSIP, SEDOL, ISIN, or Entity ID > **Note**: If this parameter is not used, `null` will be returned for the `requestId` field in the response.
     ...
     */
    getTranscriptsIntelligenceWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getTranscriptsIntelligence(opts) {
      return this.getTranscriptsIntelligenceWithHttpInfo(opts)
     ...
     * @param {Date} startDate Start Date. Format is YYYY-MM-DD   **The API supports data from 1999 onwards. Ensure that the provided Date falls within this range for accurate results.** 
