...
/**
 * The Plist model module.
 * @module model/Plist
 */
class Plist {
    /**
     * Constructs a new <code>Plist</code>.
     ...
     * @alias module:model/Plist
     */
    constructor() { 
        
        Plist.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Plist</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Plist} obj Optional instance to populate.
     * @return {module:model/Plist} The populated <code>Plist</code> instance.
     */
