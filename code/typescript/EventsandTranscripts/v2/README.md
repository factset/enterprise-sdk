...
[![npm](https://img.shields.io/badge/npm-v2.1.3-orange)](https://www.npmjs.com/package/@factset/sdk-eventsandtranscripts/v/2.1.3)
...
```shell
npm install @factset/sdk-utils @factset/sdk-eventsandtranscripts@2.1.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-eventsandtranscripts@2.1.3
```
