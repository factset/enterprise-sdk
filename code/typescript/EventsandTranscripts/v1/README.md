...
```shell
npm install @factset/sdk-utils @factset/sdk-eventsandtranscripts@0.20.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-eventsandtranscripts@0.20.0
```
...
## Documentation for Models
 ...
 - [eventsandtranscripts.EventsAudioDailyFileNameData](docs/EventsAudioDailyFileNameData.md)
 ...
 - [eventsandtranscripts.EventsAudioHistoryData](docs/EventsAudioHistoryData.md)
