...
[![npm](https://img.shields.io/badge/npm-v1.1.1-orange)](https://www.npmjs.com/package/@factset/sdk-eventsandtranscripts/v/1.1.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-eventsandtranscripts@1.1.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-eventsandtranscripts@1.1.1
```
