...
const apiInstance = new EventsAudioApi();
const opts = {
  'startDate': 2020-10-01, // Date | The earliest date of the audio file the API should fetch for.  - Format: Should be absolute (YYYY-MM-DD). 
  'endDate': 2020-12-26, // Date | The latest date of the audio file the API should fetch for. - Format: Should be absolute (YYYY-MM-DD). 
