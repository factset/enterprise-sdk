...
/**
 * The TranscriptObject model module.
 * @module model/TranscriptObject
 */
class TranscriptObject {
    /**
     * Constructs a new <code>TranscriptObject</code>.
     * @alias module:model/TranscriptObject
     */
    constructor() { 
        
        TranscriptObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TranscriptObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TranscriptObject} obj Optional instance to populate.
     * @return {module:model/TranscriptObject} The populated <code>TranscriptObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TranscriptObject();
 ...
 */
TranscriptObject.prototype['versionId'] = undefined;

/**
 * Refers to the main companies a particular document pertains to.
 * @member {Array.<String>} primaryIds
 */
TranscriptObject.prototype['primaryIds'] = undefined;

/**
 * Refers to all companies mentioned in the document. 
 * @member {Array.<String>} allIds
 */
TranscriptObject.prototype['allIds'] = undefined;

/**
 * This is a unique identifier for a specific transcript (audio or video) returned.
 * @member {String} reportId
 */
TranscriptObject.prototype['reportId'] = undefined;

/**
 * ID of the conference call.
 * @member {String} eventId
 */
TranscriptObject.prototype['eventId'] = undefined;

/**
 * The date when the event took place. Formatted as 'YYYY-MM-DD'.
 * @member {Date} eventDate
 */
TranscriptObject.prototype['eventDate'] = undefined;

/**
 * Specifies the type of transcript.  
 * @member {module:model/TranscriptObject.TranscriptTypeEnum} transcriptType
 */
TranscriptObject.prototype['transcriptType'] = undefined;

/**
 * Headline of the story.
 * @member {String} headline
 */
TranscriptObject.prototype['headline'] = undefined;
 ...
 * @readonly
 */
TranscriptObject['EventTypeEnum'] = {
