...
/**
 * The EventsAudioDailyObject model module.
 * @module model/EventsAudioDailyObject
 */
class EventsAudioDailyObject {
    /**
     * Constructs a new <code>EventsAudioDailyObject</code>.
     * @alias module:model/EventsAudioDailyObject
     */
    constructor() { 
        
        EventsAudioDailyObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsAudioDailyObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsAudioDailyObject} obj Optional instance to populate.
     * @return {module:model/EventsAudioDailyObject} The populated <code>EventsAudioDailyObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsAudioDailyObject();
 ...
 */
EventsAudioDailyObject.prototype['reportId'] = undefined;

/**
 * The filename of the audio file.
 * @member {String} fileName
 */
EventsAudioDailyObject.prototype['fileName'] = undefined;

/**
 * A pre-signed URL that allows downloading the audio file, expiring after 24 hours.
 * @member {String} url
 */
EventsAudioDailyObject.prototype['url'] = undefined;

/**
 * Size of the Audio file, in bytes.
 * @member {Number} fileSize
 */
EventsAudioDailyObject.prototype['fileSize'] = undefined;
 ...
 */
EventsAudioDailyObject.prototype['audioSourceId'] = undefined;

/**
 * Ticker-region identifier for the company hosting the event.
 * @member {String} ticker
 */
EventsAudioDailyObject.prototype['ticker'] = undefined;

/**
 * FactSet entity level identifier for the company hosting the event.
 * @member {String} entityId
 */
EventsAudioDailyObject.prototype['entityId'] = undefined;
 ...
 * @member {module:model/EventsAudioDailyObject.SourceCodeEnum} sourceCode
 */
EventsAudioDailyObject.prototype['sourceCode'] = undefined;
 ...
 * @readonly
 */
EventsAudioDailyObject['SourceCodeEnum'] = {
...
export default EventsAudioDailyObject;
