...
/**
 * The SlidesObject model module.
 * @module model/SlidesObject
 */
class SlidesObject {
    /**
     * Constructs a new <code>SlidesObject</code>.
     * @alias module:model/SlidesObject
     */
    constructor() { 
        
        SlidesObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SlidesObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SlidesObject} obj Optional instance to populate.
     * @return {module:model/SlidesObject} The populated <code>SlidesObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlidesObject();
            ...
            if (data.hasOwnProperty('slidesLink') && obj['slidesLink'] === undefined) {
                obj['slidesLink'] = ApiClient.convertToType(data['slidesLink'], 'String');
            }
 ...
 */
SlidesObject.prototype['primaryIds'] = undefined;

/**
 * Refers to all companies mentioned in the document. 
 * @member {Array.<String>} allIds
 */
SlidesObject.prototype['allIds'] = undefined;
 ...
 */
SlidesObject.prototype['searchId'] = undefined;

/**
 * Headline of the story.
 * @member {String} headline
 */
SlidesObject.prototype['headline'] = undefined;
