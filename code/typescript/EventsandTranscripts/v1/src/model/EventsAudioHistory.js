...
import EventsAudioHistoryData from './EventsAudioHistoryData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = EventsAudioHistoryData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/EventsAudioHistoryData} data
 */
