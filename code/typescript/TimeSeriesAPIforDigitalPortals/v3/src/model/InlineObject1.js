...
import VendorChartIQTimeSeriesEodSubsampleGetData from './VendorChartIQTimeSeriesEodSubsampleGetData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = VendorChartIQTimeSeriesEodSubsampleGetData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/VendorChartIQTimeSeriesEodSubsampleGetData} data
 */
