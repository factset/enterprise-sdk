...
import PricesTimeSeriesEodSubsampleListData from './PricesTimeSeriesEodSubsampleListData';
...
class InlineObject7 {
     ...
     * @param data {module:model/PricesTimeSeriesEodSubsampleListData} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PricesTimeSeriesEodSubsampleListData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PricesTimeSeriesEodSubsampleListData} data
 */
