...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/vector/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/vector/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/VectorData/0.20.0 (${process.platform}; node ${process.version})`
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.factset.com/content/vector/v0",
