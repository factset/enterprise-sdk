...
**textLength** | **Number** | Length of the text. | [optional] 
**tokenCount** | **Number** | Number of tokens. | [optional] 
**speakerId** | **Number** | Unique identifier of the speaker. | [optional] 
