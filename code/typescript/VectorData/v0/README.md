...
[![npm](https://img.shields.io/badge/npm-v0.0.4-orange)](https://www.npmjs.com/package/@factset/sdk-vectordata/v/0.0.4)
...
```shell
npm install @factset/sdk-utils @factset/sdk-vectordata@0.0.4
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-vectordata@0.0.4
```
