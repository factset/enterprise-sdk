# procuretopayscim.ServerConfigurationApi
...
```javascript
const { ApiClient, ServerConfigurationApi } = require('@factset/sdk-procuretopayscim');
...
const apiInstance = new ServerConfigurationApi();

// Call api endpoint
apiInstance.serviceProviderConfigGet().then(
  data => {
