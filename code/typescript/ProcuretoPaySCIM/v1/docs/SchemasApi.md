...
```javascript
const { ApiClient, SchemasApi } = require('@factset/sdk-procuretopayscim');
...
// Call api endpoint
apiInstance.schemasGet(opts).then(
  data => {
...
// Call api endpoint
apiInstance.schemasIdGet(id).then(
  data => {
