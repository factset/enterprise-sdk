# procuretopayscim.VermilionUsersApi
...
```javascript
const { ApiClient, VermilionUsersApi } = require('@factset/sdk-procuretopayscim');
...
const apiInstance = new VermilionUsersApi();
const id = "id_example"; // String | ID of resource.
const vermilionUserResource = new procuretopayscim.VermilionUserResource(); // VermilionUserResource | Vermilion user resource.
