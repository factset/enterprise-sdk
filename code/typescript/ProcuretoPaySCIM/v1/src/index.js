...
/**
* Procure to Pay SCIM client library for JavaScript.<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var procuretopayscim = require('index'); // See note below*.
* var xxxSvc = new procuretopayscim.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new procuretopayscim.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new procuretopayscim.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new procuretopayscim.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
