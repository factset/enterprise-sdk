...
[![npm](https://img.shields.io/badge/npm-v0.11.3-orange)](https://www.npmjs.com/package/@factset/sdk-stocksapifordigitalportals/v/0.11.3)
...
```shell
npm install @factset/sdk-utils @factset/sdk-stocksapifordigitalportals@0.11.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-stocksapifordigitalportals@0.11.3
```
