...
import InlineResponse2008DataPerformanceEndOfDayDay1 from './InlineResponse2008DataPerformanceEndOfDayDay1';
...
/**
 * The InlineResponse2008DataPerformanceEndOfDay model module.
 * @module model/InlineResponse2008DataPerformanceEndOfDay
 */
class InlineResponse2008DataPerformanceEndOfDay {
    /**
     * Constructs a new <code>InlineResponse2008DataPerformanceEndOfDay</code>.
     * Value ranges related to the end-of-day (EOD) relative performance for different time ranges.
     * @alias module:model/InlineResponse2008DataPerformanceEndOfDay
     */
    constructor() { 
        
        InlineResponse2008DataPerformanceEndOfDay.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2008DataPerformanceEndOfDay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2008DataPerformanceEndOfDay} obj Optional instance to populate.
     * @return {module:model/InlineResponse2008DataPerformanceEndOfDay} The populated <code>InlineResponse2008DataPerformanceEndOfDay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2008DataPerformanceEndOfDay();

            if (data.hasOwnProperty('day1')) {
                obj['day1'] = InlineResponse2008DataPerformanceEndOfDayDay1.constructFromObject(data['day1']);
            }
...
/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayDay1} day1
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['day1'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayWeek1} week1
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['week1'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayMonth1} month1
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['month1'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayMonths3} months3
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['months3'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayMonths6} months6
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['months6'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayYear1} year1
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['year1'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayYears3} years3
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['years3'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayYears5} years5
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['years5'] = undefined;

/**
 * @member {module:model/InlineResponse2008DataPerformanceEndOfDayYearToDate} yearToDate
 */
InlineResponse2008DataPerformanceEndOfDay.prototype['yearToDate'] = undefined;
...
export default InlineResponse2008DataPerformanceEndOfDay;
