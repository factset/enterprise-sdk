...
/**
 * The InlineResponse20012DataEstimatesFirstFiscalYear model module.
 * @module model/InlineResponse20012DataEstimatesFirstFiscalYear
 */
class InlineResponse20012DataEstimatesFirstFiscalYear {
    /**
     * Constructs a new <code>InlineResponse20012DataEstimatesFirstFiscalYear</code>.
     ...
     * @alias module:model/InlineResponse20012DataEstimatesFirstFiscalYear
     */
    constructor() { 
        
        InlineResponse20012DataEstimatesFirstFiscalYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20012DataEstimatesFirstFiscalYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20012DataEstimatesFirstFiscalYear} obj Optional instance to populate.
     * @return {module:model/InlineResponse20012DataEstimatesFirstFiscalYear} The populated <code>InlineResponse20012DataEstimatesFirstFiscalYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20012DataEstimatesFirstFiscalYear();
 ...
 */
InlineResponse20012DataEstimatesFirstFiscalYear.prototype['fiscalYear'] = undefined;

/**
 * @member {module:model/InlineResponse20012DataEstimatesFirstFiscalYearCurrencyDependentEstimates} currencyDependentEstimates
 */
InlineResponse20012DataEstimatesFirstFiscalYear.prototype['currencyDependentEstimates'] = undefined;

/**
 * @member {module:model/InlineResponse20012DataEstimatesFirstFiscalYearReturnOnAssets} returnOnAssets
 */
InlineResponse20012DataEstimatesFirstFiscalYear.prototype['returnOnAssets'] = undefined;

/**
 * @member {module:model/InlineResponse20012DataEstimatesFirstFiscalYearReturnOnEquity} returnOnEquity
 */
InlineResponse20012DataEstimatesFirstFiscalYear.prototype['returnOnEquity'] = undefined;

/**
 * @member {module:model/InlineResponse20012DataEstimatesFirstFiscalYearRatios} ratios
 */
InlineResponse20012DataEstimatesFirstFiscalYear.prototype['ratios'] = undefined;
...
export default InlineResponse20012DataEstimatesFirstFiscalYear;
