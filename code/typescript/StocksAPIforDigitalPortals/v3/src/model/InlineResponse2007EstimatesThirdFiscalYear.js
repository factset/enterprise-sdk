...
/**
 * The InlineResponse2007EstimatesThirdFiscalYear model module.
 * @module model/InlineResponse2007EstimatesThirdFiscalYear
 */
class InlineResponse2007EstimatesThirdFiscalYear {
    /**
     * Constructs a new <code>InlineResponse2007EstimatesThirdFiscalYear</code>.
     ...
     * @alias module:model/InlineResponse2007EstimatesThirdFiscalYear
     */
    constructor() { 
        
        InlineResponse2007EstimatesThirdFiscalYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007EstimatesThirdFiscalYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007EstimatesThirdFiscalYear} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007EstimatesThirdFiscalYear} The populated <code>InlineResponse2007EstimatesThirdFiscalYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007EstimatesThirdFiscalYear();
 ...
 */
InlineResponse2007EstimatesThirdFiscalYear.prototype['fiscalYear'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearCurrencyDependentEstimates} currencyDependentEstimates
 */
InlineResponse2007EstimatesThirdFiscalYear.prototype['currencyDependentEstimates'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets} returnOnAssets
 */
InlineResponse2007EstimatesThirdFiscalYear.prototype['returnOnAssets'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearReturnOnEquity} returnOnEquity
 */
InlineResponse2007EstimatesThirdFiscalYear.prototype['returnOnEquity'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearRatios} ratios
 */
InlineResponse2007EstimatesThirdFiscalYear.prototype['ratios'] = undefined;
...
export default InlineResponse2007EstimatesThirdFiscalYear;
