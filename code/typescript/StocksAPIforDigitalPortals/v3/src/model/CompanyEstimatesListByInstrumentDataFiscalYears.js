...
class CompanyEstimatesListByInstrumentDataFiscalYears {
    /**
     * Constructs a new <code>CompanyEstimatesListByInstrumentDataFiscalYears</code>.
     ...
     * @alias module:model/CompanyEstimatesListByInstrumentDataFiscalYears
     */
    constructor() { 
        
        CompanyEstimatesListByInstrumentDataFiscalYears.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompanyEstimatesListByInstrumentDataFiscalYears</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompanyEstimatesListByInstrumentDataFiscalYears} obj Optional instance to populate.
     * @return {module:model/CompanyEstimatesListByInstrumentDataFiscalYears} The populated <code>CompanyEstimatesListByInstrumentDataFiscalYears</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompanyEstimatesListByInstrumentDataFiscalYears();
 ...
 * @member {Number} start
 */
CompanyEstimatesListByInstrumentDataFiscalYears.prototype['start'] = undefined;
 ...
 * @member {Number} end
 */
CompanyEstimatesListByInstrumentDataFiscalYears.prototype['end'] = undefined;
...
export default CompanyEstimatesListByInstrumentDataFiscalYears;
