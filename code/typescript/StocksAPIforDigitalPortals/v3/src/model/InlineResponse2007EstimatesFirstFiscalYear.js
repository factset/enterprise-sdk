...
/**
 * The InlineResponse2007EstimatesFirstFiscalYear model module.
 * @module model/InlineResponse2007EstimatesFirstFiscalYear
 */
class InlineResponse2007EstimatesFirstFiscalYear {
    /**
     * Constructs a new <code>InlineResponse2007EstimatesFirstFiscalYear</code>.
     ...
     * @alias module:model/InlineResponse2007EstimatesFirstFiscalYear
     */
    constructor() { 
        
        InlineResponse2007EstimatesFirstFiscalYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007EstimatesFirstFiscalYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007EstimatesFirstFiscalYear} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007EstimatesFirstFiscalYear} The populated <code>InlineResponse2007EstimatesFirstFiscalYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007EstimatesFirstFiscalYear();
 ...
 */
InlineResponse2007EstimatesFirstFiscalYear.prototype['fiscalYear'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearCurrencyDependentEstimates} currencyDependentEstimates
 */
InlineResponse2007EstimatesFirstFiscalYear.prototype['currencyDependentEstimates'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets} returnOnAssets
 */
InlineResponse2007EstimatesFirstFiscalYear.prototype['returnOnAssets'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearReturnOnEquity} returnOnEquity
 */
InlineResponse2007EstimatesFirstFiscalYear.prototype['returnOnEquity'] = undefined;

/**
 * @member {module:model/InlineResponse2007EstimatesFirstFiscalYearRatios} ratios
 */
InlineResponse2007EstimatesFirstFiscalYear.prototype['ratios'] = undefined;
...
export default InlineResponse2007EstimatesFirstFiscalYear;
