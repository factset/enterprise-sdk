...
import InlineResponse20013Meta from './InlineResponse20013Meta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20013Data]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineResponse20013Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * List of notations.
 * @member {Array.<module:model/InlineResponse20013Data>} data
 */
InlineResponse20013.prototype['data'] = undefined;

/**
 * @member {module:model/InlineResponse20013Meta} meta
 */
