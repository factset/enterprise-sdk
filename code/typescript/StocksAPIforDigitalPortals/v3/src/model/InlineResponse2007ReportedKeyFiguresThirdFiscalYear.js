...
/**
 * The InlineResponse2007ReportedKeyFiguresThirdFiscalYear model module.
 * @module model/InlineResponse2007ReportedKeyFiguresThirdFiscalYear
 */
class InlineResponse2007ReportedKeyFiguresThirdFiscalYear {
    /**
     * Constructs a new <code>InlineResponse2007ReportedKeyFiguresThirdFiscalYear</code>.
     ...
     * @alias module:model/InlineResponse2007ReportedKeyFiguresThirdFiscalYear
     */
    constructor() { 
        
        InlineResponse2007ReportedKeyFiguresThirdFiscalYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007ReportedKeyFiguresThirdFiscalYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007ReportedKeyFiguresThirdFiscalYear} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007ReportedKeyFiguresThirdFiscalYear} The populated <code>InlineResponse2007ReportedKeyFiguresThirdFiscalYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007ReportedKeyFiguresThirdFiscalYear();
 ...
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['fiscalYear'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['currencyDependentKeyFigures'] = undefined;

/**
 * EBIT margin, which is the ratio of the EBIT, divided by the total sales revenue.
 * @member {Number} ebitMargin
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['ebitMargin'] = undefined;

/**
 * EBITDA margin, which is the ratio of the EBITDA, divided by the total sales revenue.
 * @member {Number} ebitdaMargin
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['ebitdaMargin'] = undefined;

/**
 * Net income margin, which is the ratio of the net income, divided by the total sales revenue.
 * @member {Number} netIncomeMargin
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['netIncomeMargin'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['grossIncomeMargin'] = undefined;

/**
 * Operating margin, which is the ratio of the operating income, divided by the sales revenue.
 * @member {Number} operatingMargin
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['operatingMargin'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['returnOnAssets'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['returnOnEquity'] = undefined;

/**
 * @member {module:model/InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios} ratios
 */
InlineResponse2007ReportedKeyFiguresThirdFiscalYear.prototype['ratios'] = undefined;
...
export default InlineResponse2007ReportedKeyFiguresThirdFiscalYear;
