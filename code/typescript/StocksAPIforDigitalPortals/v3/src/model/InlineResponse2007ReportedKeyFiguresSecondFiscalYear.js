...
/**
 * The InlineResponse2007ReportedKeyFiguresSecondFiscalYear model module.
 * @module model/InlineResponse2007ReportedKeyFiguresSecondFiscalYear
 */
class InlineResponse2007ReportedKeyFiguresSecondFiscalYear {
    /**
     * Constructs a new <code>InlineResponse2007ReportedKeyFiguresSecondFiscalYear</code>.
     ...
     * @alias module:model/InlineResponse2007ReportedKeyFiguresSecondFiscalYear
     */
    constructor() { 
        
        InlineResponse2007ReportedKeyFiguresSecondFiscalYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2007ReportedKeyFiguresSecondFiscalYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2007ReportedKeyFiguresSecondFiscalYear} obj Optional instance to populate.
     * @return {module:model/InlineResponse2007ReportedKeyFiguresSecondFiscalYear} The populated <code>InlineResponse2007ReportedKeyFiguresSecondFiscalYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2007ReportedKeyFiguresSecondFiscalYear();
 ...
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['fiscalYear'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['currencyDependentKeyFigures'] = undefined;

/**
 * EBIT margin, which is the ratio of the EBIT, divided by the total sales revenue.
 * @member {Number} ebitMargin
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['ebitMargin'] = undefined;

/**
 * EBITDA margin, which is the ratio of the EBITDA, divided by the total sales revenue.
 * @member {Number} ebitdaMargin
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['ebitdaMargin'] = undefined;

/**
 * Net income margin, which is the ratio of the net income, divided by the total sales revenue.
 * @member {Number} netIncomeMargin
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['netIncomeMargin'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['grossIncomeMargin'] = undefined;

/**
 * Operating margin, which is the ratio of the operating income, divided by the sales revenue.
 * @member {Number} operatingMargin
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['operatingMargin'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['returnOnAssets'] = undefined;
 ...
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['returnOnEquity'] = undefined;

/**
 * @member {module:model/InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios} ratios
 */
InlineResponse2007ReportedKeyFiguresSecondFiscalYear.prototype['ratios'] = undefined;
...
export default InlineResponse2007ReportedKeyFiguresSecondFiscalYear;
