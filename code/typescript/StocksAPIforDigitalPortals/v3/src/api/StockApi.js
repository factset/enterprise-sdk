...
export default class StockApi {
    ...
    */
     ...
     * @param {Array.<String>} idNotationBenchmark List of identifiers of benchmark notations. See the group description for the list of valid values.
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.attributes Limit the attributes returned in the response to the specified set.
     * @param {String} opts.language ISO 639-1 code of the language.
     ...
     * Current and historical trade recommendations and target prices for a stock.
     * @param {String} id Identifier of an instrument.
     * @param {Array.<module:model/String>} snapshots Choice of historic snapshots for aggregated recommendations.
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.attributes Limit the attributes returned in the response to the specified set.
