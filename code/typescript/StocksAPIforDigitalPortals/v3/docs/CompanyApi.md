...
> InlineResponse2003 getCompanyBoardListByInstrument(id, opts)
...
> InlineResponse2004 getCompanyBoardOfficerFunctionDeliveryList(opts)
...
> InlineResponse2005 getCompanyBoardTypeList(opts)
...
> InlineResponse200 postCompanyEstimatesListByInstrument(opts)
...
const apiInstance = new CompanyApi();
const opts = {
  'body': new stocksapifordigitalportals.InlineObject() // InlineObject | 
};
