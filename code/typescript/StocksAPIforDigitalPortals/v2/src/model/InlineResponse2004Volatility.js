...
class InlineResponse2004Volatility {
    /**
     * Constructs a new <code>InlineResponse2004Volatility</code>.
     * Volatility of the daily logarithmic returns, annualized assuming 256 trading days per year for different time ranges.
     * @alias module:model/InlineResponse2004Volatility
     */
    constructor() { 
        
        InlineResponse2004Volatility.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2004Volatility</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2004Volatility} obj Optional instance to populate.
     * @return {module:model/InlineResponse2004Volatility} The populated <code>InlineResponse2004Volatility</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2004Volatility();
 ...
 * @member {Number} week1
 */
InlineResponse2004Volatility.prototype['week1'] = undefined;

/**
 * One month.
 * @member {Number} month1
 */
InlineResponse2004Volatility.prototype['month1'] = undefined;

/**
 * Three months.
 * @member {Number} months3
 */
InlineResponse2004Volatility.prototype['months3'] = undefined;

/**
 * Six months.
 * @member {Number} months6
 */
InlineResponse2004Volatility.prototype['months6'] = undefined;

/**
 * One year.
 * @member {Number} year1
 */
InlineResponse2004Volatility.prototype['year1'] = undefined;

/**
 * Three years.
 * @member {Number} years3
 */
InlineResponse2004Volatility.prototype['years3'] = undefined;

/**
 * Five years.
 * @member {Number} years5
 */
InlineResponse2004Volatility.prototype['years5'] = undefined;

/**
 * Year-to-date.
 * @member {Number} yearToDate
 */
InlineResponse2004Volatility.prototype['yearToDate'] = undefined;
...
export default InlineResponse2004Volatility;
