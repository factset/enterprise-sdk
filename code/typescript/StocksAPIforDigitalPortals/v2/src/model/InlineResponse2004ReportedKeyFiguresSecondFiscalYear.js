...
/**
 * The InlineResponse2004ReportedKeyFiguresSecondFiscalYear model module.
 * @module model/InlineResponse2004ReportedKeyFiguresSecondFiscalYear
 * @version 0.9.1
 */
class InlineResponse2004ReportedKeyFiguresSecondFiscalYear {
    /**
     * Constructs a new <code>InlineResponse2004ReportedKeyFiguresSecondFiscalYear</code>.
     ...
     * @alias module:model/InlineResponse2004ReportedKeyFiguresSecondFiscalYear
     */
    constructor() { 
        
        InlineResponse2004ReportedKeyFiguresSecondFiscalYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2004ReportedKeyFiguresSecondFiscalYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2004ReportedKeyFiguresSecondFiscalYear} obj Optional instance to populate.
     * @return {module:model/InlineResponse2004ReportedKeyFiguresSecondFiscalYear} The populated <code>InlineResponse2004ReportedKeyFiguresSecondFiscalYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2004ReportedKeyFiguresSecondFiscalYear();
 ...
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['fiscalYear'] = undefined;
 ...
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['currencyDependentKeyFigures'] = undefined;

/**
 * EBIT margin, which is the ratio of the EBIT, divided by the total sales revenue.
 * @member {Number} ebitMargin
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['ebitMargin'] = undefined;

/**
 * EBITDA margin, which is the ratio of the EBITDA, divided by the total sales revenue.
 * @member {Number} ebitdaMargin
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['ebitdaMargin'] = undefined;

/**
 * Net income margin, which is the ratio of the net income, divided by the total sales revenue.
 * @member {Number} netIncomeMargin
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['netIncomeMargin'] = undefined;
 ...
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['grossIncomeMargin'] = undefined;

/**
 * Operating margin, which is the ratio of the operating income, divided by the sales revenue.
 * @member {Number} operatingMargin
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['operatingMargin'] = undefined;
 ...
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['returnOnAssets'] = undefined;
 ...
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['returnOnEquity'] = undefined;

/**
 * @member {module:model/InlineResponse2004ReportedKeyFiguresFirstFiscalYearRatios} ratios
 */
InlineResponse2004ReportedKeyFiguresSecondFiscalYear.prototype['ratios'] = undefined;
...
export default InlineResponse2004ReportedKeyFiguresSecondFiscalYear;
