...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/idsearch') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/idsearch
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/IDLookup/0.23.1 (${process.platform}; node ${process.version})`
        };
