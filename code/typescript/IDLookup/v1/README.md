...
[![npm](https://img.shields.io/badge/npm-v0.23.1-orange)](https://www.npmjs.com/package/@factset/sdk-idlookup/v/0.23.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-idlookup@0.23.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-idlookup@0.23.1
```
