...
/**
* MarketAggregates service.
* @module api/MarketAggregatesApi
*/
export default class MarketAggregatesApi {

    /**
    * Constructs a new MarketAggregatesApi. 
    * @alias module:api/MarketAggregatesApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MarketAggregatesResponse} and HTTP response
     */
    getMarketAggregatesWithHttpInfo(ids, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getMarketAggregates");
      }
      ...
      let returnType = GetMarketAggregatesResponseWrapperTypeMap;
      
      return this.apiClient.callApi(
        '/factset-funds/v1/aggregates/market', 'GET',
     ...
     * @param {String} opts.currency Controls the Currency conversion of the Fund. By default, the currency will use the funds local currency. For a list of currency ISO codes, visit Online Assistant Page [OA1470](https://my.apps.factset.com/oa/pages/1470).  (default to 'LOCAL')
     * @param {module:model/String} opts.batch Enables the ability to asynchronously \"batch\" the request, supporting a long-running request for up to 20 minutes. Upon requesting batch=Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (default to 'N')
     * @return { Promise.< GetMarketAggregatesResponseWrapper > } a Promise, with data of type {@link GetMarketAggregatesResponseWrapper }
     */
    getMarketAggregates(ids, opts) {
      return this.getMarketAggregatesWithHttpInfo(ids, opts)
     ...
     * Get market aggregates for a requested time series.
     * Retrieves FactSet market aggregate data for the funds and date range specified. 
     * @param {module:model/MarketAggregatesRequest} marketAggregatesRequest The Market Aggregates request body, allowing the user to specify a list of ids and date range.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MarketAggregatesResponse} and HTTP response
     */
    getMarketAggregatesForListWithHttpInfo(marketAggregatesRequest) {
      let postBody = marketAggregatesRequest;
      // verify the required parameter 'marketAggregatesRequest' is set
      if (marketAggregatesRequest === undefined || marketAggregatesRequest === null) {
        throw new Error("Missing the required parameter 'marketAggregatesRequest' when calling getMarketAggregatesForList");
      }
      ...
      let returnType = GetMarketAggregatesForListResponseWrapperTypeMap;
      
      return this.apiClient.callApi(
        '/factset-funds/v1/aggregates/market', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Retrieves FactSet market aggregate data for the funds and date range specified. 
     * @param {module:model/MarketAggregatesRequest} marketAggregatesRequest The Market Aggregates request body, allowing the user to specify a list of ids and date range.
     * @return { Promise.< GetMarketAggregatesForListResponseWrapper > } a Promise, with data of type {@link GetMarketAggregatesForListResponseWrapper }
     */
    getMarketAggregatesForList(marketAggregatesRequest) {
      return this.getMarketAggregatesForListWithHttpInfo(marketAggregatesRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
...
const GetMarketAggregatesResponseWrapperTypeMap = {
  200: MarketAggregatesResponse,
  ...
  _createResponseWrapper(statusCode, response) {
    return new GetMarketAggregatesResponseWrapper(statusCode, response);
  }
};

const GetMarketAggregatesForListResponseWrapperTypeMap = {
  200: MarketAggregatesResponse,
  202: BatchStatusResponse,
  400: ErrorResponse,
  401: ErrorResponse,
  ...
  _createResponseWrapper(statusCode, response) {
    return new GetMarketAggregatesForListResponseWrapper(statusCode, response);
  }
};
 ...
 * }</pre>
 *
 * @alias module:GetMarketAggregatesResponseWrapper
 * @class
 */
export class GetMarketAggregatesResponseWrapper {
  ...
  /**
   * @returns { MarketAggregatesResponse }
   */
  getResponse200() {
 ...
 * }</pre>
 *
 * @alias module:GetMarketAggregatesForListResponseWrapper
 * @class
 */
export class GetMarketAggregatesForListResponseWrapper {
