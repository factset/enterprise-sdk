...
class StatusesRequest {
    /**
     * Constructs a new <code>StatusesRequest</code>.
     * Classifications Request Body
     * @alias module:model/StatusesRequest
    ...
    constructor(ids) { 
        ...
        StatusesRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>StatusesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusesRequest} obj Optional instance to populate.
     * @return {module:model/StatusesRequest} The populated <code>StatusesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusesRequest();
 ...
 */
StatusesRequest.prototype['ids'] = undefined;
...
export default StatusesRequest;
