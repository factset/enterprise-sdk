...
[![npm](https://img.shields.io/badge/npm-v4.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetfunds/v/4.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetfunds@4.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetfunds@4.0.0
```
...
------------ | ------------- | ------------- | -------------
*factsetfunds.BatchProcessingApi* | [**getBatchData**](docs/BatchProcessingApi.md#getBatchData) | **GET** /factset-funds/v1/batch-result | Returns the response for a Batch Request
*factsetfunds.BatchProcessingApi* | [**getBatchStatus**](docs/BatchProcessingApi.md#getBatchStatus) | **GET** /factset-funds/v1/batch-status | Returns the status for a Batch Request
...
## Documentation for Models
 ...
 - [factsetfunds.Batch](docs/Batch.md)
 - [factsetfunds.BatchErrorObject](docs/BatchErrorObject.md)
 - [factsetfunds.BatchErrorResponse](docs/BatchErrorResponse.md)
 - [factsetfunds.BatchResult](docs/BatchResult.md)
 - [factsetfunds.BatchResultResponse](docs/BatchResultResponse.md)
 - [factsetfunds.BatchStatus](docs/BatchStatus.md)
 - [factsetfunds.BatchStatusResponse](docs/BatchStatusResponse.md)
