...
[![npm](https://img.shields.io/badge/npm-v3.2.1-orange)](https://www.npmjs.com/package/@factset/sdk-factsetfunds/v/3.2.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetfunds@3.2.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetfunds@3.2.1
```
