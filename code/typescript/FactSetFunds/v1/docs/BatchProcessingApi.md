# factsetfunds.BatchProcessingApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getBatchData**](BatchProcessingApi.md#getBatchData) | **GET** /factset-funds/v1/batch-result | Returns the response for a Batch Request
[**getBatchStatus**](BatchProcessingApi.md#getBatchStatus) | **GET** /factset-funds/v1/batch-status | Returns the status for a Batch Request
...
```javascript
const { ApiClient, BatchProcessingApi } = require('@factset/sdk-factsetfunds');
