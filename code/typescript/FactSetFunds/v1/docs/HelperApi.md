...
const apiInstance = new HelperApi();
const statusesRequest = new factsetfunds.StatusesRequest(); // StatusesRequest | The Statuses request body, allowing the user to specify a list of ids.
