...
/**
* ScreenerOperations service.
* @module api/ScreenerOperationsApi
*/
export default class ScreenerOperationsApi {

    /**
    * Constructs a new ScreenerOperationsApi. 
    * @alias module:api/ScreenerOperationsApi
    * @class
    ...
    */
    ...
    createContentSetWithHttpInfo(createContentSetRequest) {
      ...
      return this.apiClient.callApi(
        '/screener/content-sets/create', 'POST',
    ...
    deleteContentSetWithHttpInfo(name) {
      ...
      return this.apiClient.callApi(
        '/screener/content-sets/{name}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {Array.<String>} contentSets The content sets from which the fields are requested.
