...
const opts = {
  ...
  'frequency': M, // FrequencyAum | Controls the display frequency of the data returned. Supported values are: - **M**: Monthly, based on the last trading day of the month - **CQ**: Calendar Quarterly - **CY**: Calendar Yearly
 ...
 **frequency** | [**FrequencyAum**](.md)| Controls the display frequency of the data returned. Supported values are: - **M**: Monthly, based on the last trading day of the month - **CQ**: Calendar Quarterly - **CY**: Calendar Yearly | [optional] 
