...
**distributionType** | [**DistCurrentType**](DistCurrentType.md) |  | 
**distributionFrequency** | **String** | Returns the distribution frequency. | [optional] 
**dividendExDate** | **Date** | Returns the ex-dividend date of the most recently reported dividend. Data is currently only and available only for ETFs. | [optional] 
...
**last12MonthDistributionYield** | **Number** | Distribution yield for the last twelve months. | [optional] 
**firstDistributionDate** | **Date** | The date of the funds first distribution in YYYY-MM-DD format. | [optional] 
