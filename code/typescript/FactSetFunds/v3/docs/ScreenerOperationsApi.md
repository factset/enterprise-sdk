# factsetfunds.ScreenerOperationsApi
...
```javascript
const { ApiClient, ScreenerOperationsApi } = require('@factset/sdk-factsetfunds');
...
const apiInstance = new ScreenerOperationsApi();
...
const apiInstance = new ScreenerOperationsApi();
const contentSets = ["null"]; // [String] | The content sets from which the fields are requested.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **contentSets** | [**[String]**](String.md)| The content sets from which the fields are requested. | 
