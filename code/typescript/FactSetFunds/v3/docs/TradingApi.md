...
```javascript
const { ApiClient, TradingApi } = require('@factset/sdk-factsetfunds');
...
const apiInstance = new TradingApi();
...
// Call api endpoint
apiInstance.getTrading(ids).then(
  data => {
...
const apiInstance = new TradingApi();
const tradingRequest = new factsetfunds.TradingRequest(); // TradingRequest | 

// Call api endpoint
apiInstance.getTradingForList(tradingRequest).then(
  data => {
