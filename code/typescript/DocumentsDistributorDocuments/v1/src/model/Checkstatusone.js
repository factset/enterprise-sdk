...
/**
 * The Checkstatusone model module.
 * @module model/Checkstatusone
 */
class Checkstatusone {
    /**
     * Constructs a new <code>Checkstatusone</code>.
     * @alias module:model/Checkstatusone
     */
    constructor() { 
        
        Checkstatusone.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Checkstatusone</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Checkstatusone} obj Optional instance to populate.
     * @return {module:model/Checkstatusone} The populated <code>Checkstatusone</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Checkstatusone();
