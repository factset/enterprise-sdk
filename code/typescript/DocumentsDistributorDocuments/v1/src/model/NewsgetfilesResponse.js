...
import Getfilesone from './Getfilesone';
import MetaOne from './MetaOne';

/**
 * The NewsgetfilesResponse model module.
 * @module model/NewsgetfilesResponse
 */
class NewsgetfilesResponse {
    /**
     * Constructs a new <code>NewsgetfilesResponse</code>.
     * @alias module:model/NewsgetfilesResponse
     */
    constructor() { 
        
        NewsgetfilesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NewsgetfilesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewsgetfilesResponse} obj Optional instance to populate.
     * @return {module:model/NewsgetfilesResponse} The populated <code>NewsgetfilesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:model/Getfilesone>} data
 */
NewsgetfilesResponse.prototype['data'] = undefined;

/**
 * @member {module:model/MetaOne} meta
 */
NewsgetfilesResponse.prototype['meta'] = undefined;
...
export default NewsgetfilesResponse;
