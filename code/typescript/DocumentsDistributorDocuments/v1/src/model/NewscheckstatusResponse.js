...
import Checkstatusone from './Checkstatusone';
import MetaOne from './MetaOne';

/**
 * The NewscheckstatusResponse model module.
 * @module model/NewscheckstatusResponse
 */
class NewscheckstatusResponse {
    /**
     * Constructs a new <code>NewscheckstatusResponse</code>.
     * @alias module:model/NewscheckstatusResponse
     */
    constructor() { 
        
        NewscheckstatusResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NewscheckstatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewscheckstatusResponse} obj Optional instance to populate.
     * @return {module:model/NewscheckstatusResponse} The populated <code>NewscheckstatusResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewscheckstatusResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Checkstatusone]);
            }
...
/**
 * @member {Array.<module:model/Checkstatusone>} data
 */
NewscheckstatusResponse.prototype['data'] = undefined;

/**
 * @member {module:model/MetaOne} meta
 */
NewscheckstatusResponse.prototype['meta'] = undefined;
...
export default NewscheckstatusResponse;
