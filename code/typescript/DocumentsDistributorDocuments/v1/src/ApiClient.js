...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/bulk-documents') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/bulk-documents
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/DocumentsDistributorDocuments/0.22.0 (${process.platform}; node ${process.version})`
        };
