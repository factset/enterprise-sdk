...
[![npm](https://img.shields.io/badge/npm-v2.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetmergersandacquisitions/v/2.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetmergersandacquisitions@2.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetmergersandacquisitions@2.2.0
```
...
## Documentation for Models
 ...
 - [factsetmergersandacquisitions.AdvisorParticipant](docs/AdvisorParticipant.md)
 - [factsetmergersandacquisitions.Advisors](docs/Advisors.md)
 - [factsetmergersandacquisitions.BuyersAdvisor](docs/BuyersAdvisor.md)
 ...
 - [factsetmergersandacquisitions.SellersAdvisor](docs/SellersAdvisor.md)
