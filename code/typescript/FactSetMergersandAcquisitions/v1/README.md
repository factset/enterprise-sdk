...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetmergersandacquisitions@2.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetmergersandacquisitions@2.0.0
```
