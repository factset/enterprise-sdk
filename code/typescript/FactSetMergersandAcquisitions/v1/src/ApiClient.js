...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/factset-mergers-acquisitions/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/factset-mergers-acquisitions/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetMergersandAcquisitions/2.0.2 (${process.platform}; node ${process.version})`
        };
