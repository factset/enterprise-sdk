...
/**
 * The SellersAdvisor model module.
 * @module model/SellersAdvisor
 */
class SellersAdvisor {
    /**
     * Constructs a new <code>SellersAdvisor</code>.
     * Sellers Advisor Object
     * @alias module:model/SellersAdvisor
     */
    constructor() { 
        
        SellersAdvisor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SellersAdvisor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SellersAdvisor} obj Optional instance to populate.
     * @return {module:model/SellersAdvisor} The populated <code>SellersAdvisor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SellersAdvisor();
 ...
 */
SellersAdvisor.prototype['financial'] = undefined;

/**
 * @member {Array.<module:model/AdvisorParticipant>} legal
 */
SellersAdvisor.prototype['legal'] = undefined;
