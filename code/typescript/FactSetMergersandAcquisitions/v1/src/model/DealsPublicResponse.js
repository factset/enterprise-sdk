...
import DealPublic from './DealPublic';

/**
 * The DealsPublicResponse model module.
 * @module model/DealsPublicResponse
 */
class DealsPublicResponse {
    /**
     * Constructs a new <code>DealsPublicResponse</code>.
     * @alias module:model/DealsPublicResponse
     */
    constructor() { 
        
        DealsPublicResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DealsPublicResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DealsPublicResponse} obj Optional instance to populate.
     * @return {module:model/DealsPublicResponse} The populated <code>DealsPublicResponse</code> instance.
     */
 ...
 * @member {Array.<module:model/DealPublic>} data
 */
DealsPublicResponse.prototype['data'] = undefined;
...
export default DealsPublicResponse;
