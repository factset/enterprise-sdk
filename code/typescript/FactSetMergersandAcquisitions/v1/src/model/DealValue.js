...
class DealValue {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('completionTransactionValue') && obj['completionTransactionValue'] === undefined) {
                obj['completionTransactionValue'] = ApiClient.convertToType(data['completionTransactionValue'], 'Number');
            }
            if (data.hasOwnProperty('completionEnterpriseValue') && obj['completionEnterpriseValue'] === undefined) {
                obj['completionEnterpriseValue'] = ApiClient.convertToType(data['completionEnterpriseValue'], 'Number');
            }
 ...
 * @member {Number} completionTransactionValue
 */
DealValue.prototype['completionTransactionValue'] = undefined;
 ...
 * @member {Number} completionEnterpriseValue
 */
DealValue.prototype['completionEnterpriseValue'] = undefined;
