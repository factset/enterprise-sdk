...
```shell
npm install @factset/sdk-utils @factset/sdk-symbology@2.3.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-symbology@2.3.3
```
...
------------ | ------------- | ------------- | -------------
*symbology.IdentifierResolutionApi* | [**batchIdentifierResolution**](docs/IdentifierResolutionApi.md#batchIdentifierResolution) | **POST** /symbology/v3/identifier-resolution | Returns the specified output identifiers for the specified input identifier.
