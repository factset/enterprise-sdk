...
/**
 * The TickerHistoryTranslationRequest model module.
 * @module model/TickerHistoryTranslationRequest
 * @version 0.9.0
 */
class TickerHistoryTranslationRequest {
    /**
     * Constructs a new <code>TickerHistoryTranslationRequest</code>.
     * Request object for Ticker endpoint.
     * @alias module:model/TickerHistoryTranslationRequest
    ...
    constructor(ids, tickerType) { 
        ...
        TickerHistoryTranslationRequest.initialize(this, ids, tickerType);
    }
    ...
    /**
     * Constructs a <code>TickerHistoryTranslationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TickerHistoryTranslationRequest} obj Optional instance to populate.
     * @return {module:model/TickerHistoryTranslationRequest} The populated <code>TickerHistoryTranslationRequest</code> instance.
     */
...
export default TickerHistoryTranslationRequest;
