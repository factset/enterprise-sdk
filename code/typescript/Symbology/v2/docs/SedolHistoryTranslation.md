# symbology.SedolHistoryTranslation
...
**sedolEffectiveStartDate** | **Date** | SEDOL effective start date in YYYY-MM-DD format. | [optional] 
**sedolEffectiveEndDate** | **Date** | SEDOL effective end date in YYYY-MM-DD format. Null if still active. | [optional] 
