...
/**
 * The CusipTranslationRequest model module.
 * @module model/CusipTranslationRequest
 */
class CusipTranslationRequest {
    /**
     * Constructs a new <code>CusipTranslationRequest</code>.
     * Request object for CUSIP Translation endpoint.
     * @alias module:model/CusipTranslationRequest
    ...
    constructor(ids) { 
        ...
        CusipTranslationRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>CusipTranslationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CusipTranslationRequest} obj Optional instance to populate.
     * @return {module:model/CusipTranslationRequest} The populated <code>CusipTranslationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CusipTranslationRequest();
 ...
 */
CusipTranslationRequest.prototype['ids'] = undefined;

/**
 * As-Of Date for historical symbol request in YYYY-MM-DD format.
 * @member {String} asOfDate
 */
CusipTranslationRequest.prototype['asOfDate'] = undefined;
...
export default CusipTranslationRequest;
