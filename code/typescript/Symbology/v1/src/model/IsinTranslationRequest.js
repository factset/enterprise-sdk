...
/**
 * The IsinTranslationRequest model module.
 * @module model/IsinTranslationRequest
 * @version 0.8.2
 */
class IsinTranslationRequest {
    /**
     * Constructs a new <code>IsinTranslationRequest</code>.
     * Request object for ISIN Translation endpoint.
     * @alias module:model/IsinTranslationRequest
    ...
    constructor(ids) { 
        ...
        IsinTranslationRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>IsinTranslationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsinTranslationRequest} obj Optional instance to populate.
     * @return {module:model/IsinTranslationRequest} The populated <code>IsinTranslationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsinTranslationRequest();
 ...
 */
IsinTranslationRequest.prototype['ids'] = undefined;

/**
 * As-Of Date for historical symbol request in YYYY-MM-DD format.
 * @member {String} asOfDate
 */
IsinTranslationRequest.prototype['asOfDate'] = undefined;
...
export default IsinTranslationRequest;
