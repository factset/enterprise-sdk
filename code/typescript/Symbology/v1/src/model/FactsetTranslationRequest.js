...
/**
 * The FactsetTranslationRequest model module.
 * @module model/FactsetTranslationRequest
 * @version 0.8.0
 */
class FactsetTranslationRequest {
    /**
     * Constructs a new <code>FactsetTranslationRequest</code>.
     * Request object for FactSet endpoint.
     * @alias module:model/FactsetTranslationRequest
    ...
    constructor(ids) { 
        ...
        FactsetTranslationRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>FactsetTranslationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FactsetTranslationRequest} obj Optional instance to populate.
     * @return {module:model/FactsetTranslationRequest} The populated <code>FactsetTranslationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FactsetTranslationRequest();
 ...
 */
FactsetTranslationRequest.prototype['ids'] = undefined;
...
export default FactsetTranslationRequest;
