...
class IsinTranslation {
    /**
     * Constructs a new <code>IsinTranslation</code>.
     * ISIN Translation data object.
     * @alias module:model/IsinTranslation
     */
    constructor() { 
        
        IsinTranslation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IsinTranslation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsinTranslation} obj Optional instance to populate.
     * @return {module:model/IsinTranslation} The populated <code>IsinTranslation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsinTranslation();
 ...
 */
IsinTranslation.prototype['fsymId'] = undefined;

/**
 * Proper Name of company or issuer.
 * @member {String} name
 */
IsinTranslation.prototype['name'] = undefined;

/**
 * ISIN
 * @member {String} isin
 */
IsinTranslation.prototype['isin'] = undefined;

/**
 * Identifier specified in the request
 * @member {String} requestId
 */
IsinTranslation.prototype['requestId'] = undefined;
...
export default IsinTranslation;
