# symbology.IsinHistoryTranslation
...
**isinEffectiveStartDate** | **Date** | ISIN effective start date in YYYY-MM-DD format. | [optional] 
**isinEffectiveEndDate** | **Date** | ISIN effective end date in YYYY-MM-DD format. Null if still active. | [optional] 
