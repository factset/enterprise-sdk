...
> EntityTaskResponse createEntityTask(taskName, inputFile, clientIdColumn, nameColumn, opts)
...
// Call api endpoint
apiInstance.createEntityTask(taskName, inputFile, clientIdColumn, nameColumn, opts).then(
  data => {
