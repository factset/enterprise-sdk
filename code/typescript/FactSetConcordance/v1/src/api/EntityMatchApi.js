...
export default class EntityMatchApi {
    ...
    */
     ...
     * @param {String} opts.clientId A unique identifer supplied by the user. The clientId is recorded to the user's mapped universe. 
    ...
    getEntityMatchWithHttpInfo(name, opts) {
      ...
      return this.apiClient.callApi(
        '/factset-concordance/v1/entity-match', 'GET',
    ...
    getEntityMatchForListWithHttpInfo(entityMatchRequest) {
      ...
      return this.apiClient.callApi(
        '/factset-concordance/v1/entity-match', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
