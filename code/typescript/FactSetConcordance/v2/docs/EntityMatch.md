...
------------ | ------------- | ------------- | -------------
**taskId** | **Number** | Identifier denoting a specific Concordance task submitted by the user. This value will be null for /entity-match endpoint responses and is only available when using the \&quot;Bulk\&quot; workflow.  | [optional] 
**universeId** | **Number** | The id of the universe that entities should be mapped to | [optional] 
...
**clientIncludeEntitySubType** | **[String]** | Entity sub-types to include in the search. If provided, only entities with the specified entity sub-types will be considered.  | [optional] 
