...
const opts = {
  ...
  'sort': ["clientId:asc","clientPersonName:desc"] // [String] | Sort clientId, createdTime, updatedTime, clientPersonName, personId fields in ascending or descending order with asc and desc to indicate the order. Example (clientId:asc)
};
 ...
 **sort** | [**[String]**](String.md)| Sort clientId, createdTime, updatedTime, clientPersonName, personId fields in ascending or descending order with asc and desc to indicate the order. Example (clientId:asc) | [optional] 
