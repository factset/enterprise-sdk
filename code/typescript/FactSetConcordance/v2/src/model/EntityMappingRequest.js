...
class EntityMappingRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('clientCreditsafe') && obj['clientCreditsafe'] === undefined) {
                obj['clientCreditsafe'] = ApiClient.convertToType(data['clientCreditsafe'], 'String');
            }
            if (data.hasOwnProperty('clientCrunchbase') && obj['clientCrunchbase'] === undefined) {
                obj['clientCrunchbase'] = ApiClient.convertToType(data['clientCrunchbase'], 'String');
            }
 ...
 * @member {String} clientCreditsafe
 */
EntityMappingRequest.prototype['clientCreditsafe'] = undefined;

/**
 * Crunchbase Identifier
 * @member {String} clientCrunchbase
 */
EntityMappingRequest.prototype['clientCrunchbase'] = undefined;
