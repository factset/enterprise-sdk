...
import PeopleMatchRequestInput from './PeopleMatchRequestInput';
...
class PeopleMatchRequest {
    /**
     * Constructs a new <code>PeopleMatchRequest</code>.
     * Request object for a requesting multiple People Matches.
     * @alias module:model/PeopleMatchRequest
     */
    constructor() { 
        
        PeopleMatchRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PeopleMatchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PeopleMatchRequest} obj Optional instance to populate.
     * @return {module:model/PeopleMatchRequest} The populated <code>PeopleMatchRequest</code> instance.
     */
...
/**
 * @member {Array.<module:model/PeopleMatchRequestInput>} input
 */
PeopleMatchRequest.prototype['input'] = undefined;
 ...
 */
PeopleMatchRequest.prototype['candidatesCount'] = undefined;

/**
 * The universeId to save this set of inputs to 
 * @member {Number} universeId
 */
PeopleMatchRequest.prototype['universeId'] = undefined;
...
export default PeopleMatchRequest;
