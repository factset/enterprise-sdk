...
export default class EntityMatchBulkApi {
    ...
    */
     ...
     * @param {String} opts.creditsafeColumn the column name for type `Creditsafe Identifier`.
     * @param {String} opts.crunchbaseColumn the column name for type `Crunchbase Identifier`.
    ...
    getEntityTaskForListWithHttpInfo(universeId, taskName, inputFile, clientIdColumn, nameColumn, opts) {
      ...
      let formParams = {
        ...
        'creditsafeColumn': opts['creditsafeColumn'],
        'crunchbaseColumn': opts['crunchbaseColumn'],
