...
export default class EntityMatchApi {
    ...
    */
     ...
     * @param {String} opts.country ISO2 country code corresponding to the entity name that is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754#country).
     ...
     * @param {String} opts.creditsafe Creditsafe Identifier
     * @param {String} opts.crunchbase Crunchbase Identifier
    ...
    getEntityMatchWithHttpInfo(name, opts) {
      ...
      let queryParams = {
        ...
        'cik': opts['cik'],
        'crd': opts['crd'],
        'creditsafe': opts['creditsafe'],
        'crunchbase': opts['crunchbase'],
        'cusip': opts['cusip'],
        'ein': opts['ein'],
