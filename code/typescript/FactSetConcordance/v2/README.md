...
[![npm](https://img.shields.io/badge/npm-v3.0.2-orange)](https://www.npmjs.com/package/@factset/sdk-factsetconcordance/v/3.0.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetconcordance@3.0.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetconcordance@3.0.2
```
