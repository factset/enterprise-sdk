...
[![API Version](https://img.shields.io/badge/api-v2.11.0-blue)]()
[![npm](https://img.shields.io/badge/npm-v3.1.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetconcordance/v/3.1.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetconcordance@3.1.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetconcordance@3.1.0
```
