...
import V1ReportInstancesGenerateVrs from './V1ReportInstancesGenerateVrs';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vrs')) {
                obj['vrs'] = V1ReportInstancesGenerateVrs.constructFromObject(data['vrs']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/V1ReportInstancesGenerateVrs} vrs
 */
InlineObject.prototype['vrs'] = undefined;
