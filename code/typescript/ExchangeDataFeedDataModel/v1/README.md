...
[![npm](https://img.shields.io/badge/npm-v0.22.2-orange)](https://www.npmjs.com/package/@factset/sdk-exchangedatafeeddatamodel/v/0.22.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-exchangedatafeeddatamodel@0.22.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-exchangedatafeeddatamodel@0.22.2
```
