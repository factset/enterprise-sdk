...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/rtdatamodel/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/rtdatamodel/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ExchangeDataFeedDataModel/0.22.1 (${process.platform}; node ${process.version})`
        };
