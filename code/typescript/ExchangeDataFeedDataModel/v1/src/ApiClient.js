...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/RTDataModel') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/RTDataModel
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ExchangeDataFeedDataModel/0.21.1 (${process.platform}; node ${process.version})`
        };
