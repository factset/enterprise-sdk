...
/**
 * The ExchangesResponseData model module.
 * @module model/ExchangesResponseData
 */
class ExchangesResponseData {
    /**
     * Constructs a new <code>ExchangesResponseData</code>.
     * @alias module:model/ExchangesResponseData
     */
    constructor() { 
        
        ExchangesResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangesResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangesResponseData} obj Optional instance to populate.
     * @return {module:model/ExchangesResponseData} The populated <code>ExchangesResponseData</code> instance.
     */
 ...
 * @member {Array.<module:model/ExchangeItem>} exchanges
 */
ExchangesResponseData.prototype['exchanges'] = undefined;
...
export default ExchangesResponseData;
