...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/wealth/v4') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/wealth/v4
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/RealTimePriceAlerting/0.14.0 (${process.platform}; node ${process.version})`
        };
