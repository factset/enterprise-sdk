...
import PostAlertingPricesBasicTriggerListDataNotificationChannelItems from './PostAlertingPricesBasicTriggerListDataNotificationChannelItems';

/**
 * The PostAlertingPricesBasicTriggerListDataItemsNotification model module.
 * @module model/PostAlertingPricesBasicTriggerListDataItemsNotification
 */
class PostAlertingPricesBasicTriggerListDataItemsNotification {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListDataItemsNotification</code>.
     * Selection of notifications for triggered alerts.
     * @alias module:model/PostAlertingPricesBasicTriggerListDataItemsNotification
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListDataItemsNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListDataItemsNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListDataItemsNotification} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListDataItemsNotification} The populated <code>PostAlertingPricesBasicTriggerListDataItemsNotification</code> instance.
     */
 ...
 * @member {Array.<module:model/PostAlertingPricesBasicTriggerListDataNotificationChannelItems>} channel
 */
PostAlertingPricesBasicTriggerListDataItemsNotification.prototype['channel'] = undefined;
...
export default PostAlertingPricesBasicTriggerListDataItemsNotification;
