...
/**
 * The PostAlertingPricesBasicTriggerListDataItemsRange model module.
 * @module model/PostAlertingPricesBasicTriggerListDataItemsRange
 */
class PostAlertingPricesBasicTriggerListDataItemsRange {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListDataItemsRange</code>.
     * Price range for the trigger to monitor.
     * @alias module:model/PostAlertingPricesBasicTriggerListDataItemsRange
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListDataItemsRange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListDataItemsRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListDataItemsRange} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListDataItemsRange} The populated <code>PostAlertingPricesBasicTriggerListDataItemsRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostAlertingPricesBasicTriggerListDataItemsRange();
 ...
 */
PostAlertingPricesBasicTriggerListDataItemsRange.prototype['upperLimit'] = undefined;

/**
 * Lower limit.
 * @member {Number} lowerLimit
 */
PostAlertingPricesBasicTriggerListDataItemsRange.prototype['lowerLimit'] = undefined;
...
export default PostAlertingPricesBasicTriggerListDataItemsRange;
