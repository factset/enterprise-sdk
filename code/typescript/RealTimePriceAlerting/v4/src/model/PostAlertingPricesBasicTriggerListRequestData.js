...
import PostAlertingPricesBasicTriggerListRequestDataFilter from './PostAlertingPricesBasicTriggerListRequestDataFilter';

/**
 * The PostAlertingPricesBasicTriggerListRequestData model module.
 * @module model/PostAlertingPricesBasicTriggerListRequestData
 */
class PostAlertingPricesBasicTriggerListRequestData {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListRequestData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PostAlertingPricesBasicTriggerListRequestData
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListRequestData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListRequestData} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListRequestData} The populated <code>PostAlertingPricesBasicTriggerListRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostAlertingPricesBasicTriggerListRequestData();

            if (data.hasOwnProperty('filter')) {
                obj['filter'] = PostAlertingPricesBasicTriggerListRequestDataFilter.constructFromObject(data['filter']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostAlertingPricesBasicTriggerListRequestDataFilter} filter
 */
PostAlertingPricesBasicTriggerListRequestData.prototype['filter'] = undefined;
...
export default PostAlertingPricesBasicTriggerListRequestData;
