...
/**
 * The GetAlertingPricesBasicTriggerGetDataNotificationChannelItems model module.
 * @module model/GetAlertingPricesBasicTriggerGetDataNotificationChannelItems
 */
class GetAlertingPricesBasicTriggerGetDataNotificationChannelItems {
    /**
     * Constructs a new <code>GetAlertingPricesBasicTriggerGetDataNotificationChannelItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/GetAlertingPricesBasicTriggerGetDataNotificationChannelItems
     */
    constructor() { 
        
        GetAlertingPricesBasicTriggerGetDataNotificationChannelItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicTriggerGetDataNotificationChannelItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicTriggerGetDataNotificationChannelItems} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicTriggerGetDataNotificationChannelItems} The populated <code>GetAlertingPricesBasicTriggerGetDataNotificationChannelItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAlertingPricesBasicTriggerGetDataNotificationChannelItems();
 ...
 * @member {Number} id
 */
GetAlertingPricesBasicTriggerGetDataNotificationChannelItems.prototype['id'] = undefined;
...
export default GetAlertingPricesBasicTriggerGetDataNotificationChannelItems;
