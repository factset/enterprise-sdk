...
/**
 * The InlineResponse2002DataPrice model module.
 * @module model/InlineResponse2002DataPrice
 */
class InlineResponse2002DataPrice {
    /**
     * Constructs a new <code>InlineResponse2002DataPrice</code>.
     * Price data of the trigger.
     * @alias module:model/InlineResponse2002DataPrice
     */
    constructor() { 
        
        InlineResponse2002DataPrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2002DataPrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2002DataPrice} obj Optional instance to populate.
     * @return {module:model/InlineResponse2002DataPrice} The populated <code>InlineResponse2002DataPrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2002DataPrice();
 ...
 * @member {module:model/InlineResponse2002DataPrice.TypeEnum} type
 */
InlineResponse2002DataPrice.prototype['type'] = undefined;
 ...
 * @member {module:model/InlineResponse2002DataPrice.QualityEnum} quality
 */
InlineResponse2002DataPrice.prototype['quality'] = undefined;
 ...
 * @readonly
 */
InlineResponse2002DataPrice['TypeEnum'] = {
 ...
 * @readonly
 */
InlineResponse2002DataPrice['QualityEnum'] = {
...
export default InlineResponse2002DataPrice;
