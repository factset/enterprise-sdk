...
/**
 * The PostAlertingPricesBasicTriggerListDataNotificationChannelItems model module.
 * @module model/PostAlertingPricesBasicTriggerListDataNotificationChannelItems
 */
class PostAlertingPricesBasicTriggerListDataNotificationChannelItems {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListDataNotificationChannelItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostAlertingPricesBasicTriggerListDataNotificationChannelItems
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListDataNotificationChannelItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListDataNotificationChannelItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListDataNotificationChannelItems} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListDataNotificationChannelItems} The populated <code>PostAlertingPricesBasicTriggerListDataNotificationChannelItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostAlertingPricesBasicTriggerListDataNotificationChannelItems();
 ...
 * @member {Number} id
 */
PostAlertingPricesBasicTriggerListDataNotificationChannelItems.prototype['id'] = undefined;
...
export default PostAlertingPricesBasicTriggerListDataNotificationChannelItems;
