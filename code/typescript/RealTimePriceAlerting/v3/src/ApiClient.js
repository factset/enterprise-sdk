...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/wealth/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/wealth/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/RealTimePriceAlerting/0.12.0 (${process.platform}; node ${process.version})`
        };
