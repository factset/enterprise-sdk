...
import GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel from './GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel';

/**
 * The GetAlertingPricesBasicAlertListDataItemsTriggerNotification model module.
 * @module model/GetAlertingPricesBasicAlertListDataItemsTriggerNotification
 */
class GetAlertingPricesBasicAlertListDataItemsTriggerNotification {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertListDataItemsTriggerNotification</code>.
     * Notification specific configuration.
     * @alias module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotification
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertListDataItemsTriggerNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertListDataItemsTriggerNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotification} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotification} The populated <code>GetAlertingPricesBasicAlertListDataItemsTriggerNotification</code> instance.
     */
...
/**
 * @member {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel} channel
 */
GetAlertingPricesBasicAlertListDataItemsTriggerNotification.prototype['channel'] = undefined;
...
export default GetAlertingPricesBasicAlertListDataItemsTriggerNotification;
