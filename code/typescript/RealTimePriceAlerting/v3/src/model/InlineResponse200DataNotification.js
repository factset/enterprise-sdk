...
import InlineResponse200DataNotificationStatus from './InlineResponse200DataNotificationStatus';

/**
 * The InlineResponse200DataNotification model module.
 * @module model/InlineResponse200DataNotification
 */
class InlineResponse200DataNotification {
    /**
     * Constructs a new <code>InlineResponse200DataNotification</code>.
     * Notification information of the alert.
     * @alias module:model/InlineResponse200DataNotification
     */
    constructor() { 
        
        InlineResponse200DataNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataNotification} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataNotification} The populated <code>InlineResponse200DataNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], [InlineResponse200DataNotificationStatus]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/InlineResponse200DataNotificationStatus>} status
 */
InlineResponse200DataNotification.prototype['status'] = undefined;
...
export default InlineResponse200DataNotification;
