...
import GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel from './GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel';

/**
 * The GetAlertingPricesBasicAlertGetDataNotificationStatusItems model module.
 * @module model/GetAlertingPricesBasicAlertGetDataNotificationStatusItems
 */
class GetAlertingPricesBasicAlertGetDataNotificationStatusItems {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertGetDataNotificationStatusItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItems
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertGetDataNotificationStatusItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertGetDataNotificationStatusItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItems} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItems} The populated <code>GetAlertingPricesBasicAlertGetDataNotificationStatusItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAlertingPricesBasicAlertGetDataNotificationStatusItems();

            if (data.hasOwnProperty('channel')) {
                obj['channel'] = GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel.constructFromObject(data['channel']);
            }
...
/**
 * @member {module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel} channel
 */
GetAlertingPricesBasicAlertGetDataNotificationStatusItems.prototype['channel'] = undefined;

/**
 * Date and time of the most recent change.
 * @member {Date} time
 */
GetAlertingPricesBasicAlertGetDataNotificationStatusItems.prototype['time'] = undefined;
 ...
 * @member {module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItems.CodeEnum} code
 */
GetAlertingPricesBasicAlertGetDataNotificationStatusItems.prototype['code'] = undefined;
 ...
 * @readonly
 */
GetAlertingPricesBasicAlertGetDataNotificationStatusItems['CodeEnum'] = {
...
export default GetAlertingPricesBasicAlertGetDataNotificationStatusItems;
