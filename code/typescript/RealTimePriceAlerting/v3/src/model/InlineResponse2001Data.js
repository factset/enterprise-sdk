...
import InlineResponse200DataNotification from './InlineResponse200DataNotification';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('notification')) {
                obj['notification'] = InlineResponse200DataNotification.constructFromObject(data['notification']);
            }
...
/**
 * @member {module:model/InlineResponse200DataNotification} notification
 */
InlineResponse2001Data.prototype['notification'] = undefined;
