...
/**
 * The PostAlertingPricesBasicTriggerListRequestDataFilterStatus model module.
 * @module model/PostAlertingPricesBasicTriggerListRequestDataFilterStatus
 */
class PostAlertingPricesBasicTriggerListRequestDataFilterStatus {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListRequestDataFilterStatus</code>.
     * Status of the trigger.
     * @alias module:model/PostAlertingPricesBasicTriggerListRequestDataFilterStatus
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListRequestDataFilterStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListRequestDataFilterStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListRequestDataFilterStatus} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListRequestDataFilterStatus} The populated <code>PostAlertingPricesBasicTriggerListRequestDataFilterStatus</code> instance.
     */
...
/**
 * Code of the status.
 * @member {module:model/PostAlertingPricesBasicTriggerListRequestDataFilterStatus.CodeEnum} code
 */
PostAlertingPricesBasicTriggerListRequestDataFilterStatus.prototype['code'] = undefined;
 ...
 * @readonly
 */
PostAlertingPricesBasicTriggerListRequestDataFilterStatus['CodeEnum'] = {
...
export default PostAlertingPricesBasicTriggerListRequestDataFilterStatus;
