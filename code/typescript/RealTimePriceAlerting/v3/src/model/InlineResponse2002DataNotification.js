...
import InlineResponse2002DataNotificationChannel from './InlineResponse2002DataNotificationChannel';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('channel')) {
                obj['channel'] = ApiClient.convertToType(data['channel'], [InlineResponse2002DataNotificationChannel]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/InlineResponse2002DataNotificationChannel>} channel
 */
