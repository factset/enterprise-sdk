...
import PostAlertingPricesBasicTriggerListRequestMetaPagination from './PostAlertingPricesBasicTriggerListRequestMetaPagination';

/**
 * The PostAlertingPricesBasicTriggerListRequestMeta model module.
 * @module model/PostAlertingPricesBasicTriggerListRequestMeta
 */
class PostAlertingPricesBasicTriggerListRequestMeta {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListRequestMeta</code>.
     * The meta member contains the meta information of the request.
     * @alias module:model/PostAlertingPricesBasicTriggerListRequestMeta
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListRequestMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListRequestMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListRequestMeta} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListRequestMeta} The populated <code>PostAlertingPricesBasicTriggerListRequestMeta</code> instance.
     */
 ...
 */
PostAlertingPricesBasicTriggerListRequestMeta.prototype['attributes'] = undefined;

/**
 * @member {module:model/PostAlertingPricesBasicTriggerListRequestMetaPagination} pagination
 */
PostAlertingPricesBasicTriggerListRequestMeta.prototype['pagination'] = undefined;
...
export default PostAlertingPricesBasicTriggerListRequestMeta;
