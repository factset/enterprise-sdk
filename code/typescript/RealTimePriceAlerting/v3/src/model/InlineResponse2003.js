...
import PostAlertingPricesBasicTriggerListDataItems from './PostAlertingPricesBasicTriggerListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostAlertingPricesBasicTriggerListDataItems]);
            }
...
/**
 * List of triggers.
 * @member {Array.<module:model/PostAlertingPricesBasicTriggerListDataItems>} data
 */
