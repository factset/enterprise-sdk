...
/**
 * The GetAlertingPricesBasicAlertListDataItemsTriggerPrice model module.
 * @module model/GetAlertingPricesBasicAlertListDataItemsTriggerPrice
 */
class GetAlertingPricesBasicAlertListDataItemsTriggerPrice {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertListDataItemsTriggerPrice</code>.
     * Price data of the trigger.
     * @alias module:model/GetAlertingPricesBasicAlertListDataItemsTriggerPrice
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertListDataItemsTriggerPrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertListDataItemsTriggerPrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerPrice} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerPrice} The populated <code>GetAlertingPricesBasicAlertListDataItemsTriggerPrice</code> instance.
     */
 ...
 * @member {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerPrice.TypeEnum} type
 */
GetAlertingPricesBasicAlertListDataItemsTriggerPrice.prototype['type'] = undefined;
 ...
 * @member {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerPrice.QualityEnum} quality
 */
GetAlertingPricesBasicAlertListDataItemsTriggerPrice.prototype['quality'] = undefined;
 ...
 * @readonly
 */
GetAlertingPricesBasicAlertListDataItemsTriggerPrice['TypeEnum'] = {
 ...
 * @readonly
 */
GetAlertingPricesBasicAlertListDataItemsTriggerPrice['QualityEnum'] = {
...
export default GetAlertingPricesBasicAlertListDataItemsTriggerPrice;
