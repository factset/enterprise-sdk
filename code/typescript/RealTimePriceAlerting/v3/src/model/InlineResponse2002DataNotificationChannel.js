...
/**
 * The InlineResponse2002DataNotificationChannel model module.
 * @module model/InlineResponse2002DataNotificationChannel
 */
class InlineResponse2002DataNotificationChannel {
    /**
     * Constructs a new <code>InlineResponse2002DataNotificationChannel</code>.
     * @alias module:model/InlineResponse2002DataNotificationChannel
     */
    constructor() { 
        
        InlineResponse2002DataNotificationChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2002DataNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2002DataNotificationChannel} obj Optional instance to populate.
     * @return {module:model/InlineResponse2002DataNotificationChannel} The populated <code>InlineResponse2002DataNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2002DataNotificationChannel();
 ...
 * @member {Number} id
 */
InlineResponse2002DataNotificationChannel.prototype['id'] = undefined;
...
export default InlineResponse2002DataNotificationChannel;
