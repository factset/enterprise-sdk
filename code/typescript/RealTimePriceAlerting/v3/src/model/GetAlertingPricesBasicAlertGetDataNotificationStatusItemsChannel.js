...
/**
 * The GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel model module.
 * @module model/GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel
 */
class GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel</code>.
     * Details of the notification channel.
     * @alias module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel} The populated <code>GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel</code> instance.
     */
 ...
 * @member {Number} id
 */
GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel.prototype['id'] = undefined;
...
export default GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel;
