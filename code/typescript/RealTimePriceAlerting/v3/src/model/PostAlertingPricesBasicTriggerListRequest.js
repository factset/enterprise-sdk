...
import PostAlertingPricesBasicTriggerListRequestData from './PostAlertingPricesBasicTriggerListRequestData';
import PostAlertingPricesBasicTriggerListRequestMeta from './PostAlertingPricesBasicTriggerListRequestMeta';

/**
 * The PostAlertingPricesBasicTriggerListRequest model module.
 * @module model/PostAlertingPricesBasicTriggerListRequest
 */
class PostAlertingPricesBasicTriggerListRequest {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListRequest</code>.
     * Request Body
     * @alias module:model/PostAlertingPricesBasicTriggerListRequest
     * @param data {module:model/PostAlertingPricesBasicTriggerListRequestData} 
     */
    constructor(data) { 
        
        PostAlertingPricesBasicTriggerListRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListRequest} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListRequest} The populated <code>PostAlertingPricesBasicTriggerListRequest</code> instance.
     */
...
/**
 * @member {module:model/PostAlertingPricesBasicTriggerListRequestData} data
 */
PostAlertingPricesBasicTriggerListRequest.prototype['data'] = undefined;

/**
 * @member {module:model/PostAlertingPricesBasicTriggerListRequestMeta} meta
 */
PostAlertingPricesBasicTriggerListRequest.prototype['meta'] = undefined;
...
export default PostAlertingPricesBasicTriggerListRequest;
