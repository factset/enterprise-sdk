...
/**
 * The GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel model module.
 * @module model/GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel
 */
class GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel</code>.
     * Channel specific configuration.
     * @alias module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel} The populated <code>GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel();
 ...
 */
GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel.prototype['id'] = undefined;
...
export default GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel;
