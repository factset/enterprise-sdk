...
/**
 * The GetAlertingPricesBasicAlertListDataItemsTriggerRange model module.
 * @module model/GetAlertingPricesBasicAlertListDataItemsTriggerRange
 */
class GetAlertingPricesBasicAlertListDataItemsTriggerRange {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertListDataItemsTriggerRange</code>.
     * Price range for the trigger to monitor.
     * @alias module:model/GetAlertingPricesBasicAlertListDataItemsTriggerRange
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertListDataItemsTriggerRange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertListDataItemsTriggerRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerRange} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertListDataItemsTriggerRange} The populated <code>GetAlertingPricesBasicAlertListDataItemsTriggerRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAlertingPricesBasicAlertListDataItemsTriggerRange();
 ...
 */
GetAlertingPricesBasicAlertListDataItemsTriggerRange.prototype['upperLimit'] = undefined;

/**
 * Lower limit.
 * @member {Number} lowerLimit
 */
GetAlertingPricesBasicAlertListDataItemsTriggerRange.prototype['lowerLimit'] = undefined;
...
export default GetAlertingPricesBasicAlertListDataItemsTriggerRange;
