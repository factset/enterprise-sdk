...
/**
 * The GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel model module.
 * @module model/GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel
 */
class GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel</code>.
     * Details of the notification channel.
     * @alias module:model/GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel} The populated <code>GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel();
 ...
 * @member {Number} id
 */
GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel.prototype['id'] = undefined;
...
export default GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel;
