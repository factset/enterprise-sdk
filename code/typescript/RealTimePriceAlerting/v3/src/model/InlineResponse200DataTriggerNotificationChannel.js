...
/**
 * The InlineResponse200DataTriggerNotificationChannel model module.
 * @module model/InlineResponse200DataTriggerNotificationChannel
 */
class InlineResponse200DataTriggerNotificationChannel {
    /**
     * Constructs a new <code>InlineResponse200DataTriggerNotificationChannel</code>.
     * Channel specific configuration.
     * @alias module:model/InlineResponse200DataTriggerNotificationChannel
     */
    constructor() { 
        
        InlineResponse200DataTriggerNotificationChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataTriggerNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataTriggerNotificationChannel} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataTriggerNotificationChannel} The populated <code>InlineResponse200DataTriggerNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataTriggerNotificationChannel();
 ...
 */
InlineResponse200DataTriggerNotificationChannel.prototype['id'] = undefined;
...
export default InlineResponse200DataTriggerNotificationChannel;
