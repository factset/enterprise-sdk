...
import PostAlertingPricesBasicTriggerListRequestDataFilterStatus from './PostAlertingPricesBasicTriggerListRequestDataFilterStatus';

/**
 * The PostAlertingPricesBasicTriggerListRequestDataFilter model module.
 * @module model/PostAlertingPricesBasicTriggerListRequestDataFilter
 */
class PostAlertingPricesBasicTriggerListRequestDataFilter {
    /**
     * Constructs a new <code>PostAlertingPricesBasicTriggerListRequestDataFilter</code>.
     * Criteria that filter the items in the response list.
     * @alias module:model/PostAlertingPricesBasicTriggerListRequestDataFilter
     */
    constructor() { 
        
        PostAlertingPricesBasicTriggerListRequestDataFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostAlertingPricesBasicTriggerListRequestDataFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAlertingPricesBasicTriggerListRequestDataFilter} obj Optional instance to populate.
     * @return {module:model/PostAlertingPricesBasicTriggerListRequestDataFilter} The populated <code>PostAlertingPricesBasicTriggerListRequestDataFilter</code> instance.
     */
...
/**
 * @member {module:model/PostAlertingPricesBasicTriggerListRequestDataFilterStatus} status
 */
PostAlertingPricesBasicTriggerListRequestDataFilter.prototype['status'] = undefined;
...
export default PostAlertingPricesBasicTriggerListRequestDataFilter;
