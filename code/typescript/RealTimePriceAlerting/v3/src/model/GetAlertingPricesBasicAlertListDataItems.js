...
import GetAlertingPricesBasicAlertListDataItemsNotification from './GetAlertingPricesBasicAlertListDataItemsNotification';
import GetAlertingPricesBasicAlertListDataItemsTrigger from './GetAlertingPricesBasicAlertListDataItemsTrigger';
import InlineResponse200DataPrice from './InlineResponse200DataPrice';

/**
 * The GetAlertingPricesBasicAlertListDataItems model module.
 * @module model/GetAlertingPricesBasicAlertListDataItems
 */
class GetAlertingPricesBasicAlertListDataItems {
    /**
     * Constructs a new <code>GetAlertingPricesBasicAlertListDataItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/GetAlertingPricesBasicAlertListDataItems
     */
    constructor() { 
        
        GetAlertingPricesBasicAlertListDataItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAlertingPricesBasicAlertListDataItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAlertingPricesBasicAlertListDataItems} obj Optional instance to populate.
     * @return {module:model/GetAlertingPricesBasicAlertListDataItems} The populated <code>GetAlertingPricesBasicAlertListDataItems</code> instance.
     */
 ...
 * @member {String} id
 */
GetAlertingPricesBasicAlertListDataItems.prototype['id'] = undefined;

/**
 * Date and time when the alert was created.
 * @member {Date} creation
 */
GetAlertingPricesBasicAlertListDataItems.prototype['creation'] = undefined;

/**
 * @member {module:model/InlineResponse200DataPrice} price
 */
GetAlertingPricesBasicAlertListDataItems.prototype['price'] = undefined;

/**
 * @member {module:model/GetAlertingPricesBasicAlertListDataItemsNotification} notification
 */
GetAlertingPricesBasicAlertListDataItems.prototype['notification'] = undefined;

/**
 * @member {module:model/GetAlertingPricesBasicAlertListDataItemsTrigger} trigger
 */
GetAlertingPricesBasicAlertListDataItems.prototype['trigger'] = undefined;
...
export default GetAlertingPricesBasicAlertListDataItems;
