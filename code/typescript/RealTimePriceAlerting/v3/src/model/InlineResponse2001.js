...
import GetAlertingPricesBasicAlertListDataItems from './GetAlertingPricesBasicAlertListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetAlertingPricesBasicAlertListDataItems]);
            }
...
/**
 * List of alerts.
 * @member {Array.<module:model/GetAlertingPricesBasicAlertListDataItems>} data
 */
