...
/**
 * The InlineResponse200DataNotificationChannel model module.
 * @module model/InlineResponse200DataNotificationChannel
 */
class InlineResponse200DataNotificationChannel {
    /**
     * Constructs a new <code>InlineResponse200DataNotificationChannel</code>.
     * Details of the notification channel.
     * @alias module:model/InlineResponse200DataNotificationChannel
     */
    constructor() { 
        
        InlineResponse200DataNotificationChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataNotificationChannel} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataNotificationChannel} The populated <code>InlineResponse200DataNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataNotificationChannel();
 ...
 * @member {Number} id
 */
InlineResponse200DataNotificationChannel.prototype['id'] = undefined;
...
export default InlineResponse200DataNotificationChannel;
