...
export default class MetricsApi {
    ...
    */
     ...
     * @param {String} opts.metricDataType Returns general data type of the metrics like integer, float or strings. When left blank, metrics with all data types would be returned. (default to '')
     * @param {Boolean} opts.pitDataItems Filters the list of metrics based on whether they are available for Point-in-Time (PIT) historical data. * `true` - Returns metrics that are available in PIT datasets. These metrics can be used in the `/point-in-time` endpoint. * `false` (default) - Returns metrics that are available in non-PIT datasets. (default to false)
    ...
    getFdsFundamentalsMetricsWithHttpInfo(opts) {
      ...
      let queryParams = {
        ...
        'pitDataItems': opts['pitDataItems']
      };
      let headerParams = {
      };
      let formParams = {
