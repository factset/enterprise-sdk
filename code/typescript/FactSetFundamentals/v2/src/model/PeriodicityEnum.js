...
/**
* Enum class PeriodicityEnum.
* @enum {}
* @readonly
*/
export default class PeriodicityEnum {
    ...
    /**
    * Returns a <code>PeriodicityEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PeriodicityEnum} The enum <code>PeriodicityEnum</code> value.
    */
