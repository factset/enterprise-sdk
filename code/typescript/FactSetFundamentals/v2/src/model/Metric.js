...
class Metric {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isPIT')) {
                obj['isPIT'] = ApiClient.convertToType(data['isPIT'], 'Boolean');
            }
            if (data.hasOwnProperty('isNonPIT')) {
                obj['isNonPIT'] = ApiClient.convertToType(data['isNonPIT'], 'Boolean');
            }
 ...
 * @member {Boolean} isPIT
 */
Metric.prototype['isPIT'] = undefined;
 ...
 * @member {Boolean} isNonPIT
 */
Metric.prototype['isNonPIT'] = undefined;
