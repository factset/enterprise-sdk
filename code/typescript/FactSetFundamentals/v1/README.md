...
[![npm](https://img.shields.io/npm/v/@factset/sdk-factsetfundamentals)](https://www.npmjs.com/package/@factset/sdk-factsetfundamentals)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetfundamentals@1.0.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetfundamentals@1.0.3
```
