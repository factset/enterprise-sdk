# northfieldportfoliooptimizer.StrategyDocumentsApi
...
```javascript
const { ApiClient, StrategyDocumentsApi } = require('@factset/sdk-northfieldportfoliooptimizer');
...
// Call api endpoint
apiInstance.getNorthfieldStrategyDocuments(path).then(
  data => {
