...
```shell
npm install @factset/sdk-utils @factset/sdk-northfieldportfoliooptimizer@0.21.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-northfieldportfoliooptimizer@0.21.3
```
