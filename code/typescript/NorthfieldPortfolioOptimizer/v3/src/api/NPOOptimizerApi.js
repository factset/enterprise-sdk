...
export default class NPOOptimizerApi {
    ...
    /**
    * Constructs a new NPOOptimizerApi. 
    * @alias module:api/NPOOptimizerApi
    * @class
    ...
    */
    ...
    cancelOptimizationByIdWithHttpInfo(id) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/npo/v3/optimizations/{id}', 'DELETE',
     ...
     * @param {String} id from url, provided from the location header in the Create and Run NPO optimization endpoint
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/NPOOptimizationParametersRoot} and HTTP response
     */
    getOptimizationParametersWithHttpInfo(id) {
      ...
      let returnType = NPOOptimizationParametersRoot;

      return this.apiClient.callApi(
        '/analytics/engines/npo/v3/optimizations/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * This is the endpoint that returns the optimization parameters passed for an optimization.
     * @param {String} id from url, provided from the location header in the Create and Run NPO optimization endpoint
     * @return { Promise.< module:model/NPOOptimizationParametersRoot > } a Promise, with data of type {@link module:model/NPOOptimizationParametersRoot }
     */
     ...
     * @param {String} id from url, provided from the location header in the Get NPO optimization status by id endpoint
    ...
    getOptimizationResultWithHttpInfo(id) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/npo/v3/optimizations/{id}/result', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getOptimizationStatusByIdWithHttpInfo(id) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/npo/v3/optimizations/{id}/status', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {module:model/NPOOptimizationParametersRoot} opts.nPOOptimizationParametersRoot Optimization Parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ObjectRoot} and HTTP response
     */
    postAndOptimizeWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = opts['nPOOptimizationParametersRoot'];
      ...
      return this.apiClient.callApi(
        '/analytics/engines/npo/v3/optimizations', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    putAndOptimizeWithHttpInfo(id, opts) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/npo/v3/optimizations/{id}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
