...
[![npm](https://img.shields.io/badge/npm-v0.21.2-orange)](https://www.npmjs.com/package/@factset/sdk-eventscontribution/v/0.21.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-eventscontribution@0.21.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-eventscontribution@0.21.2
```
