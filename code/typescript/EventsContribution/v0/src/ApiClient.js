...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/events-contribution/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/events-contribution/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/EventsContribution/0.21.1 (${process.platform}; node ${process.version})`
        };
