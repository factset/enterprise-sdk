...
export default class EventsContributionApi {
    ...
    */
     ...
     * @param {String} eventId ID of event to be deleted. This ID is vendor generated and should be unique in each vendor's content set.
     ...
     * @param {String} eventId ID for event retrieval. This ID is vendor generated and should be unique in each vendor's content set.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetResponse} and HTTP response
     */
     ...
     * This endpoint retrieves previously submitted events by event ID.
     * @param {String} eventId ID for event retrieval. This ID is vendor generated and should be unique in each vendor's content set.
     * @return { Promise.< module:model/GetResponse > } a Promise, with data of type {@link module:model/GetResponse }
     */
    getEvent(eventId) {
     ...
     * @param {String} eventId ID of event to be updated. This ID is vendor generated and should be unique in each vendor's content set.
