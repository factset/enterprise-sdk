...
import TableAnswerAllOf from './TableAnswerAllOf';
import TableTemplateData from './TableTemplateData';

/**
 * The TableAnswer model module.
 * @module model/TableAnswer
 */
class TableAnswer {
    /**
     * Constructs a new <code>TableAnswer</code>.
     * @alias module:model/TableAnswer
     * @implements module:model/AnswerWithTitle
     * @implements module:model/TableAnswerAllOf
     * @param template {String} 
     * @param title {String} 
     * @param templateData {module:model/TableTemplateData} 
     */
    constructor(template, title, templateData) { 
        AnswerWithTitle.initialize(this, template, title);TableAnswerAllOf.initialize(this, templateData);
        TableAnswer.initialize(this, template, title, templateData);
    }
    ...
    /**
     * Constructs a <code>TableAnswer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TableAnswer} obj Optional instance to populate.
     * @return {module:model/TableAnswer} The populated <code>TableAnswer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TableAnswer();
            try {
              obj = AnswerWithTitle.constructFromObject(data, obj);
            } catch(error) {}
            try {
              obj = TableAnswerAllOf.constructFromObject(data, obj);
            } catch(error) {}
...
// Implement TableAnswerAllOf interface:
/**
 * @member {module:model/TableTemplateData} templateData
 */
