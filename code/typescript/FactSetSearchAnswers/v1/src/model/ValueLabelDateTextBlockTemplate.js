...
class ValueLabelDateTextBlockTemplate {
    ...
    constructor(templateName, headline) { 
        TemplateWithLinks.initialize(this, templateName, headline);ValueLabelDateTextBlockTemplateAllOf.initialize(this);
        ValueLabelDateTextBlockTemplate.initialize(this, templateName, headline);
    }
