...
import PercentChangeLabelAnswerAllOf from './PercentChangeLabelAnswerAllOf';
import PercentChangeLabelTemplateData from './PercentChangeLabelTemplateData';

/**
 * The PercentChangeLabelAnswer model module.
 * @module model/PercentChangeLabelAnswer
 */
class PercentChangeLabelAnswer {
    /**
     * Constructs a new <code>PercentChangeLabelAnswer</code>.
     * @alias module:model/PercentChangeLabelAnswer
     * @implements module:model/AnswerWithTitle
     * @implements module:model/PercentChangeLabelAnswerAllOf
     * @param template {String} 
     * @param title {String} 
     * @param templateData {module:model/PercentChangeLabelTemplateData} 
     */
    constructor(template, title, templateData) { 
        AnswerWithTitle.initialize(this, template, title);PercentChangeLabelAnswerAllOf.initialize(this, templateData);
        PercentChangeLabelAnswer.initialize(this, template, title, templateData);
    }
    ...
    /**
     * Constructs a <code>PercentChangeLabelAnswer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PercentChangeLabelAnswer} obj Optional instance to populate.
     * @return {module:model/PercentChangeLabelAnswer} The populated <code>PercentChangeLabelAnswer</code> instance.
     */
...
// Implement PercentChangeLabelAnswerAllOf interface:
/**
 * @member {module:model/PercentChangeLabelTemplateData} templateData
 */
...
export default PercentChangeLabelAnswer;
