...
[![npm](https://img.shields.io/badge/npm-v2.0.2-orange)](https://www.npmjs.com/package/@factset/sdk-factsetsearchanswers/v/2.0.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetsearchanswers@2.0.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetsearchanswers@2.0.2
```
