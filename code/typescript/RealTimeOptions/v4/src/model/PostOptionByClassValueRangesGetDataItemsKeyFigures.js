...
import PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness from './PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness';

/**
 * The PostOptionByClassValueRangesGetDataItemsKeyFigures model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsKeyFigures
 */
class PostOptionByClassValueRangesGetDataItemsKeyFigures {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsKeyFigures</code>.
     * Value ranges related to the key figures.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsKeyFigures
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsKeyFigures.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsKeyFigures</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsKeyFigures} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsKeyFigures} The populated <code>PostOptionByClassValueRangesGetDataItemsKeyFigures</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness} moneyness
 */
PostOptionByClassValueRangesGetDataItemsKeyFigures.prototype['moneyness'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsKeyFigures;
