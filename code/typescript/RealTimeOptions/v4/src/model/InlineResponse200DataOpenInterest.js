...
/**
 * The InlineResponse200DataOpenInterest model module.
 * @module model/InlineResponse200DataOpenInterest
 */
class InlineResponse200DataOpenInterest {
    /**
     * Constructs a new <code>InlineResponse200DataOpenInterest</code>.
     * Open positions of the option.
     * @alias module:model/InlineResponse200DataOpenInterest
     */
    constructor() { 
        
        InlineResponse200DataOpenInterest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataOpenInterest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataOpenInterest} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataOpenInterest} The populated <code>InlineResponse200DataOpenInterest</code> instance.
     */
 ...
 */
InlineResponse200DataOpenInterest.prototype['volume'] = undefined;

/**
 * Date and time on which the open positions of the option are determined.
 * @member {Date} time
 */
InlineResponse200DataOpenInterest.prototype['time'] = undefined;
...
export default InlineResponse200DataOpenInterest;
