...
/**
 * The PostOptionByClassValueRangesGetRequestDataClass model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataClass
 */
class PostOptionByClassValueRangesGetRequestDataClass {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataClass</code>.
     * A product group of options from the same exchange and with the same underlying.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataClass
     * @param id {String} Identifier of the option class.
     */
    constructor(id) { 
        
        PostOptionByClassValueRangesGetRequestDataClass.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataClass</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataClass} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataClass} The populated <code>PostOptionByClassValueRangesGetRequestDataClass</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataClass();
 ...
 * @member {String} id
 */
PostOptionByClassValueRangesGetRequestDataClass.prototype['id'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataClass;
