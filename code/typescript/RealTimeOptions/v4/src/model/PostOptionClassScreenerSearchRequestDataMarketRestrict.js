...
/**
 * The PostOptionClassScreenerSearchRequestDataMarketRestrict model module.
 * @module model/PostOptionClassScreenerSearchRequestDataMarketRestrict
 */
class PostOptionClassScreenerSearchRequestDataMarketRestrict {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataMarketRestrict</code>.
     * Specifies the markets from which an option class may originate.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataMarketRestrict
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataMarketRestrict.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataMarketRestrict</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataMarketRestrict} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataMarketRestrict} The populated <code>PostOptionClassScreenerSearchRequestDataMarketRestrict</code> instance.
     */
 ...
 */
PostOptionClassScreenerSearchRequestDataMarketRestrict.prototype['ids'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataMarketRestrict;
