...
/**
 * The PostOptionByClassListRequestDataFilterValidationPricePrevious model module.
 * @module model/PostOptionByClassListRequestDataFilterValidationPricePrevious
 */
class PostOptionByClassListRequestDataFilterValidationPricePrevious {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataFilterValidationPricePrevious</code>.
     * Parameters related to the presence and age of a trade price from a preceding trading day.
     * @alias module:model/PostOptionByClassListRequestDataFilterValidationPricePrevious
     */
    constructor() { 
        
        PostOptionByClassListRequestDataFilterValidationPricePrevious.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataFilterValidationPricePrevious</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataFilterValidationPricePrevious} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataFilterValidationPricePrevious} The populated <code>PostOptionByClassListRequestDataFilterValidationPricePrevious</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataFilterValidationPricePrevious();
 ...
 */
PostOptionByClassListRequestDataFilterValidationPricePrevious.prototype['availableOnly'] = undefined;

/**
 * Earliest admissible date of the trade price from a preceding trading day.
 * @member {Date} minimumDate
 */
PostOptionByClassListRequestDataFilterValidationPricePrevious.prototype['minimumDate'] = undefined;
...
export default PostOptionByClassListRequestDataFilterValidationPricePrevious;
