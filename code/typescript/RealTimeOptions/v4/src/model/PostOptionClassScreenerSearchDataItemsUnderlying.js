...
import PostOptionClassScreenerSearchDataItemsUnderlyingNotation from './PostOptionClassScreenerSearchDataItemsUnderlyingNotation';

/**
 * The PostOptionClassScreenerSearchDataItemsUnderlying model module.
 * @module model/PostOptionClassScreenerSearchDataItemsUnderlying
 */
class PostOptionClassScreenerSearchDataItemsUnderlying {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsUnderlying</code>.
     * Information regarding the underlying of the option class.
     * @alias module:model/PostOptionClassScreenerSearchDataItemsUnderlying
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsUnderlying.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsUnderlying</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsUnderlying} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsUnderlying} The populated <code>PostOptionClassScreenerSearchDataItemsUnderlying</code> instance.
     */
 ...
 * @member {String} name
 */
PostOptionClassScreenerSearchDataItemsUnderlying.prototype['name'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotation} notation
 */
PostOptionClassScreenerSearchDataItemsUnderlying.prototype['notation'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsUnderlying;
