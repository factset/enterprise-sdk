...
import PostOptionByClassListRequestDataContractExcercise from './PostOptionByClassListRequestDataContractExcercise';
import PostOptionByClassValueRangesGetRequestDataContractStrikePrice from './PostOptionByClassValueRangesGetRequestDataContractStrikePrice';

/**
 * The PostOptionByClassValueRangesGetRequestDataContract model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataContract
 */
class PostOptionByClassValueRangesGetRequestDataContract {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataContract</code>.
     * Parameters related to the option contract.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataContract
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataContract.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataContract} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataContract} The populated <code>PostOptionByClassValueRangesGetRequestDataContract</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassListRequestDataContractExcercise} excercise
 */
PostOptionByClassValueRangesGetRequestDataContract.prototype['excercise'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePrice} strikePrice
 */
PostOptionByClassValueRangesGetRequestDataContract.prototype['strikePrice'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataContract;
