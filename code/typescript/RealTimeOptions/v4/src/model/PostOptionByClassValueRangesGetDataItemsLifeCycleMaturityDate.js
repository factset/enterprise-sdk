...
/**
 * The PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate
 */
class PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate</code>.
     * Date range of the maturity date.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate} The populated <code>PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate();
 ...
 * @member {Date} minimum
 */
PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate.prototype['minimum'] = undefined;

/**
 * Maximum date.
 * @member {Date} maximum
 */
PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate;
