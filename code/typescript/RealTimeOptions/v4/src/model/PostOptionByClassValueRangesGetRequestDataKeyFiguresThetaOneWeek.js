...
import PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum from './PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum';

/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum} minimum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek;
