...
/**
 * The PostOptionByClassValueRangesGetDataItemsLeverage model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsLeverage
 */
class PostOptionByClassValueRangesGetDataItemsLeverage {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsLeverage</code>.
     * Value range of the leverage.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsLeverage
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsLeverage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsLeverage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsLeverage} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsLeverage} The populated <code>PostOptionByClassValueRangesGetDataItemsLeverage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsLeverage();
 ...
 */
PostOptionByClassValueRangesGetDataItemsLeverage.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsLeverage.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsLeverage;
