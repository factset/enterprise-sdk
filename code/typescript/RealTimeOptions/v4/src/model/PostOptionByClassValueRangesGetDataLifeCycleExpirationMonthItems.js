...
/**
 * The PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems model module.
 * @module model/PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems
 */
class PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems} The populated <code>PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems.prototype['value'] = undefined;

/**
 * Number of notations.
 * @member {Number} count
 */
PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems.prototype['count'] = undefined;
...
export default PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems;
