...
import PostOptionByClassListRequestDataContractStrikePrice from './PostOptionByClassListRequestDataContractStrikePrice';

/**
 * The PostOptionByClassListRequestDataContract model module.
 * @module model/PostOptionByClassListRequestDataContract
 */
class PostOptionByClassListRequestDataContract {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContract</code>.
     * Parameters related to the option contract.
     * @alias module:model/PostOptionByClassListRequestDataContract
     */
    constructor() { 
        
        PostOptionByClassListRequestDataContract.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContract} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContract} The populated <code>PostOptionByClassListRequestDataContract</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataContract();
            ...
            if (data.hasOwnProperty('strikePrice')) {
                obj['strikePrice'] = PostOptionByClassListRequestDataContractStrikePrice.constructFromObject(data['strikePrice']);
            }
        }
        return obj;
    }
 ...
 */
PostOptionByClassListRequestDataContract.prototype['excercise'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractStrikePrice} strikePrice
 */
PostOptionByClassListRequestDataContract.prototype['strikePrice'] = undefined;
...
export default PostOptionByClassListRequestDataContract;
