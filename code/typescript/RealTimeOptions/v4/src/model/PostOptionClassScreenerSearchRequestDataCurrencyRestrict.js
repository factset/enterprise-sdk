...
/**
 * The PostOptionClassScreenerSearchRequestDataCurrencyRestrict model module.
 * @module model/PostOptionClassScreenerSearchRequestDataCurrencyRestrict
 */
class PostOptionClassScreenerSearchRequestDataCurrencyRestrict {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataCurrencyRestrict</code>.
     * Specifies the currencies an option class may have.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataCurrencyRestrict
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataCurrencyRestrict.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataCurrencyRestrict</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataCurrencyRestrict} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataCurrencyRestrict} The populated <code>PostOptionClassScreenerSearchRequestDataCurrencyRestrict</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataCurrencyRestrict();
 ...
 */
PostOptionClassScreenerSearchRequestDataCurrencyRestrict.prototype['ids'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataCurrencyRestrict;
