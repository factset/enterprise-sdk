...
import PostOptionByClassListRequestDataOpenInterestMinimum from './PostOptionByClassListRequestDataOpenInterestMinimum';

/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega();
...
/**
 * @member {module:model/PostOptionByClassListRequestDataOpenInterestMinimum} minimum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataOpenInterestMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega;
