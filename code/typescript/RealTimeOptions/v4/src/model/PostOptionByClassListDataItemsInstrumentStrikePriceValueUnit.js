...
/**
 * The PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit model module.
 * @module model/PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit
 */
class PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit {
    /**
     * Constructs a new <code>PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit</code>.
     * Value unit of the strike price. See endpoint &#x60;/basic/value-unit/list&#x60; for possible values.
     * @alias module:model/PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit
     */
    constructor() { 
        
        PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit} The populated <code>PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit();
 ...
 * @member {Number} id
 */
PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit.prototype['id'] = undefined;

/**
 * Code of the value unit.
 * @member {String} code
 */
PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit.prototype['code'] = undefined;
...
export default PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit;
