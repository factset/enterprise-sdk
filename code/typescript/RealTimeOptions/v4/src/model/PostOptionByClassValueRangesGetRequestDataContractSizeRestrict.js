...
/**
 * The PostOptionByClassValueRangesGetRequestDataContractSizeRestrict model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataContractSizeRestrict
 */
class PostOptionByClassValueRangesGetRequestDataContractSizeRestrict {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataContractSizeRestrict</code>.
     * Specifies the contract sizes an option may have.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataContractSizeRestrict
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataContractSizeRestrict.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataContractSizeRestrict</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataContractSizeRestrict} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataContractSizeRestrict} The populated <code>PostOptionByClassValueRangesGetRequestDataContractSizeRestrict</code> instance.
     */
 ...
 */
PostOptionByClassValueRangesGetRequestDataContractSizeRestrict.prototype['values'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataContractSizeRestrict;
