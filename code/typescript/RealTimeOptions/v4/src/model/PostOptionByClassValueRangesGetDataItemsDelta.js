...
/**
 * The PostOptionByClassValueRangesGetDataItemsDelta model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsDelta
 */
class PostOptionByClassValueRangesGetDataItemsDelta {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsDelta</code>.
     * Value range of the delta.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsDelta
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsDelta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsDelta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsDelta} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsDelta} The populated <code>PostOptionByClassValueRangesGetDataItemsDelta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsDelta();
 ...
 */
PostOptionByClassValueRangesGetDataItemsDelta.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsDelta.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsDelta;
