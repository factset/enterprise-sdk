...
/**
 * The PostOptionByClassValueRangesGetDataItemsStrikePrice model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsStrikePrice
 */
class PostOptionByClassValueRangesGetDataItemsStrikePrice {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsStrikePrice</code>.
     * Value range of the strike price.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsStrikePrice
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsStrikePrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsStrikePrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsStrikePrice} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsStrikePrice} The populated <code>PostOptionByClassValueRangesGetDataItemsStrikePrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsStrikePrice();
 ...
 */
PostOptionByClassValueRangesGetDataItemsStrikePrice.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsStrikePrice.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsStrikePrice;
