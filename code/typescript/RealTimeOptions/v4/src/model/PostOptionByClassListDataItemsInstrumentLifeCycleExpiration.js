...
/**
 * The PostOptionByClassListDataItemsInstrumentLifeCycleExpiration model module.
 * @module model/PostOptionByClassListDataItemsInstrumentLifeCycleExpiration
 */
class PostOptionByClassListDataItemsInstrumentLifeCycleExpiration {
    /**
     * Constructs a new <code>PostOptionByClassListDataItemsInstrumentLifeCycleExpiration</code>.
     ...
     * @alias module:model/PostOptionByClassListDataItemsInstrumentLifeCycleExpiration
     */
    constructor() { 
        
        PostOptionByClassListDataItemsInstrumentLifeCycleExpiration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListDataItemsInstrumentLifeCycleExpiration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListDataItemsInstrumentLifeCycleExpiration} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListDataItemsInstrumentLifeCycleExpiration} The populated <code>PostOptionByClassListDataItemsInstrumentLifeCycleExpiration</code> instance.
     */
 ...
 * @member {Number} month
 */
PostOptionByClassListDataItemsInstrumentLifeCycleExpiration.prototype['month'] = undefined;

/**
 * Year of the option's expiration.
 * @member {Number} year
 */
PostOptionByClassListDataItemsInstrumentLifeCycleExpiration.prototype['year'] = undefined;
...
export default PostOptionByClassListDataItemsInstrumentLifeCycleExpiration;
