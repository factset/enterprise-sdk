...
/**
 * The PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest
 */
class PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest</code>.
     * Parameters related to the presence and age of the most recent trade price.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest} The populated <code>PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest();
 ...
 */
PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest.prototype['availableOnly'] = undefined;

/**
 * Earliest admissible date of the most recent trade price.
 * @member {Date} minimumDate
 */
PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest.prototype['minimumDate'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest;
