...
import PostOptionByClassValueRangesGetRequestDataContractSizeExclude from './PostOptionByClassValueRangesGetRequestDataContractSizeExclude';
import PostOptionByClassValueRangesGetRequestDataContractSizeRestrict from './PostOptionByClassValueRangesGetRequestDataContractSizeRestrict';

/**
 * The PostOptionByClassValueRangesGetRequestDataContractSize model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataContractSize
 */
class PostOptionByClassValueRangesGetRequestDataContractSize {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataContractSize</code>.
     * Parameters related to the contract size of the option.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataContractSize
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataContractSize.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataContractSize</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataContractSize} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataContractSize} The populated <code>PostOptionByClassValueRangesGetRequestDataContractSize</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataContractSize();

            if (data.hasOwnProperty('restrict')) {
                obj['restrict'] = PostOptionByClassValueRangesGetRequestDataContractSizeRestrict.constructFromObject(data['restrict']);
            }
            if (data.hasOwnProperty('exclude')) {
                obj['exclude'] = PostOptionByClassValueRangesGetRequestDataContractSizeExclude.constructFromObject(data['exclude']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataContractSizeRestrict} restrict
 */
PostOptionByClassValueRangesGetRequestDataContractSize.prototype['restrict'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataContractSizeExclude} exclude
 */
PostOptionByClassValueRangesGetRequestDataContractSize.prototype['exclude'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataContractSize;
