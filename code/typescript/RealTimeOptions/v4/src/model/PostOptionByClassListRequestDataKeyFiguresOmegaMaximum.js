...
/**
 * The PostOptionByClassListRequestDataKeyFiguresOmegaMaximum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresOmegaMaximum
 */
class PostOptionByClassListRequestDataKeyFiguresOmegaMaximum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresOmegaMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresOmegaMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresOmegaMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMaximum} The populated <code>PostOptionByClassListRequestDataKeyFiguresOmegaMaximum</code> instance.
     */
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresOmegaMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresOmegaMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresOmegaMaximum;
