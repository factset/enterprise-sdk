...
/**
 * The PostOptionByClassValueRangesGetDataItemsImpliedVolatility model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsImpliedVolatility
 */
class PostOptionByClassValueRangesGetDataItemsImpliedVolatility {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsImpliedVolatility</code>.
     * Value range of the implied volatility.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsImpliedVolatility
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsImpliedVolatility.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsImpliedVolatility</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsImpliedVolatility} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsImpliedVolatility} The populated <code>PostOptionByClassValueRangesGetDataItemsImpliedVolatility</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsImpliedVolatility();
 ...
 */
PostOptionByClassValueRangesGetDataItemsImpliedVolatility.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsImpliedVolatility.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsImpliedVolatility;
