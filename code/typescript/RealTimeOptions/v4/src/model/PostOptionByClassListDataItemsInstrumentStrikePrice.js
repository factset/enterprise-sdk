...
import PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit from './PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit';

/**
 * The PostOptionByClassListDataItemsInstrumentStrikePrice model module.
 * @module model/PostOptionByClassListDataItemsInstrumentStrikePrice
 */
class PostOptionByClassListDataItemsInstrumentStrikePrice {
    /**
     * Constructs a new <code>PostOptionByClassListDataItemsInstrumentStrikePrice</code>.
     ...
     * @alias module:model/PostOptionByClassListDataItemsInstrumentStrikePrice
     */
    constructor() { 
        
        PostOptionByClassListDataItemsInstrumentStrikePrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListDataItemsInstrumentStrikePrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListDataItemsInstrumentStrikePrice} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListDataItemsInstrumentStrikePrice} The populated <code>PostOptionByClassListDataItemsInstrumentStrikePrice</code> instance.
     */
 ...
 * @member {Number} level
 */
PostOptionByClassListDataItemsInstrumentStrikePrice.prototype['level'] = undefined;

/**
 * @member {module:model/PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit} valueUnit
 */
PostOptionByClassListDataItemsInstrumentStrikePrice.prototype['valueUnit'] = undefined;
...
export default PostOptionByClassListDataItemsInstrumentStrikePrice;
