...
import PostOptionByClassListRequestDataFilterValidationPrice from './PostOptionByClassListRequestDataFilterValidationPrice';

/**
 * The PostOptionByClassListRequestDataFilterValidation model module.
 * @module model/PostOptionByClassListRequestDataFilterValidation
 */
class PostOptionByClassListRequestDataFilterValidation {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataFilterValidation</code>.
     * Validation parameters.
     * @alias module:model/PostOptionByClassListRequestDataFilterValidation
     */
    constructor() { 
        
        PostOptionByClassListRequestDataFilterValidation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataFilterValidation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataFilterValidation} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataFilterValidation} The populated <code>PostOptionByClassListRequestDataFilterValidation</code> instance.
     */
 ...
 */
PostOptionByClassListRequestDataFilterValidation.prototype['onlyActive'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataFilterValidationPrice} price
 */
PostOptionByClassListRequestDataFilterValidation.prototype['price'] = undefined;
...
export default PostOptionByClassListRequestDataFilterValidation;
