...
/**
 * The PostOptionByClassListRequestDataOpenInterestMaximum model module.
 * @module model/PostOptionByClassListRequestDataOpenInterestMaximum
 */
class PostOptionByClassListRequestDataOpenInterestMaximum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataOpenInterestMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassListRequestDataOpenInterestMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataOpenInterestMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataOpenInterestMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataOpenInterestMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataOpenInterestMaximum} The populated <code>PostOptionByClassListRequestDataOpenInterestMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataOpenInterestMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataOpenInterestMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataOpenInterestMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataOpenInterestMaximum;
