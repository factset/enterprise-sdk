...
import InlineResponse200DataUnderlyingNotation from './InlineResponse200DataUnderlyingNotation';

/**
 * The InlineResponse200DataUnderlying model module.
 * @module model/InlineResponse200DataUnderlying
 */
class InlineResponse200DataUnderlying {
    /**
     * Constructs a new <code>InlineResponse200DataUnderlying</code>.
     * Information regarding the underlying of the option.
     * @alias module:model/InlineResponse200DataUnderlying
     */
    constructor() { 
        
        InlineResponse200DataUnderlying.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataUnderlying</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataUnderlying} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataUnderlying} The populated <code>InlineResponse200DataUnderlying</code> instance.
     */
 ...
 * @member {String} name
 */
InlineResponse200DataUnderlying.prototype['name'] = undefined;

/**
 * @member {module:model/InlineResponse200DataUnderlyingNotation} notation
 */
InlineResponse200DataUnderlying.prototype['notation'] = undefined;
...
export default InlineResponse200DataUnderlying;
