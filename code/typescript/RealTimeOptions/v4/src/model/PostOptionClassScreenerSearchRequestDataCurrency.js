...
import PostOptionClassScreenerSearchRequestDataCurrencyExclude from './PostOptionClassScreenerSearchRequestDataCurrencyExclude';
import PostOptionClassScreenerSearchRequestDataCurrencyRestrict from './PostOptionClassScreenerSearchRequestDataCurrencyRestrict';

/**
 * The PostOptionClassScreenerSearchRequestDataCurrency model module.
 * @module model/PostOptionClassScreenerSearchRequestDataCurrency
 */
class PostOptionClassScreenerSearchRequestDataCurrency {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataCurrency</code>.
     * Currency-related class selection. See endpoint &#x60;/basic/value-unit/currency/list&#x60; for possible values.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataCurrency
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataCurrency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataCurrency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataCurrency} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataCurrency} The populated <code>PostOptionClassScreenerSearchRequestDataCurrency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataCurrency();

            if (data.hasOwnProperty('restrict')) {
                obj['restrict'] = PostOptionClassScreenerSearchRequestDataCurrencyRestrict.constructFromObject(data['restrict']);
            }
            if (data.hasOwnProperty('exclude')) {
                obj['exclude'] = PostOptionClassScreenerSearchRequestDataCurrencyExclude.constructFromObject(data['exclude']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataCurrencyRestrict} restrict
 */
PostOptionClassScreenerSearchRequestDataCurrency.prototype['restrict'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataCurrencyExclude} exclude
 */
PostOptionClassScreenerSearchRequestDataCurrency.prototype['exclude'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataCurrency;
