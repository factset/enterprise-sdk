...
import PostOptionByClassListRequestDataFilterValidationPriceLatest from './PostOptionByClassListRequestDataFilterValidationPriceLatest';
import PostOptionByClassListRequestDataFilterValidationPricePrevious from './PostOptionByClassListRequestDataFilterValidationPricePrevious';

/**
 * The PostOptionByClassListRequestDataFilterValidationPrice model module.
 * @module model/PostOptionByClassListRequestDataFilterValidationPrice
 */
class PostOptionByClassListRequestDataFilterValidationPrice {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataFilterValidationPrice</code>.
     * Price-related parameters.
     * @alias module:model/PostOptionByClassListRequestDataFilterValidationPrice
     */
    constructor() { 
        
        PostOptionByClassListRequestDataFilterValidationPrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataFilterValidationPrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataFilterValidationPrice} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataFilterValidationPrice} The populated <code>PostOptionByClassListRequestDataFilterValidationPrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataFilterValidationPrice();

            if (data.hasOwnProperty('quality')) {
                obj['quality'] = ApiClient.convertToType(data['quality'], 'String');
            }
            if (data.hasOwnProperty('latest')) {
                obj['latest'] = PostOptionByClassListRequestDataFilterValidationPriceLatest.constructFromObject(data['latest']);
            }
            if (data.hasOwnProperty('previous')) {
                obj['previous'] = PostOptionByClassListRequestDataFilterValidationPricePrevious.constructFromObject(data['previous']);
            }
        }
        return obj;
    }
 ...
 * @member {module:model/PostOptionByClassListRequestDataFilterValidationPrice.QualityEnum} quality
 */
PostOptionByClassListRequestDataFilterValidationPrice.prototype['quality'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataFilterValidationPriceLatest} latest
 */
PostOptionByClassListRequestDataFilterValidationPrice.prototype['latest'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataFilterValidationPricePrevious} previous
 */
PostOptionByClassListRequestDataFilterValidationPrice.prototype['previous'] = undefined;
 ...
 * @readonly
 */
PostOptionByClassListRequestDataFilterValidationPrice['QualityEnum'] = {
...
export default PostOptionByClassListRequestDataFilterValidationPrice;
