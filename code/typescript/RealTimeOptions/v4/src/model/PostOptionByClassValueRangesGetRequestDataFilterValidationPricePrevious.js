...
/**
 * The PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious
 */
class PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious</code>.
     * Parameters related to the presence and age of a trade price from a preceding trading day.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious} The populated <code>PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious();
 ...
 */
PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious.prototype['availableOnly'] = undefined;

/**
 * Earliest admissible date of the trade price from a preceding trading day.
 * @member {Date} minimumDate
 */
PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious.prototype['minimumDate'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious;
