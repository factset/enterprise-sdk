...
import PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum from './PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum';
import PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum from './PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum';

/**
 * The PostOptionByClassListRequestDataKeyFiguresImpliedVolatility model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatility
 */
class PostOptionByClassListRequestDataKeyFiguresImpliedVolatility {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatility</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatility
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresImpliedVolatility.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatility</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatility} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatility} The populated <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatility</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresImpliedVolatility();

            if (data.hasOwnProperty('minimum')) {
                obj['minimum'] = PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum.constructFromObject(data['minimum']);
            }
            if (data.hasOwnProperty('maximum')) {
                obj['maximum'] = PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum.constructFromObject(data['maximum']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum} minimum
 */
PostOptionByClassListRequestDataKeyFiguresImpliedVolatility.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresImpliedVolatility.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresImpliedVolatility;
