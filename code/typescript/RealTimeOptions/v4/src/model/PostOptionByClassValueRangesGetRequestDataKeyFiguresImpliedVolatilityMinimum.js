...
/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum;
