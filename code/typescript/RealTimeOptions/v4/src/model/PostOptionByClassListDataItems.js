...
import PostOptionByClassListDataItemsInstrument from './PostOptionByClassListDataItemsInstrument';
import PostOptionByClassListDataItemsKeyFigures from './PostOptionByClassListDataItemsKeyFigures';

/**
 * The PostOptionByClassListDataItems model module.
 * @module model/PostOptionByClassListDataItems
 */
class PostOptionByClassListDataItems {
    /**
     * Constructs a new <code>PostOptionByClassListDataItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostOptionByClassListDataItems
     */
    constructor() { 
        
        PostOptionByClassListDataItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListDataItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListDataItems} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListDataItems} The populated <code>PostOptionByClassListDataItems</code> instance.
     */
 ...
 * @member {String} id
 */
PostOptionByClassListDataItems.prototype['id'] = undefined;

/**
 * @member {module:model/PostOptionByClassListDataItemsInstrument} instrument
 */
PostOptionByClassListDataItems.prototype['instrument'] = undefined;

/**
 * Open positions of the option.
 * @member {Number} openInterest
 */
PostOptionByClassListDataItems.prototype['openInterest'] = undefined;

/**
 * @member {module:model/PostOptionByClassListDataItemsKeyFigures} keyFigures
 */
PostOptionByClassListDataItems.prototype['keyFigures'] = undefined;
...
export default PostOptionByClassListDataItems;
