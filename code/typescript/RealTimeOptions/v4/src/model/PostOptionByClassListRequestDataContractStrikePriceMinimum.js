...
/**
 * The PostOptionByClassListRequestDataContractStrikePriceMinimum model module.
 * @module model/PostOptionByClassListRequestDataContractStrikePriceMinimum
 */
class PostOptionByClassListRequestDataContractStrikePriceMinimum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContractStrikePriceMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassListRequestDataContractStrikePriceMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataContractStrikePriceMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContractStrikePriceMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContractStrikePriceMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContractStrikePriceMinimum} The populated <code>PostOptionByClassListRequestDataContractStrikePriceMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataContractStrikePriceMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataContractStrikePriceMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataContractStrikePriceMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataContractStrikePriceMinimum;
