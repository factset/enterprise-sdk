...
import InlineResponse2004DataPricesAsk from './InlineResponse2004DataPricesAsk';

/**
 * The InlineResponse2004DataPrices model module.
 * @module model/InlineResponse2004DataPrices
 */
class InlineResponse2004DataPrices {
    /**
     * Constructs a new <code>InlineResponse2004DataPrices</code>.
     * Prices of the option as used for the calculation.
     * @alias module:model/InlineResponse2004DataPrices
     */
    constructor() { 
        
        InlineResponse2004DataPrices.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2004DataPrices</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2004DataPrices} obj Optional instance to populate.
     * @return {module:model/InlineResponse2004DataPrices} The populated <code>InlineResponse2004DataPrices</code> instance.
     */
...
/**
 * @member {module:model/InlineResponse2004DataPricesAsk} ask
 */
InlineResponse2004DataPrices.prototype['ask'] = undefined;
...
export default InlineResponse2004DataPrices;
