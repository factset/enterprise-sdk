...
/**
 * The PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate
 */
class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate</code>.
     * Date range of the maturity date.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate
    ...
    constructor(start, end) { 
        ...
        PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate.initialize(this, start, end);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate} The populated <code>PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate();
 ...
 * @member {Date} start
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate.prototype['start'] = undefined;
 ...
 * @member {Date} end
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate.prototype['end'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate;
