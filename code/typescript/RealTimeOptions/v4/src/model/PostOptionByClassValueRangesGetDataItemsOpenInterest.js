...
/**
 * The PostOptionByClassValueRangesGetDataItemsOpenInterest model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsOpenInterest
 */
class PostOptionByClassValueRangesGetDataItemsOpenInterest {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsOpenInterest</code>.
     * Value range of the open positions.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsOpenInterest
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsOpenInterest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsOpenInterest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsOpenInterest} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsOpenInterest} The populated <code>PostOptionByClassValueRangesGetDataItemsOpenInterest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsOpenInterest();
 ...
 */
PostOptionByClassValueRangesGetDataItemsOpenInterest.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsOpenInterest.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsOpenInterest;
