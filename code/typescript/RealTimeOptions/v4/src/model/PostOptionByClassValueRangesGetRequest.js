...
import PostOptionByClassValueRangesGetRequestData from './PostOptionByClassValueRangesGetRequestData';
import PostOptionByClassValueRangesGetRequestMeta from './PostOptionByClassValueRangesGetRequestMeta';

/**
 * The PostOptionByClassValueRangesGetRequest model module.
 * @module model/PostOptionByClassValueRangesGetRequest
 */
class PostOptionByClassValueRangesGetRequest {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequest</code>.
     * Request Body
     * @alias module:model/PostOptionByClassValueRangesGetRequest
     * @param data {module:model/PostOptionByClassValueRangesGetRequestData} 
     */
    constructor(data) { 
        
        PostOptionByClassValueRangesGetRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequest} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequest} The populated <code>PostOptionByClassValueRangesGetRequest</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestData} data
 */
PostOptionByClassValueRangesGetRequest.prototype['data'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestMeta} meta
 */
PostOptionByClassValueRangesGetRequest.prototype['meta'] = undefined;
...
export default PostOptionByClassValueRangesGetRequest;
