...
/**
 * The PostOptionByClassListRequestDataContractStrikePrice model module.
 * @module model/PostOptionByClassListRequestDataContractStrikePrice
 */
class PostOptionByClassListRequestDataContractStrikePrice {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContractStrikePrice</code>.
     * Value range of the strike price of the option.
     * @alias module:model/PostOptionByClassListRequestDataContractStrikePrice
     */
    constructor() { 
        
        PostOptionByClassListRequestDataContractStrikePrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContractStrikePrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContractStrikePrice} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContractStrikePrice} The populated <code>PostOptionByClassListRequestDataContractStrikePrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataContractStrikePrice();
 ...
 */
PostOptionByClassListRequestDataContractStrikePrice.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum} maximum
 */
PostOptionByClassListRequestDataContractStrikePrice.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataContractStrikePrice;
