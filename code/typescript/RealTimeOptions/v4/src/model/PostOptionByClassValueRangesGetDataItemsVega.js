...
/**
 * The PostOptionByClassValueRangesGetDataItemsVega model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsVega
 */
class PostOptionByClassValueRangesGetDataItemsVega {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsVega</code>.
     * Value range of the vega.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsVega
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsVega.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsVega</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsVega} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsVega} The populated <code>PostOptionByClassValueRangesGetDataItemsVega</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsVega();
 ...
 */
PostOptionByClassValueRangesGetDataItemsVega.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsVega.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsVega;
