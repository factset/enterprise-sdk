...
/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage();
 ...
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage;
