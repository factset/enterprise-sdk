...
/**
 * The PostOptionClassScreenerSearchRequestDataUnderlyingInstrument model module.
 * @module model/PostOptionClassScreenerSearchRequestDataUnderlyingInstrument
 */
class PostOptionClassScreenerSearchRequestDataUnderlyingInstrument {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataUnderlyingInstrument</code>.
     * Instrument of the underlying.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataUnderlyingInstrument
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataUnderlyingInstrument.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataUnderlyingInstrument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataUnderlyingInstrument} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataUnderlyingInstrument} The populated <code>PostOptionClassScreenerSearchRequestDataUnderlyingInstrument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataUnderlyingInstrument();
 ...
 * @member {String} id
 */
PostOptionClassScreenerSearchRequestDataUnderlyingInstrument.prototype['id'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataUnderlyingInstrument;
