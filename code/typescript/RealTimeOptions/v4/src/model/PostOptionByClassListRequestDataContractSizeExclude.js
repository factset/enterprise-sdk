...
/**
 * The PostOptionByClassListRequestDataContractSizeExclude model module.
 * @module model/PostOptionByClassListRequestDataContractSizeExclude
 */
class PostOptionByClassListRequestDataContractSizeExclude {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContractSizeExclude</code>.
     * Specifies the contract sizes an option may not have.
     * @alias module:model/PostOptionByClassListRequestDataContractSizeExclude
     */
    constructor() { 
        
        PostOptionByClassListRequestDataContractSizeExclude.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContractSizeExclude</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContractSizeExclude} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContractSizeExclude} The populated <code>PostOptionByClassListRequestDataContractSizeExclude</code> instance.
     */
 ...
 */
PostOptionByClassListRequestDataContractSizeExclude.prototype['values'] = undefined;
...
export default PostOptionByClassListRequestDataContractSizeExclude;
