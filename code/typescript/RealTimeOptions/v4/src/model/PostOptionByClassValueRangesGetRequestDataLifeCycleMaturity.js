...
import PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate from './PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate';

/**
 * The PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity
 */
class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity</code>.
     * Parameters related to the maturity.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity} The populated <code>PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate} date
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.prototype['date'] = undefined;

/**
 * Restricts the maturity interval of the option. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  
 * @member {Array.<module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.IntervalEnum>} interval
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.prototype['interval'] = undefined;
 ...
 * @readonly
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity['IntervalEnum'] = {
...
export default PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity;
