...
/**
 * The GetOptionGetDataTypeItems model module.
 * @module model/GetOptionGetDataTypeItems
 */
class GetOptionGetDataTypeItems {
    /**
     * Constructs a new <code>GetOptionGetDataTypeItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/GetOptionGetDataTypeItems
     */
    constructor() { 
        
        GetOptionGetDataTypeItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOptionGetDataTypeItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOptionGetDataTypeItems} obj Optional instance to populate.
     * @return {module:model/GetOptionGetDataTypeItems} The populated <code>GetOptionGetDataTypeItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOptionGetDataTypeItems();
 ...
 * @member {Number} id
 */
GetOptionGetDataTypeItems.prototype['id'] = undefined;

/**
 * Name of the instrument type.
 * @member {String} name
 */
GetOptionGetDataTypeItems.prototype['name'] = undefined;
...
export default GetOptionGetDataTypeItems;
