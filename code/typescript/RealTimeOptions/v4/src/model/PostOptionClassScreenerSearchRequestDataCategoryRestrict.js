...
/**
 * The PostOptionClassScreenerSearchRequestDataCategoryRestrict model module.
 * @module model/PostOptionClassScreenerSearchRequestDataCategoryRestrict
 */
class PostOptionClassScreenerSearchRequestDataCategoryRestrict {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataCategoryRestrict</code>.
     * Specifies the categories an option class may have.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataCategoryRestrict
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataCategoryRestrict.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataCategoryRestrict</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataCategoryRestrict} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataCategoryRestrict} The populated <code>PostOptionClassScreenerSearchRequestDataCategoryRestrict</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataCategoryRestrict();
 ...
 */
PostOptionClassScreenerSearchRequestDataCategoryRestrict.prototype['ids'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataCategoryRestrict;
