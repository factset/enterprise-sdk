...
/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresRho model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresRho
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresRho {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresRho</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresRho
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresRho.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresRho</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresRho} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresRho} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresRho</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresRho();
 ...
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresRho.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresRho.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresRho;
