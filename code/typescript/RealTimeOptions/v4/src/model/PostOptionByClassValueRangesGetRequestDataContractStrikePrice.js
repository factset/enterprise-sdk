...
/**
 * The PostOptionByClassValueRangesGetRequestDataContractStrikePrice model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataContractStrikePrice
 */
class PostOptionByClassValueRangesGetRequestDataContractStrikePrice {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataContractStrikePrice</code>.
     * Value range of the strike price of the option.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePrice
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataContractStrikePrice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataContractStrikePrice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePrice} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePrice} The populated <code>PostOptionByClassValueRangesGetRequestDataContractStrikePrice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataContractStrikePrice();
 ...
 */
PostOptionByClassValueRangesGetRequestDataContractStrikePrice.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataContractStrikePrice.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataContractStrikePrice;
