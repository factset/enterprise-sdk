...
/**
 * The InlineResponse200DataLifeCycleDelivery model module.
 * @module model/InlineResponse200DataLifeCycleDelivery
 */
class InlineResponse200DataLifeCycleDelivery {
    /**
     * Constructs a new <code>InlineResponse200DataLifeCycleDelivery</code>.
     * Date on which the underlying asset or respectively the cash value of the underlying is finally settled.
     * @alias module:model/InlineResponse200DataLifeCycleDelivery
     */
    constructor() { 
        
        InlineResponse200DataLifeCycleDelivery.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataLifeCycleDelivery</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataLifeCycleDelivery} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataLifeCycleDelivery} The populated <code>InlineResponse200DataLifeCycleDelivery</code> instance.
     */
 ...
 * @member {Date} date
 */
InlineResponse200DataLifeCycleDelivery.prototype['date'] = undefined;
...
export default InlineResponse200DataLifeCycleDelivery;
