...
/**
 * The InlineResponse200DataMarket model module.
 * @module model/InlineResponse200DataMarket
 */
class InlineResponse200DataMarket {
    /**
     * Constructs a new <code>InlineResponse200DataMarket</code>.
     * Market of the option.
     * @alias module:model/InlineResponse200DataMarket
     */
    constructor() { 
        
        InlineResponse200DataMarket.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataMarket</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataMarket} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataMarket} The populated <code>InlineResponse200DataMarket</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataMarket();
 ...
 * @member {Number} id
 */
InlineResponse200DataMarket.prototype['id'] = undefined;

/**
 * Name of the market.
 * @member {String} name
 */
InlineResponse200DataMarket.prototype['name'] = undefined;
...
export default InlineResponse200DataMarket;
