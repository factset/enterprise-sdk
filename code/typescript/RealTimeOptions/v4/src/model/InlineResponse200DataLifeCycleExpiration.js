...
/**
 * The InlineResponse200DataLifeCycleExpiration model module.
 * @module model/InlineResponse200DataLifeCycleExpiration
 */
class InlineResponse200DataLifeCycleExpiration {
    /**
     * Constructs a new <code>InlineResponse200DataLifeCycleExpiration</code>.
     ...
     * @alias module:model/InlineResponse200DataLifeCycleExpiration
     */
    constructor() { 
        
        InlineResponse200DataLifeCycleExpiration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataLifeCycleExpiration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataLifeCycleExpiration} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataLifeCycleExpiration} The populated <code>InlineResponse200DataLifeCycleExpiration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataLifeCycleExpiration();
 ...
 * @member {Number} month
 */
InlineResponse200DataLifeCycleExpiration.prototype['month'] = undefined;

/**
 * Year of the option's expiration.
 * @member {Number} year
 */
InlineResponse200DataLifeCycleExpiration.prototype['year'] = undefined;
...
export default InlineResponse200DataLifeCycleExpiration;
