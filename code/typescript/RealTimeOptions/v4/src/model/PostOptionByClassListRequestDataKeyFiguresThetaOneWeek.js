...
/**
 * The PostOptionByClassListRequestDataKeyFiguresThetaOneWeek model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresThetaOneWeek
 */
class PostOptionByClassListRequestDataKeyFiguresThetaOneWeek {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresThetaOneWeek</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresThetaOneWeek
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresThetaOneWeek.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresThetaOneWeek</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresThetaOneWeek} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresThetaOneWeek} The populated <code>PostOptionByClassListRequestDataKeyFiguresThetaOneWeek</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresThetaOneWeek();
 ...
 */
PostOptionByClassListRequestDataKeyFiguresThetaOneWeek.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresThetaOneWeek.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresThetaOneWeek;
