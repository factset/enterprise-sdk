...
/**
 * The PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing model module.
 * @module model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing
 */
class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing</code>.
     * Listing-level identifiers.
     * @alias module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing} The populated <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing();
 ...
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.prototype['permanentIdentifier'] = undefined;
 ...
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.prototype['tickerExchange'] = undefined;
 ...
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing.prototype['isPrimary'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing;
