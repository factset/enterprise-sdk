...
/**
 * The PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum
 */
class PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum} The populated <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum;
