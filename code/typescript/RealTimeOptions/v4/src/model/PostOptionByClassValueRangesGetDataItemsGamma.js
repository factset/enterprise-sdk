...
/**
 * The PostOptionByClassValueRangesGetDataItemsGamma model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsGamma
 */
class PostOptionByClassValueRangesGetDataItemsGamma {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsGamma</code>.
     * Value range of the gamma.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsGamma
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsGamma.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsGamma</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsGamma} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsGamma} The populated <code>PostOptionByClassValueRangesGetDataItemsGamma</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsGamma();
 ...
 */
PostOptionByClassValueRangesGetDataItemsGamma.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsGamma.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsGamma;
