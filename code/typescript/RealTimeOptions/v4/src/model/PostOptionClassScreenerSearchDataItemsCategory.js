...
/**
 * The PostOptionClassScreenerSearchDataItemsCategory model module.
 * @module model/PostOptionClassScreenerSearchDataItemsCategory
 */
class PostOptionClassScreenerSearchDataItemsCategory {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsCategory</code>.
     * Category as defined by FactSet (see MDG category system 18).
     * @alias module:model/PostOptionClassScreenerSearchDataItemsCategory
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsCategory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsCategory} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsCategory} The populated <code>PostOptionClassScreenerSearchDataItemsCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchDataItemsCategory();
 ...
 * @member {Number} id
 */
PostOptionClassScreenerSearchDataItemsCategory.prototype['id'] = undefined;

/**
 * Name of the category.
 * @member {String} name
 */
PostOptionClassScreenerSearchDataItemsCategory.prototype['name'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsCategory;
