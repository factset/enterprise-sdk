...
import PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum from './PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum';

/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresVega model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresVega
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresVega {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresVega</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresVega
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresVega.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresVega</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresVega} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresVega} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresVega</code> instance.
     */
 ...
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresVega.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresVega.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresVega;
