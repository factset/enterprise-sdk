...
import PostOptionByClassListRequestDataKeyFiguresRhoMinimum from './PostOptionByClassListRequestDataKeyFiguresRhoMinimum';

/**
 * The PostOptionByClassListRequestDataKeyFiguresRho model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresRho
 */
class PostOptionByClassListRequestDataKeyFiguresRho {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresRho</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresRho
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresRho.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresRho</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresRho} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresRho} The populated <code>PostOptionByClassListRequestDataKeyFiguresRho</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresRho();

            if (data.hasOwnProperty('minimum')) {
                obj['minimum'] = PostOptionByClassListRequestDataKeyFiguresRhoMinimum.constructFromObject(data['minimum']);
            }
...
/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresRhoMinimum} minimum
 */
PostOptionByClassListRequestDataKeyFiguresRho.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresRho.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresRho;
