...
/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum;
