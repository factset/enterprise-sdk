...
import PostOptionClassScreenerSearchRequestDataUnderlyingInstrument from './PostOptionClassScreenerSearchRequestDataUnderlyingInstrument';
import PostOptionClassScreenerSearchRequestDataUnderlyingNotation from './PostOptionClassScreenerSearchRequestDataUnderlyingNotation';

/**
 * The PostOptionClassScreenerSearchRequestDataUnderlying model module.
 * @module model/PostOptionClassScreenerSearchRequestDataUnderlying
 */
class PostOptionClassScreenerSearchRequestDataUnderlying {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataUnderlying</code>.
     * Underlying selection.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataUnderlying
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataUnderlying.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataUnderlying</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataUnderlying} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataUnderlying} The populated <code>PostOptionClassScreenerSearchRequestDataUnderlying</code> instance.
     */
...
/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataUnderlyingInstrument} instrument
 */
PostOptionClassScreenerSearchRequestDataUnderlying.prototype['instrument'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataUnderlyingNotation} notation
 */
PostOptionClassScreenerSearchRequestDataUnderlying.prototype['notation'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataUnderlying;
