...
/**
 * The PostOptionByClassListRequestDataContractStrikePriceMaximum model module.
 * @module model/PostOptionByClassListRequestDataContractStrikePriceMaximum
 */
class PostOptionByClassListRequestDataContractStrikePriceMaximum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContractStrikePriceMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataContractStrikePriceMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContractStrikePriceMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum} The populated <code>PostOptionByClassListRequestDataContractStrikePriceMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataContractStrikePriceMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataContractStrikePriceMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataContractStrikePriceMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataContractStrikePriceMaximum;
