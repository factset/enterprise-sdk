...
/**
 * The PostOptionByClassListRequestDataKeyFiguresRhoMinimum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresRhoMinimum
 */
class PostOptionByClassListRequestDataKeyFiguresRhoMinimum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresRhoMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresRhoMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresRhoMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresRhoMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresRhoMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresRhoMinimum} The populated <code>PostOptionByClassListRequestDataKeyFiguresRhoMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresRhoMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresRhoMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresRhoMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresRhoMinimum;
