...
/**
 * The InlineResponse200DataSettlementCurrency model module.
 * @module model/InlineResponse200DataSettlementCurrency
 */
class InlineResponse200DataSettlementCurrency {
    /**
     * Constructs a new <code>InlineResponse200DataSettlementCurrency</code>.
     * Main or fractional currency of the settlement price. See endpoint &#x60;/basic/value-unit/currency/list&#x60; for possible values.
     * @alias module:model/InlineResponse200DataSettlementCurrency
     */
    constructor() { 
        
        InlineResponse200DataSettlementCurrency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataSettlementCurrency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataSettlementCurrency} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataSettlementCurrency} The populated <code>InlineResponse200DataSettlementCurrency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataSettlementCurrency();
 ...
 * @member {Number} id
 */
InlineResponse200DataSettlementCurrency.prototype['id'] = undefined;

/**
 * Code of the currency.
 * @member {String} code
 */
InlineResponse200DataSettlementCurrency.prototype['code'] = undefined;
...
export default InlineResponse200DataSettlementCurrency;
