...
import PostOptionByClassListRequestDataFilterValidation from './PostOptionByClassListRequestDataFilterValidation';

/**
 * The PostOptionByClassListRequestDataFilter model module.
 * @module model/PostOptionByClassListRequestDataFilter
 */
class PostOptionByClassListRequestDataFilter {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataFilter</code>.
     * Criteria that filter the items in the response list; only items that match all of the criteria are returned.
     * @alias module:model/PostOptionByClassListRequestDataFilter
     */
    constructor() { 
        
        PostOptionByClassListRequestDataFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataFilter} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataFilter} The populated <code>PostOptionByClassListRequestDataFilter</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassListRequestDataFilterValidation} validation
 */
PostOptionByClassListRequestDataFilter.prototype['validation'] = undefined;
...
export default PostOptionByClassListRequestDataFilter;
