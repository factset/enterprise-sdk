...
/**
 * The InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity model module.
 * @module model/InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity
 */
class InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity {
    /**
     * Constructs a new <code>InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity</code>.
     * Security-level identifier.
     * @alias module:model/InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity
     */
    constructor() { 
        
        InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity} The populated <code>InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity();
 ...
 */
InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity.prototype['permanentIdentifier'] = undefined;
...
export default InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity;
