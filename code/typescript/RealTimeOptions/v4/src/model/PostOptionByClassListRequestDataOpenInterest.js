...
/**
 * The PostOptionByClassListRequestDataOpenInterest model module.
 * @module model/PostOptionByClassListRequestDataOpenInterest
 */
class PostOptionByClassListRequestDataOpenInterest {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataOpenInterest</code>.
     * Value range of the open positions.
     * @alias module:model/PostOptionByClassListRequestDataOpenInterest
     */
    constructor() { 
        
        PostOptionByClassListRequestDataOpenInterest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataOpenInterest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataOpenInterest} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataOpenInterest} The populated <code>PostOptionByClassListRequestDataOpenInterest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataOpenInterest();
 ...
 */
PostOptionByClassListRequestDataOpenInterest.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataOpenInterestMaximum} maximum
 */
PostOptionByClassListRequestDataOpenInterest.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataOpenInterest;
