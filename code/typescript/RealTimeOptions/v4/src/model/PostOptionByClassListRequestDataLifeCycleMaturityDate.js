...
/**
 * The PostOptionByClassListRequestDataLifeCycleMaturityDate model module.
 * @module model/PostOptionByClassListRequestDataLifeCycleMaturityDate
 */
class PostOptionByClassListRequestDataLifeCycleMaturityDate {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataLifeCycleMaturityDate</code>.
     * Date range of the maturity date.
     * @alias module:model/PostOptionByClassListRequestDataLifeCycleMaturityDate
    ...
    constructor(start, end) { 
        ...
        PostOptionByClassListRequestDataLifeCycleMaturityDate.initialize(this, start, end);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataLifeCycleMaturityDate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataLifeCycleMaturityDate} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataLifeCycleMaturityDate} The populated <code>PostOptionByClassListRequestDataLifeCycleMaturityDate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataLifeCycleMaturityDate();
 ...
 * @member {Date} start
 */
PostOptionByClassListRequestDataLifeCycleMaturityDate.prototype['start'] = undefined;
 ...
 * @member {Date} end
 */
PostOptionByClassListRequestDataLifeCycleMaturityDate.prototype['end'] = undefined;
...
export default PostOptionByClassListRequestDataLifeCycleMaturityDate;
