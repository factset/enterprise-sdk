...
import PostOptionByClassValueRangesGetRequestDataFilterValidationPrice from './PostOptionByClassValueRangesGetRequestDataFilterValidationPrice';

/**
 * The PostOptionByClassValueRangesGetRequestDataFilterValidation model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataFilterValidation
 */
class PostOptionByClassValueRangesGetRequestDataFilterValidation {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataFilterValidation</code>.
     * Validation parameters.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataFilterValidation
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataFilterValidation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataFilterValidation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidation} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidation} The populated <code>PostOptionByClassValueRangesGetRequestDataFilterValidation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataFilterValidation();

            if (data.hasOwnProperty('onlyActive')) {
                obj['onlyActive'] = ApiClient.convertToType(data['onlyActive'], 'Boolean');
            }
            if (data.hasOwnProperty('price')) {
                obj['price'] = PostOptionByClassValueRangesGetRequestDataFilterValidationPrice.constructFromObject(data['price']);
            }
        }
        return obj;
    }
 ...
 */
PostOptionByClassValueRangesGetRequestDataFilterValidation.prototype['onlyActive'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidationPrice} price
 */
PostOptionByClassValueRangesGetRequestDataFilterValidation.prototype['price'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataFilterValidation;
