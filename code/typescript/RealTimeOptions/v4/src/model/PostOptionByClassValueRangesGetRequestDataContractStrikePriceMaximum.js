...
/**
 * The PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum
 */
class PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum} The populated <code>PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum;
