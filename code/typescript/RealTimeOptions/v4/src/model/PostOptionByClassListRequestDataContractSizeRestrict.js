...
/**
 * The PostOptionByClassListRequestDataContractSizeRestrict model module.
 * @module model/PostOptionByClassListRequestDataContractSizeRestrict
 */
class PostOptionByClassListRequestDataContractSizeRestrict {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContractSizeRestrict</code>.
     * Specifies the contract sizes an option may have.
     * @alias module:model/PostOptionByClassListRequestDataContractSizeRestrict
     */
    constructor() { 
        
        PostOptionByClassListRequestDataContractSizeRestrict.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContractSizeRestrict</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContractSizeRestrict} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContractSizeRestrict} The populated <code>PostOptionByClassListRequestDataContractSizeRestrict</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataContractSizeRestrict();
 ...
 */
PostOptionByClassListRequestDataContractSizeRestrict.prototype['values'] = undefined;
...
export default PostOptionByClassListRequestDataContractSizeRestrict;
