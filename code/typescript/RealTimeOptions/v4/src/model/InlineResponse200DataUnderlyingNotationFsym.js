...
import InlineResponse200DataUnderlyingNotationFsymListing from './InlineResponse200DataUnderlyingNotationFsymListing';
import InlineResponse200DataUnderlyingNotationFsymRegional from './InlineResponse200DataUnderlyingNotationFsymRegional';

/**
 * The InlineResponse200DataUnderlyingNotationFsym model module.
 * @module model/InlineResponse200DataUnderlyingNotationFsym
 */
class InlineResponse200DataUnderlyingNotationFsym {
    /**
     * Constructs a new <code>InlineResponse200DataUnderlyingNotationFsym</code>.
     * Notation-level FactSet identifiers of the financial instrument used primarily in FactSet products other than the MDG.
     * @alias module:model/InlineResponse200DataUnderlyingNotationFsym
     */
    constructor() { 
        
        InlineResponse200DataUnderlyingNotationFsym.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataUnderlyingNotationFsym</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataUnderlyingNotationFsym} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataUnderlyingNotationFsym} The populated <code>InlineResponse200DataUnderlyingNotationFsym</code> instance.
     */
...
/**
 * @member {module:model/InlineResponse200DataUnderlyingNotationFsymListing} listing
 */
InlineResponse200DataUnderlyingNotationFsym.prototype['listing'] = undefined;

/**
 * @member {module:model/InlineResponse200DataUnderlyingNotationFsymRegional} regional
 */
InlineResponse200DataUnderlyingNotationFsym.prototype['regional'] = undefined;
...
export default InlineResponse200DataUnderlyingNotationFsym;
