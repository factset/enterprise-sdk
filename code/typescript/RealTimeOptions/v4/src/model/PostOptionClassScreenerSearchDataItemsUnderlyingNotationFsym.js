...
import PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing from './PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing';
import PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional from './PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional';

/**
 * The PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym model module.
 * @module model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym
 */
class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym</code>.
     * Notation-level FactSet identifiers of the financial instrument used primarily in FactSet products other than the MDG.
     * @alias module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym} The populated <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym</code> instance.
     */
...
/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing} listing
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym.prototype['listing'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional} regional
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym.prototype['regional'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym;
