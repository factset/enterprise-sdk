...
/**
 * The PostOptionByClassListRequestDataKeyFiguresDelta model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresDelta
 */
class PostOptionByClassListRequestDataKeyFiguresDelta {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresDelta</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresDelta
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresDelta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresDelta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresDelta} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresDelta} The populated <code>PostOptionByClassListRequestDataKeyFiguresDelta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresDelta();
 ...
 */
PostOptionByClassListRequestDataKeyFiguresDelta.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresDelta.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresDelta;
