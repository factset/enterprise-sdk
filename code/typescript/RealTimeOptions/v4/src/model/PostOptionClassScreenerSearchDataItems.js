...
import PostOptionClassScreenerSearchDataItemsCategory from './PostOptionClassScreenerSearchDataItemsCategory';
import PostOptionClassScreenerSearchDataItemsCurrency from './PostOptionClassScreenerSearchDataItemsCurrency';
import PostOptionClassScreenerSearchDataItemsMarket from './PostOptionClassScreenerSearchDataItemsMarket';
import PostOptionClassScreenerSearchDataItemsUnderlying from './PostOptionClassScreenerSearchDataItemsUnderlying';

/**
 * The PostOptionClassScreenerSearchDataItems model module.
 * @module model/PostOptionClassScreenerSearchDataItems
 */
class PostOptionClassScreenerSearchDataItems {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostOptionClassScreenerSearchDataItems
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItems} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItems} The populated <code>PostOptionClassScreenerSearchDataItems</code> instance.
     */
 ...
 * @member {String} id
 */
PostOptionClassScreenerSearchDataItems.prototype['id'] = undefined;

/**
 * Symbol of the option class, as defined by its market.
 * @member {String} symbol
 */
PostOptionClassScreenerSearchDataItems.prototype['symbol'] = undefined;

/**
 * ISIN of the option class.
 * @member {String} isin
 */
PostOptionClassScreenerSearchDataItems.prototype['isin'] = undefined;

/**
 * Name of the option class.
 * @member {String} name
 */
PostOptionClassScreenerSearchDataItems.prototype['name'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsMarket} market
 */
PostOptionClassScreenerSearchDataItems.prototype['market'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsUnderlying} underlying
 */
PostOptionClassScreenerSearchDataItems.prototype['underlying'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsCurrency} currency
 */
PostOptionClassScreenerSearchDataItems.prototype['currency'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsCategory} category
 */
PostOptionClassScreenerSearchDataItems.prototype['category'] = undefined;
...
export default PostOptionClassScreenerSearchDataItems;
