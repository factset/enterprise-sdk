...
/**
 * The PostOptionByClassListRequestDataClass model module.
 * @module model/PostOptionByClassListRequestDataClass
 */
class PostOptionByClassListRequestDataClass {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataClass</code>.
     * A product group of options from the same exchange and with the same underlying.
     * @alias module:model/PostOptionByClassListRequestDataClass
     * @param id {String} Identifier of the option class.
     */
    constructor(id) { 
        
        PostOptionByClassListRequestDataClass.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataClass</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataClass} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataClass} The populated <code>PostOptionByClassListRequestDataClass</code> instance.
     */
 ...
 * @member {String} id
 */
PostOptionByClassListRequestDataClass.prototype['id'] = undefined;
...
export default PostOptionByClassListRequestDataClass;
