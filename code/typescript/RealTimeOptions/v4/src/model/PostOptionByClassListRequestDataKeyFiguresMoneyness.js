...
/**
 * The PostOptionByClassListRequestDataKeyFiguresMoneyness model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresMoneyness
 */
class PostOptionByClassListRequestDataKeyFiguresMoneyness {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresMoneyness</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresMoneyness
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresMoneyness.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresMoneyness</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresMoneyness} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresMoneyness} The populated <code>PostOptionByClassListRequestDataKeyFiguresMoneyness</code> instance.
     */
 ...
 */
PostOptionByClassListRequestDataKeyFiguresMoneyness.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresMoneyness.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresMoneyness;
