...
/**
 * The PostOptionByClassValueRangesGetRequestDataOpenInterest model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataOpenInterest
 */
class PostOptionByClassValueRangesGetRequestDataOpenInterest {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataOpenInterest</code>.
     * Value range of the open positions.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataOpenInterest
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataOpenInterest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataOpenInterest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataOpenInterest} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataOpenInterest} The populated <code>PostOptionByClassValueRangesGetRequestDataOpenInterest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataOpenInterest();
 ...
 */
PostOptionByClassValueRangesGetRequestDataOpenInterest.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataOpenInterestMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataOpenInterest.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataOpenInterest;
