...
/**
 * The PostOptionClassScreenerSearchDataItemsCurrency model module.
 * @module model/PostOptionClassScreenerSearchDataItemsCurrency
 */
class PostOptionClassScreenerSearchDataItemsCurrency {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsCurrency</code>.
     * Main or fractional currency of the option class. See endpoint &#x60;/basic/value-unit/currency/list&#x60; for possible values.
     * @alias module:model/PostOptionClassScreenerSearchDataItemsCurrency
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsCurrency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsCurrency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsCurrency} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsCurrency} The populated <code>PostOptionClassScreenerSearchDataItemsCurrency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchDataItemsCurrency();
 ...
 * @member {Number} id
 */
PostOptionClassScreenerSearchDataItemsCurrency.prototype['id'] = undefined;

/**
 * Code of the currency.
 * @member {String} code
 */
PostOptionClassScreenerSearchDataItemsCurrency.prototype['code'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsCurrency;
