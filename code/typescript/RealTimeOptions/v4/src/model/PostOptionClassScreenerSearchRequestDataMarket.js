...
import PostOptionClassScreenerSearchRequestDataMarketExclude from './PostOptionClassScreenerSearchRequestDataMarketExclude';
import PostOptionClassScreenerSearchRequestDataMarketRestrict from './PostOptionClassScreenerSearchRequestDataMarketRestrict';

/**
 * The PostOptionClassScreenerSearchRequestDataMarket model module.
 * @module model/PostOptionClassScreenerSearchRequestDataMarket
 */
class PostOptionClassScreenerSearchRequestDataMarket {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataMarket</code>.
     * Market-related class selection. See endpoint &#x60;/basic/market/list&#x60; for valid values.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataMarket
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataMarket.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataMarket</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataMarket} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataMarket} The populated <code>PostOptionClassScreenerSearchRequestDataMarket</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataMarket();

            if (data.hasOwnProperty('restrict')) {
                obj['restrict'] = PostOptionClassScreenerSearchRequestDataMarketRestrict.constructFromObject(data['restrict']);
            }
            if (data.hasOwnProperty('exclude')) {
                obj['exclude'] = PostOptionClassScreenerSearchRequestDataMarketExclude.constructFromObject(data['exclude']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataMarketRestrict} restrict
 */
PostOptionClassScreenerSearchRequestDataMarket.prototype['restrict'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataMarketExclude} exclude
 */
PostOptionClassScreenerSearchRequestDataMarket.prototype['exclude'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataMarket;
