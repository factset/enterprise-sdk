...
import PostOptionByClassListRequestDataClass from './PostOptionByClassListRequestDataClass';
import PostOptionByClassListRequestDataContract from './PostOptionByClassListRequestDataContract';
import PostOptionByClassListRequestDataContractSize from './PostOptionByClassListRequestDataContractSize';
import PostOptionByClassListRequestDataFilter from './PostOptionByClassListRequestDataFilter';
import PostOptionByClassListRequestDataKeyFigures from './PostOptionByClassListRequestDataKeyFigures';
import PostOptionByClassListRequestDataLifeCycle from './PostOptionByClassListRequestDataLifeCycle';
import PostOptionByClassListRequestDataOpenInterest from './PostOptionByClassListRequestDataOpenInterest';

/**
 * The PostOptionByClassListRequestData model module.
 * @module model/PostOptionByClassListRequestData
 */
class PostOptionByClassListRequestData {
    /**
     * Constructs a new <code>PostOptionByClassListRequestData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PostOptionByClassListRequestData
     */
    constructor() { 
        
        PostOptionByClassListRequestData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestData} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestData} The populated <code>PostOptionByClassListRequestData</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassListRequestDataClass} class
 */
PostOptionByClassListRequestData.prototype['class'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataFilter} filter
 */
PostOptionByClassListRequestData.prototype['filter'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContract} contract
 */
PostOptionByClassListRequestData.prototype['contract'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataLifeCycle} lifeCycle
 */
PostOptionByClassListRequestData.prototype['lifeCycle'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractSize} contractSize
 */
PostOptionByClassListRequestData.prototype['contractSize'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataOpenInterest} openInterest
 */
PostOptionByClassListRequestData.prototype['openInterest'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFigures} keyFigures
 */
PostOptionByClassListRequestData.prototype['keyFigures'] = undefined;
...
export default PostOptionByClassListRequestData;
