...
/**
 * The PostOptionByClassValueRangesGetRequestMeta model module.
 * @module model/PostOptionByClassValueRangesGetRequestMeta
 */
class PostOptionByClassValueRangesGetRequestMeta {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestMeta</code>.
     * The meta member contains the meta information of the request.
     * @alias module:model/PostOptionByClassValueRangesGetRequestMeta
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestMeta} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestMeta} The populated <code>PostOptionByClassValueRangesGetRequestMeta</code> instance.
     */
 ...
 */
PostOptionByClassValueRangesGetRequestMeta.prototype['attributes'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestMeta;
