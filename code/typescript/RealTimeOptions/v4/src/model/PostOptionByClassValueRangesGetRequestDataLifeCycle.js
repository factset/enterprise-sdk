...
import PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration from './PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration';
import PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity from './PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity';

/**
 * The PostOptionByClassValueRangesGetRequestDataLifeCycle model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataLifeCycle
 */
class PostOptionByClassValueRangesGetRequestDataLifeCycle {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataLifeCycle</code>.
     * Parameters related to important dates.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataLifeCycle
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataLifeCycle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataLifeCycle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycle} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycle} The populated <code>PostOptionByClassValueRangesGetRequestDataLifeCycle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataLifeCycle();

            if (data.hasOwnProperty('maturity')) {
                obj['maturity'] = PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity.constructFromObject(data['maturity']);
            }
            if (data.hasOwnProperty('expiration')) {
                obj['expiration'] = PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration.constructFromObject(data['expiration']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity} maturity
 */
PostOptionByClassValueRangesGetRequestDataLifeCycle.prototype['maturity'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration} expiration
 */
PostOptionByClassValueRangesGetRequestDataLifeCycle.prototype['expiration'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataLifeCycle;
