...
/**
 * The PostOptionByClassListDataItemsInstrumentLifeCycleMaturity model module.
 * @module model/PostOptionByClassListDataItemsInstrumentLifeCycleMaturity
 */
class PostOptionByClassListDataItemsInstrumentLifeCycleMaturity {
    /**
     * Constructs a new <code>PostOptionByClassListDataItemsInstrumentLifeCycleMaturity</code>.
     * Maturity data.
     * @alias module:model/PostOptionByClassListDataItemsInstrumentLifeCycleMaturity
     */
    constructor() { 
        
        PostOptionByClassListDataItemsInstrumentLifeCycleMaturity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListDataItemsInstrumentLifeCycleMaturity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListDataItemsInstrumentLifeCycleMaturity} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListDataItemsInstrumentLifeCycleMaturity} The populated <code>PostOptionByClassListDataItemsInstrumentLifeCycleMaturity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListDataItemsInstrumentLifeCycleMaturity();
 ...
 * @member {Date} date
 */
PostOptionByClassListDataItemsInstrumentLifeCycleMaturity.prototype['date'] = undefined;

/**
 * Maturity interval of the option. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  
 * @member {module:model/PostOptionByClassListDataItemsInstrumentLifeCycleMaturity.IntervalEnum} interval
 */
PostOptionByClassListDataItemsInstrumentLifeCycleMaturity.prototype['interval'] = undefined;
 ...
 * @readonly
 */
PostOptionByClassListDataItemsInstrumentLifeCycleMaturity['IntervalEnum'] = {
...
export default PostOptionByClassListDataItemsInstrumentLifeCycleMaturity;
