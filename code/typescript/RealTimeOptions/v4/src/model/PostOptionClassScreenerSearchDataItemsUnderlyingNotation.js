...
import InlineResponse200DataUnderlyingNotationInstrument from './InlineResponse200DataUnderlyingNotationInstrument';
import PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym from './PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym';

/**
 * The PostOptionClassScreenerSearchDataItemsUnderlyingNotation model module.
 * @module model/PostOptionClassScreenerSearchDataItemsUnderlyingNotation
 */
class PostOptionClassScreenerSearchDataItemsUnderlyingNotation {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotation</code>.
     * Notation of the underlying. If there is no notation for the underlying, the object is null.
     * @alias module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotation
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsUnderlyingNotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotation} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotation} The populated <code>PostOptionClassScreenerSearchDataItemsUnderlyingNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchDataItemsUnderlyingNotation();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('fsym')) {
                obj['fsym'] = PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym.constructFromObject(data['fsym']);
            }
 ...
 * @member {String} id
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotation.prototype['id'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym} fsym
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotation.prototype['fsym'] = undefined;

/**
 * @member {module:model/InlineResponse200DataUnderlyingNotationInstrument} instrument
 */
PostOptionClassScreenerSearchDataItemsUnderlyingNotation.prototype['instrument'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsUnderlyingNotation;
