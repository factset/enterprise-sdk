...
import PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum from './PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum';
import PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum from './PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum';

/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility();

            if (data.hasOwnProperty('minimum')) {
                obj['minimum'] = PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum.constructFromObject(data['minimum']);
            }
            if (data.hasOwnProperty('maximum')) {
                obj['maximum'] = PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum.constructFromObject(data['maximum']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum} minimum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility;
