...
import PostOptionByClassListRequestDataLifeCycleMaturityDate from './PostOptionByClassListRequestDataLifeCycleMaturityDate';

/**
 * The PostOptionByClassListRequestDataLifeCycleMaturity model module.
 * @module model/PostOptionByClassListRequestDataLifeCycleMaturity
 */
class PostOptionByClassListRequestDataLifeCycleMaturity {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataLifeCycleMaturity</code>.
     * Parameters related to the maturity.
     * @alias module:model/PostOptionByClassListRequestDataLifeCycleMaturity
     */
    constructor() { 
        
        PostOptionByClassListRequestDataLifeCycleMaturity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataLifeCycleMaturity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataLifeCycleMaturity} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataLifeCycleMaturity} The populated <code>PostOptionByClassListRequestDataLifeCycleMaturity</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassListRequestDataLifeCycleMaturityDate} date
 */
PostOptionByClassListRequestDataLifeCycleMaturity.prototype['date'] = undefined;

/**
 * Restricts the maturity interval of the option. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  
 * @member {Array.<module:model/PostOptionByClassListRequestDataLifeCycleMaturity.IntervalEnum>} interval
 */
PostOptionByClassListRequestDataLifeCycleMaturity.prototype['interval'] = undefined;
 ...
 * @readonly
 */
PostOptionByClassListRequestDataLifeCycleMaturity['IntervalEnum'] = {
...
export default PostOptionByClassListRequestDataLifeCycleMaturity;
