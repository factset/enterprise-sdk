...
/**
 * The PostOptionByClassListRequestDataKeyFiguresGammaMinimum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresGammaMinimum
 */
class PostOptionByClassListRequestDataKeyFiguresGammaMinimum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresGammaMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresGammaMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresGammaMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresGammaMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresGammaMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresGammaMinimum} The populated <code>PostOptionByClassListRequestDataKeyFiguresGammaMinimum</code> instance.
     */
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresGammaMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresGammaMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresGammaMinimum;
