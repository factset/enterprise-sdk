...
/**
 * The PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum
 */
class PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum} The populated <code>PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum;
