...
import PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration from './PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration';
import PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity from './PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity';

/**
 * The PostOptionByClassValueRangesGetDataItemsLifeCycle model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsLifeCycle
 */
class PostOptionByClassValueRangesGetDataItemsLifeCycle {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsLifeCycle</code>.
     * Values and value ranges related to important dates.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsLifeCycle
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsLifeCycle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsLifeCycle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycle} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycle} The populated <code>PostOptionByClassValueRangesGetDataItemsLifeCycle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsLifeCycle();

            if (data.hasOwnProperty('maturity')) {
                obj['maturity'] = PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity.constructFromObject(data['maturity']);
            }
            if (data.hasOwnProperty('expiration')) {
                obj['expiration'] = PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration.constructFromObject(data['expiration']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity} maturity
 */
PostOptionByClassValueRangesGetDataItemsLifeCycle.prototype['maturity'] = undefined;

/**
 * @member {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration} expiration
 */
PostOptionByClassValueRangesGetDataItemsLifeCycle.prototype['expiration'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsLifeCycle;
