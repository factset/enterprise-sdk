...
/**
 * The PostOptionByClassListRequestDataKeyFiguresOmegaMinimum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresOmegaMinimum
 */
class PostOptionByClassListRequestDataKeyFiguresOmegaMinimum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresOmegaMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresOmegaMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresOmegaMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMinimum} The populated <code>PostOptionByClassListRequestDataKeyFiguresOmegaMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresOmegaMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresOmegaMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresOmegaMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresOmegaMinimum;
