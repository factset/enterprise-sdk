...
import PostOptionByClassListRequestDataLifeCycleExpiration from './PostOptionByClassListRequestDataLifeCycleExpiration';
import PostOptionByClassListRequestDataLifeCycleMaturity from './PostOptionByClassListRequestDataLifeCycleMaturity';

/**
 * The PostOptionByClassListRequestDataLifeCycle model module.
 * @module model/PostOptionByClassListRequestDataLifeCycle
 */
class PostOptionByClassListRequestDataLifeCycle {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataLifeCycle</code>.
     * Parameters related to important dates.
     * @alias module:model/PostOptionByClassListRequestDataLifeCycle
     */
    constructor() { 
        
        PostOptionByClassListRequestDataLifeCycle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataLifeCycle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataLifeCycle} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataLifeCycle} The populated <code>PostOptionByClassListRequestDataLifeCycle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataLifeCycle();

            if (data.hasOwnProperty('maturity')) {
                obj['maturity'] = PostOptionByClassListRequestDataLifeCycleMaturity.constructFromObject(data['maturity']);
            }
            if (data.hasOwnProperty('expiration')) {
                obj['expiration'] = PostOptionByClassListRequestDataLifeCycleExpiration.constructFromObject(data['expiration']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassListRequestDataLifeCycleMaturity} maturity
 */
PostOptionByClassListRequestDataLifeCycle.prototype['maturity'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataLifeCycleExpiration} expiration
 */
PostOptionByClassListRequestDataLifeCycle.prototype['expiration'] = undefined;
...
export default PostOptionByClassListRequestDataLifeCycle;
