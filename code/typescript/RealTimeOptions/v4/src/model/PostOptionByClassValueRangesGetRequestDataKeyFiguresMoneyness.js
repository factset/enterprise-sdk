...
import PostOptionByClassListRequestDataOpenInterestMaximum from './PostOptionByClassListRequestDataOpenInterestMaximum';

/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness();

            if (data.hasOwnProperty('minimum')) {
                obj['minimum'] = PostOptionByClassListRequestDataKeyFiguresOmegaMinimum.constructFromObject(data['minimum']);
            }
            if (data.hasOwnProperty('maximum')) {
                obj['maximum'] = PostOptionByClassListRequestDataOpenInterestMaximum.constructFromObject(data['maximum']);
            }
        }
        return obj;
    }
 ...
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataOpenInterestMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness;
