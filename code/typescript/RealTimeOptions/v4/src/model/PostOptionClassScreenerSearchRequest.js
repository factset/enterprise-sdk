...
import PostOptionClassScreenerSearchRequestData from './PostOptionClassScreenerSearchRequestData';
import PostOptionClassScreenerSearchRequestMeta from './PostOptionClassScreenerSearchRequestMeta';

/**
 * The PostOptionClassScreenerSearchRequest model module.
 * @module model/PostOptionClassScreenerSearchRequest
 */
class PostOptionClassScreenerSearchRequest {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequest</code>.
     * Request Body
     * @alias module:model/PostOptionClassScreenerSearchRequest
     * @param data {module:model/PostOptionClassScreenerSearchRequestData} 
     */
    constructor(data) { 
        
        PostOptionClassScreenerSearchRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequest} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequest} The populated <code>PostOptionClassScreenerSearchRequest</code> instance.
     */
...
/**
 * @member {module:model/PostOptionClassScreenerSearchRequestData} data
 */
PostOptionClassScreenerSearchRequest.prototype['data'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestMeta} meta
 */
PostOptionClassScreenerSearchRequest.prototype['meta'] = undefined;
...
export default PostOptionClassScreenerSearchRequest;
