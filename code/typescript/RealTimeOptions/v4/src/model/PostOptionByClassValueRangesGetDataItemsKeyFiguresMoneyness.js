...
/**
 * The PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness
 */
class PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness</code>.
     * Value range of the moneyness.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness} The populated <code>PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness();
 ...
 */
PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness;
