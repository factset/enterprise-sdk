...
import PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate from './PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate';
import PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems from './PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems';

/**
 * The PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity
 */
class PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity</code>.
     * Ranges related to the maturity.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity} The populated <code>PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate} date
 */
PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity.prototype['date'] = undefined;

/**
 * Values related to the maturity interval.
 * @member {Array.<module:model/PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems>} interval
 */
PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity.prototype['interval'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity;
