...
/**
 * The PostOptionByClassValueRangesGetRequestDataContractSizeExclude model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataContractSizeExclude
 */
class PostOptionByClassValueRangesGetRequestDataContractSizeExclude {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataContractSizeExclude</code>.
     * Specifies the contract sizes an option may not have.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataContractSizeExclude
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataContractSizeExclude.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataContractSizeExclude</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataContractSizeExclude} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataContractSizeExclude} The populated <code>PostOptionByClassValueRangesGetRequestDataContractSizeExclude</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataContractSizeExclude();
 ...
 */
PostOptionByClassValueRangesGetRequestDataContractSizeExclude.prototype['values'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataContractSizeExclude;
