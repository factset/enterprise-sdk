...
import InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity from './InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity';

/**
 * The InlineResponse200DataUnderlyingNotationInstrumentFsym model module.
 * @module model/InlineResponse200DataUnderlyingNotationInstrumentFsym
 */
class InlineResponse200DataUnderlyingNotationInstrumentFsym {
    /**
     * Constructs a new <code>InlineResponse200DataUnderlyingNotationInstrumentFsym</code>.
     * Instrument-level FactSet identifier of the financial instrument used primarily in FactSet products other than the MDG.
     * @alias module:model/InlineResponse200DataUnderlyingNotationInstrumentFsym
     */
    constructor() { 
        
        InlineResponse200DataUnderlyingNotationInstrumentFsym.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataUnderlyingNotationInstrumentFsym</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataUnderlyingNotationInstrumentFsym} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataUnderlyingNotationInstrumentFsym} The populated <code>InlineResponse200DataUnderlyingNotationInstrumentFsym</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataUnderlyingNotationInstrumentFsym();

            if (data.hasOwnProperty('security')) {
                obj['security'] = InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity.constructFromObject(data['security']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity} security
 */
InlineResponse200DataUnderlyingNotationInstrumentFsym.prototype['security'] = undefined;
...
export default InlineResponse200DataUnderlyingNotationInstrumentFsym;
