...
import PostOptionByClassValueRangesGetDataItems from './PostOptionByClassValueRangesGetDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostOptionByClassValueRangesGetDataItems]);
            }
 ...
 * @member {Array.<module:model/PostOptionByClassValueRangesGetDataItems>} data
 */
