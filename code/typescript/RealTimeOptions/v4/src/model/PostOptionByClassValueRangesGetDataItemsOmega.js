...
/**
 * The PostOptionByClassValueRangesGetDataItemsOmega model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsOmega
 */
class PostOptionByClassValueRangesGetDataItemsOmega {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsOmega</code>.
     * Value range of the omega.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsOmega
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsOmega.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsOmega</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsOmega} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsOmega} The populated <code>PostOptionByClassValueRangesGetDataItemsOmega</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsOmega();
 ...
 */
PostOptionByClassValueRangesGetDataItemsOmega.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsOmega.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsOmega;
