...
/**
 * The PostOptionClassScreenerSearchRequestDataCategoryExclude model module.
 * @module model/PostOptionClassScreenerSearchRequestDataCategoryExclude
 */
class PostOptionClassScreenerSearchRequestDataCategoryExclude {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataCategoryExclude</code>.
     * Specifies the categories an option class may not have.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataCategoryExclude
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataCategoryExclude.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataCategoryExclude</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataCategoryExclude} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataCategoryExclude} The populated <code>PostOptionClassScreenerSearchRequestDataCategoryExclude</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataCategoryExclude();
 ...
 */
PostOptionClassScreenerSearchRequestDataCategoryExclude.prototype['ids'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataCategoryExclude;
