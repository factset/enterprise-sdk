...
/**
 * The PostOptionByClassListRequestDataOpenInterestMinimum model module.
 * @module model/PostOptionByClassListRequestDataOpenInterestMinimum
 */
class PostOptionByClassListRequestDataOpenInterestMinimum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataOpenInterestMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassListRequestDataOpenInterestMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataOpenInterestMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataOpenInterestMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataOpenInterestMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataOpenInterestMinimum} The populated <code>PostOptionByClassListRequestDataOpenInterestMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataOpenInterestMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataOpenInterestMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataOpenInterestMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataOpenInterestMinimum;
