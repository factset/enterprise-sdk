...
import PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum from './PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum';

/**
 * The PostOptionByClassListRequestDataKeyFiguresLeverage model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresLeverage
 */
class PostOptionByClassListRequestDataKeyFiguresLeverage {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresLeverage</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresLeverage
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresLeverage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresLeverage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresLeverage} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresLeverage} The populated <code>PostOptionByClassListRequestDataKeyFiguresLeverage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresLeverage();
 ...
 */
PostOptionByClassListRequestDataKeyFiguresLeverage.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresLeverage.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresLeverage;
