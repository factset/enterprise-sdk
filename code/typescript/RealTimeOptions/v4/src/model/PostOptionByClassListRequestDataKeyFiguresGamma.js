...
import PostOptionByClassListRequestDataContractStrikePriceMaximum from './PostOptionByClassListRequestDataContractStrikePriceMaximum';
import PostOptionByClassListRequestDataKeyFiguresGammaMinimum from './PostOptionByClassListRequestDataKeyFiguresGammaMinimum';

/**
 * The PostOptionByClassListRequestDataKeyFiguresGamma model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresGamma
 */
class PostOptionByClassListRequestDataKeyFiguresGamma {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresGamma</code>.
     ...
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresGamma
     */
    constructor() { 
        
        PostOptionByClassListRequestDataKeyFiguresGamma.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresGamma</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresGamma} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresGamma} The populated <code>PostOptionByClassListRequestDataKeyFiguresGamma</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresGamma();

            if (data.hasOwnProperty('minimum')) {
                obj['minimum'] = PostOptionByClassListRequestDataKeyFiguresGammaMinimum.constructFromObject(data['minimum']);
            }
            if (data.hasOwnProperty('maximum')) {
                obj['maximum'] = PostOptionByClassListRequestDataContractStrikePriceMaximum.constructFromObject(data['maximum']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresGammaMinimum} minimum
 */
PostOptionByClassListRequestDataKeyFiguresGamma.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractStrikePriceMaximum} maximum
 */
PostOptionByClassListRequestDataKeyFiguresGamma.prototype['maximum'] = undefined;
...
export default PostOptionByClassListRequestDataKeyFiguresGamma;
