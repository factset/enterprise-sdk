...
import PostOptionByClassValueRangesGetRequestDataFilterValidation from './PostOptionByClassValueRangesGetRequestDataFilterValidation';

/**
 * The PostOptionByClassValueRangesGetRequestDataFilter model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataFilter
 */
class PostOptionByClassValueRangesGetRequestDataFilter {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataFilter</code>.
     * Criteria that filter the items in the response list; only items that match all of the criteria are returned.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataFilter
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataFilter} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataFilter} The populated <code>PostOptionByClassValueRangesGetRequestDataFilter</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassValueRangesGetRequestDataFilterValidation} validation
 */
PostOptionByClassValueRangesGetRequestDataFilter.prototype['validation'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataFilter;
