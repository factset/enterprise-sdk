...
/**
 * The PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration
 */
class PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration</code>.
     * Parameters related to the expiration month and year.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration} The populated <code>PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration();
 ...
 * @member {Number} month
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration.prototype['month'] = undefined;

/**
 * Year of the option's expiration.
 * @member {Number} year
 */
PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration.prototype['year'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration;
