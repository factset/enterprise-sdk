...
import PostOptionByClassListDataItems from './PostOptionByClassListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostOptionByClassListDataItems]);
            }
...
/**
 * List of options.
 * @member {Array.<module:model/PostOptionByClassListDataItems>} data
 */
