...
/**
 * The PostOptionClassScreenerSearchRequestDataMarketExclude model module.
 * @module model/PostOptionClassScreenerSearchRequestDataMarketExclude
 */
class PostOptionClassScreenerSearchRequestDataMarketExclude {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataMarketExclude</code>.
     * Specifies the markets from which an option class may not originate.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataMarketExclude
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataMarketExclude.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataMarketExclude</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataMarketExclude} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataMarketExclude} The populated <code>PostOptionClassScreenerSearchRequestDataMarketExclude</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataMarketExclude();
 ...
 */
PostOptionClassScreenerSearchRequestDataMarketExclude.prototype['ids'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataMarketExclude;
