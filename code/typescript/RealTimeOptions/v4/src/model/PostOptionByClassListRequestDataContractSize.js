...
import PostOptionByClassListRequestDataContractSizeExclude from './PostOptionByClassListRequestDataContractSizeExclude';
import PostOptionByClassListRequestDataContractSizeRestrict from './PostOptionByClassListRequestDataContractSizeRestrict';

/**
 * The PostOptionByClassListRequestDataContractSize model module.
 * @module model/PostOptionByClassListRequestDataContractSize
 */
class PostOptionByClassListRequestDataContractSize {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataContractSize</code>.
     * Parameters related to the contract size of the option.
     * @alias module:model/PostOptionByClassListRequestDataContractSize
     */
    constructor() { 
        
        PostOptionByClassListRequestDataContractSize.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataContractSize</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataContractSize} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataContractSize} The populated <code>PostOptionByClassListRequestDataContractSize</code> instance.
     */
...
/**
 * @member {module:model/PostOptionByClassListRequestDataContractSizeRestrict} restrict
 */
PostOptionByClassListRequestDataContractSize.prototype['restrict'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataContractSizeExclude} exclude
 */
PostOptionByClassListRequestDataContractSize.prototype['exclude'] = undefined;
...
export default PostOptionByClassListRequestDataContractSize;
