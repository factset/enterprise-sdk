...
import PostOptionClassScreenerSearchRequestDataCategoryExclude from './PostOptionClassScreenerSearchRequestDataCategoryExclude';
import PostOptionClassScreenerSearchRequestDataCategoryRestrict from './PostOptionClassScreenerSearchRequestDataCategoryRestrict';

/**
 * The PostOptionClassScreenerSearchRequestDataCategory model module.
 * @module model/PostOptionClassScreenerSearchRequestDataCategory
 */
class PostOptionClassScreenerSearchRequestDataCategory {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataCategory</code>.
     * Category-related class selection as defined by FactSet (see MDG category system 18).
     * @alias module:model/PostOptionClassScreenerSearchRequestDataCategory
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataCategory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataCategory} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataCategory} The populated <code>PostOptionClassScreenerSearchRequestDataCategory</code> instance.
     */
...
/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataCategoryRestrict} restrict
 */
PostOptionClassScreenerSearchRequestDataCategory.prototype['restrict'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataCategoryExclude} exclude
 */
PostOptionClassScreenerSearchRequestDataCategory.prototype['exclude'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataCategory;
