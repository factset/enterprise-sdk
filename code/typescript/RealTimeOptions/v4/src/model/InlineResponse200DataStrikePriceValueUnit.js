...
/**
 * The InlineResponse200DataStrikePriceValueUnit model module.
 * @module model/InlineResponse200DataStrikePriceValueUnit
 */
class InlineResponse200DataStrikePriceValueUnit {
    /**
     * Constructs a new <code>InlineResponse200DataStrikePriceValueUnit</code>.
     * Value unit of the strike price. See endpoint &#x60;/basic/value-unit/list&#x60; for possible values.
     * @alias module:model/InlineResponse200DataStrikePriceValueUnit
     */
    constructor() { 
        
        InlineResponse200DataStrikePriceValueUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataStrikePriceValueUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataStrikePriceValueUnit} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataStrikePriceValueUnit} The populated <code>InlineResponse200DataStrikePriceValueUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataStrikePriceValueUnit();
 ...
 * @member {Number} id
 */
InlineResponse200DataStrikePriceValueUnit.prototype['id'] = undefined;

/**
 * Code of the value unit.
 * @member {String} code
 */
InlineResponse200DataStrikePriceValueUnit.prototype['code'] = undefined;
...
export default InlineResponse200DataStrikePriceValueUnit;
