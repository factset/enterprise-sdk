...
/**
 * The PostOptionByClassValueRangesGetDataContractSizeItems model module.
 * @module model/PostOptionByClassValueRangesGetDataContractSizeItems
 */
class PostOptionByClassValueRangesGetDataContractSizeItems {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataContractSizeItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostOptionByClassValueRangesGetDataContractSizeItems
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataContractSizeItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataContractSizeItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataContractSizeItems} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataContractSizeItems} The populated <code>PostOptionByClassValueRangesGetDataContractSizeItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataContractSizeItems();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetDataContractSizeItems.prototype['value'] = undefined;

/**
 * Number of notations.
 * @member {Number} count
 */
PostOptionByClassValueRangesGetDataContractSizeItems.prototype['count'] = undefined;
...
export default PostOptionByClassValueRangesGetDataContractSizeItems;
