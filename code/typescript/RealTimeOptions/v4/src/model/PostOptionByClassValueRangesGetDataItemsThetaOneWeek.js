...
/**
 * The PostOptionByClassValueRangesGetDataItemsThetaOneWeek model module.
 * @module model/PostOptionByClassValueRangesGetDataItemsThetaOneWeek
 */
class PostOptionByClassValueRangesGetDataItemsThetaOneWeek {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataItemsThetaOneWeek</code>.
     * Value range of the weekly theta.
     * @alias module:model/PostOptionByClassValueRangesGetDataItemsThetaOneWeek
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataItemsThetaOneWeek.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataItemsThetaOneWeek</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataItemsThetaOneWeek} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataItemsThetaOneWeek} The populated <code>PostOptionByClassValueRangesGetDataItemsThetaOneWeek</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataItemsThetaOneWeek();
 ...
 */
PostOptionByClassValueRangesGetDataItemsThetaOneWeek.prototype['minimum'] = undefined;

/**
 * Maximum value.
 * @member {Number} maximum
 */
PostOptionByClassValueRangesGetDataItemsThetaOneWeek.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetDataItemsThetaOneWeek;
