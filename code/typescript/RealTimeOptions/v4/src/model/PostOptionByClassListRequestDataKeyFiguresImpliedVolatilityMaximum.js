...
/**
 * The PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum model module.
 * @module model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum
 */
class PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum {
    /**
     * Constructs a new <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum} The populated <code>PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum;
