...
/**
 * The PostOptionByClassValueRangesGetDataExerciseStyleItems model module.
 * @module model/PostOptionByClassValueRangesGetDataExerciseStyleItems
 */
class PostOptionByClassValueRangesGetDataExerciseStyleItems {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataExerciseStyleItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostOptionByClassValueRangesGetDataExerciseStyleItems
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataExerciseStyleItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataExerciseStyleItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataExerciseStyleItems} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataExerciseStyleItems} The populated <code>PostOptionByClassValueRangesGetDataExerciseStyleItems</code> instance.
     */
 ...
 * @member {module:model/PostOptionByClassValueRangesGetDataExerciseStyleItems.ValueEnum} value
 */
PostOptionByClassValueRangesGetDataExerciseStyleItems.prototype['value'] = undefined;

/**
 * Number of notations.
 * @member {Number} count
 */
PostOptionByClassValueRangesGetDataExerciseStyleItems.prototype['count'] = undefined;
 ...
 * @readonly
 */
PostOptionByClassValueRangesGetDataExerciseStyleItems['ValueEnum'] = {
...
export default PostOptionByClassValueRangesGetDataExerciseStyleItems;
