...
/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta</code>.
     ...
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta</code> instance.
     */
 ...
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta.prototype['minimum'] = undefined;

/**
 * @member {module:model/PostOptionByClassListRequestDataKeyFiguresOmegaMaximum} maximum
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta.prototype['maximum'] = undefined;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta;
