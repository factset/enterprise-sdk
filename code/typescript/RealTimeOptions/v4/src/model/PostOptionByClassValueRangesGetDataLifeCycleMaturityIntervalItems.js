...
/**
 * The PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems model module.
 * @module model/PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems
 */
class PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems</code>.
     * A list of objects. For semantical context see the description of the parent array.
     * @alias module:model/PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems
     */
    constructor() { 
        
        PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems} The populated <code>PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems();
...
/**
 * Attribute value. | Value | Description | | --- | --- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  
 * @member {module:model/PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.ValueEnum} value
 */
PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.prototype['value'] = undefined;

/**
 * Number of notations.
 * @member {Number} count
 */
PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems.prototype['count'] = undefined;
 ...
 * @readonly
 */
PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems['ValueEnum'] = {
...
export default PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems;
