...
/**
 * The PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum
 */
class PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum</code>.
     * The minimum of the range, or &#x60;null&#x60; to indicate that there is no minimum.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum
     * @param value {Number} The minimum value.
     */
    constructor(value) { 
        
        PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum} The populated <code>PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum.prototype['inclusive'] = true;
...
export default PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum;
