...
/**
 * The InlineResponse200DataUnderlyingNotationFsymRegional model module.
 * @module model/InlineResponse200DataUnderlyingNotationFsymRegional
 */
class InlineResponse200DataUnderlyingNotationFsymRegional {
    /**
     * Constructs a new <code>InlineResponse200DataUnderlyingNotationFsymRegional</code>.
     * Regional-level identifiers.
     * @alias module:model/InlineResponse200DataUnderlyingNotationFsymRegional
     */
    constructor() { 
        
        InlineResponse200DataUnderlyingNotationFsymRegional.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse200DataUnderlyingNotationFsymRegional</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse200DataUnderlyingNotationFsymRegional} obj Optional instance to populate.
     * @return {module:model/InlineResponse200DataUnderlyingNotationFsymRegional} The populated <code>InlineResponse200DataUnderlyingNotationFsymRegional</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse200DataUnderlyingNotationFsymRegional();
 ...
 */
InlineResponse200DataUnderlyingNotationFsymRegional.prototype['permanentIdentifier'] = undefined;
 ...
 */
InlineResponse200DataUnderlyingNotationFsymRegional.prototype['tickerRegion'] = undefined;

/**
 * Indicates whether the notation is in the primary region of the security (`true`) or not (`false`).
 * @member {Boolean} isPrimary
 */
InlineResponse200DataUnderlyingNotationFsymRegional.prototype['isPrimary'] = undefined;
...
export default InlineResponse200DataUnderlyingNotationFsymRegional;
