...
/**
 * The PostOptionClassScreenerSearchDataItemsMarket model module.
 * @module model/PostOptionClassScreenerSearchDataItemsMarket
 */
class PostOptionClassScreenerSearchDataItemsMarket {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchDataItemsMarket</code>.
     * Market of the option class.
     * @alias module:model/PostOptionClassScreenerSearchDataItemsMarket
     */
    constructor() { 
        
        PostOptionClassScreenerSearchDataItemsMarket.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchDataItemsMarket</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchDataItemsMarket} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchDataItemsMarket} The populated <code>PostOptionClassScreenerSearchDataItemsMarket</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchDataItemsMarket();
 ...
 * @member {Number} id
 */
PostOptionClassScreenerSearchDataItemsMarket.prototype['id'] = undefined;

/**
 * Name of the market.
 * @member {String} name
 */
PostOptionClassScreenerSearchDataItemsMarket.prototype['name'] = undefined;
...
export default PostOptionClassScreenerSearchDataItemsMarket;
