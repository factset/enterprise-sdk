...
import PostOptionClassScreenerSearchDataItems from './PostOptionClassScreenerSearchDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostOptionClassScreenerSearchDataItems]);
            }
 ...
 * @member {Array.<module:model/PostOptionClassScreenerSearchDataItems>} data
 */
