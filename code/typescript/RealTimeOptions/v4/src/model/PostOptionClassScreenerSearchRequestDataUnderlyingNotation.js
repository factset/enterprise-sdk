...
/**
 * The PostOptionClassScreenerSearchRequestDataUnderlyingNotation model module.
 * @module model/PostOptionClassScreenerSearchRequestDataUnderlyingNotation
 */
class PostOptionClassScreenerSearchRequestDataUnderlyingNotation {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestDataUnderlyingNotation</code>.
     * Notation of the underlying.
     * @alias module:model/PostOptionClassScreenerSearchRequestDataUnderlyingNotation
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestDataUnderlyingNotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestDataUnderlyingNotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestDataUnderlyingNotation} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestDataUnderlyingNotation} The populated <code>PostOptionClassScreenerSearchRequestDataUnderlyingNotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionClassScreenerSearchRequestDataUnderlyingNotation();
 ...
 * @member {String} id
 */
PostOptionClassScreenerSearchRequestDataUnderlyingNotation.prototype['id'] = undefined;
...
export default PostOptionClassScreenerSearchRequestDataUnderlyingNotation;
