...
/**
 * The PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum model module.
 * @module model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum
 */
class PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum {
    /**
     * Constructs a new <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum</code>.
     * The maximum of the range, or &#x60;null&#x60; to indicate that there is no maximum.
     * @alias module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum
     * @param value {Number} The maximum value.
     */
    constructor(value) { 
        
        PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum} obj Optional instance to populate.
     * @return {module:model/PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum} The populated <code>PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum();
 ...
 * @member {Number} value
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum.prototype['value'] = undefined;
 ...
 * @default true
 */
PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum.prototype['inclusive'] = true;
...
export default PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum;
