...
import PostOptionClassScreenerSearchRequestDataCategory from './PostOptionClassScreenerSearchRequestDataCategory';
import PostOptionClassScreenerSearchRequestDataCurrency from './PostOptionClassScreenerSearchRequestDataCurrency';
import PostOptionClassScreenerSearchRequestDataMarket from './PostOptionClassScreenerSearchRequestDataMarket';
import PostOptionClassScreenerSearchRequestDataText from './PostOptionClassScreenerSearchRequestDataText';
import PostOptionClassScreenerSearchRequestDataUnderlying from './PostOptionClassScreenerSearchRequestDataUnderlying';

/**
 * The PostOptionClassScreenerSearchRequestData model module.
 * @module model/PostOptionClassScreenerSearchRequestData
 */
class PostOptionClassScreenerSearchRequestData {
    /**
     * Constructs a new <code>PostOptionClassScreenerSearchRequestData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PostOptionClassScreenerSearchRequestData
     */
    constructor() { 
        
        PostOptionClassScreenerSearchRequestData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostOptionClassScreenerSearchRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostOptionClassScreenerSearchRequestData} obj Optional instance to populate.
     * @return {module:model/PostOptionClassScreenerSearchRequestData} The populated <code>PostOptionClassScreenerSearchRequestData</code> instance.
     */
...
/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataText} text
 */
PostOptionClassScreenerSearchRequestData.prototype['text'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataMarket} market
 */
PostOptionClassScreenerSearchRequestData.prototype['market'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataUnderlying} underlying
 */
PostOptionClassScreenerSearchRequestData.prototype['underlying'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataCurrency} currency
 */
PostOptionClassScreenerSearchRequestData.prototype['currency'] = undefined;

/**
 * @member {module:model/PostOptionClassScreenerSearchRequestDataCategory} category
 */
PostOptionClassScreenerSearchRequestData.prototype['category'] = undefined;
...
export default PostOptionClassScreenerSearchRequestData;
