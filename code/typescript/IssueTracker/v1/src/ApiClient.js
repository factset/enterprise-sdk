...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/issue-tracker/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/issue-tracker/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/IssueTracker/0.6.0 (${process.platform}; node ${process.version})`
        };
