...
[![npm](https://img.shields.io/badge/npm-v0.6.2-orange)](https://www.npmjs.com/package/@factset/sdk-issuetracker/v/0.6.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-issuetracker@0.6.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-issuetracker@0.6.2
```
