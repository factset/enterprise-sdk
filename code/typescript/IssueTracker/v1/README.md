...
[![npm](https://img.shields.io/badge/npm-v0.6.1-orange)](https://www.npmjs.com/package/@factset/sdk-issuetracker/v/0.6.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-issuetracker@0.6.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-issuetracker@0.6.1
```
...
*issuetracker.IssueApi* | [**patchIssue**](docs/IssueApi.md#patchIssue) | **PATCH** /issues/{id} | Update issue details
