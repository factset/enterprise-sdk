...
```shell
npm install @factset/sdk-utils @factset/sdk-issuetracker@0.3.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-issuetracker@0.3.0
```
...
*issuetracker.IssueApi* | [**patchIssue**](docs/IssueApi.md#patchIssue) | **PATCH** /issues/{id} | Update severity and subject of existing issue
