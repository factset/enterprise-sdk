...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/issue-tracker/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/issue-tracker/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/IssueTracker/0.1.0'
        };
