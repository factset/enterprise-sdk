...
export default class EventsApi {
    ...
    */
     ...
     * @param {module:model/DateTimeInterval} opts.updated A date/time (UTC) interval for filtering signal events based on their last updated date. Defaults to NOW - 7 days if omitted.
     ...
     * @param {Boolean} opts.resolveIdentifiers The api will return resolved identifiers in the meta section of the response by default (true). If the parameter is false, the api will not attempt to resolve the identifiers.
    ...
    getEventAdaptiveCardsWithHttpInfo(opts) {
      ...
      let queryParams = {
        ...
        'sort': opts['sort'],
        'resolveIdentifiers': opts['resolveIdentifiers']
      };
      let headerParams = {
      };
      let formParams = {
