...
```shell
npm install @factset/sdk-utils @factset/sdk-exchangedatafeedsnapshotapisymbollist@0.21.5
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-exchangedatafeedsnapshotapisymbollist@0.21.5
```
