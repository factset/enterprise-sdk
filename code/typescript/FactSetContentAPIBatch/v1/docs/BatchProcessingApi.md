# factsetcontentapibatch.BatchProcessingApi
...
const apiInstance = new BatchProcessingApi();
const batchDataRequest = new factsetcontentapibatch.BatchDataRequest(); // BatchDataRequest | Batch Data Request Post Body
...
const apiInstance = new BatchProcessingApi();
const batchStatusRequest = new factsetcontentapibatch.BatchStatusRequest(); // BatchStatusRequest | Batch Status Request Post Body
