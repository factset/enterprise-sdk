...
export default class AXPOptimizerApi {
    ...
    /**
    * Constructs a new AXPOptimizerApi. 
    * @alias module:api/AXPOptimizerApi
    * @class
    ...
    */
     ...
     * @param {String} id from url, provided from the location header in the Create and Run Axioma optimization endpoint
    ...
    cancelOptimizationByIdWithHttpInfo(id) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/axp/v3/optimizations/{id}', 'DELETE',
     ...
     * @param {String} id from url, provided from the location header in the Create and Run Axioma optimization endpoint
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AxiomaEquityOptimizationParametersRoot} and HTTP response
     */
    getOptimizationParametersWithHttpInfo(id) {
      ...
      let returnType = AxiomaEquityOptimizationParametersRoot;

      return this.apiClient.callApi(
        '/analytics/engines/axp/v3/optimizations/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * This is the endpoint that returns the optimization parameters passed for a calculation.
     * @param {String} id from url, provided from the location header in the Create and Run Axioma optimization endpoint
     * @return { Promise.< module:model/AxiomaEquityOptimizationParametersRoot > } a Promise, with data of type {@link module:model/AxiomaEquityOptimizationParametersRoot }
     */
     ...
     * @param {String} id from url, provided from the location header in the Get Axioma optimization status by id endpoint
    ...
    getOptimizationResultWithHttpInfo(id, opts) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/axp/v3/optimizations/{id}/result', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getOptimizationStatusByIdWithHttpInfo(id) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/axp/v3/optimizations/{id}/status', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {module:model/AxiomaEquityOptimizationParametersRoot} opts.axiomaEquityOptimizationParametersRoot Calculation Parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ObjectRoot} and HTTP response
     */
    postAndOptimizeWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = opts['axiomaEquityOptimizationParametersRoot'];
      ...
      return this.apiClient.callApi(
        '/analytics/engines/axp/v3/optimizations', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    putAndOptimizeWithHttpInfo(id, opts) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/axp/v3/optimizations/{id}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
