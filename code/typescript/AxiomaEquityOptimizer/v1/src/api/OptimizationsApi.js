    ...
    */
    ...
    cancelAxiomaOptimizationByIdWithHttpInfo(id) {
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling cancelAxiomaOptimizationById");
      }
    ...
    getAxiomaOptimizationByIdWithHttpInfo(id) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAxiomaOptimizationById");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    runAxiomaOptimizationWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = opts['axiomaEquityOptimizationParameters'];
