...
[![npm](https://img.shields.io/badge/npm-v0.9.1-orange)](https://www.npmjs.com/package/@factset/sdk-axiomaequityoptimizer/v/0.9.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-axiomaequityoptimizer@0.9.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-axiomaequityoptimizer@0.9.1
```
