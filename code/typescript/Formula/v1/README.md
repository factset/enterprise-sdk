...
[![npm](https://img.shields.io/badge/npm-v6.0.1-orange)](https://www.npmjs.com/package/@factset/sdk-formula/v/6.0.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-formula@6.0.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-formula@6.0.1
```
