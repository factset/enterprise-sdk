...
/**
 * The BatchList model module.
 * @module model/BatchList
 */
class BatchList {
    /**
     * Constructs a new <code>BatchList</code>.
     * @alias module:model/BatchList
     */
    constructor() { 
        
        BatchList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchList} obj Optional instance to populate.
     * @return {module:model/BatchList} The populated <code>BatchList</code> instance.
     */
 ...
 * @member {String} id
 */
BatchList.prototype['id'] = undefined;

/**
 * @member {module:model/BatchList.StatusEnum} status
 */
BatchList.prototype['status'] = undefined;

/**
 * Error message.
 * @member {String} error
 */
BatchList.prototype['error'] = undefined;
 ...
 */
BatchList.prototype['expiration'] = undefined;
