...
class TimeSeriesResultObjectFlattenedAddl {
    ...
    static constructFromObject(data, obj) {
        ...
        if (typeof data === 'number') return ApiClient.setValue(obj || new TimeSeriesResultObjectFlattenedAddl(), data);
        // openApiType:integer format:
        if (typeof data === 'number') return ApiClient.setValue(obj || new TimeSeriesResultObjectFlattenedAddl(), data);
        if (typeof data === 'string') return ApiClient.setValue(obj || new TimeSeriesResultObjectFlattenedAddl(), data);
    }
