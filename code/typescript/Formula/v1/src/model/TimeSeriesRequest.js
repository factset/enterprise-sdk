...
import TimeSeriesRequestData from './TimeSeriesRequestData';

/**
 * The TimeSeriesRequest model module.
 * @module model/TimeSeriesRequest
 */
class TimeSeriesRequest {
    /**
     * Constructs a new <code>TimeSeriesRequest</code>.
     * &#x60;/time-series&#x60; Request Body
     * @alias module:model/TimeSeriesRequest
     * @param data {module:model/TimeSeriesRequestData} 
     */
    constructor(data) { 
        
        TimeSeriesRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>TimeSeriesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeSeriesRequest} obj Optional instance to populate.
     * @return {module:model/TimeSeriesRequest} The populated <code>TimeSeriesRequest</code> instance.
     */
...
/**
 * @member {module:model/TimeSeriesRequestData} data
 */
TimeSeriesRequest.prototype['data'] = undefined;
...
export default TimeSeriesRequest;
