...
import TimeSeriesScalarValue from './TimeSeriesScalarValue';

/**
 * The TimeSeriesResultObjectNonflattenedScalar model module.
 * @module model/TimeSeriesResultObjectNonflattenedScalar
 */
class TimeSeriesResultObjectNonflattenedScalar {
    /**
     * Constructs a new <code>TimeSeriesResultObjectNonflattenedScalar</code>.
     * @alias module:model/TimeSeriesResultObjectNonflattenedScalar
     ...
     * @param dataType {module:model/TimeSeriesResultObjectNonflattenedScalar.DataTypeEnum} Type of data returned in `result`
     * @param objectType {module:model/TimeSeriesResultObjectNonflattenedScalar.ObjectTypeEnum} Type of object returned in `result`
     */
    constructor(error, formula, requestId, dataType, objectType) { 
        ...
        TimeSeriesResultObjectNonflattenedScalar.initialize(this, error, formula, requestId, dataType, objectType);
    }
    ...
    /**
     * Constructs a <code>TimeSeriesResultObjectNonflattenedScalar</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeSeriesResultObjectNonflattenedScalar} obj Optional instance to populate.
     * @return {module:model/TimeSeriesResultObjectNonflattenedScalar} The populated <code>TimeSeriesResultObjectNonflattenedScalar</code> instance.
     */
...
/**
 * @member {module:model/TimeSeriesScalarValue} result
 */
TimeSeriesResultObjectNonflattenedScalar.prototype['result'] = undefined;
 ...
 * @readonly
 */
TimeSeriesResultObjectNonflattenedScalar['DataTypeEnum'] = {
 ...
 * @readonly
 */
TimeSeriesResultObjectNonflattenedScalar['ObjectTypeEnum'] = {
...
export default TimeSeriesResultObjectNonflattenedScalar;
