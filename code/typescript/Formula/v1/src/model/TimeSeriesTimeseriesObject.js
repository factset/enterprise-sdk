...
/**
 * The TimeSeriesTimeseriesObject model module.
 * @module model/TimeSeriesTimeseriesObject
 * @version 0.20.0
 */
class TimeSeriesTimeseriesObject {
    /**
     * Constructs a new <code>TimeSeriesTimeseriesObject</code>.
     ...
     * @alias module:model/TimeSeriesTimeseriesObject
     */
    constructor() { 
        
        TimeSeriesTimeseriesObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeSeriesTimeseriesObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeSeriesTimeseriesObject} obj Optional instance to populate.
     * @return {module:model/TimeSeriesTimeseriesObject} The populated <code>TimeSeriesTimeseriesObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeSeriesTimeseriesObject();

            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [TimeSeriesScalarValue]);
            }
 ...
 * @member {Array.<module:model/TimeSeriesScalarValue>} values
 */
TimeSeriesTimeseriesObject.prototype['values'] = undefined;

/**
 * Representing the dates corresponding the requested FQL formula for the requestId
 * @member {Array.<Date>} dates
 */
TimeSeriesTimeseriesObject.prototype['dates'] = undefined;
...
export default TimeSeriesTimeseriesObject;
