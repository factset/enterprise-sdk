...
/**
 * The TimeSeriesResultObjectNonflattenedArray model module.
 * @module model/TimeSeriesResultObjectNonflattenedArray
 */
class TimeSeriesResultObjectNonflattenedArray {
    /**
     * Constructs a new <code>TimeSeriesResultObjectNonflattenedArray</code>.
     * The &#x60;result&#x60; attribute in the Time-Series Non-Flattened Response Object will be an ARRAY.
     * @alias module:model/TimeSeriesResultObjectNonflattenedArray
     ...
     * @param dataType {module:model/TimeSeriesResultObjectNonflattenedArray.DataTypeEnum} Type of data returned in `result`
     * @param objectType {module:model/TimeSeriesResultObjectNonflattenedArray.ObjectTypeEnum} Type of object returned in `result`
     */
    constructor(error, formula, requestId, dataType, objectType) { 
        ...
        TimeSeriesResultObjectNonflattenedArray.initialize(this, error, formula, requestId, dataType, objectType);
    }
    ...
    /**
     * Constructs a <code>TimeSeriesResultObjectNonflattenedArray</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeSeriesResultObjectNonflattenedArray} obj Optional instance to populate.
     * @return {module:model/TimeSeriesResultObjectNonflattenedArray} The populated <code>TimeSeriesResultObjectNonflattenedArray</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeSeriesResultObjectNonflattenedArray();
...
/**
 * @member {Array.<module:model/TimeSeriesScalarValue>} result
 */
TimeSeriesResultObjectNonflattenedArray.prototype['result'] = undefined;
 ...
 * @readonly
 */
TimeSeriesResultObjectNonflattenedArray['DataTypeEnum'] = {
 ...
 * @readonly
 */
TimeSeriesResultObjectNonflattenedArray['ObjectTypeEnum'] = {
...
export default TimeSeriesResultObjectNonflattenedArray;
