...
class CrossSectionalResponseObjectItems {
    ...
    constructor(dataItemName, result, dataType, error, requestId) { 
        CrossSectionalResultObjectNonflattened.initialize(this, dataItemName, result, dataType, error);UnifiedResultObjectFlattened.initialize(this, requestId);
 ...
 * @member {Date} date
 */
CrossSectionalResponseObjectItems.prototype['date'] = undefined;
