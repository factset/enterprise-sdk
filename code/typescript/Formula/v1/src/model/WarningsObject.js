...
/**
 * The WarningsObject model module.
 * @module model/WarningsObject
 */
class WarningsObject {
    /**
     * Constructs a new <code>WarningsObject</code>.
     * @alias module:model/WarningsObject
     */
    constructor() { 
        
        WarningsObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WarningsObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WarningsObject} obj Optional instance to populate.
     * @return {module:model/WarningsObject} The populated <code>WarningsObject</code> instance.
     */
 ...
 */
WarningsObject.prototype['description'] = undefined;

/**
 * Human readable message explaining the effect on the `result`
 * @member {String} effect
 */
WarningsObject.prototype['effect'] = undefined;
