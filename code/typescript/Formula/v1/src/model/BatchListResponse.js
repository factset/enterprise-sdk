...
import BatchListResponseMeta from './BatchListResponseMeta';

/**
 * The BatchListResponse model module.
 * @module model/BatchListResponse
 */
class BatchListResponse {
    /**
     * Constructs a new <code>BatchListResponse</code>.
     * @alias module:model/BatchListResponse
     */
    constructor() { 
        
        BatchListResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchListResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchListResponse} obj Optional instance to populate.
     * @return {module:model/BatchListResponse} The populated <code>BatchListResponse</code> instance.
     */
...
/**
 * @member {module:model/BatchListResponseMeta} meta
 */
BatchListResponse.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/BatchList>} data
 */
BatchListResponse.prototype['data'] = undefined;
