...
class CrossSectionalResultObjectFlattenedAddl {
    ...
    static constructFromObject(data, obj) {
        ...
        if (typeof data === 'number') return ApiClient.setValue(obj || new CrossSectionalResultObjectFlattenedAddl(), data);
        // openApiType:integer format:
        if (typeof data === 'number') return ApiClient.setValue(obj || new CrossSectionalResultObjectFlattenedAddl(), data);
        if (typeof data === 'string') return ApiClient.setValue(obj || new CrossSectionalResultObjectFlattenedAddl(), data);
    }
