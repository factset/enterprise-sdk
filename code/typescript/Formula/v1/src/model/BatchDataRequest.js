...
import BatchDataRequestData from './BatchDataRequestData';
...
class BatchDataRequest {
     ...
     * @param data {module:model/BatchDataRequestData} 
     */
    constructor(data) { 
        
        BatchDataRequest.initialize(this, data);
    }
...
/**
 * @member {module:model/BatchDataRequestData} data
 */
BatchDataRequest.prototype['data'] = undefined;
