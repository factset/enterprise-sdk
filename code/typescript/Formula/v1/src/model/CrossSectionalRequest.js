...
import CrossSectionalRequestData from './CrossSectionalRequestData';

/**
 * The CrossSectionalRequest model module.
 * @module model/CrossSectionalRequest
 */
class CrossSectionalRequest {
    /**
     * Constructs a new <code>CrossSectionalRequest</code>.
     * &#x60;/cross-sectional&#x60; Request Body
     * @alias module:model/CrossSectionalRequest
     * @param data {module:model/CrossSectionalRequestData} 
     */
    constructor(data) { 
        
        CrossSectionalRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>CrossSectionalRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrossSectionalRequest} obj Optional instance to populate.
     * @return {module:model/CrossSectionalRequest} The populated <code>CrossSectionalRequest</code> instance.
     */
...
/**
 * @member {module:model/CrossSectionalRequestData} data
 */
CrossSectionalRequest.prototype['data'] = undefined;
...
export default CrossSectionalRequest;
