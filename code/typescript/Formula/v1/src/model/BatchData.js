...
import TimeSeriesResponseObjectItems from './TimeSeriesResponseObjectItems';
...
class BatchData {
     ...
     * @implements module:model/CrossSectionalResponseObjectItems
     * @implements module:model/TimeSeriesResponseObjectItems
     ...
     */
    constructor(dataItemName, result, dataType, error, requestId, formula, objectType) { 
        CrossSectionalResponseObjectItems.initialize(this, dataItemName, result, dataType, error, requestId);TimeSeriesResponseObjectItems.initialize(this, error, formula, requestId, dataType, objectType);
        BatchData.initialize(this, dataItemName, result, dataType, error, requestId, formula, objectType);
    }
     ...
     */
    static initialize(obj, dataItemName, result, dataType, error, requestId, formula, objectType) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            CrossSectionalResponseObjectItems.constructFromObject(data, obj);
            TimeSeriesResponseObjectItems.constructFromObject(data, obj);
...
// Implement CrossSectionalResponseObjectItems interface:
/**
 * If `universe` is submitted instead of `ids`, then the universe attribute will display the universe expression requested.
 * @member {String} universe
 */
...
// Implement TimeSeriesResponseObjectItems interface:
/**
 * Indicates that there was an error in the execution of the FQL Formula. * Zero – success * Non-zero – failure 
 * @member {Number} error
 */
TimeSeriesResponseObjectItems.prototype['error'] = undefined;
/**
 * If error is non-zero, errorMessage will display the FQL formula error.
 * @member {String} errorMessage
 */
TimeSeriesResponseObjectItems.prototype['errorMessage'] = undefined;
/**
 * FQL formula requested.
 * @member {String} formula
 */
TimeSeriesResponseObjectItems.prototype['formula'] = undefined;
/**
 * Display Name.
 * @member {String} displayName
 */
TimeSeriesResponseObjectItems.prototype['displayName'] = undefined;
/**
 * Identifier requested.
 * @member {String} requestId
 */
 ...
 * @member {module:model/TimeSeriesResponseObjectItems.DataTypeEnum} dataType
 */
TimeSeriesResponseObjectItems.prototype['dataType'] = undefined;
/**
 * Type of object returned in `result`
 * @member {module:model/TimeSeriesResponseObjectItems.ObjectTypeEnum} objectType
 */
TimeSeriesResponseObjectItems.prototype['objectType'] = undefined;
/**
