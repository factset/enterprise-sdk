...
/**
 * The BatchListResponseMeta model module.
 * @module model/BatchListResponseMeta
 */
class BatchListResponseMeta {
    /**
     * Constructs a new <code>BatchListResponseMeta</code>.
     * @alias module:model/BatchListResponseMeta
     */
    constructor() { 
        
        BatchListResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchListResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchListResponseMeta} obj Optional instance to populate.
     * @return {module:model/BatchListResponseMeta} The populated <code>BatchListResponseMeta</code> instance.
     */
 ...
 */
BatchListResponseMeta.prototype['message'] = undefined;
...
export default BatchListResponseMeta;
