...
/**
 * The UnifiedResultObjectFlattenedAddl model module.
 * @module model/UnifiedResultObjectFlattenedAddl
 */
class UnifiedResultObjectFlattenedAddl {
    /**
     * Constructs a new <code>UnifiedResultObjectFlattenedAddl</code>.
     ...
     * @alias module:model/UnifiedResultObjectFlattenedAddl
     */
    constructor() { 
        
        UnifiedResultObjectFlattenedAddl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnifiedResultObjectFlattenedAddl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnifiedResultObjectFlattenedAddl} obj Optional instance to populate.
     * @return {module:model/UnifiedResultObjectFlattenedAddl} The populated <code>UnifiedResultObjectFlattenedAddl</code> instance.
     */
...
export default UnifiedResultObjectFlattenedAddl;
