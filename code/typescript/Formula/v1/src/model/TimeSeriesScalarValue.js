...
/**
 * The TimeSeriesScalarValue model module.
 * @module model/TimeSeriesScalarValue
 */
class TimeSeriesScalarValue {
    /**
     * Constructs a new <code>TimeSeriesScalarValue</code>.
     * The &#x60;result&#x60; attribute in the Time-Series Non-Flattened Response Object will be a SCALAR.
     * @alias module:model/TimeSeriesScalarValue
     */
    constructor() { 
        
        TimeSeriesScalarValue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeSeriesScalarValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeSeriesScalarValue} obj Optional instance to populate.
     * @return {module:model/TimeSeriesScalarValue} The populated <code>TimeSeriesScalarValue</code> instance.
     */
    static constructFromObject(data, obj) {
        // openApiType:number format:double
        if (typeof data === 'number') return ApiClient.setValue(obj || new TimeSeriesScalarValue(), data);
        // openApiType:integer format:
        if (typeof data === 'number') return ApiClient.setValue(obj || new TimeSeriesScalarValue(), data);
        if (typeof data === 'string') return ApiClient.setValue(obj || new TimeSeriesScalarValue(), data);
    }
...
export default TimeSeriesScalarValue;
