# officecloudrefresh.RefreshOperationsApi
...
```javascript
const { ApiClient, RefreshOperationsApi } = require('@factset/sdk-officecloudrefresh');
...
const opts = {
  ...
  'waiveXlsmSignature': true // Boolean | Option to waive signature checking for macro-enabled (.xlsm) file
};
