...
[![npm](https://img.shields.io/badge/npm-v1.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-publisher/v/1.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-publisher@1.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-publisher@1.0.0
```
