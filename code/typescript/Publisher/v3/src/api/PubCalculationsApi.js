...
export default class PubCalculationsApi {
    ...
    */
    ...
    getAllCalculationsWithHttpInfo(opts) {
      ...
      return this.apiClient.callApi(
        '/analytics/engines/pub/v3/calculations', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getCalculationUnitResultByIdWithHttpInfo(id, unitId) {
      ...
      let authNames = ['FactSetApiKey', 'FactSetOAuth2'];
      let contentTypes = [];
      let accepts = ['application/pdf', 'application/vnd.openxmlformats-officedocument.presentationml.presentation', 'application/json'];
    ...
    postAndCalculateWithHttpInfo(opts) {
      ...
      let accepts = ['application/json', 'application/pdf', 'application/vnd.openxmlformats-officedocument.presentationml.presentation'];
 ...
 * 
 *   <li>201 : {@code File }<br>Expected response if the calculation has one unit and is completed in a short span, returns JSON in the format specified in the Calculation parameters.</li>
 * 
 ...
 *     break;
 *   case 201:
 *     File data201 = response.getResponse201();
 *     break;
 *   case 202:
