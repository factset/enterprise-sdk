...
import PostPricesTimeSeriesEodListRequestData from './PostPricesTimeSeriesEodListRequestData';
...
class PostPricesTimeSeriesEodListRequest {
     ...
     * @param data {module:model/PostPricesTimeSeriesEodListRequestData} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PostPricesTimeSeriesEodListRequestData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/PostPricesTimeSeriesEodListRequestData} data
 */
