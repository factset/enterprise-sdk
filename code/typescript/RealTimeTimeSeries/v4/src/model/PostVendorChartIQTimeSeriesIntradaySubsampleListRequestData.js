...
import PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange from './PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange';

/**
 * The PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData model module.
 * @module model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData
 */
class PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData {
    /**
     * Constructs a new <code>PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData
     * @param identifier {module:model/PostVendorChartIQTimeSeriesEodListRequestDataIdentifier} 
     * @param range {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange} 
     */
    constructor(identifier, range) { 
        
        PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.initialize(this, identifier, range);
    }
    ...
    /**
     * Constructs a <code>PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData} obj Optional instance to populate.
     * @return {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData} The populated <code>PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData</code> instance.
     */
 ...
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['identifier'] = undefined;
 ...
 * @member {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.TypeEnum} type
 * @default 'trade'
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['type'] = 'trade';
 ...
 * @member {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.QualityEnum} quality
 * @default 'DLY'
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['quality'] = 'DLY';

/**
 * @member {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange} range
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['range'] = undefined;
 ...
 * @member {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.GranularityEnum} granularity
 * @default '1h'
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['granularity'] = '1h';
 ...
 * @default false
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['newestFirst'] = false;

/**
 * @member {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments} adjustments
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData.prototype['adjustments'] = undefined;
 ...
 * @readonly
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData['TypeEnum'] = {
 ...
 * @readonly
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData['QualityEnum'] = {
 ...
 * @readonly
 */
PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData['GranularityEnum'] = {
...
export default PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData;
