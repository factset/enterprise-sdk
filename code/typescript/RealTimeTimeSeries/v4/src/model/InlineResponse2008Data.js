...
import InlineResponse2008DataRange from './InlineResponse2008DataRange';
import PostPricesTimeSeriesIntradayListDataPricesItems from './PostPricesTimeSeriesIntradayListDataPricesItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('range')) {
                obj['range'] = InlineResponse2008DataRange.constructFromObject(data['range']);
            }
            if (data.hasOwnProperty('quality')) {
                obj['quality'] = ApiClient.convertToType(data['quality'], 'String');
            }
            if (data.hasOwnProperty('prices')) {
                obj['prices'] = ApiClient.convertToType(data['prices'], [PostPricesTimeSeriesIntradayListDataPricesItems]);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2008DataRange} range
 */
 ...
 * @member {Array.<module:model/PostPricesTimeSeriesIntradayListDataPricesItems>} prices
 */
