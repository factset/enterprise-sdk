...
/**
 * The PostPricesTimeSeriesIntradaySubsampleGetRequestData model module.
 * @module model/PostPricesTimeSeriesIntradaySubsampleGetRequestData
 */
class PostPricesTimeSeriesIntradaySubsampleGetRequestData {
    /**
     * Constructs a new <code>PostPricesTimeSeriesIntradaySubsampleGetRequestData</code>.
     * The data member contains the request&#39;s primary data.
     * @alias module:model/PostPricesTimeSeriesIntradaySubsampleGetRequestData
    ...
    constructor(identifier, from) { 
        ...
        PostPricesTimeSeriesIntradaySubsampleGetRequestData.initialize(this, identifier, from);
    }
    ...
    /**
     * Constructs a <code>PostPricesTimeSeriesIntradaySubsampleGetRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostPricesTimeSeriesIntradaySubsampleGetRequestData} obj Optional instance to populate.
     * @return {module:model/PostPricesTimeSeriesIntradaySubsampleGetRequestData} The populated <code>PostPricesTimeSeriesIntradaySubsampleGetRequestData</code> instance.
     */
 ...
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData.prototype['identifier'] = undefined;
 ...
 * @member {module:model/PostPricesTimeSeriesIntradaySubsampleGetRequestData.TypeEnum} type
 * @default 'trade'
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData.prototype['type'] = 'trade';
 ...
 * @member {module:model/PostPricesTimeSeriesIntradaySubsampleGetRequestData.QualityEnum} quality
 * @default 'DLY'
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData.prototype['quality'] = 'DLY';
 ...
 * @member {Date} from
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData.prototype['from'] = undefined;
 ...
 * @member {module:model/PostPricesTimeSeriesIntradaySubsampleGetRequestData.GranularityEnum} granularity
 * @default '1h'
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData.prototype['granularity'] = '1h';

/**
 * @member {module:model/PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments} adjustments
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData.prototype['adjustments'] = undefined;
 ...
 * @readonly
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData['TypeEnum'] = {
 ...
 * @readonly
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData['QualityEnum'] = {
 ...
 * @readonly
 */
PostPricesTimeSeriesIntradaySubsampleGetRequestData['GranularityEnum'] = {
...
export default PostPricesTimeSeriesIntradaySubsampleGetRequestData;
