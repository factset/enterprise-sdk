# realtimetimeseries.PostPricesTimeSeriesIntradaySubsampleListRequestData
...
**alignRange** | **Boolean** | If set to &#x60;true&#x60;, the start and end of the range are truncated so that they are aligned to the selected &#x60;granularity&#x60;. | [optional] [default to false]
