...
import CountResponseObject from './CountResponseObject';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [CountResponseObject]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/CountResponseObject>} data
 */
CountResponse.prototype['data'] = undefined;
