...
/**
 * The SecurityTypesResponse model module.
 * @module model/SecurityTypesResponse
 */
class SecurityTypesResponse {
    /**
     * Constructs a new <code>SecurityTypesResponse</code>.
     * List of supported security types.
     * @alias module:model/SecurityTypesResponse
     */
    constructor() { 
        
        SecurityTypesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SecurityTypesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SecurityTypesResponse} obj Optional instance to populate.
     * @return {module:model/SecurityTypesResponse} The populated <code>SecurityTypesResponse</code> instance.
     */
...
/**
 * @member {module:model/SecurityResponse} data
 */
SecurityTypesResponse.prototype['data'] = undefined;
...
export default SecurityTypesResponse;
