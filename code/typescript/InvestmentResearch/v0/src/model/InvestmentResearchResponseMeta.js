...
import InvestmentResearchResponseMetaPagination from './InvestmentResearchResponseMetaPagination';

/**
 * The InvestmentResearchResponseMeta model module.
 * @module model/InvestmentResearchResponseMeta
 */
class InvestmentResearchResponseMeta {
    /**
     * Constructs a new <code>InvestmentResearchResponseMeta</code>.
     * Meta Object
     * @alias module:model/InvestmentResearchResponseMeta
     */
    constructor() { 
        
        InvestmentResearchResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvestmentResearchResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvestmentResearchResponseMeta} obj Optional instance to populate.
     * @return {module:model/InvestmentResearchResponseMeta} The populated <code>InvestmentResearchResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvestmentResearchResponseMeta();

            if (data.hasOwnProperty('pagination')) {
                obj['pagination'] = InvestmentResearchResponseMetaPagination.constructFromObject(data['pagination']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InvestmentResearchResponseMetaPagination} pagination
 */
InvestmentResearchResponseMeta.prototype['pagination'] = undefined;
...
export default InvestmentResearchResponseMeta;
