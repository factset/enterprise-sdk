...
[![npm](https://img.shields.io/badge/npm-v0.1.0-orange)](https://www.npmjs.com/package/@factset/sdk-investmentresearch/v/0.1.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-investmentresearch@0.1.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-investmentresearch@0.1.0
```
