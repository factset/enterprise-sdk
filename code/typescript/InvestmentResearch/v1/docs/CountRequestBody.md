...
------------ | ------------- | ------------- | -------------
**ids** | **[String]** | Requested symbols or securities.  This is a comma-separated list with a maximum limit of 10.  Each symbol can be a FactSet exchange symbol, CUSIP, ISIN, Entity ID and SEDOL.  &gt; **Note:** If this parameter is not provided, response should not include the requestId field.        | [optional] 
