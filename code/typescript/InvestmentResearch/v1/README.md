...
[![npm](https://img.shields.io/badge/npm-v2.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-investmentresearch/v/2.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-investmentresearch@2.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-investmentresearch@2.0.0
```
...
*investmentresearch.ResearchApi* | [**getPurchaseLinks**](docs/ResearchApi.md#getPurchaseLinks) | **POST** /purchase-amr | Retrieve purchase links and metadata for specified research documents.
...
## Documentation for Models
 ...
 - [investmentresearch.CountSource](docs/CountSource.md)
 ...
 - [investmentresearch.PurchaseDocument](docs/PurchaseDocument.md)
 - [investmentresearch.PurchaseRequest](docs/PurchaseRequest.md)
 - [investmentresearch.PurchaseRequestBody](docs/PurchaseRequestBody.md)
 - [investmentresearch.PurchaseResponse](docs/PurchaseResponse.md)
 - [investmentresearch.PurchaseResponseItems](docs/PurchaseResponseItems.md)
