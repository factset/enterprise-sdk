...
import PurchaseResponseItems from './PurchaseResponseItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data') && obj['data'] === undefined) {
                obj['data'] = ApiClient.convertToType(data['data'], [PurchaseResponseItems]);
            }
...
/**
 * Data Array Object
 * @member {Array.<module:model/PurchaseResponseItems>} data
 */
PurchaseResponse.prototype['data'] = undefined;
