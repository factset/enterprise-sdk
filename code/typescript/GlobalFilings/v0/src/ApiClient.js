...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/global-filings/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/global-filings/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/GlobalFilings/0.2.0 (${process.platform}; node ${process.version})`
        };
