...
[![npm](https://img.shields.io/badge/npm-v0.2.1-orange)](https://www.npmjs.com/package/@factset/sdk-globalfilings/v/0.2.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-globalfilings@0.2.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-globalfilings@0.2.1
```
...
*globalfilings.FilingsAPIApi* | [**getHelper**](docs/FilingsAPIApi.md#getHelper) | **GET** /helper | Returns the static values for various parameters
...
## Documentation for Models
 ...
 - [globalfilings.ResponseHelper](docs/ResponseHelper.md)
 - [globalfilings.ResponseHelperObject](docs/ResponseHelperObject.md)
 - [globalfilings.ResponseHelperObjectCategoriesObject](docs/ResponseHelperObjectCategoriesObject.md)
 - [globalfilings.ResponseHelperObjectFormtypesObject](docs/ResponseHelperObjectFormtypesObject.md)
 - [globalfilings.ResponseHelperObjectSourcesObject](docs/ResponseHelperObjectSourcesObject.md)
 - [globalfilings.ResponseHelperObjectTimeZonesObject](docs/ResponseHelperObjectTimeZonesObject.md)
