...
**fiscalPeriodEndDate** | **Date** | Represents the period-end report date for the document. This field is available only for EDG and FFR sources. | [optional] 
