...
export default class FilingsAPIApi {
    ...
    */
     ...
     * @param {Array.<String>} opts.ids Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol,mCUSIP, SEDOL, ISIN, or Entity ID > **Note**: If this parameter is not used should return null for the requestId field in the response
     ...
     * @param {Boolean} opts.primaryId Type of identifier search * true - Returns headlines of stories that have the searched identifier(s) as the primary  identifier. * false - Returns headlines of stories that mentioned or referred to the  identifier. (default to false)
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.ids Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol,CUSIP, SEDOL, ISIN, or Entity ID > **Note**: If this parameter is not used should return null for the requestId field in the response. 
     * @param {String} opts.startDate Start Date. Format is YYYYMMDD or relative +/- days (0,-1,etc). 
     * @param {String} opts.endDate End Date. Format is YYYYMMDD or relative +/- days (0,-1,etc).
