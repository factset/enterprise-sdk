...
class Document {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fiscalPeriodEndDate') && obj['fiscalPeriodEndDate'] === undefined) {
                obj['fiscalPeriodEndDate'] = ApiClient.convertToType(data['fiscalPeriodEndDate'], 'Date');
            }
            ...
            if (data.hasOwnProperty('formTypes') && obj['formTypes'] === undefined) {
 ...
 * @member {Date} fiscalPeriodEndDate
 */
Document.prototype['fiscalPeriodEndDate'] = undefined;
