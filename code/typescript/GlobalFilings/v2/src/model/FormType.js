...
/**
 * The FormType model module.
 * @module model/FormType
 */
class FormType {
    /**
     * Constructs a new <code>FormType</code>.
     * @alias module:model/FormType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FormType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormType} obj Optional instance to populate.
     * @return {module:model/FormType} The populated <code>FormType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormType();
 ...
 */
FormType.prototype['source'] = undefined;

/**
 * formType
 * @member {String} formType
 */
FormType.prototype['formType'] = undefined;

/**
 * source description
 * @member {String} description
 */
FormType.prototype['description'] = undefined;
