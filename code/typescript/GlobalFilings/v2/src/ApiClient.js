...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/global-filings/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/global-filings/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/GlobalFilings/3.3.0 (${process.platform}; node ${process.version})`
        };
