# irnconfiguration.ContactsTypesApi
...
const apiInstance = new ContactsTypesApi();
const body = "body_example"; // String | Contact type name

// Call api endpoint
apiInstance.createContactType(body).then(
  data => {
...
// Call api endpoint
apiInstance.deleteContactType(contactTypeId).then(
  () => {
...
// Call api endpoint
apiInstance.getContactTypes().then(
  data => {
...
// Call api endpoint
apiInstance.updateContactType(contactTypeId, body).then(
  () => {
    console.log('API called successfully.');
  },
  error => {
