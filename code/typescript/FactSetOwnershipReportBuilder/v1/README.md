...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetownershipreportbuilder@1.1.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetownershipreportbuilder@1.1.1
```
