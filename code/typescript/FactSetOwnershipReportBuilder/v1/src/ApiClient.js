...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/report/ownership/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/report/ownership/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetOwnershipReportBuilder/2.0.0 (${process.platform}; node ${process.version})`
        };
