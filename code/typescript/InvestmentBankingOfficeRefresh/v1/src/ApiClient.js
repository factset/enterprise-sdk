...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/office-refresh/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/office-refresh/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/InvestmentBankingOfficeRefresh/2.0.0 (${process.platform}; node ${process.version})`
        };
