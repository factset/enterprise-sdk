...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/office-refresh/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/office-refresh/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/InvestmentBankingOfficeRefresh/0.20.2'
        };
