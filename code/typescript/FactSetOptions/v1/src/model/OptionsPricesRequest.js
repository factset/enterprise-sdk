...
/**
 * The OptionsPricesRequest model module.
 * @module model/OptionsPricesRequest
 * @version 0.20.0
 */
class OptionsPricesRequest {
    /**
     * Constructs a new <code>OptionsPricesRequest</code>.
     * @alias module:model/OptionsPricesRequest
    ...
    constructor(ids) { 
        ...
        OptionsPricesRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>OptionsPricesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptionsPricesRequest} obj Optional instance to populate.
     * @return {module:model/OptionsPricesRequest} The populated <code>OptionsPricesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptionsPricesRequest();
 ...
 */
OptionsPricesRequest.prototype['ids'] = undefined;
 ...
 */
OptionsPricesRequest.prototype['startDate'] = undefined;
 ...
 */
OptionsPricesRequest.prototype['endDate'] = undefined;

/**
 * @member {module:model/Frequency} frequency
 */
OptionsPricesRequest.prototype['frequency'] = undefined;
 ...
 */
OptionsPricesRequest.prototype['currency'] = undefined;

/**
 * @member {module:model/Calendar} calendar
 */
OptionsPricesRequest.prototype['calendar'] = undefined;
...
export default OptionsPricesRequest;
