...
[![npm](https://img.shields.io/badge/npm-v2.5.0-orange)](https://www.npmjs.com/package/@factset/sdk-streetaccountnews/v/2.5.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-streetaccountnews@2.5.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-streetaccountnews@2.5.0
```
...
*streetaccountnews.SABurstsApi* | [**getLatestBurstFile**](docs/SABurstsApi.md#getLatestBurstFile) | **GET** /sa-bursts/latest-file | Retrieve the latest burst file metadata and download URL
...
## Documentation for Models
 ...
 - [streetaccountnews.BurstFileResponse](docs/BurstFileResponse.md)
 - [streetaccountnews.BurstFileResponseData](docs/BurstFileResponseData.md)
 ...
 - [streetaccountnews.QuickAlertsResponseData](docs/QuickAlertsResponseData.md)
