...
[![npm](https://img.shields.io/badge/npm-v2.2.1-orange)](https://www.npmjs.com/package/@factset/sdk-streetaccountnews/v/2.2.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-streetaccountnews@2.2.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-streetaccountnews@2.2.1
```
