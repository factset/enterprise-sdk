...
import StructuredFiltersChildrenObjectTopics from './StructuredFiltersChildrenObjectTopics';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('children')) {
                obj['children'] = ApiClient.convertToType(data['children'], [StructuredFiltersChildrenObjectTopics]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/StructuredFiltersChildrenObjectTopics>} children
 */
