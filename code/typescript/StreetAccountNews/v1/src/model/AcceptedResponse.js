...
/**
 * The AcceptedResponse model module.
 * @module model/AcceptedResponse
 */
class AcceptedResponse {
    /**
     * Constructs a new <code>AcceptedResponse</code>.
     * Returns Status of the id.
     * @alias module:model/AcceptedResponse
     */
    constructor() { 
        
        AcceptedResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AcceptedResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcceptedResponse} obj Optional instance to populate.
     * @return {module:model/AcceptedResponse} The populated <code>AcceptedResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcceptedResponse();
 ...
 */
AcceptedResponse.prototype['data'] = undefined;

/**
 * @member {module:model/MetaOne} meta
 */
AcceptedResponse.prototype['meta'] = undefined;
