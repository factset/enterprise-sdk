...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/research/news/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/research/news/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/StreetAccountNews/0.20.3'
        };
