...
import OptimizerInputsTailRiskTerm from './OptimizerInputsTailRiskTerm';
...
class OptimizerInputsMPTailRiskTerm {
    /**
     * Constructs a new <code>OptimizerInputsMPTailRiskTerm</code>.
     * @alias module:model/OptimizerInputsMPTailRiskTerm
     */
    constructor() { 
        
        OptimizerInputsMPTailRiskTerm.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OptimizerInputsMPTailRiskTerm</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptimizerInputsMPTailRiskTerm} obj Optional instance to populate.
     * @return {module:model/OptimizerInputsMPTailRiskTerm} The populated <code>OptimizerInputsMPTailRiskTerm</code> instance.
     */
...
/**
 * @member {module:model/OptimizerInputsTailRiskTerm} term
 */
OptimizerInputsMPTailRiskTerm.prototype['term'] = undefined;

/**
 * @member {module:model/OptimizerInputsBoundSourceEnum} term_on
 */
OptimizerInputsMPTailRiskTerm.prototype['term_on'] = undefined;

/**
 * @member {module:model/OptimizerInputsOnPeriods} on_periods
 */
OptimizerInputsMPTailRiskTerm.prototype['on_periods'] = undefined;

/**
 * @member {module:model/OptimizerInputsAcrossPeriods} across_periods
 */
OptimizerInputsMPTailRiskTerm.prototype['across_periods'] = undefined;
...
export default OptimizerInputsMPTailRiskTerm;
