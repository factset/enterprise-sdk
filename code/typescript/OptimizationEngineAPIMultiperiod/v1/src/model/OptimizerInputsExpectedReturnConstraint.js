...
class OptimizerInputsExpectedReturnConstraint {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('return_value') && obj['return_value'] === undefined) {
                obj['return_value'] = OptimizerInputsValue.constructFromObject(data['return_value']);
            }
            if (data.hasOwnProperty('use_strategy_return_value') && obj['use_strategy_return_value'] === undefined) {
            ...
            if (data.hasOwnProperty('return_type') && obj['return_type'] === undefined) {
