...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/engines/proposal-generation/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/engines/proposal-generation/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ProposalGenerationEngine/0.1.0 (${process.platform}; node ${process.version})`
        };
