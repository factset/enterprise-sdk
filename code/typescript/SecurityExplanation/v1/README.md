...
[![API Version](https://img.shields.io/badge/api-v1.6.0-blue)](https://developer.factset.com/api-catalog/security-explanation-api)
[![npm](https://img.shields.io/badge/npm-v2.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-securityexplanation/v/2.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-securityexplanation@2.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-securityexplanation@2.2.0
```
...
## Documentation for Models
 ...
 - [securityexplanation.BrokerResearchSummary](docs/BrokerResearchSummary.md)
