...
[![npm](https://img.shields.io/badge/npm-v2.1.1-orange)](https://www.npmjs.com/package/@factset/sdk-securityexplanation/v/2.1.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-securityexplanation@2.1.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-securityexplanation@2.1.1
```
