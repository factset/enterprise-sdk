...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/security-explanation/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/security-explanation/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/SecurityExplanation/2.2.0 (${process.platform}; node ${process.version})`
        };
