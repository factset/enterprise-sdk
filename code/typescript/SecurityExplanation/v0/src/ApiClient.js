...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/security-explanation/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/security-explanation/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/SecurityExplanation/0.10.1 (${process.platform}; node ${process.version})`
        };
