...
[![npm](https://img.shields.io/badge/npm-v0.10.1-orange)](https://www.npmjs.com/package/@factset/sdk-securityexplanation/v/0.10.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-securityexplanation@0.10.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-securityexplanation@0.10.1
```
...
*securityexplanation.SecurityExplanationApi* | [**getExplanation**](docs/SecurityExplanationApi.md#getExplanation) | **GET** /explanation | Request explanation


## Documentation for Models

 - [securityexplanation.ClientErrorResponse](docs/ClientErrorResponse.md)
 - [securityexplanation.Error](docs/Error.md)
