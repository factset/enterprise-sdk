...
[![npm](https://img.shields.io/badge/npm-v0.40.0-orange)](https://www.npmjs.com/package/@factset/sdk-companylogo/v/0.40.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-companylogo@0.40.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-companylogo@0.40.0
```
...
------------ | ------------- | ------------- | -------------
*companylogo.CompanyLogosApi* | [**postCompanyLogo**](docs/CompanyLogosApi.md#postCompanyLogo) | **POST** /company/logo | Retrieves logos for one or more publicly traded companies.


## Documentation for Models

 - [companylogo.CompanyLogoItemObject](docs/CompanyLogoItemObject.md)
 - [companylogo.CompanyLogoObject](docs/CompanyLogoObject.md)
 ...
 - [companylogo.PostCompanyLogoRequest](docs/PostCompanyLogoRequest.md)
 - [companylogo.PostCompanyLogoRequestData](docs/PostCompanyLogoRequestData.md)
 - [companylogo.PostCompanyLogoRequestDataIdentifier](docs/PostCompanyLogoRequestDataIdentifier.md)
 - [companylogo.PostCompanyLogoRequestDataSize](docs/PostCompanyLogoRequestDataSize.md)
 - [companylogo.PostCompanyLogoRequestDataSizeCustom](docs/PostCompanyLogoRequestDataSizeCustom.md)
 - [companylogo.PostCompanyLogoRequestMeta](docs/PostCompanyLogoRequestMeta.md)
