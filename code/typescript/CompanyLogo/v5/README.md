...
[![npm](https://img.shields.io/badge/npm-v0.41.0-orange)](https://www.npmjs.com/package/@factset/sdk-companylogo/v/0.41.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-companylogo@0.41.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-companylogo@0.41.0
```
...
------------ | ------------- | ------------- | -------------
*companylogo.CompanyLogosApi* | [**postCompanyLogo**](docs/CompanyLogosApi.md#postCompanyLogo) | **POST** /logo/list | Retrieves logos for one or more publicly traded companies.
