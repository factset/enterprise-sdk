...
import CompanyLogoItemObject from './CompanyLogoItemObject';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data') && obj['data'] === undefined) {
                obj['data'] = ApiClient.convertToType(data['data'], [CompanyLogoItemObject]);
            }
...
/**
 * Company logos.
 * @member {Array.<module:model/CompanyLogoItemObject>} data
 */
