...
[![npm](https://img.shields.io/badge/npm-v0.12.1-orange)](https://www.npmjs.com/package/@factset/sdk-companylogo/v/0.12.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-companylogo@0.12.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-companylogo@0.12.1
```
