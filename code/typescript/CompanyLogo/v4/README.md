...
[![npm](https://img.shields.io/badge/npm-v0.20.0-orange)](https://www.npmjs.com/package/@factset/sdk-companylogo/v/0.20.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-companylogo@0.20.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-companylogo@0.20.0
```
