...
[![npm](https://img.shields.io/badge/npm-v0.20.2-orange)](https://www.npmjs.com/package/@factset/sdk-companylogo/v/0.20.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-companylogo@0.20.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-companylogo@0.20.2
```
...
------------ | ------------- | ------------- | -------------
*companylogo.CompanyApi* | [**getCompanyLogoGet**](docs/CompanyApi.md#getCompanyLogoGet) | **GET** /company/logo | List of URLs of company logos.


## Documentation for Models

 - [companylogo.ErrorDetail](docs/ErrorDetail.md)
 - [companylogo.ErrorResponse](docs/ErrorResponse.md)
 - [companylogo.ErrorResponseMeta](docs/ErrorResponseMeta.md)
 - [companylogo.ErrorResponseMetaStatus](docs/ErrorResponseMetaStatus.md)
