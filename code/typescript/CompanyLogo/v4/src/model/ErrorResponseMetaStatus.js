...
/**
 * The ErrorResponseMetaStatus model module.
 * @module model/ErrorResponseMetaStatus
 */
class ErrorResponseMetaStatus {
    /**
     * Constructs a new <code>ErrorResponseMetaStatus</code>.
     * Status information
     * @alias module:model/ErrorResponseMetaStatus
     * @param code {Number} HTTP status code
     */
    constructor(code) { 
        
        ErrorResponseMetaStatus.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>ErrorResponseMetaStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorResponseMetaStatus} obj Optional instance to populate.
     * @return {module:model/ErrorResponseMetaStatus} The populated <code>ErrorResponseMetaStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorResponseMetaStatus();
 ...
 * @member {Number} code
 */
ErrorResponseMetaStatus.prototype['code'] = undefined;
...
export default ErrorResponseMetaStatus;
