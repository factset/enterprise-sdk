...
```shell
npm install @factset/sdk-utils @factset/sdk-exchangedatafeedsnapshotapientireexchange@0.21.4
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-exchangedatafeedsnapshotapientireexchange@0.21.4
```
