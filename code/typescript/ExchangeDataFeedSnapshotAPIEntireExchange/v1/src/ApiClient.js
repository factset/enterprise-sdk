...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/bulk-documents/exchange-snapshot') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/bulk-documents/exchange-snapshot
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ExchangeDataFeedSnapshotAPIEntireExchange/0.22.0 (${process.platform}; node ${process.version})`
        };
