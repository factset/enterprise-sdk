...
/**
 * The ListSchema200ResponseMeta model module.
 * @module model/ListSchema200ResponseMeta
 */
class ListSchema200ResponseMeta {
    /**
     * Constructs a new <code>ListSchema200ResponseMeta</code>.
     * @alias module:model/ListSchema200ResponseMeta
     */
    constructor() { 
        
        ListSchema200ResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSchema200ResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSchema200ResponseMeta} obj Optional instance to populate.
     * @return {module:model/ListSchema200ResponseMeta} The populated <code>ListSchema200ResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSchema200ResponseMeta();
 ...
 */
ListSchema200ResponseMeta.prototype['pagination'] = undefined;

/**
 * @member {module:model/Partial} partial
 */
ListSchema200ResponseMeta.prototype['partial'] = undefined;
...
export default ListSchema200ResponseMeta;
