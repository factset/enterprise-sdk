...
import ListSchema200ResponseData from './ListSchema200ResponseData';
import ListSchema200ResponseMeta from './ListSchema200ResponseMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ListSchema200ResponseData]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ListSchema200ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/ListSchema200ResponseData>} data
 */
ListSchema200Response.prototype['data'] = undefined;

/**
 * @member {module:model/ListSchema200ResponseMeta} meta
 */
ListSchema200Response.prototype['meta'] = undefined;
