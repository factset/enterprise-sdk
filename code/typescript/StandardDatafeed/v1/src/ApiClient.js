...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/bulk-documents/sdf') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/bulk-documents/sdf
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/StandardDatafeed/0.21.1'
        };
