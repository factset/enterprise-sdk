...
import ListFileObjectObject from './ListFileObjectObject';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('relatedBundles')) {
                obj['relatedBundles'] = ApiClient.convertToType(data['relatedBundles'], [ListFileObjectObject]);
            }
 ...
 * @member {String} type
 */
ListFileObject.prototype['type'] = undefined;

/**
 * Bundle name.
 * @member {String} bundle
 */
ListFileObject.prototype['bundle'] = undefined;

/**
 * Schema name.
 * @member {String} schema
 */
ListFileObject.prototype['schema'] = undefined;

/**
 * Full or delta file version.
 * @member {String} version
 */
ListFileObject.prototype['version'] = undefined;

/**
 * Bundles related to the version number.
 * @member {Array.<module:model/ListFileObjectObject>} relatedBundles
 */
ListFileObject.prototype['relatedBundles'] = undefined;

/**
 * Timestamp of when the bundle was generated.
 * @member {Date} timestamp
 */
ListFileObject.prototype['timestamp'] = undefined;
