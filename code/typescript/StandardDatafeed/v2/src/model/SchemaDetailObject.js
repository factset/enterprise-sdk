...
/**
 * The SchemaDetailObject model module.
 * @module model/SchemaDetailObject
 */
class SchemaDetailObject {
    /**
     * Constructs a new <code>SchemaDetailObject</code>.
     * @alias module:model/SchemaDetailObject
     */
    constructor() { 
        
        SchemaDetailObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SchemaDetailObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SchemaDetailObject} obj Optional instance to populate.
     * @return {module:model/SchemaDetailObject} The populated <code>SchemaDetailObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SchemaDetailObject();
 ...
 */
SchemaDetailObject.prototype['schema'] = undefined;

/**
 * Version number of the schema.
 * @member {Number} version
 */
SchemaDetailObject.prototype['version'] = undefined;

/**
 * Pre-signed URL pointing to the location from where the schema details can be downloaded.
 * @member {String} url
 */
SchemaDetailObject.prototype['url'] = undefined;

/**
 * Timestamp of when the schema version was last updated.
 * @member {Date} timestamp
 */
SchemaDetailObject.prototype['timestamp'] = undefined;
...
export default SchemaDetailObject;
