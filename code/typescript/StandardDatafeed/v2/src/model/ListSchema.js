...
import ListSchemaObject from './ListSchemaObject';

/**
 * The ListSchema model module.
 * @module model/ListSchema
 */
class ListSchema {
    /**
     * Constructs a new <code>ListSchema</code>.
     * Schema List Object.
     * @alias module:model/ListSchema
     * @param data {Array.<module:model/ListSchemaObject>} Schema List Data Array.
     */
    constructor(data) { 
        
        ListSchema.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ListSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSchema} obj Optional instance to populate.
     * @return {module:model/ListSchema} The populated <code>ListSchema</code> instance.
     */
 ...
 * @member {Array.<module:model/ListSchemaObject>} data
 */
ListSchema.prototype['data'] = undefined;
