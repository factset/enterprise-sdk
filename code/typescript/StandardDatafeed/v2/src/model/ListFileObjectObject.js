...
/**
 * The ListFileObjectObject model module.
 * @module model/ListFileObjectObject
 */
class ListFileObjectObject {
    /**
     * Constructs a new <code>ListFileObjectObject</code>.
     * @alias module:model/ListFileObjectObject
     */
    constructor() { 
        
        ListFileObjectObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFileObjectObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFileObjectObject} obj Optional instance to populate.
     * @return {module:model/ListFileObjectObject} The populated <code>ListFileObjectObject</code> instance.
     */
 ...
 */
ListFileObjectObject.prototype['bundle'] = undefined;

/**
 * Bundle version.
 * @member {String} version
 */
ListFileObjectObject.prototype['version'] = undefined;
...
export default ListFileObjectObject;
