...
/**
 * The HistoricalFileObjectObject model module.
 * @module model/HistoricalFileObjectObject
 */
class HistoricalFileObjectObject {
    /**
     * Constructs a new <code>HistoricalFileObjectObject</code>.
     * @alias module:model/HistoricalFileObjectObject
     */
    constructor() { 
        
        HistoricalFileObjectObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HistoricalFileObjectObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HistoricalFileObjectObject} obj Optional instance to populate.
     * @return {module:model/HistoricalFileObjectObject} The populated <code>HistoricalFileObjectObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HistoricalFileObjectObject();
 ...
 */
HistoricalFileObjectObject.prototype['bundle'] = undefined;

/**
 * Bundle version.
 * @member {String} version
 */
HistoricalFileObjectObject.prototype['version'] = undefined;
...
export default HistoricalFileObjectObject;
