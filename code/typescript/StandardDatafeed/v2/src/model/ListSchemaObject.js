...
/**
 * The ListSchemaObject model module.
 * @module model/ListSchemaObject
 */
class ListSchemaObject {
    /**
     * Constructs a new <code>ListSchemaObject</code>.
     * @alias module:model/ListSchemaObject
     */
    constructor() { 
        
        ListSchemaObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSchemaObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSchemaObject} obj Optional instance to populate.
     * @return {module:model/ListSchemaObject} The populated <code>ListSchemaObject</code> instance.
     */
 ...
 */
ListSchemaObject.prototype['schemaName'] = undefined;
...
export default ListSchemaObject;
