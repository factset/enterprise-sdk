...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/bulk-documents/sdf/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/bulk-documents/sdf/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/StandardDatafeed/2.0.1 (${process.platform}; node ${process.version})`
        };
