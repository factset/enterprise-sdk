...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/ofs/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/ofs/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OpenFactSetMarketplace/3.0.0 (${process.platform}; node ${process.version})`
        };
