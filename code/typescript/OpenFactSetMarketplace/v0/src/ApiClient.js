...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/ofs/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/ofs/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OpenFactSetMarketplace/0.0.1 (${process.platform}; node ${process.version})`
        };
