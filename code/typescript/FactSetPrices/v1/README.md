...
[![npm](https://img.shields.io/badge/npm-v3.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetprices/v/3.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetprices@3.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetprices@3.0.0
```
...
```javascript
const { ApiClient } = require('@factset/sdk-factsetprices');
...
## Documentation for Models
 ...
 - [factsetprices.BatchOne](docs/BatchOne.md)
 - [factsetprices.BatchResult](docs/BatchResult.md)
