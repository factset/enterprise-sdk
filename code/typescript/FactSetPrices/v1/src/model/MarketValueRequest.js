    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('batch') && obj['batch'] === undefined) {
                obj['batch'] = BatchOne.constructFromObject(data['batch']);
            }
...
/**
 * @member {module:model/BatchOne} batch
 */
MarketValueRequest.prototype['batch'] = undefined;
