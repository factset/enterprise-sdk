...
class BatchResult {
     ...
     * @implements module:model/MarketValue
     */
    constructor() { 
        Price.initialize(this);MarketValue.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            try {
              obj = Price.constructFromObject(data, obj);
            } catch(error) {}
            try {
              obj = MarketValue.constructFromObject(data, obj);
            } catch(error) {}
 ...
 * @member {Date} adjDate
 */
BatchResult.prototype['adjDate'] = undefined;
 ...
 */
BatchResult.prototype['priceOpen'] = undefined;
 ...
 */
BatchResult.prototype['priceHigh'] = undefined;
 ...
 */
BatchResult.prototype['entityMarketValue'] = undefined;
 ...
 */
BatchResult.prototype['entityMarketValueExNonTraded'] = undefined;
 ...
 */
BatchResult.prototype['securityMarketValue'] = undefined;
...
// Implement MarketValue interface:
/**
 * Factset Regional Security Identifier. Six alpha-numeric characters, excluding vowels, with an -R suffix (XXXXXX-R). Identifies the security's best regional security data series per currency. For equities, all primary listings per region and currency are allocated a regional-level permanent identifier. The regional-level permanent identifier will be available once a SEDOL representing the region/currency has been allocated and the identifiers are on FactSet.
 * @member {String} fsymId
 */
