...
class DividendsRequest {
    /**
     * Constructs a new <code>DividendsRequest</code>.
     * Dividends Request Body
     * @alias module:model/DividendsRequest
    ...
    constructor(ids) { 
        ...
        DividendsRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>DividendsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DividendsRequest} obj Optional instance to populate.
     * @return {module:model/DividendsRequest} The populated <code>DividendsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DividendsRequest();
 ...
 */
DividendsRequest.prototype['ids'] = undefined;
 ...
 */
DividendsRequest.prototype['startDate'] = undefined;
 ...
 */
DividendsRequest.prototype['endDate'] = undefined;
 ...
 */
DividendsRequest.prototype['currency'] = undefined;

/**
 * @member {module:model/Adjust} adjust
 */
DividendsRequest.prototype['adjust'] = undefined;
...
export default DividendsRequest;
