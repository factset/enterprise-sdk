...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/procuretopay/provisioning') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/procuretopay/provisioning
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/ProcuretoPayProvisioning/0.9.1'
        };
