...
/**
 * The SupportedStatDetailsSecurityGroupMethod model module.
 * @module model/SupportedStatDetailsSecurityGroupMethod
 */
class SupportedStatDetailsSecurityGroupMethod {
    /**
     * Constructs a new <code>SupportedStatDetailsSecurityGroupMethod</code>.
    ...
    constructor(name, sqrt) { 
        ...
        SupportedStatDetailsSecurityGroupMethod.initialize(this, name, sqrt);
    }
    ...
    /**
     * Constructs a <code>SupportedStatDetailsSecurityGroupMethod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupportedStatDetailsSecurityGroupMethod} obj Optional instance to populate.
     * @return {module:model/SupportedStatDetailsSecurityGroupMethod} The populated <code>SupportedStatDetailsSecurityGroupMethod</code> instance.
     */
 ...
 * @member {module:model/SupportedStatDetailsSecurityGroupMethod.NameEnum} name
 */
SupportedStatDetailsSecurityGroupMethod.prototype['name'] = undefined;

/**
 * Indicates the weights stat used to weight the security groups, applicable to weighted average group methods only.
 * @member {module:model/SupportedStatDetailsSecurityGroupMethod.WeightsEnum} weights
 */
SupportedStatDetailsSecurityGroupMethod.prototype['weights'] = undefined;
 ...
 * @member {module:model/SupportedStatDetailsSecurityGroupMethod.WeightingEnum} weighting
 */
SupportedStatDetailsSecurityGroupMethod.prototype['weighting'] = undefined;
 ...
 * @member {Boolean} sqrt
 */
SupportedStatDetailsSecurityGroupMethod.prototype['sqrt'] = undefined;
 ...
 * @readonly
 */
SupportedStatDetailsSecurityGroupMethod['NameEnum'] = {
 ...
 * @readonly
 */
SupportedStatDetailsSecurityGroupMethod['WeightsEnum'] = {
 ...
 * @readonly
 */
SupportedStatDetailsSecurityGroupMethod['WeightingEnum'] = {
...
export default SupportedStatDetailsSecurityGroupMethod;
