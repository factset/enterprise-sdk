...
[![npm](https://img.shields.io/badge/npm-v6.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-openrisk/v/6.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-openrisk@6.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-openrisk@6.0.0
```
