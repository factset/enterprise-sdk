...
```shell
npm install @factset/sdk-utils @factset/sdk-openrisk@2.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-openrisk@2.0.0
```
...
## Documentation for Models
 ...
 - [openrisk.SupportedStatDetailsLevels](docs/SupportedStatDetailsLevels.md)
