...
import OrdersResponseMeta from './OrdersResponseMeta';
...
/**
 * List of Orders
 * @member {Array.<module:model/OrderSearch>} orders
 */
OrdersResponse.prototype['orders'] = undefined;

/**
 * @member {module:model/OrdersResponseMeta} meta
 */
OrdersResponse.prototype['meta'] = undefined;
