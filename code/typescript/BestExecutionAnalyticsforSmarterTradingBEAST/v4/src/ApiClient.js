...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/beast/v4') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/beast/v4
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/BestExecutionAnalyticsforSmarterTradingBEAST/0.0.4 (${process.platform}; node ${process.version})`
        };
