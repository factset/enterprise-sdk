...
export default class OutliersApi {
    ...
    */
     ...
     * @param {module:model/String} metricType The benchmark to measure outlier metrics
     ...
     * @param {Number} opts.minPercent The winsorization min percentile values defining orders as outliers (default to 2.5)
     * @param {Number} opts.maxPercent The winsorization max percentile values defining orders as outliers (default to 97.5)
     * @param {Number} opts.binScalar number of bins to distribute the orders (default to 51)
     ...
     * @param {String} opts.country The two character ISO country code of the trading region, like US. EMEA is used for the European trading region
     * @param {String} opts.trader Optionally specify a trader to filter by, Example : Ryan
     * @param {Number} opts.deviation The winsorization deviation - standard deviation to define orders as outlier (default to 2)
     * @param {Number} opts.binScalar number of bins to distribute the orders (default to 51)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OutlierResponseRoot} and HTTP response
     */
