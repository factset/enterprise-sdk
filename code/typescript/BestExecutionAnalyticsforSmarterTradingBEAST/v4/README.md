...
[![npm](https://img.shields.io/badge/npm-v0.4.0-orange)](https://www.npmjs.com/package/@factset/sdk-bestexecutionanalyticsforsmartertradingbeast/v/0.4.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-bestexecutionanalyticsforsmartertradingbeast@0.4.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-bestexecutionanalyticsforsmartertradingbeast@0.4.0
```
...
const securityIds = ["FDS-US-USD","AAPL-US","MX-CA"]; // [String] | ISIN for European or India securities, otherwise TICKER. Either FDS-US-USD or FDS-US works.
...
## Documentation for Models
 ...
 - [bestexecutionanalyticsforsmartertradingbeast.CostEstimate](docs/CostEstimate.md)
 - [bestexecutionanalyticsforsmartertradingbeast.CostEstimates](docs/CostEstimates.md)
 ...
 - [bestexecutionanalyticsforsmartertradingbeast.OrderDetail](docs/OrderDetail.md)
 ...
 - [bestexecutionanalyticsforsmartertradingbeast.OrderSearch](docs/OrderSearch.md)
 - [bestexecutionanalyticsforsmartertradingbeast.OrdersResponse](docs/OrdersResponse.md)
 - [bestexecutionanalyticsforsmartertradingbeast.OrdersResponseMeta](docs/OrdersResponseMeta.md)
