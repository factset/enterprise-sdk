...
[![npm](https://img.shields.io/badge/npm-v0.1.1-orange)](https://www.npmjs.com/package/@factset/sdk-bestexecutionanalyticsforsmartertradingbeast/v/0.1.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-bestexecutionanalyticsforsmartertradingbeast@0.1.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-bestexecutionanalyticsforsmartertradingbeast@0.1.1
```
...
*bestexecutionanalyticsforsmartertradingbeast.OutliersApi* | [**getOutlierMetricsByPercent**](docs/OutliersApi.md#getOutlierMetricsByPercent) | **GET** /tca/outlier/metrics-by-percent | Get Outlier metrics by percent
