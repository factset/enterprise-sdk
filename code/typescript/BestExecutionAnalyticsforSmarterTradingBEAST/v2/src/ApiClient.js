...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/beast/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/beast/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/BestExecutionAnalyticsforSmarterTradingBEAST/0.2.0 (${process.platform}; node ${process.version})`
        };
