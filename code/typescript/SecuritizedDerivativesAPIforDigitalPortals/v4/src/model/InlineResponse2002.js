...
import PostSecuritizedDerivativeIssuerSearchDataItems from './PostSecuritizedDerivativeIssuerSearchDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostSecuritizedDerivativeIssuerSearchDataItems]);
            }
 ...
 * @member {Array.<module:model/PostSecuritizedDerivativeIssuerSearchDataItems>} data
 */
