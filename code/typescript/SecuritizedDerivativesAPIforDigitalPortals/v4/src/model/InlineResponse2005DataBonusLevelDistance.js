...
import InlineResponse2005DataBonusLevelDistanceAbsolute from './InlineResponse2005DataBonusLevelDistanceAbsolute';
import InlineResponse2005DataBonusLevelDistanceRelative from './InlineResponse2005DataBonusLevelDistanceRelative';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('absolute')) {
                obj['absolute'] = InlineResponse2005DataBonusLevelDistanceAbsolute.constructFromObject(data['absolute']);
            }
            if (data.hasOwnProperty('relative')) {
                obj['relative'] = InlineResponse2005DataBonusLevelDistanceRelative.constructFromObject(data['relative']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2005DataBonusLevelDistanceAbsolute} absolute
 */
InlineResponse2005DataBonusLevelDistance.prototype['absolute'] = undefined;

/**
 * @member {module:model/InlineResponse2005DataBonusLevelDistanceRelative} relative
 */
