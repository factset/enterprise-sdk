...
import InlineResponse2005DataKnockOutDistanceAbsolute from './InlineResponse2005DataKnockOutDistanceAbsolute';
import InlineResponse2005DataKnockOutDistanceRelative from './InlineResponse2005DataKnockOutDistanceRelative';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('absolute')) {
                obj['absolute'] = InlineResponse2005DataKnockOutDistanceAbsolute.constructFromObject(data['absolute']);
            }
            if (data.hasOwnProperty('relative')) {
                obj['relative'] = InlineResponse2005DataKnockOutDistanceRelative.constructFromObject(data['relative']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2005DataKnockOutDistanceAbsolute} absolute
 */
InlineResponse2005DataKnockOutDistance.prototype['absolute'] = undefined;

/**
 * @member {module:model/InlineResponse2005DataKnockOutDistanceRelative} relative
 */
