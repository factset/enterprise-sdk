...
import PostSecuritizedDerivativeNotationScreenerSearchDataItems from './PostSecuritizedDerivativeNotationScreenerSearchDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostSecuritizedDerivativeNotationScreenerSearchDataItems]);
            }
...
/**
 * List of notations.
 * @member {Array.<module:model/PostSecuritizedDerivativeNotationScreenerSearchDataItems>} data
 */
