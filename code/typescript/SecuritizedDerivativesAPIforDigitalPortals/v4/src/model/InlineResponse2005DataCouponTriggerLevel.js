...
import InlineResponse2005DataCouponTriggerLevelCashFlow from './InlineResponse2005DataCouponTriggerLevelCashFlow';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cashFlow')) {
                obj['cashFlow'] = InlineResponse2005DataCouponTriggerLevelCashFlow.constructFromObject(data['cashFlow']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse2005DataCouponTriggerLevelCashFlow} cashFlow
 */
