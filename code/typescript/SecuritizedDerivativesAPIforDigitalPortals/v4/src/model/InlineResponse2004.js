...
import PostSecuritizedDerivativeNotationRankingIntradayListDataItems from './PostSecuritizedDerivativeNotationRankingIntradayListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostSecuritizedDerivativeNotationRankingIntradayListDataItems]);
            }
...
/**
 * List of notations.
 * @member {Array.<module:model/PostSecuritizedDerivativeNotationRankingIntradayListDataItems>} data
 */
