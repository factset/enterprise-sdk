...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/engines/fi/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/engines/fi/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FixedIncomeCalculation/2.0.1 (${process.platform}; node ${process.version})`
        };
