...
class FISecurity {
     ...
     */
    constructor(calcFromMethod, calcFromValue, symbol) { 
        
        FISecurity.initialize(this, calcFromMethod, calcFromValue, symbol);
    }
     ...
     */
    static initialize(obj, calcFromMethod, calcFromValue, symbol) { 
