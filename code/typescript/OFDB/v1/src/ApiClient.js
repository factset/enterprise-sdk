...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/ofdb') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/ofdb
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/OFDB/0.21.1'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.factset.com/analytics/ofdb",
