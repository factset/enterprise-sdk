...
[![npm](https://img.shields.io/badge/npm-v0.33.2-orange)](https://www.npmjs.com/package/@factset/sdk-ofdb/v/0.33.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-ofdb@0.33.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-ofdb@0.33.2
```
