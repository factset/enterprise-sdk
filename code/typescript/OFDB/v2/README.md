...
[![npm](https://img.shields.io/badge/npm-v0.33.0-orange)](https://www.npmjs.com/package/@factset/sdk-ofdb/v/0.33.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-ofdb@0.33.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-ofdb@0.33.0
```
