...
```shell
npm install @factset/sdk-utils @factset/sdk-ofdb@0.30.5
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-ofdb@0.30.5
```
...
*ofdb.DeleteApi* | [**getResourceDateFromSymbol**](docs/DeleteApi.md#getResourceDateFromSymbol) | **DELETE** /database/{path}/dates/{date}/symbols/{symbol}/jobs/{id} | 
...
*ofdb.LongRunningApi* | [**getResourceAudit**](docs/LongRunningApi.md#getResourceAudit) | **GET** /database/{path}/audit/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceBulkDelete**](docs/LongRunningApi.md#getResourceBulkDelete) | **GET** /database/{path}/delete/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceData**](docs/LongRunningApi.md#getResourceData) | **GET** /database/{path}/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceDatabase**](docs/LongRunningApi.md#getResourceDatabase) | **GET** /database/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceDate**](docs/LongRunningApi.md#getResourceDate) | **GET** /database/{path}/dates/{date}/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceDates**](docs/LongRunningApi.md#getResourceDates) | **GET** /database/{path}/dates/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceFields**](docs/LongRunningApi.md#getResourceFields) | **GET** /database/{path}/fields/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceStats**](docs/LongRunningApi.md#getResourceStats) | **GET** /database/{path}/stats/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceSymbol**](docs/LongRunningApi.md#getResourceSymbol) | **GET** /database/{path}/symbols/{symbol}/jobs/{id} | 
*ofdb.LongRunningApi* | [**getResourceSymbols**](docs/LongRunningApi.md#getResourceSymbols) | **GET** /database/{path}/symbols/jobs/{id} | 
