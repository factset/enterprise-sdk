...
[![npm](https://img.shields.io/badge/npm-v0.34.1-orange)](https://www.npmjs.com/package/@factset/sdk-ofdb/v/0.34.1)
...
```shell
npm install @factset/sdk-utils @factset/sdk-ofdb@0.34.1
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-ofdb@0.34.1
```
