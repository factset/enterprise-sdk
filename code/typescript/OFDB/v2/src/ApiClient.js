...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/ofdb/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/ofdb/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OFDB/0.32.0 (${process.platform}; node ${process.version})`
        };
