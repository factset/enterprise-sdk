...
import BulkDeleteRespItem from './BulkDeleteRespItem';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [BulkDeleteRespItem]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/BulkDeleteRespItem>} data
 */
