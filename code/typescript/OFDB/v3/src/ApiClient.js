...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/ofdb/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/ofdb/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OFDB/0.0.3 (${process.platform}; node ${process.version})`
        };
