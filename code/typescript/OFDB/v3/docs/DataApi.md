...
------------- | ------------- | -------------
[**getData**](DataApi.md#getData) | **POST** /database/data/get | 
[**getResourceGetData**](DataApi.md#getResourceGetData) | **GET** /database/job/result/data/get | 



## getData

> InlineResponse201 getData(opts)
...
```javascript
const { ApiClient, DataApi } = require('@factset/sdk-ofdb');
...
const opts = {
  ...
  'sortFieldName': "sortFieldName_example", // String | Can specify the name of field with respect to which user wants to sort data   Note: The request will respond with 400, If a field which doesn't exist in the database is requested
 ...
 **sortFieldName** | **String**| Can specify the name of field with respect to which user wants to sort data   Note: The request will respond with 400, If a field which doesn&#39;t exist in the database is requested | [optional] 
...
> InlineResponse2006 getResourceGetData(jobId)
...
// Call api endpoint
apiInstance.getResourceGetData(jobId).then(
  data => {
