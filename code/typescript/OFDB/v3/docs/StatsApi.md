...
------------- | ------------- | -------------
[**getResourceGetStats**](StatsApi.md#getResourceGetStats) | **GET** /database/job/result/stats/get | 
[**getStats**](StatsApi.md#getStats) | **POST** /database/stats/get | 



## getResourceGetStats

> InlineResponse2001 getResourceGetStats(jobId)
...
```javascript
const { ApiClient, StatsApi } = require('@factset/sdk-ofdb');
...
const apiInstance = new StatsApi();
const jobId = "jobId_example"; // String | jobId generated from the audit endpoint.

// Call api endpoint
apiInstance.getResourceGetStats(jobId).then(
  data => {
...
> InlineResponse201 getStats(opts)
...
// Call api endpoint
apiInstance.getStats(opts).then(
  data => {
