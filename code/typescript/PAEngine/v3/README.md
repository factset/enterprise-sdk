...
[![npm](https://img.shields.io/badge/npm-v4.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-paengine/v/4.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-paengine@4.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-paengine@4.0.0
```
...
*paengine.CalendarApi* | [**getPACalendars**](docs/CalendarApi.md#getPACalendars) | **GET** /analytics/engines/pa/v3/calendars | Get PA calendars
...
*paengine.ConfigurationsApi* | [**getPACommentaryConfigurations**](docs/ConfigurationsApi.md#getPACommentaryConfigurations) | **GET** /analytics/engines/pa/v3/commentary/configurations | Get PA commentary configurations in a directory
...
## Documentation for Models
 ...
 - [paengine.PACalendar](docs/PACalendar.md)
 - [paengine.PACalendarRoot](docs/PACalendarRoot.md)
 - [paengine.PACommentary](docs/PACommentary.md)
 - [paengine.PACommentaryConfigurationSummary](docs/PACommentaryConfigurationSummary.md)
 - [paengine.PACommentaryConfigurationSummaryRoot](docs/PACommentaryConfigurationSummaryRoot.md)
 ...
 - [paengine.PACommentaryParameters](docs/PACommentaryParameters.md)
 - [paengine.PACommentaryParametersRoot](docs/PACommentaryParametersRoot.md)
