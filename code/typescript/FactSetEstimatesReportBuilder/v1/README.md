...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetestimatesreportbuilder@1.0.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetestimatesreportbuilder@1.0.2
```
