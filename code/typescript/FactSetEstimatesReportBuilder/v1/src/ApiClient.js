...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/report/estimates/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/report/estimates/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetEstimatesReportBuilder/2.0.0 (${process.platform}; node ${process.version})`
        };
