...
[![npm](https://img.shields.io/badge/npm-v0.20.2-orange)](https://www.npmjs.com/package/@factset/sdk-realtimenews/v/0.20.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-realtimenews@0.20.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-realtimenews@0.20.2
```
