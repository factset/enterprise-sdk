...
import GetBasicAssetClassListDataItems from './GetBasicAssetClassListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicAssetClassListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetBasicAssetClassListDataItems>} data
 */
