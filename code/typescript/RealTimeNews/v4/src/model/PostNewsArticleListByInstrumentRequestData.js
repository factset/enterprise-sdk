...
import PostNewsArticleListByInstrumentRequestDataFilter from './PostNewsArticleListByInstrumentRequestDataFilter';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('filter')) {
                obj['filter'] = PostNewsArticleListByInstrumentRequestDataFilter.constructFromObject(data['filter']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/PostNewsArticleListByInstrumentRequestDataFilter} filter
 */
