...
import GetNewsArticleTypeListDataItems from './GetNewsArticleTypeListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetNewsArticleTypeListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetNewsArticleTypeListDataItems>} data
 */
