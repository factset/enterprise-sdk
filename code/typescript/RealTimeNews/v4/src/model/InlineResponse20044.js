...
import PostNewsArticleListDataItems from './PostNewsArticleListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostNewsArticleListDataItems]);
            }
 ...
 * @member {Array.<module:model/PostNewsArticleListDataItems>} data
 */
