...
import PostBasicValueUnitCurrencyListDataItems from './PostBasicValueUnitCurrencyListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostBasicValueUnitCurrencyListDataItems]);
            }
...
/**
 * List of currencies.
 * @member {Array.<module:model/PostBasicValueUnitCurrencyListDataItems>} data
 */
