...
import GetBasicRegionCountryListDataItems from './GetBasicRegionCountryListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicRegionCountryListDataItems]);
            }
...
/**
 * List of countries.
 * @member {Array.<module:model/GetBasicRegionCountryListDataItems>} data
 */
