...
import GetBasicLanguageListDataItems from './GetBasicLanguageListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicLanguageListDataItems]);
            }
...
/**
 * List of languages.
 * @member {Array.<module:model/GetBasicLanguageListDataItems>} data
 */
