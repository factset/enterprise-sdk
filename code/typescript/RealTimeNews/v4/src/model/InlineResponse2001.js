...
import PostBasicBackgroundTextTypeListDataItems from './PostBasicBackgroundTextTypeListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostBasicBackgroundTextTypeListDataItems]);
            }
 ...
 * @member {Array.<module:model/PostBasicBackgroundTextTypeListDataItems>} data
 */
