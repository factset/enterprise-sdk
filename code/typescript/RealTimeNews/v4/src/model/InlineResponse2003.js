...
import PostBasicDeliveryListDataItems from './PostBasicDeliveryListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostBasicDeliveryListDataItems]);
            }
...
/**
 * List of deliveries.
 * @member {Array.<module:model/PostBasicDeliveryListDataItems>} data
 */
