...
import GetCategorySystemTypeListDataItems from './GetCategorySystemTypeListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetCategorySystemTypeListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetCategorySystemTypeListDataItems>} data
 */
