...
import PostBasicValueUnitCurrencyMainListDataItems from './PostBasicValueUnitCurrencyMainListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostBasicValueUnitCurrencyMainListDataItems]);
            }
 ...
 * @member {Array.<module:model/PostBasicValueUnitCurrencyMainListDataItems>} data
 */
