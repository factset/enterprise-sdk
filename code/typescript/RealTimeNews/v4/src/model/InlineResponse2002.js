...
import GetBasicBenchmarkTypeListDataItems from './GetBasicBenchmarkTypeListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicBenchmarkTypeListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetBasicBenchmarkTypeListDataItems>} data
 */
