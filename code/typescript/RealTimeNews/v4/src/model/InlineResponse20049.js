...
import PostNewsArticleSearchByTextDataItems from './PostNewsArticleSearchByTextDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostNewsArticleSearchByTextDataItems]);
            }
 ...
 * @member {Array.<module:model/PostNewsArticleSearchByTextDataItems>} data
 */
