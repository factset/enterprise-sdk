...
import GetBasicValueUnitAlternativeListDataItems from './GetBasicValueUnitAlternativeListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicValueUnitAlternativeListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetBasicValueUnitAlternativeListDataItems>} data
 */
