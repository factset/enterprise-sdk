...
import PostNewsPublisherSearchByNameDataItems from './PostNewsPublisherSearchByNameDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostNewsPublisherSearchByNameDataItems]);
            }
...
/**
 * List of publishers.
 * @member {Array.<module:model/PostNewsPublisherSearchByNameDataItems>} data
 */
 ...
 */
InlineResponse20057.prototype['meta'] = undefined;
