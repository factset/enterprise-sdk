...
import InlineResponse20044Meta from './InlineResponse20044Meta';
import PostNewsArticleListByMediaKindDataItems from './PostNewsArticleListByMediaKindDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostNewsArticleListByMediaKindDataItems]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineResponse20044Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/PostNewsArticleListByMediaKindDataItems>} data
 */
InlineResponse20048.prototype['data'] = undefined;

/**
 * @member {module:model/InlineResponse20044Meta} meta
 */
