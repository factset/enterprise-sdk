...
import GetCategoryDatasetListDataItems from './GetCategoryDatasetListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetCategoryDatasetListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetCategoryDatasetListDataItems>} data
 */
