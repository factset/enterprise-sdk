...
import GetBasicRegionListDataItems from './GetBasicRegionListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicRegionListDataItems]);
            }
...
/**
 * List of regions.
 * @member {Array.<module:model/GetBasicRegionListDataItems>} data
 */
