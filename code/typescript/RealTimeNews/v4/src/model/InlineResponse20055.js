...
import GetNewsPublisherListDataItems from './GetNewsPublisherListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetNewsPublisherListDataItems]);
            }
...
/**
 * List of publishers.
 * @member {Array.<module:model/GetNewsPublisherListDataItems>} data
 */
InlineResponse20055.prototype['data'] = undefined;

/**
 * @member {module:model/InlineResponse2009Meta} meta
 */
InlineResponse20055.prototype['meta'] = undefined;
