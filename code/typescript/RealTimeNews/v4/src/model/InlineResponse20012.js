...
import GetBasicMediaKindListDataItems from './GetBasicMediaKindListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicMediaKindListDataItems]);
            }
...
/**
 * List of media kinds.
 * @member {Array.<module:model/GetBasicMediaKindListDataItems>} data
 */
