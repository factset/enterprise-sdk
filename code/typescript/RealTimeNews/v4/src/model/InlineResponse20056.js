...
import GetNewsPublisherListByDistributorDataItems from './GetNewsPublisherListByDistributorDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetNewsPublisherListByDistributorDataItems]);
            }
...
/**
 * List of publishers.
 * @member {Array.<module:model/GetNewsPublisherListByDistributorDataItems>} data
 */
 ...
 */
InlineResponse20056.prototype['meta'] = undefined;
