...
import GetBasicRegionContinentListDataItems from './GetBasicRegionContinentListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicRegionContinentListDataItems]);
            }
...
/**
 * List of continents.
 * @member {Array.<module:model/GetBasicRegionContinentListDataItems>} data
 */
