...
import PostBasicMicOperatingListDataItems from './PostBasicMicOperatingListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PostBasicMicOperatingListDataItems]);
            }
 ...
 * @member {Array.<module:model/PostBasicMicOperatingListDataItems>} data
 */
