...
import GetNewsDistributorListDataItems from './GetNewsDistributorListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetNewsDistributorListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetNewsDistributorListDataItems>} data
 */
