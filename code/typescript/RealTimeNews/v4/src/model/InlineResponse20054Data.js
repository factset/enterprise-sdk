...
import InlineResponse20054DataDistributor from './InlineResponse20054DataDistributor';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('distributor')) {
                obj['distributor'] = InlineResponse20054DataDistributor.constructFromObject(data['distributor']);
            }
        }
        return obj;
    }
 ...
 * @member {String} name
 */
InlineResponse20054Data.prototype['name'] = undefined;

/**
 * @member {module:model/InlineResponse20054DataDistributor} distributor
 */
InlineResponse20054Data.prototype['distributor'] = undefined;
