...
import GetBasicFrequencyTypeListDataItems from './GetBasicFrequencyTypeListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicFrequencyTypeListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetBasicFrequencyTypeListDataItems>} data
 */
