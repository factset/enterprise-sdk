...
import GetBasicRegionCountryGetByCodeDataSubdivisionsItems from './GetBasicRegionCountryGetByCodeDataSubdivisionsItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('subdivisions')) {
                obj['subdivisions'] = ApiClient.convertToType(data['subdivisions'], [GetBasicRegionCountryGetByCodeDataSubdivisionsItems]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/GetBasicRegionCountryGetByCodeDataSubdivisionsItems>} subdivisions
 */
