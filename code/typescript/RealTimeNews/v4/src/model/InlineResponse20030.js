...
import GetBasicValueUnitCurrencyFractionalListDataItems from './GetBasicValueUnitCurrencyFractionalListDataItems';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetBasicValueUnitCurrencyFractionalListDataItems]);
            }
 ...
 * @member {Array.<module:model/GetBasicValueUnitCurrencyFractionalListDataItems>} data
 */
