...
quotesapifordigitalportals - JavaScript client for @factset/sdk-quotesapifordigitalportals
...
```shell
npm install @factset/sdk-quotesapifordigitalportals --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your @factset/sdk-quotesapifordigitalportals from, and run:
...
## Documentation for Models
 ...
 - [quotesapifordigitalportals.InlineResponse20067Fsym](docs/InlineResponse20067Fsym.md)
 - [quotesapifordigitalportals.InlineResponse20067FsymListing](docs/InlineResponse20067FsymListing.md)
 - [quotesapifordigitalportals.InlineResponse20067FsymRegional](docs/InlineResponse20067FsymRegional.md)
