...
import InlineResponse20072Data from './InlineResponse20072Data';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = InlineResponse20072Data.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/InlineResponse20072Data} data
 */
InlineResponse20072.prototype['data'] = undefined;

/**
 * @member {module:model/InlineResponse200Meta} meta
 */
InlineResponse20072.prototype['meta'] = undefined;
