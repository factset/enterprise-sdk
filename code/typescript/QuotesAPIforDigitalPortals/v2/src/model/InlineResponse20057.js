...
import InlineResponse20057Data from './InlineResponse20057Data';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20057Data]);
            }
...
/**
 * List of instruments.
 * @member {Array.<module:model/InlineResponse20057Data>} data
 */
