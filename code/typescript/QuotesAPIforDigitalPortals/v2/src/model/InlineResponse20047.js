    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20047Data]);
            }
 ...
 * @member {Array.<module:model/InlineResponse20047Data>} data
 */
 ...
 */
InlineResponse20047.prototype['meta'] = undefined;
