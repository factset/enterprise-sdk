...
import InstrumentBenchmarkListData from './InstrumentBenchmarkListData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = InstrumentBenchmarkListData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/InstrumentBenchmarkListData} data
 */
