...
import InlineResponse20056Data from './InlineResponse20056Data';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20056Data]);
            }
...
/**
 * List of instruments.
 * @member {Array.<module:model/InlineResponse20056Data>} data
 */
