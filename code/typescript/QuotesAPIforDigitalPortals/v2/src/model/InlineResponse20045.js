    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20045Data]);
            }
 ...
 * @member {Array.<module:model/InlineResponse20045Data>} data
 */
 ...
 */
InlineResponse20045.prototype['meta'] = undefined;
