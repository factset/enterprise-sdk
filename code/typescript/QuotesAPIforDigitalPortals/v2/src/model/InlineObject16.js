...
import NotationCrossReferenceListByInstrumentData from './NotationCrossReferenceListByInstrumentData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NotationCrossReferenceListByInstrumentData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/NotationCrossReferenceListByInstrumentData} data
 */
InlineObject16.prototype['data'] = undefined;
