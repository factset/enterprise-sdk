...
/**
 * The InlineResponse20072DataRegionalListing model module.
 * @module model/InlineResponse20072DataRegionalListing
 */
class InlineResponse20072DataRegionalListing {
    /**
     * Constructs a new <code>InlineResponse20072DataRegionalListing</code>.
     ...
     * @alias module:model/InlineResponse20072DataRegionalListing
     */
    constructor() { 
        
        InlineResponse20072DataRegionalListing.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20072DataRegionalListing</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20072DataRegionalListing} obj Optional instance to populate.
     * @return {module:model/InlineResponse20072DataRegionalListing} The populated <code>InlineResponse20072DataRegionalListing</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20072DataRegionalListing();
 ...
 */
InlineResponse20072DataRegionalListing.prototype['isPrimary'] = undefined;
 ...
 */
InlineResponse20072DataRegionalListing.prototype['permanentIdentifier'] = undefined;
 ...
 */
InlineResponse20072DataRegionalListing.prototype['tickerExchange'] = undefined;
...
export default InlineResponse20072DataRegionalListing;
