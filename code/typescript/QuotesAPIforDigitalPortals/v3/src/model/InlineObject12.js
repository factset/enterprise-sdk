...
import InstrumentCompliancePropertyListData from './InstrumentCompliancePropertyListData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = InstrumentCompliancePropertyListData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/InstrumentCompliancePropertyListData} data
 */
InlineObject12.prototype['data'] = undefined;
