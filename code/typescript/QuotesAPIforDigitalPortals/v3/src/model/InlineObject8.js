...
import BasicValueUnitCurrencyMainListData from './BasicValueUnitCurrencyMainListData';
import BasicValueUnitListMeta from './BasicValueUnitListMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = BasicValueUnitCurrencyMainListData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = BasicValueUnitListMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/BasicValueUnitCurrencyMainListData} data
 */
InlineObject8.prototype['data'] = undefined;

/**
 * @member {module:model/BasicValueUnitListMeta} meta
 */
