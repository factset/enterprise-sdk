...
import BasicDeliveryListData from './BasicDeliveryListData';
import BasicDeliveryListMeta from './BasicDeliveryListMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = BasicDeliveryListData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = BasicDeliveryListMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/BasicDeliveryListData} data
 */
InlineObject1.prototype['data'] = undefined;

/**
 * @member {module:model/BasicDeliveryListMeta} meta
 */
