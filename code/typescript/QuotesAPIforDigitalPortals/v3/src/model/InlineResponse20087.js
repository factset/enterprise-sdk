...
import InlineResponse20087Data from './InlineResponse20087Data';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20087Data]);
            }
...
/**
 * List of instruments.
 * @member {Array.<module:model/InlineResponse20087Data>} data
 */
InlineResponse20087.prototype['data'] = undefined;

/**
 * @member {module:model/InlineResponse20036Meta} meta
 */
InlineResponse20087.prototype['meta'] = undefined;
