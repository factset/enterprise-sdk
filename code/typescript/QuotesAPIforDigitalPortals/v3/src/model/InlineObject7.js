...
import BasicValueUnitListData from './BasicValueUnitListData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = BasicValueUnitListData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/BasicValueUnitListData} data
 */
