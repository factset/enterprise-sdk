...
export default class CompanyApi {
    ...
    */
     ...
     * @param {String} identifier Identifier that resolves to a company. 
     * @param {module:model/String} identifierType The type of the identifier.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.format Format of the logos. (default to 'rectangular')
