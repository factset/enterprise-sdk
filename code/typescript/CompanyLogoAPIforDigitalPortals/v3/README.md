...
```shell
npm install @factset/sdk-utils @factset/sdk-companylogoapifordigitalportals@0.10.5
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-companylogoapifordigitalportals@0.10.5
```
