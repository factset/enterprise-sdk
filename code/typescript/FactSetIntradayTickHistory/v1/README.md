...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetintradaytickhistory@0.22.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetintradaytickhistory@0.22.0
```
...
```javascript
const { ApiClient } = require('@factset/sdk-factsetintradaytickhistory');
