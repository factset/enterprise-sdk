...
export default class RecommendationListApi {
    ...
    */
     ...
     * Search for revisions of a recommendation list.
     * @param {Object} opts Optional parameters
     * @param {String} opts.idNotation 
     * @param {String} opts.idInstrument 
     * @param {Array.<String>} opts.attributes Limit the attributes returned in the response to the specified set.
     * @param {String} opts.language 
     ...
     */
    postRecommendationListRevisionListWithHttpInfo(inlineObject) {
      let postBody = inlineObject;
      // verify the required parameter 'inlineObject' is set
      if (inlineObject === undefined || inlineObject === null) {
        throw new Error("Missing the required parameter 'inlineObject' when calling postRecommendationListRevisionList");
      }
     ...
     */
    postRecommendationListRevisionList(inlineObject) {
      return this.postRecommendationListRevisionListWithHttpInfo(inlineObject)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
