...
```shell
npm install @factset/sdk-utils @factset/sdk-newsapifordigitalportals@0.10.5
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-newsapifordigitalportals@0.10.5
```
...
## Documentation for Models
 ...
 - [newsapifordigitalportals.PostNewsArticleSearchByTextRequestDataCriteria](docs/PostNewsArticleSearchByTextRequestDataCriteria.md)
