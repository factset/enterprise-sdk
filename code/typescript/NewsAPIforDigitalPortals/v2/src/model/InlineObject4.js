...
import NewsArticleListByMediaKindData from './NewsArticleListByMediaKindData';
...
class InlineObject4 {
     ...
     * @param data {module:model/NewsArticleListByMediaKindData} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NewsArticleListByMediaKindData.constructFromObject(data['data']);
            }
...
/**
 * @member {module:model/NewsArticleListByMediaKindData} data
 */
