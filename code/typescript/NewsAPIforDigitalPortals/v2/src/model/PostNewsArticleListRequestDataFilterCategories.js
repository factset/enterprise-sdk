...
/**
 * The PostNewsArticleListRequestDataFilterCategories model module.
 * @module model/PostNewsArticleListRequestDataFilterCategories
 */
class PostNewsArticleListRequestDataFilterCategories {
    /**
     * Constructs a new <code>PostNewsArticleListRequestDataFilterCategories</code>.
     ...
     * @alias module:model/PostNewsArticleListRequestDataFilterCategories
     */
    constructor() { 
        
        PostNewsArticleListRequestDataFilterCategories.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostNewsArticleListRequestDataFilterCategories</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostNewsArticleListRequestDataFilterCategories} obj Optional instance to populate.
     * @return {module:model/PostNewsArticleListRequestDataFilterCategories} The populated <code>PostNewsArticleListRequestDataFilterCategories</code> instance.
     */
 ...
 */
PostNewsArticleListRequestDataFilterCategories.prototype['ids'] = undefined;
...
export default PostNewsArticleListRequestDataFilterCategories;
