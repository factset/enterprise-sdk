...
/**
 * The PostNewsArticleSearchByTextRequestDataIndices model module.
 * @module model/PostNewsArticleSearchByTextRequestDataIndices
 */
class PostNewsArticleSearchByTextRequestDataIndices {
    /**
     * Constructs a new <code>PostNewsArticleSearchByTextRequestDataIndices</code>.
     ...
     * @alias module:model/PostNewsArticleSearchByTextRequestDataIndices
     */
    constructor() { 
        
        PostNewsArticleSearchByTextRequestDataIndices.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostNewsArticleSearchByTextRequestDataIndices</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostNewsArticleSearchByTextRequestDataIndices} obj Optional instance to populate.
     * @return {module:model/PostNewsArticleSearchByTextRequestDataIndices} The populated <code>PostNewsArticleSearchByTextRequestDataIndices</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostNewsArticleSearchByTextRequestDataIndices();
 ...
 */
PostNewsArticleSearchByTextRequestDataIndices.prototype['ids'] = undefined;
...
export default PostNewsArticleSearchByTextRequestDataIndices;
