...
/**
 * The NewsPublisherSearchByNameDataFilterDistributor model module.
 * @module model/NewsPublisherSearchByNameDataFilterDistributor
 * @version 0.9.0
 */
class NewsPublisherSearchByNameDataFilterDistributor {
    /**
     * Constructs a new <code>NewsPublisherSearchByNameDataFilterDistributor</code>.
     * Filter for distributors. See endpoint &#x60;/news/distributor/list&#x60; for valid values.
     * @alias module:model/NewsPublisherSearchByNameDataFilterDistributor
     */
    constructor() { 
 ...
 * @member {Number} id
 */
NewsPublisherSearchByNameDataFilterDistributor.prototype['id'] = undefined;
...
export default NewsPublisherSearchByNameDataFilterDistributor;
