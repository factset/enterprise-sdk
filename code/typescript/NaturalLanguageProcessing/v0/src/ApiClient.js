...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/aiml/ner/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/aiml/ner/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/NaturalLanguageProcessing/0.40.1 (${process.platform}; node ${process.version})`
        };
