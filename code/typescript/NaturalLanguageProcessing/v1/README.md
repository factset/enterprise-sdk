...
------------ | ------------- | ------------- | -------------
*naturallanguageprocessing.ThemesApi* | [**cognitiveNlpV1ThemesPost**](docs/ThemesApi.md#cognitiveNlpV1ThemesPost) | **POST** /cognitive/nlp/v1/themes | POST request to extract themes from text
