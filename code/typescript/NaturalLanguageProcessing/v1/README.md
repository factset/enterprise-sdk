...
[![npm](https://img.shields.io/badge/npm-v0.24.3-orange)](https://www.npmjs.com/package/@factset/sdk-naturallanguageprocessing/v/0.24.3)
...
```shell
npm install @factset/sdk-utils @factset/sdk-naturallanguageprocessing@0.24.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-naturallanguageprocessing@0.24.3
```
