...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/cognitive/nlp/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/cognitive/nlp/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/NaturalLanguageProcessing/0.24.0 (${process.platform}; node ${process.version})`
        };
