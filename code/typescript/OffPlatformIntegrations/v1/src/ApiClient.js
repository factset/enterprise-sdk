...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/services/off-platform-integrations-api/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/services/off-platform-integrations-api/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OffPlatformIntegrations/0.1.0 (${process.platform}; node ${process.version})`
        };
