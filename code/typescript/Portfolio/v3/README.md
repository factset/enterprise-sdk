...
[![npm](https://img.shields.io/badge/npm-v1.0.2-orange)](https://www.npmjs.com/package/@factset/sdk-portfolio/v/1.0.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-portfolio@1.0.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-portfolio@1.0.2
```
