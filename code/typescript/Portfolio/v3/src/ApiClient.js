...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/accounts/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/accounts/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/Portfolio/1.0.1 (${process.platform}; node ${process.version})`
        };
