...
[![npm](https://img.shields.io/badge/npm-v0.25.0-orange)](https://www.npmjs.com/package/@factset/sdk-portfolioreportingbatcher/v/0.25.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-portfolioreportingbatcher@0.25.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-portfolioreportingbatcher@0.25.0
```
