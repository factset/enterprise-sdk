...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/prb/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/prb/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/PortfolioReportingBatcher/0.24.0 (${process.platform}; node ${process.version})`
        };
