...
/**
 * The InvalidCreateBookRequest model module.
 * @module model/InvalidCreateBookRequest
 */
class InvalidCreateBookRequest {
    /**
     * Constructs a new <code>InvalidCreateBookRequest</code>.
     * Invalid ticker/section_id/report_id
     * @alias module:model/InvalidCreateBookRequest
     */
    constructor() { 
        
        InvalidCreateBookRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvalidCreateBookRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvalidCreateBookRequest} obj Optional instance to populate.
     * @return {module:model/InvalidCreateBookRequest} The populated <code>InvalidCreateBookRequest</code> instance.
     */
 ...
 */
InvalidCreateBookRequest.prototype['message'] = undefined;
...
export default InvalidCreateBookRequest;
