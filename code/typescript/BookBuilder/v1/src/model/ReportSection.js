...
/**
 * The ReportSection model module.
 * @module model/ReportSection
 */
class ReportSection {
    /**
     * Constructs a new <code>ReportSection</code>.
     * @alias module:model/ReportSection
     */
    constructor() { 
        
        ReportSection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReportSection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportSection} obj Optional instance to populate.
     * @return {module:model/ReportSection} The populated <code>ReportSection</code> instance.
     */
...
/**
 * @member {module:model/ReportSection.SectionIdEnum} section_id
 */
ReportSection.prototype['section_id'] = undefined;

/**
 * @member {Array.<module:model/ReportSection.ReportsEnum>} reports
 */
ReportSection.prototype['reports'] = undefined;
