...
/**
 * The InvalidAvailableReportRequest model module.
 * @module model/InvalidAvailableReportRequest
 */
class InvalidAvailableReportRequest {
    /**
     * Constructs a new <code>InvalidAvailableReportRequest</code>.
     * Unrecognized Ticker.
     * @alias module:model/InvalidAvailableReportRequest
     */
    constructor() { 
        
        InvalidAvailableReportRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvalidAvailableReportRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvalidAvailableReportRequest} obj Optional instance to populate.
     * @return {module:model/InvalidAvailableReportRequest} The populated <code>InvalidAvailableReportRequest</code> instance.
     */
 ...
 */
InvalidAvailableReportRequest.prototype['errors'] = undefined;

/**
 * Status code indicating the error.
 * @member {Number} status
 */
InvalidAvailableReportRequest.prototype['status'] = undefined;
...
export default InvalidAvailableReportRequest;
