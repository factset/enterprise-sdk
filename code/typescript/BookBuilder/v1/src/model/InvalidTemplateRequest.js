...
/**
 * The InvalidTemplateRequest model module.
 * @module model/InvalidTemplateRequest
 */
class InvalidTemplateRequest {
    /**
     * Constructs a new <code>InvalidTemplateRequest</code>.
     * Invalid template type/section_id/report_id
     * @alias module:model/InvalidTemplateRequest
     */
    constructor() { 
        
        InvalidTemplateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvalidTemplateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvalidTemplateRequest} obj Optional instance to populate.
     * @return {module:model/InvalidTemplateRequest} The populated <code>InvalidTemplateRequest</code> instance.
     */
 ...
 */
InvalidTemplateRequest.prototype['message'] = undefined;
...
export default InvalidTemplateRequest;
