# bookbuilder.CustomDocumentsFetchApi
...
```javascript
const { ApiClient, CustomDocumentsFetchApi } = require('@factset/sdk-bookbuilder');
...
const apiInstance = new CustomDocumentsFetchApi();

// Call api endpoint
apiInstance.getCustomUploadList().then(
  data => {
