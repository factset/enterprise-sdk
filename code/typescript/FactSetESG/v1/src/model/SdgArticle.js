...
/**
 * The SdgArticle model module.
 * @module model/SdgArticle
 */
class SdgArticle {
    /**
     * Constructs a new <code>SdgArticle</code>.
     * @alias module:model/SdgArticle
     * @extends Object
    ...
    constructor(date, fsymId, requestId) { 
        ...
        SdgArticle.initialize(this, date, fsymId, requestId);
    }
    ...
    /**
     * Constructs a <code>SdgArticle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SdgArticle} obj Optional instance to populate.
     * @return {module:model/SdgArticle} The populated <code>SdgArticle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SdgArticle();
 ...
 * @member {Date} date
 */
SdgArticle.prototype['date'] = undefined;

/**
 * FactSet Entity Identifier. Six alpha-numeric characters, excluding vowels, with a -E suffix (XXXXXX-E).
 * @member {String} fsymId
 */
SdgArticle.prototype['fsymId'] = undefined;

/**
 * Identifier that was used for the request.
 * @member {String} requestId
 */
SdgArticle.prototype['requestId'] = undefined;
