...
/**
 * The SfdrPaiRequest model module.
 * @module model/SfdrPaiRequest
 */
class SfdrPaiRequest {
    /**
     * Constructs a new <code>SfdrPaiRequest</code>.
     * SFDR PAI Indicators Request Body
     * @alias module:model/SfdrPaiRequest
    ...
    constructor(ids) { 
        ...
        SfdrPaiRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>SfdrPaiRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SfdrPaiRequest} obj Optional instance to populate.
     * @return {module:model/SfdrPaiRequest} The populated <code>SfdrPaiRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SfdrPaiRequest();
 ...
 */
SfdrPaiRequest.prototype['ids'] = undefined;
 ...
 * @default false
 */
SfdrPaiRequest.prototype['feelback'] = false;
 ...
 */
SfdrPaiRequest.prototype['fiscalPeriodStart'] = undefined;
 ...
 */
SfdrPaiRequest.prototype['fiscalPeriodEnd'] = undefined;
 ...
 */
SfdrPaiRequest.prototype['indicators'] = undefined;
 ...
 * @default true
 */
SfdrPaiRequest.prototype['calculation'] = true;
