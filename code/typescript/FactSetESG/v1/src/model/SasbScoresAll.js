    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allCategories')) {
                obj['allCategories'] = ApiClient.convertToType(data['allCategories'], 'Number');
            }
            ...
            if (data.hasOwnProperty('materiality')) {
                obj['materiality'] = ApiClient.convertToType(data['materiality'], 'Number');
            }
