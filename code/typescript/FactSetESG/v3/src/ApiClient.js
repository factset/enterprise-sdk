...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content/factset-esg/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/content/factset-esg/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetESG/4.0.0 (${process.platform}; node ${process.version})`
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.factset.com/content/factset-esg/v3",
