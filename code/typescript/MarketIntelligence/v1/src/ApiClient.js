...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/market-intelligence') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/market-intelligence
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/MarketIntelligence/0.22.1 (${process.platform}; node ${process.version})`
        };
