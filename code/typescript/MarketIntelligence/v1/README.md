...
[![npm](https://img.shields.io/badge/npm-v0.22.0-orange)](https://www.npmjs.com/package/@factset/sdk-marketintelligence/v/0.22.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-marketintelligence@0.22.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-marketintelligence@0.22.0
```
