...
[![API Version](https://img.shields.io/badge/api-v0.4.0-blue)](https://developer.factset.com/api-catalog/asset-cash-flow-projections-api)
[![npm](https://img.shields.io/badge/npm-v0.13.0-orange)](https://www.npmjs.com/package/@factset/sdk-assetcashflowprojections/v/0.13.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-assetcashflowprojections@0.13.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-assetcashflowprojections@0.13.0
```
...
------------ | ------------- | ------------- | -------------
*assetcashflowprojections.BatchApi* | [**getBatchJobResult**](docs/BatchApi.md#getBatchJobResult) | **GET** /batch/{batchId}/result | Get Batch Job result by ID
*assetcashflowprojections.BatchApi* | [**getBatchStatus**](docs/BatchApi.md#getBatchStatus) | **GET** /batch/{batchId}/status | Get Batch status by ID
...
*assetcashflowprojections.DocumentsApi* | [**getDocuments**](docs/DocumentsApi.md#getDocuments) | **GET** /documents | Gives all the ACFP documents in the given directory.
...
## Documentation for Models
 ...
 - [assetcashflowprojections.BatchJobResult](docs/BatchJobResult.md)
 - [assetcashflowprojections.BatchJobResultMeta](docs/BatchJobResultMeta.md)
 - [assetcashflowprojections.BatchJobResultRoot](docs/BatchJobResultRoot.md)
 - [assetcashflowprojections.BatchJobResults](docs/BatchJobResults.md)
 - [assetcashflowprojections.BatchJobResultsLogs](docs/BatchJobResultsLogs.md)
 - [assetcashflowprojections.BatchJobStatus](docs/BatchJobStatus.md)
 - [assetcashflowprojections.BatchJobStatusRoot](docs/BatchJobStatusRoot.md)
 ...
 - [assetcashflowprojections.DocumentResponse](docs/DocumentResponse.md)
 - [assetcashflowprojections.DocumentResponseRoot](docs/DocumentResponseRoot.md)
 - [assetcashflowprojections.ErrorSource](docs/ErrorSource.md)
 - [assetcashflowprojections.Errors](docs/Errors.md)
 - [assetcashflowprojections.UpdateDocument](docs/UpdateDocument.md)
 - [assetcashflowprojections.UpdateDocumentRoot](docs/UpdateDocumentRoot.md)
