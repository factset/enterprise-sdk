...
[![API Version](https://img.shields.io/badge/api-v0.5.0-blue)](https://developer.factset.com/api-catalog/asset-cash-flow-projections-api)
[![npm](https://img.shields.io/badge/npm-v0.14.0-orange)](https://www.npmjs.com/package/@factset/sdk-assetcashflowprojections/v/0.14.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-assetcashflowprojections@0.14.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-assetcashflowprojections@0.14.0
```
