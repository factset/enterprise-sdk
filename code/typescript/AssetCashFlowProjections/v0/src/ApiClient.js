...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/asset-cash-flow-projections/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/asset-cash-flow-projections/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/AssetCashFlowProjections/0.11.0 (${process.platform}; node ${process.version})`
        };
