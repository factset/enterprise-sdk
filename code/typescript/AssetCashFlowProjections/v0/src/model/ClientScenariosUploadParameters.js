...
class ClientScenariosUploadParameters {
     ...
     * @param asOfDate {Date} Scenario As of Date ( Please select a Date not later than Previous Close Date) in YYYY-MM-DD format. 
     * @param fileName {String} Scenario file name including file extension.
     */
    constructor(asOfDate, fileName) { 
        
        ClientScenariosUploadParameters.initialize(this, asOfDate, fileName);
    }
     ...
     */
    static initialize(obj, asOfDate, fileName) { 
