...
export default class DocumentsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UpdateDocument} and HTTP response
     */
     ...
     * Provides information about the document settings.
     * @param {String} documentPath Enter the path to existing document name
     * @return { Promise.< module:model/UpdateDocument > } a Promise, with data of type {@link module:model/UpdateDocument }
     */
     ...
     * @param {String} directoryPath The directory path to retrieve documents from.
     ...
     */
    getDocumentsWithHttpInfo(directoryPath) {
      let postBody = null;
      // verify the required parameter 'directoryPath' is set
      if (directoryPath === undefined || directoryPath === null) {
        throw new Error("Missing the required parameter 'directoryPath' when calling getDocuments");
      }
     ...
     * Provides the list of all documents in a specified directory
     * @param {String} directoryPath The directory path to retrieve documents from.
     * @return { Promise.< module:model/DocumentResponse > } a Promise, with data of type {@link module:model/DocumentResponse }
     */
    getDocuments(directoryPath) {
      return this.getDocumentsWithHttpInfo(directoryPath)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} documentPath Enter the path to existing document name
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateDocument} opts.updateDocument 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    putDocumentWithHttpInfo(documentPath, opts) {
      opts = opts || {};
      let postBody = opts['updateDocument'];
      // verify the required parameter 'documentPath' is set
      if (documentPath === undefined || documentPath === null) {
