...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/cabot/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/cabot/v0
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/Cabot/0.13.0 (${process.platform}; node ${process.version})`
        };
