...
export default class OverviewModelsApi {
    ...
    */
     ...
     */
    getResultsModelAnalyticWithHttpInfo(accountPath, benchmarkPath, period) {
      let postBody = null;
      // verify the required parameter 'accountPath' is set
      if (accountPath === undefined || accountPath === null) {
     ...
     */
    getResultsModelAnalytic(accountPath, benchmarkPath, period) {
      return this.getResultsModelAnalyticWithHttpInfo(accountPath, benchmarkPath, period)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
