...
import BuyTimingHoldings from './BuyTimingHoldings';

/**
 * The BuyTimingRequestBody model module.
 * @module model/BuyTimingRequestBody
 */
class BuyTimingRequestBody {
    /**
     * Constructs a new <code>BuyTimingRequestBody</code>.
     * @alias module:model/BuyTimingRequestBody
    ...
    constructor(accountPath, benchmarkPath, period) { 
        ...
        BuyTimingRequestBody.initialize(this, accountPath, benchmarkPath, period);
    }
    ...
    /**
     * Constructs a <code>BuyTimingRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuyTimingRequestBody} obj Optional instance to populate.
     * @return {module:model/BuyTimingRequestBody} The populated <code>BuyTimingRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuyTimingRequestBody();
            ...
            if (data.hasOwnProperty('holdings')) {
                obj['holdings'] = BuyTimingHoldings.constructFromObject(data['holdings']);
            }
 ...
 */
BuyTimingRequestBody.prototype['accountPath'] = undefined;

/**
 * The path of the benchmark you want to retrieve the data for.
 * @member {String} benchmarkPath
 */
BuyTimingRequestBody.prototype['benchmarkPath'] = undefined;

/**
 * For which period you want to retrieve the data.
 * @member {String} period
 */
BuyTimingRequestBody.prototype['period'] = undefined;

/**
 * @member {module:model/Attributes} attribute
 */
BuyTimingRequestBody.prototype['attribute'] = undefined;

/**
 * Represents the sector based on the company's industry breakdown.
 * @member {String} sector
 */
BuyTimingRequestBody.prototype['sector'] = undefined;

/**
 * Region of domicile represents the region based on the company's primary listing.
 * @member {String} region
 */
BuyTimingRequestBody.prototype['region'] = undefined;

/**
 * @member {module:model/BuyTimingHoldings} holdings
 */
BuyTimingRequestBody.prototype['holdings'] = undefined;
 ...
 */
BuyTimingRequestBody.prototype['customClassifications'] = undefined;
...
export default BuyTimingRequestBody;
