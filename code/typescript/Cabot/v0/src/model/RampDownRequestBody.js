...
import RampDownHoldings from './RampDownHoldings';

/**
 * The RampDownRequestBody model module.
 * @module model/RampDownRequestBody
 */
class RampDownRequestBody {
    /**
     * Constructs a new <code>RampDownRequestBody</code>.
     * @alias module:model/RampDownRequestBody
    ...
    constructor(accountPath, benchmarkPath, period) { 
        ...
        RampDownRequestBody.initialize(this, accountPath, benchmarkPath, period);
    }
    ...
    /**
     * Constructs a <code>RampDownRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RampDownRequestBody} obj Optional instance to populate.
     * @return {module:model/RampDownRequestBody} The populated <code>RampDownRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RampDownRequestBody();
            ...
            if (data.hasOwnProperty('holdings')) {
                obj['holdings'] = RampDownHoldings.constructFromObject(data['holdings']);
            }
 ...
 */
RampDownRequestBody.prototype['accountPath'] = undefined;

/**
 * The path of the benchmark you want to retrieve the data for.
 * @member {String} benchmarkPath
 */
RampDownRequestBody.prototype['benchmarkPath'] = undefined;

/**
 * For which period you want to retrieve the data.
 * @member {String} period
 */
RampDownRequestBody.prototype['period'] = undefined;

/**
 * @member {module:model/Attributes} attribute
 */
RampDownRequestBody.prototype['attribute'] = undefined;

/**
 * Represents the sector based on the company's industry breakdown.
 * @member {String} sector
 */
RampDownRequestBody.prototype['sector'] = undefined;

/**
 * Region of domicile represents the region based on the company's primary listing.
 * @member {String} region
 */
RampDownRequestBody.prototype['region'] = undefined;

/**
 * @member {module:model/RampDownHoldings} holdings
 */
RampDownRequestBody.prototype['holdings'] = undefined;
 ...
 */
RampDownRequestBody.prototype['customClassifications'] = undefined;
...
export default RampDownRequestBody;
