...
import SkillsHoldings from './SkillsHoldings';

/**
 * The SkillsRequestBody model module.
 * @module model/SkillsRequestBody
 */
class SkillsRequestBody {
    /**
     * Constructs a new <code>SkillsRequestBody</code>.
     * @alias module:model/SkillsRequestBody
    ...
    constructor(accountPath, benchmarkPath, period) { 
        ...
        SkillsRequestBody.initialize(this, accountPath, benchmarkPath, period);
    }
    ...
    /**
     * Constructs a <code>SkillsRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SkillsRequestBody} obj Optional instance to populate.
     * @return {module:model/SkillsRequestBody} The populated <code>SkillsRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SkillsRequestBody();
            ...
            if (data.hasOwnProperty('holdings')) {
                obj['holdings'] = SkillsHoldings.constructFromObject(data['holdings']);
            }
 ...
 */
SkillsRequestBody.prototype['accountPath'] = undefined;

/**
 * The path of the benchmark you want to retrieve the data for.
 * @member {String} benchmarkPath
 */
SkillsRequestBody.prototype['benchmarkPath'] = undefined;

/**
 * For which period you want to retrieve the data.
 * @member {String} period
 */
SkillsRequestBody.prototype['period'] = undefined;

/**
 * @member {module:model/Attributes} attribute
 */
SkillsRequestBody.prototype['attribute'] = undefined;

/**
 * Represents the sector based on the company's industry breakdown.
 * @member {String} sector
 */
SkillsRequestBody.prototype['sector'] = undefined;

/**
 * Region of domicile represents the region based on the company's primary listing.
 * @member {String} region
 */
SkillsRequestBody.prototype['region'] = undefined;

/**
 * @member {module:model/SkillsHoldings} holdings
 */
SkillsRequestBody.prototype['holdings'] = undefined;
 ...
 */
SkillsRequestBody.prototype['customClassifications'] = undefined;
...
export default SkillsRequestBody;
