...
export default class CompanyApi {
    ...
    */
     ...
     * @param {Number} opts.actual The number of actual data periods to be returned. Must be greater than 0 (default to 4)
     * @param {Number} opts.estimate The number of estimate data periods to be returned. Must be greater than 0 (default to 1)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/StachTableResponse} and HTTP response
     */
    financialHighlightsGetWithHttpInfo(id, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return { Promise.< module:model/StachTableResponse > } a Promise, with data of type {@link module:model/StachTableResponse }
     */
    financialHighlightsGet(id, opts) {
      return this.financialHighlightsGetWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    keyStatsGetWithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling keyStatsGet");
      }
     ...
     */
    keyStatsGet(id) {
      return this.keyStatsGetWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
