...
/**
 * The KeyStatsEntityObjectWacc model module.
 * @module model/KeyStatsEntityObjectWacc
 */
class KeyStatsEntityObjectWacc {
    /**
     * Constructs a new <code>KeyStatsEntityObjectWacc</code>.
     ...
     * @alias module:model/KeyStatsEntityObjectWacc
    ...
    constructor(value, label) { 
        ...
        KeyStatsEntityObjectWacc.initialize(this, value, label);
    }
    ...
    /**
     * Constructs a <code>KeyStatsEntityObjectWacc</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyStatsEntityObjectWacc} obj Optional instance to populate.
     * @return {module:model/KeyStatsEntityObjectWacc} The populated <code>KeyStatsEntityObjectWacc</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyStatsEntityObjectWacc();
 ...
 */
KeyStatsEntityObjectWacc.prototype['value'] = undefined;

/**
 * @member {module:model/KeyStatsEntityObjectRange52WeekValue} label
 */
KeyStatsEntityObjectWacc.prototype['label'] = undefined;
...
export default KeyStatsEntityObjectWacc;
