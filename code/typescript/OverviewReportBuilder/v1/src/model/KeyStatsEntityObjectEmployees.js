...
/**
 * The KeyStatsEntityObjectEmployees model module.
 * @module model/KeyStatsEntityObjectEmployees
 */
class KeyStatsEntityObjectEmployees {
    /**
     * Constructs a new <code>KeyStatsEntityObjectEmployees</code>.
     * The total count of individuals who are employed by a company
     * @alias module:model/KeyStatsEntityObjectEmployees
    ...
    constructor(value, label) { 
        ...
        KeyStatsEntityObjectEmployees.initialize(this, value, label);
    }
    ...
    /**
     * Constructs a <code>KeyStatsEntityObjectEmployees</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyStatsEntityObjectEmployees} obj Optional instance to populate.
     * @return {module:model/KeyStatsEntityObjectEmployees} The populated <code>KeyStatsEntityObjectEmployees</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyStatsEntityObjectEmployees();
 ...
 */
KeyStatsEntityObjectEmployees.prototype['value'] = undefined;

/**
 * @member {module:model/KeyStatsEntityObjectRange52WeekValue} label
 */
KeyStatsEntityObjectEmployees.prototype['label'] = undefined;

/**
 * @member {module:model/KeyStatsEntityObjectRevenueAsOfDate} asOfDate
 */
KeyStatsEntityObjectEmployees.prototype['asOfDate'] = undefined;
...
export default KeyStatsEntityObjectEmployees;
