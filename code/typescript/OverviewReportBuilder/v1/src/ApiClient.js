...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/report/overview/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/report/overview/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/OverviewReportBuilder/2.1.0 (${process.platform}; node ${process.version})`
        };
