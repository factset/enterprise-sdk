...
import InlineResponse200DataHoldings from './InlineResponse200DataHoldings';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('holdings')) {
                obj['holdings'] = ApiClient.convertToType(data['holdings'], [InlineResponse200DataHoldings]);
            }
        }
        return obj;
    }
 ...
 * @member {Date} date
 */
InlineResponse200Data.prototype['date'] = undefined;

/**
 * List of holdings.
 * @member {Array.<module:model/InlineResponse200DataHoldings>} holdings
 */
InlineResponse200Data.prototype['holdings'] = undefined;
