...
import FundNotationScreenerSearchData from './FundNotationScreenerSearchData';
import FundNotationScreenerSearchMeta from './FundNotationScreenerSearchMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = FundNotationScreenerSearchData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = FundNotationScreenerSearchMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/FundNotationScreenerSearchData} data
 */
InlineObject1.prototype['data'] = undefined;

/**
 * @member {module:model/FundNotationScreenerSearchMeta} meta
 */
