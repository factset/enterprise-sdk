...
```shell
npm install @factset/sdk-utils @factset/sdk-spglobalfixedincomeevaluatedpricesandanalytics@0.1.4
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-spglobalfixedincomeevaluatedpricesandanalytics@0.1.4
```
