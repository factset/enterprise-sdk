# spglobalfixedincomeevaluatedpricesandanalytics.SpreadApi
...
> BondSpreadResponse getBondSpread(ids, opts)
...
const apiInstance = new SpreadApi();
...
// Call api endpoint
apiInstance.getBondSpread(ids, opts).then(
  data => {
...
const apiInstance = new SpreadApi();
const bondSpreadRequest = new spglobalfixedincomeevaluatedpricesandanalytics.BondSpreadRequest(); // BondSpreadRequest | Request object for requesting pricing data

// Call api endpoint
apiInstance.getBondSpreadForList(bondSpreadRequest).then(
  data => {
