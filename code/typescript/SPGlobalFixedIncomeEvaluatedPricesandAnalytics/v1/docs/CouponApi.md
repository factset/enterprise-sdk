# spglobalfixedincomeevaluatedpricesandanalytics.CouponApi
...
> BondCouponResponse getBondCoupon(ids, opts)
...
const apiInstance = new CouponApi();
...
// Call api endpoint
apiInstance.getBondCoupon(ids, opts).then(
  data => {
...
> BondCouponResponse getBondCouponForList(bondCouponRequest)
...
const apiInstance = new CouponApi();
const bondCouponRequest = new spglobalfixedincomeevaluatedpricesandanalytics.BondCouponRequest(); // BondCouponRequest | Request object for requesting Coupon data

// Call api endpoint
apiInstance.getBondCouponForList(bondCouponRequest).then(
  data => {
