# spglobalfixedincomeevaluatedpricesandanalytics.PricesApi
...
> BondPricesResponse getBondPrices(ids, opts)
...
// Call api endpoint
apiInstance.getBondPrices(ids, opts).then(
  data => {
...
const apiInstance = new PricesApi();
const bondPricesRequest = new spglobalfixedincomeevaluatedpricesandanalytics.BondPricesRequest(); // BondPricesRequest | Request object for requesting pricing data

// Call api endpoint
apiInstance.getBondPricesForList(bondPricesRequest).then(
  data => {
