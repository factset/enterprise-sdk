# spglobalfixedincomeevaluatedpricesandanalytics.ABSDetailsApi
...
> AbsDetailsResponse getABSDetails(ids, opts)
...
> AbsDetailsResponse getABSDetailsForList(absDetailsRequest)
...
const apiInstance = new ABSDetailsApi();
const absDetailsRequest = new spglobalfixedincomeevaluatedpricesandanalytics.AbsDetailsRequest(); // AbsDetailsRequest | Request object for requesting ABS details

// Call api endpoint
apiInstance.getABSDetailsForList(absDetailsRequest).then(
  data => {
