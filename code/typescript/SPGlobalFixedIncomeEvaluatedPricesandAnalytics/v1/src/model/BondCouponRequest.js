...
/**
 * The BondCouponRequest model module.
 * @module model/BondCouponRequest
 */
class BondCouponRequest {
    /**
     * Constructs a new <code>BondCouponRequest</code>.
     * Bond Coupon request body elements
     * @alias module:model/BondCouponRequest
    ...
    constructor(ids) { 
        ...
        BondCouponRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>BondCouponRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BondCouponRequest} obj Optional instance to populate.
     * @return {module:model/BondCouponRequest} The populated <code>BondCouponRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BondCouponRequest();
 ...
 */
BondCouponRequest.prototype['ids'] = undefined;
 ...
 */
BondCouponRequest.prototype['startDate'] = undefined;
 ...
 */
BondCouponRequest.prototype['endDate'] = undefined;

/**
 * @member {module:model/Frequency} frequency
 */
BondCouponRequest.prototype['frequency'] = undefined;

/**
 * @member {module:model/Calendar} calendar
 */
BondCouponRequest.prototype['calendar'] = undefined;
...
export default BondCouponRequest;
