...
/**
 * The BondPricesRequest model module.
 * @module model/BondPricesRequest
 */
class BondPricesRequest {
    /**
     * Constructs a new <code>BondPricesRequest</code>.
     * Bond Prices request body elements
     * @alias module:model/BondPricesRequest
    ...
    constructor(ids) { 
        ...
        BondPricesRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>BondPricesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BondPricesRequest} obj Optional instance to populate.
     * @return {module:model/BondPricesRequest} The populated <code>BondPricesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BondPricesRequest();
 ...
 */
BondPricesRequest.prototype['ids'] = undefined;
 ...
 */
BondPricesRequest.prototype['startDate'] = undefined;
 ...
 */
BondPricesRequest.prototype['endDate'] = undefined;

/**
 * @member {module:model/Frequency} frequency
 */
BondPricesRequest.prototype['frequency'] = undefined;

/**
 * @member {module:model/Calendar} calendar
 */
BondPricesRequest.prototype['calendar'] = undefined;
...
export default BondPricesRequest;
