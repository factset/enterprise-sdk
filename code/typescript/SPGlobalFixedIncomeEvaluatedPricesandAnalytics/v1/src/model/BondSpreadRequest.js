...
/**
 * The BondSpreadRequest model module.
 * @module model/BondSpreadRequest
 */
class BondSpreadRequest {
    /**
     * Constructs a new <code>BondSpreadRequest</code>.
     * Bond Spread request body elements
     * @alias module:model/BondSpreadRequest
    ...
    constructor(ids) { 
        ...
        BondSpreadRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>BondSpreadRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BondSpreadRequest} obj Optional instance to populate.
     * @return {module:model/BondSpreadRequest} The populated <code>BondSpreadRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BondSpreadRequest();
 ...
 */
BondSpreadRequest.prototype['ids'] = undefined;
 ...
 */
BondSpreadRequest.prototype['startDate'] = undefined;
 ...
 */
BondSpreadRequest.prototype['endDate'] = undefined;

/**
 * @member {module:model/Frequency} frequency
 */
BondSpreadRequest.prototype['frequency'] = undefined;

/**
 * @member {module:model/Calendar} calendar
 */
BondSpreadRequest.prototype['calendar'] = undefined;
...
export default BondSpreadRequest;
