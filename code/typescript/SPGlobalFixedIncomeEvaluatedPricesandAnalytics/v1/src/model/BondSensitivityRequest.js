...
/**
 * The BondSensitivityRequest model module.
 * @module model/BondSensitivityRequest
 */
class BondSensitivityRequest {
    /**
     * Constructs a new <code>BondSensitivityRequest</code>.
     * Bond Sensitivity request body elements
     * @alias module:model/BondSensitivityRequest
    ...
    constructor(ids) { 
        ...
        BondSensitivityRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>BondSensitivityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BondSensitivityRequest} obj Optional instance to populate.
     * @return {module:model/BondSensitivityRequest} The populated <code>BondSensitivityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BondSensitivityRequest();
 ...
 */
BondSensitivityRequest.prototype['ids'] = undefined;
 ...
 */
BondSensitivityRequest.prototype['startDate'] = undefined;
 ...
 */
BondSensitivityRequest.prototype['endDate'] = undefined;

/**
 * @member {module:model/Frequency} frequency
 */
BondSensitivityRequest.prototype['frequency'] = undefined;

/**
 * @member {module:model/Calendar} calendar
 */
BondSensitivityRequest.prototype['calendar'] = undefined;
...
export default BondSensitivityRequest;
