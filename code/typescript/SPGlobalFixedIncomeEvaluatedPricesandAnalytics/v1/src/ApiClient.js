...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/content') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/SPGlobalFixedIncomeEvaluatedPricesandAnalytics/0.2.1 (${process.platform}; node ${process.version})`
        };
