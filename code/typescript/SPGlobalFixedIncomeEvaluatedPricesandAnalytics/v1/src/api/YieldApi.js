...
export default class YieldApi {
    ...
    /**
    * Constructs a new YieldApi. 
    * @alias module:api/YieldApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondYieldResponse} and HTTP response
     */
    getBondYieldWithHttpInfo(ids, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getBondYield");
      }
      ...
      let returnType = BondYieldResponse;

      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/yield', 'GET',
     ...
     * @param {module:model/String} opts.frequency Controls the display frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **M** = Monthly, based on the last trading day of the month.   * **AM** = Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** = Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** = Fiscal Quarter of the company.   * **AY** = Actual Annual, based on the start date.   * **CY** = Calendar Annual, based on the last trading day of the calendar year.   * **FY** = Fiscal Annual, based on the last trading day of the company's fiscal year.  (default to 'D')
     * @param {module:model/String} opts.calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities' trading calendar which excludes date records for respective holiday periods. (default to 'FIVEDAY')
     * @return { Promise.< module:model/BondYieldResponse > } a Promise, with data of type {@link module:model/BondYieldResponse }
     */
    getBondYield(ids, opts) {
      return this.getBondYieldWithHttpInfo(ids, opts)
     ...
     * Get the yield information like yield to maturity, yield to worst, benchmark yield to maturity and yield to call provided by Markit for a specified date range and frequency. 
     * @param {module:model/BondYieldRequest} bondYieldRequest Request object for requesting yield data
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondYieldResponse} and HTTP response
     */
    getBondYieldForListWithHttpInfo(bondYieldRequest) {
      let postBody = bondYieldRequest;
      // verify the required parameter 'bondYieldRequest' is set
      if (bondYieldRequest === undefined || bondYieldRequest === null) {
        throw new Error("Missing the required parameter 'bondYieldRequest' when calling getBondYieldForList");
      }
      ...
      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/yield', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/BondYieldResponse > } a Promise, with data of type {@link module:model/BondYieldResponse }
     */
    getBondYieldForList(bondYieldRequest) {
      return this.getBondYieldForListWithHttpInfo(bondYieldRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
