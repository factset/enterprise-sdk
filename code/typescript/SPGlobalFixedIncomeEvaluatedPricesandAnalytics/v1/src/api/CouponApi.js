...
export default class CouponApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondCouponResponse} and HTTP response
     */
    getBondCouponWithHttpInfo(ids, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getBondCoupon");
      }
      ...
      let returnType = BondCouponResponse;

      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/coupon', 'GET',
     ...
     * @param {module:model/String} opts.frequency Controls the display frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **M** = Monthly, based on the last trading day of the month.   * **AM** = Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** = Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** = Fiscal Quarter of the company.   * **AY** = Actual Annual, based on the start date.   * **CY** = Calendar Annual, based on the last trading day of the calendar year.   * **FY** = Fiscal Annual, based on the last trading day of the company's fiscal year.  (default to 'D')
     * @param {module:model/String} opts.calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities' trading calendar which excludes date records for respective holiday periods. (default to 'FIVEDAY')
     * @return { Promise.< module:model/BondCouponResponse > } a Promise, with data of type {@link module:model/BondCouponResponse }
     */
    getBondCoupon(ids, opts) {
      return this.getBondCouponWithHttpInfo(ids, opts)
     ...
     * Get coupon information like accrued interest, coupon, coupon type and coupon frequency provided by Markit for specified date range and frequency. 
     * @param {module:model/BondCouponRequest} bondCouponRequest Request object for requesting Coupon data
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondCouponResponse} and HTTP response
     */
    getBondCouponForListWithHttpInfo(bondCouponRequest) {
      let postBody = bondCouponRequest;
      // verify the required parameter 'bondCouponRequest' is set
      if (bondCouponRequest === undefined || bondCouponRequest === null) {
        throw new Error("Missing the required parameter 'bondCouponRequest' when calling getBondCouponForList");
      }
      ...
      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/coupon', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/BondCouponResponse > } a Promise, with data of type {@link module:model/BondCouponResponse }
     */
    getBondCouponForList(bondCouponRequest) {
      return this.getBondCouponForListWithHttpInfo(bondCouponRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
