...
/**
* ABSDetails service.
* @module api/ABSDetailsApi
*/
export default class ABSDetailsApi {

    /**
    * Constructs a new ABSDetailsApi. 
    * @alias module:api/ABSDetailsApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AbsDetailsResponse} and HTTP response
     */
    getABSDetailsWithHttpInfo(ids, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getABSDetails");
      }
      ...
      let returnType = AbsDetailsResponse;

      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/abs-details', 'GET',
     ...
     * @param {module:model/String} opts.frequency Controls the display frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **M** = Monthly, based on the last trading day of the month.   * **AM** = Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** = Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** = Fiscal Quarter of the company.   * **AY** = Actual Annual, based on the start date.   * **CY** = Calendar Annual, based on the last trading day of the calendar year.   * **FY** = Fiscal Annual, based on the last trading day of the company's fiscal year.  (default to 'D')
     * @param {module:model/String} opts.calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities' trading calendar which excludes date records for respective holiday periods. (default to 'FIVEDAY')
     * @return { Promise.< module:model/AbsDetailsResponse > } a Promise, with data of type {@link module:model/AbsDetailsResponse }
     */
    getABSDetails(ids, opts) {
      return this.getABSDetailsWithHttpInfo(ids, opts)
     ...
     * Get details for Asset Backed Securities like factors, pay up, wal, cdr, cpr and prepay details provided by Markit for the specified date range and frequency. 
     * @param {module:model/AbsDetailsRequest} absDetailsRequest Request object for requesting ABS details
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AbsDetailsResponse} and HTTP response
     */
    getABSDetailsForListWithHttpInfo(absDetailsRequest) {
      let postBody = absDetailsRequest;
      // verify the required parameter 'absDetailsRequest' is set
      if (absDetailsRequest === undefined || absDetailsRequest === null) {
        throw new Error("Missing the required parameter 'absDetailsRequest' when calling getABSDetailsForList");
      }
      ...
      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/abs-details', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/AbsDetailsResponse > } a Promise, with data of type {@link module:model/AbsDetailsResponse }
     */
    getABSDetailsForList(absDetailsRequest) {
      return this.getABSDetailsForListWithHttpInfo(absDetailsRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
