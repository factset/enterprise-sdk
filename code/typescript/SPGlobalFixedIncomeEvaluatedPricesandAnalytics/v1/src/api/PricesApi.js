...
export default class PricesApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondPricesResponse} and HTTP response
     */
    getBondPricesWithHttpInfo(ids, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getBondPrices");
      }
      ...
      let returnType = BondPricesResponse;

      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/prices', 'GET',
     ...
     * @param {module:model/String} opts.frequency Controls the display frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **M** = Monthly, based on the last trading day of the month.   * **AM** = Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** = Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** = Fiscal Quarter of the company.   * **AY** = Actual Annual, based on the start date.   * **CY** = Calendar Annual, based on the last trading day of the calendar year.   * **FY** = Fiscal Annual, based on the last trading day of the company's fiscal year.  (default to 'D')
     * @param {module:model/String} opts.calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities' trading calendar which excludes date records for respective holiday periods. (default to 'FIVEDAY')
     * @return { Promise.< module:model/BondPricesResponse > } a Promise, with data of type {@link module:model/BondPricesResponse }
     */
    getBondPrices(ids, opts) {
      return this.getBondPricesWithHttpInfo(ids, opts)
     ...
     * Get bond clean and dirty bid, mid and ask pricing data provided by Markit for a specified date range and frequency. 
     * @param {module:model/BondPricesRequest} bondPricesRequest Request object for requesting pricing data
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondPricesResponse} and HTTP response
     */
    getBondPricesForListWithHttpInfo(bondPricesRequest) {
      let postBody = bondPricesRequest;
      // verify the required parameter 'bondPricesRequest' is set
      if (bondPricesRequest === undefined || bondPricesRequest === null) {
        throw new Error("Missing the required parameter 'bondPricesRequest' when calling getBondPricesForList");
      }
      ...
      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/prices', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/BondPricesResponse > } a Promise, with data of type {@link module:model/BondPricesResponse }
     */
    getBondPricesForList(bondPricesRequest) {
      return this.getBondPricesForListWithHttpInfo(bondPricesRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
