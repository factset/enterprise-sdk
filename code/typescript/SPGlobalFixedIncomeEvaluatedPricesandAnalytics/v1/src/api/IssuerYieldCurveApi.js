...
/**
* IssuerYieldCurve service.
* @module api/IssuerYieldCurveApi
*/
export default class IssuerYieldCurveApi {

    /**
    * Constructs a new IssuerYieldCurveApi. 
    * @alias module:api/IssuerYieldCurveApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondIssuerYieldCurveResponse} and HTTP response
     */
    getBondIssuerYieldCurveWithHttpInfo(ids, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getBondIssuerYieldCurve");
      }
      ...
      let returnType = BondIssuerYieldCurveResponse;

      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/issuer-yield-curve', 'GET',
     ...
     * @param {module:model/String} opts.frequency Controls the display frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **M** = Monthly, based on the last trading day of the month.   * **AM** = Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** = Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** = Fiscal Quarter of the company.   * **AY** = Actual Annual, based on the start date.   * **CY** = Calendar Annual, based on the last trading day of the calendar year.   * **FY** = Fiscal Annual, based on the last trading day of the company's fiscal year.  (default to 'D')
     * @param {module:model/String} opts.calendar Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities' trading calendar which excludes date records for respective holiday periods. (default to 'FIVEDAY')
     * @return { Promise.< module:model/BondIssuerYieldCurveResponse > } a Promise, with data of type {@link module:model/BondIssuerYieldCurveResponse }
     */
    getBondIssuerYieldCurve(ids, opts) {
      return this.getBondIssuerYieldCurveWithHttpInfo(ids, opts)
     ...
     * Get yield curve data points and dates for 3M, 6M, 1Y, 2Y, 3Y, 4Y, 5Y, 6Y, 7Y, 8Y, 9Y, 10Y, 15Y, 20Y, 25Y, 30Y and 40Y provided by Markit for the specified date range and frequency. 
     * @param {module:model/BondIssuerYieldCurveRequest} bondIssuerYieldCurveRequest Request object for requesting issuer yield curve data.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BondIssuerYieldCurveResponse} and HTTP response
     */
    getBondIssuerYieldCurveForListWithHttpInfo(bondIssuerYieldCurveRequest) {
      let postBody = bondIssuerYieldCurveRequest;
      // verify the required parameter 'bondIssuerYieldCurveRequest' is set
      if (bondIssuerYieldCurveRequest === undefined || bondIssuerYieldCurveRequest === null) {
        throw new Error("Missing the required parameter 'bondIssuerYieldCurveRequest' when calling getBondIssuerYieldCurveForList");
      }
      ...
      return this.apiClient.callApi(
        '/markit-bond-prices-and-analytics/v1/issuer-yield-curve', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/BondIssuerYieldCurveResponse > } a Promise, with data of type {@link module:model/BondIssuerYieldCurveResponse }
     */
    getBondIssuerYieldCurveForList(bondIssuerYieldCurveRequest) {
      return this.getBondIssuerYieldCurveForListWithHttpInfo(bondIssuerYieldCurveRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
