...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/universal-screening') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/universal-screening
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/UniversalScreening/0.21.0'
        };
