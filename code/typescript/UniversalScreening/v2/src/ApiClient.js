...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/universal-screening/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/universal-screening/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/UniversalScreening/2.0.1 (${process.platform}; node ${process.version})`
        };
