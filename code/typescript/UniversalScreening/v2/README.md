...
[![npm](https://img.shields.io/badge/npm-v2.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-universalscreening/v/2.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-universalscreening@2.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-universalscreening@2.2.0
```
...
*universalscreening.ScreeningOperationsApi* | [**getExportResults**](docs/ScreeningOperationsApi.md#getExportResults) | **GET** /job/{id}/export | 
...
*universalscreening.ScreeningOperationsApi* | [**submitExport**](docs/ScreeningOperationsApi.md#submitExport) | **POST** /job/export | 
...
## Documentation for Models
 ...
 - [universalscreening.CalculateMetadata](docs/CalculateMetadata.md)
 - [universalscreening.DelimitedOptions](docs/DelimitedOptions.md)
 ...
 - [universalscreening.ExcelOptions](docs/ExcelOptions.md)
 - [universalscreening.GroupingInfo](docs/GroupingInfo.md)
 ...
 - [universalscreening.PdfOptions](docs/PdfOptions.md)
 ...
 - [universalscreening.ScreenExportParameters](docs/ScreenExportParameters.md)
 - [universalscreening.ScreenExportParametersData](docs/ScreenExportParametersData.md)
 - [universalscreening.SubmitExportResponse](docs/SubmitExportResponse.md)
 - [universalscreening.SubmitExportResponseData](docs/SubmitExportResponseData.md)
