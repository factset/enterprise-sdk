...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api-sandbox.factset.com/charting') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api-sandbox.factset.com/charting
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'fds-sdk/javascript/ChartGenerationService/0.21.0'
        };
