...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/charting/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/charting/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ChartGenerationService/0.22.0 (${process.platform}; node ${process.version})`
        };
