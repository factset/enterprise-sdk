...
**companyName** | **String** | Name of the company/security that declared the spin-off. | [optional] 
...
**priceAdjFactor** | **Number** | The price adjustment factor associated with the rights, spin-off, split, bonus or stock dividend event. | [optional] 
