# factsetglobalprices.RightsIssue
...
**rightsIssuePrice** | **Number** | Price at which the rights are issued. | [optional] 
**rightsIssueCurrency** | **String** | Currency ISO code in which the rights are issued. | [optional] 
**priceAdjFactor** | **Number** | The price adjustment factor associated with the rights issue. | [optional] 
