...
export default class ReturnsApi {
    ...
    */
     ...
     */
    getReturnsWithHttpInfo(ids, startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      if (endDate === undefined || endDate === null) {
        throw new Error("Missing the required parameter 'endDate' when calling getReturns");
      }
     ...
     */
    getReturns(ids, startDate, endDate, opts) {
      return this.getReturnsWithHttpInfo(ids, startDate, endDate, opts)
