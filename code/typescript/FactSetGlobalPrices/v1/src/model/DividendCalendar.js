...
class DividendCalendar {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dividendStatus') && obj['dividendStatus'] === undefined) {
                obj['dividendStatus'] = ApiClient.convertToType(data['dividendStatus'], 'String');
            }
            if (data.hasOwnProperty('dividendPerShare') && obj['dividendPerShare'] === undefined) {
                obj['dividendPerShare'] = ApiClient.convertToType(data['dividendPerShare'], 'Number');
            }
            if (data.hasOwnProperty('declaredCurrency') && obj['declaredCurrency'] === undefined) {
