...
/**
 * The SpinOff model module.
 * @module model/SpinOff
 */
class SpinOff {
    /**
     * Constructs a new <code>SpinOff</code>.
     * @alias module:model/SpinOff
     */
    constructor() { 
        
        SpinOff.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SpinOff</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpinOff} obj Optional instance to populate.
     * @return {module:model/SpinOff} The populated <code>SpinOff</code> instance.
     */
