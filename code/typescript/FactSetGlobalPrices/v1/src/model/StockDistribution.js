...
/**
 * The StockDistribution model module.
 * @module model/StockDistribution
 */
class StockDistribution {
    /**
     * Constructs a new <code>StockDistribution</code>.
     * @alias module:model/StockDistribution
     */
    constructor() { 
        
        StockDistribution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StockDistribution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StockDistribution} obj Optional instance to populate.
     * @return {module:model/StockDistribution} The populated <code>StockDistribution</code> instance.
     */
 ...
 */
StockDistribution.prototype['eventId'] = undefined;

/**
 * FactSet Permanent Identifier for the company/security associated with the event.
 * @member {String} fsymId
 */
StockDistribution.prototype['fsymId'] = undefined;
