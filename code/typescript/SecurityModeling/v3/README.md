...
[![npm](https://img.shields.io/badge/npm-v0.21.2-orange)](https://www.npmjs.com/package/@factset/sdk-securitymodeling/v/0.21.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-securitymodeling@0.21.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-securitymodeling@0.21.2
```
...
------------ | ------------- | ------------- | -------------
*securitymodeling.SecurityModelingApi* | [**deleteSecurities**](docs/SecurityModelingApi.md#deleteSecurities) | **POST** /delete | Delete existing securities
*securitymodeling.SecurityModelingApi* | [**getSecurities**](docs/SecurityModelingApi.md#getSecurities) | **POST** /retrieve | Get existing securities
*securitymodeling.SecurityModelingApi* | [**upsertSecurities**](docs/SecurityModelingApi.md#upsertSecurities) | **POST** /upsert | Create or update securities
