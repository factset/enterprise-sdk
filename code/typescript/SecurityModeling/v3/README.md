...
[![npm](https://img.shields.io/badge/npm-v0.21.0-orange)](https://www.npmjs.com/package/@factset/sdk-securitymodeling/v/0.21.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-securitymodeling@0.21.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-securitymodeling@0.21.0
```
