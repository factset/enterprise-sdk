...
class CountryRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('countryIds') && obj['countryIds'] === undefined) {
