...
[![npm](https://img.shields.io/badge/npm-v2.0.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetgeorev/v/2.0.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetgeorev@2.0.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetgeorev@2.0.0
```
