...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/data-dictionary') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/data-dictionary
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/ContentFeedsDataDictionary/0.22.1 (${process.platform}; node ${process.version})`
        };
