...
export default class BenchmarkConstituentsApi {
    ...
    */
     ...
     * @param {String} opts.date Date of holding expressed in YYYY-MM-DD format.
     * @param {String} opts.currency Currency for response.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/BenchmarkConstituentsResponse}
     */
     ...
     * @param {String} opts.date Date of holding expressed in YYYY-MM-DD format.
     * @param {String} opts.currency Currency for response.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FixedIncomeBenchmarkConstituentsResponse}
     */
