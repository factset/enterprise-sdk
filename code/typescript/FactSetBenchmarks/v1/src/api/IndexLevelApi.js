...
export default class IndexLevelApi {
    ...
    */
     ...
     * @param {String} opts.currency Currency for response.  Currency code (ISO 4217). For a list of currency codes, see [OA Page 1470](https://my.apps.factset.com/oa/pages/1470).
     ...
     * @param {Array.<String>} ids Benchmark Identifiers. Reference the helper endpoint **_/id-list** to get a sample list of  valid identifiers. <p>***ids limit** =  500 per request*</p> *<p>Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \"POST\" method.</p>*
     * @param {Date} startDate Requested start date expressed in YYYY-MM-DD format.
     * @param {Date} endDate Requested End Date for Range expressed in YYYY-MM-DD format.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.returnType The return type adjustment used in returns response items. Adjustment can be made for GROSS and NET dividends that will be included in the return calculation. The service will default to GROSS. (default to 'GROSS')
     * @param {module:model/String} opts.hedgeType The hedge type adjustment used in returns response items. Adjustment can be made for HEDGED and UNHEDGED values that will be included in the return calculation. The service will default to UNHEDGED. (default to 'UNHEDGED')
     * @param {String} opts.currency Currency for response.  Currency code (ISO 4217). For a list of currency codes, see [OA Page 1470](https://my.apps.factset.com/oa/pages/1470).
     * @param {String} opts.calendar Calendar of data returned. The default value is FIVEDAY which displays Monday through Friday, regardless of whether there were trading holidays. (default to 'FIVEDAY')
     * @param {module:model/String} opts.impliedDate This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (default to 'N')
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/IndexReturnsResponse} and HTTP response
     */
    getIndexReturnsWithHttpInfo(ids, startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ids' is set
      if (ids === undefined || ids === null) {
        throw new Error("Missing the required parameter 'ids' when calling getIndexReturns");
      }
      // verify the required parameter 'startDate' is set
      if (startDate === undefined || startDate === null) {
        throw new Error("Missing the required parameter 'startDate' when calling getIndexReturns");
      }
      // verify the required parameter 'endDate' is set
      if (endDate === undefined || endDate === null) {
        throw new Error("Missing the required parameter 'endDate' when calling getIndexReturns");
      }
      ...
      let returnType = IndexReturnsResponse;

      return this.apiClient.callApi(
        '/factset-benchmarks/v1/index-returns', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {String} opts.calendar Calendar of data returned. The default value is FIVEDAY which displays Monday through Friday, regardless of whether there were trading holidays. (default to 'FIVEDAY')
     * @param {module:model/String} opts.impliedDate This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (default to 'N')
     * @return { Promise.< module:model/IndexReturnsResponse > } a Promise, with data of type {@link module:model/IndexReturnsResponse }
     */
    getIndexReturns(ids, startDate, endDate, opts) {
      return this.getIndexReturnsWithHttpInfo(ids, startDate, endDate, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * Returns aggregated (cumulative) index returns for each requested benchmark across the specified date range. Unlike `/index-history`, which provides full time-series data (prices, levels, constituents, and frequency-based observations), this endpoint is returns-focused and does not return a time series or support frequency parameters. Each benchmark produces a single cumulative return value for the entire date window, rather than a series of observations. The data is aligned with FactSet Benchmark Data Feed. Submit benchmark identifiers and a date range to retrieve cumulative return metrics for the period. 
     * @param {module:model/IndexReturnsRequest} indexReturnsRequest Requests Index Returns for a list of identifiers and specified date range.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/IndexReturnsResponse} and HTTP response
     */
    getIndexReturnsForListWithHttpInfo(indexReturnsRequest) {
      let postBody = indexReturnsRequest;
      // verify the required parameter 'indexReturnsRequest' is set
      if (indexReturnsRequest === undefined || indexReturnsRequest === null) {
        throw new Error("Missing the required parameter 'indexReturnsRequest' when calling getIndexReturnsForList");
      }
      ...
      return this.apiClient.callApi(
        '/factset-benchmarks/v1/index-returns', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/IndexReturnsResponse > } a Promise, with data of type {@link module:model/IndexReturnsResponse }
     */
    getIndexReturnsForList(indexReturnsRequest) {
      return this.getIndexReturnsForListWithHttpInfo(indexReturnsRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
