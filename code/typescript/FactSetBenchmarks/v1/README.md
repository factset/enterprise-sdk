...
[![npm](https://img.shields.io/badge/npm-v2.3.0-orange)](https://www.npmjs.com/package/@factset/sdk-factsetbenchmarks/v/2.3.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetbenchmarks@2.3.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetbenchmarks@2.3.0
```
...
*factsetbenchmarks.IndexLevelApi* | [**getIndexReturns**](docs/IndexLevelApi.md#getIndexReturns) | **GET** /factset-benchmarks/v1/index-returns | Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters
*factsetbenchmarks.IndexLevelApi* | [**getIndexReturnsForList**](docs/IndexLevelApi.md#getIndexReturnsForList) | **POST** /factset-benchmarks/v1/index-returns | Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via JSON Request body
...
## Documentation for Models
 ...
 - [factsetbenchmarks.IndexReturns](docs/IndexReturns.md)
 - [factsetbenchmarks.IndexReturnsRequest](docs/IndexReturnsRequest.md)
 - [factsetbenchmarks.IndexReturnsResponse](docs/IndexReturnsResponse.md)
