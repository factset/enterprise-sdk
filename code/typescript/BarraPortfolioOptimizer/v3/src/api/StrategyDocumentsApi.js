...
export default class StrategyDocumentsApi {
    ...
    */
     ...
     */
    getBarraStrategyDocumentsWithHttpInfo(path) {
      let postBody = null;
      // verify the required parameter 'path' is set
      if (path === undefined || path === null) {
        throw new Error("Missing the required parameter 'path' when calling getBarraStrategyDocuments");
      }
      ...
      return this.apiClient.callApi(
        '/analytics/engines/bpm/v3/strategies/{path}', 'GET',
     ...
     */
    getBarraStrategyDocuments(path) {
      return this.getBarraStrategyDocumentsWithHttpInfo(path)
