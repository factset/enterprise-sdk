...
import IndexedNRTMetaPagination from './IndexedNRTMetaPagination';
import NRTSnippetsMetaPartial from './NRTSnippetsMetaPartial';

/**
 * The IndexedNRTMeta model module.
 * @module model/IndexedNRTMeta
 */
class IndexedNRTMeta {
    /**
     * Constructs a new <code>IndexedNRTMeta</code>.
     * @alias module:model/IndexedNRTMeta
     */
    constructor() { 
        
        IndexedNRTMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IndexedNRTMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IndexedNRTMeta} obj Optional instance to populate.
     * @return {module:model/IndexedNRTMeta} The populated <code>IndexedNRTMeta</code> instance.
     */
...
/**
 * @member {module:model/IndexedNRTMetaPagination} pagination
 */
IndexedNRTMeta.prototype['pagination'] = undefined;

/**
 * @member {module:model/NRTSnippetsMetaPartial} partial
 */
IndexedNRTMeta.prototype['partial'] = undefined;
