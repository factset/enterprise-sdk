...
import EventsAudioHistoryMeta from './EventsAudioHistoryMeta';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [EventsAudioHistoryData]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = EventsAudioHistoryMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/EventsAudioHistoryData>} data
 */
EventsAudioHistory.prototype['data'] = undefined;

/**
 * @member {module:model/EventsAudioHistoryMeta} meta
 */
EventsAudioHistory.prototype['meta'] = undefined;
