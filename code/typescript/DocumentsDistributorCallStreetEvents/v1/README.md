...
```shell
npm install @factset/sdk-utils @factset/sdk-documentsdistributorcallstreetevents@0.21.9
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-documentsdistributorcallstreetevents@0.21.9
```
