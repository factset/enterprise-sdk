...
[![npm](https://img.shields.io/badge/npm-v2.1.2-orange)](https://www.npmjs.com/package/@factset/sdk-irncustomsymbols/v/2.1.2)
...
```shell
npm install @factset/sdk-utils @factset/sdk-irncustomsymbols@2.1.2
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-irncustomsymbols@2.1.2
```
