...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/research/irn/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/research/irn/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/IRNCustomSymbols/2.1.1 (${process.platform}; node ${process.version})`
        };
