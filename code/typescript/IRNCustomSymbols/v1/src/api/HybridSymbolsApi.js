    ...
    */
    ...
    createStandardSymbolMetadataWithHttpInfo(opts) {
      ...
      return this.apiClient.callApi(
        '/v1/custom-symbols/standard-symbol-metadata', 'POST',
    ...
    getStandardSymbolMetadataGuidWithHttpInfo(standardSymbol) {
      ...
      return this.apiClient.callApi(
        '/v1/custom-symbols/standard-symbol-metadata/{standardSymbol}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    patchStandardSymbolWithHttpInfo(standardSymbolId, opts) {
      ...
      return this.apiClient.callApi(
        '/v1/custom-symbols/standard-symbol-metadata/{standardSymbolId}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
