...
> FileUploadStatus analyticsQuantFpeV1FilesServerFilePost(server, file, opts)
...
// Call api endpoint
apiInstance.analyticsQuantFpeV1FilesServerFilePost(server, file, opts).then(
  data => {
...
// Call api endpoint
apiInstance.analyticsQuantFpeV1FilesUploadsIdGet(id).then(
  data => {
