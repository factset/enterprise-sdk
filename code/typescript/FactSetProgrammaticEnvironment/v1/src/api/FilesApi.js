...
export default class FilesApi {
    ...
    */
     ...
     */
    analyticsQuantFpeV1FilesServerFilePostWithHttpInfo(server, file, opts) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'server' is set
      if (server === undefined || server === null) {
        throw new Error("Missing the required parameter 'server' when calling analyticsQuantFpeV1FilesServerFilePost");
      }
      // verify the required parameter 'file' is set
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling analyticsQuantFpeV1FilesServerFilePost");
      }
      ...
      return this.apiClient.callApi(
        '/analytics/quant/fpe/v1/files/{server}/{file}', 'POST',
     ...
     */
    analyticsQuantFpeV1FilesServerFilePost(server, file, opts) {
      return this.analyticsQuantFpeV1FilesServerFilePostWithHttpInfo(server, file, opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FileUploadStatus} and HTTP response
     */
    analyticsQuantFpeV1FilesUploadsIdGetWithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling analyticsQuantFpeV1FilesUploadsIdGet");
      }
      ...
      return this.apiClient.callApi(
        '/analytics/quant/fpe/v1/files/uploads/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return { Promise.< module:model/FileUploadStatus > } a Promise, with data of type {@link module:model/FileUploadStatus }
     */
    analyticsQuantFpeV1FilesUploadsIdGet(id) {
      return this.analyticsQuantFpeV1FilesUploadsIdGetWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
