...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.factset.com/analytics/quant/fpe/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.factset.com/analytics/quant/fpe/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': `fds-sdk/javascript/FactSetProgrammaticEnvironment/0.23.1 (${process.platform}; node ${process.version})`
        };
