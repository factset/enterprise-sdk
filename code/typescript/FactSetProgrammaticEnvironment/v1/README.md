...
[![npm](https://img.shields.io/badge/npm-v0.23.3-orange)](https://www.npmjs.com/package/@factset/sdk-factsetprogrammaticenvironment/v/0.23.3)
...
```shell
npm install @factset/sdk-utils @factset/sdk-factsetprogrammaticenvironment@0.23.3
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-factsetprogrammaticenvironment@0.23.3
```
...
*factsetprogrammaticenvironment.CalculationsApi* | [**deleteCalculation**](docs/CalculationsApi.md#deleteCalculation) | **DELETE** /calculations/{id} | Kill a running calculation by id
...
*factsetprogrammaticenvironment.ServersApi* | [**stopServer**](docs/ServersApi.md#stopServer) | **DELETE** /servers | Stop the caller&#39;s API server
