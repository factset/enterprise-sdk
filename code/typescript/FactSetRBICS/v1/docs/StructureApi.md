...
const opts = {
  'rbicsIds': ["101010000000","55"], // [String] | RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry. 
...
------------- | ------------- | ------------- | -------------
 **rbicsIds** | [**[String]**](String.md)| RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry.  | [optional] 
