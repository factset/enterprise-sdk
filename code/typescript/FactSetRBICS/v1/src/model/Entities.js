...
class Entities {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('l1') && obj['l1'] === undefined) {
                obj['l1'] = ApiClient.convertToType(data['l1'], [Economy]);
            }
 ...
 */
Entities.prototype['fsymId'] = undefined;

/**
 * The company identifier submitted in the request, which corresponds to the returned revenue breakdown.
 * @member {String} requestId
 */
Entities.prototype['requestId'] = undefined;

/**
 * Effective date for data expressed in YYYY-MM-DD format.
 * @member {Date} date
 */
Entities.prototype['date'] = undefined;

/**
 * @member {Array.<module:model/Economy>} l1
 */
Entities.prototype['l1'] = undefined;

/**
 * @member {module:model/ErrorObjectResponse} error
 */
Entities.prototype['error'] = undefined;
