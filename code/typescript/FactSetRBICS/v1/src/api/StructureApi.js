...
export default class StructureApi {
    ...
    */
     ...
     * @param {Array.<String>} opts.rbicsIds RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry. 
