...
export default class ComponentsApi {
    ...
    */
     ...
     * @param {String} id Unique identifier for a SPAR component
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/SPARComponentRoot} and HTTP response
     */
    getSPARComponentByIdWithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getSPARComponentById");
      }
      ...
      let returnType = SPARComponentRoot;

      return this.apiClient.callApi(
        '/analytics/engines/spar/v3/components/{id}', 'GET',
     ...
     * This endpoint returns the default settings of a SPAR component.
     * @param {String} id Unique identifier for a SPAR component
     * @return { Promise.< module:model/SPARComponentRoot > } a Promise, with data of type {@link module:model/SPARComponentRoot }
     */
    getSPARComponentById(id) {
      return this.getSPARComponentByIdWithHttpInfo(id)
