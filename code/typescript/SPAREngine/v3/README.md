...
[![npm](https://img.shields.io/badge/npm-v3.2.0-orange)](https://www.npmjs.com/package/@factset/sdk-sparengine/v/3.2.0)
...
```shell
npm install @factset/sdk-utils @factset/sdk-sparengine@3.2.0
```

### yarn

```shell
yarn add @factset/sdk-utils @factset/sdk-sparengine@3.2.0
```
...
*sparengine.SPARPeerUniverseApi* | [**getListOfPeerUniverse**](docs/SPARPeerUniverseApi.md#getListOfPeerUniverse) | **GET** /analytics/engines/spar/v3/peer-universe | Get List of Peer Universe
...
## Documentation for Models
 ...
 - [sparengine.SPARComponentIdentifier](docs/SPARComponentIdentifier.md)
 ...
 - [sparengine.SPARPeerUniverseListResponse](docs/SPARPeerUniverseListResponse.md)
 - [sparengine.SPARPeerUniverseResponseItem](docs/SPARPeerUniverseResponseItem.md)
 - [sparengine.SPARPeerUniverseRoot](docs/SPARPeerUniverseRoot.md)
