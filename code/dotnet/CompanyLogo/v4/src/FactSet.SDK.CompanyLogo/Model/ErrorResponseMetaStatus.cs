...
namespace FactSet.SDK.CompanyLogo.Model
{
    ...
    /// Status information
    /// </summary>
    [DataContract(Name = "ErrorResponse_meta_status")]
    public partial class ErrorResponseMetaStatus : IEquatable<ErrorResponseMetaStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseMetaStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ErrorResponseMetaStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseMetaStatus" /> class.
        /// </summary>
        /// <param name="code">HTTP status code (required).</param>
        public ErrorResponseMetaStatus(int code)
        {
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as ErrorResponseMetaStatus);
        }

        /// <summary>
        /// Returns true if ErrorResponseMetaStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorResponseMetaStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorResponseMetaStatus input)
        {
            if (input == null)
            {
                return false;
