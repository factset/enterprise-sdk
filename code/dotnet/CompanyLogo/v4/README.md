...
[![Nuget](https://img.shields.io/badge/nuget-v0.20.1-orange)](https://www.nuget.org/packages/FactSet.SDK.CompanyLogo/0.20.1)
...
dotnet add package FactSet.SDK.CompanyLogo -v 0.20.1
```
...
nuget install FactSet.SDK.CompanyLogo -Version 0.20.1
```
...
------------ | ------------- | ------------- | -------------
*CompanyApi* | [**GetCompanyLogoGet**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/CompanyLogo/v4/docs/CompanyApi.md#getcompanylogoget) | **GET** /company/logo | List of URLs of company logos.


## Documentation for Models

 - [Model.ErrorDetail](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/CompanyLogo/v4/docs/ErrorDetail.md)
 - [Model.ErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/CompanyLogo/v4/docs/ErrorResponse.md)
 - [Model.ErrorResponseMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/CompanyLogo/v4/docs/ErrorResponseMeta.md)
 - [Model.ErrorResponseMetaStatus](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/CompanyLogo/v4/docs/ErrorResponseMetaStatus.md)
