...
namespace FactSet.SDK.ChartGenerationService.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/ChartGenerationService/0.21.11";
            BasePath = "https://api.factset.com/charting/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/charting/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.ChartGenerationService) Debug Report:\n";
