...
namespace FactSet.SDK.ChartGenerationService.Api
{
    ...
    public interface IChartTemplatesApiSync : IApiAccessor
    {
        ...
        /// <param name="sd">Option for overriding the startDate of the chart. For absolute dates provide a string in &#x60;YYYYMMDD&#x60; format. We can also specify relative date options (optional)</param>
        /// <param name="ed">Option for overriding the endDate of the chart. For absolute dates provide a string in &#x60;YYYYMMDD&#x60; format. We can also specify relative date options (optional)</param>
    ...
    public interface IChartTemplatesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Object>> GetChartListAsync(string categories = default(string), string type = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
