...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/ConversationalAPIPoweredbyFactSetMercury/0.1.0";
            BasePath = "https://api.factset.com/conversational/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/conversational/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury) Debug Report:\n";
