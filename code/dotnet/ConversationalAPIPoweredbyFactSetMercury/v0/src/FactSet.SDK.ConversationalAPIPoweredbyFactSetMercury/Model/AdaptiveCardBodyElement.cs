...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdaptiveCardBodyElement")]
    public partial class AdaptiveCardBodyElement : IEquatable<AdaptiveCardBodyElement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveCardBodyElement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdaptiveCardBodyElement()
        {
        ...
        public AdaptiveCardBodyElement(string type)
        {
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for AdaptiveCardBodyElement and cannot be null");
            }
            this.Type = type;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdaptiveCardBodyElement {\n");
        ...
        {
            return this.Equals(input as AdaptiveCardBodyElement);
        }

        /// <summary>
        /// Returns true if AdaptiveCardBodyElement instances are equal
        /// </summary>
        /// <param name="input">Instance of AdaptiveCardBodyElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdaptiveCardBodyElement input)
        {
            if (input == null)
            {
                return false;
