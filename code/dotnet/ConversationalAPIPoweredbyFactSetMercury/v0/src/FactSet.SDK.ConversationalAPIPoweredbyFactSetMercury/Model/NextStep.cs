...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class NextStep : IEquatable<NextStep>, IValidatableObject
    {
        ...
        /// <param name="value">List of NextStep items.</param>
        public NextStep(TypeEnum? type = default(TypeEnum?), List<NextStepItem> value = default(List<NextStepItem>))
        {
            this.Type = type;
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>List of NextStep items</value>
