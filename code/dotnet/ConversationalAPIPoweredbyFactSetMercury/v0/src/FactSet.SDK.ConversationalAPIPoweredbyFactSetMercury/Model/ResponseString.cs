...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseString")]
    public partial class ResponseString : IEquatable<ResponseString>, IValidatableObject
    {
        ...
        /// <param name="value">String containing chat response to the query (required).</param>
        ...
        public ResponseString(TypeEnum type, string value,Dictionary<string, List<Phrase>> citations = default(Dictionary<string, List<Phrase>>))
        {
            this.Type = type;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ResponseString and cannot be null");
            }
            this.Value = value;
        ...
        /// </summary>
        /// <value>String containing chat response to the query</value>
