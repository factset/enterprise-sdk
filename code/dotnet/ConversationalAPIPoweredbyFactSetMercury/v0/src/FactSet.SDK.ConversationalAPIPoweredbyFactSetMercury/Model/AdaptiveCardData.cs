...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdaptiveCardData")]
    public partial class AdaptiveCardData : IEquatable<AdaptiveCardData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveCardData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdaptiveCardData()
        {
        ...
        /// Initializes a new instance of the <see cref="AdaptiveCardData" /> class.
        /// </summary>
        /// <param name="type">Type of card (required).</param>
        /// <param name="version">Version of card (required).</param>
        /// <param name="body">Array of Adaptive Card body elements.</param>
        public AdaptiveCardData(string type, string version,List<AdaptiveCardBodyElement> body = default(List<AdaptiveCardBodyElement>))
        {
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for AdaptiveCardData and cannot be null");
            }
            this.Type = type;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for AdaptiveCardData and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Array of Adaptive Card body elements</value>
        [DataMember(Name = "body", EmitDefaultValue = false)]
        public List<AdaptiveCardBodyElement> Body { get; set; }
        ...
        {
            return this.Equals(input as AdaptiveCardData);
        }

        /// <summary>
        /// Returns true if AdaptiveCardData instances are equal
        /// </summary>
        /// <param name="input">Instance of AdaptiveCardData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdaptiveCardData input)
        {
            if (input == null)
            {
                return false;
