...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TableData")]
    public partial class TableData : IEquatable<TableData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TableData" /> class.
        /// </summary>
        /// <param name="version">Version of table.</param>
        public TableData(string version = default(string))
        {
        ...
        {
            return this.Equals(input as TableData);
        }

        /// <summary>
        /// Returns true if TableData instances are equal
        /// </summary>
        /// <param name="input">Instance of TableData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TableData input)
        {
            if (input == null)
            {
                return false;
