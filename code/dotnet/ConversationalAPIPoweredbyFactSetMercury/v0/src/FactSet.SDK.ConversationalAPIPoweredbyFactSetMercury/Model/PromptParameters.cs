...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromptParameters")]
    public partial class PromptParameters : IEquatable<PromptParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromptParameters" /> class.
        /// </summary>
        /// <param name="template">Prompt template used to build a follow up prompt to send to FactSet Mercury.</param>
        /// <param name="_params">List of prompt parameters.</param>
        public PromptParameters(string template = default(string), List<PromptParameter> _params = default(List<PromptParameter>))
        {
        ...
        /// </summary>
        /// <value>Prompt template used to build a follow up prompt to send to FactSet Mercury</value>
        ...
        /// </summary>
        /// <value>List of prompt parameters</value>
        [DataMember(Name = "params", EmitDefaultValue = false)]
        public List<PromptParameter> Params { get; set; }
        ...
        {
            return this.Equals(input as PromptParameters);
        }

        /// <summary>
        /// Returns true if PromptParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of PromptParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PromptParameters input)
        {
            if (input == null)
            {
                return false;
