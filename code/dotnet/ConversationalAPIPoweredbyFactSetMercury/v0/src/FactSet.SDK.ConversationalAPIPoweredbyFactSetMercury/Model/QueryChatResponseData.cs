...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// Data object
    /// </summary>
    [DataContract(Name = "QueryChatResponse_data")]
    public partial class QueryChatResponseData : IEquatable<QueryChatResponseData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryChatResponseData" /> class.
        /// </summary>
        /// <param name="chatId">Id of current conversation.</param>
        /// <param name="jobId">Id of current query.</param>
        /// <param name="status">status of current query.</param>
        public QueryChatResponseData(Guid chatId = default(Guid), Guid jobId = default(Guid), StatusEnum? status = default(StatusEnum?))
        {
            this.ChatId = chatId;
            this.JobId = jobId;
            this.Status = status;
        ...
        /// </summary>
        /// <value>Id of current conversation</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryChatResponseData {\n");
        ...
        {
            return this.Equals(input as QueryChatResponseData);
        }

        /// <summary>
        /// Returns true if QueryChatResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryChatResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryChatResponseData input)
        {
            if (input == null)
            {
                return false;
