...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class FeedbackRequest : IEquatable<FeedbackRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackRequest" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FeedbackRequest(FeedbackRequestData data = default(FeedbackRequestData))
        {
            this.Data = data;
        }
        ...
        public FeedbackRequestData Data { get; set; }
        ...
        {
            return this.Equals(input as FeedbackRequest);
        }

        /// <summary>
        /// Returns true if FeedbackRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FeedbackRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeedbackRequest input)
        {
            if (input == null)
            {
                return false;
