...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChatPollingRequest")]
    public partial class ChatPollingRequest : IEquatable<ChatPollingRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatPollingRequest" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ChatPollingRequest(ChatPollingRequestData data = default(ChatPollingRequestData))
        {
            this.Data = data;
        }
        ...
        public ChatPollingRequestData Data { get; set; }
        ...
        {
            return this.Equals(input as ChatPollingRequest);
        }

        /// <summary>
        /// Returns true if ChatPollingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChatPollingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatPollingRequest input)
        {
            if (input == null)
            {
                return false;
