...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdaptiveCard")]
    public partial class AdaptiveCard : IEquatable<AdaptiveCard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveCard" /> class.
        /// </summary>
        /// <param name="type">Datatype contained in this data object.</param>
        /// <param name="value">value.</param>
        public AdaptiveCard(TypeEnum? type = default(TypeEnum?), AdaptiveCardData value = default(AdaptiveCardData))
        {
            this.Type = type;
            this.Value = value;
        }
        ...
        public AdaptiveCardData Value { get; set; }
        ...
        {
            return this.Equals(input as AdaptiveCard);
        }

        /// <summary>
        /// Returns true if AdaptiveCard instances are equal
        /// </summary>
        /// <param name="input">Instance of AdaptiveCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdaptiveCard input)
        {
            if (input == null)
            {
                return false;
