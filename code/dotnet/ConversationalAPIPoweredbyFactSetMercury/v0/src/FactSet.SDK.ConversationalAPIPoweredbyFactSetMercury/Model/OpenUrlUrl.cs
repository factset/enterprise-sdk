...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// Available url links
    /// </summary>
    [DataContract(Name = "OpenUrl_url")]
    public partial class OpenUrlUrl : IEquatable<OpenUrlUrl>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenUrlUrl" /> class.
        /// </summary>
        /// <param name="fdsup">Fdsup link.</param>
        /// <param name="http">Http link.</param>
        public OpenUrlUrl(string fdsup = default(string), string http = default(string))
        {
            this.Fdsup = fdsup;
            this.Http = http;
        }
        ...
        /// Fdsup link
        /// </summary>
        /// <value>Fdsup link</value>
        [DataMember(Name = "fdsup", EmitDefaultValue = false)]
        public string Fdsup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenUrlUrl {\n");
            sb.Append("  Fdsup: ").Append(Fdsup).Append("\n");
        ...
        {
            return this.Equals(input as OpenUrlUrl);
        }

        /// <summary>
        /// Returns true if OpenUrlUrl instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenUrlUrl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenUrlUrl input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Fdsup == input.Fdsup ||
                    (this.Fdsup != null &&
                    this.Fdsup.Equals(input.Fdsup))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Fdsup != null)
                {
                    hashCode = (hashCode * 59) + this.Fdsup.GetHashCode();
                }
                if (this.Http != null)
                {
