...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// Data object
    /// </summary>
    [DataContract(Name = "QueryResponse_data")]
    public partial class QueryResponseData : IEquatable<QueryResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryResponseData" /> class.
        /// </summary>
        /// <param name="id">Id of query response.</param>
        /// <param name="data">Data array.</param>
        public QueryResponseData(Guid id = default(Guid), List<FederationData> data = default(List<FederationData>))
        {
            this.Id = id;
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Id of query response</value>
        ...
        public List<FederationData> Data { get; set; }
        ...
        {
            return this.Equals(input as QueryResponseData);
        }

        /// <summary>
        /// Returns true if QueryResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryResponseData input)
        {
            if (input == null)
            {
                return false;
