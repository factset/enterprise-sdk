...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class Download : IEquatable<Download>, IValidatableObject
    {
        ...
        /// <param name="name">Name of the download type.</param>
        /// <param name="label">Label associated with the download.</param>
        ...
        /// <param name="error">Boolean representing if there was an error generating the downloadable file (required).</param>
        /// <param name="errorMessage">Error message detailing the error in generating the downloadable file.</param>
        public Download(bool error,ActionEnum? action = default(ActionEnum?), string name = default(string), string label = default(string), string category = default(string), LocationEnum? location = default(LocationEnum?), Guid fileId = default(Guid), string contentType = default(string), string fileName = default(string), string errorMessage = default(string))
        {
            this.Error = error;
            this.Action = action;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Boolean representing if there was an error generating the downloadable file</value>
        ...
        /// </summary>
        /// <value>Error message detailing the error in generating the downloadable file</value>
