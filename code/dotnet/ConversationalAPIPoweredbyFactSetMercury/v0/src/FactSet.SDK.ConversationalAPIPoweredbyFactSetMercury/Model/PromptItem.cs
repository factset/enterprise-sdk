...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class PromptItem : IEquatable<PromptItem>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="PromptItem" /> class.
        /// </summary>
        /// <param name="prompt">Prompt to the Conversational API consumer containing a suggested further action (required).</param>
        ...
        /// </summary>
        /// <value>Prompt to the Conversational API consumer containing a suggested further action</value>
