...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class PromptParameter : IEquatable<PromptParameter>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="selectionType">Selection type, currently only support single selection.</param>
        /// <param name="placeHolder">PlaceHolder value used in the prompt template.</param>
        /// <param name="value">Selection option values can be used to replace the placeHolder in the prompt template.</param>
        public PromptParameter(SelectionTypeEnum? selectionType = default(SelectionTypeEnum?), string placeHolder = default(string), List<string> value = default(List<string>))
        {
