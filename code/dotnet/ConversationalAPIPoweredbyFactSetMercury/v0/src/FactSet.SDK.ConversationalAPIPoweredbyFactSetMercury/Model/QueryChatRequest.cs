...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueryChatRequest")]
    public partial class QueryChatRequest : IEquatable<QueryChatRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryChatRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueryChatRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryChatRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public QueryChatRequest(QueryChatRequestData data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for QueryChatRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public QueryChatRequestData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryChatRequest {\n");
        ...
        {
            return this.Equals(input as QueryChatRequest);
        }

        /// <summary>
        /// Returns true if QueryChatRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryChatRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryChatRequest input)
        {
            if (input == null)
            {
                return false;
