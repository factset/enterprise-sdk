...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class RateLimitExceededError : IEquatable<RateLimitExceededError>, IValidatableObject
    {
        /// <summary>
        /// Message of error response
        /// </summary>
        /// <value>Message of error response</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum MessageEnum
        {
            /// <summary>
            /// Enum APIRateLimitExceeded for value: API rate limit exceeded
            /// </summary>
            [EnumMember(Value = "API rate limit exceeded")]
            APIRateLimitExceeded = 1
        ...
        /// </summary>
        /// <param name="message">Message of error response.</param>
        /// <param name="errors">Array of ErrorObject.</param>
        public RateLimitExceededError(MessageEnum? message = default(MessageEnum?), List<ErrorObject> errors = default(List<ErrorObject>))
        {
        ...
        /// </summary>
        /// <value>Array of ErrorObject</value>
        ...
        {
            return this.Equals(input as RateLimitExceededError);
        }

        /// <summary>
        /// Returns true if RateLimitExceededError instances are equal
        /// </summary>
        /// <param name="input">Instance of RateLimitExceededError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RateLimitExceededError input)
        {
            if (input == null)
            {
                return false;
