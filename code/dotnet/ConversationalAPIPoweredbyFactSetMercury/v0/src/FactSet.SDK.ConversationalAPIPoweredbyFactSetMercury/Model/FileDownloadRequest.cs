...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileDownloadRequest")]
    public partial class FileDownloadRequest : IEquatable<FileDownloadRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public FileDownloadRequest(FileDownloadRequestData data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for FileDownloadRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public FileDownloadRequestData Data { get; set; }
        ...
        {
            return this.Equals(input as FileDownloadRequest);
        }

        /// <summary>
        /// Returns true if FileDownloadRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FileDownloadRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileDownloadRequest input)
        {
            if (input == null)
            {
                return false;
