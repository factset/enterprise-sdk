...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// Data object
    /// </summary>
    [DataContract(Name = "QueryChatRequest_data")]
    public partial class QueryChatRequestData : IEquatable<QueryChatRequestData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryChatRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueryChatRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryChatRequestData" /> class.
        /// </summary>
        /// <param name="query">Natural language query for FactSet data (required).</param>
        /// <param name="chatId">optional ID for the current ongoing conversation.</param>
        public QueryChatRequestData(string query,string chatId = default(string))
        {
            // to ensure "query" is required (not null)
            if (query == null) {
                throw new ArgumentNullException("query is a required property for QueryChatRequestData and cannot be null");
            }
            this.Query = query;
            this.ChatId = chatId;
        }
        ...
        /// </summary>
        /// <value>Natural language query for FactSet data</value>
        ...
        /// </summary>
        /// <value>optional ID for the current ongoing conversation</value>
        ...
        {
            return this.Equals(input as QueryChatRequestData);
        }

        /// <summary>
        /// Returns true if QueryChatRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryChatRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryChatRequestData input)
        {
            if (input == null)
            {
                return false;
