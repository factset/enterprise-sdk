...
dotnet add package FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -v 1.0.1
```
...
nuget install FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -Version 1.0.1
```
