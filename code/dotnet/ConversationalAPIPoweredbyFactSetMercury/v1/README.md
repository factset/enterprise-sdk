...
[![API Version](https://img.shields.io/badge/api-v1.0.3-blue)](https://developer.factset.com/api-catalog/conversational-api-powered-factset-mercury)
...
dotnet add package FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -v 1.0.0
```
...
nuget install FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -Version 1.0.0
```
...
namespace Example
{
    public static class GetChatResultExample
    {
