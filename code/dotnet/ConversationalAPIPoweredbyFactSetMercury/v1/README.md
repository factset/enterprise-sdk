...
[![API Version](https://img.shields.io/badge/api-v1.0.8-blue)](https://developer.factset.com/api-catalog/conversational-api-powered-factset-mercury)
[![Nuget](https://img.shields.io/badge/nuget-v1.0.4-orange)](https://www.nuget.org/packages/FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury/1.0.4)
...
dotnet add package FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -v 1.0.4
```
...
nuget install FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -Version 1.0.4
```
