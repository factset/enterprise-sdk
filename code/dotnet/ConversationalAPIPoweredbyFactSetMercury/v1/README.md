...
[![API Version](https://img.shields.io/badge/api-v1.1.0-blue)](https://developer.factset.com/api-catalog/conversational-api-powered-factset-mercury)
[![Nuget](https://img.shields.io/badge/nuget-v1.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury/1.1.0)
...
dotnet add package FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -v 1.1.0
```
...
nuget install FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -Version 1.1.0
```
