...
dotnet add package FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -v 0.10.0
```
...
nuget install FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury -Version 0.10.0
```
