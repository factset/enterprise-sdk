...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class AdaptiveCard : IEquatable<AdaptiveCard>, IValidatableObject
    {
        ...
        protected AdaptiveCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveCard" /> class.
        /// </summary>
        /// <param name="type">Datatype contained in this data object (required).</param>
        /// <param name="value">A JSON-serialized Adaptive Card object modeled after the [Adaptive Card schema](https://adaptivecards.io/explorer/). (required).</param>
        public AdaptiveCard(TypeEnum type, Object value)
        {
            this.Type = type;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for AdaptiveCard and cannot be null");
            }
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>A JSON-serialized Adaptive Card object modeled after the [Adaptive Card schema](https://adaptivecards.io/explorer/).</value>
