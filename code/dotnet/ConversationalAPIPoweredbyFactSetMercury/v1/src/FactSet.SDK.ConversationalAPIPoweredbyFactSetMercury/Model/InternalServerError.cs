...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class InternalServerError : IEquatable<InternalServerError>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InternalServerError" /> class.
        /// </summary>
        /// <param name="errors">Array of InternalServerErrorObject (required).</param>
        public InternalServerError(List<InternalServerErrorObject> errors)
        {
            // to ensure "errors" is required (not null)
            if (errors == null) {
                throw new ArgumentNullException("errors is a required property for InternalServerError and cannot be null");
            }
            this.Errors = errors;
        }
        ...
        /// </summary>
        /// <value>Array of InternalServerErrorObject</value>
        [DataMember(Name = "errors", IsRequired = true, EmitDefaultValue = false)]
        public List<InternalServerErrorObject> Errors { get; set; }
