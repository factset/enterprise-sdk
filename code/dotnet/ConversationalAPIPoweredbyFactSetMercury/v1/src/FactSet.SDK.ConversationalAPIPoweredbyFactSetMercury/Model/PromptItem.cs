...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromptItem")]
    public partial class PromptItem : IEquatable<PromptItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="PromptItem" /> class.
        /// </summary>
        /// <param name="prompt">Follow-up prompt generated by FactSet Mercury (required).</param>
        /// <param name="promptParameters">promptParameters.</param>
        public PromptItem(string prompt,PromptParameters promptParameters = default(PromptParameters))
        {
            // to ensure "prompt" is required (not null)
            if (prompt == null) {
                throw new ArgumentNullException("prompt is a required property for PromptItem and cannot be null");
            }
            this.Prompt = prompt;
        ...
        /// </summary>
        /// <value>Follow-up prompt generated by FactSet Mercury</value>
        [DataMember(Name = "prompt", IsRequired = true, EmitDefaultValue = false)]
        public string Prompt { get; set; }

        /// <summary>
        /// Gets or Sets PromptParameters
        /// </summary>
        [DataMember(Name = "promptParameters", EmitDefaultValue = false)]
        public PromptParameters PromptParameters { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PromptParameters: ").Append(PromptParameters).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(PromptItem input)
        {
            ...
            return 
                ...
                (
                    this.PromptParameters == input.PromptParameters ||
                    (this.PromptParameters != null &&
                    this.PromptParameters.Equals(input.PromptParameters))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PromptParameters.GetHashCode();
                }
                return hashCode;
            }
        }
