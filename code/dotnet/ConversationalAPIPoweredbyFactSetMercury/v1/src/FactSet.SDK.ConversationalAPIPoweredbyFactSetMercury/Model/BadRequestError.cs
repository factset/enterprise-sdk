...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class BadRequestError : IEquatable<BadRequestError>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="BadRequestError" /> class.
        /// </summary>
        /// <param name="errors">Array of BadRequestErrorObject (required).</param>
        public BadRequestError(List<BadRequestErrorObject> errors)
        {
            // to ensure "errors" is required (not null)
            if (errors == null) {
                throw new ArgumentNullException("errors is a required property for BadRequestError and cannot be null");
            }
            this.Errors = errors;
        }
        ...
        /// </summary>
        /// <value>Array of BadRequestErrorObject</value>
        [DataMember(Name = "errors", IsRequired = true, EmitDefaultValue = false)]
        public List<BadRequestErrorObject> Errors { get; set; }
