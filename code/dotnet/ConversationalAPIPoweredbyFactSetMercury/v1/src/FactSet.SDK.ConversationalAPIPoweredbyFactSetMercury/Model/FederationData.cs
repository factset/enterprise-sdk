...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class FederationData : AbstractOpenAPISchema, IEquatable<FederationData>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FederationData" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of MarkdownTable.</param>
        public FederationData(MarkdownTable actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value is MarkdownTable)
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ResponseText, AdaptiveCard, MarkdownTable, Table, NextStep, SuggestedPrompts");
                }
            }
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of MarkdownTable</returns>
        public MarkdownTable GetMarkdownTable()
        {
            return (MarkdownTable)this.ActualInstance;
        }
        ...
        public static FederationData FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                switch (discriminatorValue)
                {
                    case "AdaptiveCard":
                        ...
                        return newFederationData;
                    case "MarkdownTable":
                        newFederationData = new FederationData(JsonConvert.DeserializeObject<MarkdownTable>(jsonString, FederationData.AdditionalPropertiesSerializerSettings));
                        return newFederationData;
                    case "NextStep":
                    ...
                    case "string":
                        ...
                        return newFederationData;
                    default:
                        System.Diagnostics.Debug.WriteLine(string.Format("Failed to lookup discriminator value `{0}` for FederationData. Possible values: AdaptiveCard MarkdownTable NextStep ResponseText SuggestedPrompts Table string", discriminatorValue));
                        break;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                var hasAdditionalProperties = !(typeof(MarkdownTable).GetProperty("AdditionalProperties") is null);
                var parsedValue = JsonConvert.DeserializeObject<MarkdownTable>(
                    jsonString,
                    hasAdditionalProperties ? FederationData.AdditionalPropertiesSerializerSettings : FederationData.SerializerSettings
                );
                newFederationData = new FederationData(parsedValue);
                matchedTypes.Add("MarkdownTable");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into MarkdownTable: {1}", jsonString, exception.ToString()));
            }
