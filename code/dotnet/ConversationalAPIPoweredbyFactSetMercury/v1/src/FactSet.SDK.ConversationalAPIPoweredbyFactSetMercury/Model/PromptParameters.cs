...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class PromptParameters : IEquatable<PromptParameters>, IValidatableObject
    {
        ...
        protected PromptParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PromptParameters" /> class.
        /// </summary>
        /// <param name="template">Prompt template used to build a follow up prompt to send to FactSet Mercury (required).</param>
        /// <param name="_params">List of prompt parameters (required).</param>
        public PromptParameters(string template, List<PromptParameter> _params)
        {
            // to ensure "template" is required (not null)
            if (template == null) {
                throw new ArgumentNullException("template is a required property for PromptParameters and cannot be null");
            }
            this.Template = template;
            // to ensure "_params" is required (not null)
            if (_params == null) {
                throw new ArgumentNullException("_params is a required property for PromptParameters and cannot be null");
            }
            this.Params = _params;
        }
