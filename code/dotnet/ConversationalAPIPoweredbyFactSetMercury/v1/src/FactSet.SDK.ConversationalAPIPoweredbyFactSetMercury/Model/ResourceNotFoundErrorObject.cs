...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceNotFoundErrorObject")]
    public partial class ResourceNotFoundErrorObject : IEquatable<ResourceNotFoundErrorObject>, IValidatableObject
    {
        /// <summary>
        /// Title of error
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum EndpointNotFound for value: Endpoint Not Found
            /// </summary>
            [EnumMember(Value = "Endpoint Not Found")]
            EndpointNotFound = 1,
        ...
        public enum CodeEnum
        {
            ...
            /// <summary>
            /// Enum ConversationalApiResourceNotFound for value: conversational_api_resourceNotFound
            /// </summary>
            [EnumMember(Value = "conversational_api_resourceNotFound")]
            ConversationalApiResourceNotFound = 2
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceNotFoundErrorObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceNotFoundErrorObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceNotFoundErrorObject" /> class.
        /// </summary>
        ...
        public ResourceNotFoundErrorObject(Guid id, TitleEnum title, CodeEnum code, string detail)
        {
            this.Id = id;
            this.Title = title;
            this.Code = code;
            ...
            if (detail == null) {
                throw new ArgumentNullException("detail is a required property for ResourceNotFoundErrorObject and cannot be null");
            }
            this.Detail = detail;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceNotFoundErrorObject {\n");
        ...
        {
            return this.Equals(input as ResourceNotFoundErrorObject);
        }

        /// <summary>
        /// Returns true if ResourceNotFoundErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceNotFoundErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceNotFoundErrorObject input)
        {
            if (input == null)
            {
                return false;
