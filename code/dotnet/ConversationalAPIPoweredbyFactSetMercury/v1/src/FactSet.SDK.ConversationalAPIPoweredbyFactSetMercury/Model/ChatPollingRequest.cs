...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class ChatPollingRequest : IEquatable<ChatPollingRequest>, IValidatableObject
    {
        ...
        protected ChatPollingRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatPollingRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public ChatPollingRequest(ChatPollingRequestData data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ChatPollingRequest and cannot be null");
            }
            this.Data = data;
        }
