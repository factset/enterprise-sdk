...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class MarkdownTable : IEquatable<MarkdownTable>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum MarkdownTable for value: MarkdownTable
            /// </summary>
            [EnumMember(Value = "MarkdownTable")]
            MarkdownTable = 1
        ...
        protected MarkdownTable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkdownTable" /> class.
        /// </summary>
        /// <param name="type">Datatype contained in this data object (required).</param>
        /// <param name="value">Markdown formatted table data (required).</param>
        /// <param name="metadata">metadata.</param>
        public MarkdownTable(TypeEnum type, string value,MarkdownTableMetadata metadata = default(MarkdownTableMetadata))
        {
            this.Type = type;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for MarkdownTable and cannot be null");
            }
            this.Value = value;
        ...
        /// </summary>
        /// <value>Markdown formatted table data</value>
        ...
        public MarkdownTableMetadata Metadata { get; set; }
        ...
        {
            return this.Equals(input as MarkdownTable);
        }

        /// <summary>
        /// Returns true if MarkdownTable instances are equal
        /// </summary>
        /// <param name="input">Instance of MarkdownTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarkdownTable input)
        {
            if (input == null)
            {
                return false;
