...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InternalServerErrorObject")]
    public partial class InternalServerErrorObject : IEquatable<InternalServerErrorObject>, IValidatableObject
    {
        /// <summary>
        /// Title of error
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum UnknownError for value: Unknown Error
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalServerErrorObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InternalServerErrorObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalServerErrorObject" /> class.
        /// </summary>
        ...
        public InternalServerErrorObject(Guid id, TitleEnum title, CodeEnum code, string detail)
        {
            this.Id = id;
            this.Title = title;
            this.Code = code;
            ...
            if (detail == null) {
                throw new ArgumentNullException("detail is a required property for InternalServerErrorObject and cannot be null");
            }
            this.Detail = detail;
        }
        ...
        {
            return this.Equals(input as InternalServerErrorObject);
        }

        /// <summary>
        /// Returns true if InternalServerErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalServerErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalServerErrorObject input)
        {
            if (input == null)
            {
                return false;
