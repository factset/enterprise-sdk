...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class QueryResponseData : IEquatable<QueryResponseData>, IValidatableObject
    {
        ...
        protected QueryResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryResponseData" /> class.
        /// </summary>
        /// <param name="responseId">ID of the response generated by FactSet Mercury. **Note:** This ID cannot be used as a chatId or jobId. (required).</param>
        /// <param name="data">Data array (required).</param>
        public QueryResponseData(Guid responseId, List<FederationData> data)
        {
            this.ResponseId = responseId;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for QueryResponseData and cannot be null");
            }
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>ID of the response generated by FactSet Mercury. **Note:** This ID cannot be used as a chatId or jobId.</value>
