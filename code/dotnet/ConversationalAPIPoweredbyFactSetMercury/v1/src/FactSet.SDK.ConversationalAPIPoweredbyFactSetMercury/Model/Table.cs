...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    public partial class Table : IEquatable<Table>, IValidatableObject
    {
        ...
        /// <param name="value">Data table represented in [FactSet STACH V3](https://factset.github.io/stachschema/#/v3/README) format (required).</param>
        public Table(TypeEnum type, Object value)
        {
            this.Type = type;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for Table and cannot be null");
            }
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>Data table represented in [FactSet STACH V3](https://factset.github.io/stachschema/#/v3/README) format</value>
