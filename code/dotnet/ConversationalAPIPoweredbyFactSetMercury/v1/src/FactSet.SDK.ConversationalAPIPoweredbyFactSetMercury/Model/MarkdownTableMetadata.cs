...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MarkdownTable_metadata")]
    public partial class MarkdownTableMetadata : IEquatable<MarkdownTableMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkdownTableMetadata" /> class.
        /// </summary>
        /// <param name="displayName">Display name of the markdown formatted table.</param>
        public MarkdownTableMetadata(string displayName = default(string))
        {
            this.DisplayName = displayName;
        }

        /// <summary>
        /// Display name of the markdown formatted table
        /// </summary>
        /// <value>Display name of the markdown formatted table</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarkdownTableMetadata {\n");
        ...
        {
            return this.Equals(input as MarkdownTableMetadata);
        }

        /// <summary>
        /// Returns true if MarkdownTableMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of MarkdownTableMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarkdownTableMetadata input)
        {
            if (input == null)
            {
                return false;
