...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BadFeedbackRequestErrorObject")]
    public partial class BadFeedbackRequestErrorObject : IEquatable<BadFeedbackRequestErrorObject>, IValidatableObject
    {
        /// <summary>
        /// Title of error
        /// </summary>
        ...
        public enum TitleEnum
        {
            ...
            /// <summary>
            /// Enum InvalidResponseID for value: Invalid Response ID
            /// </summary>
            [EnumMember(Value = "Invalid Response ID")]
            InvalidResponseID = 4
        ...
        public enum CodeEnum
        {
            ...
            RequestBodyInvalid = 2,

            /// <summary>
            /// Enum ConversationalApiInvalidUri for value: conversational_api_invalidUri
            /// </summary>
            [EnumMember(Value = "conversational_api_invalidUri")]
            ConversationalApiInvalidUri = 3,

            /// <summary>
            /// Enum ConversationalApiInvalidResponseId for value: conversational_api_invalidResponseId
            /// </summary>
            [EnumMember(Value = "conversational_api_invalidResponseId")]
            ConversationalApiInvalidResponseId = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BadFeedbackRequestErrorObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BadFeedbackRequestErrorObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BadFeedbackRequestErrorObject" /> class.
        /// </summary>
        ...
        public BadFeedbackRequestErrorObject(Guid id, TitleEnum title, CodeEnum code, string detail)
        {
            this.Id = id;
            this.Title = title;
            this.Code = code;
            ...
            if (detail == null) {
                throw new ArgumentNullException("detail is a required property for BadFeedbackRequestErrorObject and cannot be null");
            }
            this.Detail = detail;
        }
        ...
        {
            return this.Equals(input as BadFeedbackRequestErrorObject);
        }

        /// <summary>
        /// Returns true if BadFeedbackRequestErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of BadFeedbackRequestErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BadFeedbackRequestErrorObject input)
        {
            if (input == null)
            {
                return false;
