...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StatusPollResponse")]
    public partial class StatusPollResponse : IEquatable<StatusPollResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusPollResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatusPollResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusPollResponse" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public StatusPollResponse(StatusPollResponseData data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for StatusPollResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        public StatusPollResponseData Data { get; set; }
        ...
        {
            return this.Equals(input as StatusPollResponse);
        }

        /// <summary>
        /// Returns true if StatusPollResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusPollResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusPollResponse input)
        {
            if (input == null)
            {
                return false;
