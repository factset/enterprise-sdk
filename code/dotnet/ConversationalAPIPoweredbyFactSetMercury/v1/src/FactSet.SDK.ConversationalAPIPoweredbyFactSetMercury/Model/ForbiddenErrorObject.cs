...
namespace FactSet.SDK.ConversationalAPIPoweredbyFactSetMercury.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ForbiddenErrorObject")]
    public partial class ForbiddenErrorObject : IEquatable<ForbiddenErrorObject>, IValidatableObject
    {
        /// <summary>
        /// Title of error
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum NotAuthorized for value: Not Authorized
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForbiddenErrorObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ForbiddenErrorObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ForbiddenErrorObject" /> class.
        /// </summary>
        ...
        public ForbiddenErrorObject(Guid id, TitleEnum title, CodeEnum code, string detail)
        {
            this.Id = id;
            this.Title = title;
            this.Code = code;
            ...
            if (detail == null) {
                throw new ArgumentNullException("detail is a required property for ForbiddenErrorObject and cannot be null");
            }
            this.Detail = detail;
        }
        ...
        {
            return this.Equals(input as ForbiddenErrorObject);
        }

        /// <summary>
        /// Returns true if ForbiddenErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ForbiddenErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForbiddenErrorObject input)
        {
            if (input == null)
            {
                return false;
