# FactSet.SDK.QuotesAPIforDigitalPortals.Model.PostNotationSearchByTextRequestDataValidationPrices
...
------------ | ------------- | ------------- | -------------
**Quality** | **string** | Quality of the price. | [optional] [default to QualityEnum.EOD]
