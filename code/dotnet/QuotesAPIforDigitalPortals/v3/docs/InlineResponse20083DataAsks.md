# FactSet.SDK.QuotesAPIforDigitalPortals.Model.InlineResponse20083DataAsks
...
**NumberOrders** | **decimal** | Number of orders for the price level. | [optional] 
**Volume** | **decimal** | Summarized volume for the price level. | [optional] 
