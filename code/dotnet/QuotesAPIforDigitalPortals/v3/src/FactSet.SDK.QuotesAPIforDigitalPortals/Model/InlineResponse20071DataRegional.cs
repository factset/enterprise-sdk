...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_71_data_regional")]
    public partial class InlineResponse20071DataRegional : IEquatable<InlineResponse20071DataRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20071DataRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20071DataRegional(bool? isPrimary = default(bool?), string permanentIdentifier = default(string), string tickerRegion = default(string), InlineResponse20071DataRegionalListing listing = default(InlineResponse20071DataRegionalListing))
        {
        ...
        public InlineResponse20071DataRegionalListing Listing { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20071DataRegional {\n");
        ...
        {
            return this.Equals(input as InlineResponse20071DataRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20071DataRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20071DataRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20071DataRegional input)
        {
            if (input == null)
            {
                return false;
