...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_94_instrument")]
    public partial class InlineResponse20094Instrument : IEquatable<InlineResponse20094Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20094Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20094Instrument(string id = default(string), InlineResponse20094InstrumentName name = default(InlineResponse20094InstrumentName), string isin = default(string), InlineResponse20093InstrumentNsin nsin = default(InlineResponse20093InstrumentNsin), InlineResponse20036Fsym fsym = default(InlineResponse20036Fsym), InlineResponse20094InstrumentAssetClass assetClass = default(InlineResponse20094InstrumentAssetClass), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        public InlineResponse20094InstrumentName Name { get; set; }
        ...
        public InlineResponse20094InstrumentAssetClass AssetClass { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20094Instrument {\n");
        ...
        {
            return this.Equals(input as InlineResponse20094Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20094Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20094Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20094Instrument input)
        {
            if (input == null)
            {
                return false;
