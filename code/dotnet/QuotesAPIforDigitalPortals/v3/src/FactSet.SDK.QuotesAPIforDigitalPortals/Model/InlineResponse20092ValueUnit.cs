...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_92_valueUnit")]
    public partial class InlineResponse20092ValueUnit : IEquatable<InlineResponse20092ValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20092ValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20092ValueUnit(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse20092ValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20092ValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20092ValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20092ValueUnit input)
        {
            if (input == null)
            {
                return false;
