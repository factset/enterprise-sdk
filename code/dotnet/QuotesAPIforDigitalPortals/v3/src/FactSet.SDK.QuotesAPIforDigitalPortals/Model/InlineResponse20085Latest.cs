...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_85_latest")]
    public partial class InlineResponse20085Latest : IEquatable<InlineResponse20085Latest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20085Latest" /> class.
        /// </summary>
        ...
        public InlineResponse20085Latest(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), InlineResponse20085LatestPerformance performance = default(InlineResponse20085LatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20085LatestPerformance Performance { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20085Latest);
        }

        /// <summary>
        /// Returns true if InlineResponse20085Latest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20085Latest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20085Latest input)
        {
            if (input == null)
            {
                return false;
