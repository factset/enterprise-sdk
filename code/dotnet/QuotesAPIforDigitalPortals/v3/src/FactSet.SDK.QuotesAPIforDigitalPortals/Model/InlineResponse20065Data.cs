...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20065Data : IEquatable<InlineResponse20065Data>, IValidatableObject
    {
        ...
        public InlineResponse20065Data(string idNotation = default(string), string sourceIdentifier = default(string), string symbol = default(string), string factSetMarketSymbol = default(string), InlineResponse20065DataValueUnit valueUnit = default(InlineResponse20065DataValueUnit), InlineResponse20065DataMarket market = default(InlineResponse20065DataMarket), InlineResponse20065DataInstrument instrument = default(InlineResponse20065DataInstrument))
        {
