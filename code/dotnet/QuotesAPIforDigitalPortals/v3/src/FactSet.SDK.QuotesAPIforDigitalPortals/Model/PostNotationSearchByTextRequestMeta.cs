...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class PostNotationSearchByTextRequestMeta : IEquatable<PostNotationSearchByTextRequestMeta>, IValidatableObject
    {
        ...
        public PostNotationSearchByTextRequestMeta(List<string> attributes = default(List<string>), string language = default(string), List<SortEnum> sort = default(List<SortEnum>), PostBasicMarketListRequestMetaPagination pagination = default(PostBasicMarketListRequestMetaPagination))
        {
