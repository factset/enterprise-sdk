...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_28_data_mainCurrency")]
    public partial class InlineResponse20028DataMainCurrency : IEquatable<InlineResponse20028DataMainCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20028DataMainCurrency" /> class.
        /// </summary>
        ...
        public InlineResponse20028DataMainCurrency(decimal? id = default(decimal?), string code = default(string), string isoCode = default(string), string name = default(string), bool? active = default(bool?))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20028DataMainCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse20028DataMainCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20028DataMainCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20028DataMainCurrency input)
        {
            if (input == null)
            {
                return false;
