...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_data_market")]
    public partial class InlineResponse20082DataMarket : IEquatable<InlineResponse20082DataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082DataMarket" /> class.
        /// </summary>
        ...
        public InlineResponse20082DataMarket(decimal? id = default(decimal?), bool? isOpen = default(bool?), string phase = default(string))
        {
            this.Id = id;
            this.IsOpen = isOpen;
            this.Phase = phase;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20082DataMarket {\n");
        ...
        {
            return this.Equals(input as InlineResponse20082DataMarket);
        }

        /// <summary>
        /// Returns true if InlineResponse20082DataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082DataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082DataMarket input)
        {
            if (input == null)
            {
                return false;
