...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20066Data : IEquatable<InlineResponse20066Data>, IValidatableObject
    {
        ...
        public InlineResponse20066Data(string idNotation = default(string), string sourceIdentifier = default(string), string symbol = default(string), string factSetMarketSymbol = default(string), InlineResponse20065DataValueUnit valueUnit = default(InlineResponse20065DataValueUnit), InlineResponse20065DataMarket market = default(InlineResponse20065DataMarket), InlineResponse20065DataInstrument instrument = default(InlineResponse20065DataInstrument), InlineResponse20066Status status = default(InlineResponse20066Status))
        {
        ...
        public InlineResponse20065DataValueUnit ValueUnit { get; set; }

        /// <summary>
        /// Gets or Sets Market
        /// </summary>
        [DataMember(Name = "market", EmitDefaultValue = false)]
        public InlineResponse20065DataMarket Market { get; set; }

        /// <summary>
        /// Gets or Sets Instrument
        /// </summary>
        [DataMember(Name = "instrument", EmitDefaultValue = false)]
        public InlineResponse20065DataInstrument Instrument { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name = "status", EmitDefaultValue = false)]
        public InlineResponse20066Status Status { get; set; }
