...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_67_data_valueUnit")]
    public partial class InlineResponse20067DataValueUnit : IEquatable<InlineResponse20067DataValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20067DataValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20067DataValueUnit(decimal? id = default(decimal?), string code = default(string), string isoCode = default(string), string name = default(string))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20067DataValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20067DataValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20067DataValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20067DataValueUnit input)
        {
            if (input == null)
            {
                return false;
