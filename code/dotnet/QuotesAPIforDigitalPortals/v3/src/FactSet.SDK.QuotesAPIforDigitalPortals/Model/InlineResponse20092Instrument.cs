...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_92_instrument")]
    public partial class InlineResponse20092Instrument : IEquatable<InlineResponse20092Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20092Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20092Instrument(string id = default(string), InlineResponse20092InstrumentName name = default(InlineResponse20092InstrumentName), string isin = default(string), InlineResponse20091InstrumentNsin nsin = default(InlineResponse20091InstrumentNsin), InlineResponse20036Fsym fsym = default(InlineResponse20036Fsym), InlineResponse20092InstrumentAssetClass assetClass = default(InlineResponse20092InstrumentAssetClass), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        public InlineResponse20092InstrumentName Name { get; set; }
        ...
        public InlineResponse20092InstrumentAssetClass AssetClass { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20092Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20092Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20092Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20092Instrument input)
        {
            if (input == null)
            {
                return false;
