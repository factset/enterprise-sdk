...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_81_data_price")]
    public partial class InlineResponse20081DataPrice : IEquatable<InlineResponse20081DataPrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20081DataPrice" /> class.
        /// </summary>
        /// <param name="days5">Five trading days..</param>
        /// <param name="days20">20 trading days..</param>
        /// <param name="days30">30 trading days..</param>
        /// <param name="days38">38 trading days..</param>
        ...
        public InlineResponse20081DataPrice(decimal? days5 = default(decimal?), decimal? days20 = default(decimal?), decimal? days30 = default(decimal?), decimal? days38 = default(decimal?), decimal? days50 = default(decimal?), decimal? days100 = default(decimal?), decimal? days200 = default(decimal?), decimal? days250 = default(decimal?))
        {
            this.Days5 = days5;
            this.Days20 = days20;
            this.Days30 = days30;
        ...
        /// 38 trading days.
        /// </summary>
        /// <value>38 trading days.</value>
        [DataMember(Name = "days38", EmitDefaultValue = true)]
        public decimal? Days38 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Days38: ").Append(Days38).Append("\n");
        ...
        {
            return this.Equals(input as InlineResponse20081DataPrice);
        }

        /// <summary>
        /// Returns true if InlineResponse20081DataPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20081DataPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20081DataPrice input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Days38 == input.Days38 ||
                    (this.Days38 != null &&
                    this.Days38.Equals(input.Days38))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Days38 != null)
                {
                    hashCode = (hashCode * 59) + this.Days38.GetHashCode();
                }
                if (this.Days50 != null)
                {
