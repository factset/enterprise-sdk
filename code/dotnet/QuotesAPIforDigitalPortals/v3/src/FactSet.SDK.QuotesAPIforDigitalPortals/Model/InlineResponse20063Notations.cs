...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20063Notations : IEquatable<InlineResponse20063Notations>, IValidatableObject
    {
        ...
        public InlineResponse20063Notations(string id = default(string), string symbol = default(string), InlineResponse20063Market market = default(InlineResponse20063Market), InlineResponse20063ValueUnit valueUnit = default(InlineResponse20063ValueUnit), InlineResponse20046NotationFsym fsym = default(InlineResponse20046NotationFsym), InlineResponse20063TradingVolume tradingVolume = default(InlineResponse20063TradingVolume))
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Market = market;
