...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_95_instrument")]
    public partial class InlineResponse20095Instrument : IEquatable<InlineResponse20095Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20095Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20095Instrument(string id = default(string), string name = default(string), string isin = default(string), InlineResponse20093InstrumentNsin nsin = default(InlineResponse20093InstrumentNsin), string assetClass = default(string), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        {
            return this.Equals(input as InlineResponse20095Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20095Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20095Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20095Instrument input)
        {
            if (input == null)
            {
                return false;
