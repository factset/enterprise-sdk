...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_85_bid")]
    public partial class InlineResponse20085Bid : IEquatable<InlineResponse20085Bid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20085Bid" /> class.
        /// </summary>
        ...
        public InlineResponse20085Bid(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20085Bid);
        }

        /// <summary>
        /// Returns true if InlineResponse20085Bid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20085Bid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20085Bid input)
        {
            if (input == null)
            {
                return false;
