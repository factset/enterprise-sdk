...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_data_high")]
    public partial class InlineResponse20082DataHigh : IEquatable<InlineResponse20082DataHigh>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082DataHigh" /> class.
        /// </summary>
        ...
        public InlineResponse20082DataHigh(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20082DataHigh);
        }

        /// <summary>
        /// Returns true if InlineResponse20082DataHigh instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082DataHigh to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082DataHigh input)
        {
            if (input == null)
            {
                return false;
