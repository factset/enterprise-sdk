...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_notation_searchByText_meta")]
    public partial class NotationSearchByTextMeta : IEquatable<NotationSearchByTextMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotationSearchByTextMeta" /> class.
        /// </summary>
        ...
        public NotationSearchByTextMeta(List<string> attributes = default(List<string>), string language = default(string), List<SortEnum> sort = default(List<SortEnum>), BasicMarketListMetaPagination pagination = default(BasicMarketListMetaPagination))
        {
        ...
        {
            return this.Equals(input as NotationSearchByTextMeta);
        }

        /// <summary>
        /// Returns true if NotationSearchByTextMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of NotationSearchByTextMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotationSearchByTextMeta input)
        {
            if (input == null)
            {
                return false;
