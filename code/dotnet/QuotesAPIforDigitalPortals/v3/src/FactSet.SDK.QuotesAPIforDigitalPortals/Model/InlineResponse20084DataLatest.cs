...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_latest")]
    public partial class InlineResponse20084DataLatest : IEquatable<InlineResponse20084DataLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataLatest" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataLatest(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), InlineResponse20084DataLatestPerformance performance = default(InlineResponse20084DataLatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20084DataLatestPerformance Performance { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20084DataLatest);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataLatest input)
        {
            if (input == null)
            {
                return false;
