...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20079DataAccumulated : IEquatable<InlineResponse20079DataAccumulated>, IValidatableObject
    {
        ...
        public InlineResponse20079DataAccumulated(decimal numberTrades = default(decimal), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal), decimal volumeWeightedAveragePrice = default(decimal))
        {
