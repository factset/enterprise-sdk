...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_83_first")]
    public partial class InlineResponse20083First : IEquatable<InlineResponse20083First>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20083First" /> class.
        /// </summary>
        ...
        public InlineResponse20083First(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20083First);
        }

        /// <summary>
        /// Returns true if InlineResponse20083First instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20083First to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20083First input)
        {
            if (input == null)
            {
                return false;
