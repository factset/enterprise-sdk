...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_73_data_regional")]
    public partial class InlineResponse20073DataRegional : IEquatable<InlineResponse20073DataRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20073DataRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20073DataRegional(bool? isPrimary = default(bool?), string permanentIdentifier = default(string), string tickerRegion = default(string), List<InlineResponse20073DataListing> listing = default(List<InlineResponse20073DataListing>))
        {
        ...
        public List<InlineResponse20073DataListing> Listing { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20073DataRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20073DataRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20073DataRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20073DataRegional input)
        {
            if (input == null)
            {
                return false;
