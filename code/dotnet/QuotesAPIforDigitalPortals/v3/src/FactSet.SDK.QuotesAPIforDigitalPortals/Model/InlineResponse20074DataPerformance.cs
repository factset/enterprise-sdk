...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// Performance values.
    /// </summary>
    [DataContract(Name = "inline_response_200_74_data_performance")]
    public partial class InlineResponse20074DataPerformance : IEquatable<InlineResponse20074DataPerformance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20074DataPerformance" /> class.
        /// </summary>
        ...
        public InlineResponse20074DataPerformance(decimal? absolute = default(decimal?), decimal? relative = default(decimal?), decimal? referencePrice = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20074DataPerformance);
        }

        /// <summary>
        /// Returns true if InlineResponse20074DataPerformance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20074DataPerformance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20074DataPerformance input)
        {
            if (input == null)
            {
                return false;
