...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_32_data_categories")]
    public partial class InlineResponse20032DataCategories : IEquatable<InlineResponse20032DataCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20032DataCategories" /> class.
        /// </summary>
        ...
        public InlineResponse20032DataCategories(decimal? id = default(decimal?), string code = default(string), string name = default(string), string description = default(string), bool? active = default(bool?), InlineResponse20031DataLevel level = default(InlineResponse20031DataLevel), InlineResponse20031DataParent parent = default(InlineResponse20031DataParent))
        {
            this.Id = id;
            this.Code = code;
            this.Name = name;
        ...
        {
            return this.Equals(input as InlineResponse20032DataCategories);
        }

        /// <summary>
        /// Returns true if InlineResponse20032DataCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20032DataCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20032DataCategories input)
        {
            if (input == null)
            {
                return false;
