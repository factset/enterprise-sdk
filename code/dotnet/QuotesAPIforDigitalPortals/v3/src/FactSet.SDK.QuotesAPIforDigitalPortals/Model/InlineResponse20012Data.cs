...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20012Data : IEquatable<InlineResponse20012Data>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">Identifier of a media kind..</param>
        /// <param name="name">English name of the media kind..</param>
        /// <param name="description">English description of the media kind..</param>
        public InlineResponse20012Data(decimal? id = default(decimal?), string name = default(string), string description = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Identifier of a media kind.</value>
        ...
        /// </summary>
        /// <value>English description of the media kind.</value>
