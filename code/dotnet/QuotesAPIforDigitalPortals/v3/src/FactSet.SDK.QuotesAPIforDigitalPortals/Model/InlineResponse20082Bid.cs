...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_bid")]
    public partial class InlineResponse20082Bid : IEquatable<InlineResponse20082Bid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082Bid" /> class.
        /// </summary>
        ...
        public InlineResponse20082Bid(string time = default(string), decimal price = default(decimal), string quoteCondition = default(string), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20082Bid);
        }

        /// <summary>
        /// Returns true if InlineResponse20082Bid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082Bid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082Bid input)
        {
            if (input == null)
            {
                return false;
