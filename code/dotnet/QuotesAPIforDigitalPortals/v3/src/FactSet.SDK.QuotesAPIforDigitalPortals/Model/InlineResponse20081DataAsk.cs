...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_81_data_ask")]
    public partial class InlineResponse20081DataAsk : IEquatable<InlineResponse20081DataAsk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20081DataAsk" /> class.
        /// </summary>
        ...
        public InlineResponse20081DataAsk(string time = default(string), decimal price = default(decimal), string quoteCondition = default(string), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20081DataAsk);
        }

        /// <summary>
        /// Returns true if InlineResponse20081DataAsk instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20081DataAsk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20081DataAsk input)
        {
            if (input == null)
            {
                return false;
