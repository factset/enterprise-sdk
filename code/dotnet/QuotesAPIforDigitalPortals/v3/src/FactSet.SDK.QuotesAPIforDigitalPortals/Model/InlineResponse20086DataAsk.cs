...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_86_data_ask")]
    public partial class InlineResponse20086DataAsk : IEquatable<InlineResponse20086DataAsk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20086DataAsk" /> class.
        /// </summary>
        ...
        public InlineResponse20086DataAsk(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20086DataAsk);
        }

        /// <summary>
        /// Returns true if InlineResponse20086DataAsk instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20086DataAsk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20086DataAsk input)
        {
            if (input == null)
            {
                return false;
