...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_93_instrument_nsin")]
    public partial class InlineResponse20093InstrumentNsin : IEquatable<InlineResponse20093InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20093InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse20093InstrumentNsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        {
            return this.Equals(input as InlineResponse20093InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse20093InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20093InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20093InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
