...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_87_data_asks")]
    public partial class InlineResponse20087DataAsks : IEquatable<InlineResponse20087DataAsks>, IValidatableObject
    {
        /// <summary>
        /// Order type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20087DataAsks" /> class.
        /// </summary>
        ...
        public InlineResponse20087DataAsks(string id = default(string), string time = default(string), TypeEnum? type = default(TypeEnum?), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? volume = default(decimal?), string marketMaker = default(string))
        {
            this.Id = id;
            this.Time = time;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse20087DataAsks);
        }

        /// <summary>
        /// Returns true if InlineResponse20087DataAsks instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20087DataAsks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20087DataAsks input)
        {
            if (input == null)
            {
                return false;
