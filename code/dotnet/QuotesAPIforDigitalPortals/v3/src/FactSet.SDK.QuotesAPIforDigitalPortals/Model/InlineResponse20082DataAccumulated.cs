...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_data_accumulated")]
    public partial class InlineResponse20082DataAccumulated : IEquatable<InlineResponse20082DataAccumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082DataAccumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20082DataAccumulated(decimal? numberTrades = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), decimal? volumeWeightedAveragePrice = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20082DataAccumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20082DataAccumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082DataAccumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082DataAccumulated input)
        {
            if (input == null)
            {
                return false;
