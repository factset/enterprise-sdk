...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20073Data : IEquatable<InlineResponse20073Data>, IValidatableObject
    {
        ...
        public InlineResponse20073Data(string id = default(string), DateTime referenceDate = default(DateTime), InlineResponse20072DataPerformance performance = default(InlineResponse20072DataPerformance), InlineResponse20072DataHigh high = default(InlineResponse20072DataHigh), InlineResponse20072DataLow low = default(InlineResponse20072DataLow), decimal averagePrice = default(decimal), InlineResponse20072DataTradingVolume tradingVolume = default(InlineResponse20072DataTradingVolume), decimal tradingValue = default(decimal), decimal volatility = default(decimal), InlineResponse20073Status status = default(InlineResponse20073Status))
        {
            this.Id = id;
