...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_85_latest_performance_intraday")]
    public partial class InlineResponse20085LatestPerformanceIntraday : IEquatable<InlineResponse20085LatestPerformanceIntraday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20085LatestPerformanceIntraday" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;valueUnit&#x60; for its unit..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse20085LatestPerformanceIntraday(decimal? absolute = default(decimal?), decimal? relative = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20085LatestPerformanceIntraday);
        }

        /// <summary>
        /// Returns true if InlineResponse20085LatestPerformanceIntraday instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20085LatestPerformanceIntraday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20085LatestPerformanceIntraday input)
        {
            if (input == null)
            {
                return false;
