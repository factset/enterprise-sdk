...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_asks")]
    public partial class InlineResponse20089DataAsks : IEquatable<InlineResponse20089DataAsks>, IValidatableObject
    {
        /// <summary>
        /// Order type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataAsks" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataAsks(string id = default(string), string time = default(string), TypeEnum? type = default(TypeEnum?), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? volume = default(decimal?), string marketMaker = default(string))
        {
            this.Id = id;
            this.Time = time;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse20089DataAsks);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataAsks instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataAsks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataAsks input)
        {
            if (input == null)
            {
                return false;
