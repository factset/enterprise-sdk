...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject13 : IEquatable<InlineObject13>, IValidatableObject
    {
        ...
        public InlineObject13(InstrumentCrossReferenceListByISINData data = default(InstrumentCrossReferenceListByISINData), BasicBackgroundTextTypeListMeta meta = default(BasicBackgroundTextTypeListMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject13 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public InstrumentCrossReferenceListByISINData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public BasicBackgroundTextTypeListMeta Meta { get; set; }
