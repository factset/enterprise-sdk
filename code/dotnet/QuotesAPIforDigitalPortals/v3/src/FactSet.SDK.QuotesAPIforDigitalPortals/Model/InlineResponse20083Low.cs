...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_83_low")]
    public partial class InlineResponse20083Low : IEquatable<InlineResponse20083Low>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20083Low" /> class.
        /// </summary>
        ...
        public InlineResponse20083Low(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20083Low);
        }

        /// <summary>
        /// Returns true if InlineResponse20083Low instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20083Low to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20083Low input)
        {
            if (input == null)
            {
                return false;
