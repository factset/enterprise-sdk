...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_accumulated")]
    public partial class InlineResponse20084DataAccumulated : IEquatable<InlineResponse20084DataAccumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataAccumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataAccumulated(decimal? numberTrades = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), decimal? volumeWeightedAveragePrice = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20084DataAccumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataAccumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataAccumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataAccumulated input)
        {
            if (input == null)
            {
                return false;
