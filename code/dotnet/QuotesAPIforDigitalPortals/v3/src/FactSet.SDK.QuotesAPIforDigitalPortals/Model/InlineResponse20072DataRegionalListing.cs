...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_72_data_regional_listing")]
    public partial class InlineResponse20072DataRegionalListing : IEquatable<InlineResponse20072DataRegionalListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20072DataRegionalListing" /> class.
        /// </summary>
        ...
        public InlineResponse20072DataRegionalListing(bool? isPrimary = default(bool?), string permanentIdentifier = default(string), string tickerExchange = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20072DataRegionalListing);
        }

        /// <summary>
        /// Returns true if InlineResponse20072DataRegionalListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20072DataRegionalListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20072DataRegionalListing input)
        {
            if (input == null)
            {
                return false;
