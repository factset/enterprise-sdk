...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_87_bid")]
    public partial class InlineResponse20087Bid : IEquatable<InlineResponse20087Bid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20087Bid" /> class.
        /// </summary>
        ...
        public InlineResponse20087Bid(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20087Bid);
        }

        /// <summary>
        /// Returns true if InlineResponse20087Bid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20087Bid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20087Bid input)
        {
            if (input == null)
            {
                return false;
