...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_69_data_notations")]
    public partial class InlineResponse20069DataNotations : IEquatable<InlineResponse20069DataNotations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20069DataNotations" /> class.
        /// </summary>
        ...
        public InlineResponse20069DataNotations(string id = default(string), string symbol = default(string), bool? active = default(bool?), InlineResponse20068DataMarket market = default(InlineResponse20068DataMarket), InlineResponse20068DataValueUnit valueUnit = default(InlineResponse20068DataValueUnit), InlineResponse20046NotationFsym fsym = default(InlineResponse20046NotationFsym))
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Active = active;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20069DataNotations {\n");
        ...
        {
            return this.Equals(input as InlineResponse20069DataNotations);
        }

        /// <summary>
        /// Returns true if InlineResponse20069DataNotations instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20069DataNotations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20069DataNotations input)
        {
            if (input == null)
            {
                return false;
