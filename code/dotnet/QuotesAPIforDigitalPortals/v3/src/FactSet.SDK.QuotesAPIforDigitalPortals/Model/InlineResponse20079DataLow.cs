...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_79_data_low")]
    public partial class InlineResponse20079DataLow : IEquatable<InlineResponse20079DataLow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20079DataLow" /> class.
        /// </summary>
        ...
        public InlineResponse20079DataLow(string time = default(string), decimal price = default(decimal), decimal tradingVolume = default(decimal))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20079DataLow);
        }

        /// <summary>
        /// Returns true if InlineResponse20079DataLow instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20079DataLow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20079DataLow input)
        {
            if (input == null)
            {
                return false;
