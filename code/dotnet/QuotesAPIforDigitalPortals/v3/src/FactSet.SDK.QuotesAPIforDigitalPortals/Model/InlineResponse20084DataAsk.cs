...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_ask")]
    public partial class InlineResponse20084DataAsk : IEquatable<InlineResponse20084DataAsk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataAsk" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataAsk(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20084DataAsk);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataAsk instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataAsk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataAsk input)
        {
            if (input == null)
            {
                return false;
