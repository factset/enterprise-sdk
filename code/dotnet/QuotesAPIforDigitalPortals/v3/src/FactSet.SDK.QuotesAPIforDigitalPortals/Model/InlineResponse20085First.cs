...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_85_first")]
    public partial class InlineResponse20085First : IEquatable<InlineResponse20085First>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20085First" /> class.
        /// </summary>
        ...
        public InlineResponse20085First(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20085First);
        }

        /// <summary>
        /// Returns true if InlineResponse20085First instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20085First to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20085First input)
        {
            if (input == null)
            {
                return false;
