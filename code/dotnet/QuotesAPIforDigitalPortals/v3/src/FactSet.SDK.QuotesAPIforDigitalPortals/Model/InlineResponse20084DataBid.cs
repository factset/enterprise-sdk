...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_bid")]
    public partial class InlineResponse20084DataBid : IEquatable<InlineResponse20084DataBid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataBid" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataBid(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20084DataBid {\n");
        ...
        {
            return this.Equals(input as InlineResponse20084DataBid);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataBid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataBid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataBid input)
        {
            if (input == null)
            {
                return false;
