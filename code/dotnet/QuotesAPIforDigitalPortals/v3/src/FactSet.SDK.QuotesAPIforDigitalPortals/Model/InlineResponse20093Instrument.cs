...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_93_instrument")]
    public partial class InlineResponse20093Instrument : IEquatable<InlineResponse20093Instrument>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as InlineResponse20093Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20093Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20093Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20093Instrument input)
        {
            if (input == null)
            {
                return false;
