...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_data_latest")]
    public partial class InlineResponse20082DataLatest : IEquatable<InlineResponse20082DataLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082DataLatest" /> class.
        /// </summary>
        ...
        public InlineResponse20082DataLatest(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), InlineResponse20082DataLatestPerformance performance = default(InlineResponse20082DataLatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20082DataLatestPerformance Performance { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20082DataLatest);
        }

        /// <summary>
        /// Returns true if InlineResponse20082DataLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082DataLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082DataLatest input)
        {
            if (input == null)
            {
                return false;
