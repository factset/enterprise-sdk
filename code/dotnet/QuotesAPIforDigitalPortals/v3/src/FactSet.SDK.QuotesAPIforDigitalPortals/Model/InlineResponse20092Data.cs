...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20092Data : IEquatable<InlineResponse20092Data>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as InlineResponse20092Data);
        }

        /// <summary>
        /// Returns true if InlineResponse20092Data instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20092Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20092Data input)
        {
            if (input == null)
            {
                return false;
