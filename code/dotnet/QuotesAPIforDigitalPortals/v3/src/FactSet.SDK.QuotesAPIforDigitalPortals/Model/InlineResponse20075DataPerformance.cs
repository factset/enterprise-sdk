...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// Performance values.
    /// </summary>
    [DataContract(Name = "inline_response_200_75_data_performance")]
    public partial class InlineResponse20075DataPerformance : IEquatable<InlineResponse20075DataPerformance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20075DataPerformance" /> class.
        /// </summary>
        ...
        public InlineResponse20075DataPerformance(decimal? absolute = default(decimal?), decimal? relative = default(decimal?), decimal? referencePrice = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20075DataPerformance);
        }

        /// <summary>
        /// Returns true if InlineResponse20075DataPerformance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20075DataPerformance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20075DataPerformance input)
        {
            if (input == null)
            {
                return false;
