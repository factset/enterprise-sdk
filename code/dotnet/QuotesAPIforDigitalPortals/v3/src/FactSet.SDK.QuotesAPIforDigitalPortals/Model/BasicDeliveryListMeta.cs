...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_basic_delivery_list_meta")]
    public partial class BasicDeliveryListMeta : IEquatable<BasicDeliveryListMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicDeliveryListMeta" /> class.
        /// </summary>
        ...
        public BasicDeliveryListMeta(List<string> attributes = default(List<string>), List<SortEnum> sort = default(List<SortEnum>))
        {
        ...
        {
            return this.Equals(input as BasicDeliveryListMeta);
        }

        /// <summary>
        /// Returns true if BasicDeliveryListMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicDeliveryListMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicDeliveryListMeta input)
        {
            if (input == null)
            {
                return false;
