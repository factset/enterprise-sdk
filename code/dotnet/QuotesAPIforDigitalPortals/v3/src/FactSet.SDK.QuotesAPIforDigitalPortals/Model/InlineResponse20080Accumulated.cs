...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_80_accumulated")]
    public partial class InlineResponse20080Accumulated : IEquatable<InlineResponse20080Accumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20080Accumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20080Accumulated(decimal numberTrades = default(decimal), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal), decimal volumeWeightedAveragePrice = default(decimal))
        {
        ...
        [DataMember(Name = "volumeWeightedAveragePrice", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as InlineResponse20080Accumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20080Accumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20080Accumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20080Accumulated input)
        {
            if (input == null)
            {
                return false;
