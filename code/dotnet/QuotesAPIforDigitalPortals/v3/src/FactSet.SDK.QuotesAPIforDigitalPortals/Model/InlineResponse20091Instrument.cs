...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_91_instrument")]
    public partial class InlineResponse20091Instrument : IEquatable<InlineResponse20091Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20091Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20091Instrument(string id = default(string), string name = default(string), string isin = default(string), InlineResponse20091InstrumentNsin nsin = default(InlineResponse20091InstrumentNsin), string assetClass = default(string), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        {
            return this.Equals(input as InlineResponse20091Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20091Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20091Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20091Instrument input)
        {
            if (input == null)
            {
                return false;
