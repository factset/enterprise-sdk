...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_83_latest")]
    public partial class InlineResponse20083Latest : IEquatable<InlineResponse20083Latest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20083Latest" /> class.
        /// </summary>
        ...
        public InlineResponse20083Latest(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), InlineResponse20083LatestPerformance performance = default(InlineResponse20083LatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20083LatestPerformance Performance { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20083Latest);
        }

        /// <summary>
        /// Returns true if InlineResponse20083Latest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20083Latest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20083Latest input)
        {
            if (input == null)
            {
                return false;
