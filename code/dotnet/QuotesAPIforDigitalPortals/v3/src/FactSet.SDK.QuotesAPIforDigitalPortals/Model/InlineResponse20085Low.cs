...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_85_low")]
    public partial class InlineResponse20085Low : IEquatable<InlineResponse20085Low>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20085Low" /> class.
        /// </summary>
        ...
        public InlineResponse20085Low(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20085Low);
        }

        /// <summary>
        /// Returns true if InlineResponse20085Low instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20085Low to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20085Low input)
        {
            if (input == null)
            {
                return false;
