...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_79_data_latest")]
    public partial class InlineResponse20079DataLatest : IEquatable<InlineResponse20079DataLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20079DataLatest" /> class.
        /// </summary>
        ...
        public InlineResponse20079DataLatest(string time = default(string), decimal price = default(decimal), string quoteCondition = default(string), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal), InlineResponse20079DataLatestPerformance performance = default(InlineResponse20079DataLatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20079DataLatestPerformance Performance { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20079DataLatest);
        }

        /// <summary>
        /// Returns true if InlineResponse20079DataLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20079DataLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20079DataLatest input)
        {
            if (input == null)
            {
                return false;
