...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_83_latest_performance_intraday")]
    public partial class InlineResponse20083LatestPerformanceIntraday : IEquatable<InlineResponse20083LatestPerformanceIntraday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20083LatestPerformanceIntraday" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;valueUnit&#x60; for its unit..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse20083LatestPerformanceIntraday(decimal? absolute = default(decimal?), decimal? relative = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20083LatestPerformanceIntraday);
        }

        /// <summary>
        /// Returns true if InlineResponse20083LatestPerformanceIntraday instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20083LatestPerformanceIntraday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20083LatestPerformanceIntraday input)
        {
            if (input == null)
            {
                return false;
