...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_73_data_listing")]
    public partial class InlineResponse20073DataListing : IEquatable<InlineResponse20073DataListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20073DataListing" /> class.
        /// </summary>
        ...
        public InlineResponse20073DataListing(InlineResponse20073DataNotation notation = default(InlineResponse20073DataNotation), bool? isPrimary = default(bool?), string permanentIdentifier = default(string), string tickerExchange = default(string))
        {
        ...
        public InlineResponse20073DataNotation Notation { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20073DataListing);
        }

        /// <summary>
        /// Returns true if InlineResponse20073DataListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20073DataListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20073DataListing input)
        {
            if (input == null)
            {
                return false;
