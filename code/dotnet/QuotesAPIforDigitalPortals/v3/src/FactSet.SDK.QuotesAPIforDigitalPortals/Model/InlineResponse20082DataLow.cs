...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_data_low")]
    public partial class InlineResponse20082DataLow : IEquatable<InlineResponse20082DataLow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082DataLow" /> class.
        /// </summary>
        ...
        public InlineResponse20082DataLow(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20082DataLow {\n");
        ...
        {
            return this.Equals(input as InlineResponse20082DataLow);
        }

        /// <summary>
        /// Returns true if InlineResponse20082DataLow instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082DataLow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082DataLow input)
        {
            if (input == null)
            {
                return false;
