...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_low")]
    public partial class InlineResponse20084DataLow : IEquatable<InlineResponse20084DataLow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataLow" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataLow(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20084DataLow {\n");
        ...
        {
            return this.Equals(input as InlineResponse20084DataLow);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataLow instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataLow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataLow input)
        {
            if (input == null)
            {
                return false;
