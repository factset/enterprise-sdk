...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_86_data_bid")]
    public partial class InlineResponse20086DataBid : IEquatable<InlineResponse20086DataBid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20086DataBid" /> class.
        /// </summary>
        ...
        public InlineResponse20086DataBid(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20086DataBid {\n");
        ...
        {
            return this.Equals(input as InlineResponse20086DataBid);
        }

        /// <summary>
        /// Returns true if InlineResponse20086DataBid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20086DataBid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20086DataBid input)
        {
            if (input == null)
            {
                return false;
