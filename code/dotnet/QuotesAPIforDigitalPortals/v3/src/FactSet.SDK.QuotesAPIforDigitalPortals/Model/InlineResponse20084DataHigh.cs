...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_high")]
    public partial class InlineResponse20084DataHigh : IEquatable<InlineResponse20084DataHigh>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataHigh" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataHigh(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20084DataHigh);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataHigh instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataHigh to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataHigh input)
        {
            if (input == null)
            {
                return false;
