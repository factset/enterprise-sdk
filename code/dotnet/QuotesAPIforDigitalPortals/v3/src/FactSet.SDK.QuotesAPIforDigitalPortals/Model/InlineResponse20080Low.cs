...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_80_low")]
    public partial class InlineResponse20080Low : IEquatable<InlineResponse20080Low>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20080Low" /> class.
        /// </summary>
        ...
        public InlineResponse20080Low(string time = default(string), decimal price = default(decimal), decimal tradingVolume = default(decimal))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20080Low);
        }

        /// <summary>
        /// Returns true if InlineResponse20080Low instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20080Low to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20080Low input)
        {
            if (input == null)
            {
                return false;
