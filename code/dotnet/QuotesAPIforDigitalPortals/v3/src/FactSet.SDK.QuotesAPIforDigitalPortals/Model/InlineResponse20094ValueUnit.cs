...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_94_valueUnit")]
    public partial class InlineResponse20094ValueUnit : IEquatable<InlineResponse20094ValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20094ValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20094ValueUnit(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse20094ValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20094ValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20094ValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20094ValueUnit input)
        {
            if (input == null)
            {
                return false;
