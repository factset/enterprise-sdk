...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_market")]
    public partial class InlineResponse20084DataMarket : IEquatable<InlineResponse20084DataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataMarket" /> class.
        /// </summary>
        /// <param name="id">Identifier of the market. See endpoint &#x60;/basic/market/list&#x60; for possible values..</param>
        /// <param name="isOpen">Indicates whether the market of the notation is currently open, that is, the current time is between the open and adjusted close of the notation&#39;s market, see endpoint &#x60;/prices/tradingSchedule/event/list&#x60; for the trading schedule of the notation&#39;s market. The adjusted close is later than the official closing time specified by the market and includes the time after closing when trades might still be reported. Breaks such as a lunch break are not considered. The value is &#x60;null&#x60; if the result quality is EOD..</param>
        /// <param name="phase">Market-specific code of the current market phase. The value is &#x60;null&#x60; if the result quality is EOD..</param>
        public InlineResponse20084DataMarket(decimal? id = default(decimal?), bool? isOpen = default(bool?), string phase = default(string))
        {
            this.Id = id;
            this.IsOpen = isOpen;
            this.Phase = phase;
        ...
        /// </summary>
        /// <value>Indicates whether the market of the notation is currently open, that is, the current time is between the open and adjusted close of the notation&#39;s market, see endpoint &#x60;/prices/tradingSchedule/event/list&#x60; for the trading schedule of the notation&#39;s market. The adjusted close is later than the official closing time specified by the market and includes the time after closing when trades might still be reported. Breaks such as a lunch break are not considered. The value is &#x60;null&#x60; if the result quality is EOD.</value>
        ...
        /// </summary>
        /// <value>Market-specific code of the current market phase. The value is &#x60;null&#x60; if the result quality is EOD.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20084DataMarket {\n");
        ...
        {
            return this.Equals(input as InlineResponse20084DataMarket);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataMarket input)
        {
            if (input == null)
            {
                return false;
