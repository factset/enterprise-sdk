...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_68_data_notations")]
    public partial class InlineResponse20068DataNotations : IEquatable<InlineResponse20068DataNotations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20068DataNotations" /> class.
        /// </summary>
        ...
        public InlineResponse20068DataNotations(string id = default(string), string symbol = default(string), bool? active = default(bool?), InlineResponse20067DataMarket market = default(InlineResponse20067DataMarket), InlineResponse20067DataValueUnit valueUnit = default(InlineResponse20067DataValueUnit), InlineResponse20046NotationFsym fsym = default(InlineResponse20046NotationFsym))
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Active = active;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20068DataNotations {\n");
        ...
        {
            return this.Equals(input as InlineResponse20068DataNotations);
        }

        /// <summary>
        /// Returns true if InlineResponse20068DataNotations instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20068DataNotations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20068DataNotations input)
        {
            if (input == null)
            {
                return false;
