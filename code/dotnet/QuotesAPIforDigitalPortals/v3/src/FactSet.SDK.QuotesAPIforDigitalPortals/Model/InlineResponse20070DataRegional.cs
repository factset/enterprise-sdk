...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_70_data_regional")]
    public partial class InlineResponse20070DataRegional : IEquatable<InlineResponse20070DataRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20070DataRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20070DataRegional(bool isPrimary = default(bool), string permanentIdentifier = default(string), string tickerRegion = default(string), List<InlineResponse20070DataListing> listing = default(List<InlineResponse20070DataListing>))
        {
        ...
        public List<InlineResponse20070DataListing> Listing { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20070DataRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20070DataRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20070DataRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20070DataRegional input)
        {
            if (input == null)
            {
                return false;
