...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class PostBasicValueUnitListRequestMeta : IEquatable<PostBasicValueUnitListRequestMeta>, IValidatableObject
    {
        ...
        public PostBasicValueUnitListRequestMeta(List<string> attributes = default(List<string>), string language = default(string), List<SortEnum> sort = default(List<SortEnum>))
        {
