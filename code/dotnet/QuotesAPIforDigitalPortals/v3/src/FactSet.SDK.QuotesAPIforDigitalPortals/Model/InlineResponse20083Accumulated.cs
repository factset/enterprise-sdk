...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_83_accumulated")]
    public partial class InlineResponse20083Accumulated : IEquatable<InlineResponse20083Accumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20083Accumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20083Accumulated(decimal? numberTrades = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), decimal? volumeWeightedAveragePrice = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20083Accumulated {\n");
        ...
        {
            return this.Equals(input as InlineResponse20083Accumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20083Accumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20083Accumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20083Accumulated input)
        {
            if (input == null)
            {
                return false;
