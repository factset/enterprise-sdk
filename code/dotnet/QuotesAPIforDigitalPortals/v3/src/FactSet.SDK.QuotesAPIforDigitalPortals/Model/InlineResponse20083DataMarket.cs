...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_83_data_market")]
    public partial class InlineResponse20083DataMarket : IEquatable<InlineResponse20083DataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20083DataMarket" /> class.
        /// </summary>
        ...
        public InlineResponse20083DataMarket(decimal? id = default(decimal?), bool? isOpen = default(bool?), string phase = default(string))
        {
            this.Id = id;
            this.IsOpen = isOpen;
            this.Phase = phase;
        ...
        {
            return this.Equals(input as InlineResponse20083DataMarket);
        }

        /// <summary>
        /// Returns true if InlineResponse20083DataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20083DataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20083DataMarket input)
        {
            if (input == null)
            {
                return false;
