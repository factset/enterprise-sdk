...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_69_data_regional")]
    public partial class InlineResponse20069DataRegional : IEquatable<InlineResponse20069DataRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20069DataRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20069DataRegional(bool isPrimary = default(bool), string permanentIdentifier = default(string), string tickerRegion = default(string), InlineResponse20069DataRegionalListing listing = default(InlineResponse20069DataRegionalListing))
        {
        ...
        public InlineResponse20069DataRegionalListing Listing { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20069DataRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20069DataRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20069DataRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20069DataRegional input)
        {
            if (input == null)
            {
                return false;
