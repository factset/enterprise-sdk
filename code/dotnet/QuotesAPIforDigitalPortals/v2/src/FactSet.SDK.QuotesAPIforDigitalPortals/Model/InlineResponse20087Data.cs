...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20087Data : IEquatable<InlineResponse20087Data>, IValidatableObject
    {
        ...
        public InlineResponse20087Data(string id = default(string), string name = default(string), string isin = default(string), InlineResponse20042DataNsin nsin = default(InlineResponse20042DataNsin), string assetClass = default(string), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
