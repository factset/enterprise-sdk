...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_67_fsym_regional")]
    public partial class InlineResponse20067FsymRegional : IEquatable<InlineResponse20067FsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20067FsymRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20067FsymRegional(string permanentIdentifier = default(string), string tickerRegion = default(string), bool isPrimary = default(bool))
        {
        ...
        {
            return this.Equals(input as InlineResponse20067FsymRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20067FsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20067FsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20067FsymRegional input)
        {
            if (input == null)
                return false;
