...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_instrument")]
    public partial class InlineResponse20090Instrument : IEquatable<InlineResponse20090Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20090Instrument(string id = default(string), string name = default(string), string isin = default(string), InlineResponse20088InstrumentNsin nsin = default(InlineResponse20088InstrumentNsin), string assetClass = default(string), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        {
            return this.Equals(input as InlineResponse20090Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20090Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090Instrument input)
        {
            if (input == null)
            {
                return false;
