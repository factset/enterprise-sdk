...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_82_ask")]
    public partial class InlineResponse20082Ask : IEquatable<InlineResponse20082Ask>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20082Ask" /> class.
        /// </summary>
        ...
        public InlineResponse20082Ask(string time = default(string), decimal price = default(decimal), string quoteCondition = default(string), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20082Ask);
        }

        /// <summary>
        /// Returns true if InlineResponse20082Ask instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20082Ask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20082Ask input)
        {
            if (input == null)
                return false;
