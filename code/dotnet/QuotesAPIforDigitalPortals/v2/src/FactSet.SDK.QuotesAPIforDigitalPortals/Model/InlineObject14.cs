...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject14 : IEquatable<InlineObject14>, IValidatableObject
    {
        ...
        public InlineObject14(InstrumentCrossReferenceListByWKNData data = default(InstrumentCrossReferenceListByWKNData), BasicBackgroundTextTypeListMeta meta = default(BasicBackgroundTextTypeListMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject14 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public InstrumentCrossReferenceListByWKNData Data { get; set; }
