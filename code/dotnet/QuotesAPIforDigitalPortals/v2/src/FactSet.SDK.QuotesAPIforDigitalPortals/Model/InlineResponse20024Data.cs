...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20024Data : IEquatable<InlineResponse20024Data>, IValidatableObject
    {
        ...
        public InlineResponse20024Data(string code = default(string), string isoCode = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?), bool active = default(bool))
        {
            this.Code = code;
