...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_73_status")]
    public partial class InlineResponse20073Status : IEquatable<InlineResponse20073Status>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20073Status" /> class.
        /// </summary>
        ...
        public InlineResponse20073Status(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20073Status);
        }

        /// <summary>
        /// Returns true if InlineResponse20073Status instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20073Status to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20073Status input)
        {
            if (input == null)
                return false;
