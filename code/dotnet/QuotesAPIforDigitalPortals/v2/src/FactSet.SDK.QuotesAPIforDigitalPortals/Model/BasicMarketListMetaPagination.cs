...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_basic_market_list_meta_pagination")]
    public partial class BasicMarketListMetaPagination : IEquatable<BasicMarketListMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicMarketListMetaPagination" /> class.
        /// </summary>
        ...
        public BasicMarketListMetaPagination(decimal offset = default(decimal), decimal limit = default(decimal))
        {
            this.Offset = offset;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as BasicMarketListMetaPagination);
        }

        /// <summary>
        /// Returns true if BasicMarketListMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicMarketListMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicMarketListMetaPagination input)
        {
            if (input == null)
                return false;
