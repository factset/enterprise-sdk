...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_88_instrument")]
    public partial class InlineResponse20088Instrument : IEquatable<InlineResponse20088Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20088Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20088Instrument(string id = default(string), string name = default(string), string isin = default(string), InlineResponse20088InstrumentNsin nsin = default(InlineResponse20088InstrumentNsin), string assetClass = default(string), List<InlineResponse20038DataCategories> type = default(List<InlineResponse20038DataCategories>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        {
            return this.Equals(input as InlineResponse20088Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20088Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20088Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20088Instrument input)
        {
            if (input == null)
            {
                return false;
