...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject22 : IEquatable<InlineObject22>, IValidatableObject
    {
        ...
        public InlineObject22(NotationSearchByTextData data = default(NotationSearchByTextData), NotationSearchByTextMeta meta = default(NotationSearchByTextMeta))
        {
            ...
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject22 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public NotationSearchByTextData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public NotationSearchByTextMeta Meta { get; set; }
