...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_80_latest_performance_intraday")]
    public partial class InlineResponse20080LatestPerformanceIntraday : IEquatable<InlineResponse20080LatestPerformanceIntraday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20080LatestPerformanceIntraday" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;valueUnit&#x60; for its unit..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse20080LatestPerformanceIntraday(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse20080LatestPerformanceIntraday);
        }

        /// <summary>
        /// Returns true if InlineResponse20080LatestPerformanceIntraday instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20080LatestPerformanceIntraday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20080LatestPerformanceIntraday input)
        {
            if (input == null)
            {
                return false;
