...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_instrument_category_list_meta")]
    public partial class InstrumentCategoryListMeta : IEquatable<InstrumentCategoryListMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentCategoryListMeta" /> class.
        /// </summary>
        ...
        public InstrumentCategoryListMeta(List<string> attributes = default(List<string>), string language = default(string), List<SortEnum> sort = default(List<SortEnum>))
        {
        ...
        {
            return this.Equals(input as InstrumentCategoryListMeta);
        }

        /// <summary>
        /// Returns true if InstrumentCategoryListMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentCategoryListMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentCategoryListMeta input)
        {
            if (input == null)
            {
                return false;
