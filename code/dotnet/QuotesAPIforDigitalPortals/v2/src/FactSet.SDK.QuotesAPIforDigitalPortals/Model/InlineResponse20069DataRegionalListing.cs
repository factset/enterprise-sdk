...
namespace FactSet.SDK.QuotesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_69_data_regional_listing")]
    public partial class InlineResponse20069DataRegionalListing : IEquatable<InlineResponse20069DataRegionalListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20069DataRegionalListing" /> class.
        /// </summary>
        ...
        public InlineResponse20069DataRegionalListing(bool isPrimary = default(bool), string permanentIdentifier = default(string), string tickerExchange = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20069DataRegionalListing);
        }

        /// <summary>
        /// Returns true if InlineResponse20069DataRegionalListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20069DataRegionalListing to be compared</param>
        /// <returns>Boolean</returns>
