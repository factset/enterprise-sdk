# FactSet.SDK.FactSetQuantFactorLibrary.Api.HelperApi
...
namespace Example
{
    public class GetFactorLibraryExample
    {
        public static async Task Main()
        {
            ...
            var factors = new List<string>(); // List<string> | Array of individual Factor Items requested for the library endpoint. Use the factorGroups parameter to pull for a full list of factors based off the input group.   (optional) 
            ...
            {
                Console.WriteLine("Exception when calling HelperApi.GetFactorLibrary: " + e.Message );
...
------------- | ------------- | ------------- | -------------
 **factors** | [**List&lt;string&gt;**](string.md)| Array of individual Factor Items requested for the library endpoint. Use the factorGroups parameter to pull for a full list of factors based off the input group.   | [optional] 
...
namespace Example
{
    public class GetFactorLibraryListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetQuantFactorLibrary.Client.Configuration();
            ...
            var libraryRequest = new LibraryRequest(); // LibraryRequest | Available Factors and Related Meta Data.
            ...
            {
                Console.WriteLine("Exception when calling HelperApi.GetFactorLibraryList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
