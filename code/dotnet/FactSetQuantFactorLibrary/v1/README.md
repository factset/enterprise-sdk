...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetQuantFactorLibrary/2.1.0)
...
dotnet add package FactSet.SDK.FactSetQuantFactorLibrary -v 2.1.0
```
...
nuget install FactSet.SDK.FactSetQuantFactorLibrary -Version 2.1.0
```
