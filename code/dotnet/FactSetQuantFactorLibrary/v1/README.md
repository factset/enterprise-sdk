...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.10-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetQuantFactorLibrary/2.0.10)
...
dotnet add package FactSet.SDK.FactSetQuantFactorLibrary -v 2.0.10
```
...
nuget install FactSet.SDK.FactSetQuantFactorLibrary -Version 2.0.10
```
