...
namespace FactSet.SDK.FactSetProgrammaticEnvironment.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/FactSetProgrammaticEnvironment/0.22.0";
            BasePath = "https://api.factset.com/analytics/quant/fpe/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/quant/fpe/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.FactSetProgrammaticEnvironment) Debug Report:\n";
