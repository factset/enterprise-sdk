...
[![Nuget](https://img.shields.io/badge/nuget-v0.22.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetProgrammaticEnvironment/0.22.1)
...
dotnet add package FactSet.SDK.FactSetProgrammaticEnvironment -v 0.22.1
```
...
nuget install FactSet.SDK.FactSetProgrammaticEnvironment -Version 0.22.1
```
...
*CalculationsApi* | [**DeleteCalculation**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetProgrammaticEnvironment/v1/docs/CalculationsApi.md#deletecalculation) | **DELETE** /calculations/{id} | Kill a running calculation by id
...
*ServersApi* | [**StopServer**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetProgrammaticEnvironment/v1/docs/ServersApi.md#stopserver) | **DELETE** /servers | Stop the caller's API server
