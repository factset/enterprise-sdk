...
namespace Example
{
    public class GetUploadFileStatusExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling FilesApi.GetUploadFileStatus: " + e.Message );
...
<a name="uploadfile"></a>
# **UploadFile**
> FileUploadStatus UploadFile (string server, string file, System.IO.Stream body = null)
...
namespace Example
{
    public class UploadFileExample
    {
        public static async Task Main()
        {
            ...
            {
                // Starts a file upload
                FileUploadStatus result = apiInstance.UploadFile(server, file, body);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling FilesApi.UploadFile: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
