...
namespace FactSet.SDK.NorthfieldPortfolioOptimizer.Api
{
    ...
    public partial class CurrenciesApi : ICurrenciesApi
    {
        ...
        {
            FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> localVarResponse = GetCurrenciesWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of CurrencyRoot</returns>
        public FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> GetCurrenciesWithHttpInfo()
        {
        ...
        {
            FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> localVarResponse = await GetCurrenciesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CurrencyRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<CurrencyRoot>> GetCurrenciesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
