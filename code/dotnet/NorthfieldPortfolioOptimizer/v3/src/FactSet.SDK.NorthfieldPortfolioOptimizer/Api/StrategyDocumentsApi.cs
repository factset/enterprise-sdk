...
namespace FactSet.SDK.NorthfieldPortfolioOptimizer.Api
{
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetNorthfieldStrategyDocumentsResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        /// <returns></returns>
        public StrategyDocumentsApi(FactSet.SDK.NorthfieldPortfolioOptimizer.Client.Configuration configuration)
        {
        ...
        public StrategyDocumentsApi(FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ISynchronousClient client, FactSet.SDK.NorthfieldPortfolioOptimizer.Client.IAsynchronousClient asyncClient, FactSet.SDK.NorthfieldPortfolioOptimizer.Client.IReadableConfiguration configuration)
        {
        ...
        {
            var localVarResponse = GetNorthfieldStrategyDocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectoriesRoot</returns>
        public ApiResponse<DocumentDirectoriesRoot> GetNorthfieldStrategyDocumentsWithHttpInfo(string path)
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
                throw new FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiException(400, "Missing required parameter 'path' when calling StrategyDocumentsApi->GetNorthfieldStrategyDocuments");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetNorthfieldStrategyDocumentsResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            DocumentDirectoriesRoot>("/analytics/engines/npo/v3/strategies/{path}", localVarRequestOptions, this.Configuration);
        ...
        {
            var localVarResponse = await GetNorthfieldStrategyDocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DocumentDirectoriesRoot>> GetNorthfieldStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
