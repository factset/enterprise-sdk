...
namespace FactSet.SDK.NorthfieldPortfolioOptimizer.Api
{
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        {
            FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = GetNorthfieldStrategyDocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectoriesRoot</returns>
        public FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> GetNorthfieldStrategyDocumentsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = await GetNorthfieldStrategyDocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DocumentDirectoriesRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot>> GetNorthfieldStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.NorthfieldPortfolioOptimizer.Client.ApiException(400, "Missing required parameter 'path' when calling StrategyDocumentsApi->GetNorthfieldStrategyDocuments");
