# FactSet.SDK.NorthfieldPortfolioOptimizer.Api.StrategyDocumentsApi
...
namespace Example
{
    public class GetNorthfieldStrategyDocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling StrategyDocumentsApi.GetNorthfieldStrategyDocuments: " + e.Message );
