# FactSet.SDK.NorthfieldPortfolioOptimizer.Api.NPOOptimizerApi
...
namespace Example
{
    public class CancelOptimizationByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NPOOptimizerApi.CancelOptimizationById: " + e.Message );
...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NPOOptimizerApi.GetOptimizationParameters: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NPOOptimizerApi.GetOptimizationResult: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NPOOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NPOOptimizerApi.PostAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NPOOptimizerApi.PutAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
