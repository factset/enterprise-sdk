...
namespace FactSet.SDK.Cabot.Api
{
    ...
    public interface IBuyingModelsApiSync : IApiAccessor
    {
        ...
        BuyTimingResponseRoot GetBuyTimingModelAnalytic(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?));
        ...
        ApiResponse<BuyTimingResponseRoot> GetBuyTimingModelAnalyticWithHttpInfo(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?));
    ...
    public interface IBuyingModelsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BuyTimingResponseRoot> GetBuyTimingModelAnalyticAsync(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BuyingModelsApi : IBuyingModelsApi
    {
        ...
        /// <param name="region">Region of domicile represents the region based on the company&#39;s primary listing.&lt;br /&gt;You can choose which of them (if any) you want to see analytics for.&lt;br /&gt;&lt;br /&gt; (optional)</param>
        /// <returns>BuyTimingResponseRoot</returns>
        public BuyTimingResponseRoot GetBuyTimingModelAnalytic(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?))
        {
            var localVarResponse = GetBuyTimingModelAnalyticWithHttpInfo(accountPath, benchmarkPath, period, attribute, sector, region);
            return localVarResponse.Data;
        }
        ...
        /// <param name="region">Region of domicile represents the region based on the company&#39;s primary listing.&lt;br /&gt;You can choose which of them (if any) you want to see analytics for.&lt;br /&gt;&lt;br /&gt; (optional)</param>
        /// <returns>ApiResponse of BuyTimingResponseRoot</returns>
        public ApiResponse<BuyTimingResponseRoot> GetBuyTimingModelAnalyticWithHttpInfo(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?))
        {
            // verify the required parameter 'accountPath' is set
            if (accountPath == null)
            {
        ...
        {
            var localVarResponse = await GetBuyTimingModelAnalyticWithHttpInfoAsync(accountPath, benchmarkPath, period, attribute, sector, region, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
