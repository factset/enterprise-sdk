...
namespace FactSet.SDK.Cabot.Api
{
    ...
    public interface IOverviewModelsApiSync : IApiAccessor
    {
        ...
        ApiResponse<ResultsResponseRoot> GetResultsModelAnalyticWithHttpInfo(string accountPath, string benchmarkPath, string period);
        /// <summary>
        ...
        SkillsResponseRoot GetSkillsModelAnalytic(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?));
        ...
        ApiResponse<SkillsResponseRoot> GetSkillsModelAnalyticWithHttpInfo(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?));
    ...
    public interface IOverviewModelsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResultsResponseRoot> GetResultsModelAnalyticAsync(string accountPath, string benchmarkPath, string period, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResultsResponseRoot>> GetResultsModelAnalyticWithHttpInfoAsync(string accountPath, string benchmarkPath, string period, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Cabot main path for Skills API
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SkillsResponseRoot> GetSkillsModelAnalyticAsync(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SkillsResponseRoot>> GetSkillsModelAnalyticWithHttpInfoAsync(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OverviewModelsApi : IOverviewModelsApi
    {
        ...
        /// <param name="period">For which period you want to retrieve the data.&lt;br /&gt;There are four options available as follows:&lt;br /&gt;&lt;br /&gt;1 -&gt; YYYY (Repeating One Year)&lt;br /&gt;&lt;br /&gt;2 -&gt; YYYY-YYYY (Repeating Three/Five/Ten Year)&lt;br /&gt;&lt;br /&gt;3 -&gt; 1M_TRAILING, 3M_TRAILING, 1Y_TRAILING, 3Y_TRAILING, 5Y_TRAILING (Trailing Periods (If available for your portfolio))&lt;br /&gt;&lt;br /&gt;4 -&gt; INCEPTION_TO_DATE&lt;br /&gt;&lt;br /&gt;You can only get the data for one period per request.&lt;br /&gt;&lt;br /&gt;</param>
        /// <returns>ResultsResponseRoot</returns>
        public ResultsResponseRoot GetResultsModelAnalytic(string accountPath, string benchmarkPath, string period)
        {
            var localVarResponse = GetResultsModelAnalyticWithHttpInfo(accountPath, benchmarkPath, period);
            return localVarResponse.Data;
        }
        ...
        /// <param name="period">For which period you want to retrieve the data.&lt;br /&gt;There are four options available as follows:&lt;br /&gt;&lt;br /&gt;1 -&gt; YYYY (Repeating One Year)&lt;br /&gt;&lt;br /&gt;2 -&gt; YYYY-YYYY (Repeating Three/Five/Ten Year)&lt;br /&gt;&lt;br /&gt;3 -&gt; 1M_TRAILING, 3M_TRAILING, 1Y_TRAILING, 3Y_TRAILING, 5Y_TRAILING (Trailing Periods (If available for your portfolio))&lt;br /&gt;&lt;br /&gt;4 -&gt; INCEPTION_TO_DATE&lt;br /&gt;&lt;br /&gt;You can only get the data for one period per request.&lt;br /&gt;&lt;br /&gt;</param>
        /// <returns>ApiResponse of ResultsResponseRoot</returns>
        public ApiResponse<ResultsResponseRoot> GetResultsModelAnalyticWithHttpInfo(string accountPath, string benchmarkPath, string period)
        {
            // verify the required parameter 'accountPath' is set
            if (accountPath == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResultsResponseRoot</returns>
        public async System.Threading.Tasks.Task<ResultsResponseRoot>GetResultsModelAnalyticAsync(string accountPath, string benchmarkPath, string period, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetResultsModelAnalyticWithHttpInfoAsync(accountPath, benchmarkPath, period, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ResultsResponseRoot>> GetResultsModelAnalyticWithHttpInfoAsync(string accountPath, string benchmarkPath, string period, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountPath' is set
            if (accountPath == null)
            {
        ...
        /// <param name="region">Region of domicile represents the region based on the company&#39;s primary listing.&lt;br /&gt;You can choose which of them (if any) you want to see analytics for.&lt;br /&gt;&lt;br /&gt; (optional)</param>
        /// <returns>SkillsResponseRoot</returns>
        public SkillsResponseRoot GetSkillsModelAnalytic(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?))
        {
            var localVarResponse = GetSkillsModelAnalyticWithHttpInfo(accountPath, benchmarkPath, period, attribute, sector, region);
            return localVarResponse.Data;
        }
        ...
        /// <param name="region">Region of domicile represents the region based on the company&#39;s primary listing.&lt;br /&gt;You can choose which of them (if any) you want to see analytics for.&lt;br /&gt;&lt;br /&gt; (optional)</param>
        /// <returns>ApiResponse of SkillsResponseRoot</returns>
        public ApiResponse<SkillsResponseRoot> GetSkillsModelAnalyticWithHttpInfo(string accountPath, string benchmarkPath, string period, Attributes? attribute = default(Attributes?), Sectors? sector = default(Sectors?), Regions? region = default(Regions?))
        {
            // verify the required parameter 'accountPath' is set
            if (accountPath == null)
            {
        ...
        {
            var localVarResponse = await GetSkillsModelAnalyticWithHttpInfoAsync(accountPath, benchmarkPath, period, attribute, sector, region, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
