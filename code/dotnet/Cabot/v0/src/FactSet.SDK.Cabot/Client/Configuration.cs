...
namespace FactSet.SDK.Cabot.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/Cabot/0.10.0";
            BasePath = "https://api.factset.com/analytics/cabot/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/cabot/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.Cabot) Debug Report:\n";
