...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// RampDownRequestBody
    /// </summary>
    [DataContract(Name = "RampDownRequestBody")]
    public partial class RampDownRequestBody : IEquatable<RampDownRequestBody>, IValidatableObject
    {
        ...
        public RampDownHoldings? Holdings { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="RampDownRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RampDownRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RampDownRequestBody" /> class.
        /// </summary>
        ...
        public RampDownRequestBody(string accountPath, string benchmarkPath, string period,Attributes attribute = default(Attributes), string sector = default(string), string region = default(string), RampDownHoldings holdings = default(RampDownHoldings), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for RampDownRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for RampDownRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for RampDownRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as RampDownRequestBody);
        }

        /// <summary>
        /// Returns true if RampDownRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of RampDownRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RampDownRequestBody input)
        {
            if (input == null)
            {
                return false;
