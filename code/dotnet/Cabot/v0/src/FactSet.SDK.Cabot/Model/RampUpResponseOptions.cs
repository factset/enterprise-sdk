...
namespace FactSet.SDK.Cabot.Model
{
    ...
    public partial class RampUpResponseOptions : IEquatable<RampUpResponseOptions>, IValidatableObject
    {
        ...
        public RampUpResponseOptions(string attribute = default(string), List<RampUpModelAnalytics> highRampUpValues = default(List<RampUpModelAnalytics>), List<RampUpModelAnalytics> lowRampUpValues = default(List<RampUpModelAnalytics>), List<RampUpModelAnalytics> rampUpValues = default(List<RampUpModelAnalytics>))
        {
