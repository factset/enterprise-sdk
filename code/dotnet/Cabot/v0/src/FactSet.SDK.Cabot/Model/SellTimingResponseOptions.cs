...
namespace FactSet.SDK.Cabot.Model
{
    ...
    public partial class SellTimingResponseOptions : IEquatable<SellTimingResponseOptions>, IValidatableObject
    {
        ...
        public SellTimingResponseOptions(string attribute = default(string), SellTimingModelAnalytics highSellTimingValues = default(SellTimingModelAnalytics), SellTimingModelAnalytics lowSellTimingValues = default(SellTimingModelAnalytics), SellTimingModelAnalytics sellTimingValues = default(SellTimingModelAnalytics))
        {
