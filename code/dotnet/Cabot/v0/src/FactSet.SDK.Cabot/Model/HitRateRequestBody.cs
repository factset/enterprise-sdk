...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// HitRateRequestBody
    /// </summary>
    [DataContract(Name = "HitRateRequestBody")]
    public partial class HitRateRequestBody : IEquatable<HitRateRequestBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HitRateRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HitRateRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HitRateRequestBody" /> class.
        /// </summary>
        ...
        /// <param name="sector">Represents the sector based on the company&#39;s industry breakdown. (required).</param>
        /// <param name="region">Region of domicile represents the region based on the company&#39;s primary listing. (required).</param>
        ...
        public HitRateRequestBody(string accountPath, string benchmarkPath, string period, string sector, string region,Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for HitRateRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for HitRateRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for HitRateRequestBody and cannot be null");
            }
            this.Period = period;
            // to ensure "sector" is required (not null)
            if (sector == null) {
                throw new ArgumentNullException("sector is a required property for HitRateRequestBody and cannot be null");
            }
            this.Sector = sector;
            // to ensure "region" is required (not null)
            if (region == null) {
                throw new ArgumentNullException("region is a required property for HitRateRequestBody and cannot be null");
            }
            this.Region = region;
        ...
        {
            return this.Equals(input as HitRateRequestBody);
        }

        /// <summary>
        /// Returns true if HitRateRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of HitRateRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HitRateRequestBody input)
        {
            if (input == null)
            {
                return false;
