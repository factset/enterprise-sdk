...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// AddTrimRequestBody
    /// </summary>
    [DataContract(Name = "AddTrimRequestBody")]
    public partial class AddTrimRequestBody : IEquatable<AddTrimRequestBody>, IValidatableObject
    {
        ...
        public AddTrimHoldings? Holdings { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTrimRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddTrimRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTrimRequestBody" /> class.
        /// </summary>
        ...
        public AddTrimRequestBody(string accountPath, string benchmarkPath, string period,Attributes attribute = default(Attributes), string sector = default(string), string region = default(string), AddTrimHoldings holdings = default(AddTrimHoldings), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for AddTrimRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for AddTrimRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for AddTrimRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as AddTrimRequestBody);
        }

        /// <summary>
        /// Returns true if AddTrimRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AddTrimRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddTrimRequestBody input)
        {
            if (input == null)
            {
                return false;
