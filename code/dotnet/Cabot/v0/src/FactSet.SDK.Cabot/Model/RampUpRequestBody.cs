...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// RampUpRequestBody
    /// </summary>
    [DataContract(Name = "RampUpRequestBody")]
    public partial class RampUpRequestBody : IEquatable<RampUpRequestBody>, IValidatableObject
    {
        ...
        public RampUpHoldings? Holdings { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="RampUpRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RampUpRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RampUpRequestBody" /> class.
        /// </summary>
        ...
        public RampUpRequestBody(string accountPath, string benchmarkPath, string period,Attributes attribute = default(Attributes), string sector = default(string), string region = default(string), RampUpHoldings holdings = default(RampUpHoldings), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for RampUpRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for RampUpRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for RampUpRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as RampUpRequestBody);
        }

        /// <summary>
        /// Returns true if RampUpRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of RampUpRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RampUpRequestBody input)
        {
            if (input == null)
            {
                return false;
