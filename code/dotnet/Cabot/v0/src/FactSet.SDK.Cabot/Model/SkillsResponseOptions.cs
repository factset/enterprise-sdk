...
namespace FactSet.SDK.Cabot.Model
{
    ...
    public partial class SkillsResponseOptions : IEquatable<SkillsResponseOptions>, IValidatableObject
    {
        ...
        public SkillsResponseOptions(SkillsModelAnalytics highSkillValues = default(SkillsModelAnalytics), SkillsModelAnalytics lowSkillValues = default(SkillsModelAnalytics), SkillsModelAnalytics skillValues = default(SkillsModelAnalytics), string attribute = default(string))
        {
