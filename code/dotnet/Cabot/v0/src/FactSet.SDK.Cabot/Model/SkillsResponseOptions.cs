...
namespace FactSet.SDK.Cabot.Model
{
    ...
    public partial class SkillsResponseOptions : IEquatable<SkillsResponseOptions>, IValidatableObject
    {
        ...
        public SkillsResponseOptions(string attribute = default(string), SkillsModelAnalytics highSkillValues = default(SkillsModelAnalytics), HoldingsResponseOptions holdingsData = default(HoldingsResponseOptions), SkillsModelAnalytics lowSkillValues = default(SkillsModelAnalytics), SkillsModelAnalytics skillValues = default(SkillsModelAnalytics))
        {
