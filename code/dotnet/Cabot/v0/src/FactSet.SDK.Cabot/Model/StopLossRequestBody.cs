...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// StopLossRequestBody
    /// </summary>
    [DataContract(Name = "StopLossRequestBody")]
    public partial class StopLossRequestBody : IEquatable<StopLossRequestBody>, IValidatableObject
    {
        ...
        public StopLossHoldings? Holdings { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="StopLossRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StopLossRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StopLossRequestBody" /> class.
        /// </summary>
        ...
        public StopLossRequestBody(string accountPath, string benchmarkPath, string period,Attributes attribute = default(Attributes), string sector = default(string), string region = default(string), StopLossHoldings holdings = default(StopLossHoldings), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for StopLossRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for StopLossRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for StopLossRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as StopLossRequestBody);
        }

        /// <summary>
        /// Returns true if StopLossRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of StopLossRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossRequestBody input)
        {
            if (input == null)
            {
                return false;
