...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BuyTimingRequestBody")]
    public partial class BuyTimingRequestBody : IEquatable<BuyTimingRequestBody>, IValidatableObject
    {
        ...
        public BuyTimingHoldings? Holdings { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyTimingRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BuyTimingRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyTimingRequestBody" /> class.
        /// </summary>
        ...
        public BuyTimingRequestBody(string accountPath, string benchmarkPath, string period,Attributes attribute = default(Attributes), string sector = default(string), string region = default(string), BuyTimingHoldings holdings = default(BuyTimingHoldings), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for BuyTimingRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for BuyTimingRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for BuyTimingRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as BuyTimingRequestBody);
        }

        /// <summary>
        /// Returns true if BuyTimingRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of BuyTimingRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuyTimingRequestBody input)
        {
            if (input == null)
            {
                return false;
