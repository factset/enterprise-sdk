...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SellTimingRequestBody")]
    public partial class SellTimingRequestBody : IEquatable<SellTimingRequestBody>, IValidatableObject
    {
        ...
        public SellTimingHoldings? Holdings { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SellTimingRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SellTimingRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SellTimingRequestBody" /> class.
        /// </summary>
        ...
        public SellTimingRequestBody(string accountPath, string benchmarkPath, string period,Attributes attribute = default(Attributes), string sector = default(string), string region = default(string), SellTimingHoldings holdings = default(SellTimingHoldings), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for SellTimingRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for SellTimingRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for SellTimingRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as SellTimingRequestBody);
        }

        /// <summary>
        /// Returns true if SellTimingRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of SellTimingRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SellTimingRequestBody input)
        {
            if (input == null)
            {
                return false;
