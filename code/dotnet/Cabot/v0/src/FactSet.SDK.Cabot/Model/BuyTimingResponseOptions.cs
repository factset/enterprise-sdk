...
namespace FactSet.SDK.Cabot.Model
{
    ...
    public partial class BuyTimingResponseOptions : IEquatable<BuyTimingResponseOptions>, IValidatableObject
    {
        ...
        public BuyTimingResponseOptions(string attribute = default(string), List<BuyTimingModelAnalytics> buyTimingValues = default(List<BuyTimingModelAnalytics>), List<BuyTimingModelAnalytics> highBuyTimingValues = default(List<BuyTimingModelAnalytics>), List<BuyTimingModelAnalytics> lowBuyTimingValues = default(List<BuyTimingModelAnalytics>))
        {
