...
namespace FactSet.SDK.Cabot.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BuyContextRequestBody")]
    public partial class BuyContextRequestBody : IEquatable<BuyContextRequestBody>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyContextRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BuyContextRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyContextRequestBody" /> class.
        /// </summary>
        ...
        public BuyContextRequestBody(string accountPath, string benchmarkPath, string period, Attributes attribute,string sector = default(string), string region = default(string), Dictionary<string, string> customClassifications = default(Dictionary<string, string>))
        {
            // to ensure "accountPath" is required (not null)
            if (accountPath == null) {
                throw new ArgumentNullException("accountPath is a required property for BuyContextRequestBody and cannot be null");
            }
            this.AccountPath = accountPath;
            // to ensure "benchmarkPath" is required (not null)
            if (benchmarkPath == null) {
                throw new ArgumentNullException("benchmarkPath is a required property for BuyContextRequestBody and cannot be null");
            }
            this.BenchmarkPath = benchmarkPath;
            // to ensure "period" is required (not null)
            if (period == null) {
                throw new ArgumentNullException("period is a required property for BuyContextRequestBody and cannot be null");
            }
            this.Period = period;
        ...
        {
            return this.Equals(input as BuyContextRequestBody);
        }

        /// <summary>
        /// Returns true if BuyContextRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of BuyContextRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuyContextRequestBody input)
        {
            if (input == null)
            {
                return false;
