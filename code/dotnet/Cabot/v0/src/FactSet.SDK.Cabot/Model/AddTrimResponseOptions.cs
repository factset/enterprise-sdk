...
namespace FactSet.SDK.Cabot.Model
{
    ...
    public partial class AddTrimResponseOptions : IEquatable<AddTrimResponseOptions>, IValidatableObject
    {
        ...
        public AddTrimResponseOptions(AddTrimModelAnalytics addTrimValues = default(AddTrimModelAnalytics), string attribute = default(string), AddTrimModelAnalytics highAddTrimValues = default(AddTrimModelAnalytics), AddTrimModelAnalytics lowAddTrimValues = default(AddTrimModelAnalytics))
        {
