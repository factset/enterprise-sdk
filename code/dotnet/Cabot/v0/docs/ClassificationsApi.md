# FactSet.SDK.Cabot.Api.ClassificationsApi
...
<a name="getportfolioclassifications"></a>
...
namespace Example
{
    public class GetPortfolioClassificationsExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new ClassificationsApi(config);
            ...
            {
                Console.WriteLine("Exception when calling ClassificationsApi.GetPortfolioClassifications: " + e.Message );
