# FactSet.SDK.OPENOPTIMIZER.Api.AxiomaFixedIncomePortfolioOptimizerApi
...
<a name="getglobalvariablesafi"></a>
# **GetGlobalVariablesAFI**
> SettingsGlobalVarsResponse GetGlobalVariablesAFI (string cacheControl = null)
...
namespace Example
{
    public class GetGlobalVariablesAFIExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new AxiomaFixedIncomePortfolioOptimizerApi(config);
            ...
            {
                Console.WriteLine("Exception when calling AxiomaFixedIncomePortfolioOptimizerApi.GetGlobalVariablesAFI: " + e.Message );
...
<a name="getoptimizationresultbyidafi"></a>
...
namespace Example
{
    public class GetOptimizationResultByIdAFIExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OPENOPTIMIZER.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling AxiomaFixedIncomePortfolioOptimizerApi.GetOptimizationResultByIdAFI: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getoptimizationstatusbyidafi"></a>
...
namespace Example
{
    public class GetOptimizationStatusByIdAFIExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OPENOPTIMIZER.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling AxiomaFixedIncomePortfolioOptimizerApi.GetOptimizationStatusByIdAFI: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="postandoptimizeafi"></a>
# **PostAndOptimizeAFI**
> OptimizationStatus PostAndOptimizeAFI (string cacheControl = null, AFIOptimizationParametersRequest aFIOptimizationParametersRequest = null)
...
namespace Example
{
    public class PostAndOptimizeAFIExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OPENOPTIMIZER.Client.Configuration();
            ...
            var cacheControl = "cacheControl_example";  // string | Standard HTTP header.  Accepts max-stale. (optional) 
            var aFIOptimizationParametersRequest = new AFIOptimizationParametersRequest(); // AFIOptimizationParametersRequest | Optimization Parameters (optional) 
            ...
            {
                Console.WriteLine("Exception when calling AxiomaFixedIncomePortfolioOptimizerApi.PostAndOptimizeAFI: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="postcomponentsafi"></a>
# **PostComponentsAFI**
> AvailableComponentsResponse PostComponentsAFI (AXPAvailableComponentsInput aXPAvailableComponentsInput = null)
...
namespace Example
{
    public class PostComponentsAFIExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OPENOPTIMIZER.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling AxiomaFixedIncomePortfolioOptimizerApi.PostComponentsAFI: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="poststrategiesafi"></a>
# **PostStrategiesAFI**
> AvailableStrategiesResponse PostStrategiesAFI (string cacheControl = null, AvailableStrategiesInput availableStrategiesInput = null)
...
namespace Example
{
    public class PostStrategiesAFIExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OPENOPTIMIZER.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling AxiomaFixedIncomePortfolioOptimizerApi.PostStrategiesAFI: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
