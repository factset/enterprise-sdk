...
namespace FactSet.SDK.OPENOPTIMIZER.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/OPENOPTIMIZER/0.0.1";
            BasePath = "https://api.factset.com/open-optimizer/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/open-optimizer/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.OPENOPTIMIZER) Debug Report:\n";
