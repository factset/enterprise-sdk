...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NPOOptimizerStrategyOverridesInput")]
    public partial class NPOOptimizerStrategyOverridesInput : IEquatable<NPOOptimizerStrategyOverridesInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NPOOptimizerStrategyOverridesInput" /> class.
        /// </summary>
        /// <param name="objective">objective.</param>
        /// <param name="tax">tax.</param>
        /// <param name="constraints">List of constraint type vs constraint id.</param>
        /// <param name="alpha">Alpha.</param>
        /// <param name="transactionCost">Transaction cost.</param>
        public NPOOptimizerStrategyOverridesInput(string objective = default(string), string tax = default(string), Object constraints = default(Object), string alpha = default(string), string transactionCost = default(string))
        {
        ...
        /// </summary>
        /// <value>List of constraint type vs constraint id</value>
        ...
        {
            return this.Equals(input as NPOOptimizerStrategyOverridesInput);
        }

        /// <summary>
        /// Returns true if NPOOptimizerStrategyOverridesInput instances are equal
        /// </summary>
        /// <param name="input">Instance of NPOOptimizerStrategyOverridesInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NPOOptimizerStrategyOverridesInput input)
        {
            if (input == null)
            {
                return false;
