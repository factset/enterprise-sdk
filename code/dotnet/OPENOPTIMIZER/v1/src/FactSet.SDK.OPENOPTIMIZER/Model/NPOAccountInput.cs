...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// NPOAccountInput
    /// </summary>
    [DataContract(Name = "NPOAccountInput")]
    public partial class NPOAccountInput : IEquatable<NPOAccountInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NPOAccountInput" /> class.
        /// </summary>
        /// <param name="id">Account path.</param>
        /// <param name="overrides">overrides.</param>
        public NPOAccountInput(string id = default(string), OptimizerAccountOverridesInput overrides = default(OptimizerAccountOverridesInput))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NPOAccountInput {\n");
        ...
        {
            return this.Equals(input as NPOAccountInput);
        }

        /// <summary>
        /// Returns true if NPOAccountInput instances are equal
        /// </summary>
        /// <param name="input">Instance of NPOAccountInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NPOAccountInput input)
        {
            if (input == null)
            {
                return false;
