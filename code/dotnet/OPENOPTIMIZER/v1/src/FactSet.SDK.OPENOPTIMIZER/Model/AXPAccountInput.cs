...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// AXPAccountInput
    /// </summary>
    [DataContract(Name = "AXPAccountInput")]
    public partial class AXPAccountInput : IEquatable<AXPAccountInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AXPAccountInput" /> class.
        /// </summary>
        /// <param name="id">Account path.</param>
        /// <param name="overrides">overrides.</param>
        public AXPAccountInput(string id = default(string), OptimizerAccountOverridesInput overrides = default(OptimizerAccountOverridesInput))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as AXPAccountInput);
        }

        /// <summary>
        /// Returns true if AXPAccountInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AXPAccountInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AXPAccountInput input)
        {
            if (input == null)
            {
                return false;
