...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    public partial class BPMOptimizationParameters : IEquatable<BPMOptimizationParameters>, IValidatableObject
    {
        ...
        public BPMOptimizationParameters(BPMOptimizerStrategyInput strategy, OptimizerOutputTypes outputTypes,BPMAccountInput account = default(BPMAccountInput), OptimizationInput optimization = default(OptimizationInput))
        {
        ...
        public BPMAccountInput Account { get; set; }

        /// <summary>
        /// Gets or Sets Strategy
        /// </summary>
        [DataMember(Name = "strategy", IsRequired = true, EmitDefaultValue = false)]
        public BPMOptimizerStrategyInput Strategy { get; set; }
