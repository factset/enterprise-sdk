...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    public partial class FPOOptimizationParameters : IEquatable<FPOOptimizationParameters>, IValidatableObject
    {
        ...
        public FPOOptimizationParameters(FPOOptimizerStrategyInput strategy, OptimizerOutputTypes outputTypes,FPOAccountInput account = default(FPOAccountInput), OptimizationInput optimization = default(OptimizationInput))
        {
        ...
        public FPOAccountInput Account { get; set; }

        /// <summary>
        /// Gets or Sets Strategy
        /// </summary>
        [DataMember(Name = "strategy", IsRequired = true, EmitDefaultValue = false)]
        public FPOOptimizerStrategyInput Strategy { get; set; }
