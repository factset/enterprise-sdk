...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AXPOptimizerStrategyInput")]
    public partial class AXPOptimizerStrategyInput : IEquatable<AXPOptimizerStrategyInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AXPOptimizerStrategyInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AXPOptimizerStrategyInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AXPOptimizerStrategyInput" /> class.
        /// </summary>
        /// <param name="overrides">overrides.</param>
        /// <param name="id">OptimizerStrategy document path (required).</param>
        public AXPOptimizerStrategyInput(string id,AXPOptimizerStrategyOverridesInput overrides = default(AXPOptimizerStrategyOverridesInput))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for AXPOptimizerStrategyInput and cannot be null");
            }
            this.Id = id;
        ...
        public AXPOptimizerStrategyOverridesInput Overrides { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AXPOptimizerStrategyInput {\n");
        ...
        {
            return this.Equals(input as AXPOptimizerStrategyInput);
        }

        /// <summary>
        /// Returns true if AXPOptimizerStrategyInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AXPOptimizerStrategyInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AXPOptimizerStrategyInput input)
        {
            if (input == null)
            {
                return false;
