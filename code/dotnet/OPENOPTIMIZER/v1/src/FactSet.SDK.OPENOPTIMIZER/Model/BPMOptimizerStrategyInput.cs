...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BPMOptimizerStrategyInput")]
    public partial class BPMOptimizerStrategyInput : IEquatable<BPMOptimizerStrategyInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BPMOptimizerStrategyInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BPMOptimizerStrategyInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BPMOptimizerStrategyInput" /> class.
        /// </summary>
        /// <param name="overrides">overrides.</param>
        /// <param name="id">OptimizerStrategy document path (required).</param>
        public BPMOptimizerStrategyInput(string id,BPMOptimizerStrategyOverridesInput overrides = default(BPMOptimizerStrategyOverridesInput))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for BPMOptimizerStrategyInput and cannot be null");
            }
            this.Id = id;
        ...
        public BPMOptimizerStrategyOverridesInput Overrides { get; set; }
        ...
        {
            return this.Equals(input as BPMOptimizerStrategyInput);
        }

        /// <summary>
        /// Returns true if BPMOptimizerStrategyInput instances are equal
        /// </summary>
        /// <param name="input">Instance of BPMOptimizerStrategyInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BPMOptimizerStrategyInput input)
        {
            if (input == null)
            {
                return false;
