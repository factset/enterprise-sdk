...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NPOOptimizerStrategyInput")]
    public partial class NPOOptimizerStrategyInput : IEquatable<NPOOptimizerStrategyInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NPOOptimizerStrategyInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NPOOptimizerStrategyInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NPOOptimizerStrategyInput" /> class.
        /// </summary>
        /// <param name="overrides">overrides.</param>
        /// <param name="id">OptimizerStrategy document path (required).</param>
        public NPOOptimizerStrategyInput(string id,NPOOptimizerStrategyOverridesInput overrides = default(NPOOptimizerStrategyOverridesInput))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for NPOOptimizerStrategyInput and cannot be null");
            }
            this.Id = id;
        ...
        public NPOOptimizerStrategyOverridesInput Overrides { get; set; }
        ...
        {
            return this.Equals(input as NPOOptimizerStrategyInput);
        }

        /// <summary>
        /// Returns true if NPOOptimizerStrategyInput instances are equal
        /// </summary>
        /// <param name="input">Instance of NPOOptimizerStrategyInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NPOOptimizerStrategyInput input)
        {
            if (input == null)
            {
                return false;
