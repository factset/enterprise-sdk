...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AXPOptimizerStrategyOverridesInput")]
    public partial class AXPOptimizerStrategyOverridesInput : IEquatable<AXPOptimizerStrategyOverridesInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AXPOptimizerStrategyOverridesInput" /> class.
        /// </summary>
        ...
        public AXPOptimizerStrategyOverridesInput(string objective = default(string), string tax = default(string), Dictionary<string, EnabledEnum> constraints = default(Dictionary<string, EnabledEnum>), string alpha = default(string), string transactionCost = default(string))
        {
        ...
        {
            return this.Equals(input as AXPOptimizerStrategyOverridesInput);
        }

        /// <summary>
        /// Returns true if AXPOptimizerStrategyOverridesInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AXPOptimizerStrategyOverridesInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AXPOptimizerStrategyOverridesInput input)
        {
            if (input == null)
            {
                return false;
