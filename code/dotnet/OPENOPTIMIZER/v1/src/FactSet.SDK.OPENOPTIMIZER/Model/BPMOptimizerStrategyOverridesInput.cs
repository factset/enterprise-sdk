...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BPMOptimizerStrategyOverridesInput")]
    public partial class BPMOptimizerStrategyOverridesInput : IEquatable<BPMOptimizerStrategyOverridesInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BPMOptimizerStrategyOverridesInput" /> class.
        /// </summary>
        ...
        public BPMOptimizerStrategyOverridesInput(string objective = default(string), string tax = default(string), Object constraints = default(Object), string alpha = default(string), string transactionCost = default(string))
        {
        ...
        {
            return this.Equals(input as BPMOptimizerStrategyOverridesInput);
        }

        /// <summary>
        /// Returns true if BPMOptimizerStrategyOverridesInput instances are equal
        /// </summary>
        /// <param name="input">Instance of BPMOptimizerStrategyOverridesInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BPMOptimizerStrategyOverridesInput input)
        {
            if (input == null)
            {
                return false;
