...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResultResponse_data_debugFile")]
    public partial class ResultResponseDataDebugFile : IEquatable<ResultResponseDataDebugFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultResponseDataDebugFile" /> class.
        /// </summary>
        /// <param name="idRef">idRef.</param>
        /// <param name="input">input.</param>
        public ResultResponseDataDebugFile(Object idRef = default(Object), ResultResponseDataDebugFileInput input = default(ResultResponseDataDebugFileInput))
        {
            this.IdRef = idRef;
            this.Input = input;
        }
        ...
        public ResultResponseDataDebugFileInput Input { get; set; }
        ...
        {
            return this.Equals(input as ResultResponseDataDebugFile);
        }

        /// <summary>
        /// Returns true if ResultResponseDataDebugFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultResponseDataDebugFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultResponseDataDebugFile input)
        {
            if (input == null)
            {
                return false;
