...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// AFIAccountInput
    /// </summary>
    [DataContract(Name = "AFIAccountInput")]
    public partial class AFIAccountInput : IEquatable<AFIAccountInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AFIAccountInput" /> class.
        /// </summary>
        /// <param name="id">Account path.</param>
        /// <param name="overrides">overrides.</param>
        public AFIAccountInput(string id = default(string), OptimizerAccountOverridesInput overrides = default(OptimizerAccountOverridesInput))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AFIAccountInput {\n");
        ...
        {
            return this.Equals(input as AFIAccountInput);
        }

        /// <summary>
        /// Returns true if AFIAccountInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AFIAccountInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AFIAccountInput input)
        {
            if (input == null)
            {
                return false;
