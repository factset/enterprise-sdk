...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    public partial class AFIOptimizationParameters : IEquatable<AFIOptimizationParameters>, IValidatableObject
    {
        ...
        public AFIOptimizationParameters(AFIOptimizerStrategyInput strategy, OptimizerOutputTypes outputTypes,AFIAccountInput account = default(AFIAccountInput), OptimizationInput optimization = default(OptimizationInput))
        {
        ...
        public AFIAccountInput Account { get; set; }

        /// <summary>
        /// Gets or Sets Strategy
        /// </summary>
        [DataMember(Name = "strategy", IsRequired = true, EmitDefaultValue = false)]
        public AFIOptimizerStrategyInput Strategy { get; set; }
