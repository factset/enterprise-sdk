...
namespace FactSet.SDK.OPENOPTIMIZER.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TradesListOutputType")]
    public partial class TradesListOutputType : IEquatable<TradesListOutputType>, IValidatableObject
    {
        /// <summary>
        /// Identifier type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TradesListOutputType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TradesListOutputType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TradesListOutputType" /> class.
        /// </summary>
        /// <param name="identifierType">Identifier type (required).</param>
        /// <param name="includeCash">Include cash.</param>
        public TradesListOutputType(IdentifierTypeEnum identifierType,bool includeCash = default(bool))
        {
        ...
        {
            return this.Equals(input as TradesListOutputType);
        }

        /// <summary>
        /// Returns true if TradesListOutputType instances are equal
        /// </summary>
        /// <param name="input">Instance of TradesListOutputType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradesListOutputType input)
        {
            if (input == null)
            {
                return false;
