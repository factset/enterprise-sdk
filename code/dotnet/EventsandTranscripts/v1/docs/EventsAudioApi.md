...
namespace Example
{
    public class GetDocsDistributorAudioV1ListFilesDateExample
    {
        public static async Task Main()
        {
            ...
            var startDate = DateTime.Parse("2020-10-01T00:00:00.000Z");  // DateTime? | The earliest date of the audio file the API should fetch for.  - Format: Should be absolute (YYYY-MM-DD).  (optional) 
            var endDate = DateTime.Parse("2020-12-26T00:00:00.000Z");  // DateTime? | The latest date of the audio file the API should fetch for. - Format: Should be absolute (YYYY-MM-DD).  (optional) 
