...
[![Nuget](https://img.shields.io/badge/nuget-v1.1.1-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/1.1.1)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 1.1.1
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 1.1.1
```
