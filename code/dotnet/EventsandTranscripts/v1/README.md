...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/1.0.0)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 1.0.0
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 1.0.0
```
