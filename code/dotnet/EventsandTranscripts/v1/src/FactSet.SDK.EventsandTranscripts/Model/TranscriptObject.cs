...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// TranscriptObject
    /// </summary>
    [DataContract(Name = "TranscriptObject")]
    public partial class TranscriptObject : IEquatable<TranscriptObject>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptObject" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranscriptObject {\n");
        ...
        {
            return this.Equals(input as TranscriptObject);
        }

        /// <summary>
        /// Returns true if TranscriptObject instances are equal
        /// </summary>
        /// <param name="input">Instance of TranscriptObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranscriptObject input)
        {
            if (input == null)
            {
                return false;
