...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    public partial class NrtSpeakerIdObject : IEquatable<NrtSpeakerIdObject>, IValidatableObject
    {
        ...
        /// <param name="confidenceScore">The  Confidence score similarity for a particular speaker.  A score &gt;&#x3D; 0.49 while a speaker is speaking can be considered as a high confidence in the predicted speaker.  Only the speakerIDs with confidenceScore &gt;&#x3D; 0.49 are rendered in the result set..</param>
        ...
        /// </summary>
        /// <value>The  Confidence score similarity for a particular speaker.  A score &gt;&#x3D; 0.49 while a speaker is speaking can be considered as a high confidence in the predicted speaker.  Only the speakerIDs with confidenceScore &gt;&#x3D; 0.49 are rendered in the result set.</value>
