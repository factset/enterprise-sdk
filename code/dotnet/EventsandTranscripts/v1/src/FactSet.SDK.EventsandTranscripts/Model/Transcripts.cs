...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    public partial class Transcripts : IEquatable<Transcripts>, IValidatableObject
    {
        ...
        public Transcripts(List<TranscriptObject> data = default(List<TranscriptObject>), TranscriptsMeta meta = default(TranscriptsMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<TranscriptObject> Data { get; set; }
