...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EventsAudioDaily_meta_pagination")]
    public partial class EventsAudioDailyMetaPagination : IEquatable<EventsAudioDailyMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsAudioDailyMetaPagination" /> class.
        /// </summary>
        ...
        public EventsAudioDailyMetaPagination(int total = default(int), bool isEstimatedTotal = default(bool))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as EventsAudioDailyMetaPagination);
        }

        /// <summary>
        /// Returns true if EventsAudioDailyMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsAudioDailyMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsAudioDailyMetaPagination input)
        {
            if (input == null)
            {
                return false;
