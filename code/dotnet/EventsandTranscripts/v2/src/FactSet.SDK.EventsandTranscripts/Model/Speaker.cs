...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    public partial class Speaker : IEquatable<Speaker>, IValidatableObject
    {
        ...
        public Speaker(string id = default(string), Plist plist = default(Plist))
        {
            this.Id = id;
            this.Plist = plist;
        }
        ...
        /// Gets or Sets Plist
        /// </summary>
        [DataMember(Name = "plist", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Plist: ").Append(Plist).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Speaker input)
        {
            ...
            return 
                ...
                (
                    this.Plist == input.Plist ||
                    (this.Plist != null &&
                    this.Plist.Equals(input.Plist))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Plist != null)
                {
                    hashCode = (hashCode * 59) + this.Plist.GetHashCode();
                }
                return hashCode;
            }
        }
