...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EventsAudioDailyResponseData")]
    public partial class EventsAudioDailyResponseData : IEquatable<EventsAudioDailyResponseData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsAudioDailyResponseData" /> class.
        /// </summary>
        ...
        /// <param name="trimmed">The trimmed attribute indicates whether the audio is a trimmed version.   - If **true**, the audio has been trimmed.   - If **false**, the full-length version is used.   Note: If &#x60;audioSource&#x60; is set to &#x60;vendor&#x60;, this attribute will always be true. .</param>
        ...
        public EventsAudioDailyResponseData(int reportId = default(int), string fileName = default(string), string url = default(string), decimal fileSize = default(decimal), int? audioSourceId = default(int?), string ticker = default(string), string entityId = default(string), AudioSourceEnum? audioSource = default(AudioSourceEnum?), bool trimmed = default(bool), decimal? durationSecs = default(decimal?), decimal? startOffsetSeconds = default(decimal?), decimal? endOffsetSeconds = default(decimal?), DateTime? startTime = default(DateTime?), DateTime? endTime = default(DateTime?), DateTime? uploadTime = default(DateTime?), decimal? sampleRate = default(decimal?), decimal? bitrate = default(decimal?))
        {
        ...
        /// </summary>
        /// <value>The trimmed attribute indicates whether the audio is a trimmed version.   - If **true**, the audio has been trimmed.   - If **false**, the full-length version is used.   Note: If &#x60;audioSource&#x60; is set to &#x60;vendor&#x60;, this attribute will always be true. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventsAudioDailyResponseData {\n");
        ...
        {
            return this.Equals(input as EventsAudioDailyResponseData);
        }

        /// <summary>
        /// Returns true if EventsAudioDailyResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsAudioDailyResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsAudioDailyResponseData input)
        {
            if (input == null)
            {
                return false;
