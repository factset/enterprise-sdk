...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    public partial class TranscriptsByIdsRequest : IEquatable<TranscriptsByIdsRequest>, IValidatableObject
    {
        ...
        public TranscriptsByIdsRequest(List<string> ids,bool primaryId = false, List<string> reportIds = default(List<string>), List<string> categories = default(List<string>), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), DateTypeEnum? dateType = default(DateTypeEnum?), string searchText = default(string))
        {
