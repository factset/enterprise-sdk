...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NrtCallsRequestByTicker")]
    public partial class NrtCallsRequestByTicker : IEquatable<NrtCallsRequestByTicker>, IValidatableObject
    {
        /// <summary>
        ...
        public enum CallStatusEnum
        {
            ...
            /// <summary>
            /// Enum EWN for value: EWN
            /// </summary>
            [EnumMember(Value = "EWN")]
            EWN = 3,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NrtCallsRequestByTicker" /> class.
        /// </summary>
        ...
        public NrtCallsRequestByTicker(string ticker = default(string), string entityId = default(string), CallStatusEnum? callStatus = default(CallStatusEnum?))
        {
            this.Ticker = ticker;
        ...
        {
            return this.Equals(input as NrtCallsRequestByTicker);
        }

        /// <summary>
        /// Returns true if NrtCallsRequestByTicker instances are equal
        /// </summary>
        /// <param name="input">Instance of NrtCallsRequestByTicker to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NrtCallsRequestByTicker input)
        {
            if (input == null)
            {
                return false;
