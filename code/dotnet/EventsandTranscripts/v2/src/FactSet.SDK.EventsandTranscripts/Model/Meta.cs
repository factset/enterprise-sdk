...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    public partial class Meta : IEquatable<Meta>, IValidatableObject
    {
        ...
        public Meta(string title = default(string), DateTime date = default(DateTime), List<string> companies = default(List<string>), List<Participant> participants = default(List<Participant>))
        {
            this.Title = title;
            this.Date = date;
