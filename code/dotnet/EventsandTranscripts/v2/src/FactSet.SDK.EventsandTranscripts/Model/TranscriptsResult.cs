...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranscriptsResult")]
    public partial class TranscriptsResult : IEquatable<TranscriptsResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranscriptsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptsResult" /> class.
        /// </summary>
        ...
        /// <param name="timeZone">Time Zone for story dates/times (POSIX format from IANA timeZone registry). Note: The timeZone will be included in the response only for TranscriptsByTimesRequest. (default to &quot;America/New_York&quot;).</param>
        ...
        /// </summary>
        /// <value>Time Zone for story dates/times (POSIX format from IANA timeZone registry). Note: The timeZone will be included in the response only for TranscriptsByTimesRequest.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranscriptsResult {\n");
        ...
        {
            return this.Equals(input as TranscriptsResult);
        }

        /// <summary>
        /// Returns true if TranscriptsResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TranscriptsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranscriptsResult input)
        {
            if (input == null)
            {
                return false;
