...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IndexedNrtResponseData")]
    public partial class IndexedNrtResponseData : IEquatable<IndexedNrtResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexedNrtResponseData" /> class.
        /// </summary>
        ...
        public IndexedNrtResponseData(DateTime snippetEndTimestamp = default(DateTime), int snippetSequence = default(int), int audioSourceId = default(int), List<Object> transcriptData = default(List<Object>))
        {
        ...
        {
            return this.Equals(input as IndexedNrtResponseData);
        }

        /// <summary>
        /// Returns true if IndexedNrtResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexedNrtResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexedNrtResponseData input)
        {
            if (input == null)
            {
                return false;
