...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    public partial class TranscriptsResponseData : AbstractOpenAPISchema, IEquatable<TranscriptsResponseData>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TranscriptsResponseData" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of TranscriptsResult.</param>
        public TranscriptsResponseData(TranscriptsResult actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value is TranscriptsResult)
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: TranscriptsByIdsResponse, TranscriptsResult");
                }
            }
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of TranscriptsResult</returns>
        public TranscriptsResult GetTranscriptsResult()
        {
            return (TranscriptsResult)this.ActualInstance;
        }
        ...
        public static TranscriptsResponseData FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                switch (discriminatorValue)
                {
                    ...
                    case "TranscriptsResult":
                        newTranscriptsResponseData = new TranscriptsResponseData(JsonConvert.DeserializeObject<TranscriptsResult>(jsonString, TranscriptsResponseData.AdditionalPropertiesSerializerSettings));
                        return newTranscriptsResponseData;
                    case "documentResult":
                        newTranscriptsResponseData = new TranscriptsResponseData(JsonConvert.DeserializeObject<TranscriptsResult>(jsonString, TranscriptsResponseData.AdditionalPropertiesSerializerSettings));
                        return newTranscriptsResponseData;
                    case "transcriptById":
                        ...
                        return newTranscriptsResponseData;
                    default:
                        System.Diagnostics.Debug.WriteLine(string.Format("Failed to lookup discriminator value `{0}` for TranscriptsResponseData. Possible values: TranscriptsByIdsResponse TranscriptsResult documentResult transcriptById", discriminatorValue));
                        break;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                var hasAdditionalProperties = !(typeof(TranscriptsResult).GetProperty("AdditionalProperties") is null);
                var parsedValue = JsonConvert.DeserializeObject<TranscriptsResult>(
                    jsonString,
                    hasAdditionalProperties ? TranscriptsResponseData.AdditionalPropertiesSerializerSettings : TranscriptsResponseData.SerializerSettings
                );
                newTranscriptsResponseData = new TranscriptsResponseData(parsedValue);
                matchedTypes.Add("TranscriptsResult");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into TranscriptsResult: {1}", jsonString, exception.ToString()));
            }
