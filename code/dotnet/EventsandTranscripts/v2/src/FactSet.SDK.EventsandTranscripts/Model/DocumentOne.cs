...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DocumentOne")]
    public partial class DocumentOne : IEquatable<DocumentOne>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentOne" /> class.
        /// </summary>
        ...
        /// <param name="slidesUrl">This is a URL for downloading the document with an expiration duration of 24 hours..</param>
        /// <param name="eventId">Unique identifier derived from report_id with a &#39;t&#39; appended, indicating a transcript or slide..</param>
        public DocumentOne(List<string> primaryIds = default(List<string>), List<string> allIds = default(List<string>), string headline = default(string), DateTime storyDateTime = default(DateTime), List<string> categories = default(List<string>), string slidesUrl = default(string), string eventId = default(string))
        {
        ...
        /// </summary>
        /// <value>This is a URL for downloading the document with an expiration duration of 24 hours.</value>
        [DataMember(Name = "slidesUrl", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as DocumentOne);
        }

        /// <summary>
        /// Returns true if DocumentOne instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentOne to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentOne input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SlidesUrl == input.SlidesUrl ||
                    (this.SlidesUrl != null &&
                    this.SlidesUrl.Equals(input.SlidesUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SlidesUrl.GetHashCode();
                }
