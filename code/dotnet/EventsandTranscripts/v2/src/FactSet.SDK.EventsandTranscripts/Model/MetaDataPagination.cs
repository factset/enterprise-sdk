...
namespace FactSet.SDK.EventsandTranscripts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetaData_pagination")]
    public partial class MetaDataPagination : IEquatable<MetaDataPagination>, IValidatableObject
    {
        /// <summary>
        ...
        public MetaDataPagination(int total = default(int), bool isEstimatedTotal = default(bool))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as MetaDataPagination);
        }

        /// <summary>
        /// Returns true if MetaDataPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of MetaDataPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetaDataPagination input)
        {
            if (input == null)
            {
                return false;
