...
namespace FactSet.SDK.EventsandTranscripts.Api
{
    ...
    public interface ITranscriptsApiSync : IApiAccessor
    {
        ...
        /// <param name="ids">Requested symbols or securities. This is a list with a maximum limit of 1000. Each symbol can be a FactSet exchange symbol, CUSIP, SEDOL, ISIN, or Entity ID &gt; **Note**: If this parameter is not used, &#x60;null&#x60; will be returned for the &#x60;requestId&#x60; field in the response. (optional)</param>
        ...
        TranscriptsIntelligenceResponse GetTranscriptsIntelligence(DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? startDateRelative = default(int?), int? endDateRelative = default(int?), List<string> ids = default(List<string>), List<string> categories = default(List<string>), string timeZone = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        ...
        ApiResponse<TranscriptsIntelligenceResponse> GetTranscriptsIntelligenceWithHttpInfo(DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? startDateRelative = default(int?), int? endDateRelative = default(int?), List<string> ids = default(List<string>), List<string> categories = default(List<string>), string timeZone = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.EventsandTranscripts.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="startDate">Start Date. Format is YYYY-MM-DD   **The API supports data from 1999 onwards. Ensure that the provided Date falls within this range for accurate results.** </param>
        ...
        InvestorSlidesResponse GetTranscriptsInvestorSlides(DateTime startDate, DateTime endDate, List<string> ids = default(List<string>), List<string> eventIds = default(List<string>), List<string> categories = default(List<string>), string searchText = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        ...
        ApiResponse<InvestorSlidesResponse> GetTranscriptsInvestorSlidesWithHttpInfo(DateTime startDate, DateTime endDate, List<string> ids = default(List<string>), List<string> eventIds = default(List<string>), List<string> categories = default(List<string>), string searchText = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        /// <summary>
    ...
    public interface ITranscriptsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<TranscriptsIntelligenceResponse>> GetTranscriptsIntelligenceWithHttpInfoAsync(DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? startDateRelative = default(int?), int? endDateRelative = default(int?), List<string> ids = default(List<string>), List<string> categories = default(List<string>), string timeZone = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns the investor slides in PDF format and related metadata within FactSet coverage based on specific date range and various parameters.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InvestorSlidesResponse> GetTranscriptsInvestorSlidesAsync(DateTime startDate, DateTime endDate, List<string> ids = default(List<string>), List<string> eventIds = default(List<string>), List<string> categories = default(List<string>), string searchText = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TranscriptsApi : ITranscriptsApi
    {
        ...
        /// <param name="paginationOffset">Specifies the starting point for pagination. This parameter is used to identify the beginning of the next set of results. (optional, default to 0)</param>
        /// <returns>TranscriptsIntelligenceResponse</returns>
        public TranscriptsIntelligenceResponse GetTranscriptsIntelligence(DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? startDateRelative = default(int?), int? endDateRelative = default(int?), List<string> ids = default(List<string>), List<string> categories = default(List<string>), string timeZone = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
            var localVarResponse = GetTranscriptsIntelligenceWithHttpInfo(startDate, endDate, startDateRelative, endDateRelative, ids, categories, timeZone, sort, paginationLimit, paginationOffset);
        ...
        /// <param name="paginationOffset">Specifies the starting point for pagination. This parameter is used to identify the beginning of the next set of results. (optional, default to 0)</param>
        /// <returns>ApiResponse of TranscriptsIntelligenceResponse</returns>
        public ApiResponse<TranscriptsIntelligenceResponse> GetTranscriptsIntelligenceWithHttpInfo(DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? startDateRelative = default(int?), int? endDateRelative = default(int?), List<string> ids = default(List<string>), List<string> categories = default(List<string>), string timeZone = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
        ...
        {
            var localVarResponse = await GetTranscriptsIntelligenceWithHttpInfoAsync(startDate, endDate, startDateRelative, endDateRelative, ids, categories, timeZone, sort, paginationLimit, paginationOffset, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<TranscriptsIntelligenceResponse>> GetTranscriptsIntelligenceWithHttpInfoAsync(DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? startDateRelative = default(int?), int? endDateRelative = default(int?), List<string> ids = default(List<string>), List<string> categories = default(List<string>), string timeZone = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="paginationOffset">Specifies the starting point for pagination. This parameter is used to identify the beginning of the next set of results. (optional, default to 0)</param>
        /// <returns>InvestorSlidesResponse</returns>
        public InvestorSlidesResponse GetTranscriptsInvestorSlides(DateTime startDate, DateTime endDate, List<string> ids = default(List<string>), List<string> eventIds = default(List<string>), List<string> categories = default(List<string>), string searchText = default(string), List<string> sort = default(List<string>), int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
