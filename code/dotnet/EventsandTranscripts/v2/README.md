...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.1-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/2.0.1)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 2.0.1
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 2.0.1
```
