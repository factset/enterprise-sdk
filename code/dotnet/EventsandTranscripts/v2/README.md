...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.4-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/2.1.4)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 2.1.4
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 2.1.4
```
