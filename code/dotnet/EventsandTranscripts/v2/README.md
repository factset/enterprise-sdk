...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.2-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/2.1.2)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 2.1.2
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 2.1.2
```
