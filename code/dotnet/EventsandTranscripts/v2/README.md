...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/2.1.0)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 2.1.0
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 2.1.0
```
