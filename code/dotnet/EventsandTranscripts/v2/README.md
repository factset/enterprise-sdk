...
[![Nuget](https://img.shields.io/badge/nuget-v3.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.EventsandTranscripts/3.0.0)
...
dotnet add package FactSet.SDK.EventsandTranscripts -v 3.0.0
```
...
nuget install FactSet.SDK.EventsandTranscripts -Version 3.0.0
```
...
## Documentation for Models
 ...
 - [Model.TranscriptsResult](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/EventsandTranscripts/v2/docs/TranscriptsResult.md)
