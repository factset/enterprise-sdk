...
[![Nuget](https://img.shields.io/badge/nuget-v0.21.10-orange)](https://www.nuget.org/packages/FactSet.SDK.FixedIncomeAnalyticsBatcher/0.21.10)
...
dotnet add package FactSet.SDK.FixedIncomeAnalyticsBatcher -v 0.21.10
```
...
nuget install FactSet.SDK.FixedIncomeAnalyticsBatcher -Version 0.21.10
```
