...
namespace FactSet.SDK.FactSetTrading.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EMSCreateChildOrdersResponse")]
    public partial class EMSCreateChildOrdersResponse : IEquatable<EMSCreateChildOrdersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMSCreateChildOrdersResponse" /> class.
        /// </summary>
        ...
        public EMSCreateChildOrdersResponse(Dictionary<string, EMSCreateChildOrderInfo> accepted = default(Dictionary<string, EMSCreateChildOrderInfo>), Dictionary<string, EMSCreateChildOrderRejectedInfo> rejected = default(Dictionary<string, EMSCreateChildOrderRejectedInfo>))
        {
        ...
        public Dictionary<string, EMSCreateChildOrderInfo> Accepted { get; set; }
        ...
        public Dictionary<string, EMSCreateChildOrderRejectedInfo> Rejected { get; set; }
        ...
        {
            return this.Equals(input as EMSCreateChildOrdersResponse);
        }

        /// <summary>
        /// Returns true if EMSCreateChildOrdersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EMSCreateChildOrdersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EMSCreateChildOrdersResponse input)
        {
            if (input == null)
            {
                return false;
