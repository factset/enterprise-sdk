...
namespace FactSet.SDK.FactSetTrading.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EMSChildOrdersResponse")]
    public partial class EMSChildOrdersResponse : IEquatable<EMSChildOrdersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMSChildOrdersResponse" /> class.
        /// </summary>
        ...
        public EMSChildOrdersResponse(Dictionary<string, EMSChildOrderInfo> accepted = default(Dictionary<string, EMSChildOrderInfo>), Dictionary<string, EMSChildOrderRejectedInfo> rejected = default(Dictionary<string, EMSChildOrderRejectedInfo>))
        {
        ...
        public Dictionary<string, EMSChildOrderInfo> Accepted { get; set; }
        ...
        public Dictionary<string, EMSChildOrderRejectedInfo> Rejected { get; set; }
        ...
        {
            return this.Equals(input as EMSChildOrdersResponse);
        }

        /// <summary>
        /// Returns true if EMSChildOrdersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EMSChildOrdersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EMSChildOrdersResponse input)
        {
            if (input == null)
            {
                return false;
