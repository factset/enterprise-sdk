...
namespace FactSet.SDK.FactSetTrading.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChildOrderInfo")]
    public partial class CreateChildOrderInfo : IEquatable<CreateChildOrderInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildOrderInfo" /> class.
        /// </summary>
        ...
        public CreateChildOrderInfo(string basketId = default(string), string ticketId = default(string), string symbol = default(string))
        {
        ...
        {
            return this.Equals(input as CreateChildOrderInfo);
        }

        /// <summary>
        /// Returns true if CreateChildOrderInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChildOrderInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChildOrderInfo input)
        {
            if (input == null)
            {
                return false;
