...
namespace FactSet.SDK.FactSetTrading.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChildOrderRejectInfo")]
    public partial class CreateChildOrderRejectInfo : IEquatable<CreateChildOrderRejectInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildOrderRejectInfo" /> class.
        /// </summary>
        ...
        public CreateChildOrderRejectInfo(string message = default(string), string basketId = default(string), string ticketId = default(string), string symbol = default(string))
        {
        ...
        {
            return this.Equals(input as CreateChildOrderRejectInfo);
        }

        /// <summary>
        /// Returns true if CreateChildOrderRejectInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChildOrderRejectInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChildOrderRejectInfo input)
        {
            if (input == null)
            {
                return false;
