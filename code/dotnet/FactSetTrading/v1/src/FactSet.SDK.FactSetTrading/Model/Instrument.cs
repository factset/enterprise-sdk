...
namespace FactSet.SDK.FactSetTrading.Model
{
    ...
    public partial class Instrument : IEquatable<Instrument>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.Symbol != null && this.Symbol.Length > 250)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Symbol, length must be less than 250.", new [] { "Symbol" });
            }
