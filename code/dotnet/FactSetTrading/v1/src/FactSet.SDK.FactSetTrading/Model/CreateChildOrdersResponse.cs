...
namespace FactSet.SDK.FactSetTrading.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChildOrdersResponse")]
    public partial class CreateChildOrdersResponse : IEquatable<CreateChildOrdersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildOrdersResponse" /> class.
        /// </summary>
        ...
        public CreateChildOrdersResponse(Dictionary<string, CreateChildOrderInfo> accepted = default(Dictionary<string, CreateChildOrderInfo>), Dictionary<string, CreateChildOrderRejectInfo> rejected = default(Dictionary<string, CreateChildOrderRejectInfo>))
        {
        ...
        public Dictionary<string, CreateChildOrderInfo> Accepted { get; set; }
        ...
        public Dictionary<string, CreateChildOrderRejectInfo> Rejected { get; set; }
        ...
        {
            return this.Equals(input as CreateChildOrdersResponse);
        }

        /// <summary>
        /// Returns true if CreateChildOrdersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChildOrdersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChildOrdersResponse input)
        {
            if (input == null)
            {
                return false;
