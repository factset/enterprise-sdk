...
namespace FactSet.SDK.IRNCustomSymbols.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCustomSymbolDto")]
    public partial class CreateCustomSymbolDto : IEquatable<CreateCustomSymbolDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCustomSymbolDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateCustomSymbolDto);
        }

        /// <summary>
        /// Returns true if CreateCustomSymbolDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCustomSymbolDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCustomSymbolDto input)
        {
            if (input == null)
            {
                return false;
