...
namespace FactSet.SDK.IRNCustomSymbols.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SymbolRelationshipSaveDto")]
    public partial class SymbolRelationshipSaveDto : IEquatable<SymbolRelationshipSaveDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolRelationshipSaveDto" /> class.
        /// </summary>
        ...
        public SymbolRelationshipSaveDto(Guid symbolsRelationshipId = default(Guid), string parentSymbol = default(string), string childSymbol = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string comment = default(string))
        {
        ...
        {
            return this.Equals(input as SymbolRelationshipSaveDto);
        }

        /// <summary>
        /// Returns true if SymbolRelationshipSaveDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolRelationshipSaveDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolRelationshipSaveDto input)
        {
            if (input == null)
            {
                return false;
