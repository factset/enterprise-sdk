...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_data_calculation")]
    public partial class InlineResponse2002DataCalculation : IEquatable<InlineResponse2002DataCalculation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002DataCalculation" /> class.
        /// </summary>
        /// <param name="time">Date and time of the calculation..</param>
        /// <param name="price">price.</param>
        public InlineResponse2002DataCalculation(string time = default(string), InlineResponse2002DataCalculationPrice price = default(InlineResponse2002DataCalculationPrice))
        {
            this.Time = time;
            this.Price = price;
        }
        ...
        /// </summary>
        /// <value>Date and time of the calculation.</value>
        ...
        public InlineResponse2002DataCalculationPrice Price { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2002DataCalculation);
        }

        /// <summary>
        /// Returns true if InlineResponse2002DataCalculation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002DataCalculation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002DataCalculation input)
        {
            if (input == null)
            {
                return false;
