...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_lifeCycle_issue")]
    public partial class DebtInstrumentNotationScreenerSearchDataLifeCycleIssue : IEquatable<DebtInstrumentNotationScreenerSearchDataLifeCycleIssue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataLifeCycleIssue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DebtInstrumentNotationScreenerSearchDataLifeCycleIssue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataLifeCycleIssue" /> class.
        /// </summary>
        ...
        public DebtInstrumentNotationScreenerSearchDataLifeCycleIssue(DateTime start = default(DateTime), DateTime end = default(DateTime))
        {
            this.Start = start;
            this.End = end;
        }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataLifeCycleIssue);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataLifeCycleIssue instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataLifeCycleIssue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataLifeCycleIssue input)
        {
            if (input == null)
            {
                return false;
