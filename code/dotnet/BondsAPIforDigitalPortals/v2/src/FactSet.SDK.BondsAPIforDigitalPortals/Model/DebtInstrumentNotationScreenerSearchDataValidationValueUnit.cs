...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_validation_valueUnit")]
    public partial class DebtInstrumentNotationScreenerSearchDataValidationValueUnit : IEquatable<DebtInstrumentNotationScreenerSearchDataValidationValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataValidationValueUnit" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public DebtInstrumentNotationScreenerSearchDataValidationValueUnit(DebtInstrumentNotationScreenerSearchDataValidationValueUnitRestrict restrict = default(DebtInstrumentNotationScreenerSearchDataValidationValueUnitRestrict), DebtInstrumentNotationScreenerSearchDataValidationValueUnitExclude exclude = default(DebtInstrumentNotationScreenerSearchDataValidationValueUnitExclude))
        {
        ...
        public DebtInstrumentNotationScreenerSearchDataValidationValueUnitRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public DebtInstrumentNotationScreenerSearchDataValidationValueUnitExclude Exclude { get; set; }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataValidationValueUnit);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataValidationValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataValidationValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataValidationValueUnit input)
        {
            if (input == null)
            {
                return false;
