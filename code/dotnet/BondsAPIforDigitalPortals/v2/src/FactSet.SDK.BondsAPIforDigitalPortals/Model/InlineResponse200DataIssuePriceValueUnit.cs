...
{
    /// <summary>
    /// Value unit of the issue price such as percentages for a debt instrument quoted in percent, or a main or a fractional currency for a per-unit-quoted debt instrument (rarely). See endpoint &#x60;/basic/valueUnit/list&#x60; for possible values.
    /// </summary>
    [DataContract(Name = "inline_response_200_data_issue_price_valueUnit")]
    public partial class InlineResponse200DataIssuePriceValueUnit : IEquatable<InlineResponse200DataIssuePriceValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataIssuePriceValueUnit" /> class.
        /// </summary>
        /// <param name="id">Identifier of the value unit..</param>
        /// <param name="code">Code of the value unit..</param>
        public InlineResponse200DataIssuePriceValueUnit(decimal id = default(decimal), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200DataIssuePriceValueUnit {\n");
        ...
        {
            return this.Equals(input as InlineResponse200DataIssuePriceValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataIssuePriceValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataIssuePriceValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataIssuePriceValueUnit input)
        {
            if (input == null)
            {
                return false;
