...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_coupon_currentInterestRate")]
    public partial class DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate : IEquatable<DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="value">value.</param>
        public DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType type = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType), DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValue value = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValue))
        {
            this.Type = type;
            this.Value = value;
        }
        ...
        public DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType Type { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = false)]
        public DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValue Value { get; set; }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRate input)
        {
            if (input == null)
            {
                return false;
