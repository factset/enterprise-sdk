...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_tradingVolume_otc_minimum")]
    public partial class DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum : IEquatable<DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum input)
        {
            if (input == null)
            {
                return false;
