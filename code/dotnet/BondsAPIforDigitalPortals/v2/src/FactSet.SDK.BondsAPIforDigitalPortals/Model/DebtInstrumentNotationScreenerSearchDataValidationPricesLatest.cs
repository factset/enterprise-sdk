...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_validation_prices_latest")]
    public partial class DebtInstrumentNotationScreenerSearchDataValidationPricesLatest : IEquatable<DebtInstrumentNotationScreenerSearchDataValidationPricesLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataValidationPricesLatest" /> class.
        /// </summary>
        ...
        public DebtInstrumentNotationScreenerSearchDataValidationPricesLatest(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataValidationPricesLatest);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataValidationPricesLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataValidationPricesLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataValidationPricesLatest input)
        {
            if (input == null)
                return false;
