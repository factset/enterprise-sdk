...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_redemption_currency")]
    public partial class InlineResponse200DataRedemptionCurrency : IEquatable<InlineResponse200DataRedemptionCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataRedemptionCurrency" /> class.
        /// </summary>
        ...
        public InlineResponse200DataRedemptionCurrency(decimal id = default(decimal), string code = default(string), string isoCode = default(string))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse200DataRedemptionCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataRedemptionCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataRedemptionCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataRedemptionCurrency input)
        {
            if (input == null)
            {
                return false;
