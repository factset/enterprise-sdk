...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_validation_market_selection_exclude")]
    public partial class DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude : IEquatable<DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude" /> class.
        /// </summary>
        /// <param name="ids">Set of market identifiers..</param>
        public DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataValidationMarketSelectionExclude input)
        {
            if (input == null)
            {
                return false;
