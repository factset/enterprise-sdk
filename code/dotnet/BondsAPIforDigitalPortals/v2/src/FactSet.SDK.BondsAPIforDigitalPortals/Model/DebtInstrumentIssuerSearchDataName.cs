...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// Issuer name.
    /// </summary>
    [DataContract(Name = "_debtInstrument_issuer_search_data_name")]
    public partial class DebtInstrumentIssuerSearchDataName : IEquatable<DebtInstrumentIssuerSearchDataName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentIssuerSearchDataName" /> class.
        /// </summary>
        /// <param name="searchValue">Text string to be searched for..</param>
        public DebtInstrumentIssuerSearchDataName(string searchValue = default(string))
        {
        ...
        {
            return this.Equals(input as DebtInstrumentIssuerSearchDataName);
        }

        /// <summary>
        /// Returns true if DebtInstrumentIssuerSearchDataName instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentIssuerSearchDataName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentIssuerSearchDataName input)
        {
            if (input == null)
            {
                return false;
