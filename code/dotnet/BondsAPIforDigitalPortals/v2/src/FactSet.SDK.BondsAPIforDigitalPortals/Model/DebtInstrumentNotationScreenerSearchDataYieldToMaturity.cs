...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_yield_toMaturity")]
    public partial class DebtInstrumentNotationScreenerSearchDataYieldToMaturity : IEquatable<DebtInstrumentNotationScreenerSearchDataYieldToMaturity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataYieldToMaturity" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public DebtInstrumentNotationScreenerSearchDataYieldToMaturity(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum minimum = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum), DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum maximum = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum))
        {
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataYieldToMaturity);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataYieldToMaturity instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataYieldToMaturity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataYieldToMaturity input)
        {
            if (input == null)
            {
                return false;
