...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_sensitivities_elasticity")]
    public partial class DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity : IEquatable<DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum minimum = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum), DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum maximum = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum))
        {
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataSensitivitiesElasticity input)
        {
            if (input == null)
            {
                return false;
