...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_validation_market")]
    public partial class DebtInstrumentNotationScreenerSearchDataValidationMarket : IEquatable<DebtInstrumentNotationScreenerSearchDataValidationMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataValidationMarket" /> class.
        /// </summary>
        /// <param name="selection">selection.</param>
        /// <param name="priority">priority.</param>
        public DebtInstrumentNotationScreenerSearchDataValidationMarket(DebtInstrumentNotationScreenerSearchDataValidationMarketSelection selection = default(DebtInstrumentNotationScreenerSearchDataValidationMarketSelection), DebtInstrumentNotationScreenerSearchDataValidationMarketPriority priority = default(DebtInstrumentNotationScreenerSearchDataValidationMarketPriority))
        {
        ...
        public DebtInstrumentNotationScreenerSearchDataValidationMarketSelection Selection { get; set; }

        /// <summary>
        /// Gets or Sets Priority
        /// </summary>
        [DataMember(Name = "priority", EmitDefaultValue = false)]
        public DebtInstrumentNotationScreenerSearchDataValidationMarketPriority Priority { get; set; }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataValidationMarket);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataValidationMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataValidationMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataValidationMarket input)
        {
            if (input == null)
            {
                return false;
