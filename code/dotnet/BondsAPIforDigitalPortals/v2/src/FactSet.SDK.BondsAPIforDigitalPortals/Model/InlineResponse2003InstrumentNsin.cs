...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_instrument_nsin")]
    public partial class InlineResponse2003InstrumentNsin : IEquatable<InlineResponse2003InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse2003InstrumentNsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        {
            return this.Equals(input as InlineResponse2003InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse2003InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003InstrumentNsin input)
        {
            if (input == null)
                return false;
