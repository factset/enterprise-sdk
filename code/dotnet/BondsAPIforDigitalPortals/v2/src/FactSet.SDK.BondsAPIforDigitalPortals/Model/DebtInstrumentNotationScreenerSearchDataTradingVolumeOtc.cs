...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_tradingVolume_otc")]
    public partial class DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc : IEquatable<DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        public DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc(DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum minimum = default(DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum))
        {
        ...
        public DebtInstrumentNotationScreenerSearchDataTradingVolumeOtcMinimum Minimum { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc {\n");
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataTradingVolumeOtc input)
        {
            if (input == null)
            {
                return false;
