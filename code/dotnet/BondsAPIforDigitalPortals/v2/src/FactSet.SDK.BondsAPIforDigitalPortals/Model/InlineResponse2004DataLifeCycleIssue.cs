...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_lifeCycle_issue")]
    public partial class InlineResponse2004DataLifeCycleIssue : IEquatable<InlineResponse2004DataLifeCycleIssue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataLifeCycleIssue" /> class.
        /// </summary>
        /// <param name="minimum">Minimum date..</param>
        /// <param name="maximum">Maximum date..</param>
        public InlineResponse2004DataLifeCycleIssue(DateTime minimum = default(DateTime), DateTime maximum = default(DateTime))
        {
        ...
        {
            return this.Equals(input as InlineResponse2004DataLifeCycleIssue);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataLifeCycleIssue instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataLifeCycleIssue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataLifeCycleIssue input)
        {
            if (input == null)
            {
                return false;
