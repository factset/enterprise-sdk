...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_instrument_categorization_level3")]
    public partial class InlineResponse2003InstrumentCategorizationLevel3 : IEquatable<InlineResponse2003InstrumentCategorizationLevel3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003InstrumentCategorizationLevel3" /> class.
        /// </summary>
        /// <param name="id">Identifier of the category..</param>
        /// <param name="name">Name of the category..</param>
        public InlineResponse2003InstrumentCategorizationLevel3(decimal id = default(decimal), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse2003InstrumentCategorizationLevel3);
        }

        /// <summary>
        /// Returns true if InlineResponse2003InstrumentCategorizationLevel3 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003InstrumentCategorizationLevel3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003InstrumentCategorizationLevel3 input)
        {
            if (input == null)
            {
                return false;
