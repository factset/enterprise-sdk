...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_coupon_currentInterestRate_value_maximum")]
    public partial class DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum : IEquatable<DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum" /> class.
        /// </summary>
        ...
        public DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum(decimal value = default(decimal), bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum input)
        {
            if (input == null)
            {
                return false;
