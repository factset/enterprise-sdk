...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_ratingSystem2")]
    public partial class InlineResponse2004DataRatingSystem2 : IEquatable<InlineResponse2004DataRatingSystem2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataRatingSystem2" /> class.
        /// </summary>
        /// <param name="rating">List of rating grades..</param>
        public InlineResponse2004DataRatingSystem2(List<InlineResponse2004DataRatingSystem1Rating> rating = default(List<InlineResponse2004DataRatingSystem1Rating>))
        {
            this.Rating = rating;
        }
        ...
        {
            return this.Equals(input as InlineResponse2004DataRatingSystem2);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataRatingSystem2 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataRatingSystem2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataRatingSystem2 input)
        {
            if (input == null)
            {
                return false;
