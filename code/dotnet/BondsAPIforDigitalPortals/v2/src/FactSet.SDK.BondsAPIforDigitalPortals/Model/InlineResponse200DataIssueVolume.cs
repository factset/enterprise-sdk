...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// Issue volume data.
    /// </summary>
    [DataContract(Name = "inline_response_200_data_issue_volume")]
    public partial class InlineResponse200DataIssueVolume : IEquatable<InlineResponse200DataIssueVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataIssueVolume" /> class.
        /// </summary>
        /// <param name="amount">Issue volume..</param>
        /// <param name="currency">currency.</param>
        public InlineResponse200DataIssueVolume(decimal amount = default(decimal), InlineResponse200DataIssueVolumeCurrency currency = default(InlineResponse200DataIssueVolumeCurrency))
        {
            this.Amount = amount;
        ...
        public InlineResponse200DataIssueVolumeCurrency Currency { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataIssueVolume);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataIssueVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataIssueVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataIssueVolume input)
        {
            if (input == null)
            {
                return false;
