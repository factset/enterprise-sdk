...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_instrument_fsym_security")]
    public partial class InlineResponse2003InstrumentFsymSecurity : IEquatable<InlineResponse2003InstrumentFsymSecurity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003InstrumentFsymSecurity" /> class.
        /// </summary>
        ...
        public InlineResponse2003InstrumentFsymSecurity(string permanentIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003InstrumentFsymSecurity);
        }

        /// <summary>
        /// Returns true if InlineResponse2003InstrumentFsymSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003InstrumentFsymSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003InstrumentFsymSecurity input)
        {
            if (input == null)
            {
                return false;
