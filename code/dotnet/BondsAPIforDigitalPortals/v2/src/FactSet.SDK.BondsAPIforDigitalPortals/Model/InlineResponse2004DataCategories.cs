...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_categories")]
    public partial class InlineResponse2004DataCategories : IEquatable<InlineResponse2004DataCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataCategories" /> class.
        /// </summary>
        /// <param name="id">Identifier of a category..</param>
        /// <param name="name">Name of the category..</param>
        /// <param name="parent">parent.</param>
        /// <param name="count">Number of notations..</param>
        public InlineResponse2004DataCategories(decimal id = default(decimal), string name = default(string), InlineResponse2004DataParent parent = default(InlineResponse2004DataParent), decimal count = default(decimal))
        {
            this.Id = id;
            this.Name = name;
            this.Parent = parent;
        ...
        public InlineResponse2004DataParent Parent { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2004DataCategories);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataCategories input)
        {
            if (input == null)
            {
                return false;
