...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_lifeCycle_maturity")]
    public partial class DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity : IEquatable<DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Defines whether or not perpetual debt instruments, i.e. such that do not mature, are included in the result. The value \&quot;only\&quot; can be used if both parameters &#x60;maturity.restriction.date&#x60; and &#x60;maturity.restriction.remainingTermYears&#x60; are not set.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity" /> class.
        /// </summary>
        /// <param name="restriction">restriction.</param>
        /// <param name="perpetual">Defines whether or not perpetual debt instruments, i.e. such that do not mature, are included in the result. The value \&quot;only\&quot; can be used if both parameters &#x60;maturity.restriction.date&#x60; and &#x60;maturity.restriction.remainingTermYears&#x60; are not set..</param>
        public DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity(DebtInstrumentNotationScreenerSearchDataLifeCycleMaturityRestriction restriction = default(DebtInstrumentNotationScreenerSearchDataLifeCycleMaturityRestriction), PerpetualEnum? perpetual = default(PerpetualEnum?))
        {
        ...
        public DebtInstrumentNotationScreenerSearchDataLifeCycleMaturityRestriction Restriction { get; set; }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataLifeCycleMaturity to be compared</param>
        /// <returns>Boolean</returns>
