...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_issuer_selection_exclude")]
    public partial class DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude : IEquatable<DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude" /> class.
        /// </summary>
        /// <param name="ids">Set of identifiers of legal entities in the role of an issuer..</param>
        public DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataIssuerSelectionExclude input)
        {
            if (input == null)
            {
                return false;
