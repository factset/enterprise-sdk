...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_instrument_coupon_occurrence")]
    public partial class InlineResponse2003InstrumentCouponOccurrence : IEquatable<InlineResponse2003InstrumentCouponOccurrence>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003InstrumentCouponOccurrence" /> class.
        /// </summary>
        /// <param name="type">Occurrence type of the coupon payments..</param>
        /// <param name="frequency">frequency.</param>
        public InlineResponse2003InstrumentCouponOccurrence(TypeEnum? type = default(TypeEnum?), InlineResponse2003InstrumentCouponOccurrenceFrequency frequency = default(InlineResponse2003InstrumentCouponOccurrenceFrequency))
        {
            this.Type = type;
        ...
        public InlineResponse2003InstrumentCouponOccurrenceFrequency Frequency { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2003InstrumentCouponOccurrence);
        }

        /// <summary>
        /// Returns true if InlineResponse2003InstrumentCouponOccurrence instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003InstrumentCouponOccurrence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003InstrumentCouponOccurrence input)
        {
            if (input == null)
            {
                return false;
