...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_yield_current")]
    public partial class DebtInstrumentNotationScreenerSearchDataYieldCurrent : IEquatable<DebtInstrumentNotationScreenerSearchDataYieldCurrent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataYieldCurrent" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public DebtInstrumentNotationScreenerSearchDataYieldCurrent(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum minimum = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMinimum), DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum maximum = default(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateValueMaximum))
        {
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataYieldCurrent);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataYieldCurrent instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataYieldCurrent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataYieldCurrent input)
        {
            if (input == null)
            {
                return false;
