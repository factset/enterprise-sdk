...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_coupon_currentInterestRate_type")]
    public partial class DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType : IEquatable<DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType" /> class.
        /// </summary>
        /// <param name="ids">List of interest rate type identifiers. See endpoint &#x60;/instrument/coupon/interestRate/type/list&#x60; for valid values..</param>
        public DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        /// </summary>
        /// <value>List of interest rate type identifiers. See endpoint &#x60;/instrument/coupon/interestRate/type/list&#x60; for valid values.</value>
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataCouponCurrentInterestRateType input)
        {
            if (input == null)
            {
                return false;
