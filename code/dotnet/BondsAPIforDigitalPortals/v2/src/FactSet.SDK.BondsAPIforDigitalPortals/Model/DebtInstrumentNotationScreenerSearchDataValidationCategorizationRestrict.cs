...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_validation_categorization_restrict")]
    public partial class DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict : IEquatable<DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict" /> class.
        /// </summary>
        /// <param name="ids">Set of category identifiers..</param>
        public DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict {\n");
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataValidationCategorizationRestrict input)
        {
            if (input == null)
            {
                return false;
