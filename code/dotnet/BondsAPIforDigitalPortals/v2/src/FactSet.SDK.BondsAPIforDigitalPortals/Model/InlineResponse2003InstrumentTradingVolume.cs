...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_instrument_tradingVolume")]
    public partial class InlineResponse2003InstrumentTradingVolume : IEquatable<InlineResponse2003InstrumentTradingVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003InstrumentTradingVolume" /> class.
        /// </summary>
        /// <param name="otc">otc.</param>
        public InlineResponse2003InstrumentTradingVolume(InlineResponse2003InstrumentTradingVolumeOtc otc = default(InlineResponse2003InstrumentTradingVolumeOtc))
        {
            this.Otc = otc;
        }
        ...
        public InlineResponse2003InstrumentTradingVolumeOtc Otc { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2003InstrumentTradingVolume);
        }

        /// <summary>
        /// Returns true if InlineResponse2003InstrumentTradingVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003InstrumentTradingVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003InstrumentTradingVolume input)
        {
            if (input == null)
            {
                return false;
