...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_issuer_country_exclude")]
    public partial class DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude : IEquatable<DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude" /> class.
        /// </summary>
        /// <param name="ids">Set of country identifiers..</param>
        public DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataIssuerCountryExclude input)
        {
            if (input == null)
            {
                return false;
