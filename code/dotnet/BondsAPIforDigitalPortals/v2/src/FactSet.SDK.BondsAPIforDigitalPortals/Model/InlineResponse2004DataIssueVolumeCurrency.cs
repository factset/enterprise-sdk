...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_issue_volume_currency")]
    public partial class InlineResponse2004DataIssueVolumeCurrency : IEquatable<InlineResponse2004DataIssueVolumeCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataIssueVolumeCurrency" /> class.
        /// </summary>
        ...
        public InlineResponse2004DataIssueVolumeCurrency(decimal id = default(decimal), string isoCode = default(string), decimal count = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as InlineResponse2004DataIssueVolumeCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataIssueVolumeCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataIssueVolumeCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataIssueVolumeCurrency input)
        {
            if (input == null)
            {
                return false;
