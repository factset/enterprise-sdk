...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// Issue price data.
    /// </summary>
    [DataContract(Name = "inline_response_200_data_issue_price")]
    public partial class InlineResponse200DataIssuePrice : IEquatable<InlineResponse200DataIssuePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataIssuePrice" /> class.
        /// </summary>
        /// <param name="value">Issue price..</param>
        /// <param name="valueUnit">valueUnit.</param>
        public InlineResponse200DataIssuePrice(decimal value = default(decimal), InlineResponse200DataIssuePriceValueUnit valueUnit = default(InlineResponse200DataIssuePriceValueUnit))
        {
            this.Value = value;
        ...
        public InlineResponse200DataIssuePriceValueUnit ValueUnit { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataIssuePrice);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataIssuePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataIssuePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataIssuePrice input)
        {
            if (input == null)
            {
                return false;
