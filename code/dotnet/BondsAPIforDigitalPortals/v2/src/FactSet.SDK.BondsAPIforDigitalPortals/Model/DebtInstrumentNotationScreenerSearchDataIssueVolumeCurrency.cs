...
namespace FactSet.SDK.BondsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_debtInstrument_notation_screener_search_data_issue_volume_currency")]
    public partial class DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency : IEquatable<DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency(DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrencyRestrict restrict = default(DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrencyRestrict), DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrencyExclude exclude = default(DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrencyExclude))
        {
        ...
        public DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrencyRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrencyExclude Exclude { get; set; }
        ...
        {
            return this.Equals(input as DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency);
        }

        /// <summary>
        /// Returns true if DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtInstrumentNotationScreenerSearchDataIssueVolumeCurrency input)
        {
            if (input == null)
            {
                return false;
