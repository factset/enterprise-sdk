...
namespace FactSet.SDK.AxiomaEquityOptimizer.Api
{
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectoriesRoot</returns>
        public ApiResponse<DocumentDirectoriesRoot> GetAxiomaEquityStrategyDocumentsWithHttpInfo(string path)
        {
            ...
            DocumentDirectoriesRoot>("/analytics/engines/axp/v3/strategies/{path}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DocumentDirectoriesRoot>> GetAxiomaEquityStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
