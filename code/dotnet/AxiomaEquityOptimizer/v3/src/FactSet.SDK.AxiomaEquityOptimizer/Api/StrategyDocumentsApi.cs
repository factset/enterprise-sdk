...
namespace FactSet.SDK.AxiomaEquityOptimizer.Api
{
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        {
            FactSet.SDK.AxiomaEquityOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = GetAxiomaEquityStrategyDocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectoriesRoot</returns>
        public FactSet.SDK.AxiomaEquityOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> GetAxiomaEquityStrategyDocumentsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.AxiomaEquityOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = await GetAxiomaEquityStrategyDocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DocumentDirectoriesRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.AxiomaEquityOptimizer.Client.ApiResponse<DocumentDirectoriesRoot>> GetAxiomaEquityStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.AxiomaEquityOptimizer.Client.ApiException(400, "Missing required parameter 'path' when calling StrategyDocumentsApi->GetAxiomaEquityStrategyDocuments");
