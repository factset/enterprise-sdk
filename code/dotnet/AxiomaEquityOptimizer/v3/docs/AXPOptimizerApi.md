# FactSet.SDK.AxiomaEquityOptimizer.Api.AXPOptimizerApi
...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling AXPOptimizerApi.GetOptimizationParameters: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling AXPOptimizerApi.GetOptimizationResult: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling AXPOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling AXPOptimizerApi.PostAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling AXPOptimizerApi.PutAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
