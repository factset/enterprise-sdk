...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AXPOptimizerApi.GetOptimizationParameters: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AXPOptimizerApi.GetOptimizationResult: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AXPOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AXPOptimizerApi.PostAndOptimize: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AXPOptimizerApi.PutAndOptimize: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
