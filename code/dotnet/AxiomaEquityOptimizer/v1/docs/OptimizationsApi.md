# FactSet.SDK.AxiomaEquityOptimizer.Api.OptimizationsApi
...
namespace Example
{
    public class GetAxiomaOptimizationByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling OptimizationsApi.GetAxiomaOptimizationById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RunAxiomaOptimizationExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling OptimizationsApi.RunAxiomaOptimization: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
