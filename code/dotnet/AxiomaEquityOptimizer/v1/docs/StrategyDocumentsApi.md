# FactSet.SDK.AxiomaEquityOptimizer.Api.StrategyDocumentsApi
...
namespace Example
{
    public class GetAxiomaEquityStrategyDocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling StrategyDocumentsApi.GetAxiomaEquityStrategyDocuments: " + e.Message );
