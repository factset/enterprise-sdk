# FactSet.SDK.AxiomaEquityOptimizer - the C# library for the Engines API
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling OptimizationsApi.CancelAxiomaOptimizationById: " + e.Message );
