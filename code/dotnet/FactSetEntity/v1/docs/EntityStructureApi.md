...
namespace Example
{
    public class GetEntityStructureExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EntityStructureApi.GetEntityStructure: " + e.Message );
...
namespace Example
{
    public class GetUltimateEntityStructureExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EntityStructureApi.GetUltimateEntityStructure: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostEntityStructureExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EntityStructureApi.PostEntityStructure: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostUltimateEntityStructureExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EntityStructureApi.PostUltimateEntityStructure: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
