...
[![Nuget](https://img.shields.io/badge/nuget-v1.3.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEntity/1.3.0)
...
dotnet add package FactSet.SDK.FactSetEntity -v 1.3.0
```
...
nuget install FactSet.SDK.FactSetEntity -Version 1.3.0
```
