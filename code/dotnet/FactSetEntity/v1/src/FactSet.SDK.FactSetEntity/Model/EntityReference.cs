...
namespace FactSet.SDK.FactSetEntity.Model
{
    ...
    public partial class EntityReference : IEquatable<EntityReference>, IValidatableObject
    {
        ...
        /// <param name="countryOfRiskGeoRev">Entity&#39;s Country of Risk based on the Top Geograghic Revenue. .</param>
        ...
        /// </summary>
        /// <value>Entity&#39;s Country of Risk based on the Top Geograghic Revenue. </value>
        [DataMember(Name = "countryOfRiskGeoRev", EmitDefaultValue = true)]
        public string CountryOfRiskGeoRev { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CountryOfRiskGeoRev: ").Append(CountryOfRiskGeoRev).Append("\n");
        ...
        public bool Equals(EntityReference input)
        {
            ...
            return 
                ...
                (
                    this.CountryOfRiskGeoRev == input.CountryOfRiskGeoRev ||
                    (this.CountryOfRiskGeoRev != null &&
                    this.CountryOfRiskGeoRev.Equals(input.CountryOfRiskGeoRev))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CountryOfRiskGeoRev != null)
                {
                    hashCode = (hashCode * 59) + this.CountryOfRiskGeoRev.GetHashCode();
                }
