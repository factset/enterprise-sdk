...
namespace FactSet.SDK.FactSetEntity.Model
{
    ...
    /// </summary>
    [DataContract(Name = "creditParentResponse")]
    public partial class CreditParentResponse : IEquatable<CreditParentResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditParentResponse" /> class.
        /// </summary>
        /// <param name="data">Array of Credit Parent objects..</param>
        public CreditParentResponse(List<CreditParent> data = default(List<CreditParent>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Array of Credit Parent objects.</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<CreditParent> Data { get; set; }
        ...
        {
            return this.Equals(input as CreditParentResponse);
        }

        /// <summary>
        /// Returns true if CreditParentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditParentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditParentResponse input)
        {
            if (input == null)
            {
                return false;
