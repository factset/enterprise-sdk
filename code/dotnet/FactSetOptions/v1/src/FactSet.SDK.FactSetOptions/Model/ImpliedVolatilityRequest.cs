...
namespace FactSet.SDK.FactSetOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "impliedVolatilityRequest")]
    public partial class ImpliedVolatilityRequest : IEquatable<ImpliedVolatilityRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImpliedVolatilityRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImpliedVolatilityRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImpliedVolatilityRequest" /> class.
        /// </summary>
        ...
        public ImpliedVolatilityRequest(List<string> ids = default(List<string>), string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), PriceType priceType = default(PriceType))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for ImpliedVolatilityRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as ImpliedVolatilityRequest);
        }

        /// <summary>
        /// Returns true if ImpliedVolatilityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ImpliedVolatilityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImpliedVolatilityRequest input)
        {
            if (input == null)
            {
                return false;
