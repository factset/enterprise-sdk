...
namespace FactSet.SDK.FactSetOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optionsVolumeRequest")]
    public partial class OptionsVolumeRequest : IEquatable<OptionsVolumeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsVolumeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptionsVolumeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsVolumeRequest" /> class.
        /// </summary>
        ...
        public OptionsVolumeRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Exchange exchange = default(Exchange), Calendar calendar = default(Calendar))
        {
            ...
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for OptionsVolumeRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as OptionsVolumeRequest);
        }

        /// <summary>
        /// Returns true if OptionsVolumeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionsVolumeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionsVolumeRequest input)
        {
            if (input == null)
            {
                return false;
