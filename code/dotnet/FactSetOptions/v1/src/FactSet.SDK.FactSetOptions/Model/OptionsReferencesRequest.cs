...
namespace FactSet.SDK.FactSetOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optionsReferencesRequest")]
    public partial class OptionsReferencesRequest : IEquatable<OptionsReferencesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsReferencesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptionsReferencesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsReferencesRequest" /> class.
        /// </summary>
        ...
        public OptionsReferencesRequest(List<string> ids = default(List<string>))
        {
            ...
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for OptionsReferencesRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OptionsReferencesRequest {\n");
        ...
        {
            return this.Equals(input as OptionsReferencesRequest);
        }

        /// <summary>
        /// Returns true if OptionsReferencesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionsReferencesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionsReferencesRequest input)
        {
            if (input == null)
            {
                return false;
