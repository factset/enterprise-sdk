...
namespace FactSet.SDK.FactSetOptions.Model
{
    ...
    public partial class UnderlyingVolumeRequest : IEquatable<UnderlyingVolumeRequest>, IValidatableObject
    {
        ...
        public UnderlyingVolumeRequest(List<string> ids = default(List<string>), string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Exchange exchange = default(Exchange))
        {
