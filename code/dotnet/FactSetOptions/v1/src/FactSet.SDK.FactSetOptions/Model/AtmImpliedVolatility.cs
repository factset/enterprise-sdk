...
namespace FactSet.SDK.FactSetOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "atmImpliedVolatility")]
    public partial class AtmImpliedVolatility : IEquatable<AtmImpliedVolatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AtmImpliedVolatility" /> class.
        /// </summary>
        /// <param name="aTMImplVol">Option at the money implied volatility..</param>
        /// <param name="aTMImplVolMarket">Option at the money implied volatility market..</param>
        /// <param name="callATMImplVol">Call option at the money implied volatility..</param>
        /// <param name="callATMImplVolMarket">Call option at the money implied volatility market..</param>
        /// <param name="date">The date of the data represented in YYYY-MM-DD format.</param>
        ...
        /// <param name="fsymId">FactSet&#39;s Security Permanent Identifier in XXXXXX-S format..</param>
        /// <param name="period">The period of the At-the-money volatility at current, 1, 2, 3, 4, and 6 month periods..</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ATMImplVol: ").Append(ATMImplVol).Append("\n");
            sb.Append("  ATMImplVolMarket: ").Append(ATMImplVolMarket).Append("\n");
            sb.Append("  CallATMImplVol: ").Append(CallATMImplVol).Append("\n");
            sb.Append("  CallATMImplVolMarket: ").Append(CallATMImplVolMarket).Append("\n");
            sb.Append("  Date: ").Append(Date).Append("\n");
            sb.Append("  Exchange: ").Append(Exchange).Append("\n");
            sb.Append("  FsymId: ").Append(FsymId).Append("\n");
            sb.Append("  Period: ").Append(Period).Append("\n");
            sb.Append("  PutATMImplVol: ").Append(PutATMImplVol).Append("\n");
            sb.Append("  PutATMImplVolMarket: ").Append(PutATMImplVolMarket).Append("\n");
        ...
        {
            return this.Equals(input as AtmImpliedVolatility);
        }

        /// <summary>
        /// Returns true if AtmImpliedVolatility instances are equal
        /// </summary>
        /// <param name="input">Instance of AtmImpliedVolatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AtmImpliedVolatility input)
        {
            if (input == null)
            {
                return false;
