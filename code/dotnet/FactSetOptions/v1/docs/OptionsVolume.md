# FactSet.SDK.FactSetOptions.Model.OptionsVolume
...
**Date** | **DateTime** | The date of the data in YYYY-MM-DD format | [optional] 
...
**OpenInterest** | **decimal** | The total number of options and/or futures contracts that are not closed or delivered on a particular day. | [optional] 
