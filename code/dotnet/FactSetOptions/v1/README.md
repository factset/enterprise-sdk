...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.10-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetOptions/1.0.10)
...
dotnet add package FactSet.SDK.FactSetOptions -v 1.0.10
```
...
nuget install FactSet.SDK.FactSetOptions -Version 1.0.10
```
