...
namespace FactSet.SDK.VectorData.Model
{
    ...
    public partial class VectorDataResult : IEquatable<VectorDataResult>, IValidatableObject
    {
        ...
        public VectorDataResult(List<string> vector = default(List<string>), string vectorId = default(string), decimal similarityScore = default(decimal), DateTime storyDate = default(DateTime), string themes = default(string), string documentType = default(string), string source = default(string), string documentID = default(string), string property = default(string), string type = default(string), List<string> ids = default(List<string>))
        {
            this.Vector = vector;
