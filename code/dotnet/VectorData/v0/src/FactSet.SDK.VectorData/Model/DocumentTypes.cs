...
namespace FactSet.SDK.VectorData.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DocumentTypes")]
    public partial class DocumentTypes : IEquatable<DocumentTypes>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="DocumentTypes" /> class.
        /// </summary>
        /// <param name="documentType">type of the document (required).</param>
        /// <param name="description">document type description (required).</param>
        public DocumentTypes(string documentType, string description)
        {
            // to ensure "documentType" is required (not null)
            if (documentType == null) {
                throw new ArgumentNullException("documentType is a required property for DocumentTypes and cannot be null");
            }
            this.DocumentType = documentType;
            // to ensure "description" is required (not null)
            if (description == null) {
                throw new ArgumentNullException("description is a required property for DocumentTypes and cannot be null");
            }
