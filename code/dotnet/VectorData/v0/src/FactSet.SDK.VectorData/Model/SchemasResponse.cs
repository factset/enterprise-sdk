...
namespace FactSet.SDK.VectorData.Model
{
    ...
    public partial class SchemasResponse : IEquatable<SchemasResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemasResponse" /> class.
        /// </summary>
        /// <param name="data">List of available schemas..</param>
        public SchemasResponse(List<Schemas> data = default(List<Schemas>))
        {
            this.Data = data;
        }
        ...
        public List<Schemas> Data { get; set; }
        ...
        {
            return this.Equals(input as SchemasResponse);
        }

        /// <summary>
        /// Returns true if SchemasResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SchemasResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemasResponse input)
        {
            if (input == null)
            {
                return false;
