...
namespace FactSet.SDK.VectorData.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/VectorData/0.20.0";
            BasePath = "https://api.factset.com/content/vector/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/content/vector/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.VectorData) Debug Report:\n";
