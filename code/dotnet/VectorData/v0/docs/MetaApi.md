# FactSet.SDK.VectorData.Api.MetaApi

All URIs are relative to *https://api.factset.com/content/vector/v0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GetDocumentTypes**](MetaApi.md#getdocumenttypes) | **GET** /meta/document-types | Returns the document types.
[**GetSources**](MetaApi.md#getsources) | **GET** /meta/sources | Returns the sources.
[**GetThemes**](MetaApi.md#getthemes) | **GET** /meta/themes | Returns the themes.
...
namespace Example
{
    public class GetSourcesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling MetaApi.GetSources: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetThemesExample
    {
        public static async Task Main()
        {
            ...
            {
                // Returns the themes.
                ThemesResponse result = apiInstance.GetThemes();
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling MetaApi.GetThemes: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getschemas"></a>
# **Getschemas**
> SchemasResponse Getschemas (List<string> sources = null)
...
namespace Example
{
    public class GetschemasExample
    {
        public static async Task Main()
        {
            ...
            var sources = new List<string>(); // List<string> | Code for document source to include.  This is a comma-separated list. Use the `/meta/sources` endpoint to get the list of available sources. (optional) 

            try
            {
                // Returns the schemas.
                SchemasResponse result = apiInstance.Getschemas(sources);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling MetaApi.Getschemas: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
------------- | ------------- | ------------- | -------------
 **sources** | [**List&lt;string&gt;**](string.md)| Code for document source to include.  This is a comma-separated list. Use the &#x60;/meta/sources&#x60; endpoint to get the list of available sources. | [optional] 
