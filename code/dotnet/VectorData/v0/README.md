...
[![Nuget](https://img.shields.io/badge/nuget-v0.0.4-orange)](https://www.nuget.org/packages/FactSet.SDK.VectorData/0.0.4)
...
dotnet add package FactSet.SDK.VectorData -v 0.0.4
```
...
nuget install FactSet.SDK.VectorData -Version 0.0.4
```
