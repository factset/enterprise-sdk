...
namespace FactSet.SDK.EventsContribution.Model
{
    ...
    public partial class EventData : IEquatable<EventData>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="EventData" /> class.
        /// </summary>
        /// <param name="eventId">ID that corresponds to the event. This ID is vendor generated and should be unique in each vendor&#39;s content set. (required).</param>
        ...
        public EventData(string eventId, string title, DateTime startDatetime, List<SymbolData> symbols,string agendaUrl = default(string), List<ParticipantsData> participants = default(List<ParticipantsData>), LocationData location = default(LocationData), RegistrationInfoData registrationInfo = default(RegistrationInfoData))
        {
            // to ensure "eventId" is required (not null)
            if (eventId == null) {
                throw new ArgumentNullException("eventId is a required property for EventData and cannot be null");
            }
            ...
            if (symbols == null) {
                throw new ArgumentNullException("symbols is a required property for EventData and cannot be null");
            }
        ...
        /// </summary>
        /// <value>ID that corresponds to the event. This ID is vendor generated and should be unique in each vendor&#39;s content set.</value>
