...
namespace FactSet.SDK.EventsContribution.Model
{
    ...
    /// </summary>
    [DataContract(Name = "insertRequest")]
    public partial class InsertRequest : IEquatable<InsertRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertRequest" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public InsertRequest(InsertRequestData data = default(InsertRequestData))
        {
            this.Data = data;
        }
        ...
        public InsertRequestData Data { get; set; }
        ...
        {
            return this.Equals(input as InsertRequest);
        }

        /// <summary>
        /// Returns true if InsertRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertRequest input)
        {
            if (input == null)
            {
                return false;
