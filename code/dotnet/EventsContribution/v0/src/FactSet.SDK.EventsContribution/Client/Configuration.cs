...
namespace FactSet.SDK.EventsContribution.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/EventsContribution/0.20.1";
            BasePath = "https://api.factset.com/events-contribution/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/events-contribution/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.EventsContribution) Debug Report:\n";
