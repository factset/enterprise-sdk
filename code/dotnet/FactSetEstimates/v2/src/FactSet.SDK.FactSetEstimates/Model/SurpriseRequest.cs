...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class SurpriseRequest : IEquatable<SurpriseRequest>, IValidatableObject
    {
        ...
        public SurpriseRequest(List<string> ids, List<string> metrics,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), Frequency frequency = default(Frequency), PeriodicitySurprise periodicity = default(PeriodicitySurprise), string currency = default(string), Statistic statistic = default(Statistic))
        {
