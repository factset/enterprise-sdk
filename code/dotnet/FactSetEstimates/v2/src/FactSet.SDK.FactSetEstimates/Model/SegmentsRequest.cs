...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class SegmentsRequest : IEquatable<SegmentsRequest>, IValidatableObject
    {
        ...
        public SegmentsRequest(List<string> ids, List<string> metrics,string startDate = default(string), string endDate = default(string), int relativeFiscalStart = default(int), int relativeFiscalEnd = default(int), Periodicity periodicity = default(Periodicity), Frequency frequency = default(Frequency), SegmentType segmentType = default(SegmentType), string currency = default(string))
        {
