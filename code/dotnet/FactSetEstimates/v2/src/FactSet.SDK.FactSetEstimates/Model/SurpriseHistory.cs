...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    /// SurpriseHistory
    /// </summary>
    [DataContract(Name = "SurpriseHistory")]
    public partial class SurpriseHistory : IEquatable<SurpriseHistory>, IValidatableObject
    {
        /// <summary>
        ...
        public SurpriseHistory(DateTime? endDate = default(DateTime?), string currency = default(string), double? high = default(double?), double? low = default(double?), int? up = default(int?), int? down = default(int?), int? analystCount = default(int?), double? mean = default(double?), double? median = default(double?), double? standardDeviation = default(double?), double? actual = default(double?), double? surprisePercent = default(double?))
        {
        ...
        {
            return this.Equals(input as SurpriseHistory);
        }

        /// <summary>
        /// Returns true if SurpriseHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of SurpriseHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SurpriseHistory input)
        {
            if (input == null)
            {
                return false;
