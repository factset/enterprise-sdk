...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class DetailEstimate : IEquatable<DetailEstimate>, IValidatableObject
    {
        ...
        /// <param name="docId">A unique identifier for the document report associated with a broker’s analyst estimate. Use this docId to retrieve the corresponding investment report through FactSet’s Investment Research API..</param>
        ...
        /// </summary>
        /// <value>A unique identifier for the document report associated with a broker’s analyst estimate. Use this docId to retrieve the corresponding investment report through FactSet’s Investment Research API.</value>
