...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class Guidance : IEquatable<Guidance>, IValidatableObject
    {
        ...
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime? InputDateHigh { get; set; }
        ...
        public bool Equals(Guidance input)
        {
            ...
            return 
                ...
                (
                    this.InputDateHigh == input.InputDateHigh ||
                    (this.InputDateHigh != null &&
                    this.InputDateHigh.Equals(input.InputDateHigh))
                ) && 
                (
                    this.InputDateLow == input.InputDateLow ||
                    (this.InputDateLow != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InputDateHigh != null)
                {
                    hashCode = (hashCode * 59) + this.InputDateHigh.GetHashCode();
                }
                if (this.InputDateLow != null)
                {
