...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class FixedConsensusRequest : IEquatable<FixedConsensusRequest>, IValidatableObject
    {
        ...
        public FixedConsensusRequest(List<string> ids, List<string> metrics,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), Frequency frequency = default(Frequency), string fiscalPeriodStart = default(string), string fiscalPeriodEnd = default(string), Periodicity periodicity = default(Periodicity), string currency = default(string))
        {
