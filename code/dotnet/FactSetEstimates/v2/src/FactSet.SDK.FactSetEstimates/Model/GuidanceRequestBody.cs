...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class GuidanceRequestBody : IEquatable<GuidanceRequestBody>, IValidatableObject
    {
        ...
        public GuidanceRequestBody(List<string> ids, List<string> metrics,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), Periodicity periodicity = default(Periodicity), Frequency frequency = default(Frequency), int relativeFiscalStart = default(int), int relativeFiscalEnd = default(int), string currency = default(string))
        {
