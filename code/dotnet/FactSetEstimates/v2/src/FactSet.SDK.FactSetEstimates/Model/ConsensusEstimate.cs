...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class ConsensusEstimate : IEquatable<ConsensusEstimate>, IValidatableObject
    {
        ...
        /// <param name="currency">Currency used estimates in consensus calculations. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470)..</param>
        ...
        public ConsensusEstimate(string requestId = default(string), string fsymId = default(string), string metric = default(string), string periodicity = default(string), int fiscalPeriod = default(int), int fiscalYear = default(int), DateTime fiscalEndDate = default(DateTime), int relativePeriod = default(int), DateTime estimateDate = default(DateTime), string currency = default(string), double mean = default(double), double median = default(double), double standardDeviation = default(double), double high = default(double), double low = default(double), int estimateCount = default(int), int up = default(int), int down = default(int))
        {
        ...
        /// </summary>
        /// <value>Currency used estimates in consensus calculations. For a list of currency ISO codes, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470).</value>
        ...
        [DataMember(Name = "estimateCount", EmitDefaultValue = false)]
