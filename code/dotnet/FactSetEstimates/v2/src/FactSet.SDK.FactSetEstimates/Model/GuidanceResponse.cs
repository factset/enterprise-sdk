...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    /// GuidanceResponse
    /// </summary>
    [DataContract(Name = "guidanceResponse")]
    public partial class GuidanceResponse : IEquatable<GuidanceResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GuidanceResponse(List<Guidance> data = default(List<Guidance>))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as GuidanceResponse);
        }

        /// <summary>
        /// Returns true if GuidanceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GuidanceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuidanceResponse input)
        {
            if (input == null)
            {
                return false;
