...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class RollingDetailRequest : IEquatable<RollingDetailRequest>, IValidatableObject
    {
        ...
        /// <param name="includeDocId">Controls whether the &#x60;docId&#x60; field is included in the response.   * &#x60;TRUE&#x60; &#x3D; Returns the &#x60;docId&#x60; field, a unique identifier linking the estimate to the corresponding investment report in FactSet&#39;s Investment Research API.   * &#x60;FALSE&#x60; &#x3D; Omits the &#x60;docId&#x60; field from the response. (default)  (default to false).</param>
        public RollingDetailRequest(List<string> ids, List<string> metrics,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), Frequency frequency = default(Frequency), bool includeAll = false, int relativeFiscalStart = 1, int relativeFiscalEnd = 1, PeriodicityDetail periodicity = default(PeriodicityDetail), string currency = default(string), List<string> brokerNames = default(List<string>), bool updatesOnly = false, bool sortByInputDateTime = false, bool includeDocId = false)
        {
            ...
            this.IncludeDocId = includeDocId;
        }
        ...
        /// <summary>
        /// Controls whether the &#x60;docId&#x60; field is included in the response.   * &#x60;TRUE&#x60; &#x3D; Returns the &#x60;docId&#x60; field, a unique identifier linking the estimate to the corresponding investment report in FactSet&#39;s Investment Research API.   * &#x60;FALSE&#x60; &#x3D; Omits the &#x60;docId&#x60; field from the response. (default) 
        /// </summary>
        /// <value>Controls whether the &#x60;docId&#x60; field is included in the response.   * &#x60;TRUE&#x60; &#x3D; Returns the &#x60;docId&#x60; field, a unique identifier linking the estimate to the corresponding investment report in FactSet&#39;s Investment Research API.   * &#x60;FALSE&#x60; &#x3D; Omits the &#x60;docId&#x60; field from the response. (default) </value>
        [DataMember(Name = "includeDocId", EmitDefaultValue = true)]
        public bool IncludeDocId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncludeDocId: ").Append(IncludeDocId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(RollingDetailRequest input)
        {
            ...
            return 
                ...
                (
                    this.IncludeDocId == input.IncludeDocId ||
                    this.IncludeDocId.Equals(input.IncludeDocId)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IncludeDocId.GetHashCode();
                return hashCode;
            }
        }
