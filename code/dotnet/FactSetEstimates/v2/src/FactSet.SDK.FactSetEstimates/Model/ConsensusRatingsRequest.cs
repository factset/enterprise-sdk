...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class ConsensusRatingsRequest : IEquatable<ConsensusRatingsRequest>, IValidatableObject
    {
        ...
        public ConsensusRatingsRequest(List<string> ids,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), Frequency frequency = default(Frequency))
        {
