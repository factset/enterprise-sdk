...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    /// Actual
    /// </summary>
    [DataContract(Name = "actual")]
    public partial class Actual : IEquatable<Actual>, IValidatableObject
    {
        /// <summary>
        ...
        public Actual(string requestId = default(string), string fsymId = default(string), string metric = default(string), string periodicity = default(string), int? fiscalPeriod = default(int?), int? fiscalYear = default(int?), DateTime? fiscalEndDate = default(DateTime?), decimal? actualValue = default(decimal?), ActualTypeEnum? actualType = default(ActualTypeEnum?), DateTime? reportDate = default(DateTime?), string currency = default(string), string estimateCurrency = default(string))
        {
        ...
        {
            return this.Equals(input as Actual);
        }

        /// <summary>
        /// Returns true if Actual instances are equal
        /// </summary>
        /// <param name="input">Instance of Actual to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Actual input)
        {
            if (input == null)
            {
                return false;
