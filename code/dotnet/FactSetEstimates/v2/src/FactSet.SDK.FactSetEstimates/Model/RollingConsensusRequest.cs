...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class RollingConsensusRequest : IEquatable<RollingConsensusRequest>, IValidatableObject
    {
        ...
        public RollingConsensusRequest(List<string> ids, List<string> metrics,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), Frequency frequency = default(Frequency), int relativeFiscalStart = default(int), int relativeFiscalEnd = default(int), Periodicity periodicity = default(Periodicity), string currency = default(string))
        {
