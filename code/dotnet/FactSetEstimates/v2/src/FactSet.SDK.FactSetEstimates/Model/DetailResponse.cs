...
namespace FactSet.SDK.FactSetEstimates.Model
{
    ...
    public partial class DetailResponse : IEquatable<DetailResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Array of detail estimate objects.</param>
        public DetailResponse(List<DetailEstimate> data = default(List<DetailEstimate>))
        {
            this.Data = data;
        }

        /// <summary>
        /// Array of detail estimate objects
        /// </summary>
        /// <value>Array of detail estimate objects</value>
