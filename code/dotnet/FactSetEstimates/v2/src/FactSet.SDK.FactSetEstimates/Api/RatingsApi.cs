...
namespace FactSet.SDK.FactSetEstimates.Api
{
    ...
    public interface IRatingsApiSync : IApiAccessor
    {
        ...
        DetailRatingsResponse GetDetailRatings(List<string> ids, string startDate = default(string), string endDate = default(string));
        ...
        ApiResponse<DetailRatingsResponse> GetDetailRatingsWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string));
        /// <summary>
        /// Broker Detail estimates to fetch Buy, Overweight, Hold, Underweight, and Sell.
        /// </summary>
        /// <remarks>
    ...
    public interface IRatingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DetailRatingsResponse> GetDetailRatingsAsync(List<string> ids, string startDate = default(string), string endDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DetailRatingsResponse>> GetDetailRatingsWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Broker Detail estimates to fetch Buy, Overweight, Hold, Underweight, and Sell.
        /// </summary>
        /// <remarks>
