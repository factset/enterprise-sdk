...
namespace FactSet.SDK.FactSetEstimates.Api
{
    ...
    public interface IRatingsApiSync : IApiAccessor
    {
        ...
        /// <param name="brokerNames">Filter to return estimate data from specific brokers only. Accepts broker names as input.  The endpoint returns data from all available brokers if this parameter is not specified. For a list of available brokers, visit [Online Assistant Page #14706](https://oa.apps.factset.com/pages/14706). (optional)</param>
        /// <param name="updatesOnly">If &#x60;true&#x60;, the endpoint returns the first reported estimates within the period plus any subsequent broker updates. If &#x60;false&#x60;, it returns data for every date in the requested range at the chosen frequency.     (optional, default to false)</param>
        /// <returns>DetailRatingsResponse</returns>
        DetailRatingsResponse GetDetailRatings(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?));
        ...
        ApiResponse<DetailRatingsResponse> GetDetailRatingsWithHttpInfo(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?));
        /// <summary>
        /// Broker Detail estimates to fetch Buy, overWeight, Hold, underWeight, and Sell.
        /// </summary>
        /// <remarks>
    ...
    public interface IRatingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DetailRatingsResponse> GetDetailRatingsAsync(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DetailRatingsResponse>> GetDetailRatingsWithHttpInfoAsync(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Broker Detail estimates to fetch Buy, overWeight, Hold, underWeight, and Sell.
        /// </summary>
        /// <remarks>
    ...
    public partial class RatingsApi : IRatingsApi
    {
        ...
        /// <param name="updatesOnly">If &#x60;true&#x60;, the endpoint returns the first reported estimates within the period plus any subsequent broker updates. If &#x60;false&#x60;, it returns data for every date in the requested range at the chosen frequency.     (optional, default to false)</param>
        /// <returns>DetailRatingsResponse</returns>
        public DetailRatingsResponse GetDetailRatings(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?))
        {
            var localVarResponse = GetDetailRatingsWithHttpInfo(ids, startDate, endDate, includeAll, brokerNames, updatesOnly);
            return localVarResponse.Data;
        }
        ...
        /// <param name="updatesOnly">If &#x60;true&#x60;, the endpoint returns the first reported estimates within the period plus any subsequent broker updates. If &#x60;false&#x60;, it returns data for every date in the requested range at the chosen frequency.     (optional, default to false)</param>
        /// <returns>ApiResponse of DetailRatingsResponse</returns>
        public ApiResponse<DetailRatingsResponse> GetDetailRatingsWithHttpInfo(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            if (brokerNames != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetEstimates.Client.ClientUtils.ParameterToMultiMap("csv", "brokerNames", brokerNames));
            }
            if (updatesOnly != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetEstimates.Client.ClientUtils.ParameterToMultiMap("", "updatesOnly", updatesOnly));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DetailRatingsResponse</returns>
        public async System.Threading.Tasks.Task<DetailRatingsResponse>GetDetailRatingsAsync(List<string> ids, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? includeAll = default(bool?), List<string> brokerNames = default(List<string>), bool? updatesOnly = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetDetailRatingsWithHttpInfoAsync(ids, startDate, endDate, includeAll, brokerNames, updatesOnly, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
