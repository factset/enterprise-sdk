...
namespace FactSet.SDK.FactSetEstimates.Api
{
    ...
    public interface IDataItemsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.FactSetEstimates.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Security or Entity identifiers. Accepted inputs include FactSet Identifiers, tickers, CUSIP, and SEDOL. </param>
        /// <param name="metrics">Requested metric. Use the &#x60;/metrics&#x60; endpoint to return a list of available estimate items. **Top 10** most used metrics are **EPS, SALES, DPS, EBITDA, EBIT, PRICE_TGT, CFPS, BPS, NET_INC, and ASSETS**. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034). </param>
        /// <param name="segmentType">Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)</param>
        /// <returns>MetricsSegmentDetailResponse</returns>
        MetricsSegmentDetailResponse GetEstimateSegmentDetailMetrics(List<string> ids, List<string> metrics, string segmentType = default(string));
        ...
        /// <param name="metrics">Requested metric. Use the &#x60;/metrics&#x60; endpoint to return a list of available estimate items. **Top 10** most used metrics are **EPS, SALES, DPS, EBITDA, EBIT, PRICE_TGT, CFPS, BPS, NET_INC, and ASSETS**. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034). </param>
        /// <param name="segmentType">Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)</param>
        /// <returns>ApiResponse of MetricsSegmentDetailResponse</returns>
        ApiResponse<MetricsSegmentDetailResponse> GetEstimateSegmentDetailMetricsWithHttpInfo(List<string> ids, List<string> metrics, string segmentType = default(string));
    ...
    public interface IDataItemsApiAsync : IApiAccessor
    {
        ...
        /// <param name="segmentType">Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MetricsSegmentDetailResponse</returns>
        System.Threading.Tasks.Task<MetricsSegmentDetailResponse> GetEstimateSegmentDetailMetricsAsync(List<string> ids, List<string> metrics, string segmentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="segmentType">Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MetricsSegmentDetailResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<MetricsSegmentDetailResponse>> GetEstimateSegmentDetailMetricsWithHttpInfoAsync(List<string> ids, List<string> metrics, string segmentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class DataItemsApi : IDataItemsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetEstimateSegmentDetailMetricsResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(MetricsSegmentDetailResponse) },
            { (HttpStatusCode)400, typeof(ErrorResponse) },
            { (HttpStatusCode)401, typeof(ErrorResponse) },
            { (HttpStatusCode)403, typeof(ErrorResponse) },
            { (HttpStatusCode)415, typeof(ErrorResponse) },
        ...
        /// <summary>
        /// Available Estimate Segment Detail metrics Returns list of available Estimate Segment Detail metrics that can be used in the &#x60;metrics&#x60; parameter of the segment details endpoint. **By default, Factset provides Estimated items in millions across all currencies. For specific metric methodology definitions, reference the &#x60;OAurl&#x60; response items to launch the available methodology page.**  
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetEstimates.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Security or Entity identifiers. Accepted inputs include FactSet Identifiers, tickers, CUSIP, and SEDOL. </param>
        /// <param name="metrics">Requested metric. Use the &#x60;/metrics&#x60; endpoint to return a list of available estimate items. **Top 10** most used metrics are **EPS, SALES, DPS, EBITDA, EBIT, PRICE_TGT, CFPS, BPS, NET_INC, and ASSETS**. For more details, visit [Online Assistant Page #15034](https://oa.apps.factset.com/pages/15034). </param>
        /// <param name="segmentType">Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)</param>
        /// <returns>MetricsSegmentDetailResponse</returns>
        public MetricsSegmentDetailResponse GetEstimateSegmentDetailMetrics(List<string> ids, List<string> metrics, string segmentType = default(string))
        {
            var localVarResponse = GetEstimateSegmentDetailMetricsWithHttpInfo(ids, metrics, segmentType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="segmentType">Controls the type of segment selected.   * **BUS** &#x3D; Business / Product Segment   * **GEO** &#x3D; Geographic Segment   * **ALL** &#x3D; Both Business and Geographic Segments  (optional, default to BUS)</param>
        /// <returns>ApiResponse of MetricsSegmentDetailResponse</returns>
        public ApiResponse<MetricsSegmentDetailResponse> GetEstimateSegmentDetailMetricsWithHttpInfo(List<string> ids, List<string> metrics, string segmentType = default(string))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
                throw new FactSet.SDK.FactSetEstimates.Client.ApiException(400, "Missing required parameter 'ids' when calling DataItemsApi->GetEstimateSegmentDetailMetrics");
            }

            // verify the required parameter 'metrics' is set
            if (metrics == null)
            {
                throw new FactSet.SDK.FactSetEstimates.Client.ApiException(400, "Missing required parameter 'metrics' when calling DataItemsApi->GetEstimateSegmentDetailMetrics");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetEstimateSegmentDetailMetricsResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            MetricsSegmentDetailResponse>("/factset-estimates/v2/segments-metrics", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetEstimateSegmentDetailMetrics", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MetricsSegmentDetailResponse</returns>
        public async System.Threading.Tasks.Task<MetricsSegmentDetailResponse>GetEstimateSegmentDetailMetricsAsync(List<string> ids, List<string> metrics, string segmentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetEstimateSegmentDetailMetricsWithHttpInfoAsync(ids, metrics, segmentType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MetricsSegmentDetailResponse>> GetEstimateSegmentDetailMetricsWithHttpInfoAsync(List<string> ids, List<string> metrics, string segmentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<MetricsSegmentDetailResponse>("/factset-estimates/v2/segments-metrics", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
