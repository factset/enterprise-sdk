...
[![Nuget](https://img.shields.io/badge/nuget-v1.4.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEstimates/1.4.1)
...
dotnet add package FactSet.SDK.FactSetEstimates -v 1.4.1
```
...
nuget install FactSet.SDK.FactSetEstimates -Version 1.4.1
```
