...
[![Nuget](https://img.shields.io/badge/nuget-v3.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEstimates/3.2.0)
...
dotnet add package FactSet.SDK.FactSetEstimates -v 3.2.0
```
...
nuget install FactSet.SDK.FactSetEstimates -Version 3.2.0
```
...
*DataItemsApi* | [**GetEstimateSegmentDetailMetrics**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/DataItemsApi.md#getestimatesegmentdetailmetrics) | **GET** /factset-estimates/v2/segments-metrics | Available Estimate Segment Detail metrics
...
*SegmentsApi* | [**GetSegmentsDetailsForList**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/SegmentsApi.md#getsegmentsdetailsforlist) | **POST** /factset-estimates/v2/segments-detail | Retrieves product segment detail estimates for a requested list of ids and fiscal periods
...
## Documentation for Models
 ...
 - [Model.MetricSegmentDetail](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/MetricSegmentDetail.md)
 ...
 - [Model.MetricsSegmentDetailResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/MetricsSegmentDetailResponse.md)
 ...
 - [Model.SegmentsDetailsEstimate](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/SegmentsDetailsEstimate.md)
 - [Model.SegmentsDetailsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/SegmentsDetailsRequest.md)
 - [Model.SegmentsDetailsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetEstimates/v2/docs/SegmentsDetailsResponse.md)
