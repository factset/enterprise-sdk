...
[![Nuget](https://img.shields.io/badge/nuget-v3.4.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEstimates/3.4.0)
...
dotnet add package FactSet.SDK.FactSetEstimates -v 3.4.0
```
...
nuget install FactSet.SDK.FactSetEstimates -Version 3.4.0
```
