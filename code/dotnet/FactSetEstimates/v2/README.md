...
[![Nuget](https://img.shields.io/badge/nuget-v1.4.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEstimates/1.4.0)
...
dotnet add package FactSet.SDK.FactSetEstimates -v 1.4.0
```
...
nuget install FactSet.SDK.FactSetEstimates -Version 1.4.0
```
