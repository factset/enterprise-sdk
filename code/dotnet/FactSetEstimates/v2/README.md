...
[![Nuget](https://img.shields.io/badge/nuget-v1.3.3-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEstimates/1.3.3)
...
dotnet add package FactSet.SDK.FactSetEstimates -v 1.3.3
```
...
nuget install FactSet.SDK.FactSetEstimates -Version 1.3.3
```
