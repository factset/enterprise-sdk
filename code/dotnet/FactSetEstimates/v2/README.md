...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetEstimates/2.0.0)
...
dotnet add package FactSet.SDK.FactSetEstimates -v 2.0.0
```
...
nuget install FactSet.SDK.FactSetEstimates -Version 2.0.0
```
