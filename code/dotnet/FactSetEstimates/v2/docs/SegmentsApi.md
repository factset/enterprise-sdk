...
[**GetSegmentsDetailsForList**](SegmentsApi.md#getsegmentsdetailsforlist) | **POST** /factset-estimates/v2/segments-detail | Retrieves product segment detail estimates for a requested list of ids and fiscal periods
...
# **GetSegments**
> SegmentsResponse GetSegments (List<string> ids, string segmentType, List<string> metrics, DateTime? startDate = null, DateTime? endDate = null, int? relativeFiscalStart = null, int? relativeFiscalEnd = null, string periodicity = null, string frequency = null, string currency = null)
...
| **429** | Too Many Requests - The API rate limit of 4 million datapoints per minute has been exceeded, resulting in a 429 error. Please wait and check the &#x60;Retry-After&#x60; header before sending more requests. |  -  |
| **500** | Internal Server Error. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)


<a name="getsegmentsdetailsforlist"></a>
# **GetSegmentsDetailsForList**
> SegmentsDetailsResponse GetSegmentsDetailsForList (SegmentsDetailsRequest segmentsDetailsRequest)

Retrieves product segment detail estimates for a requested list of ids and fiscal periods

Returns FactSet Estimates Details Data for the segments gathered from the Business, Geographical, or Actual Reconciliation (ADJUSTMENT) classifications by using fiscal periods with a reporting frequency.  
...
namespace Example
{
    public class GetSegmentsDetailsForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetEstimates.Client.Configuration();
            ...
            var segmentsDetailsRequest = new SegmentsDetailsRequest(); // SegmentsDetailsRequest | Request object for Product Segments estimates.

            try
            {
                // Retrieves product segment detail estimates for a requested list of ids and fiscal periods
                SegmentsDetailsResponse result = apiInstance.GetSegmentsDetailsForList(segmentsDetailsRequest);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SegmentsApi.GetSegmentsDetailsForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **segmentsDetailsRequest** | [**SegmentsDetailsRequest**](SegmentsDetailsRequest.md)| Request object for Product Segments estimates. | 

### Return type
[**SegmentsDetailsResponse**](SegmentsDetailsResponse.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Segments Details Estimate data items |  -  |
| **400** | Bad Request. This can occur for several reasons. Please review the \&quot;message\&quot; for more details. |  -  |
| **401** | Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses. |  -  |
| **403** | The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization. |  -  |
| **415** | Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \&quot;application/json\&quot; would be the appropriate value. |  -  |
...
namespace Example
{
    public class GetSegmentsForListExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling SegmentsApi.GetSegmentsForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
