...
namespace Example
{
    public class GetFixedConsensusExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ConsensusApi.GetFixedConsensus: " + e.Message );
...
namespace Example
{
    public class GetFixedConsensusForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ConsensusApi.GetFixedConsensusForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetRollingConsensusExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ConsensusApi.GetRollingConsensus: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetRollingConsensusForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ConsensusApi.GetRollingConsensusForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
