...
namespace FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Api
{
    ...
    public interface IMarketImpactApiSync : IApiAccessor
    {
        ...
        ApiResponse<CostImpactResponseRootV3> GetCostImpactV3WithHttpInfo(string securityId, string orderVolume, string strategy = default(string), List<string> riskAversion = default(List<string>), DateTime? date = default(DateTime?), string startTime = default(string), string endTime = default(string), bool? isMomentum = default(bool?), string side = default(string), bool? peer = default(bool?), float? frontLoadHalfLife = default(float?), float? rearLoadHalfLife = default(float?), float? rearRatio = default(float?), bool? binsData = default(bool?));
    ...
    public interface IMarketImpactApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CostImpactResponseRootV3>> GetCostImpactV3WithHttpInfoAsync(string securityId, string orderVolume, string strategy = default(string), List<string> riskAversion = default(List<string>), DateTime? date = default(DateTime?), string startTime = default(string), string endTime = default(string), bool? isMomentum = default(bool?), string side = default(string), bool? peer = default(bool?), float? frontLoadHalfLife = default(float?), float? rearLoadHalfLife = default(float?), float? rearRatio = default(float?), bool? binsData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MarketImpactApi : IMarketImpactApi
    {
        ...
        /// <param name="binsData">Flag to apply BinsData. Specify true to include BinsData (optional, default to true)</param>
        /// <returns>CostImpactResponseRootV3</returns>
        public CostImpactResponseRootV3 GetCostImpactV3(string securityId, string orderVolume, string strategy = default(string), List<string> riskAversion = default(List<string>), DateTime? date = default(DateTime?), string startTime = default(string), string endTime = default(string), bool? isMomentum = default(bool?), string side = default(string), bool? peer = default(bool?), float? frontLoadHalfLife = default(float?), float? rearLoadHalfLife = default(float?), float? rearRatio = default(float?), bool? binsData = default(bool?))
        {
            var localVarResponse = GetCostImpactV3WithHttpInfo(securityId, orderVolume, strategy, riskAversion, date, startTime, endTime, isMomentum, side, peer, frontLoadHalfLife, rearLoadHalfLife, rearRatio, binsData);
        ...
        /// <param name="binsData">Flag to apply BinsData. Specify true to include BinsData (optional, default to true)</param>
        /// <returns>ApiResponse of CostImpactResponseRootV3</returns>
        public ApiResponse<CostImpactResponseRootV3> GetCostImpactV3WithHttpInfo(string securityId, string orderVolume, string strategy = default(string), List<string> riskAversion = default(List<string>), DateTime? date = default(DateTime?), string startTime = default(string), string endTime = default(string), bool? isMomentum = default(bool?), string side = default(string), bool? peer = default(bool?), float? frontLoadHalfLife = default(float?), float? rearLoadHalfLife = default(float?), float? rearRatio = default(float?), bool? binsData = default(bool?))
        {
        ...
        {
            var localVarResponse = await GetCostImpactV3WithHttpInfoAsync(securityId, orderVolume, strategy, riskAversion, date, startTime, endTime, isMomentum, side, peer, frontLoadHalfLife, rearLoadHalfLife, rearRatio, binsData, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<CostImpactResponseRootV3>> GetCostImpactV3WithHttpInfoAsync(string securityId, string orderVolume, string strategy = default(string), List<string> riskAversion = default(List<string>), DateTime? date = default(DateTime?), string startTime = default(string), string endTime = default(string), bool? isMomentum = default(bool?), string side = default(string), bool? peer = default(bool?), float? frontLoadHalfLife = default(float?), float? rearLoadHalfLife = default(float?), float? rearRatio = default(float?), bool? binsData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'securityId' is set
            if (securityId == null)
            {
