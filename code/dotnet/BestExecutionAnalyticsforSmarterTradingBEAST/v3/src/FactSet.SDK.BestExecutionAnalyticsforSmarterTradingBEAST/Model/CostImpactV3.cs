...
namespace FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CostImpactV3")]
    public partial class CostImpactV3 : IEquatable<CostImpactV3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostImpactV3" /> class.
        /// </summary>
        /// <param name="strategy">Strategy.</param>
        /// <param name="riskAversion">RiskAversion.</param>
        /// <param name="marketImpactStatus">MarketImpactStatus.</param>
        ...
        public CostImpactV3(string strategy = default(string), double riskAversion = default(double), string marketImpactStatus = default(string), string message = default(string), double costPerShare = default(double), double costPerShareBps = default(double), double marketImpact = default(double), double confidenceInterval = default(double), double confidenceIntervalBps = default(double), double liquidityCostPerShare = default(double), double spreadCostPerShare = default(double), double liquidityCostPerShareBps = default(double), double spreadCostPerShareBps = default(double), List<OutputStrategyBinData> outputStrategyBinDataDtoList = default(List<OutputStrategyBinData>))
        {
        ...
        /// RiskAversion
        /// </summary>
        /// <value>RiskAversion</value>
        [DataMember(Name = "riskAversion", EmitDefaultValue = false)]
        public double RiskAversion { get; set; }

        /// <summary>
        /// MarketImpactStatus
        /// </summary>
        /// <value>MarketImpactStatus</value>
        [DataMember(Name = "marketImpactStatus", EmitDefaultValue = false)]
        public string MarketImpactStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MarketImpactStatus: ").Append(MarketImpactStatus).Append("\n");
        ...
        {
            return this.Equals(input as CostImpactV3);
        }

        /// <summary>
        /// Returns true if CostImpactV3 instances are equal
        /// </summary>
        /// <param name="input">Instance of CostImpactV3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostImpactV3 input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RiskAversion == input.RiskAversion ||
                    this.RiskAversion.Equals(input.RiskAversion)
                ) && 
                (
                    this.MarketImpactStatus == input.MarketImpactStatus ||
                    (this.MarketImpactStatus != null &&
                    this.MarketImpactStatus.Equals(input.MarketImpactStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RiskAversion.GetHashCode();
                if (this.MarketImpactStatus != null)
                {
                    hashCode = (hashCode * 59) + this.MarketImpactStatus.GetHashCode();
                }
