...
<a name="getorders"></a>
# **GetOrders**
> OrdersResponseRoot GetOrders (DateTime startDate, DateTime endDate, string securityId = null, string trader = null, string country = null, string strategy = null, string broker = null, List<string> orderFields = null, bool? hierarchical = null, string messageType = null, int? limit = null, int? offset = null)
...
namespace Example
{
    public class GetOrdersExample
    {
        public static async Task Main()
        {
            ...
            var startDate = DateTime.Parse("2024-08-21");  // DateTime | Date in the format YYYY-MM-DD
            var endDate = DateTime.Parse("2024-08-29");  // DateTime | Date in the format YYYY-MM-DD
            var securityId = "FDS";  // string | ISIN for European or India securities, otherwise TICKER. Works together with country and currency parameters. (optional) 
            ...
            var orderFields = new List<string>(); // List<string> | Specify order fields to select. The OrderId, Country, MasterOrderId, MessageType and ParentId fields are default fields and must be included if none are specified. (optional) 
            var hierarchical = true;  // bool? | Return order records in hierarchical format or as flat records (optional)  (default to true)
            var messageType = "Undefined";  // string | Return parent or child order records by messageType. Only apply when hierarchical is false (optional)  (default to Undefined)
            var limit = 50000;  // int? | Maximum number of records to return per page. Default with max value 50000 (optional)  (default to 50000)
            var offset = 1;  // int? | Starting position (offset) for paginated records. Specifies current page to return results. Default value 1 (optional)  (default to 1)
 ...
 **orderFields** | [**List&lt;string&gt;**](string.md)| Specify order fields to select. The OrderId, Country, MasterOrderId, MessageType and ParentId fields are default fields and must be included if none are specified. | [optional] 
 ...
 **limit** | **int?**| Maximum number of records to return per page. Default with max value 50000 | [optional] [default to 50000]
 **offset** | **int?**| Starting position (offset) for paginated records. Specifies current page to return results. Default value 1 | [optional] [default to 1]
