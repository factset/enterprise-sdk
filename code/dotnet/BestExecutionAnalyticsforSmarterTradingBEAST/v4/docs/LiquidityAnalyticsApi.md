# FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Api.LiquidityAnalyticsApi
...
<a name="getliquidityanalytics"></a>
...
namespace Example
{
    public class GetLiquidityAnalyticsExample
    {
        public static async Task Main()
        {
            ...
            var securityIds = new List<string>(); // List<string> | ISIN for European or India securities, otherwise TICKER. Either FDS-US-USD or FDS-US works.
...
------------- | ------------- | ------------- | -------------
 **securityIds** | [**List&lt;string&gt;**](string.md)| ISIN for European or India securities, otherwise TICKER. Either FDS-US-USD or FDS-US works. | 
...
namespace Example
{
    public class GetLiquidityQuotesExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Client.Configuration();
            ...
            {
                // Get Liquidity Quotes
                QuotesAnalyticsResponseRoot result = apiInstance.GetLiquidityQuotes(securityIds, startDate, endDate);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LiquidityAnalyticsApi.GetLiquidityQuotes: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetLiquidityTradesExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Client.Configuration();
            ...
            {
                // Get Liquidity Trades
                TradesAnalyticsResponseRoot result = apiInstance.GetLiquidityTrades(securityIds, startDate, endDate);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LiquidityAnalyticsApi.GetLiquidityTrades: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getliquidityvolumeanalytics"></a>
...
namespace Example
{
    public class GetLiquidityVolumeAnalyticsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Client.Configuration();
            ...
            {
                // Get Liquidity Volume Analytics
                VolumeAnalyticsResponseRootV3 result = apiInstance.GetLiquidityVolumeAnalytics(securityIds, startDate, endDate);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LiquidityAnalyticsApi.GetLiquidityVolumeAnalytics: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
