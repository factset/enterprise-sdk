...
namespace FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Model
{
    ...
    public partial class OrderSearch : IEquatable<OrderSearch>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="allocAccount">Allocation Account.</param>
        /// <param name="allocVolume">Allocation Volume.</param>
        ...
        /// Allocation Account
        /// </summary>
        /// <value>Allocation Account</value>
        [DataMember(Name = "allocAccount", EmitDefaultValue = false)]
        public string AllocAccount { get; set; }

        /// <summary>
        /// Allocation Volume
        /// </summary>
        /// <value>Allocation Volume</value>
        [DataMember(Name = "allocVolume", EmitDefaultValue = false)]
        public double AllocVolume { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllocAccount: ").Append(AllocAccount).Append("\n");
            sb.Append("  AllocVolume: ").Append(AllocVolume).Append("\n");
        ...
        public bool Equals(OrderSearch input)
        {
            ...
            return 
                (
                    this.AllocAccount == input.AllocAccount ||
                    (this.AllocAccount != null &&
                    this.AllocAccount.Equals(input.AllocAccount))
                ) && 
                (
                    this.AllocVolume == input.AllocVolume ||
                    this.AllocVolume.Equals(input.AllocVolume)
                ) && 
                (
                    this.Id == input.Id ||
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AllocAccount != null)
                {
                    hashCode = (hashCode * 59) + this.AllocAccount.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.AllocVolume.GetHashCode();
