...
namespace FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Model
{
    ...
    public partial class VolumeAnalytic : IEquatable<VolumeAnalytic>, IValidatableObject
    {
        ...
        public VolumeAnalytic(DateTime dateId = default(DateTime), double bidSideVolume = default(double), double askSideVolume = default(double), double blockVolume = default(double))
        {
            this.DateId = dateId;
