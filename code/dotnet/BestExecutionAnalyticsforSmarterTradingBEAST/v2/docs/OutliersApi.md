...
> OutlierResponseRoot GetOutlierMetricsByPercentile (string metricType, string startDate, string endDate, string region = null, string trader = null, float? minPercent = null, float? maxPercent = null, int? binScalar = null)
...
namespace Example
{
    public class GetOutlierMetricsByPercentileExample
    {
        public static async Task Main()
        {
            ...
            var startDate = "2024-07-29";  // string | Start date in the format YYYY-MM-DD
            var endDate = "2024-08-29";  // string | End date in the format YYYY-MM-DD
...
> OutlierResponseRoot GetOutlierMetricsStandard (string metricType, string startDate, string endDate, string region = null, string trader = null, float? deviation = null, int? binScalar = null)
