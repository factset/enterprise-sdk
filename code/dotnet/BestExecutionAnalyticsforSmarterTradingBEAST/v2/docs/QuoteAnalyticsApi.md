# FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Api.QuoteAnalyticsApi
...
<a name="getquoteinsidesize"></a>
# **GetQuoteInsideSize**
> QuoteInsideSizeResponseRoot GetQuoteInsideSize (string startDate, string endDate, string securityId, string region)
...
namespace Example
{
    public class GetQuoteInsideSizeExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new QuoteAnalyticsApi(config);
            ...
            {
                // Get Quote Analytics
                QuoteInsideSizeResponseRoot result = apiInstance.GetQuoteInsideSize(startDate, endDate, securityId, region);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling QuoteAnalyticsApi.GetQuoteInsideSize: " + e.Message );
