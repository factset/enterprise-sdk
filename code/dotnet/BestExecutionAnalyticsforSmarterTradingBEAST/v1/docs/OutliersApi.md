...
<a name="getoutliermetrics"></a>
# **GetOutlierMetrics**
> OutlierResponseRoot GetOutlierMetrics (string metricType, string startDate, string endDate, float? deviation = null, int? binScalar = null)
...
namespace Example
{
    public class GetOutlierMetricsExample
    {
        public static async Task Main()
        {
            ...
            var startDate = "2024-08-20";  // string | Start date in the format YYYY-MM-DD
            ...
            {
                Console.WriteLine("Exception when calling OutliersApi.GetOutlierMetrics: " + e.Message );
...
<a name="getoutliermetricsbypercent"></a>
# **GetOutlierMetricsByPercent**
> OutlierResponseRoot GetOutlierMetricsByPercent (string metricType, string startDate, string endDate, float? minPercent = null, float? maxPercent = null, int? binScalar = null)
...
namespace Example
{
    public class GetOutlierMetricsByPercentExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.BestExecutionAnalyticsforSmarterTradingBEAST.Client.Configuration();
            ...
            var startDate = "2024-08-20";  // string | Start date in the format YYYY-MM-DD
            var endDate = "2024-08-29";  // string | End date in the format YYYY-MM-DD
            var minPercent = 25F;  // float? | Min Percentage (optional)  (default to 25F)
            var maxPercent = 75F;  // float? | Max Percentage (optional)  (default to 75F)
            var binScalar = 51;  // int? | Bin Scalar (optional)  (default to 51)
            ...
            {
                Console.WriteLine("Exception when calling OutliersApi.GetOutlierMetricsByPercent: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
 ...
 **startDate** | **string**| Start date in the format YYYY-MM-DD | 
 **endDate** | **string**| End date in the format YYYY-MM-DD | 
 **minPercent** | **float?**| Min Percentage | [optional] [default to 25F]
 **maxPercent** | **float?**| Max Percentage | [optional] [default to 75F]
 **binScalar** | **int?**| Bin Scalar | [optional] [default to 51]
