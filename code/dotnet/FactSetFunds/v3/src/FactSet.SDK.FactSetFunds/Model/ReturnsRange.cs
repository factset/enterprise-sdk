...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class ReturnsRange : IEquatable<ReturnsRange>, IValidatableObject
    {
        ...
        public ReturnsRange(string fsymId = default(string), string requestId = default(string), FundsErrorObject error = default(FundsErrorObject), double? _return = default(double?), DateTime? returnStartDate = default(DateTime?), DateTime? returnEndDate = default(DateTime?))
        {
            this.FsymId = fsymId;
