...
{
    /// <summary>
    /// Request payload containing fund identifiers and optional date range and dividend adjustment parameters for returns range data
    /// </summary>
    [DataContract(Name = "ReturnsRangeRequest_data")]
    public partial class ReturnsRangeRequestData : IEquatable<ReturnsRangeRequestData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnsRangeRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReturnsRangeRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnsRangeRequestData" /> class.
        /// </summary>
        ...
        public ReturnsRangeRequestData(List<string> ids,DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), DividendAdjust dividendAdjust = default(DividendAdjust))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for ReturnsRangeRequestData and cannot be null");
            }
            this.Ids = ids;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReturnsRangeRequestData {\n");
        ...
        {
            return this.Equals(input as ReturnsRangeRequestData);
        }

        /// <summary>
        /// Returns true if ReturnsRangeRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of ReturnsRangeRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReturnsRangeRequestData input)
        {
            if (input == null)
            {
                return false;
