...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BenchmarkDetails_allOf")]
    public partial class BenchmarkDetailsAllOf : IEquatable<BenchmarkDetailsAllOf>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BenchmarkDetailsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BenchmarkDetailsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BenchmarkDetailsAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BenchmarkDetailsAllOf);
        }

        /// <summary>
        /// Returns true if BenchmarkDetailsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BenchmarkDetailsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BenchmarkDetailsAllOf input)
        {
            if (input == null)
            {
                return false;
