# FactSet.SDK.FactSetFunds.Api.ScreenerOperationsApi

All URIs are relative to *https://api.factset.com/content/factset-funds/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**CreateContentSet**](ScreenerOperationsApi.md#createcontentset) | **POST** /screener/content-sets/create | Create a new custom content set with required fields from the default content sets.
[**DeleteContentSet**](ScreenerOperationsApi.md#deletecontentset) | **DELETE** /screener/content-sets/{name} | Delete a custom content set.
[**GetContentSets**](ScreenerOperationsApi.md#getcontentsets) | **GET** /screener/content-sets | Get the content sets that are permissioned for the user.
[**GetDistinctCount**](ScreenerOperationsApi.md#getdistinctcount) | **POST** /screener/distinct-count | Returns the number of records for a given field spread across all possible values.
[**GetFields**](ScreenerOperationsApi.md#getfields) | **GET** /screener/fields | Get the list of fields available for given content set.
[**GetScreenerData**](ScreenerOperationsApi.md#getscreenerdata) | **POST** /screener/search | Returns all the records that match the given criteria.
[**GetStatistics**](ScreenerOperationsApi.md#getstatistics) | **POST** /screener/statistics | Returns the statistics and histogram data for a given field within the specified content sets.
...
namespace Example
{
    public class CreateContentSetExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new ScreenerOperationsApi(config);
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.CreateContentSet: " + e.Message );
...
namespace Example
{
    public class DeleteContentSetExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.DeleteContentSet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetContentSetsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.GetContentSets: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetDistinctCountExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.GetDistinctCount: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetFieldsExample
    {
        public static async Task Main()
        {
            ...
            var contentSets = new List<string>(); // List<string> | The content sets from which the fields are requested.
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.GetFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **contentSets** | [**List&lt;string&gt;**](string.md)| The content sets from which the fields are requested. | 
...
namespace Example
{
    public class GetScreenerDataExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.GetScreenerData: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetStatisticsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ScreenerOperationsApi.GetStatistics: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
