# FactSet.SDK.FactSetFunds.Model.FundsReturnsRequestData
Request payload containing fund identifiers and optional date range, currency, and dividend adjustment parameters for returns data
