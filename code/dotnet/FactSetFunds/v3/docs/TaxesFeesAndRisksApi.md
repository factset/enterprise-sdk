# FactSet.SDK.FactSetFunds.Api.TaxesFeesAndRisksApi
...
# **GetFundsCostsFees**
> CostsFeesResponse GetFundsCostsFees (List<string> ids, string currency = null, DateTime? date = null)
...
namespace Example
{
    public class GetFundsCostsFeesExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new TaxesFeesAndRisksApi(config);
            ...
            var date = DateTime.Parse("2025-01-01");  // DateTime? | The date for costs and fees in YYYY-MM-DD format. Future dates (T+1) are not accepted in this endpoint. (optional) 
            ...
            {
                Console.WriteLine("Exception when calling TaxesFeesAndRisksApi.GetFundsCostsFees: " + e.Message );
 ...
 **date** | **DateTime?**| The date for costs and fees in YYYY-MM-DD format. Future dates (T+1) are not accepted in this endpoint. | [optional] 
...
namespace Example
{
    public class GetFundsCostsFeesForListExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling TaxesFeesAndRisksApi.GetFundsCostsFeesForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="gettaxesandrisks"></a>
# **GetTaxesAndRisks**
> TaxesAndRisksResponse GetTaxesAndRisks (List<string> ids, TaxItemsType? taxItemsType = null)
...
namespace Example
{
    public class GetTaxesAndRisksExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetFunds.Client.Configuration();
            ...
            var ids = new List<string>(); // List<string> | The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs. <p>***IDs limit** =  10 per request*</p> *<p>Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of IDs, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \"POST\" method.</p>*
            var taxItemsType = (TaxItemsType) "REGULATION_TAX";  // TaxItemsType? | Returns type of tax and risk information. (optional) 
            ...
            {
                Console.WriteLine("Exception when calling TaxesFeesAndRisksApi.GetTaxesAndRisks: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
------------- | ------------- | ------------- | -------------
 **ids** | [**List&lt;string&gt;**](string.md)| The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs. &lt;p&gt;***IDs limit** &#x3D;  10 per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of IDs, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;* | 
 **taxItemsType** | **TaxItemsType?**| Returns type of tax and risk information. | [optional] 
...
<a name="gettaxesandrisksforlist"></a>
...
namespace Example
{
    public class GetTaxesAndRisksForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetFunds.Client.Configuration();
            ...
            var taxesAndRisksRequest = new TaxesAndRisksRequest(); // TaxesAndRisksRequest | 
            ...
            {
                Console.WriteLine("Exception when calling TaxesFeesAndRisksApi.GetTaxesAndRisksForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
