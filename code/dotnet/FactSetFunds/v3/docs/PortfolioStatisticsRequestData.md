# FactSet.SDK.FactSetFunds.Model.PortfolioStatisticsRequestData
Request payload containing fund identifiers and optional date range parameters for portfolio statistics
