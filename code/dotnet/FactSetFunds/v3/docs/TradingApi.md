# FactSet.SDK.FactSetFunds.Api.TradingApi

All URIs are relative to *https://api.factset.com/content/factset-funds/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GetTrading**](TradingApi.md#gettrading) | **GET** /trading | Get Trading Characteristics
[**GetTradingForList**](TradingApi.md#gettradingforlist) | **POST** /trading | Get Trading Characteristics
...
namespace Example
{
    public class GetTradingExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get Trading Characteristics
                TradingResponse result = apiInstance.GetTrading(ids);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling TradingApi.GetTrading: " + e.Message );
...
namespace Example
{
    public class GetTradingForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetFunds.Client.Configuration();
            ...
            var tradingRequest = new TradingRequest(); // TradingRequest | 

            try
            {
                // Get Trading Characteristics
                TradingResponse result = apiInstance.GetTradingForList(tradingRequest);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling TradingApi.GetTradingForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tradingRequest** | [**TradingRequest**](TradingRequest.md)|  | 
