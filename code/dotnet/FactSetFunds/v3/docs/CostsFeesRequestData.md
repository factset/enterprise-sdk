# FactSet.SDK.FactSetFunds.Model.CostsFeesRequestData
...
**Date** | **DateTime** | The date requested in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint. | [optional] 
