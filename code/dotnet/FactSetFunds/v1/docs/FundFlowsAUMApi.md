...
namespace Example
{
    public class GetFundsAumForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundFlowsAUMApi.GetFundsAumForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetFundsFlowsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundFlowsAUMApi.GetFundsFlows: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetFundsFlowsForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FundFlowsAUMApi.GetFundsFlowsForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
