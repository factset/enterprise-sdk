...
namespace Example
{
    public class GetStatusesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling HelperApi.GetStatuses: " + e.Message );
...
namespace Example
{
    public class GetStatusesForListExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling HelperApi.GetStatusesForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
