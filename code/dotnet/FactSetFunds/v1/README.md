...
[![Nuget](https://img.shields.io/badge/nuget-v3.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetFunds/3.0.0)
...
dotnet add package FactSet.SDK.FactSetFunds -v 3.0.0
```
...
nuget install FactSet.SDK.FactSetFunds -Version 3.0.0
```
...
------------ | ------------- | ------------- | -------------
*BatchProcessingApi* | [**GetBatchData**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchProcessingApi.md#getbatchdata) | **GET** /factset-funds/v1/batch-result | Returns the response for a Batch Request
*BatchProcessingApi* | [**GetBatchStatus**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchProcessingApi.md#getbatchstatus) | **GET** /factset-funds/v1/batch-status | Returns the status for a Batch Request
...
## Documentation for Models
 ...
 - [Model.Batch](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/Batch.md)
 - [Model.BatchErrorObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchErrorObject.md)
 - [Model.BatchErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchErrorResponse.md)
 - [Model.BatchResult](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchResult.md)
 - [Model.BatchResultResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchResultResponse.md)
 - [Model.BatchStatus](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchStatus.md)
 - [Model.BatchStatusResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/BatchStatusResponse.md)
 ...
 - [Model.ContentSet](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/ContentSet.md)
 ...
 - [Model.FieldResponseObject](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/FieldResponseObject.md)
 ...
 - [Model.Operator](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetFunds/v1/docs/Operator.md)
