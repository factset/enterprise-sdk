...
[![Nuget](https://img.shields.io/badge/nuget-v1.4.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetFunds/1.4.0)
...
dotnet add package FactSet.SDK.FactSetFunds -v 1.4.0
```
...
nuget install FactSet.SDK.FactSetFunds -Version 1.4.0
```
