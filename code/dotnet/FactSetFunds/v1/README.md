...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetFunds/2.2.0)
...
dotnet add package FactSet.SDK.FactSetFunds -v 2.2.0
```
...
nuget install FactSet.SDK.FactSetFunds -Version 2.2.0
```
