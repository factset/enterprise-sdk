...
namespace FactSet.SDK.FactSetFunds.Api
{
    ...
    public interface IGroupHoldingsApiSync : IApiAccessor
    {
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <returns>GroupHoldingsApi.GetGroupHoldingsResponseWrapper</returns>
        GroupHoldingsApi.GetGroupHoldingsResponseWrapper GetGroupHoldings(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string));
        ...
        /// <param name="group">Controls the group of the data returned.   * **ASSET** &#x3D; Asset Class   * **ASSETISTYP** &#x3D; Issue Type with Asset Class   * **CAPGRP** &#x3D; Cap Group   * **CNTRY** &#x3D; Country   * **EXCHANGE** &#x3D; Exchange   * **INDUSTRY** &#x3D; Industry   * **ISSUE_TYPE** &#x3D; Issue Type   * **REGION** &#x3D; Region   * **SECTOR** &#x3D; Sector   * **ULTPARENT** &#x3D; Ultimate Parent        (optional, default to CNTRY)</param>
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <returns>ApiResponse of GroupHoldingsApi.GetGroupHoldingsResponseWrapper</returns>
        ApiResponse<GroupHoldingsApi.GetGroupHoldingsResponseWrapper> GetGroupHoldingsWithHttpInfo(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string));
        /// <summary>
        /// Get group holdings for a specific date and group.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper</returns>
        GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper GetGroupHoldingsForList(GroupHoldingsRequest groupHoldingsRequest);
        ...
        /// <exception cref="FactSet.SDK.FactSetFunds.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="groupHoldingsRequest">The Group Holdings request body, allowing the user to specify a list of ids, date, and group.</param>
        /// <returns>ApiResponse of GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper</returns>
        ApiResponse<GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper> GetGroupHoldingsForListWithHttpInfo(GroupHoldingsRequest groupHoldingsRequest);
    ...
    public interface IGroupHoldingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GroupHoldingsApi.GetGroupHoldingsResponseWrapper> GetGroupHoldingsAsync(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GroupHoldingsApi.GetGroupHoldingsResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<GroupHoldingsApi.GetGroupHoldingsResponseWrapper>> GetGroupHoldingsWithHttpInfoAsync(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get group holdings for a specific date and group.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GroupHoldingsResponse</returns>
        System.Threading.Tasks.Task<GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper> GetGroupHoldingsForListAsync(GroupHoldingsRequest groupHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="groupHoldingsRequest">The Group Holdings request body, allowing the user to specify a list of ids, date, and group.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper>> GetGroupHoldingsForListWithHttpInfoAsync(GroupHoldingsRequest groupHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GroupHoldingsApi : IGroupHoldingsApi
    {
        ...
        /// <item>
        /// <description>
        /// 200 : GroupHoldingsResponse<br />
        /// The Group Holdings response object.
        /// </description>
        /// </item>
        /// 
        /// <item>
        ...
        /// </example>
        /// </summary>
        public class GetGroupHoldingsResponseWrapper {

            /// <summary>This constructor initializes the new GetGroupHoldingsResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetGroupHoldingsResponseWrapper(HttpStatusCode statusCode, object response)
            {
            ...
            /// The Group Holdings response object.
            /// </summary>
            public GroupHoldingsResponse Response200
            {
                get
                {
                    if (StatusCode != (HttpStatusCode) 200)
                    {
                        throw new FactSet.SDK.FactSetFunds.Client.ApiException(500, "Invalid response getter called. Response200 can't return a " + StatusCode + " response");
                    }
                    return (GroupHoldingsResponse) Response;
                }
            }
            ...
            public BatchStatusResponse Response202
            {
                get
                {
                    ...
                    {
                        throw new FactSet.SDK.FactSetFunds.Client.ApiException(500, "Invalid response getter called. Response202 can't return a " + StatusCode + " response");
                    }
        ...
        /// </example>
        /// </summary>
        public class GetGroupHoldingsForListResponseWrapper {

            /// <summary>This constructor initializes the new GetGroupHoldingsForListResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetGroupHoldingsForListResponseWrapper(HttpStatusCode statusCode, object response)
            {
                StatusCode = statusCode;
                Response = response;
            }
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <returns>GroupHoldingsApi.GetGroupHoldingsResponseWrapper</returns>
        public GroupHoldingsApi.GetGroupHoldingsResponseWrapper GetGroupHoldings(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string))
        {
            var localVarResponse = GetGroupHoldingsWithHttpInfo(ids, asOfDate, group, batch);
        ...
        public ApiResponse<GroupHoldingsApi.GetGroupHoldingsResponseWrapper> GetGroupHoldingsWithHttpInfo(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string))
        {
            ...
            if (batch != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetFunds.Client.ClientUtils.ParameterToMultiMap("", "batch", batch));
            }
            ...
            Object>("/factset-funds/v1/holdings/group", localVarRequestOptions, this.Configuration);
            ...
            var getgroupholdingsResponse = new GetGroupHoldingsResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetGroupHoldingsResponseWrapper>(localVarResponse.StatusCode, getgroupholdingsResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GroupHoldingsResponse</returns>
        public async System.Threading.Tasks.Task<GroupHoldingsApi.GetGroupHoldingsResponseWrapper>GetGroupHoldingsAsync(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetGroupHoldingsWithHttpInfoAsync(ids, asOfDate, group, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<GroupHoldingsApi.GetGroupHoldingsResponseWrapper>> GetGroupHoldingsWithHttpInfoAsync(List<string> ids, string asOfDate = default(string), string group = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/factset-funds/v1/holdings/group", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="groupHoldingsRequest">The Group Holdings request body, allowing the user to specify a list of ids, date, and group.</param>
        /// <returns>GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper</returns>
        public GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper GetGroupHoldingsForList(GroupHoldingsRequest groupHoldingsRequest)
        {
        ...
        /// <param name="groupHoldingsRequest">The Group Holdings request body, allowing the user to specify a list of ids, date, and group.</param>
        /// <returns>ApiResponse of GroupHoldingsResponse</returns>
        public ApiResponse<GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper> GetGroupHoldingsForListWithHttpInfo(GroupHoldingsRequest groupHoldingsRequest)
        {
            ...
            var getgroupholdingsforlistResponse = new GetGroupHoldingsForListResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetGroupHoldingsForListResponseWrapper>(localVarResponse.StatusCode, getgroupholdingsforlistResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GroupHoldingsResponse</returns>
        public async System.Threading.Tasks.Task<GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper>GetGroupHoldingsForListAsync(GroupHoldingsRequest groupHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<GroupHoldingsApi.GetGroupHoldingsForListResponseWrapper>> GetGroupHoldingsForListWithHttpInfoAsync(GroupHoldingsRequest groupHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'groupHoldingsRequest' is set
            if (groupHoldingsRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/factset-funds/v1/holdings/group", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
