...
namespace FactSet.SDK.FactSetFunds.Api
{
    ...
    public partial class BatchProcessingApi : IBatchProcessingApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetBatchDataResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            ...
            { (HttpStatusCode)400, typeof(BatchErrorResponse) },
            { (HttpStatusCode)401, typeof(BatchErrorResponse) },
            { (HttpStatusCode)403, typeof(BatchErrorResponse) },
            { (HttpStatusCode)404, typeof(BatchErrorResponse) },
            { (HttpStatusCode)500, typeof(BatchErrorResponse) },
        };
        ...
        /// <returns></returns>
        public BatchProcessingApi(FactSet.SDK.FactSetFunds.Client.Configuration configuration)
        {
        ...
        public BatchProcessingApi(FactSet.SDK.FactSetFunds.Client.ISynchronousClient client, FactSet.SDK.FactSetFunds.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetFunds.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<BatchProcessingApi.GetBatchDataResponseWrapper> GetBatchDataWithHttpInfo(Guid id)
        {
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetFunds.Client.ClientUtils.ParameterToMultiMap("", "id", id));
            ...
            Object>("/factset-funds/v1/batch-result", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BatchProcessingApi.GetBatchDataResponseWrapper>> GetBatchDataWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/factset-funds/v1/batch-result", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<BatchStatusResponse> GetBatchStatusWithHttpInfo(Guid id)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            BatchStatusResponse>("/factset-funds/v1/batch-status", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BatchStatusResponse>> GetBatchStatusWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BatchStatusResponse>("/factset-funds/v1/batch-status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
