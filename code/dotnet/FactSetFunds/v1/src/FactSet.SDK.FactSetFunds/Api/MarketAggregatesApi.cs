...
namespace FactSet.SDK.FactSetFunds.Api
{
    ...
    public interface IMarketAggregatesApiSync : IApiAccessor
    {
        ...
        /// <returns>MarketAggregatesApi.GetMarketAggregatesResponseWrapper</returns>
        MarketAggregatesApi.GetMarketAggregatesResponseWrapper GetMarketAggregates(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string));
        ...
        /// <param name="currency">Controls the Currency conversion of the Fund. By default, the currency will use the funds local currency. For a list of currency ISO codes, visit Online Assistant Page [OA1470](https://my.apps.factset.com/oa/pages/1470).  (optional, default to &quot;LOCAL&quot;)</param>
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <returns>ApiResponse of MarketAggregatesApi.GetMarketAggregatesResponseWrapper</returns>
        ApiResponse<MarketAggregatesApi.GetMarketAggregatesResponseWrapper> GetMarketAggregatesWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string));
        /// <summary>
        /// Get market aggregates for a requested time series.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper</returns>
        MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper GetMarketAggregatesForList(MarketAggregatesRequest marketAggregatesRequest);
        ...
        /// <exception cref="FactSet.SDK.FactSetFunds.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="marketAggregatesRequest">The Market Aggregates request body, allowing the user to specify a list of ids and date range.</param>
        /// <returns>ApiResponse of MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper</returns>
        ApiResponse<MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper> GetMarketAggregatesForListWithHttpInfo(MarketAggregatesRequest marketAggregatesRequest);
    ...
    public interface IMarketAggregatesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MarketAggregatesApi.GetMarketAggregatesResponseWrapper> GetMarketAggregatesAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MarketAggregatesApi.GetMarketAggregatesResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<MarketAggregatesApi.GetMarketAggregatesResponseWrapper>> GetMarketAggregatesWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get market aggregates for a requested time series.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MarketAggregatesResponse</returns>
        System.Threading.Tasks.Task<MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper> GetMarketAggregatesForListAsync(MarketAggregatesRequest marketAggregatesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="marketAggregatesRequest">The Market Aggregates request body, allowing the user to specify a list of ids and date range.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper>> GetMarketAggregatesForListWithHttpInfoAsync(MarketAggregatesRequest marketAggregatesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MarketAggregatesApi : IMarketAggregatesApi
    {
        ...
        /// <item>
        /// <description>
        /// 200 : MarketAggregatesResponse<br />
        /// The Market Aggregates response object.
        /// </description>
        /// </item>
        /// 
        /// <item>
        ...
        /// </example>
        /// </summary>
        public class GetMarketAggregatesResponseWrapper {

            /// <summary>This constructor initializes the new GetMarketAggregatesResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetMarketAggregatesResponseWrapper(HttpStatusCode statusCode, object response)
            {
            ...
            /// The Market Aggregates response object.
            /// </summary>
            public MarketAggregatesResponse Response200
            {
                get
                {
                    ...
                    return (MarketAggregatesResponse) Response;
                }
            }
        ...
        /// </example>
        /// </summary>
        public class GetMarketAggregatesForListResponseWrapper {

            /// <summary>This constructor initializes the new GetMarketAggregatesForListResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetMarketAggregatesForListResponseWrapper(HttpStatusCode statusCode, object response)
            {
                StatusCode = statusCode;
                Response = response;
            }
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use batch status to see if the job has been completed. Once completed, retrieve the results of the request via batch-result.     (optional, default to N)</param>
        /// <returns>MarketAggregatesApi.GetMarketAggregatesResponseWrapper</returns>
        public MarketAggregatesApi.GetMarketAggregatesResponseWrapper GetMarketAggregates(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string))
        {
            var localVarResponse = GetMarketAggregatesWithHttpInfo(ids, startDate, endDate, frequency, currency, batch);
        ...
        public ApiResponse<MarketAggregatesApi.GetMarketAggregatesResponseWrapper> GetMarketAggregatesWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string))
        {
            ...
            Object>("/factset-funds/v1/aggregates/market", localVarRequestOptions, this.Configuration);
            ...
            var getmarketaggregatesResponse = new GetMarketAggregatesResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetMarketAggregatesResponseWrapper>(localVarResponse.StatusCode, getmarketaggregatesResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MarketAggregatesResponse</returns>
        public async System.Threading.Tasks.Task<MarketAggregatesApi.GetMarketAggregatesResponseWrapper>GetMarketAggregatesAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetMarketAggregatesWithHttpInfoAsync(ids, startDate, endDate, frequency, currency, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MarketAggregatesApi.GetMarketAggregatesResponseWrapper>> GetMarketAggregatesWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/factset-funds/v1/aggregates/market", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="marketAggregatesRequest">The Market Aggregates request body, allowing the user to specify a list of ids and date range.</param>
        /// <returns>MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper</returns>
        public MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper GetMarketAggregatesForList(MarketAggregatesRequest marketAggregatesRequest)
        {
        ...
        /// <param name="marketAggregatesRequest">The Market Aggregates request body, allowing the user to specify a list of ids and date range.</param>
        /// <returns>ApiResponse of MarketAggregatesResponse</returns>
        public ApiResponse<MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper> GetMarketAggregatesForListWithHttpInfo(MarketAggregatesRequest marketAggregatesRequest)
        {
            ...
            var getmarketaggregatesforlistResponse = new GetMarketAggregatesForListResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetMarketAggregatesForListResponseWrapper>(localVarResponse.StatusCode, getmarketaggregatesforlistResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MarketAggregatesResponse</returns>
        public async System.Threading.Tasks.Task<MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper>GetMarketAggregatesForListAsync(MarketAggregatesRequest marketAggregatesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MarketAggregatesApi.GetMarketAggregatesForListResponseWrapper>> GetMarketAggregatesForListWithHttpInfoAsync(MarketAggregatesRequest marketAggregatesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'marketAggregatesRequest' is set
            if (marketAggregatesRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/factset-funds/v1/aggregates/market", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
