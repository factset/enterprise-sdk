...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class GroupHoldingsRequest : IEquatable<GroupHoldingsRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="GroupHoldingsRequest" /> class.
        /// </summary>
        /// <param name="ids">The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs.  Request Limits:    - ids limit &#x3D; 1000 per request(Non batch)     - Batch requests:       * Single day: up to 3000 IDs per request       * Multi-day: up to 500 IDs per request         (required).</param>
        ...
        public GroupHoldingsRequest(List<string> ids,string asOfDate = default(string), Group group = default(Group), Batch batch = default(Batch))
        {
        ...
        /// <summary>
        /// The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs.  Request Limits:    - ids limit &#x3D; 1000 per request(Non batch)     - Batch requests:       * Single day: up to 3000 IDs per request       * Multi-day: up to 500 IDs per request        
        /// </summary>
        /// <value>The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs.  Request Limits:    - ids limit &#x3D; 1000 per request(Non batch)     - Batch requests:       * Single day: up to 3000 IDs per request       * Multi-day: up to 500 IDs per request        </value>
