...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class DistHistorical : IEquatable<DistHistorical>, IValidatableObject
    {
        ...
        /// <param name="nonQualifiedDividends">Qualified Dividends..</param>
        ...
        public DistHistorical(string fsymId = default(string), DateTime? date = default(DateTime?), string currency = default(string), double? totalDistributions = default(double?), double? returnOfCapital = default(double?), double? qualifiedDividends = default(double?), double? nonQualifiedDividends = default(double?), double? dailyAccruedDividends = default(double?), double? stCapitalGains = default(double?), double? ltCapitalGains = default(double?), double? sevenDayNetSecYield = default(double?), double? sevenDayGrossSecYield = default(double?), double? thirtyDayNetSecYield = default(double?), double? thirtyDayGrossSecYield = default(double?), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Date = date;
