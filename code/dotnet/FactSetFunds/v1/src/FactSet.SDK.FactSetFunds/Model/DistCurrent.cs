...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class DistCurrent : IEquatable<DistCurrent>, IValidatableObject
    {
        ...
        /// <param name="distFrequency">Distribution frequency..</param>
        /// <param name="ltmDistYield">Distribution yield for the last twelve months..</param>
        /// <param name="firstDistDate">The date of the funds first distribution in YYYY-MM-DD format..</param>
        ...
        public DistCurrent(string fsymId = default(string), DateTime? date = default(DateTime?), string currency = default(string), double? totalDistributions = default(double?), double? returnOfCapital = default(double?), double? qualifiedDividends = default(double?), double? nonQualifiedDividends = default(double?), double? dailyAccruedDividends = default(double?), double? stCapitalGains = default(double?), double? ltCapitalGains = default(double?), double? indicatedAnnualDividend = default(double?), string distFrequency = default(string), double? ltmDistYield = default(double?), DateTime? firstDistDate = default(DateTime?), double? sevenDayNetSecYield = default(double?), double? sevenDayGrossSecYield = default(double?), double? thirtyDayNetSecYield = default(double?), double? thirtyDayGrossSecYield = default(double?), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Date = date;
        ...
        /// </summary>
        /// <value>Distribution frequency.</value>
        [DataMember(Name = "distFrequency", EmitDefaultValue = true)]
        public string DistFrequency { get; set; }

        /// <summary>
        /// Distribution yield for the last twelve months.
        /// </summary>
        /// <value>Distribution yield for the last twelve months.</value>
        [DataMember(Name = "ltmDistYield", EmitDefaultValue = true)]
        public double? LtmDistYield { get; set; }
        ...
        [DataMember(Name = "firstDistDate", EmitDefaultValue = true)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime? FirstDistDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DistFrequency: ").Append(DistFrequency).Append("\n");
            sb.Append("  LtmDistYield: ").Append(LtmDistYield).Append("\n");
            sb.Append("  FirstDistDate: ").Append(FirstDistDate).Append("\n");
        ...
        public bool Equals(DistCurrent input)
        {
            ...
            return 
                ...
                (
                    this.DistFrequency == input.DistFrequency ||
                    (this.DistFrequency != null &&
                    this.DistFrequency.Equals(input.DistFrequency))
                ) && 
                (
                    this.LtmDistYield == input.LtmDistYield ||
                    (this.LtmDistYield != null &&
                    this.LtmDistYield.Equals(input.LtmDistYield))
                ) && 
                (
                    this.FirstDistDate == input.FirstDistDate ||
                    (this.FirstDistDate != null &&
                    this.FirstDistDate.Equals(input.FirstDistDate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DistFrequency != null)
                {
                    hashCode = (hashCode * 59) + this.DistFrequency.GetHashCode();
                }
                if (this.LtmDistYield != null)
                {
                    hashCode = (hashCode * 59) + this.LtmDistYield.GetHashCode();
                }
                if (this.FirstDistDate != null)
                {
                    hashCode = (hashCode * 59) + this.FirstDistDate.GetHashCode();
                }
