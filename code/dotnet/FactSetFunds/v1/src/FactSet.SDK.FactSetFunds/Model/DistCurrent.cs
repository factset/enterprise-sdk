...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class DistCurrent : IEquatable<DistCurrent>, IValidatableObject
    {
        ...
        /// <param name="nonQalifiedDividends">Non-Qualified Dividends..</param>
        ...
        public DistCurrent(string fsymId = default(string), DateTime? date = default(DateTime?), string currency = default(string), double? totalDistributions = default(double?), double? returnOfCapital = default(double?), double? qualifiedDividends = default(double?), double? nonQalifiedDividends = default(double?), double? dailyAccruedDividends = default(double?), double? stCapitalGains = default(double?), double? ltCapitalGains = default(double?), double? indicatedAnnualDividend = default(double?), string distFrequency = default(string), double? ltmDistYield = default(double?), DateTime? firstDistDate = default(DateTime?), double? sevenDayNetSecYield = default(double?), double? sevenDayGrossSecYield = default(double?), double? thirtyDayNetSecYield = default(double?), double? thirtyDayGrossSecYield = default(double?), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Date = date;
