...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Prices : IEquatable<Prices>, IValidatableObject
    {
        ...
        public Prices(string fsymId = default(string), double? price = default(double?), DateTime? date = default(DateTime?), string requestId = default(string), string currency = default(string))
        {
            this.FsymId = fsymId;
            this.Price = price;
            this.Date = date;
