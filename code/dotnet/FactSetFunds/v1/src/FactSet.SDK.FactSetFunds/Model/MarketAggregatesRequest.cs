...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class MarketAggregatesRequest : IEquatable<MarketAggregatesRequest>, IValidatableObject
    {
        ...
        public MarketAggregatesRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), string currency = "LOCAL")
        {
