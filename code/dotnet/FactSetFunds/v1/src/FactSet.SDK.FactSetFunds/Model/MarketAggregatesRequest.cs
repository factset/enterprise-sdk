...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "marketAggregatesRequest")]
    public partial class MarketAggregatesRequest : IEquatable<MarketAggregatesRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketAggregatesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MarketAggregatesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketAggregatesRequest" /> class.
        /// </summary>
        /// <param name="ids">The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs.  Request Limits:      - ids limit &#x3D; 1000 per request(Non batch)   - Batch requests:       * Single day: up to 5000 IDs per request       * Multi-day: up to 1500 IDs per request         (required).</param>
        ...
        public MarketAggregatesRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), string currency = "LOCAL", Batch batch = default(Batch))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for MarketAggregatesRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        /// </summary>
        /// <value>The requested fund identifier. FactSet Identifiers, tickers, CUSIP, SEDOL, and ISIN are accepted inputs.  Request Limits:      - ids limit &#x3D; 1000 per request(Non batch)   - Batch requests:       * Single day: up to 5000 IDs per request       * Multi-day: up to 1500 IDs per request        </value>
        ...
        {
            return this.Equals(input as MarketAggregatesRequest);
        }

        /// <summary>
        /// Returns true if MarketAggregatesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketAggregatesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketAggregatesRequest input)
        {
            if (input == null)
            {
                return false;
