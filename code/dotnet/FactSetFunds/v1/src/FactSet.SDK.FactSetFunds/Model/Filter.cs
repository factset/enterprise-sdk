...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Filter : IEquatable<Filter>, IValidatableObject
    {
        ...
        public Filter(List<Criterion> criteria,JoinType joinType = default(JoinType))
        {
            // to ensure "criteria" is required (not null)
            if (criteria == null) {
                throw new ArgumentNullException("criteria is a required property for Filter and cannot be null");
            }
