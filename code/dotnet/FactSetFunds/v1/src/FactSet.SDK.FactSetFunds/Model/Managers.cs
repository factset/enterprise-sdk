...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Managers : IEquatable<Managers>, IValidatableObject
    {
        ...
        public Managers(string fsymId = default(string), string managerName = default(string), string managerTitle = default(string), string managerPhone = default(string), string managerInceptionDate = default(string), int managerJobId = default(int), string requestId = default(string))
        {
            this.FsymId = fsymId;
        ...
        [DataMember(Name = "managerTitle", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "managerInceptionDate", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public string ManagerInceptionDate { get; set; }

        /// <summary>
        /// Job Identifier for the Fund Manager
        /// </summary>
        /// <value>Job Identifier for the Fund Manager</value>
        [DataMember(Name = "managerJobId", EmitDefaultValue = false)]
