...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "statusesRequest")]
    public partial class StatusesRequest : IEquatable<StatusesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatusesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusesRequest" /> class.
        /// </summary>
        ...
        public StatusesRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for StatusesRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as StatusesRequest);
        }

        /// <summary>
        /// Returns true if StatusesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusesRequest input)
        {
            if (input == null)
            {
                return false;
