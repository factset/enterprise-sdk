...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Summaries : IEquatable<Summaries>, IValidatableObject
    {
        ...
        /// <param name="issuerLegacyName">The Issuer Legacy Name in proper format..</param>
        ...
        /// </summary>
        /// <value>The Issuer Legacy Name in proper format.</value>
        [DataMember(Name = "issuerLegacyName", EmitDefaultValue = true)]
        public string IssuerLegacyName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IssuerLegacyName: ").Append(IssuerLegacyName).Append("\n");
        ...
        public bool Equals(Summaries input)
        {
            ...
            return 
                ...
                (
                    this.IssuerLegacyName == input.IssuerLegacyName ||
                    (this.IssuerLegacyName != null &&
                    this.IssuerLegacyName.Equals(input.IssuerLegacyName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IssuerLegacyName != null)
                {
                    hashCode = (hashCode * 59) + this.IssuerLegacyName.GetHashCode();
                }
