...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Flows : IEquatable<Flows>, IValidatableObject
    {
        ...
        public Flows(string fsymId = default(string), double? fundFlows = default(double?), string currency = default(string), DateTime? date = default(DateTime?), string requestId = default(string))
        {
            this.FsymId = fsymId;
