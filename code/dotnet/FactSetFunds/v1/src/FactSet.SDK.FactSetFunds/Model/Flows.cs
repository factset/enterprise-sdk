...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Flows : IEquatable<Flows>, IValidatableObject
    {
        ...
        public Flows(string fsymId = default(string), double fundFlows = default(double), string currency = default(string), string date = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
