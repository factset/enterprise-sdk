...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Returns : IEquatable<Returns>, IValidatableObject
    {
        ...
        public Returns(string fsymId = default(string), double _return = default(double), string date = default(string), string currency = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Return = _return;
            this.Date = date;
