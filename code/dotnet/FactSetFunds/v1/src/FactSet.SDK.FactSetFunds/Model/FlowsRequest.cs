...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// Flows Request Body
    /// </summary>
    [DataContract(Name = "flowsRequest")]
    public partial class FlowsRequest : IEquatable<FlowsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowsRequest" /> class.
        /// </summary>
        ...
        public FlowsRequest(List<string> ids = default(List<string>), string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), string currency = "LOCAL")
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for FlowsRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as FlowsRequest);
        }

        /// <summary>
        /// Returns true if FlowsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowsRequest input)
        {
            if (input == null)
            {
                return false;
