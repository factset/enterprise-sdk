...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "benchmarkDetailsRequest")]
    public partial class BenchmarkDetailsRequest : IEquatable<BenchmarkDetailsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BenchmarkDetailsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BenchmarkDetailsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BenchmarkDetailsRequest" /> class.
        /// </summary>
        ...
        public BenchmarkDetailsRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BenchmarkDetailsRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BenchmarkDetailsRequest {\n");
        ...
        {
            return this.Equals(input as BenchmarkDetailsRequest);
        }

        /// <summary>
        /// Returns true if BenchmarkDetailsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BenchmarkDetailsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BenchmarkDetailsRequest input)
        {
            if (input == null)
            {
                return false;
