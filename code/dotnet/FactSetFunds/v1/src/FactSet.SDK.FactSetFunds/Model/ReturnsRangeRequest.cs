...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class ReturnsRangeRequest : IEquatable<ReturnsRangeRequest>, IValidatableObject
    {
        ...
        public ReturnsRangeRequest(List<string> ids,string startDate = default(string), string endDate = default(string), DividendAdjust dividendAdjust = default(DividendAdjust))
        {
            ...
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for ReturnsRangeRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        /// </summary>
        /// <value>The start date requested for a given date range in YYYY-MM-DD format. If left blank, the API will default to the day prior to today&#39;s previous close. The startDate cannot be equal to the endDate as no return can be computed. Additionally, the startDate MUST be equal to or greater than the &#x60;priceFirstDate&#x60; found within the /summary endpoint. </value>
