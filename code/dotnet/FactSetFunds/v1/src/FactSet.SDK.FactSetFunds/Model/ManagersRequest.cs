...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "managersRequest")]
    public partial class ManagersRequest : IEquatable<ManagersRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagersRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManagersRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagersRequest" /> class.
        /// </summary>
        ...
        public ManagersRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for ManagersRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManagersRequest {\n");
        ...
        {
            return this.Equals(input as ManagersRequest);
        }

        /// <summary>
        /// Returns true if ManagersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagersRequest input)
        {
            if (input == null)
            {
                return false;
