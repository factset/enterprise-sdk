...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class ReturnsRange : IEquatable<ReturnsRange>, IValidatableObject
    {
        ...
        public ReturnsRange(string fsymId = default(string), double? _return = default(double?), DateTime? returnStartDate = default(DateTime?), DateTime? returnEndDate = default(DateTime?), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Return = _return;
