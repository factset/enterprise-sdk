...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class DistHistoricalRequest : IEquatable<DistHistoricalRequest>, IValidatableObject
    {
        ...
        /// <param name="distributionOrYield">distributionOrYield.</param>
        public DistHistoricalRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), string currency = "LOCAL", bool splitAdjust = true, DistributionOrYieldDist distributionOrYield = default(DistributionOrYieldDist))
        {
        ...
        /// <summary>
        /// Gets or Sets DistributionOrYield
        /// </summary>
        [DataMember(Name = "distributionOrYield", EmitDefaultValue = false)]
        public DistributionOrYieldDist DistributionOrYield { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DistributionOrYield: ").Append(DistributionOrYield).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(DistHistoricalRequest input)
        {
            ...
            return 
                ...
                (
                    this.DistributionOrYield == input.DistributionOrYield ||
                    (this.DistributionOrYield != null &&
                    this.DistributionOrYield.Equals(input.DistributionOrYield))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DistributionOrYield != null)
                {
                    hashCode = (hashCode * 59) + this.DistributionOrYield.GetHashCode();
                }
                return hashCode;
            }
        }
