...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class ReturnsSnapshot : IEquatable<ReturnsSnapshot>, IValidatableObject
    {
        ...
        public ReturnsSnapshot(string fsymId = default(string), double? oneWeek = default(double?), double? oneMonth = default(double?), double? threeMonth = default(double?), double? yearToDate = default(double?), double? oneYear = default(double?), double? threeYear = default(double?), double? threeYearAnnualized = default(double?), double? fiveYear = default(double?), double? fiveYearAnnualized = default(double?), DateTime? date = default(DateTime?), string requestId = default(string))
        {
            this.FsymId = fsymId;
