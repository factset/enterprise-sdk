...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "relatedFundsRequest")]
    public partial class RelatedFundsRequest : IEquatable<RelatedFundsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedFundsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RelatedFundsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedFundsRequest" /> class.
        /// </summary>
        ...
        public RelatedFundsRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for RelatedFundsRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as RelatedFundsRequest);
        }

        /// <summary>
        /// Returns true if RelatedFundsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RelatedFundsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedFundsRequest input)
        {
            if (input == null)
            {
                return false;
