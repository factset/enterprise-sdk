...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    /// </summary>
    [DataContract(Name = "classificationsRequest")]
    public partial class ClassificationsRequest : IEquatable<ClassificationsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClassificationsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClassificationsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClassificationsRequest" /> class.
        /// </summary>
        ...
        public ClassificationsRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for ClassificationsRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as ClassificationsRequest);
        }

        /// <summary>
        /// Returns true if ClassificationsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClassificationsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClassificationsRequest input)
        {
            if (input == null)
            {
                return false;
