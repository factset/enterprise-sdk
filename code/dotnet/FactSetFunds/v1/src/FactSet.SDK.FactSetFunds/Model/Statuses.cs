...
namespace FactSet.SDK.FactSetFunds.Model
{
    ...
    public partial class Statuses : IEquatable<Statuses>, IValidatableObject
    {
        ...
        /// <param name="isonFFD">Returns a binary indicator of whether the specified fund is available in the FactSet Funds Database (FFD)..</param>
        /// <param name="requestId">The requested Id sent as input..</param>
        public Statuses(string fsymId = default(string), int? activeFlag = default(int?), int? shrClassActiveFlag = default(int?), int? isonFFD = default(int?), string requestId = default(string))
        {
            this.FsymId = fsymId;
        ...
        /// </summary>
        /// <value>Returns a binary indicator of whether the specified fund is available in the FactSet Funds Database (FFD).</value>
        [DataMember(Name = "isonFFD", EmitDefaultValue = true)]
        public int? IsonFFD { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsonFFD: ").Append(IsonFFD).Append("\n");
        ...
        public bool Equals(Statuses input)
        {
            ...
            return 
                ...
                (
                    this.IsonFFD == input.IsonFFD ||
                    (this.IsonFFD != null &&
                    this.IsonFFD.Equals(input.IsonFFD))
                ) && 
                (
