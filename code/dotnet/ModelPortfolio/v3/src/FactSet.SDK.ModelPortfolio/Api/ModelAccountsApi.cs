...
namespace FactSet.SDK.ModelPortfolio.Api
{
    ...
    public partial class ModelAccountsApi : IModelAccountsApi
    {
        ...
        {
            this.Configuration = FactSet.SDK.ModelPortfolio.Client.Configuration.MergeConfigurations(
                FactSet.SDK.ModelPortfolio.Client.GlobalConfiguration.Instance,
                new FactSet.SDK.ModelPortfolio.Client.Configuration { BasePath = basePath }
            );
            this.Client = new FactSet.SDK.ModelPortfolio.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new FactSet.SDK.ModelPortfolio.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = FactSet.SDK.ModelPortfolio.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public ModelAccountsApi(FactSet.SDK.ModelPortfolio.Client.Configuration configuration)
        {
            ...
            this.Client = new FactSet.SDK.ModelPortfolio.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new FactSet.SDK.ModelPortfolio.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = FactSet.SDK.ModelPortfolio.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public ModelAccountsApi(FactSet.SDK.ModelPortfolio.Client.ISynchronousClient client, FactSet.SDK.ModelPortfolio.Client.IAsynchronousClient asyncClient, FactSet.SDK.ModelPortfolio.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public FactSet.SDK.ModelPortfolio.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public FactSet.SDK.ModelPortfolio.Client.ISynchronousClient Client { get; set; }
        ...
        public FactSet.SDK.ModelPortfolio.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public FactSet.SDK.ModelPortfolio.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse<string> GetAccountForDateWithHttpInfo(string name, string date, string format = default(string))
        {
            ...
            if (format != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.ModelPortfolio.Client.ClientUtils.ParameterToMultiMap("", "format", format));
            }
