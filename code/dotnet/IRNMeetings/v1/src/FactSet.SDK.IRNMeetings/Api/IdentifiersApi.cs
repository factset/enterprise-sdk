...
namespace FactSet.SDK.IRNMeetings.Api
{
    ...
    public partial class IdentifiersApi : IIdentifiersApi
    {
        ...
        /// <returns></returns>
        public IdentifiersApi(FactSet.SDK.IRNMeetings.Client.Configuration configuration)
        {
        ...
        public IdentifiersApi(FactSet.SDK.IRNMeetings.Client.ISynchronousClient client, FactSet.SDK.IRNMeetings.Client.IAsynchronousClient asyncClient, FactSet.SDK.IRNMeetings.Client.IReadableConfiguration configuration)
        {
        ...
        {
            FactSet.SDK.IRNMeetings.Client.ApiResponse<List<IdentifierResolutionDto>> localVarResponse = GetIdentifiersWithHttpInfo(identifiers);
        ...
        /// <param name="identifiers">Identifiers (optional)</param>
        /// <returns>ApiResponse of List&lt;IdentifierResolutionDto&gt;</returns>
        public FactSet.SDK.IRNMeetings.Client.ApiResponse<List<IdentifierResolutionDto>> GetIdentifiersWithHttpInfo(string identifiers = default(string))
        {
            ...
            if (identifiers != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.IRNMeetings.Client.ClientUtils.ParameterToMultiMap("", "identifiers", identifiers));
            }
        ...
        {
            FactSet.SDK.IRNMeetings.Client.ApiResponse<List<IdentifierResolutionDto>> localVarResponse = await GetIdentifiersWithHttpInfoAsync(identifiers, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;IdentifierResolutionDto&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.IRNMeetings.Client.ApiResponse<List<IdentifierResolutionDto>>> GetIdentifiersWithHttpInfoAsync(string identifiers = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
