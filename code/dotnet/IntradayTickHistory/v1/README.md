...
# Intraday Tick History client library for .NET

[![Nuget](https://img.shields.io/nuget/v/FactSet.SDK.IntradayTickHistory)](https://www.nuget.org/packages/FactSet.SDK.IntradayTickHistory)
...
dotnet add package FactSet.SDK.IntradayTickHistory
```
...
nuget install FactSet.SDK.IntradayTickHistory
```
