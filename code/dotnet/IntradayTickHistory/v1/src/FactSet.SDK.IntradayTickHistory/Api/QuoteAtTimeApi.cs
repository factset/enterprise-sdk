...
namespace FactSet.SDK.IntradayTickHistory.Api
{
    ...
    public partial class QuoteAtTimeApi : IQuoteAtTimeApi
    {
        ...
        /// <returns></returns>
        public QuoteAtTimeApi(FactSet.SDK.IntradayTickHistory.Client.Configuration configuration)
        {
        ...
        public QuoteAtTimeApi(FactSet.SDK.IntradayTickHistory.Client.ISynchronousClient client, FactSet.SDK.IntradayTickHistory.Client.IAsynchronousClient asyncClient, FactSet.SDK.IntradayTickHistory.Client.IReadableConfiguration configuration)
        {
