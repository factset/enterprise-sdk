...
namespace FactSet.SDK.IntradayTickHistory.Api
{
    ...
    public partial class TradesAtTimeApi : ITradesAtTimeApi
    {
        ...
        /// <returns></returns>
        public TradesAtTimeApi(FactSet.SDK.IntradayTickHistory.Client.Configuration configuration)
        {
        ...
        public TradesAtTimeApi(FactSet.SDK.IntradayTickHistory.Client.ISynchronousClient client, FactSet.SDK.IntradayTickHistory.Client.IAsynchronousClient asyncClient, FactSet.SDK.IntradayTickHistory.Client.IReadableConfiguration configuration)
        {
