# FactSet.SDK.IntradayTickHistory.Api.TradesAtTimeApi
...
namespace Example
{
    public class TickHistoryTradesattimeGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.IntradayTickHistory.Client.Configuration();
            ...
            var apiInstance = new TradesAtTimeApi(config);
            ...
            {
                Console.WriteLine("Exception when calling TradesAtTimeApi.TickHistoryTradesattimeGet: " + e.Message );
