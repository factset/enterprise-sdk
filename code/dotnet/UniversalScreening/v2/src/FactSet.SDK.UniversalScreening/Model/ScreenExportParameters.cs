...
namespace FactSet.SDK.UniversalScreening.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenExportParameters")]
    public partial class ScreenExportParameters : IEquatable<ScreenExportParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenExportParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenExportParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenExportParameters" /> class.
        /// </summary>
        ...
        public ScreenExportParametersData Data { get; set; }
        ...
        {
            return this.Equals(input as ScreenExportParameters);
        }

        /// <summary>
        /// Returns true if ScreenExportParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenExportParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenExportParameters input)
        {
            if (input == null)
            {
                return false;
