...
namespace FactSet.SDK.UniversalScreening.Model
{
    ...
    public partial class ScreenCalcParametersData : IEquatable<ScreenCalcParametersData>, IValidatableObject
    {
        ...
        public ScreenCalcParametersData(string screenName,string backtestDate = default(string), Dictionary<string, string> globalVariablesMap = default(Dictionary<string, string>), LegacyUniverseTypeEnum? legacyUniverseType = LegacyUniverseTypeEnum.Equity)
        {
