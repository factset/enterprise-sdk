...
namespace FactSet.SDK.UniversalScreening.Model
{
    ...
    public partial class ErrorObject : IEquatable<ErrorObject>, IValidatableObject
    {
        ...
        public ErrorObject(ErrorCode code = default(ErrorCode), Guid id = default(Guid), ErrorObjectSource source = default(ErrorObjectSource), string title = default(string))
        {
            this.Code = code;
            this.Id = id;
            this.Source = source;
