...
[![Nuget](https://img.shields.io/badge/nuget-v1.3.0-orange)](https://www.nuget.org/packages/FactSet.SDK.UniversalScreening/1.3.0)
...
dotnet add package FactSet.SDK.UniversalScreening -v 1.3.0
```
...
nuget install FactSet.SDK.UniversalScreening -Version 1.3.0
```
...
*ScreeningOperationsApi* | [**GetExportResults**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/ScreeningOperationsApi.md#getexportresults) | **GET** /job/{id}/export | 
...
*ScreeningOperationsApi* | [**SubmitExport**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/ScreeningOperationsApi.md#submitexport) | **POST** /job/export | 
...
## Documentation for Models
 ...
 - [Model.CalculateMetadata](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/CalculateMetadata.md)
 - [Model.DelimitedOptions](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/DelimitedOptions.md)
 ...
 - [Model.ExcelOptions](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/ExcelOptions.md)
 - [Model.GroupingInfo](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/GroupingInfo.md)
 ...
 - [Model.PdfOptions](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/PdfOptions.md)
 ...
 - [Model.ScreenExportParameters](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/ScreenExportParameters.md)
 - [Model.ScreenExportParametersData](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/ScreenExportParametersData.md)
 - [Model.SubmitExportResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/SubmitExportResponse.md)
 - [Model.SubmitExportResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/UniversalScreening/v2/docs/SubmitExportResponseData.md)
