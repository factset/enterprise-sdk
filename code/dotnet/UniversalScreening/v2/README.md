...
[![Nuget](https://img.shields.io/badge/nuget-v1.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.UniversalScreening/1.2.0)
...
dotnet add package FactSet.SDK.UniversalScreening -v 1.2.0
```
...
nuget install FactSet.SDK.UniversalScreening -Version 1.2.0
```
