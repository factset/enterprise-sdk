...
[![Nuget](https://img.shields.io/badge/nuget-v0.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.BookBuilder/0.1.0)
...
dotnet add package FactSet.SDK.BookBuilder -v 0.1.0
```
...
nuget install FactSet.SDK.BookBuilder -Version 0.1.0
```
