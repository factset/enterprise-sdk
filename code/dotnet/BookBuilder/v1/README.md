...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.BookBuilder/1.0.0)
...
dotnet add package FactSet.SDK.BookBuilder -v 1.0.0
```
...
nuget install FactSet.SDK.BookBuilder -Version 1.0.0
```
