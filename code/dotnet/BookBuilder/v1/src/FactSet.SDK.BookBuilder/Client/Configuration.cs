...
namespace FactSet.SDK.BookBuilder.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/BookBuilder/0.1.1";
            BasePath = "https://api.factset.com/book-builder-api/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/book-builder-api/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.BookBuilder) Debug Report:\n";
