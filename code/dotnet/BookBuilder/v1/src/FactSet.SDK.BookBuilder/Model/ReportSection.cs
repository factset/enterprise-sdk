...
namespace FactSet.SDK.BookBuilder.Model
{
    ...
    /// ReportSection
    /// </summary>
    [DataContract(Name = "Report_Section")]
    public partial class ReportSection : IEquatable<ReportSection>, IValidatableObject
    {
        /// <summary>
        /// Defines SectionId
        /// </summary>
        ...
        public ReportSection(SectionIdEnum? sectionId = default(SectionIdEnum?), List<ReportsEnum> reports = default(List<ReportsEnum>))
        {
        ...
        {
            return this.Equals(input as ReportSection);
        }

        /// <summary>
        /// Returns true if ReportSection instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportSection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportSection input)
        {
            if (input == null)
            {
                return false;
