...
namespace FactSet.SDK.BookBuilder.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Available_Reports_List")]
    public partial class AvailableReportsList : IEquatable<AvailableReportsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailableReportsList" /> class.
        /// </summary>
        /// <param name="data">A list of sections and their associated reports..</param>
        public AvailableReportsList(List<ReportSection> data = default(List<ReportSection>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>A list of sections and their associated reports.</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<ReportSection> Data { get; set; }
        ...
        {
            return this.Equals(input as AvailableReportsList);
        }

        /// <summary>
        /// Returns true if AvailableReportsList instances are equal
        /// </summary>
        /// <param name="input">Instance of AvailableReportsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AvailableReportsList input)
        {
            if (input == null)
            {
                return false;
