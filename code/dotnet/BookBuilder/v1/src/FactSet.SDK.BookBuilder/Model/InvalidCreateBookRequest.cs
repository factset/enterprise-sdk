...
namespace FactSet.SDK.BookBuilder.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Invalid_Create_Book_Request")]
    public partial class InvalidCreateBookRequest : IEquatable<InvalidCreateBookRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidCreateBookRequest" /> class.
        /// </summary>
        /// <param name="message">Invalid Request Message.</param>
        public InvalidCreateBookRequest(string message = default(string))
        {
        ...
        {
            return this.Equals(input as InvalidCreateBookRequest);
        }

        /// <summary>
        /// Returns true if InvalidCreateBookRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidCreateBookRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidCreateBookRequest input)
        {
            if (input == null)
            {
                return false;
