...
namespace FactSet.SDK.BookBuilder.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Enable_Book_Info")]
    public partial class EnableBookInfo : IEquatable<EnableBookInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableBookInfo" /> class.
        /// </summary>
        /// <param name="bookName">Report Name.</param>
        /// <param name="bookId">Book ID.</param>
        /// <param name="estimatedTime">Estimated time in sec to create the book.</param>
        public EnableBookInfo(string bookName = default(string), string bookId = default(string), int estimatedTime = default(int))
        {
        ...
        {
            return this.Equals(input as EnableBookInfo);
        }

        /// <summary>
        /// Returns true if EnableBookInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of EnableBookInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnableBookInfo input)
        {
            if (input == null)
            {
                return false;
