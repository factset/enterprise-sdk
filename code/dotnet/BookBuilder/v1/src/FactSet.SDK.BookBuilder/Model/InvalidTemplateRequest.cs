...
namespace FactSet.SDK.BookBuilder.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Invalid_Template_Request")]
    public partial class InvalidTemplateRequest : IEquatable<InvalidTemplateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidTemplateRequest" /> class.
        /// </summary>
        /// <param name="message">Invalid request message.</param>
        public InvalidTemplateRequest(string message = default(string))
        {
        ...
        {
            return this.Equals(input as InvalidTemplateRequest);
        }

        /// <summary>
        /// Returns true if InvalidTemplateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidTemplateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidTemplateRequest input)
        {
            if (input == null)
            {
                return false;
