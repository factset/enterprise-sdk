...
namespace FactSet.SDK.BookBuilder.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateContentSection")]
    public partial class TemplateContentSection : IEquatable<TemplateContentSection>, IValidatableObject
    {
        /// <summary>
        /// The identifier for the section, like COMPANY_OVERVIEW.
        /// </summary>
        /// <value>The identifier for the section, like COMPANY_OVERVIEW.</value>
        ...
        /// </summary>
        /// <value>A list of reports to be included in the section.</value>
        [DataMember(Name = "reports", EmitDefaultValue = false)]
        public List<ReportsEnum> Reports { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateContentSection" /> class.
        /// </summary>
        /// <param name="sectionId">The identifier for the section, like COMPANY_OVERVIEW..</param>
        /// <param name="reports">A list of reports to be included in the section..</param>
        public TemplateContentSection(SectionIdEnum? sectionId = default(SectionIdEnum?), List<ReportsEnum> reports = default(List<ReportsEnum>))
        {
        ...
        {
            return this.Equals(input as TemplateContentSection);
        }

        /// <summary>
        /// Returns true if TemplateContentSection instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateContentSection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateContentSection input)
        {
            if (input == null)
            {
                return false;
