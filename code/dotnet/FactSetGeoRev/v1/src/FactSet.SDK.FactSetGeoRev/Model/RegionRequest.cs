...
namespace FactSet.SDK.FactSetGeoRev.Model
{
    ...
    public partial class RegionRequest : IEquatable<RegionRequest>, IValidatableObject
    {
        ...
        public RegionRequest(List<string> ids = default(List<string>), List<string> regionIds = default(List<string>), string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), string currency = default(string))
        {
