...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.10-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetGeoRev/1.0.10)
...
dotnet add package FactSet.SDK.FactSetGeoRev -v 1.0.10
```
...
nuget install FactSet.SDK.FactSetGeoRev -Version 1.0.10
```
...
------------ | ------------- | ------------- | -------------
*CountriesApi* | [**GetCountries**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/CountriesApi.md#getcountries) | **GET** /factset-georev/v1/countries | Gets the revenue details for the requested Countries.
*CountriesApi* | [**GetCountriesForList**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/CountriesApi.md#getcountriesforlist) | **POST** /factset-georev/v1/countries | Gets the revenue details for the requested Countries. Use for large lists of ids.
*RegionsApi* | [**GetRegions**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/RegionsApi.md#getregions) | **GET** /factset-georev/v1/regions | Gets the revenue details for the requested Regions
*RegionsApi* | [**GetRegionsForList**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/RegionsApi.md#getregionsforlist) | **POST** /factset-georev/v1/regions | Gets the revenue details for the requested Regions. Use for large lists of company ids.


## Documentation for Models

 - [Model.Country](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/Country.md)
 - [Model.CountryRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/CountryRequest.md)
 - [Model.CountryResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/CountryResponse.md)
 - [Model.ErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/ErrorResponse.md)
 - [Model.ErrorResponseSubErrors](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/ErrorResponseSubErrors.md)
 - [Model.Frequency](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/Frequency.md)
 - [Model.Region](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/Region.md)
 - [Model.RegionRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/RegionRequest.md)
 - [Model.RegionResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGeoRev/v1/docs/RegionResponse.md)
