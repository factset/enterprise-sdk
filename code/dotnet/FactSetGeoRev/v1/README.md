...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetGeoRev/2.0.0)
...
dotnet add package FactSet.SDK.FactSetGeoRev -v 2.0.0
```
...
nuget install FactSet.SDK.FactSetGeoRev -Version 2.0.0
```
