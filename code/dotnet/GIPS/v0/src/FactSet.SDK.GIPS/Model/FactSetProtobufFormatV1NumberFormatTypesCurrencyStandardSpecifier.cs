...
namespace FactSet.SDK.GIPS.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FactSet.Protobuf.Format.V1.NumberFormat.Types.CurrencyStandardSpecifier")]
    public partial class FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier : IEquatable<FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier" /> class.
        /// </summary>
        ...
        public FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier(int decimalDigits = default(int), string decimalSeparator = default(string), string groupSeparator = default(string), List<int> groupSizes = default(List<int>), string negativePattern = default(string), string positivePattern = default(string))
        {
        ...
        {
            return this.Equals(input as FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier);
        }

        /// <summary>
        /// Returns true if FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier instances are equal
        /// </summary>
        /// <param name="input">Instance of FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FactSetProtobufFormatV1NumberFormatTypesCurrencyStandardSpecifier input)
        {
            if (input == null)
            {
                return false;
