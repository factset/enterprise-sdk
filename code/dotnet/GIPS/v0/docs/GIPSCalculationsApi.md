# FactSet.SDK.GIPS.Api.GIPSCalculationsApi
...
<a name="gipsgetallcalculations"></a>
# **GipsGetAllCalculations**
> CalculationsSummaryRoot GipsGetAllCalculations (int? pageNumber = null)
...
namespace Example
{
    public class GipsGetAllCalculationsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.GIPS.Client.Configuration();
            ...
            var pageNumber = 1;  // int? | Page number to be viewed (optional)  (default to 1)
            ...
            {
                Console.WriteLine("Exception when calling GIPSCalculationsApi.GipsGetAllCalculations: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pageNumber** | **int?**| Page number to be viewed | [optional] [default to 1]
...
<a name="gipsgetcalculationstatusbyid"></a>
...
namespace Example
{
    public class GipsGetCalculationStatusByIdExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.GIPS.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling GIPSCalculationsApi.GipsGetCalculationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="gipsgetcalculationunitresultbyid"></a>
...
namespace Example
{
    public class GipsGetCalculationUnitResultByIdExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.GIPS.Client.Configuration();
            ...
            var id = "id_example";  // string | from url, provided from the location header in the Get GIPS calculation status by id endpoint
            var unitId = "unitId_example";  // string | from url, provided from the location header in the Get GIPS calculation status by id endpoint
            ...
            {
                Console.WriteLine("Exception when calling GIPSCalculationsApi.GipsGetCalculationUnitResultById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="gipspostandcalculate"></a>
# **GipsPostAndCalculate**
> CalculationStatusRoot GipsPostAndCalculate (int? xFactSetApiLongRunningDeadline = null, string cacheControl = null, GIPSCalculationParametersRoot gIPSCalculationParametersRoot = null)
...
namespace Example
{
    public class GipsPostAndCalculateExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.GIPS.Client.Configuration();
            ...
            var xFactSetApiLongRunningDeadline = 20;  // int? | The number of seconds the request will wait before sending back the response. If not provided, 20 will be used as default. (optional) 
            var cacheControl = "max-stale=0";  // string | Standard HTTP header.  Accepts max-stale. (optional) 
            var gIPSCalculationParametersRoot = new GIPSCalculationParametersRoot(); // GIPSCalculationParametersRoot | The request body contains the information needed to run a calculation, e.g. the GIPS composite. See the schema for more details. (optional) 
            ...
            {
                Console.WriteLine("Exception when calling GIPSCalculationsApi.GipsPostAndCalculate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **xFactSetApiLongRunningDeadline** | **int?**| The number of seconds the request will wait before sending back the response. If not provided, 20 will be used as default. | [optional] 
