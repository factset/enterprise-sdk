...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.PortfolioReportingBatcher/2.0.0)
...
dotnet add package FactSet.SDK.PortfolioReportingBatcher -v 2.0.0
```
...
nuget install FactSet.SDK.PortfolioReportingBatcher -Version 2.0.0
```
