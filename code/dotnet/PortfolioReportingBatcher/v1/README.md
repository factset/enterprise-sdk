...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.PortfolioReportingBatcher/2.1.0)
...
dotnet add package FactSet.SDK.PortfolioReportingBatcher -v 2.1.0
```
...
nuget install FactSet.SDK.PortfolioReportingBatcher -Version 2.1.0
```
