...
[![Nuget](https://img.shields.io/badge/nuget-v0.24.0-orange)](https://www.nuget.org/packages/FactSet.SDK.PortfolioReportingBatcher/0.24.0)
...
dotnet add package FactSet.SDK.PortfolioReportingBatcher -v 0.24.0
```
...
nuget install FactSet.SDK.PortfolioReportingBatcher -Version 0.24.0
```
