...
[![Nuget](https://img.shields.io/badge/nuget-v1.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.PortfolioReportingBatcher/1.1.0)
...
dotnet add package FactSet.SDK.PortfolioReportingBatcher -v 1.1.0
```
...
nuget install FactSet.SDK.PortfolioReportingBatcher -Version 1.1.0
```
