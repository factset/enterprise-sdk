...
namespace FactSet.SDK.PortfolioReportingBatcher.Api
{
    ...
    public interface IJobsApiSync : IApiAccessor
    {
        ...
        JobDetailsResponse V1GetDetailsForJob(JobTypes type, string name, List<string> attribute = default(List<string>));
        ...
        ApiResponse<JobDetailsResponse> V1GetDetailsForJobWithHttpInfo(JobTypes type, string name, List<string> attribute = default(List<string>));
        /// <summary>
        ...
        JobListResponse V1GetPrbJobs(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?));
        ...
        ApiResponse<JobListResponse> V1GetPrbJobsWithHttpInfo(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?));
    ...
    public interface IJobsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<JobDetailsResponse> V1GetDetailsForJobAsync(JobTypes type, string name, List<string> attribute = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<JobDetailsResponse>> V1GetDetailsForJobWithHttpInfoAsync(JobTypes type, string name, List<string> attribute = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a list of existing jobs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<JobListResponse> V1GetPrbJobsAsync(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<JobListResponse>> V1GetPrbJobsWithHttpInfoAsync(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class JobsApi : IJobsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> V1GetDetailsForJobResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> V1GetPrbJobsResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        /// <param name="attribute">The attribute parameter accepts a list of the given enums, separated by commas. Each of them returns the respective data associated with the job. Runs returns the run history of the job. (optional)</param>
        /// <returns>JobDetailsResponse</returns>
        public JobDetailsResponse V1GetDetailsForJob(JobTypes type, string name, List<string> attribute = default(List<string>))
        {
            var localVarResponse = V1GetDetailsForJobWithHttpInfo(type, name, attribute);
        ...
        /// <param name="attribute">The attribute parameter accepts a list of the given enums, separated by commas. Each of them returns the respective data associated with the job. Runs returns the run history of the job. (optional)</param>
        /// <returns>ApiResponse of JobDetailsResponse</returns>
        public ApiResponse<JobDetailsResponse> V1GetDetailsForJobWithHttpInfo(JobTypes type, string name, List<string> attribute = default(List<string>))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new FactSet.SDK.PortfolioReportingBatcher.Client.ApiException(400, "Missing required parameter 'name' when calling JobsApi->V1GetDetailsForJob");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = V1GetDetailsForJobResponseTypeDictionary;
            ...
            {
                Exception _exception = this.ExceptionFactory("V1GetDetailsForJob", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JobDetailsResponse</returns>
        public async System.Threading.Tasks.Task<JobDetailsResponse>V1GetDetailsForJobAsync(JobTypes type, string name, List<string> attribute = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await V1GetDetailsForJobWithHttpInfoAsync(type, name, attribute, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<JobDetailsResponse>> V1GetDetailsForJobWithHttpInfoAsync(JobTypes type, string name, List<string> attribute = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
        ...
        /// <param name="paginationLimit">The number of jobs to bring back (maximum 50) (optional)</param>
        /// <returns>JobListResponse</returns>
        public JobListResponse V1GetPrbJobs(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?))
        {
            var localVarResponse = V1GetPrbJobsWithHttpInfo(type, name, paginationOffset, paginationLimit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="paginationLimit">The number of jobs to bring back (maximum 50) (optional)</param>
        /// <returns>ApiResponse of JobListResponse</returns>
        public ApiResponse<JobListResponse> V1GetPrbJobsWithHttpInfo(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?))
        {
            FactSet.SDK.PortfolioReportingBatcher.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.PortfolioReportingBatcher.Client.RequestOptions();
            ...
            localVarRequestOptions.ResponseTypeDictionary = V1GetPrbJobsResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("V1GetPrbJobs", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JobListResponse</returns>
        public async System.Threading.Tasks.Task<JobListResponse>V1GetPrbJobsAsync(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await V1GetPrbJobsWithHttpInfoAsync(type, name, paginationOffset, paginationLimit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<JobListResponse>> V1GetPrbJobsWithHttpInfoAsync(JobTypes? type = default(JobTypes?), string name = default(string), int? paginationOffset = default(int?), int? paginationLimit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
