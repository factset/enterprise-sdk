# FactSet.SDK.PortfolioReportingBatcher.Api.RunsApi
...
namespace Example
{
    public class V1CancelRunIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling RunsApi.V1CancelRunId: " + e.Message );
...
namespace Example
{
    public class V1CheckRunStatusExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PortfolioReportingBatcher.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling RunsApi.V1CheckRunStatus: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1startjobrun"></a>
# **V1StartJobRun**
> StartJobRunResponse V1StartJobRun (StartJobRoot startJobRoot = null)
...
namespace Example
{
    public class V1StartJobRunExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PortfolioReportingBatcher.Client.Configuration();
            ...
            var startJobRoot = new StartJobRoot(); // StartJobRoot | The main object in the request body contains details for the job to be triggered. The \"name\" and \"type\" fields will uniquely identify the job and both must be provided. Other fields can be provided depending on the job's type. (optional) 
            ...
            {
                Console.WriteLine("Exception when calling RunsApi.V1StartJobRun: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
