...
<a name="getprbjobs"></a>
# **GetPrbJobs**
> JobListResponse GetPrbJobs (JobTypes? type = null, string name = null, int? paginationOffset = null, int? paginationLimit = null)
...
namespace Example
{
    public class GetPrbJobsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PortfolioReportingBatcher.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling JobsApi.GetPrbJobs: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
