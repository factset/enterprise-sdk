...
dotnet add package FactSet.SDK.PortfolioReportingBatcher -v 0.20.0
```
...
nuget install FactSet.SDK.PortfolioReportingBatcher -Version 0.20.0
```
...
namespace Example
{
    public static class CheckRunStatusExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling RunsApi.CheckRunStatus: " + e.Message );
