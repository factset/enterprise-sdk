...
namespace FactSet.SDK.PortfolioReportingBatcher.Model
{
    ...
    public partial class StartJobRunResponseData : IEquatable<StartJobRunResponseData>, IValidatableObject
    {
        ...
        /// <param name="prbStatus">prbStatus (required).</param>
        /// <param name="status">status (required).</param>
        /// <param name="jobType">jobType (required).</param>
        public StartJobRunResponseData(string id, string jobName, PrbStatus prbStatus, Status status, JobTypes jobType)
        {
            ...
            // to ensure "prbStatus" is required (not null)
            if (prbStatus == null) {
                throw new ArgumentNullException("prbStatus is a required property for StartJobRunResponseData and cannot be null");
            }
            this.PrbStatus = prbStatus;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for StartJobRunResponseData and cannot be null");
            }
            this.Status = status;
            // to ensure "jobType" is required (not null)
            if (jobType == null) {
                throw new ArgumentNullException("jobType is a required property for StartJobRunResponseData and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "prbStatus", IsRequired = true, EmitDefaultValue = false)]
