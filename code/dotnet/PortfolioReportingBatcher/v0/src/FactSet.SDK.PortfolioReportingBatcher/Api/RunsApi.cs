...
namespace FactSet.SDK.PortfolioReportingBatcher.Api
{
    ...
    public interface IRunsApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> CancelRunIdWithHttpInfo(string id);
        /// <summary>
    ...
    public interface IRunsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CancelRunIdAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CancelRunIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// check the status for a particular run ID
        /// </summary>
        /// <remarks>
    ...
    public partial class RunsApi : IRunsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> CancelRunIdResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        };
        ...
        /// <param name="id"></param>
        /// <returns>void</returns>
        public void CancelRunId(string id)
        {
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> CancelRunIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new FactSet.SDK.PortfolioReportingBatcher.Client.ApiException(400, "Missing required parameter 'id' when calling RunsApi->CancelRunId");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = CancelRunIdResponseTypeDictionary;
            ...
            {
                Exception _exception = this.ExceptionFactory("CancelRunId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CancelRunIdAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CancelRunIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> CancelRunIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
