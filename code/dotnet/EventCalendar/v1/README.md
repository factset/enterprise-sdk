...
------------ | ------------- | ------------- | -------------
*CompanyApi* | [**GetCompanyEvent**](docs/CompanyApi.md#getcompanyevent) | **POST** /company/event/list | Retrieve Company Event data


## Documentation for Models

 - [Model.CompanyEventRequest](docs/CompanyEventRequest.md)
 - [Model.CompanyEventRequestData](docs/CompanyEventRequestData.md)
 - [Model.CompanyEventRequestDataDate](docs/CompanyEventRequestDataDate.md)
 - [Model.CompanyEventRequestDataUniverse](docs/CompanyEventRequestDataUniverse.md)
 - [Model.CompanyEventResponse](docs/CompanyEventResponse.md)
 - [Model.CompanyEventResponseData](docs/CompanyEventResponseData.md)
