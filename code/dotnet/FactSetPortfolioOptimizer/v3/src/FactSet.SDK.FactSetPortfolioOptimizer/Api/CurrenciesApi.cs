...
namespace FactSet.SDK.FactSetPortfolioOptimizer.Api
{
    ...
    public partial class CurrenciesApi : ICurrenciesApi
    {
        ...
        /// <returns></returns>
        public CurrenciesApi(FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration configuration)
        {
        ...
        public CurrenciesApi(FactSet.SDK.FactSetPortfolioOptimizer.Client.ISynchronousClient client, FactSet.SDK.FactSetPortfolioOptimizer.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetPortfolioOptimizer.Client.IReadableConfiguration configuration)
        {
        ...
        {
            FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> localVarResponse = GetCurrenciesWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of CurrencyRoot</returns>
        public FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> GetCurrenciesWithHttpInfo()
        {
        ...
        {
            FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> localVarResponse = await GetCurrenciesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CurrencyRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<CurrencyRoot>> GetCurrenciesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
