...
namespace FactSet.SDK.FactSetPortfolioOptimizer.Api
{
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        {
            FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = GetFPOStrategyDocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectoriesRoot</returns>
        public FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> GetFPOStrategyDocumentsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = await GetFPOStrategyDocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DocumentDirectoriesRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectoriesRoot>> GetFPOStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiException(400, "Missing required parameter 'path' when calling StrategyDocumentsApi->GetFPOStrategyDocuments");
