...
namespace Example
{
    public class CancelOptimizationByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FPOOptimizerApi.CancelOptimizationById: " + e.Message );
...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FPOOptimizerApi.GetOptimizationParameters: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FPOOptimizerApi.GetOptimizationResult: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FPOOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FPOOptimizerApi.PostAndOptimize: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FPOOptimizerApi.PutAndOptimize: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
