# FactSet.SDK.FactSetPortfolioOptimizer.Api.FPOOptimizerApi
...
<a name="canceloptimizationbyid"></a>
...
namespace Example
{
    public class CancelOptimizationByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling FPOOptimizerApi.CancelOptimizationById: " + e.Message );
...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling FPOOptimizerApi.GetOptimizationParameters: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling FPOOptimizerApi.GetOptimizationResult: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling FPOOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                // Create and Run FPO optimization
                FPOOptimizerApi.PostAndOptimizeResponseWrapper result = apiInstance.PostAndOptimize(xFactSetApiLongRunningDeadline, cacheControl, fPOOptimizationParametersRoot);
            ...
            {
                Console.WriteLine("Exception when calling FPOOptimizerApi.PostAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration();
            ...
            {
                // Create or Update FPO optimization and run it.
                FPOOptimizerApi.PutAndOptimizeResponseWrapper result = apiInstance.PutAndOptimize(id, xFactSetApiLongRunningDeadline, cacheControl, fPOOptimizationParametersRoot);
            ...
            {
                Console.WriteLine("Exception when calling FPOOptimizerApi.PutAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
