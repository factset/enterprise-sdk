# FactSet.SDK.FactSetPortfolioOptimizer.Api.OptimizationsApi
...
namespace Example
{
    public class CancelFPOOptimizationByIdExample
    {
...
namespace Example
{
    public class GetFPOOptimizationByIdExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration();
            ...
            {
                // Get FPO optimization by id
                apiInstance.GetFPOOptimizationById(id);
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling OptimizationsApi.GetFPOOptimizationById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
# **RunFPOOptimization**
> void RunFPOOptimization (FPOOptimizationParameters fPOOptimizationParameters = null)
...
namespace Example
{
    public class RunFPOOptimizationExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration();
            ...
            var fPOOptimizationParameters = new FPOOptimizationParameters(); // FPOOptimizationParameters |  (optional) 

            try
            {
                // Run FPO optimization
                apiInstance.RunFPOOptimization(fPOOptimizationParameters);
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling OptimizationsApi.RunFPOOptimization: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
