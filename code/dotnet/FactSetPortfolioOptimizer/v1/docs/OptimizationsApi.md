...
namespace Example
{
    public class GetFPOOptimizationByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling OptimizationsApi.GetFPOOptimizationById: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RunFPOOptimizationExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling OptimizationsApi.RunFPOOptimization: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
