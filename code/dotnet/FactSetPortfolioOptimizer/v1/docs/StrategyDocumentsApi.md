# FactSet.SDK.FactSetPortfolioOptimizer.Api.StrategyDocumentsApi
...
namespace Example
{
    public class GetFPOStrategyDocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get FactSet Portfolio Optimizer strategy documents and sub-directories in a directory
                DocumentDirectories result = apiInstance.GetFPOStrategyDocuments(path);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling StrategyDocumentsApi.GetFPOStrategyDocuments: " + e.Message );
