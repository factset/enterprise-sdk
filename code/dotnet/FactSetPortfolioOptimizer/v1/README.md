# FactSet.SDK.FactSetPortfolioOptimizer - the C# library for the Engines API
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling OptimizationsApi.CancelFPOOptimizationById: " + e.Message );
