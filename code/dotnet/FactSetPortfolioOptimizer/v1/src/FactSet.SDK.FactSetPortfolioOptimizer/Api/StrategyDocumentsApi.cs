...
namespace FactSet.SDK.FactSetPortfolioOptimizer.Api
{
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        {
            FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectories> localVarResponse = GetFPOStrategyDocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectories</returns>
        public FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectories> GetFPOStrategyDocumentsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectories> localVarResponse = await GetFPOStrategyDocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DocumentDirectories)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiResponse<DocumentDirectories>> GetFPOStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiException(400, "Missing required parameter 'path' when calling StrategyDocumentsApi->GetFPOStrategyDocuments");
