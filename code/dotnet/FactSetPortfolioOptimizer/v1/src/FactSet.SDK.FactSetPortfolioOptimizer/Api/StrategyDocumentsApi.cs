...
namespace FactSet.SDK.FactSetPortfolioOptimizer.Api
{
    ...
    public interface IStrategyDocumentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DocumentDirectories> GetFPOStrategyDocumentsAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DocumentDirectories>> GetFPOStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class StrategyDocumentsApi : IStrategyDocumentsApi
    {
        ...
        # region Response Type Disctionaries
                private static readonly Dictionary<HttpStatusCode, System.Type> GetFPOStrategyDocumentsResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        /// <returns></returns>
        public StrategyDocumentsApi(FactSet.SDK.FactSetPortfolioOptimizer.Client.Configuration configuration)
        {
        ...
        public StrategyDocumentsApi(FactSet.SDK.FactSetPortfolioOptimizer.Client.ISynchronousClient client, FactSet.SDK.FactSetPortfolioOptimizer.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetPortfolioOptimizer.Client.IReadableConfiguration configuration)
        {
        ...
        {
            var localVarResponse = GetFPOStrategyDocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the strategy documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectories</returns>
        public ApiResponse<DocumentDirectories> GetFPOStrategyDocumentsWithHttpInfo(string path)
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
                throw new FactSet.SDK.FactSetPortfolioOptimizer.Client.ApiException(400, "Missing required parameter 'path' when calling StrategyDocumentsApi->GetFPOStrategyDocuments");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetFPOStrategyDocumentsResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            DocumentDirectories>("/analytics/engines/fpo/v1/strategies/{path}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DocumentDirectories</returns>
        public async System.Threading.Tasks.Task<DocumentDirectories>GetFPOStrategyDocumentsAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetFPOStrategyDocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DocumentDirectories>> GetFPOStrategyDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DocumentDirectories>("/analytics/engines/fpo/v1/strategies/{path}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
