...
namespace FactSet.SDK.RecommendationListAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_activeRange")]
    public partial class InlineResponse200DataActiveRange : IEquatable<InlineResponse200DataActiveRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataActiveRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse200DataActiveRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataActiveRange" /> class.
        /// </summary>
        ...
        public InlineResponse200DataActiveRange(string start = default(string), string end = default(string))
        {
            // to ensure "start" is required (not null)
            if (start == null) {
                throw new ArgumentNullException("start is a required property for InlineResponse200DataActiveRange and cannot be null");
            }
            this.Start = start;
            // to ensure "end" is required (not null)
            if (end == null) {
                throw new ArgumentNullException("end is a required property for InlineResponse200DataActiveRange and cannot be null");
            }
            this.End = end;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200DataActiveRange {\n");
        ...
        {
            return this.Equals(input as InlineResponse200DataActiveRange);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataActiveRange instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataActiveRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataActiveRange input)
        {
            if (input == null)
            {
                return false;
