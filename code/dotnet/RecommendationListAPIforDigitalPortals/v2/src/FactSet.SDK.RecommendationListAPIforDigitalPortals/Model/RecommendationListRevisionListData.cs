...
namespace FactSet.SDK.RecommendationListAPIforDigitalPortals.Model
{
    ...
    public partial class RecommendationListRevisionListData : IEquatable<RecommendationListRevisionListData>, IValidatableObject
    {
        ...
        public RecommendationListRevisionListData(decimal idList = default(decimal), List<decimal> idRevision = default(List<decimal>), RecommendationListRevisionListDataActiveRange activeRange = default(RecommendationListRevisionListDataActiveRange))
        {
            this.IdList = idList;
