...
namespace FactSet.SDK.RecommendationListAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2001Data : IEquatable<InlineResponse2001Data>, IValidatableObject
    {
        ...
        public InlineResponse2001Data(decimal id = default(decimal), string name = default(string), InlineResponse2001ActiveRange activeRange = default(InlineResponse2001ActiveRange), decimal numberRevisions = default(decimal), InlineResponse200DataActiveRevision activeRevision = default(InlineResponse200DataActiveRevision))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse2001ActiveRange ActiveRange { get; set; }
