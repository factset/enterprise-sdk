...
namespace FactSet.SDK.RecommendationListAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_activeRange")]
    public partial class InlineResponse2001ActiveRange : IEquatable<InlineResponse2001ActiveRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001ActiveRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2001ActiveRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001ActiveRange" /> class.
        /// </summary>
        ...
        public InlineResponse2001ActiveRange(string start = default(string), string end = default(string))
        {
            // to ensure "start" is required (not null)
            if (start == null) {
                throw new ArgumentNullException("start is a required property for InlineResponse2001ActiveRange and cannot be null");
            }
            this.Start = start;
            // to ensure "end" is required (not null)
            if (end == null) {
                throw new ArgumentNullException("end is a required property for InlineResponse2001ActiveRange and cannot be null");
            }
            this.End = end;
        }
        ...
        {
            return this.Equals(input as InlineResponse2001ActiveRange);
        }

        /// <summary>
        /// Returns true if InlineResponse2001ActiveRange instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001ActiveRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001ActiveRange input)
        {
            if (input == null)
                return false;
