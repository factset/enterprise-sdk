...
namespace FactSet.SDK.RecommendationListAPIforDigitalPortals.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/RecommendationListAPIforDigitalPortals/0.10.2";
        ...
        {
            string report = "C# SDK (FactSet.SDK.RecommendationListAPIforDigitalPortals) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2\n";
            report += "    SDK Package Version: 0.10.2\n";
