...
namespace FactSet.SDK.RecommendationListAPIforDigitalPortals.Api
{
    ...
    public interface IRecommendationListApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.RecommendationListAPIforDigitalPortals.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idNotation"> (optional)</param>
        /// <param name="idInstrument"> (optional)</param>
        /// <param name="attributes">Limit the attributes returned in the response to the specified set. (optional)</param>
        /// <param name="language"> (optional)</param>
        ...
        ApiResponse<InlineResponse2003> PostRecommendationListRevisionListWithHttpInfo(InlineObject inlineObject);
    ...
    public interface IRecommendationListApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2003> PostRecommendationListRevisionListAsync(InlineObject inlineObject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> PostRecommendationListRevisionListWithHttpInfoAsync(InlineObject inlineObject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class RecommendationListApi : IRecommendationListApi
    {
        ...
        /// <param name="inlineObject"></param>
        /// <returns>InlineResponse2003</returns>
        public InlineResponse2003 PostRecommendationListRevisionList(InlineObject inlineObject)
        {
            var localVarResponse = PostRecommendationListRevisionListWithHttpInfo(inlineObject);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inlineObject"></param>
        /// <returns>ApiResponse of InlineResponse2003</returns>
        public ApiResponse<InlineResponse2003> PostRecommendationListRevisionListWithHttpInfo(InlineObject inlineObject)
        {
            // verify the required parameter 'inlineObject' is set
            if (inlineObject == null)
            {
                throw new FactSet.SDK.RecommendationListAPIforDigitalPortals.Client.ApiException(400, "Missing required parameter 'inlineObject' when calling RecommendationListApi->PostRecommendationListRevisionList");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2003</returns>
        public async System.Threading.Tasks.Task<InlineResponse2003>PostRecommendationListRevisionListAsync(InlineObject inlineObject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await PostRecommendationListRevisionListWithHttpInfoAsync(inlineObject, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> PostRecommendationListRevisionListWithHttpInfoAsync(InlineObject inlineObject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'inlineObject' is set
            if (inlineObject == null)
            {
