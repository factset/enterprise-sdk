...
namespace FactSet.SDK.ETFProfileandPrices.Model
{
    ...
    /// Counter Party.
    /// </summary>
    [DataContract(Name = "inline_response_200_6_data_counterParty")]
    public partial class InlineResponse2006DataCounterParty : IEquatable<InlineResponse2006DataCounterParty>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006DataCounterParty" /> class.
        /// </summary>
        ...
        public InlineResponse2006DataCounterParty(string credit = default(string), string swap = default(string), bool holdsDerivatives = default(bool))
        {
            this.Credit = credit;
            this.Swap = swap;
        ...
        {
            return this.Equals(input as InlineResponse2006DataCounterParty);
        }

        /// <summary>
        /// Returns true if InlineResponse2006DataCounterParty instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006DataCounterParty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006DataCounterParty input)
        {
            if (input == null)
                return false;
