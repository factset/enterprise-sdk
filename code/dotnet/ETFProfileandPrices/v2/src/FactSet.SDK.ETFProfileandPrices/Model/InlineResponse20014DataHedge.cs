...
namespace FactSet.SDK.ETFProfileandPrices.Model
{
    ...
    /// Hedge.
    /// </summary>
    [DataContract(Name = "inline_response_200_14_data_hedge")]
    public partial class InlineResponse20014DataHedge : IEquatable<InlineResponse20014DataHedge>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014DataHedge" /> class.
        /// </summary>
        ...
        public InlineResponse20014DataHedge(bool isHedged = default(bool), string sourceCurrency = default(string), string targetCurrency = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20014DataHedge);
        }

        /// <summary>
        /// Returns true if InlineResponse20014DataHedge instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014DataHedge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014DataHedge input)
        {
            if (input == null)
            {
                return false;
