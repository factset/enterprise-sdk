...
namespace FactSet.SDK.ETFProfileandPrices.Model
{
    ...
    /// category.
    /// </summary>
    [DataContract(Name = "inline_response_200_7_data_category")]
    public partial class InlineResponse2007DataCategory : IEquatable<InlineResponse2007DataCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007DataCategory" /> class.
        /// </summary>
        ...
        public InlineResponse2007DataCategory(string broad = default(string), string focus = default(string), string niche = default(string))
        {
            this.Broad = broad;
            this.Focus = focus;
            this.Niche = niche;
        ...
        {
            return this.Equals(input as InlineResponse2007DataCategory);
        }

        /// <summary>
        /// Returns true if InlineResponse2007DataCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007DataCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007DataCategory input)
        {
            if (input == null)
                return false;
