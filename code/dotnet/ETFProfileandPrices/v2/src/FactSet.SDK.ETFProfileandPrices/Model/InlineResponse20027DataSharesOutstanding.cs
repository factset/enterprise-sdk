...
namespace FactSet.SDK.ETFProfileandPrices.Model
{
    ...
    /// Shares outstanding.
    /// </summary>
    [DataContract(Name = "inline_response_200_27_data_sharesOutstanding")]
    public partial class InlineResponse20027DataSharesOutstanding : IEquatable<InlineResponse20027DataSharesOutstanding>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20027DataSharesOutstanding" /> class.
        /// </summary>
        ...
        public InlineResponse20027DataSharesOutstanding(decimal value = default(decimal), decimal lastValue = default(decimal), DateTime earliestDate = default(DateTime))
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as InlineResponse20027DataSharesOutstanding);
        }

        /// <summary>
        /// Returns true if InlineResponse20027DataSharesOutstanding instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20027DataSharesOutstanding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20027DataSharesOutstanding input)
        {
            if (input == null)
            {
                return false;
