...
namespace FactSet.SDK.ETFProfileandPrices.Model
{
    ...
    /// Expense ratio.
    /// </summary>
    [DataContract(Name = "inline_response_200_32_data_expenseRatio")]
    public partial class InlineResponse20032DataExpenseRatio : IEquatable<InlineResponse20032DataExpenseRatio>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20032DataExpenseRatio" /> class.
        /// </summary>
        ...
        public InlineResponse20032DataExpenseRatio(decimal value = default(decimal), decimal potential = default(decimal))
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as InlineResponse20032DataExpenseRatio);
        }

        /// <summary>
        /// Returns true if InlineResponse20032DataExpenseRatio instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20032DataExpenseRatio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20032DataExpenseRatio input)
        {
            if (input == null)
            {
                return false;
