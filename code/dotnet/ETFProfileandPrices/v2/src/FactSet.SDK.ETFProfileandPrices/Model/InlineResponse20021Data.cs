...
namespace FactSet.SDK.ETFProfileandPrices.Model
{
    ...
    public partial class InlineResponse20021Data : IEquatable<InlineResponse20021Data>, IValidatableObject
    {
        ...
        public InlineResponse20021Data(InlineResponse20021DataMaxCapitalGainsRate maxCapitalGainsRate = default(InlineResponse20021DataMaxCapitalGainsRate), string dividendTreatment = default(string), string distributeK1 = default(string), string taxType = default(string), string taxOnDistributions = default(string), InlineResponse20021DataExpenseRatio expenseRatio = default(InlineResponse20021DataExpenseRatio), DateTime potentialCostIncreaseDate = default(DateTime), decimal contractAdvisoryFee = default(decimal), decimal capitalGains = default(decimal), decimal capitalGainsDistirbutions3Y = default(decimal), decimal managementExpenseRatio = default(decimal), decimal managementFee = default(decimal), decimal tradingExpenseRatio = default(decimal), string feeWaiver = default(string))
        {
        ...
        public InlineResponse20021DataMaxCapitalGainsRate MaxCapitalGainsRate { get; set; }
        ...
        public InlineResponse20021DataExpenseRatio ExpenseRatio { get; set; }
