...
namespace FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/PriceAlertingAPIforDigitalPortals/0.10.3";
        ...
        {
            string report = "C# SDK (FactSet.SDK.PriceAlertingAPIforDigitalPortals) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2\n";
            report += "    SDK Package Version: 0.10.3\n";
