...
namespace FactSet.SDK.PriceAlertingAPIforDigitalPortals.Api
{
    ...
    public interface IAlertingApiSync : IApiAccessor
    {
        ...
        /// <exception cref="FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="attributes">Limit the attributes returned in the response to the specified set. (optional)</param>
        /// <param name="subscriptionMinimumInterval">Non-negative number of milliseconds to throttle the update rate from 0ms to 5000ms. Set to 0 for sending updates immediately. (optional, default to 0.0M)</param>
        ...
        InlineResponse2003 PostAlertingPricesBasicTriggerList(InlineObject body = default(InlineObject));
        ...
        ApiResponse<InlineResponse2003> PostAlertingPricesBasicTriggerListWithHttpInfo(InlineObject body = default(InlineObject));
    ...
    public interface IAlertingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2003> PostAlertingPricesBasicTriggerListAsync(InlineObject body = default(InlineObject), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> PostAlertingPricesBasicTriggerListWithHttpInfoAsync(InlineObject body = default(InlineObject), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
