...
namespace FactSet.SDK.PriceAlertingAPIforDigitalPortals.Api
{
    ...
    public interface IAlertingApiSync : IApiAccessor
    {
        ...
        InlineResponse2003 PostAlertingPricesBasicTriggerList(InlineObject inlineObject = default(InlineObject));
        ...
        ApiResponse<InlineResponse2003> PostAlertingPricesBasicTriggerListWithHttpInfo(InlineObject inlineObject = default(InlineObject));
    ...
    public interface IAlertingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2003> PostAlertingPricesBasicTriggerListAsync(InlineObject inlineObject = default(InlineObject), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> PostAlertingPricesBasicTriggerListWithHttpInfoAsync(InlineObject inlineObject = default(InlineObject), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AlertingApi : IAlertingApi
    {
        ...
        {
            this.Configuration = FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.Configuration.MergeConfigurations(
                FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.GlobalConfiguration.Instance,
                new FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.Configuration { BasePath = basePath }
            );
            this.Client = new FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public AlertingApi(FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.Configuration configuration)
        {
            ...
            this.Client = new FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public AlertingApi(FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ISynchronousClient client, FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.IAsynchronousClient asyncClient, FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ISynchronousClient Client { get; set; }
        ...
        public FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse<InlineResponse200> GetAlertingPricesBasicAlertGetWithHttpInfo(string id, List<string> attributes = default(List<string>))
        {
            ...
            if (attributes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ClientUtils.ParameterToMultiMap("csv", "_attributes", attributes));
            }
        ...
        public ApiResponse<InlineResponse2001> GetAlertingPricesBasicAlertListWithHttpInfo(List<string> attributes = default(List<string>), decimal? subscriptionMinimumInterval = default(decimal?), string paginationCursor = default(string), decimal? paginationLimit = default(decimal?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ClientUtils.ParameterToMultiMap("", "_subscriptionMinimumInterval", subscriptionMinimumInterval));
            }
            if (paginationCursor != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ClientUtils.ParameterToMultiMap("", "_paginationCursor", paginationCursor));
            }
            if (paginationLimit != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.ClientUtils.ParameterToMultiMap("", "_paginationLimit", paginationLimit));
            }
        ...
        /// <param name="inlineObject"> (optional)</param>
        /// <returns>InlineResponse2003</returns>
        public InlineResponse2003 PostAlertingPricesBasicTriggerList(InlineObject inlineObject = default(InlineObject))
        {
            var localVarResponse = PostAlertingPricesBasicTriggerListWithHttpInfo(inlineObject);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inlineObject"> (optional)</param>
        /// <returns>ApiResponse of InlineResponse2003</returns>
        public ApiResponse<InlineResponse2003> PostAlertingPricesBasicTriggerListWithHttpInfo(InlineObject inlineObject = default(InlineObject))
        {
            FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.PriceAlertingAPIforDigitalPortals.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2003</returns>
        public async System.Threading.Tasks.Task<InlineResponse2003>PostAlertingPricesBasicTriggerListAsync(InlineObject inlineObject = default(InlineObject), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await PostAlertingPricesBasicTriggerListWithHttpInfoAsync(inlineObject, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> PostAlertingPricesBasicTriggerListWithHttpInfoAsync(InlineObject inlineObject = default(InlineObject), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
