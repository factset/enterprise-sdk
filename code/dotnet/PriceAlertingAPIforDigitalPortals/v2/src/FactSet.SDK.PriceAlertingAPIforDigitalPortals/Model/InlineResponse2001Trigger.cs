...
namespace FactSet.SDK.PriceAlertingAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_trigger")]
    public partial class InlineResponse2001Trigger : IEquatable<InlineResponse2001Trigger>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Trigger" /> class.
        /// </summary>
        ...
        public InlineResponse2001Trigger(string id = default(string), string creation = default(string), InlineResponse200DataTriggerNotation notation = default(InlineResponse200DataTriggerNotation), InlineResponse2001TriggerPrice price = default(InlineResponse2001TriggerPrice), InlineResponse200DataTriggerRange range = default(InlineResponse200DataTriggerRange), string comment = default(string), InlineResponse2001TriggerStatus status = default(InlineResponse2001TriggerStatus))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as InlineResponse2001Trigger);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Trigger instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Trigger to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Trigger input)
        {
            if (input == null)
            {
                return false;
