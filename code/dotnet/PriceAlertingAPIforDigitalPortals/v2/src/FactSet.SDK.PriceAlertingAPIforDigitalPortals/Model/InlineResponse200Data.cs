...
namespace FactSet.SDK.PriceAlertingAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse200Data : IEquatable<InlineResponse200Data>, IValidatableObject
    {
        ...
        public InlineResponse200Data(string id = default(string), string creation = default(string), InlineResponse200DataPrice price = default(InlineResponse200DataPrice), InlineResponse200DataTrigger trigger = default(InlineResponse200DataTrigger))
        {
            this.Id = id;
