...
namespace FactSet.SDK.FactSetBenchmarks.Api
{
    ...
    public interface IIndexLevelApiSync : IApiAccessor
    {
        ...
        /// <param name="currency">Currency for response.  Currency code (ISO 4217). For a list of currency codes, see [OA Page 1470](https://my.apps.factset.com/oa/pages/1470). (optional)</param>
        ...
        /// <param name="calendar">Calendar of data returned. The default value is FIVEDAY which displays Monday through Friday, regardless of whether there were trading holidays. (optional, default to &quot;FIVEDAY&quot;)</param>
        /// <param name="impliedDate">This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (optional, default to N)</param>
        /// <returns>IndexReturnsResponse</returns>
        IndexReturnsResponse GetIndexReturns(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string));
        ...
        /// <param name="calendar">Calendar of data returned. The default value is FIVEDAY which displays Monday through Friday, regardless of whether there were trading holidays. (optional, default to &quot;FIVEDAY&quot;)</param>
        /// <param name="impliedDate">This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (optional, default to N)</param>
        /// <returns>ApiResponse of IndexReturnsResponse</returns>
        ApiResponse<IndexReturnsResponse> GetIndexReturnsWithHttpInfo(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.FactSetBenchmarks.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="indexReturnsRequest">Requests Index Returns for a list of identifiers and specified date range.</param>
        /// <returns>IndexReturnsResponse</returns>
        ...
        /// <param name="indexReturnsRequest">Requests Index Returns for a list of identifiers and specified date range.</param>
        /// <returns>ApiResponse of IndexReturnsResponse</returns>
        ApiResponse<IndexReturnsResponse> GetIndexReturnsForListWithHttpInfo(IndexReturnsRequest indexReturnsRequest);
        /// <summary>
    ...
    public interface IIndexLevelApiAsync : IApiAccessor
    {
        ...
        /// <param name="impliedDate">This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (optional, default to N)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of IndexReturnsResponse</returns>
        System.Threading.Tasks.Task<IndexReturnsResponse> GetIndexReturnsAsync(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="impliedDate">This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (optional, default to N)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IndexReturnsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<IndexReturnsResponse>> GetIndexReturnsWithHttpInfoAsync(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via JSON Request body
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of IndexReturnsResponse</returns>
        System.Threading.Tasks.Task<IndexReturnsResponse> GetIndexReturnsForListAsync(IndexReturnsRequest indexReturnsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IndexReturnsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<IndexReturnsResponse>> GetIndexReturnsForListWithHttpInfoAsync(IndexReturnsRequest indexReturnsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Index Level Prices, Returns, and related information as of a single date.
        /// </summary>
        /// <remarks>
    ...
    public partial class IndexLevelApi : IIndexLevelApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetIndexReturnsResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(IndexReturnsResponse) },
            { (HttpStatusCode)400, typeof(ErrorResponse) },
            { (HttpStatusCode)401, typeof(ErrorResponse) },
            { (HttpStatusCode)403, typeof(ErrorResponse) },
            { (HttpStatusCode)415, typeof(ErrorResponse) },
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetIndexReturnsForListResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(IndexReturnsResponse) },
            { (HttpStatusCode)400, typeof(ErrorResponse) },
            { (HttpStatusCode)401, typeof(ErrorResponse) },
        ...
        /// <summary>
        /// Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters Returns aggregated (cumulative) index returns for each requested benchmark across the specified date range. Unlike &#x60;/index-history&#x60;, which provides full time-series data (prices, levels, constituents, and frequency-based observations), this endpoint is returns-focused and does not return a time series or support frequency parameters. Each benchmark produces a single cumulative return value for the entire date window, rather than a series of observations. The data is aligned with FactSet Benchmark Data Feed. Submit benchmark identifiers and a date range to retrieve cumulative return metrics for the period. 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetBenchmarks.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Benchmark Identifiers. Reference the helper endpoint **_/id-list** to get a sample list of  valid identifiers. &lt;p&gt;***ids limit** &#x3D;  500 per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;*</param>
        /// <param name="startDate">Requested start date expressed in YYYY-MM-DD format.</param>
        ...
        /// <param name="impliedDate">This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (optional, default to N)</param>
        /// <returns>IndexReturnsResponse</returns>
        public IndexReturnsResponse GetIndexReturns(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string))
        {
            var localVarResponse = GetIndexReturnsWithHttpInfo(ids, startDate, endDate, returnType, hedgeType, currency, calendar, impliedDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="impliedDate">This parameter controls the **date** returned in the date field. The default value is **N**. By default, the date field returns the actual date of the observation. This means it will repeat values for weekends and holidays. If  set to **Y**, the date field will return the implied date of the observation, making all the dates unique. (optional, default to N)</param>
        /// <returns>ApiResponse of IndexReturnsResponse</returns>
        public ApiResponse<IndexReturnsResponse> GetIndexReturnsWithHttpInfo(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
                throw new FactSet.SDK.FactSetBenchmarks.Client.ApiException(400, "Missing required parameter 'ids' when calling IndexLevelApi->GetIndexReturns");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetBenchmarks.Client.ClientUtils.ParameterToMultiMap("csv", "ids", ids));
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetBenchmarks.Client.ClientUtils.ParameterToMultiMap("", "startDate", new DateOnlyParameter(startDate)));
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetBenchmarks.Client.ClientUtils.ParameterToMultiMap("", "endDate", new DateOnlyParameter(endDate)));
            if (returnType != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetBenchmarks.Client.ClientUtils.ParameterToMultiMap("", "returnType", returnType));
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetIndexReturnsResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            IndexReturnsResponse>("/factset-benchmarks/v1/index-returns", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetIndexReturns", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of IndexReturnsResponse</returns>
        public async System.Threading.Tasks.Task<IndexReturnsResponse>GetIndexReturnsAsync(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetIndexReturnsWithHttpInfoAsync(ids, startDate, endDate, returnType, hedgeType, currency, calendar, impliedDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<IndexReturnsResponse>> GetIndexReturnsWithHttpInfoAsync(List<string> ids, DateTime startDate, DateTime endDate, string returnType = default(string), string hedgeType = default(string), string currency = default(string), string calendar = default(string), string impliedDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<IndexReturnsResponse>("/factset-benchmarks/v1/index-returns", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via JSON Request body Returns aggregated (cumulative) index returns for each requested benchmark across the specified date range. Unlike &#x60;/index-history&#x60;, which provides full time-series data (prices, levels, constituents, and frequency-based observations), this endpoint is returns-focused and does not return a time series or support frequency parameters. Each benchmark produces a single cumulative return value for the entire date window, rather than a series of observations. The data is aligned with FactSet Benchmark Data Feed. Submit benchmark identifiers and a date range to retrieve cumulative return metrics for the period. 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetBenchmarks.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="indexReturnsRequest">Requests Index Returns for a list of identifiers and specified date range.</param>
        /// <returns>IndexReturnsResponse</returns>
        public IndexReturnsResponse GetIndexReturnsForList(IndexReturnsRequest indexReturnsRequest)
        {
            var localVarResponse = GetIndexReturnsForListWithHttpInfo(indexReturnsRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="indexReturnsRequest">Requests Index Returns for a list of identifiers and specified date range.</param>
        /// <returns>ApiResponse of IndexReturnsResponse</returns>
        public ApiResponse<IndexReturnsResponse> GetIndexReturnsForListWithHttpInfo(IndexReturnsRequest indexReturnsRequest)
        {
            // verify the required parameter 'indexReturnsRequest' is set
            if (indexReturnsRequest == null)
            {
                throw new FactSet.SDK.FactSetBenchmarks.Client.ApiException(400, "Missing required parameter 'indexReturnsRequest' when calling IndexLevelApi->GetIndexReturnsForList");
            }
            ...
            localVarRequestOptions.Data = indexReturnsRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetIndexReturnsForListResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetIndexReturnsForList", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of IndexReturnsResponse</returns>
        public async System.Threading.Tasks.Task<IndexReturnsResponse>GetIndexReturnsForListAsync(IndexReturnsRequest indexReturnsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetIndexReturnsForListWithHttpInfoAsync(indexReturnsRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<IndexReturnsResponse>> GetIndexReturnsForListWithHttpInfoAsync(IndexReturnsRequest indexReturnsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'indexReturnsRequest' is set
            if (indexReturnsRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<IndexReturnsResponse>("/factset-benchmarks/v1/index-returns", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
