...
namespace FactSet.SDK.FactSetBenchmarks.Api
{
    ...
    public partial class HelperApi : IHelperApi
    {
        ...
        {
            FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse> localVarResponse = GetBenchmarkIdsWithHttpInfo(familyFilter);
        ...
        /// <param name="familyFilter">Highest Level Filter to search by common Benchmark Families, such as S&amp;P, MSCI, or Russell. This will retrieve all related benchmark ids. For further filtering, use the response items such as the categoryDescription field. Leave blank if you wish to see a full sample list of ids. requested- * **CHINA &amp; HK INDICES** - Major Hong Kong and China Indices, such as Hang Seng Index (HSI-HKX) * **DOW JONES** - Dow Jones Global, Regions, Countries, Titans. * **FACTSET MARKET INDICES** - Regional and Country Indices defined by FactSet * **FTSE** - FTSE Global, UK, Global All Cap, World, Xinhua, European, GWA, JSE, Multinationals, and Style indices * **GLOBAL INDICES** - A mix of major indices across the globe. * **MSCI** - MSCI All Country, Asia Pacific, Thematic &amp; Strategy, Emerging, Developed, US. * **RUSSELL** - US, Global, and Nomura. * **S&amp;P** - US, ASX, Select Industry, BMI, Global, Thematic, Emerging, TSX. * **STOXX** - Total Market, Europe, and Nordic * **TOPIX** - Topix Indices, such as TOPIX 500 (182301)  (optional)</param>
        /// <returns>ApiResponse of BenchmarkIdListResponse</returns>
        public FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse> GetBenchmarkIdsWithHttpInfo(string familyFilter = default(string))
        {
            ...
            var localVarResponse = this.Client.Get<BenchmarkIdListResponse>("/factset-benchmarks/v1/id-list", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse> localVarResponse = await GetBenchmarkIdsWithHttpInfoAsync(familyFilter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BenchmarkIdListResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse>> GetBenchmarkIdsWithHttpInfoAsync(string familyFilter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse> localVarResponse = GetBenchmarkIdsForListWithHttpInfo(benchmarkIdListRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="benchmarkIdListRequest">Requests a sample list of identifiers that can be used in other Benchmarks API endpoints.</param>
        /// <returns>ApiResponse of BenchmarkIdListResponse</returns>
        public FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse> GetBenchmarkIdsForListWithHttpInfo(BenchmarkIdListRequest benchmarkIdListRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<BenchmarkIdListResponse>("/factset-benchmarks/v1/id-list", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse> localVarResponse = await GetBenchmarkIdsForListWithHttpInfoAsync(benchmarkIdListRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BenchmarkIdListResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetBenchmarks.Client.ApiResponse<BenchmarkIdListResponse>> GetBenchmarkIdsForListWithHttpInfoAsync(BenchmarkIdListRequest benchmarkIdListRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'benchmarkIdListRequest' is set
            if (benchmarkIdListRequest == null)
                throw new FactSet.SDK.FactSetBenchmarks.Client.ApiException(400, "Missing required parameter 'benchmarkIdListRequest' when calling HelperApi->GetBenchmarkIdsForList");
