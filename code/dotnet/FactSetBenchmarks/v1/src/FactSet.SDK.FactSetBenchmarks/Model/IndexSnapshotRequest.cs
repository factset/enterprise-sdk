...
namespace FactSet.SDK.FactSetBenchmarks.Model
{
    ...
    public partial class IndexSnapshotRequest : IEquatable<IndexSnapshotRequest>, IValidatableObject
    {
        ...
        public IndexSnapshotRequest(List<string> ids,string date = default(string), ReturnType returnType = default(ReturnType), string currency = default(string), string calendar = "FIVEDAY")
        {
