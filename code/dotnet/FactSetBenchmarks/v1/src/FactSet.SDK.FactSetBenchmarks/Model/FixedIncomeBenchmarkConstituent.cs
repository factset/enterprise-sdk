...
namespace FactSet.SDK.FactSetBenchmarks.Model
{
    ...
    /// </summary>
    [DataContract(Name = "fixedIncomeBenchmarkConstituent")]
    public partial class FixedIncomeBenchmarkConstituent : IEquatable<FixedIncomeBenchmarkConstituent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FixedIncomeBenchmarkConstituent" /> class.
        /// </summary>
        /// <param name="fsymId">Benchmark Id.</param>
        /// <param name="date">Date of weight and shares..</param>
        /// <param name="fsymSecurityId">FactSet Security Identifier (-S)..</param>
        /// <param name="weightClose">Weight of Security in benchmark (percent)..</param>
        /// <param name="amountOutstanding">Amount Outstanding for the Fixed Income Security..</param>
        /// <param name="price">Fixed Income Price of security held..</param>
        ...
        public FixedIncomeBenchmarkConstituent(string fsymId = default(string), DateTime? date = default(DateTime?), string fsymSecurityId = default(string), double? weightClose = default(double?), double? amountOutstanding = default(double?), double? price = default(double?), double? adjMarketValue = default(double?), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Date = date;
        ...
        /// </summary>
        /// <value>FactSet Security Identifier (-S).</value>
        ...
        /// </summary>
        /// <value>Amount Outstanding for the Fixed Income Security.</value>
        ...
        /// </summary>
        /// <value>Fixed Income Price of security held.</value>
        ...
        {
            return this.Equals(input as FixedIncomeBenchmarkConstituent);
        }

        /// <summary>
        /// Returns true if FixedIncomeBenchmarkConstituent instances are equal
        /// </summary>
        /// <param name="input">Instance of FixedIncomeBenchmarkConstituent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FixedIncomeBenchmarkConstituent input)
        {
            if (input == null)
            {
                return false;
