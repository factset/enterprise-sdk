...
namespace FactSet.SDK.FactSetBenchmarks.Model
{
    ...
    public partial class IndexHistory : IEquatable<IndexHistory>, IValidatableObject
    {
        ...
        public IndexHistory(string fsymId = default(string), DateTime date = default(DateTime), string name = default(string), int constituentNumber = default(int), string currency = default(string), double marketValue = default(double), double price = default(double), double priceReturnPercent = default(double), double totalReturnLevel = default(double), double totalReturnPercent = default(double), string returnType = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Date = date;
            this.Name = name;
