...
namespace FactSet.SDK.FactSetBenchmarks.Model
{
    ...
    /// </summary>
    /// <value>The hedge type adjustment used in returns response items. Adjustment can be made for HEDGED and UNHEDGED values that will be included in the return calculation. The service will default to UNHEDGED.</value>
