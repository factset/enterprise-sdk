...
namespace FactSet.SDK.FactSetBenchmarks.Model
{
    ...
    public partial class BenchmarkRatiosRequest : IEquatable<BenchmarkRatiosRequest>, IValidatableObject
    {
        ...
        public BenchmarkRatiosRequest(List<string> ids = default(List<string>), string startDate = default(string), string endDate = default(string), Periodicity periodicity = default(Periodicity), List<string> metrics = default(List<string>), Frequency frequency = default(Frequency), string currency = default(string))
        {
