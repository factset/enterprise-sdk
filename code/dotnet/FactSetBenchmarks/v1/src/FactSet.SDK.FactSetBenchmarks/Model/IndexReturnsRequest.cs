...
namespace FactSet.SDK.FactSetBenchmarks.Model
{
    ...
    /// IndexReturnsRequest
    /// </summary>
    [DataContract(Name = "indexReturnsRequest")]
    public partial class IndexReturnsRequest : IEquatable<IndexReturnsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexReturnsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndexReturnsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexReturnsRequest" /> class.
        /// </summary>
        ...
        /// <param name="startDate">Requested start date expressed in YYYY-MM-DD format. (required).</param>
        /// <param name="endDate">Requested end date for Range expressed in YYYY-MM-DD format. (required).</param>
        /// <param name="returnType">returnType.</param>
        /// <param name="hedgeType">hedgeType.</param>
        /// <param name="currency">Currency for response. Currency code (ISO 4217). For a list of currency codes, see [OA Page 1470](https://my.apps.factset.com/oa/pages/1470)..</param>
        ...
        public IndexReturnsRequest(List<string> ids, string startDate, string endDate,ReturnType returnType = default(ReturnType), HedgeType hedgeType = default(HedgeType), string currency = default(string), string calendar = "FIVEDAY", ImpliedDate impliedDate = default(ImpliedDate))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for IndexReturnsRequest and cannot be null");
            }
            this.Ids = ids;
            // to ensure "startDate" is required (not null)
            if (startDate == null) {
                throw new ArgumentNullException("startDate is a required property for IndexReturnsRequest and cannot be null");
            }
            this.StartDate = startDate;
            // to ensure "endDate" is required (not null)
            if (endDate == null) {
                throw new ArgumentNullException("endDate is a required property for IndexReturnsRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Currency for response. Currency code (ISO 4217). For a list of currency codes, see [OA Page 1470](https://my.apps.factset.com/oa/pages/1470).</value>
        ...
        {
            return this.Equals(input as IndexReturnsRequest);
        }

        /// <summary>
        /// Returns true if IndexReturnsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexReturnsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexReturnsRequest input)
        {
            if (input == null)
            {
                return false;
