...
[![API Version](https://img.shields.io/badge/api-v1.11.0-blue)]()
[![Nuget](https://img.shields.io/badge/nuget-v1.6.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetBenchmarks/1.6.0)
...
dotnet add package FactSet.SDK.FactSetBenchmarks -v 1.6.0
```
...
nuget install FactSet.SDK.FactSetBenchmarks -Version 1.6.0
```
...
*IndexLevelApi* | [**GetIndexReturns**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetBenchmarks/v1/docs/IndexLevelApi.md#getindexreturns) | **GET** /factset-benchmarks/v1/index-returns | Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via query parameters
*IndexLevelApi* | [**GetIndexReturnsForList**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetBenchmarks/v1/docs/IndexLevelApi.md#getindexreturnsforlist) | **POST** /factset-benchmarks/v1/index-returns | Retrieves cumulative index returns over a specified date range for a list of benchmark identifiers via JSON Request body
...
## Documentation for Models
 ...
 - [Model.IndexReturns](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetBenchmarks/v1/docs/IndexReturns.md)
 - [Model.IndexReturnsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetBenchmarks/v1/docs/IndexReturnsRequest.md)
 - [Model.IndexReturnsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetBenchmarks/v1/docs/IndexReturnsResponse.md)
