...
[![Nuget](https://img.shields.io/badge/nuget-v1.4.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetBenchmarks/1.4.0)
...
dotnet add package FactSet.SDK.FactSetBenchmarks -v 1.4.0
```
...
nuget install FactSet.SDK.FactSetBenchmarks -Version 1.4.0
```
