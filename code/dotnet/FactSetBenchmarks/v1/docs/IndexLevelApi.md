...
namespace Example
{
    public class GetBenchmarkRatiosExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IndexLevelApi.GetBenchmarkRatios: " + e.Message );
...
namespace Example
{
    public class GetBenchmarkRatiosForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IndexLevelApi.GetBenchmarkRatiosForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetIndexHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IndexLevelApi.GetIndexHistory: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetIndexHistoryForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IndexLevelApi.GetIndexHistoryForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetIndexSnapshotExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IndexLevelApi.GetIndexSnapshot: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetIndexSnapshotForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IndexLevelApi.GetIndexSnapshotForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
