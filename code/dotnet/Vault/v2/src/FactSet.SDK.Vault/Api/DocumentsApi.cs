...
namespace FactSet.SDK.Vault.Api
{
    ...
    public partial class DocumentsApi : IDocumentsApi
    {
        ...
        /// <param name="path">The directory to get the documents in</param>
        /// <returns>ApiResponse of DocumentDirectories</returns>
        public ApiResponse<DocumentDirectories> GetVaultDocumentsWithHttpInfo(string path)
        {
            ...
            DocumentDirectories>("/analytics/lookups/v2/engines/vault/documents/{path}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DocumentDirectories>> GetVaultDocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
