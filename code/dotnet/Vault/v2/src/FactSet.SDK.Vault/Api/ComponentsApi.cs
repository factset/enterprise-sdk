...
namespace FactSet.SDK.Vault.Api
{
    ...
    public partial class ComponentsApi : IComponentsApi
    {
        ...
        {
            FactSet.SDK.Vault.Client.ApiResponse<VaultComponent> localVarResponse = GetVaultComponentByIdWithHttpInfo(id);
        ...
        /// <param name="id">Unique identifier for a vault component</param>
        /// <returns>ApiResponse of VaultComponent</returns>
        public FactSet.SDK.Vault.Client.ApiResponse<VaultComponent> GetVaultComponentByIdWithHttpInfo(string id)
        {
        ...
        {
            FactSet.SDK.Vault.Client.ApiResponse<VaultComponent> localVarResponse = await GetVaultComponentByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VaultComponent)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Vault.Client.ApiResponse<VaultComponent>> GetVaultComponentByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.SDK.Vault.Client.ApiException(400, "Missing required parameter 'id' when calling ComponentsApi->GetVaultComponentById");
        ...
        {
            FactSet.SDK.Vault.Client.ApiResponse<Dictionary<string, ComponentSummary>> localVarResponse = GetVaultComponentsWithHttpInfo(document);
            return localVarResponse.Data;
        }
        ...
        /// <param name="document">Document Name</param>
        /// <returns>ApiResponse of Dictionary&lt;string, ComponentSummary&gt;</returns>
        public FactSet.SDK.Vault.Client.ApiResponse<Dictionary<string, ComponentSummary>> GetVaultComponentsWithHttpInfo(string document)
        {
        ...
        {
            FactSet.SDK.Vault.Client.ApiResponse<Dictionary<string, ComponentSummary>> localVarResponse = await GetVaultComponentsWithHttpInfoAsync(document, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ComponentSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Vault.Client.ApiResponse<Dictionary<string, ComponentSummary>>> GetVaultComponentsWithHttpInfoAsync(string document, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'document' is set
            if (document == null)
                throw new FactSet.SDK.Vault.Client.ApiException(400, "Missing required parameter 'document' when calling ComponentsApi->GetVaultComponents");
