# FactSet.SDK.Vault.Api.DocumentsApi
...
namespace Example
{
    public class GetVaultDocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling DocumentsApi.GetVaultDocuments: " + e.Message );
