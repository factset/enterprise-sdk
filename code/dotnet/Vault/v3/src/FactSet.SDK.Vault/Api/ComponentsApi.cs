...
namespace FactSet.SDK.Vault.Api
{
    ...
    public interface IComponentsApiSync : IApiAccessor
    {
        ...
        /// <param name="id">Unique identifier for a vault component. This is a sample example for illustration purposes only. Client should use a valid Vault API Component Id to get a successful response.</param>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.Vault.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="document">Document Name. This is a sample example for illustration purposes only. Client should use a valid Portfolio Insight Document to get a successful response.</param>
    ...
    public partial class ComponentsApi : IComponentsApi
    {
        ...
        {
            { (HttpStatusCode)200, typeof(VaultComponentRoot) },
        ...
        /// <param name="id">Unique identifier for a vault component. This is a sample example for illustration purposes only. Client should use a valid Vault API Component Id to get a successful response.</param>
        /// <returns>ApiResponse of VaultComponentRoot</returns>
        public ApiResponse<VaultComponentRoot> GetVaultComponentByIdWithHttpInfo(string id)
        {
            ...
            VaultComponentRoot>("/analytics/engines/vault/v3/components/{id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<VaultComponentRoot>> GetVaultComponentByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <param name="document">Document Name. This is a sample example for illustration purposes only. Client should use a valid Portfolio Insight Document to get a successful response.</param>
        /// <returns>ApiResponse of ComponentSummaryRoot</returns>
        public ApiResponse<ComponentSummaryRoot> GetVaultComponentsWithHttpInfo(string document)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            ComponentSummaryRoot>("/analytics/engines/vault/v3/components", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ComponentSummaryRoot>> GetVaultComponentsWithHttpInfoAsync(string document, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'document' is set
            if (document == null)
            {
