...
namespace FactSet.SDK.Vault.Api
{
    ...
    public partial class DatesApi : IDatesApi
    {
        ...
        {
            FactSet.SDK.Vault.Client.ApiResponse<DateParametersSummaryRoot> localVarResponse = ConvertVaultDatesToAbsoluteFormatWithHttpInfo(enddate, componentid, account, startdate);
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>ApiResponse of DateParametersSummaryRoot</returns>
        public FactSet.SDK.Vault.Client.ApiResponse<DateParametersSummaryRoot> ConvertVaultDatesToAbsoluteFormatWithHttpInfo(string enddate, string componentid, string account, string startdate = default(string))
        {
        ...
        {
            FactSet.SDK.Vault.Client.ApiResponse<DateParametersSummaryRoot> localVarResponse = await ConvertVaultDatesToAbsoluteFormatWithHttpInfoAsync(enddate, componentid, account, startdate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DateParametersSummaryRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Vault.Client.ApiResponse<DateParametersSummaryRoot>> ConvertVaultDatesToAbsoluteFormatWithHttpInfoAsync(string enddate, string componentid, string account, string startdate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'enddate' is set
            if (enddate == null)
                throw new FactSet.SDK.Vault.Client.ApiException(400, "Missing required parameter 'enddate' when calling DatesApi->ConvertVaultDatesToAbsoluteFormat");
