...
namespace FactSet.SDK.Vault.Api
{
    ...
    public interface IDatesApiSync : IApiAccessor
    {
        ...
        /// <param name="componentid">Vault Component Id. This is a sample example for illustration purposes only. Client should use a valid Component Id to get a successful response.</param>
        /// <param name="account">Account. This is a sample example for illustration purposes only. Client should use a valid Component Id to get a successful response.</param>
