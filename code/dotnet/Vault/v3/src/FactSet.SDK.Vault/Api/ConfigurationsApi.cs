...
namespace FactSet.SDK.Vault.Api
{
    ...
    public interface IConfigurationsApiSync : IApiAccessor
    {
        ...
        /// <param name="id">Vault configuration id to get the details of. This is a sample example for illustration purposes only. Client should use a valid Vault API Configuration Id to get a successful response.</param>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.Vault.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="account">Required account query parameter to filter configurations for a specific account. This is a sample example for illustration purposes only. Client should use a valid Portfolio Insight Account to get a successful response.</param>
    ...
    public partial class ConfigurationsApi : IConfigurationsApi
    {
        ...
        /// <summary>
        /// Get Vault configuration by id This endpoint returns details for a Vault configuration as well as a list of accounts it is used in.    The __lockingDate__ parameter in the response can help in identifying if the vault configuration data is locked or unlocked.
        /// </summary>
        /// <exception cref="FactSet.SDK.Vault.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Vault configuration id to get the details of. This is a sample example for illustration purposes only. Client should use a valid Vault API Configuration Id to get a successful response.</param>
        /// <returns>VaultConfigurationRoot</returns>
