...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_distributor")]
    public partial class InlineResponse2001Distributor : IEquatable<InlineResponse2001Distributor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Distributor" /> class.
        /// </summary>
        /// <param name="id">Identifier of the distributor..</param>
        public InlineResponse2001Distributor(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse2001Distributor);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Distributor instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Distributor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Distributor input)
        {
            if (input == null)
            {
                return false;
