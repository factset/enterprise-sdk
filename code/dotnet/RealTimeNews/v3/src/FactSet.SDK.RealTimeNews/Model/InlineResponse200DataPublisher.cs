...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_publisher")]
    public partial class InlineResponse200DataPublisher : IEquatable<InlineResponse200DataPublisher>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataPublisher" /> class.
        /// </summary>
        /// <param name="id">Identifier of the publisher..</param>
        /// <param name="name">Name of the publisher..</param>
        public InlineResponse200DataPublisher(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200DataPublisher {\n");
        ...
        {
            return this.Equals(input as InlineResponse200DataPublisher);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataPublisher instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataPublisher to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataPublisher input)
        {
            if (input == null)
            {
                return false;
