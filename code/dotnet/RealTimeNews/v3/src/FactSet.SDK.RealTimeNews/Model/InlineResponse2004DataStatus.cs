...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_status")]
    public partial class InlineResponse2004DataStatus : IEquatable<InlineResponse2004DataStatus>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataStatus" /> class.
        /// </summary>
        ...
        public InlineResponse2004DataStatus(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse2004DataStatus);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataStatus input)
        {
            if (input == null)
            {
                return false;
