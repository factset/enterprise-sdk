...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    public partial class InlineResponse20010Data : IEquatable<InlineResponse20010Data>, IValidatableObject
    {
        ...
        public InlineResponse20010Data(decimal? id = default(decimal?), string name = default(string), InlineResponse2009DataDistributor distributor = default(InlineResponse2009DataDistributor))
        {
            this.Id = id;
            this.Name = name;
