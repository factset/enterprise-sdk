...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListRequest_data_filter_publisher")]
    public partial class PostNewsArticleListRequestDataFilterPublisher : IEquatable<PostNewsArticleListRequestDataFilterPublisher>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PostNewsArticleListRequestDataFilterPublisher);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListRequestDataFilterPublisher instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListRequestDataFilterPublisher to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListRequestDataFilterPublisher input)
        {
            if (input == null)
            {
                return false;
