...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListByIndexRequest_data_identifier")]
    public partial class PostNewsArticleListByIndexRequestDataIdentifier : IEquatable<PostNewsArticleListByIndexRequestDataIdentifier>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByIndexRequestDataIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostNewsArticleListByIndexRequestDataIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByIndexRequestDataIdentifier" /> class.
        /// </summary>
        /// <param name="values">Set of identifiers to resolve. (required).</param>
        /// <param name="type">Type of the identifier. (required).</param>
        public PostNewsArticleListByIndexRequestDataIdentifier(HashSet<string> values, TypeEnum type)
        {
            // to ensure "values" is required (not null)
            if (values == null) {
                throw new ArgumentNullException("values is a required property for PostNewsArticleListByIndexRequestDataIdentifier and cannot be null");
            }
            this.Values = values;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as PostNewsArticleListByIndexRequestDataIdentifier);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListByIndexRequestDataIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListByIndexRequestDataIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListByIndexRequestDataIdentifier input)
        {
            if (input == null)
            {
                return false;
