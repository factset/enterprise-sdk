...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// Article chain.
    /// </summary>
    [DataContract(Name = "inline_response_200_1_chain")]
    public partial class InlineResponse2001Chain : IEquatable<InlineResponse2001Chain>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Chain" /> class.
        /// </summary>
        /// <param name="id">Identifier of the news article chain..</param>
        public InlineResponse2001Chain(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse2001Chain);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Chain instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Chain to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Chain input)
        {
            if (input == null)
            {
                return false;
