...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListByInstrumentDataIdentifiersItems_status")]
    public partial class PostNewsArticleListByInstrumentDataIdentifiersItemsStatus : IEquatable<PostNewsArticleListByInstrumentDataIdentifiersItemsStatus>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Code of the error condition. | Value | Description | | - -- | - -- | | none | No error. | | parameter | The provided identifier does not refer to a valid instrument level identifier. | | entitlement | Not entitled to see data for the identifier. | | identifierMapping | Unable to resolve the provided identifier. |  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByInstrumentDataIdentifiersItemsStatus" /> class.
        /// </summary>
        /// <param name="code">Code of the error condition. | Value | Description | | - -- | - -- | | none | No error. | | parameter | The provided identifier does not refer to a valid instrument level identifier. | | entitlement | Not entitled to see data for the identifier. | | identifierMapping | Unable to resolve the provided identifier. |  .</param>
        ...
        public PostNewsArticleListByInstrumentDataIdentifiersItemsStatus(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as PostNewsArticleListByInstrumentDataIdentifiersItemsStatus);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListByInstrumentDataIdentifiersItemsStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListByInstrumentDataIdentifiersItemsStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListByInstrumentDataIdentifiersItemsStatus input)
        {
            if (input == null)
            {
                return false;
