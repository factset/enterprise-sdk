...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBasicRegionGetDataNestedRegionsItems")]
    public partial class GetBasicRegionGetDataNestedRegionsItems : IEquatable<GetBasicRegionGetDataNestedRegionsItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBasicRegionGetDataNestedRegionsItems" /> class.
        /// </summary>
        ...
        public GetBasicRegionGetDataNestedRegionsItems(decimal? id = default(decimal?), string code = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Code = code;
            this.Name = name;
        ...
        {
            return this.Equals(input as GetBasicRegionGetDataNestedRegionsItems);
        }

        /// <summary>
        /// Returns true if GetBasicRegionGetDataNestedRegionsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBasicRegionGetDataNestedRegionsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBasicRegionGetDataNestedRegionsItems input)
        {
            if (input == null)
            {
                return false;
