...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    public partial class InlineResponse20029Data : IEquatable<InlineResponse20029Data>, IValidatableObject
    {
        ...
        public InlineResponse20029Data(string code = default(string), string name = default(string), decimal? factor = default(decimal?), InlineResponse20029DataMainCurrency mainCurrency = default(InlineResponse20029DataMainCurrency))
        {
            this.Code = code;
            this.Name = name;
            this.Factor = factor;
        ...
        public InlineResponse20029DataMainCurrency MainCurrency { get; set; }
