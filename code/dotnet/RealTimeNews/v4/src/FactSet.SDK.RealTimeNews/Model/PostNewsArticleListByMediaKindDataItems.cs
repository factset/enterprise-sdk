...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListByMediaKindDataItems")]
    public partial class PostNewsArticleListByMediaKindDataItems : IEquatable<PostNewsArticleListByMediaKindDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByMediaKindDataItems" /> class.
        /// </summary>
        ...
        public PostNewsArticleListByMediaKindDataItems(string code = default(string), DateTime? time = default(DateTime?), string headline = default(string), string summary = default(string), List<PostNewsArticleListByMediaKindDataTypesItems> types = default(List<PostNewsArticleListByMediaKindDataTypesItems>), PostNewsArticleListByMediaKindDataItemsLanguage language = default(PostNewsArticleListByMediaKindDataItemsLanguage), PostNewsArticleListByMediaKindDataItemsDistributor distributor = default(PostNewsArticleListByMediaKindDataItemsDistributor), PostNewsArticleListByMediaKindDataItemsPublisher publisher = default(PostNewsArticleListByMediaKindDataItemsPublisher), List<PostNewsArticleListByMediaKindDataCategoriesItems> categories = default(List<PostNewsArticleListByMediaKindDataCategoriesItems>), PostNewsArticleListByMediaKindDataItemsChain chain = default(PostNewsArticleListByMediaKindDataItemsChain), List<PostNewsArticleListByMediaKindDataInstrumentsItems> instruments = default(List<PostNewsArticleListByMediaKindDataInstrumentsItems>))
        {
            this.Code = code;
            this.Time = time;
        ...
        public List<PostNewsArticleListByMediaKindDataTypesItems> Types { get; set; }

        /// <summary>
        /// Gets or Sets Language
        /// </summary>
        [DataMember(Name = "language", EmitDefaultValue = false)]
        public PostNewsArticleListByMediaKindDataItemsLanguage Language { get; set; }

        /// <summary>
        /// Gets or Sets Distributor
        /// </summary>
        [DataMember(Name = "distributor", EmitDefaultValue = false)]
        public PostNewsArticleListByMediaKindDataItemsDistributor Distributor { get; set; }

        /// <summary>
        /// Gets or Sets Publisher
        /// </summary>
        [DataMember(Name = "publisher", EmitDefaultValue = false)]
        public PostNewsArticleListByMediaKindDataItemsPublisher Publisher { get; set; }
        ...
        public List<PostNewsArticleListByMediaKindDataCategoriesItems> Categories { get; set; }

        /// <summary>
        /// Gets or Sets Chain
        /// </summary>
        [DataMember(Name = "chain", EmitDefaultValue = false)]
        public PostNewsArticleListByMediaKindDataItemsChain Chain { get; set; }
        ...
        public List<PostNewsArticleListByMediaKindDataInstrumentsItems> Instruments { get; set; }
        ...
        {
            return this.Equals(input as PostNewsArticleListByMediaKindDataItems);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListByMediaKindDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListByMediaKindDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListByMediaKindDataItems input)
        {
            if (input == null)
            {
                return false;
