...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleSearchByTextDataItems")]
    public partial class PostNewsArticleSearchByTextDataItems : IEquatable<PostNewsArticleSearchByTextDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleSearchByTextDataItems" /> class.
        /// </summary>
        ...
        public PostNewsArticleSearchByTextDataItems(string code = default(string), DateTime? time = default(DateTime?), string headline = default(string), string summary = default(string), List<PostNewsArticleSearchByTextDataTypesItems> types = default(List<PostNewsArticleSearchByTextDataTypesItems>), PostNewsArticleListByIndexDataArticlesItemsLanguage language = default(PostNewsArticleListByIndexDataArticlesItemsLanguage), PostNewsArticleListByMediaKindDataItemsDistributor distributor = default(PostNewsArticleListByMediaKindDataItemsDistributor), PostNewsArticleSearchByTextDataItemsPublisher publisher = default(PostNewsArticleSearchByTextDataItemsPublisher), List<PostNewsArticleSearchByTextDataCategoriesItems> categories = default(List<PostNewsArticleSearchByTextDataCategoriesItems>), PostNewsArticleListByInstrumentDataArticlesItemsChain chain = default(PostNewsArticleListByInstrumentDataArticlesItemsChain), List<PostNewsArticleSearchByTextDataInstrumentsItems> instruments = default(List<PostNewsArticleSearchByTextDataInstrumentsItems>))
        {
            this.Code = code;
            this.Time = time;
        ...
        public List<PostNewsArticleSearchByTextDataTypesItems> Types { get; set; }
        ...
        public PostNewsArticleSearchByTextDataItemsPublisher Publisher { get; set; }
        ...
        public List<PostNewsArticleSearchByTextDataCategoriesItems> Categories { get; set; }
        ...
        public List<PostNewsArticleSearchByTextDataInstrumentsItems> Instruments { get; set; }
        ...
        {
            return this.Equals(input as PostNewsArticleSearchByTextDataItems);
        }

        /// <summary>
        /// Returns true if PostNewsArticleSearchByTextDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleSearchByTextDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleSearchByTextDataItems input)
        {
            if (input == null)
            {
                return false;
