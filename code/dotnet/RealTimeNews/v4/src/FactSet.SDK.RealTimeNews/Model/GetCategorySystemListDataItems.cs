...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCategorySystemListDataItems")]
    public partial class GetCategorySystemListDataItems : IEquatable<GetCategorySystemListDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCategorySystemListDataItems" /> class.
        /// </summary>
        ...
        public GetCategorySystemListDataItems(decimal? id = default(decimal?), string name = default(string), GetCategorySystemListDataItemsType type = default(GetCategorySystemListDataItemsType), decimal? numberOfLevels = default(decimal?), decimal? firstLevelWithLeafCategories = default(decimal?))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
        ...
        public GetCategorySystemListDataItemsType Type { get; set; }
        ...
        {
            return this.Equals(input as GetCategorySystemListDataItems);
        }

        /// <summary>
        /// Returns true if GetCategorySystemListDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCategorySystemListDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCategorySystemListDataItems input)
        {
            if (input == null)
            {
                return false;
