...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// InlineResponse20057
    /// </summary>
    [DataContract(Name = "inline_response_200_57")]
    public partial class InlineResponse20057 : IEquatable<InlineResponse20057>, IValidatableObject
    {
        ...
        public InlineResponse20057(List<PostNewsPublisherSearchByNameDataItems> data = default(List<PostNewsPublisherSearchByNameDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<PostNewsPublisherSearchByNameDataItems> Data { get; set; }
