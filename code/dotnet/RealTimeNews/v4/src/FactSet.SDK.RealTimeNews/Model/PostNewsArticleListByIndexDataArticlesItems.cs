...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListByIndexDataArticlesItems")]
    public partial class PostNewsArticleListByIndexDataArticlesItems : IEquatable<PostNewsArticleListByIndexDataArticlesItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByIndexDataArticlesItems" /> class.
        /// </summary>
        ...
        public PostNewsArticleListByIndexDataArticlesItems(string code = default(string), DateTime? time = default(DateTime?), string headline = default(string), string summary = default(string), List<PostNewsArticleListByIndexDataArticlesTypesItems> types = default(List<PostNewsArticleListByIndexDataArticlesTypesItems>), PostNewsArticleListByIndexDataArticlesItemsLanguage language = default(PostNewsArticleListByIndexDataArticlesItemsLanguage), PostNewsArticleListByIndexDataArticlesItemsDistributor distributor = default(PostNewsArticleListByIndexDataArticlesItemsDistributor), PostNewsArticleListByIndexDataArticlesItemsPublisher publisher = default(PostNewsArticleListByIndexDataArticlesItemsPublisher), List<PostNewsArticleListByIndexDataArticlesCategoriesItems> categories = default(List<PostNewsArticleListByIndexDataArticlesCategoriesItems>), PostNewsArticleListByIndexDataArticlesItemsChain chain = default(PostNewsArticleListByIndexDataArticlesItemsChain), List<PostNewsArticleListByIndexDataArticlesInstrumentsItems> instruments = default(List<PostNewsArticleListByIndexDataArticlesInstrumentsItems>))
        {
            this.Code = code;
            this.Time = time;
        ...
        public List<PostNewsArticleListByIndexDataArticlesTypesItems> Types { get; set; }

        /// <summary>
        /// Gets or Sets Language
        /// </summary>
        [DataMember(Name = "language", EmitDefaultValue = false)]
        public PostNewsArticleListByIndexDataArticlesItemsLanguage Language { get; set; }

        /// <summary>
        /// Gets or Sets Distributor
        /// </summary>
        [DataMember(Name = "distributor", EmitDefaultValue = false)]
        public PostNewsArticleListByIndexDataArticlesItemsDistributor Distributor { get; set; }

        /// <summary>
        /// Gets or Sets Publisher
        /// </summary>
        [DataMember(Name = "publisher", EmitDefaultValue = false)]
        public PostNewsArticleListByIndexDataArticlesItemsPublisher Publisher { get; set; }
        ...
        public List<PostNewsArticleListByIndexDataArticlesCategoriesItems> Categories { get; set; }

        /// <summary>
        /// Gets or Sets Chain
        /// </summary>
        [DataMember(Name = "chain", EmitDefaultValue = false)]
        public PostNewsArticleListByIndexDataArticlesItemsChain Chain { get; set; }
        ...
        public List<PostNewsArticleListByIndexDataArticlesInstrumentsItems> Instruments { get; set; }
        ...
        {
            return this.Equals(input as PostNewsArticleListByIndexDataArticlesItems);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListByIndexDataArticlesItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListByIndexDataArticlesItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListByIndexDataArticlesItems input)
        {
            if (input == null)
            {
                return false;
