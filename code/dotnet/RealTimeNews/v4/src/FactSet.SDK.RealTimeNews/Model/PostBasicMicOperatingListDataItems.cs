...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostBasicMicOperatingListDataItems")]
    public partial class PostBasicMicOperatingListDataItems : IEquatable<PostBasicMicOperatingListDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostBasicMicOperatingListDataItems" /> class.
        /// </summary>
        ...
        public PostBasicMicOperatingListDataItems(decimal? id = default(decimal?), string isoCode = default(string), string name = default(string), bool? active = default(bool?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as PostBasicMicOperatingListDataItems);
        }

        /// <summary>
        /// Returns true if PostBasicMicOperatingListDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostBasicMicOperatingListDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostBasicMicOperatingListDataItems input)
        {
            if (input == null)
            {
                return false;
