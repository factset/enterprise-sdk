...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    public partial class InlineResponse20043Data : IEquatable<InlineResponse20043Data>, IValidatableObject
    {
        ...
        public InlineResponse20043Data(DateTime? time = default(DateTime?), string headline = default(string), string summary = default(string), string body = default(string), List<GetNewsArticleGetDataTypesItems> types = default(List<GetNewsArticleGetDataTypesItems>), InlineResponse20043DataLanguage language = default(InlineResponse20043DataLanguage), InlineResponse20043DataDistributor distributor = default(InlineResponse20043DataDistributor), InlineResponse20043DataPublisher publisher = default(InlineResponse20043DataPublisher), List<GetNewsArticleGetDataCategoriesItems> categories = default(List<GetNewsArticleGetDataCategoriesItems>), List<GetNewsArticleGetDataInstrumentsItems> instruments = default(List<GetNewsArticleGetDataInstrumentsItems>), List<GetNewsArticleGetDataMediaItems> media = default(List<GetNewsArticleGetDataMediaItems>))
        {
            this.Time = time;
        ...
        public List<GetNewsArticleGetDataTypesItems> Types { get; set; }

        /// <summary>
        /// Gets or Sets Language
        /// </summary>
        [DataMember(Name = "language", EmitDefaultValue = false)]
        public InlineResponse20043DataLanguage Language { get; set; }

        /// <summary>
        /// Gets or Sets Distributor
        /// </summary>
        [DataMember(Name = "distributor", EmitDefaultValue = false)]
        public InlineResponse20043DataDistributor Distributor { get; set; }

        /// <summary>
        /// Gets or Sets Publisher
        /// </summary>
        [DataMember(Name = "publisher", EmitDefaultValue = false)]
        public InlineResponse20043DataPublisher Publisher { get; set; }
        ...
        public List<GetNewsArticleGetDataCategoriesItems> Categories { get; set; }
        ...
        public List<GetNewsArticleGetDataInstrumentsItems> Instruments { get; set; }
        ...
        public List<GetNewsArticleGetDataMediaItems> Media { get; set; }
