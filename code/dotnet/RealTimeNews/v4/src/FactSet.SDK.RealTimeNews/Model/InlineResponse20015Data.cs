...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    public partial class InlineResponse20015Data : IEquatable<InlineResponse20015Data>, IValidatableObject
    {
        ...
        public InlineResponse20015Data(string code = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?), List<GetBasicRegionGetDataNestedRegionsItems> nestedRegions = default(List<GetBasicRegionGetDataNestedRegionsItems>))
        {
            this.Code = code;
            this.Name = name;
            this.Type = type;
        ...
        public List<GetBasicRegionGetDataNestedRegionsItems> NestedRegions { get; set; }
