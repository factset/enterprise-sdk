...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// Category system.
    /// </summary>
    [DataContract(Name = "GetCategoryDatasetListDataItems_system")]
    public partial class GetCategoryDatasetListDataItemsSystem : IEquatable<GetCategoryDatasetListDataItemsSystem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCategoryDatasetListDataItemsSystem" /> class.
        /// </summary>
        ...
        public GetCategoryDatasetListDataItemsSystem(decimal? id = default(decimal?), string name = default(string), decimal? numberOfLevels = default(decimal?), decimal? firstLevelWithLeafCategories = default(decimal?))
        {
            this.Id = id;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCategoryDatasetListDataItemsSystem {\n");
        ...
        {
            return this.Equals(input as GetCategoryDatasetListDataItemsSystem);
        }

        /// <summary>
        /// Returns true if GetCategoryDatasetListDataItemsSystem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCategoryDatasetListDataItemsSystem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCategoryDatasetListDataItemsSystem input)
        {
            if (input == null)
            {
                return false;
