...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListByChainDataArticlesItems")]
    public partial class PostNewsArticleListByChainDataArticlesItems : IEquatable<PostNewsArticleListByChainDataArticlesItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByChainDataArticlesItems" /> class.
        /// </summary>
        ...
        public PostNewsArticleListByChainDataArticlesItems(string code = default(string), DateTime? time = default(DateTime?), string headline = default(string), string summary = default(string), List<PostNewsArticleListByChainDataArticlesTypesItems> types = default(List<PostNewsArticleListByChainDataArticlesTypesItems>), PostNewsArticleListByChainDataArticlesItemsLanguage language = default(PostNewsArticleListByChainDataArticlesItemsLanguage), List<PostNewsArticleListByChainDataArticlesCategoriesItems> categories = default(List<PostNewsArticleListByChainDataArticlesCategoriesItems>), List<PostNewsArticleListByChainDataArticlesInstrumentsItems> instruments = default(List<PostNewsArticleListByChainDataArticlesInstrumentsItems>))
        {
            this.Code = code;
            this.Time = time;
        ...
        public List<PostNewsArticleListByChainDataArticlesTypesItems> Types { get; set; }

        /// <summary>
        /// Gets or Sets Language
        /// </summary>
        [DataMember(Name = "language", EmitDefaultValue = false)]
        public PostNewsArticleListByChainDataArticlesItemsLanguage Language { get; set; }
        ...
        public List<PostNewsArticleListByChainDataArticlesCategoriesItems> Categories { get; set; }
        ...
        public List<PostNewsArticleListByChainDataArticlesInstrumentsItems> Instruments { get; set; }
        ...
        {
            return this.Equals(input as PostNewsArticleListByChainDataArticlesItems);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListByChainDataArticlesItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListByChainDataArticlesItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListByChainDataArticlesItems input)
        {
            if (input == null)
            {
                return false;
