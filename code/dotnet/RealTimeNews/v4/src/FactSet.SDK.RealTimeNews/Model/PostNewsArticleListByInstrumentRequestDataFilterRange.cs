...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListByInstrumentRequest_data_filter_range")]
    public partial class PostNewsArticleListByInstrumentRequestDataFilterRange : IEquatable<PostNewsArticleListByInstrumentRequestDataFilterRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByInstrumentRequestDataFilterRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostNewsArticleListByInstrumentRequestDataFilterRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListByInstrumentRequestDataFilterRange" /> class.
        /// </summary>
        ...
        public PostNewsArticleListByInstrumentRequestDataFilterRange(DateTime start, DateTime end)
        {
            this.Start = start;
            this.End = end;
        }
        ...
        {
            return this.Equals(input as PostNewsArticleListByInstrumentRequestDataFilterRange);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListByInstrumentRequestDataFilterRange instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListByInstrumentRequestDataFilterRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListByInstrumentRequestDataFilterRange input)
        {
            if (input == null)
            {
                return false;
