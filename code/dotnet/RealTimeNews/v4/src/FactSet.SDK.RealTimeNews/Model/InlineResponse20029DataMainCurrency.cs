...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_29_data_mainCurrency")]
    public partial class InlineResponse20029DataMainCurrency : IEquatable<InlineResponse20029DataMainCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20029DataMainCurrency" /> class.
        /// </summary>
        ...
        public InlineResponse20029DataMainCurrency(decimal? id = default(decimal?), string code = default(string), string isoCode = default(string), string name = default(string), bool? active = default(bool?))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20029DataMainCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse20029DataMainCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20029DataMainCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20029DataMainCurrency input)
        {
            if (input == null)
            {
                return false;
