...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListDataItems")]
    public partial class PostNewsArticleListDataItems : IEquatable<PostNewsArticleListDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListDataItems" /> class.
        /// </summary>
        ...
        public PostNewsArticleListDataItems(string code = default(string), DateTime? time = default(DateTime?), string headline = default(string), string summary = default(string), List<PostNewsArticleListDataTypesItems> types = default(List<PostNewsArticleListDataTypesItems>), PostNewsArticleListByIndexDataArticlesItemsLanguage language = default(PostNewsArticleListByIndexDataArticlesItemsLanguage), PostNewsArticleListByInstrumentDataArticlesItemsDistributor distributor = default(PostNewsArticleListByInstrumentDataArticlesItemsDistributor), InlineResponse20045DataPublisher publisher = default(InlineResponse20045DataPublisher), List<PostNewsArticleListDataCategoriesItems> categories = default(List<PostNewsArticleListDataCategoriesItems>), PostNewsArticleListDataItemsChain chain = default(PostNewsArticleListDataItemsChain), List<PostNewsArticleListDataInstrumentsItems> instruments = default(List<PostNewsArticleListDataInstrumentsItems>))
        {
            this.Code = code;
            this.Time = time;
        ...
        public List<PostNewsArticleListDataTypesItems> Types { get; set; }
        ...
        public List<PostNewsArticleListDataCategoriesItems> Categories { get; set; }

        /// <summary>
        /// Gets or Sets Chain
        /// </summary>
        [DataMember(Name = "chain", EmitDefaultValue = false)]
        public PostNewsArticleListDataItemsChain Chain { get; set; }
        ...
        public List<PostNewsArticleListDataInstrumentsItems> Instruments { get; set; }
        ...
        {
            return this.Equals(input as PostNewsArticleListDataItems);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListDataItems input)
        {
            if (input == null)
            {
                return false;
