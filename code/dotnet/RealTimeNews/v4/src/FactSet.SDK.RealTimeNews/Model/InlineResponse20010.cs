...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    public partial class InlineResponse20010 : IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(List<GetBasicMarketGroupListDataItems> data = default(List<GetBasicMarketGroupListDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<GetBasicMarketGroupListDataItems> Data { get; set; }
