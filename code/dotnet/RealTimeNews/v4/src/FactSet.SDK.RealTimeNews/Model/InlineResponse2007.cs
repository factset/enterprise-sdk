...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    public partial class InlineResponse2007 : IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">List of languages..</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2007(List<GetBasicLanguageListDataItems> data = default(List<GetBasicLanguageListDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<GetBasicLanguageListDataItems> Data { get; set; }
