...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// InlineResponse20042
    /// </summary>
    [DataContract(Name = "inline_response_200_42")]
    public partial class InlineResponse20042 : IEquatable<InlineResponse20042>, IValidatableObject
    {
        ...
        public InlineResponse20042(List<GetCategorySystemTypeListDataItems> data = default(List<GetCategorySystemTypeListDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<GetCategorySystemTypeListDataItems> Data { get; set; }
