...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// InlineResponse20036
    /// </summary>
    [DataContract(Name = "inline_response_200_36")]
    public partial class InlineResponse20036 : IEquatable<InlineResponse20036>, IValidatableObject
    {
        ...
        public InlineResponse20036(List<GetCategoryDatasetListDataItems> data = default(List<GetCategoryDatasetListDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<GetCategoryDatasetListDataItems> Data { get; set; }
