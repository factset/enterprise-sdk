...
namespace FactSet.SDK.RealTimeNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostBasicValueUnitCurrencyListDataItems")]
    public partial class PostBasicValueUnitCurrencyListDataItems : IEquatable<PostBasicValueUnitCurrencyListDataItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Type of the currency. | Value | Description | | - -- | - -- | | main | Currency that is a main currency. | | fractional | Currency that is a fractional currency. |  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostBasicValueUnitCurrencyListDataItems" /> class.
        /// </summary>
        ...
        /// <param name="type">Type of the currency. | Value | Description | | - -- | - -- | | main | Currency that is a main currency. | | fractional | Currency that is a fractional currency. |  .</param>
        /// <param name="active">Indicates whether the currency is active..</param>
        public PostBasicValueUnitCurrencyListDataItems(decimal? id = default(decimal?), string code = default(string), string isoCode = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?), bool? active = default(bool?))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as PostBasicValueUnitCurrencyListDataItems);
        }

        /// <summary>
        /// Returns true if PostBasicValueUnitCurrencyListDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostBasicValueUnitCurrencyListDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostBasicValueUnitCurrencyListDataItems input)
        {
            if (input == null)
            {
                return false;
