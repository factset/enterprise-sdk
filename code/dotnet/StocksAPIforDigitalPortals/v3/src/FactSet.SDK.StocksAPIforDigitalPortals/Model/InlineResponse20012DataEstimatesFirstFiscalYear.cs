...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_12_data_estimates_firstFiscalYear")]
    public partial class InlineResponse20012DataEstimatesFirstFiscalYear : IEquatable<InlineResponse20012DataEstimatesFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012DataEstimatesFirstFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20012DataEstimatesFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20012DataEstimatesFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20012DataEstimatesFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012DataEstimatesFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
