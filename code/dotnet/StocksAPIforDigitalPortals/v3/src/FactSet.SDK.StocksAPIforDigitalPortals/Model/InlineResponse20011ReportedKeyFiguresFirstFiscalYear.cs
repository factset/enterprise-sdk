...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_reportedKeyFigures_firstFiscalYear")]
    public partial class InlineResponse20011ReportedKeyFiguresFirstFiscalYear : IEquatable<InlineResponse20011ReportedKeyFiguresFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ReportedKeyFiguresFirstFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20011ReportedKeyFiguresFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ReportedKeyFiguresFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011ReportedKeyFiguresFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ReportedKeyFiguresFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
