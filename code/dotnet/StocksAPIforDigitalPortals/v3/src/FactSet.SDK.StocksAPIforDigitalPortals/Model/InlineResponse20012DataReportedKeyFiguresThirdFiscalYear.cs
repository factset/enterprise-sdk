...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_12_data_reportedKeyFigures_thirdFiscalYear")]
    public partial class InlineResponse20012DataReportedKeyFiguresThirdFiscalYear : IEquatable<InlineResponse20012DataReportedKeyFiguresThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012DataReportedKeyFiguresThirdFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20012DataReportedKeyFiguresThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20012DataReportedKeyFiguresThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20012DataReportedKeyFiguresThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012DataReportedKeyFiguresThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
