...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_instrument_fsym_security")]
    public partial class InlineResponse20010InstrumentFsymSecurity : IEquatable<InlineResponse20010InstrumentFsymSecurity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010InstrumentFsymSecurity" /> class.
        /// </summary>
        ...
        public InlineResponse20010InstrumentFsymSecurity(string permanentIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20010InstrumentFsymSecurity);
        }

        /// <summary>
        /// Returns true if InlineResponse20010InstrumentFsymSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010InstrumentFsymSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010InstrumentFsymSecurity input)
        {
            if (input == null)
            {
                return false;
