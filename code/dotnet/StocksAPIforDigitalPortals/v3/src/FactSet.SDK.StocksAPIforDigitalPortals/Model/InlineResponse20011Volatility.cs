...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_volatility")]
    public partial class InlineResponse20011Volatility : IEquatable<InlineResponse20011Volatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Volatility" /> class.
        /// </summary>
        ...
        public InlineResponse20011Volatility(decimal week1 = default(decimal), decimal month1 = default(decimal), decimal months3 = default(decimal), decimal months6 = default(decimal), decimal year1 = default(decimal), decimal years3 = default(decimal), decimal years5 = default(decimal), decimal yearToDate = default(decimal))
        {
            this.Week1 = week1;
            this.Month1 = month1;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011Volatility {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011Volatility);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Volatility instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Volatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Volatility input)
        {
            if (input == null)
            {
                return false;
