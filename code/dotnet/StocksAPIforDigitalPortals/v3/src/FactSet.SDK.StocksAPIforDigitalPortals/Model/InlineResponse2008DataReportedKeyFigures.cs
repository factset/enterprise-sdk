...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_reportedKeyFigures")]
    public partial class InlineResponse2008DataReportedKeyFigures : IEquatable<InlineResponse2008DataReportedKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataReportedKeyFigures" /> class.
        /// </summary>
        ...
        public InlineResponse2008DataReportedKeyFigures(InlineResponse2008DataReportedKeyFiguresFirstFiscalYear firstFiscalYear = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYear), InlineResponse2008DataReportedKeyFiguresSecondFiscalYear secondFiscalYear = default(InlineResponse2008DataReportedKeyFiguresSecondFiscalYear), InlineResponse2008DataReportedKeyFiguresThirdFiscalYear thirdFiscalYear = default(InlineResponse2008DataReportedKeyFiguresThirdFiscalYear))
        {
        ...
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2008DataReportedKeyFigures);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataReportedKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataReportedKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataReportedKeyFigures input)
        {
            if (input == null)
            {
                return false;
