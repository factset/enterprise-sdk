...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostStockNotationScreenerSearchRequest_meta_pagination")]
    public partial class PostStockNotationScreenerSearchRequestMetaPagination : IEquatable<PostStockNotationScreenerSearchRequestMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostStockNotationScreenerSearchRequestMetaPagination" /> class.
        /// </summary>
        ...
        public PostStockNotationScreenerSearchRequestMetaPagination(decimal offset = 0M, decimal limit = 20M)
        {
            this.Offset = offset;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as PostStockNotationScreenerSearchRequestMetaPagination);
        }

        /// <summary>
        /// Returns true if PostStockNotationScreenerSearchRequestMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of PostStockNotationScreenerSearchRequestMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostStockNotationScreenerSearchRequestMetaPagination input)
        {
            if (input == null)
            {
                return false;
