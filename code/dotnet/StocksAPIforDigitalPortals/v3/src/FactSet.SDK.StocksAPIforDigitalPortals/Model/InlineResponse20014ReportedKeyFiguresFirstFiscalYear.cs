...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_reportedKeyFigures_firstFiscalYear")]
    public partial class InlineResponse20014ReportedKeyFiguresFirstFiscalYear : IEquatable<InlineResponse20014ReportedKeyFiguresFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014ReportedKeyFiguresFirstFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20014ReportedKeyFiguresFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20014ReportedKeyFiguresFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014ReportedKeyFiguresFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014ReportedKeyFiguresFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
