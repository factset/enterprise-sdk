...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_valueUnit")]
    public partial class InlineResponse20014ValueUnit : IEquatable<InlineResponse20014ValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014ValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20014ValueUnit(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse20014ValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20014ValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014ValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014ValueUnit input)
        {
            if (input == null)
            {
                return false;
