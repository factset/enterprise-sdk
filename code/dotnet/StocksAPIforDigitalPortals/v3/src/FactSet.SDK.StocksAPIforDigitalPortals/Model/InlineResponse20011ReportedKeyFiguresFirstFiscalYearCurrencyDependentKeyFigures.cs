...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_reportedKeyFigures_firstFiscalYear_currencyDependentKeyFigures")]
    public partial class InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures : IEquatable<InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures" /> class.
        /// </summary>
        ...
        public InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures(InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresCurrency currency = default(InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresCurrency), decimal marketCapitalization = default(decimal), decimal ebit = default(decimal), decimal ebitda = default(decimal), InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare perShare = default(InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare))
        {
        ...
        public InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresCurrency Currency { get; set; }
        ...
        public InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare PerShare { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures input)
        {
            if (input == null)
            {
                return false;
