...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_data_nsin")]
    public partial class InlineResponse2001DataNsin : IEquatable<InlineResponse2001DataNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataNsin" /> class.
        /// </summary>
        ...
        public InlineResponse2001DataNsin(string wkn = default(string), string valor = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
        }
        ...
        {
            return this.Equals(input as InlineResponse2001DataNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse2001DataNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001DataNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001DataNsin input)
        {
            if (input == null)
            {
                return false;
