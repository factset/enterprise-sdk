...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_13_fsym_regional")]
    public partial class InlineResponse20013FsymRegional : IEquatable<InlineResponse20013FsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013FsymRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20013FsymRegional(string permanentIdentifier = default(string), string tickerRegion = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20013FsymRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20013FsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20013FsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013FsymRegional input)
        {
            if (input == null)
            {
                return false;
