...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_estimates_thirdFiscalYear")]
    public partial class InlineResponse2007EstimatesThirdFiscalYear : IEquatable<InlineResponse2007EstimatesThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007EstimatesThirdFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2007EstimatesThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2007EstimatesThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007EstimatesThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007EstimatesThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
