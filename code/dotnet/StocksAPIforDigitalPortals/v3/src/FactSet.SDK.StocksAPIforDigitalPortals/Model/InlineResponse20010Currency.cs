...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_currency")]
    public partial class InlineResponse20010Currency : IEquatable<InlineResponse20010Currency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010Currency" /> class.
        /// </summary>
        ...
        public InlineResponse20010Currency(decimal id = default(decimal), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse20010Currency);
        }

        /// <summary>
        /// Returns true if InlineResponse20010Currency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010Currency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010Currency input)
        {
            if (input == null)
            {
                return false;
