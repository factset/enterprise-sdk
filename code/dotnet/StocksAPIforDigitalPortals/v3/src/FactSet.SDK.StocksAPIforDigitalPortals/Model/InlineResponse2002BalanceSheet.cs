...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_balanceSheet")]
    public partial class InlineResponse2002BalanceSheet : IEquatable<InlineResponse2002BalanceSheet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002BalanceSheet" /> class.
        /// </summary>
        ...
        public InlineResponse2002BalanceSheet(InlineResponse2002BalanceSheetNetDebt netDebt = default(InlineResponse2002BalanceSheetNetDebt), InlineResponse2002BalanceSheetReturnOnAssets returnOnAssets = default(InlineResponse2002BalanceSheetReturnOnAssets), InlineResponse2002BalanceSheetReturnOnEquity returnOnEquity = default(InlineResponse2002BalanceSheetReturnOnEquity))
        {
        ...
        public InlineResponse2002BalanceSheetNetDebt NetDebt { get; set; }

        /// <summary>
        /// Gets or Sets ReturnOnAssets
        /// </summary>
        [DataMember(Name = "returnOnAssets", EmitDefaultValue = false)]
        public InlineResponse2002BalanceSheetReturnOnAssets ReturnOnAssets { get; set; }

        /// <summary>
        /// Gets or Sets ReturnOnEquity
        /// </summary>
        [DataMember(Name = "returnOnEquity", EmitDefaultValue = false)]
        public InlineResponse2002BalanceSheetReturnOnEquity ReturnOnEquity { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2002BalanceSheet);
        }

        /// <summary>
        /// Returns true if InlineResponse2002BalanceSheet instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002BalanceSheet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002BalanceSheet input)
        {
            if (input == null)
            {
                return false;
