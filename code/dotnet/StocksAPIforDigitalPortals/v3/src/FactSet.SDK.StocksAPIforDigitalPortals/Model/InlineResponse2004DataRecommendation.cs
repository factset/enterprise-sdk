...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_recommendation")]
    public partial class InlineResponse2004DataRecommendation : IEquatable<InlineResponse2004DataRecommendation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataRecommendation" /> class.
        /// </summary>
        ...
        /// <param name="change">Recommendation change as the difference of the latest (&#x60;snapshot&#x3D;latest&#x60;) minus the historic value of the recommendation consensus (attribute &#x60;consensus&#x60;). Values are in the range from -4 to 4, whereby -4 represents a recommendation change from 5 to 1 and 4 represents a recommendation change from 1 to 5..</param>
        public InlineResponse2004DataRecommendation(DateTime? latestUpdate = default(DateTime?), InlineResponse2003DataRecommendationCounts counts = default(InlineResponse2003DataRecommendationCounts), decimal? consensus = default(decimal?), decimal? change = default(decimal?))
        {
        ...
        /// </summary>
        /// <value>Recommendation change as the difference of the latest (&#x60;snapshot&#x3D;latest&#x60;) minus the historic value of the recommendation consensus (attribute &#x60;consensus&#x60;). Values are in the range from -4 to 4, whereby -4 represents a recommendation change from 5 to 1 and 4 represents a recommendation change from 1 to 5.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004DataRecommendation {\n");
        ...
        {
            return this.Equals(input as InlineResponse2004DataRecommendation);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataRecommendation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataRecommendation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataRecommendation input)
        {
            if (input == null)
            {
                return false;
