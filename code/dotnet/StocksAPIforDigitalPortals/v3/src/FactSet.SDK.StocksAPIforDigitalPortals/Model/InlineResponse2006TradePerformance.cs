...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_trade_performance")]
    public partial class InlineResponse2006TradePerformance : IEquatable<InlineResponse2006TradePerformance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006TradePerformance" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;currency&#x60; for its currency..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse2006TradePerformance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2006TradePerformance {\n");
        ...
        {
            return this.Equals(input as InlineResponse2006TradePerformance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006TradePerformance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006TradePerformance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006TradePerformance input)
        {
            if (input == null)
            {
                return false;
