...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// Ratios.
    /// </summary>
    [DataContract(Name = "inline_response_200_11_reportedKeyFigures_firstFiscalYear_ratios")]
    public partial class InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios : IEquatable<InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios" /> class.
        /// </summary>
        ...
        public InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios(decimal priceSales = default(decimal), decimal priceEarnings = default(decimal), decimal priceBookValue = default(decimal), decimal priceCashFlow = default(decimal), decimal priceFreeCashFlow = default(decimal), decimal dividendYield = default(decimal), decimal enterpriseValueEbit = default(decimal), decimal enterpriseValueEbitda = default(decimal), decimal enterpriseValueSales = default(decimal), decimal debtEquity = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ReportedKeyFiguresFirstFiscalYearRatios input)
        {
            if (input == null)
            {
                return false;
