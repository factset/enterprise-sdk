...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_fsym_listing")]
    public partial class InlineResponse20010FsymListing : IEquatable<InlineResponse20010FsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010FsymListing" /> class.
        /// </summary>
        ...
        public InlineResponse20010FsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool isPrimary = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20010FsymListing {\n");
        ...
        {
            return this.Equals(input as InlineResponse20010FsymListing);
        }

        /// <summary>
        /// Returns true if InlineResponse20010FsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010FsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010FsymListing input)
        {
            if (input == null)
            {
                return false;
