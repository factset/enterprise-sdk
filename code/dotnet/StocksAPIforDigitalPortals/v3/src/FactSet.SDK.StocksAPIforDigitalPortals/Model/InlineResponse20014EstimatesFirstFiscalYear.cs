...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_estimates_firstFiscalYear")]
    public partial class InlineResponse20014EstimatesFirstFiscalYear : IEquatable<InlineResponse20014EstimatesFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014EstimatesFirstFiscalYear" /> class.
        /// </summary>
        ...
        public InlineResponse20014EstimatesFirstFiscalYear(InlineResponse20014EstimatesFirstFiscalYearFiscalYear fiscalYear = default(InlineResponse20014EstimatesFirstFiscalYearFiscalYear), InlineResponse20014EstimatesFirstFiscalYearCurrencyDependentEstimates currencyDependentEstimates = default(InlineResponse20014EstimatesFirstFiscalYearCurrencyDependentEstimates), InlineResponse20014EstimatesFirstFiscalYearReturnOnAssets returnOnAssets = default(InlineResponse20014EstimatesFirstFiscalYearReturnOnAssets), InlineResponse20014EstimatesFirstFiscalYearReturnOnEquity returnOnEquity = default(InlineResponse20014EstimatesFirstFiscalYearReturnOnEquity), InlineResponse20014EstimatesFirstFiscalYearRatios ratios = default(InlineResponse20014EstimatesFirstFiscalYearRatios))
        {
        ...
        {
            return this.Equals(input as InlineResponse20014EstimatesFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20014EstimatesFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014EstimatesFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014EstimatesFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
