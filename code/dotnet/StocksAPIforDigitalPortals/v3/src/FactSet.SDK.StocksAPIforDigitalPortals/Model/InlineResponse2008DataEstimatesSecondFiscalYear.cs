...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_estimates_secondFiscalYear")]
    public partial class InlineResponse2008DataEstimatesSecondFiscalYear : IEquatable<InlineResponse2008DataEstimatesSecondFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataEstimatesSecondFiscalYear" /> class.
        /// </summary>
        ...
        public InlineResponse2008DataEstimatesSecondFiscalYear(InlineResponse2008DataEstimatesFirstFiscalYearFiscalYear fiscalYear = default(InlineResponse2008DataEstimatesFirstFiscalYearFiscalYear), InlineResponse2008DataEstimatesFirstFiscalYearCurrencyDependentEstimates currencyDependentEstimates = default(InlineResponse2008DataEstimatesFirstFiscalYearCurrencyDependentEstimates), InlineResponse2008DataEstimatesFirstFiscalYearReturnOnAssets returnOnAssets = default(InlineResponse2008DataEstimatesFirstFiscalYearReturnOnAssets), InlineResponse2008DataEstimatesFirstFiscalYearReturnOnEquity returnOnEquity = default(InlineResponse2008DataEstimatesFirstFiscalYearReturnOnEquity), InlineResponse2008DataEstimatesFirstFiscalYearRatios ratios = default(InlineResponse2008DataEstimatesFirstFiscalYearRatios))
        {
        ...
        {
            return this.Equals(input as InlineResponse2008DataEstimatesSecondFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataEstimatesSecondFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataEstimatesSecondFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataEstimatesSecondFiscalYear input)
        {
            if (input == null)
            {
                return false;
