...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_estimates")]
    public partial class InlineResponse20011Estimates : IEquatable<InlineResponse20011Estimates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Estimates" /> class.
        /// </summary>
        ...
        public InlineResponse20011Estimates(InlineResponse20011EstimatesFirstFiscalYear firstFiscalYear = default(InlineResponse20011EstimatesFirstFiscalYear), InlineResponse20011EstimatesSecondFiscalYear secondFiscalYear = default(InlineResponse20011EstimatesSecondFiscalYear), InlineResponse20011EstimatesThirdFiscalYear thirdFiscalYear = default(InlineResponse20011EstimatesThirdFiscalYear))
        {
        ...
        public InlineResponse20011EstimatesFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20011EstimatesSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20011EstimatesThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20011Estimates);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Estimates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Estimates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Estimates input)
        {
            if (input == null)
            {
                return false;
