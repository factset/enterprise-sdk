...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_volatility")]
    public partial class InlineResponse2008DataVolatility : IEquatable<InlineResponse2008DataVolatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataVolatility" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2008DataVolatility);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataVolatility instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataVolatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataVolatility input)
        {
            if (input == null)
            {
                return false;
