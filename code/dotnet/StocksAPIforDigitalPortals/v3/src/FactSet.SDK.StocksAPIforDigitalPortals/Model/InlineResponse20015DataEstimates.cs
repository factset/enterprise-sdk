...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_15_data_estimates")]
    public partial class InlineResponse20015DataEstimates : IEquatable<InlineResponse20015DataEstimates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015DataEstimates" /> class.
        /// </summary>
        ...
        public InlineResponse20015DataEstimates(InlineResponse20015DataEstimatesFirstFiscalYear firstFiscalYear = default(InlineResponse20015DataEstimatesFirstFiscalYear), InlineResponse20015DataEstimatesSecondFiscalYear secondFiscalYear = default(InlineResponse20015DataEstimatesSecondFiscalYear), InlineResponse20015DataEstimatesThirdFiscalYear thirdFiscalYear = default(InlineResponse20015DataEstimatesThirdFiscalYear))
        {
        ...
        public InlineResponse20015DataEstimatesFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20015DataEstimatesSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20015DataEstimatesThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20015DataEstimates);
        }

        /// <summary>
        /// Returns true if InlineResponse20015DataEstimates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015DataEstimates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015DataEstimates input)
        {
            if (input == null)
            {
                return false;
