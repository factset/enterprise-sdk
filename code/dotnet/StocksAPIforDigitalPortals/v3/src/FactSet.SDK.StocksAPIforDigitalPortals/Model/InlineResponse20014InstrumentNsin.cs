...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_instrument_nsin")]
    public partial class InlineResponse20014InstrumentNsin : IEquatable<InlineResponse20014InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse20014InstrumentNsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        {
            return this.Equals(input as InlineResponse20014InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse20014InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
