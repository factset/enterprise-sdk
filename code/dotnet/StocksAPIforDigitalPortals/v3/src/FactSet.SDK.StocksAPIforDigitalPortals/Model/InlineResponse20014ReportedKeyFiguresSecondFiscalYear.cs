...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_reportedKeyFigures_secondFiscalYear")]
    public partial class InlineResponse20014ReportedKeyFiguresSecondFiscalYear : IEquatable<InlineResponse20014ReportedKeyFiguresSecondFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014ReportedKeyFiguresSecondFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20014ReportedKeyFiguresSecondFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20014ReportedKeyFiguresSecondFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014ReportedKeyFiguresSecondFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014ReportedKeyFiguresSecondFiscalYear input)
        {
            if (input == null)
            {
                return false;
