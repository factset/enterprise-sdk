...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostStockNotationScreenerSearchRequest_data_compliance_france_or")]
    public partial class PostStockNotationScreenerSearchRequestDataComplianceFranceOr : IEquatable<PostStockNotationScreenerSearchRequestDataComplianceFranceOr>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PostStockNotationScreenerSearchRequestDataComplianceFranceOr);
        }

        /// <summary>
        /// Returns true if PostStockNotationScreenerSearchRequestDataComplianceFranceOr instances are equal
        /// </summary>
        /// <param name="input">Instance of PostStockNotationScreenerSearchRequestDataComplianceFranceOr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostStockNotationScreenerSearchRequestDataComplianceFranceOr input)
        {
            if (input == null)
            {
                return false;
