...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_estimates_firstFiscalYear")]
    public partial class InlineResponse2007EstimatesFirstFiscalYear : IEquatable<InlineResponse2007EstimatesFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007EstimatesFirstFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2007EstimatesFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2007EstimatesFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007EstimatesFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007EstimatesFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
