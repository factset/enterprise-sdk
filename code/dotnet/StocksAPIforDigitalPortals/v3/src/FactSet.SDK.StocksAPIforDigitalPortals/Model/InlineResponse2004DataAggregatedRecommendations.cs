...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_aggregatedRecommendations")]
    public partial class InlineResponse2004DataAggregatedRecommendations : IEquatable<InlineResponse2004DataAggregatedRecommendations>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataAggregatedRecommendations" /> class.
        /// </summary>
        ...
        public InlineResponse2004DataAggregatedRecommendations(SnapshotEnum? snapshot = default(SnapshotEnum?), InlineResponse2003DataTargetPrice targetPrice = default(InlineResponse2003DataTargetPrice), InlineResponse2004DataRecommendation recommendation = default(InlineResponse2004DataRecommendation))
        {
        ...
        public InlineResponse2003DataTargetPrice TargetPrice { get; set; }

        /// <summary>
        /// Gets or Sets Recommendation
        /// </summary>
        [DataMember(Name = "recommendation", EmitDefaultValue = false)]
        public InlineResponse2004DataRecommendation Recommendation { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2004DataAggregatedRecommendations);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataAggregatedRecommendations instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataAggregatedRecommendations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataAggregatedRecommendations input)
        {
            if (input == null)
            {
                return false;
