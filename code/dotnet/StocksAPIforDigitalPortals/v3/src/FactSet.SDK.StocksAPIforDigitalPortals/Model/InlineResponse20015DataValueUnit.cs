...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_15_data_valueUnit")]
    public partial class InlineResponse20015DataValueUnit : IEquatable<InlineResponse20015DataValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015DataValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20015DataValueUnit(decimal? id = default(decimal?), string code = default(string), decimal? count = default(decimal?))
        {
            this.Id = id;
            this.Code = code;
            this.Count = count;
        ...
        {
            return this.Equals(input as InlineResponse20015DataValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20015DataValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015DataValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015DataValueUnit input)
        {
            if (input == null)
            {
                return false;
