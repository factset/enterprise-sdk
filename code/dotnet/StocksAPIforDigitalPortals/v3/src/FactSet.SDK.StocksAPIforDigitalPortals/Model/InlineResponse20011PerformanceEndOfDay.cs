...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_performance_endOfDay")]
    public partial class InlineResponse20011PerformanceEndOfDay : IEquatable<InlineResponse20011PerformanceEndOfDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011PerformanceEndOfDay" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20011PerformanceEndOfDay);
        }

        /// <summary>
        /// Returns true if InlineResponse20011PerformanceEndOfDay instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011PerformanceEndOfDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011PerformanceEndOfDay input)
        {
            if (input == null)
            {
                return false;
