...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_13_accumulated")]
    public partial class InlineResponse20013Accumulated : IEquatable<InlineResponse20013Accumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013Accumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20013Accumulated(decimal? numberTrades = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20013Accumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20013Accumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20013Accumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013Accumulated input)
        {
            if (input == null)
            {
                return false;
