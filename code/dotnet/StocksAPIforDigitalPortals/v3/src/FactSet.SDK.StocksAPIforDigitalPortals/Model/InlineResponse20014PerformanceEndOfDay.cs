...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_performance_endOfDay")]
    public partial class InlineResponse20014PerformanceEndOfDay : IEquatable<InlineResponse20014PerformanceEndOfDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014PerformanceEndOfDay" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20014PerformanceEndOfDay);
        }

        /// <summary>
        /// Returns true if InlineResponse20014PerformanceEndOfDay instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014PerformanceEndOfDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014PerformanceEndOfDay input)
        {
            if (input == null)
            {
                return false;
