...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// Per-share figures.
    /// </summary>
    [DataContract(Name = "inline_response_200_7_reportedKeyFigures_firstFiscalYear_currencyDependentKeyFigures_perShare")]
    public partial class InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare : IEquatable<InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare" /> class.
        /// </summary>
        ...
        public InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare(decimal sales = default(decimal), decimal recurringDilutedEarnings = default(decimal), decimal dividends = default(decimal), decimal bookValue = default(decimal), decimal cashFlow = default(decimal))
        {
            this.Sales = sales;
        ...
        {
            return this.Equals(input as InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare);
        }

        /// <summary>
        /// Returns true if InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare input)
        {
            if (input == null)
            {
                return false;
