...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_performance_endOfDay")]
    public partial class InlineResponse2007PerformanceEndOfDay : IEquatable<InlineResponse2007PerformanceEndOfDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007PerformanceEndOfDay" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2007PerformanceEndOfDay);
        }

        /// <summary>
        /// Returns true if InlineResponse2007PerformanceEndOfDay instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007PerformanceEndOfDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007PerformanceEndOfDay input)
        {
            if (input == null)
            {
                return false;
