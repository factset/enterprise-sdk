...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_estimates")]
    public partial class InlineResponse2008DataEstimates : IEquatable<InlineResponse2008DataEstimates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataEstimates" /> class.
        /// </summary>
        ...
        public InlineResponse2008DataEstimates(InlineResponse2008DataEstimatesFirstFiscalYear firstFiscalYear = default(InlineResponse2008DataEstimatesFirstFiscalYear), InlineResponse2008DataEstimatesSecondFiscalYear secondFiscalYear = default(InlineResponse2008DataEstimatesSecondFiscalYear), InlineResponse2008DataEstimatesThirdFiscalYear thirdFiscalYear = default(InlineResponse2008DataEstimatesThirdFiscalYear))
        {
        ...
        public InlineResponse2008DataEstimatesFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2008DataEstimatesSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2008DataEstimatesThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2008DataEstimates);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataEstimates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataEstimates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataEstimates input)
        {
            if (input == null)
            {
                return false;
