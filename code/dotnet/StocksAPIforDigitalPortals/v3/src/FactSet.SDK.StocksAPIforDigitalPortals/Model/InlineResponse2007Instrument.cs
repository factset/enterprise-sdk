...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_instrument")]
    public partial class InlineResponse2007Instrument : IEquatable<InlineResponse2007Instrument>, IValidatableObject
    {
        /// <summary>
        /// Type of stock.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse2007Instrument(string id = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse2007InstrumentNsin nsin = default(InlineResponse2007InstrumentNsin), InlineResponse2006InstrumentFsym fsym = default(InlineResponse2006InstrumentFsym), StockTypeEnum? stockType = default(StockTypeEnum?), InlineResponse2007InstrumentIndustryClassification industryClassification = default(InlineResponse2007InstrumentIndustryClassification), InlineResponse2007InstrumentCompany company = default(InlineResponse2007InstrumentCompany))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse2007InstrumentNsin Nsin { get; set; }
        ...
        public InlineResponse2007InstrumentIndustryClassification IndustryClassification { get; set; }

        /// <summary>
        /// Gets or Sets Company
        /// </summary>
        [DataMember(Name = "company", EmitDefaultValue = false)]
        public InlineResponse2007InstrumentCompany Company { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2007Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Instrument input)
        {
            if (input == null)
            {
                return false;
