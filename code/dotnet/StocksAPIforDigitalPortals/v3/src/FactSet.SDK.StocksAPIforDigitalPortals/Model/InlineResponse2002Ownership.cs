...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_ownership")]
    public partial class InlineResponse2002Ownership : IEquatable<InlineResponse2002Ownership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002Ownership" /> class.
        /// </summary>
        ...
        public InlineResponse2002Ownership(decimal fraction = default(decimal), decimal numberShares = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2002Ownership);
        }

        /// <summary>
        /// Returns true if InlineResponse2002Ownership instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002Ownership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002Ownership input)
        {
            if (input == null)
            {
                return false;
