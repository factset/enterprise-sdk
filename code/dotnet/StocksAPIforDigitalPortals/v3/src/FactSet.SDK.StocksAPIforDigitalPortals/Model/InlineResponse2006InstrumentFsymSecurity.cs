...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_fsym_security")]
    public partial class InlineResponse2006InstrumentFsymSecurity : IEquatable<InlineResponse2006InstrumentFsymSecurity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentFsymSecurity" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentFsymSecurity(string permanentIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentFsymSecurity);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentFsymSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentFsymSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentFsymSecurity input)
        {
            if (input == null)
            {
                return false;
