...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_13_instrument")]
    public partial class InlineResponse20013Instrument : IEquatable<InlineResponse20013Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20013Instrument(string id = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse2001DataNsin nsin = default(InlineResponse2001DataNsin), InlineResponse200DataFsym fsym = default(InlineResponse200DataFsym), InlineResponse20013InstrumentIndustryClassification industryClassification = default(InlineResponse20013InstrumentIndustryClassification), InlineResponse2001DataCompany company = default(InlineResponse2001DataCompany))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse20013InstrumentIndustryClassification IndustryClassification { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20013Instrument {\n");
        ...
        {
            return this.Equals(input as InlineResponse20013Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20013Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20013Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013Instrument input)
        {
            if (input == null)
            {
                return false;
