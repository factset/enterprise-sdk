...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_15_data_reportedKeyFigures_thirdFiscalYear")]
    public partial class InlineResponse20015DataReportedKeyFiguresThirdFiscalYear : IEquatable<InlineResponse20015DataReportedKeyFiguresThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015DataReportedKeyFiguresThirdFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20015DataReportedKeyFiguresThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20015DataReportedKeyFiguresThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015DataReportedKeyFiguresThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015DataReportedKeyFiguresThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
