...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2003Type : IEquatable<InlineResponse2003Type>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as InlineResponse2003Type);
        }

        /// <summary>
        /// Returns true if InlineResponse2003Type instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003Type to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003Type input)
        {
            if (input == null)
            {
                return false;
