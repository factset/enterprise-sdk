...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostStockNotationScreenerSearchRequest_data_volatility")]
    public partial class PostStockNotationScreenerSearchRequestDataVolatility : IEquatable<PostStockNotationScreenerSearchRequestDataVolatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostStockNotationScreenerSearchRequestDataVolatility" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostStockNotationScreenerSearchRequestDataVolatility);
        }

        /// <summary>
        /// Returns true if PostStockNotationScreenerSearchRequestDataVolatility instances are equal
        /// </summary>
        /// <param name="input">Instance of PostStockNotationScreenerSearchRequestDataVolatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostStockNotationScreenerSearchRequestDataVolatility input)
        {
            if (input == null)
            {
                return false;
