...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_dates")]
    public partial class InlineResponse20010DataDates : IEquatable<InlineResponse20010DataDates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataDates" /> class.
        /// </summary>
        ...
        public InlineResponse20010DataDates(DateTime? announcement = default(DateTime?), DateTime? record = default(DateTime?), DateTime? effective = default(DateTime?), DateTime? payment = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20010DataDates);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataDates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataDates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataDates input)
        {
            if (input == null)
            {
                return false;
