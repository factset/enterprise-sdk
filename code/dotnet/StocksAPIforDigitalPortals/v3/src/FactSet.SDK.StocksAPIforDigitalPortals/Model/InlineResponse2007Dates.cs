...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_dates")]
    public partial class InlineResponse2007Dates : IEquatable<InlineResponse2007Dates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Dates" /> class.
        /// </summary>
        ...
        public InlineResponse2007Dates(DateTime announcement = default(DateTime), DateTime record = default(DateTime), DateTime effective = default(DateTime), DateTime payment = default(DateTime))
        {
        ...
        {
            return this.Equals(input as InlineResponse2007Dates);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Dates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Dates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Dates input)
        {
            if (input == null)
            {
                return false;
