...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// Ratios.
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_reportedKeyFigures_firstFiscalYear_ratios")]
    public partial class InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios : IEquatable<InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios" /> class.
        /// </summary>
        ...
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceSales priceSales = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceSales), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceEarnings priceEarnings = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceEarnings), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceBookValue priceBookValue = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceBookValue), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceCashFlow priceCashFlow = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceCashFlow), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceFreeCashFlow priceFreeCashFlow = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceFreeCashFlow), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosDividendYield dividendYield = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosDividendYield), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueEbit enterpriseValueEbit = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueEbit), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueEbitda enterpriseValueEbitda = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueEbitda), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueSales enterpriseValueSales = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueSales), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosDebtEquity debtEquity = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosDebtEquity))
        {
        ...
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceSales PriceSales { get; set; }

        /// <summary>
        /// Gets or Sets PriceEarnings
        /// </summary>
        [DataMember(Name = "priceEarnings", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceEarnings PriceEarnings { get; set; }

        /// <summary>
        /// Gets or Sets PriceBookValue
        /// </summary>
        [DataMember(Name = "priceBookValue", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceBookValue PriceBookValue { get; set; }

        /// <summary>
        /// Gets or Sets PriceCashFlow
        /// </summary>
        [DataMember(Name = "priceCashFlow", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceCashFlow PriceCashFlow { get; set; }

        /// <summary>
        /// Gets or Sets PriceFreeCashFlow
        /// </summary>
        [DataMember(Name = "priceFreeCashFlow", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosPriceFreeCashFlow PriceFreeCashFlow { get; set; }

        /// <summary>
        /// Gets or Sets DividendYield
        /// </summary>
        [DataMember(Name = "dividendYield", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosDividendYield DividendYield { get; set; }

        /// <summary>
        /// Gets or Sets EnterpriseValueEbit
        /// </summary>
        [DataMember(Name = "enterpriseValueEbit", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueEbit EnterpriseValueEbit { get; set; }

        /// <summary>
        /// Gets or Sets EnterpriseValueEbitda
        /// </summary>
        [DataMember(Name = "enterpriseValueEbitda", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueEbitda EnterpriseValueEbitda { get; set; }

        /// <summary>
        /// Gets or Sets EnterpriseValueSales
        /// </summary>
        [DataMember(Name = "enterpriseValueSales", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosEnterpriseValueSales EnterpriseValueSales { get; set; }

        /// <summary>
        /// Gets or Sets DebtEquity
        /// </summary>
        [DataMember(Name = "debtEquity", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatiosDebtEquity DebtEquity { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios input)
        {
            if (input == null)
            {
                return false;
