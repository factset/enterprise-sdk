...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_simpleMovingAverage")]
    public partial class InlineResponse2007SimpleMovingAverage : IEquatable<InlineResponse2007SimpleMovingAverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007SimpleMovingAverage" /> class.
        /// </summary>
        ...
        public InlineResponse2007SimpleMovingAverage(decimal days20 = default(decimal), decimal days50 = default(decimal), decimal days200 = default(decimal), InlineResponse2007SimpleMovingAverageTradingDaysSinceCrossover tradingDaysSinceCrossover = default(InlineResponse2007SimpleMovingAverageTradingDaysSinceCrossover))
        {
            this.Days20 = days20;
            this.Days50 = days50;
        ...
        public InlineResponse2007SimpleMovingAverageTradingDaysSinceCrossover TradingDaysSinceCrossover { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2007SimpleMovingAverage);
        }

        /// <summary>
        /// Returns true if InlineResponse2007SimpleMovingAverage instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007SimpleMovingAverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007SimpleMovingAverage input)
        {
            if (input == null)
            {
                return false;
