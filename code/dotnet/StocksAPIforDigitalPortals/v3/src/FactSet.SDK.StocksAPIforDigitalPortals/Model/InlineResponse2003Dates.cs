...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_dates")]
    public partial class InlineResponse2003Dates : IEquatable<InlineResponse2003Dates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003Dates" /> class.
        /// </summary>
        ...
        public InlineResponse2003Dates(DateTime announcement = default(DateTime), DateTime record = default(DateTime), DateTime effective = default(DateTime), DateTime payment = default(DateTime))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003Dates);
        }

        /// <summary>
        /// Returns true if InlineResponse2003Dates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003Dates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003Dates input)
        {
            if (input == null)
            {
                return false;
