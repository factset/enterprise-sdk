...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_instrument_nsin")]
    public partial class InlineResponse20010InstrumentNsin : IEquatable<InlineResponse20010InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse20010InstrumentNsin(string wkn = default(string), string valor = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
        }
        ...
        {
            return this.Equals(input as InlineResponse20010InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse20010InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
