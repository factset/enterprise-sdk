...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_instrument")]
    public partial class InlineResponse20011Instrument : IEquatable<InlineResponse20011Instrument>, IValidatableObject
    {
        /// <summary>
        /// Type of stock.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20011Instrument(string id = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse20011InstrumentNsin nsin = default(InlineResponse20011InstrumentNsin), InlineResponse20010InstrumentFsym fsym = default(InlineResponse20010InstrumentFsym), StockTypeEnum? stockType = default(StockTypeEnum?), InlineResponse20011InstrumentIndustryClassification industryClassification = default(InlineResponse20011InstrumentIndustryClassification), InlineResponse20011InstrumentCompany company = default(InlineResponse20011InstrumentCompany))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse20011InstrumentNsin Nsin { get; set; }

        /// <summary>
        /// Gets or Sets Fsym
        /// </summary>
        [DataMember(Name = "fsym", EmitDefaultValue = false)]
        public InlineResponse20010InstrumentFsym Fsym { get; set; }

        /// <summary>
        /// Gets or Sets IndustryClassification
        /// </summary>
        [DataMember(Name = "industryClassification", EmitDefaultValue = false)]
        public InlineResponse20011InstrumentIndustryClassification IndustryClassification { get; set; }

        /// <summary>
        /// Gets or Sets Company
        /// </summary>
        [DataMember(Name = "company", EmitDefaultValue = false)]
        public InlineResponse20011InstrumentCompany Company { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20011Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Instrument input)
        {
            if (input == null)
            {
                return false;
