...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostStockNotationScreenerSearchRequest_data_validation_prices_latest")]
    public partial class PostStockNotationScreenerSearchRequestDataValidationPricesLatest : IEquatable<PostStockNotationScreenerSearchRequestDataValidationPricesLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostStockNotationScreenerSearchRequestDataValidationPricesLatest" /> class.
        /// </summary>
        ...
        public PostStockNotationScreenerSearchRequestDataValidationPricesLatest(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as PostStockNotationScreenerSearchRequestDataValidationPricesLatest);
        }

        /// <summary>
        /// Returns true if PostStockNotationScreenerSearchRequestDataValidationPricesLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostStockNotationScreenerSearchRequestDataValidationPricesLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostStockNotationScreenerSearchRequestDataValidationPricesLatest input)
        {
            if (input == null)
            {
                return false;
