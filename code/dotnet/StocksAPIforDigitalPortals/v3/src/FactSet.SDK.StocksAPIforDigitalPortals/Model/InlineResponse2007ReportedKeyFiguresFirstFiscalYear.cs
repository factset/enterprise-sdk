...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_reportedKeyFigures_firstFiscalYear")]
    public partial class InlineResponse2007ReportedKeyFiguresFirstFiscalYear : IEquatable<InlineResponse2007ReportedKeyFiguresFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007ReportedKeyFiguresFirstFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2007ReportedKeyFiguresFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2007ReportedKeyFiguresFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007ReportedKeyFiguresFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007ReportedKeyFiguresFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
