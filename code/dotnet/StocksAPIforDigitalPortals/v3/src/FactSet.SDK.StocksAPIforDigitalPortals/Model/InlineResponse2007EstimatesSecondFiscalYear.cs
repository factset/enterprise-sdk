...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_estimates_secondFiscalYear")]
    public partial class InlineResponse2007EstimatesSecondFiscalYear : IEquatable<InlineResponse2007EstimatesSecondFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007EstimatesSecondFiscalYear" /> class.
        /// </summary>
        ...
        public InlineResponse2007EstimatesSecondFiscalYear(InlineResponse2007EstimatesFirstFiscalYearFiscalYear fiscalYear = default(InlineResponse2007EstimatesFirstFiscalYearFiscalYear), InlineResponse2007EstimatesFirstFiscalYearCurrencyDependentEstimates currencyDependentEstimates = default(InlineResponse2007EstimatesFirstFiscalYearCurrencyDependentEstimates), InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets returnOnAssets = default(InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets), InlineResponse2007EstimatesFirstFiscalYearReturnOnEquity returnOnEquity = default(InlineResponse2007EstimatesFirstFiscalYearReturnOnEquity), InlineResponse2007EstimatesFirstFiscalYearRatios ratios = default(InlineResponse2007EstimatesFirstFiscalYearRatios))
        {
        ...
        public InlineResponse2007EstimatesFirstFiscalYearFiscalYear FiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets CurrencyDependentEstimates
        /// </summary>
        [DataMember(Name = "currencyDependentEstimates", EmitDefaultValue = false)]
        public InlineResponse2007EstimatesFirstFiscalYearCurrencyDependentEstimates CurrencyDependentEstimates { get; set; }

        /// <summary>
        /// Gets or Sets ReturnOnAssets
        /// </summary>
        [DataMember(Name = "returnOnAssets", EmitDefaultValue = false)]
        public InlineResponse2007EstimatesFirstFiscalYearReturnOnAssets ReturnOnAssets { get; set; }

        /// <summary>
        /// Gets or Sets ReturnOnEquity
        /// </summary>
        [DataMember(Name = "returnOnEquity", EmitDefaultValue = false)]
        public InlineResponse2007EstimatesFirstFiscalYearReturnOnEquity ReturnOnEquity { get; set; }

        /// <summary>
        /// Gets or Sets Ratios
        /// </summary>
        [DataMember(Name = "ratios", EmitDefaultValue = false)]
        public InlineResponse2007EstimatesFirstFiscalYearRatios Ratios { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007EstimatesSecondFiscalYear {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007EstimatesSecondFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2007EstimatesSecondFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007EstimatesSecondFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007EstimatesSecondFiscalYear input)
        {
            if (input == null)
            {
                return false;
