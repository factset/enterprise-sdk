...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_valueUnit")]
    public partial class InlineResponse20011ValueUnit : IEquatable<InlineResponse20011ValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20011ValueUnit(decimal id = default(decimal), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse20011ValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011ValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ValueUnit input)
        {
            if (input == null)
            {
                return false;
