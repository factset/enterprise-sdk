...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_nsin")]
    public partial class InlineResponse2006InstrumentNsin : IEquatable<InlineResponse2006InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentNsin(string wkn = default(string), string valor = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2006InstrumentNsin {\n");
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
