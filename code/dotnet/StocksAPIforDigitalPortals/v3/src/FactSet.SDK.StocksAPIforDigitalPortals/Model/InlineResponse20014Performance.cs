...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_performance")]
    public partial class InlineResponse20014Performance : IEquatable<InlineResponse20014Performance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014Performance" /> class.
        /// </summary>
        ...
        public InlineResponse20014Performance(decimal? intraday = default(decimal?), InlineResponse20014PerformanceEndOfDay endOfDay = default(InlineResponse20014PerformanceEndOfDay))
        {
        ...
        public InlineResponse20014PerformanceEndOfDay EndOfDay { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20014Performance);
        }

        /// <summary>
        /// Returns true if InlineResponse20014Performance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014Performance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014Performance input)
        {
            if (input == null)
            {
                return false;
