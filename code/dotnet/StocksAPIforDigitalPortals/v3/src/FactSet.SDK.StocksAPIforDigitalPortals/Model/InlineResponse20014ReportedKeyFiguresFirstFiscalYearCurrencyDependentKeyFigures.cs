...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_reportedKeyFigures_firstFiscalYear_currencyDependentKeyFigures")]
    public partial class InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures : IEquatable<InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures" /> class.
        /// </summary>
        ...
        public InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures(InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresCurrency currency = default(InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresCurrency), decimal? marketCapitalization = default(decimal?), decimal? ebit = default(decimal?), decimal? ebitda = default(decimal?), InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare perShare = default(InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare))
        {
        ...
        public InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresCurrency Currency { get; set; }
        ...
        public InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFiguresPerShare PerShare { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures);
        }

        /// <summary>
        /// Returns true if InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014ReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures input)
        {
            if (input == null)
            {
                return false;
