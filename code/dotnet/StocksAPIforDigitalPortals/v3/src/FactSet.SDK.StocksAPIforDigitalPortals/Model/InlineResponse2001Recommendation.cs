...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_recommendation")]
    public partial class InlineResponse2001Recommendation : IEquatable<InlineResponse2001Recommendation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Recommendation" /> class.
        /// </summary>
        ...
        public InlineResponse2001Recommendation(DateTime latestUpdate = default(DateTime), InlineResponse200DataRecommendationCounts counts = default(InlineResponse200DataRecommendationCounts), decimal consensus = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2001Recommendation);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Recommendation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Recommendation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Recommendation input)
        {
            if (input == null)
            {
                return false;
