...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_estimates")]
    public partial class InlineResponse20014Estimates : IEquatable<InlineResponse20014Estimates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014Estimates" /> class.
        /// </summary>
        ...
        public InlineResponse20014Estimates(InlineResponse20014EstimatesFirstFiscalYear firstFiscalYear = default(InlineResponse20014EstimatesFirstFiscalYear), InlineResponse20014EstimatesSecondFiscalYear secondFiscalYear = default(InlineResponse20014EstimatesSecondFiscalYear), InlineResponse20014EstimatesThirdFiscalYear thirdFiscalYear = default(InlineResponse20014EstimatesThirdFiscalYear))
        {
        ...
        public InlineResponse20014EstimatesFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20014EstimatesSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20014EstimatesThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20014Estimates);
        }

        /// <summary>
        /// Returns true if InlineResponse20014Estimates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014Estimates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014Estimates input)
        {
            if (input == null)
            {
                return false;
