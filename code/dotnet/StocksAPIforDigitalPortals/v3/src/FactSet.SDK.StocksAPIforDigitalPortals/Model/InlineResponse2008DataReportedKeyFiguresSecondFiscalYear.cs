...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_reportedKeyFigures_secondFiscalYear")]
    public partial class InlineResponse2008DataReportedKeyFiguresSecondFiscalYear : IEquatable<InlineResponse2008DataReportedKeyFiguresSecondFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataReportedKeyFiguresSecondFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2008DataReportedKeyFiguresSecondFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataReportedKeyFiguresSecondFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataReportedKeyFiguresSecondFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataReportedKeyFiguresSecondFiscalYear input)
        {
            if (input == null)
            {
                return false;
