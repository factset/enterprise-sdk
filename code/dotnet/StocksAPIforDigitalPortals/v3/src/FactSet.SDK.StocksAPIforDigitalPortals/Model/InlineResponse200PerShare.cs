...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_perShare")]
    public partial class InlineResponse200PerShare : IEquatable<InlineResponse200PerShare>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200PerShare" /> class.
        /// </summary>
        ...
        public InlineResponse200PerShare(InlineResponse200PerShareDividends dividends = default(InlineResponse200PerShareDividends), InlineResponse200PerShareEarnings earnings = default(InlineResponse200PerShareEarnings), InlineResponse200PerShareCashFlow cashFlow = default(InlineResponse200PerShareCashFlow), InlineResponse200PerShareSales sales = default(InlineResponse200PerShareSales), InlineResponse200PerShareNetAssetValue netAssetValue = default(InlineResponse200PerShareNetAssetValue))
        {
        ...
        public InlineResponse200PerShareDividends Dividends { get; set; }

        /// <summary>
        /// Gets or Sets Earnings
        /// </summary>
        [DataMember(Name = "earnings", EmitDefaultValue = false)]
        public InlineResponse200PerShareEarnings Earnings { get; set; }

        /// <summary>
        /// Gets or Sets CashFlow
        /// </summary>
        [DataMember(Name = "cashFlow", EmitDefaultValue = false)]
        public InlineResponse200PerShareCashFlow CashFlow { get; set; }

        /// <summary>
        /// Gets or Sets Sales
        /// </summary>
        [DataMember(Name = "sales", EmitDefaultValue = false)]
        public InlineResponse200PerShareSales Sales { get; set; }

        /// <summary>
        /// Gets or Sets NetAssetValue
        /// </summary>
        [DataMember(Name = "netAssetValue", EmitDefaultValue = false)]
        public InlineResponse200PerShareNetAssetValue NetAssetValue { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200PerShare);
        }

        /// <summary>
        /// Returns true if InlineResponse200PerShare instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200PerShare to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200PerShare input)
        {
            if (input == null)
            {
                return false;
