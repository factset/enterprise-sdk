...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_fsym_listing")]
    public partial class InlineResponse2006FsymListing : IEquatable<InlineResponse2006FsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006FsymListing" /> class.
        /// </summary>
        ...
        public InlineResponse2006FsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool isPrimary = default(bool))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006FsymListing);
        }

        /// <summary>
        /// Returns true if InlineResponse2006FsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006FsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006FsymListing input)
        {
            if (input == null)
            {
                return false;
