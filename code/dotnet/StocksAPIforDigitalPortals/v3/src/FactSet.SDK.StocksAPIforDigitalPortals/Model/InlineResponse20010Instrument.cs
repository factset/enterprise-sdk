...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_instrument")]
    public partial class InlineResponse20010Instrument : IEquatable<InlineResponse20010Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20010Instrument(string id = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse20010InstrumentNsin nsin = default(InlineResponse20010InstrumentNsin), InlineResponse20010InstrumentFsym fsym = default(InlineResponse20010InstrumentFsym), InlineResponse20010InstrumentIndustryClassification industryClassification = default(InlineResponse20010InstrumentIndustryClassification), InlineResponse20010InstrumentCompany company = default(InlineResponse20010InstrumentCompany))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse20010InstrumentNsin Nsin { get; set; }
        ...
        public InlineResponse20010InstrumentIndustryClassification IndustryClassification { get; set; }

        /// <summary>
        /// Gets or Sets Company
        /// </summary>
        [DataMember(Name = "company", EmitDefaultValue = false)]
        public InlineResponse20010InstrumentCompany Company { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20010Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20010Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010Instrument input)
        {
            if (input == null)
            {
                return false;
