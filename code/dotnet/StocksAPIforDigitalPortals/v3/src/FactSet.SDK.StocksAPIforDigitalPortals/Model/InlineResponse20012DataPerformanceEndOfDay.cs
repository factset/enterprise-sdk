...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_12_data_performance_endOfDay")]
    public partial class InlineResponse20012DataPerformanceEndOfDay : IEquatable<InlineResponse20012DataPerformanceEndOfDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012DataPerformanceEndOfDay" /> class.
        /// </summary>
        ...
        public InlineResponse20012DataPerformanceEndOfDayDay1 Day1 { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20012DataPerformanceEndOfDay);
        }

        /// <summary>
        /// Returns true if InlineResponse20012DataPerformanceEndOfDay instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20012DataPerformanceEndOfDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012DataPerformanceEndOfDay input)
        {
            if (input == null)
            {
                return false;
