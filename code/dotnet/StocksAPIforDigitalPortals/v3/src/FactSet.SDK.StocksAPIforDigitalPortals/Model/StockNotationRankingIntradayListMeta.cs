...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_stock_notation_ranking_intraday_list_meta")]
    public partial class StockNotationRankingIntradayListMeta : IEquatable<StockNotationRankingIntradayListMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StockNotationRankingIntradayListMeta" /> class.
        /// </summary>
        ...
        public StockNotationRankingIntradayListMeta(List<string> attributes = default(List<string>), string language = default(string), List<SortEnum> sort = default(List<SortEnum>), StockNotationRankingIntradayListMetaPagination pagination = default(StockNotationRankingIntradayListMetaPagination))
        {
        ...
        public StockNotationRankingIntradayListMetaPagination Pagination { get; set; }
        ...
        {
            return this.Equals(input as StockNotationRankingIntradayListMeta);
        }

        /// <summary>
        /// Returns true if StockNotationRankingIntradayListMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of StockNotationRankingIntradayListMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockNotationRankingIntradayListMeta input)
        {
            if (input == null)
            {
                return false;
