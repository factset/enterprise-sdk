...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// Ratio parameters.
    /// </summary>
    [DataContract(Name = "PostStockNotationScreenerSearchRequest_data_ratios_1")]
    public partial class PostStockNotationScreenerSearchRequestDataRatios1 : IEquatable<PostStockNotationScreenerSearchRequestDataRatios1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostStockNotationScreenerSearchRequestDataRatios1" /> class.
        /// </summary>
        ...
        public PostStockNotationScreenerSearchRequestDataRatios1(PostStockNotationScreenerSearchRequestDataRatios1PriceSales priceSales = default(PostStockNotationScreenerSearchRequestDataRatios1PriceSales), PostStockNotationScreenerSearchRequestDataRatios1PriceEarnings priceEarnings = default(PostStockNotationScreenerSearchRequestDataRatios1PriceEarnings), PostStockNotationScreenerSearchRequestDataRatios1PriceEarningsGrowth priceEarningsGrowth = default(PostStockNotationScreenerSearchRequestDataRatios1PriceEarningsGrowth), PostStockNotationScreenerSearchRequestDataRatios1PriceBookValue priceBookValue = default(PostStockNotationScreenerSearchRequestDataRatios1PriceBookValue), PostStockNotationScreenerSearchRequestDataRatios1PriceCashFlow priceCashFlow = default(PostStockNotationScreenerSearchRequestDataRatios1PriceCashFlow), PostStockNotationScreenerSearchRequestDataRatios1PriceFreeCashFlow priceFreeCashFlow = default(PostStockNotationScreenerSearchRequestDataRatios1PriceFreeCashFlow), PostStockNotationScreenerSearchRequestDataRatios1DividendYield dividendYield = default(PostStockNotationScreenerSearchRequestDataRatios1DividendYield), PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueEbit enterpriseValueEbit = default(PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueEbit), PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueEbitda enterpriseValueEbitda = default(PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueEbitda), PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueSales enterpriseValueSales = default(PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueSales))
        {
        ...
        public PostStockNotationScreenerSearchRequestDataRatios1PriceSales PriceSales { get; set; }

        /// <summary>
        /// Gets or Sets PriceEarnings
        /// </summary>
        [DataMember(Name = "priceEarnings", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1PriceEarnings PriceEarnings { get; set; }

        /// <summary>
        /// Gets or Sets PriceEarningsGrowth
        /// </summary>
        [DataMember(Name = "priceEarningsGrowth", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1PriceEarningsGrowth PriceEarningsGrowth { get; set; }

        /// <summary>
        /// Gets or Sets PriceBookValue
        /// </summary>
        [DataMember(Name = "priceBookValue", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1PriceBookValue PriceBookValue { get; set; }

        /// <summary>
        /// Gets or Sets PriceCashFlow
        /// </summary>
        [DataMember(Name = "priceCashFlow", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1PriceCashFlow PriceCashFlow { get; set; }

        /// <summary>
        /// Gets or Sets PriceFreeCashFlow
        /// </summary>
        [DataMember(Name = "priceFreeCashFlow", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1PriceFreeCashFlow PriceFreeCashFlow { get; set; }

        /// <summary>
        /// Gets or Sets DividendYield
        /// </summary>
        [DataMember(Name = "dividendYield", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1DividendYield DividendYield { get; set; }

        /// <summary>
        /// Gets or Sets EnterpriseValueEbit
        /// </summary>
        [DataMember(Name = "enterpriseValueEbit", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueEbit EnterpriseValueEbit { get; set; }

        /// <summary>
        /// Gets or Sets EnterpriseValueEbitda
        /// </summary>
        [DataMember(Name = "enterpriseValueEbitda", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueEbitda EnterpriseValueEbitda { get; set; }

        /// <summary>
        /// Gets or Sets EnterpriseValueSales
        /// </summary>
        [DataMember(Name = "enterpriseValueSales", EmitDefaultValue = false)]
        public PostStockNotationScreenerSearchRequestDataRatios1EnterpriseValueSales EnterpriseValueSales { get; set; }
        ...
        {
            return this.Equals(input as PostStockNotationScreenerSearchRequestDataRatios1);
        }

        /// <summary>
        /// Returns true if PostStockNotationScreenerSearchRequestDataRatios1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PostStockNotationScreenerSearchRequestDataRatios1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostStockNotationScreenerSearchRequestDataRatios1 input)
        {
            if (input == null)
            {
                return false;
