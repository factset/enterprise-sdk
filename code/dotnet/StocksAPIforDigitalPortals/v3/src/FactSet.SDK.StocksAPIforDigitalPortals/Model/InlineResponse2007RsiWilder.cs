...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_rsiWilder")]
    public partial class InlineResponse2007RsiWilder : IEquatable<InlineResponse2007RsiWilder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007RsiWilder" /> class.
        /// </summary>
        /// <param name="days14">14 trading days..</param>
        public InlineResponse2007RsiWilder(decimal days14 = default(decimal))
        {
            this.Days14 = days14;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007RsiWilder {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007RsiWilder);
        }

        /// <summary>
        /// Returns true if InlineResponse2007RsiWilder instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007RsiWilder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007RsiWilder input)
        {
            if (input == null)
            {
                return false;
