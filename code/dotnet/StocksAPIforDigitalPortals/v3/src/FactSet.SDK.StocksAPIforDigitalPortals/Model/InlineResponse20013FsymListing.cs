...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_13_fsym_listing")]
    public partial class InlineResponse20013FsymListing : IEquatable<InlineResponse20013FsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013FsymListing" /> class.
        /// </summary>
        ...
        public InlineResponse20013FsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20013FsymListing);
        }

        /// <summary>
        /// Returns true if InlineResponse20013FsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20013FsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013FsymListing input)
        {
            if (input == null)
            {
                return false;
