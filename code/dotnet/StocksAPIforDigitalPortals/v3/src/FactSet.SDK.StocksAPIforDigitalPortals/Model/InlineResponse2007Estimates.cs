...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_estimates")]
    public partial class InlineResponse2007Estimates : IEquatable<InlineResponse2007Estimates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Estimates" /> class.
        /// </summary>
        ...
        public InlineResponse2007Estimates(InlineResponse2007EstimatesFirstFiscalYear firstFiscalYear = default(InlineResponse2007EstimatesFirstFiscalYear), InlineResponse2007EstimatesSecondFiscalYear secondFiscalYear = default(InlineResponse2007EstimatesSecondFiscalYear), InlineResponse2007EstimatesThirdFiscalYear thirdFiscalYear = default(InlineResponse2007EstimatesThirdFiscalYear))
        {
        ...
        public InlineResponse2007EstimatesFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2007EstimatesSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2007EstimatesThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2007Estimates);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Estimates instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Estimates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Estimates input)
        {
            if (input == null)
            {
                return false;
