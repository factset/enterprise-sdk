...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_reportedKeyFigures_thirdFiscalYear")]
    public partial class InlineResponse2007ReportedKeyFiguresThirdFiscalYear : IEquatable<InlineResponse2007ReportedKeyFiguresThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007ReportedKeyFiguresThirdFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2007ReportedKeyFiguresThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2007ReportedKeyFiguresThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007ReportedKeyFiguresThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007ReportedKeyFiguresThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
