...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostStockNotationScreenerSearchRequest_data_compliance_france")]
    public partial class PostStockNotationScreenerSearchRequestDataComplianceFrance : IEquatable<PostStockNotationScreenerSearchRequestDataComplianceFrance>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PostStockNotationScreenerSearchRequestDataComplianceFrance);
        }

        /// <summary>
        /// Returns true if PostStockNotationScreenerSearchRequestDataComplianceFrance instances are equal
        /// </summary>
        /// <param name="input">Instance of PostStockNotationScreenerSearchRequestDataComplianceFrance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostStockNotationScreenerSearchRequestDataComplianceFrance input)
        {
            if (input == null)
            {
                return false;
