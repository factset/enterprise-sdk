...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_reportedKeyFigures_thirdFiscalYear")]
    public partial class InlineResponse20011ReportedKeyFiguresThirdFiscalYear : IEquatable<InlineResponse20011ReportedKeyFiguresThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ReportedKeyFiguresThirdFiscalYear" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011ReportedKeyFiguresThirdFiscalYear {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011ReportedKeyFiguresThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ReportedKeyFiguresThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011ReportedKeyFiguresThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ReportedKeyFiguresThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
