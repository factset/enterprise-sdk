...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_15_data_reportedKeyFigures")]
    public partial class InlineResponse20015DataReportedKeyFigures : IEquatable<InlineResponse20015DataReportedKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015DataReportedKeyFigures" /> class.
        /// </summary>
        ...
        public InlineResponse20015DataReportedKeyFigures(InlineResponse20015DataReportedKeyFiguresFirstFiscalYear firstFiscalYear = default(InlineResponse20015DataReportedKeyFiguresFirstFiscalYear), InlineResponse20015DataReportedKeyFiguresSecondFiscalYear secondFiscalYear = default(InlineResponse20015DataReportedKeyFiguresSecondFiscalYear), InlineResponse20015DataReportedKeyFiguresThirdFiscalYear thirdFiscalYear = default(InlineResponse20015DataReportedKeyFiguresThirdFiscalYear))
        {
        ...
        public InlineResponse20015DataReportedKeyFiguresFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20015DataReportedKeyFiguresSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20015DataReportedKeyFiguresThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20015DataReportedKeyFigures);
        }

        /// <summary>
        /// Returns true if InlineResponse20015DataReportedKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015DataReportedKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015DataReportedKeyFigures input)
        {
            if (input == null)
            {
                return false;
