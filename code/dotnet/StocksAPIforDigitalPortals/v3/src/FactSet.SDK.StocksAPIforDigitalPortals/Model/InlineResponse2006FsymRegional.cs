...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_fsym_regional")]
    public partial class InlineResponse2006FsymRegional : IEquatable<InlineResponse2006FsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006FsymRegional" /> class.
        /// </summary>
        ...
        public InlineResponse2006FsymRegional(string permanentIdentifier = default(string), string tickerRegion = default(string), bool isPrimary = default(bool))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006FsymRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse2006FsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006FsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006FsymRegional input)
        {
            if (input == null)
            {
                return false;
