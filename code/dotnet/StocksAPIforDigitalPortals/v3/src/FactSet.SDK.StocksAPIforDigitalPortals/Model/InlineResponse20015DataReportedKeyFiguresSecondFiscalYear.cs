...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_15_data_reportedKeyFigures_secondFiscalYear")]
    public partial class InlineResponse20015DataReportedKeyFiguresSecondFiscalYear : IEquatable<InlineResponse20015DataReportedKeyFiguresSecondFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015DataReportedKeyFiguresSecondFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20015DataReportedKeyFiguresSecondFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20015DataReportedKeyFiguresSecondFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015DataReportedKeyFiguresSecondFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015DataReportedKeyFiguresSecondFiscalYear input)
        {
            if (input == null)
            {
                return false;
