...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_reportedKeyFigures")]
    public partial class InlineResponse20011ReportedKeyFigures : IEquatable<InlineResponse20011ReportedKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ReportedKeyFigures" /> class.
        /// </summary>
        ...
        public InlineResponse20011ReportedKeyFigures(InlineResponse20011ReportedKeyFiguresFirstFiscalYear firstFiscalYear = default(InlineResponse20011ReportedKeyFiguresFirstFiscalYear), InlineResponse20011ReportedKeyFiguresSecondFiscalYear secondFiscalYear = default(InlineResponse20011ReportedKeyFiguresSecondFiscalYear), InlineResponse20011ReportedKeyFiguresThirdFiscalYear thirdFiscalYear = default(InlineResponse20011ReportedKeyFiguresThirdFiscalYear))
        {
        ...
        public InlineResponse20011ReportedKeyFiguresFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20011ReportedKeyFiguresSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse20011ReportedKeyFiguresThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011ReportedKeyFigures {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011ReportedKeyFigures);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ReportedKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011ReportedKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ReportedKeyFigures input)
        {
            if (input == null)
            {
                return false;
