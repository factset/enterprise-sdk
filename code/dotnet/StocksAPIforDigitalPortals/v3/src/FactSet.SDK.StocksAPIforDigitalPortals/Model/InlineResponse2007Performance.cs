...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_performance")]
    public partial class InlineResponse2007Performance : IEquatable<InlineResponse2007Performance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Performance" /> class.
        /// </summary>
        ...
        public InlineResponse2007Performance(decimal intraday = default(decimal), InlineResponse2007PerformanceEndOfDay endOfDay = default(InlineResponse2007PerformanceEndOfDay))
        {
        ...
        public InlineResponse2007PerformanceEndOfDay EndOfDay { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2007Performance);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Performance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Performance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Performance input)
        {
            if (input == null)
            {
                return false;
