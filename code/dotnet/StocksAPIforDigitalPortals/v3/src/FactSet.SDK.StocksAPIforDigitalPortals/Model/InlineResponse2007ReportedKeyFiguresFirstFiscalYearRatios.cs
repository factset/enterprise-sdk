...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// Ratios.
    /// </summary>
    [DataContract(Name = "inline_response_200_7_reportedKeyFigures_firstFiscalYear_ratios")]
    public partial class InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios : IEquatable<InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios" /> class.
        /// </summary>
        ...
        public InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios(decimal priceSales = default(decimal), decimal priceEarnings = default(decimal), decimal priceBookValue = default(decimal), decimal priceCashFlow = default(decimal), decimal priceFreeCashFlow = default(decimal), decimal dividendYield = default(decimal), decimal enterpriseValueEbit = default(decimal), decimal enterpriseValueEbitda = default(decimal), decimal enterpriseValueSales = default(decimal), decimal debtEquity = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios);
        }

        /// <summary>
        /// Returns true if InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007ReportedKeyFiguresFirstFiscalYearRatios input)
        {
            if (input == null)
            {
                return false;
