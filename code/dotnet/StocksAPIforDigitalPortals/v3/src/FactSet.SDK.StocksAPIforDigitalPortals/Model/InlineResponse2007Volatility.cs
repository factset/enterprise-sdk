...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_volatility")]
    public partial class InlineResponse2007Volatility : IEquatable<InlineResponse2007Volatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Volatility" /> class.
        /// </summary>
        ...
        public InlineResponse2007Volatility(decimal week1 = default(decimal), decimal month1 = default(decimal), decimal months3 = default(decimal), decimal months6 = default(decimal), decimal year1 = default(decimal), decimal years3 = default(decimal), decimal years5 = default(decimal), decimal yearToDate = default(decimal))
        {
            this.Week1 = week1;
            this.Month1 = month1;
        ...
        {
            return this.Equals(input as InlineResponse2007Volatility);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Volatility instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Volatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Volatility input)
        {
            if (input == null)
            {
                return false;
