...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_data_recommendation")]
    public partial class InlineResponse2001DataRecommendation : IEquatable<InlineResponse2001DataRecommendation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataRecommendation" /> class.
        /// </summary>
        ...
        public InlineResponse2001DataRecommendation(DateTime latestUpdate = default(DateTime), InlineResponse2001DataRecommendationCounts counts = default(InlineResponse2001DataRecommendationCounts), decimal consensus = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2001DataRecommendation {\n");
        ...
        {
            return this.Equals(input as InlineResponse2001DataRecommendation);
        }

        /// <summary>
        /// Returns true if InlineResponse2001DataRecommendation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001DataRecommendation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001DataRecommendation input)
        {
            if (input == null)
            {
                return false;
