...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_instrument_nsin")]
    public partial class InlineResponse20011InstrumentNsin : IEquatable<InlineResponse20011InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse20011InstrumentNsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011InstrumentNsin {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse20011InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
