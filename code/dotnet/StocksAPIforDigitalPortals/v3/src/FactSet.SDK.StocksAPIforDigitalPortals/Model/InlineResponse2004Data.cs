...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2004Data : IEquatable<InlineResponse2004Data>, IValidatableObject
    {
        ...
        /// <param name="aggregatedRecommendations">List of trade recommendations..</param>
        public InlineResponse2004Data(string idInstrument = default(string), string sourceIdentifier = default(string), List<InlineResponse2004DataAggregatedRecommendations> aggregatedRecommendations = default(List<InlineResponse2004DataAggregatedRecommendations>))
        {
        ...
        /// </summary>
        /// <value>List of trade recommendations.</value>
        [DataMember(Name = "aggregatedRecommendations", EmitDefaultValue = false)]
        public List<InlineResponse2004DataAggregatedRecommendations> AggregatedRecommendations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AggregatedRecommendations: ").Append(AggregatedRecommendations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2004Data input)
        {
            ...
            return 
                ...
                (
                    this.AggregatedRecommendations == input.AggregatedRecommendations ||
                    this.AggregatedRecommendations != null &&
                    input.AggregatedRecommendations != null &&
                    this.AggregatedRecommendations.SequenceEqual(input.AggregatedRecommendations)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AggregatedRecommendations.GetHashCode();
                }
                return hashCode;
            }
        }
