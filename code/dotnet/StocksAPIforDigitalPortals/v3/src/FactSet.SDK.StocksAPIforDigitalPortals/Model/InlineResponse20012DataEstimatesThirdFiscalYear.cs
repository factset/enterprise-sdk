...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_12_data_estimates_thirdFiscalYear")]
    public partial class InlineResponse20012DataEstimatesThirdFiscalYear : IEquatable<InlineResponse20012DataEstimatesThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012DataEstimatesThirdFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20012DataEstimatesThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse20012DataEstimatesThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20012DataEstimatesThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012DataEstimatesThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
