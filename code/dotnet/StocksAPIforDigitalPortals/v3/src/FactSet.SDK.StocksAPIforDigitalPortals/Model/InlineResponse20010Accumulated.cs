...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_accumulated")]
    public partial class InlineResponse20010Accumulated : IEquatable<InlineResponse20010Accumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010Accumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20010Accumulated(decimal numberTrades = default(decimal), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse20010Accumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20010Accumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010Accumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010Accumulated input)
        {
            if (input == null)
            {
                return false;
