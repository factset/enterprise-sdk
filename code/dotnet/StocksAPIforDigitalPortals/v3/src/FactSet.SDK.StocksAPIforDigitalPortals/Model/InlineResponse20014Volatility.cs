...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_volatility")]
    public partial class InlineResponse20014Volatility : IEquatable<InlineResponse20014Volatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014Volatility" /> class.
        /// </summary>
        ...
        public InlineResponse20014Volatility(decimal? week1 = default(decimal?), decimal? month1 = default(decimal?), decimal? months3 = default(decimal?), decimal? months6 = default(decimal?), decimal? year1 = default(decimal?), decimal? years3 = default(decimal?), decimal? years5 = default(decimal?), decimal? yearToDate = default(decimal?))
        {
            this.Week1 = week1;
            this.Month1 = month1;
        ...
        {
            return this.Equals(input as InlineResponse20014Volatility);
        }

        /// <summary>
        /// Returns true if InlineResponse20014Volatility instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014Volatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014Volatility input)
        {
            if (input == null)
            {
                return false;
