...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_instrument_nsin")]
    public partial class InlineResponse2007InstrumentNsin : IEquatable<InlineResponse2007InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007InstrumentNsin" /> class.
        /// </summary>
        ...
        public InlineResponse2007InstrumentNsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007InstrumentNsin {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse2007InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
