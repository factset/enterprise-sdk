...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_data_reportedKeyFigures_thirdFiscalYear")]
    public partial class InlineResponse2008DataReportedKeyFiguresThirdFiscalYear : IEquatable<InlineResponse2008DataReportedKeyFiguresThirdFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008DataReportedKeyFiguresThirdFiscalYear" /> class.
        /// </summary>
        ...
        public InlineResponse2008DataReportedKeyFiguresThirdFiscalYear(InlineResponse2007ReportedKeyFiguresFirstFiscalYearFiscalYear fiscalYear = default(InlineResponse2007ReportedKeyFiguresFirstFiscalYearFiscalYear), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures currencyDependentKeyFigures = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearEbitMargin ebitMargin = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearEbitMargin), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearEbitdaMargin ebitdaMargin = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearEbitdaMargin), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearNetIncomeMargin netIncomeMargin = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearNetIncomeMargin), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearGrossIncomeMargin grossIncomeMargin = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearGrossIncomeMargin), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearOperatingMargin operatingMargin = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearOperatingMargin), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearReturnOnAssets returnOnAssets = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearReturnOnAssets), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearReturnOnEquity returnOnEquity = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearReturnOnEquity), InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios ratios = default(InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios))
        {
        ...
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearCurrencyDependentKeyFigures CurrencyDependentKeyFigures { get; set; }

        /// <summary>
        /// Gets or Sets EbitMargin
        /// </summary>
        [DataMember(Name = "ebitMargin", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearEbitMargin EbitMargin { get; set; }

        /// <summary>
        /// Gets or Sets EbitdaMargin
        /// </summary>
        [DataMember(Name = "ebitdaMargin", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearEbitdaMargin EbitdaMargin { get; set; }

        /// <summary>
        /// Gets or Sets NetIncomeMargin
        /// </summary>
        [DataMember(Name = "netIncomeMargin", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearNetIncomeMargin NetIncomeMargin { get; set; }

        /// <summary>
        /// Gets or Sets GrossIncomeMargin
        /// </summary>
        [DataMember(Name = "grossIncomeMargin", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearGrossIncomeMargin GrossIncomeMargin { get; set; }

        /// <summary>
        /// Gets or Sets OperatingMargin
        /// </summary>
        [DataMember(Name = "operatingMargin", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearOperatingMargin OperatingMargin { get; set; }

        /// <summary>
        /// Gets or Sets ReturnOnAssets
        /// </summary>
        [DataMember(Name = "returnOnAssets", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearReturnOnAssets ReturnOnAssets { get; set; }

        /// <summary>
        /// Gets or Sets ReturnOnEquity
        /// </summary>
        [DataMember(Name = "returnOnEquity", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearReturnOnEquity ReturnOnEquity { get; set; }

        /// <summary>
        /// Gets or Sets Ratios
        /// </summary>
        [DataMember(Name = "ratios", EmitDefaultValue = false)]
        public InlineResponse2008DataReportedKeyFiguresFirstFiscalYearRatios Ratios { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2008DataReportedKeyFiguresThirdFiscalYear {\n");
        ...
        {
            return this.Equals(input as InlineResponse2008DataReportedKeyFiguresThirdFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2008DataReportedKeyFiguresThirdFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008DataReportedKeyFiguresThirdFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008DataReportedKeyFiguresThirdFiscalYear input)
        {
            if (input == null)
            {
                return false;
