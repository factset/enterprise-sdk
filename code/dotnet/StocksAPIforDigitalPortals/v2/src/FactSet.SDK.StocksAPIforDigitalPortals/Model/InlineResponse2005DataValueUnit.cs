...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_valueUnit")]
    public partial class InlineResponse2005DataValueUnit : IEquatable<InlineResponse2005DataValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse2005DataValueUnit(decimal id = default(decimal), string code = default(string), decimal count = default(decimal))
        {
            this.Id = id;
            this.Code = code;
            this.Count = count;
        ...
        {
            return this.Equals(input as InlineResponse2005DataValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataValueUnit input)
        {
            if (input == null)
            {
                return false;
