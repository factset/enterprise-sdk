...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_trade_performance")]
    public partial class InlineResponse2003TradePerformance : IEquatable<InlineResponse2003TradePerformance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003TradePerformance" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;currency&#x60; for its currency..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse2003TradePerformance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003TradePerformance);
        }

        /// <summary>
        /// Returns true if InlineResponse2003TradePerformance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003TradePerformance to be compared</param>
        /// <returns>Boolean</returns>
