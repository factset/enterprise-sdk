...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_estimates_secondFiscalYear")]
    public partial class InlineResponse2005DataEstimatesSecondFiscalYear : IEquatable<InlineResponse2005DataEstimatesSecondFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataEstimatesSecondFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2005DataEstimatesSecondFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataEstimatesSecondFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataEstimatesSecondFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataEstimatesSecondFiscalYear input)
        {
            if (input == null)
            {
                return false;
