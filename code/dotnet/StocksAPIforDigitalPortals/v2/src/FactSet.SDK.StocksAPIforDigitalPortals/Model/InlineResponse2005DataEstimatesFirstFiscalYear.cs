...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_estimates_firstFiscalYear")]
    public partial class InlineResponse2005DataEstimatesFirstFiscalYear : IEquatable<InlineResponse2005DataEstimatesFirstFiscalYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataEstimatesFirstFiscalYear" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2005DataEstimatesFirstFiscalYear);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataEstimatesFirstFiscalYear instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataEstimatesFirstFiscalYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataEstimatesFirstFiscalYear input)
        {
            if (input == null)
            {
                return false;
