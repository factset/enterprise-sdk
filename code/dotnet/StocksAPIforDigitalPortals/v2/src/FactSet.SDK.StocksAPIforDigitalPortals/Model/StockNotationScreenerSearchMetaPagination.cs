...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_stock_notation_screener_search_meta_pagination")]
    public partial class StockNotationScreenerSearchMetaPagination : IEquatable<StockNotationScreenerSearchMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StockNotationScreenerSearchMetaPagination" /> class.
        /// </summary>
        ...
        public StockNotationScreenerSearchMetaPagination(decimal offset = default(decimal), decimal limit = default(decimal))
        {
            this.Offset = offset;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as StockNotationScreenerSearchMetaPagination);
        }

        /// <summary>
        /// Returns true if StockNotationScreenerSearchMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of StockNotationScreenerSearchMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockNotationScreenerSearchMetaPagination input)
        {
            if (input == null)
            {
                return false;
