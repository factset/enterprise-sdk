...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_reportedKeyFigures")]
    public partial class InlineResponse2004ReportedKeyFigures : IEquatable<InlineResponse2004ReportedKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004ReportedKeyFigures" /> class.
        /// </summary>
        ...
        public InlineResponse2004ReportedKeyFigures(InlineResponse2004ReportedKeyFiguresFirstFiscalYear firstFiscalYear = default(InlineResponse2004ReportedKeyFiguresFirstFiscalYear), InlineResponse2004ReportedKeyFiguresSecondFiscalYear secondFiscalYear = default(InlineResponse2004ReportedKeyFiguresSecondFiscalYear), InlineResponse2004ReportedKeyFiguresThirdFiscalYear thirdFiscalYear = default(InlineResponse2004ReportedKeyFiguresThirdFiscalYear))
        {
        ...
        public InlineResponse2004ReportedKeyFiguresFirstFiscalYear FirstFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets SecondFiscalYear
        /// </summary>
        [DataMember(Name = "secondFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2004ReportedKeyFiguresSecondFiscalYear SecondFiscalYear { get; set; }

        /// <summary>
        /// Gets or Sets ThirdFiscalYear
        /// </summary>
        [DataMember(Name = "thirdFiscalYear", EmitDefaultValue = false)]
        public InlineResponse2004ReportedKeyFiguresThirdFiscalYear ThirdFiscalYear { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2004ReportedKeyFigures);
        }

        /// <summary>
        /// Returns true if InlineResponse2004ReportedKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004ReportedKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004ReportedKeyFigures input)
        {
            if (input == null)
                return false;
