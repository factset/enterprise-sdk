...
namespace FactSet.SDK.StocksAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_volatility")]
    public partial class InlineResponse2004Volatility : IEquatable<InlineResponse2004Volatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004Volatility" /> class.
        /// </summary>
        ...
        public InlineResponse2004Volatility(decimal week1 = default(decimal), decimal month1 = default(decimal), decimal months3 = default(decimal), decimal months6 = default(decimal), decimal year1 = default(decimal), decimal years3 = default(decimal), decimal years5 = default(decimal), decimal yearToDate = default(decimal))
        {
            this.Week1 = week1;
            this.Month1 = month1;
        ...
        {
            return this.Equals(input as InlineResponse2004Volatility);
        }

        /// <summary>
        /// Returns true if InlineResponse2004Volatility instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004Volatility to be compared</param>
        /// <returns>Boolean</returns>
