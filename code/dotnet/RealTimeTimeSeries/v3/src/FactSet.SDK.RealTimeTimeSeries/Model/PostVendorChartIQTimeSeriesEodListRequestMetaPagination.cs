...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostVendorChartIQTimeSeriesEodListRequest_meta_pagination")]
    public partial class PostVendorChartIQTimeSeriesEodListRequestMetaPagination : IEquatable<PostVendorChartIQTimeSeriesEodListRequestMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesEodListRequestMetaPagination" /> class.
        /// </summary>
        ...
        public PostVendorChartIQTimeSeriesEodListRequestMetaPagination(string cursor = default(string), decimal limit = 20M)
        {
            this.Cursor = cursor;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as PostVendorChartIQTimeSeriesEodListRequestMetaPagination);
        }

        /// <summary>
        /// Returns true if PostVendorChartIQTimeSeriesEodListRequestMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of PostVendorChartIQTimeSeriesEodListRequestMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostVendorChartIQTimeSeriesEodListRequestMetaPagination input)
        {
            if (input == null)
            {
                return false;
