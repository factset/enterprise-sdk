...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    public partial class InlineResponse2005Data : IEquatable<InlineResponse2005Data>, IValidatableObject
    {
        ...
        public InlineResponse2005Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse200DataRange range = default(InlineResponse200DataRange), QualityEnum? quality = default(QualityEnum?), List<InlineResponse2005DataPrices> prices = default(List<InlineResponse2005DataPrices>))
        {
