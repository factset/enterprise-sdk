...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    public partial class InlineResponse2002Data : IEquatable<InlineResponse2002Data>, IValidatableObject
    {
        ...
        public InlineResponse2002Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse200DataRange range = default(InlineResponse200DataRange), QualityEnum? quality = default(QualityEnum?), List<List<decimal>> subsamples = default(List<List<decimal>>))
        {
