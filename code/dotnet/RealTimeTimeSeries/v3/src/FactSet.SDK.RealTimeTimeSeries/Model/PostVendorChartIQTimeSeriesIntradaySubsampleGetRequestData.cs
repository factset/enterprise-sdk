...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostVendorChartIQTimeSeriesIntradaySubsampleGetRequest_data")]
    public partial class PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData : IEquatable<PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData" /> class.
        /// </summary>
        ...
        public PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, string from,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, GranularityEnum? granularity = GranularityEnum._1h, PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "from" is required (not null)
            if (from == null) {
                throw new ArgumentNullException("from is a required property for PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData and cannot be null");
            }
            this.From = from;
            this.Type = type;
        ...
        {
            return this.Equals(input as PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData);
        }

        /// <summary>
        /// Returns true if PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestData input)
        {
            if (input == null)
            {
                return false;
