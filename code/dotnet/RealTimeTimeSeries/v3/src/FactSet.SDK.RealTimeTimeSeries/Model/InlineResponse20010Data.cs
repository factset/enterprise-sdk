...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    public partial class InlineResponse20010Data : IEquatable<InlineResponse20010Data>, IValidatableObject
    {
        ...
        public InlineResponse20010Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse2004DataRange range = default(InlineResponse2004DataRange), QualityEnum? quality = default(QualityEnum?), List<InlineResponse20010DataSubsamples> subsamples = default(List<InlineResponse20010DataSubsamples>))
        {
