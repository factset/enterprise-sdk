...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    public partial class InlineResponse2008Data : IEquatable<InlineResponse2008Data>, IValidatableObject
    {
        ...
        public InlineResponse2008Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse2004DataRange range = default(InlineResponse2004DataRange), QualityEnum? quality = default(QualityEnum?), List<InlineResponse2008DataPrices> prices = default(List<InlineResponse2008DataPrices>))
        {
