...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesEodSubsampleGetRequest_data")]
    public partial class PostPricesTimeSeriesEodSubsampleGetRequestData : IEquatable<PostPricesTimeSeriesEodSubsampleGetRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleGetRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesEodSubsampleGetRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleGetRequestData" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesEodSubsampleGetRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, PostPricesTimeSeriesEodSubsampleGetRequestDataInterval interval,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, PostVendorChartIQTimeSeriesEodListRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesEodListRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostPricesTimeSeriesEodSubsampleGetRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "interval" is required (not null)
            if (interval == null) {
                throw new ArgumentNullException("interval is a required property for PostPricesTimeSeriesEodSubsampleGetRequestData and cannot be null");
            }
        ...
        public PostPricesTimeSeriesEodSubsampleGetRequestDataInterval Interval { get; set; }
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesEodSubsampleGetRequestData);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesEodSubsampleGetRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesEodSubsampleGetRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesEodSubsampleGetRequestData input)
        {
            if (input == null)
            {
                return false;
