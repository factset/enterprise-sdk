...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesEodListRequest_data")]
    public partial class PostPricesTimeSeriesEodListRequestData : IEquatable<PostPricesTimeSeriesEodListRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodListRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesEodListRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodListRequestData" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesEodListRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, PostPricesTimeSeriesEodListRequestDataRange range,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, bool newestFirst = false, PostVendorChartIQTimeSeriesEodListRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesEodListRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostPricesTimeSeriesEodListRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for PostPricesTimeSeriesEodListRequestData and cannot be null");
            }
            this.Range = range;
            this.Type = type;
        ...
        public PostPricesTimeSeriesEodListRequestDataRange Range { get; set; }
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesEodListRequestData);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesEodListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesEodListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesEodListRequestData input)
        {
            if (input == null)
            {
                return false;
