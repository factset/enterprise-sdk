...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesEodSubsampleGetRequest_data_interval")]
    public partial class PostPricesTimeSeriesEodSubsampleGetRequestDataInterval : IEquatable<PostPricesTimeSeriesEodSubsampleGetRequestDataInterval>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleGetRequestDataInterval" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesEodSubsampleGetRequestDataInterval() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleGetRequestDataInterval" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesEodSubsampleGetRequestDataInterval(DateTime start, DateTime end)
        {
            this.Start = start;
            this.End = end;
        }
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesEodSubsampleGetRequestDataInterval);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesEodSubsampleGetRequestDataInterval instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesEodSubsampleGetRequestDataInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesEodSubsampleGetRequestDataInterval input)
        {
            if (input == null)
            {
                return false;
