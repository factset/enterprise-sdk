...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_subsample")]
    public partial class InlineResponse2009DataSubsample : IEquatable<InlineResponse2009DataSubsample>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataSubsample" /> class.
        /// </summary>
        ...
        public InlineResponse2009DataSubsample(DateTime? time = default(DateTime?), decimal? first = default(decimal?), decimal? last = default(decimal?), decimal? low = default(decimal?), decimal? high = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.First = first;
            this.Last = last;
        ...
        {
            return this.Equals(input as InlineResponse2009DataSubsample);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataSubsample instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataSubsample to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataSubsample input)
        {
            if (input == null)
            {
                return false;
