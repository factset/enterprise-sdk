...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    public partial class InlineResponse20010Data : IEquatable<InlineResponse20010Data>, IValidatableObject
    {
        ...
        /// <param name="volumeWeightedAveragePrice">The volume-weighted average price (VWAP) for the returned time series. See attribute currency in endpoint &#x60;/prices/get&#x60; for its unit..</param>
        ...
        public InlineResponse20010Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse20010DataRange range = default(InlineResponse20010DataRange), QualityEnum? quality = default(QualityEnum?), decimal? volumeWeightedAveragePrice = default(decimal?), List<PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems> subsamples = default(List<PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems>))
        {
        ...
        public InlineResponse20010DataRange Range { get; set; }
        ...
        /// </summary>
        /// <value>The volume-weighted average price (VWAP) for the returned time series. See attribute currency in endpoint &#x60;/prices/get&#x60; for its unit.</value>
        ...
        public List<PostPricesTimeSeriesIntradaySubsampleListDataSubsamplesItems> Subsamples { get; set; }
