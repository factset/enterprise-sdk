...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesIntradayListRequest_data")]
    public partial class PostPricesTimeSeriesIntradayListRequestData : IEquatable<PostPricesTimeSeriesIntradayListRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>This attribute represents the choice whether to apply insert, update, and delete corrections for individual ticks sent by the exchange or devised by FactSet Digital Solutions GmbH.   If the exchange or FactSet Digital Solutions GmbH decides to correct data, a correction instruction tick is sent shortly (usually on the same trading day) after dissemination of the corresponding original tick (if any). The correction instruction is then applied, yielding a corrected view. For \&quot;insert\&quot; corrections, there is no original tick, and the corrected view contains the inserted tick. For \&quot;update\&quot; corrections, the corrected view contains the updated original tick. For \&quot;delete\&quot; corrections, the original tick is removed from the corrected view. | Value | Description | | - -- | - -- | | none | Select original tick data without applying any corrections. | | all | Select corrected view. |  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesIntradayListRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesIntradayListRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesIntradayListRequestData" /> class.
        /// </summary>
        ...
        /// <param name="applyTickCorrections">This attribute represents the choice whether to apply insert, update, and delete corrections for individual ticks sent by the exchange or devised by FactSet Digital Solutions GmbH.   If the exchange or FactSet Digital Solutions GmbH decides to correct data, a correction instruction tick is sent shortly (usually on the same trading day) after dissemination of the corresponding original tick (if any). The correction instruction is then applied, yielding a corrected view. For \&quot;insert\&quot; corrections, there is no original tick, and the corrected view contains the inserted tick. For \&quot;update\&quot; corrections, the corrected view contains the updated original tick. For \&quot;delete\&quot; corrections, the original tick is removed from the corrected view. | Value | Description | | - -- | - -- | | none | Select original tick data without applying any corrections. | | all | Select corrected view. |   (default to ApplyTickCorrectionsEnum.None).</param>
        /// <param name="includeVolumeOnlyTicks">Include ticks that contain a volume without a price. (default to false).</param>
        /// <param name="adjustments">adjustments.</param>
        public PostPricesTimeSeriesIntradayListRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, PostPricesTimeSeriesIntradayListRequestDataRange range,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, bool newestFirst = false, ApplyTickCorrectionsEnum? applyTickCorrections = ApplyTickCorrectionsEnum.None, bool includeVolumeOnlyTicks = false, PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostPricesTimeSeriesIntradayListRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for PostPricesTimeSeriesIntradayListRequestData and cannot be null");
            }
            this.Range = range;
            this.Type = type;
        ...
        public PostPricesTimeSeriesIntradayListRequestDataRange Range { get; set; }
        ...
        /// </summary>
        /// <value>Include ticks that contain a volume without a price.</value>
        [DataMember(Name = "includeVolumeOnlyTicks", EmitDefaultValue = true)]
        public bool IncludeVolumeOnlyTicks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncludeVolumeOnlyTicks: ").Append(IncludeVolumeOnlyTicks).Append("\n");
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesIntradayListRequestData);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesIntradayListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesIntradayListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesIntradayListRequestData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IncludeVolumeOnlyTicks == input.IncludeVolumeOnlyTicks ||
                    this.IncludeVolumeOnlyTicks.Equals(input.IncludeVolumeOnlyTicks)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IncludeVolumeOnlyTicks.GetHashCode();
