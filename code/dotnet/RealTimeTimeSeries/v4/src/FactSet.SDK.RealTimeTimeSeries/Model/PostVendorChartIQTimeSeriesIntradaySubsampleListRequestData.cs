...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostVendorChartIQTimeSeriesIntradaySubsampleListRequest_data")]
    public partial class PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData : IEquatable<PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData" /> class.
        /// </summary>
        ...
        public PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange range,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, GranularityEnum? granularity = GranularityEnum._1h, bool newestFirst = false, PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData and cannot be null");
            }
            this.Range = range;
            this.Type = type;
        ...
        public PostVendorChartIQTimeSeriesIntradaySubsampleListRequestDataRange Range { get; set; }
        ...
        {
            return this.Equals(input as PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData);
        }

        /// <summary>
        /// Returns true if PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostVendorChartIQTimeSeriesIntradaySubsampleListRequestData input)
        {
            if (input == null)
            {
                return false;
