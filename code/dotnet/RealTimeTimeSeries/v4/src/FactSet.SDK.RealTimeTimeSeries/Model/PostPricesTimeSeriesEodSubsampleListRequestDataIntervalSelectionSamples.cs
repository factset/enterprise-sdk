...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesEodSubsampleListRequest_data_intervalSelection_samples")]
    public partial class PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples : IEquatable<PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples(DateTime end, decimal number,GranularityEnum? granularity = GranularityEnum._1w)
        {
            this.End = end;
            this.Number = number;
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples input)
        {
            if (input == null)
            {
                return false;
