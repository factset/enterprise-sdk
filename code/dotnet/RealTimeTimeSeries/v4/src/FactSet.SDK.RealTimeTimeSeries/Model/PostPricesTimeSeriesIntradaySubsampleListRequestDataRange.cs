...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesIntradaySubsampleListRequest_data_range")]
    public partial class PostPricesTimeSeriesIntradaySubsampleListRequestDataRange : IEquatable<PostPricesTimeSeriesIntradaySubsampleListRequestDataRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesIntradaySubsampleListRequestDataRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesIntradaySubsampleListRequestDataRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesIntradaySubsampleListRequestDataRange" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesIntradaySubsampleListRequestDataRange(DateTime start, DateTime end)
        {
            this.Start = start;
            this.End = end;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostPricesTimeSeriesIntradaySubsampleListRequestDataRange {\n");
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesIntradaySubsampleListRequestDataRange);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesIntradaySubsampleListRequestDataRange instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesIntradaySubsampleListRequestDataRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesIntradaySubsampleListRequestDataRange input)
        {
            if (input == null)
            {
                return false;
