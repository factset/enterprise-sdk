...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesEodSubsampleListRequest_data")]
    public partial class PostPricesTimeSeriesEodSubsampleListRequestData : IEquatable<PostPricesTimeSeriesEodSubsampleListRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleListRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesEodSubsampleListRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleListRequestData" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesEodSubsampleListRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelection intervalSelection,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, bool newestFirst = false, PostPricesTimeSeriesEodSubsampleListRequestDataAdjustments adjustments = default(PostPricesTimeSeriesEodSubsampleListRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostPricesTimeSeriesEodSubsampleListRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "intervalSelection" is required (not null)
            if (intervalSelection == null) {
                throw new ArgumentNullException("intervalSelection is a required property for PostPricesTimeSeriesEodSubsampleListRequestData and cannot be null");
            }
        ...
        public PostPricesTimeSeriesEodSubsampleListRequestDataIntervalSelection IntervalSelection { get; set; }
        ...
        public PostPricesTimeSeriesEodSubsampleListRequestDataAdjustments Adjustments { get; set; }
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesEodSubsampleListRequestData);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesEodSubsampleListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesEodSubsampleListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesEodSubsampleListRequestData input)
        {
            if (input == null)
            {
                return false;
