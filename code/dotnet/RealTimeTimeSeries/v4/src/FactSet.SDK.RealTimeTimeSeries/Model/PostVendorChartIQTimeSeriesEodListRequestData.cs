...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostVendorChartIQTimeSeriesEodListRequest_data")]
    public partial class PostVendorChartIQTimeSeriesEodListRequestData : IEquatable<PostVendorChartIQTimeSeriesEodListRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesEodListRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostVendorChartIQTimeSeriesEodListRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesEodListRequestData" /> class.
        /// </summary>
        ...
        public PostVendorChartIQTimeSeriesEodListRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, PostVendorChartIQTimeSeriesEodListRequestDataRange range,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, bool newestFirst = false, PostVendorChartIQTimeSeriesEodListRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesEodListRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostVendorChartIQTimeSeriesEodListRequestData and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for PostVendorChartIQTimeSeriesEodListRequestData and cannot be null");
            }
            this.Range = range;
            this.Type = type;
        ...
        public PostVendorChartIQTimeSeriesEodListRequestDataRange Range { get; set; }
        ...
        {
            return this.Equals(input as PostVendorChartIQTimeSeriesEodListRequestData);
        }

        /// <summary>
        /// Returns true if PostVendorChartIQTimeSeriesEodListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostVendorChartIQTimeSeriesEodListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostVendorChartIQTimeSeriesEodListRequestData input)
        {
            if (input == null)
            {
                return false;
