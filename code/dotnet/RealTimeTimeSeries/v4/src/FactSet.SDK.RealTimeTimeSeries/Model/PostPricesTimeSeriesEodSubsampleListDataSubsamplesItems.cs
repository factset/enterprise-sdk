...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems")]
    public partial class PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems : IEquatable<PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems(DateTime? date = default(DateTime?), decimal? first = default(decimal?), decimal? last = default(decimal?), decimal? low = default(decimal?), decimal? high = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Date = date;
            this.First = first;
            this.Last = last;
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesEodSubsampleListDataSubsamplesItems input)
        {
            if (input == null)
            {
                return false;
