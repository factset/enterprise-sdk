...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostVendorChartIQTimeSeriesEodSubsampleListRequest_data_intervalSelection")]
    public partial class PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection : IEquatable<PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection" /> class.
        /// </summary>
        ...
        public PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection(List<DateTime> intervals = default(List<DateTime>), PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples samples = default(PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples))
        {
        ...
        public PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelectionSamples Samples { get; set; }
        ...
        {
            return this.Equals(input as PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection);
        }

        /// <summary>
        /// Returns true if PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection instances are equal
        /// </summary>
        /// <param name="input">Instance of PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostVendorChartIQTimeSeriesEodSubsampleListRequestDataIntervalSelection input)
        {
            if (input == null)
            {
                return false;
