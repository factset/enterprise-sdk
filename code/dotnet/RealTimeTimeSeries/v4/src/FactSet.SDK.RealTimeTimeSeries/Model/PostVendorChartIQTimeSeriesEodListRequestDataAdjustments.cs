...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostVendorChartIQTimeSeriesEodListRequest_data_adjustments")]
    public partial class PostVendorChartIQTimeSeriesEodListRequestDataAdjustments : IEquatable<PostVendorChartIQTimeSeriesEodListRequestDataAdjustments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVendorChartIQTimeSeriesEodListRequestDataAdjustments" /> class.
        /// </summary>
        ...
        public PostVendorChartIQTimeSeriesEodListRequestDataAdjustments(bool payout = false, bool split = true)
        {
            this.Payout = payout;
            this.Split = split;
        }
        ...
        {
            return this.Equals(input as PostVendorChartIQTimeSeriesEodListRequestDataAdjustments);
        }

        /// <summary>
        /// Returns true if PostVendorChartIQTimeSeriesEodListRequestDataAdjustments instances are equal
        /// </summary>
        /// <param name="input">Instance of PostVendorChartIQTimeSeriesEodListRequestDataAdjustments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostVendorChartIQTimeSeriesEodListRequestDataAdjustments input)
        {
            if (input == null)
            {
                return false;
