...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTimeSeriesIntradaySubsampleGetRequest_data")]
    public partial class PostPricesTimeSeriesIntradaySubsampleGetRequestData : IEquatable<PostPricesTimeSeriesIntradaySubsampleGetRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesIntradaySubsampleGetRequestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTimeSeriesIntradaySubsampleGetRequestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTimeSeriesIntradaySubsampleGetRequestData" /> class.
        /// </summary>
        ...
        public PostPricesTimeSeriesIntradaySubsampleGetRequestData(PostVendorChartIQTimeSeriesEodListRequestDataIdentifier identifier, DateTime from,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, GranularityEnum? granularity = GranularityEnum._1h, PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments adjustments = default(PostVendorChartIQTimeSeriesIntradaySubsampleGetRequestDataAdjustments))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null) {
                throw new ArgumentNullException("identifier is a required property for PostPricesTimeSeriesIntradaySubsampleGetRequestData and cannot be null");
            }
        ...
        {
            return this.Equals(input as PostPricesTimeSeriesIntradaySubsampleGetRequestData);
        }

        /// <summary>
        /// Returns true if PostPricesTimeSeriesIntradaySubsampleGetRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTimeSeriesIntradaySubsampleGetRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTimeSeriesIntradaySubsampleGetRequestData input)
        {
            if (input == null)
            {
                return false;
