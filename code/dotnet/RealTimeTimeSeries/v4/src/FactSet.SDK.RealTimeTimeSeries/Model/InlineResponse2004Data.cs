...
namespace FactSet.SDK.RealTimeTimeSeries.Model
{
    ...
    public partial class InlineResponse2004Data : IEquatable<InlineResponse2004Data>, IValidatableObject
    {
        ...
        public InlineResponse2004Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse2004DataRange range = default(InlineResponse2004DataRange), QualityEnum? quality = default(QualityEnum?), List<List<decimal>> subsamples = default(List<List<decimal>>))
        {
