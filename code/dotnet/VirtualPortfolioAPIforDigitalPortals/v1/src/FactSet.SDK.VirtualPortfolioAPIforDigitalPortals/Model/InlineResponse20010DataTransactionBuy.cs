...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_transaction_buy")]
    public partial class InlineResponse20010DataTransactionBuy : IEquatable<InlineResponse20010DataTransactionBuy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataTransactionBuy" /> class.
        /// </summary>
        /// <param name="id">Identifier of the opening transaction..</param>
        /// <param name="time">Date and time of the opening transaction..</param>
        /// <param name="notation">notation.</param>
        /// <param name="currency">currency.</param>
        /// <param name="price">Purchase price of the position in the portfolio&#39;s base currency..</param>
        /// <param name="charges">Charges accrued in the portfolio&#39;s base currency..</param>
        /// <param name="value">Purchase value of the position in the portfolio&#39;s base currency..</param>
        /// <param name="exchangeRate">The exchange rate between the notation&#39;s currency and the portfolio currency at the time of the opening trade..</param>
        public InlineResponse20010DataTransactionBuy(string id = default(string), string time = default(string), InlineResponse20010DataTransactionBuyNotation notation = default(InlineResponse20010DataTransactionBuyNotation), InlineResponse20010DataTransactionBuyCurrency currency = default(InlineResponse20010DataTransactionBuyCurrency), decimal price = default(decimal), decimal charges = default(decimal), decimal value = default(decimal), decimal exchangeRate = default(decimal))
        {
            this.Id = id;
            this.Time = time;
        ...
        /// </summary>
        /// <value>Identifier of the opening transaction.</value>
        ...
        /// </summary>
        /// <value>Date and time of the opening transaction.</value>
        ...
        public InlineResponse20010DataTransactionBuyNotation Notation { get; set; }

        /// <summary>
        /// Gets or Sets Currency
        /// </summary>
        [DataMember(Name = "currency", EmitDefaultValue = false)]
        public InlineResponse20010DataTransactionBuyCurrency Currency { get; set; }

        /// <summary>
        /// Purchase price of the position in the portfolio&#39;s base currency.
        /// </summary>
        /// <value>Purchase price of the position in the portfolio&#39;s base currency.</value>
        ...
        /// </summary>
        /// <value>Purchase value of the position in the portfolio&#39;s base currency.</value>
        ...
        /// </summary>
        /// <value>The exchange rate between the notation&#39;s currency and the portfolio currency at the time of the opening trade.</value>
        ...
        {
            return this.Equals(input as InlineResponse20010DataTransactionBuy);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataTransactionBuy instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataTransactionBuy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataTransactionBuy input)
        {
            if (input == null)
            {
                return false;
