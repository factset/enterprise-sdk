...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20012Data : IEquatable<InlineResponse20012Data>, IValidatableObject
    {
        ...
        public InlineResponse20012Data(string id = default(string), string name = default(string), decimal numberPositions = default(decimal), string creation = default(string))
        {
            this.Id = id;
            this.Name = name;
