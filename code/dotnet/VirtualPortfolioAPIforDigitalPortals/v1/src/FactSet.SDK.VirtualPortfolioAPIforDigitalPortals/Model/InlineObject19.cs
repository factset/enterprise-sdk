...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject19 : IEquatable<InlineObject19>, IValidatableObject
    {
        ...
        public InlineObject19(WatchlistPositionGetData data = default(WatchlistPositionGetData), PortfolioCreateMeta meta = default(PortfolioCreateMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public WatchlistPositionGetData Data { get; set; }
