...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_list_data_filter")]
    public partial class PortfolioPayoutListDataFilter : IEquatable<PortfolioPayoutListDataFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutListDataFilter" /> class.
        /// </summary>
        /// <param name="instrument">instrument.</param>
        public PortfolioPayoutListDataFilter(PortfolioPayoutListDataFilterInstrument instrument = default(PortfolioPayoutListDataFilterInstrument))
        {
        ...
        public PortfolioPayoutListDataFilterInstrument Instrument { get; set; }
        ...
        {
            return this.Equals(input as PortfolioPayoutListDataFilter);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutListDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutListDataFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutListDataFilter input)
        {
            if (input == null)
            {
                return false;
