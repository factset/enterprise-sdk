...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2001DataSummary : IEquatable<InlineResponse2001DataSummary>, IValidatableObject
    {
        ...
        public InlineResponse2001DataSummary(decimal totalValue = default(decimal), decimal marketValue = default(decimal), decimal purchaseValue = default(decimal), decimal numberPositions = default(decimal), InlineResponse2001DataSummaryTransactions transactions = default(InlineResponse2001DataSummaryTransactions), InlineResponse2001DataSummaryCash cash = default(InlineResponse2001DataSummaryCash))
        {
