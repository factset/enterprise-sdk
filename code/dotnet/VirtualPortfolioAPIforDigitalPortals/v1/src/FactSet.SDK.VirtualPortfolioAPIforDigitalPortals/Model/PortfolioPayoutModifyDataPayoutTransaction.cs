...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_modify_data_payout_transaction")]
    public partial class PortfolioPayoutModifyDataPayoutTransaction : IEquatable<PortfolioPayoutModifyDataPayoutTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyDataPayoutTransaction" /> class.
        /// </summary>
        /// <param name="id">Identifier of the buy transaction..</param>
        public PortfolioPayoutModifyDataPayoutTransaction(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as PortfolioPayoutModifyDataPayoutTransaction);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutModifyDataPayoutTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutModifyDataPayoutTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutModifyDataPayoutTransaction input)
        {
            if (input == null)
            {
                return false;
