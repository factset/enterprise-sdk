...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_profitLoss")]
    public partial class InlineResponse20010DataProfitLoss : IEquatable<InlineResponse20010DataProfitLoss>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataProfitLoss" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value of profit or loss..</param>
        /// <param name="relative">Relative value of profit or loss..</param>
        public InlineResponse20010DataProfitLoss(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse20010DataProfitLoss);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataProfitLoss instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataProfitLoss to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataProfitLoss input)
        {
            if (input == null)
            {
                return false;
