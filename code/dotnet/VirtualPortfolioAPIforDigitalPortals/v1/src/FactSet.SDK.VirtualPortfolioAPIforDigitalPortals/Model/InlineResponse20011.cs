...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20011 : IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(List<InlineResponse20011Data> data = default(List<InlineResponse20011Data>), InlineResponse2007Meta meta = default(InlineResponse2007Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
