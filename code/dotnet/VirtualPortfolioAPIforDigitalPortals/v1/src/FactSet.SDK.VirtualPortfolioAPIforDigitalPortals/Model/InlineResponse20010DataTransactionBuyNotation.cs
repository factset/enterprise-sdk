...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_transaction_buy_notation")]
    public partial class InlineResponse20010DataTransactionBuyNotation : IEquatable<InlineResponse20010DataTransactionBuyNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataTransactionBuyNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public InlineResponse20010DataTransactionBuyNotation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse20010DataTransactionBuyNotation);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataTransactionBuyNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataTransactionBuyNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataTransactionBuyNotation input)
        {
            if (input == null)
            {
                return false;
