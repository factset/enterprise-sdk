...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_modify_data")]
    public partial class PortfolioPayoutModifyData : IEquatable<PortfolioPayoutModifyData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutModifyData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyData" /> class.
        /// </summary>
        /// <param name="id">Identifier of the portfolio. (required).</param>
        /// <param name="payout">payout.</param>
        public PortfolioPayoutModifyData(string id,PortfolioPayoutModifyDataPayout payout = default(PortfolioPayoutModifyDataPayout))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutModifyData and cannot be null");
            }
            this.Id = id;
            this.Payout = payout;
        }
        ...
        public PortfolioPayoutModifyDataPayout Payout { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioPayoutModifyData {\n");
        ...
        {
            return this.Equals(input as PortfolioPayoutModifyData);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutModifyData instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutModifyData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutModifyData input)
        {
            if (input == null)
            {
                return false;
