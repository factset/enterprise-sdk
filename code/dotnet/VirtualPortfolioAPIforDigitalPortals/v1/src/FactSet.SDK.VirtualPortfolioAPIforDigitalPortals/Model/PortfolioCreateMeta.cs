...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_create_meta")]
    public partial class PortfolioCreateMeta : IEquatable<PortfolioCreateMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioCreateMeta" /> class.
        /// </summary>
        /// <param name="attributes">Limit the attributes returned in the response to the specified set..</param>
        public PortfolioCreateMeta(List<string> attributes = default(List<string>))
        {
        ...
        {
            return this.Equals(input as PortfolioCreateMeta);
        }

        /// <summary>
        /// Returns true if PortfolioCreateMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioCreateMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioCreateMeta input)
        {
            if (input == null)
            {
                return false;
