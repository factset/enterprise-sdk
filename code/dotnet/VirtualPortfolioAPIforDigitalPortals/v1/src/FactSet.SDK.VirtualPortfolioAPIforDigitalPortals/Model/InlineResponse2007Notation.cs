...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_notation")]
    public partial class InlineResponse2007Notation : IEquatable<InlineResponse2007Notation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Notation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public InlineResponse2007Notation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007Notation {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007Notation);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Notation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Notation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Notation input)
        {
            if (input == null)
            {
                return false;
