...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2002 : IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(List<InlineResponse2002Data> data = default(List<InlineResponse2002Data>), InlineResponse201Meta meta = default(InlineResponse201Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
