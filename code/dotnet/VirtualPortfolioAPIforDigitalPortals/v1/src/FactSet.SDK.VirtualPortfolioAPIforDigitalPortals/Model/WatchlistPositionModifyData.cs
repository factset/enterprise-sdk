...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class WatchlistPositionModifyData : IEquatable<WatchlistPositionModifyData>, IValidatableObject
    {
        ...
        public WatchlistPositionModifyData(string id, WatchlistPositionModifyDataPosition position,PortfolioPayoutCreateDataNotation notation = default(PortfolioPayoutCreateDataNotation), string comment = default(string))
        {
