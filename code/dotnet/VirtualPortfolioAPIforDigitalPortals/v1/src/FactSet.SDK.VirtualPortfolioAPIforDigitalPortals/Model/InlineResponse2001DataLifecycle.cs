...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_data_lifecycle")]
    public partial class InlineResponse2001DataLifecycle : IEquatable<InlineResponse2001DataLifecycle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataLifecycle" /> class.
        /// </summary>
        /// <param name="creation">Date and time of the portfolio creation..</param>
        /// <param name="transaction">transaction.</param>
        public InlineResponse2001DataLifecycle(string creation = default(string), InlineResponse2001DataLifecycleTransaction transaction = default(InlineResponse2001DataLifecycleTransaction))
        {
        ...
        /// </summary>
        /// <value>Date and time of the portfolio creation.</value>
        ...
        public InlineResponse2001DataLifecycleTransaction Transaction { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2001DataLifecycle);
        }

        /// <summary>
        /// Returns true if InlineResponse2001DataLifecycle instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001DataLifecycle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001DataLifecycle input)
        {
            if (input == null)
            {
                return false;
