...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_instrument")]
    public partial class InlineResponse2009DataInstrument : IEquatable<InlineResponse2009DataInstrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataInstrument" /> class.
        /// </summary>
        ...
        public InlineResponse2009DataInstrument(string id = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse2009DataInstrumentAssetClass assetClass = default(InlineResponse2009DataInstrumentAssetClass), List<InlineResponse2009DataInstrumentType> type = default(List<InlineResponse2009DataInstrumentType>))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as InlineResponse2009DataInstrument);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataInstrument input)
        {
            if (input == null)
            {
                return false;
