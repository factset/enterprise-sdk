...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_instrument_assetClass")]
    public partial class InlineResponse2009DataInstrumentAssetClass : IEquatable<InlineResponse2009DataInstrumentAssetClass>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataInstrumentAssetClass" /> class.
        /// </summary>
        /// <param name="id">Identifier of the asset class..</param>
        /// <param name="code">Code of the asset class..</param>
        public InlineResponse2009DataInstrumentAssetClass(decimal id = default(decimal), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009DataInstrumentAssetClass {\n");
        ...
        {
            return this.Equals(input as InlineResponse2009DataInstrumentAssetClass);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataInstrumentAssetClass instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataInstrumentAssetClass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataInstrumentAssetClass input)
        {
            if (input == null)
            {
                return false;
