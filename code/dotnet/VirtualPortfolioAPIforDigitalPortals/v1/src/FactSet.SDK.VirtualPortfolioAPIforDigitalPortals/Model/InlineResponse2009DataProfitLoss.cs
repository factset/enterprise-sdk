...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_profitLoss")]
    public partial class InlineResponse2009DataProfitLoss : IEquatable<InlineResponse2009DataProfitLoss>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataProfitLoss" /> class.
        /// </summary>
        /// <param name="intraday">intraday.</param>
        /// <param name="potential">potential.</param>
        public InlineResponse2009DataProfitLoss(InlineResponse2009DataProfitLossIntraday intraday = default(InlineResponse2009DataProfitLossIntraday), InlineResponse2009DataProfitLossPotential potential = default(InlineResponse2009DataProfitLossPotential))
        {
        ...
        public InlineResponse2009DataProfitLossIntraday Intraday { get; set; }

        /// <summary>
        /// Gets or Sets Potential
        /// </summary>
        [DataMember(Name = "potential", EmitDefaultValue = false)]
        public InlineResponse2009DataProfitLossPotential Potential { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2009DataProfitLoss);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataProfitLoss instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataProfitLoss to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataProfitLoss input)
        {
            if (input == null)
            {
                return false;
