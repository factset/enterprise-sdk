...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20011Data : IEquatable<InlineResponse20011Data>, IValidatableObject
    {
        ...
        public InlineResponse20011Data(string id = default(string), InlineResponse2009DataInstrument instrument = default(InlineResponse2009DataInstrument), InlineResponse20011Notation notation = default(InlineResponse20011Notation), TypeEnum? type = default(TypeEnum?), string time = default(string), decimal numberShares = default(decimal), decimal price = default(decimal), decimal charges = default(decimal), decimal exchangeRate = default(decimal))
        {
            this.Id = id;
