...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_create_data")]
    public partial class PortfolioPayoutCreateData : IEquatable<PortfolioPayoutCreateData>, IValidatableObject
    {
        /// <summary>
        /// Payout type. 
        /// </summary>
        /// <value>Payout type. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutCreateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutCreateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutCreateData" /> class.
        /// </summary>
        /// <param name="id">Identifier of the portfolio. (required).</param>
        /// <param name="type">Payout type.  (required).</param>
        /// <param name="notation">notation (required).</param>
        /// <param name="time">Date and time of the payout. (required).</param>
        /// <param name="amount">Amount of the payout in the portfolio&#39;s base currency. (required).</param>
        /// <param name="transaction">transaction.</param>
        public PortfolioPayoutCreateData(string id, TypeEnum type, PortfolioPayoutCreateDataNotation notation, string time, decimal amount,PortfolioPayoutCreateDataTransaction transaction = default(PortfolioPayoutCreateDataTransaction))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutCreateData and cannot be null");
            }
            this.Id = id;
            this.Type = type;
            // to ensure "notation" is required (not null)
            if (notation == null) {
                throw new ArgumentNullException("notation is a required property for PortfolioPayoutCreateData and cannot be null");
            }
            this.Notation = notation;
            // to ensure "time" is required (not null)
            if (time == null) {
                throw new ArgumentNullException("time is a required property for PortfolioPayoutCreateData and cannot be null");
            }
            this.Time = time;
            this.Amount = amount;
        ...
        public PortfolioPayoutCreateDataTransaction Transaction { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioPayoutCreateData {\n");
        ...
        {
            return this.Equals(input as PortfolioPayoutCreateData);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutCreateData instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutCreateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutCreateData input)
        {
            if (input == null)
            {
                return false;
