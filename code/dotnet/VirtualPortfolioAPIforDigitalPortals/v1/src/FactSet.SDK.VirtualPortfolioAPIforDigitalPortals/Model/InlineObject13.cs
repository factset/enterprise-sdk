...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject13 : IEquatable<InlineObject13>, IValidatableObject
    {
        ...
        public InlineObject13(PortfolioTransactionCashDeleteData data = default(PortfolioTransactionCashDeleteData), PortfolioCreateMeta meta = default(PortfolioCreateMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
