...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_15_notation")]
    public partial class InlineResponse20015Notation : IEquatable<InlineResponse20015Notation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015Notation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public InlineResponse20015Notation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse20015Notation);
        }

        /// <summary>
        /// Returns true if InlineResponse20015Notation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015Notation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015Notation input)
        {
            if (input == null)
            {
                return false;
