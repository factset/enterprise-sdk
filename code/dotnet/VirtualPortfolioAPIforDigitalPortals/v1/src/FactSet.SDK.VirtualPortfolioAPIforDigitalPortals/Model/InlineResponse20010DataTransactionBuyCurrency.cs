...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_transaction_buy_currency")]
    public partial class InlineResponse20010DataTransactionBuyCurrency : IEquatable<InlineResponse20010DataTransactionBuyCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataTransactionBuyCurrency" /> class.
        /// </summary>
        /// <param name="id">Identifier of the currency..</param>
        /// <param name="isoCode">ISO 4217 code of the currency..</param>
        public InlineResponse20010DataTransactionBuyCurrency(decimal id = default(decimal), string isoCode = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as InlineResponse20010DataTransactionBuyCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataTransactionBuyCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataTransactionBuyCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataTransactionBuyCurrency input)
        {
            if (input == null)
            {
                return false;
