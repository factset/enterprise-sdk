...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_notation")]
    public partial class InlineResponse2009DataNotation : IEquatable<InlineResponse2009DataNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        /// <param name="price">price.</param>
        public InlineResponse2009DataNotation(string id = default(string), InlineResponse2009DataNotationPrice price = default(InlineResponse2009DataNotationPrice))
        {
            this.Id = id;
            this.Price = price;
        }
        ...
        public InlineResponse2009DataNotationPrice Price { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2009DataNotation);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataNotation input)
        {
            if (input == null)
            {
                return false;
