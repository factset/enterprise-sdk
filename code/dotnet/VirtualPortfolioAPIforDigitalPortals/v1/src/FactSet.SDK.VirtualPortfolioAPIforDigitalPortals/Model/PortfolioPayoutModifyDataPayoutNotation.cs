...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_modify_data_payout_notation")]
    public partial class PortfolioPayoutModifyDataPayoutNotation : IEquatable<PortfolioPayoutModifyDataPayoutNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyDataPayoutNotation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutModifyDataPayoutNotation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyDataPayoutNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation (required).</param>
        public PortfolioPayoutModifyDataPayoutNotation(string id)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutModifyDataPayoutNotation and cannot be null");
            }
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioPayoutModifyDataPayoutNotation {\n");
        ...
        {
            return this.Equals(input as PortfolioPayoutModifyDataPayoutNotation);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutModifyDataPayoutNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutModifyDataPayoutNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutModifyDataPayoutNotation input)
        {
            if (input == null)
            {
                return false;
