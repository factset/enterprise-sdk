...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_transaction_sell_notation")]
    public partial class InlineResponse20010DataTransactionSellNotation : IEquatable<InlineResponse20010DataTransactionSellNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataTransactionSellNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public InlineResponse20010DataTransactionSellNotation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20010DataTransactionSellNotation {\n");
        ...
        {
            return this.Equals(input as InlineResponse20010DataTransactionSellNotation);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataTransactionSellNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataTransactionSellNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataTransactionSellNotation input)
        {
            if (input == null)
            {
                return false;
