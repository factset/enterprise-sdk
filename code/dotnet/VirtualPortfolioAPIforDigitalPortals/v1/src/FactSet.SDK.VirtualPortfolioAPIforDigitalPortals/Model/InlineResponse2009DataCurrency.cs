...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_currency")]
    public partial class InlineResponse2009DataCurrency : IEquatable<InlineResponse2009DataCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataCurrency" /> class.
        /// </summary>
        /// <param name="id">Identifier of the currency..</param>
        /// <param name="isoCode">ISO 4217 code of the currency..</param>
        public InlineResponse2009DataCurrency(decimal id = default(decimal), string isoCode = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009DataCurrency {\n");
        ...
        {
            return this.Equals(input as InlineResponse2009DataCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataCurrency input)
        {
            if (input == null)
            {
                return false;
