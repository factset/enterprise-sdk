...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_instrument_type")]
    public partial class InlineResponse2009DataInstrumentType : IEquatable<InlineResponse2009DataInstrumentType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataInstrumentType" /> class.
        /// </summary>
        /// <param name="id">Identifier of the instrument type..</param>
        /// <param name="name">Name of the instrument type..</param>
        public InlineResponse2009DataInstrumentType(decimal id = default(decimal), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse2009DataInstrumentType);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataInstrumentType instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataInstrumentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataInstrumentType input)
        {
            if (input == null)
            {
                return false;
