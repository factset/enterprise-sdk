...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_create_data_transaction")]
    public partial class PortfolioPayoutCreateDataTransaction : IEquatable<PortfolioPayoutCreateDataTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutCreateDataTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutCreateDataTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutCreateDataTransaction" /> class.
        /// </summary>
        /// <param name="id">Identifier of the buy transaction. (required).</param>
        public PortfolioPayoutCreateDataTransaction(string id)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutCreateDataTransaction and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as PortfolioPayoutCreateDataTransaction);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutCreateDataTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutCreateDataTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutCreateDataTransaction input)
        {
            if (input == null)
            {
                return false;
