...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_shares")]
    public partial class InlineResponse2009DataShares : IEquatable<InlineResponse2009DataShares>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataShares" /> class.
        /// </summary>
        ...
        public InlineResponse2009DataShares(decimal bought = default(decimal), decimal sold = default(decimal), decimal open = default(decimal))
        {
            this.Bought = bought;
            this.Sold = sold;
            this.Open = open;
        ...
        {
            return this.Equals(input as InlineResponse2009DataShares);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataShares instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataShares to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataShares input)
        {
            if (input == null)
            {
                return false;
