...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse20013Data : IEquatable<InlineResponse20013Data>, IValidatableObject
    {
        ...
        public InlineResponse20013Data(string id = default(string), string name = default(string), decimal numberPositions = default(decimal), string creation = default(string))
        {
            this.Id = id;
            this.Name = name;
