...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_transaction")]
    public partial class InlineResponse2007Transaction : IEquatable<InlineResponse2007Transaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Transaction" /> class.
        /// </summary>
        /// <param name="id">Identifier of the buy transaction..</param>
        public InlineResponse2007Transaction(string id = default(string))
        {
            this.Id = id;
        }
        ...
        /// </summary>
        /// <value>Identifier of the buy transaction.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007Transaction {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007Transaction);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Transaction instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Transaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Transaction input)
        {
            if (input == null)
            {
                return false;
