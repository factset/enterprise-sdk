...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_notation_price")]
    public partial class InlineResponse2009DataNotationPrice : IEquatable<InlineResponse2009DataNotationPrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataNotationPrice" /> class.
        /// </summary>
        /// <param name="time">Date and time of the trade price.</param>
        /// <param name="value">Trade price..</param>
        public InlineResponse2009DataNotationPrice(string time = default(string), decimal value = default(decimal))
        {
            this.Time = time;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as InlineResponse2009DataNotationPrice);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataNotationPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataNotationPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataNotationPrice input)
        {
            if (input == null)
            {
                return false;
