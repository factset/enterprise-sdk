...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_transaction_sell_currency")]
    public partial class InlineResponse20010DataTransactionSellCurrency : IEquatable<InlineResponse20010DataTransactionSellCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataTransactionSellCurrency" /> class.
        /// </summary>
        /// <param name="id">Identifier of the currency..</param>
        /// <param name="isoCode">ISO 4217 code of the currency..</param>
        public InlineResponse20010DataTransactionSellCurrency(decimal id = default(decimal), string isoCode = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as InlineResponse20010DataTransactionSellCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataTransactionSellCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataTransactionSellCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataTransactionSellCurrency input)
        {
            if (input == null)
            {
                return false;
