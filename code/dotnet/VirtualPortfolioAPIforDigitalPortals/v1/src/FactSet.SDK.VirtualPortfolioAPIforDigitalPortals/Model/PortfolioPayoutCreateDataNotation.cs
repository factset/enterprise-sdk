...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_create_data_notation")]
    public partial class PortfolioPayoutCreateDataNotation : IEquatable<PortfolioPayoutCreateDataNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutCreateDataNotation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutCreateDataNotation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutCreateDataNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation. (required).</param>
        public PortfolioPayoutCreateDataNotation(string id)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutCreateDataNotation and cannot be null");
            }
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioPayoutCreateDataNotation {\n");
        ...
        {
            return this.Equals(input as PortfolioPayoutCreateDataNotation);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutCreateDataNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutCreateDataNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutCreateDataNotation input)
        {
            if (input == null)
            {
                return false;
