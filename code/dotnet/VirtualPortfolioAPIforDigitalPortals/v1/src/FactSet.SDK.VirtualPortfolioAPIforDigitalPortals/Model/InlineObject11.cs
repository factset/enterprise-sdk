...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject11 : IEquatable<InlineObject11>, IValidatableObject
    {
        ...
        public InlineObject11(PortfolioTransactionModifyData data = default(PortfolioTransactionModifyData), PortfolioCreateMeta meta = default(PortfolioCreateMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PortfolioTransactionModifyData Data { get; set; }
