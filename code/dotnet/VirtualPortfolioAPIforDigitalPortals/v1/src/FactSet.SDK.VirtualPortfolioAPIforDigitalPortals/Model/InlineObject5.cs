...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject5 : IEquatable<InlineObject5>, IValidatableObject
    {
        ...
        public InlineObject5(PortfolioPayoutDeleteData data = default(PortfolioPayoutDeleteData), PortfolioCreateMeta meta = default(PortfolioCreateMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PortfolioPayoutDeleteData Data { get; set; }
