...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_modify_data_payout")]
    public partial class PortfolioPayoutModifyDataPayout : IEquatable<PortfolioPayoutModifyDataPayout>, IValidatableObject
    {
        /// <summary>
        /// Payout type. 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyDataPayout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutModifyDataPayout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutModifyDataPayout" /> class.
        /// </summary>
        /// <param name="id">Identifier of the payout. (required).</param>
        /// <param name="type">Payout type. .</param>
        ...
        public PortfolioPayoutModifyDataPayout(string id,TypeEnum? type = default(TypeEnum?), PortfolioPayoutModifyDataPayoutNotation notation = default(PortfolioPayoutModifyDataPayoutNotation), string time = default(string), decimal amount = default(decimal), PortfolioPayoutModifyDataPayoutTransaction transaction = default(PortfolioPayoutModifyDataPayoutTransaction))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutModifyDataPayout and cannot be null");
            }
            this.Id = id;
            this.Type = type;
        ...
        /// </summary>
        /// <value>Identifier of the payout.</value>
        ...
        public PortfolioPayoutModifyDataPayoutNotation Notation { get; set; }
        ...
        public PortfolioPayoutModifyDataPayoutTransaction Transaction { get; set; }
        ...
        {
            return this.Equals(input as PortfolioPayoutModifyDataPayout);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutModifyDataPayout instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutModifyDataPayout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutModifyDataPayout input)
        {
            if (input == null)
            {
                return false;
