...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_meta")]
    public partial class InlineResponse2007Meta : IEquatable<InlineResponse2007Meta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Meta" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="pagination">pagination.</param>
        public InlineResponse2007Meta(StatusObject status = default(StatusObject), OffsetBasedPaginationOutputObject pagination = default(OffsetBasedPaginationOutputObject))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as InlineResponse2007Meta);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Meta instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Meta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Meta input)
        {
            if (input == null)
            {
                return false;
