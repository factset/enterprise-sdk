...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_profitLoss_intraday")]
    public partial class InlineResponse2009DataProfitLossIntraday : IEquatable<InlineResponse2009DataProfitLossIntraday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataProfitLossIntraday" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value of profit or loss..</param>
        /// <param name="relative">Relative value of profit or loss..</param>
        public InlineResponse2009DataProfitLossIntraday(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009DataProfitLossIntraday {\n");
        ...
        {
            return this.Equals(input as InlineResponse2009DataProfitLossIntraday);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataProfitLossIntraday instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataProfitLossIntraday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataProfitLossIntraday input)
        {
            if (input == null)
            {
                return false;
