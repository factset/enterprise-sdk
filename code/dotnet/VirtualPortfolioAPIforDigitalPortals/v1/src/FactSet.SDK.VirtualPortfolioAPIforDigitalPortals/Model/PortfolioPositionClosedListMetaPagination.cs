...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_position_closed_list_meta_pagination")]
    public partial class PortfolioPositionClosedListMetaPagination : IEquatable<PortfolioPositionClosedListMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPositionClosedListMetaPagination" /> class.
        /// </summary>
        ...
        public PortfolioPositionClosedListMetaPagination(decimal offset = 0M, decimal limit = 20M)
        {
            this.Offset = offset;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as PortfolioPositionClosedListMetaPagination);
        }

        /// <summary>
        /// Returns true if PortfolioPositionClosedListMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPositionClosedListMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPositionClosedListMetaPagination input)
        {
            if (input == null)
            {
                return false;
