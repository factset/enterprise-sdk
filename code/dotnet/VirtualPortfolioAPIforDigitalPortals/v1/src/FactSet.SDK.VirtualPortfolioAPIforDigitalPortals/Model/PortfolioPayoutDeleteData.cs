...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_delete_data")]
    public partial class PortfolioPayoutDeleteData : IEquatable<PortfolioPayoutDeleteData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutDeleteData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutDeleteData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutDeleteData" /> class.
        /// </summary>
        /// <param name="id">Identifier of the portfolio. (required).</param>
        /// <param name="payout">payout (required).</param>
        public PortfolioPayoutDeleteData(string id, PortfolioPayoutDeleteDataPayout payout)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutDeleteData and cannot be null");
            }
            this.Id = id;
            // to ensure "payout" is required (not null)
            if (payout == null) {
                throw new ArgumentNullException("payout is a required property for PortfolioPayoutDeleteData and cannot be null");
            }
            this.Payout = payout;
        }
        ...
        /// Gets or Sets Payout
        /// </summary>
        [DataMember(Name = "payout", IsRequired = true, EmitDefaultValue = false)]
        public PortfolioPayoutDeleteDataPayout Payout { get; set; }
        ...
        {
            return this.Equals(input as PortfolioPayoutDeleteData);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutDeleteData instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutDeleteData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutDeleteData input)
        {
            if (input == null)
            {
                return false;
