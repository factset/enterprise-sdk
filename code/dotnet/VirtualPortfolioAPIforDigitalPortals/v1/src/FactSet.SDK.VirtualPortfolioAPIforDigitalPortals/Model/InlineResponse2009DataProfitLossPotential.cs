...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_profitLoss_potential")]
    public partial class InlineResponse2009DataProfitLossPotential : IEquatable<InlineResponse2009DataProfitLossPotential>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataProfitLossPotential" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value of profit or loss..</param>
        /// <param name="relative">Relative value of profit or loss..</param>
        public InlineResponse2009DataProfitLossPotential(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2009DataProfitLossPotential);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataProfitLossPotential instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataProfitLossPotential to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataProfitLossPotential input)
        {
            if (input == null)
            {
                return false;
