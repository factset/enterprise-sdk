...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class PortfolioTransactionModifyDataTransaction : IEquatable<PortfolioTransactionModifyDataTransaction>, IValidatableObject
    {
        ...
        public PortfolioTransactionModifyDataTransaction(string id,PortfolioPayoutModifyDataPayoutNotation notation = default(PortfolioPayoutModifyDataPayoutNotation), string time = default(string), decimal numberShares = default(decimal), decimal price = default(decimal), decimal charges = default(decimal), decimal exchangeRate = default(decimal))
        {
