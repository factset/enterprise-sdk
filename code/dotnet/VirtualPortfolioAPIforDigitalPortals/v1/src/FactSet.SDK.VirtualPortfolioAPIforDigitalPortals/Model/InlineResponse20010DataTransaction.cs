...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_transaction")]
    public partial class InlineResponse20010DataTransaction : IEquatable<InlineResponse20010DataTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataTransaction" /> class.
        /// </summary>
        /// <param name="buy">buy.</param>
        /// <param name="sell">sell.</param>
        public InlineResponse20010DataTransaction(InlineResponse20010DataTransactionBuy buy = default(InlineResponse20010DataTransactionBuy), InlineResponse20010DataTransactionSell sell = default(InlineResponse20010DataTransactionSell))
        {
            this.Buy = buy;
            this.Sell = sell;
        }
        ...
        public InlineResponse20010DataTransactionBuy Buy { get; set; }

        /// <summary>
        /// Gets or Sets Sell
        /// </summary>
        [DataMember(Name = "sell", EmitDefaultValue = false)]
        public InlineResponse20010DataTransactionSell Sell { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20010DataTransaction {\n");
        ...
        {
            return this.Equals(input as InlineResponse20010DataTransaction);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataTransaction input)
        {
            if (input == null)
            {
                return false;
