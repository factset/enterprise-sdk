...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    public partial class WatchlistPositionCreateData : IEquatable<WatchlistPositionCreateData>, IValidatableObject
    {
        ...
        public WatchlistPositionCreateData(string id,PortfolioPayoutCreateDataNotation notation = default(PortfolioPayoutCreateDataNotation), string comment = default(string))
        {
