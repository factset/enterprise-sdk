...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_list_data_filter_instrument")]
    public partial class PortfolioPayoutListDataFilterInstrument : IEquatable<PortfolioPayoutListDataFilterInstrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutListDataFilterInstrument" /> class.
        /// </summary>
        /// <param name="id">Identifier of the instrument..</param>
        public PortfolioPayoutListDataFilterInstrument(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioPayoutListDataFilterInstrument {\n");
        ...
        {
            return this.Equals(input as PortfolioPayoutListDataFilterInstrument);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutListDataFilterInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutListDataFilterInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutListDataFilterInstrument input)
        {
            if (input == null)
            {
                return false;
