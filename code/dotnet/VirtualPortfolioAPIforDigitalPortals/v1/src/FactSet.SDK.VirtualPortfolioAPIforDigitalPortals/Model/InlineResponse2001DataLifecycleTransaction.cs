...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_data_lifecycle_transaction")]
    public partial class InlineResponse2001DataLifecycleTransaction : IEquatable<InlineResponse2001DataLifecycleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataLifecycleTransaction" /> class.
        /// </summary>
        /// <param name="first">Date and time of the first transaction..</param>
        /// <param name="latest">Date and time of the most recent transaction..</param>
        public InlineResponse2001DataLifecycleTransaction(string first = default(string), string latest = default(string))
        {
            this.First = first;
            this.Latest = latest;
        }
        ...
        /// </summary>
        /// <value>Date and time of the first transaction.</value>
        ...
        /// </summary>
        /// <value>Date and time of the most recent transaction.</value>
        ...
        {
            return this.Equals(input as InlineResponse2001DataLifecycleTransaction);
        }

        /// <summary>
        /// Returns true if InlineResponse2001DataLifecycleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001DataLifecycleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001DataLifecycleTransaction input)
        {
            if (input == null)
            {
                return false;
