...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_data_profitLoss_potential")]
    public partial class InlineResponse2001DataProfitLossPotential : IEquatable<InlineResponse2001DataProfitLossPotential>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataProfitLossPotential" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value of profit or loss..</param>
        /// <param name="relative">Relative value of profit or loss..</param>
        public InlineResponse2001DataProfitLossPotential(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2001DataProfitLossPotential);
        }

        /// <summary>
        /// Returns true if InlineResponse2001DataProfitLossPotential instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001DataProfitLossPotential to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001DataProfitLossPotential input)
        {
            if (input == null)
            {
                return false;
