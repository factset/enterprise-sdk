...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_delete_data_payout")]
    public partial class PortfolioPayoutDeleteDataPayout : IEquatable<PortfolioPayoutDeleteDataPayout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutDeleteDataPayout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutDeleteDataPayout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutDeleteDataPayout" /> class.
        /// </summary>
        /// <param name="id">Identifier of the payout. (required).</param>
        public PortfolioPayoutDeleteDataPayout(string id)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutDeleteDataPayout and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as PortfolioPayoutDeleteDataPayout);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutDeleteDataPayout instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutDeleteDataPayout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutDeleteDataPayout input)
        {
            if (input == null)
            {
                return false;
