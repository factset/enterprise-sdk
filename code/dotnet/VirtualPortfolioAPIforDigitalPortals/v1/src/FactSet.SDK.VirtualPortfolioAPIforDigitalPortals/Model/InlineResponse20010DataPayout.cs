...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_10_data_payout")]
    public partial class InlineResponse20010DataPayout : IEquatable<InlineResponse20010DataPayout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010DataPayout" /> class.
        /// </summary>
        /// <param name="amount">Amount of the payout..</param>
        public InlineResponse20010DataPayout(decimal amount = default(decimal))
        {
            this.Amount = amount;
        }
        ...
        /// </summary>
        /// <value>Amount of the payout.</value>
        ...
        {
            return this.Equals(input as InlineResponse20010DataPayout);
        }

        /// <summary>
        /// Returns true if InlineResponse20010DataPayout instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010DataPayout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010DataPayout input)
        {
            if (input == null)
            {
                return false;
