...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_14_data_notation")]
    public partial class InlineResponse20014DataNotation : IEquatable<InlineResponse20014DataNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014DataNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public InlineResponse20014DataNotation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20014DataNotation {\n");
        ...
        {
            return this.Equals(input as InlineResponse20014DataNotation);
        }

        /// <summary>
        /// Returns true if InlineResponse20014DataNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014DataNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014DataNotation input)
        {
            if (input == null)
            {
                return false;
