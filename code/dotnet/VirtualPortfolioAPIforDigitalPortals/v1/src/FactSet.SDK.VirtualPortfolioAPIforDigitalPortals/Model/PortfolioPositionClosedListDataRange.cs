...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_position_closed_list_data_range")]
    public partial class PortfolioPositionClosedListDataRange : IEquatable<PortfolioPositionClosedListDataRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPositionClosedListDataRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPositionClosedListDataRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPositionClosedListDataRange" /> class.
        /// </summary>
        ...
        public PortfolioPositionClosedListDataRange(DateTime start, DateTime end)
        {
            this.Start = start;
            this.End = end;
        }
        ...
        {
            return this.Equals(input as PortfolioPositionClosedListDataRange);
        }

        /// <summary>
        /// Returns true if PortfolioPositionClosedListDataRange instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPositionClosedListDataRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPositionClosedListDataRange input)
        {
            if (input == null)
            {
                return false;
