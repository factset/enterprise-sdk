...
namespace FactSet.SDK.VirtualPortfolioAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_portfolio_payout_list_data")]
    public partial class PortfolioPayoutListData : IEquatable<PortfolioPayoutListData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutListData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PortfolioPayoutListData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioPayoutListData" /> class.
        /// </summary>
        /// <param name="id">Identifier of the portfolio. (required).</param>
        /// <param name="filter">filter.</param>
        public PortfolioPayoutListData(string id,PortfolioPayoutListDataFilter filter = default(PortfolioPayoutListDataFilter))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PortfolioPayoutListData and cannot be null");
            }
            this.Id = id;
            this.Filter = filter;
        }
        ...
        public PortfolioPayoutListDataFilter Filter { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioPayoutListData {\n");
        ...
        {
            return this.Equals(input as PortfolioPayoutListData);
        }

        /// <summary>
        /// Returns true if PortfolioPayoutListData instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioPayoutListData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioPayoutListData input)
        {
            if (input == null)
            {
                return false;
