...
namespace FactSet.SDK.AnalyticsDatastore.Model
{
    ...
    public partial class DocumentListResponse : IEquatable<DocumentListResponse>, IValidatableObject
    {
        ...
        /// <param name="data">Array of documents.</param>
        public DocumentListResponse(MetaModel meta = default(MetaModel), List<DocumentModel> data = default(List<DocumentModel>))
        {
            this.Meta = meta;
            this.Data = data;
        }
