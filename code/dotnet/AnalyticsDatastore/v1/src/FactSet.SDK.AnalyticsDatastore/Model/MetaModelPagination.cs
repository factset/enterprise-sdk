...
namespace FactSet.SDK.AnalyticsDatastore.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetaModel_pagination")]
    public partial class MetaModelPagination : IEquatable<MetaModelPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetaModelPagination" /> class.
        /// </summary>
        ...
        public MetaModelPagination(int total = default(int), bool isEstimatedTotal = default(bool))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as MetaModelPagination);
        }

        /// <summary>
        /// Returns true if MetaModelPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of MetaModelPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetaModelPagination input)
        {
            if (input == null)
            {
                return false;
