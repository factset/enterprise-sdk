...
namespace FactSet.SDK.CompanyLogoAPIforDigitalPortals.Model
{
    ...
    /// Medium logo.
    /// </summary>
    [DataContract(Name = "inline_response_200_data_medium")]
    public partial class InlineResponse200DataMedium : IEquatable<InlineResponse200DataMedium>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataMedium" /> class.
        /// </summary>
        /// <param name="url">URL of the logo..</param>
        /// <param name="mimeType">MIME type of the logo..</param>
        public InlineResponse200DataMedium(string url = default(string), string mimeType = default(string))
        {
            this.Url = url;
        ...
        {
            return this.Equals(input as InlineResponse200DataMedium);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataMedium instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataMedium to be compared</param>
        /// <returns>Boolean</returns>
