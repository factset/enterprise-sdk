...
namespace FactSet.SDK.PAEngine.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PACalculationParametersRoot")]
    public partial class PACalculationParametersRoot : IEquatable<PACalculationParametersRoot>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PACalculationParametersRoot);
        }

        /// <summary>
        /// Returns true if PACalculationParametersRoot instances are equal
        /// </summary>
        /// <param name="input">Instance of PACalculationParametersRoot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PACalculationParametersRoot input)
        {
            if (input == null)
            {
                return false;
