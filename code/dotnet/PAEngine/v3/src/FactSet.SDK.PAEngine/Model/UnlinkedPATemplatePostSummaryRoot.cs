...
namespace FactSet.SDK.PAEngine.Model
{
    ...
    public partial class UnlinkedPATemplatePostSummaryRoot : IEquatable<UnlinkedPATemplatePostSummaryRoot>, IValidatableObject
    {
        ...
        public UnlinkedPATemplatePostSummaryRoot(UnlinkedPATemplatePostSummary data,Object meta = default(Object))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for UnlinkedPATemplatePostSummaryRoot and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
