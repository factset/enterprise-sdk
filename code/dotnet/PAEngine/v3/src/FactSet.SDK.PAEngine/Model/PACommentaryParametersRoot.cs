...
namespace FactSet.SDK.PAEngine.Model
{
    ...
    public partial class PACommentaryParametersRoot : IEquatable<PACommentaryParametersRoot>, IValidatableObject
    {
        ...
        public PACommentaryParametersRoot(PACommentaryParameters data,Object meta = default(Object))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for PACommentaryParametersRoot and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
