...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectoriesRoot> localVarResponse = GetAccountsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>ApiResponse of AccountDirectoriesRoot</returns>
        public FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectoriesRoot> GetAccountsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectoriesRoot> localVarResponse = await GetAccountsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDirectoriesRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectoriesRoot>> GetAccountsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.PAEngine.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
