...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public interface IDatesApiSync : IApiAccessor
    {
        ...
        /// <param name="calendar">Calendar (optional)</param>
        /// <returns>DateParametersSummaryRoot</returns>
        DateParametersSummaryRoot ConvertPADatesToAbsoluteFormat(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string));
        ...
        ApiResponse<DateParametersSummaryRoot> ConvertPADatesToAbsoluteFormatWithHttpInfo(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string));
    ...
    public interface IDatesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DateParametersSummaryRoot> ConvertPADatesToAbsoluteFormatAsync(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DateParametersSummaryRoot>> ConvertPADatesToAbsoluteFormatWithHttpInfoAsync(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class DatesApi : IDatesApi
    {
        ...
        /// <param name="calendar">Calendar (optional)</param>
        /// <returns>DateParametersSummaryRoot</returns>
        public DateParametersSummaryRoot ConvertPADatesToAbsoluteFormat(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string))
        {
            var localVarResponse = ConvertPADatesToAbsoluteFormatWithHttpInfo(enddate, componentid, account, startdate, calendar);
        ...
        /// <param name="calendar">Calendar (optional)</param>
        /// <returns>ApiResponse of DateParametersSummaryRoot</returns>
        public ApiResponse<DateParametersSummaryRoot> ConvertPADatesToAbsoluteFormatWithHttpInfo(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string))
        {
            ...
            if (calendar != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.PAEngine.Client.ClientUtils.ParameterToMultiMap("", "calendar", calendar));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DateParametersSummaryRoot</returns>
        public async System.Threading.Tasks.Task<DateParametersSummaryRoot>ConvertPADatesToAbsoluteFormatAsync(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await ConvertPADatesToAbsoluteFormatWithHttpInfoAsync(enddate, componentid, account, startdate, calendar, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DateParametersSummaryRoot>> ConvertPADatesToAbsoluteFormatWithHttpInfoAsync(string enddate, string componentid, string account, string startdate = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'enddate' is set
            if (enddate == null)
            {
