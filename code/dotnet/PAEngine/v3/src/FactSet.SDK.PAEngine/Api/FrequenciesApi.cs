...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class FrequenciesApi : IFrequenciesApi
    {
        ...
        /// <exception cref="FactSet.SDK.PAEngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of FrequencyRoot</returns>
        public ApiResponse<FrequencyRoot> GetPAFrequenciesWithHttpInfo()
        {
            ...
            FrequencyRoot>("/analytics/engines/pa/v3/frequencies", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<FrequencyRoot>> GetPAFrequenciesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
