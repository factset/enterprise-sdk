...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class ColumnStatisticsApi : IColumnStatisticsApi
    {
        ...
        {
            { (HttpStatusCode)200, typeof(ColumnStatisticRoot) },
        };
        ...
        /// <exception cref="FactSet.SDK.PAEngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ColumnStatisticRoot</returns>
        public ApiResponse<ColumnStatisticRoot> GetPAColumnStatisticsWithHttpInfo()
        {
            ...
            ColumnStatisticRoot>("/analytics/engines/pa/v3/columnstatistics", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ColumnStatisticRoot>> GetPAColumnStatisticsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
