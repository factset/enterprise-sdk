...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class ColumnStatisticsApi : IColumnStatisticsApi
    {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<ColumnStatisticRoot> localVarResponse = GetPAColumnStatisticsWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.PAEngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ColumnStatisticRoot</returns>
        public FactSet.SDK.PAEngine.Client.ApiResponse<ColumnStatisticRoot> GetPAColumnStatisticsWithHttpInfo()
        {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<ColumnStatisticRoot> localVarResponse = await GetPAColumnStatisticsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ColumnStatisticRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.PAEngine.Client.ApiResponse<ColumnStatisticRoot>> GetPAColumnStatisticsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
