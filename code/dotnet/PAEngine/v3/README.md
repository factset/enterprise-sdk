...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.1-orange)](https://www.nuget.org/packages/FactSet.SDK.PAEngine/2.2.1)
...
dotnet add package FactSet.SDK.PAEngine -v 2.2.1
```
...
nuget install FactSet.SDK.PAEngine -Version 2.2.1
```
