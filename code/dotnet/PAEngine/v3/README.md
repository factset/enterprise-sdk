...
[![API Version](https://img.shields.io/badge/api-v3.23.0-blue)](https://developer.factset.com/api-catalog/pa-engine-api)
[![Nuget](https://img.shields.io/badge/nuget-v3.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.PAEngine/3.0.0)
...
dotnet add package FactSet.SDK.PAEngine -v 3.0.0
```
...
nuget install FactSet.SDK.PAEngine -Version 3.0.0
```
...
*CalendarApi* | [**GetPACalendars**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/CalendarApi.md#getpacalendars) | **GET** /analytics/engines/pa/v3/calendars | Get PA calendars
...
*ConfigurationsApi* | [**GetPACommentaryConfigurations**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/ConfigurationsApi.md#getpacommentaryconfigurations) | **GET** /analytics/engines/pa/v3/commentary/configurations | Get PA commentary configurations in a directory
...
## Documentation for Models
 ...
 - [Model.PACalendar](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACalendar.md)
 - [Model.PACalendarRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACalendarRoot.md)
 - [Model.PACommentary](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACommentary.md)
 - [Model.PACommentaryConfigurationSummary](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACommentaryConfigurationSummary.md)
 - [Model.PACommentaryConfigurationSummaryRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACommentaryConfigurationSummaryRoot.md)
 ...
 - [Model.PACommentaryGetStatus](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACommentaryGetStatus.md)
 ...
 - [Model.PACommentaryParameters](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACommentaryParameters.md)
 - [Model.PACommentaryParametersRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/PAEngine/v3/docs/PACommentaryParametersRoot.md)
