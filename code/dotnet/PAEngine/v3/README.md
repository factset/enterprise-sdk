...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.PAEngine/2.2.0)
...
dotnet add package FactSet.SDK.PAEngine -v 2.2.0
```
...
nuget install FactSet.SDK.PAEngine -Version 2.2.0
```
