...
[![API Version](https://img.shields.io/badge/api-v3.14.1-blue)](https://developer.factset.com/api-catalog/pa-engine-api)
...
dotnet add package FactSet.SDK.PAEngine -v 1.0.4
```
...
nuget install FactSet.SDK.PAEngine -Version 1.0.4
```
