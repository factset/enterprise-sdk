# FactSet.SDK.PAEngine.Api.DocumentsApi
...
namespace Example
{
    public class GetPA3DocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling DocumentsApi.GetPA3Documents: " + e.Message );
