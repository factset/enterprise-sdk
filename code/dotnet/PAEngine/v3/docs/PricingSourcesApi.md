# FactSet.SDK.PAEngine.Api.PricingSourcesApi
...
namespace Example
{
    public class GetPAPricingSourcesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling PricingSourcesApi.GetPAPricingSources: " + e.Message );
