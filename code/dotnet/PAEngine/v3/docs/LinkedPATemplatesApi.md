# FactSet.SDK.PAEngine.Api.LinkedPATemplatesApi
...
namespace Example
{
    public class CreateLinkedPATemplatesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling LinkedPATemplatesApi.CreateLinkedPATemplates: " + e.Message );
...
namespace Example
{
    public class DeleteLinkedPATemplatesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling LinkedPATemplatesApi.DeleteLinkedPATemplates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetLinkedPATemplatesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling LinkedPATemplatesApi.GetLinkedPATemplates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetLinkedPATemplatesByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling LinkedPATemplatesApi.GetLinkedPATemplatesById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpdateLinkedPATemplatesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling LinkedPATemplatesApi.UpdateLinkedPATemplates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
