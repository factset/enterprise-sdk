...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class DocumentsApi : IDocumentsApi
    {
        ...
        /// <param name="path">The directory to get the documents and sub-directories in</param>
        /// <returns>ApiResponse of DocumentDirectories</returns>
        public ApiResponse<DocumentDirectories> GetPA3DocumentsWithHttpInfo(string path)
        {
            ...
            DocumentDirectories>("/analytics/lookups/v2/engines/pa/documents/{path}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DocumentDirectories>> GetPA3DocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
            {
