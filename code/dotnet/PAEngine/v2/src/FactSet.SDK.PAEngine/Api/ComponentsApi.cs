...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class ComponentsApi : IComponentsApi
    {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<PAComponent> localVarResponse = GetPAComponentByIdWithHttpInfo(id);
        ...
        /// <param name="id">Unique identifier for a PA component</param>
        /// <returns>ApiResponse of PAComponent</returns>
        public FactSet.SDK.PAEngine.Client.ApiResponse<PAComponent> GetPAComponentByIdWithHttpInfo(string id)
        {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<PAComponent> localVarResponse = await GetPAComponentByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PAComponent)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.PAEngine.Client.ApiResponse<PAComponent>> GetPAComponentByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.SDK.PAEngine.Client.ApiException(400, "Missing required parameter 'id' when calling ComponentsApi->GetPAComponentById");
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ComponentSummary>> localVarResponse = GetPAComponentsWithHttpInfo(document);
            return localVarResponse.Data;
        }
        ...
        /// <param name="document">Document Name</param>
        /// <returns>ApiResponse of Dictionary&lt;string, ComponentSummary&gt;</returns>
        public FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ComponentSummary>> GetPAComponentsWithHttpInfo(string document)
        {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ComponentSummary>> localVarResponse = await GetPAComponentsWithHttpInfoAsync(document, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ComponentSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ComponentSummary>>> GetPAComponentsWithHttpInfoAsync(string document, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'document' is set
            if (document == null)
                throw new FactSet.SDK.PAEngine.Client.ApiException(400, "Missing required parameter 'document' when calling ComponentsApi->GetPAComponents");
