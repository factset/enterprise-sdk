...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public interface IAccountsApiSync : IApiAccessor
    {
        ...
        /// <returns>AccountDirectories</returns>
        ...
        /// <exception cref="FactSet.SDK.PAEngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>ApiResponse of AccountDirectories</returns>
        ApiResponse<AccountDirectories> GetAccountsWithHttpInfo(string path);
    ...
    public interface IAccountsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of AccountDirectories</returns>
        System.Threading.Tasks.Task<AccountDirectories> GetAccountsAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDirectories)</returns>
        System.Threading.Tasks.Task<ApiResponse<AccountDirectories>> GetAccountsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <returns></returns>
        public AccountsApi(FactSet.SDK.PAEngine.Client.Configuration configuration)
        {
        ...
        public AccountsApi(FactSet.SDK.PAEngine.Client.ISynchronousClient client, FactSet.SDK.PAEngine.Client.IAsynchronousClient asyncClient, FactSet.SDK.PAEngine.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>AccountDirectories</returns>
        public AccountDirectories GetAccounts(string path)
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectories> localVarResponse = GetAccountsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>ApiResponse of AccountDirectories</returns>
        public FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectories> GetAccountsWithHttpInfo(string path)
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.PAEngine.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
            ...
            var localVarResponse = this.Client.Get<AccountDirectories>("/analytics/lookups/v2/accounts/{path}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AccountDirectories</returns>
        public async System.Threading.Tasks.Task<AccountDirectories> GetAccountsAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectories> localVarResponse = await GetAccountsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDirectories)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.PAEngine.Client.ApiResponse<AccountDirectories>> GetAccountsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.PAEngine.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<AccountDirectories>("/analytics/lookups/v2/accounts/{path}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
