...
namespace FactSet.SDK.PAEngine.Api
{
    ...
    public partial class ColumnStatisticsApi : IColumnStatisticsApi
    {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ColumnStatistic>> localVarResponse = GetPAColumnStatisticsWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.PAEngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Dictionary&lt;string, ColumnStatistic&gt;</returns>
        public FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ColumnStatistic>> GetPAColumnStatisticsWithHttpInfo()
        {
        ...
        {
            FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ColumnStatistic>> localVarResponse = await GetPAColumnStatisticsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ColumnStatistic&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.PAEngine.Client.ApiResponse<Dictionary<string, ColumnStatistic>>> GetPAColumnStatisticsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
