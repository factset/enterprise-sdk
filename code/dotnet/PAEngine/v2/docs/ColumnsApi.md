# FactSet.SDK.PAEngine.Api.ColumnsApi
...
namespace Example
{
    public class GetPAColumnByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ColumnsApi.GetPAColumnById: " + e.Message );
...
namespace Example
{
    public class GetPAColumnsExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new ColumnsApi(config);
            var name = name_example;  // string |  (optional)  (default to "")
            var category = category_example;  // string |  (optional)  (default to "")
            var directory = directory_example;  // string |  (optional)  (default to "")
            ...
            {
                Console.WriteLine("Exception when calling ColumnsApi.GetPAColumns: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
