# FactSet.SDK.PAEngine.Api.CalculationsApi
...
namespace Example
{
    public class CancelCalculationByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CalculationsApi.CancelCalculationById: " + e.Message );
...
namespace Example
{
    public class GetCalculationStatusByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CalculationsApi.GetCalculationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCalculationStatusSummariesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CalculationsApi.GetCalculationStatusSummaries: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RunCalculationExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CalculationsApi.RunCalculation: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
