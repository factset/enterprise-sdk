# FactSet.SDK.PAEngine.Api.FrequenciesApi
...
namespace Example
{
    public class GetPAFrequenciesExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get PA frequencies
                Dictionary<string, Frequency> result = apiInstance.GetPAFrequencies();
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling FrequenciesApi.GetPAFrequencies: " + e.Message );
