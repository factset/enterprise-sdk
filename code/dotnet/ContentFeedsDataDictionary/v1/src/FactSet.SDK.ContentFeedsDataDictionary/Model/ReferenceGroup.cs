...
namespace FactSet.SDK.ContentFeedsDataDictionary.Model
{
    ...
    /// ReferenceGroup
    /// </summary>
    [DataContract(Name = "ReferenceGroup")]
    public partial class ReferenceGroup : IEquatable<ReferenceGroup>, IValidatableObject
    {
        /// <summary>
        ...
        public ReferenceGroup(string id = default(string), string name = default(string), string description = default(string), string entitled = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as ReferenceGroup);
        }

        /// <summary>
        /// Returns true if ReferenceGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of ReferenceGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReferenceGroup input)
        {
            if (input == null)
            {
                return false;
