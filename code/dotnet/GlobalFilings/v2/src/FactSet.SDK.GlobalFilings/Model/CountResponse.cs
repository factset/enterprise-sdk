...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    public partial class CountResponse : IEquatable<CountResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Provides the count of documents.</param>
        public CountResponse(List<Count> data = default(List<Count>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Provides the count of documents</value>
