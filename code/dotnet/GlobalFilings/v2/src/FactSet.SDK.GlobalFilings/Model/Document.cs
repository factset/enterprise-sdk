...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    public partial class Document : IEquatable<Document>, IValidatableObject
    {
        ...
        public Document(string headline = default(string), string source = default(string), List<string> primaryIds = default(List<string>), List<string> allIds = default(List<string>), string filingsDateTime = default(string), List<string> categories = default(List<string>), string filingsLink = default(string), string documentId = default(string), string filingSize = default(string), List<string> formTypes = default(List<string>), string accession = default(string))
        {
