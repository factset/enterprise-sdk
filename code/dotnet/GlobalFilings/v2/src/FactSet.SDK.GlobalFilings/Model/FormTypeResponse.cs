...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FormTypeResponse")]
    public partial class FormTypeResponse : IEquatable<FormTypeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormTypeResponse" /> class.
        /// </summary>
        /// <param name="data">List of available form-types.</param>
        public FormTypeResponse(List<FormType> data = default(List<FormType>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>List of available form-types</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<FormType> Data { get; set; }
        ...
        {
            return this.Equals(input as FormTypeResponse);
        }

        /// <summary>
        /// Returns true if FormTypeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FormTypeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormTypeResponse input)
        {
            if (input == null)
            {
                return false;
