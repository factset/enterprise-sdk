...
namespace FactSet.SDK.GlobalFilings.Api
{
    ...
    public interface IFilingsAPIApiSync : IApiAccessor
    {
        ...
        /// <param name="ids">Requested symbols or securities.  This is a comma-separated list with a maximum limit of 10.  Each symbol can be a FactSet exchange symbol, CUSIP, or SEDOL.</param>
        ...
        CountResponse GetCount(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string));
        ...
        ApiResponse<CountResponse> GetCountWithHttpInfo(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.GlobalFilings.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol, CUSIP, or SEDOL.</param>
    ...
    public interface IFilingsAPIApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CountResponse> GetCountAsync(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CountResponse>> GetCountWithHttpInfoAsync(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns the filings documents and related metadata within FactSet coverage.
        /// </summary>
        /// <remarks>
    ...
    public partial class FilingsAPIApi : IFilingsAPIApi
    {
        ...
        /// <param name="endDate">End Date. Format is YYYYMMDD or relative +/- days (0,-1,etc). (optional)</param>
        /// <returns>CountResponse</returns>
        public CountResponse GetCount(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string))
        {
            var localVarResponse = GetCountWithHttpInfo(ids, sources, startDate, endDate);
        ...
        /// <param name="endDate">End Date. Format is YYYYMMDD or relative +/- days (0,-1,etc). (optional)</param>
        /// <returns>ApiResponse of CountResponse</returns>
        public ApiResponse<CountResponse> GetCountWithHttpInfo(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CountResponse</returns>
        public async System.Threading.Tasks.Task<CountResponse>GetCountAsync(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetCountWithHttpInfoAsync(ids, sources, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<CountResponse>> GetCountWithHttpInfoAsync(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
        ...
        public ApiResponse<SearchResponse> GetFilingsWithHttpInfo(List<string> ids, List<string> sources, string startDate = default(string), string endDate = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?), string timeZone = default(string), List<string> sort = default(List<string>), List<string> categories = default(List<string>), bool? primaryId = default(bool?), string searchText = default(string), List<string> formTypes = default(List<string>), string edgarAccession = default(string))
        {
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.GlobalFilings.Client.ClientUtils.ParameterToMultiMap("multi", "sources", sources));
            if (categories != null)
            {
