# FactSet.SDK.GlobalFilings.Api.MetaApi
...
# **GetFormtype**
> FormTypeResponse GetFormtype (List<string> sources = null)
...
namespace Example
{
    public class GetFormtypeExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling MetaApi.GetFormtype: " + e.Message );
