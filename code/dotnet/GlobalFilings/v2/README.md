...
[![Nuget](https://img.shields.io/badge/nuget-v3.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.GlobalFilings/3.0.0)
...
dotnet add package FactSet.SDK.GlobalFilings -v 3.0.0
```
...
nuget install FactSet.SDK.GlobalFilings -Version 3.0.0
```
