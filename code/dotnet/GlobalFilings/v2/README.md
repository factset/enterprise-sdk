...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.GlobalFilings/2.2.0)
...
dotnet add package FactSet.SDK.GlobalFilings -v 2.2.0
```
...
nuget install FactSet.SDK.GlobalFilings -Version 2.2.0
```
