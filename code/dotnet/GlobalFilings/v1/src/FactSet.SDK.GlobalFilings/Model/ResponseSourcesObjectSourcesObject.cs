...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseSourcesObject_sourcesObject")]
    public partial class ResponseSourcesObjectSourcesObject : IEquatable<ResponseSourcesObjectSourcesObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSourcesObjectSourcesObject" /> class.
        /// </summary>
        /// <param name="source">source value.</param>
        /// <param name="description">source description.</param>
        public ResponseSourcesObjectSourcesObject(string source = default(string), string description = default(string))
        {
            this.Source = source;
        ...
        {
            return this.Equals(input as ResponseSourcesObjectSourcesObject);
        }

        /// <summary>
        /// Returns true if ResponseSourcesObjectSourcesObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSourcesObjectSourcesObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSourcesObjectSourcesObject input)
        {
            if (input == null)
            {
                return false;
