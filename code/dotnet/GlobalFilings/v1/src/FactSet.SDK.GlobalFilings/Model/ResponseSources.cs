...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseSources")]
    public partial class ResponseSources : IEquatable<ResponseSources>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSources" /> class.
        /// </summary>
        /// <param name="data">Data Array Object.</param>
        public ResponseSources(List<ResponseSourcesObject> data = default(List<ResponseSourcesObject>))
        {
            this.Data = data;
        }
        ...
        public List<ResponseSourcesObject> Data { get; set; }
        ...
        {
            return this.Equals(input as ResponseSources);
        }

        /// <summary>
        /// Returns true if ResponseSources instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSources input)
        {
            if (input == null)
            {
                return false;
