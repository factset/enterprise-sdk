...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseFormtypeObject")]
    public partial class ResponseFormtypeObject : IEquatable<ResponseFormtypeObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseFormtypeObject" /> class.
        /// </summary>
        /// <param name="source">source.</param>
        /// <param name="formType">formType.</param>
        /// <param name="description">source description.</param>
        public ResponseFormtypeObject(string source = default(string), string formType = default(string), string description = default(string))
        {
            this.Source = source;
        ...
        {
            return this.Equals(input as ResponseFormtypeObject);
        }

        /// <summary>
        /// Returns true if ResponseFormtypeObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseFormtypeObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseFormtypeObject input)
        {
            if (input == null)
            {
                return false;
