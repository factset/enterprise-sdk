...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseCount")]
    public partial class ResponseCount : IEquatable<ResponseCount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseCount" /> class.
        /// </summary>
        /// <param name="data">Data Array Object.</param>
        public ResponseCount(List<ResponseCountObject> data = default(List<ResponseCountObject>))
        {
            this.Data = data;
        }
        ...
        public List<ResponseCountObject> Data { get; set; }
        ...
        {
            return this.Equals(input as ResponseCount);
        }

        /// <summary>
        /// Returns true if ResponseCount instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseCount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseCount input)
        {
            if (input == null)
            {
                return false;
