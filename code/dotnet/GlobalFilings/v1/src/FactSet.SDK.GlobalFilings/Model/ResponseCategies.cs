...
namespace FactSet.SDK.GlobalFilings.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseCategies")]
    public partial class ResponseCategies : IEquatable<ResponseCategies>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseCategies" /> class.
        /// </summary>
        /// <param name="data">Data Array Object.</param>
        public ResponseCategies(List<ResponseCategoriesObject> data = default(List<ResponseCategoriesObject>))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as ResponseCategies);
        }

        /// <summary>
        /// Returns true if ResponseCategies instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseCategies to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseCategies input)
        {
            if (input == null)
            {
                return false;
