...
namespace FactSet.SDK.Signals.Model
{
    ...
    /// EventDetailDataItem
    /// </summary>
    [DataContract(Name = "eventDetailDataItem")]
    public partial class EventDetailDataItem : IEquatable<EventDetailDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventDetailDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventDetailDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventDetailDataItem" /> class.
        /// </summary>
        ...
        public EventDetailDataItem(string requestId, string signalId, string signalName, string theme, string source, Guid eventId, DateTime eventDate, string summary, float userRelevanceScore, DateTime created, DateTime updated, Dictionary<string, Object> details,string companyName = default(string))
        {
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for EventDetailDataItem and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "signalId" is required (not null)
            if (signalId == null) {
                throw new ArgumentNullException("signalId is a required property for EventDetailDataItem and cannot be null");
            }
            this.SignalId = signalId;
            // to ensure "signalName" is required (not null)
            if (signalName == null) {
                throw new ArgumentNullException("signalName is a required property for EventDetailDataItem and cannot be null");
            }
            this.SignalName = signalName;
            // to ensure "theme" is required (not null)
            if (theme == null) {
                throw new ArgumentNullException("theme is a required property for EventDetailDataItem and cannot be null");
            }
            this.Theme = theme;
            // to ensure "source" is required (not null)
            if (source == null) {
                throw new ArgumentNullException("source is a required property for EventDetailDataItem and cannot be null");
            }
            this.Source = source;
            ...
            if (summary == null) {
                throw new ArgumentNullException("summary is a required property for EventDetailDataItem and cannot be null");
            }
            ...
            if (details == null) {
                throw new ArgumentNullException("details is a required property for EventDetailDataItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as EventDetailDataItem);
        }

        /// <summary>
        /// Returns true if EventDetailDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of EventDetailDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventDetailDataItem input)
        {
            if (input == null)
            {
                return false;
