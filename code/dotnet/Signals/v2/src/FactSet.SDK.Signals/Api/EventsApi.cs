...
namespace FactSet.SDK.Signals.Api
{
    ...
    public interface IEventsApiSync : IApiAccessor
    {
        ...
        /// <param name="updated">A date/time (UTC) interval for filtering signal events based on their last updated date. Defaults to NOW - 7 days if omitted. (optional)</param>
        ...
        /// <param name="resolveIdentifiers">The api will return resolved identifiers in the meta section of the response by default (true). If the parameter is false, the api will not attempt to resolve the identifiers. (optional)</param>
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        {
            var localVarResponse = GetEventAdaptiveCardsWithHttpInfo(created, updated, signalIds, ids, portfolios, themes, categories, userRelevanceScore, sort, resolveIdentifiers);
            return localVarResponse.Data;
        }
        ...
        public ApiResponse<EventAdaptiveCards> GetEventAdaptiveCardsWithHttpInfo(DateTimeInterval created = default(DateTimeInterval), DateTimeInterval updated = default(DateTimeInterval), string signalIds = default(string), string ids = default(string), string portfolios = default(string), string themes = default(string), string categories = default(string), RelevanceScoreRange userRelevanceScore = default(RelevanceScoreRange), string sort = default(string), bool? resolveIdentifiers = default(bool?))
        {
            ...
            if (resolveIdentifiers != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.Signals.Client.ClientUtils.ParameterToMultiMap("", "resolveIdentifiers", resolveIdentifiers));
            }
        ...
        {
            var localVarResponse = await GetEventAdaptiveCardsWithHttpInfoAsync(created, updated, signalIds, ids, portfolios, themes, categories, userRelevanceScore, sort, resolveIdentifiers, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            var localVarResponse = GetEventDetailsWithHttpInfo(created, updated, signalIds, ids, portfolios, themes, categories, userRelevanceScore, sort, resolveIdentifiers);
            return localVarResponse.Data;
        }
        ...
        {
            var localVarResponse = await GetEventDetailsWithHttpInfoAsync(created, updated, signalIds, ids, portfolios, themes, categories, userRelevanceScore, sort, resolveIdentifiers, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            var localVarResponse = GetEventHeadlinesWithHttpInfo(created, updated, signalIds, ids, portfolios, themes, categories, userRelevanceScore, sort, resolveIdentifiers);
            return localVarResponse.Data;
        }
        ...
        {
            var localVarResponse = await GetEventHeadlinesWithHttpInfoAsync(created, updated, signalIds, ids, portfolios, themes, categories, userRelevanceScore, sort, resolveIdentifiers, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
