...
namespace FactSet.SDK.Signals.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.22.10";
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/Signals/0.22.10";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/signals/v2") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.Signals) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.6.0\n";
            report += "    SDK Package Version: 0.22.10\n";
