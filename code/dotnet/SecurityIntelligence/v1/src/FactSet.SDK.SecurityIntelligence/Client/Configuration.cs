...
namespace FactSet.SDK.SecurityIntelligence.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/SecurityIntelligence/0.1.0";
            BasePath = "https://api.factset.com/security-intelligence/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/security-intelligence/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.SecurityIntelligence) Debug Report:\n";
