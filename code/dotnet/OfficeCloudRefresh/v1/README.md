...
[![Nuget](https://img.shields.io/badge/nuget-v0.1.1-orange)](https://www.nuget.org/packages/FactSet.SDK.OfficeCloudRefresh/0.1.1)
...
dotnet add package FactSet.SDK.OfficeCloudRefresh -v 0.1.1
```
...
nuget install FactSet.SDK.OfficeCloudRefresh -Version 0.1.1
```
