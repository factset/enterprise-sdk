...
[![Nuget](https://img.shields.io/badge/nuget-v0.13.0-orange)](https://www.nuget.org/packages/FactSet.SDK.AssetCashFlowProjections/0.13.0)
...
dotnet add package FactSet.SDK.AssetCashFlowProjections -v 0.13.0
```
...
nuget install FactSet.SDK.AssetCashFlowProjections -Version 0.13.0
```
