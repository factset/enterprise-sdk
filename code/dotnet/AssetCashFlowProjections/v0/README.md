...
[![Nuget](https://img.shields.io/badge/nuget-v0.12.0-orange)](https://www.nuget.org/packages/FactSet.SDK.AssetCashFlowProjections/0.12.0)
...
dotnet add package FactSet.SDK.AssetCashFlowProjections -v 0.12.0
```
...
nuget install FactSet.SDK.AssetCashFlowProjections -Version 0.12.0
```
...
namespace Example
{
    public static class GetBatchJobResultExample
    {
...
------------ | ------------- | ------------- | -------------
*BatchApi* | [**GetBatchJobResult**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchApi.md#getbatchjobresult) | **GET** /batch/{batchId}/result | Get Batch Job result by ID
*BatchApi* | [**GetBatchStatus**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchApi.md#getbatchstatus) | **GET** /batch/{batchId}/status | Get Batch status by ID
...
## Documentation for Models
 ...
 - [Model.BatchJobResult](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobResult.md)
 - [Model.BatchJobResultMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobResultMeta.md)
 - [Model.BatchJobResultRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobResultRoot.md)
 - [Model.BatchJobResults](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobResults.md)
 - [Model.BatchJobResultsLogs](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobResultsLogs.md)
 - [Model.BatchJobStatus](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobStatus.md)
 - [Model.BatchJobStatusRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/BatchJobStatusRoot.md)
 ...
 - [Model.UpdateDocument](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/UpdateDocument.md)
 - [Model.UpdateDocumentRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/AssetCashFlowProjections/v0/docs/UpdateDocumentRoot.md)
