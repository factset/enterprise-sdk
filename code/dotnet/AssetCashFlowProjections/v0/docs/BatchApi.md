...
namespace Example
{
    public class GetBatchJobResultExample
    {
        public static async Task Main()
        {
            ...
            var batchId = "batchId_example";  // string | Batch Job ID
            ...
            {
                Console.WriteLine("Exception when calling BatchApi.GetBatchJobResult: " + e.Message );
...
namespace Example
{
    public class GetBatchStatusExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling BatchApi.GetBatchStatus: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
