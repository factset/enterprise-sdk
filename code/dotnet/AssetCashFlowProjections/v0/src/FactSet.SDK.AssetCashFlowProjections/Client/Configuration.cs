...
namespace FactSet.SDK.AssetCashFlowProjections.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/AssetCashFlowProjections/0.10.0";
            BasePath = "https://api.factset.com/analytics/asset-cash-flow-projections/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/asset-cash-flow-projections/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.AssetCashFlowProjections) Debug Report:\n";
