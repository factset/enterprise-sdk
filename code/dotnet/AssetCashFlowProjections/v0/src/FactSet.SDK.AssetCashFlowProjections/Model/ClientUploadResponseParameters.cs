...
namespace FactSet.SDK.AssetCashFlowProjections.Model
{
    ...
    public partial class ClientUploadResponseParameters : IEquatable<ClientUploadResponseParameters>, IValidatableObject
    {
        ...
        public ClientUploadResponseParameters(DateTime expirationTime = default(DateTime), string fileName = default(string), string signedUrl = default(string), string uploadId = default(string))
        {
