...
namespace FactSet.SDK.AssetCashFlowProjections.Model
{
    ...
    /// UpdateDocumentRoot
    /// </summary>
    [DataContract(Name = "UpdateDocumentRoot")]
    public partial class UpdateDocumentRoot : IEquatable<UpdateDocumentRoot>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDocumentRoot" /> class.
        /// </summary>
        ...
        public UpdateDocumentRoot(DateTime asOfDate = default(DateTime), List<string> portfolios = default(List<string>), List<string> scenarios = default(List<string>))
        {
        ...
        {
            return this.Equals(input as UpdateDocumentRoot);
        }

        /// <summary>
        /// Returns true if UpdateDocumentRoot instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDocumentRoot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDocumentRoot input)
        {
            if (input == null)
            {
                return false;
