# FactSet.SDK.FactSetDebtCapitalStructure.Api.LiquidityApi
...
namespace Example
{
    public class GetLiquidityPostExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new LiquidityApi(config);

            var liquidityRequest = new LiquidityRequest(); // LiquidityRequest | Request object for `Liquidity`.

            try
            {
                // Returns liquidity information for specified metrics and date ranges.
                LiquidityResponse result = apiInstance.GetLiquidityPost(liquidityRequest);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LiquidityApi.GetLiquidityPost: " + e.Message );
