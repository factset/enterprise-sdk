# FactSet.SDK.FactSetDebtCapitalStructure.Api.DetailsApi
...
<a name="getdetailssummary"></a>
# **GetDetailsSummary**
> DetailsSummaryResponse GetDetailsSummary (List<string> ids, string periodicity, DateTime startDate, string currency = null)
...
namespace Example
{
    public class GetDetailsSummaryExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetDebtCapitalStructure.Client.Configuration();
            ...
            var ids = new List<string>(); // List<string> | The requested list of security identifiers. Accepted ID types include Market Tickers,  SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.  
            var periodicity = "ANN";  // string | Periodicity or frequency of the fiscal periods, where   * **ANN**  = Annual Original,   * **QTR**  = Quarterly 
            var startDate = DateTime.Parse("2024-01-01");  // DateTime | The date of the period requested in YYYY-MM-DD format.  Future dates (T+1) are not accepted in this endpoint. 
            ...
            {
                Console.WriteLine("Exception when calling DetailsApi.GetDetailsSummary: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ids** | [**List&lt;string&gt;**](string.md)| The requested list of security identifiers. Accepted ID types include Market Tickers,  SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.   | 
...
namespace Example
{
    public class GetInterimDetailsListExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling DetailsApi.GetInterimDetailsList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
