...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Api
{
    ...
    /// </summary>
    public interface ITotalsApiSync : IApiAccessor
    {
        ...
        /// <param name="dCSRequest">Request object for &#x60;DCS Totals&#x60;.</param>
        /// <returns>DcsResponse</returns>
        ...
        /// <exception cref="FactSet.SDK.FactSetDebtCapitalStructure.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dCSRequest">Request object for &#x60;DCS Totals&#x60;.</param>
        /// <returns>ApiResponse of DcsResponse</returns>
        ApiResponse<DcsResponse> GetDcsTotalsPostWithHttpInfo(DCSRequest dCSRequest);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITotalsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of DcsResponse</returns>
        System.Threading.Tasks.Task<DcsResponse> GetDcsTotalsPostAsync(DCSRequest dCSRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="dCSRequest">Request object for &#x60;DCS Totals&#x60;.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DcsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<DcsResponse>> GetDcsTotalsPostWithHttpInfoAsync(DCSRequest dCSRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITotalsApi : ITotalsApiSync, ITotalsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TotalsApi : ITotalsApi
    {
        private FactSet.SDK.FactSetDebtCapitalStructure.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        # region Response Type Disctionaries
        
        private static readonly Dictionary<HttpStatusCode, System.Type> GetDcsTotalsPostResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(DcsResponse) },
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TotalsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TotalsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TotalsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TotalsApi(FactSet.SDK.FactSetDebtCapitalStructure.Client.Configuration configuration)
        {
        ...
        public TotalsApi(FactSet.SDK.FactSetDebtCapitalStructure.Client.ISynchronousClient client, FactSet.SDK.FactSetDebtCapitalStructure.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetDebtCapitalStructure.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieves debt instrument totals for specified metrics and date ranges. Returns debt instruments totals. 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetDebtCapitalStructure.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dCSRequest">Request object for &#x60;DCS Totals&#x60;.</param>
        /// <returns>DcsResponse</returns>
        public DcsResponse GetDcsTotalsPost(DCSRequest dCSRequest)
        {
            var localVarResponse = GetDcsTotalsPostWithHttpInfo(dCSRequest);
        ...
        /// <param name="dCSRequest">Request object for &#x60;DCS Totals&#x60;.</param>
        /// <returns>ApiResponse of DcsResponse</returns>
        public ApiResponse<DcsResponse> GetDcsTotalsPostWithHttpInfo(DCSRequest dCSRequest)
        {
            // verify the required parameter 'dCSRequest' is set
            if (dCSRequest == null)
            {
                throw new FactSet.SDK.FactSetDebtCapitalStructure.Client.ApiException(400, "Missing required parameter 'dCSRequest' when calling TotalsApi->GetDcsTotalsPost");
            }
            ...
            localVarRequestOptions.Data = dCSRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetDcsTotalsPostResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Post<
            DcsResponse>("/dcs-totals", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetDcsTotalsPost", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DcsResponse</returns>
        public async System.Threading.Tasks.Task<DcsResponse>GetDcsTotalsPostAsync(DCSRequest dCSRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetDcsTotalsPostWithHttpInfoAsync(dCSRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<DcsResponse>> GetDcsTotalsPostWithHttpInfoAsync(DCSRequest dCSRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'dCSRequest' is set
            if (dCSRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<DcsResponse>("/dcs-totals", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
