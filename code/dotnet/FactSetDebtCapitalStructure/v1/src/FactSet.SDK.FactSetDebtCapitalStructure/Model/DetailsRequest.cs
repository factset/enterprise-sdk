...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    public partial class DetailsRequest : IEquatable<DetailsRequest>, IValidatableObject
    {
        ...
        public DetailsRequest(DetailsRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for DetailsRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public DetailsRequestBody Data { get; set; }
