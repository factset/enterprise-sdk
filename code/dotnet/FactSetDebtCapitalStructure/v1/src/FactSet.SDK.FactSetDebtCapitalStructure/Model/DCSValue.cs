...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(DCSValueJsonConverter))]
    [DataContract(Name = "DCSValue")]
    public partial class DCSValue : AbstractOpenAPISchema, IEquatable<DCSValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DCSValue" /> class.
        /// </summary>
        public DCSValue()
        {
        ...
        public DCSValue(string actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        public DCSValue(double? actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, DCSValue.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of DCSValue
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of DCSValue</returns>
        public static DCSValue FromJson(string jsonString)
        {
            DCSValue newDCSValue = null;
            ...
            try
            {
                ...
                {
                    newDCSValue = new DCSValue((string)parsedValue);
            ...
            try
            {
                ...
                {
                    newDCSValue = new DCSValue((double?)parsedValue);
        ...
        {
            return this.Equals(input as DCSValue);
        }

        /// <summary>
        /// Returns true if DCSValue instances are equal
        /// </summary>
        /// <param name="input">Instance of DCSValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DCSValue input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for DCSValue
    /// </summary>
    public class DCSValueJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(DCSValue).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return DCSValue.FromJson(JToken.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
