...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DetailsSummaryResponse")]
    public partial class DetailsSummaryResponse : IEquatable<DetailsSummaryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailsSummaryResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DetailsSummaryResponse(List<DetailsSummary> data = default(List<DetailsSummary>))
        {
            this.Data = data;
        }
        ...
        public List<DetailsSummary> Data { get; set; }
        ...
        {
            return this.Equals(input as DetailsSummaryResponse);
        }

        /// <summary>
        /// Returns true if DetailsSummaryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailsSummaryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailsSummaryResponse input)
        {
            if (input == null)
            {
                return false;
