...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// Liquidity Response
    /// </summary>
    [DataContract(Name = "LiquidityResponse")]
    public partial class LiquidityResponse : IEquatable<LiquidityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiquidityResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public LiquidityResponse(List<LiquidityResponseFields> data = default(List<LiquidityResponseFields>))
        {
            this.Data = data;
        }
        ...
        public List<LiquidityResponseFields> Data { get; set; }
        ...
        {
            return this.Equals(input as LiquidityResponse);
        }

        /// <summary>
        /// Returns true if LiquidityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LiquidityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LiquidityResponse input)
        {
            if (input == null)
            {
                return false;
