...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// DCS Totals Response
    /// </summary>
    [DataContract(Name = "DCSTotalsResponse")]
    public partial class DCSTotalsResponse : IEquatable<DCSTotalsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DCSTotalsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DCSTotalsResponse(List<DcsResponseFields> data = default(List<DcsResponseFields>))
        {
            this.Data = data;
        }
        ...
        public List<DcsResponseFields> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DCSTotalsResponse {\n");
        ...
        {
            return this.Equals(input as DCSTotalsResponse);
        }

        /// <summary>
        /// Returns true if DCSTotalsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DCSTotalsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DCSTotalsResponse input)
        {
            if (input == null)
            {
                return false;
