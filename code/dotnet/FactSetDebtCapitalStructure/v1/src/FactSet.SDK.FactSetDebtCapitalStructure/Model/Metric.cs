...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    public partial class Metric : IEquatable<Metric>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="metric">Data item to be used as &#x60;metrics&#x60; input in &#x60;/dcs-totals/v#/&#x60; endpoint..</param>
        /// <param name="description">Description of the metric..</param>
        /// <param name="category">Corresponding endpoint to input metric item..</param>
        public Metric(string metric = default(string), string description = default(string), string category = default(string))
        {
            this._Metric = metric;
        ...
        /// </summary>
        /// <value>Data item to be used as &#x60;metrics&#x60; input in &#x60;/dcs-totals/v#/&#x60; endpoint.</value>
        ...
        /// </summary>
        /// <value>Corresponding endpoint to input metric item.</value>
