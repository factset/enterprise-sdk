...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DcsResponse")]
    public partial class DcsResponse : IEquatable<DcsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DcsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DcsResponse(List<DcsResponseFields> data = default(List<DcsResponseFields>))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as DcsResponse);
        }

        /// <summary>
        /// Returns true if DcsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DcsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DcsResponse input)
        {
            if (input == null)
            {
                return false;
