...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// Liquidity Request
    /// </summary>
    [DataContract(Name = "LiquidityRequest")]
    public partial class LiquidityRequest : IEquatable<LiquidityRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiquidityRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LiquidityRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LiquidityRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public LiquidityRequest(LiquidityRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for LiquidityRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public LiquidityRequestBody Data { get; set; }
        ...
        {
            return this.Equals(input as LiquidityRequest);
        }

        /// <summary>
        /// Returns true if LiquidityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LiquidityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LiquidityRequest input)
        {
            if (input == null)
            {
                return false;
