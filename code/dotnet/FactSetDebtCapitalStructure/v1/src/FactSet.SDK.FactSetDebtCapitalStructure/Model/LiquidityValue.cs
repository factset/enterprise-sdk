...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(LiquidityValueJsonConverter))]
    [DataContract(Name = "LiquidityValue")]
    public partial class LiquidityValue : AbstractOpenAPISchema, IEquatable<LiquidityValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiquidityValue" /> class.
        /// </summary>
        ...
        public LiquidityValue(string actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        public LiquidityValue(double? actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LiquidityValue {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, LiquidityValue.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of LiquidityValue
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of LiquidityValue</returns>
        public static LiquidityValue FromJson(string jsonString)
        {
            LiquidityValue newLiquidityValue = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newLiquidityValue;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newLiquidityValue = new LiquidityValue((string)parsedValue);
            ...
            try
            {
                ...
                {
                    newLiquidityValue = new LiquidityValue((double?)parsedValue);
        ...
        {
            return this.Equals(input as LiquidityValue);
        }

        /// <summary>
        /// Returns true if LiquidityValue instances are equal
        /// </summary>
        /// <param name="input">Instance of LiquidityValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LiquidityValue input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for LiquidityValue
    /// </summary>
    public class LiquidityValueJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(LiquidityValue).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return LiquidityValue.FromJson(JToken.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
