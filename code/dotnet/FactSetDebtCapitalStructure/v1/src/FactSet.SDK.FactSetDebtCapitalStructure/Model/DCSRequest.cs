...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    /// DCS Totals Request
    /// </summary>
    [DataContract(Name = "DCSRequest")]
    public partial class DCSRequest : IEquatable<DCSRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DCSRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DCSRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DCSRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public DCSRequest(DCSRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for DCSRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public DCSRequestBody Data { get; set; }
        ...
        {
            return this.Equals(input as DCSRequest);
        }

        /// <summary>
        /// Returns true if DCSRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DCSRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DCSRequest input)
        {
            if (input == null)
            {
                return false;
