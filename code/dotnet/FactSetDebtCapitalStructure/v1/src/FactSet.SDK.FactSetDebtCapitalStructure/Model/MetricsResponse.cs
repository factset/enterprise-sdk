...
namespace FactSet.SDK.FactSetDebtCapitalStructure.Model
{
    ...
    public partial class MetricsResponse : IEquatable<MetricsResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Array of metric objects representing the data items that can be requested from the Debt Capital Structure API. .</param>
        ...
        /// <summary>
        /// Array of metric objects representing the data items that can be requested from the Debt Capital Structure API. 
        /// </summary>
        /// <value>Array of metric objects representing the data items that can be requested from the Debt Capital Structure API. </value>
