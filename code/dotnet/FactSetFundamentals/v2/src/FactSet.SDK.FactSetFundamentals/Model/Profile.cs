...
namespace FactSet.SDK.FactSetFundamentals.Model
{
    ...
    public partial class Profile : IEquatable<Profile>, IValidatableObject
    {
        ...
        public Profile(string requestId = default(string), CompanyReportErrorObject error = default(CompanyReportErrorObject), string fsymId = default(string), string tickerRegion = default(string), Exchange exchange = default(Exchange), string name = default(string), Address address = default(Address), string industryId = default(string), string industry = default(string), string sectorId = default(string), string sector = default(string), int? numberOfEmployees = default(int?), string ceo = default(string), string businessSummary = default(string), int? yearFounded = default(int?), long? marketCapitalization = default(long?), long? totalMarketCapitalization = default(long?), long? sharesOutstanding = default(long?), double? peRatio = default(double?))
        {
