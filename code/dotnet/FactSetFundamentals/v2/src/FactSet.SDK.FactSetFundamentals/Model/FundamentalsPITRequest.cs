...
namespace FactSet.SDK.FactSetFundamentals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundamentalsPITRequest")]
    public partial class FundamentalsPITRequest : IEquatable<FundamentalsPITRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundamentalsPITRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FundamentalsPITRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FundamentalsPITRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public FundamentalsPITRequest(FundamentalsPITRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for FundamentalsPITRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public FundamentalsPITRequestBody Data { get; set; }
        ...
        {
            return this.Equals(input as FundamentalsPITRequest);
        }

        /// <summary>
        /// Returns true if FundamentalsPITRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FundamentalsPITRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundamentalsPITRequest input)
        {
            if (input == null)
            {
                return false;
