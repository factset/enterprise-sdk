...
namespace FactSet.SDK.FactSetFundamentals.Model
{
    ...
    public partial class Fundamental : IEquatable<Fundamental>, IValidatableObject
    {
        ...
        /// <param name="metric">The requested &#x60;metric&#x60; input, representing the Fundamentals Data Item. For a definition of the item please use the &#x60;/fundamentals/v2/metrics&#x60; endpoint..</param>
        ...
        /// <param name="fiscalPeriod">Fiscal Period indicator. Returns an integer representing the fiscal period for the requested item and periodicity.  QUARTERLY CODE: 1-First Quarter; 2-Second Quarter; 3-Third Quarter; 4-Fourth Quarter. SEMI-CODE: 1-First Semi-annual Period; 2-Second Semi-annual Period. (required).</param>
        ...
        /// <param name="epsReportDate">The date the EPS was reported for the requested periodicity. In YYYY-MM-DD format..</param>
        ...
        /// </summary>
        /// <value>The requested &#x60;metric&#x60; input, representing the Fundamentals Data Item. For a definition of the item please use the &#x60;/fundamentals/v2/metrics&#x60; endpoint.</value>
        ...
        /// </summary>
        /// <value>Fiscal Period indicator. Returns an integer representing the fiscal period for the requested item and periodicity.  QUARTERLY CODE: 1-First Quarter; 2-Second Quarter; 3-Third Quarter; 4-Fourth Quarter. SEMI-CODE: 1-First Semi-annual Period; 2-Second Semi-annual Period.</value>
        ...
        /// </summary>
        /// <value>The date the EPS was reported for the requested periodicity. In YYYY-MM-DD format.</value>
