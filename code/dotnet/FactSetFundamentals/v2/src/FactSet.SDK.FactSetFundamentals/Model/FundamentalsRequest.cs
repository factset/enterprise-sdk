...
namespace FactSet.SDK.FactSetFundamentals.Model
{
    ...
    public partial class FundamentalsRequest : IEquatable<FundamentalsRequest>, IValidatableObject
    {
        ...
        public FundamentalsRequest(FundamentalRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for FundamentalsRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public FundamentalRequestBody Data { get; set; }
