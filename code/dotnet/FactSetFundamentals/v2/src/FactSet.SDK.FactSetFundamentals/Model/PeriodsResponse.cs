...
namespace FactSet.SDK.FactSetFundamentals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PeriodsResponse")]
    public partial class PeriodsResponse : IEquatable<PeriodsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeriodsResponse" /> class.
        /// </summary>
        /// <param name="data">Array of fiscal period detail objects..</param>
        public PeriodsResponse(List<PeriodInfo> data = default(List<PeriodInfo>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Array of fiscal period detail objects.</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<PeriodInfo> Data { get; set; }
        ...
        {
            return this.Equals(input as PeriodsResponse);
        }

        /// <summary>
        /// Returns true if PeriodsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PeriodsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeriodsResponse input)
        {
            if (input == null)
            {
                return false;
