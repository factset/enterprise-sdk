...
namespace FactSet.SDK.FactSetFundamentals.Api
{
    ...
    public interface ICompanyReportsApiSync : IApiAccessor
    {
        ...
        /// <param name="ids">The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids. &lt;p&gt;***ids limit** &#x3D;  50 per request*&lt;/p&gt; </param>
        /// <param name="currency">Currency code for currency values. For a list of currency ISO codes, visit Online Assistant Page [OA1470](https://my.apps.factset.com/oa/pages/1470).  Giving input as \&quot;DOC\&quot; would give the values in reporting currency for the requested ids.  (optional, default to &quot;LOCAL&quot;)</param>
        /// <param name="periodicity">Periodicity or frequency of the fiscal periods. If not specified, default will be empty, which will return the latest available data irrespective of the periodicity.   * **ANN**  &#x3D; Annual - Original,   * **QTR**  &#x3D; Quarterly - Original   * **SEMI** &#x3D; Semi-Annual  (optional)</param>
        /// <returns>CompanyFundamentalsResponse</returns>
        CompanyFundamentalsResponse GetFundamentals(List<string> ids, string currency = default(string), string periodicity = default(string));
        ...
        ApiResponse<CompanyFundamentalsResponse> GetFundamentalsWithHttpInfo(List<string> ids, string currency = default(string), string periodicity = default(string));
    ...
    public interface ICompanyReportsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CompanyFundamentalsResponse> GetFundamentalsAsync(List<string> ids, string currency = default(string), string periodicity = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CompanyFundamentalsResponse>> GetFundamentalsWithHttpInfoAsync(List<string> ids, string currency = default(string), string periodicity = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class CompanyReportsApi : ICompanyReportsApi
    {
        ...
        /// <param name="periodicity">Periodicity or frequency of the fiscal periods. If not specified, default will be empty, which will return the latest available data irrespective of the periodicity.   * **ANN**  &#x3D; Annual - Original,   * **QTR**  &#x3D; Quarterly - Original   * **SEMI** &#x3D; Semi-Annual  (optional)</param>
        /// <returns>CompanyFundamentalsResponse</returns>
        public CompanyFundamentalsResponse GetFundamentals(List<string> ids, string currency = default(string), string periodicity = default(string))
        {
            var localVarResponse = GetFundamentalsWithHttpInfo(ids, currency, periodicity);
            return localVarResponse.Data;
        }
        ...
        /// <param name="periodicity">Periodicity or frequency of the fiscal periods. If not specified, default will be empty, which will return the latest available data irrespective of the periodicity.   * **ANN**  &#x3D; Annual - Original,   * **QTR**  &#x3D; Quarterly - Original   * **SEMI** &#x3D; Semi-Annual  (optional)</param>
        /// <returns>ApiResponse of CompanyFundamentalsResponse</returns>
        public ApiResponse<CompanyFundamentalsResponse> GetFundamentalsWithHttpInfo(List<string> ids, string currency = default(string), string periodicity = default(string))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CompanyFundamentalsResponse</returns>
        public async System.Threading.Tasks.Task<CompanyFundamentalsResponse>GetFundamentalsAsync(List<string> ids, string currency = default(string), string periodicity = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetFundamentalsWithHttpInfoAsync(ids, currency, periodicity, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<CompanyFundamentalsResponse>> GetFundamentalsWithHttpInfoAsync(List<string> ids, string currency = default(string), string periodicity = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
