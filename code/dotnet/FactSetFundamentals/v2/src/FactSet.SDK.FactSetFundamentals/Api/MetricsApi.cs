...
namespace FactSet.SDK.FactSetFundamentals.Api
{
    ...
    public interface IMetricsApiSync : IApiAccessor
    {
        ...
        /// <param name="metricDataType">Returns general data type of the metrics like integer, float or strings. When left blank, metrics with all data types would be returned. (optional, default to &quot;&quot;)</param>
        /// <param name="pitDataItems">Filters the list of metrics based on whether they are available for Point-in-Time (PIT) historical data. * &#x60;true&#x60; - Returns metrics that are available in PIT datasets. These metrics can be used in the &#x60;/point-in-time&#x60; endpoint. * &#x60;false&#x60; (default) - Returns metrics that are available in non-PIT datasets. (optional, default to false)</param>
        /// <returns>MetricsResponse</returns>
        MetricsResponse GetFdsFundamentalsMetrics(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?));
        ...
        ApiResponse<MetricsResponse> GetFdsFundamentalsMetricsWithHttpInfo(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?));
    ...
    public interface IMetricsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MetricsResponse> GetFdsFundamentalsMetricsAsync(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<MetricsResponse>> GetFdsFundamentalsMetricsWithHttpInfoAsync(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MetricsApi : IMetricsApi
    {
        ...
        /// <param name="pitDataItems">Filters the list of metrics based on whether they are available for Point-in-Time (PIT) historical data. * &#x60;true&#x60; - Returns metrics that are available in PIT datasets. These metrics can be used in the &#x60;/point-in-time&#x60; endpoint. * &#x60;false&#x60; (default) - Returns metrics that are available in non-PIT datasets. (optional, default to false)</param>
        /// <returns>MetricsResponse</returns>
        public MetricsResponse GetFdsFundamentalsMetrics(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?))
        {
            var localVarResponse = GetFdsFundamentalsMetricsWithHttpInfo(category, subcategory, metricDataType, pitDataItems);
        ...
        /// <param name="pitDataItems">Filters the list of metrics based on whether they are available for Point-in-Time (PIT) historical data. * &#x60;true&#x60; - Returns metrics that are available in PIT datasets. These metrics can be used in the &#x60;/point-in-time&#x60; endpoint. * &#x60;false&#x60; (default) - Returns metrics that are available in non-PIT datasets. (optional, default to false)</param>
        /// <returns>ApiResponse of MetricsResponse</returns>
        public ApiResponse<MetricsResponse> GetFdsFundamentalsMetricsWithHttpInfo(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?))
        {
            ...
            if (pitDataItems != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetFundamentals.Client.ClientUtils.ParameterToMultiMap("", "pitDataItems", pitDataItems));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MetricsResponse</returns>
        public async System.Threading.Tasks.Task<MetricsResponse>GetFdsFundamentalsMetricsAsync(string category = default(string), string subcategory = default(string), string metricDataType = default(string), bool? pitDataItems = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetFdsFundamentalsMetricsWithHttpInfoAsync(category, subcategory, metricDataType, pitDataItems, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
