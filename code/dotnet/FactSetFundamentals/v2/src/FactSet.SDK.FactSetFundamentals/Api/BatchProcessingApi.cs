...
namespace FactSet.SDK.FactSetFundamentals.Api
{
    ...
    public partial class BatchProcessingApi : IBatchProcessingApi
    {
        ...
        /// <summary>
        /// Returns the response for a Batch Request Returns the response data for the underlying batch request that is specified by the id. The response structure will be based on the endpoint that initiated the batch request (/fundamentals, /segments, /point-in-time, or /periods).  By default, this endpoint will return data as JSON. If you wish to receive your data in CSV format, you can edit the header to have the \&quot;accept\&quot; parameter as \&quot;text/csv\&quot; instead of \&quot;application/json\&quot;. 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetFundamentals.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Batch Request identifier.</param>
        /// <returns>BatchProcessingApi.GetBatchDataResponseWrapper</returns>
