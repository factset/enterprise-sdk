...
> MetricsResponse GetFdsFundamentalsMetrics (string category = null, string subcategory = null, string metricDataType = null)
...
namespace Example
{
    public class GetFdsFundamentalsMetricsExample
    {
        public static async Task Main()
        {
            ...
            var metricDataType = "integer";  // string | Returns general data type of the metrics like integer, float or strings, when left blankmetrics with all data types would be returned  (optional) 
