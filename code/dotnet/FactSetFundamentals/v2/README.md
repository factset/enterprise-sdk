...
[![API Version](https://img.shields.io/badge/api-v2.3.0-blue)](https://developer.factset.com/api-catalog/factset-fundamentals-api)
[![Nuget](https://img.shields.io/badge/nuget-v2.4.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetFundamentals/2.4.0)
...
dotnet add package FactSet.SDK.FactSetFundamentals -v 2.4.0
```
...
nuget install FactSet.SDK.FactSetFundamentals -Version 2.4.0
```
