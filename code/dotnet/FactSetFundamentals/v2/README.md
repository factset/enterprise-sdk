...
[![Nuget](https://img.shields.io/badge/nuget-v2.5.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetFundamentals/2.5.0)
...
dotnet add package FactSet.SDK.FactSetFundamentals -v 2.5.0
```
...
nuget install FactSet.SDK.FactSetFundamentals -Version 2.5.0
```
