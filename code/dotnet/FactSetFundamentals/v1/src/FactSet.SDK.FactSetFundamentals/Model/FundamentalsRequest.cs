...
namespace FactSet.SDK.FactSetFundamentals.Model
{
    ...
    public partial class FundamentalsRequest : IEquatable<FundamentalsRequest>, IValidatableObject
    {
        ...
        public FundamentalsRequest(List<string> ids, List<string> metrics,Periodicity periodicity = default(Periodicity), string fiscalPeriodStart = default(string), string fiscalPeriodEnd = default(string), string currency = "LOCAL", Restated restated = default(Restated))
        {
