...
namespace Example
{
    public class GetFdsFundamentalsExample
    {
        public static async Task Main()
        {
            ...
            var currency = USD;  // string | Currency code for currency values. For a list of currency ISO codes, visit Online Assistant Page [OA1470](https://my.apps.factset.com/oa/pages/1470).  Giving input as \"DOC\" would give the values in reporting currency for the requested ids.  (optional)  (default to "LOCAL")
