...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cusipTranslationRequest")]
    public partial class CusipTranslationRequest : IEquatable<CusipTranslationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipTranslationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CusipTranslationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipTranslationRequest" /> class.
        /// </summary>
        ...
        public CusipTranslationRequest(List<string> ids = default(List<string>), string asOfDate = default(string))
        {
            ...
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for CusipTranslationRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as CusipTranslationRequest);
        }

        /// <summary>
        /// Returns true if CusipTranslationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CusipTranslationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CusipTranslationRequest input)
        {
            if (input == null)
            {
                return false;
