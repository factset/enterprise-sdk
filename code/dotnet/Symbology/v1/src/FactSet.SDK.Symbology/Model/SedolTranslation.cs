...
namespace FactSet.SDK.Symbology.Model
{
    ...
    public partial class SedolTranslation : IEquatable<SedolTranslation>, IValidatableObject
    {
        ...
        /// <param name="sedolEffectiveStartDate">The effective start date in which the CUSIP was valid for the security..</param>
        /// <param name="sedolEffectiveEndDate">The effective end date in which the Sedol was valid. If null, the Sedol is still active for the security and date requested..</param>
        /// <param name="asOfDate">The reqeuested date for the symbol..</param>
        /// <param name="requestId">Identifier specified in the request.</param>
        public SedolTranslation(string fsymId = default(string), string name = default(string), string sedol = default(string), string sedolEffectiveStartDate = default(string), string sedolEffectiveEndDate = default(string), DateTime asOfDate = default(DateTime), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Name = name;
            this.Sedol = sedol;
        ...
        /// </summary>
        /// <value>The effective start date in which the CUSIP was valid for the security.</value>
        [DataMember(Name = "sedolEffectiveStartDate", EmitDefaultValue = false)]
        public string SedolEffectiveStartDate { get; set; }
        ...
        /// </summary>
        /// <value>The effective end date in which the Sedol was valid. If null, the Sedol is still active for the security and date requested.</value>
        [DataMember(Name = "sedolEffectiveEndDate", EmitDefaultValue = false)]
        public string SedolEffectiveEndDate { get; set; }

        /// <summary>
        /// The reqeuested date for the symbol.
        /// </summary>
        /// <value>The reqeuested date for the symbol.</value>
