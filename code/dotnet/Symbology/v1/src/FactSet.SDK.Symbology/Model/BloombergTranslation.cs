...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bloombergTranslation")]
    public partial class BloombergTranslation : IEquatable<BloombergTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BloombergTranslation" /> class.
        /// </summary>
        ...
        /// <param name="bbgSecurityId">Bloomberg Security Identifier..</param>
        /// <param name="bbgCompositeId">Bloomberg Security Identifier..</param>
        /// <param name="bbgListingId">Bloomberg Security Identifier..</param>
        /// <param name="bbgTickerListing">Bloomberg Security Identifier..</param>
        /// <param name="bbgTickerComposite">Bloomberg Security Identifier..</param>
        /// <param name="requestId">Identifier specified in the request.</param>
        public BloombergTranslation(string fsymId = default(string), string name = default(string), string bbgSecurityId = default(string), string bbgCompositeId = default(string), string bbgListingId = default(string), string bbgTickerListing = default(string), string bbgTickerComposite = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Bloomberg Security Identifier.</value>
        [DataMember(Name = "bbgSecurityId", EmitDefaultValue = false)]
        public string BbgSecurityId { get; set; }

        /// <summary>
        /// Bloomberg Security Identifier.
        /// </summary>
        /// <value>Bloomberg Security Identifier.</value>
        [DataMember(Name = "bbgCompositeId", EmitDefaultValue = false)]
        public string BbgCompositeId { get; set; }

        /// <summary>
        /// Bloomberg Security Identifier.
        /// </summary>
        /// <value>Bloomberg Security Identifier.</value>
        [DataMember(Name = "bbgListingId", EmitDefaultValue = false)]
        public string BbgListingId { get; set; }

        /// <summary>
        /// Bloomberg Security Identifier.
        /// </summary>
        /// <value>Bloomberg Security Identifier.</value>
        [DataMember(Name = "bbgTickerListing", EmitDefaultValue = false)]
        public string BbgTickerListing { get; set; }

        /// <summary>
        /// Bloomberg Security Identifier.
        /// </summary>
        /// <value>Bloomberg Security Identifier.</value>
        [DataMember(Name = "bbgTickerComposite", EmitDefaultValue = false)]
        public string BbgTickerComposite { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BbgSecurityId: ").Append(BbgSecurityId).Append("\n");
            sb.Append("  BbgCompositeId: ").Append(BbgCompositeId).Append("\n");
            sb.Append("  BbgListingId: ").Append(BbgListingId).Append("\n");
            sb.Append("  BbgTickerListing: ").Append(BbgTickerListing).Append("\n");
            sb.Append("  BbgTickerComposite: ").Append(BbgTickerComposite).Append("\n");
        ...
        {
            return this.Equals(input as BloombergTranslation);
        }

        /// <summary>
        /// Returns true if BloombergTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of BloombergTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BloombergTranslation input)
        {
            ...
            return 
                ...
                (
                    this.BbgSecurityId == input.BbgSecurityId ||
                    (this.BbgSecurityId != null &&
                    this.BbgSecurityId.Equals(input.BbgSecurityId))
                ) && 
                (
                    this.BbgCompositeId == input.BbgCompositeId ||
                    (this.BbgCompositeId != null &&
                    this.BbgCompositeId.Equals(input.BbgCompositeId))
                ) && 
                (
                    this.BbgListingId == input.BbgListingId ||
                    (this.BbgListingId != null &&
                    this.BbgListingId.Equals(input.BbgListingId))
                ) && 
                (
                    this.BbgTickerListing == input.BbgTickerListing ||
                    (this.BbgTickerListing != null &&
                    this.BbgTickerListing.Equals(input.BbgTickerListing))
                ) && 
                (
                    this.BbgTickerComposite == input.BbgTickerComposite ||
                    (this.BbgTickerComposite != null &&
                    this.BbgTickerComposite.Equals(input.BbgTickerComposite))
                ) && 
                (
