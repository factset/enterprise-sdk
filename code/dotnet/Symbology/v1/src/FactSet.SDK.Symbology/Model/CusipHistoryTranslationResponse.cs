...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cusipHistoryTranslationResponse")]
    public partial class CusipHistoryTranslationResponse : IEquatable<CusipHistoryTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipHistoryTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public CusipHistoryTranslationResponse(List<CusipHistoryTranslation> data = default(List<CusipHistoryTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<CusipHistoryTranslation> Data { get; set; }
        ...
        {
            return this.Equals(input as CusipHistoryTranslationResponse);
        }

        /// <summary>
        /// Returns true if CusipHistoryTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CusipHistoryTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CusipHistoryTranslationResponse input)
        {
            if (input == null)
                return false;
