...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tickerHistoryTranslation")]
    public partial class TickerHistoryTranslation : IEquatable<TickerHistoryTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TickerHistoryTranslation" /> class.
        /// </summary>
        ...
        /// <param name="ticker">Region or Exchange Ticker.</param>
        /// <param name="tickerEffectiveStartDate">Ticker effective start date in YYYY-MM-DD format..</param>
        /// <param name="asOfDate">As of Date in YYYY-MM-DD format..</param>
        /// <param name="requestId">Identifier specified in the request.</param>
        public TickerHistoryTranslation(string fsymId = default(string), string name = default(string), string ticker = default(string), DateTime tickerEffectiveStartDate = default(DateTime), DateTime asOfDate = default(DateTime), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Name = name;
            this.Ticker = ticker;
        ...
        /// </summary>
        /// <value>Region or Exchange Ticker</value>
        ...
        /// </summary>
        /// <value>Ticker effective start date in YYYY-MM-DD format.</value>
        [DataMember(Name = "tickerEffectiveStartDate", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime TickerEffectiveStartDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TickerEffectiveStartDate: ").Append(TickerEffectiveStartDate).Append("\n");
        ...
        {
            return this.Equals(input as TickerHistoryTranslation);
        }

        /// <summary>
        /// Returns true if TickerHistoryTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of TickerHistoryTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TickerHistoryTranslation input)
        {
            ...
            return 
                ...
                (
                    this.TickerEffectiveStartDate == input.TickerEffectiveStartDate ||
                    (this.TickerEffectiveStartDate != null &&
                    this.TickerEffectiveStartDate.Equals(input.TickerEffectiveStartDate))
                ) && 
                (
