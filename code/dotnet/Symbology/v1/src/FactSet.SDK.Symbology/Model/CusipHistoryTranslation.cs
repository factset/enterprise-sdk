...
namespace FactSet.SDK.Symbology.Model
{
    ...
    public partial class CusipHistoryTranslation : IEquatable<CusipHistoryTranslation>, IValidatableObject
    {
        ...
        public CusipHistoryTranslation(string fsymId = default(string), string name = default(string), string cusip = default(string), DateTime cusipEffectiveStartDate = default(DateTime), DateTime cusipEffectiveEndDate = default(DateTime), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Name = name;
            this.Cusip = cusip;
