...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cusipHistoryTranslationRequest")]
    public partial class CusipHistoryTranslationRequest : IEquatable<CusipHistoryTranslationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipHistoryTranslationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CusipHistoryTranslationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipHistoryTranslationRequest" /> class.
        /// </summary>
        ...
        public CusipHistoryTranslationRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for CusipHistoryTranslationRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as CusipHistoryTranslationRequest);
        }

        /// <summary>
        /// Returns true if CusipHistoryTranslationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CusipHistoryTranslationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CusipHistoryTranslationRequest input)
        {
            if (input == null)
                return false;
