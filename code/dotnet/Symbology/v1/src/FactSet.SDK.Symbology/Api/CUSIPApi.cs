...
namespace FactSet.SDK.Symbology.Api
{
    ...
    public interface ICUSIPApiSync : IApiAccessor
    {
        ...
        ApiResponse<CusipHistoryTranslationResponse> BatchCusipHistoryWithHttpInfo(CusipHistoryTranslationRequest cusipHistoryTranslationRequest);
        /// <summary>
        ...
        /// <param name="ids">Requested market securities or entities. Accepted identifiers include all FactSet Permanent Identifiers types, CUSIP, SEDOL, ISIN, and Tickers. This request value is sent back in the response as, &#x60;requestId&#x60;.</param>
        /// <returns>ApiResponse of CusipHistoryTranslationResponse</returns>
        ApiResponse<CusipHistoryTranslationResponse> CusipHistoryWithHttpInfo(List<string> ids);
        /// <summary>
        /// Translate market security symbols into CUSIP.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>CusipTranslationResponse</returns>
        CusipTranslationResponse TranslateCusip(List<string> ids, string asOfDate = default(string));
        ...
        /// <param name="asOfDate">As-Of date for historical symbol request in YYYY-MM-DD format. (optional)</param>
        /// <returns>ApiResponse of CusipTranslationResponse</returns>
        ApiResponse<CusipTranslationResponse> TranslateCusipWithHttpInfo(List<string> ids, string asOfDate = default(string));
    ...
    public interface ICUSIPApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CusipHistoryTranslationResponse> BatchCusipHistoryAsync(CusipHistoryTranslationRequest cusipHistoryTranslationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CusipHistoryTranslationResponse>> BatchCusipHistoryWithHttpInfoAsync(CusipHistoryTranslationRequest cusipHistoryTranslationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Translate market security symbols into CUSIP.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CusipHistoryTranslationResponse</returns>
        System.Threading.Tasks.Task<CusipHistoryTranslationResponse> CusipHistoryAsync(List<string> ids, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CusipHistoryTranslationResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<CusipHistoryTranslationResponse>> CusipHistoryWithHttpInfoAsync(List<string> ids, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Translate market security symbols into CUSIP.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CusipTranslationResponse</returns>
        System.Threading.Tasks.Task<CusipTranslationResponse> TranslateCusipAsync(List<string> ids, string asOfDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CusipTranslationResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<CusipTranslationResponse>> TranslateCusipWithHttpInfoAsync(List<string> ids, string asOfDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class CUSIPApi : ICUSIPApi
    {
        ...
        /// <summary>
        /// Retrieve the full history of CUSIP changes for the requested ID(s). Return the full history of CUSIP changes for a given market security or FactSet Permanent Id. Visit [OA 9094](https://my.apps.factset.com/oa/pages/9094) for more details regarding the CUSIP numbering system. 
        /// </summary>
        /// <exception cref="FactSet.SDK.Symbology.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cusipHistoryTranslationRequest">Request Body for CUSIP History</param>
        /// <returns>CusipHistoryTranslationResponse</returns>
        ...
        /// <summary>
        /// Translate market security symbols into CUSIP. Translate market security symbols into CUSIP and FactSet Permanent Identifiers. Visit [OA 9094](https://my.apps.factset.com/oa/pages/9094) for more details regarding the CUSIP numbering system. &lt;p&gt;This method is best for requesting **large universes** of &#x60;ids&#x60;.&lt;/p&gt;
        /// </summary>
        /// <exception cref="FactSet.SDK.Symbology.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cusipTranslationRequest">Request Body for CUSIP Symbology Translation</param>
        /// <returns>CusipTranslationResponse</returns>
        ...
        /// <summary>
        /// Retrieve the full history of CUSIP changes for the requested ID(s). Return the full history of CUSIP changes for a given market security or FactSet Permanent Id. Visit [OA 9094](https://my.apps.factset.com/oa/pages/9094) for more details regarding the CUSIP numbering system.  &lt;p&gt;*GET Method is limited by URL Length of 2,048 characters. If a large universe of symbols is requested, it&#39;s advised to use POST method to retrieve the same response model.*&lt;/P&gt;
        /// </summary>
        /// <exception cref="FactSet.SDK.Symbology.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Requested market securities or entities. Accepted identifiers include all FactSet Permanent Identifiers types, CUSIP, SEDOL, ISIN, and Tickers. This request value is sent back in the response as, &#x60;requestId&#x60;.</param>
        /// <returns>CusipHistoryTranslationResponse</returns>
        ...
        /// <summary>
        /// Translate market security symbols into CUSIP. Translate market security symbols into CUSIP and FactSet Permanent Identifiers. Visit [OA 9094](https://my.apps.factset.com/oa/pages/9094) for more details regarding the CUSIP numbering system. &lt;p&gt;*GET Method is limited by URL Length of 2,048 characters. If a large universe of symbols is requested, it&#39;s advised to use POST method to retrieve the same response model.*&lt;/P&gt;
        /// </summary>
        /// <exception cref="FactSet.SDK.Symbology.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Requested market securities or entities. Accepted identifiers include all FactSet Permanent Identifiers types, CUSIP, SEDOL, ISIN, and Tickers. This request value is sent back in the response as, &#x60;requestId&#x60;.</param>
        /// <param name="asOfDate">As-Of date for historical symbol request in YYYY-MM-DD format. (optional)</param>
