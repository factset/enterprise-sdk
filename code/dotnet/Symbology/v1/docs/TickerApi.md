...
# **TickerHistory**
> TickerHistoryTranslationResponse TickerHistory (List<string> ids, string tickerType = null)
...
# **TranslateTicker**
> TickerTranslationResponse TranslateTicker (List<string> ids, string tickerType = null, string asOfDate = null)
