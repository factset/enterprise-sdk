# FactSet.SDK.Symbology.Api.BloombergFIGIApi
...
namespace Example
{
    public class BatchTranslateBloombergExample
    {
...
namespace Example
{
    public class TranslateBloombergExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.Symbology.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling BloombergFIGIApi.TranslateBloomberg: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
