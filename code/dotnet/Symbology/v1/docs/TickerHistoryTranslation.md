# FactSet.SDK.Symbology.Model.TickerHistoryTranslation
...
**Ticker** | **string** | Region or Exchange Ticker | [optional] 
**TickerEffectiveStartDate** | **DateTime** | Ticker effective start date in YYYY-MM-DD format. | [optional] 
