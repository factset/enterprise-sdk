...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cusipTranslationResponse")]
    public partial class CusipTranslationResponse : IEquatable<CusipTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public CusipTranslationResponse(List<CusipTranslation> data = default(List<CusipTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<CusipTranslation> Data { get; set; }
        ...
        {
            return this.Equals(input as CusipTranslationResponse);
        }

        /// <summary>
        /// Returns true if CusipTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CusipTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CusipTranslationResponse input)
        {
            if (input == null)
            {
                return false;
