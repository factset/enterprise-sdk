...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "factsetTranslationAdvancedResponse")]
    public partial class FactsetTranslationAdvancedResponse : IEquatable<FactsetTranslationAdvancedResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FactsetTranslationAdvancedResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public FactsetTranslationAdvancedResponse(List<FactsetTranslationAdvanced> data = default(List<FactsetTranslationAdvanced>))
        {
            this.Data = data;
        }
        ...
        public List<FactsetTranslationAdvanced> Data { get; set; }
        ...
        {
            return this.Equals(input as FactsetTranslationAdvancedResponse);
        }

        /// <summary>
        /// Returns true if FactsetTranslationAdvancedResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FactsetTranslationAdvancedResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FactsetTranslationAdvancedResponse input)
        {
            if (input == null)
                return false;
