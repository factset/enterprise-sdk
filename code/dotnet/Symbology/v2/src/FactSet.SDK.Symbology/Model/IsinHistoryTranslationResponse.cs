...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "isinHistoryTranslationResponse")]
    public partial class IsinHistoryTranslationResponse : IEquatable<IsinHistoryTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsinHistoryTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public IsinHistoryTranslationResponse(List<IsinHistoryTranslation> data = default(List<IsinHistoryTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<IsinHistoryTranslation> Data { get; set; }
        ...
        {
            return this.Equals(input as IsinHistoryTranslationResponse);
        }

        /// <summary>
        /// Returns true if IsinHistoryTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IsinHistoryTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IsinHistoryTranslationResponse input)
        {
            if (input == null)
            {
                return false;
