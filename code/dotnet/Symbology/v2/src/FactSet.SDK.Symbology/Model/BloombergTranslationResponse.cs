...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bloombergTranslationResponse")]
    public partial class BloombergTranslationResponse : IEquatable<BloombergTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BloombergTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public BloombergTranslationResponse(List<BloombergTranslation> data = default(List<BloombergTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<BloombergTranslation> Data { get; set; }
        ...
        {
            return this.Equals(input as BloombergTranslationResponse);
        }

        /// <summary>
        /// Returns true if BloombergTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BloombergTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BloombergTranslationResponse input)
        {
            if (input == null)
            {
                return false;
