...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "factsetTranslationRequest")]
    public partial class FactsetTranslationRequest : IEquatable<FactsetTranslationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FactsetTranslationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FactsetTranslationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FactsetTranslationRequest" /> class.
        /// </summary>
        ...
        public FactsetTranslationRequest(List<string> ids = default(List<string>))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for FactsetTranslationRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FactsetTranslationRequest {\n");
        ...
        {
            return this.Equals(input as FactsetTranslationRequest);
        }

        /// <summary>
        /// Returns true if FactsetTranslationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FactsetTranslationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FactsetTranslationRequest input)
        {
            if (input == null)
            {
                return false;
