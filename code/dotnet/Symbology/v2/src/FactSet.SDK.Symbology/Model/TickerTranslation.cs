...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tickerTranslation")]
    public partial class TickerTranslation : IEquatable<TickerTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TickerTranslation" /> class.
        /// </summary>
        ...
        public TickerTranslation(string fsymId = default(string), string name = default(string), string ticker = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Name = name;
            this.Ticker = ticker;
        ...
        {
            return this.Equals(input as TickerTranslation);
        }

        /// <summary>
        /// Returns true if TickerTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of TickerTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TickerTranslation input)
        {
            if (input == null)
                return false;
