...
namespace FactSet.SDK.Symbology.Model
{
    ...
    public partial class SedolHistoryTranslation : IEquatable<SedolHistoryTranslation>, IValidatableObject
    {
        ...
        public SedolHistoryTranslation(string fsymId = default(string), string name = default(string), string sedol = default(string), DateTime sedolEffectiveStartDate = default(DateTime), DateTime sedolEffectiveEndDate = default(DateTime), DateTime asOfDate = default(DateTime), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Name = name;
            this.Sedol = sedol;
