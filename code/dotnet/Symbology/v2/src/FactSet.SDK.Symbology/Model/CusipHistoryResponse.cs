...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cusipHistoryResponse")]
    public partial class CusipHistoryResponse : IEquatable<CusipHistoryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CusipHistoryResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public CusipHistoryResponse(List<CusipHistoryTranslation> data = default(List<CusipHistoryTranslation>))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as CusipHistoryResponse);
        }

        /// <summary>
        /// Returns true if CusipHistoryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CusipHistoryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CusipHistoryResponse input)
        {
            if (input == null)
            {
                return false;
