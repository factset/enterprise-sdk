...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tickerTranslationResponse")]
    public partial class TickerTranslationResponse : IEquatable<TickerTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TickerTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public TickerTranslationResponse(List<TickerTranslation> data = default(List<TickerTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<TickerTranslation> Data { get; set; }
        ...
        {
            return this.Equals(input as TickerTranslationResponse);
        }

        /// <summary>
        /// Returns true if TickerTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TickerTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TickerTranslationResponse input)
        {
            if (input == null)
            {
                return false;
