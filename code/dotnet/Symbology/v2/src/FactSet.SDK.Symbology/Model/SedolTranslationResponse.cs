...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sedolTranslationResponse")]
    public partial class SedolTranslationResponse : IEquatable<SedolTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedolTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public SedolTranslationResponse(List<SedolTranslation> data = default(List<SedolTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<SedolTranslation> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SedolTranslationResponse {\n");
        ...
        {
            return this.Equals(input as SedolTranslationResponse);
        }

        /// <summary>
        /// Returns true if SedolTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SedolTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SedolTranslationResponse input)
        {
            if (input == null)
            {
                return false;
