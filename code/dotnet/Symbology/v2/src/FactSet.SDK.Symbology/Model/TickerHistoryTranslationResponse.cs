...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tickerHistoryTranslationResponse")]
    public partial class TickerHistoryTranslationResponse : IEquatable<TickerHistoryTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TickerHistoryTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public TickerHistoryTranslationResponse(List<TickerHistoryTranslation> data = default(List<TickerHistoryTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<TickerHistoryTranslation> Data { get; set; }
        ...
        {
            return this.Equals(input as TickerHistoryTranslationResponse);
        }

        /// <summary>
        /// Returns true if TickerHistoryTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TickerHistoryTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TickerHistoryTranslationResponse input)
        {
            if (input == null)
            {
                return false;
