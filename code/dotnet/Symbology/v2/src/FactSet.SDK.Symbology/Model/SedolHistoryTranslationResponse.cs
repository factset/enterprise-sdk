...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sedolHistoryTranslationResponse")]
    public partial class SedolHistoryTranslationResponse : IEquatable<SedolHistoryTranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedolHistoryTranslationResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public SedolHistoryTranslationResponse(List<SedolHistoryTranslation> data = default(List<SedolHistoryTranslation>))
        {
            this.Data = data;
        }
        ...
        public List<SedolHistoryTranslation> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SedolHistoryTranslationResponse {\n");
        ...
        {
            return this.Equals(input as SedolHistoryTranslationResponse);
        }

        /// <summary>
        /// Returns true if SedolHistoryTranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SedolHistoryTranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SedolHistoryTranslationResponse input)
        {
            if (input == null)
            {
                return false;
