...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sedolHistoryTranslationRequest")]
    public partial class SedolHistoryTranslationRequest : IEquatable<SedolHistoryTranslationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedolHistoryTranslationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SedolHistoryTranslationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SedolHistoryTranslationRequest" /> class.
        /// </summary>
        ...
        public SedolHistoryTranslationRequest(List<string> ids = default(List<string>), string asOfDate = default(string))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for SedolHistoryTranslationRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as SedolHistoryTranslationRequest);
        }

        /// <summary>
        /// Returns true if SedolHistoryTranslationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SedolHistoryTranslationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SedolHistoryTranslationRequest input)
        {
            if (input == null)
                return false;
