...
namespace FactSet.SDK.Symbology.Api
{
    ...
    public partial class SEDOLApi : ISEDOLApi
    {
        ...
        public FactSet.SDK.Symbology.Client.ApiResponse<SedolHistoryTranslationResponse> BatchSedolHistoryWithHttpInfo(SedolHistoryTranslationRequest sedolHistoryTranslationRequest)
        {
            ...
            var localVarResponse = this.Client.Post<SedolHistoryTranslationResponse>("/symbology/v2/sedol-history", localVarRequestOptions, this.Configuration);
        ...
        public FactSet.SDK.Symbology.Client.ApiResponse<SedolTranslationResponse> BatchTranslateSedolWithHttpInfo(SedolTranslationRequest sedolTranslationRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<SedolTranslationResponse>("/symbology/v2/sedol", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.Symbology.Client.ApiResponse<SedolHistoryTranslationResponse> localVarResponse = SedolHistoryWithHttpInfo(ids, asOfDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="asOfDate">As-Of date for historical symbol request in YYYY-MM-DD format. This is the date requested in the service. If no asOfDate was requested, the response will be null. (optional)</param>
        /// <returns>ApiResponse of SedolHistoryTranslationResponse</returns>
        public FactSet.SDK.Symbology.Client.ApiResponse<SedolHistoryTranslationResponse> SedolHistoryWithHttpInfo(List<string> ids, string asOfDate = default(string))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SedolHistoryTranslationResponse>("/symbology/v2/sedol-history", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.Symbology.Client.ApiResponse<SedolHistoryTranslationResponse> localVarResponse = await SedolHistoryWithHttpInfoAsync(ids, asOfDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SedolHistoryTranslationResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Symbology.Client.ApiResponse<SedolHistoryTranslationResponse>> SedolHistoryWithHttpInfoAsync(List<string> ids, string asOfDate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new FactSet.SDK.Symbology.Client.ApiException(400, "Missing required parameter 'ids' when calling SEDOLApi->SedolHistory");
        ...
        {
            FactSet.SDK.Symbology.Client.ApiResponse<SedolTranslationResponse> localVarResponse = TranslateSedolWithHttpInfo(ids);
            return localVarResponse.Data;
        }
        ...
        /// <param name="ids">Requested market securities or entities. Accepted identifiers include all FactSet Permanent Identifiers types, CUSIP, SEDOL, ISIN, and Tickers. This request value is sent back in the response as, &#x60;requestId&#39;. &lt;p&gt;***ids limit** &#x3D;  3000 per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;*</param>
        /// <returns>ApiResponse of SedolTranslationResponse</returns>
        public FactSet.SDK.Symbology.Client.ApiResponse<SedolTranslationResponse> TranslateSedolWithHttpInfo(List<string> ids)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SedolTranslationResponse>("/symbology/v2/sedol", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.Symbology.Client.ApiResponse<SedolTranslationResponse> localVarResponse = await TranslateSedolWithHttpInfoAsync(ids, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SedolTranslationResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Symbology.Client.ApiResponse<SedolTranslationResponse>> TranslateSedolWithHttpInfoAsync(List<string> ids, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new FactSet.SDK.Symbology.Client.ApiException(400, "Missing required parameter 'ids' when calling SEDOLApi->TranslateSedol");
