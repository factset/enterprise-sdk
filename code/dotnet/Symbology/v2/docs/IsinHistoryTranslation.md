# FactSet.SDK.Symbology.Model.IsinHistoryTranslation
...
**IsinEffectiveStartDate** | **DateTime** | ISIN effective start date in YYYY-MM-DD format. | [optional] 
**IsinEffectiveEndDate** | **DateTime** | ISIN effective end date in YYYY-MM-DD format. Null if still active. | [optional] 
**AsOfDate** | **DateTime** | As of Date in YYYY-MM-DD format. | [optional] 
