...
namespace Example
{
    public class BatchCusipHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CUSIPApi.BatchCusipHistory: " + e.Message );
...
namespace Example
{
    public class BatchTranslateCusipsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CUSIPApi.BatchTranslateCusips: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class CusipHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CUSIPApi.CusipHistory: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class TranslateCusipExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CUSIPApi.TranslateCusip: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
