...
namespace Example
{
    public class BatchSedolHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SEDOLApi.BatchSedolHistory: " + e.Message );
...
namespace Example
{
    public class BatchTranslateSedolExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SEDOLApi.BatchTranslateSedol: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class SedolHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SEDOLApi.SedolHistory: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class TranslateSedolExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SEDOLApi.TranslateSedol: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
