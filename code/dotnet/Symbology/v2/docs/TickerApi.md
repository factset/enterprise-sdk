...
namespace Example
{
    public class BatchTickerHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling TickerApi.BatchTickerHistory: " + e.Message );
...
namespace Example
{
    public class BatchTranslateTickerExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling TickerApi.BatchTranslateTicker: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class TickerHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling TickerApi.TickerHistory: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class TranslateTickerExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling TickerApi.TranslateTicker: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
