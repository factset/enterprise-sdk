...
namespace FactSet.SDK.Symbology.Model
{
    ...
    /// </summary>
    [DataContract(Name = "identifierResolutionResponse")]
    public partial class IdentifierResolutionResponse : IEquatable<IdentifierResolutionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentifierResolutionResponse" /> class.
        /// </summary>
        /// <param name="data">Array of symbol translation objects..</param>
        public IdentifierResolutionResponse(List<IdentifierResolution> data = default(List<IdentifierResolution>))
        {
            this.Data = data;
        }
        ...
        public List<IdentifierResolution> Data { get; set; }
        ...
        {
            return this.Equals(input as IdentifierResolutionResponse);
        }

        /// <summary>
        /// Returns true if IdentifierResolutionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentifierResolutionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentifierResolutionResponse input)
        {
            if (input == null)
            {
                return false;
