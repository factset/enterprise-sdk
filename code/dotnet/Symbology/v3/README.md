...
[![Nuget](https://img.shields.io/badge/nuget-v5.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.Symbology/5.0.0)
...
dotnet add package FactSet.SDK.Symbology -v 5.0.0
```
...
nuget install FactSet.SDK.Symbology -Version 5.0.0
```
