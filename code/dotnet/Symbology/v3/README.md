...
------------ | ------------- | ------------- | -------------
*IdentifierResolutionApi* | [**BatchIdentifierResolution**](docs/IdentifierResolutionApi.md#batchidentifierresolution) | **POST** /symbology/v3/identifier-resolution | Returns the specified output identifiers for the specified input identifier.
...
## Documentation for Models
 ...
 - [Model.GetInputSymbolType](docs/GetInputSymbolType.md)
 - [Model.IdentifierResolution](docs/IdentifierResolution.md)
 - [Model.IdentifierResolutionRequest](docs/IdentifierResolutionRequest.md)
 - [Model.IdentifierResolutionResponse](docs/IdentifierResolutionResponse.md)
