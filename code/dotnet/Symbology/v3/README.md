...
[![Nuget](https://img.shields.io/badge/nuget-v5.0.1-orange)](https://www.nuget.org/packages/FactSet.SDK.Symbology/5.0.1)
...
dotnet add package FactSet.SDK.Symbology -v 5.0.1
```
...
nuget install FactSet.SDK.Symbology -Version 5.0.1
```
