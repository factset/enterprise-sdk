...
<a name="deletemodelaccountbydate"></a>
# **DeleteModelAccountByDate**
> void DeleteModelAccountByDate (string name, string date, List<string> symbols = null)
...
namespace Example
{
    public class DeleteModelAccountByDateExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.Portfolio.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling ModelAccountsApi.DeleteModelAccountByDate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
 ...
 **symbols** | [**List&lt;string&gt;**](string.md)| The symbols from the given file name and date to delete (Maximum 10 symbols are allowed) | [optional] 
...
<a name="deletemodelaccountbysymbol"></a>
# **DeleteModelAccountBySymbol**
> void DeleteModelAccountBySymbol (string name, string symbol, List<string> dates = null)
...
namespace Example
{
    public class DeleteModelAccountBySymbolExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.Portfolio.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling ModelAccountsApi.DeleteModelAccountBySymbol: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
 ...
 **dates** | [**List&lt;string&gt;**](string.md)| The dates from the given file name and symbol to delete (Maximum 10 dates are allowed) | [optional] 
...
<a name="getaccount"></a>
# **GetAccount**
> DataAndMetaModel GetAccount (string name, string format = null)
...
namespace Example
{
    public class GetAccountExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ModelAccountsApi.GetAccount: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
# **GetAccountForDate**
> DataAndMetaModel GetAccountForDate (string name, string date, string format = null)
...
> DataAndMetaModel GetAccountForDateAndSymbol (string name, string symbol, string date, string format = null)
...
# **GetAccountForSymbol**
> DataAndMetaModel GetAccountForSymbol (string name, string symbol, string format = null)
