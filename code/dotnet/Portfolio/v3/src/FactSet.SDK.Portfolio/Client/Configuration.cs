...
namespace FactSet.SDK.Portfolio.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/Portfolio/1.0.0";
            BasePath = "https://api.factset.com/analytics/accounts/v3";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/accounts/v3") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.Portfolio) Debug Report:\n";
