...
dotnet add package FactSet.SDK.ExchangeDataFeedSnapshotAPISymbolList -v 0.21.8
```
...
nuget install FactSet.SDK.ExchangeDataFeedSnapshotAPISymbolList -Version 0.21.8
```
