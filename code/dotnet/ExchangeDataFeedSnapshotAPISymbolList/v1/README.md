...
dotnet add package FactSet.SDK.ExchangeDataFeedSnapshotAPISymbolList -v 0.21.10
```
...
nuget install FactSet.SDK.ExchangeDataFeedSnapshotAPISymbolList -Version 0.21.10
```
...
------------ | ------------- | ------------- | -------------
*SnapshotApi* | [**GetDFSnapshot**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/SnapshotApi.md#getdfsnapshot) | **GET** /DFSnapshot | Request a snapshot of exchange data for a list of symbols.
*SnapshotApi* | [**PostDFSnapshot**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/SnapshotApi.md#postdfsnapshot) | **POST** /DFSnapshot | Snap exchange data. Use if URL lengh of 2,048 is exceeded.


## Documentation for Models

 - [Model.DFSnapshotResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/DFSnapshotResponse.md)
 - [Model.ErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/ErrorResponse.md)
 - [Model.ErrorResponseSubErrors](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/ErrorResponseSubErrors.md)
 - [Model.Fields](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/Fields.md)
 - [Model.Specialfield](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/ExchangeDataFeedSnapshotAPISymbolList/v1/docs/Specialfield.md)
