...
namespace FactSet.SDK.IDLookup.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/IDLookup/0.10.0";
            BasePath = "https://api.factset.com/idsearch/v2";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/idsearch/v2"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/idsearch/v2") : this()
        {
