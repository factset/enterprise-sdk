...
namespace FactSet.SDK.IDLookup.Model
{
    ...
    public partial class LookupResponse : IEquatable<LookupResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="LookupResponse" /> class.
        /// </summary>
        /// <param name="data">Array of Lookup details for the query (required).</param>
        /// <param name="meta">meta.</param>
        public LookupResponse(List<ResponseDetails> data,LookupResponseMeta meta = default(LookupResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for LookupResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public LookupResponseMeta Meta { get; set; }
