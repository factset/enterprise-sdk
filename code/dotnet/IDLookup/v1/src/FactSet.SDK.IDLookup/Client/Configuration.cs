...
namespace FactSet.SDK.IDLookup.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/IDLookup/0.21.5";
            BasePath = "https://api.factset.com/idsearch";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/idsearch") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.IDLookup) Debug Report:\n";
