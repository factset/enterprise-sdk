...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// </summary>
    [DataContract(Name = "newsrequestfilesResponse")]
    public partial class NewsrequestfilesResponse : IEquatable<NewsrequestfilesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsrequestfilesResponse" /> class.
        /// </summary>
        /// <param name="jobID">Unique id to get the xml files for the requested date.</param>
        /// <param name="status">Returns the value as submitted. Tells the request has been submitted.</param>
        public NewsrequestfilesResponse(string jobID = default(string), string status = default(string))
        {
            this.JobID = jobID;
            this.Status = status;
        }
        ...
        /// </summary>
        /// <value>Returns the value as submitted. Tells the request has been submitted</value>
        ...
        {
            return this.Equals(input as NewsrequestfilesResponse);
        }

        /// <summary>
        /// Returns true if NewsrequestfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsrequestfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsrequestfilesResponse input)
        {
            if (input == null)
            {
                return false;
