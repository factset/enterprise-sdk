...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// </summary>
    [DataContract(Name = "newsgetfilesResponse")]
    public partial class NewsgetfilesResponse : IEquatable<NewsgetfilesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsgetfilesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public NewsgetfilesResponse(List<Getfilesone> data = default(List<Getfilesone>), MetaOne meta = default(MetaOne))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<Getfilesone> Data { get; set; }
        ...
        {
            return this.Equals(input as NewsgetfilesResponse);
        }

        /// <summary>
        /// Returns true if NewsgetfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsgetfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsgetfilesResponse input)
        {
            if (input == null)
            {
                return false;
