...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    public partial class GetResponse : IEquatable<GetResponse>, IValidatableObject
    {
        ...
        public GetResponse(string product = default(string), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string jobID = default(string), string status = default(string), string url = default(string), int part = default(int))
        {
