...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// Getfilesone
    /// </summary>
    [DataContract(Name = "getfilesone")]
    public partial class Getfilesone : IEquatable<Getfilesone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Getfilesone" /> class.
        /// </summary>
        ...
        public Getfilesone(string product = default(string), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string jobID = default(string), string status = default(string), string url = default(string), int part = default(int))
        {
        ...
        {
            return this.Equals(input as Getfilesone);
        }

        /// <summary>
        /// Returns true if Getfilesone instances are equal
        /// </summary>
        /// <param name="input">Instance of Getfilesone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Getfilesone input)
        {
            if (input == null)
            {
                return false;
