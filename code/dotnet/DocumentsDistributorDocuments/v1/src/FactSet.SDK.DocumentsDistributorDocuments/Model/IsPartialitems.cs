...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// </summary>
    [DataContract(Name = "isPartialitems")]
    public partial class IsPartialitems : IEquatable<IsPartialitems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsPartialitems" /> class.
        /// </summary>
        /// <param name="isPartial">isPartial.</param>
        public IsPartialitems(bool isPartial = default(bool))
        {
        ...
        {
            return this.Equals(input as IsPartialitems);
        }

        /// <summary>
        /// Returns true if IsPartialitems instances are equal
        /// </summary>
        /// <param name="input">Instance of IsPartialitems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IsPartialitems input)
        {
            if (input == null)
                return false;
