...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    public partial class Checkstatus : IEquatable<Checkstatus>, IValidatableObject
    {
        ...
        public Checkstatus(string jobID = default(string), string status = default(string), int percentDone = default(int), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), int part = default(int))
        {
            this.JobID = jobID;
            this.Status = status;
