...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// </summary>
    [DataContract(Name = "newscheckstatusResponse")]
    public partial class NewscheckstatusResponse : IEquatable<NewscheckstatusResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewscheckstatusResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public NewscheckstatusResponse(List<Checkstatusone> data = default(List<Checkstatusone>), MetaOne meta = default(MetaOne))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<Checkstatusone> Data { get; set; }
        ...
        {
            return this.Equals(input as NewscheckstatusResponse);
        }

        /// <summary>
        /// Returns true if NewscheckstatusResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NewscheckstatusResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewscheckstatusResponse input)
        {
            if (input == null)
            {
                return false;
