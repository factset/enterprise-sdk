...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// FilingsFiles
    /// </summary>
    [DataContract(Name = "filingsFiles")]
    public partial class FilingsFiles : IEquatable<FilingsFiles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilingsFiles" /> class.
        /// </summary>
        /// <param name="filePath">path of the filings document..</param>
        /// <param name="fileUrl">Download link for the filings document..</param>
        public FilingsFiles(string filePath = default(string), string fileUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>path of the filings document.</value>
        ...
        {
            return this.Equals(input as FilingsFiles);
        }

        /// <summary>
        /// Returns true if FilingsFiles instances are equal
        /// </summary>
        /// <param name="input">Instance of FilingsFiles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilingsFiles input)
        {
            if (input == null)
            {
                return false;
