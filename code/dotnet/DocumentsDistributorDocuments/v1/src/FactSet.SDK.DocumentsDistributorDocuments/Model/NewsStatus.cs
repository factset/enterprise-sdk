...
namespace FactSet.SDK.DocumentsDistributorDocuments.Model
{
    ...
    /// NewsStatus
    /// </summary>
    [DataContract(Name = "newsStatus")]
    public partial class NewsStatus : IEquatable<NewsStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsStatus" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="errorMessage">Textual error message.</param>
        public NewsStatus(string id = default(string), string errorMessage = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as NewsStatus);
        }

        /// <summary>
        /// Returns true if NewsStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsStatus input)
        {
            if (input == null)
            {
                return false;
