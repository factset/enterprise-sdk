...
namespace FactSet.SDK.DocumentsDistributorDocuments.Api
{
    ...
    public partial class StreetAccountXMLAPIApi : IStreetAccountXMLAPIApi
    {
        ...
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<CheckstatusResponse> localVarResponse = AsynchStreetaccountV1CheckStatusGetWithHttpInfo(jobID);
        ...
        /// <param name="jobID">jobID returned by the request-files endpoint to know the status and percentDone</param>
        /// <returns>ApiResponse of CheckstatusResponse</returns>
        public FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<CheckstatusResponse> AsynchStreetaccountV1CheckStatusGetWithHttpInfo(string jobID)
        {
            ...
            var localVarResponse = this.Client.Get<CheckstatusResponse>("/asynch/streetaccount/v1/check-status", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<CheckstatusResponse> localVarResponse = await AsynchStreetaccountV1CheckStatusGetWithHttpInfoAsync(jobID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CheckstatusResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<CheckstatusResponse>> AsynchStreetaccountV1CheckStatusGetWithHttpInfoAsync(string jobID, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'jobID' is set
            if (jobID == null)
                throw new FactSet.SDK.DocumentsDistributorDocuments.Client.ApiException(400, "Missing required parameter 'jobID' when calling StreetAccountXMLAPIApi->AsynchStreetaccountV1CheckStatusGet");
        ...
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<GetfilesResponse> localVarResponse = AsynchStreetaccountV1GetFilesGetWithHttpInfo(jobID);
            return localVarResponse.Data;
        }
        ...
        /// <param name="jobID">jobID returned by the request-files endpoint to collect the results of the query</param>
        /// <returns>ApiResponse of GetfilesResponse</returns>
        public FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<GetfilesResponse> AsynchStreetaccountV1GetFilesGetWithHttpInfo(string jobID)
        {
            // verify the required parameter 'jobID' is set
            if (jobID == null)
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetfilesResponse>("/asynch/streetaccount/v1/get-files", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<GetfilesResponse> localVarResponse = await AsynchStreetaccountV1GetFilesGetWithHttpInfoAsync(jobID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetfilesResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<GetfilesResponse>> AsynchStreetaccountV1GetFilesGetWithHttpInfoAsync(string jobID, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'jobID' is set
            if (jobID == null)
                throw new FactSet.SDK.DocumentsDistributorDocuments.Client.ApiException(400, "Missing required parameter 'jobID' when calling StreetAccountXMLAPIApi->AsynchStreetaccountV1GetFilesGet");
        ...
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<RequestfilesResponse> localVarResponse = AsynchStreetaccountV1RequestFilesGetWithHttpInfo(startDate, endDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">The date until which the data is to be fetched. Should be YYYY-MM-DDTHH:MM:SSZ format</param>
        /// <returns>ApiResponse of RequestfilesResponse</returns>
        public FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<RequestfilesResponse> AsynchStreetaccountV1RequestFilesGetWithHttpInfo(DateTime startDate, DateTime endDate)
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.DocumentsDistributorDocuments.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<RequestfilesResponse>("/asynch/streetaccount/v1/request-files", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<RequestfilesResponse> localVarResponse = await AsynchStreetaccountV1RequestFilesGetWithHttpInfoAsync(startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RequestfilesResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.DocumentsDistributorDocuments.Client.ApiResponse<RequestfilesResponse>> AsynchStreetaccountV1RequestFilesGetWithHttpInfoAsync(DateTime startDate, DateTime endDate, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
