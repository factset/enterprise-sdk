...
namespace FactSet.SDK.DocumentsDistributorDocuments.Api
{
    ...
    public interface INewsAPIApiSync : IApiAccessor
    {
        ...
        /// <param name="source">This parameter filters the results based on the document source.</param>
    ...
    public partial class NewsAPIApi : INewsAPIApi
    {
        ...
        /// <summary>
        /// Returns the jobID Give the startDate,endDate and source parameters as request parameters in the /request-files endpoint, it returns the jobID. startDate and endDate should be in YYYY-MM-DDTHH:MM:SSZ format.  This API only supports adhoc requests to retrieve historical files. &lt;p&gt;MT Newswire has two different products that enables 1 year of rolling history and 5 years of rolling history.&lt;/p&gt;
        /// </summary>
        /// <exception cref="FactSet.SDK.DocumentsDistributorDocuments.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="startDate">Date from which data is required. Should be YYYY-MM-DDTHH:MM:SSZ format</param>
        /// <param name="endDate">The date until which the data is to be fetched. Should be YYYY-MM-DDTHH:MM:SSZ format</param>
