...
namespace FactSet.SDK.RealTimeQuotes.Api
{
    ...
    public partial class BasicApi : IBasicApi
    {
        ...
        /// <returns></returns>
        public BasicApi(FactSet.SDK.RealTimeQuotes.Client.Configuration configuration)
        {
        ...
        public BasicApi(FactSet.SDK.RealTimeQuotes.Client.ISynchronousClient client, FactSet.SDK.RealTimeQuotes.Client.IAsynchronousClient asyncClient, FactSet.SDK.RealTimeQuotes.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<InlineResponse2006> GetBasicLanguageGetByCodeWithHttpInfo(string code, List<string> attributes = default(List<string>), string language = default(string))
        {
            ...
            if (code == null)
            {
                throw new FactSet.SDK.RealTimeQuotes.Client.ApiException(400, "Missing required parameter 'code' when calling BasicApi->GetBasicLanguageGetByCode");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("", "code", code));
            if (attributes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "_attributes", attributes));
            }
        ...
        public ApiResponse<InlineResponse2007> GetBasicLanguageListWithHttpInfo(List<string> attributes = default(List<string>), string language = default(string), List<string> sort = default(List<string>))
        {
            ...
            if (sort != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "_sort", sort));
            }
        ...
        public ApiResponse<InlineResponse20020> GetBasicRegionCountryGetByCodeWithHttpInfo(string code, List<string> attributes = default(List<string>), string language = default(string))
        {
            ...
            if (code == null)
            {
                throw new FactSet.SDK.RealTimeQuotes.Client.ApiException(400, "Missing required parameter 'code' when calling BasicApi->GetBasicRegionCountryGetByCode");
            }
        ...
        public ApiResponse<InlineResponse20022> GetBasicTimezoneGetByNameWithHttpInfo(string name, List<string> attributes = default(List<string>))
        {
            ...
            if (name == null)
            {
                throw new FactSet.SDK.RealTimeQuotes.Client.ApiException(400, "Missing required parameter 'name' when calling BasicApi->GetBasicTimezoneGetByName");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("", "name", name));
            if (attributes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "_attributes", attributes));
            }
