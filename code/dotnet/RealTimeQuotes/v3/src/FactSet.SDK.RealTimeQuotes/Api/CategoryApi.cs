...
namespace FactSet.SDK.RealTimeQuotes.Api
{
    ...
    public partial class CategoryApi : ICategoryApi
    {
        ...
        /// <returns></returns>
        public CategoryApi(FactSet.SDK.RealTimeQuotes.Client.Configuration configuration)
        {
        ...
        public CategoryApi(FactSet.SDK.RealTimeQuotes.Client.ISynchronousClient client, FactSet.SDK.RealTimeQuotes.Client.IAsynchronousClient asyncClient, FactSet.SDK.RealTimeQuotes.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<InlineResponse20036> GetCategoryInstrumentListWithHttpInfo(decimal idCategory, decimal idCategoryDataset, List<string> attributes = default(List<string>), decimal? paginationOffset = default(decimal?), decimal? paginationLimit = default(decimal?))
        {
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("", "idCategory", idCategory));
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("", "idCategoryDataset", idCategoryDataset));
            if (attributes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "_attributes", attributes));
            }
        ...
        public ApiResponse<InlineResponse20032> GetCategoryListWithHttpInfo(List<decimal> ids, List<string> attributes = default(List<string>), string language = default(string))
        {
            ...
            if (ids == null)
            {
                throw new FactSet.SDK.RealTimeQuotes.Client.ApiException(400, "Missing required parameter 'ids' when calling CategoryApi->GetCategoryList");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "ids", ids));
            if (attributes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "_attributes", attributes));
            }
        ...
        public ApiResponse<InlineResponse20040> GetCategorySystemListWithHttpInfo(decimal? idType = default(decimal?), List<string> attributes = default(List<string>), string language = default(string))
        {
            ...
            if (idType != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("", "idType", idType));
            }
            if (attributes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.RealTimeQuotes.Client.ClientUtils.ParameterToMultiMap("csv", "_attributes", attributes));
