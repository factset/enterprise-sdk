...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// Identifier and type.
    /// </summary>
    [DataContract(Name = "PostInstrumentBenchmarkListRequest_data_identifier")]
    public partial class PostInstrumentBenchmarkListRequestDataIdentifier : IEquatable<PostInstrumentBenchmarkListRequestDataIdentifier>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInstrumentBenchmarkListRequestDataIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostInstrumentBenchmarkListRequestDataIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInstrumentBenchmarkListRequestDataIdentifier" /> class.
        /// </summary>
        /// <param name="value">Identifier to resolve. (required).</param>
        /// <param name="type">Type of the identifier. (required).</param>
        public PostInstrumentBenchmarkListRequestDataIdentifier(string value, TypeEnum type)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for PostInstrumentBenchmarkListRequestDataIdentifier and cannot be null");
            }
            this.Value = value;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as PostInstrumentBenchmarkListRequestDataIdentifier);
        }

        /// <summary>
        /// Returns true if PostInstrumentBenchmarkListRequestDataIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInstrumentBenchmarkListRequestDataIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInstrumentBenchmarkListRequestDataIdentifier input)
        {
            if (input == null)
            {
                return false;
