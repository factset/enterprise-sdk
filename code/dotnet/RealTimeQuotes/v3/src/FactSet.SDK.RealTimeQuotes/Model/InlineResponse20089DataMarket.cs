...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_market")]
    public partial class InlineResponse20089DataMarket : IEquatable<InlineResponse20089DataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataMarket" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataMarket(decimal? id = default(decimal?), bool? isOpen = default(bool?), string phase = default(string))
        {
            this.Id = id;
            this.IsOpen = isOpen;
            this.Phase = phase;
        ...
        {
            return this.Equals(input as InlineResponse20089DataMarket);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataMarket input)
        {
            if (input == null)
            {
                return false;
