...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_latest")]
    public partial class InlineResponse20090Latest : IEquatable<InlineResponse20090Latest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090Latest" /> class.
        /// </summary>
        ...
        public InlineResponse20090Latest(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), InlineResponse20090LatestPerformance performance = default(InlineResponse20090LatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20090LatestPerformance Performance { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20090Latest {\n");
        ...
        {
            return this.Equals(input as InlineResponse20090Latest);
        }

        /// <summary>
        /// Returns true if InlineResponse20090Latest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090Latest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090Latest input)
        {
            if (input == null)
            {
                return false;
