...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_low")]
    public partial class InlineResponse20090Low : IEquatable<InlineResponse20090Low>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090Low" /> class.
        /// </summary>
        ...
        public InlineResponse20090Low(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20090Low);
        }

        /// <summary>
        /// Returns true if InlineResponse20090Low instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090Low to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090Low input)
        {
            if (input == null)
            {
                return false;
