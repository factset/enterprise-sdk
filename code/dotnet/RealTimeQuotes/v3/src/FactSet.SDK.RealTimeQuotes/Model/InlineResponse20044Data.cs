...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20044Data : IEquatable<InlineResponse20044Data>, IValidatableObject
    {
        ...
        /// <param name="texts">Background texts of the instrument..</param>
        public InlineResponse20044Data(string idInstrument = default(string), string sourceIdentifier = default(string), List<InlineResponse20044DataTexts> texts = default(List<InlineResponse20044DataTexts>))
        {
        ...
        /// </summary>
        /// <value>Background texts of the instrument.</value>
        [DataMember(Name = "texts", EmitDefaultValue = false)]
        public List<InlineResponse20044DataTexts> Texts { get; set; }
