...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_80_data_tradingVolume")]
    public partial class InlineResponse20080DataTradingVolume : IEquatable<InlineResponse20080DataTradingVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20080DataTradingVolume" /> class.
        /// </summary>
        ...
        public InlineResponse20080DataTradingVolume(decimal? average = default(decimal?), decimal? sum = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20080DataTradingVolume {\n");
        ...
        {
            return this.Equals(input as InlineResponse20080DataTradingVolume);
        }

        /// <summary>
        /// Returns true if InlineResponse20080DataTradingVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20080DataTradingVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20080DataTradingVolume input)
        {
            if (input == null)
            {
                return false;
