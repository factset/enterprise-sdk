...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostInstrumentCategoryListRequest_meta")]
    public partial class PostInstrumentCategoryListRequestMeta : IEquatable<PostInstrumentCategoryListRequestMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum DatasetsDatasetId for value: datasets.dataset.id
            /// </summary>
            [EnumMember(Value = "datasets.dataset.id")]
            DatasetsDatasetId = 1,

            /// <summary>
            /// Enum MINUS_DatasetsDatasetId for value: -datasets.dataset.id
            /// </summary>
            [EnumMember(Value = "-datasets.dataset.id")]
            MINUS_DatasetsDatasetId = 2,

            /// <summary>
            /// Enum DatasetsDatasetName for value: datasets.dataset.name
            /// </summary>
            [EnumMember(Value = "datasets.dataset.name")]
            DatasetsDatasetName = 3,

            /// <summary>
            /// Enum MINUS_DatasetsDatasetName for value: -datasets.dataset.name
            /// </summary>
            [EnumMember(Value = "-datasets.dataset.name")]
            MINUS_DatasetsDatasetName = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInstrumentCategoryListRequestMeta" /> class.
        /// </summary>
        ...
        public PostInstrumentCategoryListRequestMeta(HashSet<string> attributes = default(HashSet<string>), string language = default(string), HashSet<SortEnum> sort = default(HashSet<SortEnum>))
        {
        ...
        {
            return this.Equals(input as PostInstrumentCategoryListRequestMeta);
        }

        /// <summary>
        /// Returns true if PostInstrumentCategoryListRequestMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInstrumentCategoryListRequestMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInstrumentCategoryListRequestMeta input)
        {
            if (input == null)
            {
                return false;
