...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_accumulated")]
    public partial class InlineResponse20089DataAccumulated : IEquatable<InlineResponse20089DataAccumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataAccumulated" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataAccumulated(decimal? numberTrades = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), decimal? volumeWeightedAveragePrice = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20089DataAccumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataAccumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataAccumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataAccumulated input)
        {
            if (input == null)
            {
                return false;
