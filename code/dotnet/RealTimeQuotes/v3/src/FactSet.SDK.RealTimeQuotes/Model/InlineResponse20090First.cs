...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_first")]
    public partial class InlineResponse20090First : IEquatable<InlineResponse20090First>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090First" /> class.
        /// </summary>
        ...
        public InlineResponse20090First(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20090First);
        }

        /// <summary>
        /// Returns true if InlineResponse20090First instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090First to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090First input)
        {
            if (input == null)
            {
                return false;
