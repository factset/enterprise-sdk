...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_latest_performance_intraday")]
    public partial class InlineResponse20090LatestPerformanceIntraday : IEquatable<InlineResponse20090LatestPerformanceIntraday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090LatestPerformanceIntraday" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;valueUnit&#x60; for its unit..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse20090LatestPerformanceIntraday(decimal? absolute = default(decimal?), decimal? relative = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20090LatestPerformanceIntraday);
        }

        /// <summary>
        /// Returns true if InlineResponse20090LatestPerformanceIntraday instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090LatestPerformanceIntraday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090LatestPerformanceIntraday input)
        {
            if (input == null)
            {
                return false;
