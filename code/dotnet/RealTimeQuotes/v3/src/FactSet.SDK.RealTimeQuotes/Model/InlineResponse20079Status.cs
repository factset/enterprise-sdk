...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_79_status")]
    public partial class InlineResponse20079Status : IEquatable<InlineResponse20079Status>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20079Status" /> class.
        /// </summary>
        ...
        public InlineResponse20079Status(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20079Status);
        }

        /// <summary>
        /// Returns true if InlineResponse20079Status instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20079Status to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20079Status input)
        {
            if (input == null)
            {
                return false;
