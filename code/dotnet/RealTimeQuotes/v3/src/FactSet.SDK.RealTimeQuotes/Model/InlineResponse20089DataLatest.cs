...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_latest")]
    public partial class InlineResponse20089DataLatest : IEquatable<InlineResponse20089DataLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataLatest" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataLatest(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), InlineResponse20089DataLatestPerformance performance = default(InlineResponse20089DataLatestPerformance))
        {
            this.Time = time;
            this.Price = price;
        ...
        public InlineResponse20089DataLatestPerformance Performance { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20089DataLatest);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataLatest input)
        {
            if (input == null)
            {
                return false;
