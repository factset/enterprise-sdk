...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse2009Data : IEquatable<InlineResponse2009Data>, IValidatableObject
    {
        ...
        public InlineResponse2009Data(decimal? id = default(decimal?), string name = default(string), string shortName = default(string), bool? active = default(bool?), InlineResponse2009Country country = default(InlineResponse2009Country), InlineResponse2009Type type = default(InlineResponse2009Type), InlineResponse2009Group group = default(InlineResponse2009Group), InlineResponse2008DataTimezone timezone = default(InlineResponse2008DataTimezone))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse2009Country Country { get; set; }

        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        [DataMember(Name = "type", EmitDefaultValue = false)]
        public InlineResponse2009Type Type { get; set; }

        /// <summary>
        /// Gets or Sets Group
        /// </summary>
        [DataMember(Name = "group", EmitDefaultValue = false)]
        public InlineResponse2009Group Group { get; set; }
