...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_92_bid")]
    public partial class InlineResponse20092Bid : IEquatable<InlineResponse20092Bid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20092Bid" /> class.
        /// </summary>
        ...
        public InlineResponse20092Bid(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20092Bid);
        }

        /// <summary>
        /// Returns true if InlineResponse20092Bid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20092Bid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20092Bid input)
        {
            if (input == null)
            {
                return false;
