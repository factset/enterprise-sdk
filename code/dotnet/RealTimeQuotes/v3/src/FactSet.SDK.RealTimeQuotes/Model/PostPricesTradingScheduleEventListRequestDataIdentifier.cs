...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// Identifier and type.
    /// </summary>
    [DataContract(Name = "PostPricesTradingScheduleEventListRequest_data_identifier")]
    public partial class PostPricesTradingScheduleEventListRequestDataIdentifier : IEquatable<PostPricesTradingScheduleEventListRequestDataIdentifier>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTradingScheduleEventListRequestDataIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostPricesTradingScheduleEventListRequestDataIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTradingScheduleEventListRequestDataIdentifier" /> class.
        /// </summary>
        /// <param name="value">Identifier to resolve. (required).</param>
        /// <param name="type">Type of the identifier. (required).</param>
        public PostPricesTradingScheduleEventListRequestDataIdentifier(string value, TypeEnum type)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for PostPricesTradingScheduleEventListRequestDataIdentifier and cannot be null");
            }
            this.Value = value;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as PostPricesTradingScheduleEventListRequestDataIdentifier);
        }

        /// <summary>
        /// Returns true if PostPricesTradingScheduleEventListRequestDataIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTradingScheduleEventListRequestDataIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTradingScheduleEventListRequestDataIdentifier input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            Regex regexValue = new Regex(@"^[B-DF-HJ-NP-TV-Z0-9]{6}-[LR]$|^[A-Z0-9.#&*+]{1,47}-[A-Z0-9]{2,4}$|^[0-9]{3,20}$", RegexOptions.CultureInvariant);
