...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_low")]
    public partial class InlineResponse20089DataLow : IEquatable<InlineResponse20089DataLow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataLow" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataLow(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20089DataLow);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataLow instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataLow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataLow input)
        {
            if (input == null)
            {
                return false;
