...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20075Data : IEquatable<InlineResponse20075Data>, IValidatableObject
    {
        ...
        public InlineResponse20075Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse20075DataInstrument instrument = default(InlineResponse20075DataInstrument), string permanentIdentifier = default(string), InlineResponse20075DataRegional regional = default(InlineResponse20075DataRegional))
        {
        ...
        public InlineResponse20075DataInstrument Instrument { get; set; }
        ...
        public InlineResponse20075DataRegional Regional { get; set; }
