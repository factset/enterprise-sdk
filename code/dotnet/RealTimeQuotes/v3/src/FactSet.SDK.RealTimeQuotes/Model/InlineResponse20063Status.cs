...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20063Status : IEquatable<InlineResponse20063Status>, IValidatableObject
    {
        ...
        public InlineResponse20063Status(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
