...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_volume")]
    public partial class InlineResponse20084DataVolume : IEquatable<InlineResponse20084DataVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataVolume" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataVolume(decimal? days5 = default(decimal?), decimal? days30 = default(decimal?), decimal? days50 = default(decimal?), decimal? days100 = default(decimal?), decimal? days200 = default(decimal?), decimal? days250 = default(decimal?))
        {
            this.Days5 = days5;
            this.Days30 = days30;
            this.Days50 = days50;
        ...
        {
            return this.Equals(input as InlineResponse20084DataVolume);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataVolume input)
        {
            if (input == null)
            {
                return false;
