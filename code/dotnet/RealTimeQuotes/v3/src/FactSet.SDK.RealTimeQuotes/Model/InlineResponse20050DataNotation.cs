...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20050DataNotation : IEquatable<InlineResponse20050DataNotation>, IValidatableObject
    {
        ...
        public InlineResponse20050DataNotation(string id = default(string), InlineResponse20046DataNotationFsym fsym = default(InlineResponse20046DataNotationFsym), InlineResponse20050DataNotationInstrument instrument = default(InlineResponse20050DataNotationInstrument), InlineResponse20050DataNotationOperatingMIC operatingMIC = default(InlineResponse20050DataNotationOperatingMIC))
        {
            this.Id = id;
            this.Fsym = fsym;
