...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20060Data : IEquatable<InlineResponse20060Data>, IValidatableObject
    {
        ...
        /// <param name="roles">Role-specific background texts..</param>
        public InlineResponse20060Data(string idInstrument = default(string), string sourceIdentifier = default(string), List<InlineResponse20060DataRoles> roles = default(List<InlineResponse20060DataRoles>))
        {
        ...
        /// </summary>
        /// <value>Role-specific background texts.</value>
        [DataMember(Name = "roles", EmitDefaultValue = false)]
        public List<InlineResponse20060DataRoles> Roles { get; set; }
