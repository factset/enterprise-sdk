...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_91_data_ask")]
    public partial class InlineResponse20091DataAsk : IEquatable<InlineResponse20091DataAsk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20091DataAsk" /> class.
        /// </summary>
        ...
        public InlineResponse20091DataAsk(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20091DataAsk {\n");
        ...
        {
            return this.Equals(input as InlineResponse20091DataAsk);
        }

        /// <summary>
        /// Returns true if InlineResponse20091DataAsk instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20091DataAsk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20091DataAsk input)
        {
            if (input == null)
            {
                return false;
