...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostPricesTradingScheduleEventListRequest_meta_pagination")]
    public partial class PostPricesTradingScheduleEventListRequestMetaPagination : IEquatable<PostPricesTradingScheduleEventListRequestMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPricesTradingScheduleEventListRequestMetaPagination" /> class.
        /// </summary>
        ...
        public PostPricesTradingScheduleEventListRequestMetaPagination(string cursor = default(string), decimal limit = 20M)
        {
            this.Cursor = cursor;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as PostPricesTradingScheduleEventListRequestMetaPagination);
        }

        /// <summary>
        /// Returns true if PostPricesTradingScheduleEventListRequestMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPricesTradingScheduleEventListRequestMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPricesTradingScheduleEventListRequestMetaPagination input)
        {
            if (input == null)
            {
                return false;
