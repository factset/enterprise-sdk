...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_accumulated")]
    public partial class InlineResponse20090Accumulated : IEquatable<InlineResponse20090Accumulated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090Accumulated" /> class.
        /// </summary>
        ...
        /// <param name="volumeWeightedAveragePrice">The volume-weighted average price (VWAP). See attribute &#x60;valueUnit&#x60; for its unit..</param>
        public InlineResponse20090Accumulated(decimal? numberTrades = default(decimal?), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?), decimal? volumeWeightedAveragePrice = default(decimal?))
        {
        ...
        /// </summary>
        /// <value>The volume-weighted average price (VWAP). See attribute &#x60;valueUnit&#x60; for its unit.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20090Accumulated {\n");
        ...
        {
            return this.Equals(input as InlineResponse20090Accumulated);
        }

        /// <summary>
        /// Returns true if InlineResponse20090Accumulated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090Accumulated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090Accumulated input)
        {
            if (input == null)
            {
                return false;
