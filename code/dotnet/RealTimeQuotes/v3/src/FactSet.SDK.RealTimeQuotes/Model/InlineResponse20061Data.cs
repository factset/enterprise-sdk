...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20061Data : IEquatable<InlineResponse20061Data>, IValidatableObject
    {
        ...
        /// <param name="roles">Role-specific compliance properties..</param>
        public InlineResponse20061Data(string idInstrument = default(string), string sourceIdentifier = default(string), List<InlineResponse20061DataRoles> roles = default(List<InlineResponse20061DataRoles>))
        {
        ...
        /// </summary>
        /// <value>Role-specific compliance properties.</value>
        [DataMember(Name = "roles", EmitDefaultValue = false)]
        public List<InlineResponse20061DataRoles> Roles { get; set; }
