...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20067Data : IEquatable<InlineResponse20067Data>, IValidatableObject
    {
        ...
        /// <param name="category">Set of categories assigned to the instrument. The set of returned categories is limited to the values provided in the request parameter &#x60;category.restrict.ids.&#x60; Empty, if &#x60;category.restrict.ids&#x60; has not been used..</param>
        public InlineResponse20067Data(string id = default(string), InlineResponse20067Name name = default(InlineResponse20067Name), string isin = default(string), InlineResponse20067Nsin nsin = default(InlineResponse20067Nsin), InlineResponse20036Fsym fsym = default(InlineResponse20036Fsym), InlineResponse20067AssetClass assetClass = default(InlineResponse20067AssetClass), List<InlineResponse20067Category> category = default(List<InlineResponse20067Category>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        public InlineResponse20067Name Name { get; set; }
        ...
        public InlineResponse20067AssetClass AssetClass { get; set; }
        ...
        public List<InlineResponse20067Category> Category { get; set; }
