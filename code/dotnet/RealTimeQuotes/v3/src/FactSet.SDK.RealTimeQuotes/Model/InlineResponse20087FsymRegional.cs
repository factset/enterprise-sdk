...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_87_fsym_regional")]
    public partial class InlineResponse20087FsymRegional : IEquatable<InlineResponse20087FsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20087FsymRegional" /> class.
        /// </summary>
        ...
        /// <param name="tickerExchange">FactSet regional symbol of the notation, consisting of the ticker and the two-character code of the country or region where the listing is traded (example: DAI-DE)..</param>
        /// <param name="isPrimary">Indicates whether the notation is in the primary region of the security (&#x60;true&#x60;) or not (&#x60;false&#x60;)..</param>
        public InlineResponse20087FsymRegional(string permanentIdentifier = default(string), string tickerExchange = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20087FsymRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20087FsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20087FsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20087FsymRegional input)
        {
            if (input == null)
            {
                return false;
