...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_88_data_regional_us")]
    public partial class InlineResponse20088DataRegionalUs : IEquatable<InlineResponse20088DataRegionalUs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20088DataRegionalUs" /> class.
        /// </summary>
        ...
        public InlineResponse20088DataRegionalUs(bool? caveatEmptor = default(bool?), bool? proprietaryQuoteEligible = default(bool?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20088DataRegionalUs);
        }

        /// <summary>
        /// Returns true if InlineResponse20088DataRegionalUs instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20088DataRegionalUs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20088DataRegionalUs input)
        {
            if (input == null)
            {
                return false;
