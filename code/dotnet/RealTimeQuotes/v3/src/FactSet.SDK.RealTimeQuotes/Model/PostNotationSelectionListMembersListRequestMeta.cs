...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNotationSelectionListMembersListRequest_meta")]
    public partial class PostNotationSelectionListMembersListRequestMeta : IEquatable<PostNotationSelectionListMembersListRequestMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNotationSelectionListMembersListRequestMeta" /> class.
        /// </summary>
        ...
        public PostNotationSelectionListMembersListRequestMeta(HashSet<string> attributes = default(HashSet<string>), string language = default(string), HashSet<SortEnum> sort = default(HashSet<SortEnum>), PostBasicMarketListRequestMetaPagination pagination = default(PostBasicMarketListRequestMetaPagination))
        {
        ...
        {
            return this.Equals(input as PostNotationSelectionListMembersListRequestMeta);
        }

        /// <summary>
        /// Returns true if PostNotationSelectionListMembersListRequestMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNotationSelectionListMembersListRequestMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNotationSelectionListMembersListRequestMeta input)
        {
            if (input == null)
            {
                return false;
