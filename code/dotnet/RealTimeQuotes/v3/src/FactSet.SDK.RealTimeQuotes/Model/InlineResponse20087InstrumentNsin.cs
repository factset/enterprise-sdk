...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_87_instrument_nsin")]
    public partial class InlineResponse20087InstrumentNsin : IEquatable<InlineResponse20087InstrumentNsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20087InstrumentNsin" /> class.
        /// </summary>
        ...
        /// <param name="valor">The Valor number (German: Valorennummer) of the instrument. The Valor number is aninteger number that uniquely identifies an instrument..</param>
        ...
        public InlineResponse20087InstrumentNsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        /// </summary>
        /// <value>The Valor number (German: Valorennummer) of the instrument. The Valor number is aninteger number that uniquely identifies an instrument.</value>
        ...
        {
            return this.Equals(input as InlineResponse20087InstrumentNsin);
        }

        /// <summary>
        /// Returns true if InlineResponse20087InstrumentNsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20087InstrumentNsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20087InstrumentNsin input)
        {
            if (input == null)
            {
                return false;
