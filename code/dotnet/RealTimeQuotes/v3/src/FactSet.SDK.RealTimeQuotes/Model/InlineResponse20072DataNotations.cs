...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_72_data_notations")]
    public partial class InlineResponse20072DataNotations : IEquatable<InlineResponse20072DataNotations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20072DataNotations" /> class.
        /// </summary>
        ...
        public InlineResponse20072DataNotations(string id = default(string), string symbol = default(string), bool? active = default(bool?), InlineResponse20071DataMarket market = default(InlineResponse20071DataMarket), InlineResponse20071DataValueUnit valueUnit = default(InlineResponse20071DataValueUnit), InlineResponse20046DataNotationFsym fsym = default(InlineResponse20046DataNotationFsym))
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Active = active;
        ...
        public InlineResponse20071DataValueUnit ValueUnit { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20072DataNotations);
        }

        /// <summary>
        /// Returns true if InlineResponse20072DataNotations instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20072DataNotations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20072DataNotations input)
        {
            if (input == null)
            {
                return false;
