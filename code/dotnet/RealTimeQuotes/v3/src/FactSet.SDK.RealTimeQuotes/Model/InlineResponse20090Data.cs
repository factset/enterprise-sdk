...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20090Data : IEquatable<InlineResponse20090Data>, IValidatableObject
    {
        ...
        public InlineResponse20090Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse20089DataValueUnit valueUnit = default(InlineResponse20089DataValueUnit), InlineResponse20089DataCurrency currency = default(InlineResponse20089DataCurrency), InlineResponse20090Market market = default(InlineResponse20090Market), QualityEnum? quality = default(QualityEnum?), InlineResponse20090Latest latest = default(InlineResponse20090Latest), InlineResponse20090First first = default(InlineResponse20090First), InlineResponse20090Low low = default(InlineResponse20090Low), InlineResponse20090High high = default(InlineResponse20090High), InlineResponse20090PreviousClose previousClose = default(InlineResponse20090PreviousClose), InlineResponse20090Accumulated accumulated = default(InlineResponse20090Accumulated), InlineResponse20086Status status = default(InlineResponse20086Status))
        {
        ...
        public InlineResponse20089DataValueUnit ValueUnit { get; set; }

        /// <summary>
        /// Gets or Sets Currency
        /// </summary>
        [DataMember(Name = "currency", EmitDefaultValue = false)]
        public InlineResponse20089DataCurrency Currency { get; set; }

        /// <summary>
        /// Gets or Sets Market
        /// </summary>
        [DataMember(Name = "market", EmitDefaultValue = false)]
        public InlineResponse20090Market Market { get; set; }

        /// <summary>
        /// Gets or Sets Latest
        /// </summary>
        [DataMember(Name = "latest", EmitDefaultValue = false)]
        public InlineResponse20090Latest Latest { get; set; }

        /// <summary>
        /// Gets or Sets First
        /// </summary>
        [DataMember(Name = "first", EmitDefaultValue = false)]
        public InlineResponse20090First First { get; set; }

        /// <summary>
        /// Gets or Sets Low
        /// </summary>
        [DataMember(Name = "low", EmitDefaultValue = false)]
        public InlineResponse20090Low Low { get; set; }

        /// <summary>
        /// Gets or Sets High
        /// </summary>
        [DataMember(Name = "high", EmitDefaultValue = false)]
        public InlineResponse20090High High { get; set; }

        /// <summary>
        /// Gets or Sets PreviousClose
        /// </summary>
        [DataMember(Name = "previousClose", EmitDefaultValue = false)]
        public InlineResponse20090PreviousClose PreviousClose { get; set; }

        /// <summary>
        /// Gets or Sets Accumulated
        /// </summary>
        [DataMember(Name = "accumulated", EmitDefaultValue = false)]
        public InlineResponse20090Accumulated Accumulated { get; set; }
