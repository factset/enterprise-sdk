...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_97_data")]
    public partial class InlineResponse20097Data : IEquatable<InlineResponse20097Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20097Data" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20097Data);
        }

        /// <summary>
        /// Returns true if InlineResponse20097Data instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20097Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20097Data input)
        {
            if (input == null)
            {
                return false;
