...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20042Data : IEquatable<InlineResponse20042Data>, IValidatableObject
    {
        ...
        public InlineResponse20042Data(string idInstrument = default(string), string sourceIdentifier = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse20042DataNsin nsin = default(InlineResponse20042DataNsin), InlineResponse20036Fsym fsym = default(InlineResponse20036Fsym), InlineResponse20042DataAssetClass assetClass = default(InlineResponse20042DataAssetClass), List<InlineResponse20042DataType> type = default(List<InlineResponse20042DataType>))
        {
