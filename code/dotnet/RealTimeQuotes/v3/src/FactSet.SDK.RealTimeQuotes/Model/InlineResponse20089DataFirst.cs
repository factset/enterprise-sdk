...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_first")]
    public partial class InlineResponse20089DataFirst : IEquatable<InlineResponse20089DataFirst>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataFirst" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataFirst(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20089DataFirst);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataFirst instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataFirst to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataFirst input)
        {
            if (input == null)
            {
                return false;
