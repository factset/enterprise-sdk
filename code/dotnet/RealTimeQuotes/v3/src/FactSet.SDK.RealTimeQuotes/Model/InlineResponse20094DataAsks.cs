...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_94_data_asks")]
    public partial class InlineResponse20094DataAsks : IEquatable<InlineResponse20094DataAsks>, IValidatableObject
    {
        /// <summary>
        /// Order type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20094DataAsks" /> class.
        /// </summary>
        ...
        public InlineResponse20094DataAsks(string id = default(string), string time = default(string), TypeEnum? type = default(TypeEnum?), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? volume = default(decimal?), string marketMaker = default(string))
        {
            this.Id = id;
            this.Time = time;
            this.Type = type;
        ...
        [DataMember(Name = "marketMaker", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as InlineResponse20094DataAsks);
        }

        /// <summary>
        /// Returns true if InlineResponse20094DataAsks instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20094DataAsks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20094DataAsks input)
        {
            if (input == null)
            {
                return false;
