...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_92_ask")]
    public partial class InlineResponse20092Ask : IEquatable<InlineResponse20092Ask>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20092Ask" /> class.
        /// </summary>
        ...
        public InlineResponse20092Ask(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20092Ask);
        }

        /// <summary>
        /// Returns true if InlineResponse20092Ask instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20092Ask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20092Ask input)
        {
            if (input == null)
            {
                return false;
