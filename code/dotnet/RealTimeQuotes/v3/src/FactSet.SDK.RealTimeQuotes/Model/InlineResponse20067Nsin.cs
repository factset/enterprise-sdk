...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_67_nsin")]
    public partial class InlineResponse20067Nsin : IEquatable<InlineResponse20067Nsin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20067Nsin" /> class.
        /// </summary>
        ...
        public InlineResponse20067Nsin(string wkn = default(string), string valor = default(string), string cusip = default(string))
        {
            this.Wkn = wkn;
            this.Valor = valor;
            this.Cusip = cusip;
        ...
        {
            return this.Equals(input as InlineResponse20067Nsin);
        }

        /// <summary>
        /// Returns true if InlineResponse20067Nsin instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20067Nsin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20067Nsin input)
        {
            if (input == null)
            {
                return false;
