...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// Orderbook.
    /// </summary>
    [DataContract(Name = "inline_response_200_94_data")]
    public partial class InlineResponse20094Data : IEquatable<InlineResponse20094Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20094Data" /> class.
        /// </summary>
        ...
        public InlineResponse20094Data(string idNotation = default(string), string sourceIdentifier = default(string), QualityEnum? quality = default(QualityEnum?), List<InlineResponse20094DataAsks> asks = default(List<InlineResponse20094DataAsks>), List<InlineResponse20094DataAsks> bids = default(List<InlineResponse20094DataAsks>))
        {
        ...
        public List<InlineResponse20094DataAsks> Asks { get; set; }
        ...
        public List<InlineResponse20094DataAsks> Bids { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20094Data);
        }

        /// <summary>
        /// Returns true if InlineResponse20094Data instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20094Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20094Data input)
        {
            if (input == null)
            {
                return false;
