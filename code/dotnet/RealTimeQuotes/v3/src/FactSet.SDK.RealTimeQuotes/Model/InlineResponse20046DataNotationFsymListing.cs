...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_46_data_notation_fsym_listing")]
    public partial class InlineResponse20046DataNotationFsymListing : IEquatable<InlineResponse20046DataNotationFsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20046DataNotationFsymListing" /> class.
        /// </summary>
        ...
        public InlineResponse20046DataNotationFsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20046DataNotationFsymListing);
        }

        /// <summary>
        /// Returns true if InlineResponse20046DataNotationFsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20046DataNotationFsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20046DataNotationFsymListing input)
        {
            if (input == null)
            {
                return false;
