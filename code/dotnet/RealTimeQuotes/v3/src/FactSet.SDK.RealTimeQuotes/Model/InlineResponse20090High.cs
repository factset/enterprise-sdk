...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_90_high")]
    public partial class InlineResponse20090High : IEquatable<InlineResponse20090High>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20090High" /> class.
        /// </summary>
        ...
        public InlineResponse20090High(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20090High);
        }

        /// <summary>
        /// Returns true if InlineResponse20090High instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20090High to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20090High input)
        {
            if (input == null)
            {
                return false;
