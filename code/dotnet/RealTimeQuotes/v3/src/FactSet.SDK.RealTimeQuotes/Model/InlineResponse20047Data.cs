...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20047Data : IEquatable<InlineResponse20047Data>, IValidatableObject
    {
        ...
        /// <param name="datasets">List of datasets with assigned categories..</param>
        public InlineResponse20047Data(string idInstrument = default(string), string sourceIdentifier = default(string), List<InlineResponse20047DataDatasets> datasets = default(List<InlineResponse20047DataDatasets>))
        {
        ...
        /// </summary>
        /// <value>List of datasets with assigned categories.</value>
        [DataMember(Name = "datasets", EmitDefaultValue = false)]
        public List<InlineResponse20047DataDatasets> Datasets { get; set; }
