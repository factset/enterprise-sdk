...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20084Data : IEquatable<InlineResponse20084Data>, IValidatableObject
    {
        ...
        public InlineResponse20084Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse20084DataPrice price = default(InlineResponse20084DataPrice), InlineResponse20084DataVolume volume = default(InlineResponse20084DataVolume), InlineResponse20084DataValue value = default(InlineResponse20084DataValue))
        {
        ...
        public InlineResponse20084DataPrice Price { get; set; }

        /// <summary>
        /// Gets or Sets Volume
        /// </summary>
        [DataMember(Name = "volume", EmitDefaultValue = false)]
        public InlineResponse20084DataVolume Volume { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = false)]
        public InlineResponse20084DataValue Value { get; set; }
