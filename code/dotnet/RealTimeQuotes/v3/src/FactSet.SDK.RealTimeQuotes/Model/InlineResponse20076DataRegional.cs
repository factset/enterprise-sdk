...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_76_data_regional")]
    public partial class InlineResponse20076DataRegional : IEquatable<InlineResponse20076DataRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20076DataRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20076DataRegional(bool? isPrimary = default(bool?), string permanentIdentifier = default(string), string tickerRegion = default(string), List<InlineResponse20076DataListing> listing = default(List<InlineResponse20076DataListing>))
        {
        ...
        public List<InlineResponse20076DataListing> Listing { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20076DataRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20076DataRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20076DataRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20076DataRegional input)
        {
            if (input == null)
            {
                return false;
