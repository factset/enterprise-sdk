...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNotationSearchByTextRequest_data_market_order")]
    public partial class PostNotationSearchByTextRequestDataMarketOrder : IEquatable<PostNotationSearchByTextRequestDataMarketOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNotationSearchByTextRequestDataMarketOrder" /> class.
        /// </summary>
        /// <param name="ids">List of market identifiers. See endpoint &#x60;/basic/market/list&#x60; for valid values..</param>
        public PostNotationSearchByTextRequestDataMarketOrder(HashSet<decimal> ids = default(HashSet<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as PostNotationSearchByTextRequestDataMarketOrder);
        }

        /// <summary>
        /// Returns true if PostNotationSearchByTextRequestDataMarketOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNotationSearchByTextRequestDataMarketOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNotationSearchByTextRequestDataMarketOrder input)
        {
            if (input == null)
            {
                return false;
