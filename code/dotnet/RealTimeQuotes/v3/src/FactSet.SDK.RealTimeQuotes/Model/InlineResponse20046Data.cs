...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20046Data : IEquatable<InlineResponse20046Data>, IValidatableObject
    {
        ...
        public InlineResponse20046Data(string idInstrument = default(string), string sourceIdentifier = default(string), List<InlineResponse20046DataBenchmarks> benchmarks = default(List<InlineResponse20046DataBenchmarks>))
        {
        ...
        public List<InlineResponse20046DataBenchmarks> Benchmarks { get; set; }
