...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_71_data_valueUnit")]
    public partial class InlineResponse20071DataValueUnit : IEquatable<InlineResponse20071DataValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20071DataValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20071DataValueUnit(decimal? id = default(decimal?), string code = default(string), string isoCode = default(string), string name = default(string))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20071DataValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20071DataValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20071DataValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20071DataValueUnit input)
        {
            if (input == null)
            {
                return false;
