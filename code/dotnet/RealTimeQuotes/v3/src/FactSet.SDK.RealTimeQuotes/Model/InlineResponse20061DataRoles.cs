...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_61_data_roles")]
    public partial class InlineResponse20061DataRoles : IEquatable<InlineResponse20061DataRoles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20061DataRoles" /> class.
        /// </summary>
        ...
        public InlineResponse20061DataRoles(decimal? id = default(decimal?), string name = default(string), List<InlineResponse20061DataLegalEntities> legalEntities = default(List<InlineResponse20061DataLegalEntities>))
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<InlineResponse20061DataLegalEntities> LegalEntities { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20061DataRoles);
        }

        /// <summary>
        /// Returns true if InlineResponse20061DataRoles instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20061DataRoles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20061DataRoles input)
        {
            if (input == null)
            {
                return false;
