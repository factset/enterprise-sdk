...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_high")]
    public partial class InlineResponse20089DataHigh : IEquatable<InlineResponse20089DataHigh>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataHigh" /> class.
        /// </summary>
        ...
        public InlineResponse20089DataHigh(string time = default(string), decimal? price = default(decimal?), decimal? tradingVolume = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20089DataHigh {\n");
        ...
        {
            return this.Equals(input as InlineResponse20089DataHigh);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataHigh instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataHigh to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataHigh input)
        {
            if (input == null)
            {
                return false;
