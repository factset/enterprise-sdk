...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_87_valueUnit")]
    public partial class InlineResponse20087ValueUnit : IEquatable<InlineResponse20087ValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20087ValueUnit" /> class.
        /// </summary>
        /// <param name="id">Identifier of the value unit..</param>
        /// <param name="name">Code of the value unit: If assigned, a code according to ISO 4217, otherwise a local code, for a main currency; a code such as GBp (for British pence) for a fractional currency; or a code such as PT (points) for non-currency value units..</param>
        public InlineResponse20087ValueUnit(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse20087ValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20087ValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20087ValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20087ValueUnit input)
        {
            if (input == null)
            {
                return false;
