...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20092Data : IEquatable<InlineResponse20092Data>, IValidatableObject
    {
        ...
        public InlineResponse20092Data(string idNotation = default(string), string sourceIdentifier = default(string), InlineResponse20089DataValueUnit valueUnit = default(InlineResponse20089DataValueUnit), InlineResponse20089DataCurrency currency = default(InlineResponse20089DataCurrency), InlineResponse20090Market market = default(InlineResponse20090Market), QualityEnum? quality = default(QualityEnum?), InlineResponse20092Bid bid = default(InlineResponse20092Bid), InlineResponse20092Ask ask = default(InlineResponse20092Ask), InlineResponse20086Status status = default(InlineResponse20086Status))
        {
        ...
        public InlineResponse20092Bid Bid { get; set; }

        /// <summary>
        /// Gets or Sets Ask
        /// </summary>
        [DataMember(Name = "ask", EmitDefaultValue = false)]
        public InlineResponse20092Ask Ask { get; set; }
