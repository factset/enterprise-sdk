...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_46_data_notation_fsym_regional")]
    public partial class InlineResponse20046DataNotationFsymRegional : IEquatable<InlineResponse20046DataNotationFsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20046DataNotationFsymRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20046DataNotationFsymRegional(string permanentIdentifier = default(string), string tickerRegion = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20046DataNotationFsymRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20046DataNotationFsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20046DataNotationFsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20046DataNotationFsymRegional input)
        {
            if (input == null)
            {
                return false;
