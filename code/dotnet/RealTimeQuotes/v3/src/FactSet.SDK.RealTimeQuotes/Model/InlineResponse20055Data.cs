...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// Instrument response.
    /// </summary>
    [DataContract(Name = "inline_response_200_55_data")]
    public partial class InlineResponse20055Data : IEquatable<InlineResponse20055Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20055Data" /> class.
        /// </summary>
        /// <param name="id">Identifier of the instrument..</param>
        /// <param name="fsym">fsym.</param>
        /// <param name="validity">validity.</param>
        public InlineResponse20055Data(string id = default(string), InlineResponse20036Fsym fsym = default(InlineResponse20036Fsym), InlineResponse20055DataValidity validity = default(InlineResponse20055DataValidity))
        {
            this.Id = id;
            this.Fsym = fsym;
        ...
        {
            return this.Equals(input as InlineResponse20055Data);
        }

        /// <summary>
        /// Returns true if InlineResponse20055Data instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20055Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20055Data input)
        {
            if (input == null)
            {
                return false;
