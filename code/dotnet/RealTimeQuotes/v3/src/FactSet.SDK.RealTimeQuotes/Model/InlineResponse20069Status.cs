...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_69_status")]
    public partial class InlineResponse20069Status : IEquatable<InlineResponse20069Status>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20069Status" /> class.
        /// </summary>
        ...
        public InlineResponse20069Status(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20069Status {\n");
        ...
        {
            return this.Equals(input as InlineResponse20069Status);
        }

        /// <summary>
        /// Returns true if InlineResponse20069Status instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20069Status to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20069Status input)
        {
            if (input == null)
            {
                return false;
