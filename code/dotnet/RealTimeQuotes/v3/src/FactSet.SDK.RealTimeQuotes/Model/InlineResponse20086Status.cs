...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_86_status")]
    public partial class InlineResponse20086Status : IEquatable<InlineResponse20086Status>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20086Status" /> class.
        /// </summary>
        ...
        public InlineResponse20086Status(CodeEnum? code = default(CodeEnum?), string identifier = default(string), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse20086Status);
        }

        /// <summary>
        /// Returns true if InlineResponse20086Status instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20086Status to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20086Status input)
        {
            if (input == null)
            {
                return false;
