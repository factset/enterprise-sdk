...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_84_data_value")]
    public partial class InlineResponse20084DataValue : IEquatable<InlineResponse20084DataValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20084DataValue" /> class.
        /// </summary>
        ...
        public InlineResponse20084DataValue(decimal? days5 = default(decimal?), decimal? days30 = default(decimal?), decimal? days100 = default(decimal?), decimal? days250 = default(decimal?))
        {
            this.Days5 = days5;
            this.Days30 = days30;
        ...
        {
            return this.Equals(input as InlineResponse20084DataValue);
        }

        /// <summary>
        /// Returns true if InlineResponse20084DataValue instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20084DataValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20084DataValue input)
        {
            if (input == null)
            {
                return false;
