...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostBasicDeliveryListRequest_data_filter")]
    public partial class PostBasicDeliveryListRequestDataFilter : IEquatable<PostBasicDeliveryListRequestDataFilter>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PostBasicDeliveryListRequestDataFilter);
        }

        /// <summary>
        /// Returns true if PostBasicDeliveryListRequestDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PostBasicDeliveryListRequestDataFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostBasicDeliveryListRequestDataFilter input)
        {
            if (input == null)
            {
                return false;
