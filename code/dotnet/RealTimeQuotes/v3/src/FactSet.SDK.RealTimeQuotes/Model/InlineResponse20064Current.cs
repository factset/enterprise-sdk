...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// Current rating.
    /// </summary>
    [DataContract(Name = "inline_response_200_64_current")]
    public partial class InlineResponse20064Current : IEquatable<InlineResponse20064Current>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20064Current" /> class.
        /// </summary>
        ...
        public InlineResponse20064Current(decimal? id = default(decimal?), string grade = default(string), decimal? rank = default(decimal?), DateTime? date = default(DateTime?))
        {
            this.Id = id;
            this.Grade = grade;
            this.Rank = rank;
        ...
        {
            return this.Equals(input as InlineResponse20064Current);
        }

        /// <summary>
        /// Returns true if InlineResponse20064Current instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20064Current to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20064Current input)
        {
            if (input == null)
            {
                return false;
