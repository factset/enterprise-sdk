...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_88_data_market")]
    public partial class InlineResponse20088DataMarket : IEquatable<InlineResponse20088DataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20088DataMarket" /> class.
        /// </summary>
        ...
        public InlineResponse20088DataMarket(decimal? id = default(decimal?), bool? isOpen = default(bool?), string phase = default(string))
        {
            this.Id = id;
            this.IsOpen = isOpen;
            this.Phase = phase;
        ...
        {
            return this.Equals(input as InlineResponse20088DataMarket);
        }

        /// <summary>
        /// Returns true if InlineResponse20088DataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20088DataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20088DataMarket input)
        {
            if (input == null)
            {
                return false;
