...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_91_data_bid")]
    public partial class InlineResponse20091DataBid : IEquatable<InlineResponse20091DataBid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20091DataBid" /> class.
        /// </summary>
        ...
        public InlineResponse20091DataBid(string time = default(string), decimal? price = default(decimal?), string quoteCondition = default(string), decimal? tradingVolume = default(decimal?), decimal? tradingValue = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        ...
        {
            return this.Equals(input as InlineResponse20091DataBid);
        }

        /// <summary>
        /// Returns true if InlineResponse20091DataBid instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20091DataBid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20091DataBid input)
        {
            if (input == null)
            {
                return false;
