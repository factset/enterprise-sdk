...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNotationCategoryListRequest_meta")]
    public partial class PostNotationCategoryListRequestMeta : IEquatable<PostNotationCategoryListRequestMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum DatasetId for value: dataset.id
            /// </summary>
            [EnumMember(Value = "dataset.id")]
            DatasetId = 1,

            /// <summary>
            /// Enum MINUS_DatasetId for value: -dataset.id
            /// </summary>
            [EnumMember(Value = "-dataset.id")]
            MINUS_DatasetId = 2,

            /// <summary>
            /// Enum DatasetName for value: dataset.name
            /// </summary>
            [EnumMember(Value = "dataset.name")]
            DatasetName = 3,

            /// <summary>
            /// Enum MINUS_DatasetName for value: -dataset.name
            /// </summary>
            [EnumMember(Value = "-dataset.name")]
            MINUS_DatasetName = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNotationCategoryListRequestMeta" /> class.
        /// </summary>
        ...
        public PostNotationCategoryListRequestMeta(HashSet<string> attributes = default(HashSet<string>), string language = default(string), HashSet<SortEnum> sort = default(HashSet<SortEnum>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostNotationCategoryListRequestMeta {\n");
        ...
        {
            return this.Equals(input as PostNotationCategoryListRequestMeta);
        }

        /// <summary>
        /// Returns true if PostNotationCategoryListRequestMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNotationCategoryListRequestMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNotationCategoryListRequestMeta input)
        {
            if (input == null)
            {
                return false;
