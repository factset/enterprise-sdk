...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20063Data : IEquatable<InlineResponse20063Data>, IValidatableObject
    {
        ...
        /// <param name="notations">List of entitled notations..</param>
        public InlineResponse20063Data(string idInstrument = default(string), string sourceIdentifier = default(string), InlineResponse20063Status status = default(InlineResponse20063Status), List<InlineResponse20063Notations> notations = default(List<InlineResponse20063Notations>))
        {
        ...
        /// </summary>
        /// <value>List of entitled notations.</value>
        [DataMember(Name = "notations", EmitDefaultValue = false)]
        public List<InlineResponse20063Notations> Notations { get; set; }
