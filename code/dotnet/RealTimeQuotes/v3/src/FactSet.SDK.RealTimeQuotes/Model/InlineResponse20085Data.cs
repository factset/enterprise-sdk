...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    public partial class InlineResponse20085Data : IEquatable<InlineResponse20085Data>, IValidatableObject
    {
        ...
        public InlineResponse20085Data(decimal? id = default(decimal?), string name = default(string), string shortName = default(string), InlineResponse20085Country country = default(InlineResponse20085Country), InlineResponse20085Type type = default(InlineResponse20085Type), InlineResponse20085Group group = default(InlineResponse20085Group), InlineResponse20085Timezone timezone = default(InlineResponse20085Timezone), decimal? count = default(decimal?))
        {
            this.Id = id;
            this.Name = name;
        ...
        public InlineResponse20085Country Country { get; set; }

        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        [DataMember(Name = "type", EmitDefaultValue = false)]
        public InlineResponse20085Type Type { get; set; }

        /// <summary>
        /// Gets or Sets Group
        /// </summary>
        [DataMember(Name = "group", EmitDefaultValue = false)]
        public InlineResponse20085Group Group { get; set; }

        /// <summary>
        /// Gets or Sets Timezone
        /// </summary>
        [DataMember(Name = "timezone", EmitDefaultValue = false)]
        public InlineResponse20085Timezone Timezone { get; set; }
