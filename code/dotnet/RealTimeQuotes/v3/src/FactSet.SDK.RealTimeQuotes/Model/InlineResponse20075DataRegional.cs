...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_75_data_regional")]
    public partial class InlineResponse20075DataRegional : IEquatable<InlineResponse20075DataRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20075DataRegional" /> class.
        /// </summary>
        ...
        public InlineResponse20075DataRegional(bool? isPrimary = default(bool?), string permanentIdentifier = default(string), string tickerRegion = default(string), InlineResponse20075DataRegionalListing listing = default(InlineResponse20075DataRegionalListing))
        {
        ...
        public InlineResponse20075DataRegionalListing Listing { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20075DataRegional);
        }

        /// <summary>
        /// Returns true if InlineResponse20075DataRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20075DataRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20075DataRegional input)
        {
            if (input == null)
            {
                return false;
