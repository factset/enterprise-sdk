...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostBasicMediaTypeListRequest_data_filter")]
    public partial class PostBasicMediaTypeListRequestDataFilter : IEquatable<PostBasicMediaTypeListRequestDataFilter>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostBasicMediaTypeListRequestDataFilter {\n");
        ...
        {
            return this.Equals(input as PostBasicMediaTypeListRequestDataFilter);
        }

        /// <summary>
        /// Returns true if PostBasicMediaTypeListRequestDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PostBasicMediaTypeListRequestDataFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostBasicMediaTypeListRequestDataFilter input)
        {
            if (input == null)
            {
                return false;
