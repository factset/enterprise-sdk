...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_87_instrument")]
    public partial class InlineResponse20087Instrument : IEquatable<InlineResponse20087Instrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20087Instrument" /> class.
        /// </summary>
        ...
        public InlineResponse20087Instrument(string id = default(string), InlineResponse20067Name name = default(InlineResponse20067Name), string isin = default(string), InlineResponse20087InstrumentNsin nsin = default(InlineResponse20087InstrumentNsin), InlineResponse20036Fsym fsym = default(InlineResponse20036Fsym), InlineResponse20067AssetClass assetClass = default(InlineResponse20067AssetClass), List<InlineResponse20067Category> instrumentCategory = default(List<InlineResponse20067Category>))
        {
            this.Id = id;
            this.Name = name;
            this.Isin = isin;
        ...
        public InlineResponse20087InstrumentNsin Nsin { get; set; }
        ...
        public List<InlineResponse20067Category> InstrumentCategory { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20087Instrument);
        }

        /// <summary>
        /// Returns true if InlineResponse20087Instrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20087Instrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20087Instrument input)
        {
            if (input == null)
            {
                return false;
