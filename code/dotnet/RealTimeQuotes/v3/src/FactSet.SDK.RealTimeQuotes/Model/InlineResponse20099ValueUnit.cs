...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_99_valueUnit")]
    public partial class InlineResponse20099ValueUnit : IEquatable<InlineResponse20099ValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20099ValueUnit" /> class.
        /// </summary>
        ...
        public InlineResponse20099ValueUnit(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse20099ValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse20099ValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20099ValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20099ValueUnit input)
        {
            if (input == null)
            {
                return false;
