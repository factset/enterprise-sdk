...
namespace FactSet.SDK.RealTimeQuotes.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_89_data_latest_performance_intraday")]
    public partial class InlineResponse20089DataLatestPerformanceIntraday : IEquatable<InlineResponse20089DataLatestPerformanceIntraday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20089DataLatestPerformanceIntraday" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;valueUnit&#x60; for its unit..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse20089DataLatestPerformanceIntraday(decimal? absolute = default(decimal?), decimal? relative = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse20089DataLatestPerformanceIntraday);
        }

        /// <summary>
        /// Returns true if InlineResponse20089DataLatestPerformanceIntraday instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20089DataLatestPerformanceIntraday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20089DataLatestPerformanceIntraday input)
        {
            if (input == null)
            {
                return false;
