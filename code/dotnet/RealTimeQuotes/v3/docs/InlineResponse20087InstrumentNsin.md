# FactSet.SDK.RealTimeQuotes.Model.InlineResponse20087InstrumentNsin
...
**Valor** | **string** | The Valor number (German: Valorennummer) of the instrument. The Valor number is aninteger number that uniquely identifies an instrument. | [optional] 
