# FactSet.SDK.RealTimeQuotes.Model.InlineResponse20076DataRegional
...
**Listing** | [**List&lt;InlineResponse20076DataListing&gt;**](InlineResponse20076DataListing.md) | Listing-level data with a list of notations. If the set of listing identifiers contains an element for which the attribute &#x60;isPrimary &#x3D; true&#x60;, then this element is the first one in the array. | [optional] 
