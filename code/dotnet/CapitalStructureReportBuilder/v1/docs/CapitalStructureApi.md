# FactSet.SDK.CapitalStructureReportBuilder.Api.CapitalStructureApi
...
namespace Example
{
    public class GetDcsDetailExample
    {
...
# **GetDcsSummary**
> Response GetDcsSummary (string id, string schema = null)
...
namespace Example
{
    public class GetDcsSummaryExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.CapitalStructureReportBuilder.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling CapitalStructureApi.GetDcsSummary: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSourceOfCapitalExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.CapitalStructureReportBuilder.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling CapitalStructureApi.GetSourceOfCapital: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
