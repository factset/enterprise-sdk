...
namespace FactSet.SDK.CapitalStructureReportBuilder.Model
{
    ...
    public partial class Frequency : IEquatable<Frequency>, IValidatableObject
    {
        ...
        public Frequency(FrequencyFrequency frequency = default(FrequencyFrequency))
        {
            this._Frequency = frequency;
        }

        /// <summary>
        /// Gets or Sets _Frequency
        /// </summary>
        [DataMember(Name = "frequency", EmitDefaultValue = false)]
        public FrequencyFrequency _Frequency { get; set; }
        ...
        public bool Equals(Frequency input)
        {
            ...
            return 
                (
                    ...
                    this._Frequency.Equals(input._Frequency))
                );
        }
