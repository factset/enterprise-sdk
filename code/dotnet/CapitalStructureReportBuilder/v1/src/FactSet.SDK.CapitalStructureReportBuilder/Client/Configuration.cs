...
namespace FactSet.SDK.CapitalStructureReportBuilder.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/CapitalStructureReportBuilder/1.0.10";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/report/capital/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.CapitalStructureReportBuilder) Debug Report:\n";
