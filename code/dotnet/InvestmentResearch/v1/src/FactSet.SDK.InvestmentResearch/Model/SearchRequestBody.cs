...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    public partial class SearchRequestBody : IEquatable<SearchRequestBody>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ids">Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol, CUSIP, ISIN, Entity ID and SEDOL. &gt; **Note:** If this parameter is not provided, response should not include the requestId field..</param>
        ...
        /// <param name="sources">Code for document source to include. Available values:    * **FRC**: FactSet Research Connect   * **AMR**: Aftermarket Research.</param>
        ...
        /// </summary>
        /// <value>Requested symbols or securities.  This is a comma-separated list with a maximum limit of 1000.  Each symbol can be a FactSet exchange symbol, CUSIP, ISIN, Entity ID and SEDOL. &gt; **Note:** If this parameter is not provided, response should not include the requestId field.</value>
