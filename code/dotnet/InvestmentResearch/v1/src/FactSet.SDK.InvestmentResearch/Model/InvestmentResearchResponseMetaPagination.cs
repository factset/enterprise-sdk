...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    /// Pagination Object
    /// </summary>
    [DataContract(Name = "InvestmentResearchResponse_meta_pagination")]
    public partial class InvestmentResearchResponseMetaPagination : IEquatable<InvestmentResearchResponseMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentResearchResponseMetaPagination" /> class.
        /// </summary>
        ...
        public InvestmentResearchResponseMetaPagination(bool isEstimatedTotal = default(bool), int total = default(int))
        {
        ...
        {
            return this.Equals(input as InvestmentResearchResponseMetaPagination);
        }

        /// <summary>
        /// Returns true if InvestmentResearchResponseMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of InvestmentResearchResponseMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvestmentResearchResponseMetaPagination input)
        {
            if (input == null)
            {
                return false;
