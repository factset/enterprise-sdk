...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PurchaseDocument")]
    public partial class PurchaseDocument : IEquatable<PurchaseDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseDocument" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="PurchaseDocument" /> class.
        /// </summary>
        /// <param name="documentId">Unique identifier for a document. (required).</param>
        /// <param name="purchaseLink">Link to purchase or access the full document. Present for documents sourced from Aftermarket Research (AMR). (required).</param>
        ...
        public PurchaseDocument(string documentId, string purchaseLink,string headline = default(string), string source = default(string), List<string> primaryIds = default(List<string>), List<string> allIds = default(List<string>), List<string> categories = default(List<string>), DateTime storyDateTime = default(DateTime), string contributorName = default(string), int contributorId = default(int), List<string> analystName = default(List<string>), List<int> analystId = default(List<int>), int pages = default(int), List<string> reportFoci = default(List<string>), List<string> assetClasses = default(List<string>), List<string> assetTypes = default(List<string>), List<string> coverageActions = default(List<string>), bool compilationIndicators = default(bool), List<string> disciplines = default(List<string>), List<string> issuerTypes = default(List<string>), List<string> periodicities = default(List<string>), List<string> purposes = default(List<string>), List<string> ratingActions = default(List<string>), List<string> researchApproaches = default(List<string>), List<string> securityTypes = default(List<string>), List<string> targetActions = default(List<string>), List<string> weightingActions = default(List<string>))
        {
            // to ensure "documentId" is required (not null)
            if (documentId == null) {
                throw new ArgumentNullException("documentId is a required property for PurchaseDocument and cannot be null");
            }
            this.DocumentId = documentId;
            // to ensure "purchaseLink" is required (not null)
            if (purchaseLink == null) {
                throw new ArgumentNullException("purchaseLink is a required property for PurchaseDocument and cannot be null");
            }
        ...
        [DataMember(Name = "documentId", IsRequired = true, EmitDefaultValue = false)]
        public string DocumentId { get; set; }

        /// <summary>
        /// Link to purchase or access the full document. Present for documents sourced from Aftermarket Research (AMR).
        /// </summary>
        /// <value>Link to purchase or access the full document. Present for documents sourced from Aftermarket Research (AMR).</value>
        [DataMember(Name = "purchaseLink", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PurchaseLink: ").Append(PurchaseLink).Append("\n");
        ...
        {
            return this.Equals(input as PurchaseDocument);
        }

        /// <summary>
        /// Returns true if PurchaseDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseDocument input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PurchaseLink == input.PurchaseLink ||
                    (this.PurchaseLink != null &&
                    this.PurchaseLink.Equals(input.PurchaseLink))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PurchaseLink.GetHashCode();
                }
