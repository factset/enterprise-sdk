...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    public partial class PurchaseResponse : IEquatable<PurchaseResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseResponse" /> class.
        /// </summary>
        /// <param name="data">Data Array Object.</param>
        public PurchaseResponse(List<PurchaseResponseItems> data = default(List<PurchaseResponseItems>))
        {
            this.Data = data;
        }
        ...
        public List<PurchaseResponseItems> Data { get; set; }
        ...
        {
            return this.Equals(input as PurchaseResponse);
        }

        /// <summary>
        /// Returns true if PurchaseResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseResponse input)
        {
            if (input == null)
            {
                return false;
