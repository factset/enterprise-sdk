...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    /// meta object
    /// </summary>
    [DataContract(Name = "SearchRequest_meta_pagination")]
    public partial class SearchRequestMetaPagination : IEquatable<SearchRequestMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchRequestMetaPagination" /> class.
        /// </summary>
        /// <param name="limit">Number of results to return per page. (default to 25).</param>
        /// <param name="offset">Non-negative number of entries to skip. (default to 0).</param>
        public SearchRequestMetaPagination(int limit = 25, int offset = 0)
        {
            this.Limit = limit;
            this.Offset = offset;
        }
        ...
        /// </summary>
        /// <value>Number of results to return per page.</value>
        ...
        {
            return this.Equals(input as SearchRequestMetaPagination);
        }

        /// <summary>
        /// Returns true if SearchRequestMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchRequestMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchRequestMetaPagination input)
        {
            if (input == null)
            {
                return false;
