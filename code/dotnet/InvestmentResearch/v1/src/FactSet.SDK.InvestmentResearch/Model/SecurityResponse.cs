...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    /// Security Type
    /// </summary>
    [DataContract(Name = "SecurityResponse")]
    public partial class SecurityResponse : IEquatable<SecurityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityResponse" /> class.
        /// </summary>
        /// <param name="securityTypes">Array of supported security types..</param>
        public SecurityResponse(List<string> securityTypes = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Array of supported security types.</value>
        ...
        {
            return this.Equals(input as SecurityResponse);
        }

        /// <summary>
        /// Returns true if SecurityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityResponse input)
        {
            if (input == null)
            {
                return false;
