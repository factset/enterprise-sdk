...
namespace FactSet.SDK.InvestmentResearch.Api
{
    ...
    public interface IResearchApiSync : IApiAccessor
    {
        ...
        ApiResponse<PurchaseResponse> GetPurchaseLinksWithHttpInfo(PurchaseRequest purchaseRequest);
    ...
    public interface IResearchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PurchaseResponse> GetPurchaseLinksAsync(PurchaseRequest purchaseRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PurchaseResponse>> GetPurchaseLinksWithHttpInfoAsync(PurchaseRequest purchaseRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ResearchApi : IResearchApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetPurchaseLinksResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(PurchaseResponse) },
            { (HttpStatusCode)400, typeof(ErrorResponse) },
            { (HttpStatusCode)401, typeof(ErrorResponse) },
            { (HttpStatusCode)403, typeof(ErrorResponse) },
            { (HttpStatusCode)500, typeof(ErrorResponse) },
        ...
        /// <summary>
        /// Returns the count of documents for specified source. Returns the available count of documents (up to 10000) based on search criteria. This endpoint accepts up to 10 IDs per request.
        /// </summary>
        /// <exception cref="FactSet.SDK.InvestmentResearch.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="countRequest"></param>
        /// <returns>CountResponse</returns>
        ...
        /// <summary>
        /// Retrieve purchase links and metadata for specified research documents. Returns a purchase link (link to the full document) along with document metadata for each requested document ID. Primarily used for documents sourced from Aftermarket Research (AMR), where full-document access is via a purchase link distinct from the preview link returned by &#x60;/search&#x60;.  **Note:** A successful request to this endpoint is treated as a purchase and counts toward the pool subscription. If the same research report is requested again more than 24 hours after the original request, that later request counts toward the individual user&#39;s subscription count instead. 
        /// </summary>
        /// <exception cref="FactSet.SDK.InvestmentResearch.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="purchaseRequest"></param>
        /// <returns>PurchaseResponse</returns>
        public PurchaseResponse GetPurchaseLinks(PurchaseRequest purchaseRequest)
        {
            var localVarResponse = GetPurchaseLinksWithHttpInfo(purchaseRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="purchaseRequest"></param>
        /// <returns>ApiResponse of PurchaseResponse</returns>
        public ApiResponse<PurchaseResponse> GetPurchaseLinksWithHttpInfo(PurchaseRequest purchaseRequest)
        {
            // verify the required parameter 'purchaseRequest' is set
            if (purchaseRequest == null)
            {
                throw new FactSet.SDK.InvestmentResearch.Client.ApiException(400, "Missing required parameter 'purchaseRequest' when calling ResearchApi->GetPurchaseLinks");
            }
            ...
            localVarRequestOptions.Data = purchaseRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetPurchaseLinksResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Post<
            PurchaseResponse>("/purchase-amr", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPurchaseLinks", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PurchaseResponse</returns>
        public async System.Threading.Tasks.Task<PurchaseResponse>GetPurchaseLinksAsync(PurchaseRequest purchaseRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetPurchaseLinksWithHttpInfoAsync(purchaseRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<PurchaseResponse>> GetPurchaseLinksWithHttpInfoAsync(PurchaseRequest purchaseRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'purchaseRequest' is set
            if (purchaseRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<PurchaseResponse>("/purchase-amr", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
