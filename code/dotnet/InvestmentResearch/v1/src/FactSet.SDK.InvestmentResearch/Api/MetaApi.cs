...
namespace FactSet.SDK.InvestmentResearch.Api
{
    ...
    public partial class MetaApi : IMetaApi
    {
        ...
        /// <summary>
        /// Returns the research contributors&#39; details. Retrieves and delivers a comprehensive list of all the Contributor IDs that your firm is permissioned to view. This endpoint is applicable to FactSet Research Connect (FRC) contributors only.
        /// </summary>
        /// <exception cref="FactSet.SDK.InvestmentResearch.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ResearchContributorResponse</returns>
