# FactSet.SDK.InvestmentResearch.Api.MetaApi
...
namespace Example
{
    public class GetResearchAnalystExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.InvestmentResearch.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling MetaApi.GetResearchAnalyst: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
------------- | ------------- | ------------- | -------------
 **contributorId** | **int**| Contributor id. Use the &#x60;&#x60;&#x60;/meta/research-contributors&#x60;&#x60;&#x60; endpoint to get the list of permissioned contributors. | 
...
<a name="getresearchcontributor"></a>
...
namespace Example
{
    public class GetResearchContributorExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.InvestmentResearch.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling MetaApi.GetResearchContributor: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSecurityTypesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling MetaApi.GetSecurityTypes: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetTimezonesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling MetaApi.GetTimezones: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
