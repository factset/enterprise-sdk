...
[![Nuget](https://img.shields.io/badge/nuget-v0.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.InvestmentResearch/0.1.0)
...
dotnet add package FactSet.SDK.InvestmentResearch -v 0.1.0
```
...
nuget install FactSet.SDK.InvestmentResearch -Version 0.1.0
```
