...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    /// Contributor details
    /// </summary>
    [DataContract(Name = "ResearchContributorResponseObject")]
    public partial class ResearchContributorResponseObject : IEquatable<ResearchContributorResponseObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResearchContributorResponseObject" /> class.
        /// </summary>
        /// <param name="contributorName">Name of the contributor.</param>
        /// <param name="contributorId">Identifier associated with the contributor..</param>
        public ResearchContributorResponseObject(string contributorName = default(string), int contributorId = default(int))
        {
        ...
        /// </summary>
        /// <value>Identifier associated with the contributor.</value>
        ...
        {
            return this.Equals(input as ResearchContributorResponseObject);
        }

        /// <summary>
        /// Returns true if ResearchContributorResponseObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ResearchContributorResponseObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResearchContributorResponseObject input)
        {
            if (input == null)
            {
                return false;
