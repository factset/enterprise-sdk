...
namespace FactSet.SDK.InvestmentResearch.Model
{
    ...
    /// Meta Object
    /// </summary>
    [DataContract(Name = "InvestmentResearchResponse_meta")]
    public partial class InvestmentResearchResponseMeta : IEquatable<InvestmentResearchResponseMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentResearchResponseMeta" /> class.
        /// </summary>
        /// <param name="pagination">pagination.</param>
        public InvestmentResearchResponseMeta(InvestmentResearchResponseMetaPagination pagination = default(InvestmentResearchResponseMetaPagination))
        {
        ...
        public InvestmentResearchResponseMetaPagination Pagination { get; set; }
        ...
        {
            return this.Equals(input as InvestmentResearchResponseMeta);
        }

        /// <summary>
        /// Returns true if InvestmentResearchResponseMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of InvestmentResearchResponseMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvestmentResearchResponseMeta input)
        {
            if (input == null)
            {
                return false;
