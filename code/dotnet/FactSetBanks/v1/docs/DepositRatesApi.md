# FactSet.SDK.FactSetBanks.Api.DepositRatesApi
...
namespace Example
{
    public class GetRatesExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new DepositRatesApi(config);

            var ratesRequest = new RatesRequest(); // RatesRequest | 
            ...
            {
                Console.WriteLine("Exception when calling DepositRatesApi.GetRates: " + e.Message );
