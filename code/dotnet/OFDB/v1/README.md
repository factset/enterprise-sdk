...
------------ | ------------- | ------------- | -------------
*CreateApi* | [**AddSymbolDate**](docs/CreateApi.md#addsymboldate) | **POST** /v1/database/{path}/dates | 
*CreateApi* | [**AddSymbolDate3D**](docs/CreateApi.md#addsymboldate3d) | **POST** /v1/database/{path}/dates/{date}/symbols | 
*CreateApi* | [**AddSymbols**](docs/CreateApi.md#addsymbols) | **POST** /v1/database/{path}/symbols | 
*CreateApi* | [**CreateDatabase**](docs/CreateApi.md#createdatabase) | **POST** /v1/database/ | 
*ModifyApi* | [**DeleteDates**](docs/ModifyApi.md#deletedates) | **DELETE** /v1/database/{path}/dates/{date} | 
*ModifyApi* | [**DeleteSymbolDate3D**](docs/ModifyApi.md#deletesymboldate3d) | **DELETE** /v1/database/{path}/dates/{date}/symbols/{symbol} | 
*ModifyApi* | [**DeleteSymbols**](docs/ModifyApi.md#deletesymbols) | **DELETE** /v1/database/{path}/symbols/{symbol} | 
*ModifyApi* | [**UpdateSymbolDate**](docs/ModifyApi.md#updatesymboldate) | **PUT** /v1/database/{path}/dates/{date} | 
*ModifyApi* | [**UpdateSymbolDate3D**](docs/ModifyApi.md#updatesymboldate3d) | **PUT** /v1/database/{path}/dates/{date}/symbols/{symbol} | 
*ModifyApi* | [**UpdateSymbols**](docs/ModifyApi.md#updatesymbols) | **PUT** /v1/database/{path}/symbols/{symbol} | 
*ViewApi* | [**GetDatabase**](docs/ViewApi.md#getdatabase) | **GET** /v1/database/{path} | 
*ViewApi* | [**GetDates**](docs/ViewApi.md#getdates) | **GET** /v1/database/{path}/dates | 
*ViewApi* | [**GetFields**](docs/ViewApi.md#getfields) | **GET** /v1/database/{path}/fields | 
*ViewApi* | [**GetSymbols**](docs/ViewApi.md#getsymbols) | **GET** /v1/database/{path}/symbols | 


## Documentation for Models

 - [Model.AddDatabase](docs/AddDatabase.md)
 - [Model.AddSymbolDate](docs/AddSymbolDate.md)
 - [Model.AddSymbolDate3D](docs/AddSymbolDate3D.md)
 - [Model.AddSymbolDate3DData](docs/AddSymbolDate3DData.md)
 - [Model.AddSymbolDateData](docs/AddSymbolDateData.md)
 ...
 - [Model.UpdateSymbolDate](docs/UpdateSymbolDate.md)
 - [Model.UpdateSymbolDate3D](docs/UpdateSymbolDate3D.md)
 - [Model.UpdateSymbolDate3DData](docs/UpdateSymbolDate3DData.md)
