...
namespace Example
{
    public class V1DatabasePathDatesDateSymbolsPostExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CreateApi.V1DatabasePathDatesDateSymbolsPost: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1DatabasePathDatesPostExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CreateApi.V1DatabasePathDatesPost: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1DatabasePathSymbolsPostExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling CreateApi.V1DatabasePathSymbolsPost: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
