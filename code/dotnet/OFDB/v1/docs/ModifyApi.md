# FactSet.SDK.OFDB.Api.ModifyApi
...
namespace Example
{
    public class DeleteDatesExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse202 result = apiInstance.DeleteDates(path, date);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ModifyApi.DeleteDates: " + e.Message );
...
namespace Example
{
    public class DeleteSymbolDate3DExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse202 result = apiInstance.DeleteSymbolDate3D(path, date, symbol);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ModifyApi.DeleteSymbolDate3D: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class DeleteSymbolsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse202 result = apiInstance.DeleteSymbols(path, symbol);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ModifyApi.DeleteSymbols: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpdateSymbolDateExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            var path = "path_example";  // string | Encode database path
            var date = 56;  // int | Date in YYYYMMDD format
            var updateSymbolDate = new UpdateSymbolDate(); // UpdateSymbolDate | Required data for updating date in the database

            try
            {
                SuccessPostResponse result = apiInstance.UpdateSymbolDate(path, date, updateSymbolDate);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ModifyApi.UpdateSymbolDate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpdateSymbolDate3DExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            var date = 56;  // int | Date in YYYYMMDD format
            var symbol = "symbol_example";  // string | Symbol with in the ofdb
            var updateSymbolDate3D = new UpdateSymbolDate3D(); // UpdateSymbolDate3D | Data for updating symbol in the database

            try
            {
                SuccessPostResponse result = apiInstance.UpdateSymbolDate3D(path, date, symbol, updateSymbolDate3D);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ModifyApi.UpdateSymbolDate3D: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpdateSymbolsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            var path = "path_example";  // string | Encode database path
            var symbol = "symbol_example";  // string | Symbol with in the ofdb
            var updateSymbols = new UpdateSymbols(); // UpdateSymbols | Data for updating symbol in the database

            try
            {
                SuccessPostResponse result = apiInstance.UpdateSymbols(path, symbol, updateSymbols);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ModifyApi.UpdateSymbols: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
