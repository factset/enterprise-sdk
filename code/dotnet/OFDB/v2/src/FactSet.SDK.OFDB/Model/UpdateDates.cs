...
namespace FactSet.SDK.OFDB.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateDates")]
    public partial class UpdateDates : IEquatable<UpdateDates>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateDates);
        }

        /// <summary>
        /// Returns true if UpdateDates instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDates input)
        {
            if (input == null)
            {
                return false;
