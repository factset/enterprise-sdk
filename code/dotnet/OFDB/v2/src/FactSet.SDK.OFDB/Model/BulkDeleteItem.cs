...
namespace FactSet.SDK.OFDB.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkDeleteItem")]
    public partial class BulkDeleteItem : IEquatable<BulkDeleteItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkDeleteItem" /> class.
        /// </summary>
        /// <param name="symbol">symbol.</param>
        /// <param name="date">date.</param>
        /// <param name="field">field.</param>
        public BulkDeleteItem(string symbol = default(string), int date = default(int), string field = default(string))
        {
            this.Symbol = symbol;
            this.Date = date;
            this.Field = field;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkDeleteItem {\n");
        ...
        {
            return this.Equals(input as BulkDeleteItem);
        }

        /// <summary>
        /// Returns true if BulkDeleteItem instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkDeleteItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkDeleteItem input)
        {
            if (input == null)
            {
                return false;
