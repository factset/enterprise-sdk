...
namespace FactSet.SDK.OFDB.Model
{
    ...
    /// BulkDelete
    /// </summary>
    [DataContract(Name = "BulkDelete")]
    public partial class BulkDelete : IEquatable<BulkDelete>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BulkDelete);
        }

        /// <summary>
        /// Returns true if BulkDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkDelete input)
        {
            if (input == null)
            {
                return false;
