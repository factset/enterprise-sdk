...
[![Nuget](https://img.shields.io/badge/nuget-v0.32.1-orange)](https://www.nuget.org/packages/FactSet.SDK.OFDB/0.32.1)
...
dotnet add package FactSet.SDK.OFDB -v 0.32.1
```
...
nuget install FactSet.SDK.OFDB -Version 0.32.1
```
