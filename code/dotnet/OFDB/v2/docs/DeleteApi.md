# FactSet.SDK.OFDB.Api.DeleteApi
...
[**GetResourceDateFromSymbol**](DeleteApi.md#getresourcedatefromsymbol) | **DELETE** /database/{path}/dates/{date}/symbols/{symbol}/jobs/{id} | 



<a name="deletebulkitems"></a>
# **DeleteBulkItems**
> InlineResponse202 DeleteBulkItems (string path, BulkDelete bulkDelete = null)
...
namespace Example
{
    public class DeleteBulkItemsExample
    {
        public static async Task Main()
        {
            ...
            var bulkDelete = new BulkDelete(); // BulkDelete |  (optional) 

            try
            {
                InlineResponse202 result = apiInstance.DeleteBulkItems(path, bulkDelete);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DeleteApi.DeleteBulkItems: " + e.Message );
...
namespace Example
{
    public class DeleteDateExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse202 result = apiInstance.DeleteDate(path, date);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DeleteApi.DeleteDate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class DeleteDateFromSymbolExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse202 result = apiInstance.DeleteDateFromSymbol(path, date, symbol);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DeleteApi.DeleteDateFromSymbol: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class DeleteSymbolExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse202 result = apiInstance.DeleteSymbol(path, symbol);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DeleteApi.DeleteSymbol: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getresourcedatefromsymbol"></a>
...
namespace Example
{
    public class GetResourceDateFromSymbolExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse202 result = apiInstance.GetResourceDateFromSymbol(path, date, symbol, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DeleteApi.GetResourceDateFromSymbol: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Returns when the request is moved to long running mode. The next pickup URL is provided by the Location header. |  * Location -  <br>  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  |
| **204** | Resource is deleted successfully |  -  |
| **400** | Invalid query parameter or value provided |  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  |
| **403** | User is forbidden with current credentials |  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  |
| **404** | Path not found |  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  |
