...
------------- | ------------- | -------------
[**GetResourceAudit**](LongRunningApi.md#getresourceaudit) | **GET** /database/{path}/audit/jobs/{id} | 
[**GetResourceBulkDelete**](LongRunningApi.md#getresourcebulkdelete) | **GET** /database/{path}/delete/jobs/{id} | 
[**GetResourceData**](LongRunningApi.md#getresourcedata) | **GET** /database/{path}/jobs/{id} | 
[**GetResourceDatabase**](LongRunningApi.md#getresourcedatabase) | **GET** /database/jobs/{id} | 
[**GetResourceDate**](LongRunningApi.md#getresourcedate) | **GET** /database/{path}/dates/{date}/jobs/{id} | 
[**GetResourceDates**](LongRunningApi.md#getresourcedates) | **GET** /database/{path}/dates/jobs/{id} | 
[**GetResourceFields**](LongRunningApi.md#getresourcefields) | **GET** /database/{path}/fields/jobs/{id} | 
[**GetResourceStats**](LongRunningApi.md#getresourcestats) | **GET** /database/{path}/stats/jobs/{id} | 
[**GetResourceSymbol**](LongRunningApi.md#getresourcesymbol) | **GET** /database/{path}/symbols/{symbol}/jobs/{id} | 
[**GetResourceSymbols**](LongRunningApi.md#getresourcesymbols) | **GET** /database/{path}/symbols/jobs/{id} | 
[**GetStatus**](LongRunningApi.md#getstatus) | **GET** /database/jobs/{id}/status | 



<a name="getresourceaudit"></a>
# **GetResourceAudit**
...
namespace Example
{
    public class GetResourceAuditExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse200 result = apiInstance.GetResourceAudit(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceAudit: " + e.Message );
...
<a name="getresourcebulkdelete"></a>
...
namespace Example
{
    public class GetResourceBulkDeleteExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse2003 result = apiInstance.GetResourceBulkDelete(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceBulkDelete: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceDataExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse2006 result = apiInstance.GetResourceData(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceData: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceDatabaseExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                CreateDatabase result = apiInstance.GetResourceDatabase(id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceDatabase: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceDateExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                SuccessPostResponse result = apiInstance.GetResourceDate(path, date, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceDate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceDatesExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse2005 result = apiInstance.GetResourceDates(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceDates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceFieldsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse2002 result = apiInstance.GetResourceFields(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceStatsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse2001 result = apiInstance.GetResourceStats(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceStats: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceSymbolExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                SuccessPostResponse result = apiInstance.GetResourceSymbol(path, symbol, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceSymbol: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceSymbolsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            try
            {
                InlineResponse2004 result = apiInstance.GetResourceSymbols(path, id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling LongRunningApi.GetResourceSymbols: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
