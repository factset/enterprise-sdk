...
namespace FactSet.SDK.OFDB.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/OFDB/0.0.3";
            BasePath = "https://api.factset.com/analytics/ofdb/v3";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/analytics/ofdb/v3"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/ofdb/v3") : this()
        {
