...
<a name="getdates"></a>
# **GetDates**
> InlineResponse201 GetDates (DatabasePathRoot databasePathRoot = null)
...
namespace Example
{
    public class GetDatesExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse201 result = apiInstance.GetDates(databasePathRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DatesApi.GetDates: " + e.Message );
...
namespace Example
{
    public class GetResourceGetDatesExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse2005 result = apiInstance.GetResourceGetDates(jobId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DatesApi.GetResourceGetDates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class ReplaceDatesExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            var addDatesRoot = new AddDatesRoot(); // AddDatesRoot | Date content is required and must contain symbol and at least one iterative field

            try
            {
                InlineResponse201 result = apiInstance.ReplaceDates(addDatesRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DatesApi.ReplaceDates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpdateDatesExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            var updateDatesRoot = new UpdateDatesRoot(); // UpdateDatesRoot | Required data for updating date in the database

            try
            {
                InlineResponse201 result = apiInstance.UpdateDates(updateDatesRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling DatesApi.UpdateDates: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
