# FactSet.SDK.OFDB.Api.SymbolsApi
...
> InlineResponse2004 GetResourceGetSymbols (string jobId)
...
namespace Example
{
    public class GetResourceGetSymbolsExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new SymbolsApi(config);

            var jobId = "jobId_example";  // string | jobId generated from the audit endpoint.

            try
            {
                InlineResponse2004 result = apiInstance.GetResourceGetSymbols(jobId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SymbolsApi.GetResourceGetSymbols: " + e.Message );
...
<a name="getsymbols"></a>
# **GetSymbols**
> InlineResponse201 GetSymbols (DatabasePathRoot databasePathRoot = null)
...
namespace Example
{
    public class GetSymbolsExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse201 result = apiInstance.GetSymbols(databasePathRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SymbolsApi.GetSymbols: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="replacesymbols"></a>
# **ReplaceSymbols**
> InlineResponse201 ReplaceSymbols (AddSymbolsRoot addSymbolsRoot)
...
namespace Example
{
    public class ReplaceSymbolsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.OFDB.Client.Configuration();
            ...
            var addSymbolsRoot = new AddSymbolsRoot(); // AddSymbolsRoot | Data for creating symbol in the database

            try
            {
                InlineResponse201 result = apiInstance.ReplaceSymbols(addSymbolsRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SymbolsApi.ReplaceSymbols: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
# **UpdateSymbols**
> InlineResponse201 UpdateSymbols (UpdateSymbolsRoot updateSymbolsRoot)
...
namespace Example
{
    public class UpdateSymbolsExample
    {
        public static async Task Main()
        {
            ...
            var updateSymbolsRoot = new UpdateSymbolsRoot(); // UpdateSymbolsRoot | Data for updating symbol in the database

            try
            {
                InlineResponse201 result = apiInstance.UpdateSymbols(updateSymbolsRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SymbolsApi.UpdateSymbols: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
