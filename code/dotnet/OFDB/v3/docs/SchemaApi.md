# FactSet.SDK.OFDB.Api.SchemaApi
...
namespace Example
{
    public class AddFieldsExample
    {
        public static async Task Main()
        {
            ...
            var addFieldsRoot = new AddFieldsRoot(); // AddFieldsRoot | Data for creating fields in the database.

            try
            {
                InlineResponse201 result = apiInstance.AddFields(addFieldsRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SchemaApi.AddFields: " + e.Message );
...
# **CreateDatabase**
> InlineResponse201 CreateDatabase (CreateDatabaseRoot createDatabaseRoot = null)
...
namespace Example
{
    public class CreateDatabaseExample
    {
        public static async Task Main()
        {
            ...
            var createDatabaseRoot = new CreateDatabaseRoot(); // CreateDatabaseRoot |  (optional) 

            try
            {
                InlineResponse201 result = apiInstance.CreateDatabase(createDatabaseRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SchemaApi.CreateDatabase: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getfields"></a>
# **GetFields**
> InlineResponse201 GetFields (DatabasePathRoot databasePathRoot = null)
...
namespace Example
{
    public class GetFieldsExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse201 result = apiInstance.GetFields(databasePathRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SchemaApi.GetFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetResourceGetFieldsExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse2002 result = apiInstance.GetResourceGetFields(jobId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling SchemaApi.GetResourceGetFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
