# FactSet.SDK.OFDB.Api.BulkDeleteApi
...
# **DeleteBulkItems**
> InlineResponse201 DeleteBulkItems (BulkDeleteRoot bulkDeleteRoot = null)
...
namespace Example
{
    public class DeleteBulkItemsExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new BulkDeleteApi(config);

            var bulkDeleteRoot = new BulkDeleteRoot(); // BulkDeleteRoot |  (optional) 

            try
            {
                InlineResponse201 result = apiInstance.DeleteBulkItems(bulkDeleteRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling BulkDeleteApi.DeleteBulkItems: " + e.Message );
...
namespace Example
{
    public class GetResourceDeleteBulkItemsExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse2003 result = apiInstance.GetResourceDeleteBulkItems(jobId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling BulkDeleteApi.GetResourceDeleteBulkItems: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
