...
namespace Example
{
    public class GetResourceGetStatsExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse2001 result = apiInstance.GetResourceGetStats(jobId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling StatsApi.GetResourceGetStats: " + e.Message );
...
|-------------|-------------|------------------|
| **200** | Returns an object with key database stats |  * X-DataDirect-Request-Key -  <br>  * X-FactSet-Api-Request-Key -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  |
...
<a name="getstats"></a>
# **GetStats**
> InlineResponse201 GetStats (DatabasePathRoot databasePathRoot = null)
...
namespace Example
{
    public class GetStatsExample
    {
        public static async Task Main()
        {
            ...
            try
            {
                InlineResponse201 result = apiInstance.GetStats(databasePathRoot);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling StatsApi.GetStats: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
