...
<a name="getaudit"></a>
# **GetAudit**
> InlineResponse201 GetAudit (DatabasePathRoot databasePathRoot = null)
...
# **GetResourceGetAudit**
> InlineResponse200 GetResourceGetAudit (string jobId)
...
namespace Example
{
    public class GetResourceGetAuditExample
    {
        public static async Task Main()
        {
            ...
            var jobId = "jobId_example";  // string | jobId generated from the audit endpoint.

            try
            {
                InlineResponse200 result = apiInstance.GetResourceGetAudit(jobId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling AuditApi.GetResourceGetAudit: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
