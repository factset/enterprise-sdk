# FactSet.SDK.OFDB.Api.JobStatusApi
...
<a name="getdatabasestatusbyid"></a>
...
namespace Example
{
    public class GetDatabaseStatusByIdExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new JobStatusApi(config);

            var jobId = "jobId_example";  // string | jobId generated from the database endpoints.
            ...
            {
                Console.WriteLine("Exception when calling JobStatusApi.GetDatabaseStatusById: " + e.Message );
