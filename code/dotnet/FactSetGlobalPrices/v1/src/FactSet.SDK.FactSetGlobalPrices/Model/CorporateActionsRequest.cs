...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    public partial class CorporateActionsRequest : IEquatable<CorporateActionsRequest>, IValidatableObject
    {
        ...
        public CorporateActionsRequest(List<string> ids,EventCategory eventCategory = default(EventCategory), List<string> fields = default(List<string>), string startDate = default(string), string endDate = default(string), string currency = "LOCAL", CancelledDividend cancelledDividend = default(CancelledDividend), Batch batch = default(Batch))
        {
