...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    public partial class ReturnsRequest : IEquatable<ReturnsRequest>, IValidatableObject
    {
        ...
        public ReturnsRequest(List<string> ids, string startDate,string endDate = default(string), string currency = default(string), Frequency frequency = default(Frequency), DividendAdjust dividendAdjust = default(DividendAdjust))
        {
