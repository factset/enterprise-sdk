...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    public partial class Split : IEquatable<Split>, IValidatableObject
    {
        ...
        public Split(string fsymId = default(string), string eventId = default(string), EventTypeCodeEnum? eventTypeCode = default(EventTypeCodeEnum?), string eventTypeDesc = default(string), string announcementDate = default(string), string recordDate = default(string), string payDate = default(string), string effectiveDate = default(string), double adjFactor = default(double), double adjFactorCombined = default(double), double distOldTerm = default(double), double distNewTerm = default(double), string shortDesc = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
