...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    public partial class MarketValueResponseObject : IEquatable<MarketValueResponseObject>, IValidatableObject
    {
        ...
        /// <param name="currency">Currency ISO code associated with the market value. For more details, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470)..</param>
        /// <param name="date">Current Market Value Date.</param>
        public MarketValueResponseObject(string fsymId = default(string), string requestId = default(string), decimal? currentMarketValue = default(decimal?), string currency = default(string), DateTime? date = default(DateTime?))
        {
            this.FsymId = fsymId;
        ...
        /// </summary>
        /// <value>Currency ISO code associated with the market value. For more details, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470).</value>
