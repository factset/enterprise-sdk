...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    /// SplitCalendar
    /// </summary>
    [DataContract(Name = "SplitCalendar")]
    public partial class SplitCalendar : IEquatable<SplitCalendar>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitCalendar" /> class.
        /// </summary>
        ...
        public SplitCalendar(string fsymId = default(string), string eventId = default(string), EventTypeCodeEnum? eventTypeCode = default(EventTypeCodeEnum?), string eventTypeDesc = default(string), string announcementDate = default(string), string recordDate = default(string), string payDate = default(string), string effectiveDate = default(string), double adjFactor = default(double), double adjFactorCombined = default(double), double? distOldTerm = default(double?), double? distNewTerm = default(double?), string distInstFsymId = default(string), string shortDesc = default(string), string requestId = default(string), string identifier = default(string), ErrorObjectResponse error = default(ErrorObjectResponse))
        {
            this.FsymId = fsymId;
        ...
        [DataMember(Name = "distOldTerm", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "distNewTerm", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as SplitCalendar);
        }

        /// <summary>
        /// Returns true if SplitCalendar instances are equal
        /// </summary>
        /// <param name="input">Instance of SplitCalendar to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SplitCalendar input)
        {
            if (input == null)
            {
                return false;
