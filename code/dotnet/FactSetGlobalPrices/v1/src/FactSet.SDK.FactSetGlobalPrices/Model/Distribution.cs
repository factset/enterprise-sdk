...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    public partial class Distribution : IEquatable<Distribution>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum DVS for value: DVS
            /// </summary>
            [EnumMember(Value = "DVS")]
            DVS = 1,

            /// <summary>
            /// Enum DVSS for value: DVSS
            /// </summary>
            [EnumMember(Value = "DVSS")]
            DVSS = 2,

            /// <summary>
            /// Enum BNS for value: BNS
            /// </summary>
            [EnumMember(Value = "BNS")]
            BNS = 3,

            /// <summary>
            /// Enum BNSS for value: BNSS
            /// </summary>
            [EnumMember(Value = "BNSS")]
            BNSS = 4,

            /// <summary>
            /// Enum SPO for value: SPO
            /// </summary>
            [EnumMember(Value = "SPO")]
            SPO = 5,

            /// <summary>
            /// Enum DSR for value: DSR
            /// </summary>
        ...
        /// <param name="distPct">Distribution percentage of the event  (i.e. 10%). Typical for stock distributions..</param>
        ...
        /// <param name="rightsIssuePrice">Description.</param>
        /// <param name="rightsIssueCurrency">Description.</param>
        /// <param name="shortDesc">Textual description identifying the event..</param>
        /// <param name="requestId">Identifier that was used for the request..</param>
        public Distribution(string fsymId = default(string), string eventId = default(string), EventTypeCodeEnum? eventTypeCode = default(EventTypeCodeEnum?), string eventTypeDesc = default(string), string announcementDate = default(string), string recordDate = default(string), string payDate = default(string), string effectiveDate = default(string), double adjFactor = default(double), double adjFactorCombined = default(double), double amtDefTradingAdj = default(double), double amtDefTradingUnadj = default(double), string currency = default(string), double distPct = default(double), double distOldTerm = default(double), double distNewTerm = default(double), double rightsIssuePrice = default(double), string rightsIssueCurrency = default(string), string shortDesc = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
        ...
        /// </summary>
        /// <value>Distribution percentage of the event  (i.e. 10%). Typical for stock distributions.</value>
        [DataMember(Name = "distPct", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "rightsIssuePrice", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Description</value>
        [DataMember(Name = "rightsIssueCurrency", EmitDefaultValue = false)]
        ...
        public bool Equals(Distribution input)
        {
            ...
            return 
                ...
                (
                    this.DistPct == input.DistPct ||
                    this.DistPct.Equals(input.DistPct)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DistPct.GetHashCode();
