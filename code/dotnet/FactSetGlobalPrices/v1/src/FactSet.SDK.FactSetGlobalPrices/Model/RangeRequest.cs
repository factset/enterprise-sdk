...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    /// Range Request Body
    /// </summary>
    [DataContract(Name = "RangeRequest")]
    public partial class RangeRequest : IEquatable<RangeRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeRequest" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="RangeRequest" /> class.
        /// </summary>
        /// <param name="ids">The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent IDs. Requests are limited to 50 IDs for non-batch requests and 1000 for batch requests.  (required).</param>
        ...
        /// <param name="endDate">The end date requested for a given date range in **YYYY-MM-DD** format. The input end date is required and must come after the input start date. Future dates (T+1) are not accepted in this endpoint.  (required).</param>
        ...
        public RangeRequest(List<string> ids, string startDate, string endDate,string currency = "LOCAL", DividendAdjust dividendAdjust = default(DividendAdjust), Batch batch = default(Batch))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for RangeRequest and cannot be null");
            }
            this.Ids = ids;
            // to ensure "startDate" is required (not null)
            if (startDate == null) {
                throw new ArgumentNullException("startDate is a required property for RangeRequest and cannot be null");
            }
            this.StartDate = startDate;
            // to ensure "endDate" is required (not null)
            if (endDate == null) {
                throw new ArgumentNullException("endDate is a required property for RangeRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent IDs. Requests are limited to 50 IDs for non-batch requests and 1000 for batch requests. </value>
        ...
        /// </summary>
        /// <value>The end date requested for a given date range in **YYYY-MM-DD** format. The input end date is required and must come after the input start date. Future dates (T+1) are not accepted in this endpoint. </value>
        ...
        {
            return this.Equals(input as RangeRequest);
        }

        /// <summary>
        /// Returns true if RangeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RangeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RangeRequest input)
        {
            if (input == null)
            {
                return false;
