...
namespace FactSet.SDK.FactSetGlobalPrices.Model
{
    ...
    public partial class GlobalPricesRequest : IEquatable<GlobalPricesRequest>, IValidatableObject
    {
        ...
        public GlobalPricesRequest(List<string> ids, string startDate,List<string> fields = default(List<string>), string endDate = default(string), Frequency frequency = default(Frequency), string currency = "LOCAL", Calendar calendar = default(Calendar), Adjust adjust = default(Adjust), Batch batch = default(Batch))
        {
