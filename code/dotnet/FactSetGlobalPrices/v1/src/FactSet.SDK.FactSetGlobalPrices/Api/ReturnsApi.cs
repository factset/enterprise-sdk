...
namespace FactSet.SDK.FactSetGlobalPrices.Api
{
    ...
    public interface IReturnsApiSync : IApiAccessor
    {
        ...
        /// <param name="dividendAdjust">Controls the dividend reinvestment for the returns calculation.   * **PRICE** &#x3D; Price Change - Dividends Excluded.   * **EXDATE** &#x3D; Simple Return - Dividends Received on exdate but not reinvested.   * **EXDATE_C** &#x3D; Compound Return - Dividends reinvested on exdate.      (optional, default to EXDATE_C)</param>
