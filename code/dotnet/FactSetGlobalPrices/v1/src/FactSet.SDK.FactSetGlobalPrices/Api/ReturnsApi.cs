...
namespace FactSet.SDK.FactSetGlobalPrices.Api
{
    ...
    public interface IReturnsApiSync : IApiAccessor
    {
        ...
        ReturnsResponse GetReturns(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string));
        ...
        ApiResponse<ReturnsResponse> GetReturnsWithHttpInfo(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string));
        /// <summary>
        /// Gets Returns for a list of &#x60;ids&#x60; as of given date range.
        /// </summary>
        /// <remarks>
    ...
    public interface IReturnsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ReturnsResponse> GetReturnsAsync(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ReturnsResponse>> GetReturnsWithHttpInfoAsync(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Gets Returns for a list of &#x60;ids&#x60; as of given date range.
        /// </summary>
        /// <remarks>
    ...
    public partial class ReturnsApi : IReturnsApi
    {
        ...
        /// <param name="frequency">Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **AD** &#x3D; Actual Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **AQ** &#x3D;  Actual Quarterly   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **ASA** &#x3D; Actual Semi-annual   * **CSA** &#x3D; Calendar Semi-annual   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.  (optional, default to D)</param>
        /// <returns>ReturnsResponse</returns>
        public ReturnsResponse GetReturns(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string))
        {
            var localVarResponse = GetReturnsWithHttpInfo(ids, startDate, endDate, currency, frequency);
        ...
        /// <param name="frequency">Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **AD** &#x3D; Actual Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **AQ** &#x3D;  Actual Quarterly   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **ASA** &#x3D; Actual Semi-annual   * **CSA** &#x3D; Calendar Semi-annual   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.  (optional, default to D)</param>
        /// <returns>ApiResponse of ReturnsResponse</returns>
        public ApiResponse<ReturnsResponse> GetReturnsWithHttpInfo(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string))
        {
            ...
            if (endDate == null)
            {
                throw new FactSet.SDK.FactSetGlobalPrices.Client.ApiException(400, "Missing required parameter 'endDate' when calling ReturnsApi->GetReturns");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ReturnsResponse</returns>
        public async System.Threading.Tasks.Task<ReturnsResponse>GetReturnsAsync(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetReturnsWithHttpInfoAsync(ids, startDate, endDate, currency, frequency, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ReturnsResponse>> GetReturnsWithHttpInfoAsync(List<string> ids, string startDate, string endDate, string currency = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
