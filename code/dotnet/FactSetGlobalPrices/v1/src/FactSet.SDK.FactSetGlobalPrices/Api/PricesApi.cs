...
namespace FactSet.SDK.FactSetGlobalPrices.Api
{
    ...
    public partial class PricesApi : IPricesApi
    {
        ...
        {
            var localVarResponse = GetGPDPricesWithHttpInfo(ids, startDate, endDate, fields, frequency, calendar, currency, adjust);
        ...
        /// <param name="adjust">Controls the split and spinoff adjustments for the prices.   * **SPLIT** &#x3D; Split ONLY Adjusted. This is used by default.   * **SPLIT_SPINOFF** &#x3D; Splits &amp; Spinoff Adjusted.   * **UNSPLIT** &#x3D; No Adjustments.  (optional, default to SPLIT)</param>
        /// <returns>ApiResponse of GlobalPricesResponse</returns>
        public ApiResponse<GlobalPricesResponse> GetGPDPricesWithHttpInfo(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string))
        {
        ...
        {
            var localVarResponse = await GetGPDPricesWithHttpInfoAsync(ids, startDate, endDate, fields, frequency, calendar, currency, adjust, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
