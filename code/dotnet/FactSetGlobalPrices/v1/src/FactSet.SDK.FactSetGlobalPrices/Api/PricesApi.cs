...
namespace FactSet.SDK.FactSetGlobalPrices.Api
{
    ...
    public interface IPricesApiSync : IApiAccessor
    {
        ...
        GlobalPricesResponse GetGPDPrices(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string));
        ...
        ApiResponse<GlobalPricesResponse> GetGPDPricesWithHttpInfo(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string));
        /// <summary>
    ...
    public interface IPricesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GlobalPricesResponse> GetGPDPricesAsync(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PricesApi : IPricesApi
    {
        ...
        /// <param name="adjust">Controls the split and spinoff adjustments for the prices.   * **SPLIT** &#x3D; Split ONLY Adjusted. This is used by default.   * **SPLIT_SPINOFF** &#x3D; Splits &amp; Spinoff Adjusted.   * **UNSPLIT** &#x3D; No Adjustments.  (optional, default to SPLIT)</param>
        /// <returns>GlobalPricesResponse</returns>
        public GlobalPricesResponse GetGPDPrices(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string))
        {
            FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse> localVarResponse = GetGPDPricesWithHttpInfo(ids, startDate, endDate, fields, frequency, calendar, currency, adjust);
        ...
        /// <param name="adjust">Controls the split and spinoff adjustments for the prices.   * **SPLIT** &#x3D; Split ONLY Adjusted. This is used by default.   * **SPLIT_SPINOFF** &#x3D; Splits &amp; Spinoff Adjusted.   * **UNSPLIT** &#x3D; No Adjustments.  (optional, default to SPLIT)</param>
        /// <returns>ApiResponse of GlobalPricesResponse</returns>
        public FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse> GetGPDPricesWithHttpInfo(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string))
        {
            ...
            if (endDate == null)
                throw new FactSet.SDK.FactSetGlobalPrices.Client.ApiException(400, "Missing required parameter 'endDate' when calling PricesApi->GetGPDPrices");
            ...
            var localVarResponse = this.Client.Get<GlobalPricesResponse>("/factset-global-prices/v1/prices", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse> localVarResponse = await GetGPDPricesWithHttpInfoAsync(ids, startDate, endDate, fields, frequency, calendar, currency, adjust, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GlobalPricesResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse>> GetGPDPricesWithHttpInfoAsync(List<string> ids, string startDate, string endDate, List<string> fields = default(List<string>), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new FactSet.SDK.FactSetGlobalPrices.Client.ApiException(400, "Missing required parameter 'ids' when calling PricesApi->GetGPDPrices");
        ...
        {
            FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse> localVarResponse = GetSecurityPricesForListWithHttpInfo(globalPricesRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="globalPricesRequest">Request object for &#x60;Prices&#x60;.</param>
        /// <returns>ApiResponse of GlobalPricesResponse</returns>
        public FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse> GetSecurityPricesForListWithHttpInfo(GlobalPricesRequest globalPricesRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<GlobalPricesResponse>("/factset-global-prices/v1/prices", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse> localVarResponse = await GetSecurityPricesForListWithHttpInfoAsync(globalPricesRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GlobalPricesResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetGlobalPrices.Client.ApiResponse<GlobalPricesResponse>> GetSecurityPricesForListWithHttpInfoAsync(GlobalPricesRequest globalPricesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'globalPricesRequest' is set
            if (globalPricesRequest == null)
                throw new FactSet.SDK.FactSetGlobalPrices.Client.ApiException(400, "Missing required parameter 'globalPricesRequest' when calling PricesApi->GetSecurityPricesForList");
