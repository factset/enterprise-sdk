...
namespace FactSet.SDK.FactSetGlobalPrices.Api
{
    ...
    public interface IPricesApiSync : IApiAccessor
    {
        ...
        /// <param name="adjust">Controls the split and spinoff adjustments for the prices.   * **SPLIT** &#x3D; Split ONLY Adjusted. This is used by default.   * **SPLIT_SPINOFF** &#x3D; Splits &amp; Spinoff Adjusted.   * **DIV_SPIN_SPLITS** &#x3D; Dividend adjustments, Spinoff, and Splits combined.   * **UNSPLIT** &#x3D; No Adjustments.     (optional, default to SPLIT)</param>
        ...
        PricesApi.GetGPDPricesResponseWrapper GetGPDPrices(List<string> ids, string startDate, List<string> fields = default(List<string>), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string), string batch = default(string));
        ...
        ApiResponse<PricesApi.GetGPDPricesResponseWrapper> GetGPDPricesWithHttpInfo(List<string> ids, string startDate, List<string> fields = default(List<string>), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string), string batch = default(string));
        /// <summary>
    ...
    public interface IPricesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PricesApi.GetGPDPricesResponseWrapper> GetGPDPricesAsync(List<string> ids, string startDate, List<string> fields = default(List<string>), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string adjust = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PricesApi : IPricesApi
    {
        ...
        {
            var localVarResponse = GetGPDPricesWithHttpInfo(ids, startDate, fields, endDate, frequency, calendar, currency, adjust, batch);
        ...
        {
            var localVarResponse = await GetGPDPricesWithHttpInfoAsync(ids, startDate, fields, endDate, frequency, calendar, currency, adjust, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
