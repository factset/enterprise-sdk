...
namespace FactSet.SDK.FactSetGlobalPrices.Api
{
    ...
    public partial class BatchProcessingApi : IBatchProcessingApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetBatchDataResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            ...
            { (HttpStatusCode)404, typeof(BatchErrorResponse) },
        };
        ...
        /// <returns></returns>
        public BatchProcessingApi(FactSet.SDK.FactSetGlobalPrices.Client.Configuration configuration)
        {
        ...
        public BatchProcessingApi(FactSet.SDK.FactSetGlobalPrices.Client.ISynchronousClient client, FactSet.SDK.FactSetGlobalPrices.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetGlobalPrices.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<BatchProcessingApi.GetBatchDataResponseWrapper> GetBatchDataWithHttpInfo(Guid id)
        {
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetGlobalPrices.Client.ClientUtils.ParameterToMultiMap("", "id", id));
            ...
            Object>("/factset-global-prices/v1/batch-result", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BatchProcessingApi.GetBatchDataResponseWrapper>> GetBatchDataWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/factset-global-prices/v1/batch-result", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<BatchStatusResponse> GetBatchStatusWithHttpInfo(Guid id)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            BatchStatusResponse>("/factset-global-prices/v1/batch-status", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BatchStatusResponse>> GetBatchStatusWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BatchStatusResponse>("/factset-global-prices/v1/batch-status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
