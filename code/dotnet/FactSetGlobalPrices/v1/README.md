...
[![API Version](https://img.shields.io/badge/api-v1.12.0-blue)](https://developer.factset.com/api-catalog/factset-global-prices-api)
[![Nuget](https://img.shields.io/badge/nuget-v2.9.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetGlobalPrices/2.9.0)
...
dotnet add package FactSet.SDK.FactSetGlobalPrices -v 2.9.0
```
...
nuget install FactSet.SDK.FactSetGlobalPrices -Version 2.9.0
```
