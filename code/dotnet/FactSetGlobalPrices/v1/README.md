...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.2-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetGlobalPrices/2.2.2)
...
dotnet add package FactSet.SDK.FactSetGlobalPrices -v 2.2.2
```
...
nuget install FactSet.SDK.FactSetGlobalPrices -Version 2.2.2
```
