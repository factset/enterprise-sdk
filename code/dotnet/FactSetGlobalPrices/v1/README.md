...
[![API Version](https://img.shields.io/badge/api-v1.11.0-blue)](https://developer.factset.com/api-catalog/factset-global-prices-api)
[![Nuget](https://img.shields.io/badge/nuget-v2.8.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetGlobalPrices/2.8.0)
...
dotnet add package FactSet.SDK.FactSetGlobalPrices -v 2.8.0
```
...
nuget install FactSet.SDK.FactSetGlobalPrices -Version 2.8.0
```
...
*ReturnsApi* | [**GetRange**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGlobalPrices/v1/docs/ReturnsApi.md#getrange) | **GET** /factset-global-prices/v1/returns-range | Retrieves returns for specified IDs and currency within a required custom date range.
...
*ReturnsApi* | [**GetReturnsRangeForList**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGlobalPrices/v1/docs/ReturnsApi.md#getreturnsrangeforlist) | **POST** /factset-global-prices/v1/returns-range | Retrieves returns for specified IDs and currency within a required custom date range.
...
## Documentation for Models
 ...
 - [Model.RangeRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGlobalPrices/v1/docs/RangeRequest.md)
 - [Model.RangeResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGlobalPrices/v1/docs/RangeResponse.md)
 - [Model.Returns](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGlobalPrices/v1/docs/Returns.md)
 - [Model.ReturnsRange](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetGlobalPrices/v1/docs/ReturnsRange.md)
