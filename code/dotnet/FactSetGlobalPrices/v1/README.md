...
[![Nuget](https://img.shields.io/badge/nuget-v2.3.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetGlobalPrices/2.3.1)
...
dotnet add package FactSet.SDK.FactSetGlobalPrices -v 2.3.1
```
...
nuget install FactSet.SDK.FactSetGlobalPrices -Version 2.3.1
```
