...
**Currency** | **string** | Currency ISO code associated with the market value. For more details, visit [Online Assistant Page #1470](https://oa.apps.factset.com/pages/1470). | [optional] 
