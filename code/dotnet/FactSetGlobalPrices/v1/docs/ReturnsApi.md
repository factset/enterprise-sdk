...
<a name="getreturns"></a>
# **GetReturns**
> ReturnsResponse GetReturns (List<string> ids, string startDate, string endDate, string currency = null, string frequency = null)
...
namespace Example
{
    public class GetReturnsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Gets Returns for a list of `ids` as of given date range.
                ReturnsResponse result = apiInstance.GetReturns(ids, startDate, endDate, currency, frequency);
