# FactSet.SDK.FactSetGlobalPrices.Model.StockDistribution
...
**PriceAdjFactor** | **double?** | The price adjustment factor associated with the bonus or stock dividend event. | [optional] 
