...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class CalculationsApi : ICalculationsApi
    {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<CalculationStatus> localVarResponse = GetCalculationStatusByIdWithHttpInfo(id);
        ...
        /// <param name="id">From url, provided from the location header in the Run Multiple Calculations endpoint.</param>
        /// <returns>ApiResponse of CalculationStatus</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<CalculationStatus> GetCalculationStatusByIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<CalculationStatus> localVarResponse = await GetCalculationStatusByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CalculationStatus)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<CalculationStatus>> GetCalculationStatusByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'id' when calling CalculationsApi->GetCalculationStatusById");
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>> localVarResponse = GetCalculationStatusSummariesWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="FactSet.SDK.SPAREngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Dictionary&lt;string, CalculationStatusSummary&gt;</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>> GetCalculationStatusSummariesWithHttpInfo()
        {
            FactSet.SDK.SPAREngine.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.SPAREngine.Client.RequestOptions();
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>> localVarResponse = await GetCalculationStatusSummariesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, CalculationStatusSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>>> GetCalculationStatusSummariesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="calculation"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<Object> RunCalculationWithHttpInfo(Calculation calculation = default(Calculation))
        {
            FactSet.SDK.SPAREngine.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.SPAREngine.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<Object>> RunCalculationWithHttpInfoAsync(Calculation calculation = default(Calculation), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
