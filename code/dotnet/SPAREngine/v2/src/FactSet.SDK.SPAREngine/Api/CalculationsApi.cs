...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class CalculationsApi : ICalculationsApi
    {
        ...
        /// <returns></returns>
        public CalculationsApi(FactSet.SDK.SPAREngine.Client.Configuration configuration)
        {
        ...
        public CalculationsApi(FactSet.SDK.SPAREngine.Client.ISynchronousClient client, FactSet.SDK.SPAREngine.Client.IAsynchronousClient asyncClient, FactSet.SDK.SPAREngine.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Object> CancelCalculationByIdWithHttpInfo(string id)
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'id' when calling CalculationsApi->CancelCalculationById");
            }
        ...
        public ApiResponse<CalculationStatus> GetCalculationStatusByIdWithHttpInfo(string id)
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'id' when calling CalculationsApi->GetCalculationStatusById");
            }
