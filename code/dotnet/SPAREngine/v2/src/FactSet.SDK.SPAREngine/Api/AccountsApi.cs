...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <returns></returns>
        public AccountsApi(FactSet.SDK.SPAREngine.Client.Configuration configuration)
        {
        ...
        public AccountsApi(FactSet.SDK.SPAREngine.Client.ISynchronousClient client, FactSet.SDK.SPAREngine.Client.IAsynchronousClient asyncClient, FactSet.SDK.SPAREngine.Client.IReadableConfiguration configuration)
        {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<AccountDirectories> localVarResponse = GetAccountsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>ApiResponse of AccountDirectories</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<AccountDirectories> GetAccountsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<AccountDirectories> localVarResponse = await GetAccountsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDirectories)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<AccountDirectories>> GetAccountsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
