...
namespace FactSet.SDK.SPAREngine.Model
{
    ...
    public partial class SPARDateParameters : IEquatable<SPARDateParameters>, IValidatableObject
    {
        ...
        public SPARDateParameters(string startdate, string enddate, string frequency,bool useeachportfolioinception = default(bool))
        {
        ...
        [DataMember(Name = "useeachportfolioinception", EmitDefaultValue = true)]
