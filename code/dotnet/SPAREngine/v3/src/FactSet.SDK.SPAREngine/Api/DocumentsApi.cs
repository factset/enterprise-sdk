...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class DocumentsApi : IDocumentsApi
    {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = GetSPAR3DocumentsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the documents in</param>
        /// <returns>ApiResponse of DocumentDirectoriesRoot</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<DocumentDirectoriesRoot> GetSPAR3DocumentsWithHttpInfo(string path)
        {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<DocumentDirectoriesRoot> localVarResponse = await GetSPAR3DocumentsWithHttpInfoAsync(path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DocumentDirectoriesRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<DocumentDirectoriesRoot>> GetSPAR3DocumentsWithHttpInfoAsync(string path, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'path' when calling DocumentsApi->GetSPAR3Documents");
