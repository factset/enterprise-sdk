...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public interface IComponentsApiAsync : IApiAccessor
    {
        ...
        /// <param name="id">Unique identifier for a SPAR component</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SPARComponentRoot)</returns>
    ...
    public partial class ComponentsApi : IComponentsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetSPARComponentByIdResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(SPARComponentRoot) },
            { (HttpStatusCode)400, typeof(ClientErrorResponse) },
            { (HttpStatusCode)404, typeof(ClientErrorResponse) },
        };

        private static readonly Dictionary<HttpStatusCode, System.Type> GetSPARComponentsResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        {
            var localVarResponse = GetSPARComponentByIdWithHttpInfo(id);
        ...
        /// <param name="id">Unique identifier for a SPAR component</param>
        /// <returns>ApiResponse of SPARComponentRoot</returns>
        public ApiResponse<SPARComponentRoot> GetSPARComponentByIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'id' when calling ComponentsApi->GetSPARComponentById");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetSPARComponentByIdResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            SPARComponentRoot>("/analytics/engines/spar/v3/components/{id}", localVarRequestOptions, this.Configuration);
        ...
        {
            var localVarResponse = await GetSPARComponentByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SPARComponentRoot>> GetSPARComponentByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            var localVarResponse = GetSPARComponentsWithHttpInfo(document);
            return localVarResponse.Data;
        }
        ...
        /// <param name="document">Document Name</param>
        /// <returns>ApiResponse of ComponentSummaryRoot</returns>
        public ApiResponse<ComponentSummaryRoot> GetSPARComponentsWithHttpInfo(string document)
        {
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetSPARComponentsResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            ComponentSummaryRoot>("/analytics/engines/spar/v3/components", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            var localVarResponse = await GetSPARComponentsWithHttpInfoAsync(document, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ComponentSummaryRoot>> GetSPARComponentsWithHttpInfoAsync(string document, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'document' is set
            if (document == null)
            {
