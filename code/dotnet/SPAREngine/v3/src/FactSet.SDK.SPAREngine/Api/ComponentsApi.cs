...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class ComponentsApi : IComponentsApi
    {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<ComponentSummaryRoot> localVarResponse = GetSPARComponentsWithHttpInfo(document);
        ...
        /// <param name="document">Document Name</param>
        /// <returns>ApiResponse of ComponentSummaryRoot</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<ComponentSummaryRoot> GetSPARComponentsWithHttpInfo(string document)
        {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<ComponentSummaryRoot> localVarResponse = await GetSPARComponentsWithHttpInfoAsync(document, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ComponentSummaryRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<ComponentSummaryRoot>> GetSPARComponentsWithHttpInfoAsync(string document, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'document' is set
            if (document == null)
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'document' when calling ComponentsApi->GetSPARComponents");
