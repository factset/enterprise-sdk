...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class BenchmarksApi : IBenchmarksApi
    {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<SPARBenchmarkRoot> localVarResponse = GetSPARBenchmarkByIdWithHttpInfo(id);
        ...
        /// <param name="id">Benchmark Identifier</param>
        /// <returns>ApiResponse of SPARBenchmarkRoot</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<SPARBenchmarkRoot> GetSPARBenchmarkByIdWithHttpInfo(string id)
        {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<SPARBenchmarkRoot> localVarResponse = await GetSPARBenchmarkByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SPARBenchmarkRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<SPARBenchmarkRoot>> GetSPARBenchmarkByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.SDK.SPAREngine.Client.ApiException(400, "Missing required parameter 'id' when calling BenchmarksApi->GetSPARBenchmarkById");
