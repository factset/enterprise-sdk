...
namespace FactSet.SDK.SPAREngine.Api
{
    ...
    public partial class FrequenciesApi : IFrequenciesApi
    {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<FrequencyRoot> localVarResponse = GetSPARFrequenciesWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.SPAREngine.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of FrequencyRoot</returns>
        public FactSet.SDK.SPAREngine.Client.ApiResponse<FrequencyRoot> GetSPARFrequenciesWithHttpInfo()
        {
        ...
        {
            FactSet.SDK.SPAREngine.Client.ApiResponse<FrequencyRoot> localVarResponse = await GetSPARFrequenciesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FrequencyRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.SPAREngine.Client.ApiResponse<FrequencyRoot>> GetSPARFrequenciesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
