...
namespace Example
{
    public class GetSPARComponentByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ComponentsApi.GetSPARComponentById: " + e.Message );
...
namespace Example
{
    public class GetSPARComponentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ComponentsApi.GetSPARComponents: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
