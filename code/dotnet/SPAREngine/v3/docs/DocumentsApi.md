# FactSet.SDK.SPAREngine.Api.DocumentsApi
...
namespace Example
{
    public class GetSPAR3DocumentsExample
    {
        public static async Task Main()
        {
            ...
            var path = "\"SPAR_DOCUMENTS:Factset Default Document\"";  // string | The directory to get the documents in (default to "SPAR_DOCUMENTS:Factset Default Document")
            ...
            {
                Console.WriteLine("Exception when calling DocumentsApi.GetSPAR3Documents: " + e.Message );
