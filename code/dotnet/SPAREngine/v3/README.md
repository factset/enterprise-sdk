...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.SPAREngine/2.1.0)
...
dotnet add package FactSet.SDK.SPAREngine -v 2.1.0
```
...
nuget install FactSet.SDK.SPAREngine -Version 2.1.0
```
