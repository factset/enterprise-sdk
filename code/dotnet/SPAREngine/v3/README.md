...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.SPAREngine/2.2.0)
...
dotnet add package FactSet.SDK.SPAREngine -v 2.2.0
```
...
nuget install FactSet.SDK.SPAREngine -Version 2.2.0
```
...
*SPARPeerUniverseApi* | [**GetListOfPeerUniverse**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SPAREngine/v3/docs/SPARPeerUniverseApi.md#getlistofpeeruniverse) | **GET** /analytics/engines/spar/v3/peer-universe | Get List of Peer Universe
...
## Documentation for Models
 ...
 - [Model.SPARComponentIdentifier](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SPAREngine/v3/docs/SPARComponentIdentifier.md)
 ...
 - [Model.SPARPeerUniverseListResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SPAREngine/v3/docs/SPARPeerUniverseListResponse.md)
 - [Model.SPARPeerUniverseResponseItem](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SPAREngine/v3/docs/SPARPeerUniverseResponseItem.md)
 - [Model.SPARPeerUniverseRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SPAREngine/v3/docs/SPARPeerUniverseRoot.md)
