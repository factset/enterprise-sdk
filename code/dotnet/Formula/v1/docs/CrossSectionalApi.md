...
namespace Example
{
    public class GetCrossSectionalDataExample
    {
        public static async Task Main()
        {
            ...
            {
                // Retrieve data items (Screening formulas) for a list of identifiers or defined universe.
                CrossSectionalApi.GetCrossSectionalDataResponseWrapper result = apiInstance.GetCrossSectionalData(formulas, ids, symbolType, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch);
