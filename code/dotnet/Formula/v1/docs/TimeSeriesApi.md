...
# **GetTimeSeriesData**
> TimeSeriesResponse GetTimeSeriesData (List<string> formulas, List<string> ids = null, string universe = null, string universeType = null, string calendar = null, string fsymId = null, List<string> displayName = null, string flatten = null, string batch = null)
...
namespace Example
{
    public class GetTimeSeriesDataExample
    {
        public static async Task Main()
        {
            ...
            {
                // Retrieve data items (FQL formulas) for a list of identifiers or defined universe.
                TimeSeriesApi.GetTimeSeriesDataResponseWrapper result = apiInstance.GetTimeSeriesData(formulas, ids, universe, universeType, calendar, fsymId, displayName, flatten, batch);
