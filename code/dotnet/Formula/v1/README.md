...
[![Nuget](https://img.shields.io/badge/nuget-v4.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.Formula/4.0.0)
...
dotnet add package FactSet.SDK.Formula -v 4.0.0
```
...
nuget install FactSet.SDK.Formula -Version 4.0.0
```
...
namespace Example
{
    public static class GetTimeSeriesDataForListExample
    {
...
------------ | ------------- | ------------- | -------------
*BatchProcessingApi* | [**CancelBatchJob**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/BatchProcessingApi.md#cancelbatchjob) | **DELETE** /batch-cancel | Cancels individual ongoing Batch Request
...
*BatchProcessingApi* | [**GetBatchDataWithPost**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/BatchProcessingApi.md#getbatchdatawithpost) | **POST** /batch-result | Returns the response for a Batch Request
*BatchProcessingApi* | [**GetBatchList**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/BatchProcessingApi.md#getbatchlist) | **GET** /batch-list | Returns a list of all available Batch Requests submitted by a user
...
## Documentation for Models
 ...
 - [Model.BatchList](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/BatchList.md)
 - [Model.BatchListResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/BatchListResponse.md)
 - [Model.BatchListResponseMeta](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/BatchListResponseMeta.md)
 ...
 - [Model.UnifiedResultObjectFlattened](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/UnifiedResultObjectFlattened.md)
 - [Model.UnifiedResultObjectFlattenedAddl](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Formula/v1/docs/UnifiedResultObjectFlattenedAddl.md)
