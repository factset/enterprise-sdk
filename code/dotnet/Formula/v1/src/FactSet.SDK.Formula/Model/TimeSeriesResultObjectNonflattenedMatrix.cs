...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "time_series_result_object_nonflattened_matrix")]
    public partial class TimeSeriesResultObjectNonflattenedMatrix : IEquatable<TimeSeriesResultObjectNonflattenedMatrix>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResultObjectNonflattenedMatrix" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesResultObjectNonflattenedMatrix() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResultObjectNonflattenedMatrix" /> class.
        /// </summary>
        ...
        public TimeSeriesResultObjectNonflattenedMatrix(int error, string formula, string requestId, DataTypeEnum dataType, ObjectTypeEnum objectType,List<List<TimeSeriesScalarValue>> result = default(List<List<TimeSeriesScalarValue>>), string errorMessage = default(string), string displayName = default(string), string fsymId = default(string))
        {
            this.Error = error;
            // to ensure "formula" is required (not null)
            if (formula == null) {
                throw new ArgumentNullException("formula is a required property for TimeSeriesResultObjectNonflattenedMatrix and cannot be null");
            }
            this.Formula = formula;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for TimeSeriesResultObjectNonflattenedMatrix and cannot be null");
            }
        ...
        public List<List<TimeSeriesScalarValue>> Result { get; set; }
        ...
        {
            return this.Equals(input as TimeSeriesResultObjectNonflattenedMatrix);
        }

        /// <summary>
        /// Returns true if TimeSeriesResultObjectNonflattenedMatrix instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeSeriesResultObjectNonflattenedMatrix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeSeriesResultObjectNonflattenedMatrix input)
        {
            if (input == null)
            {
                return false;
