...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(TimeSeriesScalarValueJsonConverter))]
    [DataContract(Name = "time_series_scalar_value")]
    public partial class TimeSeriesScalarValue : AbstractOpenAPISchema, IEquatable<TimeSeriesScalarValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesScalarValue" /> class.
        /// </summary>
        ...
        public TimeSeriesScalarValue(string actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        public TimeSeriesScalarValue(double? actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public TimeSeriesScalarValue(int? actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public TimeSeriesScalarValue(DateTime? actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: DateTime?, double?, int?, string");
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeSeriesScalarValue {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, TimeSeriesScalarValue.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of TimeSeriesScalarValue
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of TimeSeriesScalarValue</returns>
        public static TimeSeriesScalarValue FromJson(string jsonString)
        {
            TimeSeriesScalarValue newTimeSeriesScalarValue = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newTimeSeriesScalarValue;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newTimeSeriesScalarValue = new TimeSeriesScalarValue((string)parsedValue);
            ...
            try
            {
                ...
                {
                    newTimeSeriesScalarValue = new TimeSeriesScalarValue((double?)parsedValue);
            ...
            try
            {
                ...
                {
                    newTimeSeriesScalarValue = new TimeSeriesScalarValue((int?)(long)parsedValue);
            ...
            try
            {
                ...
                {
                    newTimeSeriesScalarValue = new TimeSeriesScalarValue((DateTime?)parsedValue);
        ...
        {
            return this.Equals(input as TimeSeriesScalarValue);
        }

        /// <summary>
        /// Returns true if TimeSeriesScalarValue instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeSeriesScalarValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeSeriesScalarValue input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for TimeSeriesScalarValue
    /// </summary>
    public class TimeSeriesScalarValueJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(TimeSeriesScalarValue).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return TimeSeriesScalarValue.FromJson(JToken.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
