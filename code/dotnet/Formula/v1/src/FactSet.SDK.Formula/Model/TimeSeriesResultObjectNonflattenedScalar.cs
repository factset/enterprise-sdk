...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "time_series_result_object_nonflattened_scalar")]
    public partial class TimeSeriesResultObjectNonflattenedScalar : IEquatable<TimeSeriesResultObjectNonflattenedScalar>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResultObjectNonflattenedScalar" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesResultObjectNonflattenedScalar() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResultObjectNonflattenedScalar" /> class.
        /// </summary>
        ...
        public TimeSeriesResultObjectNonflattenedScalar(int error, string formula, string requestId, DataTypeEnum dataType, ObjectTypeEnum objectType,TimeSeriesScalarValue result = default(TimeSeriesScalarValue), string errorMessage = default(string), string displayName = default(string), string fsymId = default(string))
        {
            this.Error = error;
            // to ensure "formula" is required (not null)
            if (formula == null) {
                throw new ArgumentNullException("formula is a required property for TimeSeriesResultObjectNonflattenedScalar and cannot be null");
            }
            this.Formula = formula;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for TimeSeriesResultObjectNonflattenedScalar and cannot be null");
            }
        ...
        public TimeSeriesScalarValue Result { get; set; }
        ...
        {
            return this.Equals(input as TimeSeriesResultObjectNonflattenedScalar);
        }

        /// <summary>
        /// Returns true if TimeSeriesResultObjectNonflattenedScalar instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeSeriesResultObjectNonflattenedScalar to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeSeriesResultObjectNonflattenedScalar input)
        {
            if (input == null)
            {
                return false;
