...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class BatchDataRequest : IEquatable<BatchDataRequest>, IValidatableObject
    {
        ...
        public BatchDataRequest(BatchDataRequestData data = default(BatchDataRequestData))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for BatchDataRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public BatchDataRequestData Data { get; set; }
