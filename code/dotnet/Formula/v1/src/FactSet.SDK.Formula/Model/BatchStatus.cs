...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class BatchStatus : IEquatable<BatchStatus>, IValidatableObject
    {
        ...
        /// <param name="startTime">Time when the batch request is started. This is in UTC Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SS], following ISO 8601..</param>
        /// <param name="endTime">Time when the batch request is ended. This is in UTC Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SS], following ISO 8601..</param>
        ...
        /// </summary>
        /// <value>Time when the batch request is started. This is in UTC Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SS], following ISO 8601.</value>
        ...
        /// </summary>
        /// <value>Time when the batch request is ended. This is in UTC Time Zone. The date-time format is expressed as [YYYY-MM-DD]T[HH:MM:SS], following ISO 8601.</value>
