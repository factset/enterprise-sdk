...
namespace FactSet.SDK.Formula.Model
{
    ...
    [DataContract(Name = "TimeSeriesResultObjectNonflattened")]
    public partial class TimeSeriesResultObjectNonflattened : AbstractOpenAPISchema, IEquatable<TimeSeriesResultObjectNonflattened>, IValidatableObject
    {
        ...
        public static TimeSeriesResultObjectNonflattened FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                newTimeSeriesResultObjectNonflattened = new TimeSeriesResultObjectNonflattened(JsonConvert.DeserializeObject<TimeSeriesResultObjectNonflattenedScalar>(
                    jsonString,
            ...
            try
            {
                ...
                newTimeSeriesResultObjectNonflattened = new TimeSeriesResultObjectNonflattened(JsonConvert.DeserializeObject<TimeSeriesResultObjectNonflattenedArray>(
                    jsonString,
                    hasAdditionalProperties ? TimeSeriesResultObjectNonflattened.AdditionalPropertiesSerializerSettings : TimeSeriesResultObjectNonflattened.SerializerSettings
                ));
                // deserialization is considered successful at this point if no exception has been thrown.
            ...
            try
            {
                ...
                newTimeSeriesResultObjectNonflattened = new TimeSeriesResultObjectNonflattened(JsonConvert.DeserializeObject<TimeSeriesResultObjectNonflattenedMatrix>(
                    jsonString,
                    hasAdditionalProperties ? TimeSeriesResultObjectNonflattened.AdditionalPropertiesSerializerSettings : TimeSeriesResultObjectNonflattened.SerializerSettings
                ));
                // deserialization is considered successful at this point if no exception has been thrown.
            ...
            try
            {
                ...
                newTimeSeriesResultObjectNonflattened = new TimeSeriesResultObjectNonflattened(JsonConvert.DeserializeObject<TimeSeriesResultObjectNonflattenedTimeseriesObject>(
                    jsonString,
                    hasAdditionalProperties ? TimeSeriesResultObjectNonflattened.AdditionalPropertiesSerializerSettings : TimeSeriesResultObjectNonflattened.SerializerSettings
                ));
                // deserialization is considered successful at this point if no exception has been thrown.
