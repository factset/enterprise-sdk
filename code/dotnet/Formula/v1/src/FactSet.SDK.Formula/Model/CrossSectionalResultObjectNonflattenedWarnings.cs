...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cross_sectional_result_object_nonflattened_warnings")]
    public partial class CrossSectionalResultObjectNonflattenedWarnings : IEquatable<CrossSectionalResultObjectNonflattenedWarnings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossSectionalResultObjectNonflattenedWarnings" /> class.
        /// </summary>
        ...
        public CrossSectionalResultObjectNonflattenedWarnings(string description = default(string), string effect = default(string))
        {
        ...
        {
            return this.Equals(input as CrossSectionalResultObjectNonflattenedWarnings);
        }

        /// <summary>
        /// Returns true if CrossSectionalResultObjectNonflattenedWarnings instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossSectionalResultObjectNonflattenedWarnings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossSectionalResultObjectNonflattenedWarnings input)
        {
            if (input == null)
            {
                return false;
