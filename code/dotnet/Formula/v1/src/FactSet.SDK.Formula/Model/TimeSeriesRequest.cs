...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "time_series_request")]
    public partial class TimeSeriesRequest : IEquatable<TimeSeriesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public TimeSeriesRequest(TimeSeriesRequestData data = default(TimeSeriesRequestData))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for TimeSeriesRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public TimeSeriesRequestData Data { get; set; }
        ...
        {
            return this.Equals(input as TimeSeriesRequest);
        }

        /// <summary>
        /// Returns true if TimeSeriesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeSeriesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeSeriesRequest input)
        {
            if (input == null)
            {
                return false;
