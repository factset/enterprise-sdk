...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cross_sectional_request_data")]
    public partial class CrossSectionalRequestData : IEquatable<CrossSectionalRequestData>, IValidatableObject
    {
        ...
        public CrossSectionalRequestData(List<string> ids = default(List<string>), string universe = default(string), UniverseTypeEnum? universeType = UniverseTypeEnum.EQUITY, List<string> formulas = default(List<string>), string backTestDate = default(string), string calendar = "FIVEDAY", FsymIdEnum? fsymId = FsymIdEnum.N, List<string> displayName = default(List<string>), FlattenEnum? flatten = FlattenEnum.N, BatchEnum? batch = BatchEnum.N)
        {
