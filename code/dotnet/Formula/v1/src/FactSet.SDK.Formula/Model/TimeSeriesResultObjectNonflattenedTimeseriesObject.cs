...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class TimeSeriesResultObjectNonflattenedTimeseriesObject : IEquatable<TimeSeriesResultObjectNonflattenedTimeseriesObject>, IValidatableObject
    {
        ...
        public TimeSeriesResultObjectNonflattenedTimeseriesObject(TimeSeriesTimeseriesObject result = default(TimeSeriesTimeseriesObject), int error = default(int), string errorMessage = default(string), string formula = default(string), string displayName = default(string), string requestId = default(string), string fsymId = default(string), DataTypeEnum dataType = default(DataTypeEnum), ObjectTypeEnum objectType = default(ObjectTypeEnum))
        {
            this.Error = error;
