...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cross_sectional_response")]
    public partial class CrossSectionalResponse : IEquatable<CrossSectionalResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossSectionalResponse" /> class.
        /// </summary>
        /// <param name="data">Array of Cross-Sectional &#x60;Response Objects&#x60;.</param>
        /// <param name="meta">meta.</param>
        public CrossSectionalResponse(List<CrossSectionalResponseObjectItems> data = default(List<CrossSectionalResponseObjectItems>), Object meta = default(Object))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Array of Cross-Sectional &#x60;Response Objects&#x60;</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<CrossSectionalResponseObjectItems> Data { get; set; }
        ...
        {
            return this.Equals(input as CrossSectionalResponse);
        }

        /// <summary>
        /// Returns true if CrossSectionalResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossSectionalResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossSectionalResponse input)
        {
            if (input == null)
            {
                return false;
