...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class ErrorObject : IEquatable<ErrorObject>, IValidatableObject
    {
        ...
        /// <param name="timestamp">timestamp in YYYY-MM-DDTHH:MM:SS.SSSZ.</param>
        public ErrorObject(string id = default(string), string code = default(string), string title = default(string), DateTime? timestamp = default(DateTime?))
        {
            this.Id = id;
            this.Code = code;
            this.Title = title;
        ...
        /// </summary>
        /// <value>timestamp in YYYY-MM-DDTHH:MM:SS.SSSZ</value>
