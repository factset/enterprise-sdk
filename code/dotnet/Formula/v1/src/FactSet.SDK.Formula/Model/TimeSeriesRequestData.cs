...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class TimeSeriesRequestData : IEquatable<TimeSeriesRequestData>, IValidatableObject
    {
        ...
        public TimeSeriesRequestData(List<string> ids = default(List<string>), string universe = default(string), UniverseTypeEnum? universeType = UniverseTypeEnum.EQUITY, List<string> formulas = default(List<string>), string calendar = "FIVEDAY", FsymIdEnum? fsymId = FsymIdEnum.N, List<string> displayName = default(List<string>), FlattenEnum? flatten = FlattenEnum.N, BatchEnum? batch = BatchEnum.N)
        {
