...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimeSeriesRequest_data")]
    public partial class TimeSeriesRequestData : IEquatable<TimeSeriesRequestData>, IValidatableObject
    {
        ...
        public TimeSeriesRequestData(List<string> formulas,List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), UniverseTypeEnum? universeType = UniverseTypeEnum.EQUITY, List<UniverseExclusionEnum> universeExclusion = default(List<UniverseExclusionEnum>), string calendar = "FIVEDAY", FsymIdEnum? fsymId = FsymIdEnum.N, List<string> displayName = default(List<string>), FlattenEnum? flatten = FlattenEnum.N, DatesEnum? dates = DatesEnum.Y, BatchEnum? batch = BatchEnum.N)
        {
        ...
        /// </summary>
        /// <value>Specify the type of symbols submitted in the &#x60;ids&#x60; parameter. This is only required when submitting ids that are not supported by default.  &lt;br/&gt; Available symbol types - * DEFAULT - Accepted symbol types include Market Tickers, SEDOLs, ISINs, CUSIPs, or FactSet Permanent Ids.  * BLOOMBERG - Accepted symbol types include Bloomberg Tickers and Bloomberg FIGIs.    * When submitting Bloomberg symbols, the Bloomberg symbol is translated to a FactSet Permanent Identifier which is then used to retrieve the requested FQL and Screening formulas. The Bloomberg symbol submitted will be returned in the response in the field *requestId*. To see the FactSet Permanent Identifer that the Bloomberg symbol resolved to, use the &#x60;fsymId&#x60; parameter in addition to the &#x60;   &#x60; parameter.   * Bloomberg symbols can not be submitted with other symbol types.  &lt;br/&gt; Bloomberg Symbol Resolution is included with the Individual User subscription. Users with a Production User subscription require additional access to submit Bloomberg symbols. If you would like to gain access to Bloomberg Symbol Resolution, please contact your FactSet Account Team or \&quot;Report Issue\&quot; above and our support teams can assist. </value>
