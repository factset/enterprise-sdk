...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class TimeSeriesResultObjectNonflattenedArray : IEquatable<TimeSeriesResultObjectNonflattenedArray>, IValidatableObject
    {
        ...
        public TimeSeriesResultObjectNonflattenedArray(List<TimeSeriesScalarValue> result = default(List<TimeSeriesScalarValue>), int error = default(int), string errorMessage = default(string), string formula = default(string), string displayName = default(string), string requestId = default(string), string fsymId = default(string), DataTypeEnum dataType = default(DataTypeEnum), ObjectTypeEnum objectType = default(ObjectTypeEnum))
        {
            this.Error = error;
