...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class TimeSeriesResultObjectFlattened : Dictionary<String, TimeSeriesResultObjectFlattenedAddl>, IEquatable<TimeSeriesResultObjectFlattened>, IValidatableObject
    {
        /// <summary>
        ...
        public TimeSeriesResultObjectFlattened(string requestId = default(string), string fsymId = default(string), DateTime? date = default(DateTime?)) : base()
        {
