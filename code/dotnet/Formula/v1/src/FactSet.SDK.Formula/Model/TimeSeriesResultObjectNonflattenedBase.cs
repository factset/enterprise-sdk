...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class TimeSeriesResultObjectNonflattenedBase : IEquatable<TimeSeriesResultObjectNonflattenedBase>, IValidatableObject
    {
        ...
        public TimeSeriesResultObjectNonflattenedBase(int error, string formula, string requestId, DataTypeEnum dataType, ObjectTypeEnum objectType,string errorMessage = default(string), string displayName = default(string), string fsymId = default(string))
        {
            this.Error = error;
