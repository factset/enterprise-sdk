...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "time_series_result_object_nonflattened_base")]
    public partial class TimeSeriesResultObjectNonflattenedBase : IEquatable<TimeSeriesResultObjectNonflattenedBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResultObjectNonflattenedBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesResultObjectNonflattenedBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResultObjectNonflattenedBase" /> class.
        /// </summary>
        ...
        public TimeSeriesResultObjectNonflattenedBase(int error = default(int), string errorMessage = default(string), string formula = default(string), string displayName = default(string), string requestId = default(string), string fsymId = default(string), DataTypeEnum dataType = default(DataTypeEnum), ObjectTypeEnum objectType = default(ObjectTypeEnum))
        {
            this.Error = error;
            // to ensure "formula" is required (not null)
            if (formula == null) {
                throw new ArgumentNullException("formula is a required property for TimeSeriesResultObjectNonflattenedBase and cannot be null");
            }
            this.Formula = formula;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for TimeSeriesResultObjectNonflattenedBase and cannot be null");
            }
        ...
        {
            return this.Equals(input as TimeSeriesResultObjectNonflattenedBase);
        }

        /// <summary>
        /// Returns true if TimeSeriesResultObjectNonflattenedBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeSeriesResultObjectNonflattenedBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeSeriesResultObjectNonflattenedBase input)
        {
            if (input == null)
            {
                return false;
