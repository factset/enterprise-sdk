...
namespace FactSet.SDK.Formula.Model
{
    ...
    public partial class CrossSectionalResultObjectNonflattened : IEquatable<CrossSectionalResultObjectNonflattened>, IValidatableObject
    {
        ...
        public CrossSectionalResultObjectNonflattened(string universe = default(string), string dataItemName = default(string), string displayName = default(string), List<CrossSectionalResultObjectNonflattenedResultAttribute> result = default(List<CrossSectionalResultObjectNonflattenedResultAttribute>), DataTypeEnum dataType = default(DataTypeEnum), int error = default(int), string errorMessage = default(string), List<CrossSectionalResultObjectNonflattenedWarnings> warnings = default(List<CrossSectionalResultObjectNonflattenedWarnings>))
        {
