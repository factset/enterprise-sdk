...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchListResponse_meta")]
    public partial class BatchListResponseMeta : IEquatable<BatchListResponseMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchListResponseMeta" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        public BatchListResponseMeta(string message = default(string))
        {
        ...
        {
            return this.Equals(input as BatchListResponseMeta);
        }

        /// <summary>
        /// Returns true if BatchListResponseMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchListResponseMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchListResponseMeta input)
        {
            if (input == null)
            {
                return false;
