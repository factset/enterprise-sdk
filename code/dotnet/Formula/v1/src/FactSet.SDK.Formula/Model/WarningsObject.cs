...
namespace FactSet.SDK.Formula.Model
{
    ...
    /// WarningsObject
    /// </summary>
    [DataContract(Name = "warningsObject")]
    public partial class WarningsObject : IEquatable<WarningsObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WarningsObject" /> class.
        /// </summary>
        /// <param name="description">Human readable message explaining the warning.</param>
        /// <param name="effect">Human readable message explaining the effect on the &#x60;result&#x60;.</param>
        public WarningsObject(string description = default(string), string effect = default(string))
        {
        ...
        /// </summary>
        /// <value>Human readable message explaining the warning</value>
        ...
        /// </summary>
        /// <value>Human readable message explaining the effect on the &#x60;result&#x60;</value>
        ...
        {
            return this.Equals(input as WarningsObject);
        }

        /// <summary>
        /// Returns true if WarningsObject instances are equal
        /// </summary>
        /// <param name="input">Instance of WarningsObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WarningsObject input)
        {
            if (input == null)
            {
                return false;
