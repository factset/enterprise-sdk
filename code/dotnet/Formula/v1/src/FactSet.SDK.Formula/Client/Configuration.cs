...
namespace FactSet.SDK.Formula.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/Formula/4.0.0";
            BasePath = "https://api.factset.com/formula-api/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/formula-api/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.Formula) Debug Report:\n";
