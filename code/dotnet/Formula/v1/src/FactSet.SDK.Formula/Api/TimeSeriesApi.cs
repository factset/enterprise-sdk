...
namespace FactSet.SDK.Formula.Api
{
    ...
    public interface ITimeSeriesApiSync : IApiAccessor
    {
        ...
        /// <param name="dates">Specify **N** for the &#x60;dates&#x60; parameter to suppress the **dates** of the response. The default value for the &#x60;dates&#x60; parameter is **Y**. Setting the parameter to **Y** will only return dates if the formula has a date value associated with it.  In the non-flattened response model, setting dates to **N** will remove the \&quot;dates\&quot; array from the TIMESERIES objectType, meaning that the results will be returned as an ARRAY objectType.  In the flattened response mode, setting dates to **N** will remove the \&quot;dates\&quot; attribute from the response objects. The flatten parameter first attempts to flatten the response by dates. Removing the dates can make it easier to align multiple data items when the date definition differs from the desired alignment.  (optional, default to Y)</param>
        ...
        TimeSeriesApi.GetTimeSeriesDataResponseWrapper GetTimeSeriesData(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string dates = default(string), string batch = default(string));
    ...
    public interface ITimeSeriesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TimeSeriesApi.GetTimeSeriesDataResponseWrapper> GetTimeSeriesDataAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string dates = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TimeSeriesApi.GetTimeSeriesDataResponseWrapper>> GetTimeSeriesDataWithHttpInfoAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string dates = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve data items (FQL formulas) for a list of identifiers or defined universe.
        /// </summary>
        /// <remarks>
    ...
    public partial class TimeSeriesApi : ITimeSeriesApi
    {
        ...
        {
            var localVarResponse = GetTimeSeriesDataWithHttpInfo(formulas, ids, symbolType, universe, universeType, calendar, fsymId, displayName, flatten, dates, batch);
        ...
        public ApiResponse<TimeSeriesApi.GetTimeSeriesDataResponseWrapper> GetTimeSeriesDataWithHttpInfo(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string dates = default(string), string batch = default(string))
        {
            ...
            if (symbolType != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.Formula.Client.ClientUtils.ParameterToMultiMap("", "symbolType", symbolType));
            }
            if (universe != null)
            {
            ...
            if (dates != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.Formula.Client.ClientUtils.ParameterToMultiMap("", "dates", dates));
            }
            if (batch != null)
            {
        ...
        {
            var localVarResponse = await GetTimeSeriesDataWithHttpInfoAsync(formulas, ids, symbolType, universe, universeType, calendar, fsymId, displayName, flatten, dates, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<TimeSeriesApi.GetTimeSeriesDataResponseWrapper>> GetTimeSeriesDataWithHttpInfoAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string dates = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/time-series", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
