...
namespace FactSet.SDK.Formula.Api
{
    ...
    public interface ICrossSectionalApiSync : IApiAccessor
    {
        ...
        /// <param name="startDate">Specify the start date for running the Iterated Cross Sectional Functionality request either in **YYYY-MM-DD**, **YYYYMMDD** or **MM/DD/YYYY** format. User must have access to backtesting functionality. (optional)</param>
        /// <param name="endDate">Specify the end date for running the Iterated Cross Sectional Functionality request either in **YYYY-MM-DD**, **YYYYMMDD** or **MM/DD/YYYY** format. User must have access to backtesting functionality. (optional)</param>
        /// <param name="frequency">Specify the frequency for running the Iterated Cross Sectional Functionality request. The following frequencies are supported **D**, **W**, **M**, **AM**, **CQ**, **AY**, or **CY**. To learn more about frequency, please visit [Online Assistant Page 1964](https://my.apps.factset.com/oa/pages/1964#frequency). User must have access to backtesting functionality. (optional)</param>
        /// <returns>CrossSectionalApi.GetCrossSectionalDataResponseWrapper</returns>
        CrossSectionalApi.GetCrossSectionalDataResponseWrapper GetCrossSectionalData(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string));
        ...
        ApiResponse<CrossSectionalApi.GetCrossSectionalDataResponseWrapper> GetCrossSectionalDataWithHttpInfo(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string));
        /// <summary>
        /// Retrieve data items (Screening formulas) for a list of identifiers or defined universe.
        /// </summary>
        /// <remarks>
    ...
    public interface ICrossSectionalApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CrossSectionalApi.GetCrossSectionalDataResponseWrapper> GetCrossSectionalDataAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CrossSectionalApi.GetCrossSectionalDataResponseWrapper>> GetCrossSectionalDataWithHttpInfoAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve data items (Screening formulas) for a list of identifiers or defined universe.
        /// </summary>
        /// <remarks>
    ...
    public partial class CrossSectionalApi : ICrossSectionalApi
    {
        ...
        /// <param name="frequency">Specify the frequency for running the Iterated Cross Sectional Functionality request. The following frequencies are supported **D**, **W**, **M**, **AM**, **CQ**, **AY**, or **CY**. To learn more about frequency, please visit [Online Assistant Page 1964](https://my.apps.factset.com/oa/pages/1964#frequency). User must have access to backtesting functionality. (optional)</param>
        /// <returns>CrossSectionalApi.GetCrossSectionalDataResponseWrapper</returns>
        public CrossSectionalApi.GetCrossSectionalDataResponseWrapper GetCrossSectionalData(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string))
        {
            var localVarResponse = GetCrossSectionalDataWithHttpInfo(formulas, ids, symbolType, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch, startDate, endDate, frequency);
        ...
        public ApiResponse<CrossSectionalApi.GetCrossSectionalDataResponseWrapper> GetCrossSectionalDataWithHttpInfo(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string))
        {
            ...
            if (startDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.Formula.Client.ClientUtils.ParameterToMultiMap("", "startDate", startDate));
            }
            if (endDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.Formula.Client.ClientUtils.ParameterToMultiMap("", "endDate", endDate));
            }
            if (frequency != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.Formula.Client.ClientUtils.ParameterToMultiMap("", "frequency", frequency));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CrossSectionalResponse</returns>
        public async System.Threading.Tasks.Task<CrossSectionalApi.GetCrossSectionalDataResponseWrapper>GetCrossSectionalDataAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetCrossSectionalDataWithHttpInfoAsync(formulas, ids, symbolType, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch, startDate, endDate, frequency, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<CrossSectionalApi.GetCrossSectionalDataResponseWrapper>> GetCrossSectionalDataWithHttpInfoAsync(List<string> formulas, List<string> ids = default(List<string>), string symbolType = default(string), string universe = default(string), string universeType = default(string), string backTestDate = default(string), string calendar = default(string), string fsymId = default(string), List<string> displayName = default(List<string>), string flatten = default(string), string batch = default(string), string startDate = default(string), string endDate = default(string), string frequency = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/cross-sectional", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
