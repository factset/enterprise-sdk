...
namespace FactSet.SDK.Formula.Api
{
    ...
    public partial class CrossSectionalApi : ICrossSectionalApi
    {
        ...
        {
            var localVarResponse = GetCrossSectionalDataWithHttpInfo(formulas, ids, symbolType, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch);
        ...
        {
            var localVarResponse = await GetCrossSectionalDataWithHttpInfoAsync(formulas, ids, symbolType, universe, universeType, backTestDate, calendar, fsymId, displayName, flatten, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
