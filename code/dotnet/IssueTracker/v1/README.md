...
[![Nuget](https://img.shields.io/badge/nuget-v0.5.1-orange)](https://www.nuget.org/packages/FactSet.SDK.IssueTracker/0.5.1)
...
dotnet add package FactSet.SDK.IssueTracker -v 0.5.1
```
...
nuget install FactSet.SDK.IssueTracker -Version 0.5.1
```
...
*IssueApi* | [**PatchIssue**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/IssueTracker/v1/docs/IssueApi.md#patchissue) | **PATCH** /issues/{id} | Update issue details
