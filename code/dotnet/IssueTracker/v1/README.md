...
dotnet add package FactSet.SDK.IssueTracker -v 0.3.0
```
...
nuget install FactSet.SDK.IssueTracker -Version 0.3.0
```
...
*IssueApi* | [**PatchIssue**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/IssueTracker/v1/docs/IssueApi.md#patchissue) | **PATCH** /issues/{id} | Update severity and subject of existing issue
