...
namespace FactSet.SDK.IssueTracker.Model
{
    ...
    public partial class IssueData : IEquatable<IssueData>, IValidatableObject
    {
        ...
        public IssueData(string id = default(string), string subject = default(string), List<Comment> comments = default(List<Comment>), string severity = default(string), int internalId = default(int))
        {
            this.Id = id;
