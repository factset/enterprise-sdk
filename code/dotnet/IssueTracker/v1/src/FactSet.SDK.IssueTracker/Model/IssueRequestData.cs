...
namespace FactSet.SDK.IssueTracker.Model
{
    ...
    public partial class IssueRequestData : IEquatable<IssueRequestData>, IValidatableObject
    {
        ...
        /// <param name="connectorId">Id / GUID of the external system where Factset needs to sync back the data. Product should have the settings configured- Please reach out to factset product support team..</param>
        /// <param name="connectorDisplayId">User friendly Display ID of the external System.</param>
        public IssueRequestData(string subject, string description, string productId,string categoryId = default(string), string severity = default(string), List<Attachment> attachments = default(List<Attachment>), string connectorId = default(string), string connectorDisplayId = default(string))
        {
            ...
            this.ConnectorDisplayId = connectorDisplayId;
        }
        ...
        /// </summary>
        /// <value>Id / GUID of the external system where Factset needs to sync back the data. Product should have the settings configured- Please reach out to factset product support team.</value>
        ...
        /// </summary>
        /// <value>User friendly Display ID of the external System</value>
        [DataMember(Name = "connectorDisplayId", EmitDefaultValue = false)]
        public string ConnectorDisplayId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ConnectorDisplayId: ").Append(ConnectorDisplayId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(IssueRequestData input)
        {
            ...
            return 
                ...
                (
                    this.ConnectorDisplayId == input.ConnectorDisplayId ||
                    (this.ConnectorDisplayId != null &&
                    this.ConnectorDisplayId.Equals(input.ConnectorDisplayId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConnectorDisplayId != null)
                {
                    hashCode = (hashCode * 59) + this.ConnectorDisplayId.GetHashCode();
                }
                return hashCode;
            }
        }
