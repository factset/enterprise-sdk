...
namespace FactSet.SDK.IssueTracker.Api
{
    ...
    public interface IIssueApiSync : IApiAccessor
    {
        ...
        void PatchIssue(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest));
        ...
        ApiResponse<Object> PatchIssueWithHttpInfo(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest));
        /// <summary>
    ...
    public interface IIssueApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task PatchIssueAsync(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PatchIssueWithHttpInfoAsync(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Creates a Issue Tracker issue
        /// </summary>
        /// <remarks>
    ...
    public partial class IssueApi : IIssueApi
    {
        ...
        /// <summary>
        /// Update severity and subject of issue or productId and categoryId of issue User can update either &#x60;isCritical&#x60; with &#x60;subject&#x60; or &#x60;productId&#x60; with &#x60;categoryId&#x60;.    **Note:** Users are not allowed to update &#x60;isCritical&#x60; with &#x60;productId&#x60; or &#x60;subject&#x60; with &#x60;productId&#x60;
        /// </summary>
        /// <exception cref="FactSet.SDK.IssueTracker.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID of Issue Tracker issue</param>
        /// <param name="updateIssueRequest"> (optional)</param>
        /// <returns>void</returns>
        public void PatchIssue(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest))
        {
        ...
        /// <param name="updateIssueRequest"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PatchIssueWithHttpInfo(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            Object>("/issues/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PatchIssueAsync(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await PatchIssueWithHttpInfoAsync(id, updateIssueRequest, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PatchIssueWithHttpInfoAsync(string id, UpdateIssueRequest updateIssueRequest = default(UpdateIssueRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<Object>("/issues/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
