...
namespace FactSet.SDK.IssueTracker.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/IssueTracker/0.5.1";
            BasePath = "https://api.factset.com/issue-tracker/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/issue-tracker/v1") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 0.5.1\n";
