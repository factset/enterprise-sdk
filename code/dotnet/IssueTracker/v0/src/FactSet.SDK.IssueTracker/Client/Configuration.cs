...
namespace FactSet.SDK.IssueTracker.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/IssueTracker/0.1.0";
            BasePath = "https://api.factset.com/issue-tracker/v0";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/issue-tracker/v0"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/issue-tracker/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.IssueTracker) Debug Report:\n";
