...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_filter_validation_price_previous")]
    public partial class PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious : IEquatable<PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataFilterValidationPricePrevious input)
        {
            if (input == null)
            {
                return false;
