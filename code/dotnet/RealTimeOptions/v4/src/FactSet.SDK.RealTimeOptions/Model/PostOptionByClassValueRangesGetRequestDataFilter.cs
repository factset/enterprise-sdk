...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_filter")]
    public partial class PostOptionByClassValueRangesGetRequestDataFilter : IEquatable<PostOptionByClassValueRangesGetRequestDataFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataFilter" /> class.
        /// </summary>
        /// <param name="validation">validation.</param>
        public PostOptionByClassValueRangesGetRequestDataFilter(PostOptionByClassValueRangesGetRequestDataFilterValidation validation = default(PostOptionByClassValueRangesGetRequestDataFilterValidation))
        {
        ...
        public PostOptionByClassValueRangesGetRequestDataFilterValidation Validation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataFilter {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataFilter);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataFilter input)
        {
            if (input == null)
            {
                return false;
