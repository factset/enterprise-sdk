...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_gamma_minimum")]
    public partial class PostOptionByClassListRequestDataKeyFiguresGammaMinimum : IEquatable<PostOptionByClassListRequestDataKeyFiguresGammaMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresGammaMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataKeyFiguresGammaMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresGammaMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataKeyFiguresGammaMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresGammaMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresGammaMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresGammaMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresGammaMinimum input)
        {
            if (input == null)
            {
                return false;
