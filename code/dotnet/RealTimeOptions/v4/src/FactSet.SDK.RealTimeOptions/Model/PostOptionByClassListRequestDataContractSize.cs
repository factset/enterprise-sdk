...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contractSize")]
    public partial class PostOptionByClassListRequestDataContractSize : IEquatable<PostOptionByClassListRequestDataContractSize>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractSize" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public PostOptionByClassListRequestDataContractSize(PostOptionByClassListRequestDataContractSizeRestrict restrict = default(PostOptionByClassListRequestDataContractSizeRestrict), PostOptionByClassListRequestDataContractSizeExclude exclude = default(PostOptionByClassListRequestDataContractSizeExclude))
        {
        ...
        public PostOptionByClassListRequestDataContractSizeRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataContractSizeExclude Exclude { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractSize);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractSize instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractSize to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractSize input)
        {
            if (input == null)
            {
                return false;
