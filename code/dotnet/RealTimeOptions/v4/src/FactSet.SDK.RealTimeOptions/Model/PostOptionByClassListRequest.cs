...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// Request Body
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest")]
    public partial class PostOptionByClassListRequest : IEquatable<PostOptionByClassListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="meta">meta.</param>
        public PostOptionByClassListRequest(PostOptionByClassListRequestData data,PostOptionByClassListRequestMeta meta = default(PostOptionByClassListRequestMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for PostOptionByClassListRequest and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PostOptionByClassListRequestData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public PostOptionByClassListRequestMeta Meta { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequest input)
        {
            if (input == null)
            {
                return false;
