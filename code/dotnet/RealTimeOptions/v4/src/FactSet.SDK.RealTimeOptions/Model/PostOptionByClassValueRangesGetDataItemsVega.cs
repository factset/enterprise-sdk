...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_vega")]
    public partial class PostOptionByClassValueRangesGetDataItemsVega : IEquatable<PostOptionByClassValueRangesGetDataItemsVega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsVega" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsVega(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsVega);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsVega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsVega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsVega input)
        {
            if (input == null)
            {
                return false;
