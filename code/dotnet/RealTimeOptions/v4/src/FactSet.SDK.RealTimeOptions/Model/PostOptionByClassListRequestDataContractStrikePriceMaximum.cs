...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contract_strikePrice_maximum")]
    public partial class PostOptionByClassListRequestDataContractStrikePriceMaximum : IEquatable<PostOptionByClassListRequestDataContractStrikePriceMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractStrikePriceMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataContractStrikePriceMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractStrikePriceMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataContractStrikePriceMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractStrikePriceMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractStrikePriceMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractStrikePriceMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractStrikePriceMaximum input)
        {
            if (input == null)
            {
                return false;
