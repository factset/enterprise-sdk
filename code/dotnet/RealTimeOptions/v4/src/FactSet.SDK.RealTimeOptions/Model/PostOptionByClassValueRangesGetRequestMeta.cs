...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_meta")]
    public partial class PostOptionByClassValueRangesGetRequestMeta : IEquatable<PostOptionByClassValueRangesGetRequestMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestMeta" /> class.
        /// </summary>
        /// <param name="attributes">Limit the attributes returned in the response to the specified set..</param>
        public PostOptionByClassValueRangesGetRequestMeta(HashSet<string> attributes = default(HashSet<string>))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestMeta);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestMeta input)
        {
            if (input == null)
            {
                return false;
