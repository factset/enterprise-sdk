...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_meta_pagination")]
    public partial class PostOptionByClassListRequestMetaPagination : IEquatable<PostOptionByClassListRequestMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestMetaPagination" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestMetaPagination(int offset = 0, int limit = 20)
        {
            this.Offset = offset;
            this.Limit = limit;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestMetaPagination {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestMetaPagination);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestMetaPagination input)
        {
            if (input == null)
            {
                return false;
