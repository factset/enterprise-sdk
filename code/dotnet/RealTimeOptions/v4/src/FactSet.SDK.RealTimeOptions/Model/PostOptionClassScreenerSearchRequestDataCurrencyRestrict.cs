...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_currency_restrict")]
    public partial class PostOptionClassScreenerSearchRequestDataCurrencyRestrict : IEquatable<PostOptionClassScreenerSearchRequestDataCurrencyRestrict>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataCurrencyRestrict" /> class.
        /// </summary>
        /// <param name="ids">Set of currency identifiers..</param>
        public PostOptionClassScreenerSearchRequestDataCurrencyRestrict(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataCurrencyRestrict);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataCurrencyRestrict instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataCurrencyRestrict to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataCurrencyRestrict input)
        {
            if (input == null)
            {
                return false;
