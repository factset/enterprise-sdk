...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_thetaOneWeek")]
    public partial class PostOptionByClassListRequestDataKeyFiguresThetaOneWeek : IEquatable<PostOptionByClassListRequestDataKeyFiguresThetaOneWeek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresThetaOneWeek" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresThetaOneWeek(PostOptionByClassListRequestDataContractStrikePriceMinimum minimum = default(PostOptionByClassListRequestDataContractStrikePriceMinimum), PostOptionByClassListRequestDataContractStrikePriceMaximum maximum = default(PostOptionByClassListRequestDataContractStrikePriceMaximum))
        {
        ...
        public PostOptionByClassListRequestDataContractStrikePriceMaximum Maximum { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataKeyFiguresThetaOneWeek {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresThetaOneWeek);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresThetaOneWeek instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresThetaOneWeek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresThetaOneWeek input)
        {
            if (input == null)
            {
                return false;
