...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_underlying_notation_instrument_fsym")]
    public partial class InlineResponse200DataUnderlyingNotationInstrumentFsym : IEquatable<InlineResponse200DataUnderlyingNotationInstrumentFsym>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataUnderlyingNotationInstrumentFsym" /> class.
        /// </summary>
        /// <param name="security">security.</param>
        public InlineResponse200DataUnderlyingNotationInstrumentFsym(InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity security = default(InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity))
        {
        ...
        public InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity Security { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataUnderlyingNotationInstrumentFsym);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataUnderlyingNotationInstrumentFsym instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataUnderlyingNotationInstrumentFsym to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataUnderlyingNotationInstrumentFsym input)
        {
            if (input == null)
            {
                return false;
