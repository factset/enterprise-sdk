...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_lifeCycle_expiration")]
    public partial class PostOptionByClassListRequestDataLifeCycleExpiration : IEquatable<PostOptionByClassListRequestDataLifeCycleExpiration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataLifeCycleExpiration" /> class.
        /// </summary>
        /// <param name="month">Month of the option&#39;s expiration..</param>
        /// <param name="year">Year of the option&#39;s expiration..</param>
        public PostOptionByClassListRequestDataLifeCycleExpiration(decimal month = default(decimal), decimal year = default(decimal))
        {
            this.Month = month;
            this.Year = year;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataLifeCycleExpiration);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataLifeCycleExpiration instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataLifeCycleExpiration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataLifeCycleExpiration input)
        {
            if (input == null)
            {
                return false;
