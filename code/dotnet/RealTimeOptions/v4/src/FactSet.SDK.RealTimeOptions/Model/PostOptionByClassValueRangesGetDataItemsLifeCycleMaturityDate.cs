...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_lifeCycle_maturity_date")]
    public partial class PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate : IEquatable<PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate" /> class.
        /// </summary>
        /// <param name="minimum">Minimum date..</param>
        /// <param name="maximum">Maximum date..</param>
        public PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate(DateTime? minimum = default(DateTime?), DateTime? maximum = default(DateTime?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate input)
        {
            if (input == null)
            {
                return false;
