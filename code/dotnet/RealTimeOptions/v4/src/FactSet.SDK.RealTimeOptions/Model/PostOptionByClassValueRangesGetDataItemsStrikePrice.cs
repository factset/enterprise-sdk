...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_strikePrice")]
    public partial class PostOptionByClassValueRangesGetDataItemsStrikePrice : IEquatable<PostOptionByClassValueRangesGetDataItemsStrikePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsStrikePrice" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsStrikePrice(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsStrikePrice);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsStrikePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsStrikePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsStrikePrice input)
        {
            if (input == null)
            {
                return false;
