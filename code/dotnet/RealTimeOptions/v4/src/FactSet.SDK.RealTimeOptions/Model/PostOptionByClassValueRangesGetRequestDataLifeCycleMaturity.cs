...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_lifeCycle_maturity")]
    public partial class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity : IEquatable<PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity>, IValidatableObject
    {
        /// <summary>
        /// Defines Interval
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate date = default(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate), HashSet<IntervalEnum> interval = default(HashSet<IntervalEnum>))
        {
            this.Date = date;
        ...
        public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate Date { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturity input)
        {
            if (input == null)
            {
                return false;
