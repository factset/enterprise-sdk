...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_thetaOneWeek")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum minimum = default(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum), PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum maximum = default(PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum))
        {
        ...
        public PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresThetaOneWeek input)
        {
            if (input == null)
            {
                return false;
