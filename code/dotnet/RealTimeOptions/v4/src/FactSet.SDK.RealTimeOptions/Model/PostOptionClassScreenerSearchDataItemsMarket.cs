...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_market")]
    public partial class PostOptionClassScreenerSearchDataItemsMarket : IEquatable<PostOptionClassScreenerSearchDataItemsMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsMarket" /> class.
        /// </summary>
        /// <param name="id">Identifier of the market..</param>
        /// <param name="name">Name of the market..</param>
        public PostOptionClassScreenerSearchDataItemsMarket(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionClassScreenerSearchDataItemsMarket {\n");
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsMarket);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsMarket input)
        {
            if (input == null)
            {
                return false;
