...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_filter_validation_price")]
    public partial class PostOptionByClassListRequestDataFilterValidationPrice : IEquatable<PostOptionByClassListRequestDataFilterValidationPrice>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataFilterValidationPrice" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataFilterValidationPrice(QualityEnum? quality = default(QualityEnum?), PostOptionByClassListRequestDataFilterValidationPriceLatest latest = default(PostOptionByClassListRequestDataFilterValidationPriceLatest), PostOptionByClassListRequestDataFilterValidationPricePrevious previous = default(PostOptionByClassListRequestDataFilterValidationPricePrevious))
        {
        ...
        public PostOptionByClassListRequestDataFilterValidationPriceLatest Latest { get; set; }

        /// <summary>
        /// Gets or Sets Previous
        /// </summary>
        [DataMember(Name = "previous", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataFilterValidationPricePrevious Previous { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataFilterValidationPrice {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataFilterValidationPrice);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataFilterValidationPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataFilterValidationPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataFilterValidationPrice input)
        {
            if (input == null)
            {
                return false;
