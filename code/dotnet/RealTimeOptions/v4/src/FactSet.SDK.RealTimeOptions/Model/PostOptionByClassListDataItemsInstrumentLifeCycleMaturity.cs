...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// Maturity data.
    /// </summary>
    [DataContract(Name = "PostOptionByClassListDataItems_instrument_lifeCycle_maturity")]
    public partial class PostOptionByClassListDataItemsInstrumentLifeCycleMaturity : IEquatable<PostOptionByClassListDataItemsInstrumentLifeCycleMaturity>, IValidatableObject
    {
        /// <summary>
        /// Maturity interval of the option. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  
        /// </summary>
        /// <value>Maturity interval of the option. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListDataItemsInstrumentLifeCycleMaturity" /> class.
        /// </summary>
        /// <param name="date">Date of the option&#39;s maturity..</param>
        /// <param name="interval">Maturity interval of the option. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  .</param>
        public PostOptionByClassListDataItemsInstrumentLifeCycleMaturity(DateTime? date = default(DateTime?), IntervalEnum? interval = default(IntervalEnum?))
        {
            this.Date = date;
        ...
        /// </summary>
        /// <value>Date of the option&#39;s maturity.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListDataItemsInstrumentLifeCycleMaturity {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListDataItemsInstrumentLifeCycleMaturity);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListDataItemsInstrumentLifeCycleMaturity instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListDataItemsInstrumentLifeCycleMaturity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListDataItemsInstrumentLifeCycleMaturity input)
        {
            if (input == null)
            {
                return false;
