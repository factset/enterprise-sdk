...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_delta")]
    public partial class PostOptionByClassListRequestDataKeyFiguresDelta : IEquatable<PostOptionByClassListRequestDataKeyFiguresDelta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresDelta" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresDelta(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum), PostOptionByClassListRequestDataContractStrikePriceMaximum maximum = default(PostOptionByClassListRequestDataContractStrikePriceMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresDelta);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresDelta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresDelta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresDelta input)
        {
            if (input == null)
            {
                return false;
