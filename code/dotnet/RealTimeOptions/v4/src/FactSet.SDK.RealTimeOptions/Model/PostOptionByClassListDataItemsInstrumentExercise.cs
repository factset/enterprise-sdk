...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListDataItems_instrument_exercise")]
    public partial class PostOptionByClassListDataItemsInstrumentExercise : IEquatable<PostOptionByClassListDataItemsInstrumentExercise>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListDataItemsInstrumentExercise" /> class.
        /// </summary>
        ...
        public PostOptionByClassListDataItemsInstrumentExercise(RightEnum? right = default(RightEnum?), StyleEnum? style = default(StyleEnum?))
        {
            this.Right = right;
            this.Style = style;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListDataItemsInstrumentExercise);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListDataItemsInstrumentExercise instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListDataItemsInstrumentExercise to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListDataItemsInstrumentExercise input)
        {
            if (input == null)
            {
                return false;
