...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_lifeCycle_expiration")]
    public partial class InlineResponse200DataLifeCycleExpiration : IEquatable<InlineResponse200DataLifeCycleExpiration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataLifeCycleExpiration" /> class.
        /// </summary>
        /// <param name="month">Month of the option&#39;s expiration..</param>
        /// <param name="year">Year of the option&#39;s expiration..</param>
        public InlineResponse200DataLifeCycleExpiration(decimal? month = default(decimal?), decimal? year = default(decimal?))
        {
            this.Month = month;
            this.Year = year;
        }
        ...
        {
            return this.Equals(input as InlineResponse200DataLifeCycleExpiration);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataLifeCycleExpiration instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataLifeCycleExpiration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataLifeCycleExpiration input)
        {
            if (input == null)
            {
                return false;
