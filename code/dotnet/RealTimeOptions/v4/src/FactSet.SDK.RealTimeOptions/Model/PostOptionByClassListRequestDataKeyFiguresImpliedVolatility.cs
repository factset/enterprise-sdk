...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_impliedVolatility")]
    public partial class PostOptionByClassListRequestDataKeyFiguresImpliedVolatility : IEquatable<PostOptionByClassListRequestDataKeyFiguresImpliedVolatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresImpliedVolatility" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresImpliedVolatility(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum), PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum))
        {
        ...
        public PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresImpliedVolatility);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresImpliedVolatility instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresImpliedVolatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresImpliedVolatility input)
        {
            if (input == null)
            {
                return false;
