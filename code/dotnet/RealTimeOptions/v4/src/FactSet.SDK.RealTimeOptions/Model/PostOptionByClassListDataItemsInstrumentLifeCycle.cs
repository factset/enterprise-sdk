...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListDataItems_instrument_lifeCycle")]
    public partial class PostOptionByClassListDataItemsInstrumentLifeCycle : IEquatable<PostOptionByClassListDataItemsInstrumentLifeCycle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListDataItemsInstrumentLifeCycle" /> class.
        /// </summary>
        /// <param name="maturity">maturity.</param>
        /// <param name="expiration">expiration.</param>
        public PostOptionByClassListDataItemsInstrumentLifeCycle(PostOptionByClassListDataItemsInstrumentLifeCycleMaturity maturity = default(PostOptionByClassListDataItemsInstrumentLifeCycleMaturity), PostOptionByClassListDataItemsInstrumentLifeCycleExpiration expiration = default(PostOptionByClassListDataItemsInstrumentLifeCycleExpiration))
        {
        ...
        public PostOptionByClassListDataItemsInstrumentLifeCycleMaturity Maturity { get; set; }

        /// <summary>
        /// Gets or Sets Expiration
        /// </summary>
        [DataMember(Name = "expiration", EmitDefaultValue = false)]
        public PostOptionByClassListDataItemsInstrumentLifeCycleExpiration Expiration { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListDataItemsInstrumentLifeCycle);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListDataItemsInstrumentLifeCycle instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListDataItemsInstrumentLifeCycle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListDataItemsInstrumentLifeCycle input)
        {
            if (input == null)
            {
                return false;
