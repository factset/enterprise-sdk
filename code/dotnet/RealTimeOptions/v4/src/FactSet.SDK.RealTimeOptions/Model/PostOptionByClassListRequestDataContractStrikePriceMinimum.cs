...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contract_strikePrice_minimum")]
    public partial class PostOptionByClassListRequestDataContractStrikePriceMinimum : IEquatable<PostOptionByClassListRequestDataContractStrikePriceMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractStrikePriceMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataContractStrikePriceMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractStrikePriceMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataContractStrikePriceMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractStrikePriceMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractStrikePriceMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractStrikePriceMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractStrikePriceMinimum input)
        {
            if (input == null)
            {
                return false;
