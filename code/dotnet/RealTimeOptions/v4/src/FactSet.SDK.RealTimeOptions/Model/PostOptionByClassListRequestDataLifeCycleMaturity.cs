...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_lifeCycle_maturity")]
    public partial class PostOptionByClassListRequestDataLifeCycleMaturity : IEquatable<PostOptionByClassListRequestDataLifeCycleMaturity>, IValidatableObject
    {
        /// <summary>
        /// Defines Interval
        /// </summary>
        ...
        /// </summary>
        /// <value>Restricts the maturity interval of the option. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  </value>
        [DataMember(Name = "interval", EmitDefaultValue = false)]
        public HashSet<IntervalEnum> Interval { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataLifeCycleMaturity" /> class.
        /// </summary>
        /// <param name="date">date.</param>
        /// <param name="interval">Restricts the maturity interval of the option. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  .</param>
        public PostOptionByClassListRequestDataLifeCycleMaturity(PostOptionByClassListRequestDataLifeCycleMaturityDate date = default(PostOptionByClassListRequestDataLifeCycleMaturityDate), HashSet<IntervalEnum> interval = default(HashSet<IntervalEnum>))
        {
            this.Date = date;
        ...
        public PostOptionByClassListRequestDataLifeCycleMaturityDate Date { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataLifeCycleMaturity);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataLifeCycleMaturity instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataLifeCycleMaturity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataLifeCycleMaturity input)
        {
            if (input == null)
            {
                return false;
