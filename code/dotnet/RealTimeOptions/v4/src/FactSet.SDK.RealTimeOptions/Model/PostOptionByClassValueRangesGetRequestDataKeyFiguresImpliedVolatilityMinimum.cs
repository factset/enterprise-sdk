...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_impliedVolatility_minimum")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum input)
        {
            if (input == null)
            {
                return false;
