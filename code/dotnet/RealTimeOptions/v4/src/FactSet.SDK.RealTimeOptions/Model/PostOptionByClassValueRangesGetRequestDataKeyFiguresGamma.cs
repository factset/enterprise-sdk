...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_gamma")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma(PostOptionByClassListRequestDataContractStrikePriceMinimum minimum = default(PostOptionByClassListRequestDataContractStrikePriceMinimum), PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum maximum = default(PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresGamma input)
        {
            if (input == null)
            {
                return false;
