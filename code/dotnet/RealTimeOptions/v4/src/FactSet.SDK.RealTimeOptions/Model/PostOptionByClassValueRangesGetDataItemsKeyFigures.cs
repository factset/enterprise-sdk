...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_keyFigures")]
    public partial class PostOptionByClassValueRangesGetDataItemsKeyFigures : IEquatable<PostOptionByClassValueRangesGetDataItemsKeyFigures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsKeyFigures" /> class.
        /// </summary>
        /// <param name="moneyness">moneyness.</param>
        public PostOptionByClassValueRangesGetDataItemsKeyFigures(PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness moneyness = default(PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness))
        {
        ...
        public PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness Moneyness { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsKeyFigures);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsKeyFigures instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsKeyFigures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsKeyFigures input)
        {
            if (input == null)
            {
                return false;
