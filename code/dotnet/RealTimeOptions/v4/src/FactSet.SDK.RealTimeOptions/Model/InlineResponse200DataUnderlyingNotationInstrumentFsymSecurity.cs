...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_underlying_notation_instrument_fsym_security")]
    public partial class InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity : IEquatable<InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity" /> class.
        /// </summary>
        ...
        public InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity(string permanentIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataUnderlyingNotationInstrumentFsymSecurity input)
        {
            if (input == null)
            {
                return false;
