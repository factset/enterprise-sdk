...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_leverage_maximum")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum input)
        {
            if (input == null)
            {
                return false;
