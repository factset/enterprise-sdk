...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_currency_exclude")]
    public partial class PostOptionClassScreenerSearchRequestDataCurrencyExclude : IEquatable<PostOptionClassScreenerSearchRequestDataCurrencyExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataCurrencyExclude" /> class.
        /// </summary>
        /// <param name="ids">Set of currency identifiers..</param>
        public PostOptionClassScreenerSearchRequestDataCurrencyExclude(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataCurrencyExclude);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataCurrencyExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataCurrencyExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataCurrencyExclude input)
        {
            if (input == null)
            {
                return false;
