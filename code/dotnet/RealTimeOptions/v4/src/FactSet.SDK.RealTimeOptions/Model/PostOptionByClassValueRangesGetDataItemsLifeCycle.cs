...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_lifeCycle")]
    public partial class PostOptionByClassValueRangesGetDataItemsLifeCycle : IEquatable<PostOptionByClassValueRangesGetDataItemsLifeCycle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsLifeCycle" /> class.
        /// </summary>
        /// <param name="maturity">maturity.</param>
        /// <param name="expiration">expiration.</param>
        public PostOptionByClassValueRangesGetDataItemsLifeCycle(PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity maturity = default(PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity), PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration expiration = default(PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration))
        {
        ...
        public PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity Maturity { get; set; }

        /// <summary>
        /// Gets or Sets Expiration
        /// </summary>
        [DataMember(Name = "expiration", EmitDefaultValue = false)]
        public PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration Expiration { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsLifeCycle);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsLifeCycle instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsLifeCycle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsLifeCycle input)
        {
            if (input == null)
            {
                return false;
