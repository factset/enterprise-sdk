...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_currency")]
    public partial class PostOptionClassScreenerSearchRequestDataCurrency : IEquatable<PostOptionClassScreenerSearchRequestDataCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataCurrency" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public PostOptionClassScreenerSearchRequestDataCurrency(PostOptionClassScreenerSearchRequestDataCurrencyRestrict restrict = default(PostOptionClassScreenerSearchRequestDataCurrencyRestrict), PostOptionClassScreenerSearchRequestDataCurrencyExclude exclude = default(PostOptionClassScreenerSearchRequestDataCurrencyExclude))
        {
        ...
        public PostOptionClassScreenerSearchRequestDataCurrencyRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchRequestDataCurrencyExclude Exclude { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataCurrency);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataCurrency input)
        {
            if (input == null)
            {
                return false;
