...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_category")]
    public partial class PostOptionClassScreenerSearchDataItemsCategory : IEquatable<PostOptionClassScreenerSearchDataItemsCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsCategory" /> class.
        /// </summary>
        /// <param name="id">Identifier of the category..</param>
        /// <param name="name">Name of the category..</param>
        public PostOptionClassScreenerSearchDataItemsCategory(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsCategory);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsCategory input)
        {
            if (input == null)
            {
                return false;
