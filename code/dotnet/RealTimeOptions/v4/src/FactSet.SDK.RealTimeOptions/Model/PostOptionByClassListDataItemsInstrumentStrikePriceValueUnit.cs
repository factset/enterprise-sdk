...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListDataItems_instrument_strikePrice_valueUnit")]
    public partial class PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit : IEquatable<PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit" /> class.
        /// </summary>
        /// <param name="id">Idenitifier of the value unit..</param>
        /// <param name="code">Code of the value unit..</param>
        public PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListDataItemsInstrumentStrikePriceValueUnit input)
        {
            if (input == null)
            {
                return false;
