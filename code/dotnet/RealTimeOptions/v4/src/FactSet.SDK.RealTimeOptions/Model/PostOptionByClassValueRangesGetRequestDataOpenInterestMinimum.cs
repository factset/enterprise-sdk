...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_openInterest_minimum")]
    public partial class PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum : IEquatable<PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum input)
        {
            if (input == null)
            {
                return false;
