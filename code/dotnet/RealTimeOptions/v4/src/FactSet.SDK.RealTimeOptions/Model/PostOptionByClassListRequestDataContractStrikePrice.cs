...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contract_strikePrice")]
    public partial class PostOptionByClassListRequestDataContractStrikePrice : IEquatable<PostOptionByClassListRequestDataContractStrikePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractStrikePrice" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataContractStrikePrice(PostOptionByClassListRequestDataContractStrikePriceMinimum minimum = default(PostOptionByClassListRequestDataContractStrikePriceMinimum), PostOptionByClassListRequestDataContractStrikePriceMaximum maximum = default(PostOptionByClassListRequestDataContractStrikePriceMaximum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataContractStrikePrice {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractStrikePrice);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractStrikePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractStrikePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractStrikePrice input)
        {
            if (input == null)
            {
                return false;
