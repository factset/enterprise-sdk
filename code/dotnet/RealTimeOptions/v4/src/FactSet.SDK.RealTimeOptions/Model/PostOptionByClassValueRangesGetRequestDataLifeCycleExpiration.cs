...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_lifeCycle_expiration")]
    public partial class PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration : IEquatable<PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration" /> class.
        /// </summary>
        /// <param name="month">Month of the option&#39;s expiration..</param>
        /// <param name="year">Year of the option&#39;s expiration..</param>
        public PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration(decimal month = default(decimal), decimal year = default(decimal))
        {
            this.Month = month;
            this.Year = year;
        }
        ...
        /// </summary>
        /// <value>Month of the option&#39;s expiration.</value>
        ...
        /// </summary>
        /// <value>Year of the option&#39;s expiration.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataLifeCycleExpiration input)
        {
            if (input == null)
            {
                return false;
