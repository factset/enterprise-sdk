...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_underlying_notation_fsym")]
    public partial class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym : IEquatable<PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym" /> class.
        /// </summary>
        /// <param name="listing">listing.</param>
        /// <param name="regional">regional.</param>
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing listing = default(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing), PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional regional = default(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional))
        {
        ...
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing Listing { get; set; }

        /// <summary>
        /// Gets or Sets Regional
        /// </summary>
        [DataMember(Name = "regional", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional Regional { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym input)
        {
            if (input == null)
            {
                return false;
