...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_class")]
    public partial class InlineResponse200DataClass : IEquatable<InlineResponse200DataClass>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataClass" /> class.
        /// </summary>
        ...
        public InlineResponse200DataClass(string id = default(string), string isin = default(string), string name = default(string), string symbol = default(string))
        {
            this.Id = id;
            this.Isin = isin;
            this.Name = name;
        ...
        {
            return this.Equals(input as InlineResponse200DataClass);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataClass instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataClass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataClass input)
        {
            if (input == null)
            {
                return false;
