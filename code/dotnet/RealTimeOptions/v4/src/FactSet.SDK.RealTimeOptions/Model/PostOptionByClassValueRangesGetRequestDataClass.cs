...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_class")]
    public partial class PostOptionByClassValueRangesGetRequestDataClass : IEquatable<PostOptionByClassValueRangesGetRequestDataClass>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataClass" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataClass() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataClass" /> class.
        /// </summary>
        /// <param name="id">Identifier of the option class. (required).</param>
        public PostOptionByClassValueRangesGetRequestDataClass(string id)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PostOptionByClassValueRangesGetRequestDataClass and cannot be null");
            }
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataClass {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataClass);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataClass instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataClass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataClass input)
        {
            if (input == null)
            {
                return false;
