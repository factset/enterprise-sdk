...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems")]
    public partial class PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems : IEquatable<PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems" /> class.
        /// </summary>
        /// <param name="value">Attribute value..</param>
        /// <param name="count">Number of notations..</param>
        public PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems(decimal? value = default(decimal?), decimal? count = default(decimal?))
        {
            this.Value = value;
            this.Count = count;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems input)
        {
            if (input == null)
            {
                return false;
