...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_keyFigures_moneyness")]
    public partial class PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness : IEquatable<PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsKeyFiguresMoneyness input)
        {
            if (input == null)
            {
                return false;
