...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_openInterest")]
    public partial class InlineResponse200DataOpenInterest : IEquatable<InlineResponse200DataOpenInterest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataOpenInterest" /> class.
        /// </summary>
        /// <param name="volume">Total number of open positions of the option, which are not yet closed or delivered..</param>
        /// <param name="time">Date and time on which the open positions of the option are determined..</param>
        public InlineResponse200DataOpenInterest(decimal? volume = default(decimal?), DateTime? time = default(DateTime?))
        {
            this.Volume = volume;
            this.Time = time;
        }
        ...
        /// </summary>
        /// <value>Total number of open positions of the option, which are not yet closed or delivered.</value>
        ...
        /// </summary>
        /// <value>Date and time on which the open positions of the option are determined.</value>
        ...
        {
            return this.Equals(input as InlineResponse200DataOpenInterest);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataOpenInterest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataOpenInterest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataOpenInterest input)
        {
            if (input == null)
            {
                return false;
