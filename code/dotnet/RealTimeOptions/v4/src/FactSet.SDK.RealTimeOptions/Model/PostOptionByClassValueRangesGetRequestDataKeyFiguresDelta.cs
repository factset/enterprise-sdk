...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_delta")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta(PostOptionByClassListRequestDataKeyFiguresGammaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresGammaMinimum), PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum))
        {
        ...
        public PostOptionByClassListRequestDataKeyFiguresGammaMinimum Minimum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresDelta input)
        {
            if (input == null)
            {
                return false;
