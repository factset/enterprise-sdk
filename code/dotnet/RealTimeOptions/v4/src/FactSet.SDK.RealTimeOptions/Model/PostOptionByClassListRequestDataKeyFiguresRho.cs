...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_rho")]
    public partial class PostOptionByClassListRequestDataKeyFiguresRho : IEquatable<PostOptionByClassListRequestDataKeyFiguresRho>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresRho" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresRho(PostOptionByClassListRequestDataKeyFiguresRhoMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresRhoMinimum), PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresRho);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresRho instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresRho to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresRho input)
        {
            if (input == null)
            {
                return false;
