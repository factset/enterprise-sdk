...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contractSize_exclude")]
    public partial class PostOptionByClassListRequestDataContractSizeExclude : IEquatable<PostOptionByClassListRequestDataContractSizeExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractSizeExclude" /> class.
        /// </summary>
        /// <param name="values">Set of contract sizes..</param>
        public PostOptionByClassListRequestDataContractSizeExclude(HashSet<decimal> values = default(HashSet<decimal>))
        {
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractSizeExclude);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractSizeExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractSizeExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractSizeExclude input)
        {
            if (input == null)
            {
                return false;
