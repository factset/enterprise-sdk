...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_omega")]
    public partial class PostOptionByClassListRequestDataKeyFiguresOmega : IEquatable<PostOptionByClassListRequestDataKeyFiguresOmega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresOmega" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresOmega(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum), PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum))
        {
        ...
        public PostOptionByClassListRequestDataKeyFiguresOmegaMinimum Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataKeyFiguresOmegaMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresOmega);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresOmega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresOmega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresOmega input)
        {
            if (input == null)
            {
                return false;
