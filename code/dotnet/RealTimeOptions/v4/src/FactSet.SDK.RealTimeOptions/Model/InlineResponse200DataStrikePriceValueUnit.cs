...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_strikePrice_valueUnit")]
    public partial class InlineResponse200DataStrikePriceValueUnit : IEquatable<InlineResponse200DataStrikePriceValueUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataStrikePriceValueUnit" /> class.
        /// </summary>
        /// <param name="id">Idenitifier of the value unit..</param>
        /// <param name="code">Code of the value unit..</param>
        public InlineResponse200DataStrikePriceValueUnit(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200DataStrikePriceValueUnit {\n");
        ...
        {
            return this.Equals(input as InlineResponse200DataStrikePriceValueUnit);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataStrikePriceValueUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataStrikePriceValueUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataStrikePriceValueUnit input)
        {
            if (input == null)
            {
                return false;
