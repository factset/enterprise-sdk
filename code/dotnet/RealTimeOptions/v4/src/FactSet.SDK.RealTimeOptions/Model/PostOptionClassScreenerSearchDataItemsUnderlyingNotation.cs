...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_underlying_notation")]
    public partial class PostOptionClassScreenerSearchDataItemsUnderlyingNotation : IEquatable<PostOptionClassScreenerSearchDataItemsUnderlyingNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsUnderlyingNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        /// <param name="fsym">fsym.</param>
        /// <param name="instrument">instrument.</param>
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotation(string id = default(string), PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym fsym = default(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym), InlineResponse200DataUnderlyingNotationInstrument instrument = default(InlineResponse200DataUnderlyingNotationInstrument))
        {
            this.Id = id;
            this.Fsym = fsym;
        ...
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsym Fsym { get; set; }

        /// <summary>
        /// Gets or Sets Instrument
        /// </summary>
        [DataMember(Name = "instrument", EmitDefaultValue = false)]
        public InlineResponse200DataUnderlyingNotationInstrument Instrument { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsUnderlyingNotation);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsUnderlyingNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsUnderlyingNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsUnderlyingNotation input)
        {
            if (input == null)
            {
                return false;
