...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_market")]
    public partial class InlineResponse200DataMarket : IEquatable<InlineResponse200DataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataMarket" /> class.
        /// </summary>
        /// <param name="id">Identifier of the market..</param>
        /// <param name="name">Name of the market..</param>
        public InlineResponse200DataMarket(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse200DataMarket);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataMarket input)
        {
            if (input == null)
            {
                return false;
