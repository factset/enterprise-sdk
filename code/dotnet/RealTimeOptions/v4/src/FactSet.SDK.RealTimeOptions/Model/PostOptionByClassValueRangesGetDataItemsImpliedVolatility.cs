...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_impliedVolatility")]
    public partial class PostOptionByClassValueRangesGetDataItemsImpliedVolatility : IEquatable<PostOptionByClassValueRangesGetDataItemsImpliedVolatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsImpliedVolatility" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsImpliedVolatility(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsImpliedVolatility);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsImpliedVolatility instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsImpliedVolatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsImpliedVolatility input)
        {
            if (input == null)
            {
                return false;
