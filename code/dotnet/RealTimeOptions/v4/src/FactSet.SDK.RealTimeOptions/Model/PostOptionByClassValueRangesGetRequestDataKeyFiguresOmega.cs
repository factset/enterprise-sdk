...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_omega")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega(PostOptionByClassListRequestDataOpenInterestMinimum minimum = default(PostOptionByClassListRequestDataOpenInterestMinimum), PostOptionByClassListRequestDataOpenInterestMaximum maximum = default(PostOptionByClassListRequestDataOpenInterestMaximum))
        {
        ...
        public PostOptionByClassListRequestDataOpenInterestMinimum Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataOpenInterestMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresOmega input)
        {
            if (input == null)
            {
                return false;
