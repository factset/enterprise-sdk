...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_category_restrict")]
    public partial class PostOptionClassScreenerSearchRequestDataCategoryRestrict : IEquatable<PostOptionClassScreenerSearchRequestDataCategoryRestrict>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataCategoryRestrict" /> class.
        /// </summary>
        /// <param name="ids">List of category identifiers..</param>
        public PostOptionClassScreenerSearchRequestDataCategoryRestrict(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        /// </summary>
        /// <value>List of category identifiers.</value>
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataCategoryRestrict);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataCategoryRestrict instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataCategoryRestrict to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataCategoryRestrict input)
        {
            if (input == null)
            {
                return false;
