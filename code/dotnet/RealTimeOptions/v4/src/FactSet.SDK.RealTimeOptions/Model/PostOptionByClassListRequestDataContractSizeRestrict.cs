...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contractSize_restrict")]
    public partial class PostOptionByClassListRequestDataContractSizeRestrict : IEquatable<PostOptionByClassListRequestDataContractSizeRestrict>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractSizeRestrict" /> class.
        /// </summary>
        /// <param name="values">Set of contract sizes..</param>
        public PostOptionByClassListRequestDataContractSizeRestrict(HashSet<decimal> values = default(HashSet<decimal>))
        {
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractSizeRestrict);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractSizeRestrict instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractSizeRestrict to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractSizeRestrict input)
        {
            if (input == null)
            {
                return false;
