...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// Request Body
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest")]
    public partial class PostOptionByClassValueRangesGetRequest : IEquatable<PostOptionByClassValueRangesGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="meta">meta.</param>
        public PostOptionByClassValueRangesGetRequest(PostOptionByClassValueRangesGetRequestData data,PostOptionByClassValueRangesGetRequestMeta meta = default(PostOptionByClassValueRangesGetRequestMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for PostOptionByClassValueRangesGetRequest and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PostOptionByClassValueRangesGetRequestData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public PostOptionByClassValueRangesGetRequestMeta Meta { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequest input)
        {
            if (input == null)
            {
                return false;
