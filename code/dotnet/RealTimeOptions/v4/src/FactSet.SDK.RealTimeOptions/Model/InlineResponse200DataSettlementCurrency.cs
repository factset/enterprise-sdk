...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_settlement_currency")]
    public partial class InlineResponse200DataSettlementCurrency : IEquatable<InlineResponse200DataSettlementCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataSettlementCurrency" /> class.
        /// </summary>
        /// <param name="id">Identifier of the currency..</param>
        /// <param name="code">Code of the currency..</param>
        public InlineResponse200DataSettlementCurrency(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse200DataSettlementCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataSettlementCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataSettlementCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataSettlementCurrency input)
        {
            if (input == null)
            {
                return false;
