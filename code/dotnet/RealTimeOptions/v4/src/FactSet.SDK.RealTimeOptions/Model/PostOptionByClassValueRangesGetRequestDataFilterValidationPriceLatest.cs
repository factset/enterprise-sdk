...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_filter_validation_price_latest")]
    public partial class PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest : IEquatable<PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataFilterValidationPriceLatest input)
        {
            if (input == null)
            {
                return false;
