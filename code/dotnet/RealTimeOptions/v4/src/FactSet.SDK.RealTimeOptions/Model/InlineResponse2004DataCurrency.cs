...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_currency")]
    public partial class InlineResponse2004DataCurrency : IEquatable<InlineResponse2004DataCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataCurrency" /> class.
        /// </summary>
        /// <param name="id">Identifier of the currency..</param>
        /// <param name="code">Code of the currency..</param>
        public InlineResponse2004DataCurrency(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        /// </summary>
        /// <value>Code of the currency.</value>
        ...
        {
            return this.Equals(input as InlineResponse2004DataCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataCurrency input)
        {
            if (input == null)
            {
                return false;
