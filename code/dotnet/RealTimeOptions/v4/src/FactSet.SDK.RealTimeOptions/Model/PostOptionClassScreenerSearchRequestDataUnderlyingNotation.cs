...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_underlying_notation")]
    public partial class PostOptionClassScreenerSearchRequestDataUnderlyingNotation : IEquatable<PostOptionClassScreenerSearchRequestDataUnderlyingNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataUnderlyingNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public PostOptionClassScreenerSearchRequestDataUnderlyingNotation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionClassScreenerSearchRequestDataUnderlyingNotation {\n");
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataUnderlyingNotation);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataUnderlyingNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataUnderlyingNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataUnderlyingNotation input)
        {
            if (input == null)
            {
                return false;
