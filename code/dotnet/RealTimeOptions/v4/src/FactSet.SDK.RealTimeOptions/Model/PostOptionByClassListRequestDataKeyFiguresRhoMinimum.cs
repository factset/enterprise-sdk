...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_rho_minimum")]
    public partial class PostOptionByClassListRequestDataKeyFiguresRhoMinimum : IEquatable<PostOptionByClassListRequestDataKeyFiguresRhoMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresRhoMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataKeyFiguresRhoMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresRhoMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataKeyFiguresRhoMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresRhoMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresRhoMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresRhoMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresRhoMinimum input)
        {
            if (input == null)
            {
                return false;
