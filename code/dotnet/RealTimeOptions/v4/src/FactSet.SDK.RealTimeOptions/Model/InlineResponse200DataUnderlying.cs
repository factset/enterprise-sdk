...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_underlying")]
    public partial class InlineResponse200DataUnderlying : IEquatable<InlineResponse200DataUnderlying>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataUnderlying" /> class.
        /// </summary>
        ...
        public InlineResponse200DataUnderlying(string name = default(string), InlineResponse200DataUnderlyingNotation notation = default(InlineResponse200DataUnderlyingNotation))
        {
            this.Name = name;
        ...
        public InlineResponse200DataUnderlyingNotation Notation { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataUnderlying);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataUnderlying instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataUnderlying to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataUnderlying input)
        {
            if (input == null)
            {
                return false;
