...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_moneyness_maximum")]
    public partial class PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum : IEquatable<PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum input)
        {
            if (input == null)
            {
                return false;
