...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_impliedVolatility_minimum")]
    public partial class PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum : IEquatable<PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresImpliedVolatilityMinimum input)
        {
            if (input == null)
            {
                return false;
