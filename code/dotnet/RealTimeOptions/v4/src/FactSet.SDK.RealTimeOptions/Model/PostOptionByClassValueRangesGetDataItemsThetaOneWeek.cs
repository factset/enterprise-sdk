...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_thetaOneWeek")]
    public partial class PostOptionByClassValueRangesGetDataItemsThetaOneWeek : IEquatable<PostOptionByClassValueRangesGetDataItemsThetaOneWeek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsThetaOneWeek" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsThetaOneWeek(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsThetaOneWeek);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsThetaOneWeek instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsThetaOneWeek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsThetaOneWeek input)
        {
            if (input == null)
            {
                return false;
