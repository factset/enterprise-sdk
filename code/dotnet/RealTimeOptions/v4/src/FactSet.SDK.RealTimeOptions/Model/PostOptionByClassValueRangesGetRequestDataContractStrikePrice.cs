...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_contract_strikePrice")]
    public partial class PostOptionByClassValueRangesGetRequestDataContractStrikePrice : IEquatable<PostOptionByClassValueRangesGetRequestDataContractStrikePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataContractStrikePrice" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataContractStrikePrice(PostOptionByClassListRequestDataKeyFiguresRhoMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresRhoMinimum), PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum maximum = default(PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum))
        {
        ...
        public PostOptionByClassListRequestDataKeyFiguresRhoMinimum Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataContractStrikePrice);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataContractStrikePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataContractStrikePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataContractStrikePrice input)
        {
            if (input == null)
            {
                return false;
