...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_openInterest")]
    public partial class PostOptionByClassValueRangesGetDataItemsOpenInterest : IEquatable<PostOptionByClassValueRangesGetDataItemsOpenInterest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsOpenInterest" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsOpenInterest(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsOpenInterest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsOpenInterest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsOpenInterest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsOpenInterest input)
        {
            if (input == null)
            {
                return false;
