...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// Request Body
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest")]
    public partial class PostOptionClassScreenerSearchRequest : IEquatable<PostOptionClassScreenerSearchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionClassScreenerSearchRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="meta">meta.</param>
        public PostOptionClassScreenerSearchRequest(PostOptionClassScreenerSearchRequestData data,PostOptionClassScreenerSearchRequestMeta meta = default(PostOptionClassScreenerSearchRequestMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for PostOptionClassScreenerSearchRequest and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PostOptionClassScreenerSearchRequestData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchRequestMeta Meta { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequest);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequest input)
        {
            if (input == null)
            {
                return false;
