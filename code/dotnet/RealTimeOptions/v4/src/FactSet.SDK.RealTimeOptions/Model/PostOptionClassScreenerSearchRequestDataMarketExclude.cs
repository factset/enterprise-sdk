...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_market_exclude")]
    public partial class PostOptionClassScreenerSearchRequestDataMarketExclude : IEquatable<PostOptionClassScreenerSearchRequestDataMarketExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataMarketExclude" /> class.
        /// </summary>
        /// <param name="ids">Set of market identifiers..</param>
        public PostOptionClassScreenerSearchRequestDataMarketExclude(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataMarketExclude);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataMarketExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataMarketExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataMarketExclude input)
        {
            if (input == null)
            {
                return false;
