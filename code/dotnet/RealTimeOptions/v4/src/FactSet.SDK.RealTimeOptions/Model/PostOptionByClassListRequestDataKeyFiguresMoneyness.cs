...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_moneyness")]
    public partial class PostOptionByClassListRequestDataKeyFiguresMoneyness : IEquatable<PostOptionByClassListRequestDataKeyFiguresMoneyness>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresMoneyness" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresMoneyness(PostOptionByClassListRequestDataOpenInterestMinimum minimum = default(PostOptionByClassListRequestDataOpenInterestMinimum), PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum))
        {
        ...
        public PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresMoneyness);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresMoneyness instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresMoneyness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresMoneyness input)
        {
            if (input == null)
            {
                return false;
