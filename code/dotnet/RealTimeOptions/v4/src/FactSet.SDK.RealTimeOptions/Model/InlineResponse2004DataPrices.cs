...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_prices")]
    public partial class InlineResponse2004DataPrices : IEquatable<InlineResponse2004DataPrices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataPrices" /> class.
        /// </summary>
        /// <param name="ask">ask.</param>
        public InlineResponse2004DataPrices(InlineResponse2004DataPricesAsk ask = default(InlineResponse2004DataPricesAsk))
        {
            this.Ask = ask;
        }
        ...
        public InlineResponse2004DataPricesAsk Ask { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2004DataPrices);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataPrices instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataPrices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataPrices input)
        {
            if (input == null)
            {
                return false;
