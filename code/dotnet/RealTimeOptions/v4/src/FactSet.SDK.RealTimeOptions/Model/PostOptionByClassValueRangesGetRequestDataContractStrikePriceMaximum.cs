...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_contract_strikePrice_maximum")]
    public partial class PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum : IEquatable<PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum input)
        {
            if (input == null)
            {
                return false;
