...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_omega_maximum")]
    public partial class PostOptionByClassListRequestDataKeyFiguresOmegaMaximum : IEquatable<PostOptionByClassListRequestDataKeyFiguresOmegaMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresOmegaMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataKeyFiguresOmegaMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresOmegaMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataKeyFiguresOmegaMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresOmegaMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresOmegaMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresOmegaMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum input)
        {
            if (input == null)
            {
                return false;
