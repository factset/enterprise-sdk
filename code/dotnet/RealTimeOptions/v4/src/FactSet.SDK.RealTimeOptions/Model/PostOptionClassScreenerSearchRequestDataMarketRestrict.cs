...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_market_restrict")]
    public partial class PostOptionClassScreenerSearchRequestDataMarketRestrict : IEquatable<PostOptionClassScreenerSearchRequestDataMarketRestrict>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataMarketRestrict" /> class.
        /// </summary>
        /// <param name="ids">Set of market identifiers..</param>
        public PostOptionClassScreenerSearchRequestDataMarketRestrict(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionClassScreenerSearchRequestDataMarketRestrict {\n");
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataMarketRestrict);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataMarketRestrict instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataMarketRestrict to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataMarketRestrict input)
        {
            if (input == null)
            {
                return false;
