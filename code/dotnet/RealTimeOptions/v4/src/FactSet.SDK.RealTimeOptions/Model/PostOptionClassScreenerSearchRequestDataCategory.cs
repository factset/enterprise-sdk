...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_category")]
    public partial class PostOptionClassScreenerSearchRequestDataCategory : IEquatable<PostOptionClassScreenerSearchRequestDataCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataCategory" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public PostOptionClassScreenerSearchRequestDataCategory(PostOptionClassScreenerSearchRequestDataCategoryRestrict restrict = default(PostOptionClassScreenerSearchRequestDataCategoryRestrict), PostOptionClassScreenerSearchRequestDataCategoryExclude exclude = default(PostOptionClassScreenerSearchRequestDataCategoryExclude))
        {
        ...
        public PostOptionClassScreenerSearchRequestDataCategoryRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchRequestDataCategoryExclude Exclude { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionClassScreenerSearchRequestDataCategory {\n");
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataCategory);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataCategory input)
        {
            if (input == null)
            {
                return false;
