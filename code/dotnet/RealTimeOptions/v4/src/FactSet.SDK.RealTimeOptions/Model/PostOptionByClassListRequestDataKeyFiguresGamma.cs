...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_gamma")]
    public partial class PostOptionByClassListRequestDataKeyFiguresGamma : IEquatable<PostOptionByClassListRequestDataKeyFiguresGamma>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresGamma" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresGamma(PostOptionByClassListRequestDataKeyFiguresGammaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresGammaMinimum), PostOptionByClassListRequestDataContractStrikePriceMaximum maximum = default(PostOptionByClassListRequestDataContractStrikePriceMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresGamma);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresGamma instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresGamma to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresGamma input)
        {
            if (input == null)
            {
                return false;
