...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_contract")]
    public partial class PostOptionByClassValueRangesGetRequestDataContract : IEquatable<PostOptionByClassValueRangesGetRequestDataContract>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataContract" /> class.
        /// </summary>
        /// <param name="excercise">excercise.</param>
        /// <param name="strikePrice">strikePrice.</param>
        public PostOptionByClassValueRangesGetRequestDataContract(PostOptionByClassListRequestDataContractExcercise excercise = default(PostOptionByClassListRequestDataContractExcercise), PostOptionByClassValueRangesGetRequestDataContractStrikePrice strikePrice = default(PostOptionByClassValueRangesGetRequestDataContractStrikePrice))
        {
        ...
        public PostOptionByClassValueRangesGetRequestDataContractStrikePrice StrikePrice { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataContract);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataContract instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataContract to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataContract input)
        {
            if (input == null)
            {
                return false;
