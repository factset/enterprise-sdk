...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_openInterest_maximum")]
    public partial class PostOptionByClassListRequestDataOpenInterestMaximum : IEquatable<PostOptionByClassListRequestDataOpenInterestMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataOpenInterestMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataOpenInterestMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataOpenInterestMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataOpenInterestMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataOpenInterestMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataOpenInterestMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataOpenInterestMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataOpenInterestMaximum input)
        {
            if (input == null)
            {
                return false;
