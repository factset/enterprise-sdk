...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_openInterest_minimum")]
    public partial class PostOptionByClassListRequestDataOpenInterestMinimum : IEquatable<PostOptionByClassListRequestDataOpenInterestMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataOpenInterestMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataOpenInterestMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataOpenInterestMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataOpenInterestMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataOpenInterestMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataOpenInterestMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataOpenInterestMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataOpenInterestMinimum input)
        {
            if (input == null)
            {
                return false;
