...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_filter_validation_price_previous")]
    public partial class PostOptionByClassListRequestDataFilterValidationPricePrevious : IEquatable<PostOptionByClassListRequestDataFilterValidationPricePrevious>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataFilterValidationPricePrevious" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataFilterValidationPricePrevious(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataFilterValidationPricePrevious {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataFilterValidationPricePrevious);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataFilterValidationPricePrevious instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataFilterValidationPricePrevious to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataFilterValidationPricePrevious input)
        {
            if (input == null)
            {
                return false;
