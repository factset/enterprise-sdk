...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// Ask price.
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_prices_ask")]
    public partial class InlineResponse2004DataPricesAsk : IEquatable<InlineResponse2004DataPricesAsk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataPricesAsk" /> class.
        /// </summary>
        /// <param name="time">Date and time..</param>
        /// <param name="price">Price value..</param>
        public InlineResponse2004DataPricesAsk(DateTime? time = default(DateTime?), decimal? price = default(decimal?))
        {
            this.Time = time;
            this.Price = price;
        }
        ...
        {
            return this.Equals(input as InlineResponse2004DataPricesAsk);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataPricesAsk instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataPricesAsk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataPricesAsk input)
        {
            if (input == null)
            {
                return false;
