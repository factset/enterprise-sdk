...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_underlying")]
    public partial class PostOptionClassScreenerSearchDataItemsUnderlying : IEquatable<PostOptionClassScreenerSearchDataItemsUnderlying>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsUnderlying" /> class.
        /// </summary>
        ...
        public PostOptionClassScreenerSearchDataItemsUnderlying(string name = default(string), PostOptionClassScreenerSearchDataItemsUnderlyingNotation notation = default(PostOptionClassScreenerSearchDataItemsUnderlyingNotation))
        {
            this.Name = name;
        ...
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotation Notation { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsUnderlying);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsUnderlying instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsUnderlying to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsUnderlying input)
        {
            if (input == null)
            {
                return false;
