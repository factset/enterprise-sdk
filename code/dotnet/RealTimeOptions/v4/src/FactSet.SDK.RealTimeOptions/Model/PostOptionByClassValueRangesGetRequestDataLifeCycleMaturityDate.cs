...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_lifeCycle_maturity_date")]
    public partial class PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate : IEquatable<PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate(DateTime start, DateTime end)
        {
            this.Start = start;
            this.End = end;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataLifeCycleMaturityDate input)
        {
            if (input == null)
            {
                return false;
