...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_underlying_notation")]
    public partial class InlineResponse200DataUnderlyingNotation : IEquatable<InlineResponse200DataUnderlyingNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataUnderlyingNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        /// <param name="fsym">fsym.</param>
        /// <param name="instrument">instrument.</param>
        public InlineResponse200DataUnderlyingNotation(string id = default(string), InlineResponse200DataUnderlyingNotationFsym fsym = default(InlineResponse200DataUnderlyingNotationFsym), InlineResponse200DataUnderlyingNotationInstrument instrument = default(InlineResponse200DataUnderlyingNotationInstrument))
        {
            this.Id = id;
            this.Fsym = fsym;
        ...
        public InlineResponse200DataUnderlyingNotationFsym Fsym { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataUnderlyingNotation);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataUnderlyingNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataUnderlyingNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataUnderlyingNotation input)
        {
            if (input == null)
            {
                return false;
