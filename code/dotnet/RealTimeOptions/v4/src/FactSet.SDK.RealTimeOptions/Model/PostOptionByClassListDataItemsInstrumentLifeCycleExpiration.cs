...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListDataItems_instrument_lifeCycle_expiration")]
    public partial class PostOptionByClassListDataItemsInstrumentLifeCycleExpiration : IEquatable<PostOptionByClassListDataItemsInstrumentLifeCycleExpiration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListDataItemsInstrumentLifeCycleExpiration" /> class.
        /// </summary>
        /// <param name="month">Month of the option&#39;s expiration..</param>
        /// <param name="year">Year of the option&#39;s expiration..</param>
        public PostOptionByClassListDataItemsInstrumentLifeCycleExpiration(decimal? month = default(decimal?), decimal? year = default(decimal?))
        {
            this.Month = month;
            this.Year = year;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListDataItemsInstrumentLifeCycleExpiration {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListDataItemsInstrumentLifeCycleExpiration);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListDataItemsInstrumentLifeCycleExpiration instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListDataItemsInstrumentLifeCycleExpiration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListDataItemsInstrumentLifeCycleExpiration input)
        {
            if (input == null)
            {
                return false;
