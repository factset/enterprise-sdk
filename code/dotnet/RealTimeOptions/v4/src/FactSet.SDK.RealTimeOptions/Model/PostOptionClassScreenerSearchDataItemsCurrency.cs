...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_currency")]
    public partial class PostOptionClassScreenerSearchDataItemsCurrency : IEquatable<PostOptionClassScreenerSearchDataItemsCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsCurrency" /> class.
        /// </summary>
        /// <param name="id">Identifier of the currency..</param>
        /// <param name="code">Code of the currency..</param>
        public PostOptionClassScreenerSearchDataItemsCurrency(decimal? id = default(decimal?), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsCurrency);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsCurrency input)
        {
            if (input == null)
            {
                return false;
