...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_omega_minimum")]
    public partial class PostOptionByClassListRequestDataKeyFiguresOmegaMinimum : IEquatable<PostOptionByClassListRequestDataKeyFiguresOmegaMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresOmegaMinimum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataKeyFiguresOmegaMinimum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresOmegaMinimum" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataKeyFiguresOmegaMinimum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataKeyFiguresOmegaMinimum {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresOmegaMinimum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresOmegaMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresOmegaMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum input)
        {
            if (input == null)
            {
                return false;
