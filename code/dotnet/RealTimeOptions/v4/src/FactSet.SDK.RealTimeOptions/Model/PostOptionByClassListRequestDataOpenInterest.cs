...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_openInterest")]
    public partial class PostOptionByClassListRequestDataOpenInterest : IEquatable<PostOptionByClassListRequestDataOpenInterest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataOpenInterest" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataOpenInterest(PostOptionByClassListRequestDataOpenInterestMinimum minimum = default(PostOptionByClassListRequestDataOpenInterestMinimum), PostOptionByClassListRequestDataOpenInterestMaximum maximum = default(PostOptionByClassListRequestDataOpenInterestMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataOpenInterest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataOpenInterest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataOpenInterest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataOpenInterest input)
        {
            if (input == null)
            {
                return false;
