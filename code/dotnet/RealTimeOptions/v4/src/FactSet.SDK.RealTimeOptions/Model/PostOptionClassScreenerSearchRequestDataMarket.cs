...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_market")]
    public partial class PostOptionClassScreenerSearchRequestDataMarket : IEquatable<PostOptionClassScreenerSearchRequestDataMarket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataMarket" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public PostOptionClassScreenerSearchRequestDataMarket(PostOptionClassScreenerSearchRequestDataMarketRestrict restrict = default(PostOptionClassScreenerSearchRequestDataMarketRestrict), PostOptionClassScreenerSearchRequestDataMarketExclude exclude = default(PostOptionClassScreenerSearchRequestDataMarketExclude))
        {
        ...
        public PostOptionClassScreenerSearchRequestDataMarketRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchRequestDataMarketExclude Exclude { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataMarket);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataMarket instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataMarket input)
        {
            if (input == null)
            {
                return false;
