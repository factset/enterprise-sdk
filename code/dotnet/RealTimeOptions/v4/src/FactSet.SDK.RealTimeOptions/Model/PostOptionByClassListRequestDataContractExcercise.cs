...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contract_excercise")]
    public partial class PostOptionByClassListRequestDataContractExcercise : IEquatable<PostOptionByClassListRequestDataContractExcercise>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Restricts the exercise style of the option. | Value | Description | | - -- | - -- | | american | An American-style option can be exercised anytime during its life. | | european | A European-style option can be exercised at the end of its life. |  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContractExcercise" /> class.
        /// </summary>
        /// <param name="right">Restricts the exercise right of the option. | Value | Description | | - -- | - -- | | put | A put option gives the owner the right, but not the obligation, to sell an asset at a specified price within a specific time period. | | call | A call option gives the owner the right, but not the obligation, to buy an asset at a specified price within a specific time period. |  .</param>
        /// <param name="style">Restricts the exercise style of the option. | Value | Description | | - -- | - -- | | american | An American-style option can be exercised anytime during its life. | | european | A European-style option can be exercised at the end of its life. |  .</param>
        public PostOptionByClassListRequestDataContractExcercise(RightEnum? right = default(RightEnum?), StyleEnum? style = default(StyleEnum?))
        {
            this.Right = right;
            this.Style = style;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContractExcercise);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContractExcercise instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContractExcercise to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContractExcercise input)
        {
            if (input == null)
            {
                return false;
