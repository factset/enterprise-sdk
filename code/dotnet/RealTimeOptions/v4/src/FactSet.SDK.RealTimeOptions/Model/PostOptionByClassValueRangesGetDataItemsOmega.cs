...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_omega")]
    public partial class PostOptionByClassValueRangesGetDataItemsOmega : IEquatable<PostOptionByClassValueRangesGetDataItemsOmega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsOmega" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsOmega(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetDataItemsOmega {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsOmega);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsOmega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsOmega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsOmega input)
        {
            if (input == null)
            {
                return false;
