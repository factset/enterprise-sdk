...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_delta")]
    public partial class PostOptionByClassValueRangesGetDataItemsDelta : IEquatable<PostOptionByClassValueRangesGetDataItemsDelta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsDelta" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsDelta(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsDelta);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsDelta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsDelta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsDelta input)
        {
            if (input == null)
            {
                return false;
