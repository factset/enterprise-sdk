...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_leverage")]
    public partial class PostOptionByClassValueRangesGetDataItemsLeverage : IEquatable<PostOptionByClassValueRangesGetDataItemsLeverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsLeverage" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value..</param>
        /// <param name="maximum">Maximum value..</param>
        public PostOptionByClassValueRangesGetDataItemsLeverage(decimal? minimum = default(decimal?), decimal? maximum = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetDataItemsLeverage {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsLeverage);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsLeverage instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsLeverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsLeverage input)
        {
            if (input == null)
            {
                return false;
