...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_moneyness")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum), PostOptionByClassListRequestDataOpenInterestMaximum maximum = default(PostOptionByClassListRequestDataOpenInterestMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresMoneyness input)
        {
            if (input == null)
            {
                return false;
