...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    public partial class InlineResponse2003 : IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">List of option classes. Default sorting is done by symbol ascending..</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2003(List<PostOptionClassScreenerSearchDataItems> data = default(List<PostOptionClassScreenerSearchDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>List of option classes. Default sorting is done by symbol ascending.</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<PostOptionClassScreenerSearchDataItems> Data { get; set; }
