...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_openInterest")]
    public partial class PostOptionByClassValueRangesGetRequestDataOpenInterest : IEquatable<PostOptionByClassValueRangesGetRequestDataOpenInterest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataOpenInterest" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataOpenInterest(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum minimum = default(PostOptionByClassValueRangesGetRequestDataOpenInterestMinimum), PostOptionByClassListRequestDataOpenInterestMaximum maximum = default(PostOptionByClassListRequestDataOpenInterestMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataOpenInterest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataOpenInterest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataOpenInterest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataOpenInterest input)
        {
            if (input == null)
            {
                return false;
