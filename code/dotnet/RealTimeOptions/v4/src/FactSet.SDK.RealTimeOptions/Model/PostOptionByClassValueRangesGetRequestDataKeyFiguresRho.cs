...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_rho")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresRho : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresRho>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresRho" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresRho(PostOptionByClassListRequestDataOpenInterestMinimum minimum = default(PostOptionByClassListRequestDataOpenInterestMinimum), PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresRho);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresRho instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresRho to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresRho input)
        {
            if (input == null)
            {
                return false;
