...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_filter")]
    public partial class PostOptionByClassListRequestDataFilter : IEquatable<PostOptionByClassListRequestDataFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataFilter" /> class.
        /// </summary>
        /// <param name="validation">validation.</param>
        public PostOptionByClassListRequestDataFilter(PostOptionByClassListRequestDataFilterValidation validation = default(PostOptionByClassListRequestDataFilterValidation))
        {
        ...
        public PostOptionByClassListRequestDataFilterValidation Validation { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataFilter);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataFilter input)
        {
            if (input == null)
            {
                return false;
