...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_lifeCycle_maturity")]
    public partial class PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity : IEquatable<PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity" /> class.
        /// </summary>
        /// <param name="date">date.</param>
        /// <param name="interval">Values related to the maturity interval..</param>
        public PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity(PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate date = default(PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate), List<PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems> interval = default(List<PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems>))
        {
            this.Date = date;
        ...
        public PostOptionByClassValueRangesGetDataItemsLifeCycleMaturityDate Date { get; set; }

        /// <summary>
        /// Values related to the maturity interval.
        /// </summary>
        /// <value>Values related to the maturity interval.</value>
        [DataMember(Name = "interval", EmitDefaultValue = false)]
        public List<PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems> Interval { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsLifeCycleMaturity input)
        {
            if (input == null)
            {
                return false;
