...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_vega")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresVega : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresVega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresVega" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresVega(PostOptionByClassListRequestDataContractStrikePriceMinimum minimum = default(PostOptionByClassListRequestDataContractStrikePriceMinimum), PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum maximum = default(PostOptionByClassValueRangesGetRequestDataContractStrikePriceMaximum))
        {
        ...
        public PostOptionByClassListRequestDataContractStrikePriceMinimum Minimum { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataKeyFiguresVega {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresVega);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresVega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresVega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresVega input)
        {
            if (input == null)
            {
                return false;
