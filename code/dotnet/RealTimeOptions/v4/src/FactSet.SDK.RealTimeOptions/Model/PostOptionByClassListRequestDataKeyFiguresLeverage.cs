...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_leverage")]
    public partial class PostOptionByClassListRequestDataKeyFiguresLeverage : IEquatable<PostOptionByClassListRequestDataKeyFiguresLeverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresLeverage" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresLeverage(PostOptionByClassListRequestDataContractStrikePriceMinimum minimum = default(PostOptionByClassListRequestDataContractStrikePriceMinimum), PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresMoneynessMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresLeverage);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresLeverage instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresLeverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresLeverage input)
        {
            if (input == null)
            {
                return false;
