...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataItems_lifeCycle_expiration")]
    public partial class PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration : IEquatable<PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration" /> class.
        /// </summary>
        /// <param name="month">Expiration month..</param>
        /// <param name="year">Expiration year..</param>
        public PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration(List<PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems> month = default(List<PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems>), List<PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems> year = default(List<PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems>))
        {
            this.Month = month;
            this.Year = year;
        }
        ...
        public List<PostOptionByClassValueRangesGetDataLifeCycleExpirationMonthItems> Month { get; set; }
        ...
        public List<PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems> Year { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataItemsLifeCycleExpiration input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    this.Month != null &&
                    input.Month != null &&
                    this.Month.SequenceEqual(input.Month)
                ) && 
                (
