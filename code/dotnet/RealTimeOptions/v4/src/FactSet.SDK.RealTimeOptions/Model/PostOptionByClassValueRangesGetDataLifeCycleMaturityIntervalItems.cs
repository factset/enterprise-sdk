...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems")]
    public partial class PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems : IEquatable<PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems>, IValidatableObject
    {
        /// <summary>
        /// Attribute value. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  
        /// </summary>
        /// <value>Attribute value. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems" /> class.
        /// </summary>
        /// <param name="value">Attribute value. | Value | Description | | - -- | - -- | | monthly | Monthly | | weekly | Weekly | | daily | Daily | | mixed | Mixed |  .</param>
        /// <param name="count">Number of notations..</param>
        public PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems(ValueEnum? value = default(ValueEnum?), decimal? count = default(decimal?))
        {
            this.Value = value;
            this.Count = count;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataLifeCycleMaturityIntervalItems input)
        {
            if (input == null)
            {
                return false;
