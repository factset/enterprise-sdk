...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_underlying_notation_fsym_regional")]
    public partial class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional : IEquatable<PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional" /> class.
        /// </summary>
        ...
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional(string permanentIdentifier = default(string), string tickerRegion = default(string), bool? isPrimary = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional {\n");
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymRegional input)
        {
            if (input == null)
            {
                return false;
