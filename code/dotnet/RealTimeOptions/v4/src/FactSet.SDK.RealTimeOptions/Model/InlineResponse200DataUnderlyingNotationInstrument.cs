...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_underlying_notation_instrument")]
    public partial class InlineResponse200DataUnderlyingNotationInstrument : IEquatable<InlineResponse200DataUnderlyingNotationInstrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataUnderlyingNotationInstrument" /> class.
        /// </summary>
        ...
        public InlineResponse200DataUnderlyingNotationInstrument(string id = default(string), string isin = default(string), InlineResponse200DataUnderlyingNotationInstrumentNsin nsin = default(InlineResponse200DataUnderlyingNotationInstrumentNsin), InlineResponse200DataUnderlyingNotationInstrumentFsym fsym = default(InlineResponse200DataUnderlyingNotationInstrumentFsym))
        {
            this.Id = id;
            this.Isin = isin;
            this.Nsin = nsin;
        ...
        public InlineResponse200DataUnderlyingNotationInstrumentNsin Nsin { get; set; }

        /// <summary>
        /// Gets or Sets Fsym
        /// </summary>
        [DataMember(Name = "fsym", EmitDefaultValue = false)]
        public InlineResponse200DataUnderlyingNotationInstrumentFsym Fsym { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataUnderlyingNotationInstrument);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataUnderlyingNotationInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataUnderlyingNotationInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataUnderlyingNotationInstrument input)
        {
            if (input == null)
            {
                return false;
