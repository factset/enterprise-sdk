...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems")]
    public partial class PostOptionClassScreenerSearchDataItems : IEquatable<PostOptionClassScreenerSearchDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItems" /> class.
        /// </summary>
        /// <param name="id">Identifier of the option class..</param>
        /// <param name="symbol">Symbol of the option class, as defined by its market..</param>
        /// <param name="isin">ISIN of the option class..</param>
        /// <param name="name">Name of the option class..</param>
        /// <param name="market">market.</param>
        /// <param name="underlying">underlying.</param>
        /// <param name="currency">currency.</param>
        /// <param name="category">category.</param>
        public PostOptionClassScreenerSearchDataItems(string id = default(string), string symbol = default(string), string isin = default(string), string name = default(string), PostOptionClassScreenerSearchDataItemsMarket market = default(PostOptionClassScreenerSearchDataItemsMarket), PostOptionClassScreenerSearchDataItemsUnderlying underlying = default(PostOptionClassScreenerSearchDataItemsUnderlying), PostOptionClassScreenerSearchDataItemsCurrency currency = default(PostOptionClassScreenerSearchDataItemsCurrency), PostOptionClassScreenerSearchDataItemsCategory category = default(PostOptionClassScreenerSearchDataItemsCategory))
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Isin = isin;
        ...
        /// </summary>
        /// <value>Identifier of the option class.</value>
        ...
        /// </summary>
        /// <value>Symbol of the option class, as defined by its market.</value>
        ...
        /// </summary>
        /// <value>ISIN of the option class.</value>
        ...
        /// </summary>
        /// <value>Name of the option class.</value>
        ...
        public PostOptionClassScreenerSearchDataItemsMarket Market { get; set; }

        /// <summary>
        /// Gets or Sets Underlying
        /// </summary>
        [DataMember(Name = "underlying", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchDataItemsUnderlying Underlying { get; set; }

        /// <summary>
        /// Gets or Sets Currency
        /// </summary>
        [DataMember(Name = "currency", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchDataItemsCurrency Currency { get; set; }

        /// <summary>
        /// Gets or Sets Category
        /// </summary>
        [DataMember(Name = "category", EmitDefaultValue = false)]
        public PostOptionClassScreenerSearchDataItemsCategory Category { get; set; }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItems);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItems input)
        {
            if (input == null)
            {
                return false;
