...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_impliedVolatility")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility(PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum minimum = default(PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum), PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum maximum = default(PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum))
        {
        ...
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMinimum Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum Maximum { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatility input)
        {
            if (input == null)
            {
                return false;
