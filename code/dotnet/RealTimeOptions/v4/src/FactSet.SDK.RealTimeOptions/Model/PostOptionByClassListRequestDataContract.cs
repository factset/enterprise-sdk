...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_contract")]
    public partial class PostOptionByClassListRequestDataContract : IEquatable<PostOptionByClassListRequestDataContract>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataContract" /> class.
        /// </summary>
        /// <param name="excercise">excercise.</param>
        /// <param name="strikePrice">strikePrice.</param>
        public PostOptionByClassListRequestDataContract(PostOptionByClassListRequestDataContractExcercise excercise = default(PostOptionByClassListRequestDataContractExcercise), PostOptionByClassListRequestDataContractStrikePrice strikePrice = default(PostOptionByClassListRequestDataContractStrikePrice))
        {
        ...
        /// <summary>
        /// Gets or Sets Excercise
        /// </summary>
        [DataMember(Name = "excercise", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataContractExcercise Excercise { get; set; }

        /// <summary>
        /// Gets or Sets StrikePrice
        /// </summary>
        [DataMember(Name = "strikePrice", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataContractStrikePrice StrikePrice { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataContract {\n");
            sb.Append("  Excercise: ").Append(Excercise).Append("\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataContract);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataContract instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataContract to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataContract input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Excercise == input.Excercise ||
                    (this.Excercise != null &&
                    this.Excercise.Equals(input.Excercise))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Excercise.GetHashCode();
                }
