...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems")]
    public partial class PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems : IEquatable<PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems" /> class.
        /// </summary>
        /// <param name="value">Attribute value..</param>
        /// <param name="count">Number of notations..</param>
        public PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems(decimal? value = default(decimal?), decimal? count = default(decimal?))
        {
            this.Value = value;
            this.Count = count;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataLifeCycleExpirationYearItems input)
        {
            if (input == null)
            {
                return false;
