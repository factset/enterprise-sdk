...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    public partial class InlineResponse2002 : IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Possible values and value ranges of the parameters..</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2002(List<PostOptionByClassValueRangesGetDataItems> data = default(List<PostOptionByClassValueRangesGetDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Possible values and value ranges of the parameters.</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<PostOptionByClassValueRangesGetDataItems> Data { get; set; }
