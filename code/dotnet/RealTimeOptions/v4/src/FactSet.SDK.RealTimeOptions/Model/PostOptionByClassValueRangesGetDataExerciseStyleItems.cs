...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataExerciseStyleItems")]
    public partial class PostOptionByClassValueRangesGetDataExerciseStyleItems : IEquatable<PostOptionByClassValueRangesGetDataExerciseStyleItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>undefined | Value | Description | | - -- | - -- | | american | An American-style option can be exercised anytime during its life. | | european | A European-style option can be exercised at the end of its life. |  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataExerciseStyleItems" /> class.
        /// </summary>
        /// <param name="value">undefined | Value | Description | | - -- | - -- | | american | An American-style option can be exercised anytime during its life. | | european | A European-style option can be exercised at the end of its life. |  .</param>
        /// <param name="count">Number of notations..</param>
        public PostOptionByClassValueRangesGetDataExerciseStyleItems(ValueEnum? value = default(ValueEnum?), decimal? count = default(decimal?))
        {
            this.Value = value;
            this.Count = count;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataExerciseStyleItems);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataExerciseStyleItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataExerciseStyleItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataExerciseStyleItems input)
        {
            if (input == null)
            {
                return false;
