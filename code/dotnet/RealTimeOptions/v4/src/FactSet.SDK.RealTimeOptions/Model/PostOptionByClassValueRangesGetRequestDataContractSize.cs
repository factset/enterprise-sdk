...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_contractSize")]
    public partial class PostOptionByClassValueRangesGetRequestDataContractSize : IEquatable<PostOptionByClassValueRangesGetRequestDataContractSize>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataContractSize" /> class.
        /// </summary>
        /// <param name="restrict">restrict.</param>
        /// <param name="exclude">exclude.</param>
        public PostOptionByClassValueRangesGetRequestDataContractSize(PostOptionByClassValueRangesGetRequestDataContractSizeRestrict restrict = default(PostOptionByClassValueRangesGetRequestDataContractSizeRestrict), PostOptionByClassValueRangesGetRequestDataContractSizeExclude exclude = default(PostOptionByClassValueRangesGetRequestDataContractSizeExclude))
        {
        ...
        public PostOptionByClassValueRangesGetRequestDataContractSizeRestrict Restrict { get; set; }

        /// <summary>
        /// Gets or Sets Exclude
        /// </summary>
        [DataMember(Name = "exclude", EmitDefaultValue = false)]
        public PostOptionByClassValueRangesGetRequestDataContractSizeExclude Exclude { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataContractSize {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataContractSize);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataContractSize instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataContractSize to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataContractSize input)
        {
            if (input == null)
            {
                return false;
