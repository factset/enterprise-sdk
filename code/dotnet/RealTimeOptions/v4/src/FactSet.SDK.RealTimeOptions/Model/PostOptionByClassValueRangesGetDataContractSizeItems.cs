...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetDataContractSizeItems")]
    public partial class PostOptionByClassValueRangesGetDataContractSizeItems : IEquatable<PostOptionByClassValueRangesGetDataContractSizeItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetDataContractSizeItems" /> class.
        /// </summary>
        /// <param name="value">Attribute value..</param>
        /// <param name="count">Number of notations..</param>
        public PostOptionByClassValueRangesGetDataContractSizeItems(decimal? value = default(decimal?), decimal? count = default(decimal?))
        {
            this.Value = value;
            this.Count = count;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetDataContractSizeItems);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetDataContractSizeItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetDataContractSizeItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetDataContractSizeItems input)
        {
            if (input == null)
            {
                return false;
