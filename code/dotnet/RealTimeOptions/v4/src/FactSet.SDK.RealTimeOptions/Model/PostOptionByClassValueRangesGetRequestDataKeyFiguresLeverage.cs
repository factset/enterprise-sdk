...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_leverage")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum), PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum maximum = default(PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverageMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresLeverage input)
        {
            if (input == null)
            {
                return false;
