...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchDataItems_underlying_notation_fsym_listing")]
    public partial class PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing : IEquatable<PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing" /> class.
        /// </summary>
        ...
        public PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchDataItemsUnderlyingNotationFsymListing input)
        {
            if (input == null)
            {
                return false;
