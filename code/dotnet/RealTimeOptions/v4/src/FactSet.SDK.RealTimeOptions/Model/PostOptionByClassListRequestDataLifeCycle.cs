...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_lifeCycle")]
    public partial class PostOptionByClassListRequestDataLifeCycle : IEquatable<PostOptionByClassListRequestDataLifeCycle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataLifeCycle" /> class.
        /// </summary>
        /// <param name="maturity">maturity.</param>
        /// <param name="expiration">expiration.</param>
        public PostOptionByClassListRequestDataLifeCycle(PostOptionByClassListRequestDataLifeCycleMaturity maturity = default(PostOptionByClassListRequestDataLifeCycleMaturity), PostOptionByClassListRequestDataLifeCycleExpiration expiration = default(PostOptionByClassListRequestDataLifeCycleExpiration))
        {
        ...
        public PostOptionByClassListRequestDataLifeCycleMaturity Maturity { get; set; }

        /// <summary>
        /// Gets or Sets Expiration
        /// </summary>
        [DataMember(Name = "expiration", EmitDefaultValue = false)]
        public PostOptionByClassListRequestDataLifeCycleExpiration Expiration { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataLifeCycle {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataLifeCycle);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataLifeCycle instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataLifeCycle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataLifeCycle input)
        {
            if (input == null)
            {
                return false;
