...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_filter_validation")]
    public partial class PostOptionByClassListRequestDataFilterValidation : IEquatable<PostOptionByClassListRequestDataFilterValidation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataFilterValidation" /> class.
        /// </summary>
        /// <param name="onlyActive">If &#x60;true&#x60;, only active notations will be returned..</param>
        /// <param name="price">price.</param>
        public PostOptionByClassListRequestDataFilterValidation(bool onlyActive = default(bool), PostOptionByClassListRequestDataFilterValidationPrice price = default(PostOptionByClassListRequestDataFilterValidationPrice))
        {
        ...
        /// </summary>
        /// <value>If &#x60;true&#x60;, only active notations will be returned.</value>
        ...
        public PostOptionByClassListRequestDataFilterValidationPrice Price { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassListRequestDataFilterValidation {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataFilterValidation);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataFilterValidation instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataFilterValidation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataFilterValidation input)
        {
            if (input == null)
            {
                return false;
