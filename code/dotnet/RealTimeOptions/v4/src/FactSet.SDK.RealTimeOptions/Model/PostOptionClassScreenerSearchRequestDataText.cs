...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_text")]
    public partial class PostOptionClassScreenerSearchRequestDataText : IEquatable<PostOptionClassScreenerSearchRequestDataText>, IValidatableObject
    {
        /// <summary>
        /// Defines Attributes
        /// </summary>
        ...
        /// </summary>
        /// <value>List of attributes to be searched in. The value &#x60;allEntitled&#x60; cannot appear with any other value. | Value | Description | | - -- | - -- | | allEntitled | Search within all entitled attributes. | | symbol | Symbol of the option class. Class symbols are unique on an exchange (market). The search is executed as an \&quot;exact match\&quot;. | | ISIN | ISIN of the option class. The search is executed as an \&quot;exact match\&quot;. | | name | Name of the option class. |  </value>
        [DataMember(Name = "attributes", EmitDefaultValue = false)]
        public HashSet<AttributesEnum> Attributes { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataText" /> class.
        /// </summary>
        /// <param name="attributes">List of attributes to be searched in. The value &#x60;allEntitled&#x60; cannot appear with any other value. | Value | Description | | - -- | - -- | | allEntitled | Search within all entitled attributes. | | symbol | Symbol of the option class. Class symbols are unique on an exchange (market). The search is executed as an \&quot;exact match\&quot;. | | ISIN | ISIN of the option class. The search is executed as an \&quot;exact match\&quot;. | | name | Name of the option class. |  .</param>
        /// <param name="value">Text string to be searched for..</param>
        public PostOptionClassScreenerSearchRequestDataText(HashSet<AttributesEnum> attributes = default(HashSet<AttributesEnum>), string value = default(string))
        {
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataText);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataText instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataText to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataText input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            Regex regexValue = new Regex(@"^[-!#-&(-+- -\/0-:=?-Za-z]*$", RegexOptions.CultureInvariant);
