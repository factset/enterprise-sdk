...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_contractSize_exclude")]
    public partial class PostOptionByClassValueRangesGetRequestDataContractSizeExclude : IEquatable<PostOptionByClassValueRangesGetRequestDataContractSizeExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataContractSizeExclude" /> class.
        /// </summary>
        /// <param name="values">Set of contract sizes..</param>
        public PostOptionByClassValueRangesGetRequestDataContractSizeExclude(HashSet<decimal> values = default(HashSet<decimal>))
        {
            this.Values = values;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOptionByClassValueRangesGetRequestDataContractSizeExclude {\n");
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataContractSizeExclude);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataContractSizeExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataContractSizeExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataContractSizeExclude input)
        {
            if (input == null)
            {
                return false;
