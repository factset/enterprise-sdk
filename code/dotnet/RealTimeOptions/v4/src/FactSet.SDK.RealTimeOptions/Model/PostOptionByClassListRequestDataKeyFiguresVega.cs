...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_keyFigures_vega")]
    public partial class PostOptionByClassListRequestDataKeyFiguresVega : IEquatable<PostOptionByClassListRequestDataKeyFiguresVega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataKeyFiguresVega" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public PostOptionByClassListRequestDataKeyFiguresVega(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum minimum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMinimum), PostOptionByClassListRequestDataKeyFiguresOmegaMaximum maximum = default(PostOptionByClassListRequestDataKeyFiguresOmegaMaximum))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataKeyFiguresVega);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataKeyFiguresVega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataKeyFiguresVega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataKeyFiguresVega input)
        {
            if (input == null)
            {
                return false;
