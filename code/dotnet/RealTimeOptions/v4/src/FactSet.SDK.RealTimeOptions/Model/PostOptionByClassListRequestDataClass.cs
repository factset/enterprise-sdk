...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_class")]
    public partial class PostOptionByClassListRequestDataClass : IEquatable<PostOptionByClassListRequestDataClass>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataClass" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassListRequestDataClass() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataClass" /> class.
        /// </summary>
        /// <param name="id">Identifier of the option class. (required).</param>
        public PostOptionByClassListRequestDataClass(string id)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PostOptionByClassListRequestDataClass and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataClass);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataClass instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataClass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataClass input)
        {
            if (input == null)
            {
                return false;
