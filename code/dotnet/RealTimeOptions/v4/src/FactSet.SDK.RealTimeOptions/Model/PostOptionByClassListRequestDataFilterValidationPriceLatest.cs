...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassListRequest_data_filter_validation_price_latest")]
    public partial class PostOptionByClassListRequestDataFilterValidationPriceLatest : IEquatable<PostOptionByClassListRequestDataFilterValidationPriceLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassListRequestDataFilterValidationPriceLatest" /> class.
        /// </summary>
        ...
        public PostOptionByClassListRequestDataFilterValidationPriceLatest(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as PostOptionByClassListRequestDataFilterValidationPriceLatest);
        }

        /// <summary>
        /// Returns true if PostOptionByClassListRequestDataFilterValidationPriceLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassListRequestDataFilterValidationPriceLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassListRequestDataFilterValidationPriceLatest input)
        {
            if (input == null)
            {
                return false;
