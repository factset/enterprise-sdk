...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionClassScreenerSearchRequest_data_category_exclude")]
    public partial class PostOptionClassScreenerSearchRequestDataCategoryExclude : IEquatable<PostOptionClassScreenerSearchRequestDataCategoryExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionClassScreenerSearchRequestDataCategoryExclude" /> class.
        /// </summary>
        /// <param name="ids">List of category identifiers..</param>
        public PostOptionClassScreenerSearchRequestDataCategoryExclude(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as PostOptionClassScreenerSearchRequestDataCategoryExclude);
        }

        /// <summary>
        /// Returns true if PostOptionClassScreenerSearchRequestDataCategoryExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionClassScreenerSearchRequestDataCategoryExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionClassScreenerSearchRequestDataCategoryExclude input)
        {
            if (input == null)
            {
                return false;
