...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_keyFigures_impliedVolatility_maximum")]
    public partial class PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum : IEquatable<PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum" /> class.
        /// </summary>
        ...
        public PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum(decimal value,bool inclusive = true)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataKeyFiguresImpliedVolatilityMaximum input)
        {
            if (input == null)
            {
                return false;
