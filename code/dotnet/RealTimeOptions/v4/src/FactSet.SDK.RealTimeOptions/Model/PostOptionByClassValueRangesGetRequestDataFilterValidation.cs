...
namespace FactSet.SDK.RealTimeOptions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOptionByClassValueRangesGetRequest_data_filter_validation")]
    public partial class PostOptionByClassValueRangesGetRequestDataFilterValidation : IEquatable<PostOptionByClassValueRangesGetRequestDataFilterValidation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionByClassValueRangesGetRequestDataFilterValidation" /> class.
        /// </summary>
        /// <param name="onlyActive">If &#x60;true&#x60;, only active notations will be returned..</param>
        /// <param name="price">price.</param>
        public PostOptionByClassValueRangesGetRequestDataFilterValidation(bool onlyActive = default(bool), PostOptionByClassValueRangesGetRequestDataFilterValidationPrice price = default(PostOptionByClassValueRangesGetRequestDataFilterValidationPrice))
        {
        ...
        public PostOptionByClassValueRangesGetRequestDataFilterValidationPrice Price { get; set; }
        ...
        {
            return this.Equals(input as PostOptionByClassValueRangesGetRequestDataFilterValidation);
        }

        /// <summary>
        /// Returns true if PostOptionByClassValueRangesGetRequestDataFilterValidation instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionByClassValueRangesGetRequestDataFilterValidation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionByClassValueRangesGetRequestDataFilterValidation input)
        {
            if (input == null)
            {
                return false;
