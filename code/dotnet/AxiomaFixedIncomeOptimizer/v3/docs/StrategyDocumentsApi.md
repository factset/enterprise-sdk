# FactSet.SDK.AxiomaFixedIncomeOptimizer.Api.StrategyDocumentsApi
...
namespace Example
{
    public class GetAxiomaFIStrategyDocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling StrategyDocumentsApi.GetAxiomaFIStrategyDocuments: " + e.Message );
