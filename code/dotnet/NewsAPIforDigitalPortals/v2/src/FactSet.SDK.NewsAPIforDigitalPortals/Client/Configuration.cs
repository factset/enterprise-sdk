...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/NewsAPIforDigitalPortals/0.10.8";
        ...
        {
            string report = "C# SDK (FactSet.SDK.NewsAPIforDigitalPortals) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2\n";
            report += "    SDK Package Version: 0.10.8\n";
