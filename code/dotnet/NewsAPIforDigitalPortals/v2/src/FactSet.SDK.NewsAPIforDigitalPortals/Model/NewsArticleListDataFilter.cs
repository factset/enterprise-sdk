...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_news_article_list_data_filter")]
    public partial class NewsArticleListDataFilter : IEquatable<NewsArticleListDataFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleListDataFilter" /> class.
        /// </summary>
        ...
        public NewsArticleListDataFilter(NewsArticleListDataFilterRange range = default(NewsArticleListDataFilterRange), NewsArticleListDataFilterCategories categories = default(NewsArticleListDataFilterCategories), NewsArticleListDataFilterRegions regions = default(NewsArticleListDataFilterRegions), NewsArticleListDataFilterDistributor distributor = default(NewsArticleListDataFilterDistributor), NewsArticleListDataFilterPublisher publisher = default(NewsArticleListDataFilterPublisher), NewsArticleListDataFilterLanguage language = default(NewsArticleListDataFilterLanguage), NewsArticleListDataFilterTypes types = default(NewsArticleListDataFilterTypes))
        {
            this.Range = range;
        ...
        public NewsArticleListDataFilterCategories Categories { get; set; }

        /// <summary>
        /// Gets or Sets Regions
        /// </summary>
        [DataMember(Name = "regions", EmitDefaultValue = false)]
        public NewsArticleListDataFilterRegions Regions { get; set; }

        /// <summary>
        /// Gets or Sets Distributor
        /// </summary>
        [DataMember(Name = "distributor", EmitDefaultValue = false)]
        public NewsArticleListDataFilterDistributor Distributor { get; set; }

        /// <summary>
        /// Gets or Sets Publisher
        /// </summary>
        [DataMember(Name = "publisher", EmitDefaultValue = false)]
        public NewsArticleListDataFilterPublisher Publisher { get; set; }

        /// <summary>
        /// Gets or Sets Language
        /// </summary>
        [DataMember(Name = "language", EmitDefaultValue = false)]
        public NewsArticleListDataFilterLanguage Language { get; set; }

        /// <summary>
        /// Gets or Sets Types
        /// </summary>
        [DataMember(Name = "types", EmitDefaultValue = false)]
        public NewsArticleListDataFilterTypes Types { get; set; }
        ...
        {
            return this.Equals(input as NewsArticleListDataFilter);
        }

        /// <summary>
        /// Returns true if NewsArticleListDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsArticleListDataFilter to be compared</param>
        /// <returns>Boolean</returns>
