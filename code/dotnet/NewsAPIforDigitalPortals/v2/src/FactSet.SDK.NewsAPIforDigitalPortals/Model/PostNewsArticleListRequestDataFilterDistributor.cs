...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListRequest_data_filter_distributor")]
    public partial class PostNewsArticleListRequestDataFilterDistributor : IEquatable<PostNewsArticleListRequestDataFilterDistributor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListRequestDataFilterDistributor" /> class.
        /// </summary>
        /// <param name="ids">Identifiers of the distributors..</param>
        public PostNewsArticleListRequestDataFilterDistributor(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostNewsArticleListRequestDataFilterDistributor {\n");
        ...
        {
            return this.Equals(input as PostNewsArticleListRequestDataFilterDistributor);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListRequestDataFilterDistributor instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListRequestDataFilterDistributor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListRequestDataFilterDistributor input)
        {
            if (input == null)
            {
                return false;
