...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2008Data : IEquatable<InlineResponse2008Data>, IValidatableObject
    {
        ...
        public InlineResponse2008Data(decimal? id = default(decimal?), string name = default(string), InlineResponse2007DataDelivery delivery = default(InlineResponse2007DataDelivery))
        {
            this.Id = id;
            this.Name = name;
