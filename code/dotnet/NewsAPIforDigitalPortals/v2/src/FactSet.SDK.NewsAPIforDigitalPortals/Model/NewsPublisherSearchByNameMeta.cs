...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_news_publisher_searchByName_meta")]
    public partial class NewsPublisherSearchByNameMeta : IEquatable<NewsPublisherSearchByNameMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsPublisherSearchByNameMeta" /> class.
        /// </summary>
        ...
        public NewsPublisherSearchByNameMeta(List<string> attributes = default(List<string>), List<SortEnum> sort = default(List<SortEnum>))
        {
        ...
        {
            return this.Equals(input as NewsPublisherSearchByNameMeta);
        }

        /// <summary>
        /// Returns true if NewsPublisherSearchByNameMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsPublisherSearchByNameMeta to be compared</param>
        /// <returns>Boolean</returns>
