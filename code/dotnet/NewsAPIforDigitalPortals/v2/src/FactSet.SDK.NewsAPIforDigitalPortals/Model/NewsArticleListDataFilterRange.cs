...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleListDataFilterRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewsArticleListDataFilterRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleListDataFilterRange" /> class.
        /// </summary>
        ...
        public NewsArticleListDataFilterRange(string start = default(string), string end = default(string))
        {
            // to ensure "start" is required (not null)
            if (start == null) {
                throw new ArgumentNullException("start is a required property for NewsArticleListDataFilterRange and cannot be null");
            }
            this.Start = start;
            // to ensure "end" is required (not null)
            if (end == null) {
                throw new ArgumentNullException("end is a required property for NewsArticleListDataFilterRange and cannot be null");
            }
            this.End = end;
        }
        ...
        {
            return this.Equals(input as NewsArticleListDataFilterRange);
        }

        /// <summary>
        /// Returns true if NewsArticleListDataFilterRange instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsArticleListDataFilterRange to be compared</param>
        /// <returns>Boolean</returns>
