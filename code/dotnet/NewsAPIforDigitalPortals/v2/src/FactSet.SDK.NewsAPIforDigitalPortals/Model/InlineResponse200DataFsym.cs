...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_fsym")]
    public partial class InlineResponse200DataFsym : IEquatable<InlineResponse200DataFsym>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataFsym" /> class.
        /// </summary>
        /// <param name="security">security.</param>
        public InlineResponse200DataFsym(InlineResponse200DataFsymSecurity security = default(InlineResponse200DataFsymSecurity))
        {
        ...
        public InlineResponse200DataFsymSecurity Security { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200DataFsym {\n");
        ...
        {
            return this.Equals(input as InlineResponse200DataFsym);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataFsym instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataFsym to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataFsym input)
        {
            if (input == null)
            {
                return false;
