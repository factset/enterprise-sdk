...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_news_article_searchByText_data_publisher")]
    public partial class NewsArticleSearchByTextDataPublisher : IEquatable<NewsArticleSearchByTextDataPublisher>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleSearchByTextDataPublisher" /> class.
        /// </summary>
        /// <param name="ids">Identifiers of the publishers..</param>
        public NewsArticleSearchByTextDataPublisher(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as NewsArticleSearchByTextDataPublisher);
        }

        /// <summary>
        /// Returns true if NewsArticleSearchByTextDataPublisher instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsArticleSearchByTextDataPublisher to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsArticleSearchByTextDataPublisher input)
        {
            if (input == null)
            {
                return false;
