...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_news_article_list_meta_pagination")]
    public partial class NewsArticleListMetaPagination : IEquatable<NewsArticleListMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleListMetaPagination" /> class.
        /// </summary>
        ...
        public NewsArticleListMetaPagination(string cursor = default(string), decimal limit = default(decimal))
        {
            this.Cursor = cursor;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as NewsArticleListMetaPagination);
        }

        /// <summary>
        /// Returns true if NewsArticleListMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsArticleListMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsArticleListMetaPagination input)
        {
            if (input == null)
            {
                return false;
