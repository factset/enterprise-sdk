...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_news_article_searchByText_data_distributor")]
    public partial class NewsArticleSearchByTextDataDistributor : IEquatable<NewsArticleSearchByTextDataDistributor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleSearchByTextDataDistributor" /> class.
        /// </summary>
        /// <param name="ids">Identifiers of the distributors..</param>
        public NewsArticleSearchByTextDataDistributor(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as NewsArticleSearchByTextDataDistributor);
        }

        /// <summary>
        /// Returns true if NewsArticleSearchByTextDataDistributor instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsArticleSearchByTextDataDistributor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsArticleSearchByTextDataDistributor input)
        {
            if (input == null)
            {
                return false;
