...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_news_article_list_data_filter_types")]
    public partial class NewsArticleListDataFilterTypes : IEquatable<NewsArticleListDataFilterTypes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsArticleListDataFilterTypes" /> class.
        /// </summary>
        /// <param name="ids">Identifiers of the article types..</param>
        public NewsArticleListDataFilterTypes(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewsArticleListDataFilterTypes {\n");
        ...
        {
            return this.Equals(input as NewsArticleListDataFilterTypes);
        }

        /// <summary>
        /// Returns true if NewsArticleListDataFilterTypes instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsArticleListDataFilterTypes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsArticleListDataFilterTypes input)
        {
            if (input == null)
            {
                return false;
