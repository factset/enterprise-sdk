...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_9_data_distributor")]
    public partial class InlineResponse2009DataDistributor : IEquatable<InlineResponse2009DataDistributor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009DataDistributor" /> class.
        /// </summary>
        /// <param name="id">Identifier of the distributor..</param>
        /// <param name="name">Name of the distributor..</param>
        public InlineResponse2009DataDistributor(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse2009DataDistributor);
        }

        /// <summary>
        /// Returns true if InlineResponse2009DataDistributor instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009DataDistributor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009DataDistributor input)
        {
            if (input == null)
            {
                return false;
