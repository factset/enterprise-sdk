...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_categories")]
    public partial class InlineResponse200DataCategories : IEquatable<InlineResponse200DataCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataCategories" /> class.
        /// </summary>
        /// <param name="id">Identifier of the category..</param>
        /// <param name="name">Name of the category..</param>
        public InlineResponse200DataCategories(decimal? id = default(decimal?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse200DataCategories);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataCategories input)
        {
            if (input == null)
            {
                return false;
