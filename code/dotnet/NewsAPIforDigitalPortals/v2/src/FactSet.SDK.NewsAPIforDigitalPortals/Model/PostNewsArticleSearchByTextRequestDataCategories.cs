...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleSearchByTextRequest_data_categories")]
    public partial class PostNewsArticleSearchByTextRequestDataCategories : IEquatable<PostNewsArticleSearchByTextRequestDataCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleSearchByTextRequestDataCategories" /> class.
        /// </summary>
        /// <param name="ids">Identifiers of the categories..</param>
        public PostNewsArticleSearchByTextRequestDataCategories(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as PostNewsArticleSearchByTextRequestDataCategories);
        }

        /// <summary>
        /// Returns true if PostNewsArticleSearchByTextRequestDataCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleSearchByTextRequestDataCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleSearchByTextRequestDataCategories input)
        {
            if (input == null)
            {
                return false;
