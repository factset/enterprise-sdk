...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject4 : IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public InlineObject4(NewsArticleListByMediaKindData data = default(NewsArticleListByMediaKindData), NewsArticleListMeta meta = default(NewsArticleListMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject4 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public NewsArticleListByMediaKindData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public NewsArticleListMeta Meta { get; set; }
