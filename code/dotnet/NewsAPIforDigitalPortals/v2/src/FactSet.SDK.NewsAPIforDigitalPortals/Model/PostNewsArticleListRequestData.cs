...
namespace FactSet.SDK.NewsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNewsArticleListRequest_data")]
    public partial class PostNewsArticleListRequestData : IEquatable<PostNewsArticleListRequestData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewsArticleListRequestData" /> class.
        /// </summary>
        /// <param name="filter">filter.</param>
        public PostNewsArticleListRequestData(PostNewsArticleListRequestDataFilter filter = default(PostNewsArticleListRequestDataFilter))
        {
            this.Filter = filter;
        }
        ...
        {
            return this.Equals(input as PostNewsArticleListRequestData);
        }

        /// <summary>
        /// Returns true if PostNewsArticleListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewsArticleListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewsArticleListRequestData input)
        {
            if (input == null)
            {
                return false;
