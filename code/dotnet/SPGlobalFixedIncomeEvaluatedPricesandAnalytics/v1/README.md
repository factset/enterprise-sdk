...
dotnet add package FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics -v 0.1.7
```
...
nuget install FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics -Version 0.1.7
```
