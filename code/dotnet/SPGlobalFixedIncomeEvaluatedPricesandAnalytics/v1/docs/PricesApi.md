# FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api.PricesApi
...
<a name="getbondprices"></a>
# **GetBondPrices**
> BondPricesResponse GetBondPrices (List<string> ids, string startDate = null, string endDate = null, string frequency = null, string calendar = null)
...
namespace Example
{
    public class GetBondPricesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling PricesApi.GetBondPrices: " + e.Message );
...
<a name="getbondpricesforlist"></a>
# **GetBondPricesForList**
> BondPricesResponse GetBondPricesForList (BondPricesRequest bondPricesRequest)
...
namespace Example
{
    public class GetBondPricesForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration();
            ...
            var bondPricesRequest = new BondPricesRequest(); // BondPricesRequest | Request object for requesting pricing data
            ...
            {
                Console.WriteLine("Exception when calling PricesApi.GetBondPricesForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
