# FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api.CouponApi

All URIs are relative to *https://api.factset.com/content*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GetBondCoupon**](CouponApi.md#getbondcoupon) | **GET** /markit-bond-prices-and-analytics/v1/coupon | Get coupon data for given date range and list of securities
[**GetBondCouponForList**](CouponApi.md#getbondcouponforlist) | **POST** /markit-bond-prices-and-analytics/v1/coupon | Request coupon data for given date range and list of securities


<a name="getbondcoupon"></a>
# **GetBondCoupon**
> BondCouponResponse GetBondCoupon (List<string> ids, string startDate = null, string endDate = null, string frequency = null, string calendar = null)
...
namespace Example
{
    public class GetBondCouponExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new CouponApi(config);
            ...
            {
                // Get coupon data for given date range and list of securities
                BondCouponResponse result = apiInstance.GetBondCoupon(ids, startDate, endDate, frequency, calendar);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling CouponApi.GetBondCoupon: " + e.Message );
...
### Return type
[**BondCouponResponse**](BondCouponResponse.md)
...
<a name="getbondcouponforlist"></a>
# **GetBondCouponForList**
> BondCouponResponse GetBondCouponForList (BondCouponRequest bondCouponRequest)
...
namespace Example
{
    public class GetBondCouponForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration();
            ...
            var bondCouponRequest = new BondCouponRequest(); // BondCouponRequest | Request object for requesting Coupon data

            try
            {
                // Request coupon data for given date range and list of securities
                BondCouponResponse result = apiInstance.GetBondCouponForList(bondCouponRequest);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling CouponApi.GetBondCouponForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bondCouponRequest** | [**BondCouponRequest**](BondCouponRequest.md)| Request object for requesting Coupon data | 
