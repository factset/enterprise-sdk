# FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api.SpreadApi
...
namespace Example
{
    public class GetBondSpreadExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new SpreadApi(config);
            ...
            {
                Console.WriteLine("Exception when calling SpreadApi.GetBondSpread: " + e.Message );
...
namespace Example
{
    public class GetBondSpreadForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration();
            ...
            var bondSpreadRequest = new BondSpreadRequest(); // BondSpreadRequest | Request object for requesting pricing data
            ...
            {
                Console.WriteLine("Exception when calling SpreadApi.GetBondSpreadForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
