# FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api.YieldApi
...
namespace Example
{
    public class GetBondYieldExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new YieldApi(config);
            ...
            {
                Console.WriteLine("Exception when calling YieldApi.GetBondYield: " + e.Message );
...
namespace Example
{
    public class GetBondYieldForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration();
            ...
            var bondYieldRequest = new BondYieldRequest(); // BondYieldRequest | Request object for requesting yield data
            ...
            {
                Console.WriteLine("Exception when calling YieldApi.GetBondYieldForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
