...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondIssuerYieldCurveRequest")]
    public partial class BondIssuerYieldCurveRequest : IEquatable<BondIssuerYieldCurveRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondIssuerYieldCurveRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BondIssuerYieldCurveRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BondIssuerYieldCurveRequest" /> class.
        /// </summary>
        ...
        public BondIssuerYieldCurveRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BondIssuerYieldCurveRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as BondIssuerYieldCurveRequest);
        }

        /// <summary>
        /// Returns true if BondIssuerYieldCurveRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BondIssuerYieldCurveRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondIssuerYieldCurveRequest input)
        {
            if (input == null)
            {
                return false;
