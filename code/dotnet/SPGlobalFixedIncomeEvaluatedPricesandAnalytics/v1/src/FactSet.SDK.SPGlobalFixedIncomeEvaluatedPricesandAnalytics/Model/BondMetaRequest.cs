...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondMetaRequest")]
    public partial class BondMetaRequest : IEquatable<BondMetaRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondMetaRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BondMetaRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BondMetaRequest" /> class.
        /// </summary>
        ...
        public BondMetaRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BondMetaRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as BondMetaRequest);
        }

        /// <summary>
        /// Returns true if BondMetaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BondMetaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondMetaRequest input)
        {
            if (input == null)
            {
                return false;
