...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "absDetailsRequest")]
    public partial class AbsDetailsRequest : IEquatable<AbsDetailsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbsDetailsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AbsDetailsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AbsDetailsRequest" /> class.
        /// </summary>
        ...
        public AbsDetailsRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for AbsDetailsRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as AbsDetailsRequest);
        }

        /// <summary>
        /// Returns true if AbsDetailsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AbsDetailsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbsDetailsRequest input)
        {
            if (input == null)
            {
                return false;
