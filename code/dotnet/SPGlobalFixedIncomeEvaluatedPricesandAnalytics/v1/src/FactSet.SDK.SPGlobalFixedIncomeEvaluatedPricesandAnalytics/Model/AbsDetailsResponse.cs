...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "absDetailsResponse")]
    public partial class AbsDetailsResponse : IEquatable<AbsDetailsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbsDetailsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public AbsDetailsResponse(List<AbsDetails> data = default(List<AbsDetails>))
        {
            this.Data = data;
        }
        ...
        public List<AbsDetails> Data { get; set; }
        ...
        {
            return this.Equals(input as AbsDetailsResponse);
        }

        /// <summary>
        /// Returns true if AbsDetailsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AbsDetailsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbsDetailsResponse input)
        {
            if (input == null)
            {
                return false;
