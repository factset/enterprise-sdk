...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondPricesResponse")]
    public partial class BondPricesResponse : IEquatable<BondPricesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondPricesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public BondPricesResponse(List<BondPrices> data = default(List<BondPrices>))
        {
            this.Data = data;
        }
        ...
        public List<BondPrices> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BondPricesResponse {\n");
        ...
        {
            return this.Equals(input as BondPricesResponse);
        }

        /// <summary>
        /// Returns true if BondPricesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BondPricesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondPricesResponse input)
        {
            if (input == null)
            {
                return false;
