...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondSensitivityRequest")]
    public partial class BondSensitivityRequest : IEquatable<BondSensitivityRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondSensitivityRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BondSensitivityRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BondSensitivityRequest" /> class.
        /// </summary>
        ...
        public BondSensitivityRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BondSensitivityRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as BondSensitivityRequest);
        }

        /// <summary>
        /// Returns true if BondSensitivityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BondSensitivityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondSensitivityRequest input)
        {
            if (input == null)
            {
                return false;
