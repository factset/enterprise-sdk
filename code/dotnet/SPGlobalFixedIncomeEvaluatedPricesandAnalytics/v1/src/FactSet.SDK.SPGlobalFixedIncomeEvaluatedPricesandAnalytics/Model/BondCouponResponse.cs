...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondCouponResponse")]
    public partial class BondCouponResponse : IEquatable<BondCouponResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondCouponResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public BondCouponResponse(List<BondCoupon> data = default(List<BondCoupon>))
        {
            this.Data = data;
        }
        ...
        public List<BondCoupon> Data { get; set; }
        ...
        {
            return this.Equals(input as BondCouponResponse);
        }

        /// <summary>
        /// Returns true if BondCouponResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BondCouponResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondCouponResponse input)
        {
            if (input == null)
            {
                return false;
