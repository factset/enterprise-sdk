...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondCouponRequest")]
    public partial class BondCouponRequest : IEquatable<BondCouponRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondCouponRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BondCouponRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BondCouponRequest" /> class.
        /// </summary>
        ...
        public BondCouponRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BondCouponRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as BondCouponRequest);
        }

        /// <summary>
        /// Returns true if BondCouponRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BondCouponRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondCouponRequest input)
        {
            if (input == null)
            {
                return false;
