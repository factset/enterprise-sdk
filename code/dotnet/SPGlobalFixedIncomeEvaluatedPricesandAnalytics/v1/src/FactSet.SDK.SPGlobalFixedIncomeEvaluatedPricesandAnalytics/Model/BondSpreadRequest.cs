...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondSpreadRequest")]
    public partial class BondSpreadRequest : IEquatable<BondSpreadRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondSpreadRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BondSpreadRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BondSpreadRequest" /> class.
        /// </summary>
        ...
        public BondSpreadRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BondSpreadRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as BondSpreadRequest);
        }

        /// <summary>
        /// Returns true if BondSpreadRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BondSpreadRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondSpreadRequest input)
        {
            if (input == null)
            {
                return false;
