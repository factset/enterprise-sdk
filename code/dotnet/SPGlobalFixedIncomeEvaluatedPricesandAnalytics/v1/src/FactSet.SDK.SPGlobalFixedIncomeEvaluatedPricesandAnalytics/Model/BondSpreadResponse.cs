...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondSpreadResponse")]
    public partial class BondSpreadResponse : IEquatable<BondSpreadResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondSpreadResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public BondSpreadResponse(List<BondSpread> data = default(List<BondSpread>))
        {
            this.Data = data;
        }
        ...
        public List<BondSpread> Data { get; set; }
        ...
        {
            return this.Equals(input as BondSpreadResponse);
        }

        /// <summary>
        /// Returns true if BondSpreadResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BondSpreadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondSpreadResponse input)
        {
            if (input == null)
            {
                return false;
