...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bondYieldRequest")]
    public partial class BondYieldRequest : IEquatable<BondYieldRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BondYieldRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BondYieldRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BondYieldRequest" /> class.
        /// </summary>
        ...
        public BondYieldRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), Calendar calendar = default(Calendar))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for BondYieldRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as BondYieldRequest);
        }

        /// <summary>
        /// Returns true if BondYieldRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BondYieldRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BondYieldRequest input)
        {
            if (input == null)
            {
                return false;
