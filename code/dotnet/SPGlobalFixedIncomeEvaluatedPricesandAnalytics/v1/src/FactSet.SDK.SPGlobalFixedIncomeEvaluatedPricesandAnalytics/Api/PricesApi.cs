...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api
{
    ...
    public interface IPricesApiSync : IApiAccessor
    {
        ...
        /// <returns>BondPricesResponse</returns>
        BondPricesResponse GetBondPrices(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string));
        ...
        /// <param name="frequency">Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** &#x3D; Fiscal Quarter of the company.   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.   * **FY** &#x3D; Fiscal Annual, based on the last trading day of the company&#39;s fiscal year.  (optional, default to D)</param>
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of BondPricesResponse</returns>
        ApiResponse<BondPricesResponse> GetBondPricesWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bondPricesRequest">Request object for requesting pricing data</param>
        /// <returns>BondPricesResponse</returns>
        ...
        /// <param name="bondPricesRequest">Request object for requesting pricing data</param>
        /// <returns>ApiResponse of BondPricesResponse</returns>
        ApiResponse<BondPricesResponse> GetBondPricesForListWithHttpInfo(BondPricesRequest bondPricesRequest);
    ...
    public interface IPricesApiAsync : IApiAccessor
    {
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BondPricesResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<BondPricesResponse>> GetBondPricesWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Request Bid, Mid and Ask prices for a list of securities
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondPricesResponse</returns>
        System.Threading.Tasks.Task<BondPricesResponse> GetBondPricesForListAsync(BondPricesRequest bondPricesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BondPricesResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<BondPricesResponse>> GetBondPricesForListWithHttpInfoAsync(BondPricesRequest bondPricesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PricesApi : IPricesApi
    {
        ...
        /// <returns></returns>
        public PricesApi(FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration configuration)
        {
        ...
        /// <summary>
        /// Get Bid, Mid and Ask prices for a list of securities Get bond clean and dirty bid, mid and ask pricing data provided by Markit for a specified date range and frequency. 
        /// </summary>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Security or Entity identifiers. FactSet Identifiers, tickers, CUSIP, ISIN and SEDOL are accepted as input. &lt;p&gt;***ids limit** &#x3D; 2000  per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;* </param>
        /// <param name="startDate">The start date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint.  (optional)</param>
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>BondPricesResponse</returns>
        public BondPricesResponse GetBondPrices(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            var localVarResponse = GetBondPricesWithHttpInfo(ids, startDate, endDate, frequency, calendar);
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of BondPricesResponse</returns>
        public ApiResponse<BondPricesResponse> GetBondPricesWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
                throw new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException(400, "Missing required parameter 'ids' when calling PricesApi->GetBondPrices");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetBondPricesResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            BondPricesResponse>("/markit-bond-prices-and-analytics/v1/prices", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBondPrices", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondPricesResponse</returns>
        public async System.Threading.Tasks.Task<BondPricesResponse>GetBondPricesAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetBondPricesWithHttpInfoAsync(ids, startDate, endDate, frequency, calendar, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BondPricesResponse>> GetBondPricesWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BondPricesResponse>("/markit-bond-prices-and-analytics/v1/prices", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Request Bid, Mid and Ask prices for a list of securities Get bond clean and dirty bid, mid and ask pricing data provided by Markit for a specified date range and frequency. 
        /// </summary>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bondPricesRequest">Request object for requesting pricing data</param>
        /// <returns>BondPricesResponse</returns>
        public BondPricesResponse GetBondPricesForList(BondPricesRequest bondPricesRequest)
        {
            var localVarResponse = GetBondPricesForListWithHttpInfo(bondPricesRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="bondPricesRequest">Request object for requesting pricing data</param>
        /// <returns>ApiResponse of BondPricesResponse</returns>
        public ApiResponse<BondPricesResponse> GetBondPricesForListWithHttpInfo(BondPricesRequest bondPricesRequest)
        {
            // verify the required parameter 'bondPricesRequest' is set
            if (bondPricesRequest == null)
            {
                throw new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException(400, "Missing required parameter 'bondPricesRequest' when calling PricesApi->GetBondPricesForList");
            }
            ...
            localVarRequestOptions.Data = bondPricesRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetBondPricesForListResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBondPricesForList", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondPricesResponse</returns>
        public async System.Threading.Tasks.Task<BondPricesResponse>GetBondPricesForListAsync(BondPricesRequest bondPricesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetBondPricesForListWithHttpInfoAsync(bondPricesRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BondPricesResponse>> GetBondPricesForListWithHttpInfoAsync(BondPricesRequest bondPricesRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'bondPricesRequest' is set
            if (bondPricesRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<BondPricesResponse>("/markit-bond-prices-and-analytics/v1/prices", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
