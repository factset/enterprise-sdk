...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api
{
    ...
    public interface IMetaApiSync : IApiAccessor
    {
        ...
        /// <returns>BondMetaResponse</returns>
        BondMetaResponse GetBondMeta(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string));
        ...
        /// <param name="frequency">Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** &#x3D; Fiscal Quarter of the company.   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.   * **FY** &#x3D; Fiscal Annual, based on the last trading day of the company&#39;s fiscal year.  (optional, default to D)</param>
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of BondMetaResponse</returns>
        ApiResponse<BondMetaResponse> GetBondMetaWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string));
        /// <summary>
        /// Get bond meta data for a list of securities.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bondMetaRequest">Request object for requesting meta data</param>
        /// <returns>BondMetaResponse</returns>
        ...
        /// <param name="bondMetaRequest">Request object for requesting meta data</param>
        /// <returns>ApiResponse of BondMetaResponse</returns>
        ApiResponse<BondMetaResponse> GetBondMetaForListWithHttpInfo(BondMetaRequest bondMetaRequest);
    ...
    public interface IMetaApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of BondMetaResponse</returns>
        System.Threading.Tasks.Task<BondMetaResponse> GetBondMetaAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BondMetaResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<BondMetaResponse>> GetBondMetaWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get bond meta data for a list of securities.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondMetaResponse</returns>
        System.Threading.Tasks.Task<BondMetaResponse> GetBondMetaForListAsync(BondMetaRequest bondMetaRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BondMetaResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<BondMetaResponse>> GetBondMetaForListWithHttpInfoAsync(BondMetaRequest bondMetaRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MetaApi : IMetaApi
    {
        ...
        # region Response Type Disctionaries
                private static readonly Dictionary<HttpStatusCode, System.Type> GetBondMetaResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(BondMetaResponse) },
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetBondMetaForListResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(BondMetaResponse) },
            { (HttpStatusCode)400, typeof(ErrorResponse) },
            { (HttpStatusCode)401, typeof(ErrorResponse) },
        ...
        /// <returns></returns>
        public MetaApi(FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration configuration)
        {
        ...
        /// <summary>
        /// Get bond meta data for a list of securities. Get bond metadata like classification, maturity date, symbology information like isin, cusip, vendorid, ticker, issue and issuer name provided by Markit for a list of securities. 
        /// </summary>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Security or Entity identifiers. FactSet Identifiers, tickers, CUSIP, ISIN and SEDOL are accepted as input. &lt;p&gt;***ids limit** &#x3D; 2000  per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;* </param>
        /// <param name="startDate">The start date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint.  (optional)</param>
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>BondMetaResponse</returns>
        public BondMetaResponse GetBondMeta(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            var localVarResponse = GetBondMetaWithHttpInfo(ids, startDate, endDate, frequency, calendar);
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of BondMetaResponse</returns>
        public ApiResponse<BondMetaResponse> GetBondMetaWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
                throw new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException(400, "Missing required parameter 'ids' when calling MetaApi->GetBondMeta");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetBondMetaResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            BondMetaResponse>("/markit-bond-prices-and-analytics/v1/meta", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBondMeta", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondMetaResponse</returns>
        public async System.Threading.Tasks.Task<BondMetaResponse>GetBondMetaAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetBondMetaWithHttpInfoAsync(ids, startDate, endDate, frequency, calendar, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BondMetaResponse>> GetBondMetaWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BondMetaResponse>("/markit-bond-prices-and-analytics/v1/meta", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="bondMetaRequest">Request object for requesting meta data</param>
        /// <returns>BondMetaResponse</returns>
        public BondMetaResponse GetBondMetaForList(BondMetaRequest bondMetaRequest)
        {
            var localVarResponse = GetBondMetaForListWithHttpInfo(bondMetaRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="bondMetaRequest">Request object for requesting meta data</param>
        /// <returns>ApiResponse of BondMetaResponse</returns>
        public ApiResponse<BondMetaResponse> GetBondMetaForListWithHttpInfo(BondMetaRequest bondMetaRequest)
        {
            // verify the required parameter 'bondMetaRequest' is set
            if (bondMetaRequest == null)
            {
                throw new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException(400, "Missing required parameter 'bondMetaRequest' when calling MetaApi->GetBondMetaForList");
            }
            ...
            localVarRequestOptions.Data = bondMetaRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetBondMetaForListResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBondMetaForList", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondMetaResponse</returns>
        public async System.Threading.Tasks.Task<BondMetaResponse>GetBondMetaForListAsync(BondMetaRequest bondMetaRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetBondMetaForListWithHttpInfoAsync(bondMetaRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BondMetaResponse>> GetBondMetaForListWithHttpInfoAsync(BondMetaRequest bondMetaRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'bondMetaRequest' is set
            if (bondMetaRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<BondMetaResponse>("/markit-bond-prices-and-analytics/v1/meta", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
