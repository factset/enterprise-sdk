...
namespace FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Api
{
    ...
    /// </summary>
    public interface ISpreadApiSync : IApiAccessor
    {
        ...
        /// <returns>BondSpreadResponse</returns>
        BondSpreadResponse GetBondSpread(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string));
        ...
        /// <param name="frequency">Controls the display frequency of the data returned.   * **D** &#x3D; Daily   * **W** &#x3D; Weekly, based on the last day of the week of the start date.   * **M** &#x3D; Monthly, based on the last trading day of the month.   * **AM** &#x3D; Monthly, based on the start date (e.g., if the start date is June 16, data is displayed for June 16, May 16, April 16 etc.).   * **CQ** &#x3D; Quarterly based on the last trading day of the calendar quarter (March, June, September, or December).   * **FQ** &#x3D; Fiscal Quarter of the company.   * **AY** &#x3D; Actual Annual, based on the start date.   * **CY** &#x3D; Calendar Annual, based on the last trading day of the calendar year.   * **FY** &#x3D; Fiscal Annual, based on the last trading day of the company&#39;s fiscal year.  (optional, default to D)</param>
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of BondSpreadResponse</returns>
        ApiResponse<BondSpreadResponse> GetBondSpreadWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bondSpreadRequest">Request object for requesting pricing data</param>
        /// <returns>BondSpreadResponse</returns>
        ...
        /// <param name="bondSpreadRequest">Request object for requesting pricing data</param>
        /// <returns>ApiResponse of BondSpreadResponse</returns>
        ApiResponse<BondSpreadResponse> GetBondSpreadForListWithHttpInfo(BondSpreadRequest bondSpreadRequest);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISpreadApiAsync : IApiAccessor
    {
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BondSpreadResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<BondSpreadResponse>> GetBondSpreadWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Request the Spread and OAS data for a list of securities
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondSpreadResponse</returns>
        System.Threading.Tasks.Task<BondSpreadResponse> GetBondSpreadForListAsync(BondSpreadRequest bondSpreadRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BondSpreadResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<BondSpreadResponse>> GetBondSpreadForListWithHttpInfoAsync(BondSpreadRequest bondSpreadRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISpreadApi : ISpreadApiSync, ISpreadApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SpreadApi : ISpreadApi
    {
        ...
        # region Response Type Disctionaries
                private static readonly Dictionary<HttpStatusCode, System.Type> GetBondSpreadResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(BondSpreadResponse) },
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetBondSpreadForListResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(BondSpreadResponse) },
            { (HttpStatusCode)400, typeof(ErrorResponse) },
            { (HttpStatusCode)401, typeof(ErrorResponse) },
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpreadApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SpreadApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SpreadApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SpreadApi(FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.Configuration configuration)
        {
        ...
        /// <summary>
        /// Get the Spread and OAS data for a list of securities Get spread details like discount margin, OAS, Asset Swap Spread, Z Spread, spread benchmark provided by Markit for a specified date range and frequency. 
        /// </summary>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">Security or Entity identifiers. FactSet Identifiers, tickers, CUSIP, ISIN and SEDOL are accepted as input. &lt;p&gt;***ids limit** &#x3D; 2000  per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;* </param>
        /// <param name="startDate">The start date requested for a given date range in **YYYY-MM-DD** format. If left blank, the API will default to previous close. Future dates (T+1) are not accepted in this endpoint.  (optional)</param>
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>BondSpreadResponse</returns>
        public BondSpreadResponse GetBondSpread(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            var localVarResponse = GetBondSpreadWithHttpInfo(ids, startDate, endDate, frequency, calendar);
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. LOCAL calendar will default to the securities&#39; trading calendar which excludes date records for respective holiday periods. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of BondSpreadResponse</returns>
        public ApiResponse<BondSpreadResponse> GetBondSpreadWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
                throw new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException(400, "Missing required parameter 'ids' when calling SpreadApi->GetBondSpread");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetBondSpreadResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            BondSpreadResponse>("/markit-bond-prices-and-analytics/v1/spread", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBondSpread", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondSpreadResponse</returns>
        public async System.Threading.Tasks.Task<BondSpreadResponse>GetBondSpreadAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetBondSpreadWithHttpInfoAsync(ids, startDate, endDate, frequency, calendar, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BondSpreadResponse>> GetBondSpreadWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BondSpreadResponse>("/markit-bond-prices-and-analytics/v1/spread", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Request the Spread and OAS data for a list of securities Get spread details like discount margin, OAS, Asset Swap Spread, Z Spread, spread benchmark provided by Markit for a specified date range and frequency. 
        /// </summary>
        /// <exception cref="FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bondSpreadRequest">Request object for requesting pricing data</param>
        /// <returns>BondSpreadResponse</returns>
        public BondSpreadResponse GetBondSpreadForList(BondSpreadRequest bondSpreadRequest)
        {
            var localVarResponse = GetBondSpreadForListWithHttpInfo(bondSpreadRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="bondSpreadRequest">Request object for requesting pricing data</param>
        /// <returns>ApiResponse of BondSpreadResponse</returns>
        public ApiResponse<BondSpreadResponse> GetBondSpreadForListWithHttpInfo(BondSpreadRequest bondSpreadRequest)
        {
            // verify the required parameter 'bondSpreadRequest' is set
            if (bondSpreadRequest == null)
            {
                throw new FactSet.SDK.SPGlobalFixedIncomeEvaluatedPricesandAnalytics.Client.ApiException(400, "Missing required parameter 'bondSpreadRequest' when calling SpreadApi->GetBondSpreadForList");
            }
            ...
            localVarRequestOptions.Data = bondSpreadRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetBondSpreadForListResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBondSpreadForList", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BondSpreadResponse</returns>
        public async System.Threading.Tasks.Task<BondSpreadResponse>GetBondSpreadForListAsync(BondSpreadRequest bondSpreadRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetBondSpreadForListWithHttpInfoAsync(bondSpreadRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BondSpreadResponse>> GetBondSpreadForListWithHttpInfoAsync(BondSpreadRequest bondSpreadRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'bondSpreadRequest' is set
            if (bondSpreadRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<BondSpreadResponse>("/markit-bond-prices-and-analytics/v1/spread", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
