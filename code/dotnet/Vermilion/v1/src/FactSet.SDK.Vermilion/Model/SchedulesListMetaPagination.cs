...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SchedulesList_meta_pagination")]
    public partial class SchedulesListMetaPagination : IEquatable<SchedulesListMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulesListMetaPagination" /> class.
        /// </summary>
        /// <param name="total">The total number of Schedules available in the response..</param>
        ...
        public SchedulesListMetaPagination(int total = default(int), bool isEstimatedTotal = default(bool))
        {
            this.Total = total;
        ...
        /// </summary>
        /// <value>The total number of Schedules available in the response.</value>
        ...
        {
            return this.Equals(input as SchedulesListMetaPagination);
        }

        /// <summary>
        /// Returns true if SchedulesListMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of SchedulesListMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchedulesListMetaPagination input)
        {
            if (input == null)
            {
                return false;
