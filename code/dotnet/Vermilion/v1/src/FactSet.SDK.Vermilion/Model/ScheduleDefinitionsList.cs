...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class ScheduleDefinitionsList : IEquatable<ScheduleDefinitionsList>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ScheduleDefinitionsList);
        }

        /// <summary>
        /// Returns true if ScheduleDefinitionsList instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleDefinitionsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleDefinitionsList input)
        {
            if (input == null)
            {
                return false;
