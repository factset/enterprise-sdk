...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class ReportRevisionDTO : IEquatable<ReportRevisionDTO>, IValidatableObject
    {
        ...
        public ReportRevisionDTO(ReportStatusEnum? reportStatus = default(ReportStatusEnum?), string startDate = default(string), string finishDate = default(string), SignOffStatusEnum? signOffStatus = default(SignOffStatusEnum?), string signOffNotes = default(string), string reportReasonCd = default(string), string outputFormat = default(string), int percentageComplete = default(int))
        {
