...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskList_meta_pagination")]
    public partial class TaskListMetaPagination : IEquatable<TaskListMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskListMetaPagination" /> class.
        /// </summary>
        /// <param name="total">The total number of Tasks available in the response..</param>
        ...
        public TaskListMetaPagination(int total = default(int), bool isEstimatedTotal = default(bool))
        {
            this.Total = total;
        ...
        /// </summary>
        /// <value>The total number of Tasks available in the response.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskListMetaPagination {\n");
        ...
        {
            return this.Equals(input as TaskListMetaPagination);
        }

        /// <summary>
        /// Returns true if TaskListMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskListMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskListMetaPagination input)
        {
            if (input == null)
            {
                return false;
