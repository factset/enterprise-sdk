...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class DataSourceList : IEquatable<DataSourceList>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DataSourceList);
        }

        /// <summary>
        /// Returns true if DataSourceList instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSourceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSourceList input)
        {
            if (input == null)
            {
                return false;
