...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class Tenancy : IEquatable<Tenancy>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as Tenancy);
        }

        /// <summary>
        /// Returns true if Tenancy instances are equal
        /// </summary>
        /// <param name="input">Instance of Tenancy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Tenancy input)
        {
            if (input == null)
            {
                return false;
