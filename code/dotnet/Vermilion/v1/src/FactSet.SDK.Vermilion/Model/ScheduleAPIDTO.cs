...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScheduleAPIDTO")]
    public partial class ScheduleAPIDTO : IEquatable<ScheduleAPIDTO>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleAPIDTO" /> class.
        /// </summary>
        ...
        public ScheduleAPIDTO(int scheduleId = default(int), string name = default(string), string definitionName = default(string), StatusEnum? status = default(StatusEnum?), string scheduleGroup = default(string), string reportDate = default(string), int noOfTasks = default(int), string businessCalendar = default(string), string owner = default(string), string notes = default(string), string finishDate = default(string), string startDate = default(string), string lastUpdatedBy = default(string), string lastUpdated = default(string), bool hasTaskGenIssues = default(bool))
        {
        ...
        {
            return this.Equals(input as ScheduleAPIDTO);
        }

        /// <summary>
        /// Returns true if ScheduleAPIDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleAPIDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleAPIDTO input)
        {
            if (input == null)
            {
                return false;
