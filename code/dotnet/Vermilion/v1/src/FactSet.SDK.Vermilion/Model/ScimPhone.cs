...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class ScimPhone : IEquatable<ScimPhone>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ScimPhone);
        }

        /// <summary>
        /// Returns true if ScimPhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimPhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimPhone input)
        {
            if (input == null)
            {
                return false;
