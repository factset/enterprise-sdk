...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    /// Task Object
    /// </summary>
    [DataContract(Name = "TaskListItemDetails")]
    public partial class TaskListItemDetails : IEquatable<TaskListItemDetails>, IValidatableObject
    {
        /// <summary>
        /// Type of the task.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskListItemDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TaskListItemDetails);
        }

        /// <summary>
        /// Returns true if TaskListItemDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskListItemDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskListItemDetails input)
        {
            if (input == null)
            {
                return false;
