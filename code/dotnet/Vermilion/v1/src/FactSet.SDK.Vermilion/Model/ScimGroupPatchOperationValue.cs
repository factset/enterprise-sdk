...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class ScimGroupPatchOperationValue : IEquatable<ScimGroupPatchOperationValue>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ScimGroupPatchOperationValue);
        }

        /// <summary>
        /// Returns true if ScimGroupPatchOperationValue instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimGroupPatchOperationValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimGroupPatchOperationValue input)
        {
            if (input == null)
            {
                return false;
