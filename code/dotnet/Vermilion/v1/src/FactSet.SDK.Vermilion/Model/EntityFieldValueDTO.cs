...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class EntityFieldValueDTO : IEquatable<EntityFieldValueDTO>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EntityFieldValueDTO);
        }

        /// <summary>
        /// Returns true if EntityFieldValueDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityFieldValueDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityFieldValueDTO input)
        {
            if (input == null)
            {
                return false;
