...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScheduleDefinitionsList_meta_pagination")]
    public partial class ScheduleDefinitionsListMetaPagination : IEquatable<ScheduleDefinitionsListMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleDefinitionsListMetaPagination" /> class.
        /// </summary>
        /// <param name="total">The total number of Schedule Definitions available in the response..</param>
        ...
        public ScheduleDefinitionsListMetaPagination(int total = default(int), bool isEstimatedTotal = default(bool))
        {
            this.Total = total;
        ...
        /// </summary>
        /// <value>The total number of Schedule Definitions available in the response.</value>
        ...
        {
            return this.Equals(input as ScheduleDefinitionsListMetaPagination);
        }

        /// <summary>
        /// Returns true if ScheduleDefinitionsListMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleDefinitionsListMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleDefinitionsListMetaPagination input)
        {
            if (input == null)
            {
                return false;
