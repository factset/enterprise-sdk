...
namespace FactSet.SDK.Vermilion.Model
{
    ...
    public partial class ReportInstanceListMeta : IEquatable<ReportInstanceListMeta>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ReportInstanceListMeta);
        }

        /// <summary>
        /// Returns true if ReportInstanceListMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportInstanceListMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportInstanceListMeta input)
        {
            if (input == null)
            {
                return false;
