...
namespace FactSet.SDK.Vermilion.Api
{
    ...
    public interface IEntityApiSync : IApiAccessor
    {
        ...
        EntityFieldValueDTO V1TenantEntitiesEntityCodeValuesGet(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        ...
        ApiResponse<EntityFieldValueDTO> V1TenantEntitiesEntityCodeValuesGetWithHttpInfo(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?));
    ...
    public interface IEntityApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<EntityFieldValueDTO>> V1TenantEntitiesEntityCodeValuesGetWithHttpInfoAsync(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EntityApi : IEntityApi
    {
        ...
        /// <param name="paginationOffset">Non-negative number of entries to skip. Default is 0 (optional)</param>
        /// <returns>EntityFieldValueDTO</returns>
        public EntityFieldValueDTO V1TenantEntitiesEntityCodeValuesGet(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
            FactSet.SDK.Vermilion.Client.ApiResponse<EntityFieldValueDTO> localVarResponse = V1TenantEntitiesEntityCodeValuesGetWithHttpInfo(tenant, entityCode, sort, paginationLimit, paginationOffset);
        ...
        /// <param name="paginationOffset">Non-negative number of entries to skip. Default is 0 (optional)</param>
        /// <returns>ApiResponse of EntityFieldValueDTO</returns>
        public FactSet.SDK.Vermilion.Client.ApiResponse<EntityFieldValueDTO> V1TenantEntitiesEntityCodeValuesGetWithHttpInfo(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
            // verify the required parameter 'tenant' is set
            if (tenant == null)
            {
                throw new FactSet.SDK.Vermilion.Client.ApiException(400, "Missing required parameter 'tenant' when calling EntityApi->V1TenantEntitiesEntityCodeValuesGet");
            }

            // verify the required parameter 'entityCode' is set
            if (entityCode == null)
            {
                throw new FactSet.SDK.Vermilion.Client.ApiException(400, "Missing required parameter 'entityCode' when calling EntityApi->V1TenantEntitiesEntityCodeValuesGet");
            }
            ...
            var localVarResponse = this.Client.Get<EntityFieldValueDTO>("/v1/{tenant}/entities/{entityCode}/values", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("V1TenantEntitiesEntityCodeValuesGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EntityFieldValueDTO</returns>
        public async System.Threading.Tasks.Task<EntityFieldValueDTO> V1TenantEntitiesEntityCodeValuesGetAsync(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FactSet.SDK.Vermilion.Client.ApiResponse<EntityFieldValueDTO> localVarResponse = await V1TenantEntitiesEntityCodeValuesGetWithHttpInfoAsync(tenant, entityCode, sort, paginationLimit, paginationOffset, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EntityFieldValueDTO)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Vermilion.Client.ApiResponse<EntityFieldValueDTO>> V1TenantEntitiesEntityCodeValuesGetWithHttpInfoAsync(string tenant, string entityCode, string sort = default(string), int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenant' is set
            if (tenant == null)
            {
