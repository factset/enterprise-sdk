...
namespace Example
{
    public class GetPeopleProfilesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ProfilesApi.GetPeopleProfiles: " + e.Message );
...
namespace Example
{
    public class GetPeopleProfilesForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ProfilesApi.GetPeopleProfilesForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
