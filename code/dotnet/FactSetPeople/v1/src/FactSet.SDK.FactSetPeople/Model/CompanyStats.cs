...
namespace FactSet.SDK.FactSetPeople.Model
{
    ...
    public partial class CompanyStats : IEquatable<CompanyStats>, IValidatableObject
    {
        ...
        public CompanyStats(string fsymId = default(string), decimal? averageMgmtCompensation = default(decimal?), double? averageTenure = default(double?), double? medianTenure = default(double?), double? averageAge = default(double?), decimal? maxAge = default(decimal?), decimal? minimumAge = default(decimal?), decimal? medianAge = default(decimal?), decimal? boardIndependentDirectors = default(decimal?), decimal? femaleBoardMembers = default(decimal?), double? femaleBoardMembersPercent = default(double?), decimal? numberOfMembers = default(decimal?), decimal? onOtherBoardsAll = default(decimal?), decimal? onOtherBoardsCorporate = default(decimal?), string mbType = default(string), string requestId = default(string))
        {
            this.FsymId = fsymId;
