...
namespace FactSet.SDK.FactSetPeople.Model
{
    ...
    /// </summary>
    [DataContract(Name = "companyPositionsRequest")]
    public partial class CompanyPositionsRequest : IEquatable<CompanyPositionsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyPositionsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompanyPositionsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyPositionsRequest" /> class.
        /// </summary>
        ...
        public CompanyPositionsRequest(List<string> ids = default(List<string>), Position position = default(Position))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for CompanyPositionsRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as CompanyPositionsRequest);
        }

        /// <summary>
        /// Returns true if CompanyPositionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyPositionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyPositionsRequest input)
        {
            if (input == null)
                return false;
