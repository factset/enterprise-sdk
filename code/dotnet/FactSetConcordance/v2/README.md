...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetConcordance/2.0.1)
...
dotnet add package FactSet.SDK.FactSetConcordance -v 2.0.1
```
...
nuget install FactSet.SDK.FactSetConcordance -Version 2.0.1
```
