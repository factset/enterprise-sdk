...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class EntityMatchRequest : IEquatable<EntityMatchRequest>, IValidatableObject
    {
        ...
        /// <param name="candidatesCount">Maximum number of candidates to be returned. Parent entities, when includeParent is true, are not included in this count.  (default to 20).</param>
        ...
        public EntityMatchRequest(List<EntityMatchRequestInput> input,List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), int candidatesCount = 20, List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool includeParent = false, int universeId = default(int))
        {
