...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PeopleUniverseResponse")]
    public partial class PeopleUniverseResponse : IEquatable<PeopleUniverseResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleUniverseResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PeopleUniverseResponse(List<PeopleMapping> data = default(List<PeopleMapping>))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as PeopleUniverseResponse);
        }

        /// <summary>
        /// Returns true if PeopleUniverseResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleUniverseResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleUniverseResponse input)
        {
            if (input == null)
            {
                return false;
