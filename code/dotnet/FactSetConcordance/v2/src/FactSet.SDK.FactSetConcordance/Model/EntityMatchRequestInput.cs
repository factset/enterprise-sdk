...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class EntityMatchRequestInput : IEquatable<EntityMatchRequestInput>, IValidatableObject
    {
        ...
        /// <param name="country">ISO2 country code corresponding to the entity name that is used when evaluating candidates for a match. For a list of ISO Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754#country). .</param>
        ...
        /// <param name="creditsafe">Creditsafe Identifier.</param>
        /// <param name="crunchbase">Crunchbase Identifier.</param>
        ...
        /// </summary>
        /// <value>ISO2 country code corresponding to the entity name that is used when evaluating candidates for a match. For a list of ISO Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754#country). </value>
        ...
        [DataMember(Name = "creditsafe", EmitDefaultValue = false)]
        public string Creditsafe { get; set; }

        /// <summary>
        /// Crunchbase Identifier
        /// </summary>
        /// <value>Crunchbase Identifier</value>
        [DataMember(Name = "crunchbase", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Creditsafe: ").Append(Creditsafe).Append("\n");
            sb.Append("  Crunchbase: ").Append(Crunchbase).Append("\n");
        ...
        public bool Equals(EntityMatchRequestInput input)
        {
            ...
            return 
                ...
                (
                    this.Creditsafe == input.Creditsafe ||
                    (this.Creditsafe != null &&
                    this.Creditsafe.Equals(input.Creditsafe))
                ) && 
                (
                    this.Crunchbase == input.Crunchbase ||
                    (this.Crunchbase != null &&
                    this.Crunchbase.Equals(input.Crunchbase))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Creditsafe != null)
                {
                    hashCode = (hashCode * 59) + this.Creditsafe.GetHashCode();
                }
                if (this.Crunchbase != null)
                {
                    hashCode = (hashCode * 59) + this.Crunchbase.GetHashCode();
                }
                if (this.Cusip != null)
                {
