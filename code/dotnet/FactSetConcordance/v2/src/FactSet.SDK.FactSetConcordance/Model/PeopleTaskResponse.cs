...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    /// PeopleTaskResponse
    /// </summary>
    [DataContract(Name = "PeopleTaskResponse")]
    public partial class PeopleTaskResponse : IEquatable<PeopleTaskResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleTaskResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PeopleTaskResponse(PeopleTask data = default(PeopleTask))
        {
            this.Data = data;
        }
        ...
        public PeopleTask Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PeopleTaskResponse {\n");
        ...
        {
            return this.Equals(input as PeopleTaskResponse);
        }

        /// <summary>
        /// Returns true if PeopleTaskResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleTaskResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleTaskResponse input)
        {
            if (input == null)
            {
                return false;
