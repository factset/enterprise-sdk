...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityUniverseStatisticsResponse")]
    public partial class EntityUniverseStatisticsResponse : IEquatable<EntityUniverseStatisticsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityUniverseStatisticsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EntityUniverseStatisticsResponse(List<UniverseStatistics> data = default(List<UniverseStatistics>))
        {
            this.Data = data;
        }
        ...
        public List<UniverseStatistics> Data { get; set; }
        ...
        {
            return this.Equals(input as EntityUniverseStatisticsResponse);
        }

        /// <summary>
        /// Returns true if EntityUniverseStatisticsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityUniverseStatisticsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityUniverseStatisticsResponse input)
        {
            if (input == null)
            {
                return false;
