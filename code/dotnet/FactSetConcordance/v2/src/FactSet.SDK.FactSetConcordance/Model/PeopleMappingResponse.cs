...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PeopleMappingResponse")]
    public partial class PeopleMappingResponse : IEquatable<PeopleMappingResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleMappingResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PeopleMappingResponse(PeopleMapping data = default(PeopleMapping))
        {
            this.Data = data;
        }
        ...
        public PeopleMapping Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PeopleMappingResponse {\n");
        ...
        {
            return this.Equals(input as PeopleMappingResponse);
        }

        /// <summary>
        /// Returns true if PeopleMappingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleMappingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleMappingResponse input)
        {
            if (input == null)
            {
                return false;
