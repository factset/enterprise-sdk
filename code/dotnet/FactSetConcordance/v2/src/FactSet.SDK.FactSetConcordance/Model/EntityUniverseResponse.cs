...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityUniverseResponse")]
    public partial class EntityUniverseResponse : IEquatable<EntityUniverseResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityUniverseResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EntityUniverseResponse(List<EntityMapping> data = default(List<EntityMapping>))
        {
            this.Data = data;
        }
        ...
        public List<EntityMapping> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityUniverseResponse {\n");
        ...
        {
            return this.Equals(input as EntityUniverseResponse);
        }

        /// <summary>
        /// Returns true if EntityUniverseResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityUniverseResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityUniverseResponse input)
        {
            if (input == null)
            {
                return false;
