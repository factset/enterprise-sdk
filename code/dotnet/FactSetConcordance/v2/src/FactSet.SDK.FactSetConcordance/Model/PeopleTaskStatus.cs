...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class PeopleTaskStatus : IEquatable<PeopleTaskStatus>, IValidatableObject
    {
        ...
        public PeopleTaskStatus(string clientIdColumn = default(string), int? decisionRate = default(int?), string entityColumn = default(string), string firstNameColumn = default(string), bool? hasResult = default(bool?), int? inputCount = default(int?), string inputFile = default(string), string lastNameColumn = default(string), int? mappedCount = default(int?), string middleNameColumn = default(string), string personNameColumn = default(string), string priorityColumn = default(string), DateTime? processStartTime = default(DateTime?), double? processDuration = default(double?), string salutationColumn = default(string), StatusEnum? status = default(StatusEnum?), string suffixColumn = default(string), string taskAction = default(string), int? taskId = default(int?), string taskName = default(string), int? unmappedCount = default(int?), int? tryCount = default(int?), string message = default(string), string error = default(string), string errorTitle = default(string), int? indeterminateCount = default(int?), DateTime? taskSubmitTime = default(DateTime?), int? universeId = default(int?), string universeName = default(string), string userFullName = default(string), string userSerial = default(string))
        {
