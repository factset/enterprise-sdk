...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class EntityTaskStatus : IEquatable<EntityTaskStatus>, IValidatableObject
    {
        ...
        /// <param name="creditsafeColumn">the column name for type Creditsafe Identifier.</param>
        /// <param name="crunchbaseColumn">the column name for type Crunchbase Identifier.</param>
        ...
        /// </summary>
        /// <value>the column name for type Creditsafe Identifier</value>
        [DataMember(Name = "creditsafeColumn", EmitDefaultValue = true)]
        public string CreditsafeColumn { get; set; }

        /// <summary>
        /// the column name for type Crunchbase Identifier
        /// </summary>
        /// <value>the column name for type Crunchbase Identifier</value>
        [DataMember(Name = "crunchbaseColumn", EmitDefaultValue = true)]
        public string CrunchbaseColumn { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditsafeColumn: ").Append(CreditsafeColumn).Append("\n");
            sb.Append("  CrunchbaseColumn: ").Append(CrunchbaseColumn).Append("\n");
        ...
        public bool Equals(EntityTaskStatus input)
        {
            ...
            return 
                ...
                (
                    this.CreditsafeColumn == input.CreditsafeColumn ||
                    (this.CreditsafeColumn != null &&
                    this.CreditsafeColumn.Equals(input.CreditsafeColumn))
                ) && 
                (
                    this.CrunchbaseColumn == input.CrunchbaseColumn ||
                    (this.CrunchbaseColumn != null &&
                    this.CrunchbaseColumn.Equals(input.CrunchbaseColumn))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CreditsafeColumn != null)
                {
                    hashCode = (hashCode * 59) + this.CreditsafeColumn.GetHashCode();
                }
                if (this.CrunchbaseColumn != null)
                {
                    hashCode = (hashCode * 59) + this.CrunchbaseColumn.GetHashCode();
                }
