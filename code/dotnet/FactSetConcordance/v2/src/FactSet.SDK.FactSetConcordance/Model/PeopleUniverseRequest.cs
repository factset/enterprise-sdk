...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class PeopleUniverseRequest : IEquatable<PeopleUniverseRequest>, IValidatableObject
    {
        ...
        public PeopleUniverseRequest(int universeId = default(int), int offset = default(int), int limit = default(int), List<MapStatusEnum> mapStatus = default(List<MapStatusEnum>), List<string> clientId = default(List<string>))
        {
