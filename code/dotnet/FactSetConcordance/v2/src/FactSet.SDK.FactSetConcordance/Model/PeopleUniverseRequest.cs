...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PeopleUniverseRequest")]
    public partial class PeopleUniverseRequest : IEquatable<PeopleUniverseRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines MapStatus
        /// </summary>
        ...
        /// </summary>
        /// <value>Filter by the People Decisions that have the specified mapStatus, where -       * MAPPED - The requested Entity Name is successfully mapped to a FactSet Entity Id (-E)       * UNMAPPED - The requested Entity Name is unmapped by FactSet.       * INDETERMINATE - The requested Entity Name was unable to make a mapping. </value>
        [DataMember(Name = "mapStatus", EmitDefaultValue = false)]
        public List<MapStatusEnum> MapStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleUniverseRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PeopleUniverseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleUniverseRequest" /> class.
        /// </summary>
        ...
        /// <param name="mapStatus">Filter by the People Decisions that have the specified mapStatus, where -       * MAPPED - The requested Entity Name is successfully mapped to a FactSet Entity Id (-E)       * UNMAPPED - The requested Entity Name is unmapped by FactSet.       * INDETERMINATE - The requested Entity Name was unable to make a mapping. .</param>
        ...
        public PeopleUniverseRequest(int universeId,int offset = default(int), int limit = default(int), List<MapStatusEnum> mapStatus = default(List<MapStatusEnum>), List<string> clientId = default(List<string>), List<string> sort = default(List<string>))
        {
        ...
        {
            return this.Equals(input as PeopleUniverseRequest);
        }

        /// <summary>
        /// Returns true if PeopleUniverseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleUniverseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleUniverseRequest input)
        {
            if (input == null)
            {
                return false;
