...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class PeopleMatch : IEquatable<PeopleMatch>, IValidatableObject
    {
        ...
        public PeopleMatch(string activeRole = default(string), string clientEntity = default(string), string clientFirstName = default(string), string clientLastName = default(string), string clientMiddleName = default(string), string clientSalutation = default(string), string clientSuffix = default(string), string clientPriority = default(string), string clientPersonName = default(string), string firstName = default(string), string personId = default(string), string lastName = default(string), string middleName = default(string), string entity = default(string), MapStatusEnum? mapStatus = default(MapStatusEnum?), string matchFlag = default(string), string nameMatchSource = default(string), string nameMatchString = default(string), int? rowIndex = default(int?), double? similarityScore = default(double?), string title = default(string), int? universeId = default(int?), int? taskId = default(int?), string suffix = default(string), string salutation = default(string), string personName = default(string), string email = default(string), string clientId = default(string))
        {
