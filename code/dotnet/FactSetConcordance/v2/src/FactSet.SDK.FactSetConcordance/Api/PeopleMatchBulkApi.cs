...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public partial class PeopleMatchBulkApi : IPeopleMatchBulkApi
    {
        ...
        {
            var localVarResponse = GetPeopleTaskForListWithHttpInfo(universeId, taskName, inputFile, clientIdColumn, entityColumn, additionalContextColumns, firstNameColumn, lastNameColumn, middleNameColumn, personNameColumn, priorityColumn, salutationColumn, suffixColumn, autoRemap);
            return localVarResponse.Data;
        }
        ...
        {
            var localVarResponse = await GetPeopleTaskForListWithHttpInfoAsync(universeId, taskName, inputFile, clientIdColumn, entityColumn, additionalContextColumns, firstNameColumn, lastNameColumn, middleNameColumn, personNameColumn, priorityColumn, salutationColumn, suffixColumn, autoRemap, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
