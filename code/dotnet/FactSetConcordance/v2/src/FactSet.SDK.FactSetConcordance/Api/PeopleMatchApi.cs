...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface IPeopleMatchApiSync : IApiAccessor
    {
        ...
        /// <param name="entity">Entity the person is associated with. It is used to filter the candidates before taking a match decision. Can be entity ID or name.</param>
        ...
        /// <param name="candidatesCount">Maximum number of candidates to be returned. Parent entities, when includeParent is true, are not included in this count. &lt;p&gt;*minimum - 20*&lt;/p&gt; &lt;p&gt;*maximum - 100*&lt;/p&gt; (optional)</param>
        /// <returns>PeopleMatchesResponse</returns>
        PeopleMatchesResponse GetPeopleMatch(string entity, string personName = default(string), string salutation = default(string), string firstName = default(string), string middleName = default(string), string lastName = default(string), string suffix = default(string), int? candidatesCount = default(int?));
        ...
        ApiResponse<PeopleMatchesResponse> GetPeopleMatchWithHttpInfo(string entity, string personName = default(string), string salutation = default(string), string firstName = default(string), string middleName = default(string), string lastName = default(string), string suffix = default(string), int? candidatesCount = default(int?));
        /// <summary>
    ...
    public partial class PeopleMatchApi : IPeopleMatchApi
    {
        ...
        /// <param name="candidatesCount">Maximum number of candidates to be returned. Parent entities, when includeParent is true, are not included in this count. &lt;p&gt;*minimum - 20*&lt;/p&gt; &lt;p&gt;*maximum - 100*&lt;/p&gt; (optional)</param>
        /// <returns>PeopleMatchesResponse</returns>
        public PeopleMatchesResponse GetPeopleMatch(string entity, string personName = default(string), string salutation = default(string), string firstName = default(string), string middleName = default(string), string lastName = default(string), string suffix = default(string), int? candidatesCount = default(int?))
        {
            var localVarResponse = GetPeopleMatchWithHttpInfo(entity, personName, salutation, firstName, middleName, lastName, suffix, candidatesCount);
        ...
        /// <param name="candidatesCount">Maximum number of candidates to be returned. Parent entities, when includeParent is true, are not included in this count. &lt;p&gt;*minimum - 20*&lt;/p&gt; &lt;p&gt;*maximum - 100*&lt;/p&gt; (optional)</param>
        /// <returns>ApiResponse of PeopleMatchesResponse</returns>
        public ApiResponse<PeopleMatchesResponse> GetPeopleMatchWithHttpInfo(string entity, string personName = default(string), string salutation = default(string), string firstName = default(string), string middleName = default(string), string lastName = default(string), string suffix = default(string), int? candidatesCount = default(int?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetConcordance.Client.ClientUtils.ParameterToMultiMap("", "candidatesCount", candidatesCount));
            }
        ...
        {
            var localVarResponse = await GetPeopleMatchWithHttpInfoAsync(entity, personName, salutation, firstName, middleName, lastName, suffix, candidatesCount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
