...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface IMappingsApiSync : IApiAccessor
    {
        ...
        /// <param name="sort">Sort clientId, createdTime, updatedTime, clientName, entityId fields in ascending or descending order with asc and desc to indicate the order. Example (clientId:asc) (optional)</param>
        /// <returns>EntityUniverseResponse</returns>
        EntityUniverseResponse GetEntityUniverse(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?), List<string> sort = default(List<string>));
        ...
        ApiResponse<EntityUniverseResponse> GetEntityUniverseWithHttpInfo(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?), List<string> sort = default(List<string>));
        /// <summary>
    ...
    public partial class MappingsApi : IMappingsApi
    {
        ...
        /// <param name="sort">Sort clientId, createdTime, updatedTime, clientName, entityId fields in ascending or descending order with asc and desc to indicate the order. Example (clientId:asc) (optional)</param>
        /// <returns>EntityUniverseResponse</returns>
        public EntityUniverseResponse GetEntityUniverse(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?), List<string> sort = default(List<string>))
        {
            var localVarResponse = GetEntityUniverseWithHttpInfo(universeId, clientId, mapStatus, offset, limit, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Sort clientId, createdTime, updatedTime, clientName, entityId fields in ascending or descending order with asc and desc to indicate the order. Example (clientId:asc) (optional)</param>
        /// <returns>ApiResponse of EntityUniverseResponse</returns>
        public ApiResponse<EntityUniverseResponse> GetEntityUniverseWithHttpInfo(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?), List<string> sort = default(List<string>))
        {
            FactSet.SDK.FactSetConcordance.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.FactSetConcordance.Client.RequestOptions();
        ...
        {
            var localVarResponse = await GetEntityUniverseWithHttpInfoAsync(universeId, clientId, mapStatus, offset, limit, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
