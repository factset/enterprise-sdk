...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface IPeopleMappingApiSync : IApiAccessor
    {
        ...
        PeopleUniverseResponse GetPeopleUniverse(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?));
        ...
        ApiResponse<PeopleUniverseResponse> GetPeopleUniverseWithHttpInfo(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?));
        /// <summary>
    ...
    public partial class PeopleMappingApi : IPeopleMappingApi
    {
        ...
        /// <param name="limit">Limits the number of records in the response. (optional)</param>
        /// <returns>PeopleUniverseResponse</returns>
        public PeopleUniverseResponse GetPeopleUniverse(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?))
        {
            var localVarResponse = GetPeopleUniverseWithHttpInfo(universeId, clientId, mapStatus, offset, limit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="limit">Limits the number of records in the response. (optional)</param>
        /// <returns>ApiResponse of PeopleUniverseResponse</returns>
        public ApiResponse<PeopleUniverseResponse> GetPeopleUniverseWithHttpInfo(int universeId, List<string> clientId = default(List<string>), List<string> mapStatus = default(List<string>), int? offset = default(int?), int? limit = default(int?))
        {
            FactSet.SDK.FactSetConcordance.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.FactSetConcordance.Client.RequestOptions();
        ...
        {
            var localVarResponse = await GetPeopleUniverseWithHttpInfoAsync(universeId, clientId, mapStatus, offset, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
