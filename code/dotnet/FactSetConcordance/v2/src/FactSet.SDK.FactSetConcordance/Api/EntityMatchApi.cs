...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface IEntityMatchApiSync : IApiAccessor
    {
        ...
        /// <param name="rssd">Input identifiers for the RSSD - Federal Reserve RSSD symbol type (optional)</param>
        ...
        /// <param name="spr">Input identifiers for the S&amp;PRating - S&amp;P Ratings Identifier symbol type (optional)</param>
    ...
    public interface IEntityMatchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EntityMatchesResponse> GetEntityMatchAsync(string name, string country = default(string), string state = default(string), string url = default(string), List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool? includeParent = default(bool?), string bic = default(string), string bbgTicker = default(string), string cik = default(string), string crd = default(string), string cusip = default(string), string duns = default(string), string ein = default(string), string rssd = default(string), string fitch = default(string), string isin = default(string), string lei = default(string), string bbgFigi = default(string), string md = default(string), string ticker = default(string), string spr = default(string), string sedol = default(string), string tickerExchange = default(string), string tickerRegion = default(string), string ukch = default(string), string valoren = default(string), string wkn = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EntityMatchApi : IEntityMatchApi
    {
        ...
        {
            var localVarResponse = GetEntityMatchWithHttpInfo(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, bic, bbgTicker, cik, crd, cusip, duns, ein, rssd, fitch, isin, lei, bbgFigi, md, ticker, spr, sedol, tickerExchange, tickerRegion, ukch, valoren, wkn);
        ...
        {
            var localVarResponse = await GetEntityMatchWithHttpInfoAsync(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, bic, bbgTicker, cik, crd, cusip, duns, ein, rssd, fitch, isin, lei, bbgFigi, md, ticker, spr, sedol, tickerExchange, tickerRegion, ukch, valoren, wkn, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
