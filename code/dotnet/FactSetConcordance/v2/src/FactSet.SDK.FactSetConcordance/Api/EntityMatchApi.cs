...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public partial class EntityMatchApi : IEntityMatchApi
    {
        ...
        {
            var localVarResponse = GetEntityMatchWithHttpInfo(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent);
        ...
        {
            var localVarResponse = await GetEntityMatchWithHttpInfoAsync(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
