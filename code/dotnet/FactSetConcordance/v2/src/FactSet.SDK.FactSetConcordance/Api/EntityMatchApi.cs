...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public partial class EntityMatchApi : IEntityMatchApi
    {
        ...
        {
            var localVarResponse = GetEntityMatchWithHttpInfo(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, bbgFigi, bbgTicker, bic, cik, crd, cusip, ein, factsetId, fitch, gvkey, gvkeyIid, isin, jcn, lei, lxid, md, redCode, rssd, sedol, spr, ticker, tickerExchange, tickerRegion, ukch, valoren, wkn, candidatesCount);
        ...
        {
            var localVarResponse = await GetEntityMatchWithHttpInfoAsync(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, bbgFigi, bbgTicker, bic, cik, crd, cusip, ein, factsetId, fitch, gvkey, gvkeyIid, isin, jcn, lei, lxid, md, redCode, rssd, sedol, spr, ticker, tickerExchange, tickerRegion, ukch, valoren, wkn, candidatesCount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
