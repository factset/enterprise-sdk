...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface IEntityMatchApiSync : IApiAccessor
    {
        ...
        /// <param name="country">ISO2 country code corresponding to the entity name that is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754#country). (optional)</param>
        ...
        /// <param name="creditsafe">Creditsafe Identifier (optional)</param>
        /// <param name="crunchbase">Crunchbase Identifier (optional)</param>
    ...
    public interface IEntityMatchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EntityMatchesResponse> GetEntityMatchAsync(string name, string country = default(string), string state = default(string), string url = default(string), List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool? includeParent = default(bool?), string bbgFigi = default(string), string bbgTicker = default(string), string bic = default(string), string cik = default(string), string crd = default(string), string creditsafe = default(string), string crunchbase = default(string), string cusip = default(string), string ein = default(string), string factsetId = default(string), string fitch = default(string), string gvkey = default(string), string gvkeyIid = default(string), string isin = default(string), string jcn = default(string), string lei = default(string), string lxid = default(string), string md = default(string), string redCode = default(string), string rssd = default(string), string sedol = default(string), string spr = default(string), string ticker = default(string), string tickerExchange = default(string), string tickerRegion = default(string), string ukch = default(string), string valoren = default(string), string wkn = default(string), int? candidatesCount = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EntityMatchApi : IEntityMatchApi
    {
        ...
        {
            var localVarResponse = GetEntityMatchWithHttpInfo(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, bbgFigi, bbgTicker, bic, cik, crd, creditsafe, crunchbase, cusip, ein, factsetId, fitch, gvkey, gvkeyIid, isin, jcn, lei, lxid, md, redCode, rssd, sedol, spr, ticker, tickerExchange, tickerRegion, ukch, valoren, wkn, candidatesCount);
        ...
        public ApiResponse<EntityMatchesResponse> GetEntityMatchWithHttpInfo(string name, string country = default(string), string state = default(string), string url = default(string), List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool? includeParent = default(bool?), string bbgFigi = default(string), string bbgTicker = default(string), string bic = default(string), string cik = default(string), string crd = default(string), string creditsafe = default(string), string crunchbase = default(string), string cusip = default(string), string ein = default(string), string factsetId = default(string), string fitch = default(string), string gvkey = default(string), string gvkeyIid = default(string), string isin = default(string), string jcn = default(string), string lei = default(string), string lxid = default(string), string md = default(string), string redCode = default(string), string rssd = default(string), string sedol = default(string), string spr = default(string), string ticker = default(string), string tickerExchange = default(string), string tickerRegion = default(string), string ukch = default(string), string valoren = default(string), string wkn = default(string), int? candidatesCount = default(int?))
        {
            ...
            if (creditsafe != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetConcordance.Client.ClientUtils.ParameterToMultiMap("", "creditsafe", creditsafe));
            }
            if (crunchbase != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetConcordance.Client.ClientUtils.ParameterToMultiMap("", "crunchbase", crunchbase));
            }
            if (cusip != null)
            {
        ...
        {
            var localVarResponse = await GetEntityMatchWithHttpInfoAsync(name, country, state, url, includeEntityType, excludeEntityType, includeEntitySubType, excludeEntitySubType, includeParent, bbgFigi, bbgTicker, bic, cik, crd, creditsafe, crunchbase, cusip, ein, factsetId, fitch, gvkey, gvkeyIid, isin, jcn, lei, lxid, md, redCode, rssd, sedol, spr, ticker, tickerExchange, tickerRegion, ukch, valoren, wkn, candidatesCount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
