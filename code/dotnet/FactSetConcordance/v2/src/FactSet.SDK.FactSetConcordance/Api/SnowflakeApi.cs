...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface ISnowflakeApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.FactSetConcordance.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="snowflakeEntityMappingRequest">A request to save entity mappings to a universe</param>
        /// <returns>SnowflakeEntityMappingResponse</returns>
        ...
        /// <exception cref="FactSet.SDK.FactSetConcordance.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="snowflakeEntityMappingRequest">A request to save entity mappings to a universe</param>
        /// <returns>ApiResponse of SnowflakeEntityMappingResponse</returns>
        ApiResponse<SnowflakeEntityMappingResponse> SnowflakeEntityMappingPostWithHttpInfo(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest);
    ...
    public interface ISnowflakeApiAsync : IApiAccessor
    {
        ...
        /// <param name="snowflakeEntityMappingRequest">A request to save entity mappings to a universe</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SnowflakeEntityMappingResponse</returns>
        System.Threading.Tasks.Task<SnowflakeEntityMappingResponse> SnowflakeEntityMappingPostAsync(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="snowflakeEntityMappingRequest">A request to save entity mappings to a universe</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SnowflakeEntityMappingResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<SnowflakeEntityMappingResponse>> SnowflakeEntityMappingPostWithHttpInfoAsync(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SnowflakeApi : ISnowflakeApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> SnowflakeEntityMappingPostResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)0, typeof(SnowflakeEntityMappingResponse) },
        };
        ...
        /// <summary>
        /// Save entity mappings to a universe Manually save or update entity mappings with metadata
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetConcordance.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="snowflakeEntityMappingRequest">A request to save entity mappings to a universe</param>
        /// <returns>SnowflakeEntityMappingResponse</returns>
        public SnowflakeEntityMappingResponse SnowflakeEntityMappingPost(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest)
        {
            var localVarResponse = SnowflakeEntityMappingPostWithHttpInfo(snowflakeEntityMappingRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="snowflakeEntityMappingRequest">A request to save entity mappings to a universe</param>
        /// <returns>ApiResponse of SnowflakeEntityMappingResponse</returns>
        public ApiResponse<SnowflakeEntityMappingResponse> SnowflakeEntityMappingPostWithHttpInfo(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest)
        {
            // verify the required parameter 'snowflakeEntityMappingRequest' is set
            if (snowflakeEntityMappingRequest == null)
            {
                throw new FactSet.SDK.FactSetConcordance.Client.ApiException(400, "Missing required parameter 'snowflakeEntityMappingRequest' when calling SnowflakeApi->SnowflakeEntityMappingPost");
            }
            ...
            localVarRequestOptions.Data = snowflakeEntityMappingRequest;
            ...
            localVarRequestOptions.ResponseTypeDictionary = SnowflakeEntityMappingPostResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Post<
            SnowflakeEntityMappingResponse>("/factset-concordance/v2/snowflake-entity-mapping", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SnowflakeEntityMappingPost", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SnowflakeEntityMappingResponse</returns>
        public async System.Threading.Tasks.Task<SnowflakeEntityMappingResponse>SnowflakeEntityMappingPostAsync(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await SnowflakeEntityMappingPostWithHttpInfoAsync(snowflakeEntityMappingRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SnowflakeEntityMappingResponse>> SnowflakeEntityMappingPostWithHttpInfoAsync(SnowflakeEntityMappingRequest snowflakeEntityMappingRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'snowflakeEntityMappingRequest' is set
            if (snowflakeEntityMappingRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<SnowflakeEntityMappingResponse>("/factset-concordance/v2/snowflake-entity-mapping", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
