...
namespace Example
{
    public class GetEntityMappingDeleteForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MappingsApi.GetEntityMappingDeleteForList: " + e.Message );
...
namespace Example
{
    public class GetEntityMappingForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MappingsApi.GetEntityMappingForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetEntityUniverseExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MappingsApi.GetEntityUniverse: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetEntityUniverseForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MappingsApi.GetEntityUniverseForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
