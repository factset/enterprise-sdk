...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface IEntityMatchApiSync : IApiAccessor
    {
        ...
        /// <param name="clientId">A unique identifer supplied by the user. The clientId is recorded to the user&#39;s mapped universe.  (optional)</param>
        ...
        ApiResponse<EntityMatchesResponse> GetEntityMatchWithHttpInfo(string name, string clientId = default(string), string country = default(string), string state = default(string), string url = default(string), List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool? includeParent = default(bool?));
        /// <summary>
    ...
    public interface IEntityMatchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<EntityMatchesResponse>> GetEntityMatchWithHttpInfoAsync(string name, string clientId = default(string), string country = default(string), string state = default(string), string url = default(string), List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool? includeParent = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a list of Entity Candidates and Matches for a requested list of up to 25 names and attributes.
        /// </summary>
        /// <remarks>
    ...
    public partial class EntityMatchApi : IEntityMatchApi
    {
        ...
        public ApiResponse<EntityMatchesResponse> GetEntityMatchWithHttpInfo(string name, string clientId = default(string), string country = default(string), string state = default(string), string url = default(string), List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool? includeParent = default(bool?))
        {
            ...
            if (clientId != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetConcordance.Client.ClientUtils.ParameterToMultiMap("", "clientId", clientId));
            }
            if (country != null)
            {
        ...
        /// <summary>
        /// Get a list of Entity Candidates and Matches for a requested list of up to 25 names and attributes. Finds the best candidate entities matching the given entity name. Additional attributes can be supplied to narrow the search, such as State, URL, and Entity Types. &lt;p&gt;**Max of 25 Names inputted.** Use the \&quot;Entity Match - Bulk\&quot; workflow to submit larger universes of names to be concorded via a file.&lt;/p&gt;&lt;p&gt; Supported types of Entities in which the names can match to include -   * Corporations, Joint Ventures, and Holding Companies   * Fund Managers and various Fund Types (Open-end, Closed End, Hedge, Soverign Wealth, Pension, Exchange Traded, and more).&lt;/p&gt; 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetConcordance.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="entityMatchRequest">A request to match a Entity.</param>
        /// <returns>EntityMatchesResponse</returns>
