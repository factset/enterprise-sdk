...
namespace FactSet.SDK.FactSetConcordance.Api
{
    ...
    public interface ISnowflakeApiSync : IApiAccessor
    {
        ...
        SnowflakeEntityMatchResponse GetSnowflakeEntityMatch(string name, string country = default(string), string state = default(string), string url = default(string));
        ...
        ApiResponse<SnowflakeEntityMatchResponse> GetSnowflakeEntityMatchWithHttpInfo(string name, string country = default(string), string state = default(string), string url = default(string));
        /// <summary>
    ...
    public interface ISnowflakeApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SnowflakeEntityMatchResponse> GetSnowflakeEntityMatchAsync(string name, string country = default(string), string state = default(string), string url = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SnowflakeEntityMatchResponse>> GetSnowflakeEntityMatchWithHttpInfoAsync(string name, string country = default(string), string state = default(string), string url = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Perform an entity search and return a snowflake-friendly response. Up to 25 Names per request.
        /// </summary>
        /// <remarks>
    ...
    public partial class SnowflakeApi : ISnowflakeApi
    {
        ...
        /// <summary>
        /// Perform an entity match and return a snowflake-friendly response. 1 Name per request. Finds the best candidate entities matching the given entity name. Additional attributes can be supplied to narrow the search. *This endpoint is used natively within Snowflake and is not to be consumed directly by users. Reach out to your FactSet Account team to learn more about Concordance in Snowflake.* 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetConcordance.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name">Name of Entity to match.</param>
        /// <param name="country">ISO2 country code corresponding to the entity name that is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754). (optional)</param>
