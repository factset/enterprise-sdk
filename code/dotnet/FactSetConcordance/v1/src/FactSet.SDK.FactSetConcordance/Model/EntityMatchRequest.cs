...
namespace FactSet.SDK.FactSetConcordance.Model
{
    ...
    public partial class EntityMatchRequest : IEquatable<EntityMatchRequest>, IValidatableObject
    {
        ...
        public EntityMatchRequest(List<EntityMatchRequestInput> input,List<string> includeEntityType = default(List<string>), List<string> excludeEntityType = default(List<string>), List<string> includeEntitySubType = default(List<string>), List<string> excludeEntitySubType = default(List<string>), bool includeParent = false)
        {
