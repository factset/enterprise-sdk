...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetSupplyChain/2.0.1)
...
dotnet add package FactSet.SDK.FactSetSupplyChain -v 2.0.1
```
...
nuget install FactSet.SDK.FactSetSupplyChain -Version 2.0.1
```
