...
namespace FactSet.SDK.FactSetSupplyChain.Api
{
    ...
    public partial class BatchProcessingApi : IBatchProcessingApi
    {
        ...
        /// The long-running request has been completed and the result is created. The response structure will be based on the endpoint that initiated the batch request.
        /// </description>
        /// </item>
        /// 
        /// <item>
        ...
        public class GetBatchDataResponseWrapper {
            ...
            public BatchResultResponse Response200
            {
                get
                {
                    ...
                    {
                        throw new FactSet.SDK.FactSetSupplyChain.Client.ApiException(500, "Invalid response getter called. Response200 can't return a " + StatusCode + " response");
                    }
            ...
            public BatchStatusResponse Response202
            {
                get
                {
                    ...
                    {
                        throw new FactSet.SDK.FactSetSupplyChain.Client.ApiException(500, "Invalid response getter called. Response202 can't return a " + StatusCode + " response");
                    }
        ...
        /// <returns></returns>
        public BatchProcessingApi(FactSet.SDK.FactSetSupplyChain.Client.Configuration configuration)
        {
        ...
        public BatchProcessingApi(FactSet.SDK.FactSetSupplyChain.Client.ISynchronousClient client, FactSet.SDK.FactSetSupplyChain.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetSupplyChain.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Returns the response for a Batch Request Returns the response data for the underlying batch request that is specified by the ID. The response structure will be based on the endpoint that initiated the batch request. 
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetSupplyChain.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Batch Request identifier.</param>
        /// <returns>BatchProcessingApi.GetBatchDataResponseWrapper</returns>
        ...
        public ApiResponse<BatchProcessingApi.GetBatchDataResponseWrapper> GetBatchDataWithHttpInfo(Guid id)
        {
            ...
            localVarRequestOptions.QueryParameters.Add(FactSet.SDK.FactSetSupplyChain.Client.ClientUtils.ParameterToMultiMap("", "id", id));
