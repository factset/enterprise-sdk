...
namespace FactSet.SDK.ProposalGenerationEngine.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/ProposalGenerationEngine/0.1.0";
            BasePath = "https://api.factset.com/analytics/engines/proposal-generation/v0";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/analytics/engines/proposal-generation/v0"},
                        {"description", "Production"},
                    }
                },
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.uat.factset.com/analytics/engines/proposal-generation/v0"},
                        {"description", "Staging"},
                    }
                }
            };
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/engines/proposal-generation/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.ProposalGenerationEngine) Debug Report:\n";
