...
namespace FactSet.SDK.ProposalGenerationEngine.Model
{
    ...
    public partial class Investment : IEquatable<Investment>, IValidatableObject
    {
        ...
        public Investment(string id = default(string), string name = default(string), string proxyCode = default(string), string cusip = default(string), string tradingSymbol = default(string), string securityType = default(string), string className = default(string), string currency = default(string))
        {
            this.Id = id;
            this.Name = name;
