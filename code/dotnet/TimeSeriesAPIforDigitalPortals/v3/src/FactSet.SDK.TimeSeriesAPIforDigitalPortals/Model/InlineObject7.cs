...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject7 : IEquatable<InlineObject7>, IValidatableObject
    {
        ...
        public InlineObject7(PricesTimeSeriesEodSubsampleListData data = default(PricesTimeSeriesEodSubsampleListData), VendorChartIQTimeSeriesEodListMeta meta = default(VendorChartIQTimeSeriesEodListMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
