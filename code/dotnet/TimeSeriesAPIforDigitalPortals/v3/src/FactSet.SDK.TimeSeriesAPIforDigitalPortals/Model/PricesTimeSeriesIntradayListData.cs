...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class PricesTimeSeriesIntradayListData : IEquatable<PricesTimeSeriesIntradayListData>, IValidatableObject
    {
        ...
        public PricesTimeSeriesIntradayListData(string id = default(string), TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, PricesTimeSeriesIntradayListDataRange range = default(PricesTimeSeriesIntradayListDataRange), ApplyTickCorrectionsEnum? applyTickCorrections = ApplyTickCorrectionsEnum.None, bool includeVolumeOnlyTicks = false, VendorChartIQTimeSeriesIntradaySubsampleGetDataAdjustments adjustments = default(VendorChartIQTimeSeriesIntradaySubsampleGetDataAdjustments))
        {
