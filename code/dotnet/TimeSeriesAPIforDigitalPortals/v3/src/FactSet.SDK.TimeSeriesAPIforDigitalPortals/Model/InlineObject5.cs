...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject5 : IEquatable<InlineObject5>, IValidatableObject
    {
        ...
        public InlineObject5(VendorChartIQTimeSeriesEodListData data = default(VendorChartIQTimeSeriesEodListData), VendorChartIQTimeSeriesEodListMeta meta = default(VendorChartIQTimeSeriesEodListMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject5 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
