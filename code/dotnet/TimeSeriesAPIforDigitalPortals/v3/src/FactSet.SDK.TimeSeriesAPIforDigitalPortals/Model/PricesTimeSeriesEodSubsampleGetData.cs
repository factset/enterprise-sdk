...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_prices_timeSeries_eod_subsample_get_data")]
    public partial class PricesTimeSeriesEodSubsampleGetData : IEquatable<PricesTimeSeriesEodSubsampleGetData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricesTimeSeriesEodSubsampleGetData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricesTimeSeriesEodSubsampleGetData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricesTimeSeriesEodSubsampleGetData" /> class.
        /// </summary>
        ...
        public PricesTimeSeriesEodSubsampleGetData(string id, PricesTimeSeriesEodSubsampleGetDataInterval interval,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, VendorChartIQTimeSeriesEodListDataAdjustments adjustments = default(VendorChartIQTimeSeriesEodListDataAdjustments))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for PricesTimeSeriesEodSubsampleGetData and cannot be null");
            }
            this.Id = id;
            // to ensure "interval" is required (not null)
            if (interval == null) {
                throw new ArgumentNullException("interval is a required property for PricesTimeSeriesEodSubsampleGetData and cannot be null");
            }
        ...
        public PricesTimeSeriesEodSubsampleGetDataInterval Interval { get; set; }
        ...
        {
            return this.Equals(input as PricesTimeSeriesEodSubsampleGetData);
        }

        /// <summary>
        /// Returns true if PricesTimeSeriesEodSubsampleGetData instances are equal
        /// </summary>
        /// <param name="input">Instance of PricesTimeSeriesEodSubsampleGetData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricesTimeSeriesEodSubsampleGetData input)
        {
            if (input == null)
            {
                return false;
