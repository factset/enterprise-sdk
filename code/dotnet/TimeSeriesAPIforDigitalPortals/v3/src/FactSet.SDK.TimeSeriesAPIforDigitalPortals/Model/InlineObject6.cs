...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject6 : IEquatable<InlineObject6>, IValidatableObject
    {
        ...
        public InlineObject6(PricesTimeSeriesEodSubsampleGetData data = default(PricesTimeSeriesEodSubsampleGetData), VendorChartIQTimeSeriesEodSubsampleGetMeta meta = default(VendorChartIQTimeSeriesEodSubsampleGetMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject6 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PricesTimeSeriesEodSubsampleGetData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public VendorChartIQTimeSeriesEodSubsampleGetMeta Meta { get; set; }
