...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject9 : IEquatable<InlineObject9>, IValidatableObject
    {
        ...
        public InlineObject9(VendorChartIQTimeSeriesIntradaySubsampleGetData data = default(VendorChartIQTimeSeriesIntradaySubsampleGetData), VendorChartIQTimeSeriesEodSubsampleGetMeta meta = default(VendorChartIQTimeSeriesEodSubsampleGetMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject9 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public VendorChartIQTimeSeriesIntradaySubsampleGetData Data { get; set; }
