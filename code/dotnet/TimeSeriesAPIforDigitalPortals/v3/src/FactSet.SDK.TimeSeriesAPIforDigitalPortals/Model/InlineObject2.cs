...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineObject2 : IEquatable<InlineObject2>, IValidatableObject
    {
        ...
        public InlineObject2(VendorChartIQTimeSeriesEodSubsampleListData data = default(VendorChartIQTimeSeriesEodSubsampleListData), VendorChartIQTimeSeriesEodListMeta meta = default(VendorChartIQTimeSeriesEodListMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject2 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public VendorChartIQTimeSeriesEodSubsampleListData Data { get; set; }
