...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2009DataSubsample : IEquatable<InlineResponse2009DataSubsample>, IValidatableObject
    {
        ...
        public InlineResponse2009DataSubsample(string time = default(string), decimal first = default(decimal), decimal last = default(decimal), decimal low = default(decimal), decimal high = default(decimal), decimal tradingVolume = default(decimal), decimal tradingValue = default(decimal))
        {
            this.Time = time;
            this.First = first;
            this.Last = last;
