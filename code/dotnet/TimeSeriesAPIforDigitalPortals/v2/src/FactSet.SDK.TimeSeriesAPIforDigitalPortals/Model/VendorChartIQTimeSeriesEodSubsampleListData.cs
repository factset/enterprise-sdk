...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    public partial class VendorChartIQTimeSeriesEodSubsampleListData : IEquatable<VendorChartIQTimeSeriesEodSubsampleListData>, IValidatableObject
    {
        ...
        public VendorChartIQTimeSeriesEodSubsampleListData(string id, List<DateTime> intervals,TypeEnum? type = TypeEnum.Trade, QualityEnum? quality = QualityEnum.DLY, VendorChartIQTimeSeriesEodListDataAdjustments adjustments = default(VendorChartIQTimeSeriesEodListDataAdjustments))
        {
