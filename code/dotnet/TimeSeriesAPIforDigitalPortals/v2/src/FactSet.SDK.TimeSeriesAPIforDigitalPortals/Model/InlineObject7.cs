...
namespace FactSet.SDK.TimeSeriesAPIforDigitalPortals.Model
{
    ...
    /// InlineObject7
    /// </summary>
    [DataContract(Name = "inline_object_7")]
    public partial class InlineObject7 : IEquatable<InlineObject7>, IValidatableObject
    {
        ...
        public InlineObject7(PricesTimeSeriesIntradayListData data = default(PricesTimeSeriesIntradayListData), PricesTimeSeriesIntradayListMeta meta = default(PricesTimeSeriesIntradayListMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for InlineObject7 and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PricesTimeSeriesIntradayListMeta Meta { get; set; }
