...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetPrices/2.0.0)
...
dotnet add package FactSet.SDK.FactSetPrices -v 2.0.0
```
...
nuget install FactSet.SDK.FactSetPrices -Version 2.0.0
```
...
## Documentation for Models
 ...
 - [Model.BatchOne](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetPrices/v1/docs/BatchOne.md)
 - [Model.BatchResult](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetPrices/v1/docs/BatchResult.md)
