...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetPrices/2.0.1)
...
dotnet add package FactSet.SDK.FactSetPrices -v 2.0.1
```
...
nuget install FactSet.SDK.FactSetPrices -Version 2.0.1
```
