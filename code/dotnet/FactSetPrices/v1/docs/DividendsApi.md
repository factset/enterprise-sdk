...
namespace Example
{
    public class GetSecurityDividendsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DividendsApi.GetSecurityDividends: " + e.Message );
...
namespace Example
{
    public class GetSecurityDividendsForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DividendsApi.GetSecurityDividendsForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
