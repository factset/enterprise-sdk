...
namespace Example
{
    public class GetMarketValueExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketValueApi.GetMarketValue: " + e.Message );
...
namespace Example
{
    public class GetMarketValueForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MarketValueApi.GetMarketValueForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
