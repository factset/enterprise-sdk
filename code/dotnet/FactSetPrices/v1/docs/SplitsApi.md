...
namespace Example
{
    public class GetSecuritySplitsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SplitsApi.GetSecuritySplits: " + e.Message );
...
namespace Example
{
    public class GetSecuritySplitsForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SplitsApi.GetSecuritySplitsForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
