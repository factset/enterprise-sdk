...
namespace Example
{
    public class GetSecurityReferenceForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReferenceApi.GetSecurityReferenceForList: " + e.Message );
...
namespace Example
{
    public class GetSecurityReferencesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReferenceApi.GetSecurityReferences: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
