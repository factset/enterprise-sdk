...
namespace FactSet.SDK.FactSetPrices.Api
{
    ...
    public interface IMarketValueApiSync : IApiAccessor
    {
        ...
        /// <param name="ids"> The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids.*&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;*   - Batch requests:       * Single day: up to 700 IDs per request       * Multi-day: up to 700 IDs per request </param>
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 30 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use the corresponding &#x60;/batch/v1/status&#x60; endpoint to see if the job has been completed. Once completed, retrieve the results of the request via the &#x60;/batch/v1/result&#x60; endpoint.  (optional, default to N)</param>
        /// <returns>MarketValueApi.GetMarketValueResponseWrapper</returns>
        MarketValueApi.GetMarketValueResponseWrapper GetMarketValue(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string));
        ...
        /// <param name="currency">Currency code for adjusting prices. Default is Local. For a list of currency ISO codes, visit [Online Assistant Page 1470](https://oa.apps.factset.com/pages/1470). (optional)</param>
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 30 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use the corresponding &#x60;/batch/v1/status&#x60; endpoint to see if the job has been completed. Once completed, retrieve the results of the request via the &#x60;/batch/v1/result&#x60; endpoint.  (optional, default to N)</param>
        /// <returns>ApiResponse of MarketValueApi.GetMarketValueResponseWrapper</returns>
        ApiResponse<MarketValueApi.GetMarketValueResponseWrapper> GetMarketValueWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string));
        /// <summary>
        ...
        /// <returns>MarketValueApi.GetMarketValueForListResponseWrapper</returns>
        MarketValueApi.GetMarketValueForListResponseWrapper GetMarketValueForList(MarketValueRequest marketValueRequest);
        ...
        /// <exception cref="FactSet.SDK.FactSetPrices.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="marketValueRequest">Request object for &#x60;Security&#x60; market values.</param>
        /// <returns>ApiResponse of MarketValueApi.GetMarketValueForListResponseWrapper</returns>
        ApiResponse<MarketValueApi.GetMarketValueForListResponseWrapper> GetMarketValueForListWithHttpInfo(MarketValueRequest marketValueRequest);
    ...
    public interface IMarketValueApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MarketValueApi.GetMarketValueResponseWrapper> GetMarketValueAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 30 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use the corresponding &#x60;/batch/v1/status&#x60; endpoint to see if the job has been completed. Once completed, retrieve the results of the request via the &#x60;/batch/v1/result&#x60; endpoint.  (optional, default to N)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MarketValueApi.GetMarketValueResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<MarketValueApi.GetMarketValueResponseWrapper>> GetMarketValueWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Requests the market value for a list of &#x60;ids&#x60; as of given date range.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MarketValueResponse</returns>
        System.Threading.Tasks.Task<MarketValueApi.GetMarketValueForListResponseWrapper> GetMarketValueForListAsync(MarketValueRequest marketValueRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="marketValueRequest">Request object for &#x60;Security&#x60; market values.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MarketValueApi.GetMarketValueForListResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<MarketValueApi.GetMarketValueForListResponseWrapper>> GetMarketValueForListWithHttpInfoAsync(MarketValueRequest marketValueRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MarketValueApi : IMarketValueApi
    {
        ...
        /// Array of company market capitalization values.
        /// </description>
        /// </item>
        /// 
        /// <item>
        ...
        /// </example>
        /// </summary>
        public class GetMarketValueResponseWrapper {

            /// <summary>This constructor initializes the new GetMarketValueResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetMarketValueResponseWrapper(HttpStatusCode statusCode, object response)
            {
        ...
        /// </example>
        /// </summary>
        public class GetMarketValueForListResponseWrapper {

            /// <summary>This constructor initializes the new GetMarketValueForListResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetMarketValueForListResponseWrapper(HttpStatusCode statusCode, object response)
            {
                StatusCode = statusCode;
                Response = response;
            }
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 30 minutes. Upon requesting batch&#x3D;Y, the service will respond with an HTTP Status Code of 202. Once a batch request is submitted, use the corresponding &#x60;/batch/v1/status&#x60; endpoint to see if the job has been completed. Once completed, retrieve the results of the request via the &#x60;/batch/v1/result&#x60; endpoint.  (optional, default to N)</param>
        /// <returns>MarketValueApi.GetMarketValueResponseWrapper</returns>
        public MarketValueApi.GetMarketValueResponseWrapper GetMarketValue(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string))
        {
            var localVarResponse = GetMarketValueWithHttpInfo(ids, startDate, endDate, frequency, calendar, currency, batch);
        ...
        public ApiResponse<MarketValueApi.GetMarketValueResponseWrapper> GetMarketValueWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string))
        {
            ...
            Object>("/factset-prices/v1/market-value", localVarRequestOptions, this.Configuration);
            ...
            var getmarketvalueResponse = new GetMarketValueResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetMarketValueResponseWrapper>(localVarResponse.StatusCode, getmarketvalueResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MarketValueResponse</returns>
        public async System.Threading.Tasks.Task<MarketValueApi.GetMarketValueResponseWrapper>GetMarketValueAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetMarketValueWithHttpInfoAsync(ids, startDate, endDate, frequency, calendar, currency, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MarketValueApi.GetMarketValueResponseWrapper>> GetMarketValueWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/factset-prices/v1/market-value", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="marketValueRequest">Request object for &#x60;Security&#x60; market values.</param>
        /// <returns>MarketValueApi.GetMarketValueForListResponseWrapper</returns>
        public MarketValueApi.GetMarketValueForListResponseWrapper GetMarketValueForList(MarketValueRequest marketValueRequest)
        {
        ...
        /// <param name="marketValueRequest">Request object for &#x60;Security&#x60; market values.</param>
        /// <returns>ApiResponse of MarketValueResponse</returns>
        public ApiResponse<MarketValueApi.GetMarketValueForListResponseWrapper> GetMarketValueForListWithHttpInfo(MarketValueRequest marketValueRequest)
        {
            ...
            var getmarketvalueforlistResponse = new GetMarketValueForListResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetMarketValueForListResponseWrapper>(localVarResponse.StatusCode, getmarketvalueforlistResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MarketValueResponse</returns>
        public async System.Threading.Tasks.Task<MarketValueApi.GetMarketValueForListResponseWrapper>GetMarketValueForListAsync(MarketValueRequest marketValueRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MarketValueApi.GetMarketValueForListResponseWrapper>> GetMarketValueForListWithHttpInfoAsync(MarketValueRequest marketValueRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'marketValueRequest' is set
            if (marketValueRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/factset-prices/v1/market-value", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
