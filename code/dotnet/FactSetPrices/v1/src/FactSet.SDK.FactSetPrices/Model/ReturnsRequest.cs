...
namespace FactSet.SDK.FactSetPrices.Model
{
    ...
    public partial class ReturnsRequest : IEquatable<ReturnsRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets RollingPeriod
        /// </summary>
        [DataMember(Name = "rollingPeriod", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RollingPeriod: ").Append(RollingPeriod).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ReturnsRequest input)
        {
            ...
            return 
                ...
                (
                    this.RollingPeriod == input.RollingPeriod ||
                    (this.RollingPeriod != null &&
                    this.RollingPeriod.Equals(input.RollingPeriod))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RollingPeriod.GetHashCode();
                }
                return hashCode;
            }
        }
