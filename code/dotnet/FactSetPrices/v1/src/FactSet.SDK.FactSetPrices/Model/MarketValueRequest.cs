...
namespace FactSet.SDK.FactSetPrices.Model
{
    ...
    /// </summary>
    [DataContract(Name = "marketValueRequest")]
    public partial class MarketValueRequest : IEquatable<MarketValueRequest>, IValidatableObject
    {
        ...
        public BatchOne? Batch { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketValueRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MarketValueRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketValueRequest" /> class.
        /// </summary>
        ...
        public MarketValueRequest(List<string> ids,string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency), string currency = default(string), Calendar calendar = default(Calendar), BatchOne batch = default(BatchOne))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for MarketValueRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as MarketValueRequest);
        }

        /// <summary>
        /// Returns true if MarketValueRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketValueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketValueRequest input)
        {
            if (input == null)
            {
                return false;
