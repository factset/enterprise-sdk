...
namespace FactSet.SDK.FactSetPrices.Model
{
    ...
    /// Splits Request Body
    /// </summary>
    [DataContract(Name = "splitsRequest")]
    public partial class SplitsRequest : IEquatable<SplitsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SplitsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitsRequest" /> class.
        /// </summary>
        ...
        public SplitsRequest(List<string> ids)
        {
            ...
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for SplitsRequest and cannot be null");
            }
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as SplitsRequest);
        }

        /// <summary>
        /// Returns true if SplitsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SplitsRequest to be compared</param>
        /// <returns>Boolean</returns>
