...
namespace FactSet.SDK.FactSetPrices.Model
{
    ...
    public partial class ModelReturn : IEquatable<ModelReturn>, IValidatableObject
    {
        ...
        public ModelReturn(string fsymId = default(string), DateTime date = default(DateTime), DateTime adjDate = default(DateTime), string currency = default(string), double totalReturn = default(double), string requestId = default(string))
        {
            this.FsymId = fsymId;
            this.Date = date;
