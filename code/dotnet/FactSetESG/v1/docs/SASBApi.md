...
namespace Example
{
    public class GetSasbRanksExample
    {
        public static void Main()
        {
            ...
            var frequency = frequency_example;  // string | Controls the display frequency of the data returned.   * **D** = Daily   * **W** = Weekly, based on the last day of the week of the start date.   * **M** = Monthly, based on the last trading day of the month.   * **CY** = Calendar Annual, based on the last trading day of the calendar year.  (optional)  (default to D)
            ...
            {
                Debug.Print("Exception when calling SASBApi.GetSasbRanks: " + e.Message );
...
namespace Example
{
    public class GetSasbRanksPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SASBApi.GetSasbRanksPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **GetSasbScores**
> SasbScoresResponse GetSasbScores (List<string> ids, List<string> scoreTypes = null, List<string> categories = null, string startDate = null, string endDate = null, string frequency = null)
...
namespace Example
{
    public class GetSasbScoresExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SASBApi.GetSasbScores: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSasbScoresAllExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SASBApi.GetSasbScoresAll: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSasbScoresAllPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SASBApi.GetSasbScoresAllPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSasbScoresPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SASBApi.GetSasbScoresPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
