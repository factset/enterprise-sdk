...
namespace FactSet.SDK.FactSetESG.Model
{
    ...
    public partial class SasbRanksRequest : IEquatable<SasbRanksRequest>, IValidatableObject
    {
        ...
        public SasbRanksRequest(List<string> ids,List<string> categories = default(List<string>), string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency))
        {
