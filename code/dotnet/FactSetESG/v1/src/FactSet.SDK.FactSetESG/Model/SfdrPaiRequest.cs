...
namespace FactSet.SDK.FactSetESG.Model
{
    ...
    public partial class SfdrPaiRequest : IEquatable<SfdrPaiRequest>, IValidatableObject
    {
        ...
        public SfdrPaiRequest(List<string> ids = default(List<string>), bool feelback = false, string fiscalPeriodStart = default(string), string fiscalPeriodEnd = default(string), List<string> indicators = default(List<string>), bool calculation = true)
        {
