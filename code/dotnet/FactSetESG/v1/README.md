...
[![Nuget](https://img.shields.io/badge/nuget-v2.3.2-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetESG/2.3.2)
...
dotnet add package FactSet.SDK.FactSetESG -v 2.3.2
```
...
nuget install FactSet.SDK.FactSetESG -Version 2.3.2
```
