...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// ValueLabelTemplate
    /// </summary>
    [DataContract(Name = "ValueLabelTemplate")]
    public partial class ValueLabelTemplate : IEquatable<ValueLabelTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelTemplate" /> class.
        /// </summary>
        ...
        public ValueLabelTemplate(string templateName, string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string))
        {
            // to ensure "templateName" is required (not null)
            if (templateName == null) {
                throw new ArgumentNullException("templateName is a required property for ValueLabelTemplate and cannot be null");
            }
            this.TemplateName = templateName;
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ValueLabelTemplate and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueLabelTemplate);
        }

        /// <summary>
        /// Returns true if ValueLabelTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelTemplate input)
        {
            if (input == null)
            {
                return false;
