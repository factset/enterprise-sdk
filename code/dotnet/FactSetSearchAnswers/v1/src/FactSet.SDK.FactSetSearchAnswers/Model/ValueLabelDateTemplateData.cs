...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueLabelDateTemplateData")]
    public partial class ValueLabelDateTemplateData : IEquatable<ValueLabelDateTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelDateTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateTemplateData" /> class.
        /// </summary>
        ...
        public ValueLabelDateTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string), string date = default(string))
        {
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ValueLabelDateTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueLabelDateTemplateData);
        }

        /// <summary>
        /// Returns true if ValueLabelDateTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelDateTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelDateTemplateData input)
        {
            if (input == null)
            {
                return false;
