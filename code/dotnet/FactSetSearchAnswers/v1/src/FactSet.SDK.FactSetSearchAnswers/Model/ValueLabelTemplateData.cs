...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueLabelTemplateData")]
    public partial class ValueLabelTemplateData : IEquatable<ValueLabelTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelTemplateData" /> class.
        /// </summary>
        ...
        public ValueLabelTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string))
        {
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ValueLabelTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueLabelTemplateData);
        }

        /// <summary>
        /// Returns true if ValueLabelTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelTemplateData input)
        {
            if (input == null)
            {
                return false;
