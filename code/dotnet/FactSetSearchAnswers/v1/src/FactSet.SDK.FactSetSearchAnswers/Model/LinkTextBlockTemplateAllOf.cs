...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinkTextBlockTemplate_allOf")]
    public partial class LinkTextBlockTemplateAllOf : IEquatable<LinkTextBlockTemplateAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LinkTextBlockTemplateAllOf);
        }

        /// <summary>
        /// Returns true if LinkTextBlockTemplateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkTextBlockTemplateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkTextBlockTemplateAllOf input)
        {
            if (input == null)
                return false;
