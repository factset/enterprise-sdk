...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    public partial class TableTableTemplate : IEquatable<TableTableTemplate>, IValidatableObject
    {
        ...
        public TableTableTemplate(string headline = default(string), string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), Table table1 = default(Table), Table table2 = default(Table))
        {
