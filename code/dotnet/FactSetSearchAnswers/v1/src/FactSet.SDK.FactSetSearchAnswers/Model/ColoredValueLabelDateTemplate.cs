...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ColoredValueLabelDateTemplate")]
    public partial class ColoredValueLabelDateTemplate : IEquatable<ColoredValueLabelDateTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ColoredValueLabelDateTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ColoredValueLabelDateTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ColoredValueLabelDateTemplate" /> class.
        /// </summary>
        ...
        public ColoredValueLabelDateTemplate(string headline = default(string), string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), ColoredValue value = default(ColoredValue), string label = default(string), string date = default(string))
        {
        ...
        {
            return this.Equals(input as ColoredValueLabelDateTemplate);
        }

        /// <summary>
        /// Returns true if ColoredValueLabelDateTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of ColoredValueLabelDateTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ColoredValueLabelDateTemplate input)
        {
            if (input == null)
                return false;
