...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateWithLinks_allOf")]
    public partial class TemplateWithLinksAllOf : IEquatable<TemplateWithLinksAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateWithLinksAllOf" /> class.
        /// </summary>
        /// <param name="applicationLinks">applicationLinks.</param>
        public TemplateWithLinksAllOf(List<ApplicationLink> applicationLinks = default(List<ApplicationLink>))
        {
        ...
        {
            return this.Equals(input as TemplateWithLinksAllOf);
        }

        /// <summary>
        /// Returns true if TemplateWithLinksAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateWithLinksAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateWithLinksAllOf input)
        {
            if (input == null)
            {
                return false;
