...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PercentChangeLabelTemplate")]
    public partial class PercentChangeLabelTemplate : IEquatable<PercentChangeLabelTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PercentChangeLabelTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PercentChangeLabelTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PercentChangeLabelTemplate" /> class.
        /// </summary>
        ...
        public PercentChangeLabelTemplate(string templateName, string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), PercentChange percentChange = default(PercentChange), string label = default(string))
        {
            // to ensure "templateName" is required (not null)
            if (templateName == null) {
                throw new ArgumentNullException("templateName is a required property for PercentChangeLabelTemplate and cannot be null");
            }
            this.TemplateName = templateName;
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for PercentChangeLabelTemplate and cannot be null");
            }
        ...
        {
            return this.Equals(input as PercentChangeLabelTemplate);
        }

        /// <summary>
        /// Returns true if PercentChangeLabelTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of PercentChangeLabelTemplate to be compared</param>
        /// <returns>Boolean</returns>
