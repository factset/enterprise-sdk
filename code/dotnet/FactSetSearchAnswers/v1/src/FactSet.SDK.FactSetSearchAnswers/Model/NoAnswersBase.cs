...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// NoAnswersBase
    /// </summary>
    [DataContract(Name = "NoAnswersBase")]
    public partial class NoAnswersBase : IEquatable<NoAnswersBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NoAnswersBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NoAnswersBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NoAnswersBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NoAnswersBase);
        }

        /// <summary>
        /// Returns true if NoAnswersBase instances are equal
        /// </summary>
        /// <param name="input">Instance of NoAnswersBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NoAnswersBase input)
        {
            if (input == null)
            {
                return false;
