...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinkTextBlockTemplateData")]
    public partial class LinkTextBlockTemplateData : IEquatable<LinkTextBlockTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkTextBlockTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinkTextBlockTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkTextBlockTemplateData" /> class.
        /// </summary>
        ...
        public LinkTextBlockTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string link = default(string), string text = default(string))
        {
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for LinkTextBlockTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as LinkTextBlockTemplateData);
        }

        /// <summary>
        /// Returns true if LinkTextBlockTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkTextBlockTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkTextBlockTemplateData input)
        {
            if (input == null)
            {
                return false;
