...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// RankedTableTemplate
    /// </summary>
    [DataContract(Name = "RankedTableTemplate")]
    public partial class RankedTableTemplate : IEquatable<RankedTableTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedTableTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RankedTableTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedTableTemplate" /> class.
        /// </summary>
        ...
        public RankedTableTemplate(string templateName, string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), RankedTable table = default(RankedTable))
        {
            // to ensure "templateName" is required (not null)
            if (templateName == null) {
                throw new ArgumentNullException("templateName is a required property for RankedTableTemplate and cannot be null");
            }
            this.TemplateName = templateName;
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for RankedTableTemplate and cannot be null");
            }
        ...
        {
            return this.Equals(input as RankedTableTemplate);
        }

        /// <summary>
        /// Returns true if RankedTableTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of RankedTableTemplate to be compared</param>
        /// <returns>Boolean</returns>
