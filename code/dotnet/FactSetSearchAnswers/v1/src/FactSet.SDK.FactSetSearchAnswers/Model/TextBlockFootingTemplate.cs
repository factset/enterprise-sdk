...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    public partial class TextBlockFootingTemplate : IEquatable<TextBlockFootingTemplate>, IValidatableObject
    {
        ...
        public TextBlockFootingTemplate(string headline = default(string), string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string body = default(string), TitledTextBlock footing = default(TitledTextBlock))
        {
