...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ColoredValueLabelDateTemplateData")]
    public partial class ColoredValueLabelDateTemplateData : IEquatable<ColoredValueLabelDateTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ColoredValueLabelDateTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ColoredValueLabelDateTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ColoredValueLabelDateTemplateData" /> class.
        /// </summary>
        ...
        public ColoredValueLabelDateTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), ColoredValue value = default(ColoredValue), string label = default(string), string date = default(string))
        {
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ColoredValueLabelDateTemplateData and cannot be null");
            }
        ...
        public ColoredValue Value { get; set; }
        ...
        {
            return this.Equals(input as ColoredValueLabelDateTemplateData);
        }

        /// <summary>
        /// Returns true if ColoredValueLabelDateTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ColoredValueLabelDateTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ColoredValueLabelDateTemplateData input)
        {
            if (input == null)
            {
                return false;
