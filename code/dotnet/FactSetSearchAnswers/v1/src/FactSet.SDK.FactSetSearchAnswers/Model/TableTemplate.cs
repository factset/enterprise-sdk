...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// TableTemplate
    /// </summary>
    [DataContract(Name = "TableTemplate")]
    public partial class TableTemplate : IEquatable<TableTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TableTemplate" /> class.
        /// </summary>
        ...
        public TableTemplate(string templateName, string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), Table table = default(Table))
        {
            // to ensure "templateName" is required (not null)
            if (templateName == null) {
                throw new ArgumentNullException("templateName is a required property for TableTemplate and cannot be null");
            }
            this.TemplateName = templateName;
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for TableTemplate and cannot be null");
            }
        ...
        {
            return this.Equals(input as TableTemplate);
        }

        /// <summary>
        /// Returns true if TableTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of TableTemplate to be compared</param>
        /// <returns>Boolean</returns>
