...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// TableTemplateData
    /// </summary>
    [DataContract(Name = "TableTemplateData")]
    public partial class TableTemplateData : IEquatable<TableTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TableTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TableTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TableTemplateData" /> class.
        /// </summary>
        ...
        public TableTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), Table table = default(Table))
        {
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for TableTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as TableTemplateData);
        }

        /// <summary>
        /// Returns true if TableTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of TableTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TableTemplateData input)
        {
            if (input == null)
            {
                return false;
