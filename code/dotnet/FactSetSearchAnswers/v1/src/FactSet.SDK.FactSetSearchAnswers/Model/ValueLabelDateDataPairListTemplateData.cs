...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueLabelDateDataPairListTemplateData")]
    public partial class ValueLabelDateDataPairListTemplateData : IEquatable<ValueLabelDateDataPairListTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateDataPairListTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelDateDataPairListTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateDataPairListTemplateData" /> class.
        /// </summary>
        ...
        public ValueLabelDateDataPairListTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string), string date = default(string), List<DataPair> list = default(List<DataPair>))
        {
            ...
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ValueLabelDateDataPairListTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueLabelDateDataPairListTemplateData);
        }

        /// <summary>
        /// Returns true if ValueLabelDateDataPairListTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelDateDataPairListTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelDateDataPairListTemplateData input)
        {
            if (input == null)
            {
                return false;
