...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueLabelDateTextBlockTemplate")]
    public partial class ValueLabelDateTextBlockTemplate : IEquatable<ValueLabelDateTextBlockTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateTextBlockTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelDateTextBlockTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateTextBlockTemplate" /> class.
        /// </summary>
        ...
        public ValueLabelDateTextBlockTemplate(string headline = default(string), string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string), string date = default(string), string blurb = default(string))
        {
        ...
        {
            return this.Equals(input as ValueLabelDateTextBlockTemplate);
        }

        /// <summary>
        /// Returns true if ValueLabelDateTextBlockTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelDateTextBlockTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelDateTextBlockTemplate input)
        {
            if (input == null)
                return false;
