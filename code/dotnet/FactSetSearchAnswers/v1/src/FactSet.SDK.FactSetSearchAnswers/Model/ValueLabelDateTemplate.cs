...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    public partial class ValueLabelDateTemplate : IEquatable<ValueLabelDateTemplate>, IValidatableObject
    {
        ...
        public ValueLabelDateTemplate(string templateName, string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string), string date = default(string))
        {
            // to ensure "templateName" is required (not null)
            if (templateName == null) {
                throw new ArgumentNullException("templateName is a required property for ValueLabelDateTemplate and cannot be null");
            }
