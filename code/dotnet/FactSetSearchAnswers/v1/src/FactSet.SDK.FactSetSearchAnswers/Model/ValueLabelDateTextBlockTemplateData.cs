...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueLabelDateTextBlockTemplateData")]
    public partial class ValueLabelDateTextBlockTemplateData : IEquatable<ValueLabelDateTextBlockTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateTextBlockTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelDateTextBlockTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateTextBlockTemplateData" /> class.
        /// </summary>
        ...
        public ValueLabelDateTextBlockTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), string label = default(string), string date = default(string), string text = default(string))
        {
            // to ensure "headline" is required (not null)
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ValueLabelDateTextBlockTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueLabelDateTextBlockTemplateData);
        }

        /// <summary>
        /// Returns true if ValueLabelDateTextBlockTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelDateTextBlockTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelDateTextBlockTemplateData input)
        {
            if (input == null)
            {
                return false;
