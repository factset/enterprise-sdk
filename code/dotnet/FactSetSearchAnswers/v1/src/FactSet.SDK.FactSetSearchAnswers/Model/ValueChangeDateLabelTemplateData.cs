...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueChangeDateLabelTemplateData")]
    public partial class ValueChangeDateLabelTemplateData : IEquatable<ValueChangeDateLabelTemplateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueChangeDateLabelTemplateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueChangeDateLabelTemplateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueChangeDateLabelTemplateData" /> class.
        /// </summary>
        ...
        public ValueChangeDateLabelTemplateData(string headline,string footer = default(string), Fdc3Context fdc3Context = default(Fdc3Context), List<ApplicationLink> applicationLinks = default(List<ApplicationLink>), string value = default(string), ValueChange valueChange = default(ValueChange), string date = default(string), string label = default(string))
        {
            ...
            if (headline == null) {
                throw new ArgumentNullException("headline is a required property for ValueChangeDateLabelTemplateData and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueChangeDateLabelTemplateData);
        }

        /// <summary>
        /// Returns true if ValueChangeDateLabelTemplateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueChangeDateLabelTemplateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueChangeDateLabelTemplateData input)
        {
            if (input == null)
            {
                return false;
