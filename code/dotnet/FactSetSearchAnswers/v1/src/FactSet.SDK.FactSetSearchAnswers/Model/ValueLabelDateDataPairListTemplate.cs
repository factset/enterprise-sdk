...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValueLabelDateDataPairListTemplate")]
    public partial class ValueLabelDateDataPairListTemplate : IEquatable<ValueLabelDateDataPairListTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateDataPairListTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueLabelDateDataPairListTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueLabelDateDataPairListTemplate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ValueLabelDateDataPairListTemplate);
        }

        /// <summary>
        /// Returns true if ValueLabelDateDataPairListTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueLabelDateDataPairListTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueLabelDateDataPairListTemplate input)
        {
            if (input == null)
            {
                return false;
