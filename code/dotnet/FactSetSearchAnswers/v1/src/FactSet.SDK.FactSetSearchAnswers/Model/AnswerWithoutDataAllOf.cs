...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AnswerWithoutData_allOf")]
    public partial class AnswerWithoutDataAllOf : IEquatable<AnswerWithoutDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnswerWithoutDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnswerWithoutDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnswerWithoutDataAllOf" /> class.
        /// </summary>
        /// <param name="title">title (required).</param>
        /// <param name="templateData">templateData.</param>
        public AnswerWithoutDataAllOf(string title = default(string), AnswerWithoutDataAllOfTemplateData templateData = default(AnswerWithoutDataAllOfTemplateData))
        {
        ...
        {
            return this.Equals(input as AnswerWithoutDataAllOf);
        }

        /// <summary>
        /// Returns true if AnswerWithoutDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AnswerWithoutDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnswerWithoutDataAllOf input)
        {
            if (input == null)
                return false;
