...
namespace FactSet.SDK.FactSetSearchAnswers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TableTableTemplateData_allOf")]
    public partial class TableTableTemplateDataAllOf : IEquatable<TableTableTemplateDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TableTableTemplateDataAllOf" /> class.
        /// </summary>
        /// <param name="table1">table1.</param>
        /// <param name="table2">table2.</param>
        public TableTableTemplateDataAllOf(Table table1 = default(Table), Table table2 = default(Table))
        {
            this.Table1 = table1;
            this.Table2 = table2;
        }
        ...
        {
            return this.Equals(input as TableTableTemplateDataAllOf);
        }

        /// <summary>
        /// Returns true if TableTableTemplateDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TableTableTemplateDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TableTableTemplateDataAllOf input)
        {
            if (input == null)
            {
                return false;
