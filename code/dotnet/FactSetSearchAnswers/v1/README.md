...
[![Nuget](https://img.shields.io/badge/nuget-v1.1.3-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetSearchAnswers/1.1.3)
...
dotnet add package FactSet.SDK.FactSetSearchAnswers -v 1.1.3
```
...
nuget install FactSet.SDK.FactSetSearchAnswers -Version 1.1.3
```
