...
namespace Example
{
    public class GetFICalculationByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling FICalculationsApi.GetFICalculationById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RunFICalculationExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling FICalculationsApi.RunFICalculation: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
