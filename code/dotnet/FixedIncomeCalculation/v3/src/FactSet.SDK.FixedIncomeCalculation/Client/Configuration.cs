...
namespace FactSet.SDK.FixedIncomeCalculation.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/FixedIncomeCalculation/1.2.0";
            BasePath = "https://api.factset.com/analytics/engines/fi/v3";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/analytics/engines/fi/v3"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/engines/fi/v3") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.FixedIncomeCalculation) Debug Report:\n";
