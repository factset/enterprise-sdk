...
namespace FactSet.SDK.ExchangeDataFeedDataModel.Model
{
    ...
    /// ExchangesResponse
    /// </summary>
    [DataContract(Name = "ExchangesResponse")]
    public partial class ExchangesResponse : IEquatable<ExchangesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangesResponse" /> class.
        /// </summary>
        ...
        public ExchangesResponse(ExchangesResponseData data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ExchangesResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        public ExchangesResponseData Data { get; set; }
        ...
        {
            return this.Equals(input as ExchangesResponse);
        }

        /// <summary>
        /// Returns true if ExchangesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangesResponse input)
        {
            if (input == null)
            {
                return false;
