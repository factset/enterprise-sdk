...
namespace FactSet.SDK.ExchangeDataFeedDataModel.Api
{
    ...
    /// </summary>
    public interface IFactSetProductCodesApiSync : IApiAccessor
    {
        ...
        /// <param name="format">The format of the output file.&lt;p&gt;**Try it Out** - All formats available&lt;/p&gt; (optional, default to json)</param>
        /// <returns>RTDataModelProducts</returns>
        RTDataModelProducts GetProducts(string format = default(string));
        ...
        /// <exception cref="FactSet.SDK.ExchangeDataFeedDataModel.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="format">The format of the output file.&lt;p&gt;**Try it Out** - All formats available&lt;/p&gt; (optional, default to json)</param>
        /// <returns>ApiResponse of RTDataModelProducts</returns>
        ApiResponse<RTDataModelProducts> GetProductsWithHttpInfo(string format = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFactSetProductCodesApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of RTDataModelProducts</returns>
        System.Threading.Tasks.Task<RTDataModelProducts> GetProductsAsync(string format = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="format">The format of the output file.&lt;p&gt;**Try it Out** - All formats available&lt;/p&gt; (optional, default to json)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RTDataModelProducts)</returns>
        System.Threading.Tasks.Task<ApiResponse<RTDataModelProducts>> GetProductsWithHttpInfoAsync(string format = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFactSetProductCodesApi : IFactSetProductCodesApiSync, IFactSetProductCodesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class FactSetProductCodesApi : IFactSetProductCodesApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FactSetProductCodesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public FactSetProductCodesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public FactSetProductCodesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public FactSetProductCodesApi(FactSet.SDK.ExchangeDataFeedDataModel.Client.Configuration configuration)
        {
        ...
        public FactSetProductCodesApi(FactSet.SDK.ExchangeDataFeedDataModel.Client.ISynchronousClient client, FactSet.SDK.ExchangeDataFeedDataModel.Client.IAsynchronousClient asyncClient, FactSet.SDK.ExchangeDataFeedDataModel.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="format">The format of the output file.&lt;p&gt;**Try it Out** - All formats available&lt;/p&gt; (optional, default to json)</param>
        /// <returns>RTDataModelProducts</returns>
        public RTDataModelProducts GetProducts(string format = default(string))
        {
            var localVarResponse = GetProductsWithHttpInfo(format);
        ...
        /// <param name="format">The format of the output file.&lt;p&gt;**Try it Out** - All formats available&lt;/p&gt; (optional, default to json)</param>
        /// <returns>ApiResponse of RTDataModelProducts</returns>
        public ApiResponse<RTDataModelProducts> GetProductsWithHttpInfo(string format = default(string))
        {
            ...
            RTDataModelProducts>("/products", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RTDataModelProducts</returns>
        public async System.Threading.Tasks.Task<RTDataModelProducts>GetProductsAsync(string format = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetProductsWithHttpInfoAsync(format, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<RTDataModelProducts>> GetProductsWithHttpInfoAsync(string format = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<RTDataModelProducts>("/products", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
