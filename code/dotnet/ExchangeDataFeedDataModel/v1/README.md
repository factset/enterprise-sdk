...
[![Nuget](https://img.shields.io/badge/nuget-v0.21.1-orange)](https://www.nuget.org/packages/FactSet.SDK.ExchangeDataFeedDataModel/0.21.1)
...
dotnet add package FactSet.SDK.ExchangeDataFeedDataModel -v 0.21.1
```
...
nuget install FactSet.SDK.ExchangeDataFeedDataModel -Version 0.21.1
```
