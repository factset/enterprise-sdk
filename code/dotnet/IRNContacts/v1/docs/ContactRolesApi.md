...
namespace Example
{
    public class V1ContactRolesContactRoleIdDeleteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactRolesApi.V1ContactRolesContactRoleIdDelete: " + e.Message );
...
namespace Example
{
    public class V1ContactRolesContactRoleIdPutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactRolesApi.V1ContactRolesContactRoleIdPut: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1ContactRolesGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactRolesApi.V1ContactRolesGet: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1ContactRolesPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactRolesApi.V1ContactRolesPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
