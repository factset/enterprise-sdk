...
<a name="v1contactscontactidaboutget"></a>
...
namespace Example
{
    public class V1ContactsContactIdAboutGetExample
    {
        public static async Task Main()
        {
            ...
            var contactId = 38400000-8cf0-11bd-b23e-10b96e4ef00d;  // Guid | contactId of associated record
            ...
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdAboutGet: " + e.Message );
...
<a name="v1contactscontactiddelete"></a>
...
namespace Example
{
    public class V1ContactsContactIdDeleteExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            var apiInstance = new ContactsApi(config);
            var contactId = 38400000-8cf0-11bd-b23e-10b96e4ef00d;  // Guid | contactId to delete associated record
            ...
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdDelete: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactscontactideventsget"></a>
...
namespace Example
{
    public class V1ContactsContactIdEventsGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            var apiInstance = new ContactsApi(config);
            var contactId = 38400000-8cf0-11bd-b23e-10b96e4ef00d;  // Guid | contactId to get associated records

            try
            {
                // Get a contact’s audit history
                List<ContactEventDto> result = apiInstance.V1ContactsContactIdEventsGet(contactId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdEventsGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactscontactidget"></a>
...
namespace Example
{
    public class V1ContactsContactIdGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            var apiInstance = new ContactsApi(config);
            var contactId = 38400000-8cf0-11bd-b23e-10b96e4ef00d;  // Guid | contactId to get associated record
            ...
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactscontactidpatch"></a>
# **V1ContactsContactIdPatch**
> void V1ContactsContactIdPatch (Guid contactId, List<Operation> operation = null)
...
namespace Example
{
    public class V1ContactsContactIdPatchExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            var apiInstance = new ContactsApi(config);
            var contactId = 38400000-8cf0-11bd-b23e-10b96e4ef00d;  // Guid | contactId to update associated record
            ...
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdPatch: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactscontactidrecordsget"></a>
...
namespace Example
{
    public class V1ContactsContactIdRecordsGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            {
                // Get all notes and meetings where a specific contact was tagged
                List<RecordPreviewDto> result = apiInstance.V1ContactsContactIdRecordsGet(contactId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdRecordsGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactscontactidrelationshipsget"></a>
...
namespace Example
{
    public class V1ContactsContactIdRelationshipsGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            {
                // Returns a list of a contact’s relationships
                List<ContactRelationshipDto> result = apiInstance.V1ContactsContactIdRelationshipsGet(contactId);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsContactIdRelationshipsGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactsget"></a>
# **V1ContactsGet**
> List&lt;ContactSummaryDto&gt; V1ContactsGet (string fullName = null, string emailAddress = null, string identifier = null, string employerName = null, bool? customFieldValues = null, string search = null, string sort = null, bool? includeLastMeetingDate = null, int? limit = null)
...
namespace Example
{
    public class V1ContactsGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            var customFieldValues = true;  // bool? | Includes custom field values in response if true (optional)  (default to false)
            ...
            var includeLastMeetingDate = true;  // bool? | If true, returns when they were last tagged as an attendee in an IRN meeting (optional)  (default to false)
            var limit = 56;  // int? | Restrict number of records returned (optional)  (default to 0)

            try
            {
                // Get list of all contacts in your group along with some of their standard field data
                List<ContactSummaryDto> result = apiInstance.V1ContactsGet(fullName, emailAddress, identifier, employerName, customFieldValues, search, sort, includeLastMeetingDate, limit);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="v1contactspost"></a>
# **V1ContactsPost**
> Guid V1ContactsPost (ContactSaveDto contactSaveDto = null)
...
namespace Example
{
    public class V1ContactsPostExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            {
                // Create a contact
                Guid result = apiInstance.V1ContactsPost(contactSaveDto);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ContactsApi.V1ContactsPost: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
