...
namespace Example
{
    public class V1PhoneNumberTypesGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PhoneNumberTypesApi.V1PhoneNumberTypesGet: " + e.Message );
...
namespace Example
{
    public class V1PhoneNumberTypesPhoneNumberTypeIdDeleteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PhoneNumberTypesApi.V1PhoneNumberTypesPhoneNumberTypeIdDelete: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1PhoneNumberTypesPhoneNumberTypeIdPutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PhoneNumberTypesApi.V1PhoneNumberTypesPhoneNumberTypeIdPut: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1PhoneNumberTypesPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PhoneNumberTypesApi.V1PhoneNumberTypesPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
