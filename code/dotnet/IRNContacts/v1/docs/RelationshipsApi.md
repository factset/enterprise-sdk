...
namespace Example
{
    public class V1RelationshipsGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RelationshipsApi.V1RelationshipsGet: " + e.Message );
...
namespace Example
{
    public class V1RelationshipsPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RelationshipsApi.V1RelationshipsPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1RelationshipsRelationshipIdDeleteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RelationshipsApi.V1RelationshipsRelationshipIdDelete: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class V1RelationshipsRelationshipIdPutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RelationshipsApi.V1RelationshipsRelationshipIdPut: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
