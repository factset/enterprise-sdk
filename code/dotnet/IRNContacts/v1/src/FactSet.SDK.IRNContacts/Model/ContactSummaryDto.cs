...
namespace FactSet.SDK.IRNContacts.Model
{
    ...
    public partial class ContactSummaryDto : IEquatable<ContactSummaryDto>, IValidatableObject
    {
        ...
        public ContactSummaryDto(Guid id = default(Guid), string primaryEmailAddress = default(string), string identifier = default(string), string fullName = default(string), string employerName = default(string), string city = default(string), string stateProvince = default(string), string postalCode = default(string), string country = default(string), ContactRoleDto role = default(ContactRoleDto), ContactTypeDto type = default(ContactTypeDto), bool isDeleted = default(bool), string lastMeeting = default(string), List<AlternativeEmailAddressDto> alternativeEmailAddresses = default(List<AlternativeEmailAddressDto>), List<ContactCustomFieldValueDto> customFieldValues = default(List<ContactCustomFieldValueDto>))
        {
            this.Id = id;
