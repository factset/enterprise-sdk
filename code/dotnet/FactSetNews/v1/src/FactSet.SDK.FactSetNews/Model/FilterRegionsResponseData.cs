...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FilterRegionsResponse_data")]
    public partial class FilterRegionsResponseData : IEquatable<FilterRegionsResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterRegionsResponseData" /> class.
        /// </summary>
        /// <param name="structured">structured.</param>
        /// <param name="flattened">flattened.</param>
        public FilterRegionsResponseData(StructuredFiltersRegions structured = default(StructuredFiltersRegions), FlattenedFiltersRegions flattened = default(FlattenedFiltersRegions))
        {
        ...
        public StructuredFiltersRegions Structured { get; set; }

        /// <summary>
        /// Gets or Sets Flattened
        /// </summary>
        [DataMember(Name = "flattened", EmitDefaultValue = false)]
        public FlattenedFiltersRegions Flattened { get; set; }
        ...
        {
            return this.Equals(input as FilterRegionsResponseData);
        }

        /// <summary>
        /// Returns true if FilterRegionsResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterRegionsResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterRegionsResponseData input)
        {
            if (input == null)
            {
                return false;
