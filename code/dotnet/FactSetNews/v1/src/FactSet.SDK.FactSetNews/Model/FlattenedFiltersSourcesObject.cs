...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlattenedFiltersSourcesObject")]
    public partial class FlattenedFiltersSourcesObject : IEquatable<FlattenedFiltersSourcesObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedFiltersSourcesObject" /> class.
        /// </summary>
        /// <param name="name">The name of the source..</param>
        /// <param name="value">The value associated with the source..</param>
        public FlattenedFiltersSourcesObject(string name = default(string), List<string> value = default(List<string>))
        {
            this.Name = name;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as FlattenedFiltersSourcesObject);
        }

        /// <summary>
        /// Returns true if FlattenedFiltersSourcesObject instances are equal
        /// </summary>
        /// <param name="input">Instance of FlattenedFiltersSourcesObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlattenedFiltersSourcesObject input)
        {
            if (input == null)
            {
                return false;
