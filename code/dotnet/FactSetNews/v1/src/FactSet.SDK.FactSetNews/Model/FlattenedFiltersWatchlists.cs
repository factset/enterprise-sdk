...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlattenedFiltersWatchlists")]
    public partial class FlattenedFiltersWatchlists : IEquatable<FlattenedFiltersWatchlists>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedFiltersWatchlists" /> class.
        /// </summary>
        /// <param name="watchlists">watchlists.</param>
        public FlattenedFiltersWatchlists(List<FlattenedFiltersWatchlistsObject> watchlists = default(List<FlattenedFiltersWatchlistsObject>))
        {
        ...
        {
            return this.Equals(input as FlattenedFiltersWatchlists);
        }

        /// <summary>
        /// Returns true if FlattenedFiltersWatchlists instances are equal
        /// </summary>
        /// <param name="input">Instance of FlattenedFiltersWatchlists to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlattenedFiltersWatchlists input)
        {
            if (input == null)
            {
                return false;
