...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    public partial class FlattenedFiltersCategoriesObject : IEquatable<FlattenedFiltersCategoriesObject>, IValidatableObject
    {
        ...
        /// <param name="sourceDisplayNames">An array containing a source names associated with the category. .</param>
        /// <param name="field">The field of the category..</param>
        /// <param name="source">The source of the category..</param>
        public FlattenedFiltersCategoriesObject(string name = default(string), List<string> value = default(List<string>), List<string> sourceDisplayNames = default(List<string>), string field = default(string), List<string> source = default(List<string>))
        {
            this.Name = name;
            this.Value = value;
        ...
        /// </summary>
        /// <value>An array containing a source names associated with the category. </value>
        ...
        /// </summary>
        /// <value>The field of the category.</value>
        ...
        /// </summary>
        /// <value>The source of the category.</value>
