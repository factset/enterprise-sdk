...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FilterSourcesResponse_data")]
    public partial class FilterSourcesResponseData : IEquatable<FilterSourcesResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterSourcesResponseData" /> class.
        /// </summary>
        /// <param name="structured">structured.</param>
        /// <param name="flattened">flattened.</param>
        public FilterSourcesResponseData(StructuredFiltersSources structured = default(StructuredFiltersSources), FlattenedFiltersSources flattened = default(FlattenedFiltersSources))
        {
        ...
        public StructuredFiltersSources Structured { get; set; }

        /// <summary>
        /// Gets or Sets Flattened
        /// </summary>
        [DataMember(Name = "flattened", EmitDefaultValue = false)]
        public FlattenedFiltersSources Flattened { get; set; }
        ...
        {
            return this.Equals(input as FilterSourcesResponseData);
        }

        /// <summary>
        /// Returns true if FilterSourcesResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterSourcesResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterSourcesResponseData input)
        {
            if (input == null)
            {
                return false;
