...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    /// RegionObject
    /// </summary>
    [DataContract(Name = "RegionObject")]
    public partial class RegionObject : IEquatable<RegionObject>, IValidatableObject
    {
        /// <summary>
        ...
        public RegionObject(string name = default(string), List<string> value = default(List<string>))
        {
            this.Name = name;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as RegionObject);
        }

        /// <summary>
        /// Returns true if RegionObject instances are equal
        /// </summary>
        /// <param name="input">Instance of RegionObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegionObject input)
        {
            if (input == null)
            {
                return false;
