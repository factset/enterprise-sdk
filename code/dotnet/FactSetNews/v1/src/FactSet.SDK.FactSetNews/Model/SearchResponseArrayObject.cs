...
namespace FactSet.SDK.FactSetNews.Model
{
    ...
    public partial class SearchResponseArrayObject : IEquatable<SearchResponseArrayObject>, IValidatableObject
    {
        ...
        /// <param name="htmlUrl">The URL to view the story in HTML format.  **Note:** HTML version does not include footer or metadata details that appear in the standard story view. .</param>
        ...
        public SearchResponseArrayObject(DateTime storyDateAndTime = default(DateTime), string headlines = default(string), string id = default(string), string url = default(string), string htmlUrl = default(string), string source = default(string), string product = default(string), List<string> primarySymbols = default(List<string>), List<string> symbols = default(List<string>), List<string> subjects = default(List<string>), string fdsSubject = default(string))
        {
        ...
        /// </summary>
        /// <value>The URL to view the story in HTML format.  **Note:** HTML version does not include footer or metadata details that appear in the standard story view. </value>
