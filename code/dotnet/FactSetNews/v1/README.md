...
[![API Version](https://img.shields.io/badge/api-v1.1.0-blue)](https://developer.factset.com/api-catalog/factset-news-api)
[![Nuget](https://img.shields.io/badge/nuget-v1.1.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetNews/1.1.0)
...
dotnet add package FactSet.SDK.FactSetNews -v 1.1.0
```
...
nuget install FactSet.SDK.FactSetNews -Version 1.1.0
```
