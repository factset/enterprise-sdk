...
[![Nuget](https://img.shields.io/badge/nuget-v0.1.2-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetNews/0.1.2)
...
dotnet add package FactSet.SDK.FactSetNews -v 0.1.2
```
...
nuget install FactSet.SDK.FactSetNews -Version 0.1.2
```
