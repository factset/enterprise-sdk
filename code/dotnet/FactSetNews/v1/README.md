...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.1-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetNews/1.0.1)
...
dotnet add package FactSet.SDK.FactSetNews -v 1.0.1
```
...
nuget install FactSet.SDK.FactSetNews -Version 1.0.1
```
