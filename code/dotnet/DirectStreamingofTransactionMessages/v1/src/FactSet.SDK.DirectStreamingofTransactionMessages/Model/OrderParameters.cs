...
namespace FactSet.SDK.DirectStreamingofTransactionMessages.Model
{
    ...
    public partial class OrderParameters : IEquatable<OrderParameters>, IValidatableObject
    {
        ...
        public OrderParameters(string portfolio, string transactionid, string symbol, string description, string tradetype, string status, string tradedate, double amount, string currencyiso,string orderid = default(string), double transactionleaves = default(double), float foreignexchangerate = default(float))
        {
