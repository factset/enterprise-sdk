...
namespace FactSet.SDK.DirectStreamingofTransactionMessages.Model
{
    ...
    public partial class PlacementParameters : IEquatable<PlacementParameters>, IValidatableObject
    {
        ...
        public PlacementParameters(string settlementcurrencyiso = default(string), string portfolio = default(string), string transactionid = default(string), string symbol = default(string), string description = default(string), string tradetype = default(string), string status = default(string), string tradedate = default(string), float transactionleaves = default(float), float amount = default(float), string currencyiso = default(string), float foreignexchangerate = default(float))
        {
