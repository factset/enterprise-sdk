...
namespace FactSet.SDK.DirectStreamingofTransactionMessages.Model
{
    ...
    public partial class ExecutionParameters : IEquatable<ExecutionParameters>, IValidatableObject
    {
        ...
        public ExecutionParameters(float net = default(float), float gross = default(float), float settlementvalue = default(float), string settlementdate = default(string), string settlementcurrencyiso = default(string), string portfolio = default(string), string transactionid = default(string), string symbol = default(string), string description = default(string), string tradetype = default(string), string status = default(string), string tradedate = default(string), float transactionleaves = default(float), float amount = default(float), string currencyiso = default(string), float foreignexchangerate = default(float))
        {
            this.Net = net;
            this.Gross = gross;
        ...
        [DataMember(Name = "settlementcurrencyiso", EmitDefaultValue = false)]
