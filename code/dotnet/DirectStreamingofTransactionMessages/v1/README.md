...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 0.24.1
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 0.24.1
```
