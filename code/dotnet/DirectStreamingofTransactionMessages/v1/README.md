...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages
```
...
## Documentation for Models
 ...
 - [Model.ExecutionParameters](docs/ExecutionParameters.md)
 - [Model.OrderParameters](docs/OrderParameters.md)
 - [Model.PlacementParameters](docs/PlacementParameters.md)
