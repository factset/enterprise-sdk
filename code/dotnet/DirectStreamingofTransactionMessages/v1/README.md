...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 0.22.7
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 0.22.7
```
