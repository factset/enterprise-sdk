...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 0.23.0
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 0.23.0
```
