...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 0.23.2
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 0.23.2
```
