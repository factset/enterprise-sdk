...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.DirectStreamingofTransactionMessages/1.0.0)
...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 1.0.0
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 1.0.0
```
