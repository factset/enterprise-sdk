...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 0.24.2
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 0.24.2
```
