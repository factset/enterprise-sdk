...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.DirectStreamingofTransactionMessages/2.0.0)
...
dotnet add package FactSet.SDK.DirectStreamingofTransactionMessages -v 2.0.0
```
...
nuget install FactSet.SDK.DirectStreamingofTransactionMessages -Version 2.0.0
```
...
## Documentation for Models
 ...
 - [Model.AdditionalField](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/DirectStreamingofTransactionMessages/v1/docs/AdditionalField.md)
 ...
 - [Model.DsotmParameters](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/DirectStreamingofTransactionMessages/v1/docs/DsotmParameters.md)
 - [Model.DsotmParametersRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/DirectStreamingofTransactionMessages/v1/docs/DsotmParametersRoot.md)
 ...
 - [Model.Execution](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/DirectStreamingofTransactionMessages/v1/docs/Execution.md)
 - [Model.Order](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/DirectStreamingofTransactionMessages/v1/docs/Order.md)
 - [Model.Placement](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/DirectStreamingofTransactionMessages/v1/docs/Placement.md)
