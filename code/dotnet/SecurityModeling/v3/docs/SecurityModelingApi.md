...
namespace Example
{
    public class GetSecuritiesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling SecurityModelingApi.GetSecurities: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpsertSecuritiesExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling SecurityModelingApi.UpsertSecurities: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
