...
namespace FactSet.SDK.SecurityModeling.Api
{
    ...
    public partial class SecurityModelingApi : ISecurityModelingApi
    {
        ...
        public ApiResponse<SMDeleteResponseRoot> DeleteSecuritiesWithHttpInfo(SMDeleteParametersRoot sMDeleteParametersRoot = default(SMDeleteParametersRoot))
        {
            ...
            SMDeleteResponseRoot>("/delete", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SMDeleteResponseRoot>> DeleteSecuritiesWithHttpInfoAsync(SMDeleteParametersRoot sMDeleteParametersRoot = default(SMDeleteParametersRoot), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<SMDeleteResponseRoot>("/delete", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<SMRetrieveResponseRoot> GetSecuritiesWithHttpInfo(SMRetrieveParametersRoot sMRetrieveParametersRoot = default(SMRetrieveParametersRoot))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<
            SMRetrieveResponseRoot>("/retrieve", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SMRetrieveResponseRoot>> GetSecuritiesWithHttpInfoAsync(SMRetrieveParametersRoot sMRetrieveParametersRoot = default(SMRetrieveParametersRoot), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<SMRetrieveResponseRoot>("/retrieve", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<SMCreateResponseRoot> UpsertSecuritiesWithHttpInfo(SMCreateParametersRoot sMCreateParametersRoot = default(SMCreateParametersRoot))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<
            SMCreateResponseRoot>("/upsert", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SMCreateResponseRoot>> UpsertSecuritiesWithHttpInfoAsync(SMCreateParametersRoot sMCreateParametersRoot = default(SMCreateParametersRoot), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<SMCreateResponseRoot>("/upsert", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
