...
namespace FactSet.SDK.SecurityModeling.Model
{
    ...
    /// SMDeleteResponse
    /// </summary>
    [DataContract(Name = "SMDeleteResponse")]
    public partial class SMDeleteResponse : IEquatable<SMDeleteResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SMDeleteResponse" /> class.
        /// </summary>
        /// <param name="securityName">securityName.</param>
        /// <param name="status">status.</param>
        /// <param name="errors">errors.</param>
        public SMDeleteResponse(string securityName = default(string), StatusEnum? status = default(StatusEnum?), List<SMError> errors = default(List<SMError>))
        {
        ...
        {
            return this.Equals(input as SMDeleteResponse);
        }

        /// <summary>
        /// Returns true if SMDeleteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SMDeleteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMDeleteResponse input)
        {
            if (input == null)
            {
                return false;
