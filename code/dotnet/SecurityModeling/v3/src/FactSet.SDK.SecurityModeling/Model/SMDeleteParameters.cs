...
namespace FactSet.SDK.SecurityModeling.Model
{
    ...
    public partial class SMDeleteParameters : IEquatable<SMDeleteParameters>, IValidatableObject
    {
        ...
        public SMDeleteParameters(string securityName,string location = default(string), string asofdate = default(string), SecurityTypeEnum? securityType = default(SecurityTypeEnum?))
        {
            // to ensure "securityName" is required (not null)
            if (securityName == null) {
                throw new ArgumentNullException("securityName is a required property for SMDeleteParameters and cannot be null");
            }
