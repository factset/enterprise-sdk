...
[![Nuget](https://img.shields.io/badge/nuget-v0.20.12-orange)](https://www.nuget.org/packages/FactSet.SDK.SecurityModeling/0.20.12)
...
dotnet add package FactSet.SDK.SecurityModeling -v 0.20.12
```
...
nuget install FactSet.SDK.SecurityModeling -Version 0.20.12
```
...
------------ | ------------- | ------------- | -------------
*SecurityModelingApi* | [**DeleteSecurities**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SecurityModeling/v3/docs/SecurityModelingApi.md#deletesecurities) | **POST** /delete | Delete existing securities
*SecurityModelingApi* | [**GetSecurities**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SecurityModeling/v3/docs/SecurityModelingApi.md#getsecurities) | **POST** /retrieve | Get existing securities
*SecurityModelingApi* | [**UpsertSecurities**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/SecurityModeling/v3/docs/SecurityModelingApi.md#upsertsecurities) | **POST** /upsert | Create or update securities
