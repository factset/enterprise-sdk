...
namespace FactSet.SDK.SecurityModeling.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/SecurityModeling/1.0.0";
            BasePath = "https://api.factset.com/analytics/security-modeling/v4";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/analytics/security-modeling/v4"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/security-modeling/v4") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.SecurityModeling) Debug Report:\n";
