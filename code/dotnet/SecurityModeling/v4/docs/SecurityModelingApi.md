...
# **DeleteSecurities**
> RequestStatusRoot DeleteSecurities (SMDeleteParametersRoot sMDeleteParametersRoot = null)
...
namespace Example
{
    public class GetFieldsExample
    {
        public static async Task Main()
        {
            ...
            var securityType = "securityType_example";  // string | Security Type
            ...
            {
                Console.WriteLine("Exception when calling SecurityModelingApi.GetFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="smgetrequestresultbyid"></a>
...
namespace Example
{
    public class SmGetRequestResultByIdExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.SecurityModeling.Client.Configuration();
            ...
            var jobId = "jobId_example";  // string | from url, provided from the location header in the Get SM upsert status by id endpoint
            ...
            {
                Console.WriteLine("Exception when calling SecurityModelingApi.SmGetRequestResultById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="smgetupsertstatusbyid"></a>
...
namespace Example
{
    public class SmGetUpsertStatusByIdExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.SecurityModeling.Client.Configuration();
            ...
            var jobId = "jobId_example";  // string | from url, provided from the location header in the Create and Run SM upsert/delete endpoint
            ...
            {
                Console.WriteLine("Exception when calling SecurityModelingApi.SmGetUpsertStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
# **UpsertSecurities**
> RequestStatusRoot UpsertSecurities (SMCreateParametersRoot sMCreateParametersRoot = null)
