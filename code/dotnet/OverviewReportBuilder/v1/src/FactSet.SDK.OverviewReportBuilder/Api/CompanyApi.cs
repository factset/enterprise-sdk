...
namespace FactSet.SDK.OverviewReportBuilder.Api
{
    ...
    public interface ICompanyApiSync : IApiAccessor
    {
        ...
        /// <param name="id">Company ticker</param>
        /// <returns>ApiResponse of StachTableResponse</returns>
        ApiResponse<StachTableResponse> FinancialHighlightsGetWithHttpInfo(string id);
        /// <summary>
        /// Overview Profile
        /// </summary>
        /// <exception cref="FactSet.SDK.OverviewReportBuilder.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface ICompanyApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StachTableResponse</returns>
        System.Threading.Tasks.Task<StachTableResponse> FinancialHighlightsGetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StachTableResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<StachTableResponse>> FinancialHighlightsGetWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Overview Profile
        /// </summary>
        /// <remarks>
    ...
    public partial class CompanyApi : ICompanyApi
    {
        ...
        /// <param name="id">Company ticker</param>
        /// <returns>StachTableResponse</returns>
        public StachTableResponse FinancialHighlightsGet(string id)
        {
            var localVarResponse = FinancialHighlightsGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Company ticker</param>
        /// <returns>ApiResponse of StachTableResponse</returns>
        public ApiResponse<StachTableResponse> FinancialHighlightsGetWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StachTableResponse</returns>
        public async System.Threading.Tasks.Task<StachTableResponse>FinancialHighlightsGetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await FinancialHighlightsGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<StachTableResponse>> FinancialHighlightsGetWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
