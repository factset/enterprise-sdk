...
namespace FactSet.SDK.OverviewReportBuilder.Model
{
    ...
    public partial class ProfileDataStage : IEquatable<ProfileDataStage>, IValidatableObject
    {
        ...
        public ProfileDataStage(ProfileDataBusinessIndustry exchangePrimary, ProfileDataStageTradeDateRange tradeDateRange, ProfileDataBusinessIndustry foundedYear, ProfileDataBusinessIndustry pevcBacking,ProfileDataStagePevcLatestPostMoneyValuation pevcLatestPostMoneyValuation = default(ProfileDataStagePevcLatestPostMoneyValuation), KeyStatsEntityObjectAverageDailyVolValue peActiveFirmNumber = default(KeyStatsEntityObjectAverageDailyVolValue), KeyStatsEntityObjectAverageDailyVolValue peActiveInvestmentNumber = default(KeyStatsEntityObjectAverageDailyVolValue), ProfileDataBusinessIndustry peLastInvestmentDate = default(ProfileDataBusinessIndustry), List<ProfileDataStagePeActiveFirms> peActiveFirms = default(List<ProfileDataStagePeActiveFirms>), ProfileDataBusinessIndustry peActiveAcqDate = default(ProfileDataBusinessIndustry), ProfileDataSizeEv peActiveAcqAmt = default(ProfileDataSizeEv), ProfileDataBusinessIndustry vcLastRound = default(ProfileDataBusinessIndustry), ProfileDataSizeEv vcLastRoundAmt = default(ProfileDataSizeEv), KeyStatsEntityObjectAverageDailyVolValue vcLastRoundInvestorNumber = default(KeyStatsEntityObjectAverageDailyVolValue), ProfileDataBusinessIndustry vcLastRoundDate = default(ProfileDataBusinessIndustry), ProfileDataSizeEv vcTotalEstRaised = default(ProfileDataSizeEv), ProfileDataStageCrunchbaseRank crunchbaseRank = default(ProfileDataStageCrunchbaseRank))
        {
        ...
        public ProfileDataStagePevcLatestPostMoneyValuation PevcLatestPostMoneyValuation { get; set; }

        /// <summary>
        /// Gets or Sets PeActiveFirmNumber
        /// </summary>
        [DataMember(Name = "peActiveFirmNumber", EmitDefaultValue = false)]
        public KeyStatsEntityObjectAverageDailyVolValue PeActiveFirmNumber { get; set; }

        /// <summary>
        /// Gets or Sets PeActiveInvestmentNumber
        /// </summary>
        [DataMember(Name = "peActiveInvestmentNumber", EmitDefaultValue = false)]
        public KeyStatsEntityObjectAverageDailyVolValue PeActiveInvestmentNumber { get; set; }
        ...
        public KeyStatsEntityObjectAverageDailyVolValue VcLastRoundInvestorNumber { get; set; }
