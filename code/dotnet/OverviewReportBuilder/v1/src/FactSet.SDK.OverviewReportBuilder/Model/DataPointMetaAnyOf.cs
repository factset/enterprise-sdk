...
namespace FactSet.SDK.OverviewReportBuilder.Model
{
    ...
    /// DataPointMetaAnyOf
    /// </summary>
    [DataContract(Name = "DataPointMeta_anyOf")]
    public partial class DataPointMetaAnyOf : IEquatable<DataPointMetaAnyOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataPointMetaAnyOf" /> class.
        /// </summary>
        ...
        public DataPointMetaAnyOf(string currencyCode = default(string), string currencySymbol = default(string), int scale = default(int))
        {
        ...
        {
            return this.Equals(input as DataPointMetaAnyOf);
        }

        /// <summary>
        /// Returns true if DataPointMetaAnyOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DataPointMetaAnyOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataPointMetaAnyOf input)
        {
            if (input == null)
            {
                return false;
