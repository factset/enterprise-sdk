...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StructuredFiltersSectors")]
    public partial class StructuredFiltersSectors : IEquatable<StructuredFiltersSectors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StructuredFiltersSectors" /> class.
        /// </summary>
        /// <param name="sectors">sectors.</param>
        public StructuredFiltersSectors(List<StructuredFiltersSectorsObject> sectors = default(List<StructuredFiltersSectorsObject>))
        {
        ...
        {
            return this.Equals(input as StructuredFiltersSectors);
        }

        /// <summary>
        /// Returns true if StructuredFiltersSectors instances are equal
        /// </summary>
        /// <param name="input">Instance of StructuredFiltersSectors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StructuredFiltersSectors input)
        {
            if (input == null)
            {
                return false;
