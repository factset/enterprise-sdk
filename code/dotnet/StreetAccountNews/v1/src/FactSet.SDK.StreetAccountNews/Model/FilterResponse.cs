...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// Filters Object
    /// </summary>
    [DataContract(Name = "FilterResponse")]
    public partial class FilterResponse : IEquatable<FilterResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FilterResponse(FilterResponseData data = default(FilterResponseData))
        {
            this.Data = data;
        }
        ...
        public FilterResponseData Data { get; set; }
        ...
        {
            return this.Equals(input as FilterResponse);
        }

        /// <summary>
        /// Returns true if FilterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterResponse input)
        {
            if (input == null)
            {
                return false;
