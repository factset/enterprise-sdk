...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    public partial class StructuredFiltersCategoriesObject : IEquatable<StructuredFiltersCategoriesObject>, IValidatableObject
    {
        ...
        public StructuredFiltersCategoriesObject(string name = default(string), List<string> value = default(List<string>), List<StructuredFiltersChildrenObjectCategories> children = default(List<StructuredFiltersChildrenObjectCategories>))
        {
            this.Name = name;
            this.Value = value;
        ...
        public List<StructuredFiltersChildrenObjectCategories> Children { get; set; }
