...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FilterWatchlistsResponse_data")]
    public partial class FilterWatchlistsResponseData : IEquatable<FilterWatchlistsResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterWatchlistsResponseData" /> class.
        /// </summary>
        /// <param name="structured">structured.</param>
        /// <param name="flattened">flattened.</param>
        public FilterWatchlistsResponseData(StructuredFiltersWatchlists structured = default(StructuredFiltersWatchlists), FlattenedFiltersWatchlists flattened = default(FlattenedFiltersWatchlists))
        {
        ...
        public StructuredFiltersWatchlists Structured { get; set; }

        /// <summary>
        /// Gets or Sets Flattened
        /// </summary>
        [DataMember(Name = "flattened", EmitDefaultValue = false)]
        public FlattenedFiltersWatchlists Flattened { get; set; }
        ...
        {
            return this.Equals(input as FilterWatchlistsResponseData);
        }

        /// <summary>
        /// Returns true if FilterWatchlistsResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterWatchlistsResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterWatchlistsResponseData input)
        {
            if (input == null)
            {
                return false;
