...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HeadlinesRequestByView")]
    public partial class HeadlinesRequestByView : IEquatable<HeadlinesRequestByView>, IValidatableObject
    {
        /// <summary>
        ...
        public HeadlinesRequestByViewMeta Meta { get; set; }
        ...
        {
            return this.Equals(input as HeadlinesRequestByView);
        }

        /// <summary>
        /// Returns true if HeadlinesRequestByView instances are equal
        /// </summary>
        /// <param name="input">Instance of HeadlinesRequestByView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HeadlinesRequestByView input)
        {
            if (input == null)
            {
                return false;
