...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedFiltersCategoriesObject" /> class.
        /// </summary>
        /// <param name="name">The name of the category..</param>
        /// <param name="value">An array containing a single value associated with the category. .</param>
        public FlattenedFiltersCategoriesObject(string name = default(string), List<string> value = default(List<string>))
        {
            this.Name = name;
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>An array containing a single value associated with the category. </value>
        ...
        {
            return this.Equals(input as FlattenedFiltersCategoriesObject);
        }

        /// <summary>
        /// Returns true if FlattenedFiltersCategoriesObject instances are equal
        /// </summary>
        /// <param name="input">Instance of FlattenedFiltersCategoriesObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlattenedFiltersCategoriesObject input)
        {
            if (input == null)
            {
                return false;
