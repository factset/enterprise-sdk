...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrEditViewBody")]
    public partial class CreateOrEditViewBody : IEquatable<CreateOrEditViewBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateOrEditViewBody);
        }

        /// <summary>
        /// Returns true if CreateOrEditViewBody instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrEditViewBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrEditViewBody input)
        {
            if (input == null)
            {
                return false;
