...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    public partial class StructuredFiltersRegionsObject : IEquatable<StructuredFiltersRegionsObject>, IValidatableObject
    {
        ...
        public StructuredFiltersRegionsObject(string name = default(string), List<string> value = default(List<string>), List<StructuredFiltersChildrenObjectRegions> children = default(List<StructuredFiltersChildrenObjectRegions>))
        {
            this.Name = name;
            this.Value = value;
        ...
        public List<StructuredFiltersChildrenObjectRegions> Children { get; set; }
