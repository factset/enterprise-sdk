...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QuickAlertsBody")]
    public partial class QuickAlertsBody : IEquatable<QuickAlertsBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as QuickAlertsBody);
        }

        /// <summary>
        /// Returns true if QuickAlertsBody instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickAlertsBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickAlertsBody input)
        {
            if (input == null)
            {
                return false;
