...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QuickAlertsResponse_data")]
    public partial class QuickAlertsResponseData : IEquatable<QuickAlertsResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickAlertsResponseData" /> class.
        /// </summary>
        /// <param name="name">The name of the view associated with quick alerts..</param>
        public QuickAlertsResponseData(string name = default(string))
        {
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuickAlertsResponseData {\n");
        ...
        {
            return this.Equals(input as QuickAlertsResponseData);
        }

        /// <summary>
        /// Returns true if QuickAlertsResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickAlertsResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickAlertsResponseData input)
        {
            if (input == null)
            {
                return false;
