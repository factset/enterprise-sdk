...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createFilesRequest")]
    public partial class CreateFilesRequest : IEquatable<CreateFilesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFilesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateFilesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFilesRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public CreateFilesRequest(CreateFilesRequestObject data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for CreateFilesRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public CreateFilesRequestObject Data { get; set; }
