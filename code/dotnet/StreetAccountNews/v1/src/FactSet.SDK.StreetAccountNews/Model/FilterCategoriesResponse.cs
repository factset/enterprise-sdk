...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FilterCategoriesResponse")]
    public partial class FilterCategoriesResponse : IEquatable<FilterCategoriesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterCategoriesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FilterCategoriesResponse(FilterCategoriesResponseData data = default(FilterCategoriesResponseData))
        {
            this.Data = data;
        }
        ...
        public FilterCategoriesResponseData Data { get; set; }
        ...
        {
            return this.Equals(input as FilterCategoriesResponse);
        }

        /// <summary>
        /// Returns true if FilterCategoriesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterCategoriesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterCategoriesResponse input)
        {
            if (input == null)
            {
                return false;
