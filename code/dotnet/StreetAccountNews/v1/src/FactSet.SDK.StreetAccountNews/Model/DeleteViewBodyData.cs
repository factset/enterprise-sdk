...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// DeleteViewBodyData
    /// </summary>
    [DataContract(Name = "DeleteViewBody_data")]
    public partial class DeleteViewBodyData : IEquatable<DeleteViewBodyData>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeleteViewBodyData);
        }

        /// <summary>
        /// Returns true if DeleteViewBodyData instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteViewBodyData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteViewBodyData input)
        {
            if (input == null)
            {
                return false;
