...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateViewResponse")]
    public partial class CreateViewResponse : IEquatable<CreateViewResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateViewResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CreateViewResponse(CreateViewResponseData data = default(CreateViewResponseData))
        {
            this.Data = data;
        }
        ...
        public CreateViewResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateViewResponse {\n");
        ...
        {
            return this.Equals(input as CreateViewResponse);
        }

        /// <summary>
        /// Returns true if CreateViewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateViewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateViewResponse input)
        {
            if (input == null)
            {
                return false;
