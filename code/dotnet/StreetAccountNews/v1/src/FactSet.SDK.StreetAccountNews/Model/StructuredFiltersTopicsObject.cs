...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    public partial class StructuredFiltersTopicsObject : IEquatable<StructuredFiltersTopicsObject>, IValidatableObject
    {
        ...
        public StructuredFiltersTopicsObject(string name = default(string), List<string> value = default(List<string>), List<StructuredFiltersChildrenObjectTopics> children = default(List<StructuredFiltersChildrenObjectTopics>))
        {
            this.Name = name;
            this.Value = value;
        ...
        public List<StructuredFiltersChildrenObjectTopics> Children { get; set; }
