...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    public partial class StructuredFiltersTopicsObject : IEquatable<StructuredFiltersTopicsObject>, IValidatableObject
    {
        ...
        public StructuredFiltersTopicsObject(string name,List<string> value = default(List<string>), List<StructuredFiltersChildrenObjectTopics> children = default(List<StructuredFiltersChildrenObjectTopics>))
        {
