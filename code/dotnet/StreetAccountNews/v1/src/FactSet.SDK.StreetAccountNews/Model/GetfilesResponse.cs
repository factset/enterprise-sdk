...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// GetfilesResponse
    /// </summary>
    [DataContract(Name = "getfilesResponse")]
    public partial class GetfilesResponse : IEquatable<GetfilesResponse>, IValidatableObject
    {
        ...
        public GetfilesResponse(List<Getfiles> data = default(List<Getfiles>), MetaOne meta = default(MetaOne))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<Getfiles> Data { get; set; }
