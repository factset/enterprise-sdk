...
[![Nuget](https://img.shields.io/badge/nuget-v1.3.0-orange)](https://www.nuget.org/packages/FactSet.SDK.StreetAccountNews/1.3.0)
...
dotnet add package FactSet.SDK.StreetAccountNews -v 1.3.0
```
...
nuget install FactSet.SDK.StreetAccountNews -Version 1.3.0
```
