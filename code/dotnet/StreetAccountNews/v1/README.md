...
[![Nuget](https://img.shields.io/badge/nuget-v1.2.1-orange)](https://www.nuget.org/packages/FactSet.SDK.StreetAccountNews/1.2.1)
...
dotnet add package FactSet.SDK.StreetAccountNews -v 1.2.1
```
...
nuget install FactSet.SDK.StreetAccountNews -Version 1.2.1
```
