...
[![Nuget](https://img.shields.io/badge/nuget-v1.5.0-orange)](https://www.nuget.org/packages/FactSet.SDK.StreetAccountNews/1.5.0)
...
dotnet add package FactSet.SDK.StreetAccountNews -v 1.5.0
```
...
nuget install FactSet.SDK.StreetAccountNews -Version 1.5.0
```
...
*SABurstsApi* | [**GetLatestBurstFile**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/StreetAccountNews/v1/docs/SABurstsApi.md#getlatestburstfile) | **GET** /sa-bursts/latest-file | Retrieve the latest burst file metadata and download URL
...
## Documentation for Models
 ...
 - [Model.BurstFileResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/StreetAccountNews/v1/docs/BurstFileResponse.md)
 - [Model.BurstFileResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/StreetAccountNews/v1/docs/BurstFileResponseData.md)
 ...
 - [Model.QuickAlertsResponseData](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/StreetAccountNews/v1/docs/QuickAlertsResponseData.md)
