...
namespace FactSet.SDK.StreetAccountNews.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/StreetAccountNews/0.20.3";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/research/news/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.StreetAccountNews) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.1.0\n";
            report += "    SDK Package Version: 0.20.3\n";
