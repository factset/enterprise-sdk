...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "saHeadlinesRequest_meta_pagination")]
    public partial class SaHeadlinesRequestMetaPagination : IEquatable<SaHeadlinesRequestMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaHeadlinesRequestMetaPagination" /> class.
        /// </summary>
        ...
        public SaHeadlinesRequestMetaPagination(int limit = 500, int offset = 0)
        {
            this.Limit = limit;
            this.Offset = offset;
        }
        ...
        {
            return this.Equals(input as SaHeadlinesRequestMetaPagination);
        }

        /// <summary>
        /// Returns true if SaHeadlinesRequestMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of SaHeadlinesRequestMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaHeadlinesRequestMetaPagination input)
        {
            if (input == null)
            {
                return false;
