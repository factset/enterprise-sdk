...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    public partial class CreateOrEditViewBodyData : IEquatable<CreateOrEditViewBodyData>, IValidatableObject
    {
        ...
        /// <param name="quickAlert">quickAlert.</param>
        public CreateOrEditViewBodyData(List<CreateOrEditViewTickers> tickers = default(List<CreateOrEditViewTickers>), List<string> categories = default(List<string>), List<string> regions = default(List<string>), List<string> topics = default(List<string>), List<string> sectors = default(List<string>), bool isPrimary = default(bool), bool quickAlert = default(bool))
        {
