...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    /// </summary>
    [DataContract(Name = "saHeadlinesRequestByView")]
    public partial class SaHeadlinesRequestByView : IEquatable<SaHeadlinesRequestByView>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaHeadlinesRequestByView" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public SaHeadlinesRequestByView(SaHeadlinesRequestByViewData data = default(SaHeadlinesRequestByViewData), SaHeadlinesRequestMeta meta = default(SaHeadlinesRequestMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public SaHeadlinesRequestByViewData Data { get; set; }
        ...
        {
            return this.Equals(input as SaHeadlinesRequestByView);
        }

        /// <summary>
        /// Returns true if SaHeadlinesRequestByView instances are equal
        /// </summary>
        /// <param name="input">Instance of SaHeadlinesRequestByView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaHeadlinesRequestByView input)
        {
            if (input == null)
            {
                return false;
