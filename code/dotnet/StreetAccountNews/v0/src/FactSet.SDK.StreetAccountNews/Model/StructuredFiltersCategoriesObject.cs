...
namespace FactSet.SDK.StreetAccountNews.Model
{
    ...
    public partial class StructuredFiltersCategoriesObject : IEquatable<StructuredFiltersCategoriesObject>, IValidatableObject
    {
        ...
        public StructuredFiltersCategoriesObject(string name = default(string), List<string> value = default(List<string>), List<StructuredFiltersChildrenObject> children = default(List<StructuredFiltersChildrenObject>))
        {
            this.Name = name;
            this.Value = value;
