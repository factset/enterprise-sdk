...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.10-orange)](https://www.nuget.org/packages/FactSet.SDK.Classifications/1.0.10)
...
dotnet add package FactSet.SDK.Classifications -v 1.0.10
```
...
nuget install FactSet.SDK.Classifications -Version 1.0.10
```
...
------------ | ------------- | ------------- | -------------
*GICSApi* | [**GetGics**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/GICSApi.md#getgics) | **GET** /classifications/v1/gics | Gets the GICS Direct Classifications
*GICSApi* | [**PostGics**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/GICSApi.md#postgics) | **POST** /classifications/v1/gics | Returns the GICS classifications for the requested 'ids' and date range.


## Documentation for Models

 - [Model.Calendar](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/Calendar.md)
 - [Model.ErrorResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/ErrorResponse.md)
 - [Model.ErrorResponseSubErrors](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/ErrorResponseSubErrors.md)
 - [Model.Frequency](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/Frequency.md)
 - [Model.Gics](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/Gics.md)
 - [Model.GicsRequest](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/GicsRequest.md)
 - [Model.GicsResponse](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Classifications/v1/docs/GicsResponse.md)
