...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.11-orange)](https://www.nuget.org/packages/FactSet.SDK.Classifications/1.0.11)
...
dotnet add package FactSet.SDK.Classifications -v 1.0.11
```
...
nuget install FactSet.SDK.Classifications -Version 1.0.11
```
