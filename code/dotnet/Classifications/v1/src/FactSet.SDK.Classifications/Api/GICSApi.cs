...
namespace FactSet.SDK.Classifications.Api
{
    ...
    public interface IGICSApiSync : IApiAccessor
    {
        ...
        /// <param name="ids">The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids. &lt;p&gt;***ids limit** &#x3D;  3000 per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;* </param>
    ...
    public partial class GICSApi : IGICSApi
    {
        ...
        /// <summary>
        /// Gets the GICS Direct Classifications Gets the The **Global Industry Classification Standard (\&quot;GICS\&quot;)** Sectors, Industry Group, Industry, and Sub-Industry Names and Numbers for a requested list of ids and date range. All economic sectors have a two-digit identification code, all industry groups have a four-digit identification code, all industries have a six-digit identification code, and all sub-industries have an eight-digit identification code. To access the complete GICS structure and definitions, visit the [MSCI GICS](https://www.msci.com/gics) or [S&amp;P GICS](http://us.spindices.com/resource-center/index-policies/) home pages. Coverage includes over 37,000 securities. *Licensing for GICS Classifications, Regions, and History is required in addition to FactSet API license. Reach out to your FactSet Account Team for assistance.* 
        /// </summary>
        /// <exception cref="FactSet.SDK.Classifications.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">The requested list of security identifiers. Accepted ID types include Market Tickers, SEDOL, ISINs, CUSIPs, or FactSet Permanent Ids. &lt;p&gt;***ids limit** &#x3D;  3000 per request*&lt;/p&gt; *&lt;p&gt;Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB, its advised for any requests with large request lines to be requested through the respective \&quot;POST\&quot; method.&lt;/p&gt;* </param>
        /// <param name="startDate">Requested start date expressed in YYYY-MM-DD format. (optional)</param>
        ...
        {
            FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse> localVarResponse = GetGicsWithHttpInfo(ids, startDate, endDate, frequency, calendar);
        ...
        /// <param name="calendar">Calendar of data returned. SEVENDAY includes weekends. (optional, default to FIVEDAY)</param>
        /// <returns>ApiResponse of GicsResponse</returns>
        public FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse> GetGicsWithHttpInfo(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string))
        {
            ...
            var localVarResponse = this.Client.Get<GicsResponse>("/classifications/v1/gics", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse> localVarResponse = await GetGicsWithHttpInfoAsync(ids, startDate, endDate, frequency, calendar, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GicsResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse>> GetGicsWithHttpInfoAsync(List<string> ids, string startDate = default(string), string endDate = default(string), string frequency = default(string), string calendar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new FactSet.SDK.Classifications.Client.ApiException(400, "Missing required parameter 'ids' when calling GICSApi->GetGics");
        ...
        /// <summary>
        /// Returns the GICS classifications for the requested &#39;ids&#39; and date range. Gets the The **Global Industry Classification Standard (\&quot;GICS\&quot;)** Sectors, Industry Group, Industry, and Sub-Industry Names and Numbers for a requested list of ids and date range. All economic sectors have a two-digit identification code, all industry groups have a four-digit identification code, all industries have a six-digit identification code, and all sub-industries have an eight-digit identification code. To access the complete GICS structure and definitions, visit the [MSCI GICS](https://www.msci.com/gics) or [S&amp;P GICS](http://us.spindices.com/resource-center/index-policies/) home pages. Coverage includes over 37,000 secutries. *Licencing for GICS Classifications, Regions, and History is required in addition to FactSet API license. Reach out to your FactSet Account Team for assistance.* 
        /// </summary>
        /// <exception cref="FactSet.SDK.Classifications.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gicsRequest">Requests GICS Classifications for the given identifier and date range.</param>
        /// <returns>GicsResponse</returns>
        ...
        {
            FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse> localVarResponse = PostGicsWithHttpInfo(gicsRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="gicsRequest">Requests GICS Classifications for the given identifier and date range.</param>
        /// <returns>ApiResponse of GicsResponse</returns>
        public FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse> PostGicsWithHttpInfo(GicsRequest gicsRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<GicsResponse>("/classifications/v1/gics", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse> localVarResponse = await PostGicsWithHttpInfoAsync(gicsRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GicsResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Classifications.Client.ApiResponse<GicsResponse>> PostGicsWithHttpInfoAsync(GicsRequest gicsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'gicsRequest' is set
            if (gicsRequest == null)
                throw new FactSet.SDK.Classifications.Client.ApiException(400, "Missing required parameter 'gicsRequest' when calling GICSApi->PostGics");
