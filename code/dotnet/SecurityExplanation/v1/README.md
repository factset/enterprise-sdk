...
[![Nuget](https://img.shields.io/badge/nuget-v2.1.1-orange)](https://www.nuget.org/packages/FactSet.SDK.SecurityExplanation/2.1.1)
...
dotnet add package FactSet.SDK.SecurityExplanation -v 2.1.1
```
...
nuget install FactSet.SDK.SecurityExplanation -Version 2.1.1
```
