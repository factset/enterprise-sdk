...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.SecurityExplanation/1.0.0)
...
dotnet add package FactSet.SDK.SecurityExplanation -v 1.0.0
```
...
nuget install FactSet.SDK.SecurityExplanation -Version 1.0.0
```
