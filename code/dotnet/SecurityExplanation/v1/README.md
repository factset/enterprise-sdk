...
[![Nuget](https://img.shields.io/badge/nuget-v2.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.SecurityExplanation/2.2.0)
...
dotnet add package FactSet.SDK.SecurityExplanation -v 2.2.0
```
...
nuget install FactSet.SDK.SecurityExplanation -Version 2.2.0
```
