...
namespace FactSet.SDK.SecurityExplanation.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/SecurityExplanation/2.2.0";
            BasePath = "https://api.factset.com/analytics/security-explanation/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/security-explanation/v1") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.SecurityExplanation) Debug Report:\n";
