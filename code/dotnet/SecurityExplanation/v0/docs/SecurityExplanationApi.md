...
namespace Example
{
    public class FetchExplanationResultsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get explanation results by id
                SecurityExplanationApi.FetchExplanationResultsResponseWrapper result = apiInstance.FetchExplanationResults(id);
...
namespace Example
{
    public class GetExplanationExample
    {
        public static async Task Main()
        {
            ...
            var endDate = DateTime.Parse("2024-10-15");  // DateTime | 
            var enableLinks = true;  // bool? |  (optional)  (default to true)
            var explanationStyle = "short";  // string |  (optional)  (default to short)
            ...
            {
                Console.WriteLine("Exception when calling SecurityExplanationApi.GetExplanation: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
 ...
 **startDate** | **DateTime**|  | 
 **endDate** | **DateTime**|  | 
 **enableLinks** | **bool?**|  | [optional] [default to true]
