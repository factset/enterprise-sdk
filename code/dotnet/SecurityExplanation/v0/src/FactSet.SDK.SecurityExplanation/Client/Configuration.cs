...
namespace FactSet.SDK.SecurityExplanation.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/SecurityExplanation/0.10.0";
            BasePath = "https://api.factset.com/analytics/security-explanation/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/security-explanation/v0") : this()
        {
