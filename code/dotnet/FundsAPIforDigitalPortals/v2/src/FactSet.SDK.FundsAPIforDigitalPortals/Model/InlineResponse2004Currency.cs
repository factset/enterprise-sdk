...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_currency")]
    public partial class InlineResponse2004Currency : IEquatable<InlineResponse2004Currency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004Currency" /> class.
        /// </summary>
        ...
        public InlineResponse2004Currency(decimal id = default(decimal), string code = default(string))
        {
            this.Id = id;
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as InlineResponse2004Currency);
        }

        /// <summary>
        /// Returns true if InlineResponse2004Currency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004Currency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004Currency input)
        {
            if (input == null)
            {
                return false;
