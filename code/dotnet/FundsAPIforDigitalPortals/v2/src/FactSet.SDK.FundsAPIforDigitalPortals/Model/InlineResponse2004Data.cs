...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2004Data : IEquatable<InlineResponse2004Data>, IValidatableObject
    {
        ...
        public InlineResponse2004Data(string id = default(string), InlineResponse2004Currency currency = default(InlineResponse2004Currency), InlineResponse2004Market market = default(InlineResponse2004Market), string symbol = default(string), InlineResponse2004Nsin nsin = default(InlineResponse2004Nsin), InlineResponse2004Fsym fsym = default(InlineResponse2004Fsym), InlineResponse2004Instrument instrument = default(InlineResponse2004Instrument), InlineResponse2004Fund fund = default(InlineResponse2004Fund), InlineResponse2004ShareClass shareClass = default(InlineResponse2004ShareClass), InlineResponse2004Performance performance = default(InlineResponse2004Performance))
        {
            this.Id = id;
        ...
        public InlineResponse2004Currency Currency { get; set; }
        ...
        public InlineResponse2004Fund Fund { get; set; }

        /// <summary>
        /// Gets or Sets ShareClass
        /// </summary>
        [DataMember(Name = "shareClass", EmitDefaultValue = false)]
        public InlineResponse2004ShareClass ShareClass { get; set; }
