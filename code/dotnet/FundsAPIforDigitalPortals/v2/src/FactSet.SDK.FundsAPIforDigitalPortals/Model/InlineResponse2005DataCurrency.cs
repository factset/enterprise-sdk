...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_currency")]
    public partial class InlineResponse2005DataCurrency : IEquatable<InlineResponse2005DataCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataCurrency" /> class.
        /// </summary>
        ...
        public InlineResponse2005DataCurrency(decimal id = default(decimal), string code = default(string), decimal count = default(decimal))
        {
            this.Id = id;
            this.Code = code;
            this.Count = count;
        ...
        {
            return this.Equals(input as InlineResponse2005DataCurrency);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataCurrency input)
        {
            if (input == null)
            {
                return false;
