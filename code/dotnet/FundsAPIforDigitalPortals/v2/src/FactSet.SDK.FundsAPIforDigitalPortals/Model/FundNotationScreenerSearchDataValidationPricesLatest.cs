...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_fund_notation_screener_search_data_validation_prices_latest")]
    public partial class FundNotationScreenerSearchDataValidationPricesLatest : IEquatable<FundNotationScreenerSearchDataValidationPricesLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundNotationScreenerSearchDataValidationPricesLatest" /> class.
        /// </summary>
        ...
        public FundNotationScreenerSearchDataValidationPricesLatest(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as FundNotationScreenerSearchDataValidationPricesLatest);
        }

        /// <summary>
        /// Returns true if FundNotationScreenerSearchDataValidationPricesLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of FundNotationScreenerSearchDataValidationPricesLatest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundNotationScreenerSearchDataValidationPricesLatest input)
        {
            if (input == null)
            {
                return false;
