...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_instrument_fsym_security")]
    public partial class InlineResponse2004InstrumentFsymSecurity : IEquatable<InlineResponse2004InstrumentFsymSecurity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004InstrumentFsymSecurity" /> class.
        /// </summary>
        ...
        public InlineResponse2004InstrumentFsymSecurity(string permanentIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse2004InstrumentFsymSecurity);
        }

        /// <summary>
        /// Returns true if InlineResponse2004InstrumentFsymSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004InstrumentFsymSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004InstrumentFsymSecurity input)
        {
            if (input == null)
            {
                return false;
