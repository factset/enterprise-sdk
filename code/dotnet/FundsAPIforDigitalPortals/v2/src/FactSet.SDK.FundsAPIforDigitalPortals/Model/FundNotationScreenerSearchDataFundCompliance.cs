...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_fund_notation_screener_search_data_fund_compliance")]
    public partial class FundNotationScreenerSearchDataFundCompliance : IEquatable<FundNotationScreenerSearchDataFundCompliance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundNotationScreenerSearchDataFundCompliance" /> class.
        /// </summary>
        ...
        public FundNotationScreenerSearchDataFundCompliance(List<FundNotationScreenerSearchDataFundComplianceOr> or = default(List<FundNotationScreenerSearchDataFundComplianceOr>))
        {
            this.Or = or;
        }
        ...
        {
            return this.Equals(input as FundNotationScreenerSearchDataFundCompliance);
        }

        /// <summary>
        /// Returns true if FundNotationScreenerSearchDataFundCompliance instances are equal
        /// </summary>
        /// <param name="input">Instance of FundNotationScreenerSearchDataFundCompliance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundNotationScreenerSearchDataFundCompliance input)
        {
            if (input == null)
            {
                return false;
