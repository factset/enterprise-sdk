...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_shareClass_fee")]
    public partial class InlineResponse2004ShareClassFee : IEquatable<InlineResponse2004ShareClassFee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004ShareClassFee" /> class.
        /// </summary>
        ...
        public InlineResponse2004ShareClassFee(InlineResponse2004ShareClassFeeOngoing ongoing = default(InlineResponse2004ShareClassFeeOngoing), InlineResponse2004ShareClassFeeAllIn allIn = default(InlineResponse2004ShareClassFeeAllIn), InlineResponse2004ShareClassFeePerformance performance = default(InlineResponse2004ShareClassFeePerformance), InlineResponse2004ShareClassFeeManagement management = default(InlineResponse2004ShareClassFeeManagement), InlineResponse2004ShareClassFeeInitial initial = default(InlineResponse2004ShareClassFeeInitial), InlineResponse2004ShareClassFeeDistribution distribution = default(InlineResponse2004ShareClassFeeDistribution), InlineResponse2004ShareClassFeeAdministration administration = default(InlineResponse2004ShareClassFeeAdministration), InlineResponse2004ShareClassFeeHandling handling = default(InlineResponse2004ShareClassFeeHandling), InlineResponse2004ShareClassFeeRedemption redemption = default(InlineResponse2004ShareClassFeeRedemption), InlineResponse2004ShareClassFeeCustodianBank custodianBank = default(InlineResponse2004ShareClassFeeCustodianBank), InlineResponse2004ShareClassFee12b _12b = default(InlineResponse2004ShareClassFee12b), InlineResponse2004ShareClassFeeSwitching switching = default(InlineResponse2004ShareClassFeeSwitching))
        {
        ...
        public InlineResponse2004ShareClassFeeOngoing Ongoing { get; set; }

        /// <summary>
        /// Gets or Sets AllIn
        /// </summary>
        [DataMember(Name = "allIn", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeAllIn AllIn { get; set; }

        /// <summary>
        /// Gets or Sets Performance
        /// </summary>
        [DataMember(Name = "performance", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeePerformance Performance { get; set; }

        /// <summary>
        /// Gets or Sets Management
        /// </summary>
        [DataMember(Name = "management", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeManagement Management { get; set; }

        /// <summary>
        /// Gets or Sets Initial
        /// </summary>
        [DataMember(Name = "initial", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeInitial Initial { get; set; }

        /// <summary>
        /// Gets or Sets Distribution
        /// </summary>
        [DataMember(Name = "distribution", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeDistribution Distribution { get; set; }

        /// <summary>
        /// Gets or Sets Administration
        /// </summary>
        [DataMember(Name = "administration", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeAdministration Administration { get; set; }

        /// <summary>
        /// Gets or Sets Handling
        /// </summary>
        [DataMember(Name = "handling", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeHandling Handling { get; set; }

        /// <summary>
        /// Gets or Sets Redemption
        /// </summary>
        [DataMember(Name = "redemption", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeRedemption Redemption { get; set; }

        /// <summary>
        /// Gets or Sets CustodianBank
        /// </summary>
        [DataMember(Name = "custodianBank", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeCustodianBank CustodianBank { get; set; }

        /// <summary>
        /// Gets or Sets _12b
        /// </summary>
        [DataMember(Name = "12b", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFee12b _12b { get; set; }

        /// <summary>
        /// Gets or Sets Switching
        /// </summary>
        [DataMember(Name = "switching", EmitDefaultValue = false)]
        public InlineResponse2004ShareClassFeeSwitching Switching { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2004ShareClassFee);
        }

        /// <summary>
        /// Returns true if InlineResponse2004ShareClassFee instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004ShareClassFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004ShareClassFee input)
        {
            if (input == null)
            {
                return false;
