...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_fund_notation_screener_valueRanges_get_data_performance_endOfDay")]
    public partial class FundNotationScreenerValueRangesGetDataPerformanceEndOfDay : IEquatable<FundNotationScreenerValueRangesGetDataPerformanceEndOfDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundNotationScreenerValueRangesGetDataPerformanceEndOfDay" /> class.
        /// </summary>
        ...
        public FundNotationScreenerValueRangesGetDataPerformanceEndOfDayWeek1 Week1 { get; set; }
        ...
        {
            return this.Equals(input as FundNotationScreenerValueRangesGetDataPerformanceEndOfDay);
        }

        /// <summary>
        /// Returns true if FundNotationScreenerValueRangesGetDataPerformanceEndOfDay instances are equal
        /// </summary>
        /// <param name="input">Instance of FundNotationScreenerValueRangesGetDataPerformanceEndOfDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundNotationScreenerValueRangesGetDataPerformanceEndOfDay input)
        {
            if (input == null)
            {
                return false;
