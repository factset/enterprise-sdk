...
namespace FactSet.SDK.FundsAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2001Data : IEquatable<InlineResponse2001Data>, IValidatableObject
    {
        ...
        /// <param name="count">Number of funds issued..</param>
        public InlineResponse2001Data(decimal id = default(decimal), string name = default(string), decimal count = default(decimal))
        {
            this.Id = id;
            this.Name = name;
            this.Count = count;
        ...
        /// </summary>
        /// <value>Number of funds issued.</value>
