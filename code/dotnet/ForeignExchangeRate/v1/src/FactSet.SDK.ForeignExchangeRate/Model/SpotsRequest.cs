...
namespace FactSet.SDK.ForeignExchangeRate.Model
{
    ...
    /// Spots Request Body
    /// </summary>
    [DataContract(Name = "spotsRequest")]
    public partial class SpotsRequest : IEquatable<SpotsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpotsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SpotsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SpotsRequest" /> class.
        /// </summary>
        ...
        public SpotsRequest(List<string> ids = default(List<string>), string startDate = default(string), string endDate = default(string), Frequency frequency = default(Frequency))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for SpotsRequest and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as SpotsRequest);
        }

        /// <summary>
        /// Returns true if SpotsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SpotsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpotsRequest input)
        {
            if (input == null)
                return false;
