...
namespace FactSet.SDK.FactSetETF.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EtfReferenceDataResponse")]
    public partial class EtfReferenceDataResponse : IEquatable<EtfReferenceDataResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EtfReferenceDataResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EtfReferenceDataResponse(List<EtfReferenceData> data = default(List<EtfReferenceData>))
        {
            this.Data = data;
        }
        ...
        public List<EtfReferenceData> Data { get; set; }
        ...
        {
            return this.Equals(input as EtfReferenceDataResponse);
        }

        /// <summary>
        /// Returns true if EtfReferenceDataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EtfReferenceDataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EtfReferenceDataResponse input)
        {
            if (input == null)
            {
                return false;
