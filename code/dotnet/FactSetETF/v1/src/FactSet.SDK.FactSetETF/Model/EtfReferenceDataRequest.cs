...
namespace FactSet.SDK.FactSetETF.Model
{
    ...
    public partial class EtfReferenceDataRequest : IEquatable<EtfReferenceDataRequest>, IValidatableObject
    {
        ...
        public EtfReferenceDataRequest(List<string> ids = default(List<string>), List<string> metrics = default(List<string>), List<Category> categories = default(List<Category>))
        {
