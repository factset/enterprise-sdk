# FactSet.SDK.FactSetEstimatesReportBuilder.Api.EstimateTablesApi
...
<a name="getestimatetablestable"></a>
# **GetEstimateTablesTable**
> Response GetEstimateTablesTable (string id, string metric = null)
...
namespace Example
{
    public class GetEstimateTablesTableExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling EstimateTablesApi.GetEstimateTablesTable: " + e.Message );
