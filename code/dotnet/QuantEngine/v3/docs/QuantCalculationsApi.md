# FactSet.SDK.QuantEngine.Api.QuantCalculationsApi
...
namespace Example
{
    public class GetAllCalculationsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.GetAllCalculations: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCalculationParametersExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.GetCalculationParameters: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCalculationStatusByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.GetCalculationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCalculationUnitInfoByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.GetCalculationUnitInfoById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCalculationUnitResultByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.GetCalculationUnitResultById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndCalculateExample
    {
        public static async Task Main()
        {
            ...
            {
                // Create and Run Quant Engine calculation
                QuantCalculationsApi.PostAndCalculateResponseWrapper result = apiInstance.PostAndCalculate(cacheControl, quantCalculationParametersRoot);
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.PostAndCalculate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndCalculateExample
    {
        public static async Task Main()
        {
            ...
            {
                // Create or update Quant Engine calculation and run it.
                QuantCalculationsApi.PutAndCalculateResponseWrapper result = apiInstance.PutAndCalculate(id, cacheControl, quantCalculationParametersRoot);
            ...
            {
                Console.WriteLine("Exception when calling QuantCalculationsApi.PutAndCalculate: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
