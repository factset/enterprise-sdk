...
namespace FactSet.SDK.QuantEngine.Model
{
    ...
    public partial class QuantScreeningExpressionObsolete : IEquatable<QuantScreeningExpressionObsolete>, IValidatableObject
    {
        ...
        public QuantScreeningExpressionObsolete(string expr, string name,string dateOffset = default(string))
        {
            // to ensure "expr" is required (not null)
            if (expr == null) {
                throw new ArgumentNullException("expr is a required property for QuantScreeningExpressionObsolete and cannot be null");
            }
            this.Expr = expr;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for QuantScreeningExpressionObsolete and cannot be null");
            }
            this.Name = name;
