...
namespace FactSet.SDK.QuantEngine.Model
{
    ...
    public partial class QuantScreeningExpressionUniverseObsolete : IEquatable<QuantScreeningExpressionUniverseObsolete>, IValidatableObject
    {
        ...
        public QuantScreeningExpressionUniverseObsolete(string universeExpr, UniverseTypeEnum universeType,string securityExpr = default(string), SourceEnum? source = default(SourceEnum?))
        {
            // to ensure "universeExpr" is required (not null)
            if (universeExpr == null) {
                throw new ArgumentNullException("universeExpr is a required property for QuantScreeningExpressionUniverseObsolete and cannot be null");
            }
