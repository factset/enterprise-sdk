...
namespace FactSet.SDK.QuantEngine.Model
{
    ...
    public partial class QuantFqlExpression : IEquatable<QuantFqlExpression>, IValidatableObject
    {
        ...
        public QuantFqlExpression(string expr, string name, SourceEnum source,string dateOffset = default(string), bool? isArrayReturnType = default(bool?))
        {
        ...
        /// </summary>
        [DataMember(Name = "isArrayReturnType", EmitDefaultValue = true)]
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsArrayReturnType != null)
                {
