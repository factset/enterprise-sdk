...
namespace FactSet.SDK.QuantEngine.Api
{
    ...
    public partial class QuantCalculationsApi : IQuantCalculationsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> PostAndCalculateResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            ...
            { (HttpStatusCode)400, typeof(ClientErrorResponse) },
            { (HttpStatusCode)404, typeof(ClientErrorResponse) },
            { (HttpStatusCode)413, typeof(ClientErrorResponse) },
        };
        ...
        public ApiResponse<QuantCalculationParametersRoot> GetCalculationParametersWithHttpInfo(string id)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            QuantCalculationParametersRoot>("/calculations/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<QuantCalculationParametersRoot>> GetCalculationParametersWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<QuantCalculationParametersRoot>("/calculations/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<System.IO.Stream> GetCalculationUnitInfoByIdWithHttpInfo(string id, string unitId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            System.IO.Stream>("/calculations/{id}/units/{unitId}/info", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetCalculationUnitInfoByIdWithHttpInfoAsync(string id, string unitId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream>("/calculations/{id}/units/{unitId}/info", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<System.IO.Stream> GetCalculationUnitResultByIdWithHttpInfo(string id, string unitId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            System.IO.Stream>("/calculations/{id}/units/{unitId}/result", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetCalculationUnitResultByIdWithHttpInfoAsync(string id, string unitId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream>("/calculations/{id}/units/{unitId}/result", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
