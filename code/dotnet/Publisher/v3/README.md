...
[![Nuget](https://img.shields.io/badge/nuget-v0.21.10-orange)](https://www.nuget.org/packages/FactSet.SDK.Publisher/0.21.10)
...
dotnet add package FactSet.SDK.Publisher -v 0.21.10
```
...
nuget install FactSet.SDK.Publisher -Version 0.21.10
```
...
## Documentation for Models
 ...
 - [Model.ObjectRoot](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/Publisher/v3/docs/ObjectRoot.md)
