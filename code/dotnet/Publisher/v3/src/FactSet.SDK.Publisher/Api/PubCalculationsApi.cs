...
namespace FactSet.SDK.Publisher.Api
{
    ...
    public partial class PubCalculationsApi : IPubCalculationsApi
    {
        ...
        {
            var localVarResponse = GetCalculationUnitResultByIdWithHttpInfo(id, unitId, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="accept">Standard HTTP header. Value can be gzip, compress, deflate, br, identity and/or * (optional)</param>
        /// <returns>ApiResponse of ObjectRoot</returns>
        public ApiResponse<ObjectRoot> GetCalculationUnitResultByIdWithHttpInfo(string id, string unitId, string accept = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            ObjectRoot>("/analytics/engines/pub/v3/calculations/{id}/units/{unitId}/result", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            var localVarResponse = await GetCalculationUnitResultByIdWithHttpInfoAsync(id, unitId, accept, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ObjectRoot>> GetCalculationUnitResultByIdWithHttpInfoAsync(string id, string unitId, string accept = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
