...
namespace FactSet.SDK.Publisher.Api
{
    ...
    public partial class CalculationsApi : ICalculationsApi
    {
        ...
        public FactSet.SDK.Publisher.Client.ApiResponse<Object> CancelCalculationByIdWithHttpInfo(string id)
        {
            ...
            var localVarResponse = this.Client.Delete<Object>("/analytics/engines/v2/calculations/{id}", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.Publisher.Client.ApiResponse<CalculationStatus> localVarResponse = GetCalculationStatusByIdWithHttpInfo(id);
        ...
        /// <param name="id">From url, provided from the location header in the Run Multiple Calculations endpoint.</param>
        /// <returns>ApiResponse of CalculationStatus</returns>
        public FactSet.SDK.Publisher.Client.ApiResponse<CalculationStatus> GetCalculationStatusByIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        {
            FactSet.SDK.Publisher.Client.ApiResponse<CalculationStatus> localVarResponse = await GetCalculationStatusByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CalculationStatus)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Publisher.Client.ApiResponse<CalculationStatus>> GetCalculationStatusByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.SDK.Publisher.Client.ApiException(400, "Missing required parameter 'id' when calling CalculationsApi->GetCalculationStatusById");
        ...
        {
            FactSet.SDK.Publisher.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>> localVarResponse = GetCalculationStatusSummariesWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="FactSet.SDK.Publisher.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Dictionary&lt;string, CalculationStatusSummary&gt;</returns>
        public FactSet.SDK.Publisher.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>> GetCalculationStatusSummariesWithHttpInfo()
        {
            FactSet.SDK.Publisher.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.Publisher.Client.RequestOptions();
        ...
        {
            FactSet.SDK.Publisher.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>> localVarResponse = await GetCalculationStatusSummariesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, CalculationStatusSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Publisher.Client.ApiResponse<Dictionary<string, CalculationStatusSummary>>> GetCalculationStatusSummariesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="calculation"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public FactSet.SDK.Publisher.Client.ApiResponse<Object> RunCalculationWithHttpInfo(Calculation calculation = default(Calculation))
        {
            FactSet.SDK.Publisher.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.Publisher.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/analytics/engines/v2/calculations", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.Publisher.Client.ApiResponse<Object>> RunCalculationWithHttpInfoAsync(Calculation calculation = default(Calculation), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
