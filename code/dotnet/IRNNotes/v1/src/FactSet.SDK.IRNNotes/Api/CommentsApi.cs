...
namespace FactSet.SDK.IRNNotes.Api
{
    ...
    public partial class CommentsApi : ICommentsApi
    {
        ...
        public ApiResponse<NewItemDto> CreateCommentWithHttpInfo(Guid noteId, CreateCommentDto createCommentDto = default(CreateCommentDto))
        {
            ...
            NewItemDto>("/notes/{noteId}/comments", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<NewItemDto>> CreateCommentWithHttpInfoAsync(Guid noteId, CreateCommentDto createCommentDto = default(CreateCommentDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NewItemDto>("/notes/{noteId}/comments", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<NewItemDto> CreateCommentAttachmentWithHttpInfo(Guid noteId, Guid commentId, System.IO.Stream file)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<
            NewItemDto>("/notes/{noteId}/comments/{commentId}/attachments", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<NewItemDto>> CreateCommentAttachmentWithHttpInfoAsync(Guid noteId, Guid commentId, System.IO.Stream file, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NewItemDto>("/notes/{noteId}/comments/{commentId}/attachments", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<Object> DeleteCommentWithHttpInfo(Guid noteId, Guid commentId)
        {
            ...
            Object>("/notes/{noteId}/comments/{commentId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteCommentWithHttpInfoAsync(Guid noteId, Guid commentId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/notes/{noteId}/comments/{commentId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<Object> DownloadCommentAttachmentForCommentWithHttpInfo(Guid noteId, Guid commentId, Guid attachmentId)
        {
            ...
            Object>("/notes/{noteId}/comments/{commentId}/attachments/{attachmentId}/download", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DownloadCommentAttachmentForCommentWithHttpInfoAsync(Guid noteId, Guid commentId, Guid attachmentId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/notes/{noteId}/comments/{commentId}/attachments/{attachmentId}/download", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<CommentDto> GetCommentWithHttpInfo(Guid noteId, Guid commentId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            CommentDto>("/notes/{noteId}/comments/{commentId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<CommentDto>> GetCommentWithHttpInfoAsync(Guid noteId, Guid commentId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<CommentDto>("/notes/{noteId}/comments/{commentId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<List<AttachmentSummaryDto>> GetCommentAttachmentsWithHttpInfo(Guid noteId, Guid commentId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            List<AttachmentSummaryDto>>("/notes/{noteId}/comments/{commentId}/attachments", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<List<AttachmentSummaryDto>>> GetCommentAttachmentsWithHttpInfoAsync(Guid noteId, Guid commentId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<AttachmentSummaryDto>>("/notes/{noteId}/comments/{commentId}/attachments", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<List<CommentSummaryDto>> GetCommentsWithHttpInfo(Guid noteId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<
            List<CommentSummaryDto>>("/notes/{noteId}/comments", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<List<CommentSummaryDto>>> GetCommentsWithHttpInfoAsync(Guid noteId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<CommentSummaryDto>>("/notes/{noteId}/comments", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PatchCommentWithHttpInfoAsync(Guid noteId, Guid commentId, List<Operation> operation = default(List<Operation>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<Object>("/notes/{noteId}/comments/{commentId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
