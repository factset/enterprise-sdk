# FactSet.SDK.OpenFactSetMarketplace.Api.ProductsApi
...
namespace Example
{
    public class GetProductByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ProductsApi.GetProductById: " + e.Message );
...
namespace Example
{
    public class GetProductsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ProductsApi.GetProducts: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
