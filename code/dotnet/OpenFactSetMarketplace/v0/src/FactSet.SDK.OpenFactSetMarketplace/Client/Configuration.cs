...
namespace FactSet.SDK.OpenFactSetMarketplace.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/OpenFactSetMarketplace/0.0.1";
            BasePath = "https://api.factset.com/ofs/v0";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/ofs/v0"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/ofs/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.OpenFactSetMarketplace) Debug Report:\n";
