...
namespace FactSet.SDK.NaturalLanguageProcessing.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QnATask")]
    public partial class QnATask : IEquatable<QnATask>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QnATask" /> class.
        /// </summary>
        ...
        public QnATask(Guid id, DateTime startedAt, StatusEnum status)
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as QnATask);
        }

        /// <summary>
        /// Returns true if QnATask instances are equal
        /// </summary>
        /// <param name="input">Instance of QnATask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QnATask input)
        {
            if (input == null)
            {
                return false;
