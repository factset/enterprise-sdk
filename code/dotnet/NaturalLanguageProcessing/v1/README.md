...
namespace Example
{
    public static class CognitiveNlpV1ThemesPostExample
    {
...
------------ | ------------- | ------------- | -------------
*ThemesApi* | [**CognitiveNlpV1ThemesPost**](docs/ThemesApi.md#cognitivenlpv1themespost) | **POST** /cognitive/nlp/v1/themes | POST request to extract themes from text
