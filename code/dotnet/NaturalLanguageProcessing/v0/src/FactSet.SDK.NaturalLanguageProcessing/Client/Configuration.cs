...
namespace FactSet.SDK.NaturalLanguageProcessing.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/NaturalLanguageProcessing/0.40.0";
            BasePath = "https://api.factset.com/aiml/ner/v0";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.factset.com/aiml/ner/v0"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/aiml/ner/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.NaturalLanguageProcessing) Debug Report:\n";
