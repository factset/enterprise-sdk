# FactSet.SDK.BarraPortfolioOptimizer.Api.StrategyDocumentsApi
...
namespace Example
{
    public class GetBarraStrategyDocumentsExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling StrategyDocumentsApi.GetBarraStrategyDocuments: " + e.Message );
