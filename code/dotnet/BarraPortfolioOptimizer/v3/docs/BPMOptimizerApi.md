# FactSet.SDK.BarraPortfolioOptimizer.Api.BPMOptimizerApi
...
namespace Example
{
    public class CancelOptimizationByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling BPMOptimizerApi.CancelOptimizationById: " + e.Message );
...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling BPMOptimizerApi.GetOptimizationParameters: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling BPMOptimizerApi.GetOptimizationResult: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling BPMOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                // Create and Run BPM optimization
                BPMOptimizerApi.PostAndOptimizeResponseWrapper result = apiInstance.PostAndOptimize(xFactSetApiLongRunningDeadline, cacheControl, bPMOptimizationParametersRoot);
            ...
            {
                Console.WriteLine("Exception when calling BPMOptimizerApi.PostAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static async Task Main()
        {
            ...
            {
                // Create or Update BPM optimization and run it.
                BPMOptimizerApi.PutAndOptimizeResponseWrapper result = apiInstance.PutAndOptimize(id, xFactSetApiLongRunningDeadline, cacheControl, bPMOptimizationParametersRoot);
            ...
            {
                Console.WriteLine("Exception when calling BPMOptimizerApi.PutAndOptimize: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
