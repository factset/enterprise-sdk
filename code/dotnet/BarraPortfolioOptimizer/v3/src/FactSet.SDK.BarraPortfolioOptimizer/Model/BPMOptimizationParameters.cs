...
namespace FactSet.SDK.BarraPortfolioOptimizer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BPMOptimizationParameters")]
    public partial class BPMOptimizationParameters : IEquatable<BPMOptimizationParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BPMOptimizationParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BPMOptimizationParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BPMOptimizationParameters" /> class.
        /// </summary>
        ...
        public BPMOptimizationParameters(BPMOptimizerStrategy strategy, OptimizerOutputTypes outputTypes,BPMOptimization optimization = default(BPMOptimization), OptimizerAccount account = default(OptimizerAccount))
        {
            ...
            if (strategy == null) {
                throw new ArgumentNullException("strategy is a required property for BPMOptimizationParameters and cannot be null");
            }
            this.Strategy = strategy;
            // to ensure "outputTypes" is required (not null)
            if (outputTypes == null) {
                throw new ArgumentNullException("outputTypes is a required property for BPMOptimizationParameters and cannot be null");
            }
        ...
        public BPMOptimizerStrategy Strategy { get; set; }

        /// <summary>
        /// Gets or Sets Optimization
        /// </summary>
        [DataMember(Name = "optimization", EmitDefaultValue = false)]
        public BPMOptimization Optimization { get; set; }
        ...
        {
            return this.Equals(input as BPMOptimizationParameters);
        }

        /// <summary>
        /// Returns true if BPMOptimizationParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of BPMOptimizationParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BPMOptimizationParameters input)
        {
            if (input == null)
            {
                return false;
