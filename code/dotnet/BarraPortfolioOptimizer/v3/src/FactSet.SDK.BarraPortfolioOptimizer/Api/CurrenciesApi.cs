...
namespace FactSet.SDK.BarraPortfolioOptimizer.Api
{
    ...
    public partial class CurrenciesApi : ICurrenciesApi
    {
        ...
        /// <returns></returns>
        public CurrenciesApi(FactSet.SDK.BarraPortfolioOptimizer.Client.Configuration configuration)
        {
        ...
        public CurrenciesApi(FactSet.SDK.BarraPortfolioOptimizer.Client.ISynchronousClient client, FactSet.SDK.BarraPortfolioOptimizer.Client.IAsynchronousClient asyncClient, FactSet.SDK.BarraPortfolioOptimizer.Client.IReadableConfiguration configuration)
        {
        ...
        {
            FactSet.SDK.BarraPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> localVarResponse = GetCurrenciesWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.BarraPortfolioOptimizer.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of CurrencyRoot</returns>
        public FactSet.SDK.BarraPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> GetCurrenciesWithHttpInfo()
        {
        ...
        {
            FactSet.SDK.BarraPortfolioOptimizer.Client.ApiResponse<CurrencyRoot> localVarResponse = await GetCurrenciesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CurrencyRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.BarraPortfolioOptimizer.Client.ApiResponse<CurrencyRoot>> GetCurrenciesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
