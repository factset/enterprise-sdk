...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems")]
    public partial class PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems : IEquatable<PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems(TypeEnum? type = default(TypeEnum?), PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsObservation observation = default(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsObservation), PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsUpper upper = default(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsUpper), PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsLower lower = default(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsLower), PostSecuritizedDerivativeNotationScreenerValueRangesGetDataSingleBarriersItemsBreach breach = default(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataSingleBarriersItemsBreach), PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsCashFlow cashFlow = default(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsCashFlow))
        {
            this.Type = type;
        ...
        public PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsObservation Observation { get; set; }

        /// <summary>
        /// Gets or Sets Upper
        /// </summary>
        [DataMember(Name = "upper", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsUpper Upper { get; set; }

        /// <summary>
        /// Gets or Sets Lower
        /// </summary>
        [DataMember(Name = "lower", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsLower Lower { get; set; }
        ...
        public PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItemsCashFlow CashFlow { get; set; }
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerValueRangesGetDataRangeBarriersItems input)
        {
            if (input == null)
            {
                return false;
