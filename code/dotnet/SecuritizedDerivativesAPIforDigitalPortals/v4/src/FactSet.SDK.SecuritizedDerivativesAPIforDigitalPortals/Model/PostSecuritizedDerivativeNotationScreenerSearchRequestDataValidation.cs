...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchRequest_data_validation")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation(bool onlyActive = true, PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationPrices prices = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationPrices), PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationValueUnit valueUnit = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationValueUnit), PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationMarket market = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationMarket), PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationInstrumentRestrictionList instrumentRestrictionList = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationInstrumentRestrictionList), PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationNotationRestrictionList notationRestrictionList = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationNotationRestrictionList))
        {
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationPrices Prices { get; set; }

        /// <summary>
        /// Gets or Sets ValueUnit
        /// </summary>
        [DataMember(Name = "valueUnit", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationValueUnit ValueUnit { get; set; }

        /// <summary>
        /// Gets or Sets Market
        /// </summary>
        [DataMember(Name = "market", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationMarket Market { get; set; }

        /// <summary>
        /// Gets or Sets InstrumentRestrictionList
        /// </summary>
        [DataMember(Name = "instrumentRestrictionList", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationInstrumentRestrictionList InstrumentRestrictionList { get; set; }

        /// <summary>
        /// Gets or Sets NotationRestrictionList
        /// </summary>
        [DataMember(Name = "notationRestrictionList", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidationNotationRestrictionList NotationRestrictionList { get; set; }
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation input)
        {
            if (input == null)
            {
                return false;
