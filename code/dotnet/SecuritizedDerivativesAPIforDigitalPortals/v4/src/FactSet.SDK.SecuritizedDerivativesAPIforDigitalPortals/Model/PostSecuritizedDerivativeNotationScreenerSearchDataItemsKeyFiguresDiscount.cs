...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchDataItems_keyFigures_discount")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount" /> class.
        /// </summary>
        /// <param name="absolute">Discount in absolute terms..</param>
        /// <param name="relative">Discount relative to the underlying level..</param>
        public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount(decimal? absolute = default(decimal?), decimal? relative = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresDiscount input)
        {
            if (input == null)
            {
                return false;
