...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2002 : IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">List of issuers, including issuer groups, sorted descending by the number of securitized derivatives issued..</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2002(List<PostSecuritizedDerivativeIssuerSearchDataItems> data = default(List<PostSecuritizedDerivativeIssuerSearchDataItems>), InlineResponse200Meta meta = default(InlineResponse200Meta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>List of issuers, including issuer groups, sorted descending by the number of securitized derivatives issued.</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<PostSecuritizedDerivativeIssuerSearchDataItems> Data { get; set; }
