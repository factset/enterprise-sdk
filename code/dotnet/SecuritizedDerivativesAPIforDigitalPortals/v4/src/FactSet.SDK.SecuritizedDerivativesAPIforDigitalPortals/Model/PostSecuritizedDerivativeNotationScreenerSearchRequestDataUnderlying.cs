...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchRequest_data_underlying")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying" /> class.
        /// </summary>
        /// <param name="instrument">instrument.</param>
        /// <param name="notation">notation.</param>
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying(PostSecuritizedDerivativeNotationRankingIntradayListRequestDataUnderlyingInstrument instrument = default(PostSecuritizedDerivativeNotationRankingIntradayListRequestDataUnderlyingInstrument), PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlyingNotation notation = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlyingNotation))
        {
        ...
        public PostSecuritizedDerivativeNotationRankingIntradayListRequestDataUnderlyingInstrument Instrument { get; set; }

        /// <summary>
        /// Gets or Sets Notation
        /// </summary>
        [DataMember(Name = "notation", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlyingNotation Notation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying {\n");
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying input)
        {
            if (input == null)
            {
                return false;
