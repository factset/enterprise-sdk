...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationRankingIntradayListDataItems_fsym_regional")]
    public partial class PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional : IEquatable<PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional(string permanentIdentifier = default(string), string tickerRegion = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymRegional input)
        {
            if (input == null)
            {
                return false;
