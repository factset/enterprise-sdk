...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationRankingIntradayListDataItems_fsym_listing")]
    public partial class PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing : IEquatable<PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool? isPrimary = default(bool?))
        {
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationRankingIntradayListDataItemsFsymListing input)
        {
            if (input == null)
            {
                return false;
