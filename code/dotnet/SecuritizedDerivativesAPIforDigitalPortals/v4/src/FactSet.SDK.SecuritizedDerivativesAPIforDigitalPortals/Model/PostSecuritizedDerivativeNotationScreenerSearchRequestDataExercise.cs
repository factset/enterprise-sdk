...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchRequest_data_exercise")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Code of the exercise style. | Value | Description | | - -- | - -- | | american | An American-style securitized derivative can be exercised anytime during its life. | | european | An European-style securitized derivative can be exercised at maturity only. | | bermudan | A Bermudan-style securitized derivative can be exercised only on predetermined dates. |  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise" /> class.
        /// </summary>
        /// <param name="right">Code of the exercise right. | Value | Description | | - -- | - -- | | put | A put option gives buyer the right, but not the obligation, to sell an asset at a specified price within a specific time period. Put is synonymous to short or bear and is used in a broader sense for products that make profits from falling underlying levels. | | call | A call option gives buyer the right, but not the obligation, to buy an asset at a specified price within a specific time period. Call is synonymous to long or bull and is used in a broader sense for products that make profits from rising underlying levels. |  .</param>
        /// <param name="style">Code of the exercise style. | Value | Description | | - -- | - -- | | american | An American-style securitized derivative can be exercised anytime during its life. | | european | An European-style securitized derivative can be exercised at maturity only. | | bermudan | A Bermudan-style securitized derivative can be exercised only on predetermined dates. |  .</param>
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise(RightEnum? right = default(RightEnum?), StyleEnum? style = default(StyleEnum?))
        {
            this.Right = right;
            this.Style = style;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise {\n");
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise input)
        {
            if (input == null)
            {
                return false;
