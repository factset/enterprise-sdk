...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationRankingIntradayListRequest_meta")]
    public partial class PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta : IEquatable<PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// </summary>
        /// <value>Sortable attributes. The sort order is ascending unless it is prefixed with a minus sign, in which case it is descending. A list of at most 5 (possibly prefixed) attribute name(s) is allowed. | Value | | - -- | | trade.performance.absolute | | -trade.performance.absolute | | trade.performance.relative | | -trade.performance.relative | | accumulated.numberTrades | | -accumulated.numberTrades | | accumulated.tradingVolume | | -accumulated.tradingVolume | | accumulated.tradingValue | | -accumulated.tradingValue |  </value>
        [DataMember(Name = "sort", EmitDefaultValue = false)]
        public HashSet<SortEnum> Sort { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta" /> class.
        /// </summary>
        ...
        /// <param name="sort">Sortable attributes. The sort order is ascending unless it is prefixed with a minus sign, in which case it is descending. A list of at most 5 (possibly prefixed) attribute name(s) is allowed. | Value | | - -- | | trade.performance.absolute | | -trade.performance.absolute | | trade.performance.relative | | -trade.performance.relative | | accumulated.numberTrades | | -accumulated.numberTrades | | accumulated.tradingVolume | | -accumulated.tradingVolume | | accumulated.tradingValue | | -accumulated.tradingValue |  .</param>
        /// <param name="pagination">pagination.</param>
        public PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta(HashSet<string> attributes = default(HashSet<string>), string language = default(string), HashSet<SortEnum> sort = default(HashSet<SortEnum>), PostSecuritizedDerivativeNotationRankingIntradayListRequestMetaPagination pagination = default(PostSecuritizedDerivativeNotationRankingIntradayListRequestMetaPagination))
        {
        ...
        public PostSecuritizedDerivativeNotationRankingIntradayListRequestMetaPagination Pagination { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta {\n");
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationRankingIntradayListRequestMeta input)
        {
            if (input == null)
            {
                return false;
