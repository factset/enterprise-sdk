...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchDataItems_keyFigures_thetaOneWeek")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek(decimal? effective = default(decimal?), decimal? unadjusted = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresThetaOneWeek input)
        {
            if (input == null)
            {
                return false;
