...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItems_single_participationFactor")]
    public partial class GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor : IEquatable<GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor" /> class.
        /// </summary>
        ...
        public GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor(decimal? positive = default(decimal?), decimal? negative = default(decimal?))
        {
        ...
        {
            return this.Equals(input as GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor);
        }

        /// <summary>
        /// Returns true if GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSecuritizedDerivativeUnderlyingListDataBarrierTypeConditionsConditionsBarriersItemsSingleParticipationFactor input)
        {
            if (input == null)
            {
                return false;
