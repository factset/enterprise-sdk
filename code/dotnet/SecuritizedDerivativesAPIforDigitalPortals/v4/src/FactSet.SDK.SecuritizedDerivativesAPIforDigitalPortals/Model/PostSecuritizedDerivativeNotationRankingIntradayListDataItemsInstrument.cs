...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationRankingIntradayListDataItems_instrument")]
    public partial class PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument : IEquatable<PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument(string id = default(string), string name = default(string), string shortName = default(string), string isin = default(string), InlineResponse200DataNsin nsin = default(InlineResponse200DataNsin), GetSecuritizedDerivativeUnderlyingListDataUnderlyingsItemsNotationInstrumentFsym fsym = default(GetSecuritizedDerivativeUnderlyingListDataUnderlyingsItemsNotationInstrumentFsym))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationRankingIntradayListDataItemsInstrument input)
        {
            if (input == null)
            {
                return false;
