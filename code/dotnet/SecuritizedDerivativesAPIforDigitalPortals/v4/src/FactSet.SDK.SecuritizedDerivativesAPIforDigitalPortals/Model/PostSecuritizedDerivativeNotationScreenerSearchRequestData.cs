...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchRequest_data")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchRequestData : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchRequestData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchRequestData" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchRequestData(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation validation = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation), PostSecuritizedDerivativeNotationScreenerSearchRequestDataCategory category = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataCategory), PostSecuritizedDerivativeNotationScreenerSearchRequestDataRegistrationCountry registrationCountry = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataRegistrationCountry), PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycle lifeCycle = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycle), PostSecuritizedDerivativeNotationRankingIntradayListRequestDataIssuer issuer = default(PostSecuritizedDerivativeNotationRankingIntradayListRequestDataIssuer), PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise exercise = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise), SettlementEnum? settlement = default(SettlementEnum?), bool collateralized = default(bool), bool quanto = default(bool), PostSecuritizedDerivativeNotationScreenerSearchRequestDataCapitalProtection capitalProtection = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataCapitalProtection), PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying underlying = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying), PostSecuritizedDerivativeNotationScreenerSearchRequestDataCashFlowCurrency cashFlowCurrency = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataCashFlowCurrency), List<PostSecuritizedDerivativeNotationScreenerSearchDataSingleBarriersItems> singleBarriers = default(List<PostSecuritizedDerivativeNotationScreenerSearchDataSingleBarriersItems>), List<PostSecuritizedDerivativeNotationScreenerSearchDataRangeBarriersItems> rangeBarriers = default(List<PostSecuritizedDerivativeNotationScreenerSearchDataRangeBarriersItems>), PostSecuritizedDerivativeNotationScreenerSearchRequestDataFactorCertificates factorCertificates = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataFactorCertificates), PostSecuritizedDerivativeNotationScreenerSearchRequestDataNominalCurrency nominalCurrency = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataNominalCurrency), PostSecuritizedDerivativeNotationScreenerSearchRequestDataCurrentInterestRate currentInterestRate = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataCurrentInterestRate), PostSecuritizedDerivativeNotationScreenerSearchRequestDataKeyFigures keyFigures = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataKeyFigures), PostSecuritizedDerivativeNotationScreenerSearchRequestDataPerformance performance = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataPerformance), PostSecuritizedDerivativeNotationScreenerSearchRequestDataVolatility volatility = default(PostSecuritizedDerivativeNotationScreenerSearchRequestDataVolatility))
        {
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataValidation Validation { get; set; }

        /// <summary>
        /// Gets or Sets Category
        /// </summary>
        [DataMember(Name = "category", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataCategory Category { get; set; }

        /// <summary>
        /// Gets or Sets RegistrationCountry
        /// </summary>
        [DataMember(Name = "registrationCountry", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataRegistrationCountry RegistrationCountry { get; set; }

        /// <summary>
        /// Gets or Sets LifeCycle
        /// </summary>
        [DataMember(Name = "lifeCycle", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataLifeCycle LifeCycle { get; set; }
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataExercise Exercise { get; set; }
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataCapitalProtection CapitalProtection { get; set; }

        /// <summary>
        /// Gets or Sets Underlying
        /// </summary>
        [DataMember(Name = "underlying", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataUnderlying Underlying { get; set; }

        /// <summary>
        /// Gets or Sets CashFlowCurrency
        /// </summary>
        [DataMember(Name = "cashFlowCurrency", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataCashFlowCurrency CashFlowCurrency { get; set; }
        ...
        public List<PostSecuritizedDerivativeNotationScreenerSearchDataSingleBarriersItems> SingleBarriers { get; set; }
        ...
        public List<PostSecuritizedDerivativeNotationScreenerSearchDataRangeBarriersItems> RangeBarriers { get; set; }

        /// <summary>
        /// Gets or Sets FactorCertificates
        /// </summary>
        [DataMember(Name = "factorCertificates", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataFactorCertificates FactorCertificates { get; set; }

        /// <summary>
        /// Gets or Sets NominalCurrency
        /// </summary>
        [DataMember(Name = "nominalCurrency", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataNominalCurrency NominalCurrency { get; set; }

        /// <summary>
        /// Gets or Sets CurrentInterestRate
        /// </summary>
        [DataMember(Name = "currentInterestRate", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataCurrentInterestRate CurrentInterestRate { get; set; }

        /// <summary>
        /// Gets or Sets KeyFigures
        /// </summary>
        [DataMember(Name = "keyFigures", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataKeyFigures KeyFigures { get; set; }

        /// <summary>
        /// Gets or Sets Performance
        /// </summary>
        [DataMember(Name = "performance", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataPerformance Performance { get; set; }

        /// <summary>
        /// Gets or Sets Volatility
        /// </summary>
        [DataMember(Name = "volatility", EmitDefaultValue = false)]
        public PostSecuritizedDerivativeNotationScreenerSearchRequestDataVolatility Volatility { get; set; }
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchRequestData);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchRequestData input)
        {
            if (input == null)
            {
                return false;
