...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchDataItems_keyFigures_sidewaysYield")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield(decimal? absolute = default(decimal?), decimal? relative = default(decimal?), decimal? annualized = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresSidewaysYield input)
        {
            if (input == null)
            {
                return false;
