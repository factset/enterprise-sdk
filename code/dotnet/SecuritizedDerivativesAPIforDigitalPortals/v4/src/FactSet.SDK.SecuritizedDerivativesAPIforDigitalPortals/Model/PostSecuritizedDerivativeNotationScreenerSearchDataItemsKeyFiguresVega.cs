...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostSecuritizedDerivativeNotationScreenerSearchDataItems_keyFigures_vega")]
    public partial class PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega : IEquatable<PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega" /> class.
        /// </summary>
        ...
        public PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega(decimal? effective = default(decimal?), decimal? unadjusted = default(decimal?))
        {
        ...
        [DataMember(Name = "effective", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "unadjusted", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega);
        }

        /// <summary>
        /// Returns true if PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega instances are equal
        /// </summary>
        /// <param name="input">Instance of PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostSecuritizedDerivativeNotationScreenerSearchDataItemsKeyFiguresVega input)
        {
            if (input == null)
            {
                return false;
