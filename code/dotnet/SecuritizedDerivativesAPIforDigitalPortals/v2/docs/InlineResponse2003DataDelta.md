# FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model.InlineResponse2003DataDelta
...
------------ | ------------- | ------------- | -------------
**Effective** | **decimal** | Delta calculated using the actual cover ration of the securitized derivative. | [optional] 
**Unadjusted** | **decimal** | Delta calculated using a (hypothetical) cover ratio of 1:1. | [optional] 
