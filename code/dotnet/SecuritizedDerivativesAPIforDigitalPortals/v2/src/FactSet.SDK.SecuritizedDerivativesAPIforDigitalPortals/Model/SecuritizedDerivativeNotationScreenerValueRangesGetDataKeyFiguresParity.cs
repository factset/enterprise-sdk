...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_securitizedDerivative_notation_screener_valueRanges_get_data_keyFigures_parity")]
    public partial class SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity : IEquatable<SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        public SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity(SecuritizedDerivativeNotationScreenerValueRangesGetDataLevelAbsoluteMinimum minimum = default(SecuritizedDerivativeNotationScreenerValueRangesGetDataLevelAbsoluteMinimum), SecuritizedDerivativeNotationScreenerValueRangesGetDataLevelAbsoluteMaximum maximum = default(SecuritizedDerivativeNotationScreenerValueRangesGetDataLevelAbsoluteMaximum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity {\n");
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresParity input)
        {
            if (input == null)
                return false;
