...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_securitizedDerivative_notation_screener_search_meta")]
    public partial class SecuritizedDerivativeNotationScreenerSearchMeta : IEquatable<SecuritizedDerivativeNotationScreenerSearchMeta>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerSearchMeta" /> class.
        /// </summary>
        ...
        public SecuritizedDerivativeNotationScreenerSearchMeta(List<string> attributes = default(List<string>), string language = default(string), List<SortEnum> sort = default(List<SortEnum>), SecuritizedDerivativeNotationScreenerSearchMetaPagination pagination = default(SecuritizedDerivativeNotationScreenerSearchMetaPagination))
        {
        ...
        public SecuritizedDerivativeNotationScreenerSearchMetaPagination Pagination { get; set; }
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerSearchMeta);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerSearchMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerSearchMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecuritizedDerivativeNotationScreenerSearchMeta input)
        {
            if (input == null)
            {
                return false;
