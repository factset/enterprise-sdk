...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_securitizedDerivative_notation_screener_valueRanges_get_data_validation_prices_latest")]
    public partial class SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest : IEquatable<SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest" /> class.
        /// </summary>
        ...
        public SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest(bool availableOnly = default(bool), DateTime minimumDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationPricesLatest to be compared</param>
        /// <returns>Boolean</returns>
