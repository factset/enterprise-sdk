...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_underlying_notation_instrument")]
    public partial class InlineResponse2004UnderlyingNotationInstrument : IEquatable<InlineResponse2004UnderlyingNotationInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004UnderlyingNotationInstrument" /> class.
        /// </summary>
        ...
        public InlineResponse2004UnderlyingNotationInstrument(string id = default(string), TypeCompositeEnum? typeComposite = default(TypeCompositeEnum?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as InlineResponse2004UnderlyingNotationInstrument);
        }

        /// <summary>
        /// Returns true if InlineResponse2004UnderlyingNotationInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004UnderlyingNotationInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004UnderlyingNotationInstrument input)
        {
            if (input == null)
            {
                return false;
