...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_bonusLevel_distance")]
    public partial class InlineResponse2006InstrumentBonusLevelDistance : IEquatable<InlineResponse2006InstrumentBonusLevelDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentBonusLevelDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentBonusLevelDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentBonusLevelDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentBonusLevelDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentBonusLevelDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentBonusLevelDistance input)
        {
            if (input == null)
            {
                return false;
