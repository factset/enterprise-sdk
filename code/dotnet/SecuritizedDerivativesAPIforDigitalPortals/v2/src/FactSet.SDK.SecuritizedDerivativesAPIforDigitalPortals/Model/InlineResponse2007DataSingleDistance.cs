...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_data_single_distance")]
    public partial class InlineResponse2007DataSingleDistance : IEquatable<InlineResponse2007DataSingleDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007DataSingleDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2007DataSingleDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2007DataSingleDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2007DataSingleDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007DataSingleDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007DataSingleDistance input)
        {
            if (input == null)
            {
                return false;
