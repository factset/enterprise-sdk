...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_lockIn_distance")]
    public partial class InlineResponse2005DataLockInDistance : IEquatable<InlineResponse2005DataLockInDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataLockInDistance" /> class.
        /// </summary>
        /// <param name="absolute">absolute.</param>
        /// <param name="relative">relative.</param>
        public InlineResponse2005DataLockInDistance(InlineResponse2005DataStrikeDistanceAbsolute absolute = default(InlineResponse2005DataStrikeDistanceAbsolute), InlineResponse2005DataStrikeDistanceRelative relative = default(InlineResponse2005DataStrikeDistanceRelative))
        {
        ...
        {
            return this.Equals(input as InlineResponse2005DataLockInDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataLockInDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataLockInDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataLockInDistance input)
        {
            if (input == null)
            {
                return false;
