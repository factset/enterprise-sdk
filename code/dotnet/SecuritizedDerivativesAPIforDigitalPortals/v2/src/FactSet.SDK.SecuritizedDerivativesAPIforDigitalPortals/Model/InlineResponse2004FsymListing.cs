...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_fsym_listing")]
    public partial class InlineResponse2004FsymListing : IEquatable<InlineResponse2004FsymListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004FsymListing" /> class.
        /// </summary>
        ...
        public InlineResponse2004FsymListing(string permanentIdentifier = default(string), string tickerExchange = default(string), bool isPrimary = default(bool))
        {
        ...
        {
            return this.Equals(input as InlineResponse2004FsymListing);
        }

        /// <summary>
        /// Returns true if InlineResponse2004FsymListing instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004FsymListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004FsymListing input)
        {
            if (input == null)
            {
                return false;
