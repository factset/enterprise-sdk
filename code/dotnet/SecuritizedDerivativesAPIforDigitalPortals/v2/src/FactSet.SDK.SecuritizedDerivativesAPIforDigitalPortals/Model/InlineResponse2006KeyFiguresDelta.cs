...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_keyFigures_delta")]
    public partial class InlineResponse2006KeyFiguresDelta : IEquatable<InlineResponse2006KeyFiguresDelta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006KeyFiguresDelta" /> class.
        /// </summary>
        ...
        public InlineResponse2006KeyFiguresDelta(decimal effective = default(decimal), decimal unadjusted = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006KeyFiguresDelta);
        }

        /// <summary>
        /// Returns true if InlineResponse2006KeyFiguresDelta instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006KeyFiguresDelta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006KeyFiguresDelta input)
        {
            if (input == null)
            {
                return false;
