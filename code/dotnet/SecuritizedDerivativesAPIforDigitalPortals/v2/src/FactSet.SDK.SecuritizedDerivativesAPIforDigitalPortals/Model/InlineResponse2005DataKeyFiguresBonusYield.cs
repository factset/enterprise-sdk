...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_keyFigures_bonusYield")]
    public partial class InlineResponse2005DataKeyFiguresBonusYield : IEquatable<InlineResponse2005DataKeyFiguresBonusYield>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataKeyFiguresBonusYield" /> class.
        /// </summary>
        /// <param name="absolute">absolute.</param>
        /// <param name="relative">relative.</param>
        /// <param name="annualized">annualized.</param>
        public InlineResponse2005DataKeyFiguresBonusYield(InlineResponse2005DataKeyFiguresBonusYieldAbsolute absolute = default(InlineResponse2005DataKeyFiguresBonusYieldAbsolute), InlineResponse2005DataKeyFiguresBonusYieldRelative relative = default(InlineResponse2005DataKeyFiguresBonusYieldRelative), InlineResponse2005DataKeyFiguresBonusYieldAnnualized annualized = default(InlineResponse2005DataKeyFiguresBonusYieldAnnualized))
        {
        ...
        public InlineResponse2005DataKeyFiguresBonusYieldAbsolute Absolute { get; set; }

        /// <summary>
        /// Gets or Sets Relative
        /// </summary>
        [DataMember(Name = "relative", EmitDefaultValue = false)]
        public InlineResponse2005DataKeyFiguresBonusYieldRelative Relative { get; set; }

        /// <summary>
        /// Gets or Sets Annualized
        /// </summary>
        [DataMember(Name = "annualized", EmitDefaultValue = false)]
        public InlineResponse2005DataKeyFiguresBonusYieldAnnualized Annualized { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2005DataKeyFiguresBonusYield);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataKeyFiguresBonusYield instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataKeyFiguresBonusYield to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataKeyFiguresBonusYield input)
        {
            if (input == null)
            {
                return false;
