...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_cap_distance")]
    public partial class InlineResponse2006InstrumentCapDistance : IEquatable<InlineResponse2006InstrumentCapDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentCapDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentCapDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentCapDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentCapDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentCapDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentCapDistance input)
        {
            if (input == null)
            {
                return false;
