...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_keyFigures_maximumYield")]
    public partial class InlineResponse2006KeyFiguresMaximumYield : IEquatable<InlineResponse2006KeyFiguresMaximumYield>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006KeyFiguresMaximumYield" /> class.
        /// </summary>
        ...
        public InlineResponse2006KeyFiguresMaximumYield(decimal absolute = default(decimal), decimal relative = default(decimal), decimal annualized = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006KeyFiguresMaximumYield);
        }

        /// <summary>
        /// Returns true if InlineResponse2006KeyFiguresMaximumYield instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006KeyFiguresMaximumYield to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006KeyFiguresMaximumYield input)
        {
            if (input == null)
            {
                return false;
