...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_securitizedDerivative_notation_screener_valueRanges_get_data_keyFigures_intrinsicValue")]
    public partial class SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue : IEquatable<SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecuritizedDerivativeNotationScreenerValueRangesGetDataKeyFiguresIntrinsicValue input)
        {
            if (input == null)
            {
                return false;
