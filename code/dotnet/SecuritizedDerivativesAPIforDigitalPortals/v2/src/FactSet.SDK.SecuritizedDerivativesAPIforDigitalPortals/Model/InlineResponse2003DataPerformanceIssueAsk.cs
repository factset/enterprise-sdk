...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_data_performanceIssue_ask")]
    public partial class InlineResponse2003DataPerformanceIssueAsk : IEquatable<InlineResponse2003DataPerformanceIssueAsk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003DataPerformanceIssueAsk" /> class.
        /// </summary>
        ...
        public InlineResponse2003DataPerformanceIssueAsk(decimal absolute = default(decimal), decimal relative = default(decimal), decimal annualized = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003DataPerformanceIssueAsk);
        }

        /// <summary>
        /// Returns true if InlineResponse2003DataPerformanceIssueAsk instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003DataPerformanceIssueAsk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003DataPerformanceIssueAsk input)
        {
            if (input == null)
            {
                return false;
