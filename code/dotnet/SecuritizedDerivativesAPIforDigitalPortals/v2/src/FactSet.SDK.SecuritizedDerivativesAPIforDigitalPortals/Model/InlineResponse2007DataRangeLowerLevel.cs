...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_data_range_lower_level")]
    public partial class InlineResponse2007DataRangeLowerLevel : IEquatable<InlineResponse2007DataRangeLowerLevel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007DataRangeLowerLevel" /> class.
        /// </summary>
        ...
        public InlineResponse2007DataRangeLowerLevel(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2007DataRangeLowerLevel);
        }

        /// <summary>
        /// Returns true if InlineResponse2007DataRangeLowerLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007DataRangeLowerLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007DataRangeLowerLevel input)
        {
            if (input == null)
            {
                return false;
