...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationMarketPriority" /> class.
        /// </summary>
        /// <param name="ids">List of market identifiers..</param>
        public SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationMarketPriority(List<decimal> ids = default(List<decimal>))
        {
            this.Ids = ids;
        }
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationMarketPriority);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationMarketPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerValueRangesGetDataValidationMarketPriority to be compared</param>
        /// <returns>Boolean</returns>
