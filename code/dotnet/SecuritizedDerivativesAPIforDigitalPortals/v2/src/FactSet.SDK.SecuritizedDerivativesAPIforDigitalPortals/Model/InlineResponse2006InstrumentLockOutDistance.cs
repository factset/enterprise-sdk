...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_lockOut_distance")]
    public partial class InlineResponse2006InstrumentLockOutDistance : IEquatable<InlineResponse2006InstrumentLockOutDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentLockOutDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentLockOutDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentLockOutDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentLockOutDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentLockOutDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentLockOutDistance input)
        {
            if (input == null)
            {
                return false;
