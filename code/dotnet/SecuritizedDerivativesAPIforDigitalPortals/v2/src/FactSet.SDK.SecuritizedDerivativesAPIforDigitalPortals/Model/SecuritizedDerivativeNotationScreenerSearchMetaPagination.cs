...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_securitizedDerivative_notation_screener_search_meta_pagination")]
    public partial class SecuritizedDerivativeNotationScreenerSearchMetaPagination : IEquatable<SecuritizedDerivativeNotationScreenerSearchMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerSearchMetaPagination" /> class.
        /// </summary>
        ...
        public SecuritizedDerivativeNotationScreenerSearchMetaPagination(decimal offset = default(decimal), decimal limit = default(decimal))
        {
            this.Offset = offset;
            this.Limit = limit;
        }
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerSearchMetaPagination);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerSearchMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerSearchMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecuritizedDerivativeNotationScreenerSearchMetaPagination input)
        {
            if (input == null)
                return false;
