...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_capitalGuarantee_distance")]
    public partial class InlineResponse2006InstrumentCapitalGuaranteeDistance : IEquatable<InlineResponse2006InstrumentCapitalGuaranteeDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentCapitalGuaranteeDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentCapitalGuaranteeDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentCapitalGuaranteeDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentCapitalGuaranteeDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentCapitalGuaranteeDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentCapitalGuaranteeDistance input)
        {
            if (input == null)
            {
                return false;
