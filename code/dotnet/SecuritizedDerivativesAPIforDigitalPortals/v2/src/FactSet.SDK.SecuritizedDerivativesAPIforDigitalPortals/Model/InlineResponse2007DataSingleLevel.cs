...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_data_single_level")]
    public partial class InlineResponse2007DataSingleLevel : IEquatable<InlineResponse2007DataSingleLevel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007DataSingleLevel" /> class.
        /// </summary>
        ...
        public InlineResponse2007DataSingleLevel(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007DataSingleLevel {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007DataSingleLevel);
        }

        /// <summary>
        /// Returns true if InlineResponse2007DataSingleLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007DataSingleLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007DataSingleLevel input)
        {
            if (input == null)
            {
                return false;
