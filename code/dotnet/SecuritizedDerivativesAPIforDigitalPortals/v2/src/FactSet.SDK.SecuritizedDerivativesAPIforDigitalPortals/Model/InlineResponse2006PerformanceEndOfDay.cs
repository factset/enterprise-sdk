...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_performance_endOfDay")]
    public partial class InlineResponse2006PerformanceEndOfDay : IEquatable<InlineResponse2006PerformanceEndOfDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006PerformanceEndOfDay" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2006PerformanceEndOfDay);
        }

        /// <summary>
        /// Returns true if InlineResponse2006PerformanceEndOfDay instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006PerformanceEndOfDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006PerformanceEndOfDay input)
        {
            if (input == null)
            {
                return false;
