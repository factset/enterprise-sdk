...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_knockIn_distance")]
    public partial class InlineResponse2006InstrumentKnockInDistance : IEquatable<InlineResponse2006InstrumentKnockInDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentKnockInDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentKnockInDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentKnockInDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentKnockInDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentKnockInDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentKnockInDistance input)
        {
            if (input == null)
                return false;
