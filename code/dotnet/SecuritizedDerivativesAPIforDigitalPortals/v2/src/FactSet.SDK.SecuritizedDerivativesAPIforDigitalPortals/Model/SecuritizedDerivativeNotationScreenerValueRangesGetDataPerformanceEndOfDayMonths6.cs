...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_securitizedDerivative_notation_screener_valueRanges_get_data_performance_endOfDay_months6")]
    public partial class SecuritizedDerivativeNotationScreenerValueRangesGetDataPerformanceEndOfDayMonths6 : IEquatable<SecuritizedDerivativeNotationScreenerValueRangesGetDataPerformanceEndOfDayMonths6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritizedDerivativeNotationScreenerValueRangesGetDataPerformanceEndOfDayMonths6" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SecuritizedDerivativeNotationScreenerValueRangesGetDataPerformanceEndOfDayMonths6);
        }

        /// <summary>
        /// Returns true if SecuritizedDerivativeNotationScreenerValueRangesGetDataPerformanceEndOfDayMonths6 instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritizedDerivativeNotationScreenerValueRangesGetDataPerformanceEndOfDayMonths6 to be compared</param>
        /// <returns>Boolean</returns>
