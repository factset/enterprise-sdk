...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_data_sidewaysYield")]
    public partial class InlineResponse2003DataSidewaysYield : IEquatable<InlineResponse2003DataSidewaysYield>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003DataSidewaysYield" /> class.
        /// </summary>
        ...
        public InlineResponse2003DataSidewaysYield(decimal absolute = default(decimal), decimal relative = default(decimal), decimal annualized = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003DataSidewaysYield);
        }

        /// <summary>
        /// Returns true if InlineResponse2003DataSidewaysYield instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003DataSidewaysYield to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003DataSidewaysYield input)
        {
            if (input == null)
            {
                return false;
