...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_data_spread")]
    public partial class InlineResponse2003DataSpread : IEquatable<InlineResponse2003DataSpread>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003DataSpread" /> class.
        /// </summary>
        ...
        public InlineResponse2003DataSpread(decimal harmonized = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003DataSpread);
        }

        /// <summary>
        /// Returns true if InlineResponse2003DataSpread instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003DataSpread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003DataSpread input)
        {
            if (input == null)
                return false;
