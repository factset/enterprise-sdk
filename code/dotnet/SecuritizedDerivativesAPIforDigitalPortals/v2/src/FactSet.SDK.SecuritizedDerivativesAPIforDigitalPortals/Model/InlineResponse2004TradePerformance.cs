...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_trade_performance")]
    public partial class InlineResponse2004TradePerformance : IEquatable<InlineResponse2004TradePerformance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004TradePerformance" /> class.
        /// </summary>
        /// <param name="absolute">Absolute value. See attribute &#x60;valueUnit&#x60; for its unit..</param>
        /// <param name="relative">Relative value..</param>
        public InlineResponse2004TradePerformance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2004TradePerformance);
        }

        /// <summary>
        /// Returns true if InlineResponse2004TradePerformance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004TradePerformance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004TradePerformance input)
        {
            if (input == null)
            {
                return false;
