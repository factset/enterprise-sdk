...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_lockIn_distance")]
    public partial class InlineResponse2006InstrumentLockInDistance : IEquatable<InlineResponse2006InstrumentLockInDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentLockInDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentLockInDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentLockInDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentLockInDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentLockInDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentLockInDistance input)
        {
            if (input == null)
                return false;
