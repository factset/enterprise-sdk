...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    public partial class SecuritizedDerivativeNotationRankingIntradayListMetaPagination : IEquatable<SecuritizedDerivativeNotationRankingIntradayListMetaPagination>, IValidatableObject
    {
        ...
        /// <param name="limit">Non-negative maximum number of entries to return. (default to 10M).</param>
        public SecuritizedDerivativeNotationRankingIntradayListMetaPagination(decimal offset = 0M, decimal limit = 10M)
        {
            this.Offset = offset;
            this.Limit = limit;
        }
