...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_data_lockOut_distance")]
    public partial class InlineResponse2005DataLockOutDistance : IEquatable<InlineResponse2005DataLockOutDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005DataLockOutDistance" /> class.
        /// </summary>
        /// <param name="absolute">absolute.</param>
        /// <param name="relative">relative.</param>
        public InlineResponse2005DataLockOutDistance(InlineResponse2005DataStrikeDistanceAbsolute absolute = default(InlineResponse2005DataStrikeDistanceAbsolute), InlineResponse2005DataStrikeDistanceRelative relative = default(InlineResponse2005DataStrikeDistanceRelative))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2005DataLockOutDistance {\n");
        ...
        {
            return this.Equals(input as InlineResponse2005DataLockOutDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2005DataLockOutDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005DataLockOutDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005DataLockOutDistance input)
        {
            if (input == null)
            {
                return false;
