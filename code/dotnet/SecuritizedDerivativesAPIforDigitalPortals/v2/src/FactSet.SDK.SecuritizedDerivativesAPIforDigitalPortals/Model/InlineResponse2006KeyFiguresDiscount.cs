...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_keyFigures_discount")]
    public partial class InlineResponse2006KeyFiguresDiscount : IEquatable<InlineResponse2006KeyFiguresDiscount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006KeyFiguresDiscount" /> class.
        /// </summary>
        /// <param name="absolute">Discount in absolute terms..</param>
        /// <param name="relative">Discount relative to the underlying level..</param>
        public InlineResponse2006KeyFiguresDiscount(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006KeyFiguresDiscount);
        }

        /// <summary>
        /// Returns true if InlineResponse2006KeyFiguresDiscount instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006KeyFiguresDiscount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006KeyFiguresDiscount input)
        {
            if (input == null)
                return false;
