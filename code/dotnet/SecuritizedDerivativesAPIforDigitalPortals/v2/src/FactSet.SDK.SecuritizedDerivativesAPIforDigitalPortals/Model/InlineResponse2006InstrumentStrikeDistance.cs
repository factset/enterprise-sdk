...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_instrument_strike_distance")]
    public partial class InlineResponse2006InstrumentStrikeDistance : IEquatable<InlineResponse2006InstrumentStrikeDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006InstrumentStrikeDistance" /> class.
        /// </summary>
        ...
        public InlineResponse2006InstrumentStrikeDistance(decimal absolute = default(decimal), decimal relative = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006InstrumentStrikeDistance);
        }

        /// <summary>
        /// Returns true if InlineResponse2006InstrumentStrikeDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006InstrumentStrikeDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006InstrumentStrikeDistance input)
        {
            if (input == null)
            {
                return false;
