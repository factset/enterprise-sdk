...
namespace FactSet.SDK.SecuritizedDerivativesAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_3_data_thetaOneWeek")]
    public partial class InlineResponse2003DataThetaOneWeek : IEquatable<InlineResponse2003DataThetaOneWeek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003DataThetaOneWeek" /> class.
        /// </summary>
        ...
        public InlineResponse2003DataThetaOneWeek(decimal effective = default(decimal), decimal unadjusted = default(decimal))
        {
        ...
        {
            return this.Equals(input as InlineResponse2003DataThetaOneWeek);
        }

        /// <summary>
        /// Returns true if InlineResponse2003DataThetaOneWeek instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003DataThetaOneWeek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003DataThetaOneWeek input)
        {
            if (input == null)
                return false;
