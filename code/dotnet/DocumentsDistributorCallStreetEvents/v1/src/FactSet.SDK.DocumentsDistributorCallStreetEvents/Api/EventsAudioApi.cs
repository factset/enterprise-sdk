...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Api
{
    ...
    public interface IEventsAudioApiSync : IApiAccessor
    {
        ...
        /// <param name="audioSourceId">Unique ID for an Internal recording specific to reportID. For example, ReportID X would have multiple recordings from different source (phone or webcast or vendor or replay). One ReportID can have multiple AudioSource ids. (optional)</param>
        ...
        EventsAudio GetDocsDistributorAudioV1ListFiles(string sort = default(string), int? paginationLimit = default(int?), DateTime? startDate = default(DateTime?), int? paginationOffset = default(int?), DateTime? endDate = default(DateTime?), int? reportId = default(int?), int? audioSourceId = default(int?), string ids = default(string), string sourceCode = default(string), string fileName = default(string), bool? trimmed = default(bool?), int? uploadTime = default(int?));
    ...
    public interface IEventsAudioApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EventsAudio> GetDocsDistributorAudioV1ListFilesAsync(string sort = default(string), int? paginationLimit = default(int?), DateTime? startDate = default(DateTime?), int? paginationOffset = default(int?), DateTime? endDate = default(DateTime?), int? reportId = default(int?), int? audioSourceId = default(int?), string ids = default(string), string sourceCode = default(string), string fileName = default(string), bool? trimmed = default(bool?), int? uploadTime = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
