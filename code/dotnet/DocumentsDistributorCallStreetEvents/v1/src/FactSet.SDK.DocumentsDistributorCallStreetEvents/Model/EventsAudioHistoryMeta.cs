...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Events_Audio_History_meta")]
    public partial class EventsAudioHistoryMeta : IEquatable<EventsAudioHistoryMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsAudioHistoryMeta" /> class.
        /// </summary>
        /// <param name="pagination">pagination.</param>
        /// <param name="partial">partial.</param>
        public EventsAudioHistoryMeta(EventsAudioMetaPagination pagination = default(EventsAudioMetaPagination), NRTSnippetsMetaPartial partial = default(NRTSnippetsMetaPartial))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventsAudioHistoryMeta {\n");
        ...
        {
            return this.Equals(input as EventsAudioHistoryMeta);
        }

        /// <summary>
        /// Returns true if EventsAudioHistoryMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsAudioHistoryMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsAudioHistoryMeta input)
        {
            if (input == null)
            {
                return false;
