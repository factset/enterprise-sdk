...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    public partial class EventsAudioHistoryData : IEquatable<EventsAudioHistoryData>, IValidatableObject
    {
        ...
        /// <param name="trimmed">True  indicates that the pre-signed downloadable URL contains trimmed historical audio recordings and related metadata of a specific year.  False  indicates that the pre-signed downloadable URL contains untrimmed historical audio recordings and related metadata of a specific year..</param>
        ...
        /// </summary>
        /// <value>True  indicates that the pre-signed downloadable URL contains trimmed historical audio recordings and related metadata of a specific year.  False  indicates that the pre-signed downloadable URL contains untrimmed historical audio recordings and related metadata of a specific year.</value>
