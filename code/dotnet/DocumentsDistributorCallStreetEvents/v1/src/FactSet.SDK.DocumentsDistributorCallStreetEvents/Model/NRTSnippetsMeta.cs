...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// NRTSnippetsMeta
    /// </summary>
    [DataContract(Name = "NRT_Snippets_meta")]
    public partial class NRTSnippetsMeta : IEquatable<NRTSnippetsMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NRTSnippetsMeta" /> class.
        /// </summary>
        /// <param name="pagination">pagination.</param>
        /// <param name="partial">partial.</param>
        public NRTSnippetsMeta(NRTSnippetsMetaPagination pagination = default(NRTSnippetsMetaPagination), NRTSnippetsMetaPartial partial = default(NRTSnippetsMetaPartial))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NRTSnippetsMeta {\n");
        ...
        {
            return this.Equals(input as NRTSnippetsMeta);
        }

        /// <summary>
        /// Returns true if NRTSnippetsMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of NRTSnippetsMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NRTSnippetsMeta input)
        {
            if (input == null)
            {
                return false;
