...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Events_Audio_meta_pagination")]
    public partial class EventsAudioMetaPagination : IEquatable<EventsAudioMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsAudioMetaPagination" /> class.
        /// </summary>
        ...
        public EventsAudioMetaPagination(int total = default(int), bool isEstimatedTotal = default(bool), int limit = default(int), int offset = default(int))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as EventsAudioMetaPagination);
        }

        /// <summary>
        /// Returns true if EventsAudioMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsAudioMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsAudioMetaPagination input)
        {
            if (input == null)
                return false;
