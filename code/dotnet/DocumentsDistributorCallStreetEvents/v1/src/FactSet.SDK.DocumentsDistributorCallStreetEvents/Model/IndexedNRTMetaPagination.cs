...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Indexed_NRT_meta_pagination")]
    public partial class IndexedNRTMetaPagination : IEquatable<IndexedNRTMetaPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexedNRTMetaPagination" /> class.
        /// </summary>
        ...
        public IndexedNRTMetaPagination(int total = default(int), bool isEstimatedTotal = default(bool), int limit = default(int), int offset = default(int))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as IndexedNRTMetaPagination);
        }

        /// <summary>
        /// Returns true if IndexedNRTMetaPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexedNRTMetaPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexedNRTMetaPagination input)
        {
            if (input == null)
            {
                return false;
