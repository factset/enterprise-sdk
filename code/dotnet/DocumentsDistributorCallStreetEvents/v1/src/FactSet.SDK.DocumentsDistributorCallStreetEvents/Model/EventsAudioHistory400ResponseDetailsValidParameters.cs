...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    public partial class EventsAudioHistory400ResponseDetailsValidParameters : IEquatable<EventsAudioHistory400ResponseDetailsValidParameters>, IValidatableObject
    {
        ...
        public EventsAudioHistory400ResponseDetailsValidParameters(List<string> paginationLimit = default(List<string>), List<string> paginationOffset = default(List<string>), List<string> year = default(List<string>), List<string> trimmed = default(List<string>))
        {
