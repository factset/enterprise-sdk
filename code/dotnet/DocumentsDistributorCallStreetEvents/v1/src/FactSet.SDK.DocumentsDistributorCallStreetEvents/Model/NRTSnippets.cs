...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NRT-Snippets")]
    public partial class NRTSnippets : IEquatable<NRTSnippets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NRTSnippets" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public NRTSnippets(List<NRTSnippetsData> data = default(List<NRTSnippetsData>), NRTSnippetsMeta meta = default(NRTSnippetsMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<NRTSnippetsData> Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public NRTSnippetsMeta Meta { get; set; }
        ...
        {
            return this.Equals(input as NRTSnippets);
        }

        /// <summary>
        /// Returns true if NRTSnippets instances are equal
        /// </summary>
        /// <param name="input">Instance of NRTSnippets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NRTSnippets input)
        {
            if (input == null)
            {
                return false;
