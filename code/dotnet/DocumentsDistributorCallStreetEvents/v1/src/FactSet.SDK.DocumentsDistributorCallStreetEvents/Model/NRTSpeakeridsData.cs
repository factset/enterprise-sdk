...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    public partial class NRTSpeakeridsData : IEquatable<NRTSpeakeridsData>, IValidatableObject
    {
        ...
        /// <param name="cosineScore">The cosine similarity score (Confidence score)  for a particular speaker.  A score &gt;&#x3D; 0.49 while a speaker is speaking can be considered as a high confidence in the predicted speaker.  Only the SpeakerIDs with the highest cosineScore are rendered in the result set..</param>
        /// <param name="affiliationId">Affiliation ID denotes the company a speaker is associated with..</param>
        public NRTSpeakeridsData(int? audioSourceId = default(int?), decimal? speakerStartOffset = default(decimal?), string speakerId = default(string), decimal? cosineScore = default(decimal?), string affiliationId = default(string))
        {
        ...
        /// </summary>
        /// <value>The cosine similarity score (Confidence score)  for a particular speaker.  A score &gt;&#x3D; 0.49 while a speaker is speaking can be considered as a high confidence in the predicted speaker.  Only the SpeakerIDs with the highest cosineScore are rendered in the result set.</value>
        ...
        /// </summary>
        /// <value>Affiliation ID denotes the company a speaker is associated with.</value>
