...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Events_Audio_400_Response_details")]
    public partial class EventsAudio400ResponseDetails : IEquatable<EventsAudio400ResponseDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsAudio400ResponseDetails" /> class.
        /// </summary>
        /// <param name="validParameters">validParameters.</param>
        public EventsAudio400ResponseDetails(EventsAudio400ResponseDetailsValidParameters validParameters = default(EventsAudio400ResponseDetailsValidParameters))
        {
        ...
        public EventsAudio400ResponseDetailsValidParameters ValidParameters { get; set; }
        ...
        {
            return this.Equals(input as EventsAudio400ResponseDetails);
        }

        /// <summary>
        /// Returns true if EventsAudio400ResponseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsAudio400ResponseDetails to be compared</param>
        /// <returns>Boolean</returns>
