...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NRT_Snippets_400_Response_details_validParameters")]
    public partial class NRTSnippets400ResponseDetailsValidParameters : IEquatable<NRTSnippets400ResponseDetailsValidParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NRTSnippets400ResponseDetailsValidParameters" /> class.
        /// </summary>
        ...
        public NRTSnippets400ResponseDetailsValidParameters(List<string> paginationLimit = default(List<string>), List<string> paginationOffset = default(List<string>), List<string> audioSourceId = default(List<string>), List<string> reportId = default(List<string>))
        {
        ...
        {
            return this.Equals(input as NRTSnippets400ResponseDetailsValidParameters);
        }

        /// <summary>
        /// Returns true if NRTSnippets400ResponseDetailsValidParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of NRTSnippets400ResponseDetailsValidParameters to be compared</param>
        /// <returns>Boolean</returns>
