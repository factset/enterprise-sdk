...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// NRTSnippetsMetadata
    /// </summary>
    [DataContract(Name = "NRT_Snippets_metadata")]
    public partial class NRTSnippetsMetadata : IEquatable<NRTSnippetsMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NRTSnippetsMetadata" /> class.
        /// </summary>
        ...
        public NRTSnippetsMetadata(string transcript = default(string), decimal endTime = default(decimal), decimal startTime = default(decimal))
        {
        ...
        {
            return this.Equals(input as NRTSnippetsMetadata);
        }

        /// <summary>
        /// Returns true if NRTSnippetsMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of NRTSnippetsMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NRTSnippetsMetadata input)
        {
            if (input == null)
                return false;
