...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Events_Audio_History_400_Response_details")]
    public partial class EventsAudioHistory400ResponseDetails : IEquatable<EventsAudioHistory400ResponseDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsAudioHistory400ResponseDetails" /> class.
        /// </summary>
        /// <param name="validParameters">validParameters.</param>
        public EventsAudioHistory400ResponseDetails(EventsAudioHistory400ResponseDetailsValidParameters validParameters = default(EventsAudioHistory400ResponseDetailsValidParameters))
        {
        ...
        public EventsAudioHistory400ResponseDetailsValidParameters ValidParameters { get; set; }
        ...
        {
            return this.Equals(input as EventsAudioHistory400ResponseDetails);
        }

        /// <summary>
        /// Returns true if EventsAudioHistory400ResponseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsAudioHistory400ResponseDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsAudioHistory400ResponseDetails input)
        {
            if (input == null)
            {
                return false;
