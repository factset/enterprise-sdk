...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NRT-Speakerids")]
    public partial class NRTSpeakerids : IEquatable<NRTSpeakerids>, IValidatableObject
    {
        ...
        public NRTSpeakerids(List<NRTSpeakeridsData> data = default(List<NRTSpeakeridsData>), NRTSpeakeridsMeta meta = default(NRTSpeakeridsMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<NRTSpeakeridsData> Data { get; set; }
