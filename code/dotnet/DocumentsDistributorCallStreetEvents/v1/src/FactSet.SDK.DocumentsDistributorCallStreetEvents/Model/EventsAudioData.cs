...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    public partial class EventsAudioData : IEquatable<EventsAudioData>, IValidatableObject
    {
        ...
        /// <param name="reportId">The unique ID of the audio file for an event. The same ID is used for the transcript of the same event.</param>
        ...
        /// <param name="trimmed">The trimmed attribute helps identify if the audio is the trimmed version.</param>
        ...
        /// <param name="audioSourceId">Unique ID for an Internal recording specific to reportID. For example, ReportID X would have multiple recordings from different source (Phone or Webcast or Vendor or Replay). One ReportID can have multiple AudioSource ids..</param>
        ...
        [DataMember(Name = "durationSecs", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The unique ID of the audio file for an event. The same ID is used for the transcript of the same event</value>
        ...
        /// </summary>
        /// <value>The trimmed attribute helps identify if the audio is the trimmed version</value>
        ...
        /// </summary>
        /// <value>Unique ID for an Internal recording specific to reportID. For example, ReportID X would have multiple recordings from different source (Phone or Webcast or Vendor or Replay). One ReportID can have multiple AudioSource ids.</value>
