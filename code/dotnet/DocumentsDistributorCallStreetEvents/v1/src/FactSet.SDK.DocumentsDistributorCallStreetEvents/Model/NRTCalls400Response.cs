...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    public partial class NRTCalls400Response : IEquatable<NRTCalls400Response>, IValidatableObject
    {
        ...
        public NRTCalls400Response(string id = default(string), string code = default(string), string title = default(string), NRTCalls400ResponseDetails details = default(NRTCalls400ResponseDetails))
        {
            this.Id = id;
            this.Code = code;
            this.Title = title;
