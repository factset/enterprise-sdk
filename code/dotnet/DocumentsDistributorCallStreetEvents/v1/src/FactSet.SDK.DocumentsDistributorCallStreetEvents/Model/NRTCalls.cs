...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NRT-Calls")]
    public partial class NRTCalls : IEquatable<NRTCalls>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NRTCalls" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public NRTCalls(List<NRTCallsData> data = default(List<NRTCallsData>), NRTCallsMeta meta = default(NRTCallsMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<NRTCallsData> Data { get; set; }
        ...
        {
            return this.Equals(input as NRTCalls);
        }

        /// <summary>
        /// Returns true if NRTCalls instances are equal
        /// </summary>
        /// <param name="input">Instance of NRTCalls to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NRTCalls input)
        {
            if (input == null)
            {
                return false;
