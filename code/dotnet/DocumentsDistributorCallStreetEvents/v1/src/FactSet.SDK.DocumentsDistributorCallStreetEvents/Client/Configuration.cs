...
namespace FactSet.SDK.DocumentsDistributorCallStreetEvents.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/DocumentsDistributorCallStreetEvents/0.21.16";
        ...
        {
            string report = "C# SDK (FactSet.SDK.DocumentsDistributorCallStreetEvents) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.8.3\n";
            report += "    SDK Package Version: 0.21.16\n";
