...
namespace FactSet.SDK.OpenRisk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/OpenRisk/0.21.1";
            BasePath = "https://api.factset.com/analytics/openrisk";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/analytics/openrisk") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.21.0\n";
