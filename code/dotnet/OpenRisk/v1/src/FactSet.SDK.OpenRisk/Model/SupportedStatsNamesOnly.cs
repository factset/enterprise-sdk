...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    public partial class SupportedStatsNamesOnly : IEquatable<SupportedStatsNamesOnly>, IValidatableObject
    {
        ...
        protected SupportedStatsNamesOnly() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SupportedStatsNamesOnly" /> class.
        /// </summary>
        ...
        public SupportedStatsNamesOnly(List<string> data)
        {
            ...
            if (data == null) {
                throw new ArgumentNullException("data is a required property for SupportedStatsNamesOnly and cannot be null");
            }
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as SupportedStatsNamesOnly);
        }

        /// <summary>
        /// Returns true if SupportedStatsNamesOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of SupportedStatsNamesOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupportedStatsNamesOnly input)
        {
            if (input == null)
            {
                return false;
