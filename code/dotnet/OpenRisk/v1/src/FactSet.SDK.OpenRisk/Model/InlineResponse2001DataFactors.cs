...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_data_factors")]
    public partial class InlineResponse2001DataFactors : IEquatable<InlineResponse2001DataFactors>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataFactors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2001DataFactors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001DataFactors" /> class.
        /// </summary>
        ...
        public InlineResponse2001DataFactors(DefinedAsEnum definedAs, string id, string name)
        {
            this.DefinedAs = definedAs;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for InlineResponse2001DataFactors and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for InlineResponse2001DataFactors and cannot be null");
            }
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as InlineResponse2001DataFactors);
        }

        /// <summary>
        /// Returns true if InlineResponse2001DataFactors instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001DataFactors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001DataFactors input)
        {
            if (input == null)
            {
                return false;
