...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Labels_security")]
    public partial class LabelsSecurity : IEquatable<LabelsSecurity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelsSecurity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LabelsSecurity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelsSecurity" /> class.
        /// </summary>
        ...
        public LabelsSecurity(List<string> ids,InputToResultSecurityIndexMapping indicesInputToResult = default(InputToResultSecurityIndexMapping), ResultToInputSecurityIndexMapping indicesResultToInput = default(ResultToInputSecurityIndexMapping))
        {
            // to ensure "ids" is required (not null)
            if (ids == null) {
                throw new ArgumentNullException("ids is a required property for LabelsSecurity and cannot be null");
            }
            this.Ids = ids;
        ...
        {
            return this.Equals(input as LabelsSecurity);
        }

        /// <summary>
        /// Returns true if LabelsSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelsSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelsSecurity input)
        {
            if (input == null)
            {
                return false;
