...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InputToResultSecurityIndexMapping")]
    public partial class InputToResultSecurityIndexMapping : IEquatable<InputToResultSecurityIndexMapping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InputToResultSecurityIndexMapping" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InputToResultSecurityIndexMapping() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InputToResultSecurityIndexMapping" /> class.
        /// </summary>
        ...
        public InputToResultSecurityIndexMapping(List<int> portfolio,List<int> benchmark = default(List<int>), List<int> market = default(List<int>))
        {
            // to ensure "portfolio" is required (not null)
            if (portfolio == null) {
                throw new ArgumentNullException("portfolio is a required property for InputToResultSecurityIndexMapping and cannot be null");
            }
        ...
        {
            return this.Equals(input as InputToResultSecurityIndexMapping);
        }

        /// <summary>
        /// Returns true if InputToResultSecurityIndexMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of InputToResultSecurityIndexMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InputToResultSecurityIndexMapping input)
        {
            if (input == null)
            {
                return false;
