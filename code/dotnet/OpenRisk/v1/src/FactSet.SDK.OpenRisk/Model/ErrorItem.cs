...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    public partial class ErrorItem : IEquatable<ErrorItem>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ErrorItem" /> class.
        /// </summary>
        /// <param name="id">UUID for the particular occurrence of the problem (required).</param>
        /// <param name="code">Error code for the problem type. (required).</param>
        /// <param name="title">Human-readable summary of the problem tied to the error code and not specific to the particular occurrence of the problem (required).</param>
        /// <param name="detail">Human-readable explanation of the problem specific to the particular occurrence.</param>
        public ErrorItem(string id, string code, string title,string detail = default(string))
        {
        ...
        /// </summary>
        /// <value>UUID for the particular occurrence of the problem</value>
        ...
        /// </summary>
        /// <value>Error code for the problem type.</value>
        ...
        /// </summary>
        /// <value>Human-readable summary of the problem tied to the error code and not specific to the particular occurrence of the problem</value>
        ...
        /// </summary>
        /// <value>Human-readable explanation of the problem specific to the particular occurrence</value>
