...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    public partial class InlineResponse200Data : IEquatable<InlineResponse200Data>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineResponse200Data" /> class.
        /// </summary>
        /// <param name="available">If the model is available for use (required).</param>
        ...
        public InlineResponse200Data(bool available, string category, string code, string name, string vendor)
        {
            this.Available = available;
            // to ensure "category" is required (not null)
            if (category == null) {
                throw new ArgumentNullException("category is a required property for InlineResponse200Data and cannot be null");
            }
            this.Category = category;
            // to ensure "code" is required (not null)
            if (code == null) {
                throw new ArgumentNullException("code is a required property for InlineResponse200Data and cannot be null");
            }
            this.Code = code;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for InlineResponse200Data and cannot be null");
            }
            this.Name = name;
            // to ensure "vendor" is required (not null)
            if (vendor == null) {
                throw new ArgumentNullException("vendor is a required property for InlineResponse200Data and cannot be null");
            }
            this.Vendor = vendor;
        }
        ...
        /// </summary>
        /// <value>If the model is available for use</value>
