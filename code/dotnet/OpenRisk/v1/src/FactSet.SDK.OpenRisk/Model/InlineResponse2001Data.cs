...
namespace FactSet.SDK.OpenRisk.Model
{
    ...
    public partial class InlineResponse2001Data : IEquatable<InlineResponse2001Data>, IValidatableObject
    {
        ...
        public InlineResponse2001Data(bool available, string category, string code, string name, string vendor)
        {
            this.Available = available;
            // to ensure "category" is required (not null)
            if (category == null) {
                throw new ArgumentNullException("category is a required property for InlineResponse2001Data and cannot be null");
            }
