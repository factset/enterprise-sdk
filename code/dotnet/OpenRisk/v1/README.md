...
dotnet add package FactSet.SDK.OpenRisk -v 4.0.1
```
...
nuget install FactSet.SDK.OpenRisk -Version 4.0.1
```
...
## Documentation for Models
 ...
 - [Model.SupportedStatDetailsLevels](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/OpenRisk/v1/docs/SupportedStatDetailsLevels.md)
