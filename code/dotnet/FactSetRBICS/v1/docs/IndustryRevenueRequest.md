# FactSet.SDK.FactSetRBICS.Model.IndustryRevenueRequest
...
------------ | ------------- | ------------- | -------------
**RbicsIds** | **List&lt;string&gt;** | RBICS Level 6 Sub-Industry ID Filter. **Note**: Only Level 6 IDs are supported for this endpoint. A complete list of valid Level 6 IDs can be retrieved using the &#x60;/structure&#x60; endpoints. | 
