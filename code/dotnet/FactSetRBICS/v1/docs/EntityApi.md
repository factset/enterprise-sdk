# FactSet.SDK.FactSetRBICS.Api.EntityApi
...
namespace Example
{
    public class GetRbicsEntityFocusForListExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling EntityApi.GetRbicsEntityFocusForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getrbicsentityrevenue"></a>
# **GetRbicsEntityRevenue**
> EntityResponse GetRbicsEntityRevenue (List<string> ids, DateTime? startDate = null, DateTime? endDate = null, int? level = null)
...
namespace Example
{
    public class GetRbicsEntityRevenueExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetRBICS.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling EntityApi.GetRbicsEntityRevenue: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getrbicsentityrevenueforlist"></a>
...
namespace Example
{
    public class GetRbicsEntityRevenueForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetRBICS.Client.Configuration();
            ...
            var entityRequest = new EntityRequest(); // EntityRequest | Request Body to request a list of Entity Revenue objects.
            ...
            {
                Console.WriteLine("Exception when calling EntityApi.GetRbicsEntityRevenueForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
