...
namespace FactSet.SDK.FactSetRBICS.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TradeNamesRequest")]
    public partial class TradeNamesRequest : IEquatable<TradeNamesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeNamesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TradeNamesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeNamesRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public TradeNamesRequest(TradeNamesRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for TradeNamesRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public TradeNamesRequestBody Data { get; set; }
        ...
        {
            return this.Equals(input as TradeNamesRequest);
        }

        /// <summary>
        /// Returns true if TradeNamesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeNamesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeNamesRequest input)
        {
            if (input == null)
            {
                return false;
