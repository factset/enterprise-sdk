...
namespace FactSet.SDK.FactSetRBICS.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IndustryFocusResponse")]
    public partial class IndustryFocusResponse : IEquatable<IndustryFocusResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndustryFocusResponse" /> class.
        /// </summary>
        /// <param name="data">Array of Industry Objects.</param>
        public IndustryFocusResponse(List<Industries> data = default(List<Industries>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Array of Industry Objects</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<Industries> Data { get; set; }
        ...
        {
            return this.Equals(input as IndustryFocusResponse);
        }

        /// <summary>
        /// Returns true if IndustryFocusResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IndustryFocusResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndustryFocusResponse input)
        {
            if (input == null)
            {
                return false;
