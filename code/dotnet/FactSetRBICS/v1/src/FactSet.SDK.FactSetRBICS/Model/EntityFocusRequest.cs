...
namespace FactSet.SDK.FactSetRBICS.Model
{
    ...
    public partial class EntityFocusRequest : IEquatable<EntityFocusRequest>, IValidatableObject
    {
        ...
        public EntityFocusRequest(List<string> ids = default(List<string>), DateTime date = default(DateTime), HashSet<int> levels = default(HashSet<int>), bool includeNames = true)
        {
            this.Ids = ids;
            this.Date = date;
            this.Levels = levels;
