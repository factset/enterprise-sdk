...
namespace FactSet.SDK.FactSetRBICS.Model
{
    ...
    /// TradeNames Response
    /// </summary>
    [DataContract(Name = "TradeNamesResponse")]
    public partial class TradeNamesResponse : IEquatable<TradeNamesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeNamesResponse" /> class.
        /// </summary>
        /// <param name="data">Array of Tradename Objects.</param>
        public TradeNamesResponse(List<TradeName> data = default(List<TradeName>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Array of Tradename Objects</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<TradeName> Data { get; set; }
        ...
        {
            return this.Equals(input as TradeNamesResponse);
        }

        /// <summary>
        /// Returns true if TradeNamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeNamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeNamesResponse input)
        {
            if (input == null)
            {
                return false;
