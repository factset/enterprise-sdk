...
namespace FactSet.SDK.FactSetRBICS.Model
{
    ...
    public partial class StructureRequest : IEquatable<StructureRequest>, IValidatableObject
    {
        ...
        public StructureRequest(List<string> rbicsIds = default(List<string>), int level = default(int), bool includeNames = true, DateTime date = default(DateTime))
        {
