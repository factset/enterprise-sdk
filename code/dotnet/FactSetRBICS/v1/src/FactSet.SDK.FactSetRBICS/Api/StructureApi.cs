...
namespace FactSet.SDK.FactSetRBICS.Api
{
    ...
    public interface IStructureApiSync : IApiAccessor
    {
        ...
        /// <param name="rbicsIds">RBICS Taxonomy Id Filter. Use to lookup the structure details for the Id requested, or to screen for companies by industry.  (optional)</param>
