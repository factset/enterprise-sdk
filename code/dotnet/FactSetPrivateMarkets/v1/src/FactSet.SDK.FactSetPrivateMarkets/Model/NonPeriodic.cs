...
namespace FactSet.SDK.FactSetPrivateMarkets.Model
{
    ...
    public partial class NonPeriodic : Dictionary<String, Object>, IEquatable<NonPeriodic>, IValidatableObject
    {
        /// <summary>
        ...
        public NonPeriodic(string fsymId = default(string), string requestId = default(string)) : base()
        {
            this.FsymId = fsymId;
