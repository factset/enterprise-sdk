...
namespace FactSet.SDK.FactSetPrivateMarkets.Model
{
    ...
    public partial class FieldsResponse : IEquatable<FieldsResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Array of field objects representing the data items that can be requested from the Private Markets API. .</param>
        public FieldsResponse(List<Field> data = default(List<Field>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Array of field objects representing the data items that can be requested from the Private Markets API. </value>
