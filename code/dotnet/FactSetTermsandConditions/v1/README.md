...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.9-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetTermsandConditions/2.0.9)
...
dotnet add package FactSet.SDK.FactSetTermsandConditions -v 2.0.9
```
...
nuget install FactSet.SDK.FactSetTermsandConditions -Version 2.0.9
```
