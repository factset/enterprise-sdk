# FactSet.SDK.FactSetTermsandConditions.Api.UnderwritersApi
...
namespace Example
{
    public class GetLeadUnderwritersExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new UnderwritersApi(config);
            ...
            {
                // Return Lead Underwriters for a Fixed Income security.
                LeadUnderwritersResponse result = apiInstance.GetLeadUnderwriters(ids);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling UnderwritersApi.GetLeadUnderwriters: " + e.Message );
...
<a name="getleadunderwritersforlist"></a>
...
namespace Example
{
    public class GetLeadUnderwritersForListExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.FactSetTermsandConditions.Client.Configuration();
            ...
            var termsAndConditionsScalarRequest = new TermsAndConditionsScalarRequest(); // TermsAndConditionsScalarRequest | Request object for Fixed Income Lead Underwriters.

            try
            {
                // Return Lead Underwriters for a list of Fixed Income securities.
                LeadUnderwritersResponse result = apiInstance.GetLeadUnderwritersForList(termsAndConditionsScalarRequest);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling UnderwritersApi.GetLeadUnderwritersForList: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
