...
namespace Example
{
    public class GetLeadUnderwritersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UnderwritersApi.GetLeadUnderwriters: " + e.Message );
...
namespace Example
{
    public class GetLeadUnderwritersForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UnderwritersApi.GetLeadUnderwritersForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
