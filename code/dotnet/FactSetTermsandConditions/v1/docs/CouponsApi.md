...
namespace Example
{
    public class GetCouponHistoryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CouponsApi.GetCouponHistory: " + e.Message );
...
namespace Example
{
    public class GetCouponHistoryForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CouponsApi.GetCouponHistoryForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCouponSchedulesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CouponsApi.GetCouponSchedules: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCouponSchedulesForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CouponsApi.GetCouponSchedulesForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
