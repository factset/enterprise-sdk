...
namespace Example
{
    public class GetCovenantDetailsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CovenantsApi.GetCovenantDetails: " + e.Message );
...
namespace Example
{
    public class GetCovenantDetailsForListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CovenantsApi.GetCovenantDetailsForList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
