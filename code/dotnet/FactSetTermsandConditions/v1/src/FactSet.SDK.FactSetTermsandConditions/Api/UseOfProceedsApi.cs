...
namespace FactSet.SDK.FactSetTermsandConditions.Api
{
    ...
    public partial class UseOfProceedsApi : IUseOfProceedsApi
    {
        ...
        {
            FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse> localVarResponse = GetFixedIncomeUseOfProceedsWithHttpInfo(ids);
        ...
        /// <param name="ids">List of Fixed Income Security identifiers. Supported symbol types include CUSIP, SEDOL, ISIN, and FactSet Security Permanent Identifier (-S).  **ID LIMIT &#x3D; 250** *per request*. </param>
        /// <returns>ApiResponse of UseOfProceedsResponse</returns>
        public FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse> GetFixedIncomeUseOfProceedsWithHttpInfo(List<string> ids)
        {
            ...
            var localVarResponse = this.Client.Get<UseOfProceedsResponse>("/factset-terms-and-conditions/v1/use-of-proceeds", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse> localVarResponse = await GetFixedIncomeUseOfProceedsWithHttpInfoAsync(ids, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UseOfProceedsResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse>> GetFixedIncomeUseOfProceedsWithHttpInfoAsync(List<string> ids, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new FactSet.SDK.FactSetTermsandConditions.Client.ApiException(400, "Missing required parameter 'ids' when calling UseOfProceedsApi->GetFixedIncomeUseOfProceeds");
        ...
        {
            FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse> localVarResponse = GetFixedIncomeUseOfProceedsForListWithHttpInfo(termsAndConditionsScalarRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="termsAndConditionsScalarRequest">Request object for Fixed Income Use of Proceeds.</param>
        /// <returns>ApiResponse of UseOfProceedsResponse</returns>
        public FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse> GetFixedIncomeUseOfProceedsForListWithHttpInfo(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<UseOfProceedsResponse>("/factset-terms-and-conditions/v1/use-of-proceeds", localVarRequestOptions, this.Configuration);
        ...
        {
            FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse> localVarResponse = await GetFixedIncomeUseOfProceedsForListWithHttpInfoAsync(termsAndConditionsScalarRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UseOfProceedsResponse)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.FactSetTermsandConditions.Client.ApiResponse<UseOfProceedsResponse>> GetFixedIncomeUseOfProceedsForListWithHttpInfoAsync(TermsAndConditionsScalarRequest termsAndConditionsScalarRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'termsAndConditionsScalarRequest' is set
            if (termsAndConditionsScalarRequest == null)
                throw new FactSet.SDK.FactSetTermsandConditions.Client.ApiException(400, "Missing required parameter 'termsAndConditionsScalarRequest' when calling UseOfProceedsApi->GetFixedIncomeUseOfProceedsForList");
