...
namespace FactSet.SDK.WatchlistAPIforDigitalPortals.Model
{
    ...
    public partial class WatchlistPositionModifyData : IEquatable<WatchlistPositionModifyData>, IValidatableObject
    {
        ...
        public WatchlistPositionModifyData(string id, WatchlistPositionModifyDataPosition position,WatchlistPositionCreateDataNotation notation = default(WatchlistPositionCreateDataNotation), string comment = default(string))
        {
