...
namespace FactSet.SDK.WatchlistAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2001Data : IEquatable<InlineResponse2001Data>, IValidatableObject
    {
        ...
        public InlineResponse2001Data(string id = default(string), string name = default(string), decimal numberPositions = default(decimal), string creation = default(string))
        {
            this.Id = id;
            this.Name = name;
