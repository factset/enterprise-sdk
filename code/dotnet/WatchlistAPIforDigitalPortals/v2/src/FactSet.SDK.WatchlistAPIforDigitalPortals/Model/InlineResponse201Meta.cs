...
namespace FactSet.SDK.WatchlistAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_201_meta")]
    public partial class InlineResponse201Meta : IEquatable<InlineResponse201Meta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse201Meta" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public InlineResponse201Meta(StatusObject status = default(StatusObject))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse201Meta {\n");
        ...
        {
            return this.Equals(input as InlineResponse201Meta);
        }

        /// <summary>
        /// Returns true if InlineResponse201Meta instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse201Meta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse201Meta input)
        {
            if (input == null)
            {
                return false;
