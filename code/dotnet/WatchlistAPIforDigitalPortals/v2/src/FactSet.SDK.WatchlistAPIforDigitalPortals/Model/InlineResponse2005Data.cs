...
namespace FactSet.SDK.WatchlistAPIforDigitalPortals.Model
{
    ...
    public partial class InlineResponse2005Data : IEquatable<InlineResponse2005Data>, IValidatableObject
    {
        ...
        public InlineResponse2005Data(decimal id = default(decimal), InlineResponse2005Notation notation = default(InlineResponse2005Notation), string comment = default(string))
        {
            this.Id = id;
