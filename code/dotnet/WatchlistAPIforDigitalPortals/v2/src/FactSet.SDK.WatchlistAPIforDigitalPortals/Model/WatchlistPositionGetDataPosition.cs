...
namespace FactSet.SDK.WatchlistAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_watchlist_position_get_data_position")]
    public partial class WatchlistPositionGetDataPosition : IEquatable<WatchlistPositionGetDataPosition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WatchlistPositionGetDataPosition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WatchlistPositionGetDataPosition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WatchlistPositionGetDataPosition" /> class.
        /// </summary>
        /// <param name="id">Identifier of the position (required).</param>
        public WatchlistPositionGetDataPosition(decimal id)
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WatchlistPositionGetDataPosition {\n");
        ...
        {
            return this.Equals(input as WatchlistPositionGetDataPosition);
        }

        /// <summary>
        /// Returns true if WatchlistPositionGetDataPosition instances are equal
        /// </summary>
        /// <param name="input">Instance of WatchlistPositionGetDataPosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WatchlistPositionGetDataPosition input)
        {
            if (input == null)
            {
                return false;
