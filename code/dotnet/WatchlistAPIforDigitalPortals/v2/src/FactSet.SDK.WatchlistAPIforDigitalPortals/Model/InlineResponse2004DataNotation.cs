...
namespace FactSet.SDK.WatchlistAPIforDigitalPortals.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_data_notation")]
    public partial class InlineResponse2004DataNotation : IEquatable<InlineResponse2004DataNotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004DataNotation" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notation..</param>
        public InlineResponse2004DataNotation(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse2004DataNotation);
        }

        /// <summary>
        /// Returns true if InlineResponse2004DataNotation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004DataNotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004DataNotation input)
        {
            if (input == null)
            {
                return false;
