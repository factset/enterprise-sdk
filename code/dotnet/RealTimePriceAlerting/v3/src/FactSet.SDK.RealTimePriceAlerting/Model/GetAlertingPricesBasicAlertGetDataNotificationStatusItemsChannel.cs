...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertGetDataNotificationStatusItems_channel")]
    public partial class GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel : IEquatable<GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel {\n");
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel input)
        {
            if (input == null)
            {
                return false;
