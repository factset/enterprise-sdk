...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_data_status")]
    public partial class InlineResponse2002DataStatus : IEquatable<InlineResponse2002DataStatus>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002DataStatus" /> class.
        /// </summary>
        ...
        public InlineResponse2002DataStatus(CodeEnum? code = default(CodeEnum?), string details = default(string), string encryptedDetails = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as InlineResponse2002DataStatus);
        }

        /// <summary>
        /// Returns true if InlineResponse2002DataStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002DataStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002DataStatus input)
        {
            if (input == null)
            {
                return false;
