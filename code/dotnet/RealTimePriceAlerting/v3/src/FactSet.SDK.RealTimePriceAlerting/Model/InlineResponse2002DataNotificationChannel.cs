...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_data_notification_channel")]
    public partial class InlineResponse2002DataNotificationChannel : IEquatable<InlineResponse2002DataNotificationChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002DataNotificationChannel" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public InlineResponse2002DataNotificationChannel(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2002DataNotificationChannel {\n");
        ...
        {
            return this.Equals(input as InlineResponse2002DataNotificationChannel);
        }

        /// <summary>
        /// Returns true if InlineResponse2002DataNotificationChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002DataNotificationChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002DataNotificationChannel input)
        {
            if (input == null)
            {
                return false;
