...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_trigger_notification_channel")]
    public partial class InlineResponse200DataTriggerNotificationChannel : IEquatable<InlineResponse200DataTriggerNotificationChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataTriggerNotificationChannel" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public InlineResponse200DataTriggerNotificationChannel(List<decimal> id = default(List<decimal>))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse200DataTriggerNotificationChannel);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataTriggerNotificationChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataTriggerNotificationChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataTriggerNotificationChannel input)
        {
            if (input == null)
            {
                return false;
