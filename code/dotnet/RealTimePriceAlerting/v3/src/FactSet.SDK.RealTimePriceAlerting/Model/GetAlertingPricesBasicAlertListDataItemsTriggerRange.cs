...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataItems_trigger_range")]
    public partial class GetAlertingPricesBasicAlertListDataItemsTriggerRange : IEquatable<GetAlertingPricesBasicAlertListDataItemsTriggerRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataItemsTriggerRange" /> class.
        /// </summary>
        /// <param name="upperLimit">Upper limit..</param>
        /// <param name="lowerLimit">Lower limit..</param>
        public GetAlertingPricesBasicAlertListDataItemsTriggerRange(decimal? upperLimit = default(decimal?), decimal? lowerLimit = default(decimal?))
        {
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataItemsTriggerRange);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataItemsTriggerRange instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataItemsTriggerRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataItemsTriggerRange input)
        {
            if (input == null)
            {
                return false;
