...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    public partial class InlineResponse2002Data : IEquatable<InlineResponse2002Data>, IValidatableObject
    {
        ...
        public InlineResponse2002Data(string id = default(string), DateTime? creation = default(DateTime?), InlineResponse200DataTriggerNotation notation = default(InlineResponse200DataTriggerNotation), InlineResponse2002DataPrice price = default(InlineResponse2002DataPrice), InlineResponse2002DataRange range = default(InlineResponse2002DataRange), string comment = default(string), InlineResponse2002DataNotification notification = default(InlineResponse2002DataNotification), InlineResponse2002DataStatus status = default(InlineResponse2002DataStatus))
        {
            this.Id = id;
        ...
        public InlineResponse2002DataPrice Price { get; set; }
        ...
        public InlineResponse2002DataNotification Notification { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name = "status", EmitDefaultValue = false)]
        public InlineResponse2002DataStatus Status { get; set; }
