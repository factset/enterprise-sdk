...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    public partial class InlineResponse2002Data : IEquatable<InlineResponse2002Data>, IValidatableObject
    {
        ...
        public InlineResponse2002Data(string id = default(string), string creation = default(string), InlineResponse200DataTriggerNotation notation = default(InlineResponse200DataTriggerNotation), InlineResponse2001TriggerPrice price = default(InlineResponse2001TriggerPrice), InlineResponse200DataTriggerRange range = default(InlineResponse200DataTriggerRange), string comment = default(string), InlineResponse2002DataNotification notification = default(InlineResponse2002DataNotification), InlineResponse200DataTriggerStatus status = default(InlineResponse200DataTriggerStatus))
        {
            this.Id = id;
