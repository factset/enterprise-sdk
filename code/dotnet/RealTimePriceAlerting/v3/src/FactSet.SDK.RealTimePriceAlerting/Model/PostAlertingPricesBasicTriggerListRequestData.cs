...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListRequest_data")]
    public partial class PostAlertingPricesBasicTriggerListRequestData : IEquatable<PostAlertingPricesBasicTriggerListRequestData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListRequestData" /> class.
        /// </summary>
        /// <param name="filter">filter.</param>
        public PostAlertingPricesBasicTriggerListRequestData(PostAlertingPricesBasicTriggerListRequestDataFilter filter = default(PostAlertingPricesBasicTriggerListRequestDataFilter))
        {
            this.Filter = filter;
        }
        ...
        public PostAlertingPricesBasicTriggerListRequestDataFilter Filter { get; set; }
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListRequestData);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListRequestData input)
        {
            if (input == null)
            {
                return false;
