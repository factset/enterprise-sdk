...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_data_price")]
    public partial class InlineResponse2002DataPrice : IEquatable<InlineResponse2002DataPrice>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002DataPrice" /> class.
        /// </summary>
        ...
        public InlineResponse2002DataPrice(TypeEnum? type = default(TypeEnum?), QualityEnum? quality = default(QualityEnum?))
        {
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2002DataPrice {\n");
        ...
        {
            return this.Equals(input as InlineResponse2002DataPrice);
        }

        /// <summary>
        /// Returns true if InlineResponse2002DataPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002DataPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002DataPrice input)
        {
            if (input == null)
            {
                return false;
