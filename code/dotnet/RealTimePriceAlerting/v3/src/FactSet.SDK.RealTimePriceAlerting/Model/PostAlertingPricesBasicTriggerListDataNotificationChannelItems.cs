...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListDataNotificationChannelItems")]
    public partial class PostAlertingPricesBasicTriggerListDataNotificationChannelItems : IEquatable<PostAlertingPricesBasicTriggerListDataNotificationChannelItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListDataNotificationChannelItems" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public PostAlertingPricesBasicTriggerListDataNotificationChannelItems(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostAlertingPricesBasicTriggerListDataNotificationChannelItems {\n");
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListDataNotificationChannelItems);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListDataNotificationChannelItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListDataNotificationChannelItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListDataNotificationChannelItems input)
        {
            if (input == null)
            {
                return false;
