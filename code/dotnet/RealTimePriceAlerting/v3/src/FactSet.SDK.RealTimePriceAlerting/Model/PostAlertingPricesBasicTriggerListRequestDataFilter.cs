...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListRequest_data_filter")]
    public partial class PostAlertingPricesBasicTriggerListRequestDataFilter : IEquatable<PostAlertingPricesBasicTriggerListRequestDataFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListRequestDataFilter" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public PostAlertingPricesBasicTriggerListRequestDataFilter(PostAlertingPricesBasicTriggerListRequestDataFilterStatus status = default(PostAlertingPricesBasicTriggerListRequestDataFilterStatus))
        {
            this.Status = status;
        }
        ...
        public PostAlertingPricesBasicTriggerListRequestDataFilterStatus Status { get; set; }
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListRequestDataFilter);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListRequestDataFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListRequestDataFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListRequestDataFilter input)
        {
            if (input == null)
            {
                return false;
