...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// Request Body
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListRequest")]
    public partial class PostAlertingPricesBasicTriggerListRequest : IEquatable<PostAlertingPricesBasicTriggerListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostAlertingPricesBasicTriggerListRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="meta">meta.</param>
        public PostAlertingPricesBasicTriggerListRequest(PostAlertingPricesBasicTriggerListRequestData data,PostAlertingPricesBasicTriggerListRequestMeta meta = default(PostAlertingPricesBasicTriggerListRequestMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for PostAlertingPricesBasicTriggerListRequest and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public PostAlertingPricesBasicTriggerListRequestData Data { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public PostAlertingPricesBasicTriggerListRequestMeta Meta { get; set; }
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListRequest);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListRequest input)
        {
            if (input == null)
            {
                return false;
