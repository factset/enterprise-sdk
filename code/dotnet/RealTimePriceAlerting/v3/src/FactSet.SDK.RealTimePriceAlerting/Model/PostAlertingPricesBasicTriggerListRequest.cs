...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    public partial class PostAlertingPricesBasicTriggerListRequest : IEquatable<PostAlertingPricesBasicTriggerListRequest>, IValidatableObject
    {
        ...
        public PostAlertingPricesBasicTriggerListRequest(PostAlertingPricesBasicTriggerListRequestData data = default(PostAlertingPricesBasicTriggerListRequestData), PostAlertingPricesBasicTriggerListRequestMeta meta = default(PostAlertingPricesBasicTriggerListRequestMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
