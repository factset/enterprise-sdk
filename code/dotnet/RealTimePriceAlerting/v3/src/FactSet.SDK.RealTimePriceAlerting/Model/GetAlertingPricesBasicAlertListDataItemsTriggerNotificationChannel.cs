...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataItems_trigger_notification_channel")]
    public partial class GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel : IEquatable<GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel(List<decimal> id = default(List<decimal>))
        {
            this.Id = id;
        }
        ...
        /// </summary>
        /// <value>Identifier of the notification channel.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel {\n");
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel input)
        {
            if (input == null)
            {
                return false;
