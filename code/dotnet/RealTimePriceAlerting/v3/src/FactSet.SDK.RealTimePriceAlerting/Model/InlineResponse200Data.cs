...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    public partial class InlineResponse200Data : IEquatable<InlineResponse200Data>, IValidatableObject
    {
        ...
        public InlineResponse200Data(string id = default(string), string creation = default(string), InlineResponse200DataPrice price = default(InlineResponse200DataPrice), InlineResponse200DataNotification notification = default(InlineResponse200DataNotification), InlineResponse200DataTrigger trigger = default(InlineResponse200DataTrigger))
        {
            this.Id = id;
        ...
        public InlineResponse200DataNotification Notification { get; set; }

        /// <summary>
        /// Gets or Sets Trigger
        /// </summary>
        [DataMember(Name = "trigger", EmitDefaultValue = false)]
        public InlineResponse200DataTrigger Trigger { get; set; }
