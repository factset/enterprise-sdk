...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicTriggerGetDataNotificationChannelItems")]
    public partial class GetAlertingPricesBasicTriggerGetDataNotificationChannelItems : IEquatable<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicTriggerGetDataNotificationChannelItems" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public GetAlertingPricesBasicTriggerGetDataNotificationChannelItems(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicTriggerGetDataNotificationChannelItems);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicTriggerGetDataNotificationChannelItems instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicTriggerGetDataNotificationChannelItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicTriggerGetDataNotificationChannelItems input)
        {
            if (input == null)
            {
                return false;
