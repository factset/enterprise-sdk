...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    public partial class InlineResponse2001Trigger : IEquatable<InlineResponse2001Trigger>, IValidatableObject
    {
        ...
        public InlineResponse2001Trigger(string id = default(string), string creation = default(string), InlineResponse200DataTriggerNotation notation = default(InlineResponse200DataTriggerNotation), InlineResponse2001TriggerPrice price = default(InlineResponse2001TriggerPrice), InlineResponse200DataTriggerRange range = default(InlineResponse200DataTriggerRange), string comment = default(string), InlineResponse200DataTriggerNotification notification = default(InlineResponse200DataTriggerNotification), InlineResponse2001TriggerStatus status = default(InlineResponse2001TriggerStatus))
        {
            this.Id = id;
