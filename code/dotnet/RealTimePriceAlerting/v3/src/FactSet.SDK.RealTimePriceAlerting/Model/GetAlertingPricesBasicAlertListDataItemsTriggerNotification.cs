...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataItems_trigger_notification")]
    public partial class GetAlertingPricesBasicAlertListDataItemsTriggerNotification : IEquatable<GetAlertingPricesBasicAlertListDataItemsTriggerNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataItemsTriggerNotification" /> class.
        /// </summary>
        /// <param name="channel">channel.</param>
        public GetAlertingPricesBasicAlertListDataItemsTriggerNotification(GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel channel = default(GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel))
        {
        ...
        public GetAlertingPricesBasicAlertListDataItemsTriggerNotificationChannel Channel { get; set; }
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataItemsTriggerNotification);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataItemsTriggerNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataItemsTriggerNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataItemsTriggerNotification input)
        {
            if (input == null)
            {
                return false;
