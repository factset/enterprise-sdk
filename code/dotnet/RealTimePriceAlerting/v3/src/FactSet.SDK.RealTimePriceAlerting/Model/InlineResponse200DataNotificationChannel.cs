...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_notification_channel")]
    public partial class InlineResponse200DataNotificationChannel : IEquatable<InlineResponse200DataNotificationChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataNotificationChannel" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public InlineResponse200DataNotificationChannel(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InlineResponse200DataNotificationChannel);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataNotificationChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataNotificationChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataNotificationChannel input)
        {
            if (input == null)
            {
                return false;
