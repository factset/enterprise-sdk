...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListDataItems_range")]
    public partial class PostAlertingPricesBasicTriggerListDataItemsRange : IEquatable<PostAlertingPricesBasicTriggerListDataItemsRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListDataItemsRange" /> class.
        /// </summary>
        /// <param name="upperLimit">Upper limit..</param>
        /// <param name="lowerLimit">Lower limit..</param>
        public PostAlertingPricesBasicTriggerListDataItemsRange(decimal? upperLimit = default(decimal?), decimal? lowerLimit = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListDataItemsRange);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListDataItemsRange instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListDataItemsRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListDataItemsRange input)
        {
            if (input == null)
            {
                return false;
