...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_2_data_notification")]
    public partial class InlineResponse2002DataNotification : IEquatable<InlineResponse2002DataNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002DataNotification" /> class.
        /// </summary>
        ...
        public InlineResponse2002DataNotification(List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems> channel = default(List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems>))
        {
        ...
        public List<GetAlertingPricesBasicTriggerGetDataNotificationChannelItems> Channel { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2002DataNotification);
        }

        /// <summary>
        /// Returns true if InlineResponse2002DataNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002DataNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002DataNotification input)
        {
            if (input == null)
            {
                return false;
