...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertGetDataNotificationStatusItems")]
    public partial class GetAlertingPricesBasicAlertGetDataNotificationStatusItems : IEquatable<GetAlertingPricesBasicAlertGetDataNotificationStatusItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertGetDataNotificationStatusItems" /> class.
        /// </summary>
        ...
        public GetAlertingPricesBasicAlertGetDataNotificationStatusItems(GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel channel = default(GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel), DateTime? time = default(DateTime?), CodeEnum? code = default(CodeEnum?))
        {
        ...
        public GetAlertingPricesBasicAlertGetDataNotificationStatusItemsChannel Channel { get; set; }
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertGetDataNotificationStatusItems);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertGetDataNotificationStatusItems instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertGetDataNotificationStatusItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertGetDataNotificationStatusItems input)
        {
            if (input == null)
            {
                return false;
