...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_notification_status")]
    public partial class InlineResponse200DataNotificationStatus : IEquatable<InlineResponse200DataNotificationStatus>, IValidatableObject
    {
        /// <summary>
        /// Code of the status.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataNotificationStatus" /> class.
        /// </summary>
        /// <param name="channel">channel.</param>
        /// <param name="time">Date and time of the most recent change..</param>
        /// <param name="code">Code of the status..</param>
        public InlineResponse200DataNotificationStatus(InlineResponse200DataNotificationChannel channel = default(InlineResponse200DataNotificationChannel), string time = default(string), CodeEnum? code = default(CodeEnum?))
        {
        ...
        public InlineResponse200DataNotificationChannel Channel { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataNotificationStatus);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataNotificationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataNotificationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataNotificationStatus input)
        {
            if (input == null)
            {
                return false;
