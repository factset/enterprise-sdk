# FactSet.SDK.RealTimePriceAlerting.Api.AlertingApi
...
> InlineResponse2003 PostAlertingPricesBasicTriggerList (PostAlertingPricesBasicTriggerListRequest postAlertingPricesBasicTriggerListRequest = null)
...
namespace Example
{
    public class PostAlertingPricesBasicTriggerListExample
    {
        public static async Task Main()
        {
            ...
            var postAlertingPricesBasicTriggerListRequest = new PostAlertingPricesBasicTriggerListRequest(); // PostAlertingPricesBasicTriggerListRequest | Request Body (optional) 
