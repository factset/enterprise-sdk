...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_data_notification")]
    public partial class InlineResponse200DataNotification : IEquatable<InlineResponse200DataNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200DataNotification" /> class.
        /// </summary>
        /// <param name="status">Status of a notification per channel..</param>
        public InlineResponse200DataNotification(List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems> status = default(List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems>))
        {
            this.Status = status;
        }
        ...
        public List<GetAlertingPricesBasicAlertGetDataNotificationStatusItems> Status { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse200DataNotification);
        }

        /// <summary>
        /// Returns true if InlineResponse200DataNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200DataNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200DataNotification input)
        {
            if (input == null)
            {
                return false;
