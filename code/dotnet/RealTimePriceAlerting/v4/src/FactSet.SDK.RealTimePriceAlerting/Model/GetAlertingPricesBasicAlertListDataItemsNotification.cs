...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataItems_notification")]
    public partial class GetAlertingPricesBasicAlertListDataItemsNotification : IEquatable<GetAlertingPricesBasicAlertListDataItemsNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataItemsNotification" /> class.
        /// </summary>
        /// <param name="status">Status of a notification per channel..</param>
        public GetAlertingPricesBasicAlertListDataItemsNotification(List<GetAlertingPricesBasicAlertListDataNotificationStatusItems> status = default(List<GetAlertingPricesBasicAlertListDataNotificationStatusItems>))
        {
            this.Status = status;
        }
        ...
        /// </summary>
        /// <value>Status of a notification per channel.</value>
        [DataMember(Name = "status", EmitDefaultValue = false)]
        public List<GetAlertingPricesBasicAlertListDataNotificationStatusItems> Status { get; set; }
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataItemsNotification);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataItemsNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataItemsNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataItemsNotification input)
        {
            if (input == null)
            {
                return false;
