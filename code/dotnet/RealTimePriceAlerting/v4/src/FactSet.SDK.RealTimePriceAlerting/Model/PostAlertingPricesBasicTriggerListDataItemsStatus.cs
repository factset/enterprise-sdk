...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListDataItems_status")]
    public partial class PostAlertingPricesBasicTriggerListDataItemsStatus : IEquatable<PostAlertingPricesBasicTriggerListDataItemsStatus>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListDataItemsStatus" /> class.
        /// </summary>
        ...
        public PostAlertingPricesBasicTriggerListDataItemsStatus(CodeEnum? code = default(CodeEnum?), string details = default(string))
        {
            this.Code = code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostAlertingPricesBasicTriggerListDataItemsStatus {\n");
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListDataItemsStatus);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListDataItemsStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListDataItemsStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListDataItemsStatus input)
        {
            if (input == null)
            {
                return false;
