...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataNotificationStatusItems_channel")]
    public partial class GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel : IEquatable<GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel" /> class.
        /// </summary>
        /// <param name="id">Identifier of the notification channel..</param>
        public GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel(decimal? id = default(decimal?))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel {\n");
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataNotificationStatusItemsChannel input)
        {
            if (input == null)
            {
                return false;
