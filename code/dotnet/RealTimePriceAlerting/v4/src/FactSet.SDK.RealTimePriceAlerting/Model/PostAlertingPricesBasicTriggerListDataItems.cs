...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAlertingPricesBasicTriggerListDataItems")]
    public partial class PostAlertingPricesBasicTriggerListDataItems : IEquatable<PostAlertingPricesBasicTriggerListDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlertingPricesBasicTriggerListDataItems" /> class.
        /// </summary>
        ...
        public PostAlertingPricesBasicTriggerListDataItems(string id = default(string), DateTime? creation = default(DateTime?), InlineResponse200DataTriggerNotation notation = default(InlineResponse200DataTriggerNotation), PostAlertingPricesBasicTriggerListDataItemsPrice price = default(PostAlertingPricesBasicTriggerListDataItemsPrice), PostAlertingPricesBasicTriggerListDataItemsRange range = default(PostAlertingPricesBasicTriggerListDataItemsRange), string comment = default(string), PostAlertingPricesBasicTriggerListDataItemsNotification notification = default(PostAlertingPricesBasicTriggerListDataItemsNotification), PostAlertingPricesBasicTriggerListDataItemsStatus status = default(PostAlertingPricesBasicTriggerListDataItemsStatus))
        {
            this.Id = id;
        ...
        public PostAlertingPricesBasicTriggerListDataItemsPrice Price { get; set; }

        /// <summary>
        /// Gets or Sets Range
        /// </summary>
        [DataMember(Name = "range", EmitDefaultValue = false)]
        public PostAlertingPricesBasicTriggerListDataItemsRange Range { get; set; }
        ...
        public PostAlertingPricesBasicTriggerListDataItemsNotification Notification { get; set; }
        ...
        {
            return this.Equals(input as PostAlertingPricesBasicTriggerListDataItems);
        }

        /// <summary>
        /// Returns true if PostAlertingPricesBasicTriggerListDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlertingPricesBasicTriggerListDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlertingPricesBasicTriggerListDataItems input)
        {
            if (input == null)
            {
                return false;
