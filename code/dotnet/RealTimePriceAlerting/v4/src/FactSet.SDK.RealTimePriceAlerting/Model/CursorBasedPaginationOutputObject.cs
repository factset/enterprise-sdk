...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    public partial class CursorBasedPaginationOutputObject : IEquatable<CursorBasedPaginationOutputObject>, IValidatableObject
    {
        ...
        /// <param name="next">The next cursor position to use in the parameter &#x60;pagination.cursor&#x60; for an endpoint that supports cursor-based pagination, otherwise &#x60;null&#x60;..</param>
        /// <param name="previous">The previous cursor position to use in the parameter &#x60;pagination.cursor&#x60; for an endpoint that supports cursor-based pagination. If a previous cursor position is not supported or available, &#x60;previous&#x60; is &#x60;null&#x60;..</param>
        public CursorBasedPaginationOutputObject(int? total = default(int?), bool? isEstimatedTotal = default(bool?), string next = default(string), string previous = default(string))
        {
            this.Total = total;
