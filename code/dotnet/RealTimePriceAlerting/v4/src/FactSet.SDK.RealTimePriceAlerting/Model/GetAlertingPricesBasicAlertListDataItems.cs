...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataItems")]
    public partial class GetAlertingPricesBasicAlertListDataItems : IEquatable<GetAlertingPricesBasicAlertListDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataItems" /> class.
        /// </summary>
        ...
        public GetAlertingPricesBasicAlertListDataItems(string id = default(string), DateTime? creation = default(DateTime?), InlineResponse200DataPrice price = default(InlineResponse200DataPrice), GetAlertingPricesBasicAlertListDataItemsNotification notification = default(GetAlertingPricesBasicAlertListDataItemsNotification), GetAlertingPricesBasicAlertListDataItemsTrigger trigger = default(GetAlertingPricesBasicAlertListDataItemsTrigger))
        {
            this.Id = id;
        ...
        public GetAlertingPricesBasicAlertListDataItemsNotification Notification { get; set; }

        /// <summary>
        /// Gets or Sets Trigger
        /// </summary>
        [DataMember(Name = "trigger", EmitDefaultValue = false)]
        public GetAlertingPricesBasicAlertListDataItemsTrigger Trigger { get; set; }
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataItems);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataItems input)
        {
            if (input == null)
            {
                return false;
