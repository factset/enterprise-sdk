...
namespace FactSet.SDK.RealTimePriceAlerting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAlertingPricesBasicAlertListDataItems_trigger_price")]
    public partial class GetAlertingPricesBasicAlertListDataItemsTriggerPrice : IEquatable<GetAlertingPricesBasicAlertListDataItemsTriggerPrice>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Quality of the price. | Value | Description | | - -- | - -- | | RLT | Real-time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours or days. |  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertingPricesBasicAlertListDataItemsTriggerPrice" /> class.
        /// </summary>
        ...
        /// <param name="quality">Quality of the price. | Value | Description | | - -- | - -- | | RLT | Real-time: intraday prices with minimal technical processing delays. | | DLY | Delayed: intraday prices with an exchange-imposed delay of usually 15 to 30 minutes. | | EOD | End-of-day: prices updated once per day after the close of trading, possibly with an exchange-imposed delay of several hours or days. |  .</param>
        public GetAlertingPricesBasicAlertListDataItemsTriggerPrice(TypeEnum? type = default(TypeEnum?), QualityEnum? quality = default(QualityEnum?))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as GetAlertingPricesBasicAlertListDataItemsTriggerPrice);
        }

        /// <summary>
        /// Returns true if GetAlertingPricesBasicAlertListDataItemsTriggerPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlertingPricesBasicAlertListDataItemsTriggerPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlertingPricesBasicAlertListDataItemsTriggerPrice input)
        {
            if (input == null)
            {
                return false;
