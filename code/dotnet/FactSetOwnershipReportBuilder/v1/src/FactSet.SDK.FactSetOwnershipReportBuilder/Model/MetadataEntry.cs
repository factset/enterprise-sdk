...
namespace FactSet.SDK.FactSetOwnershipReportBuilder.Model
{
    ...
    public partial class MetadataEntry : AbstractOpenAPISchema, IEquatable<MetadataEntry>, IValidatableObject
    {
        ...
        /// with the <see cref="FsymId" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of FsymId.</param>
        public MetadataEntry(FsymId actualInstance)
        {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: Category, CurrencyCode, CurrencySymbol, Description, Frequency, FsymId, Scale, ValueType");
                }
            }
        }
        ...
        /// </summary>
        /// <returns>An instance of FsymId</returns>
        public FsymId GetFsymId()
        {
            return (FsymId)this.ActualInstance;
        }
        ...
        public static MetadataEntry FromJson(string jsonString)
        {
            ...
            try
            {
                var hasAdditionalProperties = !(typeof(FsymId).GetProperty("AdditionalProperties") is null);
                var parsedValue = JsonConvert.DeserializeObject<FsymId>(
                    jsonString, 
                ...
                matchedTypes.Add("FsymId");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into FsymId: {1}", jsonString, exception.ToString()));
            }
