...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetTickHistory/1.0.0)
...
dotnet add package FactSet.SDK.FactSetTickHistory -v 1.0.0
```
...
nuget install FactSet.SDK.FactSetTickHistory -Version 1.0.0
```
