...
[![Nuget](https://img.shields.io/badge/nuget-v1.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetTickHistory/1.2.0)
...
dotnet add package FactSet.SDK.FactSetTickHistory -v 1.2.0
```
...
nuget install FactSet.SDK.FactSetTickHistory -Version 1.2.0
```
