...
dotnet add package FactSet.SDK.FactSetTickHistory -v 0.31.0
```
...
nuget install FactSet.SDK.FactSetTickHistory -Version 0.31.0
```
...
*Level2Api* | [**GetLevel2FileStatus**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetTickHistory/v2/docs/Level2Api.md#getlevel2filestatus) | **GET** /level2/files/status | Returns the status of the ID
*Level2Api* | [**GetTickHistoryLevel2Files**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetTickHistory/v2/docs/Level2Api.md#gettickhistorylevel2files) | **GET** /level2/files/get | Returns the tick history files requested in the /create endpoint
*Level2Api* | [**RequestTickHistoryLeve2Files**](https://github.com/FactSet/enterprise-sdk/tree/main/code/dotnet/FactSetTickHistory/v2/docs/Level2Api.md#requesttickhistoryleve2files) | **POST** /level2/files/create | Returns the ID for the requested data.
