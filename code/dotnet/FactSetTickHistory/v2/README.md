...
[![Nuget](https://img.shields.io/badge/nuget-v1.0.2-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetTickHistory/1.0.2)
...
dotnet add package FactSet.SDK.FactSetTickHistory -v 1.0.2
```
...
nuget install FactSet.SDK.FactSetTickHistory -Version 1.0.2
```
