...
namespace FactSet.SDK.FactSetTickHistory.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimePeriodMin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DateTimePeriodMin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimePeriodMin" /> class.
        /// </summary>
        /// <param name="start">The date for (or from which) the data is required. Supports in YYYY-MM-DDTHH:MM:SSZ format.   (required).</param>
        /// <param name="end">The date to which data is required. Supports in YYYY-MM-DDTHH:MM:SSZ format.   (required).</param>
        public DateTimePeriodMin(DateTime start, DateTime end)
        {
            this.Start = start;
            this.End = end;
        }
        ...
        {
            return this.Equals(input as DateTimePeriodMin);
        }

        /// <summary>
        /// Returns true if DateTimePeriodMin instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTimePeriodMin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTimePeriodMin input)
        {
            if (input == null)
            {
                return false;
