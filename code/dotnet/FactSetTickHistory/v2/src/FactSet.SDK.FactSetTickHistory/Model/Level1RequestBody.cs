...
namespace FactSet.SDK.FactSetTickHistory.Model
{
    ...
    public partial class Level1RequestBody : IEquatable<Level1RequestBody>, IValidatableObject
    {
        ...
        /// <param name="factsetExchangeCode">FactSet specific regional or composite exchange code. &lt;p&gt; NOTE:Does not support multiple factsetExchangeCodes&lt;/p&gt;.  (required).</param>
        ...
        /// </summary>
        /// <value>FactSet specific regional or composite exchange code. &lt;p&gt; NOTE:Does not support multiple factsetExchangeCodes&lt;/p&gt;. </value>
