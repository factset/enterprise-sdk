...
namespace FactSet.SDK.FactSetTickHistory.Api
{
    ...
    public interface ILevel2ApiSync : IApiAccessor
    {
        ...
        /// <returns>Level2Api.GetStatusLevel2ResponseWrapper</returns>
        Level2Api.GetStatusLevel2ResponseWrapper GetStatusLevel2(string id);
        ...
        /// <exception cref="FactSet.SDK.FactSetTickHistory.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">id returned by files create endpoint to poll and collect status of the query</param>
        /// <returns>ApiResponse of Level2Api.GetStatusLevel2ResponseWrapper</returns>
        ApiResponse<Level2Api.GetStatusLevel2ResponseWrapper> GetStatusLevel2WithHttpInfo(string id);
        /// <summary>
        ...
        /// <returns>Level2Api.GetTickHistoryFilesLevel2ResponseWrapper</returns>
        Level2Api.GetTickHistoryFilesLevel2ResponseWrapper GetTickHistoryFilesLevel2(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        ...
        /// <param name="paginationLimit">Specifies the maximum number of results to return per response page (optional, default to 20)</param>
        /// <param name="paginationOffset">Specifies the starting point for pagination. This parameter is used to identify the beginning of next set of results (optional, default to 0)</param>
        /// <returns>ApiResponse of Level2Api.GetTickHistoryFilesLevel2ResponseWrapper</returns>
        ApiResponse<Level2Api.GetTickHistoryFilesLevel2ResponseWrapper> GetTickHistoryFilesLevel2WithHttpInfo(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?));
        /// <summary>
        ...
        ApiResponse<SubmittedResponse> Getlevel2idWithHttpInfo(LevelTwoRequest levelTwoRequest);
    ...
    public interface ILevel2ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Level2Api.GetStatusLevel2ResponseWrapper> GetStatusLevel2Async(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="id">id returned by files create endpoint to poll and collect status of the query</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Level2Api.GetStatusLevel2ResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<Level2Api.GetStatusLevel2ResponseWrapper>> GetStatusLevel2WithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns the tick history files requested in the /create endpoint
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Level2Api.GetTickHistoryFilesLevel2ResponseWrapper> GetTickHistoryFilesLevel2Async(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="paginationOffset">Specifies the starting point for pagination. This parameter is used to identify the beginning of next set of results (optional, default to 0)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Level2Api.GetTickHistoryFilesLevel2ResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<Level2Api.GetTickHistoryFilesLevel2ResponseWrapper>> GetTickHistoryFilesLevel2WithHttpInfoAsync(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns the ID for the requested data.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SubmittedResponse> Getlevel2idAsync(LevelTwoRequest levelTwoRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SubmittedResponse>> Getlevel2idWithHttpInfoAsync(LevelTwoRequest levelTwoRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class Level2Api : ILevel2Api
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetStatusLevel2ResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> Getlevel2idResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)202, typeof(SubmittedResponse) },
            { (HttpStatusCode)400, typeof(Status) },
            { (HttpStatusCode)401, typeof(Status) },
        ...
        /// </example>
        /// </summary>
        public class GetStatusLevel2ResponseWrapper {

            /// <summary>This constructor initializes the new GetStatusLevel2ResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetStatusLevel2ResponseWrapper(HttpStatusCode statusCode, object response)
            {
        ...
        /// </example>
        /// </summary>
        public class GetTickHistoryFilesLevel2ResponseWrapper {

            /// <summary>This constructor initializes the new GetTickHistoryFilesLevel2ResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetTickHistoryFilesLevel2ResponseWrapper(HttpStatusCode statusCode, object response)
            {
                StatusCode = statusCode;
                Response = response;
            }
        ...
        /// <param name="id">id returned by files create endpoint to poll and collect status of the query</param>
        /// <returns>Level2Api.GetStatusLevel2ResponseWrapper</returns>
        public Level2Api.GetStatusLevel2ResponseWrapper GetStatusLevel2(string id)
        {
            var localVarResponse = GetStatusLevel2WithHttpInfo(id);
        ...
        public ApiResponse<Level2Api.GetStatusLevel2ResponseWrapper> GetStatusLevel2WithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new FactSet.SDK.FactSetTickHistory.Client.ApiException(400, "Missing required parameter 'id' when calling Level2Api->GetStatusLevel2");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetStatusLevel2ResponseTypeDictionary;
            ...
            {
                Exception _exception = this.ExceptionFactory("GetStatusLevel2", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
            }
            var getstatuslevel2Response = new GetStatusLevel2ResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetStatusLevel2ResponseWrapper>(localVarResponse.StatusCode, getstatuslevel2Response);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CompletedResponse</returns>
        public async System.Threading.Tasks.Task<Level2Api.GetStatusLevel2ResponseWrapper>GetStatusLevel2Async(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetStatusLevel2WithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Level2Api.GetStatusLevel2ResponseWrapper>> GetStatusLevel2WithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <param name="paginationOffset">Specifies the starting point for pagination. This parameter is used to identify the beginning of next set of results (optional, default to 0)</param>
        /// <returns>Level2Api.GetTickHistoryFilesLevel2ResponseWrapper</returns>
        public Level2Api.GetTickHistoryFilesLevel2ResponseWrapper GetTickHistoryFilesLevel2(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
            var localVarResponse = GetTickHistoryFilesLevel2WithHttpInfo(id, paginationLimit, paginationOffset);
            return localVarResponse.Data;
        }
        ...
        public ApiResponse<Level2Api.GetTickHistoryFilesLevel2ResponseWrapper> GetTickHistoryFilesLevel2WithHttpInfo(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new FactSet.SDK.FactSetTickHistory.Client.ApiException(400, "Missing required parameter 'id' when calling Level2Api->GetTickHistoryFilesLevel2");
            }
            ...
            var gettickhistoryfileslevel2Response = new GetTickHistoryFilesLevel2ResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetTickHistoryFilesLevel2ResponseWrapper>(localVarResponse.StatusCode, gettickhistoryfileslevel2Response);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LeveltwoGetFilesResponse</returns>
        public async System.Threading.Tasks.Task<Level2Api.GetTickHistoryFilesLevel2ResponseWrapper>GetTickHistoryFilesLevel2Async(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetTickHistoryFilesLevel2WithHttpInfoAsync(id, paginationLimit, paginationOffset, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Level2Api.GetTickHistoryFilesLevel2ResponseWrapper>> GetTickHistoryFilesLevel2WithHttpInfoAsync(string id, int? paginationLimit = default(int?), int? paginationOffset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <summary>
        /// Returns the ID for the requested data. Data available from past 6 years to current date.
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetTickHistory.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="levelTwoRequest"></param>
        /// <returns>SubmittedResponse</returns>
        public SubmittedResponse Getlevel2id(LevelTwoRequest levelTwoRequest)
        {
            var localVarResponse = Getlevel2idWithHttpInfo(levelTwoRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="levelTwoRequest"></param>
        /// <returns>ApiResponse of SubmittedResponse</returns>
        public ApiResponse<SubmittedResponse> Getlevel2idWithHttpInfo(LevelTwoRequest levelTwoRequest)
        {
            // verify the required parameter 'levelTwoRequest' is set
            if (levelTwoRequest == null)
            {
                throw new FactSet.SDK.FactSetTickHistory.Client.ApiException(400, "Missing required parameter 'levelTwoRequest' when calling Level2Api->Getlevel2id");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = Getlevel2idResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("Getlevel2id", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SubmittedResponse</returns>
        public async System.Threading.Tasks.Task<SubmittedResponse>Getlevel2idAsync(LevelTwoRequest levelTwoRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await Getlevel2idWithHttpInfoAsync(levelTwoRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SubmittedResponse>> Getlevel2idWithHttpInfoAsync(LevelTwoRequest levelTwoRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'levelTwoRequest' is set
            if (levelTwoRequest == null)
            {
