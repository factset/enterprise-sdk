...
namespace FactSet.SDK.FactSetTickHistory.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.32.3";
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/FactSetTickHistory/0.32.3";
            BasePath = "https://api.factset.com/tick-history/v2";
            ...
            Servers = new List<IReadOnlyDictionary<string, object>>()
            {
                ...
                {
                    new Dictionary<string, object> {
                        {"url", "https://api-sandbox.factset.com/tick-history/v2"},
                        {"description", "No description provided"},
                    }
                }
            };
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/tick-history/v2") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.FactSetTickHistory) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.3.0\n";
            report += "    SDK Package Version: 0.32.3\n";
