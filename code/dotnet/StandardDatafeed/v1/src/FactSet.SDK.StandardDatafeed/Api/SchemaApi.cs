...
namespace FactSet.SDK.StandardDatafeed.Api
{
    ...
    public partial class SchemaApi : ISchemaApi
    {
        ...
        {
            { (HttpStatusCode)200, typeof(ListSchemas) },
        ...
        public ApiResponse<ListSchemas> GetV1ListSchemasWithHttpInfo(string schema = default(string), int? sequence = default(int?))
        {
            ...
            ListSchemas>("/list-schemas", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ListSchemas>> GetV1ListSchemasWithHttpInfoAsync(string schema = default(string), int? sequence = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListSchemas>("/list-schemas", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
