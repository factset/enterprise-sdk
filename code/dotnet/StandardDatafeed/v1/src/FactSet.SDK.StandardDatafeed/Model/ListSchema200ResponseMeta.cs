...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// </summary>
    [DataContract(Name = "list_schema_200Response_meta")]
    public partial class ListSchema200ResponseMeta : IEquatable<ListSchema200ResponseMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSchema200ResponseMeta" /> class.
        /// </summary>
        /// <param name="pagination">pagination.</param>
        /// <param name="partial">partial.</param>
        public ListSchema200ResponseMeta(Pagination pagination = default(Pagination), Partial partial = default(Partial))
        {
        ...
        {
            return this.Equals(input as ListSchema200ResponseMeta);
        }

        /// <summary>
        /// Returns true if ListSchema200ResponseMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSchema200ResponseMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSchema200ResponseMeta input)
        {
            if (input == null)
            {
                return false;
