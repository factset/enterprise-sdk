...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// </summary>
    [DataContract(Name = "list_schema_200Response_data")]
    public partial class ListSchema200ResponseData : IEquatable<ListSchema200ResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSchema200ResponseData" /> class.
        /// </summary>
        ...
        public ListSchema200ResponseData(string schema = default(string), int sequence = default(int), string url = default(string), string timestamp = default(string))
        {
            this.Schema = schema;
        ...
        {
            return this.Equals(input as ListSchema200ResponseData);
        }

        /// <summary>
        /// Returns true if ListSchema200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSchema200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSchema200ResponseData input)
        {
            if (input == null)
            {
                return false;
