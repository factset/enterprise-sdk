...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    public partial class ListFiles200Response : IEquatable<ListFiles200Response>, IValidatableObject
    {
        ...
        public ListFiles200Response(List<Dataresponseitems> data = default(List<Dataresponseitems>), ListFiles200ResponseMeta meta = default(ListFiles200ResponseMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public ListFiles200ResponseMeta Meta { get; set; }
