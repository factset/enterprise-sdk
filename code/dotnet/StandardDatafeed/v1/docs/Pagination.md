# FactSet.SDK.StandardDatafeed.Model.Pagination
...
**IsEstimatedTotal** | **bool** | Boolean value that represents whether the total count of files returned is exact or an estimate. This is defaulted to  â€œFalseâ€ as the API should always return the exact count | [optional] 
