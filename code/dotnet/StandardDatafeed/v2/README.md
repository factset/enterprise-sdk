...
[![Nuget](https://img.shields.io/badge/nuget-v2.0.0-orange)](https://www.nuget.org/packages/FactSet.SDK.StandardDatafeed/2.0.0)
...
dotnet add package FactSet.SDK.StandardDatafeed -v 2.0.0
```
...
nuget install FactSet.SDK.StandardDatafeed -Version 2.0.0
```
