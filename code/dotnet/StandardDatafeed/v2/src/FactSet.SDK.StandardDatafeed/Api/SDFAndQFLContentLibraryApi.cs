...
namespace FactSet.SDK.StandardDatafeed.Api
{
    ...
    public interface ISDFAndQFLContentLibraryApiSync : IApiAccessor
    {
        ...
        ListFile GetListFiles(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>));
        ...
        ApiResponse<ListFile> GetListFilesWithHttpInfo(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>));
        /// <summary>
        ...
        HistoricalFile GethistoricalFiles(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>));
        ...
        ApiResponse<HistoricalFile> GethistoricalFilesWithHttpInfo(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>));
    ...
    public interface ISDFAndQFLContentLibraryApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ListFile> GetListFilesAsync(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ListFile>> GetListFilesWithHttpInfoAsync(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns full historic data of specified schema and bundle.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<HistoricalFile> GethistoricalFilesAsync(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SDFAndQFLContentLibraryApi : ISDFAndQFLContentLibraryApi
    {
        ...
        /// <param name="sort">Enables sorting data in ascending or descending chronological order based on startDate.  (optional)</param>
        /// <returns>ListFile</returns>
        public ListFile GetListFiles(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>))
        {
            var localVarResponse = GetListFilesWithHttpInfo(schema, bundle, type, startDate, startDateRelative, endDate, endDateRelative, excludeRelatedBundles, paginationLimit, paginationOffset, sort);
        ...
        /// <param name="sort">Enables sorting data in ascending or descending chronological order based on startDate.  (optional)</param>
        /// <returns>ApiResponse of ListFile</returns>
        public ApiResponse<ListFile> GetListFilesWithHttpInfo(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>))
        {
            ...
            if (excludeRelatedBundles != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.StandardDatafeed.Client.ClientUtils.ParameterToMultiMap("", "excludeRelatedBundles", excludeRelatedBundles));
            }
        ...
        {
            var localVarResponse = await GetListFilesWithHttpInfoAsync(schema, bundle, type, startDate, startDateRelative, endDate, endDateRelative, excludeRelatedBundles, paginationLimit, paginationOffset, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Enables sorting data in ascending or descending chronological order based on startDate.  (optional)</param>
        /// <returns>HistoricalFile</returns>
        public HistoricalFile GethistoricalFiles(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>))
        {
            var localVarResponse = GethistoricalFilesWithHttpInfo(schema, bundle, type, startDate, startDateRelative, endDate, endDateRelative, excludeRelatedBundles, paginationLimit, paginationOffset, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Enables sorting data in ascending or descending chronological order based on startDate.  (optional)</param>
        /// <returns>ApiResponse of HistoricalFile</returns>
        public ApiResponse<HistoricalFile> GethistoricalFilesWithHttpInfo(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>))
        {
            FactSet.SDK.StandardDatafeed.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.StandardDatafeed.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of HistoricalFile</returns>
        public async System.Threading.Tasks.Task<HistoricalFile>GethistoricalFilesAsync(string schema = default(string), string bundle = default(string), string type = default(string), string startDate = default(string), int? startDateRelative = default(int?), string endDate = default(string), int? endDateRelative = default(int?), bool? excludeRelatedBundles = default(bool?), int? paginationLimit = default(int?), int? paginationOffset = default(int?), List<string> sort = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GethistoricalFilesWithHttpInfoAsync(schema, bundle, type, startDate, startDateRelative, endDate, endDateRelative, excludeRelatedBundles, paginationLimit, paginationOffset, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
