...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// List Files Object
    /// </summary>
    [DataContract(Name = "ListFile")]
    public partial class ListFile : IEquatable<ListFile>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ListFile" /> class.
        /// </summary>
        /// <param name="data">List Files Data Array. (required).</param>
        /// <param name="meta">meta.</param>
        public ListFile(List<ListFileObject> data,Meta meta = default(Meta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ListFile and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>List Files Data Array.</value>
        [DataMember(Name = "data", IsRequired = true, EmitDefaultValue = false)]
        public List<ListFileObject> Data { get; set; }
        ...
        {
            return this.Equals(input as ListFile);
        }

        /// <summary>
        /// Returns true if ListFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ListFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListFile input)
        {
            if (input == null)
            {
                return false;
