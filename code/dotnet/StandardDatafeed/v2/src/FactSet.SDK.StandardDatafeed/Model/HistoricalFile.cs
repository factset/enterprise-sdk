...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricalFile")]
    public partial class HistoricalFile : IEquatable<HistoricalFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricalFile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HistoricalFile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricalFile" /> class.
        /// </summary>
        /// <param name="data">Historical Files Data Array. (required).</param>
        /// <param name="meta">meta.</param>
        public HistoricalFile(List<HistoricalFileObject> data,Meta meta = default(Meta))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for HistoricalFile and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Historical Files Data Array.</value>
        [DataMember(Name = "data", IsRequired = true, EmitDefaultValue = false)]
        public List<HistoricalFileObject> Data { get; set; }
        ...
        {
            return this.Equals(input as HistoricalFile);
        }

        /// <summary>
        /// Returns true if HistoricalFile instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricalFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricalFile input)
        {
            if (input == null)
            {
                return false;
