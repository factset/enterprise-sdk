...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// Schema List Object.
    /// </summary>
    [DataContract(Name = "ListSchema")]
    public partial class ListSchema : IEquatable<ListSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSchema" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ListSchema" /> class.
        /// </summary>
        /// <param name="data">Schema List Data Array. (required).</param>
        public ListSchema(List<ListSchemaObject> data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ListSchema and cannot be null");
            }
            this.Data = data;
        }

        /// <summary>
        /// Schema List Data Array.
        /// </summary>
        /// <value>Schema List Data Array.</value>
        [DataMember(Name = "data", IsRequired = true, EmitDefaultValue = false)]
        public List<ListSchemaObject> Data { get; set; }
        ...
        {
            return this.Equals(input as ListSchema);
        }

        /// <summary>
        /// Returns true if ListSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSchema input)
        {
            if (input == null)
            {
                return false;
