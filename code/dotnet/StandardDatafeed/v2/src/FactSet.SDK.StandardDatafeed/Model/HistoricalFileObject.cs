...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricalFileObject")]
    public partial class HistoricalFileObject : IEquatable<HistoricalFileObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricalFileObject" /> class.
        /// </summary>
        ...
        public HistoricalFileObject(string type = default(string), string bundle = default(string), string schema = default(string), string version = default(string), List<HistoricalFileObjectObject> relatedBundles = default(List<HistoricalFileObjectObject>), DateTime timestamp = default(DateTime), string url = default(string), string fileSize = default(string))
        {
            this.Type = type;
            this.Bundle = bundle;
            this.Schema = schema;
        ...
        public List<HistoricalFileObjectObject> RelatedBundles { get; set; }
        ...
        {
            return this.Equals(input as HistoricalFileObject);
        }

        /// <summary>
        /// Returns true if HistoricalFileObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricalFileObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricalFileObject input)
        {
            if (input == null)
            {
                return false;
