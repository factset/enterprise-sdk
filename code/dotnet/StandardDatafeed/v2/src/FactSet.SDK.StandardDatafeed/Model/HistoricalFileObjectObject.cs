...
namespace FactSet.SDK.StandardDatafeed.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricalFileObjectObject")]
    public partial class HistoricalFileObjectObject : IEquatable<HistoricalFileObjectObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricalFileObjectObject" /> class.
        /// </summary>
        /// <param name="bundle">Bundle name..</param>
        /// <param name="version">Bundle version..</param>
        public HistoricalFileObjectObject(string bundle = default(string), string version = default(string))
        {
            this.Bundle = bundle;
        ...
        {
            return this.Equals(input as HistoricalFileObjectObject);
        }

        /// <summary>
        /// Returns true if HistoricalFileObjectObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricalFileObjectObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricalFileObjectObject input)
        {
            if (input == null)
            {
                return false;
