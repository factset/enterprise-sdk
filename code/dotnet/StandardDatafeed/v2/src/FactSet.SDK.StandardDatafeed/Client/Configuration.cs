...
namespace FactSet.SDK.StandardDatafeed.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/StandardDatafeed/0.40.3";
            BasePath = "https://api.factset.com/bulk-documents/sdf/v2";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/bulk-documents/sdf/v2") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.StandardDatafeed) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.0.0\n";
            report += "    SDK Package Version: 0.40.3\n";
