...
[![Nuget](https://img.shields.io/badge/nuget-v0.23.0-orange)](https://www.nuget.org/packages/FactSet.SDK.ProcuretoPayAPISCIM/0.23.0)
...
dotnet add package FactSet.SDK.ProcuretoPayAPISCIM -v 0.23.0
```
...
nuget install FactSet.SDK.ProcuretoPayAPISCIM -Version 0.23.0
```
