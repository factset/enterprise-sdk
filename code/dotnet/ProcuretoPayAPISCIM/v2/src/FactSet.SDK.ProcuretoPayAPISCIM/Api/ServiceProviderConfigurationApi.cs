...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Api
{
    ...
    /// </summary>
    public interface IServiceProviderConfigurationApiSync : IApiAccessor
    {
        ...
        ApiResponse<ServiceProviderConfig> GetServiceProviderConfigWithHttpInfo();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IServiceProviderConfigurationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ServiceProviderConfig> GetServiceProviderConfigAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ServiceProviderConfig>> GetServiceProviderConfigWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IServiceProviderConfigurationApi : IServiceProviderConfigurationApiSync, IServiceProviderConfigurationApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ServiceProviderConfigurationApi : IServiceProviderConfigurationApi
    {
        private FactSet.SDK.ProcuretoPayAPISCIM.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        # region Response Type Disctionaries
        
        private static readonly Dictionary<HttpStatusCode, System.Type> GetServiceProviderConfigResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceProviderConfigurationApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ServiceProviderConfigurationApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ServiceProviderConfigurationApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ServiceProviderConfigurationApi(FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration configuration)
        {
        ...
        public ServiceProviderConfigurationApi(FactSet.SDK.ProcuretoPayAPISCIM.Client.ISynchronousClient client, FactSet.SDK.ProcuretoPayAPISCIM.Client.IAsynchronousClient asyncClient, FactSet.SDK.ProcuretoPayAPISCIM.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get service provider configuration. Get service provider configuration, which describes the SCIM specification features available. See RFC 7644 section 4.
        /// </summary>
        /// <exception cref="FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ServiceProviderConfig</returns>
        public ServiceProviderConfig GetServiceProviderConfig()
        {
            var localVarResponse = GetServiceProviderConfigWithHttpInfo();
        ...
        /// <exception cref="FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ServiceProviderConfig</returns>
        public ApiResponse<ServiceProviderConfig> GetServiceProviderConfigWithHttpInfo()
        {
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetServiceProviderConfigResponseTypeDictionary;
            ...
            {
                Exception _exception = this.ExceptionFactory("GetServiceProviderConfig", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ServiceProviderConfig</returns>
        public async System.Threading.Tasks.Task<ServiceProviderConfig>GetServiceProviderConfigAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetServiceProviderConfigWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ServiceProviderConfig>> GetServiceProviderConfigWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
