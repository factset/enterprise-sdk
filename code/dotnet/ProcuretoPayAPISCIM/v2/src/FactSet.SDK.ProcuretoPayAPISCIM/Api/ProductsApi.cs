...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Api
{
    ...
    public interface IProductsApiSync : IApiAccessor
    {
        ...
        ProductResource GetProduct(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>));
        ...
        ApiResponse<ProductResource> GetProductWithHttpInfo(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>));
        /// <summary>
        ...
        ApiResponse<ProductResourceList> GetProductsWithHttpInfo(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>));
    ...
    public interface IProductsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ProductResource>> GetProductWithHttpInfoAsync(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a list of products.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProductsApi : IProductsApi
    {
        ...
        /// <param name="additionalAttributes">Non-standard attribute filter string. A comma-separated list of resource attribute names to be included in the response, complementing the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* or *excludedAttributes* parameters. (optional)</param>
        /// <returns>ProductResource</returns>
        public ProductResource GetProduct(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>))
        {
            var localVarResponse = GetProductWithHttpInfo(id, attributes, excludedAttributes, additionalAttributes);
        ...
        /// <param name="additionalAttributes">Non-standard attribute filter string. A comma-separated list of resource attribute names to be included in the response, complementing the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* or *excludedAttributes* parameters. (optional)</param>
        /// <returns>ApiResponse of ProductResource</returns>
        public ApiResponse<ProductResource> GetProductWithHttpInfo(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProductResource</returns>
        public async System.Threading.Tasks.Task<ProductResource>GetProductAsync(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetProductWithHttpInfoAsync(id, attributes, excludedAttributes, additionalAttributes, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ProductResource>> GetProductWithHttpInfoAsync(string id, List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <param name="additionalAttributes">Non-standard attribute filter string. A comma-separated list of resource attribute names to be included in the response, complementing the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* or *excludedAttributes* parameters. (optional)</param>
        /// <returns>ProductResourceList</returns>
        public ProductResourceList GetProducts(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>))
        {
            var localVarResponse = GetProductsWithHttpInfo(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes, additionalAttributes);
            return localVarResponse.Data;
        }
        ...
        /// <param name="additionalAttributes">Non-standard attribute filter string. A comma-separated list of resource attribute names to be included in the response, complementing the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* or *excludedAttributes* parameters. (optional)</param>
        /// <returns>ApiResponse of ProductResourceList</returns>
        public ApiResponse<ProductResourceList> GetProductsWithHttpInfo(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), List<string> attributes = default(List<string>), List<string> excludedAttributes = default(List<string>), List<string> additionalAttributes = default(List<string>))
        {
            FactSet.SDK.ProcuretoPayAPISCIM.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.ProcuretoPayAPISCIM.Client.RequestOptions();
        ...
        {
            var localVarResponse = await GetProductsWithHttpInfoAsync(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes, additionalAttributes, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
