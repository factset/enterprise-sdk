...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Api
{
    ...
    public interface IUserClassesApiSync : IApiAccessor
    {
        ...
        ApiResponse<UserClassResource> GetUserClassWithHttpInfo(string id);
        /// <summary>
        ...
        UserClassResourceList GetUserClasses(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string));
        ...
        ApiResponse<UserClassResourceList> GetUserClassesWithHttpInfo(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string));
    ...
    public interface IUserClassesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UserClassResource> GetUserClassAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UserClassResource>> GetUserClassWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a list of user classes.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<UserClassResourceList>> GetUserClassesWithHttpInfoAsync(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class UserClassesApi : IUserClassesApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetUserClassResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetUserClassesResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
        ...
        /// <summary>
        /// Get a user class. Get a specific user class resource.
        /// </summary>
        /// <exception cref="FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID of resource.</param>
        /// <returns>UserClassResource</returns>
        public UserClassResource GetUserClass(string id)
        {
            var localVarResponse = GetUserClassWithHttpInfo(id);
        ...
        /// <param name="id">ID of resource.</param>
        /// <returns>ApiResponse of UserClassResource</returns>
        public ApiResponse<UserClassResource> GetUserClassWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException(400, "Missing required parameter 'id' when calling UserClassesApi->GetUserClass");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetUserClassResponseTypeDictionary;
            ...
            {
                Exception _exception = this.ExceptionFactory("GetUserClass", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserClassResource</returns>
        public async System.Threading.Tasks.Task<UserClassResource>GetUserClassAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetUserClassWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<UserClassResource>> GetUserClassWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <summary>
        /// Get a list of user classes. Get a list of user class resources.
        /// </summary>
        /// <exception cref="FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filter">Resource filter string. See [RFC 7644 section 3.4.2.2](https://tools.ietf.org/html/rfc7644#section-3.4.2.2) for syntax. Note this API implementation also supports a non-standard \&quot;re\&quot; operator for regular expression matching against string attributes. When using the \&quot;re\&quot; operator, do not include slash characters as delimiters (e.g. use \&quot;foo\&quot; instead of \&quot;/foo/\&quot;.) Also note the case-sensitivity of the regular expression corresponds to the \&quot;caseExact\&quot; characteristic of the target attribute. (optional)</param>
        /// <param name="sortBy">Attribute to be used for sorting resources. See [RFC 7644 section 3.4.2.3](https://tools.ietf.org/html/rfc7644#section-3.4.2.3). The attribute name must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) Use the *sortOrder* parameter to specify whether resources should be sorted in ascending or descending order. (optional)</param>
        ...
        /// <param name="excludedAttributes">Attribute blacklist filter string. A comma-separated list of resource attribute names to be excluded in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* parameter. (optional)</param>
        /// <returns>UserClassResourceList</returns>
        public UserClassResourceList GetUserClasses(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string))
        {
            var localVarResponse = GetUserClassesWithHttpInfo(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes);
            return localVarResponse.Data;
        }
        ...
        /// <param name="excludedAttributes">Attribute blacklist filter string. A comma-separated list of resource attribute names to be excluded in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* parameter. (optional)</param>
        /// <returns>ApiResponse of UserClassResourceList</returns>
        public ApiResponse<UserClassResourceList> GetUserClassesWithHttpInfo(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string))
        {
            FactSet.SDK.ProcuretoPayAPISCIM.Client.RequestOptions localVarRequestOptions = new FactSet.SDK.ProcuretoPayAPISCIM.Client.RequestOptions();
            ...
            localVarRequestOptions.ResponseTypeDictionary = GetUserClassesResponseTypeDictionary;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUserClasses", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserClassResourceList</returns>
        public async System.Threading.Tasks.Task<UserClassResourceList>GetUserClassesAsync(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetUserClassesWithHttpInfoAsync(filter, sortBy, sortOrder, startIndex, count, attributes, excludedAttributes, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<UserClassResourceList>> GetUserClassesWithHttpInfoAsync(string filter = default(string), string sortBy = default(string), string sortOrder = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
