...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    /// SchemaMeta
    /// </summary>
    [DataContract(Name = "Schema_meta")]
    public partial class SchemaMeta : IEquatable<SchemaMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemaMeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SchemaMeta(string resourceType, string location)
        {
        }
        ...
        {
            return this.Equals(input as SchemaMeta);
        }

        /// <summary>
        /// Returns true if SchemaMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of SchemaMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemaMeta input)
        {
            if (input == null)
            {
                return false;
