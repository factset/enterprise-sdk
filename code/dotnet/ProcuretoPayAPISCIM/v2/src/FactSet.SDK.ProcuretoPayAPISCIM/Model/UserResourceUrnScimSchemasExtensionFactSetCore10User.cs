...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    public partial class UserResourceUrnScimSchemasExtensionFactSetCore10User : IEquatable<UserResourceUrnScimSchemasExtensionFactSetCore10User>, IValidatableObject
    {
        ...
        public UserResourceUrnScimSchemasExtensionFactSetCore10User(string username,string serialNumber = default(string), string uniqueId = default(string), LocationResourceReference location = default(LocationResourceReference), UserResourceUrnScimSchemasExtensionFactSetCore10UserUserTaxonomyData userTaxonomyData = default(UserResourceUrnScimSchemasExtensionFactSetCore10UserUserTaxonomyData), string roleName = default(string), string department = default(string), string royaltyClass = default(string), List<ProductResourceReferenceWithRapidActivationInfo> products = default(List<ProductResourceReferenceWithRapidActivationInfo>), List<PendingProductOrder> pendingProductOrders = default(List<PendingProductOrder>), List<FederationResourceReference> federations = default(List<FederationResourceReference>), string invoiceId = default(string))
        {
        ...
        /// </summary>
        /// <value>Description of user&#39;s role/workflow within your organization.</value>
