...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    public partial class GroupResourceMeta : IEquatable<GroupResourceMeta>, IValidatableObject
    {
        ...
        public GroupResourceMeta(string resourceType = default(string), DateTime created = default(DateTime), DateTime lastModified = default(DateTime), string location = default(string))
        {
