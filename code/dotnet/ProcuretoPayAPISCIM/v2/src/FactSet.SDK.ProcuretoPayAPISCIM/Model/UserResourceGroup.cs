...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    /// UserResourceGroup
    /// </summary>
    [DataContract(Name = "UserResourceGroup")]
    public partial class UserResourceGroup : IEquatable<UserResourceGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResourceGroup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public UserResourceGroup(string value = default(string), string _ref = default(string), string display = default(string))
        {
        }
        ...
        {
            return this.Equals(input as UserResourceGroup);
        }

        /// <summary>
        /// Returns true if UserResourceGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of UserResourceGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserResourceGroup input)
        {
            if (input == null)
            {
                return false;
