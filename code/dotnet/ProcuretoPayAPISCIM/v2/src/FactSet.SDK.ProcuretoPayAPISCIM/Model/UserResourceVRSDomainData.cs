...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    public partial class UserResourceVRSDomainData : IEquatable<UserResourceVRSDomainData>, IValidatableObject
    {
        ...
        public UserResourceVRSDomainData(string domainCode, bool isAdministrator,UserResourceVRSDomainDataTenancies tenancies = default(UserResourceVRSDomainDataTenancies), string password = default(string))
        {
