...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    /// SchemaAttribute
    /// </summary>
    [DataContract(Name = "SchemaAttribute")]
    public partial class SchemaAttribute : IEquatable<SchemaAttribute>, IValidatableObject
    {
        /// <summary>
        ...
        public SchemaAttribute(string name, TypeEnum type, bool multiValued,string description = default(string), bool required = default(bool), List<string> canonicalValues = default(List<string>), bool caseExact = default(bool), MutabilityEnum? mutability = default(MutabilityEnum?), ReturnedEnum? returned = default(ReturnedEnum?), UniquenessEnum? uniqueness = default(UniquenessEnum?), List<string> referenceTypes = default(List<string>), List<SchemaSubAttribute> subAttributes = default(List<SchemaSubAttribute>))
        {
        }
        ...
        public List<SchemaSubAttribute> SubAttributes { get; private set; }
        ...
        {
            return this.Equals(input as SchemaAttribute);
        }

        /// <summary>
        /// Returns true if SchemaAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of SchemaAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemaAttribute input)
        {
            if (input == null)
            {
                return false;
