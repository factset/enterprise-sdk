...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    /// GroupResourceMember
    /// </summary>
    [DataContract(Name = "GroupResourceMember")]
    public partial class GroupResourceMember : IEquatable<GroupResourceMember>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupResourceMember" /> class.
        /// </summary>
        ...
        public GroupResourceMember(string value = default(string), string _ref = default(string), string type = default(string))
        {
            this.Value = value;
            this.Ref = _ref;
            this.Type = type;
        ...
        {
            return this.Equals(input as GroupResourceMember);
        }

        /// <summary>
        /// Returns true if GroupResourceMember instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupResourceMember to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupResourceMember input)
        {
            if (input == null)
            {
                return false;
