...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FederationResourceLocation")]
    public partial class FederationResourceLocation : IEquatable<FederationResourceLocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FederationResourceLocation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FederationResourceLocation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FederationResourceLocation" /> class.
        /// </summary>
        ...
        public FederationResourceLocation(string value,string _ref = default(string), string display = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for FederationResourceLocation and cannot be null");
            }
            this.Value = value;
            this.Ref = _ref;
        ...
        {
            return this.Equals(input as FederationResourceLocation);
        }

        /// <summary>
        /// Returns true if FederationResourceLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of FederationResourceLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FederationResourceLocation input)
        {
            if (input == null)
            {
                return false;
