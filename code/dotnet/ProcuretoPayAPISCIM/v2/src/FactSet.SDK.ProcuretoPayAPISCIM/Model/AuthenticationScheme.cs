...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    public partial class AuthenticationScheme : IEquatable<AuthenticationScheme>, IValidatableObject
    {
        ...
        public AuthenticationScheme(string type = default(string), string name = default(string), string description = default(string), string specUri = default(string), string documentationUri = default(string))
        {
        }
