...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    public partial class GroupResource : IEquatable<GroupResource>, IValidatableObject
    {
        ...
        /// <param name="displayName">A human-readable name for the Group. (required).</param>
        /// <param name="description">A description for the Group..</param>
        /// <param name="members">A list of members of the Group..</param>
        /// <param name="urnscimschemasextensionFactSetCore10Group">urnscimschemasextensionFactSetCore10Group.</param>
        ...
        public GroupResource(string displayName,List<string> schemas = default(List<string>), string id = default(string), string externalId = default(string), string description = default(string), List<GroupResourceMember> members = default(List<GroupResourceMember>), GroupResourceUrnScimSchemasExtensionFactSetCore10Group urnscimschemasextensionFactSetCore10Group = default(GroupResourceUrnScimSchemasExtensionFactSetCore10Group), GroupResourceUrnScimSchemasExtensionFactSetEnterpriseHosting10Group urnscimschemasextensionFactSetEnterpriseHosting10Group = default(GroupResourceUrnScimSchemasExtensionFactSetEnterpriseHosting10Group), GroupResourceUrnScimSchemasExtensionFactSetVRS10Group urnscimschemasextensionFactSetVRS10Group = default(GroupResourceUrnScimSchemasExtensionFactSetVRS10Group), GroupResourceMeta meta = default(GroupResourceMeta))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null) {
                throw new ArgumentNullException("displayName is a required property for GroupResource and cannot be null");
            }
            ...
            this.UrnscimschemasextensionFactSetCore10Group = urnscimschemasextensionFactSetCore10Group;
        ...
        /// <summary>
        /// Gets or Sets UrnscimschemasextensionFactSetCore10Group
        /// </summary>
        [DataMember(Name = "urn:scim:schemas:extension:FactSet:Core:1.0:Group", EmitDefaultValue = false)]
        public GroupResourceUrnScimSchemasExtensionFactSetCore10Group UrnscimschemasextensionFactSetCore10Group { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UrnscimschemasextensionFactSetCore10Group: ").Append(UrnscimschemasextensionFactSetCore10Group).Append("\n");
        ...
        public bool Equals(GroupResource input)
        {
            ...
            return 
                ...
                (
                    this.UrnscimschemasextensionFactSetCore10Group == input.UrnscimschemasextensionFactSetCore10Group ||
                    (this.UrnscimschemasextensionFactSetCore10Group != null &&
                    this.UrnscimschemasextensionFactSetCore10Group.Equals(input.UrnscimschemasextensionFactSetCore10Group))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UrnscimschemasextensionFactSetCore10Group != null)
                {
                    hashCode = (hashCode * 59) + this.UrnscimschemasextensionFactSetCore10Group.GetHashCode();
                }
