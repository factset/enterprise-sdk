# FactSet.SDK.ProcuretoPayAPISCIM.Api.FederationsApi
...
namespace Example
{
    public class GetFederationExample
    {
...
<a name="getfederations"></a>
# **GetFederations**
> FederationResourceList GetFederations (string filter = null, int? startIndex = null, int? count = null, string attributes = null, string excludedAttributes = null)
...
namespace Example
{
    public class GetFederationsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling FederationsApi.GetFederations: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="modifyfederation"></a>
# **ModifyFederation**
> FederationResource ModifyFederation (string id, Patch patch = null)
...
namespace Example
{
    public class ModifyFederationExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling FederationsApi.ModifyFederation: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class ReplaceFederationExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration();
            ...
            var id = "id_example";  // string | ID of resource.
            var federationResource = new FederationResource(); // FederationResource | Federation resource.
            ...
            {
                Console.WriteLine("Exception when calling FederationsApi.ReplaceFederation: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
