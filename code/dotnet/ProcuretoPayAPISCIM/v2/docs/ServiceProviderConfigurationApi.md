# FactSet.SDK.ProcuretoPayAPISCIM.Api.ServiceProviderConfigurationApi
...
namespace Example
{
    public class GetServiceProviderConfigExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new ServiceProviderConfigurationApi(config);
            ...
            {
                Console.WriteLine("Exception when calling ServiceProviderConfigurationApi.GetServiceProviderConfig: " + e.Message );
