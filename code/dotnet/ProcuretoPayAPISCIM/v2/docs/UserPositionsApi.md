...
<a name="userpositionsget"></a>
# **UserPositionsGet**
> UserPositionResourceList UserPositionsGet (string filter = null, int? startIndex = null, int? count = null, string attributes = null, string excludedAttributes = null)
...
namespace Example
{
    public class UserPositionsGetExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling UserPositionsApi.UserPositionsGet: " + e.Message );
...
namespace Example
{
    public class UserPositionsIdGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling UserPositionsApi.UserPositionsIdGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
