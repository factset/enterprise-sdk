# FactSet.SDK.ProcuretoPayAPISCIM.Api.UserPositionsApi
...
<a name="getuserposition"></a>
# **GetUserPosition**
> UserPositionResource GetUserPosition (string id, List<string> attributes = null, List<string> excludedAttributes = null, List<string> additionalAttributes = null)
...
namespace Example
{
    public class GetUserPositionExample
    {
        public static async Task Main()
        {
            ...
            var apiInstance = new UserPositionsApi(config);
            ...
            {
                Console.WriteLine("Exception when calling UserPositionsApi.GetUserPosition: " + e.Message );
...
<a name="getuserpositions"></a>
# **GetUserPositions**
> UserPositionResourceList GetUserPositions (string filter = null, string sortBy = null, string sortOrder = null, int? startIndex = null, int? count = null, List<string> attributes = null, List<string> excludedAttributes = null, List<string> additionalAttributes = null)
...
namespace Example
{
    public class GetUserPositionsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling UserPositionsApi.GetUserPositions: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
