...
<a name="userclassesget"></a>
# **UserClassesGet**
> UserClassResourceList UserClassesGet (string filter = null, int? startIndex = null, int? count = null, string attributes = null, string excludedAttributes = null)
...
namespace Example
{
    public class UserClassesGetExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get a list of user classes.
                UserClassResourceList result = apiInstance.UserClassesGet(filter, startIndex, count, attributes, excludedAttributes);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling UserClassesApi.UserClassesGet: " + e.Message );
...
namespace Example
{
    public class UserClassesIdGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration();
            ...
            {
                // Get a user class.
                UserClassResource result = apiInstance.UserClassesIdGet(id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling UserClassesApi.UserClassesIdGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
