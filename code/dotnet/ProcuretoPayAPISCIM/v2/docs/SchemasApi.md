...
namespace Example
{
    public class GetSchemaExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling SchemasApi.GetSchema: " + e.Message );
...
<a name="getschemas"></a>
# **GetSchemas**
> SchemaList GetSchemas (int? startIndex = null, int? count = null)
...
namespace Example
{
    public class GetSchemasExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling SchemasApi.GetSchemas: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
