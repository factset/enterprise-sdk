# FactSet.SDK.ProcuretoPayAPISCIM.Api.ProductsApi
...
namespace Example
{
    public class ProductsGetExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get a list of products.
                ProductResourceList result = apiInstance.ProductsGet(filter, startIndex, count, attributes, excludedAttributes);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ProductsApi.ProductsGet: " + e.Message );
...
namespace Example
{
    public class ProductsIdGetExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get a product.
                ProductResource result = apiInstance.ProductsIdGet(id);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ProductsApi.ProductsIdGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
