...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    public partial class SchemaAttributes : IEquatable<SchemaAttributes>, IValidatableObject
    {
        ...
        public SchemaAttributes(string name, string type, bool multiValued,string description = default(string), bool required = default(bool), List<string> canonicalValues = default(List<string>), bool caseExact = default(bool), string mutability = default(string), string returned = default(string), string uniqueness = default(string), List<string> referenceTypes = default(List<string>), List<SchemaSubAttributes> subAttributes = default(List<SchemaSubAttributes>))
        {
        }
