...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceProviderConfig_sort")]
    public partial class ServiceProviderConfigSort : IEquatable<ServiceProviderConfigSort>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceProviderConfigSort {\n");
        ...
        {
            return this.Equals(input as ServiceProviderConfigSort);
        }

        /// <summary>
        /// Returns true if ServiceProviderConfigSort instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceProviderConfigSort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceProviderConfigSort input)
        {
            if (input == null)
            {
                return false;
