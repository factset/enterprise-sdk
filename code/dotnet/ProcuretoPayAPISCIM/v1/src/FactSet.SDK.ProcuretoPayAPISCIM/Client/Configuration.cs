...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/ProcuretoPayAPISCIM/0.21.4";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/scim/v2") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.ProcuretoPayAPISCIM) Debug Report:\n";
