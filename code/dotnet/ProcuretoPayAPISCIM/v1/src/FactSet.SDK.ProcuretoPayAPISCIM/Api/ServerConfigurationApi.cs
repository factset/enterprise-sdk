...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Api
{
    ...
    public partial class ServerConfigurationApi : IServerConfigurationApi
    {
        ...
        /// <returns></returns>
        public ServerConfigurationApi(FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration configuration)
        {
        ...
        public ServerConfigurationApi(FactSet.SDK.ProcuretoPayAPISCIM.Client.ISynchronousClient client, FactSet.SDK.ProcuretoPayAPISCIM.Client.IAsynchronousClient asyncClient, FactSet.SDK.ProcuretoPayAPISCIM.Client.IReadableConfiguration configuration)
        {
