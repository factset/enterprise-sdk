...
namespace FactSet.SDK.ProcuretoPayAPISCIM.Api
{
    ...
    public interface IProductsApiSync : IApiAccessor
    {
        ...
        /// <returns>ProductResourceList</returns>
        ProductResourceList ProductsGet(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string));
        ...
        /// <param name="attributes">Attribute whitelist filter string. A comma-separated list of resource attribute names to be returned in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *excludedAttributes* parameter. (optional)</param>
        /// <param name="excludedAttributes">Attribute blacklist filter string. A comma-separated list of resource attribute names to be excluded in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* parameter. (optional)</param>
        /// <returns>ApiResponse of ProductResourceList</returns>
        ApiResponse<ProductResourceList> ProductsGetWithHttpInfo(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string));
        /// <summary>
        /// Get a product.
        /// </summary>
        /// <exception cref="FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <exception cref="FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID of resource.</param>
        /// <returns>ApiResponse of ProductResource</returns>
        ApiResponse<ProductResource> ProductsIdGetWithHttpInfo(string id);
    ...
    public interface IProductsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ProductResourceList</returns>
        System.Threading.Tasks.Task<ProductResourceList> ProductsGetAsync(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="id">ID of resource.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProductResource</returns>
        System.Threading.Tasks.Task<ProductResource> ProductsIdGetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="id">ID of resource.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProductResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<ProductResource>> ProductsIdGetWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ProductsApi : IProductsApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> ProductsGetResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(ProductResourceList) },
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> ProductsIdGetResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            { (HttpStatusCode)200, typeof(ProductResource) },
            { (HttpStatusCode)401, typeof(Error) },
            { (HttpStatusCode)403, typeof(Error) },
        ...
        /// <returns></returns>
        public ProductsApi(FactSet.SDK.ProcuretoPayAPISCIM.Client.Configuration configuration)
        {
        ...
        public ProductsApi(FactSet.SDK.ProcuretoPayAPISCIM.Client.ISynchronousClient client, FactSet.SDK.ProcuretoPayAPISCIM.Client.IAsynchronousClient asyncClient, FactSet.SDK.ProcuretoPayAPISCIM.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="excludedAttributes">Attribute blacklist filter string. A comma-separated list of resource attribute names to be excluded in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* parameter. (optional)</param>
        /// <returns>ProductResourceList</returns>
        public ProductResourceList ProductsGet(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string))
        {
            var localVarResponse = ProductsGetWithHttpInfo(filter, startIndex, count, attributes, excludedAttributes);
        ...
        /// <param name="excludedAttributes">Attribute blacklist filter string. A comma-separated list of resource attribute names to be excluded in the response, overriding the set of attributes that would be returned by default. Attribute names must be specified in standard attribute notation (see [RFC 7644 section 3.10](https://datatracker.ietf.org/doc/html/rfc7644#section-3.10).) This parameter cannot be used with the *attributes* parameter. (optional)</param>
        /// <returns>ApiResponse of ProductResourceList</returns>
        public ApiResponse<ProductResourceList> ProductsGetWithHttpInfo(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string))
        {
            ...
            localVarRequestOptions.ResponseTypeDictionary = ProductsGetResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            ProductResourceList>("/Products", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProductResourceList</returns>
        public async System.Threading.Tasks.Task<ProductResourceList>ProductsGetAsync(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await ProductsGetWithHttpInfoAsync(filter, startIndex, count, attributes, excludedAttributes, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ProductResourceList>> ProductsGetWithHttpInfoAsync(string filter = default(string), int? startIndex = default(int?), int? count = default(int?), string attributes = default(string), string excludedAttributes = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ProductResourceList>("/Products", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="id">ID of resource.</param>
        /// <returns>ProductResource</returns>
        public ProductResource ProductsIdGet(string id)
        {
            var localVarResponse = ProductsIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID of resource.</param>
        /// <returns>ApiResponse of ProductResource</returns>
        public ApiResponse<ProductResource> ProductsIdGetWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPayAPISCIM.Client.ApiException(400, "Missing required parameter 'id' when calling ProductsApi->ProductsIdGet");
            }
            ...
            localVarRequestOptions.ResponseTypeDictionary = ProductsIdGetResponseTypeDictionary;

            // make the HTTP request
            var localVarResponse = this.Client.Get<
            ProductResource>("/Products/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ProductsIdGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProductResource</returns>
        public async System.Threading.Tasks.Task<ProductResource>ProductsIdGetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await ProductsIdGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ProductResource>> ProductsIdGetWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ProductResource>("/Products/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
