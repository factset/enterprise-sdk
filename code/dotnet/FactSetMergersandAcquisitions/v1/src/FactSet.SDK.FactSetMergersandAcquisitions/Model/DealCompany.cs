...
namespace FactSet.SDK.FactSetMergersandAcquisitions.Model
{
    ...
    /// DealCompany
    /// </summary>
    [DataContract(Name = "DealCompany")]
    public partial class DealCompany : IEquatable<DealCompany>, IValidatableObject
    {
        /// <summary>
        /// Type of deal.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealCompany" /> class.
        /// </summary>
        ...
        /// <param name="announceDate">Date the deal was announced. If the deal has a status of &#x60;rumor&#x60; or &#x60;rumor cancelled&#x60;, then this may be the same as &#x60;rumorDate&#x60;..</param>
        ...
        public DealCompany(string dealId = default(string), Target target = default(Target), List<Participant> buyers = default(List<Participant>), List<Participant> sellers = default(List<Participant>), DealTypeEnum? dealType = default(DealTypeEnum?), DateTime announceDate = default(DateTime), DateTime? closeDate = default(DateTime?), decimal? transactionValue = default(decimal?), StatusEnum? status = default(StatusEnum?), string requestId = default(string))
        {
            this.DealId = dealId;
            this.Target = target;
            this.Buyers = buyers;
        ...
        /// </summary>
        /// <value>Date the deal was announced. If the deal has a status of &#x60;rumor&#x60; or &#x60;rumor cancelled&#x60;, then this may be the same as &#x60;rumorDate&#x60;.</value>
        ...
        {
            return this.Equals(input as DealCompany);
        }

        /// <summary>
        /// Returns true if DealCompany instances are equal
        /// </summary>
        /// <param name="input">Instance of DealCompany to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealCompany input)
        {
            if (input == null)
            {
                return false;
