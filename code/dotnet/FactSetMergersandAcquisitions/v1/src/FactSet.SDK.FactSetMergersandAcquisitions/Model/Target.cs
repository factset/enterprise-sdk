...
namespace FactSet.SDK.FactSetMergersandAcquisitions.Model
{
    ...
    public partial class Target : IEquatable<Target>, IValidatableObject
    {
        ...
        public Target(string fsymId,string name = default(string), string industry = default(string))
        {
            // to ensure "fsymId" is required (not null)
            if (fsymId == null) {
                throw new ArgumentNullException("fsymId is a required property for Target and cannot be null");
            }
            this.FsymId = fsymId;
            this.Name = name;
