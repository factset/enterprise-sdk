...
namespace FactSet.SDK.FactSetMergersandAcquisitions.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BuyersAdvisor")]
    public partial class BuyersAdvisor : IEquatable<BuyersAdvisor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyersAdvisor" /> class.
        /// </summary>
        /// <param name="financial">financial.</param>
        /// <param name="legal">legal.</param>
        public BuyersAdvisor(List<AdvisorParticipant> financial = default(List<AdvisorParticipant>), List<AdvisorParticipant> legal = default(List<AdvisorParticipant>))
        {
        ...
        {
            return this.Equals(input as BuyersAdvisor);
        }

        /// <summary>
        /// Returns true if BuyersAdvisor instances are equal
        /// </summary>
        /// <param name="input">Instance of BuyersAdvisor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuyersAdvisor input)
        {
            if (input == null)
            {
                return false;
