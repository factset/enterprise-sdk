...
namespace FactSet.SDK.FactSetMergersandAcquisitions.Model
{
    ...
    /// Deals Request
    /// </summary>
    [DataContract(Name = "DealsRequest")]
    public partial class DealsRequest : IEquatable<DealsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public DealsRequest(DealsRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for DealsRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public DealsRequestBody Data { get; set; }
        ...
        {
            return this.Equals(input as DealsRequest);
        }

        /// <summary>
        /// Returns true if DealsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsRequest input)
        {
            if (input == null)
            {
                return false;
