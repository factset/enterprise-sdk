...
namespace FactSet.SDK.FactSetMergersandAcquisitions.Model
{
    ...
    /// DealsPublicResponse
    /// </summary>
    [DataContract(Name = "DealsPublicResponse")]
    public partial class DealsPublicResponse : IEquatable<DealsPublicResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsPublicResponse" /> class.
        /// </summary>
        /// <param name="data">Array of Deals Objects.</param>
        public DealsPublicResponse(List<DealPublic> data = default(List<DealPublic>))
        {
            this.Data = data;
        }
        ...
        public List<DealPublic> Data { get; set; }
        ...
        {
            return this.Equals(input as DealsPublicResponse);
        }

        /// <summary>
        /// Returns true if DealsPublicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsPublicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsPublicResponse input)
        {
            if (input == null)
            {
                return false;
