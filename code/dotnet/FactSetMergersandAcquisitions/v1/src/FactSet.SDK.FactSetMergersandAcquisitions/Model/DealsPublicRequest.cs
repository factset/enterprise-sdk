...
namespace FactSet.SDK.FactSetMergersandAcquisitions.Model
{
    ...
    /// Deals Request
    /// </summary>
    [DataContract(Name = "DealsPublicRequest")]
    public partial class DealsPublicRequest : IEquatable<DealsPublicRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsPublicRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsPublicRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsPublicRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public DealsPublicRequest(DealsPublicRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for DealsPublicRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public DealsPublicRequestBody Data { get; set; }
        ...
        {
            return this.Equals(input as DealsPublicRequest);
        }

        /// <summary>
        /// Returns true if DealsPublicRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsPublicRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsPublicRequest input)
        {
            if (input == null)
            {
                return false;
