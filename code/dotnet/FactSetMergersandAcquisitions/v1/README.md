...
[![Nuget](https://img.shields.io/badge/nuget-v1.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetMergersandAcquisitions/1.2.0)
...
dotnet add package FactSet.SDK.FactSetMergersandAcquisitions -v 1.2.0
```
...
nuget install FactSet.SDK.FactSetMergersandAcquisitions -Version 1.2.0
```
