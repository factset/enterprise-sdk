# FactSet.SDK.FactSetPartnerFunds.Model.RiskResponseInfo
...
**Volatility** | **decimal?** | Volatility is a measure of risk using a ranking of Standard Deviation in percentiles among its peer group. A scale from 1 to 10 is used to indicate in which decile the fund falls. A fund with 10 volatility is the highest and 1 is the lowest. | [optional] 
