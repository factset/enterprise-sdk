...
namespace FactSet.SDK.FactSetIntradayTickHistory.Api
{
    ...
    /// </summary>
    public interface ITradesAtTimeApiSync : IApiAccessor
    {
        ...
        TickhistoryResponse TickHistoryTradesattimeGet(string id, string reqId = default(string), string format = default(string), string date = default(string), string time = default(string));
        ...
        ApiResponse<TickhistoryResponse> TickHistoryTradesattimeGetWithHttpInfo(string id, string reqId = default(string), string format = default(string), string date = default(string), string time = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITradesAtTimeApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TickhistoryResponse> TickHistoryTradesattimeGetAsync(string id, string reqId = default(string), string format = default(string), string date = default(string), string time = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TickhistoryResponse>> TickHistoryTradesattimeGetWithHttpInfoAsync(string id, string reqId = default(string), string format = default(string), string date = default(string), string time = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITradesAtTimeApi : ITradesAtTimeApiSync, ITradesAtTimeApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TradesAtTimeApi : ITradesAtTimeApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public TradesAtTimeApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TradesAtTimeApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TradesAtTimeApi(FactSet.SDK.FactSetIntradayTickHistory.Client.Configuration configuration)
        {
        ...
        public TradesAtTimeApi(FactSet.SDK.FactSetIntradayTickHistory.Client.ISynchronousClient client, FactSet.SDK.FactSetIntradayTickHistory.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetIntradayTickHistory.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<TickhistoryResponse> TickHistoryTradesattimeGetWithHttpInfo(string id, string reqId = default(string), string format = default(string), string date = default(string), string time = default(string))
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.FactSetIntradayTickHistory.Client.ApiException(400, "Missing required parameter 'id' when calling TradesAtTimeApi->TickHistoryTradesattimeGet");
            }
