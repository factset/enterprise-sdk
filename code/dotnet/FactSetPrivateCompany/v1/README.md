...
[![Nuget](https://img.shields.io/badge/nuget-v1.2.0-orange)](https://www.nuget.org/packages/FactSet.SDK.FactSetPrivateCompany/1.2.0)
...
dotnet add package FactSet.SDK.FactSetPrivateCompany -v 1.2.0
```
...
nuget install FactSet.SDK.FactSetPrivateCompany -Version 1.2.0
```
