...
namespace FactSet.SDK.FactSetPrivateCompany.Api
{
    ...
    public interface INonPeriodicApiSync : IApiAccessor
    {
        ...
        /// <param name="metrics">Requested list of Private Company Non-Periodic Metrics. </param>
        ...
        ApiResponse<NonPeriodicResponse> GetNonPeriodicWithHttpInfo(List<string> ids, List<string> metrics);
        /// <summary>
        /// Returns Private Company Reference Data.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="FactSet.SDK.FactSetPrivateCompany.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="nonPeriodicRequest">Request Body to request a list of Private Company non-periodic objects.</param>
        /// <returns>NonPeriodicResponse</returns>
    ...
    public interface INonPeriodicApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<NonPeriodicResponse> GetNonPeriodicAsync(List<string> ids, List<string> metrics, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<NonPeriodicResponse>> GetNonPeriodicWithHttpInfoAsync(List<string> ids, List<string> metrics, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns Private Company Reference Data.
        /// </summary>
        /// <remarks>
    ...
    public partial class NonPeriodicApi : INonPeriodicApi
    {
        ...
        /// <returns></returns>
        public NonPeriodicApi(FactSet.SDK.FactSetPrivateCompany.Client.Configuration configuration)
        {
        ...
        public NonPeriodicApi(FactSet.SDK.FactSetPrivateCompany.Client.ISynchronousClient client, FactSet.SDK.FactSetPrivateCompany.Client.IAsynchronousClient asyncClient, FactSet.SDK.FactSetPrivateCompany.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Returns Private Company Reference Data. Retrieves non-periodic reference information for specified Private Companies. Use the &#x60;&#x60;&#x60;/universe&#x60;&#x60;&#x60; endpoint to  retrieve valid Private Company identifiers. Use the &#x60;&#x60;&#x60;/metrics&#x60;&#x60;&#x60; endpoint to retrieve a  full list of valid metrics or data items.  
        /// </summary>
        /// <exception cref="FactSet.SDK.FactSetPrivateCompany.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ids">The requested FactSet Private Company Entity Identifier in XXXXXX-E format.&lt;br/&gt;&lt;br/&gt; *Make note, GET Method URL request lines are also limited to a total length of 8192 bytes (8KB). In cases where the  service allows for thousands of ids, which may lead to exceeding this request line limit of 8KB,  it&#39;s advised for any requests with large request lines to be requested through the respective \\\&quot;POST\\\&quot; method.* </param>
        /// <param name="metrics">Requested list of Private Company Non-Periodic Metrics. </param>
        /// <returns>NonPeriodicResponse</returns>
        public NonPeriodicResponse GetNonPeriodic(List<string> ids, List<string> metrics)
        {
            var localVarResponse = GetNonPeriodicWithHttpInfo(ids, metrics);
        ...
        /// <param name="metrics">Requested list of Private Company Non-Periodic Metrics. </param>
        /// <returns>ApiResponse of NonPeriodicResponse</returns>
        public ApiResponse<NonPeriodicResponse> GetNonPeriodicWithHttpInfo(List<string> ids, List<string> metrics)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
                throw new FactSet.SDK.FactSetPrivateCompany.Client.ApiException(400, "Missing required parameter 'ids' when calling NonPeriodicApi->GetNonPeriodic");
            }

            // verify the required parameter 'metrics' is set
            if (metrics == null)
            {
                throw new FactSet.SDK.FactSetPrivateCompany.Client.ApiException(400, "Missing required parameter 'metrics' when calling NonPeriodicApi->GetNonPeriodic");
            }
            ...
            NonPeriodicResponse>("/non-periodic", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NonPeriodicResponse</returns>
        public async System.Threading.Tasks.Task<NonPeriodicResponse>GetNonPeriodicAsync(List<string> ids, List<string> metrics, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetNonPeriodicWithHttpInfoAsync(ids, metrics, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<NonPeriodicResponse>> GetNonPeriodicWithHttpInfoAsync(List<string> ids, List<string> metrics, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<NonPeriodicResponse>("/non-periodic", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<NonPeriodicResponse> GetNonPeriodicForListWithHttpInfo(NonPeriodicRequest nonPeriodicRequest)
        {
            ...
            {
                throw new FactSet.SDK.FactSetPrivateCompany.Client.ApiException(400, "Missing required parameter 'nonPeriodicRequest' when calling NonPeriodicApi->GetNonPeriodicForList");
            }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<NonPeriodicResponse>> GetNonPeriodicForListWithHttpInfoAsync(NonPeriodicRequest nonPeriodicRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NonPeriodicResponse>("/non-periodic", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
