...
namespace FactSet.SDK.FactSetPrivateCompany.Model
{
    ...
    public partial class NonPeriodicRequest : IEquatable<NonPeriodicRequest>, IValidatableObject
    {
        ...
        public NonPeriodicRequest(NonPeriodicRequestBody data)
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for NonPeriodicRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public NonPeriodicRequestBody Data { get; set; }
