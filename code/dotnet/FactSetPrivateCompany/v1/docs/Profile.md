...
**TotalInvestors** | **int?** | Total number of investors for the portfolio company. | [optional] 
...
**VcpeAmountRaisedLocalCurrency** | **double?** | Current estimated total of venture capital and private equity raised in all rounds of the portfolio company. This item applies to venture capital and private equity raised rounds.    | [optional] 
