# FactSet.SDK.FactSetPrivateCompany.Api.UniverseApi
...
namespace Example
{
    public class GetUniverseExample
    {
        public static async Task Main()
        {
            ...
            var name = "Alto Pharmacy";  // string | Name of Entity to match.<br/>  <p>***max length** =  200 per request*</p> 
            var country = "US";  // string | ISO2 country code corresponding to the entity name is used when evaluating candidates for a match. For a list of ISO2 Country codes, visit [OA 8754](https://my.apps.factset.com/oa/pages/8754). (optional) 
