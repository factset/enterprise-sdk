...
dotnet add package FactSet.SDK.ExchangeDataFeedSnapshotAPIEntireExchange -v 0.21.8
```
...
nuget install FactSet.SDK.ExchangeDataFeedSnapshotAPIEntireExchange -Version 0.21.8
```
