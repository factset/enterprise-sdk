...
namespace FactSet.SDK.ProcuretoPayProvisioning.Model
{
    ...
    /// ManageProductIds
    /// </summary>
    [DataContract(Name = "manageProductIds")]
    public partial class ManageProductIds : IEquatable<ManageProductIds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManageProductIds" /> class.
        /// </summary>
        /// <param name="uniqueId">uniqueId.</param>
        /// <param name="productIds">productIds.</param>
        public ManageProductIds(string uniqueId = default(string), List<string> productIds = default(List<string>))
        {
        ...
        {
            return this.Equals(input as ManageProductIds);
        }

        /// <summary>
        /// Returns true if ManageProductIds instances are equal
        /// </summary>
        /// <param name="input">Instance of ManageProductIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManageProductIds input)
        {
            if (input == null)
                return false;
