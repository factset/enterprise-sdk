...
namespace FactSet.SDK.ProcuretoPayProvisioning.Model
{
    ...
    /// CreateIndividual
    /// </summary>
    [DataContract(Name = "createIndividual")]
    public partial class CreateIndividual : IEquatable<CreateIndividual>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIndividual" /> class.
        /// </summary>
        /// <param name="firstName">firstName.</param>
        /// <param name="lastName">lastName.</param>
        /// <param name="uniqueId">A unique, constant reference to an individual/account. Used for Future management of individual..</param>
        /// <param name="roleId">roleId.</param>
        /// <param name="email">email.</param>
        /// <param name="assertionField">A unique value passed as nameId in the SAML response.</param>
        /// <param name="locationId">Your reference to a physical location..</param>
        public CreateIndividual(string firstName = default(string), string lastName = default(string), string uniqueId = default(string), string roleId = default(string), string email = default(string), string assertionField = default(string), string locationId = default(string))
        {
        ...
        /// </summary>
        /// <value>A unique, constant reference to an individual/account. Used for Future management of individual.</value>
        ...
        /// </summary>
        /// <value>A unique value passed as nameId in the SAML response</value>
        ...
        {
            return this.Equals(input as CreateIndividual);
        }

        /// <summary>
        /// Returns true if CreateIndividual instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateIndividual to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateIndividual input)
        {
            if (input == null)
                return false;
