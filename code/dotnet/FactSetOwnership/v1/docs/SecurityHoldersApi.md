...
namespace Example
{
    public class GetSecurityHoldersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SecurityHoldersApi.GetSecurityHolders: " + e.Message );
...
namespace Example
{
    public class PostSecurityHoldersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SecurityHoldersApi.PostSecurityHolders: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
