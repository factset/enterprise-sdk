...
namespace FactSet.SDK.FactSetOwnership.Api
{
    ...
    public interface IFundHoldingsApiSync : IApiAccessor
    {
        ...
        /// <param name="ids">List of requested fund identifiers. &lt;p&gt;***ids limit** &#x3D;  10 per request*&lt;/p&gt; &lt;p&gt;***Batch ids limit** &#x3D;  1000 per request*&lt;/p&gt;</param>
        ...
        /// <param name="assetType">Filter holdings by the following major asset classes -   * **EQ**  &#x3D; Equity   * **FI** &#x3D; Fixed Income   * **ALL** &#x3D; ALL  (optional)</param>
        ...
        /// <returns>FundHoldingsApi.GetOwnershipHoldingsResponseWrapper</returns>
        FundHoldingsApi.GetOwnershipHoldingsResponseWrapper GetOwnershipHoldings(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?));
        ...
        /// <param name="currency">Currency code for adjusting prices. Default is Local. For a list of currency ISO codes, visit [Online Assistant Page 1470](https://oa.apps.factset.com/pages/1470). (optional, default to &quot;LOCAL&quot;)</param>
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional)</param>
        /// <returns>ApiResponse of FundHoldingsApi.GetOwnershipHoldingsResponseWrapper</returns>
        ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper> GetOwnershipHoldingsWithHttpInfo(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?));
        /// <summary>
        ...
        /// <returns>FundHoldingsApi.PostOwnershipHoldingsResponseWrapper</returns>
        FundHoldingsApi.PostOwnershipHoldingsResponseWrapper PostOwnershipHoldings(FundHoldingsRequest fundHoldingsRequest);
        ...
        /// <exception cref="FactSet.SDK.FactSetOwnership.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="fundHoldingsRequest">Requesting Underlying Holdings for a list of Fund Identifiers.</param>
        /// <returns>ApiResponse of FundHoldingsApi.PostOwnershipHoldingsResponseWrapper</returns>
        ApiResponse<FundHoldingsApi.PostOwnershipHoldingsResponseWrapper> PostOwnershipHoldingsWithHttpInfo(FundHoldingsRequest fundHoldingsRequest);
    ...
    public interface IFundHoldingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper> GetOwnershipHoldingsAsync(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FundHoldingsApi.GetOwnershipHoldingsResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper>> GetOwnershipHoldingsWithHttpInfoAsync(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get holdings for a list of funds.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FundHoldingsResponse</returns>
        System.Threading.Tasks.Task<FundHoldingsApi.PostOwnershipHoldingsResponseWrapper> PostOwnershipHoldingsAsync(FundHoldingsRequest fundHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="fundHoldingsRequest">Requesting Underlying Holdings for a list of Fund Identifiers.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FundHoldingsApi.PostOwnershipHoldingsResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<FundHoldingsApi.PostOwnershipHoldingsResponseWrapper>> PostOwnershipHoldingsWithHttpInfoAsync(FundHoldingsRequest fundHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class FundHoldingsApi : IFundHoldingsApi
    {
        ...
        /// <item>
        /// <description>
        /// 200 : FundHoldingsResponse<br />
        /// Fund Holdings Response.
        /// </description>
        /// </item>
        /// 
        /// <item>
        ...
        /// </example>
        /// </summary>
        public class GetOwnershipHoldingsResponseWrapper {

            /// <summary>This constructor initializes the new GetOwnershipHoldingsResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetOwnershipHoldingsResponseWrapper(HttpStatusCode statusCode, object response)
            {
            ...
            /// Fund Holdings Response.
            /// </summary>
            public FundHoldingsResponse Response200
            {
                get
                {
                    ...
                    return (FundHoldingsResponse) Response;
                }
            }
        ...
        /// </example>
        /// </summary>
        public class PostOwnershipHoldingsResponseWrapper {

            /// <summary>This constructor initializes the new PostOwnershipHoldingsResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public PostOwnershipHoldingsResponseWrapper(HttpStatusCode statusCode, object response)
            {
                StatusCode = statusCode;
                Response = response;
            }
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional)</param>
        /// <returns>FundHoldingsApi.GetOwnershipHoldingsResponseWrapper</returns>
        public FundHoldingsApi.GetOwnershipHoldingsResponseWrapper GetOwnershipHoldings(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?))
        {
            var localVarResponse = GetOwnershipHoldingsWithHttpInfo(ids, date, topn, assetType, currency, batch);
        ...
        public ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper> GetOwnershipHoldingsWithHttpInfo(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?))
        {
            ...
            Object>("/fund-holdings", localVarRequestOptions, this.Configuration);
            ...
            var getownershipholdingsResponse = new GetOwnershipHoldingsResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetOwnershipHoldingsResponseWrapper>(localVarResponse.StatusCode, getownershipholdingsResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FundHoldingsResponse</returns>
        public async System.Threading.Tasks.Task<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper>GetOwnershipHoldingsAsync(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetOwnershipHoldingsWithHttpInfoAsync(ids, date, topn, assetType, currency, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper>> GetOwnershipHoldingsWithHttpInfoAsync(List<string> ids, string date = default(string), string topn = default(string), AssetType? assetType = default(AssetType?), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/fund-holdings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="fundHoldingsRequest">Requesting Underlying Holdings for a list of Fund Identifiers.</param>
        /// <returns>FundHoldingsApi.PostOwnershipHoldingsResponseWrapper</returns>
        public FundHoldingsApi.PostOwnershipHoldingsResponseWrapper PostOwnershipHoldings(FundHoldingsRequest fundHoldingsRequest)
        {
        ...
        /// <param name="fundHoldingsRequest">Requesting Underlying Holdings for a list of Fund Identifiers.</param>
        /// <returns>ApiResponse of FundHoldingsResponse</returns>
        public ApiResponse<FundHoldingsApi.PostOwnershipHoldingsResponseWrapper> PostOwnershipHoldingsWithHttpInfo(FundHoldingsRequest fundHoldingsRequest)
        {
            ...
            var postownershipholdingsResponse = new PostOwnershipHoldingsResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<PostOwnershipHoldingsResponseWrapper>(localVarResponse.StatusCode, postownershipholdingsResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FundHoldingsResponse</returns>
        public async System.Threading.Tasks.Task<FundHoldingsApi.PostOwnershipHoldingsResponseWrapper>PostOwnershipHoldingsAsync(FundHoldingsRequest fundHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<FundHoldingsApi.PostOwnershipHoldingsResponseWrapper>> PostOwnershipHoldingsWithHttpInfoAsync(FundHoldingsRequest fundHoldingsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'fundHoldingsRequest' is set
            if (fundHoldingsRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/fund-holdings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
