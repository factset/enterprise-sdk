...
namespace FactSet.SDK.FactSetOwnership.Api
{
    ...
    public interface IFundHoldingsApiSync : IApiAccessor
    {
        ...
        FundHoldingsApi.GetOwnershipHoldingsResponseWrapper GetOwnershipHoldings(List<string> ids, string date = default(string), string topn = default(string), string assetType = default(string), string currency = default(string), string batch = default(string));
        ...
        ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper> GetOwnershipHoldingsWithHttpInfo(List<string> ids, string date = default(string), string topn = default(string), string assetType = default(string), string currency = default(string), string batch = default(string));
        /// <summary>
    ...
    public interface IFundHoldingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper> GetOwnershipHoldingsAsync(List<string> ids, string date = default(string), string topn = default(string), string assetType = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper>> GetOwnershipHoldingsWithHttpInfoAsync(List<string> ids, string date = default(string), string topn = default(string), string assetType = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get holdings for a list of funds.
        /// </summary>
        /// <remarks>
    ...
    public partial class FundHoldingsApi : IFundHoldingsApi
    {
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional, default to N)</param>
        /// <returns>FundHoldingsApi.GetOwnershipHoldingsResponseWrapper</returns>
        public FundHoldingsApi.GetOwnershipHoldingsResponseWrapper GetOwnershipHoldings(List<string> ids, string date = default(string), string topn = default(string), string assetType = default(string), string currency = default(string), string batch = default(string))
        {
        ...
        public ApiResponse<FundHoldingsApi.GetOwnershipHoldingsResponseWrapper> GetOwnershipHoldingsWithHttpInfo(List<string> ids, string date = default(string), string topn = default(string), string assetType = default(string), string currency = default(string), string batch = default(string))
        {
