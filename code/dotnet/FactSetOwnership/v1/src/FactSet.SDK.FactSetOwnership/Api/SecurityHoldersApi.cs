...
namespace FactSet.SDK.FactSetOwnership.Api
{
    ...
    public interface ISecurityHoldersApiSync : IApiAccessor
    {
        ...
        /// <param name="ids">Requested list of security identifiers. &lt;p&gt;***ids limit** &#x3D;  1 per request*&lt;/p&gt; &lt;p&gt;***Batch ids limit** &#x3D;  1000 per request*&lt;/p&gt;.</param>
        ...
        /// <returns>SecurityHoldersApi.GetSecurityHoldersResponseWrapper</returns>
        SecurityHoldersApi.GetSecurityHoldersResponseWrapper GetSecurityHolders(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?));
        ...
        /// <param name="currency">Currency code for adjusting prices. Default is Local. For a list of currency ISO codes, visit [Online Assistant Page 1470](https://oa.apps.factset.com/pages/1470). (optional, default to &quot;LOCAL&quot;)</param>
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional)</param>
        /// <returns>ApiResponse of SecurityHoldersApi.GetSecurityHoldersResponseWrapper</returns>
        ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper> GetSecurityHoldersWithHttpInfo(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?));
        /// <summary>
        ...
        /// <returns>SecurityHoldersApi.PostSecurityHoldersResponseWrapper</returns>
        SecurityHoldersApi.PostSecurityHoldersResponseWrapper PostSecurityHolders(SecurityHoldersRequest securityHoldersRequest);
        ...
        /// <exception cref="FactSet.SDK.FactSetOwnership.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="securityHoldersRequest">Requesting Security Holders for a list of Fund Identifiers.</param>
        /// <returns>ApiResponse of SecurityHoldersApi.PostSecurityHoldersResponseWrapper</returns>
        ApiResponse<SecurityHoldersApi.PostSecurityHoldersResponseWrapper> PostSecurityHoldersWithHttpInfo(SecurityHoldersRequest securityHoldersRequest);
    ...
    public interface ISecurityHoldersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SecurityHoldersApi.GetSecurityHoldersResponseWrapper> GetSecurityHoldersAsync(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SecurityHoldersApi.GetSecurityHoldersResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper>> GetSecurityHoldersWithHttpInfoAsync(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get security ownership data for a list of requested securities.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SecurityHoldersResponse</returns>
        System.Threading.Tasks.Task<SecurityHoldersApi.PostSecurityHoldersResponseWrapper> PostSecurityHoldersAsync(SecurityHoldersRequest securityHoldersRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="securityHoldersRequest">Requesting Security Holders for a list of Fund Identifiers.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SecurityHoldersApi.PostSecurityHoldersResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<SecurityHoldersApi.PostSecurityHoldersResponseWrapper>> PostSecurityHoldersWithHttpInfoAsync(SecurityHoldersRequest securityHoldersRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SecurityHoldersApi : ISecurityHoldersApi
    {
        ...
        /// <item>
        /// <description>
        /// 200 : SecurityHoldersResponse<br />
        /// Security Holders Response.
        /// </description>
        /// </item>
        /// 
        /// <item>
        ...
        /// </example>
        /// </summary>
        public class GetSecurityHoldersResponseWrapper {

            /// <summary>This constructor initializes the new GetSecurityHoldersResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public GetSecurityHoldersResponseWrapper(HttpStatusCode statusCode, object response)
            {
            ...
            /// Security Holders Response.
            /// </summary>
            public SecurityHoldersResponse Response200
            {
                get
                {
                    ...
                    return (SecurityHoldersResponse) Response;
                }
            }
        ...
        /// </example>
        /// </summary>
        public class PostSecurityHoldersResponseWrapper {

            /// <summary>This constructor initializes the new PostSecurityHoldersResponseWrapper to
            /// (<paramref name="statusCode"/>,<paramref name="response"/>).
            /// </summary>
            /// <param name="statusCode">Http status code of the response</param>
            /// <param name="response">Raw response</param>
            public PostSecurityHoldersResponseWrapper(HttpStatusCode statusCode, object response)
            {
                StatusCode = statusCode;
                Response = response;
            }
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional)</param>
        /// <returns>SecurityHoldersApi.GetSecurityHoldersResponseWrapper</returns>
        public SecurityHoldersApi.GetSecurityHoldersResponseWrapper GetSecurityHolders(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?))
        {
            var localVarResponse = GetSecurityHoldersWithHttpInfo(ids, holderType, topn, date, currency, batch);
        ...
        public ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper> GetSecurityHoldersWithHttpInfo(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?))
        {
            ...
            Object>("/security-holders", localVarRequestOptions, this.Configuration);
            ...
            var getsecurityholdersResponse = new GetSecurityHoldersResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<GetSecurityHoldersResponseWrapper>(localVarResponse.StatusCode, getsecurityholdersResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SecurityHoldersResponse</returns>
        public async System.Threading.Tasks.Task<SecurityHoldersApi.GetSecurityHoldersResponseWrapper>GetSecurityHoldersAsync(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetSecurityHoldersWithHttpInfoAsync(ids, holderType, topn, date, currency, batch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper>> GetSecurityHoldersWithHttpInfoAsync(List<string> ids, HolderType? holderType = default(HolderType?), string topn = default(string), string date = default(string), string currency = default(string), Batch? batch = default(Batch?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/security-holders", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="securityHoldersRequest">Requesting Security Holders for a list of Fund Identifiers.</param>
        /// <returns>SecurityHoldersApi.PostSecurityHoldersResponseWrapper</returns>
        public SecurityHoldersApi.PostSecurityHoldersResponseWrapper PostSecurityHolders(SecurityHoldersRequest securityHoldersRequest)
        {
        ...
        /// <param name="securityHoldersRequest">Requesting Security Holders for a list of Fund Identifiers.</param>
        /// <returns>ApiResponse of SecurityHoldersResponse</returns>
        public ApiResponse<SecurityHoldersApi.PostSecurityHoldersResponseWrapper> PostSecurityHoldersWithHttpInfo(SecurityHoldersRequest securityHoldersRequest)
        {
            ...
            var postsecurityholdersResponse = new PostSecurityHoldersResponseWrapper(localVarResponse.StatusCode, localVarResponse.Data);
            return new ApiResponse<PostSecurityHoldersResponseWrapper>(localVarResponse.StatusCode, postsecurityholdersResponse);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SecurityHoldersResponse</returns>
        public async System.Threading.Tasks.Task<SecurityHoldersApi.PostSecurityHoldersResponseWrapper>PostSecurityHoldersAsync(SecurityHoldersRequest securityHoldersRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SecurityHoldersApi.PostSecurityHoldersResponseWrapper>> PostSecurityHoldersWithHttpInfoAsync(SecurityHoldersRequest securityHoldersRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'securityHoldersRequest' is set
            if (securityHoldersRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/security-holders", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
