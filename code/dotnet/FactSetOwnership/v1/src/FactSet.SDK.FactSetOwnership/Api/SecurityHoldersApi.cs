...
namespace FactSet.SDK.FactSetOwnership.Api
{
    ...
    public interface ISecurityHoldersApiSync : IApiAccessor
    {
        ...
        SecurityHoldersApi.GetSecurityHoldersResponseWrapper GetSecurityHolders(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string));
        ...
        ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper> GetSecurityHoldersWithHttpInfo(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string));
        /// <summary>
    ...
    public interface ISecurityHoldersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SecurityHoldersApi.GetSecurityHoldersResponseWrapper> GetSecurityHoldersAsync(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper>> GetSecurityHoldersWithHttpInfoAsync(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get security ownership data for a list of requested securities.
        /// </summary>
        /// <remarks>
    ...
    public partial class SecurityHoldersApi : ISecurityHoldersApi
    {
        ...
        /// <param name="batch">Enables the ability to asynchronously \&quot;batch\&quot; the request, supporting a long-running request for up to 20 minutes.  When &#x60;batch&#x3D;Y&#x60;, the service will respond with an HTTP Status Code of 202.  Once a batch request is submitted, use batch status to see if the job has been completed.  Once completed, retrieve the results of the request via batch-result. When using Batch, ids     limit is increased to  1000 ids per request, though limits on query string via GET method still apply.  It&#39;s advised to submit large lists of ids via POST method.  (optional, default to N)</param>
        /// <returns>SecurityHoldersApi.GetSecurityHoldersResponseWrapper</returns>
        public SecurityHoldersApi.GetSecurityHoldersResponseWrapper GetSecurityHolders(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string))
        {
        ...
        public ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper> GetSecurityHoldersWithHttpInfo(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SecurityHoldersResponse</returns>
        public async System.Threading.Tasks.Task<SecurityHoldersApi.GetSecurityHoldersResponseWrapper>GetSecurityHoldersAsync(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<SecurityHoldersApi.GetSecurityHoldersResponseWrapper>> GetSecurityHoldersWithHttpInfoAsync(List<string> ids, string holderType = default(string), string topn = default(string), string date = default(string), string currency = default(string), string batch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
