...
namespace FactSet.SDK.FactSetOwnership.Api
{
    ...
    public interface ITransactionsApiSync : IApiAccessor
    {
        ...
        InstitutionalTransactionsResponse GetOwnershipInstitutionalTransactions(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string));
        ...
        ApiResponse<InstitutionalTransactionsResponse> GetOwnershipInstitutionalTransactionsWithHttpInfo(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string));
        /// <summary>
        /// Get insider transactions details for a list of requested identifiers.
        /// </summary>
        /// <remarks>
    ...
    public interface ITransactionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InstitutionalTransactionsResponse> GetOwnershipInstitutionalTransactionsAsync(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InstitutionalTransactionsResponse>> GetOwnershipInstitutionalTransactionsWithHttpInfoAsync(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get insider transactions details for a list of requested identifiers.
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionsApi : ITransactionsApi
    {
        ...
        /// <param name="periodOfMeasure">Determines the range over which the code calculates change for Percent Ownership and Position Change.   * **1M** &#x3D; 1 Month (last 30 days)   * **3M** &#x3D; 3 Months (last 90 days)   * **6M** &#x3D; 6 Months (last 180 days)   * **12M** &#x3D; 12 Months (last 365 days)  (optional, default to 6M)</param>
        /// <returns>InstitutionalTransactionsResponse</returns>
        public InstitutionalTransactionsResponse GetOwnershipInstitutionalTransactions(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string))
        {
            var localVarResponse = GetOwnershipInstitutionalTransactionsWithHttpInfo(ids, startDate, endDate, currency, frequency, topNHolders, holderType, periodOfMeasure);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstitutionalTransactionsResponse</returns>
        public async System.Threading.Tasks.Task<InstitutionalTransactionsResponse>GetOwnershipInstitutionalTransactionsAsync(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetOwnershipInstitutionalTransactionsWithHttpInfoAsync(ids, startDate, endDate, currency, frequency, topNHolders, holderType, periodOfMeasure, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<InstitutionalTransactionsResponse>> GetOwnershipInstitutionalTransactionsWithHttpInfoAsync(List<string> ids, DateTime startDate, DateTime endDate, string currency = default(string), string frequency = default(string), string topNHolders = default(string), string holderType = default(string), string periodOfMeasure = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
            {
