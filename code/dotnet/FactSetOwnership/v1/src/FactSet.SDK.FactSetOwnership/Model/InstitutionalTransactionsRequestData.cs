...
namespace FactSet.SDK.FactSetOwnership.Model
{
    ...
    public partial class InstitutionalTransactionsRequestData : IEquatable<InstitutionalTransactionsRequestData>, IValidatableObject
    {
        ...
        public InstitutionalTransactionsRequestData(List<string> ids, DateTime startDate, DateTime endDate,TopNHolders topNHolders = default(TopNHolders), HolderType holderType = default(HolderType), string currency = default(string), Frequency frequency = default(Frequency), PeriodOfMeasure periodOfMeasure = default(PeriodOfMeasure), Batch batch = default(Batch))
        {
