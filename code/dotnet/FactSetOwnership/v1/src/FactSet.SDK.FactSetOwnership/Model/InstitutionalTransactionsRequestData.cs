...
namespace FactSet.SDK.FactSetOwnership.Model
{
    ...
    public partial class InstitutionalTransactionsRequestData : IEquatable<InstitutionalTransactionsRequestData>, IValidatableObject
    {
        ...
        public InstitutionalTransactionsRequestData(List<string> ids, DateTime startDate, DateTime endDate,TopNHolders topNHolders = default(TopNHolders), HolderType holderType = default(HolderType), PeriodOfMeasure periodOfMeasure = default(PeriodOfMeasure), string currency = default(string), Frequency frequency = default(Frequency), Batch batch = default(Batch))
        {
