...
namespace FactSet.SDK.FactSetOwnership.Model
{
    ...
    public partial class InsiderTransactions : IEquatable<InsiderTransactions>, IValidatableObject
    {
        ...
        /// <param name="transactionCode">Returns the transaction detail code for the transaction..</param>
        /// <param name="transactionCodeDescription">Returns the description of the transaction detail code for the transaction..</param>
        ...
        /// </summary>
        /// <value>Returns the transaction detail code for the transaction.</value>
        ...
        /// </summary>
        /// <value>Returns the description of the transaction detail code for the transaction.</value>
        [DataMember(Name = "transactionCodeDescription", EmitDefaultValue = true)]
