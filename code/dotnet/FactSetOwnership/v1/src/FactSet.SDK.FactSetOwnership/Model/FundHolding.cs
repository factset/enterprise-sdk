...
namespace FactSet.SDK.FactSetOwnership.Model
{
    ...
    public partial class FundHolding : IEquatable<FundHolding>, IValidatableObject
    {
        ...
        public FundHolding(string requestId = default(string), string fsymId = default(string), string date = default(string), string currency = default(string), double? adjHolding = default(double?), double? adjMarketValue = default(double?), double? weightClose = default(double?), string issueType = default(string), string fsymSecurityId = default(string), string fsymRegionalId = default(string), string securityName = default(string), string securityTicker = default(string))
        {
