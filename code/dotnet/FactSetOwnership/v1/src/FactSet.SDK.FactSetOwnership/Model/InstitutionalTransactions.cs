...
namespace FactSet.SDK.FactSetOwnership.Model
{
    ...
    public partial class InstitutionalTransactions : IEquatable<InstitutionalTransactions>, IValidatableObject
    {
        ...
        /// <param name="periodOfMeasure">Returns the range over which the code calculates change for Percent Ownership and Position Change..</param>
        ...
        /// </summary>
        /// <value>Returns the range over which the code calculates change for Percent Ownership and Position Change.</value>
        [DataMember(Name = "periodOfMeasure", EmitDefaultValue = true)]
        public string PeriodOfMeasure { get; set; }
