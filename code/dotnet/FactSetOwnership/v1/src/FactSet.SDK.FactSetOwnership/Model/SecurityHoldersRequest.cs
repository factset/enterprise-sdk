...
namespace FactSet.SDK.FactSetOwnership.Model
{
    ...
    public partial class SecurityHoldersRequest : IEquatable<SecurityHoldersRequest>, IValidatableObject
    {
        ...
        public SecurityHoldersRequest(List<string> ids,HolderType holderType = default(HolderType), string date = default(string), string topn = "ALL", string currency = default(string), Batch batch = default(Batch))
        {
