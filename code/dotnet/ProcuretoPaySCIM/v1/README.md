...
# Procure to Pay SCIM client library for .NET

[![Nuget](https://img.shields.io/nuget/v/FactSet.SDK.ProcuretoPaySCIM)](https://www.nuget.org/packages/FactSet.SDK.ProcuretoPaySCIM)
...
dotnet add package FactSet.SDK.ProcuretoPaySCIM
```
...
nuget install FactSet.SDK.ProcuretoPaySCIM
```
...
namespace Example
{ 
    public static class GroupIdGetExample
    {
