...
namespace FactSet.SDK.ProcuretoPaySCIM.Api
{
    ...
    public partial class SchemasApi : ISchemasApi
    {
        ...
        /// <returns></returns>
        public SchemasApi(FactSet.SDK.ProcuretoPaySCIM.Client.Configuration configuration)
        {
        ...
        public SchemasApi(FactSet.SDK.ProcuretoPaySCIM.Client.ISynchronousClient client, FactSet.SDK.ProcuretoPaySCIM.Client.IAsynchronousClient asyncClient, FactSet.SDK.ProcuretoPaySCIM.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Schema> SchemasIdGetWithHttpInfo(string id)
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'id' when calling SchemasApi->SchemasIdGet");
            }
