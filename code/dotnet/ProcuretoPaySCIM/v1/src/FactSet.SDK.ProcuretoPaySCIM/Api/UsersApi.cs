...
namespace FactSet.SDK.ProcuretoPaySCIM.Api
{
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <returns></returns>
        public UsersApi(FactSet.SDK.ProcuretoPaySCIM.Client.Configuration configuration)
        {
        ...
        public UsersApi(FactSet.SDK.ProcuretoPaySCIM.Client.ISynchronousClient client, FactSet.SDK.ProcuretoPaySCIM.Client.IAsynchronousClient asyncClient, FactSet.SDK.ProcuretoPaySCIM.Client.IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Object> UsersIdDeleteWithHttpInfo(string id)
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'id' when calling UsersApi->UsersIdDelete");
            }
        ...
        public ApiResponse<UserResource> UsersIdGetWithHttpInfo(string id)
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'id' when calling UsersApi->UsersIdGet");
            }
        ...
        public ApiResponse<UserResource> UsersIdPatchWithHttpInfo(string id, Patch patch = default(Patch))
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'id' when calling UsersApi->UsersIdPatch");
            }
        ...
        public ApiResponse<UserResource> UsersIdPutWithHttpInfo(string id, UserResource userResource)
        {
            ...
            if (id == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'id' when calling UsersApi->UsersIdPut");
            }

            // verify the required parameter 'userResource' is set
            if (userResource == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'userResource' when calling UsersApi->UsersIdPut");
            }
        ...
        public ApiResponse<UserResource> UsersPostWithHttpInfo(UserResource userResource)
        {
            ...
            if (userResource == null)
            {
                throw new FactSet.SDK.ProcuretoPaySCIM.Client.ApiException(400, "Missing required parameter 'userResource' when calling UsersApi->UsersPost");
            }
