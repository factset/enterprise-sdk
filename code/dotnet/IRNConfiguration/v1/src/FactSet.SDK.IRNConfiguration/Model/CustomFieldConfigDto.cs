...
namespace FactSet.SDK.IRNConfiguration.Model
{
    ...
    public partial class CustomFieldConfigDto : IEquatable<CustomFieldConfigDto>, IValidatableObject
    {
        ...
        public CustomFieldConfigDto(Guid id = default(Guid), string code = default(string), string name = default(string), string source = default(string), string type = default(string), bool usePreviousValue = default(bool), bool isMandatory = default(bool), bool isHidden = default(bool), FormulaConfigDto formulaConfig = default(FormulaConfigDto), NumericConfigDto numericConfig = default(NumericConfigDto), IntegerConfigDto integerConfig = default(IntegerConfigDto), ExtendedTextConfigDto extendedTextConfig = default(ExtendedTextConfigDto), OptionsConfigDto optionsConfig = default(OptionsConfigDto))
        {
            this.Id = id;
            this.Code = code;
            this.Name = name;
