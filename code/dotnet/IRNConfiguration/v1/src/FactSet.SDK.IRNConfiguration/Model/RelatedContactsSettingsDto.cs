...
namespace FactSet.SDK.IRNConfiguration.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RelatedContactsSettingsDto")]
    public partial class RelatedContactsSettingsDto : IEquatable<RelatedContactsSettingsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedContactsSettingsDto" /> class.
        /// </summary>
        /// <param name="isHidden">isHidden.</param>
        /// <param name="isMandatory">isMandatory.</param>
        /// <param name="usePrevious">usePrevious.</param>
        public RelatedContactsSettingsDto(bool isHidden = default(bool), bool isMandatory = default(bool), bool usePrevious = default(bool))
        {
        ...
        {
            return this.Equals(input as RelatedContactsSettingsDto);
        }

        /// <summary>
        /// Returns true if RelatedContactsSettingsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RelatedContactsSettingsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedContactsSettingsDto input)
        {
            if (input == null)
            {
                return false;
