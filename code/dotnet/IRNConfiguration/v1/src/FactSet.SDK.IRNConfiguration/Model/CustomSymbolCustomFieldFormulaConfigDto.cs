...
namespace FactSet.SDK.IRNConfiguration.Model
{
    ...
    public partial class CustomSymbolCustomFieldFormulaConfigDto : IEquatable<CustomSymbolCustomFieldFormulaConfigDto>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Formula, length must be greater than 1.", new [] { "Formula" });
            }

            // FormulaType (string) minLength
            if (this.FormulaType != null && this.FormulaType.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FormulaType, length must be greater than 1.", new [] { "FormulaType" });
            }
