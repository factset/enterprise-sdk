...
namespace FactSet.SDK.IRNConfiguration.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RelatedResearchSettingsDto")]
    public partial class RelatedResearchSettingsDto : IEquatable<RelatedResearchSettingsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedResearchSettingsDto" /> class.
        /// </summary>
        /// <param name="isHidden">isHidden.</param>
        /// <param name="isMandatory">isMandatory.</param>
        /// <param name="usePrevious">usePrevious.</param>
        public RelatedResearchSettingsDto(bool isHidden = default(bool), bool isMandatory = default(bool), bool usePrevious = default(bool))
        {
        ...
        {
            return this.Equals(input as RelatedResearchSettingsDto);
        }

        /// <summary>
        /// Returns true if RelatedResearchSettingsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RelatedResearchSettingsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedResearchSettingsDto input)
        {
            if (input == null)
            {
                return false;
