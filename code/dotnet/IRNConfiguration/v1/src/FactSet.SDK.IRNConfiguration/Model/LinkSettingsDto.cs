...
namespace FactSet.SDK.IRNConfiguration.Model
{
    ...
    /// LinkSettingsDto
    /// </summary>
    [DataContract(Name = "LinkSettingsDto")]
    public partial class LinkSettingsDto : IEquatable<LinkSettingsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkSettingsDto" /> class.
        /// </summary>
        /// <param name="isHidden">isHidden.</param>
        /// <param name="isMandatory">isMandatory.</param>
        /// <param name="usePrevious">usePrevious.</param>
        public LinkSettingsDto(bool isHidden = default(bool), bool isMandatory = default(bool), bool usePrevious = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinkSettingsDto {\n");
        ...
        {
            return this.Equals(input as LinkSettingsDto);
        }

        /// <summary>
        /// Returns true if LinkSettingsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkSettingsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkSettingsDto input)
        {
            if (input == null)
            {
                return false;
