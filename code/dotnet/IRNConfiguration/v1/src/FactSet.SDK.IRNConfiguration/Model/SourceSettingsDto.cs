...
namespace FactSet.SDK.IRNConfiguration.Model
{
    ...
    /// SourceSettingsDto
    /// </summary>
    [DataContract(Name = "SourceSettingsDto")]
    public partial class SourceSettingsDto : IEquatable<SourceSettingsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceSettingsDto" /> class.
        /// </summary>
        /// <param name="isHidden">isHidden.</param>
        /// <param name="isMandatory">isMandatory.</param>
        /// <param name="usePrevious">usePrevious.</param>
        public SourceSettingsDto(bool isHidden = default(bool), bool isMandatory = default(bool), bool usePrevious = default(bool))
        {
        ...
        {
            return this.Equals(input as SourceSettingsDto);
        }

        /// <summary>
        /// Returns true if SourceSettingsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceSettingsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceSettingsDto input)
        {
            if (input == null)
            {
                return false;
