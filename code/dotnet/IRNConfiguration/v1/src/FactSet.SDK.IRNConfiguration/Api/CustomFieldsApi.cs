...
namespace FactSet.SDK.IRNConfiguration.Api
{
    ...
    public interface ICustomFieldsApiSync : IApiAccessor
    {
        ...
        List<CustomFieldConfigDto> V1CustomFieldsGet(bool? xIRNIgnorePermissions = default(bool?));
        ...
        ApiResponse<List<CustomFieldConfigDto>> V1CustomFieldsGetWithHttpInfo(bool? xIRNIgnorePermissions = default(bool?));
    ...
    public interface ICustomFieldsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<CustomFieldConfigDto>> V1CustomFieldsGetAsync(bool? xIRNIgnorePermissions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<CustomFieldConfigDto>>> V1CustomFieldsGetWithHttpInfoAsync(bool? xIRNIgnorePermissions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class CustomFieldsApi : ICustomFieldsApi
    {
        ...
        /// <returns></returns>
        public CustomFieldsApi(FactSet.SDK.IRNConfiguration.Client.Configuration configuration)
        {
        ...
        public CustomFieldsApi(FactSet.SDK.IRNConfiguration.Client.ISynchronousClient client, FactSet.SDK.IRNConfiguration.Client.IAsynchronousClient asyncClient, FactSet.SDK.IRNConfiguration.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="xIRNIgnorePermissions"> (optional, default to false)</param>
        /// <returns>List&lt;CustomFieldConfigDto&gt;</returns>
        public List<CustomFieldConfigDto> V1CustomFieldsGet(bool? xIRNIgnorePermissions = default(bool?))
        {
            FactSet.SDK.IRNConfiguration.Client.ApiResponse<List<CustomFieldConfigDto>> localVarResponse = V1CustomFieldsGetWithHttpInfo(xIRNIgnorePermissions);
        ...
        /// <param name="xIRNIgnorePermissions"> (optional, default to false)</param>
        /// <returns>ApiResponse of List&lt;CustomFieldConfigDto&gt;</returns>
        public FactSet.SDK.IRNConfiguration.Client.ApiResponse<List<CustomFieldConfigDto>> V1CustomFieldsGetWithHttpInfo(bool? xIRNIgnorePermissions = default(bool?))
        {
            ...
            var localVarResponse = this.Client.Get<List<CustomFieldConfigDto>>("/v1/custom-fields", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("V1CustomFieldsGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;CustomFieldConfigDto&gt;</returns>
        public async System.Threading.Tasks.Task<List<CustomFieldConfigDto>> V1CustomFieldsGetAsync(bool? xIRNIgnorePermissions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FactSet.SDK.IRNConfiguration.Client.ApiResponse<List<CustomFieldConfigDto>> localVarResponse = await V1CustomFieldsGetWithHttpInfoAsync(xIRNIgnorePermissions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomFieldConfigDto&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.SDK.IRNConfiguration.Client.ApiResponse<List<CustomFieldConfigDto>>> V1CustomFieldsGetWithHttpInfoAsync(bool? xIRNIgnorePermissions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
