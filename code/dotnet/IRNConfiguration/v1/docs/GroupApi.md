...
namespace Example
{
    public class V1GroupClientSalesRepresentativeGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling GroupApi.V1GroupClientSalesRepresentativeGet: " + e.Message );
...
namespace Example
{
    public class V1GroupGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling GroupApi.V1GroupGet: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
