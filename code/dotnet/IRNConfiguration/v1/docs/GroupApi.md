# FactSet.SDK.IRNConfiguration.Api.GroupApi
...
<a name="v1groupclientsalesrepresentativeget"></a>
...
namespace Example
{
    public class V1GroupClientSalesRepresentativeGetExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling GroupApi.V1GroupClientSalesRepresentativeGet: " + e.Message );
...
namespace Example
{
    public class V1GroupGetExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.PAEngine.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling GroupApi.V1GroupGet: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
