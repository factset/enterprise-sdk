...
namespace Example
{
    public class DeleteContactCustomFieldExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling ContactsCustomFieldsApi.DeleteContactCustomField: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetContactCustomFieldExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.IRNConfiguration.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling ContactsCustomFieldsApi.GetContactCustomField: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetContactCustomFieldsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.IRNConfiguration.Client.Configuration();
            ...
            {
                // Get all the contact custom fields
                List<ContactCustomFieldDto> result = apiInstance.GetContactCustomFields();
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling ContactsCustomFieldsApi.GetContactCustomFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
> void PatchContactCustomField (Guid contactCustomFieldId, List<Operation> operation = null)
...
namespace Example
{
    public class PatchContactCustomFieldExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.IRNConfiguration.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling ContactsCustomFieldsApi.PatchContactCustomField: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
