...
namespace Example
{
    public class GetAssignedFactSetUsersExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get all assigned FactSet users
                List<UserConfigDto> result = apiInstance.GetAssignedFactSetUsers();
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetAssignedFactSetUsers: " + e.Message );
...
<a name="getauthors"></a>
# **GetAuthors**
> List&lt;AuthorConfigDto&gt; GetAuthors (bool? xIRNIgnorePermissions = null)
...
namespace Example
{
    public class GetAuthorsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get all Authors
                List<AuthorConfigDto> result = apiInstance.GetAuthors(xIRNIgnorePermissions);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetAuthors: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetClientsSalesRepresentativeExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.IRNConfiguration.Client.Configuration();
            ...
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetClientsSalesRepresentative: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetCustomFieldsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get all Custom Fields
                List<CustomFieldConfigDto> result = apiInstance.GetCustomFields(xIRNIgnorePermissions);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetCustomFields: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetGroupExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetGroup: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetRecommendationsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get all Recommendations
                List<RecommendationConfigDto> result = apiInstance.GetRecommendations();
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetRecommendations: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSentimentsExample
    {
        public static async Task Main()
        {
            var config = new FactSet.SDK.IRNConfiguration.Client.Configuration();
            ...
            {
                // Get all Sentiments
                List<SentimentConfigDto> result = apiInstance.GetSentiments();
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetSentiments: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
### Return type
[**List&lt;SentimentConfigDto&gt;**](SentimentConfigDto.md)
...
namespace Example
{
    public class GetSubjectExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetSubject: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetSubjectsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get all Subjects
                List<SubjectSummaryDto> result = apiInstance.GetSubjects(xIRNIgnorePermissions);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetSubjects: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
<a name="getteam"></a>
# **GetTeam**
> TeamConfigDto GetTeam (Guid teamId, bool? xIRNIgnorePermissions = null)
...
namespace Example
{
    public class GetTeamExample
    {
        public static async Task Main()
        {
            ...
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetTeam: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetTeamsExample
    {
        public static async Task Main()
        {
            ...
            {
                // Get all Teams
                List<TeamSummaryDto> result = apiInstance.GetTeams(xIRNIgnorePermissions);
                Console.WriteLine(result.ToJson());
            }
            catch (ApiException  e)
            {
                Console.WriteLine("Exception when calling NotesConfigurationApi.GetTeams: " + e.Message );
                Console.WriteLine("Status Code: "+ e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
