...
namespace FactSet.SDK.InvestmentBankingOfficeRefresh.Api
{
    ...
    {
        private FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        public class GetFileByIdResponseWrapper {
            ...
            public System.IO.Stream Response200
            {
                get
                {
                    ...
                    {
                        throw new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiException(500, "Invalid response getter called. Response200 can't return a " + StatusCode + " response");
                    }
            ...
            public JobStatus Response202
            {
                get
                {
                    ...
                    {
                        throw new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiException(500, "Invalid response getter called. Response202 can't return a " + StatusCode + " response");
                    }
        ...
        {
            this.Configuration = FactSet.SDK.InvestmentBankingOfficeRefresh.Client.Configuration.MergeConfigurations(
                FactSet.SDK.InvestmentBankingOfficeRefresh.Client.GlobalConfiguration.Instance,
                new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.Configuration { BasePath = basePath }
            );
            this.Client = new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = FactSet.SDK.InvestmentBankingOfficeRefresh.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public RefreshOperationsApi(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.Configuration configuration)
        {
            ...
            this.Client = new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = FactSet.SDK.InvestmentBankingOfficeRefresh.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public RefreshOperationsApi(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ISynchronousClient client, FactSet.SDK.InvestmentBankingOfficeRefresh.Client.IAsynchronousClient asyncClient, FactSet.SDK.InvestmentBankingOfficeRefresh.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public FactSet.SDK.InvestmentBankingOfficeRefresh.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ISynchronousClient Client { get; set; }
        ...
        public FactSet.SDK.InvestmentBankingOfficeRefresh.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse<RefreshOperationsApi.GetFileByIdResponseWrapper> GetFileByIdWithHttpInfo(Guid id)
        {
            ...
            var localVarContentType = FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);
            }

            var localVarAccept = FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.SelectHeaderAccept(_accepts);
            ...
            {
                localVarRequestOptions.HeaderParameters.Add("Authorization", "Basic " + FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.Base64Encode(this.Configuration.Username + ":" + this.Configuration.Password));
            }
        ...
        public ApiResponse<JobStatus> PostWorkbookWithHttpInfo(System.IO.Stream body, bool? nowHandlingEnabled = default(bool?), bool? refreshAutoFilters = default(bool?), bool? resizeArrays = default(bool?))
        {
            ...
            if (body == null)
            {
                throw new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiException(400, "Missing required parameter 'body' when calling RefreshOperationsApi->PostWorkbook");
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.ParameterToMultiMap("", "nowHandlingEnabled", nowHandlingEnabled));
            }
            if (refreshAutoFilters != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.ParameterToMultiMap("", "refreshAutoFilters", refreshAutoFilters));
            }
            if (resizeArrays != null)
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.ParameterToMultiMap("", "resizeArrays", resizeArrays));
            }
