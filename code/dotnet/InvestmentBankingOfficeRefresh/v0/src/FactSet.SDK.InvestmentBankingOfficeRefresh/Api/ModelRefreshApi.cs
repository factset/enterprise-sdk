...
namespace FactSet.SDK.InvestmentBankingOfficeRefresh.Api
{
    ...
    /// </summary>
    public interface IModelRefreshApiSync : IApiAccessor
    {
        ...
        /// <param name="outputFileName">Optional name for returned output file as set in the Content-Disposition response header. (optional)</param>
        /// <returns>ModelRefreshApi.GetFileByIdResponseWrapper</returns>
        ModelRefreshApi.GetFileByIdResponseWrapper GetFileById(Guid id, string outputFileName = default(string));
        ...
        /// <param name="id">Resource ID</param>
        /// <param name="outputFileName">Optional name for returned output file as set in the Content-Disposition response header. (optional)</param>
        /// <returns>ApiResponse of ModelRefreshApi.GetFileByIdResponseWrapper</returns>
        ApiResponse<ModelRefreshApi.GetFileByIdResponseWrapper> GetFileByIdWithHttpInfo(Guid id, string outputFileName = default(string));
        /// <summary>
        ...
        /// <param name="nowHandlingEnabled">Option to handle &#x3D;NOW codes. (optional)</param>
        /// <param name="refreshAutoFilters">Option to refresh codes in autofilters. (optional)</param>
        /// <param name="resizeArrays">Option to resize arrays (optional)</param>
        /// <returns>JobStatus</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IModelRefreshApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ModelRefreshApi.GetFileByIdResponseWrapper> GetFileByIdAsync(Guid id, string outputFileName = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="outputFileName">Optional name for returned output file as set in the Content-Disposition response header. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModelRefreshApi.GetFileByIdResponseWrapper)</returns>
        System.Threading.Tasks.Task<ApiResponse<ModelRefreshApi.GetFileByIdResponseWrapper>> GetFileByIdWithHttpInfoAsync(Guid id, string outputFileName = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the status of the refresh job with the given resource ID
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IModelRefreshApi : IModelRefreshApiSync, IModelRefreshApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ModelRefreshApi : IModelRefreshApi
    {
        ...
        private static readonly Dictionary<HttpStatusCode, System.Type> GetFileByIdResponseTypeDictionary = new Dictionary<HttpStatusCode, System.Type>
        {
            ...
            { (HttpStatusCode)429, typeof(Errors) },
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelRefreshApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ModelRefreshApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ModelRefreshApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ModelRefreshApi(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.Configuration configuration)
        {
        ...
        public ModelRefreshApi(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ISynchronousClient client, FactSet.SDK.InvestmentBankingOfficeRefresh.Client.IAsynchronousClient asyncClient, FactSet.SDK.InvestmentBankingOfficeRefresh.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="outputFileName">Optional name for returned output file as set in the Content-Disposition response header. (optional)</param>
        /// <returns>ModelRefreshApi.GetFileByIdResponseWrapper</returns>
        public ModelRefreshApi.GetFileByIdResponseWrapper GetFileById(Guid id, string outputFileName = default(string))
        {
            var localVarResponse = GetFileByIdWithHttpInfo(id, outputFileName);
        ...
        public ApiResponse<ModelRefreshApi.GetFileByIdResponseWrapper> GetFileByIdWithHttpInfo(Guid id, string outputFileName = default(string))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ClientUtils.ParameterToMultiMap("", "outputFileName", outputFileName));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<ModelRefreshApi.GetFileByIdResponseWrapper>GetFileByIdAsync(Guid id, string outputFileName = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await GetFileByIdWithHttpInfoAsync(id, outputFileName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<ModelRefreshApi.GetFileByIdResponseWrapper>> GetFileByIdWithHttpInfoAsync(Guid id, string outputFileName = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <summary>
        /// Get the status of the refresh job with the given resource ID Check the status of the given job by ID
        /// </summary>
        /// <exception cref="FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Resource ID</param>
        /// <returns>JobStatus</returns>
        ...
        /// <summary>
        /// Upload a model Upload a model (e.g., an Excel workbook in Open Office XML format) for FactSet to refresh.
        /// </summary>
        /// <exception cref="FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <param name="nowHandlingEnabled">Option to handle &#x3D;NOW codes. (optional)</param>
        ...
        public ApiResponse<JobStatus> PostWorkbookWithHttpInfo(System.IO.Stream body, bool? nowHandlingEnabled = default(bool?), bool? refreshAutoFilters = default(bool?), bool? resizeArrays = default(bool?))
        {
            ...
            if (body == null)
            {
                throw new FactSet.SDK.InvestmentBankingOfficeRefresh.Client.ApiException(400, "Missing required parameter 'body' when calling ModelRefreshApi->PostWorkbook");
            }
            ...
            JobStatus>("/refresh", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<JobStatus>> PostWorkbookWithHttpInfoAsync(System.IO.Stream body, bool? nowHandlingEnabled = default(bool?), bool? refreshAutoFilters = default(bool?), bool? resizeArrays = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<JobStatus>("/refresh", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
