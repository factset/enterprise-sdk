...
namespace FactSet.SDK.InvestmentBankingOfficeRefresh.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/InvestmentBankingOfficeRefresh/0.20.0";
            BasePath = "https://api.factset.com/office-refresh/v0";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/office-refresh/v0") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.InvestmentBankingOfficeRefresh) Debug Report:\n";
