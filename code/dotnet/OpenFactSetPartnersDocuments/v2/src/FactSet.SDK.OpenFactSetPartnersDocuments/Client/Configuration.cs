...
namespace FactSet.SDK.OpenFactSetPartnersDocuments.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "fds-sdk/dotnet/OpenFactSetPartnersDocuments/3.0.2";
            BasePath = "https://api.factset.com/bulk-documents/ofm/v2";
        ...
        public Configuration(
            ...
            string basePath = "https://api.factset.com/bulk-documents/ofm/v2") : this()
        {
        ...
        {
            string report = "C# SDK (FactSet.SDK.OpenFactSetPartnersDocuments) Debug Report:\n";
