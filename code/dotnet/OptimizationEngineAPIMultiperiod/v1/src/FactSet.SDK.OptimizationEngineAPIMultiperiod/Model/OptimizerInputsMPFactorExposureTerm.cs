...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPFactorExposureTerm")]
    public partial class OptimizerInputsMPFactorExposureTerm : IEquatable<OptimizerInputsMPFactorExposureTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPFactorExposureTerm" /> class.
        /// </summary>
        /// <param name="term">term.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPFactorExposureTerm(OptimizerInputsFactorExposureTerm term = default(OptimizerInputsFactorExposureTerm), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
            this.Term = term;
        ...
        public OptimizerInputsFactorExposureTerm Term { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPFactorExposureTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPFactorExposureTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPFactorExposureTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPFactorExposureTerm input)
        {
            if (input == null)
            {
                return false;
