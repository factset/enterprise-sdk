...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// 13
    /// </summary>
    [DataContract(Name = "optimizer.inputs.TradeThresholdConstraint")]
    public partial class OptimizerInputsTradeThresholdConstraint : IEquatable<OptimizerInputsTradeThresholdConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsTradeThresholdConstraint" /> class.
        /// </summary>
        ...
        public OptimizerInputsTradeThresholdConstraint(string name = default(string), OptimizerInputsValue min = default(OptimizerInputsValue), OptimizerInputsValue customAsset = default(OptimizerInputsValue), List<OptimizerInputsConstraintGroup> groups = default(List<OptimizerInputsConstraintGroup>), OptimizerInputsEConstraintLevelEnum level = default(OptimizerInputsEConstraintLevelEnum), OptimizerInputsEConstraintUnitTypeEnum unit = default(OptimizerInputsEConstraintUnitTypeEnum), OptimizerInputsEFPOConstraintAssetTypeEnum assetType = default(OptimizerInputsEFPOConstraintAssetTypeEnum), int hierarchy = default(int))
        {
            this.Name = name;
            this.Min = min;
        ...
        {
            return this.Equals(input as OptimizerInputsTradeThresholdConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsTradeThresholdConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsTradeThresholdConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsTradeThresholdConstraint input)
        {
            if (input == null)
            {
                return false;
