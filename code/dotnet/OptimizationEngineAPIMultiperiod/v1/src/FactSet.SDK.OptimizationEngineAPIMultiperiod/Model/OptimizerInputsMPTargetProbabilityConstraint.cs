...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPTargetProbabilityConstraint")]
    public partial class OptimizerInputsMPTargetProbabilityConstraint : IEquatable<OptimizerInputsMPTargetProbabilityConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPTargetProbabilityConstraint" /> class.
        /// </summary>
        ...
        public OptimizerInputsMPTargetProbabilityConstraint(OptimizerInputsTargetProbabilityConstraint constraint = default(OptimizerInputsTargetProbabilityConstraint), OptimizerInputsBoundSourceEnum constraintOn = default(OptimizerInputsBoundSourceEnum), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
        ...
        public OptimizerInputsTargetProbabilityConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPTargetProbabilityConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPTargetProbabilityConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPTargetProbabilityConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPTargetProbabilityConstraint input)
        {
            if (input == null)
            {
                return false;
