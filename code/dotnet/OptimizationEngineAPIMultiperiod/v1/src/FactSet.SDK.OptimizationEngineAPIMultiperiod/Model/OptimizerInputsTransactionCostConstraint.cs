...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// 14
    /// </summary>
    [DataContract(Name = "optimizer.inputs.TransactionCostConstraint")]
    public partial class OptimizerInputsTransactionCostConstraint : IEquatable<OptimizerInputsTransactionCostConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsTransactionCostConstraint" /> class.
        /// </summary>
        ...
        public OptimizerInputsTransactionCostConstraint(string name = default(string), OptimizerInputsValue max = default(OptimizerInputsValue), OptimizerInputsValue customAsset = default(OptimizerInputsValue), List<OptimizerInputsConstraintGroup> groups = default(List<OptimizerInputsConstraintGroup>), OptimizerInputsEConstraintLevelEnum level = default(OptimizerInputsEConstraintLevelEnum), OptimizerInputsEConstraintUnitTypeEnum unit = default(OptimizerInputsEConstraintUnitTypeEnum), OptimizerInputsEFPOConstraintAssetTypeEnum assetType = default(OptimizerInputsEFPOConstraintAssetTypeEnum), int hierarchy = default(int))
        {
            this.Name = name;
            this.Max = max;
        ...
        {
            return this.Equals(input as OptimizerInputsTransactionCostConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsTransactionCostConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsTransactionCostConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsTransactionCostConstraint input)
        {
            if (input == null)
            {
                return false;
