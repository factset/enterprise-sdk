...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPRiskVolatilityConstraint")]
    public partial class OptimizerInputsMPRiskVolatilityConstraint : IEquatable<OptimizerInputsMPRiskVolatilityConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPRiskVolatilityConstraint" /> class.
        /// </summary>
        ...
        public OptimizerInputsMPRiskVolatilityConstraint(OptimizerInputsRiskVolatilityConstraint constraint = default(OptimizerInputsRiskVolatilityConstraint), OptimizerInputsBoundSourceEnum constraintOn = default(OptimizerInputsBoundSourceEnum), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
        ...
        public OptimizerInputsRiskVolatilityConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPRiskVolatilityConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPRiskVolatilityConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPRiskVolatilityConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPRiskVolatilityConstraint input)
        {
            if (input == null)
            {
                return false;
