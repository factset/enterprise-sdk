...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPVolatilityTerm")]
    public partial class OptimizerInputsMPVolatilityTerm : IEquatable<OptimizerInputsMPVolatilityTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPVolatilityTerm" /> class.
        /// </summary>
        /// <param name="term">term.</param>
        /// <param name="termOn">termOn.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPVolatilityTerm(OptimizerInputsVolatilityTerm term = default(OptimizerInputsVolatilityTerm), OptimizerInputsBoundSourceEnum termOn = default(OptimizerInputsBoundSourceEnum), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
            this.Term = term;
            this.TermOn = termOn;
        ...
        public OptimizerInputsVolatilityTerm Term { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPVolatilityTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPVolatilityTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPVolatilityTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPVolatilityTerm input)
        {
            if (input == null)
            {
                return false;
