...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.STARRTerm")]
    public partial class OptimizerInputsSTARRTerm : IEquatable<OptimizerInputsSTARRTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsSTARRTerm" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OptimizerInputsSTARRTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsSTARRTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsSTARRTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsSTARRTerm input)
        {
            if (input == null)
            {
                return false;
