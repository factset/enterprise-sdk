...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// 19
    /// </summary>
    [DataContract(Name = "optimizer.inputs.TradingLimitTradeConstraint")]
    public partial class OptimizerInputsTradingLimitTradeConstraint : IEquatable<OptimizerInputsTradingLimitTradeConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsTradingLimitTradeConstraint" /> class.
        /// </summary>
        ...
        public OptimizerInputsTradingLimitTradeConstraint(string name = default(string), OptimizerInputsValue customAsset = default(OptimizerInputsValue), OptimizerInputsValue min = default(OptimizerInputsValue), OptimizerInputsValue max = default(OptimizerInputsValue), OptimizerInputsPenalty penalty = default(OptimizerInputsPenalty), List<OptimizerInputsConstraintGroup> groups = default(List<OptimizerInputsConstraintGroup>), OptimizerInputsEConstraintUnitTypeEnum unit = default(OptimizerInputsEConstraintUnitTypeEnum), OptimizerInputsEConstraintLevelEnum level = default(OptimizerInputsEConstraintLevelEnum), OptimizerInputsEFPOConstraintAssetTypeEnum assetType = default(OptimizerInputsEFPOConstraintAssetTypeEnum), int hierarchy = default(int))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as OptimizerInputsTradingLimitTradeConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsTradingLimitTradeConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsTradingLimitTradeConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsTradingLimitTradeConstraint input)
        {
            if (input == null)
            {
                return false;
