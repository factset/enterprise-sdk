...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPSensitivityConstraint")]
    public partial class OptimizerInputsMPSensitivityConstraint : IEquatable<OptimizerInputsMPSensitivityConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPSensitivityConstraint" /> class.
        /// </summary>
        /// <param name="constraint">constraint.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPSensitivityConstraint(OptimizerInputsSensitivityConstraint constraint = default(OptimizerInputsSensitivityConstraint), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
        ...
        public OptimizerInputsSensitivityConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPSensitivityConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPSensitivityConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPSensitivityConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPSensitivityConstraint input)
        {
            if (input == null)
            {
                return false;
