...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.TailRiskTerm")]
    public partial class OptimizerInputsTailRiskTerm : IEquatable<OptimizerInputsTailRiskTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsTailRiskTerm" /> class.
        /// </summary>
        ...
        public OptimizerInputsTailRiskTerm(string name = default(string), OptimizerInputsValue multiplier = default(OptimizerInputsValue), OptimizerInputsEObjectiveTermDirectionEnum direction = default(OptimizerInputsEObjectiveTermDirectionEnum), OptimizerInputsTailRiskMeasureEnum riskMeasure = default(OptimizerInputsTailRiskMeasureEnum), double confidenceLevel = default(double), bool useCenteredEtl = default(bool), bool activeRisk = default(bool), int benchmarkIndex = default(int))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as OptimizerInputsTailRiskTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsTailRiskTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsTailRiskTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsTailRiskTerm input)
        {
            if (input == null)
            {
                return false;
