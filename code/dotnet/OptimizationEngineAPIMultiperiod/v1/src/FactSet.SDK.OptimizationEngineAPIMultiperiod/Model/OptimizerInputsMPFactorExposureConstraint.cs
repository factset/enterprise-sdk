...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPFactorExposureConstraint")]
    public partial class OptimizerInputsMPFactorExposureConstraint : IEquatable<OptimizerInputsMPFactorExposureConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPFactorExposureConstraint" /> class.
        /// </summary>
        /// <param name="constraint">constraint.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPFactorExposureConstraint(OptimizerInputsFactorExposureConstraint constraint = default(OptimizerInputsFactorExposureConstraint), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
        ...
        public OptimizerInputsFactorExposureConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPFactorExposureConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPFactorExposureConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPFactorExposureConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPFactorExposureConstraint input)
        {
            if (input == null)
            {
                return false;
