...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPGeneralLinearTerm")]
    public partial class OptimizerInputsMPGeneralLinearTerm : IEquatable<OptimizerInputsMPGeneralLinearTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPGeneralLinearTerm" /> class.
        /// </summary>
        /// <param name="term">term.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPGeneralLinearTerm(OptimizerInputsGeneralLinearTerm term = default(OptimizerInputsGeneralLinearTerm), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
            this.Term = term;
        ...
        public OptimizerInputsGeneralLinearTerm Term { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPGeneralLinearTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPGeneralLinearTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPGeneralLinearTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPGeneralLinearTerm input)
        {
            if (input == null)
            {
                return false;
