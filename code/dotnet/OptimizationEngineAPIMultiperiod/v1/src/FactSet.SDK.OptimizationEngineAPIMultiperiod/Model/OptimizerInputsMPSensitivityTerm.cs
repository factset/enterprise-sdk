...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPSensitivityTerm")]
    public partial class OptimizerInputsMPSensitivityTerm : IEquatable<OptimizerInputsMPSensitivityTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPSensitivityTerm" /> class.
        /// </summary>
        /// <param name="term">term.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPSensitivityTerm(OptimizerInputsSensitivityTerm term = default(OptimizerInputsSensitivityTerm), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
            this.Term = term;
        ...
        public OptimizerInputsSensitivityTerm Term { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPSensitivityTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPSensitivityTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPSensitivityTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPSensitivityTerm input)
        {
            if (input == null)
            {
                return false;
