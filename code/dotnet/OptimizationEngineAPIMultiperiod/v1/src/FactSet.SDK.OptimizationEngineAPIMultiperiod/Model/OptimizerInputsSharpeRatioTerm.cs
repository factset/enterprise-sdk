...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.SharpeRatioTerm")]
    public partial class OptimizerInputsSharpeRatioTerm : IEquatable<OptimizerInputsSharpeRatioTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsSharpeRatioTerm" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="multiplier">multiplier.</param>
        /// <param name="riskFreeRate">riskFreeRate.</param>
        /// <param name="direction">direction.</param>
        /// <param name="activeRisk">activeRisk.</param>
        /// <param name="benchmarkIndex">benchmarkIndex.</param>
        public OptimizerInputsSharpeRatioTerm(string name = default(string), OptimizerInputsValue multiplier = default(OptimizerInputsValue), OptimizerInputsValue riskFreeRate = default(OptimizerInputsValue), OptimizerInputsEObjectiveTermDirectionEnum direction = default(OptimizerInputsEObjectiveTermDirectionEnum), bool activeRisk = default(bool), int benchmarkIndex = default(int))
        {
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets RiskFreeRate
        /// </summary>
        [DataMember(Name = "risk_free_rate", EmitDefaultValue = false)]
        public OptimizerInputsValue RiskFreeRate { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsSharpeRatioTerm);
        }

        /// <summary>
        /// Returns true if OptimizerInputsSharpeRatioTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsSharpeRatioTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsSharpeRatioTerm input)
        {
            if (input == null)
            {
                return false;
