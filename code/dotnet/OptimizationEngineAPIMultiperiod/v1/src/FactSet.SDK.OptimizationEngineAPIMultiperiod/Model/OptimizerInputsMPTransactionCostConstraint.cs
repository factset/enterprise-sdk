...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPTransactionCostConstraint")]
    public partial class OptimizerInputsMPTransactionCostConstraint : IEquatable<OptimizerInputsMPTransactionCostConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPTransactionCostConstraint" /> class.
        /// </summary>
        /// <param name="constraint">constraint.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPTransactionCostConstraint(OptimizerInputsTransactionCostConstraint constraint = default(OptimizerInputsTransactionCostConstraint), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
        ...
        public OptimizerInputsTransactionCostConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPTransactionCostConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPTransactionCostConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPTransactionCostConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPTransactionCostConstraint input)
        {
            if (input == null)
            {
                return false;
