...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPExpectedReturnConstraint")]
    public partial class OptimizerInputsMPExpectedReturnConstraint : IEquatable<OptimizerInputsMPExpectedReturnConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPExpectedReturnConstraint" /> class.
        /// </summary>
        ...
        public OptimizerInputsExpectedReturnConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPExpectedReturnConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPExpectedReturnConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPExpectedReturnConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPExpectedReturnConstraint input)
        {
            if (input == null)
            {
                return false;
