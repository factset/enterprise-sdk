...
namespace FactSet.SDK.OptimizationEngineAPIMultiperiod.Model
{
    ...
    /// </summary>
    [DataContract(Name = "optimizer.inputs.MPGeneralLinearConstraint")]
    public partial class OptimizerInputsMPGeneralLinearConstraint : IEquatable<OptimizerInputsMPGeneralLinearConstraint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizerInputsMPGeneralLinearConstraint" /> class.
        /// </summary>
        /// <param name="constraint">constraint.</param>
        /// <param name="onPeriods">onPeriods.</param>
        /// <param name="acrossPeriods">acrossPeriods.</param>
        public OptimizerInputsMPGeneralLinearConstraint(OptimizerInputsGeneralLinearConstraint constraint = default(OptimizerInputsGeneralLinearConstraint), OptimizerInputsOnPeriods onPeriods = default(OptimizerInputsOnPeriods), OptimizerInputsAcrossPeriods acrossPeriods = default(OptimizerInputsAcrossPeriods))
        {
        ...
        public OptimizerInputsGeneralLinearConstraint Constraint { get; set; }
        ...
        {
            return this.Equals(input as OptimizerInputsMPGeneralLinearConstraint);
        }

        /// <summary>
        /// Returns true if OptimizerInputsMPGeneralLinearConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizerInputsMPGeneralLinearConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizerInputsMPGeneralLinearConstraint input)
        {
            if (input == null)
            {
                return false;
